...
public class ActionMenuItemView extends z implements n.a, View.OnClickListener, ActionMenuView.a {
    ...
    public class a extends h0 {
        ...
        public boolean c() {
            ...
            return bVar != null && bVar.a(actionMenuItemView.f67f) && (b2 = b()) != null && b2.c();
        }
    }
    ...
    @Override // androidx.appcompat.widget.ActionMenuView.a
    public boolean b() {
        return c() && this.f67f.getIcon() == null;
    }
    ...
    public final void g() {
        boolean z = true;
        boolean z2 = !TextUtils.isEmpty(this.f68g);
        if (this.h != null) {
            if (!((this.f67f.y & 4) == 4) || (!this.l && !this.m)) {
                z = false;
            }
        }
        boolean z3 = z2 & z;
        CharSequence charSequence = null;
        setText(z3 ? this.f68g : null);
        CharSequence charSequence2 = this.f67f.q;
        if (TextUtils.isEmpty(charSequence2)) {
            if (z3) {
                charSequence2 = null;
            } else {
                charSequence2 = this.f67f.f736e;
            }
        }
        setContentDescription(charSequence2);
        CharSequence charSequence3 = this.f67f.r;
        if (TextUtils.isEmpty(charSequence3)) {
            if (!z3) {
                charSequence = this.f67f.f736e;
            }
            i.j.i0(this, charSequence);
            return;
        }
        i.j.i0(this, charSequence3);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        h0 h0Var;
        if (!this.f67f.hasSubMenu() || (h0Var = this.j) == null || !h0Var.onTouch(this, motionEvent)) {
