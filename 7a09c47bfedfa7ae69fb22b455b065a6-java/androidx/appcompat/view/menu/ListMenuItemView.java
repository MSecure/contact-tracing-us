...
public class ListMenuItemView extends LinearLayout implements n.a, AbsListView.SelectionBoundsAdjuster {
    ...
    public RadioButton f73d;

    /* renamed from: e  reason: collision with root package name */
    public TextView f74e;

    /* renamed from: f  reason: collision with root package name */
    public CheckBox f75f;

    /* renamed from: g  reason: collision with root package name */
    public TextView f76g;
    public ImageView h;
    public ImageView i;
    ...
    public void c(boolean z) {
        String str;
        int i2;
        int i3 = (!z || !this.f71b.m()) ? 8 : 0;
        if (i3 == 0) {
            TextView textView = this.f76g;
            i iVar = this.f71b;
            char e2 = iVar.e();
            if (e2 == 0) {
                str = "";
            } else {
                Resources resources = iVar.n.f722a.getResources();
                StringBuilder sb = new StringBuilder();
                if (ViewConfiguration.get(iVar.n.f722a).hasPermanentMenuKey()) {
        ...
        if (this.f76g.getVisibility() != i3) {
            this.f76g.setVisibility(i3);
        }
    }
    ...
    public void onFinishInflate() {
        ...
        this.f76g = (TextView) findViewById(f.shortcut);
    ...
    public void onMeasure(int i2, int i3) {
        if (this.f72c != null && this.n) {
            ViewGroup.LayoutParams layoutParams = getLayoutParams();
            LinearLayout.LayoutParams layoutParams2 = (LinearLayout.LayoutParams) this.f72c.getLayoutParams();
    ...
    public void setCheckable(boolean z) {
        ...
        if (z || this.f73d != null || this.f75f != null) {
            if (this.f71b.h()) {
                if (this.f73d == null) {
                    b();
                }
                compoundButton2 = this.f73d;
                compoundButton = this.f75f;
            } else {
                if (this.f75f == null) {
                    a();
                }
                compoundButton2 = this.f75f;
                compoundButton = this.f73d;
            }
            if (z) {
                compoundButton2.setChecked(this.f71b.isChecked());
            ...
            CheckBox checkBox = this.f75f;
            if (checkBox != null) {
                checkBox.setVisibility(8);
            }
            RadioButton radioButton = this.f73d;
            if (radioButton != null) {
    ...
    public void setIcon(Drawable drawable) {
        boolean z = this.f71b.n.s || this.r;
        if (!z && !this.n) {
            return;
        }
        if (this.f72c != null || drawable != null || this.n) {
            if (this.f72c == null) {
            ...
            if (drawable != null || this.n) {
                ImageView imageView2 = this.f72c;
                if (!z) {
                    drawable = null;
                }
                imageView2.setImageDrawable(drawable);
                if (this.f72c.getVisibility() != 0) {
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        if (charSequence != null) {
            this.f74e.setText(charSequence);
