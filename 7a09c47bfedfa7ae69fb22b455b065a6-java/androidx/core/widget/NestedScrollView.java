...
public class NestedScrollView extends FrameLayout implements h, e {
    ...
    public OverScroller f210d = new OverScroller(getContext());

    /* renamed from: e  reason: collision with root package name */
    public EdgeEffect f211e;

    /* renamed from: f  reason: collision with root package name */
    public EdgeEffect f212f;
    ...
    public static class a extends b.i.l.a {
        ...
        public void d(View view, b.i.l.w.b bVar) {
            ...
            NestedScrollView nestedScrollView = (NestedScrollView) view;
            bVar.f1906a.setClassName(ScrollView.class.getName());
    ...
    public static class c extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder h = c.a.a.a.a.h("HorizontalScrollView.SavedState{");
    ...
    public final void A(View view) {
        view.getDrawingRect(this.f209c);
        offsetDescendantRectToMyCoords(view, this.f209c);
        int d2 = d(this.f209c);
        if (d2 != 0) {
            scrollBy(0, d2);
        }
    ...
    public final void B(int i2, int i3, int i4, boolean z2) {
        if (getChildCount() != 0) {
            if (AnimationUtils.currentAnimationTimeMillis() - this.f208b > 250) {
                View childAt = getChildAt(0);
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) childAt.getLayoutParams();
                int scrollY = getScrollY();
                OverScroller overScroller = this.f210d;
                ...
                if (!this.f210d.isFinished()) {
                    a();
                }
                scrollBy(i2, i3);
            }
            this.f208b = AnimationUtils.currentAnimationTimeMillis();
        }
    }
    ...
    public boolean b(int i2) {
        ...
        if (findNextFocus == null || !t(findNextFocus, maxScrollAmount, getHeight())) {
            ...
            findNextFocus.getDrawingRect(this.f209c);
            offsetDescendantRectToMyCoords(findNextFocus, this.f209c);
            f(d(this.f209c));
    ...
    public void computeScroll() {
        ...
        if (!this.f210d.isFinished()) {
            this.f210d.computeScrollOffset();
            int currY = this.f210d.getCurrY();
            int i2 = currY - this.v;
            this.v = currY;
            int[] iArr = this.t;
            boolean z2 = false;
            ...
            if (i3 != 0) {
                ...
                if (z2) {
                    k();
                    if (i3 < 0) {
                        if (this.f211e.isFinished()) {
                            edgeEffect = this.f211e;
                        }
                    } else if (this.f212f.isFinished()) {
                        edgeEffect = this.f212f;
                    }
                    edgeEffect.onAbsorb((int) this.f210d.getCurrVelocity());
                }
                a();
            }
            if (!this.f210d.isFinished()) {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f211e != null) {
            ...
            if (!this.f211e.isFinished()) {
                ...
                this.f211e.setSize(width, height);
                if (this.f211e.draw(canvas)) {
                    m.M(this);
                }
                canvas.restoreToCount(save);
            }
            if (!this.f212f.isFinished()) {
                ...
                this.f212f.setSize(width2, height2);
                if (this.f212f.draw(canvas)) {
                    m.M(this);
                }
    ...
    public final void g() {
        ...
        x();
        this.y.i(0);
        EdgeEffect edgeEffect = this.f211e;
        if (edgeEffect != null) {
            edgeEffect.onRelease();
            this.f212f.onRelease();
        }
    }
    ...
    public final void k() {
        if (getOverScrollMode() == 2) {
            ...
            Context context = getContext();
            this.f211e = new EdgeEffect(context);
            this.f212f = new EdgeEffect(context);
        }
    }
        ...
        if (getChildCount() > 0) {
            ...
            if (childAt.getHeight() + layoutParams.topMargin + layoutParams.bottomMargin > (getHeight() - getPaddingTop()) - getPaddingBottom()) {
                ...
                if (z2) {
                    ...
                    int height = getHeight();
                    if (z3) {
                        this.f209c.top = getScrollY() + height;
                        int childCount = getChildCount();
                        if (childCount > 0) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        int i2 = action & BuildConfig.VERSION_CODE;
        if (i2 != 0) {
            if (i2 != 1) {
                if (i2 == 2) {
                    int i3 = this.r;
                    if (!(i3 == -1 || (findPointerIndex = motionEvent.findPointerIndex(i3)) == -1)) {
                        ...
                        if (Math.abs(y2 - this.f213g) > this.o && (2 & getNestedScrollAxes()) == 0) {
                            this.k = true;
                            this.f213g = y2;
                            if (this.l == null) {
            ...
            this.r = -1;
            x();
            if (this.f210d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                m.M(this);
            }
            this.y.i(0);
        } else {
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (!this.i) {
            if (this.w != null) {
                scrollTo(getScrollX(), this.w.f214b);
                this.w = null;
            }
            if (getChildCount() > 0) {
                View childAt = getChildAt(0);
    ...
    public void onScrollChanged(int i2, int i3, int i4, int i5) {
        ...
        if (bVar != null) {
            ...
            AlertController.c(this, cVar.f510a, cVar.f511b);
        }
    }
    ...
    public void onSizeChanged(int i2, int i3, int i4, int i5) {
        ...
        if (findFocus != null && this != findFocus && t(findFocus, 0, i5)) {
            findFocus.getDrawingRect(this.f209c);
            offsetDescendantRectToMyCoords(findFocus, this.f209c);
            f(d(this.f209c));
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x007d, code lost:
        if (r22.f210d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange()) != false) goto L_0x01ee;
     */
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (findPointerIndex != -1) {
                    ...
                    if (this.k) {
                        ...
                        if (z2) {
                            ...
                            int i8 = scrollY + i7;
                            if (i8 < 0) {
                                this.f211e.onPull(((float) i7) / ((float) getHeight()), motionEvent.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.f212f.isFinished()) {
                                    edgeEffect = this.f212f;
                                }
                                EdgeEffect edgeEffect2 = this.f211e;
                                if (edgeEffect2 != null && (!edgeEffect2.isFinished() || !this.f212f.isFinished())) {
                                    m.M(this);
                                }
                            } else {
                                if (i8 > scrollRange) {
                                    this.f212f.onPull(((float) i7) / ((float) getHeight()), 1.0f - (motionEvent.getX(findPointerIndex) / ((float) getWidth())));
                                    if (!this.f211e.isFinished()) {
                                        edgeEffect = this.f211e;
                                    }
                                }
                                EdgeEffect edgeEffect22 = this.f211e;
                                m.M(this);
                            }
                            edgeEffect.onRelease();
                            EdgeEffect edgeEffect222 = this.f211e;
                            m.M(this);
                        }
                    }
                }
                ...
                this.f213g = (int) motionEvent.getY(actionIndex);
                this.r = motionEvent.getPointerId(actionIndex);
            } else if (actionMasked == 6) {
                v(motionEvent);
                this.f213g = (int) motionEvent.getY(motionEvent.findPointerIndex(this.r));
            }
            m.M(this);
            this.r = -1;
            g();
            ...
            boolean z3 = !this.f210d.isFinished();
            this.k = z3;
            ...
            this.f213g = (int) motionEvent.getY();
            this.r = motionEvent.getPointerId(0);
            C(2, 0);
        }
    ...
    public void p(int i2) {
        if (getChildCount() > 0) {
            this.f210d.fling(getScrollX(), getScrollY(), 0, i2, 0, 0, BleSignal.UNKNOWN_TX_POWER, Integer.MAX_VALUE, 0, 0);
            y(true);
        }
    }
    ...
    public boolean q(int i2) {
        ...
        boolean z2 = i2 == 130;
        int height = getHeight();
        Rect rect = this.f209c;
        rect.top = 0;
        rect.bottom = height;
        if (z2 && (childCount = getChildCount()) > 0) {
            View childAt = getChildAt(childCount - 1);
            this.f209c.bottom = getPaddingBottom() + childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin;
            Rect rect2 = this.f209c;
            rect2.top = rect2.bottom - height;
        }
        Rect rect3 = this.f209c;
    ...
    public final boolean t(View view, int i2, int i3) {
        view.getDrawingRect(this.f209c);
        offsetDescendantRectToMyCoords(view, this.f209c);
        return this.f209c.bottom + i2 >= getScrollY() && this.f209c.top - i2 <= getScrollY() + i3;
    }
    ...
    public final void v(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerId(actionIndex) == this.r) {
            ...
            this.f213g = (int) motionEvent.getY(i2);
    ...
    public boolean w(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        if (z3 && !r(1)) {
            this.f210d.springBack(i10, i12, 0, 0, 0, getScrollRange());
        }
