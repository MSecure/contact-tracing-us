...
public final class i implements b {
    ...
    public Drawable getIcon() {
        ...
        Drawable b2 = b.b.l.a.a.b(this.n.f722a, i2);
        this.m = 0;
        this.l = b2;
        return d(b2);
    }
    ...
    public CharSequence getTitleCondensed() {
        CharSequence charSequence = this.f737f;
        return charSequence != null ? charSequence : this.f736e;
    }
    ...
    public b.i.g.a.b i(View view) {
        ...
        this.z = view;
        this.A = null;
        if (view != null && view.getId() == -1 && (i2 = this.f732a) > 0) {
            view.setId(i2);
        }
        this.n.p();
        return this;
    ...
    public MenuItem setChecked(boolean z2) {
        if ((this.x & 4) != 0) {
            ...
            if (gVar != null) {
                ...
                int size = gVar.f727f.size();
                gVar.z();
                for (int i2 = 0; i2 < size; i2++) {
                    i iVar = gVar.f727f.get(i2);
                    if (iVar.f733b == groupId && iVar.h() && iVar.isCheckable()) {
                        iVar.j(iVar == this);
                    }
                }
                gVar.y();
    ...
    public MenuItem setTitle(int i2) {
        setTitle(this.n.f722a.getString(i2));
        return this;
    }
    ...
    public String toString() {
        CharSequence charSequence = this.f736e;
