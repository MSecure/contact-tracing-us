...
public class f0 extends ListView {
    ...
    public boolean b(MotionEvent motionEvent, int i2) {
        ...
        if (actionMasked == 1) {
            ...
            if (actionMasked != 3) {
                ...
                if (!z || z2) {
                    ...
                    childAt = getChildAt(this.f837g - getFirstVisiblePosition());
                    if (childAt != null) {
        ...
        if (findPointerIndex >= 0) {
            ...
            if (pointToPosition != -1) {
                ...
                Rect rect = this.f832b;
                rect.set(childAt3.getLeft(), childAt3.getTop(), childAt3.getRight(), childAt3.getBottom());
                rect.left -= this.f833c;
                rect.top -= this.f834d;
                rect.right += this.f835e;
                rect.bottom += this.f836f;
                try {
    ...
    public void dispatchDraw(Canvas canvas) {
        Drawable selector;
        if (!this.f832b.isEmpty() && (selector = getSelector()) != null) {
            selector.setBounds(this.f832b);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f837g = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY());
        }
        b bVar = this.o;
        if (bVar != null) {
            f0 f0Var = f0.this;
    ...
    public void setSelector(Drawable drawable) {
        ...
        this.f833c = rect.left;
        this.f834d = rect.top;
        this.f835e = rect.right;
        this.f836f = rect.bottom;
    }
}
