...
public class q {
    ...
    public static final int[] f911c = {16843067, 16843068};

    /* renamed from: a  reason: collision with root package name */
    public final ProgressBar f912a;
    ...
    public void a(AttributeSet attributeSet, int i) {
        y0 q = y0.q(this.f912a.getContext(), attributeSet, f911c, i, 0);
        Drawable h = q.h(0);
        if (h != null) {
            ProgressBar progressBar = this.f912a;
        ...
        Drawable h2 = q.h(1);
        if (h2 != null) {
            this.f912a.setProgressDrawable(b(h2, false));
        }
        q.f986b.recycle();
    }
