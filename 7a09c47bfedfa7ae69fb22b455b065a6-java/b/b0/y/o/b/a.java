...
public class a {
    ...
    public static final String f1131a = m.e("Alarms");

    public static void a(Context context, k kVar, String str) {
        i iVar = (i) kVar.f1096c.e();
        g a2 = iVar.a(str);
        if (a2 != null) {
            b(context, str, a2.f1220b);
            m.c().a(f1131a, String.format("Removing SystemIdInfo for workSpecId (%s)", str), new Throwable[0]);
            iVar.c(str);
        }
    }
    ...
    public static void b(Context context, String str, int i) {
        ...
        if (service != null && alarmManager != null) {
            m.c().a(f1131a, String.format("Cancelling existing alarm with (workSpecId, systemId) (%s, %s)", str, Integer.valueOf(i)), new Throwable[0]);
