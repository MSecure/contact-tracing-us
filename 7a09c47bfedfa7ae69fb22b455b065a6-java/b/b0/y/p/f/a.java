...
public class a extends c<Boolean> {
    ...
    public a(Context context, b.b0.y.s.s.a aVar) {
        super(context, aVar);
    }

    @Override // b.b0.y.p.f.d
    public Object a() {
        Intent registerReceiver = this.f1183b.registerReceiver(null, new IntentFilter("android.intent.action.BATTERY_CHANGED"));
        boolean z = false;
