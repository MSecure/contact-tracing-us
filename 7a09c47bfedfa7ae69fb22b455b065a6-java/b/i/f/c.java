...
public class c {
    ...
    public c(c cVar) {
        ...
        float[] fArr = cVar.f1750b;
        this.f1750b = i.j.n(fArr, 0, fArr.length);
    }
    ...
    public static void b(c[] cVarArr, Path path) {
        ...
        while (i6 < cVarArr2.length) {
            char c5 = cVarArr2[i6].f1749a;
            float[] fArr3 = cVarArr2[i6].f1750b;
            float f21 = fArr2[i5];
            float f22 = fArr2[1];
            float f23 = fArr2[2];
            float f24 = fArr2[3];
                ...
                if (c5 != 'A') {
                    if (c5 != 'C') {
                        if (c5 == 'H') {
                            ...
                            c2 = c5;
                            i3 = i6;
                            a(path, f29, f30, fArr3[i44] + f29, fArr3[i45] + f30, fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != 0.0f, fArr3[i2 + 4] != 0.0f);
                            f29 += fArr[i44];
                            f30 += fArr[i45];
                        }
                        i7 = i2 + i;
