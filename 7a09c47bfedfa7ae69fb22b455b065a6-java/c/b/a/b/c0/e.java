...
public class e extends ViewGroup {
    ...
    public e(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f4198b = obtainStyledAttributes.getDimensionPixelSize(l.FlowLayout_lineSpacing, 0);
        this.f4199c = obtainStyledAttributes.getDimensionPixelSize(l.FlowLayout_itemSpacing, 0);
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (!this.f4200d && measuredWidth > i7) {
                    i9 = this.f4198b + paddingTop;
                    this.f4201e++;
                    i8 = paddingRight;
                }
                childAt.setTag(f.row_index_key, Integer.valueOf(this.f4201e - 1));
                int i11 = i8 + i5;
                ...
                i8 += childAt.getMeasuredWidth() + i5 + i6 + this.f4199c;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int measuredWidth2 = childAt.getMeasuredWidth() + i4 + i5 + this.f4199c + paddingLeft;
