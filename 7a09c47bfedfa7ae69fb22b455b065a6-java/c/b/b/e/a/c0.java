...
public class c0<V> extends l.a<V> implements RunnableFuture<V> {
    ...
    public final class a extends t<V> {
        ...
        public final Callable<V> f4746e;

        public a(Callable<V> callable) {
            if (callable != null) {
                this.f4746e = callable;
                return;
            }
            throw null;
        }
    ...
    public void c() {
        ...
        if (p() && (tVar = this.i) != null) {
            ...
            if ((runnable instanceof Thread) && tVar.compareAndSet(runnable, t.f4765c)) {
                try {
                    ((Thread) runnable).interrupt();
                } finally {
                    if (((Runnable) tVar.getAndSet(t.f4764b)) == t.f4766d) {
