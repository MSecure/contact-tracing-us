...
public final class a extends s<g0, h0> {
    ...
    public class C0093a extends i.b<d, g0> {
        ...
        public d a(g0 g0Var) {
            ...
            f0 q = h0Var.q();
            i0 p = q.p();
            return new q(t.G1(t.S2(p.n()), g0Var2.keyValue_.q()), p.hkdfSalt_.q(), t.X2(p.o()), t.Z2(q.o()), new f(q.n().n()));
        }
    }
    ...
    public class b extends i.a<e0, g0> {
        ...
        public g0 a(e0 e0Var) {
            e0 e0Var2 = e0Var;
            KeyPair y1 = t.y1(t.S2(e0Var2.n().p().n()));
    ...
    public a() {
        super(g0.class, h0.class, new C0093a(d.class));
    }
