...
public final class q1 {
    ...
    public static final a f5014a = ((!(p1.h && p1.f5007g) || d.a()) ? new b() : new d());
                    ...
                    if (t.c(b3)) {
                        ...
                        if (!(b3 < -32)) {
                            if (b3 < -16) {
                                if (i6 < i3 - 1) {
                                    int i8 = i6 + 1;
                                    t.i(b3, bArr[i6], bArr[i8], cArr, i5);
                                    i = i8 + 1;
                                    i5++;
                                } else {
                                    throw b0.c();
                                ...
                                byte b5 = bArr[i6];
                                int i10 = i9 + 1;
                                t.a(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                                i5 = i5 + 1 + 1;
                                i = i10 + 1;
                            } else {
                                throw b0.c();
                    ...
                    if (t.c(g3)) {
                        ...
                        if (!(g3 < -32)) {
                            if (g3 < -16) {
                                if (i6 < i3 - 1) {
                                    int i8 = i6 + 1;
                                    t.i(g3, p1.g(bArr, (long) i6), p1.g(bArr, (long) i8), cArr, i5);
                                    i = i8 + 1;
                                    i5++;
                                } else {
                                    throw b0.c();
                                ...
                                int i9 = i6 + 1;
                                int i10 = i9 + 1;
                                t.a(g3, p1.g(bArr, (long) i6), p1.g(bArr, (long) i9), p1.g(bArr, (long) i10), cArr, i5);
                                i5 = i5 + 1 + 1;
                                i = i10 + 1;
                            } else {
                                throw b0.c();
                            ...
                            t.f(g3, p1.g(bArr, (long) i6), cArr, i5);
                            i = i6 + 1;
                            i5++;
                        } else {
                            throw b0.c();
                    ...
                    while (i4 < length) {
                        ...
                        if (charAt2 >= c2 || j2 >= j3) {
                            if (charAt2 < 2048 && j2 <= j3 - 2) {
                                ...
                                j = j5 + j4;
                                p1.q(bArr, j5, (byte) ((charAt2 & '?') | RecyclerView.a0.FLAG_IGNORE));
                            } else if ((charAt2 < 55296 || 57343 < charAt2) && j2 <= j3 - 3) {
                                long j6 = j2 + j4;
                                p1.q(bArr, j2, (byte) ((charAt2 >>> '\f') | 480));
                                long j7 = j4 + j6;
                                p1.q(bArr, j6, (byte) (((charAt2 >>> 6) & 63) | RecyclerView.a0.FLAG_IGNORE));
                                j = 1 + j7;
                                p1.q(bArr, j7, (byte) ((charAt2 & '?') | RecyclerView.a0.FLAG_IGNORE));
                                j4 = 1;
                            } else if (j2 <= j3 - 4) {
                                int i5 = i4 + 1;
                                if (i5 != length) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        ...
                                        long j9 = 1 + j8;
                                        p1.q(bArr, j8, (byte) (((codePoint >>> 12) & 63) | RecyclerView.a0.FLAG_IGNORE));
                                        long j10 = 1 + j9;
                                        p1.q(bArr, j9, (byte) (((codePoint >>> 6) & 63) | RecyclerView.a0.FLAG_IGNORE));
                                        j4 = 1;
                                        p1.q(bArr, j10, (byte) ((codePoint & 63) | RecyclerView.a0.FLAG_IGNORE));
                                        i4 = i5;
                                        c2 = 128;
                                        j2 = j10 + 1;
                                    } else {
                    ...
                    if (i6 != 0) {
                        ...
                        if (b6 >= -32) {
                            if (b6 >= -16) {
                                ...
                                i6 = i7 - 2;
                                long j15 = j10 + 1;
                                byte g4 = p1.g(bArr, j10);
                                if (g4 > -65 || ((b6 == -32 && g4 < -96) || (b6 == -19 && g4 >= -96))) {
                                    break;
                                }
                                j10 = j15 + 1;
                                if (p1.g(bArr, j15) > -65) {
