...
public final class g extends s<j1, k1> {
    ...
    public static final byte[] f5080d = "Tink and Wycheproof.".getBytes(Charset.forName(o.DEFAULT_PARAMS_ENCODING));
    ...
    public class a extends i.b<t, j1> {
        ...
        public t a(j1 j1Var) {
            ...
            j0 j0Var = new j0((RSAPrivateCrtKey) a2.generatePrivate(new RSAPrivateCrtKeySpec(new BigInteger(1, j1Var2.u().n_.q()), new BigInteger(1, j1Var2.u().e_.q()), new BigInteger(1, j1Var2.d_.q()), new BigInteger(1, j1Var2.p_.q()), new BigInteger(1, j1Var2.q_.q()), new BigInteger(1, j1Var2.dp_.q()), new BigInteger(1, j1Var2.dq_.q()), new BigInteger(1, j1Var2.crt_.q()))), b.x.t.W2(j1Var2.u().q().n()));
            try {
                new k0((RSAPublicKey) a2.generatePublic(new RSAPublicKeySpec(new BigInteger(1, j1Var2.u().n_.q()), new BigInteger(1, j1Var2.u().e_.q()))), b.x.t.W2(j1Var2.u().q().n())).a(j0Var.a(g.f5080d), g.f5080d);
                return j0Var;
    ...
    public class b extends i.a<h1, j1> {
        ...
        public j1 a(h1 h1Var) {
            ...
            a2.initialize(new RSAKeyGenParameterSpec(h1Var2.modulusSizeInBits_, new BigInteger(1, h1Var2.publicExponent_.q())));
    ...
    public void g(r0 r0Var) {
        ...
        n0.c(new BigInteger(1, j1Var.u().n_.q()).bitLength());
        b.x.t.g3(j1Var.u().q());
    }
}
