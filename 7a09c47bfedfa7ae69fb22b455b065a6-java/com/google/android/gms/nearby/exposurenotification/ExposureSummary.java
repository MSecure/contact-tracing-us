...
public final class ExposureSummary extends a implements ReflectedParcelable {
    ...
    public static final class ExposureSummaryBuilder {
        ...
        public final ExposureSummaryBuilder setDaysSinceLastExposure(int i) {
            t.u(i >= 0, "daysSinceLastExposure (%s) must be >= 0", Integer.valueOf(i));
            this.zza = i;
            return this;
        }

        public final ExposureSummaryBuilder setMatchedKeyCount(int i) {
            t.u(i >= 0, "matchedKeyCount (%s) must be >= 0", Integer.valueOf(i));
            this.zzb = i;
            return this;
        }

        public final ExposureSummaryBuilder setMaximumRiskScore(int i) {
            t.u(i >= 0 && i <= 4096, "maximumRiskScore (%s) must be >= 0 and <= 4096", Integer.valueOf(i));
            this.zzc = i;
            return this;
        }

        public final ExposureSummaryBuilder setSummationRiskScore(int i) {
            t.u(i >= 0, "summationRiskScore (%s) must be >= 0", Integer.valueOf(i));
            this.zze = i;
            return this;
        }
    }
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof ExposureSummary) {
            ...
            return t.j1(Integer.valueOf(this.zza), Integer.valueOf(exposureSummary.getDaysSinceLastExposure())) && t.j1(Integer.valueOf(this.zzb), Integer.valueOf(exposureSummary.getMatchedKeyCount())) && t.j1(Integer.valueOf(this.zzc), Integer.valueOf(exposureSummary.getMaximumRiskScore())) && Arrays.equals(this.zzd, exposureSummary.getAttenuationDurationsInMinutes()) && t.j1(Integer.valueOf(this.zze), Integer.valueOf(exposureSummary.getSummationRiskScore()));
        }
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        int m = t.m(parcel);
        t.q3(parcel, 1, getDaysSinceLastExposure());
        t.q3(parcel, 2, getMatchedKeyCount());
        t.q3(parcel, 3, getMaximumRiskScore());
        t.r3(parcel, 4, getAttenuationDurationsInMinutes(), false);
        t.q3(parcel, 5, getSummationRiskScore());
        t.w4(parcel, m);
    }
}
