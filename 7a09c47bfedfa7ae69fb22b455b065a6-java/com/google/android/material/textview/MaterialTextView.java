...
public class MaterialTextView extends z {
    public MaterialTextView(Context context, AttributeSet attributeSet) {
        ...
        boolean z = true;
        if (t.A2(context2, b.textAppearanceLineHeightEnabled, true)) {
            Resources.Theme theme = context2.getTheme();
            TypedArray obtainStyledAttributes = theme.obtainStyledAttributes(attributeSet, l.MaterialTextView, 16842884, 0);
            int f2 = f(context2, obtainStyledAttributes, l.MaterialTextView_android_lineHeight, l.MaterialTextView_lineHeight);
    ...
    public final void c(Resources.Theme theme, int i) {
        ...
        int f2 = f(getContext(), obtainStyledAttributes, l.MaterialTextAppearance_android_lineHeight, l.MaterialTextAppearance_lineHeight);
        obtainStyledAttributes.recycle();
        if (f2 >= 0) {
            setLineHeight(f2);
        }
    ...
    public void setTextAppearance(Context context, int i) {
        ...
        if (t.A2(context, b.textAppearanceLineHeightEnabled, true)) {
