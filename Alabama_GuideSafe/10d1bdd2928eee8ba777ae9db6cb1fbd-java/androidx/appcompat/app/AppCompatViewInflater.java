...
public class AppCompatViewInflater {
        ...
        public void onClick(View view) {
            ...
            if (this.mResolvedMethod == null) {
                ...
                if (id == -1) {
                    ...
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17(" with id '");
                    outline17.append(this.mHostView.getContext().getResources().getResourceEntryName(id));
                    outline17.append("'");
                    str = outline17.toString();
                }
                StringBuilder outline172 = GeneratedOutlineSupport.outline17("Could not find method ");
                outline172.append(this.mMethodName);
                outline172.append("(View) in a parent or ancestor Context for android:onClick attribute defined on view ");
                outline172.append(this.mHostView.getClass());
    ...
    public static Context themifyContext(Context context, AttributeSet attributeSet, boolean z, boolean z2) {
        ...
        obtainStyledAttributes.recycle();
        if (resourceId != 0) {
            return (!(context instanceof ContextThemeWrapper) || ((ContextThemeWrapper) context).mThemeResource != resourceId) ? new ContextThemeWrapper(context, resourceId) : context;
        }
        return context;
    }
    ...
    public AppCompatSpinner createSpinner(Context context, AttributeSet attributeSet) {
        return new AppCompatSpinner(context, attributeSet, R$attr.spinnerStyle, -1);
    }
