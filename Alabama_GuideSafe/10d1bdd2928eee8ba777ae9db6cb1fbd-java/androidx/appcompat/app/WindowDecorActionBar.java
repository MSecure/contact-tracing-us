...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public final ViewPropertyAnimatorListener mHideListener = new ViewPropertyAnimatorListenerAdapter() {
        ...
        public void onAnimationEnd(View view) {
            ...
            if (windowDecorActionBar.mContentAnimations && (view2 = windowDecorActionBar.mContentView) != null) {
                ...
                WindowDecorActionBar.this.mContainerView.setTranslationY(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
            }
    ...
    public final void init(View view) {
        ...
        if (findViewById instanceof DecorToolbar) {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Can't make a decor toolbar out of ");
            outline17.append(findViewById != null ? findViewById.getClass().getSimpleName() : "null");
        ...
        if (this.mShowingForMode || !this.mHiddenBySystem) {
            if (!this.mNowShowing) {
                ...
                if (this.mCurWindowVisibility != 0 || (!this.mShowHideAnimationEnabled && !z)) {
                    ...
                    this.mContainerView.setTranslationY(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
                    ...
                    if (this.mContentAnimations && (view3 = this.mContentView) != null) {
                        ...
                        animate2.translationY(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
                        if (!viewPropertyAnimatorCompatSet2.mIsStarted) {
