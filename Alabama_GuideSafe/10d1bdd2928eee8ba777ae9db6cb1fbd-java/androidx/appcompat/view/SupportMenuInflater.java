    ...
    public static class InflatedOnMenuItemClickListener implements MenuItem.OnMenuItemClickListener {
        ...
        public InflatedOnMenuItemClickListener(Object obj, String str) {
            ...
            try {
                ...
                StringBuilder outline20 = GeneratedOutlineSupport.outline20("Couldn't resolve menu item onClick handler ", str, " in class ");
                outline20.append(cls.getName());
                InflateException inflateException = new InflateException(outline20.toString());
        ...
        while (true) {
            if (eventType == 2) {
                ...
                if (name.equals("menu")) {
                    ...
                    throw new RuntimeException(GeneratedOutlineSupport.outline10("Expecting menu, got ", name));
                }
            } else {
                eventType = xmlPullParser.next();
                if (eventType == 1) {
