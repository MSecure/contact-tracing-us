                    ...
                    if (this.mOutsideDrawablesCache.containsKey(flattenToShortString)) {
                        ...
                        try {
                            ...
                            if (iconResource != 0) {
                                ...
                                if (drawable3 == null) {
                                    StringBuilder outline18 = GeneratedOutlineSupport.outline18("Invalid icon resource ", iconResource, " for ");
                                    outline18.append(searchActivity.flattenToShortString());
                                    Log.w("SuggestionsAdapter", outline18.toString());
                                }
                                if (drawable3 != null) {
                                    constantState = null;
                                } else {
