...
public final class CallbackToFutureAdapter$Completer<T> {
    ...
    public void finalize() {
        ...
        if (callbackToFutureAdapter$SafeFuture != null && !callbackToFutureAdapter$SafeFuture.isDone()) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("The completer object was garbage collected - this future would otherwise never complete. The tag was: ");
            outline17.append(this.tag);
            callbackToFutureAdapter$SafeFuture.delegate.setException(new CallbackToFutureAdapter$FutureGarbageCollectedException(outline17.toString()));
        }
