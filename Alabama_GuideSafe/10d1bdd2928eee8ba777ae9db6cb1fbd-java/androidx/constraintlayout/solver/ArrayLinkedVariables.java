...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public String toString() {
        ...
        int i2 = 0;
        while (i != -1 && i2 < this.currentSize) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17(GeneratedOutlineSupport.outline10(str, " -> "));
            outline17.append(this.mArrayValues[i]);
            outline17.append(" : ");
            StringBuilder outline172 = GeneratedOutlineSupport.outline17(outline17.toString());
            outline172.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
