...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public float get(SolverVariable solverVariable) {
        int indexOf = indexOf(solverVariable);
        return indexOf != -1 ? this.values[indexOf] : BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
    }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                String outline10 = GeneratedOutlineSupport.outline10(str4, "[p: ");
                if (this.previous[indexOf] != -1) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17(outline10);
                    outline17.append(this.mCache.mIndexedVariables[this.variables[this.previous[indexOf]]]);
                    str = outline17.toString();
                } else {
                    str = GeneratedOutlineSupport.outline10(outline10, "none");
                }
                String outline102 = GeneratedOutlineSupport.outline10(str, ", n: ");
                if (this.next[indexOf] != -1) {
                    StringBuilder outline172 = GeneratedOutlineSupport.outline17(outline102);
                    outline172.append(this.mCache.mIndexedVariables[this.variables[this.next[indexOf]]]);
                    str2 = outline172.toString();
                } else {
                    str2 = GeneratedOutlineSupport.outline10(outline102, "none");
                }
                str3 = GeneratedOutlineSupport.outline10(str2, "]");
            }
        }
        return GeneratedOutlineSupport.outline10(str3, " }");
    }
