...
public class Barrier extends HelperWidget {
    ...
    public String toString() {
        String outline14 = GeneratedOutlineSupport.outline14(GeneratedOutlineSupport.outline17("[Barrier] "), this.mDebugName, " {");
        for (int i = 0; i < this.mWidgetsCount; i++) {
            ConstraintWidget constraintWidget = this.mWidgets[i];
            if (i > 0) {
                outline14 = GeneratedOutlineSupport.outline10(outline14, ", ");
            }
            StringBuilder outline17 = GeneratedOutlineSupport.outline17(outline14);
            outline17.append(constraintWidget.mDebugName);
            outline14 = outline17.toString();
        }
        return GeneratedOutlineSupport.outline10(outline14, "}");
    }
}
