...
public class ConstraintWidget {
    ...
    public String toString() {
        ...
        String str = "";
        sb.append(this.mType != null ? GeneratedOutlineSupport.outline14(GeneratedOutlineSupport.outline17("type: "), this.mType, " ") : str);
        if (this.mDebugName != null) {
            str = GeneratedOutlineSupport.outline14(GeneratedOutlineSupport.outline17("id: "), this.mDebugName, " ");
        }
        sb.append(str);
        sb.append("(");
        sb.append(this.mX);
        ...
        sb.append(" x ");
        return GeneratedOutlineSupport.outline13(sb, this.mHeight, ")");
    }
