        ...
        if (constraintSet != null) {
            ...
            while (i6 < childCount3) {
                ...
                if (!constraintSet.mConstraints.containsKey(Integer.valueOf(id2))) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("id unknown ");
                    try {
                    ...
                    Log.w("ConstraintSet", outline17.toString());
                    ...
                    for (String str4 : hashMap.keySet()) {
                        ...
                        String outline10 = GeneratedOutlineSupport.outline10("set", str4);
                        try {
                            switch (constraintAttribute.mType.ordinal()) {
                                case 0:
                                    i5 = childCount2;
                                    cls.getMethod(outline10, Integer.TYPE).invoke(childAt3, Integer.valueOf(constraintAttribute.mIntegerValue));
                                    break;
                                case 1:
                                    i5 = childCount2;
                                    cls.getMethod(outline10, Float.TYPE).invoke(childAt3, Float.valueOf(constraintAttribute.mFloatValue));
                                    break;
                                case 2:
                                    i5 = childCount2;
                                    cls.getMethod(outline10, Integer.TYPE).invoke(childAt3, Integer.valueOf(constraintAttribute.mColorValue));
                                    break;
                                case 3:
                                    i5 = childCount2;
                                    Method method = cls.getMethod(outline10, Drawable.class);
                                ...
                                case 4:
                                    i5 = childCount2;
                                    cls.getMethod(outline10, CharSequence.class).invoke(childAt3, constraintAttribute.mStringValue);
                                    break;
                                case 5:
                                    i5 = childCount2;
                                    cls.getMethod(outline10, Boolean.TYPE).invoke(childAt3, Boolean.valueOf(constraintAttribute.mBooleanValue));
                                    break;
                                case 6:
                                    i5 = childCount2;
                                    try {
                                        ...
                                        e2 = e5;
                                        StringBuilder outline20 = GeneratedOutlineSupport.outline20(" Custom Attribute \"", str4, "\" not found on ");
                                        outline20.append(cls.getName());
                                        Log.e("TransitionLayout", outline20.toString());
                                        e2.printStackTrace();
                                        z = z;
                                        hashMap = hashMap;
                                        isInEditMode = isInEditMode;
                                        ...
                                        e3 = e6;
                                        StringBuilder outline202 = GeneratedOutlineSupport.outline20(" Custom Attribute \"", str4, "\" not found on ");
                                        outline202.append(cls.getName());
                                        Log.e("TransitionLayout", outline202.toString());
                                        e3.printStackTrace();
                                        z = z;
                                        hashMap = hashMap;
                                        isInEditMode = isInEditMode;
                            ...
                            e2 = e8;
                            i5 = childCount2;
                            StringBuilder outline203 = GeneratedOutlineSupport.outline20(" Custom Attribute \"", str4, "\" not found on ");
                            outline203.append(cls.getName());
                            Log.e("TransitionLayout", outline203.toString());
                            e2.printStackTrace();
                            z = z;
                            hashMap = hashMap;
                            isInEditMode = isInEditMode;
                            ...
                            e3 = e9;
                            i5 = childCount2;
                            StringBuilder outline2022 = GeneratedOutlineSupport.outline20(" Custom Attribute \"", str4, "\" not found on ");
                            outline2022.append(cls.getName());
                            Log.e("TransitionLayout", outline2022.toString());
                            e3.printStackTrace();
                            z = z;
                            hashMap = hashMap;
                            isInEditMode = isInEditMode;
