...
public final class NotificationManagerCompat {
    ...
    public static class NotifyTask implements Task {
        ...
        public String toString() {
            ...
            sb.append(this.id);
            sb.append(", tag:");
            return GeneratedOutlineSupport.outline14(sb, this.tag, "]");
        }
    }
    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
                ...
                if (!set.equals(this.mCachedEnabledPackages)) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (!hashSet2.contains(next.getKey())) {
                            if (Log.isLoggable("NotifManCompat", 3)) {
                                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Removing listener record for ");
                                outline17.append(next.getKey());
                                outline17.toString();
                            }
        ...
        public final void processListenerQueue(ListenerRecord listenerRecord) {
            boolean z;
            if (Log.isLoggable("NotifManCompat", 3)) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Processing component ");
                outline17.append(listenerRecord.componentName);
                outline17.append(", ");
                outline17.append(listenerRecord.taskQueue.size());
                outline17.append(" queued tasks");
                outline17.toString();
            }
            if (!listenerRecord.taskQueue.isEmpty()) {
                if (listenerRecord.bound) {
                    ...
                    if (bindService) {
                        ...
                        StringBuilder outline172 = GeneratedOutlineSupport.outline17("Unable to bind to listener ");
                        outline172.append(listenerRecord.componentName);
                        Log.w("NotifManCompat", outline172.toString());
                        this.mContext.unbindService(this);
                    }
                ...
                while (true) {
                    ...
                    try {
                        ...
                        if (Log.isLoggable("NotifManCompat", 3)) {
                            StringBuilder outline173 = GeneratedOutlineSupport.outline17("Remote service has died: ");
                            outline173.append(listenerRecord.componentName);
                            outline173.toString();
                        }
                    } catch (RemoteException e) {
                        StringBuilder outline174 = GeneratedOutlineSupport.outline17("RemoteException communicating with ");
                        outline174.append(listenerRecord.componentName);
                        Log.w("NotifManCompat", outline174.toString(), e);
                    }
                }
                if (!listenerRecord.taskQueue.isEmpty()) {
                    scheduleListenerRetry(listenerRecord);
        ...
        public final void scheduleListenerRetry(ListenerRecord listenerRecord) {
            if (!this.mHandler.hasMessages(3, listenerRecord.componentName)) {
                ...
                if (i > 6) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("Giving up on delivering ");
                    outline17.append(listenerRecord.taskQueue.size());
                    outline17.append(" tasks to ");
                    outline17.append(listenerRecord.componentName);
                    outline17.append(" after ");
                    outline17.append(listenerRecord.retryCount);
                    outline17.append(" retries");
                    Log.w("NotifManCompat", outline17.toString());
