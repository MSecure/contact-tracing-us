...
public class FileProvider extends ContentProvider {
    ...
    public static final File DEVICE_ROOT = new File(ColorPropConverter.PATH_DELIMITER);
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                if (entry != null) {
                    ...
                    if (path2.endsWith(ColorPropConverter.PATH_DELIMITER)) {
                        str = canonicalPath.substring(path2.length());
                    } else {
                        str = canonicalPath.substring(path2.length() + 1);
                    }
                    return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(str, ColorPropConverter.PATH_DELIMITER)).build();
                }
    ...
    public static PathStrategy parsePathStrategy(Context context, String str) throws IOException, XmlPullParserException {
        ...
        if (resolveContentProvider != null) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Couldn't find meta-data for provider with authority ", str));
        }
    }
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        ...
        if ("r".equals(str)) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Invalid mode: ", str));
        }
