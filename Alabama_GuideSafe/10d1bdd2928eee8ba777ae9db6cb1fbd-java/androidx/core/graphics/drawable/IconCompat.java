...
public class IconCompat extends CustomVersionedParcelable {
    ...
    public String getResPackage() {
        ...
        if (i == -1) {
            ...
            return ((String) this.mObj1).split(ColorPropConverter.PACKAGE_DELIMITER, -1)[0];
        } else {
    ...
    public Icon toIcon() {
        ...
        switch (this.mType) {
            ...
            case 6:
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Context is required to resolve the file uri of the icon: ");
                outline17.append(getUri());
