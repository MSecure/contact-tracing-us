...
public class FontsContractCompat {
    ...
    public static FontFamilyResult fetchFonts(Context context, CancellationSignal cancellationSignal, FontRequest fontRequest) throws PackageManager.NameNotFoundException {
        ...
        if (resolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(GeneratedOutlineSupport.outline10("No package found for authority: ", str));
            ...
            StringBuilder outline20 = GeneratedOutlineSupport.outline20("Found content provider ", str, ", but package was not ");
            outline20.append(fontRequest.mProviderPackage);
            throw new PackageManager.NameNotFoundException(outline20.toString());
        }
    }
