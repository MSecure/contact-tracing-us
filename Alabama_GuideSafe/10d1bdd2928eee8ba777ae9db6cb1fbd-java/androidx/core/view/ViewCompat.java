...
public class ViewCompat {
    ...
    public static WindowInsetsCompat dispatchApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
        WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
        return (windowInsets == null || view.dispatchApplyWindowInsets(windowInsets).equals(windowInsets)) ? windowInsetsCompat : new WindowInsetsCompat(windowInsets);
    }
    ...
    public static void notifyViewAccessibilityStateChangedIfNeeded(View view, int i) {
        if (((AccessibilityManager) view.getContext().getSystemService("accessibility")).isEnabled()) {
            boolean z = ((CharSequence) new AccessibilityViewProperty<CharSequence>(R$id.tag_accessibility_pane_title, CharSequence.class, 8, 28) {
    ...
    public static WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
        ...
        return !onApplyWindowInsets.equals(windowInsets) ? new WindowInsetsCompat(onApplyWindowInsets) : windowInsetsCompat;
    }
        ...
        if (onApplyWindowInsetsListener == null) {
            ...
            view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() {
                ...
                public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                    if (windowInsets != null) {
                        return OnApplyWindowInsetsListener.this.onApplyWindowInsets(view, new WindowInsetsCompat(windowInsets)).toWindowInsets();
                    }
                    throw null;
                }
            });
