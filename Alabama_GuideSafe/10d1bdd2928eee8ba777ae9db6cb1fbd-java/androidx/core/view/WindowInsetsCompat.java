...
public class WindowInsetsCompat {
    ...
    public static class BuilderImpl29 extends BuilderImpl {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setStableInsets(Insets insets) {
            this.mPlatBuilder.setStableInsets(android.graphics.Insets.of(insets.left, insets.top, insets.right, insets.bottom));
        }

        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        public void setSystemWindowInsets(Insets insets) {
            this.mPlatBuilder.setSystemWindowInsets(android.graphics.Insets.of(insets.left, insets.top, insets.right, insets.bottom));
        }
