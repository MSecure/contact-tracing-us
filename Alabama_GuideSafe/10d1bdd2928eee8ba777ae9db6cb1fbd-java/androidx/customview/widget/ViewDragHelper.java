...
public class ViewDragHelper {
    ...
    public void captureChildView(View view, int i) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
        outline17.append(this.mParentView);
        outline17.append(")");
