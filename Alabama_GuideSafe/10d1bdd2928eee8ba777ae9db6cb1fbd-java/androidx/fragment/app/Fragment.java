...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    public static Fragment instantiate(Context context, String str, Bundle bundle) {
        try {
            ...
            throw new InstantiationException(GeneratedOutlineSupport.outline11("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e);
        } catch (IllegalAccessException e2) {
            throw new InstantiationException(GeneratedOutlineSupport.outline11("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e2);
        } catch (NoSuchMethodException e3) {
            throw new InstantiationException(GeneratedOutlineSupport.outline11("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e3);
        } catch (InvocationTargetException e4) {
            throw new InstantiationException(GeneratedOutlineSupport.outline11("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e4);
        }
    }
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        this.mChildFragmentManager.dump(GeneratedOutlineSupport.outline10(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline8("Fragment ", this, " has not been attached yet."));
    }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline8("Fragment ", this, " not associated with a fragment manager."));
    }
    ...
    public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline8("Fragment ", this, " not attached to an activity."));
    }
    ...
    public final Context requireContext() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline8("Fragment ", this, " not attached to a context."));
    }
    ...
    public final View requireView() {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline8("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
    }
