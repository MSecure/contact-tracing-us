...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, FragmentManager fragmentManager) {
        ...
        if (classAttribute != null && findFragmentById == null) {
            if (id <= 0) {
                throw new IllegalStateException(GeneratedOutlineSupport.outline11("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? GeneratedOutlineSupport.outline10(" with tag ", string) : ""));
            }
