...
public class FragmentFactory {
    ...
    public static Class<? extends Fragment> loadFragmentClass(ClassLoader classLoader, String str) {
        try {
            ...
            throw new Fragment.InstantiationException(GeneratedOutlineSupport.outline11("Unable to instantiate fragment ", str, ": make sure class name exists"), e);
        } catch (ClassCastException e2) {
            throw new Fragment.InstantiationException(GeneratedOutlineSupport.outline11("Unable to instantiate fragment ", str, ": make sure class is a valid subclass of Fragment"), e2);
        }
    }
