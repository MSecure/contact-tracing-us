...
public abstract class FragmentManager {
                ...
                if (canonicalName != null) {
                    ...
                    if (!FragmentManagerViewModel.class.isInstance(viewModel2)) {
                        if (viewModelProvider$Factory instanceof ViewModelProvider$KeyedFactory) {
                            viewModel = ((ViewModelProvider$KeyedFactory) viewModelProvider$Factory).create(outline10, FragmentManagerViewModel.class);
                        } else {
    ...
    public final void destroyFragmentView(Fragment fragment) {
        ...
        throw new SuperNotCalledException(GeneratedOutlineSupport.outline8("Fragment ", fragment, " did not call through to super.onDestroyView()"));
    }
    ...
    public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (fragmentStore != null) {
            String outline102 = GeneratedOutlineSupport.outline10(str, "    ");
            if (!fragmentStore.mActive.isEmpty()) {
                ...
                for (FragmentStateManager fragmentStateManager : fragmentStore.mActive.values()) {
                    ...
                    if (fragmentStateManager != null) {
                        ...
                        fragment.dump(outline102, fileDescriptor, printWriter, strArr);
                    } else {
            ...
            if (arrayList2 != null && (size = arrayList2.size()) > 0) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    backStackRecord.dump(outline10, printWriter, true);
                }
            }
            printWriter.print(str);
            ...
            if (i4 != -1) {
                if (i4 != 0) {
                    if (i4 != 1) {
                        ...
                        if (min > 2) {
                            if (isLoggingEnabled(3)) {
                                StringBuilder outline17 = GeneratedOutlineSupport.outline17("moveto STARTED: ");
                                outline17.append(fragmentStateManager.mFragment);
                                outline17.toString();
                            }
                            ...
                            if (fragment5.mCalled) {
                                ...
                                throw new SuperNotCalledException(GeneratedOutlineSupport.outline8("Fragment ", fragment5, " did not call through to super.onStart()"));
                            }
                        }
                        if (min > 3) {
                            if (isLoggingEnabled(3)) {
                                StringBuilder outline172 = GeneratedOutlineSupport.outline17("moveto RESUMED: ");
                                outline172.append(fragmentStateManager.mFragment);
                                outline172.toString();
                            }
                            ...
                            if (fragment6.mCalled) {
                                ...
                                throw new SuperNotCalledException(GeneratedOutlineSupport.outline8("Fragment ", fragment6, " did not call through to super.onResume()"));
                            }
                        }
                    }
                    if (min > -1) {
                        ...
                        if (fragment8.mFromLayout && fragment8.mInLayout && !fragment8.mPerformedCreateView) {
                            if (isLoggingEnabled(3)) {
                                StringBuilder outline173 = GeneratedOutlineSupport.outline17("moveto CREATE_VIEW: ");
                                outline173.append(fragmentStateManager.mFragment);
                                outline173.toString();
                            }
                    ...
                    if (min > 1) {
                        ...
                        if (!fragmentStateManager.mFragment.mFromLayout) {
                            if (isLoggingEnabled(3)) {
                                StringBuilder outline174 = GeneratedOutlineSupport.outline17("moveto CREATE_VIEW: ");
                                outline174.append(fragmentStateManager.mFragment);
                                outline174.toString();
                            }
                                ...
                                if (i5 == 0) {
                                    ...
                                    if (viewGroup2 == null) {
                                        ...
                                        if (!fragment15.mRestored) {
                                            ...
                                            StringBuilder outline175 = GeneratedOutlineSupport.outline17("No view found for id 0x");
                                            outline175.append(Integer.toHexString(fragmentStateManager.mFragment.mContainerId));
                                            outline175.append(" (");
                                            outline175.append(str);
                                            outline175.append(") for fragment ");
                                            outline175.append(fragmentStateManager.mFragment);
                                            throw new IllegalArgumentException(outline175.toString());
                                        }
                                    }
                                } else {
                                    StringBuilder outline176 = GeneratedOutlineSupport.outline17("Cannot create fragment ");
                                    outline176.append(fragmentStateManager.mFragment);
                                    outline176.append(" for a container view with no id");
                                    throw new IllegalArgumentException(outline176.toString());
                                }
                            }
                        ...
                        if (isLoggingEnabled(3)) {
                            StringBuilder outline177 = GeneratedOutlineSupport.outline17("moveto ACTIVITY_CREATED: ");
                            outline177.append(fragmentStateManager.mFragment);
                            outline177.toString();
                        }
                        ...
                        if (fragment22.mCalled) {
                            ...
                            if (isLoggingEnabled(3)) {
                                StringBuilder outline178 = GeneratedOutlineSupport.outline17("moveto RESTORE_VIEW_STATE: ");
                                outline178.append(fragmentStateManager.mFragment);
                                outline178.toString();
                            }
                            ...
                            if (view3 != null) {
                                ...
                                if (!fragment24.mCalled) {
                                    throw new SuperNotCalledException(GeneratedOutlineSupport.outline8("Fragment ", fragment24, " did not call through to super.onViewStateRestored()"));
                            ...
                            throw new SuperNotCalledException(GeneratedOutlineSupport.outline8("Fragment ", fragment22, " did not call through to super.onActivityCreated()"));
                        }
                    }
                    if (min > 2) {
                    }
                ...
                if (str3 != null) {
                    ...
                    if (findActiveFragment2 == null) {
                        ...
                        throw new IllegalStateException(GeneratedOutlineSupport.outline14(sb, fragment.mTargetWho, " that does not belong to this FragmentManager!"));
                    ...
                    if (fragmentManagerState.mActive != null) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (next != null) {
                                ...
                                if (isLoggingEnabled(2)) {
                                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("restoreSaveState: active (");
                                    outline17.append(fragment2.mWho);
                                    outline17.append("): ");
                                    outline17.append(fragment2);
                                    outline17.toString();
                                }
                                fragmentStateManager.restoreState(this.mHost.mContext.getClassLoader());
                                this.mFragmentStore.mActive.put(fragmentStateManager.mFragment.mWho, fragmentStateManager);
                        ...
                        if (arrayList != null) {
                            for (String str3 : arrayList) {
                                ...
                                if (findActiveFragment != null) {
                                    ...
                                    throw new IllegalStateException(GeneratedOutlineSupport.outline11("No instantiated fragment for (", str3, ")"));
                                }
                            }
                        }
                        if (fragmentManagerState.mBackStack != null) {
                            ...
                            while (true) {
                                ...
                                if (backStackState != null) {
                                    ...
                                    if (isLoggingEnabled(2)) {
                                        StringBuilder outline18 = GeneratedOutlineSupport.outline18("restoreAllState: back stack #", i, " (index ");
                                        outline18.append(backStackRecord.mIndex);
                                        outline18.append("): ");
                                        outline18.append(backStackRecord);
                                        outline18.toString();
                ...
                if (fragmentStore != null) {
                    ...
                    if (arrayList3 != null && (size = arrayList3.size()) > 0) {
                        ...
                        for (i = 0; i < size; i++) {
                            ...
                            if (isLoggingEnabled(2)) {
                                StringBuilder outline18 = GeneratedOutlineSupport.outline18("saveAllState: adding back stack #", i, ": ");
                                outline18.append(this.mBackStack.get(i));
                                outline18.toString();
                            }
                        }
                    }
