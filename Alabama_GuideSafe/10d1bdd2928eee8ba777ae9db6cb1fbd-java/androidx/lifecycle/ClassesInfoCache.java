...
public class ClassesInfoCache {
    ...
    public final void verifyAndPutHandler(Map<MethodReference, Lifecycle.Event> map, MethodReference methodReference, Lifecycle.Event event, Class<?> cls) {
        ...
        if (event2 != null && event != event2) {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Method ");
            outline17.append(method.getName());
            outline17.append(" in ");
            outline17.append(cls.getName());
            outline17.append(" already declared with different @OnLifecycleEvent value: previous value ");
            outline17.append(event2);
            outline17.append(", new value ");
            outline17.append(event);
