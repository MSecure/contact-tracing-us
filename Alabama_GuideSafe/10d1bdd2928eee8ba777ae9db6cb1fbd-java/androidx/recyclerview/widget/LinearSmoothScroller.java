...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public void onTargetFound(View view, RecyclerView.State state, RecyclerView.SmoothScroller.Action action) {
        ...
        int i4 = 0;
        int i5 = (pointF == null || pointF.x == BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER) ? 0 : i3 > 0 ? 1 : -1;
        ...
        int i6 = (pointF2 == null || pointF2.y == BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER) ? 0 : i2 > 0 ? 1 : -1;
        ...
        int ceil = (int) Math.ceil(((double) calculateTimeForScrolling((int) Math.sqrt((double) ((i4 * i4) + (i * i))))) / 0.3356d);
        if (ceil > 0) {
