    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("FullSpanItem{mPosition=");
                outline17.append(this.mPosition);
                outline17.append(", mGapDir=");
                outline17.append(this.mGapDir);
                outline17.append(", mHasUnwantedGapAfter=");
                outline17.append(this.mHasUnwantedGapAfter);
                outline17.append(", mGapPerSpan=");
                outline17.append(Arrays.toString(this.mGapPerSpan));
                outline17.append('}');
