...
public abstract class Transition implements Cloneable {
    ...
    public String toString(String str) {
        ...
        outline17.append(ColorPropConverter.PREFIX_RESOURCE);
        outline17.append(Integer.toHexString(hashCode()));
        outline17.append(": ");
        String sb = outline17.toString();
        if (this.mDuration != -1) {
            StringBuilder outline19 = GeneratedOutlineSupport.outline19(sb, "dur(");
            outline19.append(this.mDuration);
            outline19.append(") ");
            sb = outline19.toString();
        }
        if (this.mStartDelay != -1) {
            StringBuilder outline192 = GeneratedOutlineSupport.outline19(sb, "dly(");
            outline192.append(this.mStartDelay);
            outline192.append(") ");
            sb = outline192.toString();
        }
        if (this.mInterpolator != null) {
            StringBuilder outline193 = GeneratedOutlineSupport.outline19(sb, "interp(");
            outline193.append(this.mInterpolator);
            outline193.append(") ");
            sb = outline193.toString();
        }
        if (this.mTargetIds.size() <= 0 && this.mTargets.size() <= 0) {
            return sb;
        }
        String outline10 = GeneratedOutlineSupport.outline10(sb, "tgts(");
        if (this.mTargetIds.size() > 0) {
            for (int i = 0; i < this.mTargetIds.size(); i++) {
                ...
                outline172.append(this.mTargetIds.get(i));
        ...
        if (this.mTargets.size() > 0) {
            for (int i2 = 0; i2 < this.mTargets.size(); i2++) {
                ...
                StringBuilder outline173 = GeneratedOutlineSupport.outline17(outline10);
                outline173.append(this.mTargets.get(i2));
                outline10 = outline173.toString();
            }
        }
        return GeneratedOutlineSupport.outline10(outline10, ")");
    }
}
