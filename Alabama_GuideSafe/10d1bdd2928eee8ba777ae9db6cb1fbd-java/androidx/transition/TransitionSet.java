...
public class TransitionSet extends Transition {
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder outline19 = GeneratedOutlineSupport.outline19(transition, "\n");
            outline19.append(this.mTransitions.get(i).toString(str + "  "));
            transition = outline19.toString();
        }
        return transition;
    }
