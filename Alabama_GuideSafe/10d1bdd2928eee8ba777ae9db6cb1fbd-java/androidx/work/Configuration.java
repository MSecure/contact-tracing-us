...
public final class Configuration {
    ...
    public final InputMergerFactory mInputMergerFactory = new InputMergerFactory() {
    ...
    public final DefaultRunnableScheduler mRunnableScheduler = new DefaultRunnableScheduler();
