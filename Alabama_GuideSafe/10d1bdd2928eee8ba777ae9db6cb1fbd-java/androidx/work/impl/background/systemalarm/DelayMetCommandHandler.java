...
public class DelayMetCommandHandler implements WorkConstraintsCallback, ExecutionListener, WorkTimer.TimeLimitExceededListener {
    ...
    public void onExecuted(String str, boolean z) {
        ...
        if (z) {
            ...
            systemAlarmDispatcher.mMainHandler.post(new SystemAlarmDispatcher.AddRunnable(systemAlarmDispatcher, createScheduleWorkIntent, this.mStartId));
        }
        if (this.mHasConstraints) {
            ...
            systemAlarmDispatcher2.mMainHandler.post(new SystemAlarmDispatcher.AddRunnable(systemAlarmDispatcher2, createConstraintsChangedIntent, this.mStartId));
        }
    }
    ...
    public final void stopWork() {
        synchronized (this.mLock) {
            if (this.mCurrentState < 2) {
                ...
                SystemAlarmDispatcher systemAlarmDispatcher = this.mDispatcher;
                systemAlarmDispatcher.mMainHandler.post(new SystemAlarmDispatcher.AddRunnable(this.mDispatcher, intent, this.mStartId));
                if (this.mDispatcher.mProcessor.isEnqueued(this.mWorkSpecId)) {
                    ...
                    Intent createScheduleWorkIntent = CommandHandler.createScheduleWorkIntent(this.mContext, this.mWorkSpecId);
                    SystemAlarmDispatcher systemAlarmDispatcher2 = this.mDispatcher;
                    systemAlarmDispatcher2.mMainHandler.post(new SystemAlarmDispatcher.AddRunnable(this.mDispatcher, createScheduleWorkIntent, this.mStartId));
                } else {
