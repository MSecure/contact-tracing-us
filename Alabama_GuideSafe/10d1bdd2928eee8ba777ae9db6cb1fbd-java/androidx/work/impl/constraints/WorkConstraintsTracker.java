    ...
    public boolean areAllConstraintsMet(String str) {
        synchronized (this.mLock) {
            ...
            for (ConstraintController<?> constraintController : constraintControllerArr) {
                OffsetDateTime offsetDateTime = (T) constraintController.mCurrentValue;
                if (offsetDateTime != null && constraintController.isConstrained(offsetDateTime) && constraintController.mMatchingWorkSpecIds.contains(str)) {
