...
public class WorkTimer {
    ...
    public final ThreadFactory mBackgroundThreadFactory = new ThreadFactory(this) {
        ...
        public Thread newThread(Runnable runnable) {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("WorkManager-WorkTimer-thread-");
            outline17.append(this.mThreadsCreated);
            newThread.setName(outline17.toString());
