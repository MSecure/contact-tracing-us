...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
    ...
    public String pendingToString() {
        ...
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("setFuture=[");
            ListenableFuture<? extends V> listenableFuture = ((SetFuture) obj).future;
            ...
            return GeneratedOutlineSupport.outline14(outline17, str, "]");
        } else if (!(this instanceof ScheduledFuture)) {
            return null;
        } else {
            StringBuilder outline172 = GeneratedOutlineSupport.outline17("remaining delay=[");
            outline172.append(((ScheduledFuture) this).getDelay(TimeUnit.MILLISECONDS));
            outline172.append(" ms]");
