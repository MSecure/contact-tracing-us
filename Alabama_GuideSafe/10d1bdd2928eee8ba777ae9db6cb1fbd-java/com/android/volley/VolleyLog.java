    ...
    public static String buildMessage(String str, Object... objArr) {
        ...
        while (true) {
            if (i >= stackTrace.length) {
                ...
                StringBuilder outline19 = GeneratedOutlineSupport.outline19(substring.substring(substring.lastIndexOf(36) + 1), ".");
                outline19.append(stackTrace[i].getMethodName());
                str2 = outline19.toString();
                break;
            } else {
                i++;
            }
