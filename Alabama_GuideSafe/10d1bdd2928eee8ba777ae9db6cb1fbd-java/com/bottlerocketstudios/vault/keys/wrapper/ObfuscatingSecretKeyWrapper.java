...
public class ObfuscatingSecretKeyWrapper implements SecretKeyWrapper {
    ...
    public final SecretKey getWrappingKey(Context context) {
        if (this.mWrappingKey == null) {
            ...
            try {
                this.mWrappingKey = new SecretKeySpec(MessageDigest.getInstance("SHA256").digest(AppCompatDelegateImpl.ConfigurationImplApi17.concatByteArrays(this.mPresharedSecret.getBytes(RNCWebViewManager.HTML_ENCODING), this.mSalt)), RNSCAes.KEY_ALGORITHM);
