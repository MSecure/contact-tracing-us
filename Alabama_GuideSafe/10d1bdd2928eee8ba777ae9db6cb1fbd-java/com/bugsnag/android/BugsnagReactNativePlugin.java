            ...
            if (obj != null) {
                ...
                if (client4 != null) {
                    ...
                    if (notifier != null) {
                        ...
                        List<Notifier> listOf = MoreExecutors.listOf(new Notifier(null, null, null, 7));
                                    ...
                                    if (obj17 != null) {
                                        ...
                                        if (obj33 != null) {
                                            ...
                                            if (obj37 != null) {
                                                ...
                                                ArrayList arrayList = new ArrayList(MoreExecutors.collectionSizeOrDefault(list, 10));
                                                ...
                                                if (obj39 != null) {
                                                    ...
                                                    ArrayList arrayList3 = new ArrayList(MoreExecutors.collectionSizeOrDefault(list3, 10));
                                                    ...
                                                    if (obj41 != null) {
                                                        ...
                                                        ArrayList arrayList5 = new ArrayList(MoreExecutors.collectionSizeOrDefault(list5, 10));
                                                        for (Map map6 : list5) {
            ...
            if (appSerializer2 != null) {
                ...
                if (internalHooks3 != null) {
                    ...
                    if (deviceSerializer2 != null) {
                        ...
                        linkedHashMap4.put("cpuAbi", strArr != null ? MoreExecutors.toList(strArr) : null);
                        ...
                        if (client2 != null) {
                            ...
                            if (internalHooks4 != null) {
                                ...
                                if (threadSendPolicy == ThreadSendPolicy.ALWAYS || (threadSendPolicy == ThreadSendPolicy.UNHANDLED_ONLY && z)) {
                                    ...
                                    if (keySet.size() <= 1) {
                                        ...
                                        if (size == 0) {
                                            ...
                                            list = MoreExecutors.listOf(keySet instanceof List ? ((List) keySet).get(0) : keySet.iterator().next());
                                        }
                                    } else {
                                        ...
                                        if (array != null) {
                                            ...
                                            list = MoreExecutors.asList(array);
                                        } else {
                                            throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<T>");
                                        }
                                    }
                                    ArrayList arrayList3 = new ArrayList(MoreExecutors.collectionSizeOrDefault(list, 10));
                                    ...
                                    iterable = CollectionsKt___CollectionsKt.toMutableList(arrayList3);
                                } else {
                                    linkedHashMap = linkedHashMap2;
                                    obj = "type";
                                    str = "null cannot be cast to non-null type java.lang.String";
                                ...
                                ArrayList arrayList4 = new ArrayList(MoreExecutors.collectionSizeOrDefault(iterable, 10));
                                for (Thread thread2 : iterable) {
                                    ...
                                    if (threadSerializer2 != null) {
                                        ...
                                        if (str2 != null) {
                                            ...
                                            ArrayList arrayList5 = new ArrayList(MoreExecutors.collectionSizeOrDefault(list2, 10));
                                            for (T t : list2) {
