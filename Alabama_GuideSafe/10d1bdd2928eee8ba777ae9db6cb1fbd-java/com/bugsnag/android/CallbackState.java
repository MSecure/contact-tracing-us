...
public final class CallbackState {
    ...
    public String toString() {
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("CallbackState(onErrorTasks=");
        outline17.append(this.onErrorTasks);
        outline17.append(", onBreadcrumbTasks=");
        outline17.append(this.onBreadcrumbTasks);
        outline17.append(", onSessionTasks=");
        outline17.append(this.onSessionTasks);
        outline17.append(")");
