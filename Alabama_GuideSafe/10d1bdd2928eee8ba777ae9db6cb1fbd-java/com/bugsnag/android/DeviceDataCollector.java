...
public final class DeviceDataCollector {
    ...
    public DeviceDataCollector(Connectivity connectivity2, Context context, Resources resources2, String str, DeviceBuildInfo deviceBuildInfo, File file, Logger logger2) {
        ...
        this.emulator = str4 != null && (MoreExecutors.startsWith$default(str4, "unknown", false, 2) || StringsKt__StringNumberConversionsKt.contains$default(str4, "generic", false, 2) || StringsKt__StringNumberConversionsKt.contains$default(str4, "vbox", false, 2));
        String str5 = this.buildInfo.tags;
        if (str5 == null || !StringsKt__StringNumberConversionsKt.contains$default(str5, "test-keys", false, 2)) {
            try {
    ...
    public final Device generateDevice() {
        return new Device(this.buildInfo, this.cpuAbi, Boolean.valueOf(this.rooted), this.installId, this.locale, Long.valueOf(calculateTotalMemory()), MoreExecutors.toMutableMap(this.runtimeVersions));
    }
    ...
    public final DeviceWithState generateDeviceWithState(long j) {
        ...
        Map mutableMap = MoreExecutors.toMutableMap(this.runtimeVersions);
