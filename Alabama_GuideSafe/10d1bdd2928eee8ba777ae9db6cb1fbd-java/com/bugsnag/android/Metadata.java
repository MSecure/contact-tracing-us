...
public final class Metadata implements JsonStream.Streamable {
    ...
    public static final Map<String, Object> mergeMaps$bugsnag_android_core_release(List<? extends Map<String, ? extends Object>> list) {
        ...
        while (it.hasNext()) {
            MoreExecutors.addAll(arrayList, it.next().keySet());
        }
            ...
            for (String str : set) {
                ...
                if (obj2 != null) {
                    if (!(obj instanceof Map) || !(obj2 instanceof Map)) {
                        ...
                        concurrentHashMap.put(str, mergeMaps$bugsnag_android_core_release(MoreExecutors.listOf((Object[]) new Map[]{(Map) obj, (Map) obj2})));
                    }
                } else if (obj != null) {
    ...
    public final Metadata copy() {
        Map mutableMap = MoreExecutors.toMutableMap(toMap());
    ...
    public String toString() {
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Metadata(store=");
        outline17.append(this.store);
        outline17.append(", jsonStreamer=");
        outline17.append(this.jsonStreamer);
        outline17.append(", redactedKeys=");
        outline17.append(this.redactedKeys);
        outline17.append(")");
    ...
    public void addMetadata(String str, String str2, Object obj) {
        ...
        if (obj2 != null) {
            ...
            if (TypeIntrinsics.isMutableMap(obj) && (!asMutableMap.isEmpty())) {
                obj = mergeMaps$bugsnag_android_core_release(MoreExecutors.listOf((Object[]) new Map[]{asMutableMap, (Map) obj}));
            }
