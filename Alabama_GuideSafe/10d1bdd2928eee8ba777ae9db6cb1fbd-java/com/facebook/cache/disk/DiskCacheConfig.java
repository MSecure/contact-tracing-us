...
public class DiskCacheConfig {
    ...
    public DiskCacheConfig(Builder builder, AnonymousClass1 r4) {
        ...
        AppCompatDelegateImpl.ConfigurationImplApi17.checkNotNull1(str);
        this.mBaseDirectoryName = str;
        Supplier<File> supplier = builder.mBaseDirectoryPathSupplier;
        AppCompatDelegateImpl.ConfigurationImplApi17.checkNotNull1(supplier);
        ...
        AppCompatDelegateImpl.ConfigurationImplApi17.checkNotNull1(entryEvictionComparatorSupplier);
