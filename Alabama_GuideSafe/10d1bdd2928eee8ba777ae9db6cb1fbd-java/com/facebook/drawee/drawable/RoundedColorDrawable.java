...
public class RoundedColorDrawable extends Drawable implements Rounded {
    ...
    public void draw(Canvas canvas) {
        this.mPaint.setColor(AppCompatDelegateImpl.ConfigurationImplApi17.multiplyColorAlpha(this.mColor, this.mAlpha));
        this.mPaint.setStyle(Paint.Style.FILL);
        this.mPaint.setFilterBitmap(this.mPaintFilterBitmap);
        canvas.drawPath(this.mPath, this.mPaint);
        if (this.mBorderWidth != BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER) {
            this.mPaint.setColor(AppCompatDelegateImpl.ConfigurationImplApi17.multiplyColorAlpha(this.mBorderColor, this.mAlpha));
    ...
    public int getOpacity() {
        int multiplyColorAlpha = AppCompatDelegateImpl.ConfigurationImplApi17.multiplyColorAlpha(this.mColor, this.mAlpha) >>> 24;
    ...
    public void setRadius(float f) {
        AppCompatDelegateImpl.ConfigurationImplApi17.checkArgument1(f >= BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, "radius should be non negative");
