...
public class ScaleTypeDrawable extends ForwardingDrawable {
    ...
    public void configureBounds() {
        ...
        if (intrinsicWidth <= 0 || intrinsicHeight <= 0) {
            ...
            ((ScalingUtils$AbstractScaleType) scalingUtils$ScaleType).getTransform(matrix, bounds, intrinsicWidth, intrinsicHeight, f, pointF2 != null ? pointF2.y : 0.5f);
    ...
    public void setScaleType(ScalingUtils$ScaleType scalingUtils$ScaleType) {
        if (!AppCompatDelegateImpl.ConfigurationImplApi17.equal(this.mScaleType, scalingUtils$ScaleType)) {
            this.mScaleType = scalingUtils$ScaleType;
