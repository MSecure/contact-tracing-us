    ...
    public Producer<Void> getEncodedImagePrefetchProducerSequence(ImageRequest imageRequest) {
        ...
        if (imageRequest != null) {
            ...
            if (i == 0) {
                ...
                Uri uri = imageRequest.mSourceUri;
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Unsupported uri scheme for encoded image fetch! Uri is: ");
                outline17.append(getShortenedUriString(uri));
