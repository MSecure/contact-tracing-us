    ...
    public void copy(int i, MemoryChunk memoryChunk, int i2, int i3) {
        if (memoryChunk != null) {
            if (memoryChunk.getUniqueId() == this.mId) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Copying from BufferMemoryChunk ");
                outline17.append(Long.toHexString(this.mId));
                outline17.append(" to BufferMemoryChunk ");
                outline17.append(Long.toHexString(memoryChunk.getUniqueId()));
                outline17.append(" which are the same ");
                Log.w("BufferMemoryChunk", outline17.toString());
