...
public class PoolConfig {
    ...
    public PoolConfig(Builder builder, AnonymousClass1 r14) {
        ...
        sparseIntArray2.put(AsyncTimeout.TIMEOUT_WRITE_SIZE, 5);
        sparseIntArray2.put(131072, 5);
        sparseIntArray2.put(Http1ExchangeCodec.HEADER_LIMIT, 2);
        ...
        this.mBitmapPoolMaxPoolSize = 0;
        this.mBitmapPoolMaxBitmapSize = 4194304;
        this.mRegisterLruBitmapPoolAsMemoryTrimmable = false;
        FrescoSystrace.isTracing();
    }
}
