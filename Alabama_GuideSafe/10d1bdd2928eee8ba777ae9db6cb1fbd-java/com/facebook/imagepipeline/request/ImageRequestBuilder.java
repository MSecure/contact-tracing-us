...
public class ImageRequestBuilder {
    ...
    public boolean mProgressiveRenderingEnabled = ImagePipelineConfig.sDefaultImageRequestConfig.mProgressiveRenderingEnabled;
    ...
    public static class BuilderException extends RuntimeException {
        public BuilderException(String str) {
            super(GeneratedOutlineSupport.outline10("Invalid request builder: ", str));
        }
    }
