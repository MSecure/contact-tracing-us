...
public class ReactDelegate {
    ...
    public void onHostPause() {
        if (this.mReactNativeHost.hasInstance()) {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Pausing an activity that is not the current activity, this is incorrect! Current activity: ");
            outline17.append(reactInstanceManager.mCurrentActivity.getClass().getSimpleName());
            outline17.append(" Paused activity: ");
            outline17.append(activity.getClass().getSimpleName());
            AppCompatDelegateImpl.ConfigurationImplApi17.assertCondition(z, outline17.toString());
            UiThreadUtil.assertOnUiThread();
