    ...
    public void startAnimatingNode(int i, int i2, ReadableMap readableMap, Callback callback) {
        ...
        if (animatedNode == null) {
            ...
            if ("frames".equals(string)) {
                ...
                throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("Unsupported animation type: ", string));
            }
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Animated node should be of type ");
