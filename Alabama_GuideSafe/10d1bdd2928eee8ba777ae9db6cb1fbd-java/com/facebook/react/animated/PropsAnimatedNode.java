                ...
                if (nodeById == null) {
                    ...
                    for (Map.Entry<String, Integer> entry2 : styleAnimatedNode.mPropMapping.entrySet()) {
                        ...
                        if (nodeById2 == null) {
                            ...
                            for (TransformAnimatedNode.TransformConfig transformConfig : transformAnimatedNode.mTransformConfigs) {
                                if (transformConfig instanceof TransformAnimatedNode.AnimatedTransformConfig) {
                                    ...
                                    if (nodeById3 == null) {
                                        ...
                                        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Unsupported type of node used as a transform child node ");
                                        outline17.append(nodeById3.getClass());
                            ...
                            StringBuilder outline172 = GeneratedOutlineSupport.outline17("Unsupported type of node used in property node ");
                            outline172.append(nodeById2.getClass());
                    ...
                    StringBuilder outline173 = GeneratedOutlineSupport.outline17("Unsupported type of node used in property node ");
                    outline173.append(nodeById.getClass());
