...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public static class Builder {
        ...
        public CatalystInstanceImpl build() {
            ...
            AppCompatDelegateImpl.ConfigurationImplApi17.assertNotNull(reactQueueConfigurationSpec);
            ...
            AppCompatDelegateImpl.ConfigurationImplApi17.assertNotNull(javaScriptExecutor);
            JavaScriptExecutor javaScriptExecutor2 = javaScriptExecutor;
            NativeModuleRegistry nativeModuleRegistry = this.mRegistry;
            AppCompatDelegateImpl.ConfigurationImplApi17.assertNotNull(nativeModuleRegistry);
            ...
            AppCompatDelegateImpl.ConfigurationImplApi17.assertNotNull(nativeModuleCallExceptionHandler);
    ...
    public static class PendingJSCall {
        ...
        public String toString() {
            ...
            return GeneratedOutlineSupport.outline14(sb, str, ")");
        }
    }
    ...
    private <T extends NativeModule> String getNameFromAnnotation(Class<T> cls) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Could not find @ReactModule annotation in ");
        outline17.append(cls.getCanonicalName());
    ...
    private void onNativeException(Exception exc) {
        FLog.e("ReactNative", "CatalystInstanceImpl caught native exception", exc);
            ...
            while (true) {
                if (!this.mNativeModulesThreadDestructionComplete || !this.mJSThreadDestructionComplete) {
                    if (System.currentTimeMillis() - currentTimeMillis > 100) {
                        FLog.w("ReactNative", "CatalystInstanceImpl.destroy() timed out waiting for Native Modules and JS thread teardown");
                        break;
                    }
                } else {
                    break;
    ...
    public void initialize() {
        ...
        AppCompatDelegateImpl.ConfigurationImplApi17.assertCondition(!this.mInitialized, "This catalyst instance has already been initialized");
        AppCompatDelegateImpl.ConfigurationImplApi17.assertCondition(this.mAcceptCalls, "RunJSBundle hasn't completed.");
    ...
    public void runJSBundle() {
        ...
        AppCompatDelegateImpl.ConfigurationImplApi17.assertCondition(!this.mJSBundleHasLoaded, "JS bundle was already loaded!");
    ...
    public CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, NativeModuleCallExceptionHandler nativeModuleCallExceptionHandler) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("pending_js_calls_instance");
        outline17.append(sNextInstanceIdForTrace.getAndIncrement());
        this.mJsPendingCallsTitleForTrace = outline17.toString();
    ...
    public NativeModule getNativeModule(String str) {
        if (getTurboModuleRegistry() != null) {
            ...
            StringBuilder outline19 = GeneratedOutlineSupport.outline19("CatalystInstanceImpl.getNativeModule: TurboModule ", str);
            outline19.append(module == null ? " not" : "");
            outline19.append(" found");
            FLog.e("ReactNative", outline19.toString());
            if (module != null) {
