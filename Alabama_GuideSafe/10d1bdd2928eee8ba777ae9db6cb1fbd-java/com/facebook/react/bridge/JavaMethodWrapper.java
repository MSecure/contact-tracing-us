...
public class JavaMethodWrapper implements NativeModule.NativeMethod {
    ...
    private ArgumentExtractor[] buildArgumentExtractors(Class[] clsArr) {
        ...
        for (int i = 0; i < clsArr.length; i += argumentExtractorArr[i].getJSArgumentsNeeded()) {
            ...
            if (cls == Boolean.class || cls == Boolean.TYPE) {
                ...
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Got unknown argument class: ");
    ...
    private String getAffectedRange(int i, int i2) {
        if (i2 <= 1) {
            return GeneratedOutlineSupport.outline5("", i);
        }
        StringBuilder outline18 = GeneratedOutlineSupport.outline18("", i, "-");
        outline18.append((i + i2) - 1);
    ...
    public static char paramTypeToChar(Class cls) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Got unknown param class: ");
        outline17.append(cls.getSimpleName());
        throw new RuntimeException(outline17.toString());
    }
    ...
    public static char returnTypeToChar(Class cls) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Got unknown return class: ");
        outline17.append(cls.getSimpleName());
        throw new RuntimeException(outline17.toString());
    }
