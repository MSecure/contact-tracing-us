...
public class ModuleSpec {
    ...
    public static ModuleSpec nativeModuleSpec(Class<? extends NativeModule> cls, Provider<? extends NativeModule> provider) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Could not find @ReactModule annotation on ");
        outline17.append(cls.getName());
        outline17.append(". So creating the module eagerly to get the name. Consider adding an annotation to make this Lazy");
        FLog.w(TAG, outline17.toString());
