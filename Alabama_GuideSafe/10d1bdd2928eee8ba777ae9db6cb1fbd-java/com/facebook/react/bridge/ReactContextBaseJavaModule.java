...
public abstract class ReactContextBaseJavaModule extends BaseJavaModule {
    ...
    public final ReactApplicationContext getReactApplicationContextIfActiveOrWarn() {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Catalyst Instance has already disappeared: requested by ");
        outline17.append(getName());
        ReactSoftException.logSoftException("ReactContextBaseJavaModule", new RuntimeException(outline17.toString()));
        return null;
    }
