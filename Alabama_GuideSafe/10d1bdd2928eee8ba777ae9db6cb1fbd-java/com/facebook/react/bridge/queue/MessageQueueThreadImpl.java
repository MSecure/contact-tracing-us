...
public class MessageQueueThreadImpl implements MessageQueueThread {
    ...
    public static MessageQueueThreadImpl create(MessageQueueThreadSpec messageQueueThreadSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Unknown thread type: ");
        outline17.append(messageQueueThreadSpec.getThreadType());
    ...
    public static MessageQueueThreadImpl startNewBackgroundThread(String str, long j, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        ...
        }, GeneratedOutlineSupport.outline10("mqt_", str), j).start();
        try {
    ...
    public void quitSynchronous() {
        ...
        if (this.mLooper.getThread() != Thread.currentThread()) {
            try {
                ...
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Got interrupted waiting to join thread ");
    ...
    public void runOnQueue(Runnable runnable) {
        if (this.mIsFinished) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Tried to enqueue runnable on already finished thread: '");
            outline17.append(getName());
            outline17.append("... dropping Runnable.");
    ...
    public MessageQueueThreadImpl(String str, Looper looper, QueueThreadExceptionHandler queueThreadExceptionHandler, MessageQueueThreadPerfStats messageQueueThreadPerfStats) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Expected to be called from the '");
        outline17.append(getName());
        outline17.append("' thread!");
        this.mAssertionErrorMessage = outline17.toString();
    }
