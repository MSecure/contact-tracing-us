...
public class ReactQueueConfigurationSpec {
    ...
    public static class Builder {
        ...
        public ReactQueueConfigurationSpec build() {
            ...
            AppCompatDelegateImpl.ConfigurationImplApi17.assertNotNull(messageQueueThreadSpec);
            MessageQueueThreadSpec messageQueueThreadSpec2 = this.mJSQueueSpec;
            AppCompatDelegateImpl.ConfigurationImplApi17.assertNotNull(messageQueueThreadSpec2);
        ...
        public Builder setJSQueueThreadSpec(MessageQueueThreadSpec messageQueueThreadSpec) {
            AppCompatDelegateImpl.ConfigurationImplApi17.assertCondition(this.mJSQueueSpec == null, "Setting JS queue multiple times!");
        ...
        public Builder setNativeModulesQueueThreadSpec(MessageQueueThreadSpec messageQueueThreadSpec) {
            AppCompatDelegateImpl.ConfigurationImplApi17.assertCondition(this.mNativeModulesQueueSpec == null, "Setting native modules queue spec multiple times!");
