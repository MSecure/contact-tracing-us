    ...
    public void showForUrl(String str) {
        ...
        if (context != null) {
            try {
                ...
                showMessage(context.getString(i, url.getHost() + ColorPropConverter.PACKAGE_DELIMITER + url.getPort()));
            } catch (MalformedURLException e) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Bundle url format is invalid. \n\n");
