...
public class DevServerHelper {
    ...
    private String getHostForJSProxy() {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("localhost");
        outline17.append(str.substring(lastIndexOf));
    ...
    public void isPackagerRunning(final PackagerStatusCallback packagerStatusCallback) {
        this.mClient.newCall(new Request.Builder().url(createPackagerStatusURL(this.mSettings.getPackagerConnectionSettings().getDebugServerHost())).build()).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException iOException) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("The packager does not seem to be running as we got an IOException requesting its status: ");
                outline17.append(iOException.getMessage());
            ...
            public void onResponse(Call call, Response response) throws IOException {
                if (!response.isSuccessful()) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("Got non-success http code from packager when requesting status: ");
    ...
    public void openStackFrameCall(StackFrame stackFrame) {
        ...
        newCall.enqueue(new Callback() {
            ...
            @Override // okhttp3.Callback
            public void onFailure(Call call, IOException iOException) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Got IOException when attempting to open stack frame: ");
                outline17.append(iOException.getMessage());
                FLog.w("ReactNative", outline17.toString());
            }
    ...
    public void symbolicateStackTrace(Iterable<StackFrame> iterable, final SymbolicationListener symbolicationListener) {
        try {
            ...
            newCall.enqueue(new Callback() {
                ...
                @Override // okhttp3.Callback
                public void onFailure(Call call, IOException iOException) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("Got IOException when attempting symbolicate stack trace: ");
                    outline17.append(iOException.getMessage());
                    FLog.w("ReactNative", outline17.toString());
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Got JSONException when attempting symbolicate stack trace: ");
