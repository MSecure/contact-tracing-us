                ...
                if (16.666666f - ((float) uptimeMillis) >= 1.0f) {
                    ...
                    if (z) {
                        ...
                        if (reactApplicationContext != null) {
                            ((JSTimers) reactApplicationContext.getJSModule(JSTimers.class)).callIdleCallbacks(d);
                        }
                    }
                ...
                synchronized (JavaTimerManager.this.mIdleCallbackGuard) {
                    if (z) {
                        ...
                        if (!javaTimerManager.mFrameIdleCallbackPosted) {
                            javaTimerManager.mReactChoreographer.postFrameCallback(callbackType, javaTimerManager.mIdleFrameCallback);
                            javaTimerManager.mFrameIdleCallbackPosted = true;
                        }
                    } else {
                        JavaTimerManager javaTimerManager2 = JavaTimerManager.this;
                        if (javaTimerManager2.mFrameIdleCallbackPosted) {
                            javaTimerManager2.mReactChoreographer.removeFrameCallback(callbackType, javaTimerManager2.mIdleFrameCallback);
