        ...
        if (i2 > 0) {
            for (int i4 = 0; i4 < i - i2; i4++) {
                ...
                if (i4 < longArray.mLength) {
                    ...
                    StringBuilder outline18 = GeneratedOutlineSupport.outline18("", i4, " >= ");
                    outline18.append(longArray.mLength);
            ...
            StringBuilder outline182 = GeneratedOutlineSupport.outline18("Trying to drop ", i2, " items from array of length ");
            outline182.append(longArray.mLength);
            throw new IndexOutOfBoundsException(outline182.toString());
        }
    }
