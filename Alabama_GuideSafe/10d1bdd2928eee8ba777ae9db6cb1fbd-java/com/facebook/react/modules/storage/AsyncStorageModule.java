...
public final class AsyncStorageModule extends NativeAsyncStorageSpec {
        ...
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void[] voidArr) {
                ...
                try {
                    ...
                    callback.invoke(AppCompatDelegateImpl.ConfigurationImplApi17.getError(null, e.getMessage()));
                }
            }
        ...
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void[] voidArr) {
                if (!AsyncStorageModule.this.ensureDatabase()) {
                    callback.invoke(AppCompatDelegateImpl.ConfigurationImplApi17.getDBError(null), null);
                    return;
                }
                ...
                try {
                    ...
                    FLog.w("ReactNative", e.getMessage(), e);
                    callback.invoke(AppCompatDelegateImpl.ConfigurationImplApi17.getError(null, e.getMessage()), null);
                    query.close();
                } catch (Throwable th) {
                    query.close();
                    throw th;
    ...
    public void multiGet(final ReadableArray readableArray, final Callback callback) {
        if (readableArray == null) {
            callback.invoke(AppCompatDelegateImpl.ConfigurationImplApi17.getInvalidKeyError(null), null);
            return;
        }
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void[] voidArr) {
                ...
                for (int i = 0; i < readableArray.size(); i += 999) {
                    ...
                    String buildKeySelection = AppCompatDelegateImpl.ConfigurationImplApi17.buildKeySelection(min);
    ...
    public void multiMerge(final ReadableArray readableArray, final Callback callback) {
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void[] voidArr) {
                ...
                if (!AsyncStorageModule.this.ensureDatabase()) {
                    callback.invoke(AppCompatDelegateImpl.ConfigurationImplApi17.getDBError(null));
                    return;
                }
                try {
                    ...
                    for (int i = 0; i < readableArray.size(); i++) {
                        if (readableArray.getArray(i).size() != 2) {
                            AppCompatDelegateImpl.ConfigurationImplApi17.getInvalidValueError(null);
                            try {
                            ...
                            AppCompatDelegateImpl.ConfigurationImplApi17.getInvalidKeyError(null);
                            AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                            return;
                            ...
                            AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                            return;
                        } else if (!AppCompatDelegateImpl.ConfigurationImplApi17.mergeImpl(AsyncStorageModule.this.mReactDatabaseSupplier.get(), readableArray.getArray(i).getString(0), readableArray.getArray(i).getString(1))) {
                            AppCompatDelegateImpl.ConfigurationImplApi17.getDBError(null);
                            AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                            return;
                        }
                    }
                    ...
                    try {
                        ...
                        writableMap = AppCompatDelegateImpl.ConfigurationImplApi17.getError(null, e2.getMessage());
                    }
                } catch (Exception e3) {
                    FLog.w("ReactNative", e3.getMessage(), e3);
                    writableMap = AppCompatDelegateImpl.ConfigurationImplApi17.getError(null, e3.getMessage());
                    try {
                        AsyncStorageModule.this.mReactDatabaseSupplier.get().endTransaction();
                    } catch (Exception e4) {
                    ...
                    try {
                        ...
                        AppCompatDelegateImpl.ConfigurationImplApi17.getError(null, e5.getMessage());
                    }
                    throw th;
                }
                if (writableMap != null) {
    ...
    public void multiRemove(final ReadableArray readableArray, final Callback callback) {
        if (readableArray.size() == 0) {
            callback.invoke(AppCompatDelegateImpl.ConfigurationImplApi17.getInvalidKeyError(null));
            return;
        }
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void[] voidArr) {
                ...
                try {
                    ...
                    try {
                        ...
                        FLog.w("ReactNative", e.getMessage(), e);
                        writableMap = AppCompatDelegateImpl.ConfigurationImplApi17.getError(null, e.getMessage());
                    }
                } catch (Exception e2) {
                    FLog.w("ReactNative", e2.getMessage(), e2);
                    writableMap = AppCompatDelegateImpl.ConfigurationImplApi17.getError(null, e2.getMessage());
                    ...
                    try {
                        ...
                        FLog.w("ReactNative", e4.getMessage(), e4);
                        AppCompatDelegateImpl.ConfigurationImplApi17.getError(null, e4.getMessage());
                    }
                    throw th;
                }
                if (writableMap != null) {
