    ...
    public final void reconnect() {
        if (!this.mClosed) {
            if (!this.mSuppressConnectionErrors) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Couldn't connect to \"");
                outline17.append(this.mUrl);
                outline17.append("\", will silently retry");
                FLog.w("ReconnectingWebSocket", outline17.toString());
