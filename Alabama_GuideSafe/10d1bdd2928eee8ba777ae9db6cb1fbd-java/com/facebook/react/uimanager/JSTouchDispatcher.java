    ...
    public void handleTouchEvent(MotionEvent motionEvent, EventDispatcher eventDispatcher) {
        ...
        if (action == 0) {
            ...
            if (i == -1) {
                ...
                StringBuilder outline18 = GeneratedOutlineSupport.outline18("Warning : touch event was ignored. Action=", action, " Target=");
                outline18.append(this.mTargetTag);
                FLog.w("ReactNative", outline18.toString());
            }
        }
    }
}
