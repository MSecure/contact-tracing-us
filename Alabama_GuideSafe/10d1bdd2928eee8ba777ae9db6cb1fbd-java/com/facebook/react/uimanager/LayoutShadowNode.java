        ...
        public void setFromDynamic(Dynamic dynamic) {
            if (dynamic.isNull()) {
                ...
                if (asString.equals("auto")) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Unknown value: ", asString));
                }
            } else {
        ...
        if (!isVirtual()) {
            ...
            switch (c) {
                ...
                case 7:
                    ...
                    return;
                default:
                    throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("invalid value for alignContent: ", str));
            }
        }
    }
        ...
        if (!isVirtual()) {
            ...
            switch (c) {
                ...
                case 7:
                    ...
                    return;
                default:
                    throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("invalid value for alignItems: ", str));
            }
        }
    }
        ...
        if (!isVirtual()) {
            ...
            switch (c) {
                ...
                case 7:
                    ...
                    return;
                default:
                    throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("invalid value for alignSelf: ", str));
            }
        }
    }
    ...
    public void setDisplay(String str) {
        ...
        if (!isVirtual()) {
            ...
            if (c == 0) {
                ...
                throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("invalid value for display: ", str));
            }
        }
    }
    ...
    public void setFlexDirection(String str) {
        ...
        if (!isVirtual()) {
            ...
            if (c == 0) {
                ...
                throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("invalid value for flexDirection: ", str));
            }
        }
    }
    ...
    public void setFlexWrap(String str) {
        ...
        if (!isVirtual()) {
            ...
            if (c == 0) {
                ...
                throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("invalid value for flexWrap: ", str));
            }
        }
    }
    ...
    public void setJustifyContent(String str) {
        ...
        if (!isVirtual()) {
            ...
            if (c == 0) {
                ...
                throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("invalid value for justifyContent: ", str));
            }
        }
    }
    ...
    public void setOverflow(String str) {
        ...
        if (!isVirtual()) {
            ...
            if (c == 0) {
                ...
                throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("invalid value for overflow: ", str));
            }
        }
    }
    ...
    public void setPosition(String str) {
        ...
        if (!isVirtual()) {
            ...
            if (c == 0) {
                ...
                throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("invalid value for position: ", str));
            }
        }
    }
