...
public class NativeViewHierarchyManager {
    ...
    public static String constructManageChildrenErrorMessage(ViewGroup viewGroup, ViewGroupManager viewGroupManager, int[] iArr, ViewAtIndex[] viewAtIndexArr, int[] iArr2) {
        ...
        if (viewGroup != null) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("View tag:");
            outline17.append(viewGroup.getId());
            outline17.append("\n");
        ...
        if (iArr != null) {
            StringBuilder outline172 = GeneratedOutlineSupport.outline17("  indicesToRemove(");
            outline172.append(iArr.length);
            outline172.append("): [\n");
        ...
        if (viewAtIndexArr != null) {
            StringBuilder outline173 = GeneratedOutlineSupport.outline17("  viewsToAdd(");
            outline173.append(viewAtIndexArr.length);
            outline173.append("): [\n");
            ...
            for (int i7 = 0; i7 < viewAtIndexArr.length; i7 += 16) {
                ...
                while (true) {
                    ...
                    if (i9 >= viewAtIndexArr.length || i8 >= 16) {
                        ...
                        outline174.append(viewAtIndexArr[i9].mIndex);
                        outline174.append(",");
                        outline174.append(viewAtIndexArr[i9].mTag);
                        outline174.append("],");
        ...
        if (iArr2 != null) {
            StringBuilder outline175 = GeneratedOutlineSupport.outline17("  tagsToDelete(");
            outline175.append(iArr2.length);
            outline175.append("): [\n");
