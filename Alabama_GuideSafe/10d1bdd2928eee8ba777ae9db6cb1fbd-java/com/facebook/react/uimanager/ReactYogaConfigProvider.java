...
public class ReactYogaConfigProvider {
    ...
    public static <TResult> TResult await(Task<TResult> task) throws ExecutionException, InterruptedException {
        ...
        task.addOnSuccessListener(TaskExecutors.zza, tasks$zzb);
        task.addOnFailureListener(TaskExecutors.zza, tasks$zzb);
        task.addOnCanceledListener(TaskExecutors.zza, tasks$zzb);
        tasks$zzb.zza.await();
        return (TResult) zza(task);
    }
    ...
    public static void invokeJniOnload(String str) {
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Unknown library: ", str));
    }
    ...
    public static int parseOverScrollMode(String str) {
        ...
        throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("wrong overScrollMode: ", str));
    }
    ...
    public static ScalingUtils$ScaleType toScaleType(String str) {
        ...
        throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline11("Invalid resize mode: '", str, "'"));
    }
