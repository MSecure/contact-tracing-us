...
public class UIImplementation {
    ...
    public final void assertNodeDoesNotNeedCustomLayoutForChildren(ReactShadowNode reactShadowNode) {
        ...
        if (!(viewManager2 instanceof IViewManagerWithChildren)) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Trying to use view ");
            outline17.append(reactShadowNode.getViewClass());
            outline17.append(" as a parent, but its Manager doesn't extends ViewGroupManager");
            throw new IllegalViewOperationException(outline17.toString());
        } else if (((IViewManagerWithChildren) viewManager2).needsCustomLayoutForChildren()) {
            StringBuilder outline172 = GeneratedOutlineSupport.outline17("Trying to measure a view using measureLayout/measureLayoutRelativeToParent relative to an ancestor that requires custom layout for it's children (");
            outline172.append(reactShadowNode.getViewClass());
            outline172.append("). Use measure instead.");
            throw new IllegalViewOperationException(outline172.toString());
        }
    }
    ...
    public final void measureLayout(int i, int i2, int[] iArr) {
        ...
        if (reactShadowNode == null || reactShadowNode2 == null) {
            ...
            throw new IllegalViewOperationException(GeneratedOutlineSupport.outline13(outline17, i, " does not exist"));
        }
    ...
    public final void measureLayoutRelativeToParent(int i, int[] iArr) {
        ...
        if (reactShadowNode != null) {
            ...
            throw new IllegalViewOperationException(GeneratedOutlineSupport.outline6("View with tag ", i, " doesn't have a parent!"));
        }
        throw new IllegalViewOperationException(GeneratedOutlineSupport.outline6("No native view for tag ", i, " exists!"));
    }
    ...
    public final void removeShadowNodeRecursive(ReactShadowNode reactShadowNode) {
        ...
        if (!shadowNodeRegistry.mRootTags.get(reactTag)) {
            ...
            throw new IllegalViewOperationException(GeneratedOutlineSupport.outline6("Trying to remove root node ", reactTag, " without using removeRootNode!"));
        }
    }
