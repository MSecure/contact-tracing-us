...
public class ViewManagerPropertyUpdater {
        ...
        public void setProperty(ReactShadowNode reactShadowNode, String str, Object obj) {
            ...
            if (propSetter != null) {
                try {
                    ...
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("Error while updating prop ");
                    outline17.append(propSetter.mPropName);
                    FLog.e(ViewManager.class, outline17.toString(), th);
                    StringBuilder outline172 = GeneratedOutlineSupport.outline17("Error while updating property '");
                    outline172.append(propSetter.mPropName);
                    outline172.append("' in shadow node of type: ");
                    outline172.append(reactShadowNode.getViewClass());
                    throw new JSApplicationIllegalArgumentException(outline172.toString(), th);
                }
            }
        }
    }
        ...
        public void setProperty(T t, V v, String str, Object obj) {
            ...
            if (propSetter != null) {
                try {
                    ...
                    StringBuilder outline172 = GeneratedOutlineSupport.outline17("Error while updating property '");
                    outline172.append(propSetter.mPropName);
                    outline172.append("' of a view managed by: ");
                    outline172.append(t.getName());
                    throw new JSApplicationIllegalArgumentException(outline172.toString(), th);
                }
            }
        }
    ...
    public static <T> T findGeneratedSetter(Class<?> cls) {
        ...
        try {
            ...
            throw new RuntimeException(GeneratedOutlineSupport.outline10("Unable to instantiate methods getter for ", name), e);
        }
    }
