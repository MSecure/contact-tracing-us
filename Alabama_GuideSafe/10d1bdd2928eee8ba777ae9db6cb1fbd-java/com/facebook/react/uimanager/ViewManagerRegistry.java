...
public final class ViewManagerRegistry {
    ...
    public ViewManager get(String str) {
        ...
        if (this.mViewManagerResolver != null) {
            ...
            throw new IllegalViewOperationException(GeneratedOutlineSupport.outline10("ViewManagerResolver returned null for ", str));
        }
        throw new IllegalViewOperationException(GeneratedOutlineSupport.outline10("No ViewManager found for class ", str));
    }
