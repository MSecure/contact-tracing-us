...
public class TouchEvent extends Event<TouchEvent> {
    ...
    public static TouchEvent obtain(int i, TouchEventType touchEventType, MotionEvent motionEvent, long j, float f, float f2, TouchEventCoalescingKeyHelper touchEventCoalescingKeyHelper) {
        ...
        if (action == 0) {
            ...
            throw new RuntimeException(GeneratedOutlineSupport.outline5("Unhandled MotionEvent action: ", action));
        }
    ...
    public boolean canCoalesce() {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Unknown touch event type: ");
        outline17.append(this.mTouchEventType);
