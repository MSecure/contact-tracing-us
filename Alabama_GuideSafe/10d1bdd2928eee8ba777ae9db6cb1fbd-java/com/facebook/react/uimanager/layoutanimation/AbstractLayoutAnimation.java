    ...
    public void initializeFromConfig(ReadableMap readableMap, int i) {
        ...
        if (readableMap.hasKey("property")) {
            ...
            if (!z) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Unsupported animated property: ", string));
            }
        } else {
        ...
        if (readableMap.hasKey("type")) {
            ...
            if (c == 0) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Unsupported interpolation type : ", string2));
            }
