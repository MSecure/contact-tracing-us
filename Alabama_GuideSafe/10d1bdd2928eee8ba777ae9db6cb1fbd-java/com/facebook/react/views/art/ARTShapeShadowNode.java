...
public class ARTShapeShadowNode extends ARTVirtualNode {
            ...
            if (i5 != 0) {
                ...
                if (i5 == 1) {
                    ...
                    if (i5 == 3) {
                        ...
                        throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline5("Unrecognized drawing instruction ", i5));
                    }
                    i3 = i2;
                } else {
                    int i16 = i4 + 1;
    ...
    public boolean setupFillPaint(Paint paint, float f) {
        ...
        if (i2 == 0) {
            ...
            int i3 = 5;
            if (fArr3.length < 5) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("[ARTShapeShadowNode setupFillPaint] expects 5 elements, received ");
                outline17.append(this.mBrushData.length);
    ...
    public boolean setupStrokePaint(Paint paint, float f) {
        ...
        if (i == 0) {
            ...
            throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline13(GeneratedOutlineSupport.outline17("strokeCap "), this.mStrokeCap, " unrecognized"));
        }
        ...
        if (i2 == 0) {
            ...
            throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline13(GeneratedOutlineSupport.outline17("strokeJoin "), this.mStrokeJoin, " unrecognized"));
        }
