...
public class ImageLoadEvent extends Event<ImageLoadEvent> {
    ...
    public static String eventNameForType(int i) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Invalid image event: ");
        outline17.append(Integer.toString(i));
    ...
    public void dispatch(RCTEventEmitter rCTEventEmitter) {
        ...
        if (this.mImageUri != null || (i = this.mEventType) == 2 || i == 1) {
            ...
            if (str != null) {
                writableMap.putString(NetworkingModule.REQUEST_BODY_KEY_URI, str);
            }
            int i2 = this.mEventType;
            if (i2 == 2) {
                WritableMap createMap = Arguments.createMap();
                createMap.putDouble(RNGestureHandlerModule.KEY_HIT_SLOP_WIDTH, (double) this.mWidth);
                createMap.putDouble(RNGestureHandlerModule.KEY_HIT_SLOP_HEIGHT, (double) this.mHeight);
