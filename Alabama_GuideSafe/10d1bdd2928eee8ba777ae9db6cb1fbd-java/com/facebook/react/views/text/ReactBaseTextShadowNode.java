...
public abstract class ReactBaseTextShadowNode extends LayoutShadowNode {
            ...
            if (childAt instanceof ReactRawTextShadowNode) {
                ...
                if (childAt instanceof ReactTextInlineImageShadowNode) {
                    ...
                    if (z) {
                        ...
                        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Unexpected view type nested under a <Text> or <TextInput> node: ");
                        outline17.append(childAt.getClass());
    ...
    public void setTextTransform(String str) {
        if (str == null) {
            ...
            throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("Invalid textTransform: ", str));
        }
        markUpdated();
    }
