...
public class TextAttributeProps {
    ...
    public TextAttributeProps(ReactStylesDiffMap reactStylesDiffMap) {
        ...
        if (stringProp4 == null || "none".equals(stringProp4)) {
            ...
            throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("Invalid textTransform: ", stringProp4));
        }
    }
    ...
    public static int getTextAlignment(ReactStylesDiffMap reactStylesDiffMap) {
        ...
        throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("Invalid textAlign: ", string));
    }
    ...
    public float getLetterSpacing() {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("FontSize should be a positive value. Current value: ");
