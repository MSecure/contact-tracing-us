...
public class ReactViewManager extends ReactClippingViewManager<ReactViewGroup> {
    ...
    private void handleHotspotUpdate(ReactViewGroup reactViewGroup, ReadableArray readableArray) {
        ...
        reactViewGroup.drawableHotspotChanged(AppCompatDelegateImpl.ConfigurationImplApi17.toPixelFromDIP(readableArray.getDouble(0)), AppCompatDelegateImpl.ConfigurationImplApi17.toPixelFromDIP(readableArray.getDouble(1)));
    }
    ...
    public Map<String, Integer> getCommandsMap() {
        return AppCompatDelegateImpl.ConfigurationImplApi17.of(HOTSPOT_UPDATE_KEY, 1, "setPressed", 2);
    }
    ...
    public void setFocusable(final ReactViewGroup reactViewGroup, boolean z) {
        if (z) {
            reactViewGroup.setOnClickListener(new View.OnClickListener(this) {
    ...
    public void setHitSlop(ReactViewGroup reactViewGroup, ReadableMap readableMap) {
        ...
        int i = 0;
        int pixelFromDIP = readableMap.hasKey(RNGestureHandlerModule.KEY_HIT_SLOP_LEFT) ? (int) AppCompatDelegateImpl.ConfigurationImplApi17.toPixelFromDIP(readableMap.getDouble(RNGestureHandlerModule.KEY_HIT_SLOP_LEFT)) : 0;
        int pixelFromDIP2 = readableMap.hasKey(RNGestureHandlerModule.KEY_HIT_SLOP_TOP) ? (int) AppCompatDelegateImpl.ConfigurationImplApi17.toPixelFromDIP(readableMap.getDouble(RNGestureHandlerModule.KEY_HIT_SLOP_TOP)) : 0;
        int pixelFromDIP3 = readableMap.hasKey(RNGestureHandlerModule.KEY_HIT_SLOP_RIGHT) ? (int) AppCompatDelegateImpl.ConfigurationImplApi17.toPixelFromDIP(readableMap.getDouble(RNGestureHandlerModule.KEY_HIT_SLOP_RIGHT)) : 0;
        if (readableMap.hasKey(RNGestureHandlerModule.KEY_HIT_SLOP_BOTTOM)) {
            i = (int) AppCompatDelegateImpl.ConfigurationImplApi17.toPixelFromDIP(readableMap.getDouble(RNGestureHandlerModule.KEY_HIT_SLOP_BOTTOM));
        }
