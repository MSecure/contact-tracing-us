...
public abstract class UnpackingSoSource extends DirectorySoSource {
    ...
    public final void deleteUnmentionedFiles(Dso[] dsoArr) throws IOException {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("unable to list directory ");
        outline17.append(this.soDirectory);
    ...
    public final void extractDso(InputDso inputDso, byte[] bArr) throws IOException {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("extracting DSO ");
        outline17.append(inputDso.dso.name);
        Log.i("fb-UnpackingSoSource", outline17.toString());
        if (this.soDirectory.setWritable(true, true)) {
            ...
            StringBuilder outline172 = GeneratedOutlineSupport.outline17("cannot make directory writable for us: ");
            outline172.append(this.soDirectory);
    ...
    public void prepare(int i) throws IOException {
        ...
        if (file.mkdirs() || file.isDirectory()) {
            ...
            try {
                ...
                if (fileLocker == null) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("not releasing dso store lock for ");
                    outline17.append(this.soDirectory);
                    outline17.append(" (syncer thread started)");
                    outline17.toString();
                }
            } finally {
                StringBuilder outline172 = GeneratedOutlineSupport.outline17("releasing dso store lock for ");
                outline172.append(this.soDirectory);
                outline172.toString();
                fileLocker.close();
            }
    ...
    public final boolean refreshLocked(final FileLocker fileLocker, int i, final byte[] bArr) throws IOException {
        ...
        if (b != 0) {
            if ((i & 2) == 0) {
                ...
                if ((i & 1) != 0) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("SoSync:");
                    outline17.append(this.soDirectory.getName());
                    new Thread(r9, outline17.toString()).start();
                } else {
                    r9.run();
                }
                return true;
