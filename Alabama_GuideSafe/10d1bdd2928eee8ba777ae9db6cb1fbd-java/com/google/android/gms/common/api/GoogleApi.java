...
public class GoogleApi<O extends Api.ApiOptions> {
    ...
    public final <TResult, A extends Api.AnyClient> Task<TResult> zaa(int i, TaskApiCall<A, TResult> taskApiCall) {
        ...
        if (googleApiManager != null) {
            zaf zaf2 = new zaf(i, taskApiCall, taskCompletionSource, apiExceptionMapper);
            Handler handler = googleApiManager.zaq;
            handler.sendMessage(handler.obtainMessage(4, new zabr(zaf2, googleApiManager.zal.get(), this)));
