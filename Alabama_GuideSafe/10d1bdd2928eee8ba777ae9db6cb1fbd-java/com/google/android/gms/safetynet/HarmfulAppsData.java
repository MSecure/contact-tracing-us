...
public class HarmfulAppsData extends AbstractSafeParcelable {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        ReactYogaConfigProvider.writeString(parcel, 2, this.apkPackageName, false);
        ReactYogaConfigProvider.writeByteArray(parcel, 3, this.apkSha256, false);
        ReactYogaConfigProvider.writeInt(parcel, 4, this.apkCategory);
