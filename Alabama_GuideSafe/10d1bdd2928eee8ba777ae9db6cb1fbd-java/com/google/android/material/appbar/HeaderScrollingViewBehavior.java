...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    public final int getOverlapPixelsForOffset(View view) {
        ...
        return AppCompatDelegateImpl.ConfigurationImplApi17.clamp((int) (f * ((float) i2)), 0, i2);
    }
    ...
    public boolean onMeasureChild(CoordinatorLayout coordinatorLayout, View view, int i, int i2, int i3, int i4) {
        ...
        coordinatorLayout.onMeasureChild(view, i, i2, View.MeasureSpec.makeMeasureSpec((size + findFirstDependency.getTotalScrollRange()) - findFirstDependency.getMeasuredHeight(), i5 == -1 ? 1073741824 : RecyclerView.UNDEFINED_DURATION), i4);
        return true;
    }
