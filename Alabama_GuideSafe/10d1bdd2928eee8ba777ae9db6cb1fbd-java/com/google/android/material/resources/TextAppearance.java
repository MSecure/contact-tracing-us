...
public class TextAppearance {
    ...
    public TextAppearance(Context context, int i) {
        ...
        this.textColorHint = ReactYogaConfigProvider.getColorStateList(context, obtainStyledAttributes, R$styleable.TextAppearance_android_textColorHint);
        this.textColorLink = ReactYogaConfigProvider.getColorStateList(context, obtainStyledAttributes, R$styleable.TextAppearance_android_textColorLink);
    ...
    public void getFontAsync(Context context, final TextAppearanceFontCallback textAppearanceFontCallback) {
        ...
        try {
            ...
            if (context.isRestricted()) {
                ...
                AppCompatDelegateImpl.ConfigurationImplApi17.loadFont(context, i, new TypedValue(), 0, r6, null, false);
            }
