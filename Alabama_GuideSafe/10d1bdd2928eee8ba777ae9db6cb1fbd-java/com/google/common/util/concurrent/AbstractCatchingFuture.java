...
public abstract class AbstractCatchingFuture<V, X extends Throwable, F, T> extends FluentFuture.TrustedFuture<V> implements Runnable {
    ...
    public static <V, X extends Throwable> ListenableFuture<V> create(ListenableFuture<? extends V> listenableFuture, Class<X> cls, Function<? super X, ? extends V> function, Executor executor) {
        ...
        if (executor != null) {
            if (executor != DirectExecutor.INSTANCE) {
                executor = new Executor(executor, catchingFuture) {
    ...
    public String pendingToString() {
        ...
        if (cls != null && f != null) {
            ...
            return GeneratedOutlineSupport.outline10(str, pendingToString);
        } else {
            return null;
        }
    }
    ...
    public final void run() {
        ...
        if ((!z && !z2) && !(this.value instanceof AbstractFuture.Cancellation)) {
            this.inputFuture = null;
            try {
                th = listenableFuture instanceof InternalFutureFailureAccess ? MoreExecutors.tryInternalFastPathGetFailure((InternalFutureFailureAccess) listenableFuture) : null;
                if (th == null) {
                ...
                if (cause == null) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("Future type ");
                    outline17.append(listenableFuture.getClass());
                    outline17.append(" threw ");
                    outline17.append(e.getClass());
                    outline17.append(" without a cause");
                    cause = new NullPointerException(outline17.toString());
                }
                th = cause;
            } catch (Throwable th3) {
                th = th3;
