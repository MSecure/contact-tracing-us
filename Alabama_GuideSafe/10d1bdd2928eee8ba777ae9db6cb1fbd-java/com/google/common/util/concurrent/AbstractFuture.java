...
public abstract class AbstractFuture<V> extends InternalFutureFailureAccess implements ListenableFuture<V> {
    ...
    public static void complete(AbstractFuture<?> abstractFuture) {
        ...
        while (true) {
            Waiter waiter = ((AbstractFuture) abstractFuture).waiters;
            if (ATOMIC_HELPER.casWaiters((AbstractFuture) abstractFuture, waiter, Waiter.TOMBSTONE)) {
                while (waiter != null) {
                ...
                ((AbstractFuture) abstractFuture).afterDone();
                do {
                    listener = ((AbstractFuture) abstractFuture).listeners;
                } while (!ATOMIC_HELPER.casListeners((AbstractFuture) abstractFuture, listener, Listener.TOMBSTONE));
                while (true) {
                    listener2 = listener3;
                    listener3 = listener;
                    if (listener3 == null) {
    ...
    public static Object getFutureValue(ListenableFuture<?> listenableFuture) {
        ...
        if (listenableFuture instanceof Trusted) {
            ...
            return obj;
        } else if ((listenableFuture instanceof InternalFutureFailureAccess) && (tryInternalFastPathGetFailure = MoreExecutors.tryInternalFastPathGetFailure((InternalFutureFailureAccess) listenableFuture)) != null) {
    ...
    public V get(long j, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        if (!Thread.interrupted()) {
            ...
            if (nanos + 1000 < 0) {
                String outline10 = GeneratedOutlineSupport.outline10(str, " (plus ");
                long j2 = -nanos;
                ...
                if (i > 0) {
                    String str2 = outline10 + convert + " " + lowerCase;
                    if (z) {
                        str2 = GeneratedOutlineSupport.outline10(str2, ",");
                    }
                    outline10 = GeneratedOutlineSupport.outline10(str2, " ");
                }
                if (z) {
                    outline10 = outline10 + nanos2 + " nanoseconds ";
                }
                str = GeneratedOutlineSupport.outline10(outline10, "delay)");
            }
            if (isDone()) {
                throw new TimeoutException(GeneratedOutlineSupport.outline10(str, " but future completed as timeout expired"));
            }
            throw new TimeoutException(GeneratedOutlineSupport.outline11(str, " for ", abstractFuture));
        }
        throw new InterruptedException();
    }
    ...
    public String pendingToString() {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("remaining delay=[");
        outline17.append(((ScheduledFuture) this).getDelay(TimeUnit.MILLISECONDS));
        outline17.append(" ms]");
    ...
    public String toString() {
        ...
        if (isCancelled()) {
            ...
            if (obj instanceof SetFuture) {
                ...
                try {
                    str = Platform.emptyToNull(pendingToString());
                } catch (RuntimeException | StackOverflowError e) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("Exception thrown from implementation: ");
                    outline17.append(e.getClass());
