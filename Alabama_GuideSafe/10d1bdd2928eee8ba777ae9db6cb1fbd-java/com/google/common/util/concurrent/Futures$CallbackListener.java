...
public final class Futures$CallbackListener<V> implements Runnable {
    ...
    public void run() {
        ...
        if (!(future2 instanceof InternalFutureFailureAccess) || (tryInternalFastPathGetFailure = MoreExecutors.tryInternalFastPathGetFailure((InternalFutureFailureAccess) future2)) == null) {
            try {
