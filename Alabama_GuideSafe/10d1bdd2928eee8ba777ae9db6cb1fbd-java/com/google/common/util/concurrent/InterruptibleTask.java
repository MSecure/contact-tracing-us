...
public abstract class InterruptibleTask<T> extends AtomicReference<Runnable> implements Runnable {
    ...
    public final String toString() {
        ...
        if (runnable == DONE) {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("running=[RUNNING ON ");
            outline17.append(((Thread) runnable).getName());
            outline17.append("]");
        ...
        outline19.append(((TrustedListenableFutureTask.TrustedFutureInterruptibleTask) this).callable.toString());
