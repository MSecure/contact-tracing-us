            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (map.put(read, this.valueTypeAdapter.read(jsonReader)) == null) {
                        ...
                        throw new JsonSyntaxException(GeneratedOutlineSupport.outline9("duplicate key: ", read));
                    }
                }
                jsonReader.endArray();
            } else {
                    ...
                    if (((JsonReader.AnonymousClass1) JsonReaderInternalAccess.INSTANCE) != null) {
                        if (jsonReader instanceof JsonTreeReader) {
                            ...
                            if (i == 13) {
                                ...
                                outline17.append(jsonReader.peek());
                                outline17.append(jsonReader.locationString());
                        ...
                        if (map.put(read2, this.valueTypeAdapter.read(jsonReader)) != null) {
                            throw new JsonSyntaxException(GeneratedOutlineSupport.outline9("duplicate key: ", read2));
                        }
                    } else {
                        throw null;
                    }
