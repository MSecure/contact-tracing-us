...
public abstract class RenderableView extends VirtualView {
                        ...
                        if (val3 > 1.0d && val4 > 1.0d) {
                            ...
                            if (patternView != null) {
                                ...
                                if (rectF3.width() > BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER && rectF3.height() > BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER) {
                                    ...
                                    canvas.concat(MoreExecutors.getTransform(rectF3, rectF4, patternView2.mAlign, patternView2.mMeetOrSlice));
                                }
            ...
            while (it2.hasNext()) {
                ...
                if (markerView5 != null) {
                    ...
                    if (markerView5.mAlign != null) {
                        ...
                        Matrix transform = MoreExecutors.getTransform(new RectF(f3 * f4, f5 * f4, (f3 + markerView5.mVbWidth) * f4, (f5 + markerView5.mVbHeight) * f4), rectF, markerView5.mAlign, markerView5.mMeetOrSlice);
    ...
    public void setFillRule(int i) {
        if (i == 0) {
            ...
            throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline6("fillRule ", i, " unrecognized"));
        }
        invalidate();
    }
    ...
    public void setStrokeLinecap(int i) {
        if (i == 0) {
            ...
            throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline6("strokeLinecap ", i, " unrecognized"));
        }
        invalidate();
    }
    ...
    public void setStrokeLinejoin(int i) {
        if (i == 0) {
            ...
            throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline6("strokeLinejoin ", i, " unrecognized"));
        }
        invalidate();
    }
