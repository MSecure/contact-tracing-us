...
public class SvgView extends ReactViewGroup implements ReactCompoundView, ReactCompoundViewGroup {
    ...
    public synchronized void drawChildren(Canvas canvas) {
        ...
        if (this.mAlign != null) {
            ...
            if (z) {
                width = (float) MoreExecutors.fromRelative(this.mbbWidth, (double) width, 0.0d, (double) this.mScale, 12.0d);
                height = (float) MoreExecutors.fromRelative(this.mbbHeight, (double) height, 0.0d, (double) this.mScale, 12.0d);
            }
            ...
            matrix = MoreExecutors.getTransform(viewBox, rectF, this.mAlign, this.mMeetOrSlice);
