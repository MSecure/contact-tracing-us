...
public class UseView extends RenderableView {
    ...
    public void draw(Canvas canvas, Paint paint, float f) {
        ...
        if (definedTemplate == null) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("`Use` element expected a pre-defined svg template as `href` prop, template named: ");
            outline17.append(this.mHref);
            outline17.append(" is not defined.");
        ...
        if (definedTemplate instanceof SymbolView) {
            ...
            if (symbolView.mAlign != null) {
                ...
                z = z2;
                canvas.concat(MoreExecutors.getTransform(new RectF(f2 * f3, f4 * f3, (f2 + symbolView.mVbWidth) * f3, (f4 + symbolView.mVbHeight) * f3), new RectF(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, relativeOnWidth, relativeOnHeight), symbolView.mAlign, symbolView.mMeetOrSlice));
