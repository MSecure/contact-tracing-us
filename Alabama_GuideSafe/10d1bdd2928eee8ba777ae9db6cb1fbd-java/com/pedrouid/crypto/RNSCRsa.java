...
public class RNSCRsa extends ReactContextBaseJavaModule {
    ...
    public void decrypt(final String str, final String str2, final Promise promise) {
        AsyncTask.execute(new Runnable(this) {
            /* class com.pedrouid.crypto.RNSCRsa.AnonymousClass4 */
    ...
    public void decrypt64(final String str, final String str2, final Promise promise) {
        AsyncTask.execute(new Runnable(this) {
            /* class com.pedrouid.crypto.RNSCRsa.AnonymousClass5 */
    ...
    public void encrypt(final String str, final String str2, final Promise promise) {
        AsyncTask.execute(new Runnable(this) {
            /* class com.pedrouid.crypto.RNSCRsa.AnonymousClass2 */
    ...
    public void encrypt64(final String str, final String str2, final Promise promise) {
        AsyncTask.execute(new Runnable(this) {
            /* class com.pedrouid.crypto.RNSCRsa.AnonymousClass3 */
    ...
    public void generateKeys(final int i, final Promise promise) {
        AsyncTask.execute(new Runnable(this) {
            /* class com.pedrouid.crypto.RNSCRsa.AnonymousClass1 */
    ...
    public void sign(final String str, final String str2, final String str3, final Promise promise) {
        AsyncTask.execute(new Runnable() {
            /* class com.pedrouid.crypto.RNSCRsa.AnonymousClass6 */
            ...
            public void run() {
                try {
                    ...
                    rsa.setPrivateKey(str2);
                    String str = str;
                    promise.resolve(rsa.sign(str.getBytes(RSA.CharsetUTF_8), RNSCRsa.this.getAlgorithmFromHash(str3)));
                } catch (Exception e) {
                    promise.reject("Error", e.getMessage());
                }
            }
    ...
    public void sign64(final String str, final String str2, final String str3, final Promise promise) {
        AsyncTask.execute(new Runnable() {
            /* class com.pedrouid.crypto.RNSCRsa.AnonymousClass7 */
            ...
            public void run() {
                try {
                    ...
                    rsa.setPrivateKey(str2);
                    String str = str;
                    promise.resolve(rsa.sign(Base64.decode(str, 0), RNSCRsa.this.getAlgorithmFromHash(str3)));
                } catch (Exception e) {
                    promise.reject("Error", e.getMessage());
                }
            }
    ...
    public void verify(final String str, final String str2, final String str3, final String str4, final Promise promise) {
        AsyncTask.execute(new Runnable() {
            /* class com.pedrouid.crypto.RNSCRsa.AnonymousClass8 */
            ...
            public void run() {
                try {
                    ...
                    String str = str;
                    String str2 = str2;
                    String algorithmFromHash = RNSCRsa.this.getAlgorithmFromHash(str4);
    ...
    public void verify64(final String str, final String str2, final String str3, final String str4, final Promise promise) {
        AsyncTask.execute(new Runnable() {
            /* class com.pedrouid.crypto.RNSCRsa.AnonymousClass9 */
