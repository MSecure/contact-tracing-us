...
public class RNTimePickerDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        int i3 = (bundle2 == null || !MinuteIntervalSnappableTimePickerDialog.isValidMinuteInterval(bundle2.getInt("minuteInterval"))) ? 1 : bundle2.getInt("minuteInterval");
        ...
        if (ordinal == 0 || ordinal == 1) {
            rNDismissableTimePickerDialog = new RNDismissableTimePickerDialog(activity, activity.getResources().getIdentifier(rNTimePickerDisplay == RNTimePickerDisplay.CLOCK ? "ClockTimePickerDialog" : "SpinnerTimePickerDialog", "style", activity.getPackageName()), onTimeSetListener, i, i2, i3, is24HourFormat, rNTimePickerDisplay);
        } else {
            rNDismissableTimePickerDialog = new RNDismissableTimePickerDialog(activity, onTimeSetListener, i, i2, i3, is24HourFormat, rNTimePickerDisplay);
        }
