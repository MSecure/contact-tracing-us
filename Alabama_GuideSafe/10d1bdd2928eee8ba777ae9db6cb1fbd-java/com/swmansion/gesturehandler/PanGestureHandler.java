...
public class PanGestureHandler extends GestureHandler<PanGestureHandler> {
    ...
    public void onHandle(MotionEvent motionEvent) {
        ...
        if (actionMasked == 6 || actionMasked == 5) {
            ...
            this.mLastX = MoreExecutors.getLastPointerX(motionEvent, this.mAverageTouches);
            float lastPointerY = MoreExecutors.getLastPointerY(motionEvent, this.mAverageTouches);
            this.mLastY = lastPointerY;
            this.mStartX = this.mLastX;
            this.mStartY = lastPointerY;
        } else {
            this.mLastX = MoreExecutors.getLastPointerX(motionEvent, this.mAverageTouches);
            this.mLastY = MoreExecutors.getLastPointerY(motionEvent, this.mAverageTouches);
        }
