...
public class PinchGestureHandler extends GestureHandler<PinchGestureHandler> {
    public ScaleGestureDetector.OnScaleGestureListener mGestureListener = new ScaleGestureDetector.OnScaleGestureListener() {
        /* class com.swmansion.gesturehandler.PinchGestureHandler.AnonymousClass1 */
        ...
        public boolean onScale(ScaleGestureDetector scaleGestureDetector) {
            ...
            pinchGestureHandler.mLastScaleFactor = ((double) scaleGestureDetector.getScaleFactor()) * d;
            long timeDelta = scaleGestureDetector.getTimeDelta();
            if (timeDelta > 0) {
                PinchGestureHandler pinchGestureHandler2 = PinchGestureHandler.this;
                pinchGestureHandler2.mLastVelocity = (pinchGestureHandler2.mLastScaleFactor - d) / ((double) timeDelta);
            }
