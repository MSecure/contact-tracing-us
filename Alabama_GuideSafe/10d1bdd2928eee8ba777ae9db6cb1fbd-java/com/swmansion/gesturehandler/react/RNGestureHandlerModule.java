        ...
        public void configure(T t, ReadableMap readableMap) {
                ...
                if (t.mView != null) {
                    ...
                    /*  JADX ERROR: Method code generation error
                        jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0023: INVOKE  
                          (wrap: com.swmansion.gesturehandler.GestureHandler$1 : 0x0020: CONSTRUCTOR  (r1v3 com.swmansion.gesturehandler.GestureHandler$1) = (r3v0 't' T extends com.swmansion.gesturehandler.GestureHandler) call: com.swmansion.gesturehandler.GestureHandler.1.<init>(com.swmansion.gesturehandler.GestureHandler):void type: CONSTRUCTOR)
                         type: STATIC call: com.facebook.react.bridge.UiThreadUtil.runOnUiThread(java.lang.Runnable):void in method: com.swmansion.gesturehandler.react.RNGestureHandlerModule.HandlerFactory.configure(T extends com.swmansion.gesturehandler.GestureHandler, com.facebook.react.bridge.ReadableMap):void, file: classes.dex
                        ...
                        Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0020: CONSTRUCTOR  (r1v3 com.swmansion.gesturehandler.GestureHandler$1) = (r3v0 't' T extends com.swmansion.gesturehandler.GestureHandler) call: com.swmansion.gesturehandler.GestureHandler.1.<init>(com.swmansion.gesturehandler.GestureHandler):void type: CONSTRUCTOR in method: com.swmansion.gesturehandler.react.RNGestureHandlerModule.HandlerFactory.configure(T extends com.swmansion.gesturehandler.GestureHandler, com.facebook.react.bridge.ReadableMap):void, file: classes.dex
                        	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:255)
                        	...
                        	... 24 more
                        Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.swmansion.gesturehandler.GestureHandler, state: GENERATED_AND_UNLOADED
                    ...
                    /*
                        ...
                        r3.mShouldCancelWhenOutside = r0
                    L_0x000e:
                        ...
                        com.swmansion.gesturehandler.GestureHandler$1 r1 = new com.swmansion.gesturehandler.GestureHandler$1
                        r1.<init>()
                    ...
                    L_0x0028:
                        ...
                        com.swmansion.gesturehandler.react.RNGestureHandlerModule.access$000(r3, r4)
                    L_0x0033:
                        return
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.swmansion.gesturehandler.react.RNGestureHandlerModule.HandlerFactory.configure(com.swmansion.gesturehandler.GestureHandler, com.facebook.react.bridge.ReadableMap):void");
                }
            ...
            private void tryInitializeHandlerForReactRootView(int i) {
                ...
                if (resolveRootTagFromReactTag >= 1) {
                    ...
                    throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline5("Could find root view for a given ancestor with tag ", i));
                }
            }
            ...
            public void attachGestureHandler(int i, int i2) {
                ...
                if (!this.mRegistry.attachHandlerToView(i, i2)) {
                    throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline6("Handler with tag ", i, " does not exists"));
                }
            }
            ...
            public void createGestureHandler(String str, int i, ReadableMap readableMap) {
                ...
                while (true) {
                    ...
                    if (i2 < handlerFactoryArr.length) {
                        ...
                        throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline10("Invalid handler name ", str));
                    }
                }
            }
