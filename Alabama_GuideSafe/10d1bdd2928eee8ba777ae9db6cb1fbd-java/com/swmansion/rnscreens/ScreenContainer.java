...
public class ScreenContainer<T extends ScreenFragment> extends ViewGroup {
    ...
    public ScreenFragment mParentScreenFragment = null;
    ...
    public Screen.ActivityState getActivityState(ScreenFragment screenFragment) {
        return screenFragment.mScreenView.getActivityState();
    }
    ...
    public void performUpdate() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (getActivityState(t) == activityState && t.isAdded()) {
        ...
        for (int i3 = 0; i3 < size2; i3++) {
            if (getActivityState(this.mScreenFragments.get(i3)) == Screen.ActivityState.ON_TOP) {
                z = false;
            }
        }
        ...
        for (int i4 = 0; i4 < size3; i4++) {
            ...
            Screen.ActivityState activityState2 = getActivityState(t2);
            if (activityState2 != activityState && !t2.isAdded()) {
                getOrCreateTransaction().add(getId(), t2);
                z2 = true;
            } else if (activityState2 != activityState && z2) {
