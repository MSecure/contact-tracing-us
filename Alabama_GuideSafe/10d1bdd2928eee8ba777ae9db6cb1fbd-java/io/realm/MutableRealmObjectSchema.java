...
public class MutableRealmObjectSchema extends RealmObjectSchema {
    ...
    public RealmObjectSchema addField(String str, Class<?> cls, FieldAttribute... fieldAttributeArr) {
        ...
        if (fieldMetaData == null) {
            if (RealmObjectSchema.SUPPORTED_LINKED_FIELDS.containsKey(cls)) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Use addRealmObjectField() instead to add fields that link to other RealmObjects: ", str));
    ...
    public RealmObjectSchema addIndex(String str) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline10(str, " already has an index."));
    }
    ...
    public RealmObjectSchema addRealmListField(String str, Class<?> cls) {
        ...
        if (fieldMetaData != null) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Use 'addRealmListField(String name, RealmObjectSchema schema)' instead to add lists that link to other RealmObjects: ", str));
        } else {
    ...
    public final void checkFieldNameIsAvailable(String str) {
        if (this.table.getColumnKey(str) != -1) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Field already exists in '");
    ...
    public RealmObjectSchema removeField(String str) {
        ...
        throw new IllegalStateException(GeneratedOutlineSupport.outline10(str, " does not exist."));
    }
    ...
    public RealmObjectSchema transform(RealmObjectSchema.Function function) {
        ...
        throw new UnsupportedOperationException(GeneratedOutlineSupport.outline7("Too many results to iterate: ", size));
    }
}
