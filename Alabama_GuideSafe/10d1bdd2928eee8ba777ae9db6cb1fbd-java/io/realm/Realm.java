...
public class Realm extends BaseRealm {
    ...
    public static Object getDefaultModule() {
        try {
            ...
            throw new RealmException(GeneratedOutlineSupport.outline10("Could not create an instance of ", "io.realm.DefaultRealmModule"), e);
        } catch (InstantiationException e2) {
            throw new RealmException(GeneratedOutlineSupport.outline10("Could not create an instance of ", "io.realm.DefaultRealmModule"), e2);
        } catch (IllegalAccessException e3) {
            throw new RealmException(GeneratedOutlineSupport.outline10("Could not create an instance of ", "io.realm.DefaultRealmModule"), e3);
        }
    }
    ...
    public static void initializeRealm(Context context, String str) {
        ...
        if (context != null) {
            ...
            if (context.getFilesDir() == null || !context.getFilesDir().exists()) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Context.getFilesDir() returns ");
                outline17.append(context.getFilesDir());
                outline17.append(" which is not an existing directory. See https://issuetracker.google.com/issues/36918154");
