...
public class RealmConfiguration {
    ...
    public static class Builder {
        ...
        public RealmConfiguration build() {
            ...
            try {
                ...
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Could not resolve the canonical path to the Realm file: ");
                outline17.append(file2.getAbsolutePath());
                throw new RealmFileException(kind, outline17.toString(), e);
            }
        }
    }
    ...
    public static RealmProxyMediator getModuleMediator(String str) {
        ...
        try {
            ...
            throw new RealmException(GeneratedOutlineSupport.outline10("Could not find ", format), e);
        } catch (InvocationTargetException e2) {
            throw new RealmException(GeneratedOutlineSupport.outline10("Could not create an instance of ", format), e2);
        } catch (InstantiationException e3) {
            throw new RealmException(GeneratedOutlineSupport.outline10("Could not create an instance of ", format), e3);
        } catch (IllegalAccessException e4) {
            throw new RealmException(GeneratedOutlineSupport.outline10("Could not create an instance of ", format), e4);
        }
    }
    ...
    public String toString() {
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("realmDirectory: ");
        File file = this.realmDirectory;
        outline17.append(file != null ? file.toString() : "");
        outline17.append("\n");
        outline17.append("realmFileName : ");
        outline17.append(this.realmFileName);
        outline17.append("\n");
        outline17.append("canonicalPath: ");
        outline17.append(this.canonicalPath);
        outline17.append("\n");
        outline17.append("key: ");
        outline17.append("[length: ");
        outline17.append(this.key == null ? 0 : 64);
        outline17.append("]");
        outline17.append("\n");
        outline17.append("schemaVersion: ");
        outline17.append(Long.toString(this.schemaVersion));
        outline17.append("\n");
        outline17.append("migration: ");
        outline17.append(this.migration);
        outline17.append("\n");
        outline17.append("deleteRealmIfMigrationNeeded: ");
        outline17.append(this.deleteRealmIfMigrationNeeded);
        outline17.append("\n");
        outline17.append("durability: ");
        outline17.append(this.durability);
        outline17.append("\n");
        outline17.append("schemaMediator: ");
        outline17.append(this.schemaMediator);
        outline17.append("\n");
        outline17.append("readOnly: ");
        outline17.append(this.readOnly);
        outline17.append("\n");
        outline17.append("compactOnLaunch: ");
        outline17.append(this.compactOnLaunch);
        outline17.append("\n");
        outline17.append("maxNumberOfActiveVersions: ");
        outline17.append(this.maxNumberOfActiveVersions);
