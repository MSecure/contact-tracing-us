...
public final class RealmModelListOperator<T> extends ManagedListOperator<T> {
    ...
    public final <E extends RealmModel> E copyToRealmIfNeeded(E e) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("A RealmObject with no @PrimaryKey cannot be updated: ");
        outline17.append(cls.toString());
    ...
    public void insertValue(int i, Object obj) {
        ...
        if (i < 0 || i2 < i) {
            StringBuilder outline18 = GeneratedOutlineSupport.outline18("Invalid index ", i, ", size is ");
            outline18.append(this.osList.size());
