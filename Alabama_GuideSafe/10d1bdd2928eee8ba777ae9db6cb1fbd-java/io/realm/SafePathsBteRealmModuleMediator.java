...
@RealmModule
public class SafePathsBteRealmModuleMediator extends RealmProxyMediator {
    ...
    public <E extends RealmModel> E newInstance(Class<E> cls, Object obj, Row row, ColumnInfo columnInfo, boolean z, List<String> list) {
        ...
        try {
            ...
            RealmProxyMediator.checkClass(cls);
            if (cls.equals(ExposureEntity.class)) {
                return cls.cast(new org_pathcheck_covidsafepaths_exposurenotifications_storage_objects_ExposureEntityRealmProxy());
            }
            if (cls.equals(KeyValues.class)) {
                E cast = cls.cast(new org_pathcheck_covidsafepaths_exposurenotifications_storage_objects_KeyValuesRealmProxy());
                realmObjectContext.clear();
                return cast;
            } else if (cls.equals(SymptomLogEntry.class)) {
                E cast2 = cls.cast(new org_pathcheck_covidsafepaths_exposurenotifications_storage_objects_SymptomLogEntryRealmProxy());
                realmObjectContext.clear();
                return cast2;
            } else {
                throw RealmProxyMediator.getMissingProxyClassException(cls);
