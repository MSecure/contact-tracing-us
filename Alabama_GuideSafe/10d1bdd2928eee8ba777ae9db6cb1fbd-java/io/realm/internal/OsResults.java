...
public class OsResults implements NativeObject, ObservableCollection {
    ...
    public static abstract class Iterator<T> implements java.util.Iterator<T> {
        ...
        public T next() {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Cannot access index ");
            outline17.append(this.pos);
            outline17.append(" when size is ");
            outline17.append(this.iteratorOsResults.size());
            outline17.append(". Remember to check hasNext() before using next().");
            throw new NoSuchElementException(outline17.toString());
        }
    ...
    public static abstract class ListIterator<T> extends Iterator<T> implements java.util.ListIterator<T> {
        public ListIterator(OsResults osResults, int i) {
            ...
            if (i < 0 || ((long) i) > this.iteratorOsResults.size()) {
                ...
                outline17.append(this.iteratorOsResults.size() - 1);
                outline17.append("]. Yours was ");
                outline17.append(i);
        ...
        public T previous() {
            ...
            try {
                ...
                throw new NoSuchElementException(GeneratedOutlineSupport.outline13(GeneratedOutlineSupport.outline17("Cannot access index less than zero. This was "), this.pos, ". Remember to check hasPrevious() before using previous()."));
            }
        }
    ...
    public OsResults(OsSharedRealm osSharedRealm, Table table2, long j) {
        ...
        if (nativeGetMode == 0) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("Invalid value: ", nativeGetMode));
        }
