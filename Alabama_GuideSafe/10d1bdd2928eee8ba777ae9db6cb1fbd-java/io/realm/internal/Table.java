...
public class Table implements NativeObject {
    ...
    public static String getTableNameForClass(String str) {
        ...
        return GeneratedOutlineSupport.outline14(new StringBuilder(), TABLE_PREFIX, str);
    }
    ...
    public static void throwDuplicatePrimaryKeyException(Object obj) {
        throw new RealmPrimaryKeyConstraintException(GeneratedOutlineSupport.outline9("Value already exists: ", obj));
    }
