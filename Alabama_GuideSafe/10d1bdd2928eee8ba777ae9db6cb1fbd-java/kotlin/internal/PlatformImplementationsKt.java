...
public final class PlatformImplementationsKt {
    ...
    static {
        ...
        if (property != null) {
            int indexOf$default = StringsKt__StringNumberConversionsKt.indexOf$default((CharSequence) property, '.', 0, false, 6);
            if (indexOf$default < 0) {
                ...
                int indexOf$default2 = StringsKt__StringNumberConversionsKt.indexOf$default((CharSequence) property, '.', i2, false, 4);
