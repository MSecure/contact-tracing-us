...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        if (size == 0) {
            ...
            map = new LinkedHashMap<>(MoreExecutors.mapCapacity(arrayList.size()));
            MoreExecutors.toMap(arrayList, map);
        } else {
        ...
        for (T t : values) {
            ...
            sb.append(StringsKt__StringNumberConversionsKt.substringAfterLast$default(t, '.', null, 2));
            sb.append("CompanionObject");
            hashMap3.put(sb.toString(), ((String) t) + ".Companion");
        }
        for (Map.Entry<Class<? extends Object<?>>, Integer> entry : FUNCTION_CLASSES.entrySet()) {
            int intValue = entry.getValue().intValue();
            hashMap3.put(entry.getKey().getName(), "kotlin.Function" + intValue);
        }
        classFqNames = hashMap3;
        LinkedHashMap linkedHashMap = new LinkedHashMap(MoreExecutors.mapCapacity(hashMap3.size()));
        for (T t2 : hashMap3.entrySet()) {
            linkedHashMap.put(t2.getKey(), StringsKt__StringNumberConversionsKt.substringAfterLast$default((String) t2.getValue(), '.', null, 2));
        }
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof ClassReference) && Intrinsics.areEqual(MoreExecutors.getJavaObjectType(this), MoreExecutors.getJavaObjectType((KClass) obj));
    }
    ...
    public int hashCode() {
        return MoreExecutors.getJavaObjectType(this).hashCode();
    }
