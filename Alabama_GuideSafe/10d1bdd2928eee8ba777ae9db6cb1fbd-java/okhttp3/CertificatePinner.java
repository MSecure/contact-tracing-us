...
public final class CertificatePinner {
    ...
    public static final class Pin {
        ...
        public Pin(String str, String str2) {
            ...
            if (str.startsWith(WILDCARD)) {
                ...
                outline17.append(str.substring(2));
                str3 = HttpUrl.get(outline17.toString()).host();
            } else {
            ...
            if (str2.startsWith("sha1/")) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("pins must start with 'sha256/' or 'sha1/': ", str2));
            }
            if (this.hash == null) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("pins must be base64: ", str2));
            }
        }
    ...
    public static String pin(Certificate certificate) {
        if (certificate instanceof X509Certificate) {
            ...
            outline17.append(sha256((X509Certificate) certificate).base64());
    ...
    public void check(String str, List<Certificate> list) throws SSLPeerUnverifiedException {
        ...
        if (!findMatchingPins.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if (pin.hashAlgorithm.equals("sha256/")) {
                        ...
                        StringBuilder outline17 = GeneratedOutlineSupport.outline17("unsupported hashAlgorithm: ");
                        outline17.append(pin.hashAlgorithm);
                        throw new AssertionError(outline17.toString());
                    }
                }
            }
            StringBuilder outline19 = GeneratedOutlineSupport.outline19("Certificate pinning failure!", "\n  Peer certificate chain:");
            int size3 = list.size();
            for (int i3 = 0; i3 < size3; i3++) {
                X509Certificate x509Certificate2 = (X509Certificate) list.get(i3);
                outline19.append("\n    ");
                outline19.append(pin(x509Certificate2));
                outline19.append(": ");
                outline19.append(x509Certificate2.getSubjectDN().getName());
            }
            ...
            for (int i4 = 0; i4 < size4; i4++) {
                outline19.append("\n    ");
                outline19.append(findMatchingPins.get(i4));
            }
            throw new SSLPeerUnverifiedException(outline19.toString());
        }
    }
    ...
    public CertificatePinner withCertificateChainCleaner(CertificateChainCleaner certificateChainCleaner2) {
        return Objects.equals(this.certificateChainCleaner, certificateChainCleaner2) ? this : new CertificatePinner(this.pins, certificateChainCleaner2);
    }
