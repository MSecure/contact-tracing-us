...
public final class CipherSuite {
    ...
    public static final Comparator<String> ORDER_BY_NAME = $$Lambda$CipherSuite$9SWcmR6qHxy1V18Yo6ZHyn4RNk.INSTANCE;
    ...
    public static String secondaryName(String str) {
        if (str.startsWith("TLS_")) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("SSL_");
            outline17.append(str.substring(4));
            return outline17.toString();
        } else if (!str.startsWith("SSL_")) {
            return str;
        } else {
            StringBuilder outline172 = GeneratedOutlineSupport.outline17("TLS_");
