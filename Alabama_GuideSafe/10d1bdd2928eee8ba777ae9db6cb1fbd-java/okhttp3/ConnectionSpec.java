...
public final class ConnectionSpec {
    ...
    public String toString() {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("ConnectionSpec(cipherSuites=");
        outline17.append(Objects.toString(cipherSuites(), "[all enabled]"));
        outline17.append(", tlsVersions=");
        outline17.append(Objects.toString(tlsVersions(), "[all enabled]"));
        outline17.append(", supportsTlsExtensions=");
        outline17.append(this.supportsTlsExtensions);
        outline17.append(")");
