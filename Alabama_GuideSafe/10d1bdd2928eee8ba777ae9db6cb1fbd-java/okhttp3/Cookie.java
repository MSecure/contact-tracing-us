...
public final class Cookie {
    ...
    public static final class Builder {
        ...
        public String name;
        public String path = ColorPropConverter.PATH_DELIMITER;
        ...
        private Builder domain(String str, boolean z) {
            if (str != null) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("unexpected domain: ", str));
            }
    ...
    public static boolean pathMatch(HttpUrl httpUrl, String str) {
        ...
        if (!str.endsWith(ColorPropConverter.PATH_DELIMITER) && encodedPath.charAt(str.length()) != '/') {
            return false;
        }
        return true;
    }
    ...
    public static Cookie parse(long j, HttpUrl httpUrl, String str) {
        ...
        if (j3 != Long.MIN_VALUE) {
            if (j3 != -1) {
                j5 = j + (j3 <= 9223372036854775L ? j3 * 1000 : RecyclerView.FOREVER_NS);
            ...
            str3 = ColorPropConverter.PATH_DELIMITER;
