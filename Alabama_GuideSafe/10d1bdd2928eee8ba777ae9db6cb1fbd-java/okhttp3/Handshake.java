...
public final class Handshake {
    ...
    public String toString() {
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Handshake{tlsVersion=");
        outline17.append(this.tlsVersion);
        outline17.append(" cipherSuite=");
        outline17.append(this.cipherSuite);
        outline17.append(" peerCertificates=");
        outline17.append(names(this.peerCertificates));
        outline17.append(" localCertificates=");
        outline17.append(names(this.localCertificates));
        outline17.append('}');
