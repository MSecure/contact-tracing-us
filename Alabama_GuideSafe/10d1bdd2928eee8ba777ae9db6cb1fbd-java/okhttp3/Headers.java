...
public final class Headers {
    ...
    public static void checkValue(String str, String str2) {
        ...
        throw new NullPointerException(GeneratedOutlineSupport.outline11("value for name ", str2, " == null"));
    }
    ...
    public static final class Builder {
        ...
        public Builder add(String str) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Unexpected header: ", str));
        }
        ...
        public Builder addLenient(String str) {
            int indexOf = str.indexOf(ColorPropConverter.PACKAGE_DELIMITER, 1);
            if (indexOf != -1) {
                return addLenient(str.substring(0, indexOf), str.substring(indexOf + 1));
            }
            if (str.startsWith(ColorPropConverter.PACKAGE_DELIMITER)) {
        ...
        public Builder set(String str, Date date) {
            ...
            throw new NullPointerException(GeneratedOutlineSupport.outline11("value for name ", str, " == null"));
        }
