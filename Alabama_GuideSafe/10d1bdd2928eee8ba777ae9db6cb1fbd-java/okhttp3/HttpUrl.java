    ...
    public static final class Builder {
        ...
        public Builder encodedPath(String str) {
            if (str == null) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("unexpected encodedPath: ", str));
            }
        }
        ...
        public Builder host(String str) {
            if (str != null) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("unexpected host: ", str));
            }
        ...
        public Builder parse(HttpUrl httpUrl, String str) {
            ...
            if (schemeDelimiterOffset != -1) {
                if (str.regionMatches(true, skipLeadingAsciiWhitespace, "https:", 0, 6)) {
                    ...
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("Expected URL scheme 'http' or 'https' but was '");
                    outline17.append(str.substring(0, schemeDelimiterOffset));
                    outline17.append("'");
            ...
            if (slashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    char charAt = delimiterOffset != skipTrailingAsciiWhitespace ? str.charAt(delimiterOffset) : c;
                ...
                if (i22 < delimiterOffset) {
                    ...
                    this.port = parsePort;
                    if (parsePort == -1) {
                        StringBuilder outline172 = GeneratedOutlineSupport.outline17("Invalid URL port: \"");
                        outline172.append(str.substring(i22, delimiterOffset));
                        outline172.append('\"');
                ...
                if (this.host != null) {
                    ...
                    StringBuilder outline173 = GeneratedOutlineSupport.outline17("Invalid URL host: \"");
                    outline173.append(str.substring(i, portColonOffset2));
                    outline173.append('\"');
                    throw new IllegalArgumentException(outline173.toString());
                }
            } else {
        ...
        public Builder port(int i) {
            if (i <= 0 || i > 65535) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("unexpected port: ", i));
            }
            this.port = i;
            return this;
        }
        ...
        public Builder scheme(String str) {
            if (str != null) {
                if (str.equalsIgnoreCase("http")) {
                    ...
                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("unexpected scheme: ", str));
                }
                return this;
            }
        ...
        public Builder setEncodedPathSegment(int i, String str) {
            if (str != null) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("unexpected path segment: ", str));
            }
            throw new NullPointerException("encodedPathSegment == null");
        }
