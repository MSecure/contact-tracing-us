...
public final class JavaNetCookieJar implements CookieJar {
    ...
    public List<Cookie> loadForRequest(HttpUrl httpUrl) {
        try {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Loading cookies failed for ");
            outline17.append(httpUrl.resolve("/..."));
            platform.log(5, outline17.toString(), e);
            return Collections.emptyList();
        }
    }
    ...
    public void saveFromResponse(HttpUrl httpUrl, List<Cookie> list) {
        if (this.cookieHandler != null) {
            ...
            try {
                ...
                Platform platform = Platform.get();
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Saving cookies failed for ");
                outline17.append(httpUrl.resolve("/..."));
                platform.log(5, outline17.toString(), e);
            }
        }
