...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public OkHttpClient(Builder builder) {
        ...
        if (this.interceptors.contains(null)) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Null interceptor: ");
            outline17.append(this.interceptors);
            throw new IllegalStateException(outline17.toString());
        } else if (this.networkInterceptors.contains(null)) {
            StringBuilder outline172 = GeneratedOutlineSupport.outline17("Null network interceptor: ");
            outline172.append(this.networkInterceptors);
