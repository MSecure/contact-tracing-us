...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder method(String str, RequestBody requestBody) {
            if (str == null) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline11("method ", str, " must not have a request body."));
            } else if (requestBody != null || !HttpMethod.requiresRequestBody(str)) {
                this.method = str;
                this.body = requestBody;
                return this;
            } else {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline11("method ", str, " must have a request body."));
            }
        }
    ...
    public String toString() {
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Request{method=");
        outline17.append(this.method);
        outline17.append(", url=");
        outline17.append(this.url);
