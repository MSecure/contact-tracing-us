...
public final class Util {
    ...
    public static String canonicalizeHost(String str) {
        ...
        if (str.contains(ColorPropConverter.PACKAGE_DELIMITER)) {
            ...
            throw new AssertionError(GeneratedOutlineSupport.outline11("Invalid IPv6 address: '", str, "'"));
        }
        try {
        ...
        while (true) {
            if (i >= i2) {
                ...
                if (i6 > i2 || !str.regionMatches(i, "::", 0, 2)) {
                    if (i5 != 0) {
                        if (str.regionMatches(i, ColorPropConverter.PACKAGE_DELIMITER, 0, 1)) {
                            i++;
    ...
    public static String hostHeader(HttpUrl httpUrl, boolean z) {
        String str;
        if (httpUrl.host().contains(ColorPropConverter.PACKAGE_DELIMITER)) {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("[");
            outline17.append(httpUrl.host());
            outline17.append("]");
        ...
        StringBuilder outline19 = GeneratedOutlineSupport.outline19(str, ColorPropConverter.PACKAGE_DELIMITER);
        outline19.append(httpUrl.port());
    ...
    public static ThreadFactory threadFactory(String str, boolean z) {
        return new ThreadFactory(str, z) {
            /* class okhttp3.internal.$$Lambda$Util$h7t7benxn5wsEKvjxE9svqr_kuY */
