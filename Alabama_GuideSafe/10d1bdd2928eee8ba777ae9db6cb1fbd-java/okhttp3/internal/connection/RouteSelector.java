...
public final class RouteSelector {
    ...
    private Proxy nextProxy() throws IOException {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("No route to ");
        outline17.append(this.address.url().host());
        outline17.append("; exhausted proxy configurations: ");
        outline17.append(this.proxies);
        throw new SocketException(outline17.toString());
    }
    ...
    private void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (proxy.type() == Proxy.Type.DIRECT || proxy.type() == Proxy.Type.SOCKS) {
            ...
            if (address2 instanceof InetSocketAddress) {
                ...
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Proxy.address() is not an InetSocketAddress: ");
                outline17.append(address2.getClass());
