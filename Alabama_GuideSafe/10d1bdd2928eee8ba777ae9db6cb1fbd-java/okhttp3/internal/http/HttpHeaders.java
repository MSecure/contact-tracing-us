...
public final class HttpHeaders {
    ...
    public static void parseChallengeHeader(List<Challenge> list, Buffer buffer) {
        ...
        while (true) {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17(readToken);
            outline17.append(repeat('=', skipAll));
            list.add(new Challenge(str2, Collections.singletonMap(null, outline17.toString())));
        }
    }
