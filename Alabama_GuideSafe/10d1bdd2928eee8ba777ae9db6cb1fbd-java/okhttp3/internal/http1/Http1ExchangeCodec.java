...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public abstract class AbstractSource implements Source {
        ...
        public final void responseBodyComplete() {
            if (Http1ExchangeCodec.this.state != 6) {
                ...
                outline17.append(Http1ExchangeCodec.this.state);
    ...
    public final class ChunkedSink implements Sink {
        public boolean closed;
        public final ForwardingTimeout timeout = new ForwardingTimeout(Http1ExchangeCodec.this.sink.timeout());
        ...
        public void write(Buffer buffer, long j) throws IOException {
            if (this.closed) {
                ...
                Http1ExchangeCodec.this.sink.writeUtf8(MultipartStreamReader.CRLF);
    ...
    public class ChunkedSource extends AbstractSource {
        ...
        @Override // okio.Source, okhttp3.internal.http1.Http1ExchangeCodec.AbstractSource, java.io.Closeable, java.lang.AutoCloseable
    ...
    public Response.Builder readResponseHeaders(boolean z) throws IOException {
        ...
        if (i == 1 || i == 3) {
            try {
                ...
                RealConnection realConnection2 = this.realConnection;
                throw new IOException(GeneratedOutlineSupport.outline10("unexpected end of stream on ", realConnection2 != null ? realConnection2.route().address().url().redact() : "unknown"), e);
            }
        } else {
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("state: ");
            outline17.append(this.state);
