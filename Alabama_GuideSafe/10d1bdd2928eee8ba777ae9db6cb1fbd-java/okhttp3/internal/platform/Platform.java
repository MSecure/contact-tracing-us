...
public class Platform {
    ...
    public void logCloseableLeak(String str, Object obj) {
        if (obj == null) {
            str = GeneratedOutlineSupport.outline10(str, " To see where this was allocated, set the OkHttpClient logger level to FINE: Logger.getLogger(OkHttpClient.class.getName()).setLevel(Level.FINE);");
        }
    ...
    public CertificateChainCleaner buildCertificateChainCleaner(SSLSocketFactory sSLSocketFactory) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("Unable to extract the trust manager on ");
        outline17.append(get());
        outline17.append(", sslSocketFactory is ");
        outline17.append(sSLSocketFactory.getClass());
