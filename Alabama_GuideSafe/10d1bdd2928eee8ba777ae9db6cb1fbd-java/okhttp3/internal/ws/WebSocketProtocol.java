...
public final class WebSocketProtocol {
    ...
    public static String closeCodeExceptionMessage(int i) {
        if (i < 1000 || i >= 5000) {
            return GeneratedOutlineSupport.outline5("Code must be in range [1000,5000): ", i);
        }
        if ((i < 1004 || i > 1006) && (i < 1012 || i > 2999)) {
            return null;
        }
        return GeneratedOutlineSupport.outline6("Code ", i, " is reserved and may not be used.");
    }
