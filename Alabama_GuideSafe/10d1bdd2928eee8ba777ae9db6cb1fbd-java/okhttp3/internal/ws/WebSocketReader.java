...
public final class WebSocketReader {
    ...
    private void readControlFrame() throws IOException {
        ...
        switch (this.opcode) {
            ...
            case 10:
                ...
                return;
            default:
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Unknown control opcode: ");
                outline17.append(Integer.toHexString(this.opcode));
            ...
            try {
                ...
                if (!z2 || this.isFinalFrame) {
                    ...
                    if (j == 126) {
                        ...
                        if (readLong < 0) {
                            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Frame length 0x");
                            outline17.append(Long.toHexString(this.frameLength));
                            outline17.append(" > 0x7FFFFFFFFFFFFFFF");
                            throw new ProtocolException(outline17.toString());
                        }
                    }
    ...
    private void readMessage() throws IOException {
        while (!this.closed) {
            ...
            if (!this.isFinalFrame) {
                ...
                if (this.opcode != 0) {
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("Expected continuation opcode. Got: ");
                    outline17.append(Integer.toHexString(this.opcode));
                    throw new ProtocolException(outline17.toString());
                }
            } else {
    ...
    private void readMessageFrame() throws IOException {
        ...
        if (i == 1 || i == 2) {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Unknown opcode: ");
