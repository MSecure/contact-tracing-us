...
public class EventDiskCache {
    ...
    public final File writeEventFile(List<Event> list) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("events_");
        outline17.append(list.get(list.size() - 1).mTimestamp);
        File file2 = new File(file, outline17.toString());
        try {
