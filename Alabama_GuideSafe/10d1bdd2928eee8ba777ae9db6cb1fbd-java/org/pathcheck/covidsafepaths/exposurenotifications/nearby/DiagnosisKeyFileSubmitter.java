...
public class DiagnosisKeyFileSubmitter {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x004f, code lost:
        com.google.common.util.concurrent.MoreExecutors.closeFinally(r0, r2);
     */
    ...
    public static Void lambda$submitBatches$1(List list, Void r3) {
        if (!list.isEmpty()) {
            ...
            if (!immutableList.isEmpty()) {
                String replace = immutableList.get(immutableList.size() - 1).toString().replace("https://encdn.prod.exposurenotification.health/", "");
