...
public final class ExposureConfigurations {
    ...
    public static final List<Integer> DEFAULT_ATTENUATION_DURATION_THRESHOLDS = MoreExecutors.listOf((Object[]) new Integer[]{55, 63, 70});
    public static final Map<Integer, Integer> DEFAULT_DAYS_SINCE_ONSET_TO_INFECTIOUSNESS = MoreExecutors.mapOf(new Pair(-14, 0), new Pair(-13, 0), new Pair(-12, 0), new Pair(-11, 0), new Pair(-10, 0), new Pair(-9, 0), new Pair(-8, 0), new Pair(-7, 0), new Pair(-6, 0), new Pair(-5, 0), new Pair(-4, 0), new Pair(-3, 1), new Pair(-2, 2), new Pair(-1, 2), new Pair(0, 2), new Pair(1, 2), new Pair(2, 2), new Pair(3, 2), new Pair(4, 1), new Pair(5, 0), new Pair(6, 0), new Pair(7, 0), new Pair(8, 0), new Pair(9, 0), new Pair(10, 0), new Pair(11, 0), new Pair(12, 0), new Pair(13, 0), new Pair(14, 0));
    public static final List<Double> DEFAULT_INFECTIOUSNESS_WEIGHT;
    public static final List<Double> DEFAULT_REPORT_TYPE_WEIGHTS;
    public static final Uri configurationUri = Uri.parse(BuildConfig.ANDROID_EN_CONFIG_URL_V1_6);
    public final ExposureNotificationSharedPreferences prefs;

    static {
        Double valueOf = Double.valueOf(1.0d);
        Double valueOf2 = Double.valueOf(0.0d);
        DEFAULT_ATTENUATION_BUCKET_WEIGHTS = MoreExecutors.listOf((Object[]) new Double[]{Double.valueOf(1.5d), valueOf, Double.valueOf(0.4d), valueOf2});
        DEFAULT_REPORT_TYPE_WEIGHTS = MoreExecutors.listOf((Object[]) new Double[]{valueOf, valueOf2, valueOf2, valueOf2});
        DEFAULT_INFECTIOUSNESS_WEIGHT = MoreExecutors.listOf((Object[]) new Double[]{Double.valueOf(0.3d), valueOf});
    }
