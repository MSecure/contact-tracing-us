...
public class ProvideDiagnosisKeysWorker extends ListenableWorker {
    ...
    public static final Duration JOB_FLEX_INTERVAL = Duration.create(MoreExecutors.safeMultiply(3L, 3600), 0);
    public static final Duration JOB_INTERVAL = Duration.create(MoreExecutors.safeMultiply(12L, 3600), 0);
    ...
    public static void cancel(Context context) {
        ...
        public final ForegroundInfo createForegroundInfo() {
            return NotificationHelper.createWorkerNotification(this.mAppContext);
        }
        ...
        public ListenableFuture<ListenableWorker.Result> startWork() {
            FluentFuture transformAsync = FluentFuture.from(MoreExecutors.getFutureWithTimeout(ExposureNotificationClientWrapper.get(this.mAppContext).isEnabled(), IS_ENABLED_TIMEOUT.toMillis(), TimeUnit.MILLISECONDS, AppExecutors.getScheduledExecutor())).transformAsync(new AsyncFunction() {
