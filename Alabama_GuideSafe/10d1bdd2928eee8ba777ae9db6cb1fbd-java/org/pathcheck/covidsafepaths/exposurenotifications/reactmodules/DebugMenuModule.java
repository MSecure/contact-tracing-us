...
public class DebugMenuModule extends ReactContextBaseJavaModule {
    ...
    private Long getRandomExposureDate() {
        return Long.valueOf(Instant.now().toEpochMilli() - ((long) ((((new SecureRandom().nextInt(13) * 24) * 60) * 60) * RNCWebViewManager.COMMAND_CLEAR_FORM_DATA)));
    }
    ...
    public void lambda$toggleExposureNotifications$0$DebugMenuModule(ExposureNotificationClientWrapper exposureNotificationClientWrapper, ReactContext reactContext, final Promise promise, Boolean bool) {
        if (bool.booleanValue()) {
            ...
            promise.getClass();
            zzu zzu = (zzu) stopTracing;
            zzu.addOnSuccessListener(TaskExecutors.MAIN_THREAD, new OnSuccessListener() {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x003a, code lost:
        com.google.common.util.concurrent.MoreExecutors.closeFinally(r0, r7);
     */
    @ReactMethod
    ...
    public void toggleExposureNotifications(Promise promise) {
        ...
        $$Lambda$DebugMenuModule$n2sqNb6NZLZJtV6jq0iMuPrBOQA r3 = new OnSuccessListener(exposureNotificationClientWrapper, reactApplicationContext, promise) {
        ...
        if (zzu != null) {
            zzu.addOnSuccessListener(TaskExecutors.MAIN_THREAD, r3);
            promise.getClass();
            zzu.addOnFailureListener(TaskExecutors.MAIN_THREAD, new OnFailureListener() {
                /* class org.pathcheck.covidsafepaths.exposurenotifications.reactmodules.$$Lambda$4FnuZITwpTidBCa7qe8kzCWQ6s */
