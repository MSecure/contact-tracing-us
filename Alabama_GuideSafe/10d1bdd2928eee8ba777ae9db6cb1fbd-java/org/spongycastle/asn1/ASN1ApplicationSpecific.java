...
public abstract class ASN1ApplicationSpecific extends ASN1Primitive {
    ...
    public ASN1ApplicationSpecific(boolean z, int i, byte[] bArr) {
        ...
        this.tag = i;
        this.octets = MoreExecutors.clone(bArr);
    }
    ...
    public boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        ...
        if (this.isConstructed == aSN1ApplicationSpecific.isConstructed && this.tag == aSN1ApplicationSpecific.tag && MoreExecutors.areEqual(this.octets, aSN1ApplicationSpecific.octets)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((z ? 1 : 0) ^ this.tag) ^ MoreExecutors.hashCode(this.octets);
    }
