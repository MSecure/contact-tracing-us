...
public abstract class ASN1BitString extends ASN1Primitive implements ASN1String {
    ...
    public ASN1BitString(byte[] bArr, int i) {
        if (bArr == null) {
            ...
            this.data = MoreExecutors.clone(bArr);
            this.padBits = i;
        }
    }

    public static byte[] derForm(byte[] bArr, int i) {
        byte[] clone = MoreExecutors.clone(bArr);
        if (i > 0) {
    ...
    public boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        ...
        if (this.padBits != aSN1BitString.padBits || !MoreExecutors.areEqual(getBytes(), aSN1BitString.getBytes())) {
            return false;
        }
        return true;
    }
    ...
    public String getString() {
        ...
        try {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Internal error encoding BitString: ");
    ...
    public int hashCode() {
        return this.padBits ^ MoreExecutors.hashCode(getBytes());
    }
