...
public class ASN1ObjectIdentifier extends ASN1Primitive {
    ...
    public static class OidHandle {
        ...
        public OidHandle(byte[] bArr) {
            this.key = MoreExecutors.hashCode(bArr);
            this.enc = bArr;
        }

        public boolean equals(Object obj) {
            if (obj instanceof OidHandle) {
                return MoreExecutors.areEqual(this.enc, ((OidHandle) obj).enc);
            }
            return false;
        }
    ...
    public ASN1ObjectIdentifier(byte[] bArr) {
        ...
        this.body = MoreExecutors.clone(bArr);
    }
    ...
    public static ASN1ObjectIdentifier getInstance(Object obj) {
        ...
        if (obj instanceof byte[]) {
            try {
                ...
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("failed to construct object identifier from byte[]: ");
    ...
    public ASN1ObjectIdentifier(String str) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline11("string ", str, " not an OID"));
    }
    ...
    public ASN1ObjectIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, String str) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline11("string ", str, " not a valid OID branch"));
    }
}
