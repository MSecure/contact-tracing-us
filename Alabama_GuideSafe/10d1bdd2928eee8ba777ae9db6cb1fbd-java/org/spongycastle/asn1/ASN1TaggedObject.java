...
public abstract class ASN1TaggedObject extends ASN1Primitive implements ASN1Encodable, InMemoryRepresentable {
    ...
    public static ASN1TaggedObject getInstance(Object obj2) {
        ...
        if (obj2 instanceof byte[]) {
            try {
                ...
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("failed to construct tagged object from byte[]: ");
            ...
            outline172.append(obj2.getClass().getName());
    ...
    public String toString() {
        ...
        outline17.append(this.tagNo);
        outline17.append("]");
        outline17.append(this.obj);
