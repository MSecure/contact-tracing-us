...
public class Time extends ASN1Object implements ASN1Choice {
    ...
    public static Time getInstance(Object obj) {
        ...
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("unknown object in factory: ");
    ...
    public String toString() {
        ...
        if (fromByteArray.indexOf(45) >= 0 || fromByteArray.indexOf(43) >= 0) {
            ...
            if (indexOf == fromByteArray.length() - 3) {
                fromByteArray = GeneratedOutlineSupport.outline10(fromByteArray, "00");
            }
            if (indexOf == 10) {
                StringBuilder sb = new StringBuilder();
                GeneratedOutlineSupport.outline23(fromByteArray, 0, 10, sb, "00GMT");
                GeneratedOutlineSupport.outline23(fromByteArray, 10, 13, sb, ColorPropConverter.PACKAGE_DELIMITER);
                sb.append(fromByteArray.substring(13, 15));
                str = sb.toString();
            } else {
                StringBuilder sb2 = new StringBuilder();
                GeneratedOutlineSupport.outline23(fromByteArray, 0, 12, sb2, "GMT");
                GeneratedOutlineSupport.outline23(fromByteArray, 12, 15, sb2, ColorPropConverter.PACKAGE_DELIMITER);
        ...
        if (str.charAt(0) < '5') {
            return GeneratedOutlineSupport.outline10("20", str);
        }
        return GeneratedOutlineSupport.outline10("19", str);
    }
}
