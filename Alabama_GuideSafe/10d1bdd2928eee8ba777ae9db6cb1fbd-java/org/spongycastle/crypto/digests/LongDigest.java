...
public abstract class LongDigest implements ExtendedDigest, Memoable {
    ...
    public void processWord(byte[] bArr, int i) {
        long[] jArr = this.W;
        int i2 = this.wOff;
        int bigEndianToInt = MoreExecutors.bigEndianToInt(bArr, i);
        jArr[i2] = (((long) MoreExecutors.bigEndianToInt(bArr, i + 4)) & 4294967295L) | ((((long) bigEndianToInt) & 4294967295L) << 32);
        int i3 = this.wOff + 1;
        this.wOff = i3;
        if (i3 == 16) {
            processBlock();
