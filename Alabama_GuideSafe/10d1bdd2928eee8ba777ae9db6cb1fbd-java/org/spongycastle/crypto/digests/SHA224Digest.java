...
public class SHA224Digest extends GeneralDigest {
    ...
    public final void doCopy(SHA224Digest sHA224Digest) {
    ...
    public int doFinal(byte[] bArr, int i) {
        finish();
        MoreExecutors.intToBigEndian(this.H1, bArr, i);
        MoreExecutors.intToBigEndian(this.H2, bArr, i + 4);
        MoreExecutors.intToBigEndian(this.H3, bArr, i + 8);
        MoreExecutors.intToBigEndian(this.H4, bArr, i + 12);
        MoreExecutors.intToBigEndian(this.H5, bArr, i + 16);
        MoreExecutors.intToBigEndian(this.H6, bArr, i + 20);
        MoreExecutors.intToBigEndian(this.H7, bArr, i + 24);
        reset();
        return 28;
    }
