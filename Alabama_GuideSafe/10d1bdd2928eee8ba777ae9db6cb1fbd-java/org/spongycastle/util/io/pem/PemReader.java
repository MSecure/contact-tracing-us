...
public class PemReader extends BufferedReader {
    ...
    public PemObject readPemObject() throws IOException {
        ...
        String outline10 = GeneratedOutlineSupport.outline10("-----END ", substring2);
        ...
        while (true) {
            ...
            } else if (readLine.indexOf(outline10) != -1) {
                break;
            } else {
        ...
        throw new IOException(GeneratedOutlineSupport.outline10(outline10, " not found"));
    }
}
