...
public enum DayOfWeek implements TemporalAccessor, TemporalAdjuster {
    ...
    public static DayOfWeek of(int i) {
        ...
        throw new DateTimeException(GeneratedOutlineSupport.outline5("Invalid value for DayOfWeek: ", i));
    }
    ...
    public <R> R query(TemporalQuery<R> temporalQuery) {
        ...
        if (temporalQuery == TemporalQueries.LOCAL_DATE || temporalQuery == TemporalQueries.LOCAL_TIME || temporalQuery == TemporalQueries.CHRONO || temporalQuery == TemporalQueries.ZONE || temporalQuery == TemporalQueries.ZONE_ID || temporalQuery == TemporalQueries.OFFSET) {
            return null;
        }
