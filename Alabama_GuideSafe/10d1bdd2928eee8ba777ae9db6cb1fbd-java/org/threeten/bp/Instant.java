...
public final class Instant extends DefaultInterfaceTemporalAccessor implements Temporal, TemporalAdjuster, Comparable<Instant>, Serializable {
    ...
    public static Instant from(TemporalAccessor temporalAccessor) {
        try {
            ...
            throw new DateTimeException(GeneratedOutlineSupport.outline15(temporalAccessor, GeneratedOutlineSupport.outline21("Unable to obtain Instant from TemporalAccessor: ", temporalAccessor, ", type ")), e);
        }
    }
    ...
    public static Instant ofEpochMilli(long j) {
        return create(MoreExecutors.floorDiv(j, 1000), MoreExecutors.floorMod(j, (int) RNCWebViewManager.COMMAND_CLEAR_FORM_DATA) * 1000000);
    }
    ...
    public int compareTo(Instant instant) {
        ...
        int compareLongs = MoreExecutors.compareLongs(this.seconds, instant2.seconds);
    ...
    public int get(TemporalField temporalField) {
        ...
        if (ordinal == 2) {
            return this.nanos / RNCWebViewManager.COMMAND_CLEAR_FORM_DATA;
        }
        if (ordinal == 4) {
    ...
    public long getLong(TemporalField temporalField) {
        ...
        if (ordinal == 0) {
            ...
            i = this.nanos / RNCWebViewManager.COMMAND_CLEAR_FORM_DATA;
        } else if (ordinal == 4) {
    ...
    public long toEpochMilli() {
        long j = this.seconds;
        if (j >= 0) {
            return MoreExecutors.safeAdd(MoreExecutors.safeMultiply(j, 1000L), (long) (this.nanos / 1000000));
        }
        return MoreExecutors.safeSubtract(MoreExecutors.safeMultiply(j + 1, 1000L), 1000 - ((long) (this.nanos / 1000000)));
    }
    ...
    public String toString() {
        ...
        if (dateTimeFormatter != null) {
            ...
            MoreExecutors.requireNonNull(this, "temporal");
            MoreExecutors.requireNonNull(sb, "appendable");
            try {
    ...
    public Instant plus(long j, TemporalUnit temporalUnit) {
        ...
        switch (((ChronoUnit) temporalUnit).ordinal()) {
            ...
            case 3:
                return plus(j, 0);
            case 4:
                return plusSeconds(MoreExecutors.safeMultiply(j, 60));
            case 5:
                return plusSeconds(MoreExecutors.safeMultiply(j, 3600));
            case 6:
                return plusSeconds(MoreExecutors.safeMultiply(j, 43200));
            case 7:
                return plusSeconds(MoreExecutors.safeMultiply(j, 86400));
            default:
    ...
    public Temporal with(TemporalField temporalField, long j) {
        ...
        if (ordinal != 0) {
            if (ordinal == 2) {
                int i = ((int) j) * RNCWebViewManager.COMMAND_CLEAR_FORM_DATA;
                if (i != this.nanos) {
    ...
    public final Instant plus(long j, long j2) {
        ...
        return ofEpochSecond(MoreExecutors.safeAdd(MoreExecutors.safeAdd(this.seconds, j), j2 / Http2Connection.DEGRADED_PONG_TIMEOUT_NS), ((long) this.nanos) + (j2 % Http2Connection.DEGRADED_PONG_TIMEOUT_NS));
    }
}
