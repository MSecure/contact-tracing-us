...
public final class LocalDateTime extends ChronoLocalDateTime<LocalDate> implements Temporal, TemporalAdjuster, Serializable {
    ...
    public static LocalDateTime from(TemporalAccessor temporalAccessor) {
        ...
        try {
            ...
            throw new DateTimeException(GeneratedOutlineSupport.outline15(temporalAccessor, GeneratedOutlineSupport.outline21("Unable to obtain LocalDateTime from TemporalAccessor: ", temporalAccessor, ", type ")));
        }
    }
    ...
    public static LocalDateTime ofEpochSecond(long j, int i, ZoneOffset zoneOffset) {
        ...
        return new LocalDateTime(LocalDate.ofEpochDay(MoreExecutors.floorDiv(j2, 86400)), LocalTime.ofSecondOfDay((long) MoreExecutors.floorMod(j2, 86400), i));
    }
    ...
    public final LocalDateTime plusWithOverflow(LocalDate localDate, long j, long j2, long j3, long j4, int i) {
        ...
        long j7 = (long) i;
        long j8 = ((j % 24) * 3600000000000L) + ((j2 % 1440) * 60000000000L) + ((j3 % 86400) * Http2Connection.DEGRADED_PONG_TIMEOUT_NS) + (j4 % 86400000000000L);
        long nanoOfDay = this.time.toNanoOfDay();
        long j9 = (j8 * j7) + nanoOfDay;
        long floorDiv = MoreExecutors.floorDiv(j9, 86400000000000L) + (j6 * j7);
        long floorMod = MoreExecutors.floorMod(j9, 86400000000000L);
