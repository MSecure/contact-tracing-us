...
public final class LocalTime extends DefaultInterfaceTemporalAccessor implements Temporal, TemporalAdjuster, Comparable<LocalTime>, Serializable {
    ...
    public static LocalTime from(TemporalAccessor temporalAccessor) {
        ...
        throw new DateTimeException(GeneratedOutlineSupport.outline15(temporalAccessor, GeneratedOutlineSupport.outline21("Unable to obtain LocalTime from TemporalAccessor: ", temporalAccessor, ", type ")));
    }
    ...
    public static LocalTime ofNanoOfDay(long j) {
        ...
        return create(i, i2, i3, (int) (j3 - (((long) i3) * Http2Connection.DEGRADED_PONG_TIMEOUT_NS)));
    }
    ...
    public final int get0(TemporalField temporalField) {
        switch (((ChronoField) temporalField).ordinal()) {
            ...
            case 2:
                return this.nano / RNCWebViewManager.COMMAND_CLEAR_FORM_DATA;
            case 3:
                throw new DateTimeException(GeneratedOutlineSupport.outline12("Field too large for an int: ", temporalField));
            case 4:
    ...
    public LocalTime plusNanos(long j) {
        ...
        return create((int) (j2 / 3600000000000L), (int) ((j2 / 60000000000L) % 60), (int) ((j2 / Http2Connection.DEGRADED_PONG_TIMEOUT_NS) % 60), (int) (j2 % Http2Connection.DEGRADED_PONG_TIMEOUT_NS));
    }
    ...
    public long toNanoOfDay() {
        return (((long) this.second) * Http2Connection.DEGRADED_PONG_TIMEOUT_NS) + (((long) this.minute) * 60000000000L) + (((long) this.hour) * 3600000000000L) + ((long) this.nano);
    }
    ...
    public int compareTo(LocalTime localTime) {
        int compareInts = MoreExecutors.compareInts(this.hour, localTime.hour);
        if (compareInts != 0) {
            return compareInts;
        }
        int compareInts2 = MoreExecutors.compareInts(this.minute, localTime.minute);
        if (compareInts2 != 0) {
            return compareInts2;
        }
        int compareInts3 = MoreExecutors.compareInts(this.second, localTime.second);
        return compareInts3 == 0 ? MoreExecutors.compareInts(this.nano, localTime.nano) : compareInts3;
    }
    ...
    public LocalTime with(TemporalField temporalField, long j) {
        ...
        switch (chronoField.ordinal()) {
            ...
            case 2:
                return withNano(((int) j) * RNCWebViewManager.COMMAND_CLEAR_FORM_DATA);
            case 3:
