...
public final class OffsetTime extends DefaultInterfaceTemporalAccessor implements Temporal, TemporalAdjuster, Comparable<OffsetTime>, Serializable {
    ...
    public int compareTo(OffsetTime offsetTime) {
        ...
        int compareLongs = MoreExecutors.compareLongs(this.time.toNanoOfDay() - (((long) this.offset.totalSeconds) * Http2Connection.DEGRADED_PONG_TIMEOUT_NS), offsetTime2.time.toNanoOfDay() - (((long) offsetTime2.offset.totalSeconds) * Http2Connection.DEGRADED_PONG_TIMEOUT_NS));
