...
public final class HijrahChronology extends Chronology implements Serializable {
    ...
    static {
        ERA_NARROW_NAMES.put(BuildConfig.SUPPORTED_LOCALES, new String[]{"BH", "HE"});
        ERA_SHORT_NAMES.put(BuildConfig.SUPPORTED_LOCALES, new String[]{"B.H.", "H.E."});
        ERA_FULL_NAMES.put(BuildConfig.SUPPORTED_LOCALES, new String[]{"Before Hijrah", "Hijrah Era"});
    }
