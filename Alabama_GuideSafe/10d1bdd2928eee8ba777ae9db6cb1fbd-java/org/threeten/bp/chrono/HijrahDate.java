...
public final class HijrahDate extends ChronoDateImpl<HijrahDate> implements Serializable {
    ...
    static {
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("org");
        outline17.append(FILE_SEP);
        outline17.append("threeten");
        outline17.append(FILE_SEP);
        outline17.append("bp");
        outline17.append(FILE_SEP);
        outline17.append("chrono");
        DEFAULT_CONFIG_PATH = outline17.toString();
        int i = 0;
        int i2 = 0;
        while (true) {
            int[] iArr = NUM_DAYS;
    ...
    public static void checkValidDayOfMonth(int i) {
        if (i < 1 || i > ADJUSTED_MAX_VALUES[5].intValue()) {
            StringBuilder outline18 = GeneratedOutlineSupport.outline18("Invalid day of month of Hijrah date, day ", i, " greater than ");
            outline18.append(ADJUSTED_MAX_VALUES[5].intValue());
            outline18.append(" or less than 1");
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                if (parseInt2 == -1 || parseInt3 == -1 || parseInt4 == -1 || parseInt5 == -1) {
                                                    throw new ParseException(GeneratedOutlineSupport.outline6("Unknown error at line ", i, "."), i);
                                                } else if (parseInt2 < 1) {
                                                ...
                                                throw new ParseException(GeneratedOutlineSupport.outline6("End month is not properly set at line ", i, "."), i);
                                            }
                                        } catch (NumberFormatException unused2) {
                                            throw new ParseException(GeneratedOutlineSupport.outline6("End year is not properly set at line ", i, "."), i);
                                        }
                                    } else {
                                        throw new ParseException(GeneratedOutlineSupport.outline6("End year/month has incorrect format at line ", i, "."), i);
                                    }
                                } catch (NumberFormatException unused3) {
                                    throw new ParseException(GeneratedOutlineSupport.outline6("Start month is not properly set at line ", i, "."), i);
                                }
                            } catch (NumberFormatException unused4) {
                                throw new ParseException(GeneratedOutlineSupport.outline6("Start year is not properly set at line ", i, "."), i);
                            }
                        } else {
                            throw new ParseException(GeneratedOutlineSupport.outline6("Start year/month has incorrect format at line ", i, "."), i);
                        }
                    } else {
                        throw new ParseException(GeneratedOutlineSupport.outline6("Start and end year/month has incorrect format at line ", i, "."), i);
                    }
                } catch (NumberFormatException unused5) {
                    throw new ParseException(GeneratedOutlineSupport.outline6("Offset is not properly set at line ", i, "."), i);
                }
            } else {
                throw new ParseException(GeneratedOutlineSupport.outline6("Offset has incorrect format at line ", i, "."), i);
            }
        }
    }
    ...
    public static void readDeviationConfig() throws IOException, ParseException {
        ...
        if (property2 == null) {
            ...
            while (true) {
                ...
                if (file.exists()) {
                    if (file.isDirectory()) {
                        StringBuilder outline17 = GeneratedOutlineSupport.outline17(nextToken);
                        outline17.append(FILE_SEP);
                        outline17.append(DEFAULT_CONFIG_PATH);
                        if (new File(outline17.toString(), property).exists()) {
                            try {
            ...
            if (property2.length() != 0 || !property2.endsWith(System.getProperty("file.separator"))) {
                StringBuilder outline172 = GeneratedOutlineSupport.outline17(property2);
                outline172.append(System.getProperty("file.separator"));
                property2 = outline172.toString();
            }
            StringBuilder outline173 = GeneratedOutlineSupport.outline17(property2);
            outline173.append(FILE_SEP);
            outline173.append(property);
            File file2 = new File(outline173.toString());
            if (file2.exists()) {
                try {
    ...
    public ChronoDateImpl<HijrahDate> plusMonths(long j) {
        ...
        return of(this.era, MoreExecutors.safeAdd(this.yearOfEra, i2), i3 + 1, this.dayOfMonth);
    }
    ...
    public ChronoDateImpl<HijrahDate> plusYears(long j) {
        ...
        return of(this.era, MoreExecutors.safeAdd(this.yearOfEra, (int) j), this.monthOfYear, this.dayOfMonth);
    }
    ...
    public Temporal m14minus(long j, TemporalUnit temporalUnit) {
        return (HijrahDate) super.minus(j, temporalUnit);
    }
    ...
    public ChronoDateImpl<HijrahDate> m17plusDays(long j) {
        return new HijrahDate(this.gregorianEpochDay + j);
    }

    public static HijrahDate of(HijrahEra hijrahEra, int i, int i2, int i3) {
        MoreExecutors.requireNonNull(hijrahEra, "era");
        if (i < 1 || i > 9999) {
            throw new DateTimeException("Invalid year of Hijrah Era");
        } else if (i2 < 1 || i2 > 12) {
            throw new DateTimeException("Invalid month of Hijrah date");
    ...
    @Override // org.threeten.bp.temporal.Temporal, org.threeten.bp.chrono.ChronoLocalDate, org.threeten.bp.chrono.ChronoLocalDate, org.threeten.bp.chrono.ChronoDateImpl, org.threeten.bp.chrono.ChronoDateImpl, org.threeten.bp.chrono.ChronoDateImpl
    /* renamed from: plus  reason: collision with other method in class */
    public ChronoDateImpl<HijrahDate> m16plus(long j, TemporalUnit temporalUnit) {
        return (HijrahDate) super.plus(j, temporalUnit);
    }
    ...
    public Temporal m18with(TemporalAdjuster temporalAdjuster) {
    ...
    public HijrahDate with(TemporalField temporalField, long j) {
        ...
        switch (chronoField.ordinal()) {
            case 15:
                return m17plusDays(j - ((long) this.dayOfWeek.getValue()));
            case 16:
                return m17plusDays(j - getLong(ChronoField.ALIGNED_DAY_OF_WEEK_IN_MONTH));
            case 17:
                return m17plusDays(j - getLong(ChronoField.ALIGNED_DAY_OF_WEEK_IN_YEAR));
            case 18:
            ...
            case 21:
                return m17plusDays((j - getLong(ChronoField.ALIGNED_WEEK_OF_MONTH)) * 7);
            case 22:
                return m17plusDays((j - getLong(ChronoField.ALIGNED_WEEK_OF_YEAR)) * 7);
            case 23:
