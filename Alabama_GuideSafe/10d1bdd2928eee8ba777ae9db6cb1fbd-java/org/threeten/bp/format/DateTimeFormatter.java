...
public final class DateTimeFormatter {
    ...
    public DateTimeFormatter(DateTimeFormatterBuilder.CompositePrinterParser compositePrinterParser, Locale locale2, DecimalStyle decimalStyle2, ResolverStyle resolverStyle2, Set<TemporalField> set, Chronology chronology, ZoneId zoneId) {
        MoreExecutors.requireNonNull(compositePrinterParser, "printerParser");
        this.printerParser = compositePrinterParser;
        MoreExecutors.requireNonNull(locale2, "locale");
        this.locale = locale2;
        MoreExecutors.requireNonNull(decimalStyle2, "decimalStyle");
        this.decimalStyle = decimalStyle2;
        MoreExecutors.requireNonNull(resolverStyle2, "resolverStyle");
    ...
    public DateTimeFormatter withChronology(Chronology chronology) {
        if (MoreExecutors.equals1(this.chrono, chronology)) {
            return this;
        }
