...
public final class DateTimeFormatterBuilder {
    ...
    public static final class FractionPrinterParser implements DateTimePrinterParser {
        ...
        public FractionPrinterParser(TemporalField temporalField, int i, int i2, boolean z) {
            MoreExecutors.requireNonNull(temporalField, "field");
            ValueRange range = temporalField.range();
            if (!(range.minSmallest == range.minLargest && range.maxSmallest == range.maxLargest)) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline12("Field must have a fixed set of values: ", temporalField));
            } else if (i < 0 || i > 9) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("Minimum width must be from 0 to 9 inclusive but was ", i));
            } else if (i2 < 1 || i2 > 9) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("Maximum width must be from 1 to 9 inclusive but was ", i2));
            } else if (i2 >= i) {
        ...
        public String toString() {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Fraction(");
            outline17.append(this.field);
            outline17.append(",");
            outline17.append(this.minWidth);
            outline17.append(",");
            outline17.append(this.maxWidth);
    ...
    public static final class InstantPrinterParser implements DateTimePrinterParser {
        ...
        public boolean print(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            if (longValue >= -62167219200L) {
                ...
                long floorDiv = MoreExecutors.floorDiv(j, 315569520000L) + 1;
                LocalDateTime ofEpochSecond = LocalDateTime.ofEpochSecond(MoreExecutors.floorMod(j, 315569520000L) - 62167219200L, 0, ZoneOffset.UTC);
                if (floorDiv > 0) {
                    sb.append('+');
                    sb.append(floorDiv);
                }
            ...
            if (i2 == -2) {
                if (checkValidIntValue != 0) {
                    ...
                    if (checkValidIntValue % 1000000 == 0) {
                        sb.append(Integer.toString((checkValidIntValue / 1000000) + RNCWebViewManager.COMMAND_CLEAR_FORM_DATA).substring(1));
                    } else if (checkValidIntValue % RNCWebViewManager.COMMAND_CLEAR_FORM_DATA == 0) {
                        sb.append(Integer.toString((checkValidIntValue / RNCWebViewManager.COMMAND_CLEAR_FORM_DATA) + 1000000).substring(1));
                    } else {
    ...
    public static final class OffsetIdPrinterParser implements DateTimePrinterParser {
        ...
        public OffsetIdPrinterParser(String str, String str2) {
            MoreExecutors.requireNonNull(str, "noOffsetText");
            MoreExecutors.requireNonNull(str2, "pattern");
            this.noOffsetText = str;
            int i = 0;
            while (true) {
                String[] strArr = PATTERNS;
                if (i >= strArr.length) {
                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Invalid zone offset pattern: ", str2));
        ...
        public boolean print(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            if (longValue > 2147483647L || longValue < -2147483648L) {
                throw new ArithmeticException(GeneratedOutlineSupport.outline7("Calculation overflows an int: ", longValue));
            }
            int i = (int) longValue;
            if (i == 0) {
        ...
        public String toString() {
            ...
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Offset(");
            outline17.append(PATTERNS[this.type]);
            outline17.append(",'");
    ...
    public static final class PadPrinterParserDecorator implements DateTimePrinterParser {
        ...
        public boolean print(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            StringBuilder outline18 = GeneratedOutlineSupport.outline18("Cannot print as output of ", length2, " characters exceeds pad width of ");
            outline18.append(this.padWidth);
            throw new DateTimeException(outline18.toString());
        }

        public String toString() {
            String str;
            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Pad(");
            outline17.append(this.printerParser);
            outline17.append(",");
            outline17.append(this.padWidth);
            if (this.padChar == ' ') {
                str = ")";
            } else {
                StringBuilder outline172 = GeneratedOutlineSupport.outline17(",'");
                outline172.append(this.padChar);
                outline172.append("')");
    ...
    public static final class StringLiteralPrinterParser implements DateTimePrinterParser {
        ...
        public String toString() {
            return GeneratedOutlineSupport.outline11("'", this.literal.replace("'", "''"), "'");
        }
    }
    ...
    public static final class TextPrinterParser implements DateTimePrinterParser {
        ...
        public String toString() {
            if (this.textStyle == TextStyle.FULL) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Text(");
                outline17.append(this.field);
                outline17.append(")");
                return outline17.toString();
            }
            StringBuilder outline172 = GeneratedOutlineSupport.outline17("Text(");
            outline172.append(this.field);
            outline172.append(",");
            outline172.append(this.textStyle);
            outline172.append(")");
    ...
    public static final class ZoneIdPrinterParser implements DateTimePrinterParser {
        ...
        public boolean print(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            if (query2 == null && dateTimePrintContext.optional == 0) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Unable to extract value: ");
                outline17.append(dateTimePrintContext.temporal.getClass());
    ...
    public DateTimeFormatterBuilder append(DateTimeFormatter dateTimeFormatter) {
        MoreExecutors.requireNonNull(dateTimeFormatter, "formatter");
    ...
    public final int appendInternal(DateTimePrinterParser dateTimePrinterParser) {
        MoreExecutors.requireNonNull(dateTimePrinterParser, "pp");
    ...
    public DateTimeFormatterBuilder appendText(TemporalField temporalField, Map<Long, String> map) {
        ...
        MoreExecutors.requireNonNull(temporalField, "field");
        MoreExecutors.requireNonNull(map, "textLookup");
    ...
    public DateTimeFormatterBuilder appendValue(TemporalField temporalField, int i) {
        MoreExecutors.requireNonNull(temporalField, "field");
        if (i < 1 || i > 19) {
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("The width must be from 1 to 19 inclusive but was ", i));
        }
    ...
    public DateTimeFormatter toFormatter() {
        ...
        MoreExecutors.requireNonNull(locale, "locale");
    ...
    public DateTimeFormatterBuilder appendLiteral(String str) {
        MoreExecutors.requireNonNull(str, "literal");
        if (str.length() > 0) {
            if (str.length() == 1) {
    ...
    public DateTimeFormatterBuilder appendValue(TemporalField temporalField, int i, int i2, SignStyle signStyle) {
        ...
        MoreExecutors.requireNonNull(temporalField, "field");
        MoreExecutors.requireNonNull(signStyle, "signStyle");
        if (i < 1 || i > 19) {
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("The minimum width must be from 1 to 19 inclusive but was ", i));
        } else if (i2 < 1 || i2 > 19) {
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("The maximum width must be from 1 to 19 inclusive but was ", i2));
        } else if (i2 >= i) {
    ...
    public static class NumberPrinterParser implements DateTimePrinterParser {
        public static final int[] EXCEED_POINTS = {0, 10, 100, RNCWebViewManager.COMMAND_CLEAR_FORM_DATA, 10000, 100000, 1000000, 10000000, NetworkingModule.CHUNK_TIMEOUT_NS, 1000000000};
        public final TemporalField field;
        public final int maxWidth;
        public final int minWidth;
        ...
        public boolean print(DateTimePrintContext dateTimePrintContext, StringBuilder sb) {
            ...
            if (str.length() <= this.maxWidth) {
                ...
                if (longValue >= 0) {
                    ...
                    if (!(ordinal2 == 0 || ordinal2 == 1)) {
                        if (ordinal2 == 3) {
                            StringBuilder outline17 = GeneratedOutlineSupport.outline17("Field ");
                            outline17.append(this.field);
                            outline17.append(" cannot be printed as the value ");
                            outline17.append(longValue);
                            outline17.append(" cannot be negative according to the SignStyle");
                            throw new DateTimeException(outline17.toString());
                        }
                    }
            ...
            StringBuilder outline172 = GeneratedOutlineSupport.outline17("Field ");
            outline172.append(this.field);
            outline172.append(" cannot be printed as the value ");
            outline172.append(longValue);
            outline172.append(" exceeds the maximum print width of ");
            outline172.append(this.maxWidth);
            throw new DateTimeException(outline172.toString());
        }

        public String toString() {
            if (this.minWidth == 1 && this.maxWidth == 19 && this.signStyle == SignStyle.NORMAL) {
                StringBuilder outline17 = GeneratedOutlineSupport.outline17("Value(");
                outline17.append(this.field);
                outline17.append(")");
                return outline17.toString();
            } else if (this.minWidth == this.maxWidth && this.signStyle == SignStyle.NOT_NEGATIVE) {
                StringBuilder outline172 = GeneratedOutlineSupport.outline17("Value(");
                outline172.append(this.field);
                outline172.append(",");
                return GeneratedOutlineSupport.outline13(outline172, this.minWidth, ")");
            } else {
                StringBuilder outline173 = GeneratedOutlineSupport.outline17("Value(");
                outline173.append(this.field);
                outline173.append(",");
                outline173.append(this.minWidth);
                outline173.append(",");
                outline173.append(this.maxWidth);
                outline173.append(",");
                outline173.append(this.signStyle);
                outline173.append(")");
    ...
    public DateTimeFormatter toFormatter(ResolverStyle resolverStyle) {
        ...
        MoreExecutors.requireNonNull(resolverStyle, "resolverStyle");
        return MoreExecutors.equals1(formatter.resolverStyle, resolverStyle) ? formatter : new DateTimeFormatter(formatter.printerParser, formatter.locale, formatter.decimalStyle, resolverStyle, formatter.resolverFields, formatter.chrono, formatter.zone);
    }
