...
public enum ChronoField implements TemporalField {
    ...
    YEAR_OF_ERA("YearOfEra", ChronoUnit.YEARS, ChronoUnit.FOREVER, ValueRange.of(1, 999999999, Http2Connection.DEGRADED_PONG_TIMEOUT_NS)),
    ...
    INSTANT_SECONDS("InstantSeconds", ChronoUnit.SECONDS, ChronoUnit.FOREVER, ValueRange.of(Long.MIN_VALUE, RecyclerView.FOREVER_NS)),
