...
public final class StandardZoneRules extends ZoneRules implements Serializable {
    ...
    public ZoneOffset getOffset(Instant instant) {
        ...
        if (this.lastRules.length > 0) {
            ...
            if (j > jArr[jArr.length - 1]) {
                ...
                ZoneOffsetTransition[] findTransitionArray = findTransitionArray(LocalDate.ofEpochDay(MoreExecutors.floorDiv(((long) zoneOffsetArr[zoneOffsetArr.length - 1].totalSeconds) + j, 86400)).year);
    ...
    public String toString() {
        StringBuilder outline17 = GeneratedOutlineSupport.outline17("StandardZoneRules[currentStandardOffset=");
        ZoneOffset[] zoneOffsetArr = this.standardOffsets;
        outline17.append(zoneOffsetArr[zoneOffsetArr.length - 1]);
        outline17.append("]");
