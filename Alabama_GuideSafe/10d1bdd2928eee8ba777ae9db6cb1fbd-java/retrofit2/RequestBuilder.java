    ...
    public void addHeader(String str, String str2) {
        if ("Content-Type".equalsIgnoreCase(str)) {
            try {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline10("Malformed content type: ", str2), e);
            }
        } else {
    ...
    public void addQueryParam(String str, String str2, boolean z) {
        ...
        if (str3 != null) {
            ...
            if (newBuilder != null) {
                ...
                outline17.append(this.baseUrl);
                outline17.append(", Relative: ");
                outline17.append(this.relativeUrl);
