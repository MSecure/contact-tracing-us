...
public class ActionMenuItemView extends z implements n.a, View.OnClickListener, ActionMenuView.a {
    ...
    public class a extends h0 {
        ...
        public p b() {
            c.a aVar;
            b bVar = ActionMenuItemView.this.f44l;
        ...
        public boolean c() {
            ...
            g.b bVar = actionMenuItemView.f42j;
            return bVar != null && bVar.a(actionMenuItemView.f39g) && (b = b()) != null && b.c();
        }
    }
    ...
    @Override // androidx.appcompat.widget.ActionMenuView.a
    public boolean b() {
        return c() && this.f39g.getIcon() == null;
    }
    ...
    public void d(i iVar, int i2) {
        ...
        if (iVar.hasSubMenu() && this.f43k == null) {
            this.f43k = new a();
        }
    }
    ...
    public final void f() {
        boolean z = true;
        boolean z2 = !TextUtils.isEmpty(this.f40h);
        if (this.f41i != null) {
            if (!((this.f39g.y & 4) == 4) || (!this.m && !this.n)) {
                z = false;
            }
        }
        boolean z3 = z2 & z;
        CharSequence charSequence = null;
        setText(z3 ? this.f40h : null);
        CharSequence charSequence2 = this.f39g.q;
        if (TextUtils.isEmpty(charSequence2)) {
            if (z3) {
                charSequence2 = null;
            } else {
                charSequence2 = this.f39g.f791e;
            }
        }
        setContentDescription(charSequence2);
        CharSequence charSequence3 = this.f39g.r;
        if (TextUtils.isEmpty(charSequence3)) {
            if (!z3) {
                charSequence = this.f39g.f791e;
            }
            m.h.n1(this, charSequence);
            return;
        }
        m.h.n1(this, charSequence3);
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (!c && this.f41i != null) {
            super.setPadding((getMeasuredWidth() - this.f41i.getBounds().width()) / 2, getPaddingTop(), getPaddingRight(), getPaddingBottom());
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        h0 h0Var;
        if (!this.f39g.hasSubMenu() || (h0Var = this.f43k) == null || !h0Var.onTouch(this, motionEvent)) {
