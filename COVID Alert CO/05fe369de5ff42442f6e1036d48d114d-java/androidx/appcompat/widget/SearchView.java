...
public class SearchView extends i0 implements e.b.e.b {
    ...
    public static class SearchAutoComplete extends e.b.f.d {
        ...
        public int f84e = getThreshold();

        /* renamed from: f  reason: collision with root package name */
        public SearchView f85f;

        /* renamed from: g  reason: collision with root package name */
        public boolean f86g;

        /* renamed from: h  reason: collision with root package name */
        public final Runnable f87h = new a();
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                if (searchAutoComplete.f86g) {
                    ((InputMethodManager) searchAutoComplete.getContext().getSystemService("input_method")).showSoftInput(searchAutoComplete, 0);
                    searchAutoComplete.f86g = false;
                }
            }
        }
        ...
        public boolean enoughToFilter() {
            return this.f84e <= 0 || super.enoughToFilter();
        }
        ...
        public void onWindowFocusChanged(boolean z) {
            ...
            if (z && this.f85f.hasFocus() && getVisibility() == 0) {
                boolean z2 = true;
                this.f86g = true;
    ...
    public static class o extends e.k.a.a {
        ...
        public o(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f88d = ((Boolean) parcel.readValue(null)).booleanValue();
        }
        ...
        public String toString() {
            StringBuilder i2 = f.a.a.a.a.i("SearchView.SavedState{");
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeValue(Boolean.valueOf(this.f88d));
        }
    }
    ...
    public static class p extends TouchDelegate {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final Rect f89d = new Rect();
        ...
        public p(Rect rect, Rect rect2, View view) {
            super(rect, view);
            this.f90e = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
            a(rect, rect2);
            this.a = view;
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i2) {
        ...
        m.h.n1(imageView, getResources().getString(R$string.abc_searchview_description_search));
