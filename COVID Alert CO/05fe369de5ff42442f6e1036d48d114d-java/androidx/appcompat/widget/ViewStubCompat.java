...
public final class ViewStubCompat extends View {
    ...
    public WeakReference<View> f104d;

    /* renamed from: e  reason: collision with root package name */
    public LayoutInflater f105e;
    ...
    public View a() {
        ...
        if (!(parent instanceof ViewGroup)) {
            ...
            LayoutInflater layoutInflater = this.f105e;
            ...
            this.f104d = new WeakReference<>(inflate);
            a aVar = this.f106f;
            if (aVar != null) {
                aVar.a(this, inflate);
            }
    ...
    public void setVisibility(int i2) {
        WeakReference<View> weakReference = this.f104d;
