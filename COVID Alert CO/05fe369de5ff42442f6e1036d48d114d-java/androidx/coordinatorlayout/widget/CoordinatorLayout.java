...
public class CoordinatorLayout extends ViewGroup implements e.i.i.h, e.i.i.i {
    ...
    public final List<View> f133d = new ArrayList();

    /* renamed from: e  reason: collision with root package name */
    public final List<View> f134e = new ArrayList();

    /* renamed from: f  reason: collision with root package name */
    public Paint f135f;

    /* renamed from: g  reason: collision with root package name */
    public final int[] f136g = new int[2];

    /* renamed from: h  reason: collision with root package name */
    public final int[] f137h = new int[2];
    ...
    public static class f extends ViewGroup.MarginLayoutParams {
        ...
        public f(Context context, AttributeSet attributeSet) {
            ...
            this.f144f = obtainStyledAttributes.getResourceId(R$styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.f142d = obtainStyledAttributes.getInteger(R$styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.f143e = obtainStyledAttributes.getInteger(R$styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.f145g = obtainStyledAttributes.getInt(R$styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.f146h = obtainStyledAttributes.getInt(R$styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            ...
            if (hasValue) {
                ...
                if (TextUtils.isEmpty(string)) {
                    ...
                    try {
                        ...
                        throw new RuntimeException(f.a.a.a.a.c("Could not inflate Behavior subclass ", string), e2);
                    }
                }
                this.a = cVar;
            }
    ...
    public static class h extends e.k.a.a {
        ...
        /* renamed from: d  reason: collision with root package name */
        public SparseArray<Parcelable> f151d;
        ...
        public h(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f151d = new SparseArray<>(readInt);
            for (int i2 = 0; i2 < readInt; i2++) {
                this.f151d.append(iArr[i2], readParcelableArray[i2]);
            }
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            SparseArray<Parcelable> sparseArray = this.f151d;
            int size = sparseArray != null ? sparseArray.size() : 0;
            parcel.writeInt(size);
            int[] iArr = new int[size];
            Parcelable[] parcelableArr = new Parcelable[size];
            for (int i3 = 0; i3 < size; i3++) {
                iArr[i3] = this.f151d.keyAt(i3);
                parcelableArr[i3] = this.f151d.valueAt(i3);
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet) {
        ...
        if (resourceId != 0) {
            ...
            this.f140k = resources.getIntArray(resourceId);
            float f2 = resources.getDisplayMetrics().density;
            int length = this.f140k.length;
            for (int i3 = 0; i3 < length; i3++) {
                int[] iArr2 = this.f140k;
    ...
    public boolean drawChild(Canvas canvas, View view, long j2) {
        ...
        if (cVar != null) {
            ...
            if (c2 > 0.0f) {
                ...
                this.f135f.setColor(fVar.a.b());
                Paint paint = this.f135f;
                ...
                canvas.drawRect((float) getPaddingLeft(), (float) getPaddingTop(), (float) (getWidth() - getPaddingRight()), (float) (getHeight() - getPaddingBottom()), this.f135f);
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (fVar.a(i6) && (cVar = fVar.a) != null) {
                    ...
                    i8 = i5 > 0 ? Math.max(i8, this.f136g[1]) : Math.min(i8, this.f136g[1]);
                    z2 = true;
                }
            }
        }
    ...
    public void n(View view, int i2, int i3, int i4, int i5, int i6) {
        m(view, i2, i3, i4, i5, 0, this.f137h);
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        SparseArray<Parcelable> sparseArray = hVar.f151d;
        int childCount = getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        c cVar = ((f) this.f141l.getLayoutParams()).a;
        if (cVar != null) {
            z2 = cVar.A(this, this.f141l, motionEvent);
            motionEvent2 = null;
            if (this.f141l != null) {
    ...
    public final void q(int i2) {
        ...
        while (i14 < size) {
            ...
            if (i2 == 0 && view.getVisibility() == 8) {
                ...
                i3 = i14;
                c(view, true, a3);
                if (fVar2.f145g != 0 && !a3.isEmpty()) {
                    int absoluteGravity = Gravity.getAbsoluteGravity(fVar2.f145g, layoutDirection);
                ...
                if (fVar2.f146h != 0 && view.getVisibility() == 0) {
                    ...
                    if (view.isLaidOut() && view.getWidth() > 0 && view.getHeight() > 0) {
                        ...
                        if (cVar2 == null || !cVar2.a(this, view, a8)) {
                            ...
                            StringBuilder i20 = f.a.a.a.a.i("Rect should be within the child's bounds. Rect:");
                            i20.append(a8.toShortString());
                            i20.append(" | Bounds:");
                            i20.append(a9.toShortString());
                        ...
                        bVar2.b(a9);
                        if (!a8.isEmpty()) {
                            int absoluteGravity2 = Gravity.getAbsoluteGravity(fVar4.f146h, layoutDirection);
                            if ((absoluteGravity2 & 48) != 48 || (i9 = (a8.top - ((ViewGroup.MarginLayoutParams) fVar4).topMargin) - fVar4.f148j) >= (i10 = a2.top)) {
                                z3 = false;
                            } else {
                                x(view, i10 - i9);
                                z3 = true;
                            }
                            if ((absoluteGravity2 & 80) == 80 && (height = ((getHeight() - a8.bottom) - ((ViewGroup.MarginLayoutParams) fVar4).bottomMargin) + fVar4.f148j) < (i8 = a2.bottom)) {
                                x(view, height - i8);
                                z3 = true;
                            }
                            if (!z3) {
                            ...
                            if ((absoluteGravity2 & 3) != 3 || (i6 = (a8.left - ((ViewGroup.MarginLayoutParams) fVar4).leftMargin) - fVar4.f147i) >= (i7 = a2.left)) {
                                z4 = false;
                            } else {
                                w(view, i7 - i6);
                                z4 = true;
                            }
                            if ((absoluteGravity2 & 5) == 5 && (width = ((getWidth() - a8.right) - ((ViewGroup.MarginLayoutParams) fVar4).rightMargin) + fVar4.f147i) < (i5 = a2.right)) {
                                w(view, width - i5);
                                z4 = true;
                            }
                            if (!z4) {
    ...
    public void r(View view, int i2) {
        f fVar = (f) view.getLayoutParams();
        View view2 = fVar.f149k;
        int i3 = 0;
        if (view2 == null && fVar.f144f != -1) {
    ...
    public void setStatusBarBackground(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawable3 != null) {
                ...
                AtomicInteger atomicInteger = m.a;
                m.h.f1(drawable4, getLayoutDirection());
    ...
    public final void u() {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (l2.f144f == -1) {
                ...
                View findViewById = findViewById(l2.f144f);
                l2.f149k = findViewById;
                if (findViewById != null) {
                    if (findViewById != this) {
                        ...
                        l2.f150l = findViewById;
                    } else if (!isInEditMode()) {
                        throw new IllegalStateException("View can not be anchored to the the parent CoordinatorLayout");
                    }
                } else if (!isInEditMode()) {
                    StringBuilder i5 = f.a.a.a.a.i("Could not find CoordinatorLayout descendant view with id ");
                    i5.append(getResources().getResourceName(l2.f144f));
                    i5.append(" to anchor view ");
                    i5.append(childAt);
            ...
            for (int i6 = 0; i6 < childCount; i6++) {
                if (i6 != i4) {
                    ...
                    if (childAt2 != l2.f150l) {
                        AtomicInteger atomicInteger = e.i.i.m.a;
                        int layoutDirection = getLayoutDirection();
                        int absoluteGravity = Gravity.getAbsoluteGravity(((f) childAt2.getLayoutParams()).f145g, layoutDirection);
                        if (!(absoluteGravity != 0 && (Gravity.getAbsoluteGravity(l2.f146h, layoutDirection) & absoluteGravity) == absoluteGravity) && ((cVar = l2.a) == null || !cVar.d(this, childAt, childAt2))) {
                            z2 = false;
                            if (!z2) {
                                continue;
                            } else {
        ...
        aVar3.c.clear();
        aVar3.f1207d.clear();
        int i7 = aVar3.b.f1022d;
        for (int i8 = 0; i8 < i7; i8++) {
            aVar3.b(aVar3.b.h(i8), aVar3.c, aVar3.f1207d);
        }
        list.addAll(aVar3.c);
