...
public class IconCompat extends CustomVersionedParcelable {
    ...
    public static final PorterDuff.Mode f155k = PorterDuff.Mode.SRC_IN;
    public int a = -1;
    public Object b;
    public byte[] c = null;

    /* renamed from: d  reason: collision with root package name */
    public Parcelable f156d = null;
    ...
    public ColorStateList f159g = null;

    /* renamed from: h  reason: collision with root package name */
    public PorterDuff.Mode f160h = f155k;

    /* renamed from: i  reason: collision with root package name */
    public String f161i = null;
    ...
    public Icon e() {
        ...
        switch (i3) {
            ...
            case 2:
                ...
                icon = Icon.createWithResource(str, this.f157e);
                break;
            case 3:
                icon = Icon.createWithData((byte[]) this.b, this.f157e, this.f158f);
                break;
            case 4:
            ...
            case 6:
                if (Build.VERSION.SDK_INT >= 30) {
                    ...
                    StringBuilder i4 = a.i("Context is required to resolve the file uri of the icon: ");
                    i4.append(d());
                    throw new IllegalArgumentException(i4.toString());
                }
        }
        ColorStateList colorStateList = this.f159g;
        if (colorStateList != null) {
            icon.setTintList(colorStateList);
        }
        PorterDuff.Mode mode = this.f160h;
        if (mode == f155k) {
            return icon;
        }
