...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public class a extends h.a {
        ...
        public void b(e.v.a.b bVar) {
            ...
            List<g.b> list = workDatabase_Impl.f1705h;
            if (list != null) {
                int size = list.size();
                for (int i3 = 0; i3 < size; i3++) {
                    Objects.requireNonNull(WorkDatabase_Impl.this.f1705h.get(i3));
                }
            }
        }
        ...
        public void d(e.v.a.b bVar) {
            ...
            List<g.b> list = WorkDatabase_Impl.this.f1705h;
            if (list != null) {
                int size = list.size();
                for (int i3 = 0; i3 < size; i3++) {
                    WorkDatabase_Impl.this.f1705h.get(i3).a(bVar);
                }
            }
        }
        ...
        public h.b g(e.v.a.b bVar) {
            ...
            hashSet2.add(new d.C0052d("index_Dependency_work_spec_id", false, Arrays.asList("work_spec_id")));
            hashSet2.add(new d.C0052d("index_Dependency_prerequisite_id", false, Arrays.asList("prerequisite_id")));
            ...
            hashSet4.add(new d.C0052d("index_WorkSpec_schedule_requested_at", false, Arrays.asList("schedule_requested_at")));
            hashSet4.add(new d.C0052d("index_WorkSpec_period_start_time", false, Arrays.asList("period_start_time")));
            ...
            hashSet6.add(new d.C0052d("index_WorkTag_work_spec_id", false, Arrays.asList("work_spec_id")));
            ...
            hashSet9.add(new d.C0052d("index_WorkName_work_spec_id", false, Arrays.asList("work_spec_id")));
