...
public abstract class ExposureNotificationDatabase extends e.t.g {
    ...
    public static final e.t.o.a f441k;

    /* renamed from: l  reason: collision with root package name */
    public static final e.t.o.a f442l;
    ...
    public static final e.t.o.a s;
    public static final e.t.o.a[] t;
    ...
    public class h extends e.t.o.a {
        ...
        @Override // e.t.o.a
        public void a(e.v.a.b bVar) {
            ((e.v.a.f.a) bVar).b.execSQL("CREATE TABLE VerificationCodeRequestEntity (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, requestTime INTEGER NOT NULL, expiresAtTime INTEGER, nonce TEXT NOT NULL)");
        }
    }

    public class i extends e.t.o.a {
        ...
        @Override // e.t.o.a
        public void a(e.v.a.b bVar) {
            ((e.v.a.f.a) bVar).b.execSQL("ALTER TABLE DiagnosisEntity ADD COLUMN isPreAuth INTEGER NOT NULL DEFAULT 0");
        }
    }
    ...
    static {
        ...
        i iVar = new i(43, 44);
        s = iVar;
        t = new e.t.o.a[]{aVar, bVar, cVar, dVar, eVar, fVar, gVar, hVar, iVar};
    }

    public abstract f.b.a.a.a.b0.c m();
