...
public final class ExposureNotificationDatabase_Impl extends ExposureNotificationDatabase {
    ...
    public class a extends h.a {
        ...
        public void b(b bVar) {
            ...
            List<g.b> list = ExposureNotificationDatabase_Impl.this.f1705h;
            if (list != null) {
                int size = list.size();
                for (int i2 = 0; i2 < size; i2++) {
                    Objects.requireNonNull(ExposureNotificationDatabase_Impl.this.f1705h.get(i2));
                }
            }
        }
        ...
        public void d(b bVar) {
            ...
            if (list != null) {
                int size = list.size();
                for (int i2 = 0; i2 < size; i2++) {
                    ExposureNotificationDatabase_Impl.this.f1705h.get(i2).a(bVar);
                }
            }
        }
    ...
    public f.b.a.a.a.b0.c m() {
        ...
        synchronized (this) {
            if (this.u == null) {
                this.u = new f.b.a.a.a.b0.d(this);
            }
            cVar = this.u;
        }
        return cVar;
