...
public final class DynamiteModule {
    ...
    public static g f464d = null;

    /* renamed from: e  reason: collision with root package name */
    public static String f465e = null;

    /* renamed from: f  reason: collision with root package name */
    public static int f466f = -1;

    /* renamed from: g  reason: collision with root package name */
    public static final ThreadLocal<c> f467g = new ThreadLocal<>();

    /* renamed from: h  reason: collision with root package name */
    public static final b.AbstractC0004b f468h = new f.b.a.c.d.a();
    @RecentlyNonNull

    /* renamed from: i  reason: collision with root package name */
    public static final b f469i = new f.b.a.c.d.b();
    ...
    public static DynamiteModule a(@RecentlyNonNull Context context, @RecentlyNonNull b bVar, @RecentlyNonNull String str) {
        Cursor cursor;
        ThreadLocal<c> threadLocal = f467g;
        c cVar = threadLocal.get();
        c cVar2 = new c(null);
        threadLocal.set(cVar2);
        try {
            b.a a2 = bVar.a(context, str, f468h);
            int i2 = a2.a;
            str.length();
            str.length();
            int i3 = a2.c;
    ...
    public static DynamiteModule h(Context context, String str, int i2) {
        ...
        if (gVar != null) {
            ...
            synchronized (DynamiteModule.class) {
                valueOf = Boolean.valueOf(f466f >= 2);
            }
            ...
            if (query != null) {
                try {
                    if (query.moveToFirst()) {
                        ...
                        if (i2 > 0) {
                            synchronized (DynamiteModule.class) {
                                f465e = query.getString(2);
                                int columnIndex = query.getColumnIndex("loaderVersion");
                                if (columnIndex >= 0) {
                                    f466f = query.getInt(columnIndex);
                                }
                            }
                        }
                        cursor2 = query;
