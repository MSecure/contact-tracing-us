...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.b {
    ...
    public WeakReference<View> f492l;
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends e<T> {
        ...
        public static class a extends e.k.a.a {
            ...
            public void writeToParcel(Parcel parcel, int i2) {
                ...
                parcel.writeByte(this.f498f ? (byte) 1 : 0);
            }
        }
            ...
            if (i3 == 0 || E < i3 || E > i4) {
                ...
                if (E != s) {
                    if (appBarLayout.f486f) {
                        ...
                        int i10 = E - s;
                        this.f493j = s - i5;
                        if (!D && appBarLayout.f486f && (orDefault = coordinatorLayout.c.b.getOrDefault(appBarLayout, null)) != null && !orDefault.isEmpty()) {
        ...
        public final void I(CoordinatorLayout coordinatorLayout, T t, int i2, float f2) {
            ...
            int E = E();
            if (E == i2) {
                ValueAnimator valueAnimator = this.f495l;
            ...
            ValueAnimator valueAnimator2 = this.f495l;
            if (valueAnimator2 == null) {
                ValueAnimator valueAnimator3 = new ValueAnimator();
                this.f495l = valueAnimator3;
                valueAnimator3.setInterpolator(f.b.a.e.a.a.f2778e);
                this.f495l.addUpdateListener(new b(this, coordinatorLayout, t));
            } else {
                valueAnimator2.cancel();
            }
            this.f495l.setDuration((long) Math.min(round, 600));
            this.f495l.setIntValues(E, i2);
            this.f495l.start();
        }
        ...
        public boolean N(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, View view, int i2, int i3) {
            ...
            if ((i2 & 2) != 0) {
                ...
                if (z && (valueAnimator = this.f495l) != null) {
        ...
        public final void P(CoordinatorLayout coordinatorLayout, T t) {
            b.a aVar = b.a.f1310f;
            e.i.i.m.n(aVar.a(), coordinatorLayout);
            e.i.i.m.k(coordinatorLayout, 0);
            b.a aVar2 = b.a.f1311g;
            e.i.i.m.n(aVar2.a(), coordinatorLayout);
            e.i.i.m.k(coordinatorLayout, 0);
            ...
            if (K != null && t.getTotalScrollRange() != 0 && (((CoordinatorLayout.f) K.getLayoutParams()).a instanceof ScrollingViewBehavior)) {
                if (E() != (-t.getTotalScrollRange()) && K.canScrollVertically(1)) {
                    e.i.i.m.o(coordinatorLayout, aVar, null, new d(this, t, false));
                }
                if (E() == 0) {
                    return;
                }
                if (K.canScrollVertically(-1)) {
                    ...
                    if (i2 != 0) {
                        e.i.i.m.o(coordinatorLayout, aVar2, null, new c(this, coordinatorLayout, t, K, i2));
                        return;
                    }
                    return;
                }
                e.i.i.m.o(coordinatorLayout, aVar2, null, new d(this, t, true));
            }
        }
                            ...
                            if (c) {
                                ...
                                while (true) {
                                    ...
                                    if (!(cVar instanceof ScrollingViewBehavior)) {
                                        i6++;
                                    } else if (((ScrollingViewBehavior) cVar).f2792f != 0) {
                                        z3 = true;
                                    }
                                }
                                if (!z3) {
        ...
        public Parcelable v(CoordinatorLayout coordinatorLayout, View view) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (childAt.getTop() + B <= 0 && bottom >= 0) {
                    ...
                    aVar.f498f = z;
                    aVar.f497e = ((float) bottom) / ((float) childAt.getHeight());
                    return aVar;
                }
            }
    ...
    public static class ScrollingViewBehavior extends f.b.a.e.b.f {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            ...
            this.f2792f = obtainStyledAttributes.getDimensionPixelSize(R$styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0);
        ...
        public boolean g(CoordinatorLayout coordinatorLayout, View view, View view2) {
            ...
            if (cVar instanceof BaseBehavior) {
                e.i.i.m.m(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) cVar).f493j) + this.f2791e) - E(view2));
            }
        ...
        public void h(CoordinatorLayout coordinatorLayout, View view, View view2) {
            if (view2 instanceof AppBarLayout) {
                e.i.i.m.n(b.a.f1310f.a(), coordinatorLayout);
                e.i.i.m.k(coordinatorLayout, 0);
                e.i.i.m.n(b.a.f1311g.a(), coordinatorLayout);
                e.i.i.m.k(coordinatorLayout, 0);
            }
        }
    ...
    public boolean c(boolean z) {
        ...
        if (this.f490j && (getBackground() instanceof g)) {
            ...
            this.m.setInterpolator(f.b.a.e.a.a.a);
            this.m.addUpdateListener(new f.b.a.e.b.a(this, gVar));
            this.m.start();
        }
        return true;
    }
    ...
    public boolean d(View view) {
        int i2;
        View view2 = null;
        if (this.f492l == null && (i2 = this.f491k) != -1) {
            View findViewById = view != null ? view.findViewById(i2) : null;
            if (findViewById == null && (getParent() instanceof ViewGroup)) {
                findViewById = ((ViewGroup) getParent()).findViewById(this.f491k);
            }
            if (findViewById != null) {
                this.f492l = new WeakReference<>(findViewById);
            }
        }
        WeakReference<View> weakReference = this.f492l;
    ...
    public void onAttachedToWindow() {
        ...
        if (background instanceof g) {
            f.b.a.c.b.o.b.m1(this, (g) background);
        }
    }
    ...
    public int[] onCreateDrawableState(int i2) {
        ...
        iArr[0] = i3;
        iArr[1] = (!z || !this.f489i) ? -R$attr.state_lifted : R$attr.state_lifted;
        int i4 = R$attr.state_collapsible;
        if (!z) {
            i4 = -i4;
        }
        iArr[2] = i4;
        iArr[3] = (!z || !this.f489i) ? -R$attr.state_collapsed : R$attr.state_collapsed;
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (getFitsSystemWindows() && e()) {
            int topInset = getTopInset();
            for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
                e.i.i.m.m(getChildAt(childCount), topInset);
            }
        }
        this.c = -1;
        this.f484d = -1;
