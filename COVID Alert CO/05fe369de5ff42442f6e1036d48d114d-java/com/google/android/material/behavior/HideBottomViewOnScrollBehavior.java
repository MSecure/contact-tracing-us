...
public class HideBottomViewOnScrollBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    public ViewPropertyAnimator f499d;
    ...
    public class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            HideBottomViewOnScrollBehavior.this.f499d = null;
        }
    }
    ...
    public final void B(V v, int i2, long j2, TimeInterpolator timeInterpolator) {
        this.f499d = v.animate().translationY((float) i2).setInterpolator(timeInterpolator).setDuration(j2).setListener(new a());
    }
    ...
    public void r(CoordinatorLayout coordinatorLayout, V v, View view, int i2, int i3, int i4, int i5, int i6, int[] iArr) {
        if (i3 > 0) {
            if (this.b != 1) {
                ViewPropertyAnimator viewPropertyAnimator = this.f499d;
            ...
            ViewPropertyAnimator viewPropertyAnimator2 = this.f499d;
            if (viewPropertyAnimator2 != null) {
                viewPropertyAnimator2.cancel();
                v.clearAnimation();
            }
            this.b = 2;
            B(v, 0, 225, f.b.a.e.a.a.f2777d);
        }
    }
