...
public class Chip extends g implements b.a, n {
    ...
    public f.b.a.e.i.b f553e;

    /* renamed from: f  reason: collision with root package name */
    public InsetDrawable f554f;

    /* renamed from: g  reason: collision with root package name */
    public RippleDrawable f555g;

    /* renamed from: h  reason: collision with root package name */
    public View.OnClickListener f556h;

    /* renamed from: i  reason: collision with root package name */
    public CompoundButton.OnCheckedChangeListener f557i;
    ...
    public class b extends e.k.b.a {
        ...
        public void o(List<Integer> list) {
            ...
            if (chip.e()) {
                ...
                f.b.a.e.i.b bVar = chip2.f553e;
                if (bVar != null && bVar.M) {
                    z = true;
                }
                if (z && chip2.f556h != null) {
                    list.add(1);
                }
            }
        }
        ...
        public boolean r(int i2, int i3, Bundle bundle) {
            ...
            if (i3 == 16) {
                ...
                if (i2 == 1) {
                    ...
                    View.OnClickListener onClickListener = chip.f556h;
        ...
        @Override // e.k.b.a
        public void t(int i2, e.i.i.x.b bVar) {
            String str = "";
            if (i2 == 1) {
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        ...
        ColorStateList w0 = f.b.a.c.b.o.b.w0(bVar.g0, d2, R$styleable.Chip_chipSurfaceColor);
        if (bVar.z != w0) {
            bVar.z = w0;
            bVar.onStateChange(bVar.getState());
        }
        bVar.Q(f.b.a.c.b.o.b.w0(bVar.g0, d2, R$styleable.Chip_chipBackgroundColor));
        ...
        bVar.Z(f.b.a.c.b.o.b.w0(bVar.g0, d2, R$styleable.Chip_chipStrokeColor));
        bVar.a0(d2.getDimension(R$styleable.Chip_chipStrokeWidth, 0.0f));
        bVar.k0(f.b.a.c.b.o.b.w0(bVar.g0, d2, R$styleable.Chip_rippleColor));
        bVar.l0(d2.getText(R$styleable.Chip_android_text));
        Context context4 = bVar.g0;
        int i8 = R$styleable.Chip_android_textAppearance;
        f.b.a.e.r.b bVar2 = (!d2.hasValue(i8) || (resourceId = d2.getResourceId(i8, 0)) == 0) ? null : new f.b.a.e.r.b(context4, resourceId);
        bVar2.f2951k = d2.getDimension(R$styleable.Chip_android_textSize, bVar2.f2951k);
        bVar.m0(bVar2);
        ...
        if (i9 == 1) {
            ...
            bVar.T(f.b.a.c.b.o.b.B0(bVar.g0, d2, R$styleable.Chip_chipIcon));
            i2 = R$styleable.Chip_chipIconTint;
            if (d2.hasValue(i2)) {
                bVar.V(f.b.a.c.b.o.b.w0(bVar.g0, d2, i2));
            }
            ...
            bVar.b0(f.b.a.c.b.o.b.B0(bVar.g0, d2, R$styleable.Chip_closeIcon));
            bVar.g0(f.b.a.c.b.o.b.w0(bVar.g0, d2, R$styleable.Chip_closeIconTint));
            ...
            bVar.N(f.b.a.c.b.o.b.B0(bVar.g0, d2, R$styleable.Chip_checkedIcon));
            i3 = R$styleable.Chip_checkedIconTint;
            if (d2.hasValue(i3)) {
                bVar.O(f.b.a.c.b.o.b.w0(bVar.g0, d2, i3));
            }
            bVar.W = f.b.a.e.a.g.a(bVar.g0, d2, R$styleable.Chip_showMotionSpec);
            bVar.X = f.b.a.e.a.g.a(bVar.g0, d2, R$styleable.Chip_hideMotionSpec);
            ...
            this.p = (int) Math.ceil((double) obtainStyledAttributes.getDimension(R$styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) TypedValue.applyDimension(1, (float) 48, getContext().getResources().getDisplayMetrics()))));
            ...
            if (Build.VERSION.SDK_INT < 23) {
                setTextColor(f.b.a.c.b.o.b.w0(context2, obtainStyledAttributes2, R$styleable.Chip_android_textColor));
            }
        ...
        this.p = (int) Math.ceil((double) obtainStyledAttributes3.getDimension(R$styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) TypedValue.applyDimension(1, (float) 48, getContext().getResources().getDisplayMetrics()))));
    ...
    private RectF getCloseIconTouchBounds() {
        this.s.setEmpty();
        if (e() && this.f556h != null) {
            f.b.a.e.i.b bVar = this.f553e;
    ...
    private f.b.a.e.r.b getTextAppearance() {
        f.b.a.e.i.b bVar = this.f553e;
        if (bVar != null) {
            return bVar.m0.f2906f;
        }
        return null;
    }
    ...
    public boolean d(int i2) {
        ...
        if (!this.n) {
            if (this.f554f != null) {
                ...
                int[] iArr = f.b.a.e.s.a.a;
                i();
            }
            return false;
        }
        int max = Math.max(0, i2 - ((int) this.f553e.B));
        int max2 = Math.max(0, i2 - this.f553e.getIntrinsicWidth());
        if (max2 > 0 || max > 0) {
            int i3 = max2 > 0 ? max2 / 2 : 0;
            int i4 = max > 0 ? max / 2 : 0;
            if (this.f554f != null) {
                Rect rect = new Rect();
                this.f554f.getPadding(rect);
                if (rect.top == i4) {
                    if (rect.bottom == i4) {
                        if (rect.left == i3) {
                        }
            ...
            this.f554f = new InsetDrawable((Drawable) this.f553e, i3, i4, i3, i4);
            int[] iArr2 = f.b.a.e.s.a.a;
            i();
            return true;
        }
        if (this.f554f != null) {
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        if (!z || this.q.f1355l == Integer.MIN_VALUE) {
    ...
    public void drawableStateChanged() {
        ...
        int i2 = 0;
        z = false;
        if (bVar != null && f.b.a.e.i.b.J(bVar.N)) {
            f.b.a.e.i.b bVar2 = this.f553e;
            ?? isEnabled = isEnabled();
            int i3 = isEnabled;
            if (this.m) {
                i3 = isEnabled + 1;
    ...
    public Drawable getBackgroundDrawable() {
        InsetDrawable insetDrawable = this.f554f;
        return insetDrawable == null ? this.f553e : insetDrawable;
    }
    ...
    public void getFocusedRect(Rect rect) {
        b bVar = this.q;
        if (bVar.f1355l == 1 || bVar.f1354k == 1) {
    ...
    public final void h() {
        ...
        if (e()) {
            f.b.a.e.i.b bVar2 = this.f553e;
            if ((bVar2 != null && bVar2.M) && this.f556h != null) {
                bVar = this.q;
                e.i.i.m.q(this, bVar);
            }
        }
    ...
    public final void i() {
        this.f555g = new RippleDrawable(f.b.a.e.s.a.a(this.f553e.F), getBackgroundDrawable(), null);
        this.f553e.p0(false);
        RippleDrawable rippleDrawable = this.f555g;
    ...
    public final void j() {
        f.b.a.e.i.b bVar;
        if (!TextUtils.isEmpty(getText()) && (bVar = this.f553e) != null) {
    ...
    public final void k() {
        ...
        f.b.a.e.r.b textAppearance = getTextAppearance();
    ...
    public void onAttachedToWindow() {
        ...
        f.b.a.c.b.o.b.m1(this, this.f553e);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                ...
                playSoundEffect(0);
                View.OnClickListener onClickListener = this.f556h;
                if (onClickListener != null) {
    ...
    public void setBackground(Drawable drawable) {
        if (drawable == getBackgroundDrawable() || drawable == this.f555g) {
    ...
    public void setChecked(boolean z) {
        ...
        if (bVar == null) {
            ...
            super.setChecked(z);
            if (isChecked != z && (onCheckedChangeListener = this.f557i) != null) {
    ...
    public void setHideMotionSpecResource(int i2) {
        f.b.a.e.i.b bVar = this.f553e;
        if (bVar != null) {
            bVar.X = f.b.a.e.a.g.b(bVar.g0, i2);
        }
    }
    ...
    public void setOnCheckedChangeListenerInternal(CompoundButton.OnCheckedChangeListener onCheckedChangeListener) {
        this.f557i = onCheckedChangeListener;
    }

    public void setOnCloseIconClickListener(View.OnClickListener onClickListener) {
        this.f556h = onClickListener;
        h();
    }
    ...
    public void setShowMotionSpecResource(int i2) {
        f.b.a.e.i.b bVar = this.f553e;
        if (bVar != null) {
            bVar.W = f.b.a.e.a.g.b(bVar.g0, i2);
        }
    }
    ...
    public void setTextAppearance(int i2) {
        ...
        f.b.a.e.i.b bVar = this.f553e;
        if (bVar != null) {
            bVar.m0(new f.b.a.e.r.b(bVar.g0, i2));
        }
        k();
    }

    public void setTextAppearance(f.b.a.e.r.b bVar) {
        f.b.a.e.i.b bVar2 = this.f553e;
        if (bVar2 != null) {
            bVar2.m0(bVar);
        }
