...
public class ChipGroup extends f.b.a.e.p.e {
    ...
    public final b f566k = new b(null);

    /* renamed from: l  reason: collision with root package name */
    public e f567l = new e(null);
    public int m = -1;
        ...
        public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
            ...
            if (!chipGroup.n) {
                ...
                if (z) {
                    ...
                    int i2 = chipGroup4.m;
                    if (!(i2 == -1 || i2 == id || !chipGroup4.f563h)) {
    ...
    public class e implements ViewGroup.OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View view, View view2) {
            if (view == ChipGroup.this && (view2 instanceof Chip)) {
                ...
                chip.setOnCheckedChangeListenerInternal(ChipGroup.this.f566k);
            }
    ...
    public ChipGroup(Context context, AttributeSet attributeSet) {
        ...
        d2.recycle();
        super.setOnHierarchyChangeListener(this.f567l);
        AtomicInteger atomicInteger = m.a;
    ...
    private void setCheckedId(int i2) {
        this.m = i2;
        d dVar = this.f565j;
        if (dVar != null && this.f563h) {
            dVar.a(this, i2);
        }
    }

    @Override // f.b.a.e.p.e
    public boolean a() {
        return this.f2892d;
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) b.C0034b.a(getRowCount(), this.f2892d ? getChipCount() : -1, false, this.f563h ? 1 : 2).a);
    }
    ...
    public void setOnHierarchyChangeListener(ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener) {
        this.f567l.a = onHierarchyChangeListener;
    }
