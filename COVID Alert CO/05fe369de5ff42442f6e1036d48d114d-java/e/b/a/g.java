...
public class g extends r implements DialogInterface {
    ...
    public final AlertController f647d = new AlertController(getContext(), this, getWindow());
    ...
    public static class a {
        ...
        public g a() {
            ...
            AlertController alertController = gVar.f647d;
            View view = bVar.f31e;
            if (view != null) {
                alertController.G = view;
            } else {
                CharSequence charSequence = bVar.f30d;
            ...
            CharSequence charSequence2 = bVar.f32f;
            ...
            CharSequence charSequence3 = bVar.f33g;
            if (charSequence3 != null) {
                alertController.e(-1, charSequence3, bVar.f34h, null, null);
            }
            CharSequence charSequence4 = bVar.f35i;
            if (charSequence4 != null) {
                alertController.e(-2, charSequence4, bVar.f36j, null, null);
            }
            if (bVar.o != null) {
            ...
            int i3 = bVar.q;
            if (i3 != 0) {
                alertController.f25h = null;
                alertController.f26i = i3;
                alertController.n = false;
            }
            gVar.setCancelable(this.a.f37k);
            if (this.a.f37k) {
                gVar.setCanceledOnTouchOutside(true);
            }
            gVar.setOnCancelListener(this.a.f38l);
    ...
    public void onCreate(Bundle bundle) {
        ...
        AlertController alertController = this.f647d;
        ...
        View view4 = alertController.f25h;
        int i6 = 0;
        if (view4 == null) {
            view4 = alertController.f26i != 0 ? LayoutInflater.from(alertController.a).inflate(alertController.f26i, viewGroup, false) : null;
        }
        ...
        if (z2) {
            ...
            if (alertController.n) {
                frameLayout.setPadding(alertController.f27j, alertController.f28k, alertController.f29l, alertController.m);
            }
        ...
        if (i11 != 0) {
            ...
            view3 = (alertController.f23f == null && alertController.f24g == null) ? view : d2.findViewById(R$id.titleDividerNoCustom);
        } else {
        ...
        if (!z3) {
            View view5 = alertController.f24g;
            if (view5 == null) {
                    ...
                    if (!(findViewById9 == null && view2 == null)) {
                        if (alertController.f23f != null) {
                            ...
                            if (listView2 != null) {
                                ...
                                alertController.f24g.post(new e(alertController, findViewById9, view2));
                            } else {
                                if (findViewById9 != null) {
                                    d3.removeView(findViewById9);
                                }
    ...
    public boolean onKeyDown(int i2, KeyEvent keyEvent) {
        NestedScrollView nestedScrollView = this.f647d.A;
