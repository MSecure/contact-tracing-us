...
public class a extends d implements e.i.c.l.a {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:75:0x0207, code lost:
        throw new org.xmlpull.v1.XmlPullParserException(f.a.a.a.a.h(r20, new java.lang.StringBuilder(), ": <transition> tag requires 'fromId' & 'toId' attributes"));
     */
    public static a g(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (name.equals("animated-selector")) {
            ...
            c cVar = aVar.q;
            cVar.f712d |= e2.getChangingConfigurations();
            cVar.f717i = e2.getBoolean(R$styleable.AnimatedStateListDrawableCompat_android_variablePadding, cVar.f717i);
            cVar.f720l = e2.getBoolean(R$styleable.AnimatedStateListDrawableCompat_android_constantSize, cVar.f720l);
                    ...
                    if (xmlPullParser.getName().equals("item")) {
                        ...
                        if (drawable == null) {
                            ...
                            if (next2 == 2) {
                                ...
                                throw new XmlPullParserException(f.a.a.a.a.h(xmlPullParser, new StringBuilder(), ": <item> tag requires a 'drawable' attribute or child tag defining a drawable"));
                            }
                        }
                        if (drawable != null) {
                            c cVar2 = aVar.q;
                        ...
                        if (xmlPullParser.getName().equals("transition")) {
                            ...
                            if (f2 == null) {
                                ...
                                if (next != 2) {
                                    throw new XmlPullParserException(f.a.a.a.a.h(xmlPullParser, new StringBuilder(), ": <transition> tag requires a 'drawable' attribute or child tag defining a drawable"));
