...
public final class i implements b {
    ...
    public int f795i = 4096;

    /* renamed from: j  reason: collision with root package name */
    public char f796j;

    /* renamed from: k  reason: collision with root package name */
    public int f797k = 4096;
    ...
    public char e() {
        return this.n.n() ? this.f796j : this.f794h;
    }
    ...
    public CharSequence getTitleCondensed() {
        ...
        return charSequence != null ? charSequence : this.f791e;
    }
    ...
    public MenuItem setAlphabeticShortcut(char c2) {
        ...
        this.f796j = Character.toLowerCase(c2);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setAlphabeticShortcut(char c2, int i2) {
        if (this.f796j == c2 && this.f797k == i2) {
            return this;
        }
        this.f796j = Character.toLowerCase(c2);
        this.f797k = KeyEvent.normalizeMetaState(i2);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setChecked(boolean z2) {
        if ((this.x & 4) != 0) {
            ...
            int size = gVar.f782f.size();
            gVar.z();
            for (int i2 = 0; i2 < size; i2++) {
                i iVar = gVar.f782f.get(i2);
    ...
    public MenuItem setNumericShortcut(char c2, int i2) {
        if (this.f794h == c2 && this.f795i == i2) {
            return this;
        }
        this.f794h = c2;
        this.f795i = KeyEvent.normalizeMetaState(i2);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setShortcut(char c2, char c3) {
        this.f794h = c2;
        this.f796j = Character.toLowerCase(c3);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setShortcut(char c2, char c3, int i2, int i3) {
        ...
        this.f795i = KeyEvent.normalizeMetaState(i2);
        this.f796j = Character.toLowerCase(c3);
        this.f797k = KeyEvent.normalizeMetaState(i3);
        this.n.q(false);
        return this;
    }
    ...
    public String toString() {
        CharSequence charSequence = this.f791e;
