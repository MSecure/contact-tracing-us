...
public class c extends e.b.e.i.b {
    ...
    public class a extends l {
        public a(Context context, r rVar, View view) {
            ...
            if (!rVar.A.g()) {
                View view2 = c.this.f855j;
                this.f804f = view2 == null ? (View) c.this.f759i : view2;
            }
            d(c.this.y);
        }
    ...
    public class RunnableC0019c implements Runnable {
        ...
        public void run() {
            g.a aVar;
            g gVar = c.this.f754d;
            if (!(gVar == null || (aVar = gVar.f781e) == null)) {
                aVar.b(gVar);
            }
            View view = (View) c.this.f759i;
    ...
    public class d extends n implements ActionMenuView.a {
        ...
        public d(Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            m.h.n1(this, getContentDescription());
    ...
    public View c(i iVar, View view, ViewGroup viewGroup) {
        ...
        if (actionView == null || iVar.f()) {
            if (view instanceof n.a) {
                ...
                aVar = (n.a) this.f755e.inflate(this.f758h, viewGroup, false);
            }
            aVar.d(iVar, 0);
            ActionMenuItemView actionMenuItemView = (ActionMenuItemView) aVar;
            actionMenuItemView.setItemInvoker((ActionMenuView) this.f759i);
            if (this.x == null) {
                this.x = new b();
            }
    ...
    public boolean d() {
        ...
        ViewGroup viewGroup = (ViewGroup) this.f759i;
        int i6 = 0;
        boolean z2 = false;
        int i7 = 0;
        int i8 = 0;
    ...
    public void e(Context context, g gVar) {
        ...
        if (this.m) {
            if (this.f855j == null) {
                ...
                this.f855j = dVar;
                if (this.f857l) {
                    dVar.setImageDrawable(this.f856k);
                    this.f856k = null;
                    this.f857l = false;
                }
                int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(0, 0);
                this.f855j.measure(makeMeasureSpec, makeMeasureSpec);
            }
            i5 -= this.f855j.getMeasuredWidth();
        } else {
            this.f855j = null;
        }
        this.p = i5;
    ...
    public void j(boolean z) {
        ...
        if (viewGroup != null) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (iVar.g()) {
                        ...
                        if (c != childAt) {
                            ...
                            ((ViewGroup) this.f759i).addView(c, i2);
                        }
                        i2++;
                    }
                }
            ...
            while (i2 < viewGroup.getChildCount()) {
                if (viewGroup.getChildAt(i2) == this.f855j) {
                    z2 = false;
                } else {
        ...
        ((View) this.f759i).requestLayout();
        g gVar2 = this.f754d;
        if (gVar2 != null) {
            gVar2.i();
            ArrayList<i> arrayList2 = gVar2.f785i;
        ...
        if (z3) {
            if (dVar == null) {
                this.f855j = new d(this.b);
            }
            ViewGroup viewGroup3 = (ViewGroup) this.f855j.getParent();
            if (viewGroup3 != this.f759i) {
                if (viewGroup3 != null) {
                    viewGroup3.removeView(this.f855j);
                }
                ActionMenuView actionMenuView = (ActionMenuView) this.f759i;
                d dVar2 = this.f855j;
                ActionMenuView.c q2 = actionMenuView.h();
                q2.a = true;
                actionMenuView.addView(dVar2, q2);
            }
        } else if (dVar != null && dVar.getParent() == (nVar = this.f759i)) {
            ((ViewGroup) nVar).removeView(this.f855j);
        }
        ((ActionMenuView) this.f759i).setOverflowReserved(this.m);
    }

    public boolean k() {
        n nVar;
        RunnableC0019c cVar = this.w;
        if (cVar == null || (nVar = this.f759i) == null) {
            e eVar = this.u;
            if (eVar == null) {
                return false;
            }
    ...
    public boolean n() {
        g gVar;
        if (!this.m || m() || (gVar = this.f754d) == null || this.f759i == null || this.w != null) {
            return false;
        }
        gVar.i();
        if (gVar.f786j.isEmpty()) {
            return false;
        }
        RunnableC0019c cVar = new RunnableC0019c(new e(this.c, this.f754d, this.f855j, true));
        this.w = cVar;
        ((View) this.f759i).post(cVar);
        return true;
    }
}
