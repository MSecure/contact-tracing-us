...
public final class n0 {
    ...
    public static final PorterDuff.Mode f911h = PorterDuff.Mode.SRC_IN;

    /* renamed from: i  reason: collision with root package name */
    public static n0 f912i;

    /* renamed from: j  reason: collision with root package name */
    public static final c f913j = new c(6);
    public WeakHashMap<Context, i<ColorStateList>> a;
    public h<String, e> b;
    public i<String> c;

    /* renamed from: d  reason: collision with root package name */
    public final WeakHashMap<Context, e.e.e<WeakReference<Drawable.ConstantState>>> f914d = new WeakHashMap<>(0);

    /* renamed from: e  reason: collision with root package name */
    public TypedValue f915e;
    ...
    public final synchronized boolean b(Context context, long j2, Drawable drawable) {
        ...
        if (constantState != null) {
            e.e.e<WeakReference<Drawable.ConstantState>> eVar = this.f914d.get(context);
            if (eVar == null) {
                eVar = new e.e.e<>();
                this.f914d.put(context, eVar);
            }
    ...
    public final Drawable c(Context context, int i2) {
        int i3;
        if (this.f915e == null) {
            this.f915e = new TypedValue();
        }
        TypedValue typedValue = this.f915e;
    ...
    public final synchronized Drawable e(Context context, long j2) {
        ...
        if (f2 != null) {
            ...
            int b2 = e.e.d.b(eVar.c, eVar.f1008e, j2);
            if (b2 >= 0 && (objArr = eVar.f1007d)[b2] != (obj = e.e.e.f1006f)) {
                objArr[b2] = obj;
                eVar.b = true;
            }
        }
