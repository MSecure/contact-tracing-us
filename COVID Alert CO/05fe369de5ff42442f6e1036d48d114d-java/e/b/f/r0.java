...
public class r0 extends c implements View.OnClickListener {
    ...
    public static final class a {
        ...
        public final ImageView f928e;

        public a(View view) {
            this.a = (TextView) view.findViewById(16908308);
            this.b = (TextView) view.findViewById(16908309);
            this.c = (ImageView) view.findViewById(16908295);
            this.f927d = (ImageView) view.findViewById(16908296);
            this.f928e = (ImageView) view.findViewById(R$id.edit_query);
        }
    }
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.b != null) {
            ...
            if (h3 != null) {
                if (this.s == null) {
                    ...
                    this.f1339e.getTheme().resolveAttribute(R$attr.textColorSearchUrl, typedValue, true);
                    this.s = this.f1339e.getResources().getColorStateList(typedValue.resourceId);
                }
            ...
            if (i4 == -1) {
                ...
                if (drawable == null) {
                    ...
                    if (this.p.containsKey(flattenToShortString)) {
                        ...
                        PackageManager packageManager = this.f1339e.getPackageManager();
                        try {
                    ...
                    if (drawable == null) {
                        drawable = this.f1339e.getPackageManager().getDefaultActivityIcon();
                    }
                }
            }
        ...
        ImageView imageView2 = aVar.f927d;
        if (imageView2 != null) {
            int i5 = this.x;
            if (i5 != -1) {
        ...
        int i6 = this.r;
        if (i6 == 2 || (i6 == 1 && (i3 & 1) != 0)) {
            aVar.f928e.setVisibility(0);
            aVar.f928e.setTag(aVar.a.getText());
            aVar.f928e.setOnClickListener(this);
            return;
        }
        aVar.f928e.setVisibility(8);
    }
    ...
    public View d(Context context, Cursor cursor, ViewGroup viewGroup) {
        View inflate = this.f1346l.inflate(this.f1344j, viewGroup, false);
    ...
    public Drawable e(Uri uri) {
        ...
        if (!TextUtils.isEmpty(authority)) {
            try {
                Resources resourcesForApplication = this.f1339e.getPackageManager().getResourcesForApplication(authority);
    ...
    public Cursor g(SearchableInfo searchableInfo, String str, int i2) {
        ...
        return this.f1339e.getContentResolver().query(fragment.build(), null, suggestSelection, strArr, null);
    }
    ...
    public View getDropDownView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            View inflate = this.f1346l.inflate(this.f1345k, viewGroup, false);
            if (inflate != null) {
    ...
    public View getView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            View d2 = d(this.f1339e, this.f1338d, viewGroup);
