...
public class z extends TextView implements f, b {
    ...
    public int getAutoSizeMaxTextSize() {
        ...
        y yVar = this.c;
        if (yVar != null) {
            return Math.round(yVar.f965i.f830e);
        }
        return -1;
    }
    ...
    public int getAutoSizeMinTextSize() {
        ...
        y yVar = this.c;
        if (yVar != null) {
            return Math.round(yVar.f965i.f829d);
        }
        return -1;
    }
    ...
    public int getAutoSizeStepGranularity() {
        ...
        y yVar = this.c;
        if (yVar != null) {
            return Math.round(yVar.f965i.c);
        }
        return -1;
    }
    ...
    public int[] getAutoSizeTextAvailableSizes() {
        ...
        y yVar = this.c;
        return yVar != null ? yVar.f965i.f831f : new int[0];
    }
    ...
    public CharSequence getText() {
        Future<e.i.g.b> future = this.f972f;
        if (future != null) {
            try {
                this.f972f = null;
                m.h.i1(this, future.get());
    ...
    public TextClassifier getTextClassifier() {
        x xVar;
        return (Build.VERSION.SDK_INT >= 28 || (xVar = this.f970d) == null) ? super.getTextClassifier() : xVar.a();
    }
    ...
    public void setTextClassifier(TextClassifier textClassifier) {
        x xVar;
        if (Build.VERSION.SDK_INT >= 28 || (xVar = this.f970d) == null) {
    ...
    public void setTextMetricsParamsCompat(b.a aVar) {
        ...
        setHyphenationFrequency(aVar.f1286d);
    }
