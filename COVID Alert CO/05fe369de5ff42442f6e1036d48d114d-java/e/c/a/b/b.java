...
public class b<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    public WeakHashMap<f<K, V>, Boolean> f975d = new WeakHashMap<>();
    ...
    public class d implements Iterator<Map.Entry<K, V>>, f<K, V> {
        ...
        public boolean hasNext() {
            ...
            c<K, V> cVar = this.b;
            return (cVar == null || cVar.f977d == null) ? false : true;
        }
        ...
        public Object next() {
            ...
            if (this.c) {
                ...
                c<K, V> cVar2 = this.b;
                cVar = cVar2 != null ? cVar2.f977d : null;
            }
            this.b = cVar;
            return cVar;
        }
    ...
    public b<K, V>.d i() {
        b<K, V>.d dVar = new d();
        this.f975d.put(dVar, Boolean.FALSE);
        return dVar;
    }
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        ...
        this.f975d.put(aVar, Boolean.FALSE);
        return aVar;
    }
    ...
    public V l(K k2) {
        ...
        if (!this.f975d.isEmpty()) {
            for (f<K, V> fVar : this.f975d.keySet()) {
                fVar.b(h2);
            }
        }
        c<K, V> cVar = h2.f978e;
        c<K, V> cVar2 = h2.f977d;
        if (cVar != null) {
            cVar.f977d = cVar2;
        } else {
            this.b = cVar2;
        }
        c<K, V> cVar3 = h2.f977d;
        if (cVar3 != null) {
            cVar3.f978e = cVar;
        } else {
            this.c = cVar;
