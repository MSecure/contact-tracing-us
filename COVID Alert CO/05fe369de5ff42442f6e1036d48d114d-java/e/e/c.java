...
public final class c<E> implements Collection<E>, Set<E> {
    ...
    public static final Object[] f999g = new Object[0];

    /* renamed from: h  reason: collision with root package name */
    public static Object[] f1000h;

    /* renamed from: i  reason: collision with root package name */
    public static int f1001i;

    /* renamed from: j  reason: collision with root package name */
    public static Object[] f1002j;

    /* renamed from: k  reason: collision with root package name */
    public static int f1003k;
    public int[] b;
    public Object[] c;
    ...
    public boolean add(E e2) {
        ...
        if (i4 < i7) {
            ...
            System.arraycopy(objArr2, i4, objArr2, i8, this.f1004d - i4);
        }
        this.b[i4] = i2;
        this.c[i4] = e2;
        this.f1004d++;
    ...
    public boolean addAll(Collection<? extends E> collection) {
        int size = collection.size() + this.f1004d;
        int[] iArr = this.b;
        boolean z = false;
        if (iArr.length < size) {
            Object[] objArr = this.c;
            ...
            if (i2 > 0) {
                ...
                System.arraycopy(objArr, 0, this.c, 0, this.f1004d);
            }
            i(iArr, objArr, this.f1004d);
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Set) {
            Set set = (Set) obj;
            if (this.f1004d != set.size()) {
                return false;
            }
            for (int i2 = 0; i2 < this.f1004d; i2++) {
                try {
    ...
    public final void h(int i2) {
        if (i2 == 8) {
            synchronized (c.class) {
                Object[] objArr = f1002j;
                if (objArr != null) {
                    this.c = objArr;
                    f1002j = (Object[]) objArr[0];
                    this.b = (int[]) objArr[1];
                    objArr[1] = null;
                    objArr[0] = null;
                    f1003k--;
            ...
            synchronized (c.class) {
                Object[] objArr2 = f1000h;
                if (objArr2 != null) {
                    this.c = objArr2;
                    f1000h = (Object[]) objArr2[0];
    ...
    public Iterator<E> iterator() {
        if (this.f1005e == null) {
            this.f1005e = new b(this);
        }
        g<E, E> gVar = this.f1005e;
        if (gVar.b == null) {
            gVar.b = new g.c();
        }
        ...
        if (i3 <= 1) {
            ...
            if (iArr.length <= 8 || i3 >= iArr.length / 3) {
                ...
                if (i2 < i5) {
                    ...
                    Object[] objArr2 = this.c;
                    System.arraycopy(objArr2, i6, objArr2, i2, this.f1004d - i2);
                }
                this.c[this.f1004d] = null;
            } else {
                if (i3 > 8) {
                    i4 = i3 + (i3 >> 1);
                }
                ...
                if (i2 < i7) {
                    ...
                    System.arraycopy(objArr, i8, this.c, i2, this.f1004d - i2);
                }
            }
        }
        return e2;
    ...
    public boolean retainAll(Collection<?> collection) {
        boolean z = false;
        for (int i2 = this.f1004d - 1; i2 >= 0; i2--) {
    ...
    public <T> T[] toArray(T[] tArr) {
        if (tArr.length < this.f1004d) {
            tArr = (T[]) ((Object[]) Array.newInstance(tArr.getClass().getComponentType(), this.f1004d));
        }
        System.arraycopy(this.c, 0, tArr, 0, this.f1004d);
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder(this.f1004d * 14);
        sb.append('{');
        for (int i2 = 0; i2 < this.f1004d; i2++) {
            if (i2 > 0) {
                sb.append(", ");
