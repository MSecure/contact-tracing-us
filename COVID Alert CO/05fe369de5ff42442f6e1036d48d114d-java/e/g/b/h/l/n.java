...
public class n {
    ...
    public static int f1142f;
    public ArrayList<d> a = new ArrayList<>();
    public int b = -1;
    public int c = 0;

    /* renamed from: d  reason: collision with root package name */
    public ArrayList<a> f1143d = null;
    ...
    public void b(ArrayList<n> arrayList) {
        ...
        if (this.f1144e != -1 && size > 0) {
            for (int i2 = 0; i2 < arrayList.size(); i2++) {
                n nVar = arrayList.get(i2);
                if (this.f1144e == nVar.b) {
                    d(this.c, nVar);
                }
            }
        }
    ...
    public int c(e.g.b.d dVar, int i2) {
        ...
        for (int i5 = 0; i5 < arrayList.size(); i5++) {
            this.f1143d.add(new a(this, arrayList.get(i5), dVar, i2));
        }
        if (i2 == 0) {
            i3 = dVar.o(eVar.D);
            cVar = eVar.F;
    ...
    public String toString() {
        ...
        Iterator<d> it = this.a.iterator();
        while (it.hasNext()) {
            StringBuilder j2 = f.a.a.a.a.j(sb2, " ");
            j2.append(it.next().d0);
            sb2 = j2.toString();
        }
        return f.a.a.a.a.c(sb2, " >");
    }
}
