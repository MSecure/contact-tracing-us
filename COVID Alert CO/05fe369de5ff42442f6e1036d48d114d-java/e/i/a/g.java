...
public final class g {
    ...
    public static final Method f1209d;

    /* renamed from: e  reason: collision with root package name */
    public static final Method f1210e;

    /* renamed from: f  reason: collision with root package name */
    public static final Method f1211f;

    /* renamed from: g  reason: collision with root package name */
    public static final Handler f1212g = new Handler(Looper.getMainLooper());
    ...
    public static final class a implements Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityPaused(Activity activity) {
            if (this.f1214e && !this.f1215f && !this.f1213d) {
                Object obj = this.b;
                boolean z = false;
                try {
                    Object obj2 = g.c.get(activity);
                    if (obj2 == obj) {
                        g.f1212g.postAtFrontOfQueue(new f(g.b.get(activity), obj2));
                        z = true;
                    }
