...
public class f extends k {
    ...
    public static final Method f1251d;

    /* renamed from: e  reason: collision with root package name */
    public static final Method f1252e;
    ...
    public static boolean f(Object obj, ByteBuffer byteBuffer, int i2, int i3, boolean z) {
        try {
            return ((Boolean) f1251d.invoke(obj, byteBuffer, Integer.valueOf(i2), null, Integer.valueOf(i3), Boolean.valueOf(z))).booleanValue();
    ...
    public static Typeface g(Object obj) {
        try {
            ...
            return (Typeface) f1252e.invoke(null, newInstance);
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return null;
        }
    }
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        for (d dVar : dVarArr) {
            int i3 = dVar.f1245f;
            File t0 = m.h.t0(context);
            if (t0 != null) {
                try {
                    if (m.h.y(t0, resources, i3)) {
                        try {
                            ...
                            try {
                                ...
                                t0.delete();
                                if (!(mappedByteBuffer == null && f(obj, mappedByteBuffer, dVar.f1244e, dVar.b, dVar.c))) {
                                    return null;
                                }
                            } catch (Throwable th) {
                                th.addSuppressed(th);
    ...
    public Typeface b(Context context, CancellationSignal cancellationSignal, e.c[] cVarArr, int i2) {
        ...
        for (e.c cVar : cVarArr) {
            ...
            if (byteBuffer == null) {
                byteBuffer = m.h.K0(context, cancellationSignal, uri);
                hVar.put(uri, byteBuffer);
            }
            if (byteBuffer == null || !f(obj, byteBuffer, cVar.b, cVar.c, cVar.f1271d)) {
                return null;
            }
        }
        Typeface g2 = g(obj);
