...
public class e {
    ...
    public static final h<String, ArrayList<f.c<d>>> f1269d = new h<>();

    /* renamed from: e  reason: collision with root package name */
    public static final Comparator<byte[]> f1270e = new a();
    ...
    public static b a(Context context, CancellationSignal cancellationSignal, a aVar) {
        ...
        if (resolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(f.a.a.a.a.c("No package found for authority: ", str));
            ...
            Collections.sort(arrayList, f1270e);
            List<List<byte[]>> list = aVar.f1266d;
            if (list == null) {
                list = m.h.W0(resources, 0);
            }
            int i2 = 0;
            while (true) {
                cursor = 0;
                ...
                Collections.sort(arrayList2, f1270e);
            ...
            StringBuilder k2 = f.a.a.a.a.k("Found content provider ", str, ", but package was not ");
            k2.append(aVar.b);
            throw new PackageManager.NameNotFoundException(k2.toString());
        }
    }
