    ...
    public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        ...
        if (!this.f1337f) {
            ...
            try {
                ...
                this.c = cls;
                this.f1335d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                this.f1336e = true;
        ...
        Method declaredMethod = (!this.f1336e || !this.c.isInstance(menu)) ? menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE) : this.f1335d;
