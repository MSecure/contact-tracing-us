...
public class a {
    ...
    public static final ThreadLocal<a> f1366g = new ThreadLocal<>();
    ...
    public class C0040a {
        ...
        public void a() {
            boolean z;
            a.this.f1368e = SystemClock.uptimeMillis();
            a aVar = a.this;
            long j2 = aVar.f1368e;
            ...
            if (a.this.b.size() > 0) {
                a aVar2 = a.this;
                if (aVar2.f1367d == null) {
                    aVar2.f1367d = new d(aVar2.c);
                }
                d dVar = (d) aVar2.f1367d;
    ...
    public static class d extends c {
        ...
        public final Choreographer.FrameCallback c = new Choreographer$FrameCallbackC0041a();
        ...
        public d(C0040a aVar) {
            super(aVar);
        }
    }

    public static a a() {
        ThreadLocal<a> threadLocal = f1366g;
