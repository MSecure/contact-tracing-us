        ...
        if (attributeValue != null) {
            ...
            if (z) {
                ...
                if (mVar == null) {
                    ...
                    b0<?> b0Var = e0Var.q;
                    mVar.t = b0Var;
                    mVar.W(b0Var.c, attributeSet, mVar.c);
                    k0Var = this.b.h(mVar);
                    this.b.a(mVar);
                    if (e0.O(2)) {
                    ...
                    throw new IllegalStateException(a.d("Fragment ", attributeValue, " did not create a view."));
                } else if (!mVar.o) {
                    mVar.o = true;
                    e0 e0Var2 = this.b;
                    mVar.s = e0Var2;
                    b0<?> b0Var2 = e0Var2.q;
                    mVar.t = b0Var2;
                    mVar.W(b0Var2.c, attributeSet, mVar.c);
                    k0Var = this.b.h(mVar);
                    if (e0.O(2)) {
                        sb = new StringBuilder();
