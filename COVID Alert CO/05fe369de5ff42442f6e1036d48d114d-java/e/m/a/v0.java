...
public abstract class v0 {
    ...
    public class a implements Runnable {
        ...
        public final /* synthetic */ ArrayList f1520d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ ArrayList f1521e;

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ ArrayList f1522f;

        public a(v0 v0Var, int i2, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
            this.b = i2;
            this.c = arrayList;
            this.f1520d = arrayList2;
            this.f1521e = arrayList3;
            this.f1522f = arrayList4;
        }

        public void run() {
            for (int i2 = 0; i2 < this.b; i2++) {
                AtomicInteger atomicInteger = m.a;
                ((View) this.c.get(i2)).setTransitionName((String) this.f1520d.get(i2));
                ((View) this.f1521e.get(i2)).setTransitionName((String) this.f1522f.get(i2));
            }
        }
    }
