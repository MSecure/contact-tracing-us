...
public final class y extends FrameLayout {
    ...
    public y(Context context, AttributeSet attributeSet, e0 e0Var) {
        ...
        if (classAttribute != null && H == null) {
            if (id <= 0) {
                throw new IllegalStateException(a.d("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? a.c(" with tag ", string) : ""));
            }
    ...
    public boolean drawChild(Canvas canvas, View view, long j2) {
        ...
        if (!this.f1526d || (arrayList = this.b) == null || arrayList.size() <= 0 || !this.b.contains(view)) {
