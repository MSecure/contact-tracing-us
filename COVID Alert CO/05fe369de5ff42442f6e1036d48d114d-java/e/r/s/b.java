...
public class b extends m {
    ...
    public void M(Bundle bundle) {
        ...
        e0 e0Var;
        super.M(bundle);
        e.r.m mVar = new e.r.m(p0());
        this.W = mVar;
        mVar.f188i = this;
        this.O.a(mVar.m);
        e.r.m mVar2 = this.W;
        OnBackPressedDispatcher onBackPressedDispatcher = o0().f5h;
        if (mVar2.f188i != null) {
            mVar2.n.b();
            onBackPressedDispatcher.a(mVar2.f188i, mVar2.n);
            e.r.m mVar3 = this.W;
            Boolean bool = this.X;
            int i2 = 0;
            ...
            if (mVar4.f187h.isEmpty()) {
                ...
                if (canonicalName != null) {
                    ...
                    mVar4.f189j = (g) e0Var2;
                    e.r.m mVar5 = this.W;
                    mVar5.f190k.a(new DialogFragmentNavigator(p0(), h()));
                    r rVar = mVar5.f190k;
                    Context p0 = p0();
                    e.m.a.e0 h2 = h();
                    int i4 = this.w;
                    ...
                    if (bundle2 != null) {
                        ...
                        mVar6.f184e = bundle2.getBundle("android-support-nav:controller:navigatorState");
                        mVar6.f185f = bundle2.getParcelableArray("android-support-nav:controller:backStack");
                        mVar6.f186g = bundle2.getBoolean("android-support-nav:controller:deepLinkHandled");
                    }
                    int i5 = this.Z;
                    if (i5 != 0) {
                        this.W.g(i5, null);
    ...
    public void d0(Bundle bundle) {
        ...
        for (Map.Entry<String, q<? extends j>> entry : mVar.f190k.a.entrySet()) {
        ...
        if (!mVar.f187h.isEmpty()) {
            if (bundle2 == null) {
                bundle2 = new Bundle();
            }
            Parcelable[] parcelableArr = new Parcelable[mVar.f187h.size()];
            int i2 = 0;
            for (e eVar : mVar.f187h) {
        ...
        if (mVar.f186g) {
            ...
            bundle2.putBoolean("android-support-nav:controller:deepLinkHandled", mVar.f186g);
        }
        if (bundle2 != null) {
