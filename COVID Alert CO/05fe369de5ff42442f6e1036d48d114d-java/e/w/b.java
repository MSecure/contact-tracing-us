...
public class b extends h {
    ...
    public static final Property<i, PointF> B = new C0057b(PointF.class, "topLeft");
    ...
    public static class C0057b extends Property<i, PointF> {
        ...
        public void set(i iVar, PointF pointF) {
            ...
            iVar2.b = round;
            int i2 = iVar2.f1763f + 1;
            iVar2.f1763f = i2;
            if (i2 == iVar2.f1764g) {
                s.b(iVar2.f1762e, iVar2.a, round, iVar2.c, iVar2.f1761d);
                iVar2.f1763f = 0;
                iVar2.f1764g = 0;
            }
        }
    ...
    public static class c extends Property<i, PointF> {
        ...
        public void set(i iVar, PointF pointF) {
            ...
            int round = Math.round(pointF2.y);
            iVar2.f1761d = round;
            int i2 = iVar2.f1764g + 1;
            iVar2.f1764g = i2;
            if (iVar2.f1763f == i2) {
                s.b(iVar2.f1762e, iVar2.a, iVar2.b, iVar2.c, round);
                iVar2.f1763f = 0;
                iVar2.f1764g = 0;
            }
        }
    ...
    public Animator k(ViewGroup viewGroup, p pVar, p pVar2) {
        ...
        if (i2 != 2) {
            ...
            bVar = this;
            i iVar = new i(view);
            ObjectAnimator L0 = m.h.L0(iVar, B, bVar.u.a((float) i3, (float) i5, (float) i4, (float) i6));
            ObjectAnimator L02 = m.h.L0(iVar, C, bVar.u.a((float) i7, (float) i9, (float) i8, (float) i10));
        ...
        objectAnimator = m.h.L0(view, property, path);
        if (view.getParent() instanceof ViewGroup) {
        }
        return objectAnimator;
    }
