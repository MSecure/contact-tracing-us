...
public abstract class h implements Cloneable {
    ...
    public TimeInterpolator f1770e = null;

    /* renamed from: f  reason: collision with root package name */
    public ArrayList<Integer> f1771f = new ArrayList<>();

    /* renamed from: g  reason: collision with root package name */
    public ArrayList<View> f1772g = new ArrayList<>();

    /* renamed from: h  reason: collision with root package name */
    public q f1773h = new q();

    /* renamed from: i  reason: collision with root package name */
    public q f1774i = new q();

    /* renamed from: j  reason: collision with root package name */
    public n f1775j = null;

    /* renamed from: k  reason: collision with root package name */
    public int[] f1776k = v;

    /* renamed from: l  reason: collision with root package name */
    public ArrayList<p> f1777l;
    ...
    public static void c(q qVar, View view, p pVar) {
        ...
        if (transitionName != null) {
            if (qVar.f1780d.e(transitionName) >= 0) {
                qVar.f1780d.put(transitionName, null);
            } else {
                qVar.f1780d.put(transitionName, view);
            }
        }
        if (view.getParent() instanceof ListView) {
            ...
            if (listView.getAdapter().hasStableIds()) {
                ...
                if (e.e.d.b(eVar.c, eVar.f1008e, itemIdAtPosition) >= 0) {
    ...
    public String G(String str) {
        ...
        if (this.f1770e != null) {
            ...
            j4.append(this.f1770e);
            j4.append(") ");
            sb = j4.toString();
        }
        if (this.f1771f.size() <= 0 && this.f1772g.size() <= 0) {
            return sb;
        }
        String c2 = f.a.a.a.a.c(sb, "tgts(");
        if (this.f1771f.size() > 0) {
            for (int i3 = 0; i3 < this.f1771f.size(); i3++) {
                if (i3 > 0) {
                    c2 = f.a.a.a.a.c(c2, ", ");
                }
                StringBuilder i4 = f.a.a.a.a.i(c2);
                i4.append(this.f1771f.get(i3));
                c2 = i4.toString();
            }
        }
        if (this.f1772g.size() > 0) {
            for (int i5 = 0; i5 < this.f1772g.size(); i5++) {
                if (i5 > 0) {
                    c2 = f.a.a.a.a.c(c2, ", ");
                }
                StringBuilder i6 = f.a.a.a.a.i(c2);
                i6.append(this.f1772g.get(i5));
                c2 = i6.toString();
            }
        }
    ...
    public final void e(View view, boolean z) {
        if (view != null) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                pVar.c.add(this);
                f(pVar);
                c(z ? this.f1773h : this.f1774i, view, pVar);
            }
    ...
    public void h(ViewGroup viewGroup, boolean z) {
        i(z);
        if (this.f1771f.size() > 0 || this.f1772g.size() > 0) {
            for (int i2 = 0; i2 < this.f1771f.size(); i2++) {
                View findViewById = viewGroup.findViewById(this.f1771f.get(i2).intValue());
                if (findViewById != null) {
                    ...
                    pVar.c.add(this);
                    f(pVar);
                    c(z ? this.f1773h : this.f1774i, findViewById, pVar);
                }
            }
            for (int i3 = 0; i3 < this.f1772g.size(); i3++) {
                View view = this.f1772g.get(i3);
                p pVar2 = new p(view);
                if (z) {
                    g(pVar2);
                } else {
                ...
                pVar2.c.add(this);
                f(pVar2);
                c(z ? this.f1773h : this.f1774i, view, pVar2);
            }
            return;
        }
        e(viewGroup, z);
    ...
    public void m() {
        ...
        if (i2 == 0) {
            ...
            for (int i4 = 0; i4 < this.f1773h.c.h(); i4++) {
                View i5 = this.f1773h.c.i(i4);
                if (i5 != null) {
                    AtomicInteger atomicInteger = m.a;
                    i5.setHasTransientState(false);
                }
            }
            for (int i6 = 0; i6 < this.f1774i.c.h(); i6++) {
                View i7 = this.f1774i.c.i(i6);
                if (i7 != null) {
    ...
    public p n(View view, boolean z) {
        ...
        ArrayList<p> arrayList = z ? this.f1777l : this.m;
        if (arrayList == null) {
            return null;
        }
        int size = arrayList.size();
        ...
        return (z ? this.m : this.f1777l).get(i2);
    }
    ...
    public p q(View view, boolean z) {
        ...
        return (z ? this.f1773h : this.f1774i).a.getOrDefault(view, null);
    }
    ...
    public boolean s(View view) {
        return (this.f1771f.size() == 0 && this.f1772g.size() == 0) || this.f1771f.contains(Integer.valueOf(view.getId())) || this.f1772g.contains(view);
    }
    ...
    public void u(View view) {
        if (!this.q) {
            ...
            for (int i3 = i2 - 1; i3 >= 0; i3--) {
                b k2 = o2.k(i3);
                if (k2.a != null && b0Var.equals(k2.f1778d)) {
                    o2.h(i3).pause();
                }
            }
            ArrayList<d> arrayList = this.r;
        ...
        while (it.hasNext()) {
            ...
            if (o2.containsKey(next)) {
                ...
                if (next != null) {
                    ...
                    TimeInterpolator timeInterpolator = this.f1770e;
