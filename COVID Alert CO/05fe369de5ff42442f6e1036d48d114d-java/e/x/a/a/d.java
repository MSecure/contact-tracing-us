...
public class d {
        ...
        while (true) {
            ...
            if (next == 2) {
                ...
                if (name.equals("objectAnimator")) {
                    ...
                    TypedArray e2 = h.e(resources2, theme2, attributeSet, a.f1792h);
                    a(context, resources, theme, xmlPullParser, attributeSet, animatorSet2, !h.c(xmlPullParser2, "ordering") ? 0 : e2.getInt(0, 0), f2);
                    e2.recycle();
                    ...
                    if (name.equals(str2)) {
                        ...
                        while (true) {
                            ...
                            if (eventType == i3 || eventType == i4) {
                                ...
                                if (xmlPullParser.getName().equals(str2)) {
                                    TypedArray e3 = h.e(resources2, theme2, asAttributeSet, a.f1793i);
                                    String b = h.b(e3, xmlPullParser2, "propertyName", i3);
                                    int i7 = !h.c(xmlPullParser2, "valueType") ? 4 : e3.getInt(i5, 4);
                                    ...
                                    while (true) {
                                        ...
                                        if (next2 == i3 || next2 == 1) {
                                            ...
                                            if (i8 == 4) {
                                                TypedArray e4 = h.e(resources2, theme2, Xml.asAttributeSet(xmlPullParser), a.f1794j);
                                                TypedValue peekValue = !h.c(xmlPullParser2, "value") ? null : e4.peekValue(0);
                                                i8 = (!(peekValue != null) || !d(peekValue.type)) ? 0 : 3;
                                                e4.recycle();
                                            }
                                            TypedArray e5 = h.e(resources2, theme2, Xml.asAttributeSet(xmlPullParser), a.f1794j);
                                            float f3 = -1.0f;
                                            if (h.c(xmlPullParser2, "fraction")) {
                                                f3 = e5.getFloat(3, -1.0f);
                                            }
                                            TypedValue peekValue2 = !h.c(xmlPullParser2, "value") ? null : e5.peekValue(0);
                                            boolean z2 = peekValue2 != null;
                                            int i9 = i8 == 4 ? (!z2 || !d(peekValue2.type)) ? 0 : 3 : i8;
                                            if (!z2) {
                                                keyframe = i9 == 0 ? Keyframe.ofFloat(f3) : Keyframe.ofInt(f3);
                                            } else if (i9 == 0) {
                                                keyframe = Keyframe.ofFloat(f3, !h.c(xmlPullParser2, "value") ? 0.0f : e5.getFloat(0, 0.0f));
                                            } else if (i9 == 1 || i9 == 3) {
                                                keyframe = Keyframe.ofInt(f3, !h.c(xmlPullParser2, "value") ? 0 : e5.getInt(0, 0));
                                            } else {
                                                keyframe = null;
                                            }
                                            int resourceId = !h.c(xmlPullParser2, "interpolator") ? 0 : e5.getResourceId(1, 0);
                                            if (resourceId > 0) {
                                    ...
                                    if (propertyValuesHolder == null) {
                                        propertyValuesHolder = c(e3, i7, 0, 1, b);
                                    }
                                    if (propertyValuesHolder != null) {
                                        if (arrayList2 == null) {
                        ...
                        StringBuilder i15 = f.a.a.a.a.i("Unknown animator name: ");
                        i15.append(xmlPullParser.getName());
    ...
    public static PropertyValuesHolder c(TypedArray typedArray, int i2, int i3, int i4, String str) {
        ...
        if (i2 == 2) {
            ...
            if (I != null) {
                a aVar = new a();
                if (I2 == null) {
                    propertyValuesHolder2 = PropertyValuesHolder.ofObject(str, aVar, I);
                } else if (m.h.g(I, I2)) {
                    propertyValuesHolder2 = PropertyValuesHolder.ofObject(str, aVar, I, I2);
                } else {
                ...
                return PropertyValuesHolder.ofObject(str, new a(), I2);
            }
        } else {
    ...
    public static ValueAnimator e(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) {
        ...
        PropertyValuesHolder propertyValuesHolder;
        TypedArray e2 = h.e(resources, theme, attributeSet, a.f1791g);
        TypedArray e3 = h.e(resources, theme, attributeSet, a.f1795k);
