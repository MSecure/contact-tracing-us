...
public abstract class b {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: e.y.b */
                ...
                while (k2 > 0) {
                    ...
                    if (p == null) {
                        ...
                        try {
                            ...
                            throw new RuntimeException(f.a.a.a.a.d("VersionedParcelable encountered IOException reading a Serializable object (name = ", p, ")"), e2);
                        } catch (ClassNotFoundException e3) {
                            throw new RuntimeException(f.a.a.a.a.d("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", p, ")"), e3);
                        }
                    }
                ...
                while (i4 < length) {
                    ...
                    if (t2 == null) {
                        ...
                        try {
                            ...
                            throw new RuntimeException(f.a.a.a.a.d("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e2);
                        }
                    }
                    i4++;
                }
