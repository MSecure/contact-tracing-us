...
public class b implements e.z.x.b {

    /* renamed from: e  reason: collision with root package name */
    public static final String f1933e = l.e("CommandHandler");
    public final Context b;
    public final Map<String, e.z.x.b> c = new HashMap();
    ...
    public void a(String str, boolean z) {
        synchronized (this.f1934d) {
            e.z.x.b remove = this.c.remove(str);
            if (remove != null) {
                remove.a(str, z);
            }
        }
    ...
    public void e(Intent intent, int i2, e eVar) {
        ...
        if ("ACTION_CONSTRAINTS_CHANGED".equals(action)) {
            l.c().a(f1933e, String.format("Handling constraints changed %s", intent), new Throwable[0]);
            c cVar = new c(this.b, i2, eVar);
            List<o> f2 = ((q) eVar.f1948f.c.r()).f();
            ...
            while (it2.hasNext()) {
                o oVar = (o) it2.next();
                String str3 = oVar.a;
                if (currentTimeMillis >= oVar.a() && (!oVar.b() || cVar.f1936d.a(str3))) {
                    arrayList2.add(oVar);
                }
            }
            ...
            while (it3.hasNext()) {
                ...
                l.c().a(c.f1935e, String.format("Creating a delay_met command for workSpec with id (%s)", str4), new Throwable[0]);
                e eVar2 = cVar.c;
                eVar2.f1950h.post(new e.b(eVar2, c2, cVar.b));
            }
            cVar.f1936d.c();
        } else if ("ACTION_RESCHEDULE".equals(action)) {
            l.c().a(f1933e, String.format("Handling reschedule %s, %s", intent, Integer.valueOf(i2)), new Throwable[0]);
            eVar.f1948f.h();
        } else {
            ...
            if (extras != null && !extras.isEmpty()) {
                ...
                if (z) {
                    l.c().b(f1933e, String.format("Invalid request for %s, requires %s.", action, "KEY_WORKSPEC_ID"), new Throwable[0]);
                    return;
                    ...
                    WorkDatabase workDatabase = eVar.f1948f.c;
                    workDatabase.c();
                    try {
                    ...
                    l.c().a(f1933e, String.format("Handing stopWork work for %s", string3), new Throwable[0]);
                    eVar.f1948f.i(string3);
                    Context context2 = this.b;
                    e.z.x.l lVar = eVar.f1948f;
                    String str7 = a.a;
                    i iVar = (i) lVar.c.o();
                    g a2 = iVar.a(string3);
                    if (a2 != null) {
                    ...
                    l.c().a(f1933e, String.format("Handling onExecutionCompleted %s, %s", intent, Integer.valueOf(i2)), new Throwable[0]);
                    a(string4, z6);
                    return;
                } else {
                    l.c().f(f1933e, String.format("Ignoring intent %s", intent), new Throwable[0]);
                    return;
                }
            }
            z = false;
