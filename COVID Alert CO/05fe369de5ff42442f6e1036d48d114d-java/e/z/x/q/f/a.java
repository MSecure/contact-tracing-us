...
public class a extends c<Boolean> {
    ...
    public static final String f1963i = l.e("BatteryChrgTracker");

    public a(Context context, e.z.x.t.q.a aVar) {
        super(context, aVar);
    }
    ...
    public Object a() {
        ...
        if (registerReceiver == null) {
            l.c().b(f1963i, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
    ...
    public void g(Context context, Intent intent) {
        ...
        if (action != null) {
            char c = 0;
            l.c().a(f1963i, String.format("Received %s", action), new Throwable[0]);
