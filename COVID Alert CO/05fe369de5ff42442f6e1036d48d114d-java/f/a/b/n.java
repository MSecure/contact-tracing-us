...
public abstract class n<T> implements Comparable<n<T>> {
    ...
    public void c(String str) {
        ...
        if (oVar != null) {
            ...
            synchronized (oVar.f2058j) {
                for (o.a aVar : oVar.f2058j) {
                    aVar.a(this);
                }
            }
        }
    ...
    public int compareTo(Object obj) {
        ...
        return this.f2043h.intValue() - nVar.f2043h.intValue();
    }
    ...
    public String f() {
        return f.a.a.a.a.c("application/x-www-form-urlencoded; charset=", "UTF-8");
    }
    ...
    public void o(p<?> pVar) {
        ...
        if (bVar != null) {
            ...
            b.a aVar2 = pVar.b;
            if (aVar2 != null) {
                if (!(aVar2.f2024d < System.currentTimeMillis())) {
                    String h2 = h();
                    synchronized (aVar) {
                    ...
                    if (remove != null) {
                        if (v.a) {
                            v.b("Releasing %d waiting requests for cacheKey=%s.", Integer.valueOf(remove.size()), h2);
                        }
                        for (n<?> nVar : remove) {
                            ((f) aVar.b.f2030e).a(nVar, pVar, null);
                        }
                        return;
                    }
                    return;
    ...
    public String toString() {
        StringBuilder i2 = f.a.a.a.a.i("0x");
        i2.append(Integer.toHexString(this.f2040e));
