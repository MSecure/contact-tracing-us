...
public final /* synthetic */ class i implements d {
    ...
    public final Object a(b bVar) {
        ...
        a<f.b.a.a.a.r.d> t = e0Var.g().listIterator();
        while (t.hasNext()) {
            f.b.a.a.a.r.d next = t.next();
            arrayList.add(String.format(Locale.ENGLISH, "%s.%d.%d.%d", c0.f2298j.c(next.c()), Integer.valueOf(next.a()), Integer.valueOf(next.d()), Integer.valueOf(next.e())));
        }
        Collections.sort(arrayList);
        String a2 = c0.f2297i.a(arrayList);
        f.b.a.a.a.i.e0.a aVar = c0.f2296h;
        aVar.a(e0Var.g().size() + " keys for hashing prior to verification: [" + a2 + "]");
        try {
            Mac instance = Mac.getInstance("HmacSHA256");
            f.b.b.c.a aVar2 = c0.f2298j;
            ...
            c0.a aVar3 = new c0.a(c0Var.f2301e, c0Var.b, put2, new g(c0Var, put2, bVar, e0Var), new c(c0Var, bVar), c0Var.f2302f, e0Var.f());
            c0Var.f2300d.a(aVar3);
            return aVar3;
