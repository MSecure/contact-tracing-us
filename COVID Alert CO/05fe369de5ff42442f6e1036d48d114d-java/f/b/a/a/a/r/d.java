...
public abstract class d {
    ...
    public static abstract class a {
        public d a() {
            ...
            int i3;
            a.b bVar = (a.b) this;
            Integer num = bVar.f2368d;
            if (num != null) {
                if (num.intValue() > 0) {
                    Integer num2 = bVar.f2368d;
                    if (num2 != null) {
                        i2 = num2.intValue();
                    } else {
                ...
                if (num3 != null) {
                    ...
                    if (bVar.b == null) {
                        str = f.a.a.a.a.c(str, " intervalNumber");
                    }
                    if (bVar.c == null) {
                        str = f.a.a.a.a.c(str, " rollingPeriod");
                    }
                    if (bVar.f2368d == null) {
                        str = f.a.a.a.a.c(str, " transmissionRisk");
                    }
                    if (str.isEmpty()) {
                        return new a(bVar.a, bVar.b.intValue(), bVar.c.intValue(), bVar.f2368d.intValue(), null);
                    }
    ...
    public String toString() {
        ...
        i2.append(a.c(c()));
        i2.append("]");
        q1.d("key:hex", i2.toString());
        q1.d("key:base64", "[" + b.c(c()) + "]");
        q1.a("interval_number", a());
        q1.a("rolling_period", d());
        q1.a("transmission_risk", e());
        return q1.toString();
    }
}
