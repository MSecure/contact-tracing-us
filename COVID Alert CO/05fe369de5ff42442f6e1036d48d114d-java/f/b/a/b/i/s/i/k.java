    ...
    public Object a(Object obj) {
        ...
        while (cursor.moveToNext()) {
            ...
            if (z) {
                ...
                bVar4.d(new e(bVar, (byte[]) t.Q(tVar.d().query("event_payloads", new String[]{"bytes"}, "event_id = ?", new String[]{String.valueOf(j2)}, null, null, "sequence_num"), l.a)));
            }
            if (!cursor.isNull(6)) {
