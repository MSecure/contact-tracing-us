...
public class c<O extends a.c> {
    ...
    public final b<O> f2576d;

    /* renamed from: e  reason: collision with root package name */
    public final int f2577e;

    /* renamed from: f  reason: collision with root package name */
    public final f.b.a.c.b.l.l.a f2578f;
    ...
    public c(@RecentlyNonNull Context context, @RecentlyNonNull a<O> aVar, @RecentlyNonNull O o, @RecentlyNonNull a aVar2) {
        ...
        if (i2 >= 29) {
            if (i2 < 30 || !Build.VERSION.CODENAME.equals("REL")) {
                ...
                if (str.length() == 1 && str.charAt(0) >= 'R' && str.charAt(0) <= 'Z') {
                    Boolean bool = f.b.a.c.b.o.b.f2665e;
                    if (bool == null) {
                        try {
                            ...
                            f.b.a.c.b.o.b.f2665e = Boolean.valueOf(z);
                        } catch (NumberFormatException unused) {
                            f.b.a.c.b.o.b.f2665e = Boolean.TRUE;
                        }
                        f.b.a.c.b.o.b.f2665e.booleanValue();
                        bool = f.b.a.c.b.o.b.f2665e;
                    }
                    z = bool.booleanValue();
                }
            }
            ...
            this.b = aVar;
            this.c = null;
            this.f2576d = new b<>(aVar, null);
            e a2 = e.a(this.a);
            this.f2579g = a2;
            this.f2577e = a2.f2585e.getAndIncrement();
            this.f2578f = aVar2.a;
            Handler handler = a2.f2590j;
        ...
        e a22 = e.a(this.a);
        this.f2579g = a22;
        this.f2577e = a22.f2585e.getAndIncrement();
        this.f2578f = aVar2.a;
        Handler handler2 = a22.f2590j;
    ...
    public c.a k() {
        ...
        } else if (b3.f444e != null) {
            account = new Account(b3.f444e, "com.google");
        }
        aVar.a = account;
        O o3 = this.c;
        ...
        aVar.f2630d = this.a.getClass().getName();
    ...
    public final <TResult, A> h<TResult> l(int i2, l<A, TResult> lVar) {
        i iVar = new i();
        e eVar = this.f2579g;
        f.b.a.c.b.l.l.a aVar = this.f2578f;
        Objects.requireNonNull(eVar);
        e0 e0Var = new e0(i2, lVar, iVar, aVar);
        Handler handler = eVar.f2590j;
        handler.sendMessage(handler.obtainMessage(4, new u(e0Var, eVar.f2586f.get(), this)));
        return iVar.a;
    }
}
