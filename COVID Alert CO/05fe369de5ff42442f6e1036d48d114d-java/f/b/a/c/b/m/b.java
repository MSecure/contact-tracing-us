...
public abstract class b<T extends IInterface> {
    ...
    public final g f2610d;

    /* renamed from: e  reason: collision with root package name */
    public final Handler f2611e;

    /* renamed from: f  reason: collision with root package name */
    public final Object f2612f = new Object();
    ...
    public final ArrayList<h<?>> f2617k = new ArrayList<>();
    ...
    public abstract class f extends h<Boolean> {
        ...
        public final /* synthetic */ void a(Boolean bool) {
            ...
            if (this.f2619d != 0) {
                b.this.B(1, null);
                Bundle bundle = this.f2620e;
                if (bundle != null) {
                    pendingIntent = (PendingIntent) bundle.getParcelable("pendingIntent");
                }
                d(new f.b.a.c.b.a(this.f2619d, pendingIntent));
            } else if (!e()) {
                b.this.B(1, null);
        ...
        public final void handleMessage(Message message) {
            ...
            if (b.this.u.get() == message.arg1) {
                ...
                if (i3 == 4) {
                    ...
                    b.this.f2615i.a(new f.b.a.c.b.a(message.arg2, pendingIntent));
                    Objects.requireNonNull(b.this);
                    System.currentTimeMillis();
                } else if (i3 == 6) {
                    b.this.B(5, null);
    ...
    public abstract class h<TListener> {
        ...
        public final void c() {
            ...
            synchronized (b.this.f2617k) {
                b.this.f2617k.remove(this);
            }
        }
    }
    ...
    public final class i implements ServiceConnection {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            synchronized (bVar.f2613g) {
                b bVar2 = b.this;
                IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.IGmsServiceBroker");
                bVar2.f2614h = (queryLocalInterface == null || !(queryLocalInterface instanceof k)) ? new j(iBinder) : (k) queryLocalInterface;
            }
            b bVar3 = b.this;
            int i2 = this.a;
            Handler handler = bVar3.f2611e;
            handler.sendMessage(handler.obtainMessage(7, i2, -1, new l(0)));
        }

        public final void onServiceDisconnected(ComponentName componentName) {
            b bVar;
            synchronized (b.this.f2613g) {
                bVar = b.this;
                bVar.f2614h = null;
            }
            Handler handler = bVar.f2611e;
    ...
    public final class k extends f {
        ...
        public final boolean e() {
            try {
                ...
                IInterface q = b.this.q(this.f2622g);
                if (q == null) {
                    return false;
                }
    ...
    public final class l extends f {
        ...
        @Override // f.b.a.c.b.m.b.f
        public final boolean e() {
            b.this.f2615i.a(f.b.a.c.b.a.f2571f);
            return true;
        }
    }
    ...
    public void a(@RecentlyNonNull e eVar) {
        r rVar = (r) eVar;
        f.b.a.c.b.l.l.e.this.f2590j.post(new s(rVar));
    }
    ...
    public void h(h hVar, @RecentlyNonNull Set<Scope> set) {
        Bundle s2 = s();
        e eVar = new e(this.p);
        eVar.f2640e = this.c.getPackageName();
        eVar.f2643h = s2;
        if (set != null) {
            eVar.f2642g = (Scope[]) set.toArray(new Scope[set.size()]);
        }
        if (l()) {
    ...
    public void j() {
        this.u.incrementAndGet();
        synchronized (this.f2617k) {
            int size = this.f2617k.size();
            for (int i2 = 0; i2 < size; i2++) {
                h<?> hVar = this.f2617k.get(i2);
                synchronized (hVar) {
                    hVar.a = null;
                }
            }
