...
public class a {
    ...
    public Drawable f2814h;

    /* renamed from: i  reason: collision with root package name */
    public Drawable f2815i;
    ...
    public final float a() {
        float b2 = b(this.f2818l.a, this.c.l());
        d dVar = this.f2818l.b;
        g gVar = this.c;
        float max = Math.max(b2, b(dVar, gVar.b.a.f2982f.a(gVar.h())));
        d dVar2 = this.f2818l.c;
        g gVar2 = this.c;
        float b3 = b(dVar2, gVar2.b.a.f2983g.a(gVar2.h()));
        d dVar3 = this.f2818l.f2980d;
        g gVar3 = this.c;
        return Math.max(max, Math.max(b3, b(dVar3, gVar3.b.a.f2984h.a(gVar3.h()))));
    }
    ...
    public final Drawable e() {
        if (this.n == null) {
            ...
            this.q = new g(this.f2818l);
            this.n = new RippleDrawable(this.f2816j, null, this.q);
        }
        if (this.o == null) {
            StateListDrawable stateListDrawable = new StateListDrawable();
            Drawable drawable = this.f2815i;
            if (drawable != null) {
                stateListDrawable.addState(t, drawable);
            }
            LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{this.n, this.f2810d, stateListDrawable});
    ...
    public void g(Drawable drawable) {
        this.f2815i = drawable;
        if (drawable != null) {
            Drawable C1 = m.h.C1(drawable.mutate());
            this.f2815i = C1;
            C1.setTintList(this.f2817k);
        }
        if (this.o != null) {
            StateListDrawable stateListDrawable = new StateListDrawable();
            Drawable drawable2 = this.f2815i;
            if (drawable2 != null) {
    ...
    public void k() {
        ...
        Rect rect = this.b;
        materialCardView.f984f.set(rect.left + i2, rect.top + i2, rect.right + i2, rect.bottom + i2);
        ((b) e.d.a.a.f981j).c(materialCardView.f986h);
    }
    ...
    public void l() {
        ...
        this.a.setForeground(f(this.f2814h));
    }
    ...
    public final void m() {
        ...
        if (drawable != null) {
            ((RippleDrawable) drawable).setColor(this.f2816j);
            return;
        }
        g gVar = this.p;
        if (gVar != null) {
    ...
    public void n() {
        this.f2810d.u((float) this.f2813g, this.m);
    }
}
