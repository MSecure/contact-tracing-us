...
public class x extends RecyclerView.e<a> {
    ...
    public static class a extends RecyclerView.b0 {
        ...
        public a(LinearLayout linearLayout, boolean z) {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                ...
                m.q(textView, f2 == null ? new e.i.i.a() : f2);
                textView.setTag(qVar.a, bool);
                m.k(textView, qVar.f1295d);
            }
    ...
    public x(Context context, f<?> fVar, a aVar, i.f fVar2) {
        ...
        if (uVar.compareTo(uVar3) > 0) {
            ...
            int dimensionPixelSize2 = q.F0(context) ? context.getResources().getDimensionPixelSize(i4) : 0;
            this.c = context;
            this.f2860g = dimensionPixelSize + dimensionPixelSize2;
            this.f2857d = aVar;
            this.f2858e = fVar;
            this.f2859f = fVar2;
            if (!this.a.a()) {
    ...
    public int a() {
        return this.f2857d.f2826g;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.e
    public long b(int i2) {
        return this.f2857d.b.v(i2).b.getTimeInMillis();
    }
    ...
    public void e(a aVar, int i2) {
        ...
        if (materialCalendarGridView.getAdapter() == null || !v.equals(materialCalendarGridView.getAdapter().b)) {
            v vVar = new v(v, this.f2858e, this.f2857d);
            materialCalendarGridView.setNumColumns(v.f2849e);
            materialCalendarGridView.setAdapter((ListAdapter) vVar);
        } else {
            materialCalendarGridView.invalidate();
            v a2 = materialCalendarGridView.getAdapter();
            for (Long l2 : a2.f2854d) {
    ...
    public a g(ViewGroup viewGroup, int i2) {
        ...
        linearLayout.setLayoutParams(new RecyclerView.n(-1, this.f2860g));
        return new a(linearLayout, true);
    }

    public u m(int i2) {
        return this.f2857d.b.v(i2);
    }

    public int n(u uVar) {
        return this.f2857d.b.w(uVar);
    }
}
