...
public abstract class c<E> extends b<E> implements List<E>, RandomAccess {
    public static final a<Object> c = new b(g.f3072f, 0);
    ...
    public static final class a<E> extends b.a<E> {
        ...
        @Override // f.b.b.b.b.AbstractC0103b
        public b.AbstractC0103b a(Object obj) {
            c(obj);
            return this;
        }
    ...
    public class C0104c extends c<E> {

        /* renamed from: d  reason: collision with root package name */
        public final transient int f3067d;

        /* renamed from: e  reason: collision with root package name */
        public final transient int f3068e;
        ...
        public E get(int i2) {
            f.b.a.c.b.o.b.v(i2, this.f3068e);
            return (E) c.this.get(i2 + this.f3067d);
        }
        ...
        @Override // f.b.b.b.b
        public int k() {
            return c.this.l() + this.f3067d + this.f3068e;
        }

        @Override // f.b.b.b.b
        public int l() {
            return c.this.l() + this.f3067d;
        }
        ...
        public c<E> subList(int i2, int i3) {
            f.b.a.c.b.o.b.D(i2, i3, this.f3068e);
            c cVar = c.this;
            int i4 = this.f3067d;
    ...
    public static <E> c<E> p(Object[] objArr, int i2) {
        return i2 == 0 ? (c<E>) g.f3072f : new g(objArr, i2);
    }

    public static <E> c<E> q(Object... objArr) {
        int length = objArr.length;
        for (int i2 = 0; i2 < length; i2++) {
            f.b.a.c.b.o.b.w(objArr[i2], i2);
        }
        return p(objArr, objArr.length);
    }
        ...
        if (obj != this) {
            ...
            if (list instanceof RandomAccess) {
                for (int i2 = 0; i2 < size; i2++) {
                    if (!f.b.a.c.b.o.b.m0(get(i2), list.get(i2))) {
                        return false;
                    }
                }
            } else {
                ...
                for (E e2 : this) {
                    if (!it.hasNext() || !f.b.a.c.b.o.b.m0(e2, it.next())) {
                        return false;
                    }
                    while (r2.hasNext()) {
                    }
    ...
    public a<E> listIterator(int i2) {
        f.b.a.c.b.o.b.C(i2, size());
        return isEmpty() ? (a<E>) c : new b(this, i2);
    }

    /* renamed from: z */
    public c<E> subList(int i2, int i3) {
        f.b.a.c.b.o.b.D(i2, i3, size());
        int i4 = i3 - i2;
        if (i4 == size()) {
            return this;
        }
        return i4 == 0 ? (c<E>) g.f3072f : new C0104c(i2, i4);
    }
}
