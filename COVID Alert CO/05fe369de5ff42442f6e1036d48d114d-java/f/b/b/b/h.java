...
public final class h<K, V> extends d<K, V> {
    ...
    public static final d<Object, Object> f3075h = new h(null, new Object[0], 0);

    /* renamed from: e  reason: collision with root package name */
    public final transient Object f3076e;

    /* renamed from: f  reason: collision with root package name */
    public final transient Object[] f3077f;

    /* renamed from: g  reason: collision with root package name */
    public final transient int f3078g;

    public static class a<K, V> extends e<Map.Entry<K, V>> {

        /* renamed from: e  reason: collision with root package name */
        public final transient d<K, V> f3079e;

        /* renamed from: f  reason: collision with root package name */
        public final transient Object[] f3080f;

        /* renamed from: g  reason: collision with root package name */
        public final transient int f3081g;

        /* renamed from: h  reason: collision with root package name */
        public final transient int f3082h;
        ...
        public class C0105a extends c<Map.Entry<K, V>> {
            ...
            public Object get(int i2) {
                f.b.a.c.b.o.b.v(i2, a.this.f3082h);
                a aVar = a.this;
                Object[] objArr = aVar.f3080f;
                int i3 = i2 * 2;
                int i4 = aVar.f3081g;
        ...
        public boolean contains(Object obj) {
            ...
            return value != null && value.equals(this.f3079e.get(key));
        }
    ...
    public static final class b<K> extends e<K> {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final transient d<K, ?> f3084e;

        /* renamed from: f  reason: collision with root package name */
        public final transient c<K> f3085f;
        ...
        @Override // f.b.b.b.b
        public boolean contains(Object obj) {
            return this.f3084e.get(obj) != null;
        }
        ...
        @Override // f.b.b.b.b
        public int i(Object[] objArr, int i2) {
            return this.f3085f.i(objArr, i2);
        }
        ...
        /* renamed from: n */
        public k<K> iterator() {
            return this.f3085f.listIterator();
        }

        public int size() {
            return ((h) this.f3084e).f3078g;
        }
    }
    ...
    public static final class c extends c<Object> {
        ...
        public final transient Object[] f3086d;

        /* renamed from: e  reason: collision with root package name */
        public final transient int f3087e;

        /* renamed from: f  reason: collision with root package name */
        public final transient int f3088f;
        ...
        @Override // java.util.List
        public Object get(int i2) {
            f.b.a.c.b.o.b.v(i2, this.f3088f);
            return this.f3086d[(i2 * 2) + this.f3087e];
        }
        ...
        if (i2 == 1) {
            ...
            if (o <= 128) {
                ...
                while (i4 < i2) {
                    ...
                    int o1 = f.b.a.c.b.o.b.o1(obj2.hashCode());
                    while (true) {
                        int i6 = o1 & i3;
                        int i7 = bArr[i6] & 255;
                        if (i7 == 255) {
                ...
                while (i8 < i2) {
                    ...
                    int o12 = f.b.a.c.b.o.b.o1(obj4.hashCode());
                    while (true) {
                        int i10 = o12 & i3;
                ...
                while (i12 < i2) {
                    ...
                    int o13 = f.b.a.c.b.o.b.o1(obj6.hashCode());
                    while (true) {
                        int i14 = o13 & i3;
                        ?? r9 = bArr[i14];
                        if (r9 == -1) {
    ...
    public V get(Object obj) {
        Object obj2 = this.f3076e;
        Object[] objArr = this.f3077f;
        int i2 = this.f3078g;
        if (obj == null) {
            return null;
        }
        if (i2 == 1) {
            ...
            if (obj2 instanceof byte[]) {
                ...
                int o1 = f.b.a.c.b.o.b.o1(obj.hashCode());
                while (true) {
                    int i3 = o1 & length;
                    int i4 = bArr[i3] & 255;
                    if (i4 == 255) {
                ...
                int o12 = f.b.a.c.b.o.b.o1(obj.hashCode());
                while (true) {
                    int i5 = o12 & length2;
                ...
                int o13 = f.b.a.c.b.o.b.o1(obj.hashCode());
                while (true) {
                    int i7 = o13 & length3;
                    int i8 = iArr[i7];
                    if (i8 == -1) {
