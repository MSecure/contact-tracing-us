...
public final class c0<V> extends l.a<V> {
    ...
    public static final class b<V> implements Runnable {
        ...
        public void run() {
            u<V> uVar;
            c0<V> c0Var = this.b;
            if (c0Var != null && (uVar = c0Var.f3125i) != null) {
                this.b = null;
                if (uVar.isDone()) {
                    c0Var.v(uVar);
                    return;
                ...
                try {
                    ScheduledFuture<?> scheduledFuture = c0Var.f3126j;
                    c0Var.f3126j = null;
    ...
    public void j() {
        q(this.f3125i);
        ScheduledFuture<?> scheduledFuture = this.f3126j;
        if (scheduledFuture != null) {
