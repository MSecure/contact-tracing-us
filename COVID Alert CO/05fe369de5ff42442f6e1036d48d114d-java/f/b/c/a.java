...
public class a {
    ...
    public static final Object f3143i = new Object();

    /* renamed from: j  reason: collision with root package name */
    public static final Executor f3144j = new d(null);

    /* renamed from: k  reason: collision with root package name */
    public static final Map<String, a> f3145k = new e.e.a();
    public final Context a;
    public final String b;
    public final c c;

    /* renamed from: d  reason: collision with root package name */
    public final k f3146d;
    ...
    public final List<b> f3149g = new CopyOnWriteArrayList();

    /* renamed from: h  reason: collision with root package name */
    public final List<Object> f3150h = new CopyOnWriteArrayList();
    ...
    public static class c implements c.a {
        ...
        public void a(boolean z) {
            Object obj = a.f3143i;
            synchronized (a.f3143i) {
                Iterator it = new ArrayList(a.f3145k.values()).iterator();
                while (it.hasNext()) {
                    a aVar = (a) it.next();
                    if (aVar.f3147e.get()) {
                        for (b bVar : aVar.f3149g) {
                            bVar.a(z);
                        }
                    }
                }
    ...
    public a(Context context, String str, c cVar) {
        ...
        try {
            ...
            if (packageManager != null) {
                ...
                if (serviceInfo == null) {
                    ...
                    str2 = j.a.f4246f.toString();
                    Executor executor = f3144j;
                    ...
                    a3.c(f.b.c.l.a.a);
                    dVarArr[7] = a3.b();
                    this.f3146d = new k(executor, arrayList2, dVarArr);
                }
            }
        ...
        a32.c(f.b.c.l.a.a);
        dVarArr2[7] = a32.b();
        this.f3146d = new k(executor2, arrayList22, dVarArr2);
    }

    public static a b() {
        a aVar;
        synchronized (f3143i) {
            aVar = f3145k.get("[DEFAULT]");
            if (aVar == null) {
        ...
        if (context.getApplicationContext() instanceof Application) {
            ...
            if (c.a.get() == null) {
                ...
                if (c.a.compareAndSet(null, cVar2)) {
                    ...
                    f.b.a.c.b.l.l.c cVar3 = f.b.a.c.b.l.l.c.f2580f;
                    Objects.requireNonNull(cVar3);
                    synchronized (cVar3) {
                        cVar3.f2581d.add(cVar2);
                    }
                }
            }
        }
    ...
    public final void a() {
        m.h.r(!this.f3148f.get(), "FirebaseApp was deleted");
    }
