...
public final class a0 implements e0 {
    ...
    public void b(f fVar, j jVar) {
        ...
        b.M0(l2 == 0, "Can only acknowledge the first batch in the mutation queue", new Object[0]);
        f fVar2 = this.a.get(l2);
        b.M0(i2 == fVar2.a, "Queue ordering failure: expected batch %d, got batch %d", Integer.valueOf(i2), Integer.valueOf(fVar2.a));
    ...
    public void c() {
        if (this.a.isEmpty()) {
            b.M0(this.b.b.isEmpty(), "Document leak -- detected dangling mutation references when queue is empty.", new Object[0]);
        }
    }
    ...
    public f f(d dVar, List<e> list, List<e> list2) {
        boolean z = true;
        b.M0(!list2.isEmpty(), "Mutation batches should not be empty", new Object[0]);
        int i2 = this.c;
        this.c = i2 + 1;
        ...
        if (size > 0) {
            ...
            b.M0(z, "Mutation batchIds must be monotonically increasing order", new Object[0]);
        }
        ...
        for (e eVar : list2) {
            ...
            this.f3266e.c.a.a((l) eVar.a.b.q());
        }
        return fVar;
    }
    ...
    public f i(int i2) {
        ...
        b.M0(fVar.a == i2, "If found batch must match", new Object[0]);
        return fVar;
    }

    @Override // f.b.c.k.t.e0
    public void j(f fVar) {
        b.M0(l(fVar.a, "removed") == 0, "Can only remove the first entry of the mutation queue", new Object[0]);
        this.a.remove(0);
        f.b.c.g.a.f<c> fVar2 = this.b;
        for (e eVar : fVar.f3310d) {
            f.b.c.k.u.f fVar3 = eVar.a;
            this.f3266e.f3269f.h(fVar3);
    ...
    public final int l(int i2, String str) {
        int k2 = k(i2);
        b.M0(k2 >= 0 && k2 < this.a.size(), "Batches must exist to be %s", str);
        return k2;
    }
