...
public class a1 {
        ...
        while (rawQuery.moveToNext()) {
            try {
                ...
                try {
                    ...
                    b.q0("Failed to decode Query data for target %s", Integer.valueOf(i2));
                    throw null;
                }
    ...
    public final void b(String[] strArr, Runnable runnable) {
        String str;
        String f2 = a.f(a.i("["), TextUtils.join(", ", strArr), "]");
        boolean z = false;
        for (int i2 = 0; i2 < strArr.length; i2++) {
            ...
            if (i2 == 0) {
                ...
                StringBuilder i3 = a.i(a.d("Expected all of ", f2, " to either exist or not, but "));
                if (z) {
                    i3.append(strArr[0]);
    ...
    public void c(int i2) {
        ...
        if (i2 < 7) {
            try {
                ...
                try {
                    ...
                    b.M0(l2 != null, "Missing highest sequence number", new Object[0]);
                    ...
                    while (true) {
                        ...
                        while (rawQueryWithFactory.moveToNext()) {
                            try {
                                ...
                                b.M0(compileStatement.executeInsert() != -1, "Failed to insert a sentinel row", new Object[0]);
                                z = true;
                            } catch (Throwable unused2) {
                            }
                        }
        ...
        if (i2 < 8) {
            ...
            while (rawQuery3.moveToNext()) {
                try {
                    l lVar = (l) b.b0(rawQuery3.getString(0)).q();
                    b.M0(lVar.n() % 2 == 1, "Expected a collection path.", new Object[0]);
                    String h2 = lVar.h();
                    l lVar2 = (l) lVar.q();
                    ...
                    if (hashSet.add(lVar2)) {
                        ...
                        compileStatement2.bindString(2, b.l0((l) lVar.q()));
            ...
            while (rawQuery4.moveToNext()) {
                try {
                    l lVar3 = (l) b.b0(rawQuery4.getString(0)).q();
                    b.M0(lVar3.n() % 2 == 1, "Expected a collection path.", new Object[0]);
                    String h4 = lVar3.h();
                    l lVar4 = (l) lVar3.q();
                    ...
                    if (hashSet2.add(lVar4)) {
                        ...
                        compileStatement2.bindString(2, b.l0((l) lVar3.q()));
                        compileStatement2.execute();
                    }
        ...
        if (i2 < 9) {
            ...
            b.M0(d2 == d3, "Table contained just one of read_time_seconds or read_time_nanos", new Object[0]);
            if (!(d2 && d3)) {
            ...
            while (rawQuery5.moveToNext()) {
                try {
                    ...
                    try {
                        ...
                        b.q0("Failed to decode Query data for target %s", Integer.valueOf(i7));
                        throw null;
                    }
