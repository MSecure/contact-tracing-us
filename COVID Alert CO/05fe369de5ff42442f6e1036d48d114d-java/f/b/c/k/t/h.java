...
public final class h {
    ...
    public d1 c(f.b.c.k.v.c cVar) {
        ...
        if (ordinal == 0) {
            ...
            int l2 = g2.l();
            if (l2 > 0) {
                f.b.a.c.b.o.b.M0(l2 == 1, "StructuredQuery.from with more than one collection is not supported.", new Object[0]);
                p.c k2 = g2.k(0);
                boolean e4 = k2.e();
                String f2 = k2.f();
                if (e4) {
                    ...
                    if (!g2.u()) {
                        ...
                        if (q2.i() == p.h.b.COMPOSITE_FILTER) {
                            f.b.a.c.b.o.b.M0(q2.f().g() == p.d.b.AND, "Only AND-type composite filters are supported, got %d", q2.f().g());
                            list2 = q2.f().f();
                        } else {
            ...
            int f3 = k3.f();
            f.b.a.c.b.o.b.M0(f3 == 1, "DocumentsTarget contained other than 1 document %d", Integer.valueOf(f3));
