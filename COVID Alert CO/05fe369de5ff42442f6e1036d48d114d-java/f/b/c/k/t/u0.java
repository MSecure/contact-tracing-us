...
public final class u0 implements k0 {
    ...
    public void a(i iVar, m mVar) {
        boolean z;
        b.M0(!mVar.equals(m.c), "Cannot add document to the RemoteDocumentCache with a read time of zero", new Object[0]);
        String f2 = f(iVar.a);
        d dVar = mVar.b;
        h hVar = this.b;
        ...
        if (iVar instanceof j) {
            ...
            Map<String, s> f3 = cVar.f3306d.a.u().f();
            j3.copyOnWrite();
            ...
            l2.b(true);
            r0 r0Var = this.a;
            r0Var.f3301i.execSQL("INSERT OR REPLACE INTO remote_documents (path, read_time_seconds, read_time_nanos, contents) VALUES (?, ?, ?, ?)", new Object[]{f2, Long.valueOf(dVar.b), Integer.valueOf(dVar.c), ((a) l2.build()).toByteArray()});
            this.a.f3297e.a((l) iVar.a.b.q());
        } else {
            f.b.a.c.b.o.b.q0("Unknown document type %s", iVar.getClass().getCanonicalName());
            throw null;
        }
        l2.b(z);
        r0 r0Var2 = this.a;
        r0Var2.f3301i.execSQL("INSERT OR REPLACE INTO remote_documents (path, read_time_seconds, read_time_nanos, contents) VALUES (?, ?, ?, ?)", new Object[]{f2, Long.valueOf(dVar.b), Integer.valueOf(dVar.c), ((a) l2.build()).toByteArray()});
        this.a.f3297e.a((l) iVar.a.b.q());
    }
    ...
    public i b(f fVar) {
        ...
        i iVar = null;
        try {
            Cursor rawQueryWithFactory = this.a.f3301i.rawQueryWithFactory(new s0(new Object[]{f2}), "SELECT contents FROM remote_documents WHERE path = ?", null, null);
            try {
    ...
    public void c(f fVar) {
        String f2 = f(fVar);
        Object[] objArr = {f2};
        this.a.f3301i.execSQL("DELETE FROM remote_documents WHERE path = ?", objArr);
    }
    ...
    public Map<f, i> d(Iterable<f> iterable) {
        ...
        for (f fVar : iterable) {
            arrayList.add(f.b.a.c.b.o.b.l0(fVar.b));
        }
    ...
    public final i e(byte[] bArr) {
        try {
            ...
            f.b.a.c.b.o.b.q0("MaybeDocument failed to parse: %s", e2);
            throw null;
        }
    }

    public final String f(f fVar) {
        return f.b.a.c.b.o.b.l0(fVar.b);
    }
}
