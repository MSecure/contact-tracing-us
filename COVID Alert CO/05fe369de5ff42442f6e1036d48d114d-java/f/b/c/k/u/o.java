...
public class o {
    ...
    public static void a(StringBuilder sb, s sVar) {
        ...
        switch (sVar.y().ordinal()) {
            ...
            case 6:
                ...
                break;
            case 7:
                b.M0(i(sVar), "Value should be a ReferenceValue", new Object[0]);
            ...
            case 10:
                ...
                return;
            default:
                StringBuilder i3 = f.a.a.a.a.i("Invalid value type: ");
                i3.append(sVar.y());
                b.q0(i3.toString(), new Object[0]);
                throw null;
        }
        sb.append(str);
    }
    ...
    public static boolean c(s sVar, s sVar2) {
        ...
        if (j2 == 2) {
            ...
            return b.F0(sVar).equals(b.F0(sVar2));
        } else {
            if (j2 == 9) {
                f.b.d.a.a n = sVar.n();
    ...
    public static int j(s sVar) {
        switch (sVar.y().ordinal()) {
            ...
            case 9:
                return 9;
            case 10:
                return b.U0(sVar) ? 4 : 10;
            default:
                StringBuilder i2 = f.a.a.a.a.i("Invalid value type: ");
                i2.append(sVar.y());
