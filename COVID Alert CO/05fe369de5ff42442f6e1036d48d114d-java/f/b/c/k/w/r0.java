...
public class r0 {
    ...
    public Map<f, Set<Integer>> f3360d = new HashMap();

    /* renamed from: e  reason: collision with root package name */
    public Set<Integer> f3361e = new HashSet();
    ...
    public final void d(int i2, f fVar, i iVar) {
        if (c(i2) != null) {
            ...
            Set<Integer> set = this.f3360d.get(fVar);
            if (set == null) {
                set = new HashSet<>();
                this.f3360d.put(fVar, set);
            }
    ...
    public final void e(int i2) {
        b.M0(this.b.get(Integer.valueOf(i2)) != null && !this.b.get(Integer.valueOf(i2)).a(), "Should only reset active targets", new Object[0]);
