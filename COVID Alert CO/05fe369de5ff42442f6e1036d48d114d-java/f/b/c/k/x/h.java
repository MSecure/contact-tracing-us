...
public class h {
    ...
    public static class a<T> {
        ...
        public final Map<String, Method> f3376d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        public final Map<String, Field> f3377e = new HashMap();

        /* renamed from: f  reason: collision with root package name */
        public final HashSet<String> f3378f = new HashSet<>();

        /* renamed from: g  reason: collision with root package name */
        public final HashSet<String> f3379g = new HashSet<>();
        ...
        public a(Class<T> cls) {
                    ...
                    if (!this.c.containsKey(f2)) {
                        ...
                        if (method.isAnnotationPresent(n.class)) {
                            ...
                            if (returnType == Date.class || returnType == f.b.c.d.class) {
                                this.f3378f.add(f(method));
                            } else {
                                StringBuilder i2 = f.a.a.a.a.i("Method ");
                                i2.append(method.getName());
                                i2.append(" is annotated with @ServerTimestamp but returns ");
                                i2.append(returnType);
                                i2.append(" instead of Date or Timestamp.");
                                throw new IllegalArgumentException(i2.toString());
                            }
                        }
                        if (method.isAnnotationPresent(f.b.c.k.b.class)) {
                            d("Method", "returns", method.getReturnType());
                            this.f3379g.add(f(method));
                        }
                    } else {
                        StringBuilder i3 = f.a.a.a.a.i("Found conflicting getters for name ");
            ...
            do {
                ...
                for (Method method2 : declaredMethods) {
                    if (method2.getName().startsWith("set") && !method2.getDeclaringClass().equals(Object.class) && !Modifier.isStatic(method2.getModifiers()) && method2.getReturnType().equals(Void.TYPE) && method2.getParameterTypes().length == 1 && !method2.isAnnotationPresent(d.class)) {
                        ...
                        if (str == null) {
                            ...
                            Method method3 = this.f3376d.get(f3);
                            if (method3 == null) {
                                method2.setAccessible(true);
                                this.f3376d.put(f3, method2);
                                if (method2.isAnnotationPresent(n.class)) {
                                    StringBuilder i4 = f.a.a.a.a.i("Method ");
                                    i4.append(method2.getName());
                                    i4.append(" is annotated with @ServerTimestamp but should not be. @ServerTimestamp can only be applied to fields and getters, not setters.");
                                    throw new IllegalArgumentException(i4.toString());
                                } else if (method2.isAnnotationPresent(f.b.c.k.b.class)) {
                                    d("Method", "accepts", method2.getParameterTypes()[c3]);
                                    this.f3379g.add(f(method2));
                                }
                            } else {
                                ...
                                if (method2.getName().equals(method3.getName())) {
                                    ...
                                    if (parameterTypes[0].equals(parameterTypes2[0])) {
                                        ...
                                        if (!z) {
                                            ...
                                            StringBuilder i5 = f.a.a.a.a.i("Class ");
                                            i5.append(cls.getName());
                                            i5.append(" has multiple setter overloads with name ");
                                            i5.append(method2.getName());
                                            throw new RuntimeException(i5.toString());
                                        } else {
                                            StringBuilder i6 = f.a.a.a.a.i("Found conflicting setters with name: ");
                                            i6.append(method2.getName());
                                            i6.append(" (conflicts with ");
                                            i6.append(method3.getName());
                                            i6.append(" defined on ");
                                            i6.append(method3.getDeclaringClass().getName());
                                            i6.append(")");
                            ...
                            StringBuilder i7 = f.a.a.a.a.i("Found setter on ");
                            i7.append(cls2.getName());
                            i7.append(" with invalid case-sensitive name: ");
                            i7.append(method2.getName());
                ...
                for (Field field2 : declaredFields) {
                    String e2 = e(field2);
                    if (this.b.containsKey(e2.toLowerCase(Locale.US)) && !this.f3377e.containsKey(e2)) {
                        field2.setAccessible(true);
                        this.f3377e.put(e2, field2);
                        c(field2);
                    }
                }
            ...
            if (!this.b.isEmpty()) {
                Iterator<String> it = this.f3379g.iterator();
                while (it.hasNext()) {
                    String next = it.next();
                    if (!(this.f3376d.containsKey(next) || this.f3377e.containsKey(next))) {
                        StringBuilder k2 = f.a.a.a.a.k("@DocumentId is annotated on property ", next, " of class ");
                        k2.append(cls.getName());
                        k2.append(" but no field or public setter was found");
                        throw new RuntimeException(k2.toString());
                    }
                }
                return;
            }
            StringBuilder i8 = f.a.a.a.a.i("No properties to serialize found on class ");
        ...
        public static String f(Method method) {
            ...
            throw new IllegalArgumentException(f.a.a.a.a.c("Unknown Bean prefix for method: ", name));
        }
        ...
        public final void a(String str) {
            ...
            if (put != null && !str.equals(put)) {
                StringBuilder i2 = f.a.a.a.a.i("Found two getters or fields with conflicting case sensitivity for property: ");
                i2.append(str.toLowerCase(locale));
        ...
        public final void c(Field field) {
            if (field.isAnnotationPresent(n.class)) {
                ...
                if (type == Date.class || type == f.b.c.d.class) {
                    this.f3378f.add(e(field));
                } else {
                    StringBuilder i2 = f.a.a.a.a.i("Field ");
                    i2.append(field.getName());
                    i2.append(" is annotated with @ServerTimestamp but is ");
                    i2.append(type);
                    i2.append(" instead of Date or Timestamp.");
                    throw new IllegalArgumentException(i2.toString());
                }
    ...
    public static class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f3380d = new b(null, null, 0);
        public final int a;
        public final b b;
    ...
    public static void a(boolean z, String str) {
        if (!z) {
            throw new RuntimeException(f.a.a.a.a.c("Hard assert failed: ", str));
        }
    }
        ...
        if (bVar.a > 500) {
            ...
            if (t instanceof Number) {
                ...
                if (t instanceof Character) {
                        ...
                        for (String str2 : aVar.b.values()) {
                            if (!aVar.f3379g.contains(str2)) {
                                if (aVar.c.containsKey(str2)) {
                                    ...
                                    Field field = aVar.f3377e.get(str2);
                                    if (field != null) {
                                        try {
                                            obj = field.get(t);
                                        ...
                                        throw new IllegalStateException(f.a.a.a.a.c("Bean property without field or getter: ", str2));
                                    }
                                }
                                if (!aVar.f3378f.contains(str2) || obj != null) {
                    ...
                    StringBuilder i3 = f.a.a.a.a.i("Can't serialize object of class ");
                    i3.append(t.getClass());
                    i3.append(" with BeanMapper for class ");
                    i3.append(aVar.a);
    ...
    public static IllegalArgumentException c(b bVar, String str) {
        String c = f.a.a.a.a.c("Could not serialize object. ", str);
        if (bVar.a > 0) {
            StringBuilder j2 = f.a.a.a.a.j(c, " (found in field '");
