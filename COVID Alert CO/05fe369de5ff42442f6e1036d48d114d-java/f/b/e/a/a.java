...
public class a implements Closeable {
    ...
    public String Q() {
        return " at line " + (this.f3454f + 1) + " column " + ((this.f3452d - this.f3455g) + 1) + " path " + x();
    }
        ...
        while (true) {
            if (i2 == i3) {
                ...
                if (t(1)) {
                    ...
                    StringBuilder i4 = f.a.a.a.a.i("End of input");
                    i4.append(Q());
    ...
    public final String S(char c2) {
            ...
            while (true) {
                if (i6 < i5) {
                    ...
                    if (c3 == '\\') {
                        ...
                        if (this.f3452d != this.f3453e || t(1)) {
                            char[] cArr2 = this.c;
                            int i10 = this.f3452d;
                            int i11 = i10 + 1;
                            this.f3452d = i11;
                                        ...
                                        while (i12 < i13) {
                                            ...
                                            if (c6 < '0' || c6 > '9') {
                                                if (c6 >= 'a' && c6 <= 'f') {
                                                    ...
                                                    StringBuilder i14 = f.a.a.a.a.i("\\u");
                                                    i14.append(new String(this.c, this.f3452d, 4));
                                                } else {
                                                    i3 = c6 - 'A';
                                                }
                                                i2 = i3 + 10;
        ...
        StringBuilder i142 = f.a.a.a.a.i("\\u");
        i142.append(new String(this.c, this.f3452d, 4));
        throw new NumberFormatException(i142.toString());
    }
    ...
    public final String T() {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i4 + i2 < this.f3453e) {
                    ...
                    sb.append(this.c, this.f3452d, i2);
                    this.f3452d += i2;
                    if (!t(1)) {
                    }
                } else if (t(i2 + 1)) {
        ...
        i3 = i2;
        if (sb == null) {
            str = new String(this.c, this.f3452d, i3);
        } else {
            sb.append(this.c, this.f3452d, i3);
            str = sb.toString();
        }
        this.f3452d += i3;
        return str;
    ...
    public final void V(int i2) {
        int i3 = this.m;
        int[] iArr = this.f3460l;
        if (i3 == iArr.length) {
            int i4 = i3 * 2;
            this.f3460l = Arrays.copyOf(iArr, i4);
            this.o = Arrays.copyOf(this.o, i4);
            this.n = (String[]) Arrays.copyOf(this.n, i4);
        }
        int[] iArr2 = this.f3460l;
        int i5 = this.m;
        this.m = i5 + 1;
        iArr2[i5] = i2;
    }
        ...
        if (i6 == 1) {
            ...
            if (R != 34) {
                ...
                if (R == 44 || R == 59) {
                    ...
                    while (true) {
                        if (i13 < length) {
                            if ((this.f3452d + i13 >= this.f3453e && !t(i13 + 1)) || ((c2 = this.c[this.f3452d + i13]) != str2.charAt(i13) && c2 != str.charAt(i13))) {
                                break;
                            }
                            i13++;
                        } else if ((this.f3452d + length >= this.f3453e && !t(length + 1)) || !L(this.c[this.f3452d + length])) {
                            this.f3452d += length;
                            this.f3456h = i4;
                        }
                    }
    ...
    public final boolean t(int i2) {
        ...
        do {
            ...
            i3 = this.f3453e + read;
            this.f3453e = i3;
            if (this.f3454f == 0 && (i4 = this.f3455g) == 0 && i3 > 0 && cArr[0] == 65279) {
                this.f3452d++;
                this.f3455g = i4 + 1;
                i2++;
                continue;
