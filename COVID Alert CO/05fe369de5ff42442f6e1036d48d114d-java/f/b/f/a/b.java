...
public final class b {
    ...
    static {
        ...
        f.a.a.a.a.p(hashSet2, "PR", "PT", "PW", "PY");
        f.a.a.a.a.p(hashSet2, "QA", "RE", "RO", "RS");
        f.a.a.a.a.p(hashSet2, "RU", "RW", "SA", "SB");
        f.a.a.a.a.p(hashSet2, "SC", "SD", "SE", "SG");
        f.a.a.a.a.p(hashSet2, "SH", "SI", "SJ", "SK");
        f.a.a.a.a.p(hashSet2, "SL", "SM", "SN", "SO");
        f.a.a.a.a.p(hashSet2, "SR", "ST", "SV", "SX");
        f.a.a.a.a.p(hashSet2, "SY", "SZ", "TC", "TD");
        f.a.a.a.a.p(hashSet2, "TG", "TH", "TJ", "TL");
        f.a.a.a.a.p(hashSet2, "TM", "TN", "TO", "TR");
        f.a.a.a.a.p(hashSet2, "TT", "TV", "TW", "TZ");
        f.a.a.a.a.p(hashSet2, "UA", "UG", "US", "UY");
        f.a.a.a.a.p(hashSet2, "UZ", "VA", "VC", "VE");
        f.a.a.a.a.p(hashSet2, "VG", "VI", "VN", "VU");
        f.a.a.a.a.p(hashSet2, "WF", "WS", "YE", "YT");
        hashSet2.add("ZA");
        hashSet2.add("ZM");
        hashSet2.add("ZW");
    }
    ...
    public static <T> g a(T t, ConcurrentHashMap<T, g> concurrentHashMap, String str, a aVar) {
        ...
        if (resourceAsStream != null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        throw new IllegalStateException(f.a.a.a.a.c("empty metadata: ", str2));
            ...
            throw new IllegalStateException(f.a.a.a.a.c("missing metadata: ", str2));
        }
    }
}
