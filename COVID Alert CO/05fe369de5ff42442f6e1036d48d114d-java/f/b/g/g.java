...
public abstract class g implements h1 {
    ...
    public static final class b extends g {
        ...
        public b(ByteBuffer byteBuffer, boolean z) {
            ...
            this.f3546d = byteBuffer.limit() + byteBuffer.arrayOffset();
        }
        ...
        public <K, V> void a(Map<K, V> map, m0.a<K, V> aVar, r rVar) {
            ...
            e0(b0);
            int i2 = this.f3546d;
            this.f3546d = this.c + b0;
            try {
                Object obj = aVar.b;
                Object obj2 = aVar.f3607d;
                while (true) {
                    int M = M();
                    if (M == Integer.MAX_VALUE) {
                        ...
                        obj2 = S(aVar.c, aVar.f3607d.getClass(), rVar);
                    }
                }
            } finally {
                this.f3546d = i2;
        ...
        public boolean p() {
            ...
            int i3;
            int i4;
            if (Q() || (i2 = this.f3547e) == (i3 = this.f3548f)) {
                return false;
            }
            int i5 = i2 & 7;
            if (i5 != 0) {
