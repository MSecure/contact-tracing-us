...
public abstract class j implements Iterable<Byte>, Serializable {
    ...
    public static final e f3565d = (d.a() ? new i(null) : new c(null));
    public int b = 0;
    ...
    public static final class d extends h {
        ...
        @Override // f.b.g.j, f.b.g.j.h
        public byte i(int i2) {
            j.j(i2, this.f3568g);
            return this.f3569e[this.f3567f + i2];
        }

        @Override // f.b.g.j, f.b.g.j.h
        public void p(byte[] bArr, int i2, int i3, int i4) {
            System.arraycopy(this.f3569e, this.f3567f + i2, bArr, i3, i4);
        }
    ...
    public static class h extends g {
        ...
        public final String A(Charset charset) {
            return new String(this.f3569e, E(), size(), charset);
        }

        @Override // f.b.g.j
        public final void C(i iVar) {
            iVar.a(this.f3569e, E(), size());
        }
        ...
        @Override // f.b.g.j
        public byte i(int i2) {
            return this.f3569e[i2];
        }

        @Override // f.b.g.j
        public void p(byte[] bArr, int i2, int i3, int i4) {
            System.arraycopy(this.f3569e, i2, bArr, i3, i4);
        }
        ...
        public final boolean t() {
            int E = E();
            return w1.h(this.f3569e, E, size() + E);
        }

        @Override // f.b.g.j
        public final k v() {
            return k.h(this.f3569e, E(), size(), true);
        }
        ...
        public final int x(int i2, int i3, int i4) {
            int E = E() + i3;
            return w1.a.e(i2, this.f3569e, E, i4 + E);
        }

        @Override // f.b.g.j
        public final j y(int i2, int i3) {
            int k2 = j.k(i2, i3, size());
            return k2 == 0 ? j.c : new d(this.f3569e, E() + i2, k2);
        }
    }
    ...
    public static j h(Iterator<j> it, int i2) {
        ...
        if (i2 < 1) {
            ...
            if (Integer.MAX_VALUE - h2.size() < h3.size()) {
                StringBuilder i4 = f.a.a.a.a.i("ByteString would be too long: ");
                i4.append(h2.size());
                i4.append("+");
                i4.append(h3.size());
                ...
                if (h2 instanceof i1) {
                    i1 i1Var2 = (i1) h2;
                    if (h3.size() + i1Var2.f3556g.size() < 128) {
                        i1Var = new i1(i1Var2.f3555f, i1.D(i1Var2.f3556g, h3));
                        return i1Var;
                    } else if (i1Var2.f3555f.q() > i1Var2.f3556g.q() && i1Var2.f3558i > h3.q()) {
                        return new i1(i1Var2.f3555f, new i1(i1Var2.f3556g, h3));
                    }
                }
    ...
    public static void j(int i2, int i3) {
        ...
        if (i2 < 0) {
            throw new ArrayIndexOutOfBoundsException(f.a.a.a.a.v("Index < 0: ", i2));
        }
    ...
    public static int k(int i2, int i3, int i4) {
        ...
        if (i2 < 0) {
            throw new IndexOutOfBoundsException(f.a.a.a.a.w("Beginning index: ", i2, " < 0"));
        } else if (i3 < i2) {
    ...
    public static j m(byte[] bArr, int i2, int i3) {
        ...
        return new h(f3565d.a(bArr, i2, i3));
    }
    ...
    public final String toString() {
        ...
        if (size() <= 50) {
            str = f.b.a.c.b.o.b.n0(this);
        } else {
            str = f.b.a.c.b.o.b.n0(y(0, 47)) + "...";
        }
        objArr[2] = str;
