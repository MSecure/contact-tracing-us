...
public final class d extends f.d.b.q.a<a> {
    ...
    public static final class a extends RecyclerView.b0 {
        ...
        public static final class C0132a extends f implements j.k.a.b<TypedArray, h> {
            ...
            public h d(TypedArray typedArray) {
                ...
                e.b(context2, "ctx");
                materialCardView.setCardBackgroundColor(typedArray2.getColor(i2, f.b.a.c.b.o.b.K0(context, i3, f.b.a.c.b.o.b.I0(context2, R$color.about_libraries_card))));
                ...
                Context context3 = this.f3723d;
                e.b(context3, "ctx");
                int i6 = R$attr.aboutLibrariesOpenSourceDivider;
                Context context4 = this.f3723d;
                e.b(context4, "ctx");
                int i7 = R$color.about_libraries_dividerLight_openSource;
                view.setBackgroundColor(typedArray2.getColor(i5, f.b.a.c.b.o.b.K0(context3, i6, f.b.a.c.b.o.b.I0(context4, i7))));
                this.c.x.setTextColor(typedArray2.getColorStateList(i4));
                View view2 = this.c.y;
                Context context5 = this.f3723d;
                e.b(context5, "ctx");
                Context context6 = this.f3723d;
                e.b(context6, "ctx");
                view2.setBackgroundColor(typedArray2.getColor(i5, f.b.a.c.b.o.b.K0(context5, i6, f.b.a.c.b.o.b.I0(context6, i7))));
        ...
        public a(View view) {
            ...
            e.b(context, "ctx");
            f.b.a.c.b.o.b.k1(context, null, 0, 0, new C0132a(this, context), 7);
        }
    }
        ...
        try {
            ...
            if (!(a2 == null || (str = a2.f3719e) == null)) {
                if (str.length() > 0) {
                    ...
                    aVar2.a.f32f = Html.fromHtml(str2);
                    aVar2.a().show();
                    return;
                }
            }
    ...
    public void g(RecyclerView.b0 b0Var, List list) {
        ...
        Context context = view.getContext();
        aVar.u.setText(this.b.f3710e);
        aVar.v.setText(this.b.f3711f);
        if (TextUtils.isEmpty(this.b.f3713h)) {
            textView = aVar.x;
            charSequence = this.b.f3713h;
        } else {
            textView = aVar.x;
            charSequence = Html.fromHtml(this.b.f3713h);
        }
        textView.setText(charSequence);
        Objects.requireNonNull(this.c);
        boolean z = false;
        if (!(!(this.b.f3714i.length() == 0) || (a3 = this.b.a()) == null || (str3 = a3.b) == null)) {
            if (str3.length() == 0) {
                aVar.y.setVisibility(8);
                aVar.z.setVisibility(8);
                aVar.A.setVisibility(8);
                if (this.b.f3712g.length() > 0) {
        ...
        String str4 = "";
        if (this.b.f3714i.length() > 0) {
            Objects.requireNonNull(this.c);
            aVar.z.setText(this.b.f3714i);
        } else {
            aVar.z.setText(str4);
        }
        if (!(this.b.a() == null || (a2 = this.b.a()) == null || (str2 = a2.b) == null)) {
            if ((str2.length() > 0) && this.c.f3697e) {
                textView2 = aVar.A;
