...
public abstract class b<T extends b<T>> extends l0<T> {
    ...
    public static final t B = t.f4236d;
        ...
        synchronized (u0.class) {
            if (u0.f4238e == null) {
                ...
                try {
                    ...
                    u0.f4237d.log(Level.FINE, "Unable to find DNS NameResolver", (Throwable) e2);
                }
                List<s0> q2 = c.q(s0.class, Collections.unmodifiableList(arrayList), s0.class.getClassLoader(), new u0.b(null));
                if (q2.isEmpty()) {
                    u0.f4237d.warning("No NameResolverProviders found via ServiceLoader, including for DNS. This is probably due to a broken build. If using ProGuard, check your configuration");
                }
                u0.f4238e = new u0();
                for (s0 s0Var : q2) {
                    Logger logger2 = u0.f4237d;
