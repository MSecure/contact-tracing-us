...
public final class b2 extends b.a {
    ...
    public final Object f3829f = new Object();
    ...
    public void a(n0 n0Var) {
        f.b.a.c.b.o.b.F(!this.f3831h, "apply() or fail() already called");
        f.b.a.c.b.o.b.z(n0Var, "headers");
        this.c.f(n0Var);
        q d2 = this.f3828e.d();
        try {
            u g2 = this.a.g(this.b, this.c, this.f3827d);
            this.f3828e.Q(d2);
            c(g2);
        } catch (Throwable th) {
            this.f3828e.Q(d2);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:10:0x0019, code lost:
        if (r3.f3832i == null) goto L_0x001c;
     */
    ...
    public final void c(u uVar) {
        boolean z = true;
        f.b.a.c.b.o.b.F(!this.f3831h, "already finalized");
        this.f3831h = true;
