...
public class f implements c0, z1.b {
    ...
    public final Queue<InputStream> f3864e = new ArrayDeque();
    ...
    public void e(boolean z) {
        this.f3863d.c(new RunnableC0146f(z));
    }

    @Override // h.a.j1.z1.b
    public void f(int i2) {
        this.f3863d.c(new e(i2));
    }
