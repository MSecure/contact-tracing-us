...
public final class x1 {
    ...
    public static final class a {
        ...
        public final o2 f4030e;

        /* renamed from: f  reason: collision with root package name */
        public final s0 f4031f;
        ...
        public a(Map<String, ?> map, boolean z, int i2, int i3) {
            ...
            if (f2 == null) {
                ...
                b.z(d2, "backoffMultiplier cannot be empty");
                double doubleValue = d2.doubleValue();
                b.s(doubleValue > 0.0d, "backoffMultiplier must be greater than 0: %s", Double.valueOf(doubleValue));
                Set<c1.b> n = c.n(f2, "retryableStatusCodes");
                b.t1(n != null, "%s is required in retry policy", "retryableStatusCodes");
                b.t1(!n.isEmpty(), "%s must not be empty", "retryableStatusCodes");
                b.t1(!n.contains(c1.b.OK), "%s must not contain OK", "retryableStatusCodes");
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            return b.m0(this.a, aVar.a) && b.m0(this.b, aVar.b) && b.m0(this.c, aVar.c) && b.m0(this.f4029d, aVar.f4029d) && b.m0(this.f4030e, aVar.f4030e) && b.m0(this.f4031f, aVar.f4031f);
        }

        public int hashCode() {
            return Arrays.hashCode(new Object[]{this.a, this.b, this.c, this.f4029d, this.f4030e, this.f4031f});
        }

        public String toString() {
            k q1 = b.q1(this);
            q1.d("timeoutNanos", this.a);
            q1.d("waitForReady", this.b);
            q1.d("maxInboundMessageSize", this.c);
            q1.d("maxOutboundMessageSize", this.f4029d);
            q1.d("retryPolicy", this.f4030e);
            q1.d("hedgingPolicy", this.f4031f);
            return q1.toString();
        }
    }
    ...
    public static x1 a(Map<String, ?> map, boolean z, int i2, int i3, Object obj) {
        ...
        if (!z || map == null || (f2 = i1.f(map, "retryThrottling")) == null) {
            ...
            b.F(floatValue > 0.0f, "maxToken should be greater than zero");
            b.F(floatValue2 > 0.0f, "tokenRatio should be greater than zero");
    ...
    public boolean equals(Object obj) {
        ...
        x1 x1Var = (x1) obj;
        return b.m0(this.a, x1Var.a) && b.m0(this.b, x1Var.b) && b.m0(this.c, x1Var.c) && b.m0(this.f4028d, x1Var.f4028d);
    }

    public int hashCode() {
        return Arrays.hashCode(new Object[]{this.a, this.b, this.c, this.f4028d});
    }

    public String toString() {
        k q1 = b.q1(this);
        q1.d("serviceMethodMap", this.a);
        q1.d("serviceMap", this.b);
        q1.d("retryThrottling", this.c);
        q1.d("loadBalancingConfig", this.f4028d);
        return q1.toString();
    }
}
