...
public class f extends h.a.j1.a {
    ...
    public class a implements a.b {
        ...
        public void a(n0 n0Var, byte[] bArr) {
            ...
            String str = "/" + f.this.f4080g.b;
            if (bArr != null) {
                f.this.p = true;
                StringBuilder j2 = f.a.a.a.a.j(str, "?");
                j2.append(f.b.b.c.a.a.c(bArr));
                str = j2.toString();
            }
            try {
    ...
    public class b extends t0 {
        ...
        public static void l(b bVar, n0 n0Var, String str) {
            boolean z2;
            f fVar = f.this;
            String str2 = fVar.f4083j;
            String str3 = fVar.f4081h;
            boolean z3 = fVar.p;
            ...
            n0Var.b(q0.f3970g);
            n0Var.b(q0.f3971h);
            n0.f<String> fVar2 = q0.f3972i;
            n0Var.b(fVar2);
            ArrayList arrayList = new ArrayList(n0Var.b + 7);
            arrayList.add(z4 ? c.b : c.a);
            arrayList.add(z3 ? c.f4067d : c.c);
            arrayList.add(new h.a.k1.p.m.d(h.a.k1.p.m.d.f4171h, str2));
            arrayList.add(new h.a.k1.p.m.d(h.a.k1.p.m.d.f4169f, str));
            arrayList.add(new h.a.k1.p.m.d(fVar2.b, str3));
            arrayList.add(c.f4068e);
            arrayList.add(c.f4069f);
            Logger logger = a3.a;
            ...
            for (int i8 = 0; i8 < bArr.length; i8 += 2) {
                h f2 = h.f(bArr[i8]);
                String q = f2.q();
                if (!q.startsWith(":") && !q0.f3970g.b.equalsIgnoreCase(q) && !q0.f3972i.b.equalsIgnoreCase(q)) {
        ...
        public static void m(b bVar, e eVar, boolean z2, boolean z3) {
            if (!bVar.D) {
                ...
                f.b.a.c.b.o.b.F(f.this.f4085l != -1, "streamId should be set");
                bVar.H.a(z2, f.this.f4085l, eVar, z3);
            }
        }
        ...
        public void e(boolean z2) {
            ...
            if (!this.o) {
                ...
                this.I.k(f.this.f4085l, null, aVar, false, null, null);
            }
        ...
        public void f(int i2) {
            ...
            if (((float) i3) <= ((float) i4) * 0.5f) {
                ...
                this.E += i5;
                this.F = i3 + i5;
                this.G.s(f.this.f4085l, (long) i5);
            }
        }
        ...
        public final void n(c1 c1Var, boolean z2, n0 n0Var) {
            ...
            if (!this.D) {
                ...
                synchronized (gVar2.f4092j) {
                    ...
                    if (remove != null) {
                        gVar2.f4090h.O(i2, h.a.k1.p.m.a.CANCEL);
                        if (c1Var != null) {
                            b bVar = remove.m;
                            if (n0Var == null) {
                                n0Var = new n0();
        ...
        public void o(e eVar, boolean z2) {
            ...
            this.E = i2;
            if (i2 < 0) {
                this.G.O(f.this.f4085l, h.a.k1.p.m.a.FLOW_CONTROL_ERROR);
                this.I.k(f.this.f4085l, c1.m.g("Received data size exceeded our receiving window size"), aVar, false, null, null);
                return;
            }
            j jVar = new j(eVar);
            c1 c1Var2 = this.r;
            boolean z3 = false;
            if (c1Var2 != null) {
                StringBuilder i3 = f.a.a.a.a.i("DATA-----------------------------\n");
                ...
                jVar.K(bArr, 0, b);
                i3.append(new String(bArr, charset));
                this.r = c1Var2.a(i3.toString());
                jVar.b.c();
                ...
                try {
                    if (this.p) {
                        h.a.j1.a.f3796f.log(Level.INFO, "Received data on closed stream");
                        jVar.b.c();
                    } else {
                        try {
                            this.b.L(jVar);
        ...
        public void p(List<h.a.k1.p.m.d> list, boolean z2) {
            ...
            if (z2) {
                ...
                if (c1Var4 != null) {
                    ...
                    f.b.a.c.b.o.b.z(n0Var, "trailers");
                    if (!this.p) {
                        h.a.j1.a.f3796f.log(Level.INFO, "Received trailers on closed stream:\n {1}\n {2}", new Object[]{c1Var2, n0Var});
                        return;
                    }
    ...
    public f(o0<?, ?> o0Var, n0 n0Var, b bVar, g gVar, n nVar, Object obj, int i2, int i3, String str, String str2, w2 w2Var, c3 c3Var, h.a.c cVar, boolean z) {
        super(new m(), w2Var, c3Var, n0Var, cVar, z && o0Var.f4212h);
        this.f4085l = -1;
        this.n = new a();
        this.p = false;
