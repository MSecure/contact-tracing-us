...
public final class e {
    ...
    public static final class a {
        ...
        public final void a() {
            Arrays.fill(this.f4173e, (Object) null);
            this.f4174f = this.f4173e.length - 1;
            this.f4175g = 0;
            this.f4176h = 0;
        }

        public final int b(int i2) {
            return this.f4174f + 1 + i2;
        }
        ...
        public final int c(int i2) {
            ...
            int i4 = 0;
            if (i2 > 0) {
                int length = this.f4173e.length;
                while (true) {
                    length--;
                    i3 = this.f4174f;
                    if (length < i3 || i2 <= 0) {
                        d[] dVarArr = this.f4173e;
                        System.arraycopy(dVarArr, i3 + 1, dVarArr, i3 + 1 + i4, this.f4175g);
                        this.f4174f += i4;
                    } else {
                        d[] dVarArr2 = this.f4173e;
                        i2 -= dVarArr2[length].c;
                        this.f4176h -= dVarArr2[length].c;
                        this.f4175g--;
                        i4++;
                    }
                }
                d[] dVarArr3 = this.f4173e;
                System.arraycopy(dVarArr3, i3 + 1, dVarArr3, i3 + 1 + i4, this.f4175g);
                this.f4174f += i4;
            }
            return i4;
        }
        ...
        public final h d(int i2) {
            ...
            if (i2 >= 0 && i2 <= e.b.length + -1) {
                ...
                StringBuilder i3 = f.a.a.a.a.i("Header index too large ");
                i3.append(i2 + 1);
        ...
        public final void e(int i2, d dVar) {
            ...
            int i3 = dVar.c;
            if (i2 != -1) {
                i3 -= this.f4173e[(this.f4174f + 1) + i2].c;
            }
            int i4 = this.f4172d;
            if (i3 > i4) {
                a();
            ...
            int c2 = c((this.f4176h + i3) - i4);
            if (i2 == -1) {
                int i5 = this.f4175g + 1;
                d[] dVarArr = this.f4173e;
                if (i5 > dVarArr.length) {
                    d[] dVarArr2 = new d[(dVarArr.length * 2)];
                    System.arraycopy(dVarArr, 0, dVarArr2, dVarArr.length, dVarArr.length);
                    this.f4174f = this.f4173e.length - 1;
                    this.f4173e = dVarArr2;
                }
                int i6 = this.f4174f;
                this.f4174f = i6 - 1;
                this.f4173e[i6] = dVar;
                ...
                this.f4173e[this.f4174f + 1 + i2 + c2 + i2] = dVar;
            }
            this.f4176h += i3;
        }
    ...
    public static final class b {
        ...
        public final void a(d dVar) {
            ...
            if (i3 > 4096) {
                ...
                this.f4178e = this.c.length - 1;
                this.f4177d = 0;
                this.f4179f = 0;
                return;
            }
            int i4 = (this.f4179f + i3) - 4096;
            if (i4 > 0) {
                ...
                while (true) {
                    ...
                    if (length < i2 || i4 <= 0) {
                        d[] dVarArr = this.c;
                        int i6 = i2 + 1;
                        System.arraycopy(dVarArr, i6, dVarArr, i6 + i5, this.f4177d);
                        this.f4178e += i5;
                    } else {
                        d[] dVarArr2 = this.c;
                        i4 -= dVarArr2[length].c;
                        this.f4179f -= dVarArr2[length].c;
                        this.f4177d--;
                        i5++;
                        length--;
                    }
                ...
                d[] dVarArr3 = this.c;
                int i62 = i2 + 1;
                System.arraycopy(dVarArr3, i62, dVarArr3, i62 + i5, this.f4177d);
                this.f4178e += i5;
            }
            int i7 = this.f4177d + 1;
            d[] dVarArr4 = this.c;
    ...
    public static h a(h hVar) {
        ...
        for (int i2 = 0; i2 < l2; i2++) {
            byte c2 = hVar.c(i2);
            if (c2 >= 65 && c2 <= 90) {
                StringBuilder i3 = f.a.a.a.a.i("PROTOCOL_ERROR response malformed: mixed case name: ");
                i3.append(hVar.q());
                throw new IOException(i3.toString());
            }
        }
