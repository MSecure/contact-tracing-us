...
public enum c implements e, f {
    ...
    public static final c[] f4288i = values();

    public static c r(int i2) {
        if (i2 >= 1 && i2 <= 7) {
            return f4288i[i2 - 1];
        }
        throw new b(a.v("Invalid value for DayOfWeek: ", i2));
    }
    ...
    public <R> R c(l<R> lVar) {
        ...
        if (lVar == k.f4459f || lVar == k.f4460g || lVar == k.b || lVar == k.f4457d || lVar == k.a || lVar == k.f4458e) {
            return null;
        }
        return lVar.a(this);
    }
