...
public final class k extends b implements d, f, Comparable<k>, Serializable {
    ...
    public static final /* synthetic */ int f4314d = 0;
    public final g b;
    public final r c;
    ...
    public static k q(e eVar) {
        ...
        try {
            ...
            throw new b(a.g(eVar, a.l("Unable to obtain OffsetDateTime from TemporalAccessor: ", eVar, ", type ")));
        }
    }
    ...
    public <R> R c(l<R> lVar) {
        ...
        if (lVar == l.b.a.x.k.f4458e || lVar == l.b.a.x.k.f4457d) {
            return (R) this.c;
        }
        if (lVar == l.b.a.x.k.f4459f) {
            return (R) this.b.b;
        }
        if (lVar == l.b.a.x.k.f4460g) {
            return (R) this.b.c;
        }
        if (lVar == l.b.a.x.k.a) {
            return null;
    ...
    public int compareTo(k kVar) {
        ...
        if (this.c.equals(kVar2.c)) {
            ...
            int e2 = c.e(u(), kVar2.u());
            if (e2 != 0) {
                return e2;
            }
            gVar2 = this.b;
            int i2 = gVar2.c.f4303e;
            gVar = kVar2.b;
            int i3 = i2 - gVar.c.f4303e;
            if (i3 != 0) {
                return i3;
            }
        }
    ...
    public d l(j jVar, long j2) {
        ...
        if (ordinal != 29) {
            ...
            gVar = this.b;
            rVar = r.z(aVar.f4441e.a(j2, aVar));
        }
        return v(gVar, rVar);
    }
    ...
    public String toString() {
        return this.b.toString() + this.c.f4324d;
    }
