...
public final class t extends f<f> implements d, Serializable {
    ...
    public static t F(e eVar) {
        ...
        try {
            ...
            throw new b(f.a.a.a.a.g(eVar, f.a.a.a.a.l("Unable to obtain ZonedDateTime from TemporalAccessor: ", eVar, ", type ")));
        }
    }
    ...
    public static t J(g gVar, q qVar, r rVar) {
        ...
        if (c2.size() == 1) {
            ...
            if (c2.size() == 0) {
                ...
                gVar = gVar.K(d.n((long) (b2.f4483d.c - b2.c.c)).b);
                rVar = b2.f4483d;
    ...
    public f<f> D(q qVar) {
        c.u(qVar, "zone");
        return this.f4327d.equals(qVar) ? this : J(this.b, qVar, this.c);
    }
    ...
    public t u(long j2, m mVar) {
        ...
        c.u(rVar, "offset");
        c.u(qVar, "zone");
        return E(H.v(rVar), H.c.f4303e, qVar);
    }

    public t L(long j2) {
        g gVar = this.b;
        return J(gVar.N(gVar.b.V(j2), gVar.c), this.f4327d, this.c);
    }

    public final t M(g gVar) {
        return J(gVar, this.f4327d, this.c);
    }

    public final t N(r rVar) {
        return (rVar.equals(this.c) || !this.f4327d.s().f(this.b, rVar)) ? this : new t(this.b, rVar, this.f4327d);
    }

    /* renamed from: O */
    public t e(l.b.a.x.f fVar) {
        if (fVar instanceof f) {
            return J(g.F((f) fVar, this.b.c), this.f4327d, this.c);
        }
        if (fVar instanceof h) {
            return J(g.F(this.b.b, (h) fVar), this.f4327d, this.c);
        }
        ...
        e eVar = (e) fVar;
        return E(eVar.b, eVar.c, this.f4327d);
    }
    ...
    public t l(j jVar, long j2) {
        ...
        if (ordinal == 28) {
            return E(j2, this.b.c.f4303e, this.f4327d);
        }
        if (ordinal != 29) {
            return M(this.b.l(jVar, j2));
        }
        return N(r.z(aVar.f4441e.a(j2, aVar)));
    }

    /* renamed from: Q */
    public t C(q qVar) {
        c.u(qVar, "zone");
        return this.f4327d.equals(qVar) ? this : E(this.b.v(this.c), this.b.c.f4303e, qVar);
    }
    ...
    public <R> R c(l<R> lVar) {
        return lVar == k.f4459f ? (R) this.b.b : (R) super.c(lVar);
    }
    ...
    public boolean equals(Object obj) {
        ...
        t tVar = (t) obj;
        return this.b.equals(tVar.b) && this.c.equals(tVar.c) && this.f4327d.equals(tVar.f4327d);
    }
    ...
    @Override // l.b.a.u.f
    public int hashCode() {
        return (this.b.hashCode() ^ this.c.c) ^ Integer.rotateLeft(this.f4327d.hashCode(), 3);
    }
    ...
    public String toString() {
        ...
        if (this.c == this.f4327d) {
            return str;
        }
        return str + '[' + this.f4327d.toString() + ']';
    }
