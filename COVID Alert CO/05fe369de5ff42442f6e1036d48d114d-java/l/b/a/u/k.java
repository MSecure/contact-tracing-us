...
public final class k extends a<k> implements Serializable {
    ...
    public static final Integer[] B = new Integer[f4334j.length];
    public static final Integer[] C = new Integer[f4335k.length];
    public static final Integer[] D = new Integer[f4336l.length];
    public static final Integer[] E = new Integer[p.length];

    /* renamed from: i  reason: collision with root package name */
    public static final int[] f4333i;

    /* renamed from: j  reason: collision with root package name */
    public static final int[] f4334j = {0, 30, 59, 89, 118, 148, 177, 207, 236, 266, 295, 325};

    /* renamed from: k  reason: collision with root package name */
    public static final int[] f4335k = {30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 29};

    /* renamed from: l  reason: collision with root package name */
    public static final int[] f4336l = {30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 30};
    ...
    public final transient int f4337d;

    /* renamed from: e  reason: collision with root package name */
    public final transient int f4338e;

    /* renamed from: f  reason: collision with root package name */
    public final transient int f4339f;

    /* renamed from: g  reason: collision with root package name */
    public final transient c f4340g;
    ...
    public static void E(int i2) {
        if (i2 < 1 || i2 > z[5].intValue()) {
            throw new b("Invalid day of month of Hijrah date, day " + i2 + " greater than " + z[5].intValue() + " or less than 1");
        }
    }
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                if (parseInt2 == -1 || parseInt3 == -1 || parseInt4 == -1 || parseInt5 == -1) {
                                                    throw new ParseException(a.w("Unknown error at line ", i2, "."), i2);
                                                } else if (parseInt2 < 1) {
                                                    ...
                                                    if (numArr == null) {
                                                        if (!M) {
                                                            numArr = new Integer[f4333i.length];
                                                            int i4 = 0;
                                                            while (true) {
                                                                int[] iArr = f4333i;
                                                                if (i4 >= iArr.length) {
                                                            ...
                                                            numArr = new Integer[f4334j.length];
                                                            int i5 = 0;
                                                            while (true) {
                                                                int[] iArr2 = f4334j;
                                                                if (i5 >= iArr2.length) {
                                                    ...
                                                    if (numArr3 == null) {
                                                        if (!M) {
                                                            numArr3 = new Integer[f4335k.length];
                                                            int i7 = 0;
                                                            while (true) {
                                                                int[] iArr3 = f4335k;
                                                                if (i7 >= iArr3.length) {
                                                            ...
                                                            numArr3 = new Integer[f4336l.length];
                                                            int i8 = 0;
                                                            while (true) {
                                                                int[] iArr4 = f4336l;
                                                                if (i8 >= iArr4.length) {
                                                    ...
                                                    if (numArr9 == null) {
                                                        if (!M2) {
                                                            numArr9 = new Integer[f4333i.length];
                                                            int i21 = 0;
                                                            while (true) {
                                                                int[] iArr5 = f4333i;
                                                                if (i21 >= iArr5.length) {
                                                            ...
                                                            numArr9 = new Integer[f4334j.length];
                                                            int i22 = 0;
                                                            while (true) {
                                                                int[] iArr6 = f4334j;
                                                                if (i22 >= iArr6.length) {
                                                    ...
                                                    if (numArr11 == null) {
                                                        if (!M2) {
                                                            numArr11 = new Integer[f4335k.length];
                                                            int i24 = 0;
                                                            while (true) {
                                                                int[] iArr7 = f4335k;
                                                                if (i24 >= iArr7.length) {
                                                            ...
                                                            numArr11 = new Integer[f4336l.length];
                                                            int i25 = 0;
                                                            while (true) {
                                                                int[] iArr8 = f4336l;
                                                                if (i25 >= iArr8.length) {
                                                ...
                                                throw new ParseException(a.w("End month is not properly set at line ", i3, "."), i3);
                                            }
                                        } catch (NumberFormatException unused2) {
                                            throw new ParseException(a.w("End year is not properly set at line ", i3, "."), i3);
                                        }
                                    } else {
                                        throw new ParseException(a.w("End year/month has incorrect format at line ", i3, "."), i3);
                                    }
                                } catch (NumberFormatException unused3) {
                                    throw new ParseException(a.w("Start month is not properly set at line ", i3, "."), i3);
                                }
                            } catch (NumberFormatException unused4) {
                                throw new ParseException(a.w("Start year is not properly set at line ", i3, "."), i3);
                            }
                        } else {
                            throw new ParseException(a.w("Start year/month has incorrect format at line ", i3, "."), i3);
                        }
                    } else {
                        throw new ParseException(a.w("Start and end year/month has incorrect format at line ", i3, "."), i3);
                    }
                } catch (NumberFormatException unused5) {
                    throw new ParseException(a.w("Offset is not properly set at line ", i3, "."), i3);
                }
            } else {
                throw new ParseException(a.w("Offset has incorrect format at line ", i3, "."), i3);
            }
        }
    }
    ...
    public static void R() {
        ...
        if (property2 != null) {
            if (property2.length() != 0 || !property2.endsWith(System.getProperty("file.separator"))) {
                StringBuilder i2 = a.i(property2);
                i2.append(System.getProperty("file.separator"));
                property2 = i2.toString();
            }
            StringBuilder i3 = a.i(property2);
            i3.append(q);
            i3.append(property);
            ...
            while (true) {
                ...
                if (file2.exists()) {
                    if (file2.isDirectory()) {
                        StringBuilder i5 = a.i(nextToken);
                        char c2 = q;
                        i5.append(c2);
                        String str = s;
                        i5.append(str);
                        if (new File(i5.toString(), property).exists()) {
                            try {
    ...
    public a<k> C(long j2) {
        ...
        int i2 = (this.f4337d - 1) + ((int) j2);
        int i3 = i2 / 12;
        int i4 = i2 % 12;
        while (i4 < 0) {
            i4 += 12;
            i3 = g.b.a.c.c.c.z(i3, 1);
        }
        return O(this.b, g.b.a.c.c.c.v(this.c, i3), i4 + 1, this.f4338e);
    }
    ...
    public a<k> D(long j2) {
        ...
        return O(this.b, g.b.a.c.c.c.v(this.c, (int) j2), this.f4337d, this.f4338e);
    }
    ...
    public k z(j jVar, long j2) {
        ...
        aVar.f4441e.b(j2, aVar);
        int i2 = (int) j2;
        switch (aVar.ordinal()) {
            case 15:
                return Q(j2 - ((long) this.f4340g.q()));
            case 16:
                return Q(j2 - i(l.b.a.x.a.ALIGNED_DAY_OF_WEEK_IN_MONTH));
            case 17:
                return Q(j2 - i(l.b.a.x.a.ALIGNED_DAY_OF_WEEK_IN_YEAR));
            case 18:
                return S(this.c, this.f4337d, i2);
            case 19:
                int i3 = i2 - 1;
            ...
            case 21:
                return Q((j2 - i(l.b.a.x.a.ALIGNED_WEEK_OF_MONTH)) * 7);
            case 22:
                return Q((j2 - i(l.b.a.x.a.ALIGNED_WEEK_OF_YEAR)) * 7);
            case 23:
                return S(this.c, i2, this.f4338e);
            case 24:
            default:
            ...
            case 25:
                ...
                return S(i2, this.f4337d, this.f4338e);
            case 26:
                return S(i2, this.f4337d, this.f4338e);
            case 27:
                return S(1 - this.c, this.f4337d, this.f4338e);
        }
    }
    ...
    public d e(f fVar) {
        return (k) j.f4329d.e(fVar.n(this));
    }
    ...
    @Override // l.b.a.u.b
    public b w(i iVar) {
        return (k) j.f4329d.e(((l.b.a.m) iVar).b(this));
    }

    @Override // l.b.a.u.b
    public long x() {
        return J(this.c, this.f4337d, this.f4338e);
    }
