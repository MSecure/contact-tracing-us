...
public final class d {
    ...
    public static final l.b.a.x.l<l.b.a.q> f4380h = new a();

    /* renamed from: i  reason: collision with root package name */
    public static final Map<Character, l.b.a.x.j> f4381i;

    /* renamed from: j  reason: collision with root package name */
    public static final Comparator<String> f4382j = new c();
    public d a;
    public final d b;
    ...
    /* renamed from: l.b.a.v.d$d  reason: collision with other inner class name */
    public static final class C0155d implements f {
        public final char b;

        public C0155d(char c) {
            this.b = c;
        }
    ...
    public static final class e implements f {
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            if (this.c) {
                ArrayList<e.a> arrayList = eVar.f4408g;
                e.a b2 = eVar.b();
                e.a aVar = new e.a();
                aVar.b = b2.b;
                aVar.c = b2.c;
                aVar.f4409d.putAll(b2.f4409d);
                aVar.f4410e = b2.f4410e;
                arrayList.add(aVar);
                int i3 = i2;
                for (f fVar : this.b) {
    ...
    public static final class g implements f {
        ...
        public g(l.b.a.x.j jVar, int i2, int i3, boolean z) {
            ...
            l.b.a.x.o h2 = jVar.h();
            if (!(h2.b == h2.c && h2.f4461d == h2.f4462e)) {
                throw new IllegalArgumentException(f.a.a.a.a.e("Field must have a fixed set of values: ", jVar));
            } else if (i2 < 0 || i2 > 9) {
                throw new IllegalArgumentException(f.a.a.a.a.v("Minimum width must be from 0 to 9 inclusive but was ", i2));
            } else if (i3 < 1 || i3 > 9) {
                throw new IllegalArgumentException(f.a.a.a.a.v("Maximum width must be from 1 to 9 inclusive but was ", i3));
            } else if (i3 >= i2) {
                this.b = jVar;
                this.c = i2;
                this.f4387d = i3;
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            BigDecimal divide = BigDecimal.valueOf(longValue).subtract(valueOf).divide(BigDecimal.valueOf(h2.f4462e).subtract(valueOf).add(BigDecimal.ONE), 9, RoundingMode.FLOOR);
            BigDecimal stripTrailingZeros = divide.compareTo(BigDecimal.ZERO) == 0 ? BigDecimal.ZERO : divide.stripTrailingZeros();
            if (stripTrailingZeros.scale() != 0) {
                String a = jVar.a(stripTrailingZeros.setScale(Math.min(Math.max(stripTrailingZeros.scale(), this.c), this.f4387d), RoundingMode.FLOOR).toPlainString().substring(2));
                if (this.f4388e) {
                    sb.append(jVar.f4418d);
                }
                sb.append(a);
                return true;
            } else if (this.c <= 0) {
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            int i3;
            boolean z = eVar.f4407f;
            int i4 = z ? this.c : 0;
            int i5 = z ? this.f4387d : 9;
            int length = charSequence.length();
            if (i2 == length) {
                return i4 > 0 ? ~i2 : i2;
            }
            if (this.f4388e) {
                if (charSequence.charAt(i2) != eVar.b.f4418d) {
                    return i4 > 0 ? ~i2 : i2;
                }
                i2++;
            }
            ...
            l.b.a.x.o h2 = this.b.h();
            BigDecimal valueOf = BigDecimal.valueOf(h2.b);
            return eVar.g(this.b, movePointLeft.multiply(BigDecimal.valueOf(h2.f4462e).subtract(valueOf).add(BigDecimal.ONE)).setScale(0, RoundingMode.FLOOR).add(valueOf).longValueExact(), i2, i3);
        }

        public String toString() {
            String str = this.f4388e ? ",DecimalPoint" : "";
            StringBuilder i2 = f.a.a.a.a.i("Fraction(");
            i2.append(this.b);
            i2.append(",");
            i2.append(this.c);
            i2.append(",");
            i2.append(this.f4387d);
            i2.append(str);
            i2.append(")");
            return i2.toString();
        }
    ...
    public static final class h implements f {
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            if (longValue >= -62167219200L) {
                ...
                long i3 = g.b.a.c.c.c.i(j2, 315569520000L) + 1;
                l.b.a.g G = l.b.a.g.G(g.b.a.c.c.c.l(j2, 315569520000L) - 62167219200L, 0, l.b.a.r.f4321g);
                if (i3 > 0) {
                    sb.append('+');
                    sb.append(i3);
                }
                ...
                l.b.a.g G2 = l.b.a.g.G(j5 - 62167219200L, 0, l.b.a.r.f4321g);
                int length = sb.length();
                sb.append(G2);
                if (G2.c.f4302d == 0) {
                    sb.append(":00");
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            try {
                l.b.a.g gVar = l.b.a.g.f4296d;
                return eVar.g(aVar4, (long) intValue6, i2, eVar.g(l.b.a.x.a.INSTANT_SECONDS, new l.b.a.g(l.b.a.f.P(i4, intValue, intValue2), l.b.a.h.v(intValue3, intValue4, intValue5, 0)).I((long) i3).v(l.b.a.r.f4321g) + g.b.a.c.c.c.y(longValue / 10000, 315569520000L), i2, b));
    ...
    public static final class i implements f {
        ...
        @Override // l.b.a.v.d.f
        public boolean a(h hVar, StringBuilder sb) {
            Long b2 = hVar.b(l.b.a.x.a.OFFSET_SECONDS);
            if (b2 == null) {
                return false;
            }
            sb.append("GMT");
            ...
            int B = g.b.a.c.c.c.B(b2.longValue());
            if (B == 0) {
                return true;
            }
    ...
    public static final class j implements f {
        ...
        public String toString() {
            StringBuilder i2 = f.a.a.a.a.i("Localized(");
            Object obj = this.b;
            Object obj2 = "";
            if (obj == null) {
                obj = obj2;
    ...
    public static class k implements f {
        ...
        /* renamed from: g  reason: collision with root package name */
        public static final int[] f4389g = {0, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000};
        public final l.b.a.x.j b;
        public final int c;
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            if (str.length() <= this.f4390d) {
                String a = jVar.a(str);
                int i3 = (c3 > 0 ? 1 : (c3 == 0 ? 0 : -1));
                int ordinal = this.f4391e.ordinal();
                if (i3 >= 0) {
                    if (ordinal == 1 || (ordinal == 4 && (i2 = this.c) < 19 && c3 >= ((long) f4389g[i2]))) {
                        c2 = jVar.b;
                    }
                ...
                if (!(ordinal == 0 || ordinal == 1)) {
                    if (ordinal == 3) {
                        StringBuilder i5 = f.a.a.a.a.i("Field ");
                        i5.append(this.b);
                        i5.append(" cannot be printed as the value ");
                        i5.append(c3);
                        i5.append(" cannot be negative according to the SignStyle");
                        throw new l.b.a.b(i5.toString());
                    }
                }
                c2 = jVar.c;
                sb.append(c2);
            ...
            StringBuilder i6 = f.a.a.a.a.i("Field ");
            i6.append(this.b);
            i6.append(" cannot be printed as the value ");
            i6.append(c3);
            i6.append(" exceeds the maximum print width of ");
            i6.append(this.f4390d);
            throw new l.b.a.b(i6.toString());
        }
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            int i8 = 0;
            if (charAt == jVar.b) {
                if (!this.f4391e.a(true, eVar.f4407f, this.c == this.f4390d)) {
                    return ~i7;
                }
                i3 = i7 + 1;
                z2 = true;
                ...
                if (charAt == jVar.c) {
                    if (!this.f4391e.a(false, eVar.f4407f, this.c == this.f4390d)) {
                        return ~i7;
                    }
                    i7++;
                    z = true;
                } else if (this.f4391e == m.ALWAYS && eVar.f4407f) {
                    return ~i7;
                } else {
                    z = false;
                }
            ...
            int i9 = (eVar.f4407f || d(eVar)) ? this.c : 1;
            int i10 = i3 + i9;
            if (i10 > length) {
                return ~i3;
            }
            int i11 = 9;
            int max = Math.max(this.f4392f, 0) + ((eVar.f4407f || d(eVar)) ? this.f4390d : 9);
            while (true) {
                bigInteger = null;
                if (i8 >= 2) {
                    i4 = i3;
            ...
            if (z) {
                if (bigInteger != null) {
                    if (bigInteger.equals(BigInteger.ZERO) && eVar.f4407f) {
                        return ~(i3 - 1);
                    }
                    bigInteger = bigInteger.negate();
                } else if (j2 == 0 && eVar.f4407f) {
                    return ~(i3 - 1);
                } else {
                    j3 = -j2;
                    if (bigInteger != null) {
            ...
            } else if (this.f4391e == m.EXCEEDS_PAD && eVar.f4407f) {
                int i14 = i4 - i3;
                int i15 = this.c;
                if (z2) {
                    if (i14 <= i15) {
        ...
        public boolean d(e eVar) {
            int i2 = this.f4392f;
            return i2 == -1 || (i2 > 0 && this.c == this.f4390d && this.f4391e == m.NOT_NEGATIVE);
        }
        ...
        public k f() {
            return this.f4392f == -1 ? this : new k(this.b, this.c, this.f4390d, this.f4391e, -1);
        }

        public k g(int i2) {
            return new k(this.b, this.c, this.f4390d, this.f4391e, this.f4392f + i2);
        }
        ...
        public String toString() {
            ...
            Object obj;
            int i2 = this.c;
            if (i2 == 1 && this.f4390d == 19 && this.f4391e == m.NORMAL) {
                sb = f.a.a.a.a.i("Value(");
                obj = this.b;
            } else if (i2 == this.f4390d && this.f4391e == m.NOT_NEGATIVE) {
                sb = f.a.a.a.a.i("Value(");
                sb.append(this.b);
                sb.append(",");
                sb.append(this.c);
    ...
    public static final class l implements f {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final String[] f4393d = {"+HH", "+HHmm", "+HH:mm", "+HHMM", "+HH:MM", "+HHMMss", "+HH:MM:ss", "+HHMMSS", "+HH:MM:SS"};

        /* renamed from: e  reason: collision with root package name */
        public static final l f4394e = new l("Z", "+HH:MM:ss");
        public final String b;
        public final int c;

        public l(String str, String str2) {
            g.b.a.c.c.c.u(str, "noOffsetText");
            g.b.a.c.c.c.u(str2, "pattern");
            this.b = str;
            int i2 = 0;
            while (true) {
                String[] strArr = f4393d;
                if (i2 >= strArr.length) {
                    throw new IllegalArgumentException(f.a.a.a.a.c("Invalid zone offset pattern: ", str2));
        ...
        public String toString() {
            ...
            StringBuilder i2 = f.a.a.a.a.i("Offset(");
            i2.append(f4393d[this.c]);
            i2.append(",'");
            i2.append(replace);
            i2.append("')");
            return i2.toString();
    ...
    public static final class m implements f {
        ...
        public String toString() {
            String str;
            StringBuilder i2 = f.a.a.a.a.i("Pad(");
            i2.append(this.b);
            i2.append(",");
            i2.append(this.c);
            if (this.f4395d == ' ') {
                ...
                StringBuilder i3 = f.a.a.a.a.i(",'");
                i3.append(this.f4395d);
                i3.append("')");
                str = i3.toString();
            }
            i2.append(str);
    ...
    public static final class n extends k {
        ...
        /* renamed from: j  reason: collision with root package name */
        public static final l.b.a.f f4396j = l.b.a.f.P(2000, 1, 1);

        /* renamed from: h  reason: collision with root package name */
        public final int f4397h;

        /* renamed from: i  reason: collision with root package name */
        public final l.b.a.u.b f4398i;

        public n(l.b.a.x.j jVar, int i2, int i3, int i4, l.b.a.u.b bVar) {
            super(jVar, i2, i3, m.NOT_NEGATIVE);
            if (i2 < 1 || i2 > 10) {
                throw new IllegalArgumentException(f.a.a.a.a.v("The width must be from 1 to 10 inclusive but was ", i2));
            } else if (i3 < 1 || i3 > 10) {
                throw new IllegalArgumentException(f.a.a.a.a.v("The maxWidth must be from 1 to 10 inclusive but was ", i3));
            } else if (i3 >= i2) {
                if (bVar == null) {
                    long j2 = (long) i4;
                    if (!jVar.h().c(j2)) {
                        throw new IllegalArgumentException("The base value must be within the range of the field");
                    } else if (j2 + ((long) k.f4389g[i2]) > 2147483647L) {
        ...
        public long c(h hVar, long j2) {
            ...
            int i3 = this.f4397h;
            if (this.f4398i != null) {
                i3 = l.b.a.u.h.l(hVar.a).c(this.f4398i).b(this.b);
            }
            if (j2 >= ((long) i3)) {
                int[] iArr = k.f4389g;
                int i4 = this.c;
        ...
        public int e(e eVar, long j2, int i2, int i3) {
            int i4 = this.f4397h;
            if (this.f4398i != null) {
                i4 = eVar.d().c(this.f4398i).b(this.b);
                e.a b = eVar.b();
                if (b.f4412g == null) {
                    b.f4412g = new ArrayList(2);
                }
                b.f4412g.add(new Object[]{this, Long.valueOf(j2), Integer.valueOf(i2), Integer.valueOf(i3)});
            }
            int i5 = i3 - i2;
            int i6 = this.c;
            if (i5 == i6 && j2 >= 0) {
                long j3 = (long) k.f4389g[i6];
                long j4 = (long) i4;
                long j5 = j4 - (j4 % j3);
                j2 = i4 > 0 ? j5 + j2 : j5 - j2;
                if (j2 < j4) {
        ...
        @Override // l.b.a.v.d.k
        public k f() {
            return this.f4392f == -1 ? this : new n(this.b, this.c, this.f4390d, this.f4397h, this.f4398i, -1);
        }

        @Override // l.b.a.v.d.k
        public k g(int i2) {
            return new n(this.b, this.c, this.f4390d, this.f4397h, this.f4398i, this.f4392f + i2);
        }

        @Override // l.b.a.v.d.k
        public String toString() {
            StringBuilder i2 = f.a.a.a.a.i("ReducedValue(");
            i2.append(this.b);
            i2.append(",");
            i2.append(this.c);
            i2.append(",");
            i2.append(this.f4390d);
            i2.append(",");
            Object obj = this.f4398i;
            if (obj == null) {
                obj = Integer.valueOf(this.f4397h);
            }
            i2.append(obj);
            i2.append(")");
            return i2.toString();
    ...
    public static final class p implements f {
        ...
        public String toString() {
            return f.a.a.a.a.d("'", this.b.replace("'", "''"), "'");
        }
    }
    ...
    public static final class q implements f {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final i f4402d;

        /* renamed from: e  reason: collision with root package name */
        public volatile k f4403e;
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            String a = this.f4402d.a(this.b, b2.longValue(), this.c, hVar.b);
            if (a == null) {
                return c().a(hVar, sb);
            }
            sb.append(a);
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            Iterator<Map.Entry<String, Long>> b2 = this.f4402d.b(this.b, eVar.f4407f ? this.c : null, eVar.a);
            if (b2 != null) {
                while (b2.hasNext()) {
        ...
        public final k c() {
            if (this.f4403e == null) {
                this.f4403e = new k(this.b, 1, 19, m.NORMAL);
            }
            return this.f4403e;
        }
    ...
    public static final class r implements f {
        ...
        public final f c(l.b.a.x.p pVar) {
            ...
            char c2 = this.b;
            if (c2 == 'W') {
                kVar = new k(pVar.f4465e, 1, 2, mVar);
            } else if (c2 == 'Y') {
                int i2 = this.c;
                if (i2 == 2) {
                    kVar2 = new n(pVar.f4467g, 2, 2, 0, n.f4396j);
                } else {
                    kVar2 = new k(pVar.f4467g, i2, 19, i2 < 4 ? m.NORMAL : m.EXCEEDS_PAD, -1, null);
                }
                return kVar2;
            } else if (c2 == 'c') {
                kVar = new k(pVar.f4464d, this.c, 2, mVar);
            } else if (c2 == 'e') {
                kVar = new k(pVar.f4464d, this.c, 2, mVar);
            } else if (c2 != 'w') {
                return null;
            } else {
                kVar = new k(pVar.f4466f, this.c, 2, mVar);
            }
            return kVar;
        }
    ...
    public static final class s implements f {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static volatile Map.Entry<Integer, a> f4404d;
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            if (i2 > length) {
                ...
                if (charAt == '+' || charAt == '-') {
                    Objects.requireNonNull(eVar);
                    e eVar2 = new e(eVar);
                    int b2 = l.f4394e.b(eVar2, charSequence, i2);
                    if (b2 < 0) {
                        return b2;
                    }
                ...
                Map.Entry<Integer, a> entry = f4404d;
                String str2 = null;
                if (entry == null || entry.getKey().intValue() != size) {
                    synchronized (this) {
                        ...
                        if (entry == null || entry.getKey().intValue() != size) {
                            ...
                            Collections.sort(arrayList, d.f4382j);
                ...
                l.b.a.q c2 = c(unmodifiableSet, str3, eVar.f4406e);
                if (c2 == null) {
                    c2 = c(unmodifiableSet, str2, eVar.f4406e);
                    if (c2 == null) {
                        if (!eVar.a(charAt, 'Z')) {
                            return ~i2;
                        }
                        eVar.f(l.b.a.r.f4321g);
                        return i2 + 1;
                    }
                } else {
                    str2 = str3;
        ...
        public final int d(e eVar, CharSequence charSequence, int i2, int i3) {
            ...
            e eVar2 = new e(eVar);
            if ((i3 >= charSequence.length() || !eVar.a(charSequence.charAt(i3), 'Z')) && (b2 = l.f4394e.b(eVar2, charSequence, i3)) >= 0) {
                eVar.f(l.b.a.q.u(upperCase, l.b.a.r.z((int) eVar2.e(l.b.a.x.a.OFFSET_SECONDS).longValue())));
                return b2;
            }
            eVar.f(l.b.a.q.u(upperCase, l.b.a.r.f4321g));
            return i3;
        }
    ...
    public static final class t implements f {
        ...
        public String toString() {
            StringBuilder i2 = f.a.a.a.a.i("ZoneText(");
            i2.append(this.b);
            i2.append(")");
            return i2.toString();
        }
    ...
    public final int c(f fVar) {
        g.b.a.c.c.c.u(fVar, "pp");
        d dVar = this.a;
        int i2 = dVar.f4384e;
        if (i2 > 0) {
            m mVar = new m(fVar, i2, dVar.f4385f);
            dVar.f4384e = 0;
            dVar.f4385f = 0;
            fVar = mVar;
        }
    ...
    public d e(String str) {
        g.b.a.c.c.c.u(str, "literal");
        if (str.length() > 0) {
            c(str.length() == 1 ? new C0155d(str.charAt(0)) : new p(str));
        }
        return this;
    }

    public d f(p pVar) {
        g.b.a.c.c.c.u(pVar, "style");
        ...
        while (i3 < str.length()) {
            ...
            if ((charAt >= 'A' && charAt <= 'Z') || (charAt >= 'a' && charAt <= 'z')) {
                ...
                if (charAt == 'p') {
                    ...
                    if (i5 == 0) {
                        throw new IllegalArgumentException(f.a.a.a.a.c("Pad letter 'p' must be followed by valid pad pattern: ", str));
                    } else if (i5 >= 1) {
                        d dVar = this.a;
                        dVar.f4384e = i5;
                        dVar.f4385f = ' ';
                        ...
                        throw new IllegalArgumentException(f.a.a.a.a.v("The pad width must be at least one but was ", i5));
                    }
                }
                l.b.a.x.j jVar = f4381i.get(Character.valueOf(charAt));
                if (jVar != null) {
                                            ...
                                            if (charAt != 'u' && charAt != 'y') {
                                                switch (charAt) {
                                                    case 'D':
                                                        if (i5 != 1) {
                                                            if (i5 > 3) {
                                                                throw new IllegalArgumentException(f.a.a.a.a.u("Too many pattern letters: ", charAt));
                                                            }
                                                            m(jVar, i5);
                                                            break;
                                                        }
                                                                ...
                                                                switch (charAt) {
                                                                    case 'c':
                                                                        if (i5 == 1) {
                                                                            ...
                                                                            throw new IllegalArgumentException(f.a.a.a.a.u("Invalid number of pattern letters: ", charAt));
                                                                        }
                                                                    case 'e':
                                                                        if (i5 != 1 && i5 != 2) {
                                                                            if (i5 != 3) {
                                                ...
                                                l.b.a.f fVar = n.f4396j;
                                                g.b.a.c.c.c.u(jVar, "field");
                                                g.b.a.c.c.c.u(fVar, "baseDate");
                    ...
                    if (charAt == 'Z') {
                        ...
                        if (i5 == 1) {
                            ...
                            throw new IllegalArgumentException(f.a.a.a.a.u("Pattern letter count must be 1 or 4: ", charAt));
                        }
                    } else if (charAt == 'X') {
                        if (i5 <= 5) {
                            str3 = l.f4393d[i5 + (i5 == 1 ? 0 : 1)];
                            g(str3, "Z");
                        } else {
                            throw new IllegalArgumentException(f.a.a.a.a.u("Too many pattern letters: ", charAt));
                        }
                        ...
                        if (charAt == 'W') {
                            ...
                            throw new IllegalArgumentException(f.a.a.a.a.u("Unknown pattern letter: ", charAt));
                        }
                        c(rVar);
                    } else if (i5 <= 5) {
                        if (i5 == 1) {
                    ...
                    throw new IllegalArgumentException(f.a.a.a.a.u("Pattern letter count must be 2: ", charAt));
                }
                i3 = i4 - 1;
            } else if (charAt == '\'') {
                int i7 = i3 + 1;
                ...
                while (i8 < str.length()) {
                    if (str.charAt(i8) == '\'') {
                        ...
                        if (i8 >= str.length()) {
                            ...
                            throw new IllegalArgumentException(f.a.a.a.a.c("Pattern ends with an incomplete string literal: ", str));
                        }
                    }
                    i8++;
                }
    ...
    public final d k(k kVar) {
        ...
        if (i2 < 0 || !(dVar.c.get(i2) instanceof k)) {
            ...
            int i4 = kVar.c;
            int i5 = kVar.f4390d;
            if (i4 == i5 && kVar.f4391e == m.NOT_NEGATIVE) {
                kVar2 = kVar3.g(i5);
                c(kVar.f());
                this.a.f4386g = i3;
            } else {
    ...
    public d m(l.b.a.x.j jVar, int i2) {
        g.b.a.c.c.c.u(jVar, "field");
        if (i2 < 1 || i2 > 19) {
            throw new IllegalArgumentException(f.a.a.a.a.v("The width must be from 1 to 19 inclusive but was ", i2));
        }
    ...
    public d n(l.b.a.x.j jVar, int i2, int i3, m mVar) {
        ...
        g.b.a.c.c.c.u(jVar, "field");
        g.b.a.c.c.c.u(mVar, "signStyle");
        if (i2 < 1 || i2 > 19) {
            throw new IllegalArgumentException(f.a.a.a.a.v("The minimum width must be from 1 to 19 inclusive but was ", i2));
        } else if (i3 < 1 || i3 > 19) {
            throw new IllegalArgumentException(f.a.a.a.a.v("The maximum width must be from 1 to 19 inclusive but was ", i3));
        } else if (i3 >= i2) {
    ...
    public d o() {
        ...
        if (dVar.b != null) {
            if (dVar.c.size() > 0) {
                d dVar2 = this.a;
                e eVar = new e(dVar2.c, dVar2.f4383d);
                this.a = this.a.b;
                c(eVar);
            } else {
                this.a = this.a.b;
    ...
    public c r(Locale locale) {
        ...
        return new c(new e(this.c, false), locale, j.f4417e, l.SMART, null, null, null);
    }

    public c s(l lVar) {
        c q2 = q();
        g.b.a.c.c.c.u(lVar, "resolverStyle");
        return g.b.a.c.c.c.h(q2.f4376d, lVar) ? q2 : new c(q2.a, q2.b, q2.c, lVar, q2.f4377e, q2.f4378f, q2.f4379g);
    }
}
