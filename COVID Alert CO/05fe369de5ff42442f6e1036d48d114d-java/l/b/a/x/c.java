...
public final class c {
    public static final m a = EnumC0158c.WEEK_BASED_YEARS;
    ...
    public enum b implements j {
        DAY_OF_QUARTER {
            ...
            public e e(Map<j, Long> map, e eVar, l lVar) {
                ...
                if (lVar == l.LENIENT) {
                    fVar = f.P(m, 1, 1).W(g.b.a.c.c.c.x(g.b.a.c.c.c.A(l3.longValue(), 1), 3)).V(g.b.a.c.c.c.A(longValue, 1));
                } else {
                    int a = ((C0156b) bVar).h().a(l3.longValue(), bVar);
                    if (lVar == l.STRICT) {
                        int i2 = 92;
                        if (a == 1) {
                            if (!m.f4343d.u((long) m)) {
                                i2 = 90;
                                oVar = o.d(1, (long) i2);
                            }
                        }
            ...
            public long f(e eVar) {
                if (eVar.f(this)) {
                    return (long) (eVar.b(a.DAY_OF_YEAR) - b.f4453f[((eVar.b(a.MONTH_OF_YEAR) - 1) / 3) + (m.f4343d.u(eVar.i(a.YEAR)) ? 4 : 0)]);
                }
            ...
            public o l(e eVar) {
                if (eVar.f(this)) {
                    ...
                    return m.f4343d.u(eVar.i(a.YEAR)) ? o.d(1, 91) : o.d(1, 90);
                }
                throw new n("Unsupported field: DayOfQuarter");
            }
        ...
        WEEK_OF_WEEK_BASED_YEAR {
            ...
            public <R extends d> R c(R r, long j2) {
                h().b(j2, this);
                return (R) r.m(g.b.a.c.c.c.A(j2, f(r)), b.WEEKS);
            }
            ...
            public e e(Map<j, Long> map, e eVar, l lVar) {
                ...
                int a = a.YEAR.f4441e.a(l2.longValue(), bVar2);
        ...
        WEEK_BASED_YEAR {
            ...
            public <R extends d> R c(R r, long j2) {
                if (b(r)) {
                    int a = a.YEAR.f4441e.a(j2, b.WEEK_BASED_YEAR);
                    f E = f.E(r);
                    a aVar = a.DAY_OF_WEEK;
                    int b = E.b(aVar);
                    int n = b.n(E);
        ...
        public static final int[] f4453f = {0, 90, 181, 273, 0, 91, 182, 274};
        ...
        public static boolean m(e eVar) {
            return h.l(eVar).equals(m.f4343d);
        }
        ...
        public static int n(f fVar) {
            ...
            if (H < i4) {
                ...
                return (int) o.d(1, (long) q(o(fVar.Y(-1)))).f4462e;
            }
            int i5 = ((H - i4) / 7) + 1;
            if (i5 == 53) {
            }
    ...
    public enum EnumC0158c implements m {
        ...
        public long b(d dVar, d dVar2) {
            ...
            if (ordinal == 0) {
                ...
                return g.b.a.c.c.c.A(dVar2.i(bVar), dVar.i(bVar));
            } else if (ordinal == 1) {
        ...
        public <R extends d> R c(R r, long j2) {
            ...
            if (ordinal == 0) {
                m mVar = c.a;
                b bVar = b.WEEK_BASED_YEAR;
                return (R) r.l(bVar, g.b.a.c.c.c.w((long) r.b(bVar), j2));
            } else if (ordinal == 1) {
    ...
    static {
        EnumC0158c cVar = EnumC0158c.QUARTER_YEARS;
    }
}
