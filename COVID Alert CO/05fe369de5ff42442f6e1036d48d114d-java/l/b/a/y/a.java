...
public final class a implements Externalizable {
    ...
    public void writeExternal(ObjectOutput objectOutput) {
        ...
        if (b2 == 1) {
            ...
            objectOutput.writeInt(bVar.f4476d.length);
            for (long j3 : bVar.f4476d) {
                d(j3, objectOutput);
            }
            for (r rVar2 : bVar.f4478f) {
                e(rVar2, objectOutput);
            }
            objectOutput.writeByte(bVar.f4479g.length);
            for (e eVar : bVar.f4479g) {
                eVar.b(objectOutput);
            }
        } else if (b2 == 2) {
            d dVar = (d) obj;
