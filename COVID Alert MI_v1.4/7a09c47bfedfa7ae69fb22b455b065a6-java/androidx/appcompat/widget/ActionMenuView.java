...
public class ActionMenuView extends i0 implements g.b, n {
    ...
    public class d implements g.a {
        ...
        public boolean a(g gVar, MenuItem menuItem) {
            ...
            if (fVar != null ? r.this.f572c.onMenuItemSelected(0, menuItem) : false) {
                return true;
            }
            return false;
        }
    ...
    public void onLayout(boolean z2, int i, int i2, int i3, int i4) {
        ...
        if (a2) {
            ...
            for (int i16 = 0; i16 < childCount; i16++) {
                ...
                if (childAt3.getVisibility() != 8 && !cVar2.f93c) {
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (childAt4.getVisibility() != 8 && !cVar3.f93c) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        while (i17 < childCount2) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                cVar2.f97g = z7 && ((ActionMenuItemView) childAt).c();
                int u2 = u(childAt, i12, cVar2.f93c ? 1 : i10, childMeasureSpec, paddingBottom);
                i15 = Math.max(i15, u2);
                if (cVar2.f96f) {
                    i16++;
                }
        ...
        if (i10 > 0 && j != 0 && (i10 < i13 - 1 || z10 || i15 > 1)) {
            ...
            if (!z10) {
                if ((j & 1) != 0 && !((c) getChildAt(0).getLayoutParams()).f97g) {
                    bitCount -= 0.5f;
                }
                int i30 = childCount2 - 1;
                if ((j & ((long) (1 << i30))) != 0 && !((c) getChildAt(i30).getLayoutParams()).f97g) {
                    bitCount -= 0.5f;
                }
            }
        ...
        if (z2) {
            for (int i33 = 0; i33 < childCount2; i33++) {
                ...
                if (cVar6.h) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((cVar6.f94d * i12) + cVar6.f95e, 1073741824), childMeasureSpec);
                }
            }
        }
        if (mode != 1073741824) {
