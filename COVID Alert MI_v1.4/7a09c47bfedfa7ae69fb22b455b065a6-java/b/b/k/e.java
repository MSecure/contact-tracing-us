...
public class e extends o implements DialogInterface {
    ...
    public final AlertController f514d = new AlertController(getContext(), this, getWindow());

    public static class a {

        /* renamed from: a  reason: collision with root package name */
        public final AlertController.b f515a;
        ...
        public a(Context context) {
            ...
            this.f515a = new AlertController.b(new ContextThemeWrapper(context, e.d(context, d2)));
            this.f516b = d2;
        }

        public a(Context context, int i) {
            this.f515a = new AlertController.b(new ContextThemeWrapper(context, e.d(context, i)));
            this.f516b = i;
        }

        public e a() {
            e eVar = new e(this.f515a.f59a, this.f516b);
            AlertController.b bVar = this.f515a;
            AlertController alertController = eVar.f514d;
            View view = bVar.f65g;
            if (view != null) {
                alertController.G = view;
            } else {
                CharSequence charSequence = bVar.f64f;
            ...
            if (bVar.q != null) {
                AlertController.RecycleListView recycleListView = (AlertController.RecycleListView) bVar.f60b.inflate(alertController.L, (ViewGroup) null);
                int i3 = bVar.v ? alertController.N : alertController.O;
                ListAdapter listAdapter = bVar.q;
                if (listAdapter == null) {
                    listAdapter = new AlertController.d(bVar.f59a, i3, 16908308, null);
                }
            ...
            eVar.setCancelable(this.f515a.m);
            if (this.f515a.m) {
                eVar.setCanceledOnTouchOutside(true);
            }
            eVar.setOnCancelListener(this.f515a.n);
            eVar.setOnDismissListener(this.f515a.o);
            DialogInterface.OnKeyListener onKeyListener = this.f515a.p;
    ...
    public void e(int i, CharSequence charSequence, DialogInterface.OnClickListener onClickListener) {
        this.f514d.e(i, charSequence, onClickListener, null, null);
    }

    public void f(CharSequence charSequence) {
        AlertController alertController = this.f514d;
        alertController.f54f = charSequence;
    ...
    public void onCreate(Bundle bundle) {
        ...
        alertController.f50b.setContentView(i);
        View findViewById2 = alertController.f51c.findViewById(f.parentPanel);
        ...
        int i2 = 0;
        if (view2 == null) {
            view2 = alertController.i != 0 ? LayoutInflater.from(alertController.f49a).inflate(alertController.i, viewGroup, false) : null;
        }
        boolean z2 = view2 != null;
        if (!z2 || !AlertController.a(view2)) {
            alertController.f51c.setFlags(131072, 131072);
        }
        if (z2) {
            FrameLayout frameLayout = (FrameLayout) alertController.f51c.findViewById(f.custom);
            ...
            if (alertController.f55g != null) {
                ((i0.a) viewGroup.getLayoutParams()).f865a = 0.0f;
            }
        } else {
        ...
        NestedScrollView nestedScrollView = (NestedScrollView) alertController.f51c.findViewById(f.scrollView);
        ...
        if (textView != null) {
            CharSequence charSequence = alertController.f54f;
            if (charSequence != null) {
                textView.setText(charSequence);
            } else {
                ...
                if (alertController.f55g != null) {
                    ...
                    viewGroup2.addView(alertController.f55g, indexOfChild, new ViewGroup.LayoutParams(-1, -1));
                } else {
                    d3.setVisibility(8);
                }
            }
        ...
        Context context = alertController.f49a;
        TypedValue typedValue = new TypedValue();
        ...
        if (alertController.G != null) {
            ...
            alertController.f51c.findViewById(f.title_template).setVisibility(8);
        } else {
            alertController.D = (ImageView) alertController.f51c.findViewById(16908294);
            if (!(!TextUtils.isEmpty(alertController.f53e)) || !alertController.P) {
                alertController.f51c.findViewById(f.title_template).setVisibility(8);
                alertController.D.setVisibility(8);
                d2.setVisibility(8);
            } else {
                TextView textView2 = (TextView) alertController.f51c.findViewById(f.alertTitle);
                alertController.E = textView2;
                textView2.setText(alertController.f53e);
        ...
        if (i7 != 0) {
            ...
            view = (alertController.f54f == null && alertController.f55g == null) ? null : d2.findViewById(f.titleDividerNoCustom);
        } else {
            view = d3.findViewById(f.textSpacerNoTitle);
        }
        view.setVisibility(0);
        ListView listView = alertController.f55g;
        if (listView instanceof AlertController.RecycleListView) {
            AlertController.RecycleListView recycleListView = (AlertController.RecycleListView) listView;
            if (recycleListView == null) {
                throw null;
            } else if (!z4 || i7 == 0) {
                recycleListView.setPadding(recycleListView.getPaddingLeft(), i7 != 0 ? recycleListView.getPaddingTop() : recycleListView.f56b, recycleListView.getPaddingRight(), z4 ? recycleListView.getPaddingBottom() : recycleListView.f57c);
            }
        }
        if (!z3) {
            View view3 = alertController.f55g;
            if (view3 == null) {
            ...
            if (view3 != null) {
                ...
                int i8 = i7 | i2;
                View findViewById9 = alertController.f51c.findViewById(f.scrollIndicatorUp);
                View findViewById10 = alertController.f51c.findViewById(f.scrollIndicatorDown);
                m.e0(view3, i8, 3);
        ...
        ListView listView2 = alertController.f55g;
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        NestedScrollView nestedScrollView = this.f514d.A;
