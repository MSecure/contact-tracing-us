...
public class c extends b.b.p.i.b {
    ...
    public class a extends l {
        public a(Context context, r rVar, View view) {
            ...
            if (!rVar.B.g()) {
                View view2 = c.this.j;
                this.f756f = view2 == null ? (View) c.this.i : view2;
            }
            d(c.this.y);
        }
    ...
    public class RunnableC0015c implements Runnable {
        ...
        public void run() {
            g.a aVar;
            g gVar = c.this.f686d;
            if (!(gVar == null || (aVar = gVar.f726e) == null)) {
                aVar.b(gVar);
            }
            View view = (View) c.this.i;
            if (!(view == null || view.getWindowToken() == null || !this.f805b.f())) {
                c.this.u = this.f805b;
            }
            c.this.w = null;
        }
    ...
    public class d extends n implements ActionMenuView.a {
        ...
        public d(Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            i.j.i0(this, getContentDescription());
    ...
    public boolean i(r rVar) {
        ...
        a aVar = new a(this.f685c, rVar, view);
        this.v = aVar;
        aVar.h = z2;
        k kVar = aVar.j;
        if (kVar != null) {
    ...
    public boolean n() {
        g gVar;
        if (!this.m || m() || (gVar = this.f686d) == null || this.i == null || this.w != null) {
            return false;
        }
        gVar.i();
        if (gVar.j.isEmpty()) {
        ...
        RunnableC0015c cVar = new RunnableC0015c(new e(this.f685c, this.f686d, this.j, true));
        this.w = cVar;
