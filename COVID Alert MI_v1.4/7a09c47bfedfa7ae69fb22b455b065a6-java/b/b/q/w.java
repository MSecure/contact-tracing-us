...
public class w extends Spinner {
    ...
    public class b implements f, DialogInterface.OnClickListener {
        ...
        /* renamed from: b  reason: collision with root package name */
        public b.b.k.e f957b;

        /* renamed from: c  reason: collision with root package name */
        public ListAdapter f958c;
        ...
        public void e(int i, int i2) {
            if (this.f958c != null) {
                ...
                CharSequence charSequence = this.f959d;
                if (charSequence != null) {
                    aVar.f515a.f64f = charSequence;
                }
                ListAdapter listAdapter = this.f958c;
                ...
                b.b.k.e a2 = aVar.a();
                this.f957b = a2;
                ListView listView = a2.f514d.f55g;
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            if (w.this.getOnItemClickListener() != null) {
                w.this.performItemClick(null, i, this.f958c.getItemId(i));
            }
            b.b.k.e eVar = this.f957b;
            if (eVar != null) {
                eVar.dismiss();
    ...
    public static class c implements ListAdapter, SpinnerAdapter {
        ...
        /* renamed from: b  reason: collision with root package name */
        public SpinnerAdapter f961b;

        /* renamed from: c  reason: collision with root package name */
        public ListAdapter f962c;

        public c(SpinnerAdapter spinnerAdapter, Resources.Theme theme) {
            this.f961b = spinnerAdapter;
            if (spinnerAdapter instanceof ListAdapter) {
                this.f962c = (ListAdapter) spinnerAdapter;
            }
            if (theme == null) {
                return;
            }
        ...
        public boolean areAllItemsEnabled() {
            ListAdapter listAdapter = this.f962c;
            if (listAdapter != null) {
        ...
        public int getCount() {
            SpinnerAdapter spinnerAdapter = this.f961b;
    ...
    public class d extends k0 implements f {
        ...
        public class b implements ViewTreeObserver.OnGlobalLayoutListener {
            ...
            public void onGlobalLayout() {
                ...
                w wVar = w.this;
                if (dVar != null) {
                    if (!(m.B(wVar) && wVar.getGlobalVisibleRect(dVar.I))) {
                        d.this.dismiss();
                        return;
                    }
                    d.this.u();
        ...
        public class c implements PopupWindow.OnDismissListener {
            ...
            /* renamed from: b  reason: collision with root package name */
            public final /* synthetic */ ViewTreeObserver.OnGlobalLayoutListener f965b;

            public c(ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener) {
                this.f965b = onGlobalLayoutListener;
            }

            public void onDismiss() {
                ViewTreeObserver viewTreeObserver = w.this.getViewTreeObserver();
                if (viewTreeObserver != null) {
                    viewTreeObserver.removeGlobalOnLayoutListener(this.f965b);
                }
            }
        }
        ...
        public void u() {
            ...
            if (i4 == -2) {
                ...
                r(i4);
                this.f882g = !e1.a(w.this) ? (((width - paddingRight) - this.f881f) - this.J) + i3 : paddingLeft + this.J + i3;
            }
            r(i);
            this.f882g = !e1.a(w.this) ? (((width - paddingRight) - this.f881f) - this.J) + i3 : paddingLeft + this.J + i3;
        }
    ...
    public static class e extends View.BaseSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeByte(this.f967b ? (byte) 1 : 0);
        }
    }
    ...
    public w(Context context, AttributeSet attributeSet, int i2) {
        ...
        if (i3 == 0) {
            ...
            d dVar = new d(this.f951c, attributeSet, i2);
            y0 q = y0.q(this.f951c, attributeSet, j.Spinner, i2, 0);
            ...
            q.f986b.recycle();
            this.f955g = dVar;
            this.f952d = new v(this, this, dVar);
        }
        ...
        this.f954f = true;
        SpinnerAdapter spinnerAdapter = this.f953e;
        if (spinnerAdapter != null) {
            setAdapter(spinnerAdapter);
            this.f953e = null;
        }
        this.f950b.d(attributeSet, i2);
    }
    ...
    public void b() {
        this.f955g.e(getTextDirection(), getTextAlignment());
    }
    ...
    public int getDropDownWidth() {
        return this.f955g != null ? this.h : super.getDropDownWidth();
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f955g != null && View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (eVar.f967b && (viewTreeObserver = getViewTreeObserver()) != null) {
    ...
    public void setAdapter(SpinnerAdapter spinnerAdapter) {
        ...
        if (this.f955g != null) {
            ...
            this.f955g.o(new c(spinnerAdapter, context.getTheme()));
        }
    }
