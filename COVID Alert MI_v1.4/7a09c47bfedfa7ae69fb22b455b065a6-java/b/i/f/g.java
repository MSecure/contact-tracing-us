...
public class g extends e {
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        for (d dVar : dVarArr) {
            if (!j(context, n, dVar.f1726a, dVar.f1730e, dVar.f1727b, dVar.f1728c ? 1 : 0, FontVariationAxis.fromFontVariationSettings(dVar.f1729d))) {
                i(n);
                return null;
            }
        }
    ...
    public Typeface b(Context context, CancellationSignal cancellationSignal, b.f[] fVarArr, int i2) {
        ...
        if (!m()) {
            b.f f2 = f(fVarArr, i2);
            try {
                ParcelFileDescriptor openFileDescriptor = context.getContentResolver().openFileDescriptor(f2.f1791a, "r", cancellationSignal);
                ...
                try {
                    Typeface build = new Typeface.Builder(openFileDescriptor.getFileDescriptor()).setWeight(f2.f1793c).setItalic(f2.f1794d).build();
                    openFileDescriptor.close();
                    return build;
                } catch (Throwable th) {
                    th.addSuppressed(th);
            ...
            while (i3 < length) {
                b.f fVar = fVarArr[i3];
                ByteBuffer byteBuffer = d2.get(fVar.f1791a);
                if (byteBuffer != null) {
                    try {
                        z = ((Boolean) this.j.invoke(n, byteBuffer, Integer.valueOf(fVar.f1792b), null, Integer.valueOf(fVar.f1793c), Integer.valueOf(fVar.f1794d ? 1 : 0))).booleanValue();
    ...
    public Typeface k(Object obj) {
        try {
            Object newInstance = Array.newInstance(this.f1762g, 1);
