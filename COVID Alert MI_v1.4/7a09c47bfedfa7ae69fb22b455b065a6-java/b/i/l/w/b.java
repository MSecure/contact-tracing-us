...
public class b {
    ...
    public static int f1905d;

    /* renamed from: a  reason: collision with root package name */
    public final AccessibilityNodeInfo f1906a;
    ...
    public static class a {
        ...
        public static final a f1909e = new a(16, null);

        /* renamed from: f  reason: collision with root package name */
        public static final a f1910f = new a(4096, null);

        /* renamed from: g  reason: collision with root package name */
        public static final a f1911g = new a(RecyclerView.a0.FLAG_BOUNCED_FROM_HIDDEN_LIST, null);
        ...
        /* renamed from: c  reason: collision with root package name */
        public final Class<? extends d.a> f1914c;
        ...
        static {
            ...
            new AccessibilityNodeInfo.AccessibilityAction(RecyclerView.a0.FLAG_IGNORE, null);
            new AccessibilityNodeInfo.AccessibilityAction(RecyclerView.a0.FLAG_TMP_DETACHED, null);
            new AccessibilityNodeInfo.AccessibilityAction(RecyclerView.a0.FLAG_ADAPTER_POSITION_UNKNOWN, null);
        ...
        public a(Object obj, int i2, CharSequence charSequence, d dVar, Class<? extends d.a> cls) {
            this.f1913b = i2;
            this.f1915d = dVar;
            this.f1912a = obj == null ? new AccessibilityNodeInfo.AccessibilityAction(i2, charSequence) : obj;
            this.f1914c = cls;
        }

        public int a() {
            return ((AccessibilityNodeInfo.AccessibilityAction) this.f1912a).getId();
        }
        ...
        public boolean equals(Object obj) {
            ...
            Object obj2 = this.f1912a;
            Object obj3 = ((a) obj).f1912a;
    ...
    public b(AccessibilityNodeInfo accessibilityNodeInfo) {
        this.f1906a = accessibilityNodeInfo;
    }
    ...
    public static String c(int i) {
        ...
        switch (i) {
            ...
            case RecyclerView.a0.FLAG_TMP_DETACHED:
                return "ACTION_NEXT_AT_MOVEMENT_GRANULARITY";
            case RecyclerView.a0.FLAG_ADAPTER_POSITION_UNKNOWN:
    ...
    public void a(a aVar) {
        this.f1906a.addAction((AccessibilityNodeInfo.AccessibilityAction) aVar.f1912a);
    }

    public final List<Integer> b(String str) {
        ArrayList<Integer> integerArrayList = this.f1906a.getExtras().getIntegerArrayList(str);
        if (integerArrayList != null) {
            return integerArrayList;
        }
        ArrayList<Integer> arrayList = new ArrayList<>();
        this.f1906a.getExtras().putIntegerArrayList(str, arrayList);
        return arrayList;
    }

    public CharSequence e() {
        return this.f1906a.getContentDescription();
    }
    ...
    public boolean equals(Object obj) {
        ...
        b bVar = (b) obj;
        AccessibilityNodeInfo accessibilityNodeInfo = this.f1906a;
        if (accessibilityNodeInfo == null) {
            if (bVar.f1906a != null) {
                return false;
            }
        } else if (!accessibilityNodeInfo.equals(bVar.f1906a)) {
            return false;
        }
        return this.f1908c == bVar.f1908c && this.f1907b == bVar.f1907b;
    }

    public Bundle f() {
        return this.f1906a.getExtras();
    }

    public CharSequence g() {
        if (!(!b("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_START_KEY").isEmpty())) {
            return this.f1906a.getText();
        }
        ...
        SpannableString spannableString = new SpannableString(TextUtils.substring(this.f1906a.getText(), 0, this.f1906a.getText().length()));
    ...
    public void i(Object obj) {
        this.f1906a.setCollectionInfo(obj == null ? null : (AccessibilityNodeInfo.CollectionInfo) ((C0036b) obj).f1916a);
    }

    public void j(Object obj) {
        this.f1906a.setCollectionItemInfo((AccessibilityNodeInfo.CollectionItemInfo) ((c) obj).f1917a);
    }

    public void k(CharSequence charSequence) {
        if (Build.VERSION.SDK_INT >= 26) {
            this.f1906a.setHintText(charSequence);
        } else {
            this.f1906a.getExtras().putCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.HINT_TEXT_KEY", charSequence);
        }
    }
    ...
    public String toString() {
        ...
        Rect rect = new Rect();
        this.f1906a.getBoundsInParent(rect);
        sb.append("; boundsInParent: " + rect);
        this.f1906a.getBoundsInScreen(rect);
        sb.append("; boundsInScreen: " + rect);
        sb.append("; packageName: ");
        sb.append(this.f1906a.getPackageName());
        sb.append("; className: ");
        sb.append(this.f1906a.getClassName());
        sb.append("; text: ");
        sb.append(g());
        sb.append("; contentDescription: ");
        sb.append(e());
        sb.append("; viewId: ");
        sb.append(this.f1906a.getViewIdResourceName());
        sb.append("; checkable: ");
        sb.append(this.f1906a.isCheckable());
        sb.append("; checked: ");
        sb.append(this.f1906a.isChecked());
        sb.append("; focusable: ");
        sb.append(this.f1906a.isFocusable());
        sb.append("; focused: ");
        sb.append(this.f1906a.isFocused());
        sb.append("; selected: ");
        sb.append(this.f1906a.isSelected());
        sb.append("; clickable: ");
        sb.append(this.f1906a.isClickable());
        sb.append("; longClickable: ");
        sb.append(this.f1906a.isLongClickable());
        sb.append("; enabled: ");
        sb.append(this.f1906a.isEnabled());
        sb.append("; password: ");
        sb.append(this.f1906a.isPassword());
        sb.append("; scrollable: " + this.f1906a.isScrollable());
        sb.append("; [");
        List<AccessibilityNodeInfo.AccessibilityAction> actionList = this.f1906a.getActionList();
        if (actionList != null) {
            r3 = new ArrayList();
        ...
        for (int i2 = 0; i2 < r3.size(); i2++) {
            a aVar = (a) r3.get(i2);
            String c2 = c(aVar.a());
            if (c2.equals("ACTION_UNKNOWN") && ((AccessibilityNodeInfo.AccessibilityAction) aVar.f1912a).getLabel() != null) {
                c2 = ((AccessibilityNodeInfo.AccessibilityAction) aVar.f1912a).getLabel().toString();
            }
            sb.append(c2);
            if (i2 != r3.size() - 1) {
                sb.append(", ");
