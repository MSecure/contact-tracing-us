...
public class d implements ActionMode.Callback {
    ...
    public final ActionMode.Callback f1936a;
    ...
    public d(ActionMode.Callback callback, TextView textView) {
        this.f1936a = callback;
        this.f1937b = textView;
    }

    public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        return this.f1936a.onActionItemClicked(actionMode, menuItem);
    }

    public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
        return this.f1936a.onCreateActionMode(actionMode, menu);
    }

    public void onDestroyActionMode(ActionMode actionMode) {
        this.f1936a.onDestroyActionMode(actionMode);
    }
    ...
    public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        boolean z;
        String str;
        Context context = this.f1937b.getContext();
        ...
        if (!this.f1941f) {
            ...
            try {
                ...
                this.f1938c = cls;
                this.f1939d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                this.f1940e = true;
        ...
        Method declaredMethod = (!this.f1940e || !this.f1938c.isInstance(menu)) ? menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE) : this.f1939d;
        ...
        return this.f1936a.onPrepareActionMode(actionMode, menu);
    }
}
