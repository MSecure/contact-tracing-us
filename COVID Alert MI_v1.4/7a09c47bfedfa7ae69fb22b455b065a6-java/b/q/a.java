...
public final class a {
    ...
    public static final Set<File> f2270a = new HashSet();

    /* renamed from: b  reason: collision with root package name */
    public static final boolean f2271b;
    ...
    public static void d(Context context, File file, File file2, String str, String str2, boolean z) {
        ...
        try {
            try {
                f(classLoader, file4, dVar.d(context, str2, false));
            } catch (IOException e3) {
                if (z) {
                    f(classLoader, file4, dVar.d(context, str2, true));
                } else {
                    throw e3;
                }
            }
    ...
    public static void g(File file) {
        ...
        if (!file.isDirectory()) {
            ...
            StringBuilder h = c.a.a.a.a.h("Failed to create directory ");
