                ...
                if (t.N4(b3)) {
                    ...
                    if (!(b3 < -32)) {
                        if (b3 < -16) {
                            if (i6 < i3 - 1) {
                                int i8 = i6 + 1;
                                t.u4(b3, bArr[i6], bArr[i8], cArr, i5);
                                i = i8 + 1;
                                i5++;
                            } else {
                                throw c2.f();
                            ...
                            byte b5 = bArr[i6];
                            int i10 = i9 + 1;
                            t.t4(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                            i5 = i5 + 1 + 1;
                            i = i10 + 1;
                        } else {
                            throw c2.f();
