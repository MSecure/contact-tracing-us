...
public abstract class h0 {
    ...
    public static final h0 f4926a = new b(null);

    /* renamed from: b  reason: collision with root package name */
    public static final h0 f4927b = new c(null);

    public static final class b extends h0 {

        /* renamed from: c  reason: collision with root package name */
        public static final Class<?> f4928c = Collections.unmodifiableList(Collections.emptyList()).getClass();
        ...
        public static <L> List<L> d(Object obj, long j, int i) {
            ...
            if (list.isEmpty()) {
                ...
                p1.f5006f.q(obj, j, list);
                return list;
            }
            if (f4928c.isAssignableFrom(list.getClass())) {
        ...
        public void a(Object obj, long j) {
            ...
            if (list instanceof g0) {
                obj2 = ((g0) list).d();
            } else if (!f4928c.isAssignableFrom(list.getClass())) {
                if (!(list instanceof z0) || !(list instanceof a0.c)) {
