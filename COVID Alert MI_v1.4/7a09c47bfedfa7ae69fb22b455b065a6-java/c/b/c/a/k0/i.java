...
public final class i extends s<n1, o1> {
    ...
    public static final byte[] f5082d = "Tink and Wycheproof.".getBytes(Charset.forName(o.DEFAULT_PARAMS_ENCODING));
    ...
    public class a extends i.b<t, n1> {
        ...
        public t a(n1 n1Var) {
            ...
            m1 q = n1Var2.u().q();
            l0 l0Var = new l0((RSAPrivateCrtKey) a2.generatePrivate(new RSAPrivateCrtKeySpec(new BigInteger(1, n1Var2.u().n_.q()), new BigInteger(1, n1Var2.u().e_.q()), new BigInteger(1, n1Var2.d_.q()), new BigInteger(1, n1Var2.p_.q()), new BigInteger(1, n1Var2.q_.q()), new BigInteger(1, n1Var2.dp_.q()), new BigInteger(1, n1Var2.dq_.q()), new BigInteger(1, n1Var2.crt_.q()))), b.x.t.W2(q.o()), b.x.t.W2(q.n()), q.saltLength_);
            try {
                new m0((RSAPublicKey) a2.generatePublic(new RSAPublicKeySpec(new BigInteger(1, n1Var2.u().n_.q()), new BigInteger(1, n1Var2.u().e_.q()))), b.x.t.W2(q.o()), b.x.t.W2(q.n()), q.saltLength_).a(l0Var.a(i.f5082d), i.f5082d);
                return l0Var;
    ...
    public class b extends i.a<l1, n1> {
        ...
        public n1 a(l1 l1Var) {
            ...
            n0.d(b.x.t.W2(m1Var.o()));
            KeyPairGenerator a2 = a0.j.a("RSA");
            a2.initialize(new RSAKeyGenParameterSpec(l1Var2.modulusSizeInBits_, new BigInteger(1, l1Var2.publicExponent_.q())));
    ...
    public void g(r0 r0Var) {
        ...
        n0.c(new BigInteger(1, n1Var.u().n_.q()).bitLength());
        b.x.t.h3(n1Var.u().q());
    }
}
