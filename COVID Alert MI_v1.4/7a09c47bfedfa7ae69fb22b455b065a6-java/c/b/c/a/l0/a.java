...
public final class a extends i<f> {
    ...
    public class C0103a extends i.b<z, f> {
        ...
        public z a(f fVar) {
            f fVar2 = fVar;
            byte[] q = fVar2.keyValue_.q();
            o0 b2 = o0.b(fVar2.p().hkdfHashType_);
            if (b2 == null) {
                b2 = o0.UNRECOGNIZED;
            }
            return new c.b.c.a.m0.b(q, t.Y2(b2), fVar2.p().derivedKeySize_, t.Y2(fVar2.p().n().n()), fVar2.p().n().tagSize_, fVar2.p().ciphertextSegmentSize_, 0);
        }
    }
    ...
    public class b extends i.a<g, f> {
        ...
        public f a(g gVar) {
            ...
            bVar.d();
            f.o((f) bVar.f5063c, g2);
            h hVar = gVar2.params_;
            if (hVar == null) {
                hVar = h.DEFAULT_INSTANCE;
            }
            bVar.d();
            f.n((f) bVar.f5063c, hVar);
            if (a.this != null) {
                bVar.d();
                ((f) bVar.f5063c).version_ = 0;
                return (f) bVar.b();
            }
            throw null;
        }
    ...
    public a() {
        super(f.class, new C0103a(z.class));
    }
