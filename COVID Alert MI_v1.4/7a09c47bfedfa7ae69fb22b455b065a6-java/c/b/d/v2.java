...
public final class v2 {
    ...
    public static final Logger f5894a = Logger.getLogger(v2.class.getName());

    /* renamed from: b  reason: collision with root package name */
    public static final Unsafe f5895b = q();

    /* renamed from: c  reason: collision with root package name */
    public static final Class<?> f5896c = e.f5247a;

    /* renamed from: d  reason: collision with root package name */
    public static final boolean f5897d = f(Long.TYPE);

    /* renamed from: e  reason: collision with root package name */
    public static final boolean f5898e = f(Integer.TYPE);

    /* renamed from: f  reason: collision with root package name */
    public static final e f5899f;

    /* renamed from: g  reason: collision with root package name */
    public static final boolean f5900g;
    ...
    public static final class b extends e {
        ...
        public boolean d(Object obj, long j) {
            return v2.k ? v2.j(obj, j) != 0 : v2.k(obj, j) != 0;
        }
        ...
        public void n(Object obj, long j, boolean z) {
            if (v2.k) {
                v2.u(obj, j, z ? (byte) 1 : 0);
            } else {
                v2.v(obj, j, z ? (byte) 1 : 0);
            }
        }
        ...
        @Override // c.b.d.v2.e
        public void q(Object obj, long j, float f2) {
    ...
    public static final class d extends e {
        ...
        @Override // c.b.d.v2.e
        public void c(long j, byte[] bArr, long j2, long j3) {
            this.f5901a.copyMemory((Object) null, j, bArr, v2.i + j2, j3);
        }

        @Override // c.b.d.v2.e
        public boolean d(Object obj, long j) {
            return this.f5901a.getBoolean(obj, j);
        }

        @Override // c.b.d.v2.e
        public byte e(long j) {
            return this.f5901a.getByte(j);
        }

        @Override // c.b.d.v2.e
        public byte f(Object obj, long j) {
            return this.f5901a.getByte(obj, j);
        }

        @Override // c.b.d.v2.e
        public double g(Object obj, long j) {
            return this.f5901a.getDouble(obj, j);
        }

        @Override // c.b.d.v2.e
        public float h(Object obj, long j) {
            return this.f5901a.getFloat(obj, j);
        }

        @Override // c.b.d.v2.e
        public Object l(Field field) {
            return k(this.f5901a.staticFieldBase(field), this.f5901a.staticFieldOffset(field));
        }

        @Override // c.b.d.v2.e
        public void n(Object obj, long j, boolean z) {
            this.f5901a.putBoolean(obj, j, z);
        }

        @Override // c.b.d.v2.e
        public void o(Object obj, long j, byte b2) {
            this.f5901a.putByte(obj, j, b2);
        }

        @Override // c.b.d.v2.e
        public void p(Object obj, long j, double d2) {
            this.f5901a.putDouble(obj, j, d2);
        }

        @Override // c.b.d.v2.e
        public void q(Object obj, long j, float f2) {
            this.f5901a.putFloat(obj, j, f2);
        }
    }
    ...
    public static abstract class e {
        ...
        public final int a(Class<?> cls) {
            return this.f5901a.arrayBaseOffset(cls);
        }

        public final int b(Class<?> cls) {
            return this.f5901a.arrayIndexScale(cls);
        }
    ...
    static {
            ...
            try {
                ...
                try {
                    ...
                    if (e() != null) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        if (e.a()) {
                                            ...
                                            try {
                                                ...
                                                try {
                                                    ...
                                                    th = th4;
                                                    f5894a.log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + th);
                                                    z3 = false;
                                                    h = z3;
                                                    c(boolean[].class);
                                                    d(boolean[].class);
                                                    ...
                                                    d(Object[].class);
                                                    Field e2 = e();
                                                    j = (e2 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e2);
                                                ...
                                                d(Object[].class);
                                                Field e22 = e();
                                                j = (e22 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e22);
                                                k = ByteOrder.nativeOrder() != ByteOrder.BIG_ENDIAN ? z2 : false;
                                            }
                                            h = z3;
                                            c(boolean[].class);
                                            ...
                                            d(Object[].class);
                                            Field e222 = e();
                                            j = (e222 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e222);
                                            k = ByteOrder.nativeOrder() != ByteOrder.BIG_ENDIAN ? z2 : false;
                                        }
                                    } catch (Throwable th6) {
                                        th = th6;
                                        ...
                                        d(Object[].class);
                                        Field e2222 = e();
                                        j = (e2222 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e2222);
                                        k = ByteOrder.nativeOrder() != ByteOrder.BIG_ENDIAN ? z2 : false;
                                    }
                                } catch (Throwable th7) {
                                    th = th7;
                                    ...
                                    d(Object[].class);
                                    Field e22222 = e();
                                    j = (e22222 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e22222);
                                    k = ByteOrder.nativeOrder() != ByteOrder.BIG_ENDIAN ? z2 : false;
                                }
                            } catch (Throwable th8) {
                                th = th8;
                                ...
                                d(Object[].class);
                                Field e222222 = e();
                                j = (e222222 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e222222);
                                k = ByteOrder.nativeOrder() != ByteOrder.BIG_ENDIAN ? z2 : false;
                            }
                        }
                        z2 = true;
                        ...
                        d(Object[].class);
                        Field e2222222 = e();
                        j = (e2222222 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e2222222);
                        k = ByteOrder.nativeOrder() != ByteOrder.BIG_ENDIAN ? z2 : false;
                    }
                } catch (Throwable th9) {
                    th2 = th9;
                    cls = long[].class;
                    f5894a.log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + th2);
                    z = false;
                    f5900g = z;
                    unsafe = f5895b;
                    if (unsafe != null) {
                    ...
                    d(Object[].class);
                    Field e22222222 = e();
                    j = (e22222222 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e22222222);
                    k = ByteOrder.nativeOrder() != ByteOrder.BIG_ENDIAN ? z2 : false;
                }
                ...
                d(Object[].class);
                Field e222222222 = e();
                j = (e222222222 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e222222222);
                k = ByteOrder.nativeOrder() != ByteOrder.BIG_ENDIAN ? z2 : false;
            }
        }
        cls = long[].class;
        ...
        d(Object[].class);
        Field e2222222222 = e();
        j = (e2222222222 != null || (eVar = f5899f) == null) ? -1 : eVar.m(e2222222222);
        k = ByteOrder.nativeOrder() != ByteOrder.BIG_ENDIAN ? z2 : false;
    }

    public static void A(Object obj, long j2, Object obj2) {
        f5899f.t(obj, j2, obj2);
    }

    public static long a(ByteBuffer byteBuffer) {
        return f5899f.j(byteBuffer, j);
    }

    public static <T> T b(Class<T> cls) {
        try {
            return (T) f5895b.allocateInstance(cls);
    ...
    public static byte i(byte[] bArr, long j2) {
        return f5899f.f(bArr, i + j2);
    }

    public static byte j(Object obj, long j2) {
        return (byte) ((n(obj, -4 & j2) >>> ((int) (((~j2) & 3) << 3))) & BuildConfig.VERSION_CODE);
    }
    ...
    public static void u(Object obj, long j2, byte b2) {
        ...
        int i2 = ((~((int) j2)) & 3) << 3;
        e eVar = f5899f;
        eVar.r(obj, j3, ((255 & b2) << i2) | (n & (~(BuildConfig.VERSION_CODE << i2))));
    }
    ...
    public static void v(Object obj, long j2, byte b2) {
        ...
        int i2 = (((int) j2) & 3) << 3;
        e eVar = f5899f;
        eVar.r(obj, j3, ((255 & b2) << i2) | (n(obj, j3) & (~(BuildConfig.VERSION_CODE << i2))));
    }
