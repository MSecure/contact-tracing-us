...
public final class zzo extends a {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzo) {
            zzo zzo = (zzo) obj;
            return t.j1(Integer.valueOf(this.zza), Integer.valueOf(zzo.zza)) && t.j1(Integer.valueOf(this.zzb), Integer.valueOf(zzo.zzb)) && t.j1(Integer.valueOf(this.zzc), Integer.valueOf(zzo.zzc)) && t.j1(Boolean.valueOf(this.zzd), Boolean.valueOf(zzo.zzd));
        }
    }
