...
public class Chip extends g implements b.a, n {
    ...
    public c.b.a.b.v.b f6071e;

    /* renamed from: f  reason: collision with root package name */
    public InsetDrawable f6072f;

    /* renamed from: g  reason: collision with root package name */
    public RippleDrawable f6073g;
    ...
    public class b extends b.k.b.a {
        ...
        public void m(List<Integer> list) {
            ...
            list.add(0);
            if (Chip.this.f()) {
                c.b.a.b.v.b bVar = Chip.this.f6071e;
                if (bVar != null && bVar.M) {
                    z = true;
                }
        ...
        public void q(int i, b.i.l.w.b bVar) {
            ...
            if (i == 1) {
                ...
                bVar.f1906a.setContentDescription(closeIconContentDescription);
                bVar.f1906a.setBoundsInParent(Chip.this.getCloseIconTouchBoundsInt());
                bVar.a(b.a.f1909e);
                bVar.f1906a.setEnabled(Chip.this.isEnabled());
                return;
            }
            bVar.f1906a.setContentDescription(str);
            bVar.f1906a.setBoundsInParent(Chip.v);
        }
    }

    /* JADX WARNING: Illegal instructions before constructor call */
    /* JADX WARNING: Removed duplicated region for block: B:50:0x0172  */
    /* JADX WARNING: Removed duplicated region for block: B:67:0x020b  */
    /* JADX WARNING: Removed duplicated region for block: B:70:0x02e1  */
    /* JADX WARNING: Removed duplicated region for block: B:73:0x0301  */
    /* JADX WARNING: Removed duplicated region for block: B:76:0x0311  */
    public Chip(Context context, AttributeSet attributeSet) {
        ...
        TypedArray d2 = c.b.a.b.c0.k.d(bVar.g0, attributeSet, l.Chip, i2, i3, new int[0]);
        bVar.I0 = d2.hasValue(l.Chip_shapeAppearance);
        ColorStateList B1 = t.B1(bVar.g0, d2, l.Chip_chipSurfaceColor);
        if (bVar.z != B1) {
            bVar.z = B1;
            bVar.onStateChange(bVar.getState());
        }
        bVar.R(t.B1(bVar.g0, d2, l.Chip_chipBackgroundColor));
        bVar.Y(d2.getDimension(l.Chip_chipMinHeight, 0.0f));
        if (d2.hasValue(l.Chip_chipCornerRadius)) {
            bVar.S(d2.getDimension(l.Chip_chipCornerRadius, 0.0f));
        }
        bVar.a0(t.B1(bVar.g0, d2, l.Chip_chipStrokeColor));
        bVar.b0(d2.getDimension(l.Chip_chipStrokeWidth, 0.0f));
        bVar.l0(t.B1(bVar.g0, d2, l.Chip_rippleColor));
        bVar.m0(d2.getText(l.Chip_android_text));
        Context context3 = bVar.g0;
        int i4 = l.Chip_android_textAppearance;
        c.b.a.b.e0.b bVar2 = (!d2.hasValue(i4) || (resourceId = d2.getResourceId(i4, 0)) == 0) ? null : new c.b.a.b.e0.b(context3, resourceId);
        bVar2.k = d2.getDimension(l.Chip_android_textSize, bVar2.k);
        bVar.n0.b(bVar2, bVar.g0);
        ...
        if (i5 == 1) {
            ...
            bVar.X(d2.getBoolean(l.Chip_chipIconVisible, false));
            if (!(attributeSet == null || attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "chipIconEnabled") == null || attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "chipIconVisible") != null)) {
                bVar.X(d2.getBoolean(l.Chip_chipIconEnabled, false));
            }
            bVar.U(t.F1(bVar.g0, d2, l.Chip_chipIcon));
            if (d2.hasValue(l.Chip_chipIconTint)) {
                bVar.W(t.B1(bVar.g0, d2, l.Chip_chipIconTint));
            }
            bVar.V(d2.getDimension(l.Chip_chipIconSize, -1.0f));
            bVar.i0(d2.getBoolean(l.Chip_closeIconVisible, false));
            if (!(attributeSet == null || attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "closeIconEnabled") == null || attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "closeIconVisible") != null)) {
                bVar.i0(d2.getBoolean(l.Chip_closeIconEnabled, false));
            }
            bVar.c0(t.F1(bVar.g0, d2, l.Chip_closeIcon));
            bVar.h0(t.B1(bVar.g0, d2, l.Chip_closeIconTint));
            bVar.e0(d2.getDimension(l.Chip_closeIconSize, 0.0f));
            bVar.N(d2.getBoolean(l.Chip_android_checkable, false));
            bVar.Q(d2.getBoolean(l.Chip_checkedIconVisible, false));
            if (!(attributeSet == null || attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "checkedIconEnabled") == null || attributeSet.getAttributeValue("http://schemas.android.com/apk/res-auto", "checkedIconVisible") != null)) {
                bVar.Q(d2.getBoolean(l.Chip_checkedIconEnabled, false));
            }
            bVar.O(t.F1(bVar.g0, d2, l.Chip_checkedIcon));
            if (d2.hasValue(l.Chip_checkedIconTint)) {
                bVar.P(t.B1(bVar.g0, d2, l.Chip_checkedIconTint));
            }
            bVar.W = c.b.a.b.m.g.a(bVar.g0, d2, l.Chip_showMotionSpec);
            bVar.X = c.b.a.b.m.g.a(bVar.g0, d2, l.Chip_hideMotionSpec);
            bVar.Z(d2.getDimension(l.Chip_chipStartPadding, 0.0f));
            bVar.k0(d2.getDimension(l.Chip_iconStartPadding, 0.0f));
            bVar.j0(d2.getDimension(l.Chip_iconEndPadding, 0.0f));
            bVar.o0(d2.getDimension(l.Chip_textStartPadding, 0.0f));
            bVar.n0(d2.getDimension(l.Chip_textEndPadding, 0.0f));
            bVar.f0(d2.getDimension(l.Chip_closeIconStartPadding, 0.0f));
            bVar.d0(d2.getDimension(l.Chip_closeIconEndPadding, 0.0f));
            bVar.T(d2.getDimension(l.Chip_chipEndPadding, 0.0f));
            bVar.H0 = d2.getDimensionPixelSize(l.Chip_android_maxWidth, Integer.MAX_VALUE);
            d2.recycle();
            TypedArray d3 = c.b.a.b.c0.k.d(context2, attributeSet, l.Chip, i2, u, new int[0]);
            this.n = d3.getBoolean(l.Chip_ensureMinTouchTargetSize, false);
            this.p = (int) Math.ceil((double) d3.getDimension(l.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) t.f1(getContext(), 48))));
            d3.recycle();
            setChipDrawable(bVar);
            bVar.q(getElevation());
            TypedArray d4 = c.b.a.b.c0.k.d(context2, attributeSet, l.Chip, i2, u, new int[0]);
        ...
        bVar.H0 = d2.getDimensionPixelSize(l.Chip_android_maxWidth, Integer.MAX_VALUE);
        d2.recycle();
        TypedArray d32 = c.b.a.b.c0.k.d(context2, attributeSet, l.Chip, i2, u, new int[0]);
        this.n = d32.getBoolean(l.Chip_ensureMinTouchTargetSize, false);
        this.p = (int) Math.ceil((double) d32.getDimension(l.Chip_chipMinTouchTargetSize, (float) Math.ceil((double) t.f1(getContext(), 48))));
        d32.recycle();
        setChipDrawable(bVar);
        bVar.q(getElevation());
        TypedArray d42 = c.b.a.b.c0.k.d(context2, attributeSet, l.Chip, i2, u, new int[0]);
        ...
        if (motionEvent.getAction() == 10) {
            try {
                ...
                if (((Integer) declaredField.get(this.q)).intValue() != Integer.MIN_VALUE) {
                    ...
                    declaredMethod.invoke(this.q, Integer.valueOf((int) BleSignal.UNKNOWN_TX_POWER));
                    z = true;
                    if (!z) {
                        return true;
                    }
                    ...
                    if (bVar.h.isEnabled() && bVar.h.isTouchExplorationEnabled()) {
                        ...
                        if (action == 7 || action == 9) {
                            ...
                            if (i4 != i3) {
                                bVar.m = i3;
                                bVar.s(i3, RecyclerView.a0.FLAG_IGNORE);
                                bVar.s(i4, RecyclerView.a0.FLAG_TMP_DETACHED);
                            }
                        } else if (action == 10 && (i2 = bVar.m) != Integer.MIN_VALUE) {
                            if (i2 != Integer.MIN_VALUE) {
                                bVar.m = BleSignal.UNKNOWN_TX_POWER;
                                bVar.s(BleSignal.UNKNOWN_TX_POWER, RecyclerView.a0.FLAG_IGNORE);
                                bVar.s(i2, RecyclerView.a0.FLAG_TMP_DETACHED);
                            }
                        }
                        z2 = true;
    ...
    public void drawableStateChanged() {
        ...
        int i2 = 0;
        z = false;
        if (bVar != null && c.b.a.b.v.b.K(bVar.N)) {
            c.b.a.b.v.b bVar2 = this.f6071e;
            ?? isEnabled = isEnabled();
            int i3 = isEnabled;
            if (this.m) {
                i3 = isEnabled + 1;
    ...
    public boolean e(int i2) {
        ...
        int max = Math.max(0, i2 - ((int) this.f6071e.B));
        int max2 = Math.max(0, i2 - this.f6071e.getIntrinsicWidth());
        if (max2 > 0 || max > 0) {
            ...
            this.f6072f = new InsetDrawable((Drawable) this.f6071e, i4, i3, i4, i3);
    ...
    public Drawable getBackgroundDrawable() {
        InsetDrawable insetDrawable = this.f6072f;
        return insetDrawable == null ? this.f6071e : insetDrawable;
    }
    ...
    public c.b.a.b.h0.j getShapeAppearanceModel() {
        return this.f6071e.f4261b.f4268a;
    }
    ...
    public final void j() {
        this.f6073g = new RippleDrawable(c.b.a.b.f0.a.b(this.f6071e.F), getBackgroundDrawable(), null);
        this.f6071e.p0(false);
        m.X(this, this.f6073g);
        k();
    }

    public final void k() {
        c.b.a.b.v.b bVar;
        if (!TextUtils.isEmpty(getText()) && (bVar = this.f6071e) != null) {
            ...
            m.d0(this, C, getPaddingTop(), F, getPaddingBottom());
        }
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        if (getParent() instanceof ChipGroup) {
            ...
            accessibilityNodeInfo.setCollectionItemInfo((AccessibilityNodeInfo.CollectionItemInfo) b.c.a(i3, 1, i2, 1, false, isChecked()).f1917a);
        }
    }
    ...
    public void setBackground(Drawable drawable) {
        if (drawable == getBackgroundDrawable() || drawable == this.f6073g) {
    ...
    public void setCheckableResource(int i2) {
        c.b.a.b.v.b bVar = this.f6071e;
        if (bVar != null) {
            bVar.N(bVar.g0.getResources().getBoolean(i2));
        }
    }
    ...
    public void setCheckedIconVisible(int i2) {
        c.b.a.b.v.b bVar = this.f6071e;
        if (bVar != null) {
            bVar.Q(bVar.g0.getResources().getBoolean(i2));
        }
    }
    ...
    public void setChipEndPaddingResource(int i2) {
        c.b.a.b.v.b bVar = this.f6071e;
        if (bVar != null) {
            bVar.T(bVar.g0.getResources().getDimension(i2));
        }
    }
    ...
    public void setChipIconVisible(int i2) {
        c.b.a.b.v.b bVar = this.f6071e;
        if (bVar != null) {
            bVar.X(bVar.g0.getResources().getBoolean(i2));
        }
    }
    ...
    public void setChipStrokeColorResource(int i2) {
        c.b.a.b.v.b bVar = this.f6071e;
        if (bVar != null) {
            bVar.a0(b.b.l.a.a.a(bVar.g0, i2));
        }
    }
    ...
    public void setCloseIconContentDescription(CharSequence charSequence) {
        ...
        if (bVar != null && bVar.R != charSequence) {
            ...
            bVar.R = c2.d(charSequence, c2.f1822c, true);
            bVar.invalidateSelf();
        }
    }
    ...
    public void setCloseIconResource(int i2) {
        c.b.a.b.v.b bVar = this.f6071e;
        if (bVar != null) {
            bVar.c0(b.b.l.a.a.b(bVar.g0, i2));
        }
        i();
    }
    ...
    public void setCloseIconTintResource(int i2) {
        c.b.a.b.v.b bVar = this.f6071e;
        if (bVar != null) {
            bVar.h0(b.b.l.a.a.a(bVar.g0, i2));
        }
    }
    ...
    public void setRippleColorResource(int i2) {
        c.b.a.b.v.b bVar = this.f6071e;
        if (bVar != null) {
            bVar.l0(b.b.l.a.a.a(bVar.g0, i2));
            if (!this.f6071e.C0) {
                j();
            }
        }
    ...
    public void setText(CharSequence charSequence, TextView.BufferType bufferType) {
        if (this.f6071e != null) {
            ...
            super.setText(this.f6071e.G0 ? null : charSequence, bufferType);
            c.b.a.b.v.b bVar = this.f6071e;
            if (bVar != null) {
