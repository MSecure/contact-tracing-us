...
public final class o extends i {
    ...
    public static final Comparator<Map.Entry<String, Long>> f6618c = new a();

    /* renamed from: b  reason: collision with root package name */
    public final ConcurrentMap<Map.Entry<j, Locale>, Object> f6619b = new ConcurrentHashMap(16, 0.75f, 2);
    ...
    public static final class b {
        ...
        public final Map<p, Map<Long, String>> f6620a;

        /* renamed from: b  reason: collision with root package name */
        public final Map<p, List<Map.Entry<String, Long>>> f6621b;
        ...
        public b(Map<p, Map<Long, String>> map) {
            ...
            for (p pVar : map.keySet()) {
                ...
                Collections.sort(arrayList2, o.f6618c);
                hashMap.put(pVar, arrayList2);
                arrayList.addAll(arrayList2);
                hashMap.put(null, arrayList);
            }
            Collections.sort(arrayList, o.f6618c);
            this.f6621b = hashMap;
        }

        public String a(long j, p pVar) {
            Map<Long, String> map = this.f6620a.get(pVar);
            if (map != null) {
    ...
    public String b(j jVar, long j, p pVar, Locale locale) {
        Object f2 = f(jVar, locale);
        if (f2 instanceof b) {
            return ((b) f2).a(j, pVar);
        }
        return null;
    }
    ...
    public Iterator<Map.Entry<String, Long>> c(j jVar, p pVar, Locale locale) {
        ...
        Object f2 = f(jVar, locale);
        if (!(f2 instanceof b) || (list = ((b) f2).f6621b.get(pVar)) == null) {
            return null;
        }
    ...
    public final Object f(j jVar, Locale locale) {
        ...
        Object obj2 = this.f6619b.get(simpleImmutableEntry2);
        if (obj2 != null) {
            return obj2;
        }
        p pVar = p.NARROW;
        ...
        if (jVar == g.b.a.w.a.MONTH_OF_YEAR) {
            ...
            if (jVar == g.b.a.w.a.DAY_OF_WEEK) {
            ...
            } else if (jVar == g.b.a.w.a.AMPM_OF_DAY) {
                ...
                this.f6619b.putIfAbsent(simpleImmutableEntry, obj);
                return this.f6619b.get(simpleImmutableEntry);
            }
        }
        obj = e(hashMap);
        this.f6619b.putIfAbsent(simpleImmutableEntry, obj);
