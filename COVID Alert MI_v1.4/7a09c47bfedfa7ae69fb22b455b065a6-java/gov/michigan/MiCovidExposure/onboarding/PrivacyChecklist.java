...
public class PrivacyChecklist extends Fragment {
    public /* synthetic */ void d(View view) {
        ...
        d2.h(R.id.home_fragment, new OnboardingStartFragment(), ExposureNotificationActivity.HOME_FRAGMENT_TAG);
        d2.j(4099);
        d2.c(null);
        d2.d();
    }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ((Button) view.findViewById(R.id.done_btn)).setOnClickListener(new h(this));
    }
}
