...
public class AlertController {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            this.f25c = obtainStyledAttributes.getDimensionPixelOffset(j.RecycleListView_paddingBottomNoButtons, -1);
            this.f24b = obtainStyledAttributes.getDimensionPixelOffset(j.RecycleListView_paddingTopNoTitle, -1);
        }
    }
        ...
        public void onClick(View view) {
            ...
            if (view != alertController.o || (message3 = alertController.q) == null) {
                ...
                if (view != alertController2.s || (message3 = alertController2.u) == null) {
                    ...
                    alertController4.R.obtainMessage(1, alertController4.f20b).sendToTarget();
                }
            }
            ...
            alertController42.R.obtainMessage(1, alertController42.f20b).sendToTarget();
        }
    }
    ...
    public static final class c extends Handler {
        ...
        /* renamed from: a  reason: collision with root package name */
        public WeakReference<DialogInterface> f32a;
    ...
    public AlertController(Context context, o oVar, Window window) {
        ...
        this.f22d = obtainStyledAttributes.getDimensionPixelSize(j.AlertDialog_buttonIconDimen, 0);
