...
public class a0 {
    ...
    public float f587c = -1.0f;

    /* renamed from: d  reason: collision with root package name */
    public float f588d = -1.0f;

    /* renamed from: e  reason: collision with root package name */
    public float f589e = -1.0f;
    ...
    public final boolean g() {
        if (!i() || this.f585a != 1) {
            ...
            if (!this.g || this.f.length == 0) {
                int floor = ((int) Math.floor((double) ((this.f589e - this.f588d) / this.f587c))) + 1;
                int[] iArr = new int[floor];
                for (int i2 = 0; i2 < floor; i2++) {
                    iArr[i2] = Math.round((((float) i2) * this.f587c) + this.f588d);
                }
                this.f = b(iArr);
            }
            this.f586b = true;
    ...
    public final boolean h() {
        ...
        if (z) {
            this.f585a = 1;
            int[] iArr = this.f;
            this.f588d = (float) iArr[0];
            this.f589e = (float) iArr[length - 1];
            this.f587c = -1.0f;
        }
        return this.g;
    }
