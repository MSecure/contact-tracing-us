...
public class i0 extends ViewGroup {
    ...
    public static class a extends ViewGroup.MarginLayoutParams {
        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            this.f657a = obtainStyledAttributes.getFloat(j.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.f658b = obtainStyledAttributes.getInt(j.LinearLayoutCompat_Layout_android_layout_gravity, -1);
    ...
    public i0(Context context, AttributeSet attributeSet, int i2) {
        ...
        m.S(this, context, j.LinearLayoutCompat, attributeSet, obtainStyledAttributes, i2, 0);
        ...
        this.f654c = obtainStyledAttributes.getInt(j.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
    ...
    public int getBaseline() {
        ...
        if (childCount > i3) {
            ...
            if (baseline != -1) {
                int i4 = this.f655d;
                if (this.f656e == 1 && (i2 = this.f & 112) != 48) {
                    if (i2 == 16) {
        ...
        if (this.f656e == 1) {
            ...
            while (i24 < virtualChildCount) {
                ...
                if (childAt == null) {
                    ...
                    int absoluteGravity = Gravity.getAbsoluteGravity(i25, m.o(this)) & 7;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f656e == 1) {
            ...
            while (i44 < virtualChildCount) {
                ...
                if (childAt == null) {
                    ...
                    if (mode2 == i42 && ((ViewGroup.MarginLayoutParams) aVar3).height == 0 && f7 > f5) {
                        ...
                        if (((ViewGroup.MarginLayoutParams) aVar3).height != 0 || aVar3.f657a <= f5) {
                            i37 = i40;
                        } else {
                        ...
                        int measuredHeight = childAt.getMeasuredHeight();
                        int i51 = this.g;
                        this.g = Math.max(i51, n() + i51 + measuredHeight + ((ViewGroup.MarginLayoutParams) aVar2).topMargin + ((ViewGroup.MarginLayoutParams) aVar2).bottomMargin);
                        if (z11) {
            ...
            int i54 = i48;
            int i55 = i49;
            if (this.g > 0 && o(virtualChildCount)) {
                this.g += this.n;
            }
            int i56 = mode2;
            if (z11 && (i56 == Integer.MIN_VALUE || i56 == 0)) {
                ...
                while (i57 < virtualChildCount) {
                    ...
                    if (childAt2 == null) {
                        ...
                        int i58 = this.g;
                        this.g = Math.max(i58, n() + i58 + i46 + ((ViewGroup.MarginLayoutParams) aVar4).topMargin + ((ViewGroup.MarginLayoutParams) aVar4).bottomMargin);
                    }
                    i57++;
                }
            }
            ...
            if (z12 || (i59 != 0 && f6 > 0.0f)) {
                    ...
                    if (childAt3.getVisibility() == 8) {
                        ...
                        if (mode != 1073741824) {
                            ...
                            if (((ViewGroup.MarginLayoutParams) aVar5).width == -1) {
                                ...
                                int i64 = this.g;
                                this.g = Math.max(i64, n() + childAt3.getMeasuredHeight() + i64 + ((ViewGroup.MarginLayoutParams) aVar5).topMargin + ((ViewGroup.MarginLayoutParams) aVar5).bottomMargin);
                                z14 = z16;
                                i59 = i28;
                            }
                        } else {
                        ...
                        int i642 = this.g;
                        this.g = Math.max(i642, n() + childAt3.getMeasuredHeight() + i642 + ((ViewGroup.MarginLayoutParams) aVar5).topMargin + ((ViewGroup.MarginLayoutParams) aVar5).bottomMargin);
                        z14 = z16;
                        i59 = i28;
                    }
                    i60++;
                ...
                if (z11 && i56 != 1073741824) {
                    for (int i65 = 0; i65 < virtualChildCount; i65++) {
                        ...
                        if (!(childAt4 == null || childAt4.getVisibility() == 8 || ((a) childAt4.getLayoutParams()).f657a <= 0.0f)) {
                ...
                if (mode3 == 1073741824 && ((ViewGroup.MarginLayoutParams) aVar7).width == 0 && f11 > 0.0f) {
                    ...
                    if (((ViewGroup.MarginLayoutParams) aVar7).width == 0) {
                        ...
                        if (aVar7.f657a > 0.0f) {
                            ...
                            z3 = z18;
                            z2 = z17;
                            p(childAt6, i2, f12 != f4 ? this.g : 0, i3, 0);
                            ...
                            int i77 = this.g;
                            if (!z19) {
                                this.g = n() + ((ViewGroup.MarginLayoutParams) aVar).leftMargin + measuredWidth3 + ((ViewGroup.MarginLayoutParams) aVar).rightMargin + i77;
                            } else {
                                this.g = Math.max(i77, n() + i77 + measuredWidth3 + ((ViewGroup.MarginLayoutParams) aVar).leftMargin + ((ViewGroup.MarginLayoutParams) aVar).rightMargin);
                            }
                            if (z3) {
        ...
        int i78 = i69;
        if (this.g > 0 && o(virtualChildCount2)) {
            this.g += this.m;
        }
            ...
            if (iArr[3] == -1) {
                ...
                if (z18 && (mode3 == Integer.MIN_VALUE || mode3 == 0)) {
                    ...
                    while (i18 < virtualChildCount2) {
                        ...
                        if (childAt7 == null) {
                            ...
                            int i79 = this.g;
                            this.g = z19 ? n() + ((ViewGroup.MarginLayoutParams) aVar8).leftMargin + i71 + ((ViewGroup.MarginLayoutParams) aVar8).rightMargin + i79 : Math.max(i79, n() + i79 + i71 + ((ViewGroup.MarginLayoutParams) aVar8).leftMargin + ((ViewGroup.MarginLayoutParams) aVar8).rightMargin);
                        }
                        i18++;
                    }
                }
                ...
                if (!z21 || (i5 != 0 && f10 > 0.0f)) {
                    ...
                    while (i10 < virtualChildCount2) {
                        ...
                        if (childAt8 == null || childAt8.getVisibility() == 8) {
                            ...
                            if (z19) {
                                f3 = f10;
                                i15 = n() + childAt8.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) aVar9).leftMargin + ((ViewGroup.MarginLayoutParams) aVar9).rightMargin + this.g;
                                i14 = i13;
                            } else {
                                f3 = f10;
                                int i84 = this.g;
                                i14 = i13;
                                i15 = Math.max(i84, n() + childAt8.getMeasuredWidth() + i84 + ((ViewGroup.MarginLayoutParams) aVar9).leftMargin + ((ViewGroup.MarginLayoutParams) aVar9).rightMargin);
                            }
                            this.g = i15;
                ...
                if (z18 && mode3 != 1073741824) {
                    for (int i90 = 0; i90 < virtualChildCount2; i90++) {
                        ...
                        if (!(childAt10 == null || childAt10.getVisibility() == 8 || ((a) childAt10.getLayoutParams()).f657a <= 0.0f)) {
    ...
    public void setBaselineAlignedChildIndex(int i2) {
        if (i2 < 0 || i2 >= getChildCount()) {
            StringBuilder g2 = c.a.a.a.a.g("base aligned child index out of range (0, ");
