...
public class e {
    ...
    public e(Context context, ViewGroup viewGroup, c cVar) {
        if (cVar != null) {
            ...
            this.f1240b = viewConfiguration.getScaledTouchSlop();
    ...
    public void a() {
        this.f1241c = -1;
        float[] fArr = this.f1242d;
        if (fArr != null) {
            Arrays.fill(fArr, 0.0f);
            Arrays.fill(this.f1243e, 0.0f);
    ...
    public void b(View view, int i2) {
        ...
        StringBuilder g2 = c.a.a.a.a.g("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
        g2.append(this.t);
        g2.append(")");
    ...
    public final boolean c(float f2, float f3, int i2, int i3) {
        ...
        if (abs < abs2 * 0.5f && this.q == null) {
            throw null;
        } else if ((this.i[i2] & i3) != 0 || abs <= ((float) this.f1240b)) {
            return false;
        } else {
            return true;
        }
    ...
    public final boolean d(View view, float f2, float f3) {
        ...
        if (!z || !z2) {
            return z ? Math.abs(f2) > ((float) this.f1240b) : z2 && Math.abs(f3) > ((float) this.f1240b);
        }
        float f4 = f3 * f3;
        int i2 = this.f1240b;
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    if (this.f1239a != 1) {
                        ...
                        while (i3 < pointerCount) {
                            ...
                            if (m(pointerId)) {
                                ...
                                float f2 = x - this.f1242d[pointerId];
                                float f3 = y - this.f1243e[pointerId];
                                p(f2, f3, pointerId);
                                if (this.f1239a != 1) {
                    ...
                    } else if (m(this.f1241c)) {
                        int findPointerIndex = motionEvent.findPointerIndex(this.f1241c);
                    ...
                    if (actionMasked == 5) {
                        ...
                        if (this.f1239a == 1 && pointerId3 == this.f1241c) {
    ...
    public final void o() {
        ...
        j(e(this.l.getXVelocity(this.f1241c), this.n, this.m), e(this.l.getYVelocity(this.f1241c), this.n, this.m));
    }
    ...
    public final void q(float f2, float f3, int i2) {
        ...
        if (fArr == null || fArr.length <= i2) {
            ...
            float[] fArr6 = this.f1242d;
            if (fArr6 != null) {
                System.arraycopy(fArr6, 0, fArr2, 0, fArr6.length);
                float[] fArr7 = this.f1243e;
        ...
        float[] fArr10 = this.f1242d;
        this.f[i2] = f2;
        fArr10[i2] = f2;
        float[] fArr11 = this.f1243e;
        this.g[i2] = f3;
        fArr11[i2] = f3;
        int[] iArr7 = this.h;
        int i5 = (int) f2;
    ...
    public boolean t(int i2, int i3) {
        if (this.s) {
            return l(i2, i3, (int) this.l.getXVelocity(this.f1241c), (int) this.l.getYVelocity(this.f1241c));
        }
    ...
    public boolean u(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                ...
                } else if (!(this.f1242d == null || this.f1243e == null)) {
                    int pointerCount = motionEvent.getPointerCount();
                    int i3 = 0;
                    while (i3 < pointerCount) {
                        ...
                        if (m(pointerId2)) {
                            ...
                            float f2 = x2 - this.f1242d[pointerId2];
                            float f3 = y2 - this.f1243e[pointerId2];
