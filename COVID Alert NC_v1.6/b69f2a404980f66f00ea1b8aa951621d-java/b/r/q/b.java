...
public class b {
    ...
    public static void a(b.u.a.b bVar) {
        ArrayList arrayList = new ArrayList();
        Cursor d2 = ((a) bVar).d(new b.u.a.a("SELECT name FROM sqlite_master WHERE type = 'trigger'"));
        while (d2.moveToNext()) {
            try {
        ...
        while (it.hasNext()) {
            ...
            if (str.startsWith("room_fts_content_sync_")) {
                ((a) bVar).f1742b.execSQL(c.a.a.a.a.o("DROP TRIGGER IF EXISTS ", str));
            }
        }
    }
