...
public final class e {
    ...
    public static final String f1911b = m.e("Data");

    /* renamed from: c  reason: collision with root package name */
    public static final e f1912c;

    /* renamed from: a  reason: collision with root package name */
    public Map<String, Object> f1913a;

    public static final class a {

        /* renamed from: a  reason: collision with root package name */
        public Map<String, Object> f1914a = new HashMap();

        public e a() {
            e eVar = new e(this.f1914a);
            e.h(eVar);
            return eVar;
        }
        ...
        public a b(Map<String, Object> map) {
            for (Map.Entry<String, Object> entry : map.entrySet()) {
                ...
                if (value == null) {
                    this.f1914a.put(key, null);
                } else {
                    Class<?> cls = value.getClass();
                    if (cls == Boolean.class || cls == Byte.class || cls == Integer.class || cls == Long.class || cls == Float.class || cls == Double.class || cls == String.class || cls == Boolean[].class || cls == Byte[].class || cls == Integer[].class || cls == Long[].class || cls == Float[].class || cls == Double[].class || cls == String[].class) {
                        this.f1914a.put(key, value);
                    } else if (cls == boolean[].class) {
                        this.f1914a.put(key, e.a((boolean[]) value));
                    } else if (cls == byte[].class) {
                        this.f1914a.put(key, e.b((byte[]) value));
                    } else if (cls == int[].class) {
                        this.f1914a.put(key, e.e((int[]) value));
                    } else if (cls == long[].class) {
                        this.f1914a.put(key, e.f((long[]) value));
                    } else if (cls == float[].class) {
                        this.f1914a.put(key, e.d((float[]) value));
                    } else if (cls == double[].class) {
                        this.f1914a.put(key, e.c((double[]) value));
                    } else {
    ...
    public e(e eVar) {
        this.f1913a = new HashMap(eVar.f1913a);
    }

    public e(Map<String, ?> map) {
        this.f1913a = new HashMap(map);
    }
    ...
    public static byte[] h(e eVar) {
        ...
        try {
            objectOutputStream2.writeInt(eVar.f1913a.size());
            for (Map.Entry<String, Object> entry : eVar.f1913a.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        e eVar = (e) obj;
        Set<String> keySet = this.f1913a.keySet();
        if (!keySet.equals(eVar.f1913a.keySet())) {
            return false;
        }
        for (String str : keySet) {
            Object obj2 = this.f1913a.get(str);
            Object obj3 = eVar.f1913a.get(str);
    ...
    public int hashCode() {
        return this.f1913a.hashCode() * 31;
    }

    public String toString() {
        StringBuilder sb = new StringBuilder("Data {");
        if (!this.f1913a.isEmpty()) {
            for (String str : this.f1913a.keySet()) {
                sb.append(str);
                sb.append(" : ");
                Object obj = this.f1913a.get(str);
