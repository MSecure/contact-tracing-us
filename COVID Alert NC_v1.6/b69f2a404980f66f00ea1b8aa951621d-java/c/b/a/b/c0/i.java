...
public final class i {
    ...
    public static final int[] f2951a = {b.colorPrimary};

    /* renamed from: b  reason: collision with root package name */
    public static final int[] f2952b = {b.colorPrimaryVariant};
    ...
    public static void a(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (z) {
            ...
            if (!context.getTheme().resolveAttribute(b.isMaterialTheme, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                c(context, f2952b, "Theme.MaterialComponents");
            }
        }
        c(context, f2951a, "Theme.AppCompat");
    }
    ...
    public static void c(Context context, int[] iArr, String str) {
        ...
        if (!z) {
            throw new IllegalArgumentException(a.p("The style on this component requires your app theme to be ", str, " (or a descendant)."));
        }
    }
