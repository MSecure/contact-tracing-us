...
public final class p1 {
    ...
    public static final Logger f3624a = Logger.getLogger(p1.class.getName());

    /* renamed from: b  reason: collision with root package name */
    public static final Unsafe f3625b = o();

    /* renamed from: c  reason: collision with root package name */
    public static final Class<?> f3626c = d.f3534a;

    /* renamed from: d  reason: collision with root package name */
    public static final boolean f3627d = e(Long.TYPE);

    /* renamed from: e  reason: collision with root package name */
    public static final boolean f3628e = e(Integer.TYPE);
    ...
    public static final class d extends e {
        ...
        @Override // c.b.c.a.j0.a.p1.e
        public boolean c(Object obj, long j) {
            return this.f3629a.getBoolean(obj, j);
        }

        @Override // c.b.c.a.j0.a.p1.e
        public byte d(Object obj, long j) {
            return this.f3629a.getByte(obj, j);
        }

        @Override // c.b.c.a.j0.a.p1.e
        public double e(Object obj, long j) {
            return this.f3629a.getDouble(obj, j);
        }

        @Override // c.b.c.a.j0.a.p1.e
        public float f(Object obj, long j) {
            return this.f3629a.getFloat(obj, j);
        }

        @Override // c.b.c.a.j0.a.p1.e
        public void k(Object obj, long j, boolean z) {
            this.f3629a.putBoolean(obj, j, z);
        }

        @Override // c.b.c.a.j0.a.p1.e
        public void l(Object obj, long j, byte b2) {
            this.f3629a.putByte(obj, j, b2);
        }

        @Override // c.b.c.a.j0.a.p1.e
        public void m(Object obj, long j, double d2) {
            this.f3629a.putDouble(obj, j, d2);
        }

        @Override // c.b.c.a.j0.a.p1.e
        public void n(Object obj, long j, float f) {
            this.f3629a.putFloat(obj, j, f);
        }
    }
    ...
    public static abstract class e {
        ...
        public final int a(Class<?> cls) {
            return this.f3629a.arrayBaseOffset(cls);
        }

        public final int b(Class<?> cls) {
            return this.f3629a.arrayIndexScale(cls);
        }
        ...
        public final int g(Object obj, long j) {
            return this.f3629a.getInt(obj, j);
        }

        public final long h(Object obj, long j) {
            return this.f3629a.getLong(obj, j);
        }

        public final Object i(Object obj, long j) {
            return this.f3629a.getObject(obj, j);
        }

        public final long j(Field field) {
            return this.f3629a.objectFieldOffset(field);
        }
        ...
        if (unsafe2 == null) {
            ...
            try {
                ...
                try {
                                        ...
                                        if (d.a()) {
                                            ...
                                            try {
                                                ...
                                                try {
                                                    ...
                                                    th = th4;
                                                    f3624a.log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + th);
                                                    z3 = false;
                                                    h = z3;
                                                    b(boolean[].class);
                                                    c(boolean[].class);
                    ...
                    th2 = th9;
                    cls = long[].class;
                    f3624a.log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + th2);
                    z = false;
                    g = z;
                    unsafe = f3625b;
                    if (unsafe != null) {
    ...
    public static <T> T a(Class<T> cls) {
        try {
            return (T) f3625b.allocateInstance(cls);
    ...
    public static void r(Object obj, long j2, byte b2) {
        ...
        int i2 = ((~((int) j2)) & 3) << 3;
        e eVar = f;
        eVar.o(obj, j3, ((255 & b2) << i2) | (l & (~(255 << i2))));
    }
    ...
    public static void s(Object obj, long j2, byte b2) {
        ...
        int i2 = (((int) j2) & 3) << 3;
        e eVar = f;
        eVar.o(obj, j3, ((255 & b2) << i2) | (l(obj, j3) & (~(255 << i2))));
    }
