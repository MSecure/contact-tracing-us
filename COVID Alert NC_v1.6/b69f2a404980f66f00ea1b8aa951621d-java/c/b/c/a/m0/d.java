...
public final class d implements c.b.c.a.a {
    ...
    public static final ThreadLocal<Cipher> f3717e = new a();
    ...
    public final SecretKeySpec f3720c;
    ...
    public class a extends ThreadLocal<Cipher> {
        ...
        public Cipher initialValue() {
            try {
                return a0.f.a("AES/ECB/NOPADDING");
    ...
    public d(byte[] bArr, int i) {
        if (i == 12 || i == 16) {
            this.f3721d = i;
            n0.a(bArr.length);
            this.f3720c = new SecretKeySpec(bArr, "AES");
            Cipher cipher = f3717e.get();
            cipher.init(1, this.f3720c);
    ...
    public byte[] a(byte[] bArr, byte[] bArr2) {
        ...
        if (length <= (Integer.MAX_VALUE - i) - 16) {
            ...
            byte[] a2 = i0.a(i);
            System.arraycopy(a2, 0, bArr3, 0, this.f3721d);
            Cipher cipher = f3717e.get();
            cipher.init(1, this.f3720c);
            ...
            cipher2.init(1, this.f3720c, new IvParameterSpec(d2));
            cipher2.doFinal(bArr, 0, bArr.length, bArr3, this.f3721d);
            byte[] d4 = d(cipher, 2, bArr3, this.f3721d, bArr.length);
            int length2 = bArr.length + this.f3721d;
    ...
    public byte[] b(byte[] bArr, byte[] bArr2) {
        int length = (bArr.length - this.f3721d) - 16;
        if (length >= 0) {
            Cipher cipher = f3717e.get();
            cipher.init(1, this.f3720c);
            byte[] d2 = d(cipher, 0, bArr, 0, this.f3721d);
            if (bArr2 == null) {
                bArr2 = new byte[0];
            }
            byte[] d3 = d(cipher, 1, bArr2, 0, bArr2.length);
            byte[] d4 = d(cipher, 2, bArr, this.f3721d, length);
            ...
            if (b2 == 0) {
                Cipher cipher2 = f.get();
                cipher2.init(1, this.f3720c, new IvParameterSpec(d2));
                return cipher2.doFinal(bArr, this.f3721d, length);
            }
    ...
    public final byte[] d(Cipher cipher, int i, byte[] bArr, int i2, int i3) {
        ...
        bArr3[15] = (byte) i;
        if (i3 == 0) {
            return cipher.doFinal(e(bArr3, this.f3718a));
        }
        ...
        if (copyOfRange.length == 16) {
            bArr2 = e(copyOfRange, this.f3718a);
        } else {
            byte[] copyOf = Arrays.copyOf(this.f3719b, 16);
