...
public final class h {
    ...
    public static final Charset f3739a = Charset.forName(o.DEFAULT_PARAMS_ENCODING);
    ...
    public static class b extends a {
        ...
        public static final int[] f3742c;

        /* renamed from: d  reason: collision with root package name */
        public static final int[] f3743d;
    ...
    public static class c extends a {
        ...
        public c(int i2, byte[] bArr) {
            ...
            this.i = (i2 & 8) == 0 ? j : k;
            this.f3744c = new byte[2];
            this.f3745d = 0;
            this.f3746e = this.g ? 19 : -1;
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:60:0x00ea A[EDGE_INSN: B:60:0x00ea->B:42:0x00ea ?: BREAK  , SYNTHETIC] */
    public static byte[] a(String str, int i) {
        boolean z;
        byte[] bytes = str.getBytes(f3739a);
        int length = bytes.length;
        int i2 = (length * 3) / 4;
        byte[] bArr = new byte[i2];
        int[] iArr = (i & 8) == 0 ? b.f3742c : b.f3743d;
        int i3 = length + 0;
        int i4 = 0;
        int i5 = 0;
        int i6 = 0;
        ...
        while (true) {
            ...
            if (i5 == 0) {
                while (true) {
                    int i8 = i4 + 4;
                    if (i8 > i3 || (i6 = (iArr[bytes[i4] & 255] << 18) | (iArr[bytes[i4 + 1] & 255] << 12) | (iArr[bytes[i4 + 2] & 255] << 6) | iArr[bytes[i4 + 3] & 255]) < 0) {
                        if (i4 >= i3) {
                            break;
                        }
                    } else {
    ...
    public static String b(byte[] bArr) {
        try {
            return new String(c(bArr, 2), "US-ASCII");
    ...
    /* JADX WARNING: Removed duplicated region for block: B:96:0x0123 A[SYNTHETIC] */
    public static byte[] c(byte[] r17, int r18) {
        /*
        // Method dump skipped, instructions count: 506
        */
        throw new UnsupportedOperationException("Method not decompiled: c.b.c.a.m0.h.c(byte[], int):byte[]");
    }
}
