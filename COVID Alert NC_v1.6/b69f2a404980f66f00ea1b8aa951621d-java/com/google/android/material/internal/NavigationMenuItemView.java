...
public class NavigationMenuItemView extends e implements n.a {
    ...
    public class a extends b.i.l.a {
        ...
        public void d(View view, b bVar) {
            ...
            bVar.f1195a.setCheckable(NavigationMenuItemView.this.y);
        }
    }
    ...
    public void e(i iVar, int i) {
        ...
        if (!(iVar2.f552e == null && iVar2.getIcon() == null && this.B.getActionView() != null)) {
            z2 = false;
        }
        if (z2) {
    ...
    public void setIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (this.E == null) {
                Drawable drawable2 = getResources().getDrawable(c.b.a.b.e.navigation_empty_icon, getContext().getTheme());
                this.E = drawable2;
                if (drawable2 != null) {
                    int i2 = this.w;
