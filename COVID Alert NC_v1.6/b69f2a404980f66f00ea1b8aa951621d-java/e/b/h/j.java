...
public class j {
    ...
    public static final char[] f4849a = {',', ';'};

    /* renamed from: b  reason: collision with root package name */
    public static final HashMap<String, String> f4850b = new HashMap<>();
    ...
    public enum b {
        ...
        public int b(String str) {
            int binarySearch = Arrays.binarySearch(this.f4855b, str);
            if (binarySearch >= 0) {
                return this.f4856c[binarySearch];
            }
            return -1;
        }
    }
    ...
    public static void a(b bVar, String str, int i) {
        int i2;
        bVar.f4855b = new String[i];
        bVar.f4856c = new int[i];
        bVar.f4857d = new int[i];
        bVar.f4858e = new String[i];
        e.b.i.a aVar = new e.b.i.a(new StringReader(str), str.length());
        boolean z = false;
        int i3 = 0;
        while (!aVar.l()) {
            String g = aVar.g('=');
            aVar.a();
            int parseInt = Integer.parseInt(aVar.h(f4849a), 36);
            char k = aVar.k();
            aVar.a();
            if (k == ',') {
            ...
            aVar.a();
            bVar.f4855b[i3] = g;
            bVar.f4856c[i3] = parseInt;
            bVar.f4857d[parseInt2] = parseInt;
            bVar.f4858e[parseInt2] = g;
            if (i2 != -1) {
                f4850b.put(g, new String(new int[]{parseInt, i2}, 0, 2));
            }
            i3++;
        }
        if (i3 == i) {
        ...
        c.u1(z, "Unexpected count of entities loaded");
    }

    public static void b(Appendable appendable, b bVar, int i) {
        String str;
        Appendable appendable2;
        int binarySearch = Arrays.binarySearch(bVar.f4857d, i);
        if (binarySearch >= 0) {
            String[] strArr = bVar.f4858e;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x00a7, code lost:
        if (r3.canEncode(r11) != false) goto L_0x008d;
     */
    public static void c(Appendable appendable, String str, f.a aVar, boolean z, boolean z2, boolean z3) {
        String str2;
        b bVar = aVar.f4834b;
        CharsetEncoder charsetEncoder = aVar.f4836d.get();
