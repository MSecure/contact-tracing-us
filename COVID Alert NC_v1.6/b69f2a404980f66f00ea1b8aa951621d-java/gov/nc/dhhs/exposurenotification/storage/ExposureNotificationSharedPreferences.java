...
public class ExposureNotificationSharedPreferences {
    ...
    public static final String CHECK_IF_APP_INSTALLED = "ExposureNotificationSharedPreferences.CHECK_IF_APP_INSTALLED";
    ...
    public static final String DEFAULT_MASTER_KEY_ALIAS = "NCCovidExposure";
    ...
    public static final String TOTAL_DOWNLOADS = "ExposureNotificationSharedPreferences.TOTAL_DOWNLOADS";
    public static final String UPDATE_NOTIFICATION = "ExposureNotificationSharedPreferences.UPDATE_NOTIFICATION";
    public static final String VERSION_NUMBER = "ExposureNotificationSharedPreferences.VERSION_NUMBER";
    ...
    public ExposureNotificationSharedPreferences(Context context) {
        ...
        try {
            ...
            KeyGenParameterSpec build = new KeyGenParameterSpec.Builder(DEFAULT_MASTER_KEY_ALIAS, 3).setBlockModes("GCM").setEncryptionPaddings("NoPadding").setKeySize(RecyclerView.d0.FLAG_TMP_DETACHED).build();
    ...
    public boolean getCheckIfAppInstalled(boolean z) {
        return this.sharedPreferences.getBoolean(CHECK_IF_APP_INSTALLED, z);
    }
    ...
    public String getTotalDownloads(String str) {
        return this.sharedPreferences.getString(TOTAL_DOWNLOADS, str);
    }

    public boolean getUpdateNotificationShown(boolean z) {
        return this.sharedPreferences.getBoolean(UPDATE_NOTIFICATION, z);
    }

    public String getVersionNumber(String str) {
        return this.sharedPreferences.getString(VERSION_NUMBER, str);
    }
    ...
    public void setCheckIfAppInstalled(boolean z) {
        this.sharedPreferences.edit().putBoolean(CHECK_IF_APP_INSTALLED, z).apply();
    }
    ...
    public void setTotalDownloads(String str) {
        this.sharedPreferences.edit().putString(TOTAL_DOWNLOADS, str).apply();
    }

    public void setUpdateNotificationShown(boolean z) {
        this.sharedPreferences.edit().putBoolean(UPDATE_NOTIFICATION, z).apply();
    }

    public void setVersionNumber(String str) {
        this.sharedPreferences.edit().putString(VERSION_NUMBER, str).apply();
    }
}
