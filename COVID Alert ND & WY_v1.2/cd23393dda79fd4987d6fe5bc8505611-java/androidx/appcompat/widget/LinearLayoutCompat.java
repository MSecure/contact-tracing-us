                            ...
                            if (f4 > 0.0f) {
                                ...
                                if (layoutParams3.height == 0) {
                                    ...
                                    if (mode2 == 1073741824) {
                                        ...
                                        virtualChildAt3.measure(childMeasureSpec, View.MeasureSpec.makeMeasureSpec(i39, Ints.MAX_POWER_OF_TWO));
                    ...
                    if (z3 && mode2 != 1073741824) {
                        for (int i42 = 0; i42 < i3; i42++) {
                            ...
                            if (!(virtualChildAt4 == null || virtualChildAt4.getVisibility() == 8 || ((LayoutParams) virtualChildAt4.getLayoutParams()).weight <= 0.0f)) {
                                virtualChildAt4.measure(View.MeasureSpec.makeMeasureSpec(virtualChildAt4.getMeasuredWidth(), Ints.MAX_POWER_OF_TWO), View.MeasureSpec.makeMeasureSpec(i24, Ints.MAX_POWER_OF_TWO));
                            }
                        }
                    }
                    i4 = i;
