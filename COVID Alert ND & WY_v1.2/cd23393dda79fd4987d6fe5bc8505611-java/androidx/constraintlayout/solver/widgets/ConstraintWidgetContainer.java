...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public void layout() {
        ...
        Object[] objArr = (getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT || getVerticalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) ? 1 : null;
        boolean z3 = false;
        int i8 = 0;
            ...
            if (this.mWidgetGroups.get(i8).mSkipSolver) {
                ...
                while (z5) {
                    ...
                    if (z5) {
                        ...
                        if (objArr != null || i11 >= 8 || !Optimizer.flags[c]) {
                            i3 = i11;
                            z = false;
                        } else {
                            int i14 = 0;
                        ...
                        if (!z2) {
                            if (this.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT && max3 > 0 && getWidth() > max3) {
                                ...
                                this.mListDimensionBehaviors[0] = ConstraintWidget.DimensionBehaviour.FIXED;
                                setWidth(max3);
                                boolean z7 = r8 == true ? 1 : 0;
                                Object[] objArr2 = r8 == true ? 1 : 0;
                                Object[] objArr3 = r8 == true ? 1 : 0;
                                z = z7;
                                z2 = z;
                            }
