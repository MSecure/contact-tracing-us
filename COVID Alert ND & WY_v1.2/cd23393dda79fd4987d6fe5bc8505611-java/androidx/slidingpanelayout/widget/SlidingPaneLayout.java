        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(paddingLeft - i15, Ints.MAX_POWER_OF_TWO);
                } else {
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z2) {
                                    ...
                                    i6 = i16;
                                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i18, Ints.MAX_POWER_OF_TWO);
                                    if (i7 != i18) {
