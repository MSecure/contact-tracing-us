            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (infoForChild = infoForChild(childAt2)) != null) {
                    ...
                    if (layoutParams2.needsMeasure) {
                        ...
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), Ints.MAX_POWER_OF_TWO), View.MeasureSpec.makeMeasureSpec((i10 - paddingTop) - paddingBottom, Ints.MAX_POWER_OF_TWO));
                    }
