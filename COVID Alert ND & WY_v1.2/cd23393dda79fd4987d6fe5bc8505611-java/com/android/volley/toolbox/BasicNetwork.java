...
public class BasicNetwork implements Network {
    ...
    public NetworkResponse performRequest(Request<?> request) throws VolleyError {
        ...
        while (true) {
            ...
            try {
                executeRequest = this.mBaseHttpStack.executeRequest(request, getCacheHeaders(request.getCacheEntry()));
                ...
                inputStreamToBytes = content != null ? inputStreamToBytes(content, executeRequest.getContentLength()) : new byte[0];
