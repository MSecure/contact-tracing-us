...
public final class zzem<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public final V put(@NullableDecl K k, @NullableDecl V v) {
        ...
        if (zza()) {
            ...
            int max2 = Math.max(4, (max <= ((int) (((double) highestOneBit) * 1.0d)) || (highestOneBit = highestOneBit << 1) > 0) ? highestOneBit : Ints.MAX_POWER_OF_TWO);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private final int zza(@NullableDecl Object obj) {
        if (zza()) {
            return -1;
        }
    ...
    /* access modifiers changed from: public */
    @NullableDecl
    private final Object zzb(@NullableDecl Object obj) {
        if (zza()) {
            return zzd;
        }
        int zzi2 = zzi();
