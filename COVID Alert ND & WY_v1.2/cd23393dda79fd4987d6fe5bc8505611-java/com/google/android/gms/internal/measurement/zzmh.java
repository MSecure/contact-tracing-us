...
public final class zzmh implements zzme {
    ...
    static {
        ...
        zza = zzdm.zza("measurement.ad_id_cache_time", WorkRequest.MIN_BACKOFF_MILLIS);
        zzb = zzdm.zza("measurement.config.cache_time", 86400000L);
        ...
        zzm = zzdm.zza("measurement.monitoring.sample_period_millis", 86400000L);
        zzn = zzdm.zza("measurement.upload.realtime_upload_interval", WorkRequest.MIN_BACKOFF_MILLIS);
        zzo = zzdm.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000L);
        ...
        zzs = zzdm.zza("measurement.upload.stale_data_deletion_interval", 86400000L);
