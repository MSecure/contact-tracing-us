...
public final class zzii extends zzg {
    ...
    public final void zza(Activity activity, Bundle bundle) {
        ...
        if (zzs().zzh().booleanValue() && bundle != null && (bundle2 = bundle.getBundle("com.google.app_measurement.screen_service")) != null) {
            this.zzd.put(activity, new zzij(bundle2.getString(AppMeasurementSdk.ConditionalUserProperty.NAME), bundle2.getString("referrer_name"), bundle2.getLong("id")));
        }
    }
    ...
    public final void zzb(Activity activity, Bundle bundle) {
        ...
        if (zzs().zzh().booleanValue() && bundle != null && (zzij = this.zzd.get(activity)) != null) {
            ...
            bundle2.putString(AppMeasurementSdk.ConditionalUserProperty.NAME, zzij.zza);
