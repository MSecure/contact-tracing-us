                ...
                if (zze != null) {
                    for (zzcd.zzk zzk : zze) {
                        if (zzk != null) {
                            ...
                            zza(sb, 2, AppMeasurementSdk.ConditionalUserProperty.NAME, zzn().zzc(zzk.zzc()));
                ...
                if (zzc != null) {
                    for (zzcd.zzc zzc2 : zzc) {
                        if (zzc2 != null) {
                            zza(sb, 2);
                            sb.append("event {\n");
                            zza(sb, 2, AppMeasurementSdk.ConditionalUserProperty.NAME, zzn().zza(zzc2.zzc()));
                            if (zzc2.zzd()) {
        ...
        if (list != null) {
            ...
            for (zzcd.zze zze : list) {
                if (zze != null) {
                    ...
                    sb.append("param {\n");
                    Double d = null;
                    zza(sb, i2, AppMeasurementSdk.ConditionalUserProperty.NAME, zze.zza() ? zzn().zzb(zze.zzb()) : null);
