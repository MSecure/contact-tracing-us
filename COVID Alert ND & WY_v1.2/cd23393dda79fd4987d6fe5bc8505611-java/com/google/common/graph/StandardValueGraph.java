...
public class StandardValueGraph<N, V> extends AbstractValueGraph<N, V> {
    ...
    public Set<EndpointPair<N>> incidentEdges(N n) {
        ...
        return new IncidentEdgeSet<N>(this, n) {
            /* class com.google.common.graph.StandardValueGraph.AnonymousClass1 */

            /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: com.google.common.graph.GraphConnections */
