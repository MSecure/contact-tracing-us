...
public class NotificationParams {
    ...
    public static boolean isNotification(Bundle bundle) {
        return DiskLruCache.VERSION_1.equals(bundle.getString(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)) || DiskLruCache.VERSION_1.equals(bundle.getString(keyWithOldPrefix(Constants.MessageNotificationKeys.ENABLE_NOTIFICATION)));
    }
