                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m424contentEqualsus8wMrg(t.m220unboximpl(), t2.m220unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m421contentEqualsctEhBpI(t.m151unboximpl(), t2.m151unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m423contentEqualsmazbYpA(t.m315unboximpl(), t2.m315unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m422contentEqualskdPth3s(t.m82unboximpl(), t2.m82unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m430contentToStringGBYM_sE(t.m82unboximpl()));
            } else if (t instanceof UShortArray) {
                sb.append(UArraysKt.m432contentToStringrL5Bavg(t.m315unboximpl()));
            } else if (t instanceof UIntArray) {
                sb.append(UArraysKt.m429contentToStringajY9A(t.m151unboximpl()));
            } else if (t instanceof ULongArray) {
                sb.append(UArraysKt.m431contentToStringQwZRm1k(t.m220unboximpl()));
            } else {
