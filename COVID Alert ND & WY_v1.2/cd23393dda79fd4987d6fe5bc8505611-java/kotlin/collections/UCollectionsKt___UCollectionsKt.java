...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        for (UByte uByte : collection) {
            UByteArray.m78setVurrAj0(r0, i, uByte.m65unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        ...
        int[] r0 = UIntArray.m136constructorimpl(collection.size());
        int i = 0;
        for (UInt uInt : collection) {
            UIntArray.m147setVXSXFK8(r0, i, uInt.m134unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        ...
        short[] r0 = UShortArray.m300constructorimpl(collection.size());
        int i = 0;
        for (UShort uShort : collection) {
            UShortArray.m311set01HTLdE(r0, i, uShort.m298unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt uInt : iterable) {
            i = UInt.m91constructorimpl(i + uInt.m134unboximpl());
        }
        return i;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte uByte : iterable) {
            i = UInt.m91constructorimpl(i + UInt.m91constructorimpl(uByte.m65unboximpl() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort uShort : iterable) {
            i = UInt.m91constructorimpl(i + UInt.m91constructorimpl(uShort.m298unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
