...
public class ActionBarContextView extends e.b.f.a {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        ...
        this.f831f = obtainStyledAttributes.getLayoutDimension(R$styleable.ActionMode_height, 0);
    ...
    public void f(e.b.e.a aVar) {
        ...
        if (view2 == null) {
            ...
            gVar.b(this.f830e, this.c);
            c cVar3 = this.f830e;
            nVar = cVar3.f766i;
            if (nVar == null) {
                n nVar3 = (n) cVar3.f762e.inflate(cVar3.f764g, (ViewGroup) this, false);
                cVar3.f766i = nVar3;
                nVar3.b(cVar3.f761d);
                cVar3.j(true);
            }
            ...
            this.f829d = actionMenuView;
            AtomicInteger atomicInteger = l.a;
            actionMenuView.setBackground(null);
            addView(this.f829d, layoutParams);
        }
        addView(view);
        this.f54l.findViewById(R$id.action_mode_close_button).setOnClickListener(new a(this, aVar));
        g gVar2 = (g) aVar.e();
        ...
        this.f829d = actionMenuView2;
        AtomicInteger atomicInteger2 = l.a;
        actionMenuView2.setBackground(null);
        addView(this.f829d, layoutParams2);
    }
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        ActionMenuView actionMenuView = this.f829d;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (View.MeasureSpec.getMode(i2) != 1073741824) {
            ...
            if (actionMenuView != null && actionMenuView.getParent() == this) {
                paddingLeft = c(this.f829d, paddingLeft, makeMeasureSpec, 0);
            }
            LinearLayout linearLayout = this.n;
