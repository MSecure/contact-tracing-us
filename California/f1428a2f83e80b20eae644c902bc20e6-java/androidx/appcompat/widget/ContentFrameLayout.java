...
public class ContentFrameLayout extends FrameLayout {
    ...
    public TypedValue f67d;

    /* renamed from: e  reason: collision with root package name */
    public TypedValue f68e;

    /* renamed from: f  reason: collision with root package name */
    public TypedValue f69f;

    /* renamed from: g  reason: collision with root package name */
    public TypedValue f70g;

    /* renamed from: h  reason: collision with root package name */
    public final Rect f71h = new Rect();
    ...
    public void onDetachedFromWindow() {
        ...
        if (aVar != null) {
            ...
            if (mVar.q != null) {
                mVar.f657f.getDecorView().removeCallbacks(mVar.r);
                if (mVar.q.isShowing()) {
                    try {
                        mVar.q.dismiss();
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (mode == Integer.MIN_VALUE) {
            TypedValue typedValue = z3 ? this.f68e : this.f67d;
                ...
                if (i8 == 5) {
                    ...
                    if (i9 > 0) {
                        ...
                        if (mode2 == Integer.MIN_VALUE) {
                            TypedValue typedValue2 = z3 ? this.f69f : this.f70g;
