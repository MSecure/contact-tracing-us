...
public class Toolbar extends ViewGroup {
    ...
    public ImageButton f82e;

    /* renamed from: f  reason: collision with root package name */
    public ImageView f83f;

    /* renamed from: g  reason: collision with root package name */
    public Drawable f84g;

    /* renamed from: h  reason: collision with root package name */
    public CharSequence f85h;

    /* renamed from: i  reason: collision with root package name */
    public ImageButton f86i;
    ...
    public class d implements m {
        ...
        public boolean f(e.b.e.i.g gVar, i iVar) {
            View view = Toolbar.this.f87j;
            if (view instanceof e.b.e.b) {
                ((e.b.e.b) view).e();
            }
            Toolbar toolbar = Toolbar.this;
            toolbar.removeView(toolbar.f87j);
            Toolbar toolbar2 = Toolbar.this;
            toolbar2.removeView(toolbar2.f86i);
        ...
        public boolean g(e.b.e.i.g gVar, i iVar) {
            Toolbar.this.c();
            ViewParent parent = Toolbar.this.f86i.getParent();
            Toolbar toolbar = Toolbar.this;
            if (parent != toolbar) {
                if (parent instanceof ViewGroup) {
                    ((ViewGroup) parent).removeView(toolbar.f86i);
                }
                Toolbar toolbar2 = Toolbar.this;
                toolbar2.addView(toolbar2.f86i);
            }
            Toolbar.this.f87j = iVar.getActionView();
            this.c = iVar;
            ViewParent parent2 = Toolbar.this.f87j.getParent();
            Toolbar toolbar3 = Toolbar.this;
            if (parent2 != toolbar3) {
                if (parent2 instanceof ViewGroup) {
                    ((ViewGroup) parent2).removeView(toolbar3.f87j);
                }
                e h2 = Toolbar.this.generateDefaultLayoutParams();
                Toolbar toolbar4 = Toolbar.this;
                h2.a = 8388611 | (toolbar4.o & 112);
                h2.b = 2;
                toolbar4.f87j.setLayoutParams(h2);
                Toolbar toolbar5 = Toolbar.this;
                toolbar5.addView(toolbar5.f87j);
            }
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i2) {
        ...
        l.q(this, context, iArr, attributeSet, q2.b, i2, 0);
        ...
        this.f84g = q2.g(R$styleable.Toolbar_collapseIcon);
        this.f85h = q2.n(R$styleable.Toolbar_collapseContentDescription);
    ...
    public void c() {
        if (this.f86i == null) {
            e.b.f.l lVar = new e.b.f.l(getContext(), null, R$attr.toolbarNavigationButtonStyle);
            this.f86i = lVar;
            lVar.setImageDrawable(this.f84g);
            this.f86i.setContentDescription(this.f85h);
            e h2 = generateDefaultLayoutParams();
            h2.a = 8388611 | (this.o & 112);
            h2.b = 2;
            this.f86i.setLayoutParams(h2);
            this.f86i.setOnClickListener(new c());
        }
    }
    ...
    public final void f() {
        if (this.b == null) {
            ...
            actionMenuView.setPopupTheme(this.f89l);
    ...
    public final void g() {
        if (this.f82e == null) {
            this.f82e = new e.b.f.l(getContext(), null, R$attr.toolbarNavigationButtonStyle);
            e h2 = generateDefaultLayoutParams();
            h2.a = 8388611 | (this.o & 112);
            this.f82e.setLayoutParams(h2);
        }
    }
    ...
    public CharSequence getCollapseContentDescription() {
        ImageButton imageButton = this.f86i;
        if (imageButton != null) {
    ...
    public int getContentInsetEnd() {
        p0 p0Var = this.u;
        if (p0Var != null) {
            return p0Var.f929g ? p0Var.a : p0Var.b;
        }
        return 0;
    }
    ...
    public int getContentInsetStart() {
        p0 p0Var = this.u;
        if (p0Var != null) {
            return p0Var.f929g ? p0Var.b : p0Var.a;
        }
        return 0;
    }
    ...
    public CharSequence getNavigationContentDescription() {
        ImageButton imageButton = this.f82e;
        if (imageButton != null) {
            return imageButton.getContentDescription();
        }
        return null;
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (u(this.f82e)) {
            ...
            if (z3) {
                ...
                i7 = paddingLeft;
                if (u(this.f86i)) {
                    ImageButton imageButton2 = this.f86i;
                    if (z3) {
                ...
                if (!u3) {
                    e eVar2 = (e) this.f81d.getLayoutParams();
                    i10 = width;
                    i9 += this.f81d.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) eVar2).topMargin + ((ViewGroup.MarginLayoutParams) eVar2).bottomMargin;
                } else {
                    i10 = width;
                }
                if (!u2 || u3) {
                    TextView textView = !u2 ? this.c : this.f81d;
                    TextView textView2 = !u3 ? this.f81d : this.c;
                    e eVar3 = (e) textView.getLayoutParams();
                    e eVar4 = (e) textView2.getLayoutParams();
                    boolean z4 = (!u2 && this.c.getMeasuredWidth() > 0) || (u3 && this.f81d.getMeasuredWidth() > 0);
                    i19 = this.x & 112;
                    i12 = paddingLeft;
                    if (i19 != 48) {
                        i20 = max;
                    ...
                    if (!z3) {
                        ...
                        if (u3) {
                            int i34 = i21 + ((ViewGroup.MarginLayoutParams) ((e) this.f81d.getLayoutParams())).topMargin;
                            this.f81d.layout(min2 - this.f81d.getMeasuredWidth(), i34, min2, this.f81d.getMeasuredHeight() + i34);
                            i25 = min2 - this.r;
                        } else {
                            i25 = min2;
                        }
                        ...
                        if (u3) {
                            int i36 = i21 + ((ViewGroup.MarginLayoutParams) ((e) this.f81d.getLayoutParams())).topMargin;
                            int measuredWidth3 = this.f81d.getMeasuredWidth() + max2;
                            this.f81d.layout(max2, i36, measuredWidth3, this.f81d.getMeasuredHeight() + i36);
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (u(this.f82e)) {
            t(this.f82e, i2, 0, i3, 0, this.p);
            i6 = l(this.f82e) + this.f82e.getMeasuredWidth();
            i5 = Math.max(0, m(this.f82e) + this.f82e.getMeasuredHeight());
            i4 = View.combineMeasuredStates(0, this.f82e.getMeasuredState());
        } else {
            i6 = 0;
            i5 = 0;
            i4 = 0;
        ...
        if (u(this.f86i)) {
            t(this.f86i, i2, 0, i3, 0, this.p);
            i6 = l(this.f86i) + this.f86i.getMeasuredWidth();
            i5 = Math.max(i5, m(this.f86i) + this.f86i.getMeasuredHeight());
            i4 = View.combineMeasuredStates(i4, this.f86i.getMeasuredState());
        }
        ...
        if (u(this.f87j)) {
            max2 += s(this.f87j, i2, max2, i3, 0, iArr);
            i5 = Math.max(i5, m(this.f87j) + this.f87j.getMeasuredHeight());
            i4 = View.combineMeasuredStates(i4, this.f87j.getMeasuredState());
        }
        if (u(this.f83f)) {
            max2 += s(this.f83f, i2, max2, i3, 0, iArr);
            i5 = Math.max(i5, m(this.f83f) + this.f83f.getMeasuredHeight());
            i4 = View.combineMeasuredStates(i4, this.f83f.getMeasuredState());
        }
        int childCount = getChildCount();
        ...
        if (u(this.f81d)) {
            i9 = Math.max(i9, s(this.f81d, i2, max2 + i14, i3, i8 + i13, iArr));
            i8 = m(this.f81d) + this.f81d.getMeasuredHeight() + i8;
            i10 = View.combineMeasuredStates(i10, this.f81d.getMeasuredState());
        }
    ...
    public void setCollapseIcon(Drawable drawable) {
        if (drawable != null) {
            c();
            this.f86i.setImageDrawable(drawable);
            return;
        }
        ImageButton imageButton = this.f86i;
        if (imageButton != null) {
            imageButton.setImageDrawable(this.f84g);
        }
    }
    ...
    public void setLogo(Drawable drawable) {
        if (drawable != null) {
            if (this.f83f == null) {
                this.f83f = new n(getContext(), null, 0);
            }
            if (!o(this.f83f)) {
                b(this.f83f, true);
            }
            ...
            if (imageView != null && o(imageView)) {
                removeView(this.f83f);
                this.F.remove(this.f83f);
            }
        }
        ImageView imageView2 = this.f83f;
        if (imageView2 != null) {
    ...
    public void setLogoDescription(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence) && this.f83f == null) {
            this.f83f = new n(getContext(), null, 0);
        }
        ImageView imageView = this.f83f;
        if (imageView != null) {
    ...
    public void setNavigationIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (imageButton != null && o(imageButton)) {
                removeView(this.f82e);
                this.F.remove(this.f82e);
            }
        }
        ImageButton imageButton2 = this.f82e;
    ...
    public void setNavigationOnClickListener(View.OnClickListener onClickListener) {
        g();
        this.f82e.setOnClickListener(onClickListener);
    }
    ...
    public void setPopupTheme(int i2) {
        if (this.f89l != i2) {
            ...
            if (i2 == 0) {
                ...
                this.f88k = new ContextThemeWrapper(getContext(), i2);
            }
        }
    }
    ...
    public void setSubtitle(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence)) {
            if (this.f81d == null) {
                ...
                this.f81d = zVar;
                zVar.setSingleLine();
                this.f81d.setEllipsize(TextUtils.TruncateAt.END);
                int i2 = this.n;
                if (i2 != 0) {
                    this.f81d.setTextAppearance(context, i2);
                }
                ColorStateList colorStateList = this.B;
                if (colorStateList != null) {
                    this.f81d.setTextColor(colorStateList);
                }
            }
            if (!o(this.f81d)) {
                b(this.f81d, true);
            ...
            TextView textView = this.f81d;
            if (textView != null && o(textView)) {
                removeView(this.f81d);
                this.F.remove(this.f81d);
            }
        }
        TextView textView2 = this.f81d;
        if (textView2 != null) {
