...
public class CoordinatorLayout extends ViewGroup implements e.i.i.g, e.i.i.h {
    ...
    public final List<View> f122d = new ArrayList();

    /* renamed from: e  reason: collision with root package name */
    public final List<View> f123e = new ArrayList();

    /* renamed from: f  reason: collision with root package name */
    public Paint f124f;

    /* renamed from: g  reason: collision with root package name */
    public final int[] f125g = new int[2];

    /* renamed from: h  reason: collision with root package name */
    public final int[] f126h = new int[2];
    ...
    public j t;
    public final e.i.i.i u = new e.i.i.i();
    ...
    public static abstract class c<V extends View> {
        ...
        /* JADX WARN: Incorrect args count in method signature: (Landroidx/coordinatorlayout/widget/CoordinatorLayout;TV;Le/i/i/v;)Le/i/i/v; */
        public v e(v vVar) {
            return vVar;
        }
    ...
    public static class f extends ViewGroup.MarginLayoutParams {
        ...
        public f(Context context, AttributeSet attributeSet) {
            ...
            this.f133f = obtainStyledAttributes.getResourceId(R$styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.f131d = obtainStyledAttributes.getInteger(R$styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.f132e = obtainStyledAttributes.getInteger(R$styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.f134g = obtainStyledAttributes.getInt(R$styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.f135h = obtainStyledAttributes.getInt(R$styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
    ...
    public static class h extends e.k.a.a {
        ...
        /* renamed from: d  reason: collision with root package name */
        public SparseArray<Parcelable> f140d;
        ...
        public h(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f140d = new SparseArray<>(readInt);
            for (int i2 = 0; i2 < readInt; i2++) {
                this.f140d.append(iArr[i2], readParcelableArray[i2]);
            }
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            SparseArray<Parcelable> sparseArray = this.f140d;
            int size = sparseArray != null ? sparseArray.size() : 0;
            parcel.writeInt(size);
            int[] iArr = new int[size];
            Parcelable[] parcelableArr = new Parcelable[size];
            for (int i3 = 0; i3 < size; i3++) {
                iArr[i3] = this.f140d.keyAt(i3);
                parcelableArr[i3] = this.f140d.valueAt(i3);
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet) {
        ...
        if (resourceId != 0) {
            ...
            this.f129k = resources.getIntArray(resourceId);
            float f2 = resources.getDisplayMetrics().density;
            int length = this.f129k.length;
            for (int i3 = 0; i3 < length; i3++) {
                int[] iArr2 = this.f129k;
    ...
    public boolean drawChild(Canvas canvas, View view, long j2) {
        ...
        if (cVar != null) {
            ...
            if (c2 > 0.0f) {
                if (this.f124f == null) {
                    this.f124f = new Paint();
                }
                this.f124f.setColor(fVar.a.b());
                Paint paint = this.f124f;
                ...
                canvas.drawRect((float) getPaddingLeft(), (float) getPaddingTop(), (float) (getWidth() - getPaddingRight()), (float) (getHeight() - getPaddingBottom()), this.f124f);
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (fVar.a(i6) && (cVar = fVar.a) != null) {
                    ...
                    i8 = i5 > 0 ? Math.max(i8, this.f125g[1]) : Math.min(i8, this.f125g[1]);
                    z2 = true;
                }
            }
        }
    ...
    public void n(View view, int i2, int i3, int i4, int i5, int i6) {
        m(view, i2, i3, i4, i5, 0, this.f126h);
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        SparseArray<Parcelable> sparseArray = hVar.f140d;
        int childCount = getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        c cVar = ((f) this.f130l.getLayoutParams()).a;
        if (cVar != null) {
            z2 = cVar.A(this, this.f130l, motionEvent);
            motionEvent2 = null;
            if (this.f130l != null) {
    ...
    public final void q(int i2) {
        ...
        while (i14 < size) {
            ...
            if (i2 == 0 && view.getVisibility() == 8) {
                ...
                i3 = i14;
                c(view, true, a3);
                if (fVar2.f134g != 0 && !a3.isEmpty()) {
                    int absoluteGravity = Gravity.getAbsoluteGravity(fVar2.f134g, layoutDirection);
                ...
                if (fVar2.f135h != 0 && view.getVisibility() == 0) {
                    ...
                    if (view.isLaidOut() && view.getWidth() > 0 && view.getHeight() > 0) {
                        ...
                        bVar2.b(a9);
                        if (!a8.isEmpty()) {
                            int absoluteGravity2 = Gravity.getAbsoluteGravity(fVar4.f135h, layoutDirection);
                            if ((absoluteGravity2 & 48) != 48 || (i9 = (a8.top - ((ViewGroup.MarginLayoutParams) fVar4).topMargin) - fVar4.f137j) >= (i10 = a2.top)) {
                                z3 = false;
                            } else {
                                x(view, i10 - i9);
                                z3 = true;
                            }
                            if ((absoluteGravity2 & 80) == 80 && (height = ((getHeight() - a8.bottom) - ((ViewGroup.MarginLayoutParams) fVar4).bottomMargin) + fVar4.f137j) < (i8 = a2.bottom)) {
                                x(view, height - i8);
                                z3 = true;
                            }
                            if (!z3) {
                            ...
                            if ((absoluteGravity2 & 3) != 3 || (i6 = (a8.left - ((ViewGroup.MarginLayoutParams) fVar4).leftMargin) - fVar4.f136i) >= (i7 = a2.left)) {
                                z4 = false;
                            } else {
                                w(view, i7 - i6);
                                z4 = true;
                            }
                            if ((absoluteGravity2 & 5) == 5 && (width = ((getWidth() - a8.right) - ((ViewGroup.MarginLayoutParams) fVar4).rightMargin) + fVar4.f136i) < (i5 = a2.right)) {
                                w(view, width - i5);
                                z4 = true;
                            }
                            if (!z4) {
    ...
    public void r(View view, int i2) {
        f fVar = (f) view.getLayoutParams();
        View view2 = fVar.f138k;
        int i3 = 0;
        if (view2 == null && fVar.f133f != -1) {
    ...
    public final void u() {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (l2.f133f == -1) {
                ...
                View findViewById = findViewById(l2.f133f);
                l2.f138k = findViewById;
            ...
            for (int i5 = 0; i5 < childCount; i5++) {
                if (i5 != i4) {
                    ...
                    if (childAt2 != l2.f139l) {
                        AtomicInteger atomicInteger = l.a;
                        int layoutDirection = getLayoutDirection();
                        int absoluteGravity = Gravity.getAbsoluteGravity(((f) childAt2.getLayoutParams()).f134g, layoutDirection);
                        if (!(absoluteGravity != 0 && (Gravity.getAbsoluteGravity(l2.f135h, layoutDirection) & absoluteGravity) == absoluteGravity) && ((cVar = l2.a) == null || !cVar.d(this, childAt, childAt2))) {
                            z2 = false;
                            if (!z2) {
                                continue;
                            } else {
        ...
        aVar3.c.clear();
        aVar3.f1384d.clear();
        int i6 = aVar3.b.f1199d;
        for (int i7 = 0; i7 < i6; i7++) {
            aVar3.b(aVar3.b.h(i7), aVar3.c, aVar3.f1384d);
        }
        list.addAll(aVar3.c);
