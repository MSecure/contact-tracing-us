...
public class NavController {
    ...
    public final boolean a() {
        ...
        while (!this.f176h.isEmpty() && (this.f176h.peekLast().c instanceof k) && f(this.f176h.peekLast().c.f1745d, true)) {
        ...
        while (descendingIterator2.hasNext()) {
            ...
            g.b bVar3 = next.f1733i;
            e.r.j jVar4 = next.c;
            if (jVar != null && jVar4.f1745d == jVar.f1745d) {
                if (bVar3 != bVar2) {
                    hashMap.put(next, bVar2);
                }
                jVar = jVar.c;
            } else if (jVar2 == null || jVar4.f1745d != jVar2.f1745d) {
                next.f1733i = g.b.CREATED;
                next.d();
            } else {
                if (bVar3 == bVar2) {
                    next.f1733i = bVar;
        ...
        while (it.hasNext()) {
            it.next().a(this, peekLast.c, peekLast.f1728d);
        }
        return true;
    }
    ...
    public final void d(e.r.j jVar, Bundle bundle, o oVar, q.a aVar) {
        ...
        if (b2 != null) {
            if (!(b2 instanceof e.r.b)) {
                while (!this.f176h.isEmpty() && (this.f176h.peekLast().c instanceof e.r.b) && f(this.f176h.peekLast().c.f1745d, true)) {
                }
            }
            if (this.f176h.isEmpty()) {
            ...
            e.r.j jVar2 = b2;
            while (jVar2 != null && b(jVar2.f1745d) == null) {
                jVar2 = jVar2.c;
                if (jVar2 != null) {
    ...
    public boolean e() {
        if (!this.f176h.isEmpty() && f(c().f1745d, true) && a()) {
            return true;
        }
        return false;
    }
    ...
    public boolean f(int i2, boolean z) {
        ...
        while (it.hasNext() && ((q) it.next()).e()) {
            ...
            removeLast.f1733i = g.b.DESTROYED;
            removeLast.d();
            e.r.g gVar = this.f178j;
            if (!(gVar == null || (remove = gVar.c.remove(removeLast.f1731g)) == null)) {
                remove.a();
            }
            z3 = true;
        }
    ...
    public void g(int i2, Bundle bundle) {
        ...
        if (parcelableArr != null) {
            for (Parcelable parcelable : parcelableArr) {
                ...
                e.r.j b2 = b(fVar.c);
                if (b2 != null) {
                    Bundle bundle4 = fVar.f1736d;
                    if (bundle4 != null) {
                        bundle4.setClassLoader(this.a.getClassLoader());
                    }
                    this.f176h.add(new e(this.a, b2, bundle4, this.f177i, this.f178j, fVar.b, fVar.f1737e));
                } else {
        ...
        if (!this.f175g && (activity = this.b) != null) {
            ...
            if (intent != null) {
                ...
                if (!(!(intArray == null || intArray.length == 0) || intent.getData() == null || (j2 = this.f172d.j(new e.r.i(intent))) == null)) {
                    ...
                    while (true) {
                        k kVar4 = jVar2.c;
                        if (kVar4 == null || kVar4.f1755k != jVar2.f1745d) {
                    ...
                    int i3 = 0;
                    while (it2.hasNext()) {
                        intArray[i3] = ((e.r.j) it2.next()).f1745d;
                        i3++;
                    }
                    bundle5.putAll(j2.c);
                }
                if (!(intArray == null || intArray.length == 0)) {
                    ...
                    while (true) {
                        ...
                        if (i4 != intArray.length - 1) {
                            while (true) {
                                kVar2 = (k) jVar;
                                if (!(kVar2.n(kVar2.f1755k) instanceof k)) {
                                    break;
                                }
                                jVar = kVar2.n(kVar2.f1755k);
                            }
                            kVar5 = kVar2;
                        }
                        i4++;
                    ...
                    if (str != null) {
                        ...
                        if (i6 != 0 && (flags & 32768) == 0) {
                            ...
                            if (component != null) {
                                ...
                                while (true) {
                                    try {
                                        Intent k0 = m.h.k0(context, component);
                                        if (k0 == null) {
                                            break;
                                        }
                            ...
                            while (i10 < intArray.length) {
                                ...
                                if (n2 != null) {
                                    if (i10 != intArray.length - 1) {
                                        while (true) {
                                            kVar = (k) n2;
                                            if (!(kVar.n(kVar.f1755k) instanceof k)) {
                                                break;
                                            }
                                            n2 = kVar.n(kVar.f1755k);
                                        }
                                        kVar6 = kVar;
                                    } else {
                                        d(n2, n2.h(bundle5), new o(false, this.f172d.f1745d, true, 0, 0, -1, -1), null);
                                    }
                                    i10++;
                                } else {
