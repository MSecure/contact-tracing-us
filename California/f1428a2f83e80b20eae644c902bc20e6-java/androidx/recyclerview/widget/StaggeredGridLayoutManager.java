...
public class StaggeredGridLayoutManager extends RecyclerView.m implements RecyclerView.x.b {
        ...
        if (!(xVar != null && xVar.f243e) || (i5 = yVar.a) == -1) {
            ...
            if (this.z == (i5 < i2)) {
                ...
                if (!(recyclerView == null && recyclerView.f202h)) {
                    this.x.f1812f = this.t.k() - i3;
                    this.x.f1813g = this.t.g() + i4;
                } else {
                    this.x.f1813g = this.t.f() + i4;
                    this.x.f1812f = -i3;
                }
                k kVar2 = this.x;
                kVar2.f1814h = false;
    ...
    public final int f1(RecyclerView.t tVar, k kVar, RecyclerView.y yVar) {
        ...
        if (this.x.f1815i) {
            i2 = kVar.f1811e == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE;
        } else {
            i2 = kVar.f1811e == 1 ? kVar.f1813g + kVar.b : kVar.f1812f - kVar.b;
        }
        B1(kVar.f1811e, i2);
        ...
        while (true) {
            int i15 = kVar.c;
            if ((i15 >= 0 && i15 < yVar.b()) && (this.x.f1815i || !this.A.isEmpty())) {
                ...
                D1(fVar, this.x.f1811e, i2);
                v1(tVar, this.x);
                if (this.x.f1814h && view.hasFocusable()) {
                    this.A.set(fVar.f276e, false);
                }
                z5 = true;
                z4 = false;
        ...
        int k4 = this.x.f1811e == -1 ? this.t.k() - n1(this.t.k()) : m1(this.t.g()) - this.t.g();
        if (k4 > 0) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:7:0x0011, code lost:
        if (r6.f1811e == -1) goto L_0x0013;
     */
    public final void v1(RecyclerView.t tVar, k kVar) {
        int min;
        int min2;
        if (kVar.a && !kVar.f1815i) {
            if (kVar.b != 0) {
                int i2 = 1;
                if (kVar.f1811e == -1) {
                    int i3 = kVar.f1812f;
                    ...
                    int i4 = i3 - k2;
                    if (i4 >= 0) {
                        min2 = kVar.f1813g - Math.min(i4, kVar.b);
                        w1(tVar, min2);
                    }
                } else {
                    int i5 = kVar.f1813g;
                    ...
                    int i6 = h2 - kVar.f1813g;
                    if (i6 >= 0) {
                        min = Math.min(i6, kVar.b) + kVar.f1812f;
                        x1(tVar, min);
                        return;
                    }
                    min = kVar.f1812f;
