...
public class SystemForegroundService extends m implements c.a {
    ...
    public final void d() {
        ...
        this.f313e = cVar;
        if (cVar.f1112k != null) {
            l.c().b(c.f1104l, "A callback already exists.", new Throwable[0]);
        } else {
            cVar.f1112k = this;
        }
    }
    ...
    public int onStartCommand(Intent intent, int i2, int i3) {
        ...
        if ("ACTION_START_FOREGROUND".equals(action)) {
            l.c().d(c.f1104l, String.format("Started foreground service %s", intent), new Throwable[0]);
            String stringExtra = intent.getStringExtra("KEY_WORKSPEC_ID");
            WorkDatabase workDatabase = cVar.c.c;
            e.b0.x.t.q.a aVar = cVar.f1105d;
            ((b) aVar).a.execute(new e.b0.x.r.b(cVar, workDatabase, stringExtra));
        } else if (!"ACTION_NOTIFY".equals(action)) {
            if ("ACTION_CANCEL_WORK".equals(action)) {
                l.c().d(c.f1104l, String.format("Stopping foreground work for %s", intent), new Throwable[0]);
                ...
                ((b) lVar.f1029d).a.execute(new e.b0.x.t.a(lVar, fromString));
                return 3;
            } else if (!"ACTION_STOP_FOREGROUND".equals(action)) {
                return 3;
            } else {
                l.c().d(c.f1104l, "Stopping foreground service", new Throwable[0]);
                c.a aVar2 = cVar.f1112k;
                if (aVar2 == null) {
                    return 3;
                }
