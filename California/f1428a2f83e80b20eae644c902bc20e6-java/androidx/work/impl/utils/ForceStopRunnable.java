                ...
                while (true) {
                    if (it.hasNext()) {
                        if (!hashSet.contains((String) it.next())) {
                            l.c().a(b.f1081f, "Reconciling jobs", new Throwable[0]);
                            z = true;
                            break;
                        }
                    } else {
        ...
        try {
            ...
            if (a != null && a.longValue() == 1) {
                ...
                if (z2) {
                    ...
                    e.b0.x.f.a(lVar2.b, lVar2.c, lVar2.f1030e);
                }
            }
            ...
            synchronized (e.b0.x.l.n) {
                lVar3.f1033h = true;
                BroadcastReceiver.PendingResult pendingResult = lVar3.f1034i;
