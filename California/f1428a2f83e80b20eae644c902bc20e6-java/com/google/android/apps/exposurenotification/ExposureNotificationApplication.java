...
public final class ExposureNotificationApplication extends g implements b.AbstractC0018b {
    ...
    public void onCreate() {
        ...
        m mVar = m.CONNECTED;
        aVar2.a = mVar;
        aVar.c.f1120j = new c(aVar2);
        f fVar = f.KEEP;
        e.b0.x.t.p.c<o.b.c> cVar = ((e.b0.x.c) tVar.c("UploadCoverTrafficWorker", fVar, (p) aVar.a())).f1006d;
        ...
        aVar4.b = true;
        aVar4.a = mVar;
        aVar3.c.f1120j = new c(aVar4);
        e.b0.a aVar5 = e.b0.a.EXPONENTIAL;
        TimeUnit timeUnit3 = TimeUnit.MILLISECONDS;
        e.b0.x.t.p.c<o.b.c> cVar2 = ((e.b0.x.c) tVar2.c("ProvideDiagnosisKeysWorker", fVar, (p) ((p.a) aVar3.d(aVar5, 30000, timeUnit3)).a())).f1006d;
        f.b.a.a.a.x.g gVar = new f.b.a.a.a.x.g(kVar);
        cVar2.a(new q(cVar2, gVar), kVar.b);
        e.b0.x.t.p.c<o.b.c> cVar3 = ((e.b0.x.c) kVar.a.c("CountryCheckingWorker", fVar, (p) new p.a(CountryCheckingWorker.class, 6, timeUnit2).a())).f1006d;
        f.b.a.a.a.x.h hVar = new f.b.a.a.a.x.h(kVar);
        cVar3.a(new q(cVar3, hVar), kVar.b);
        e.b0.x.t.p.c<o.b.c> cVar4 = ((e.b0.x.c) kVar.a.c("FirelogAnalyticsUploadWorker", fVar, (p) new p.a(FirelogAnalyticsWorker.class, FirelogAnalyticsWorker.f351h.b / 60, TimeUnit.MINUTES).a())).f1006d;
        i iVar = new i(kVar);
        ...
        if (u.b()) {
            ...
            aVar7.b = true;
            aVar7.a = mVar;
            aVar6.c.f1120j = new c(aVar7);
            e.b0.x.t.p.c<o.b.c> cVar6 = ((e.b0.x.c) tVar3.c("SubmitPrivateAnalyticsWorker", fVar, (p) ((p.a) aVar6.d(aVar5, 30000, timeUnit3)).a())).f1006d;
            j jVar = new j(kVar);
            cVar6.a(new q(cVar6, jVar), kVar.b);
            return;
        }
        String.format("Private Analytics not scheduled. isFeatureSupported=%s, isDeviceAttestationAvailable=%s", Boolean.TRUE, Boolean.valueOf(u.b()));
    }
}
