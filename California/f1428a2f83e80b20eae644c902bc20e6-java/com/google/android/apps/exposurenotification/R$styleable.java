...
public final class R$styleable {
    ...
    public static final int[] AboutLibrariesTheme = {R.attr.aboutLibrariesStyle};
    ...
    public static final int[] MaterialToolbar = {R.attr.navigationIconColor};
