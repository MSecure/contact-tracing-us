...
public final class ExposureNotificationActivity extends b0 {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            n0.b bVar = n0.b.SEEN;
            n0.b bVar2 = n0.b.DISMISSED;
            exposureHomeViewModel.d(bVar, bVar2);
            exposureHomeViewModel.c(bVar, bVar2);
        }
        ExposureNotificationViewModel exposureNotificationViewModel = (ExposureNotificationViewModel) new e.p.b0(this).a(ExposureNotificationViewModel.class);
        this.r = exposureNotificationViewModel;
        exposureNotificationViewModel.f336i.f(this, new b(this));
        if (bundle != null) {
        ...
        for (l lVar : n().N()) {
            if (lVar instanceof e0) {
                ...
                if ("com.google.android.apps.exposurenotification.ACTION_LAUNCH_FROM_EXPOSURE_NOTIFICATION".equals(intent.getAction())) {
                    ...
                    exposureNotificationViewModel.f334g.g(exposureNotificationViewModel.o.b(), n0.c.CLICKED);
                }
            }
        }
    }
