...
public final class ExposureNotificationDatabase_Impl extends ExposureNotificationDatabase {
    ...
    public class a extends h.a {
        ...
        public void b(b bVar) {
            ...
            List<g.b> list = ExposureNotificationDatabase_Impl.this.f1857h;
            if (list != null) {
                int size = list.size();
                for (int i2 = 0; i2 < size; i2++) {
                    Objects.requireNonNull(ExposureNotificationDatabase_Impl.this.f1857h.get(i2));
                }
            }
        }
        ...
        public void d(b bVar) {
            ...
            if (list != null) {
                int size = list.size();
                for (int i2 = 0; i2 < size; i2++) {
                    ExposureNotificationDatabase_Impl.this.f1857h.get(i2).a(bVar);
                }
            }
        }
