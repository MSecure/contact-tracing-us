...
public abstract class BasePendingResult<R extends i> extends f<R> {
    ...
    public final ArrayList<f.a> f415d = new ArrayList<>();

    /* renamed from: e  reason: collision with root package name */
    public final AtomicReference<Object> f416e = new AtomicReference<>();
    ...
    public static class a<R extends i> extends d {
        ...
        public void handleMessage(@RecentlyNonNull Message message) {
            ...
            if (i2 == 1) {
                ...
                ((BasePendingResult) message.obj).b(Status.f410h);
            }
        }
    }
    ...
    public final class b {
        ...
        public final void finalize() {
            BasePendingResult.e(BasePendingResult.this.f417f);
            super.finalize();
        }
    }
    ...
    public final void f(R r) {
        this.f417f = r;
        this.f418g = r.getStatus();
        this.c.countDown();
        if (this.f417f instanceof g) {
            this.mResultGuardian = new b(null);
        }
        ArrayList<f.a> arrayList = this.f415d;
