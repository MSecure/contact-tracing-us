...
public final class DynamiteModule {
    ...
    public static g f421d = null;

    /* renamed from: e  reason: collision with root package name */
    public static String f422e = null;

    /* renamed from: f  reason: collision with root package name */
    public static int f423f = -1;

    /* renamed from: g  reason: collision with root package name */
    public static final ThreadLocal<c> f424g = new ThreadLocal<>();

    /* renamed from: h  reason: collision with root package name */
    public static final b.AbstractC0003b f425h = new f.b.a.c.d.a();
    @RecentlyNonNull

    /* renamed from: i  reason: collision with root package name */
    public static final b f426i = new f.b.a.c.d.b();
    ...
    public static DynamiteModule a(@RecentlyNonNull Context context, @RecentlyNonNull b bVar, @RecentlyNonNull String str) {
        Cursor cursor;
        ThreadLocal<c> threadLocal = f424g;
        c cVar = threadLocal.get();
        c cVar2 = new c(null);
        threadLocal.set(cVar2);
        try {
            b.a a2 = bVar.a(context, str, f425h);
            int i2 = a2.a;
            int i3 = a2.b;
    ...
    public static DynamiteModule h(Context context, String str, int i2) {
        ...
        if (gVar != null) {
            ...
            synchronized (DynamiteModule.class) {
                valueOf = Boolean.valueOf(f423f >= 2);
            }
            ...
            if (query != null) {
                try {
                    if (query.moveToFirst()) {
                        ...
                        if (i2 > 0) {
                            synchronized (DynamiteModule.class) {
                                f422e = query.getString(2);
                                int columnIndex = query.getColumnIndex("loaderVersion");
                                if (columnIndex >= 0) {
                                    f423f = query.getInt(columnIndex);
                                }
                            }
                        }
                        cursor2 = query;
