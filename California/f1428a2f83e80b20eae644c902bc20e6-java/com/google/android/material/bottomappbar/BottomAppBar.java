...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.b {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        public final Rect f462e = new Rect();

        /* renamed from: f  reason: collision with root package name */
        public WeakReference<BottomAppBar> f463f;

        /* renamed from: g  reason: collision with root package name */
        public int f464g;

        /* renamed from: h  reason: collision with root package name */
        public final View.OnLayoutChangeListener f465h = new a();
        ...
        public class a implements View.OnLayoutChangeListener {
            ...
            public void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                if (Behavior.this.f463f.get() == null || !(view instanceof FloatingActionButton)) {
                    view.removeOnLayoutChangeListener(this);
                    return;
                }
                FloatingActionButton floatingActionButton = (FloatingActionButton) view;
                Behavior.this.f462e.set(0, 0, floatingActionButton.getMeasuredWidth(), floatingActionButton.getMeasuredHeight());
                throw null;
            }
        }
        ...
        public boolean k(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i2) {
            ...
            this.f463f = new WeakReference<>(bottomAppBar2);
            ...
            if (z != null) {
                ...
                if (!z.isLaidOut()) {
                    ...
                    fVar.f131d = 49;
                    this.f464g = ((ViewGroup.MarginLayoutParams) fVar).bottomMargin;
                    if (z instanceof FloatingActionButton) {
                        FloatingActionButton floatingActionButton = (FloatingActionButton) z;
                        floatingActionButton.addOnLayoutChangeListener(this.f465h);
    ...
    public static class a extends e.k.a.a {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeInt(this.f467e ? 1 : 0);
        }
    }
    ...
    private float getFabTranslationY() {
        return -getTopEdgeTreatment().f2586d;
    }
    ...
    public int A(ActionMenuView actionMenuView, int i2, boolean z) {
        ...
        return measuredWidth - ((g1 ? actionMenuView.getRight() : actionMenuView.getLeft()) + 0);
    }
    ...
    public final void D() {
        getTopEdgeTreatment().f2587e = getFabTranslationX();
        z();
        if (this.a0) {
            C();
        }
