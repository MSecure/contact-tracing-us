...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    public static class d extends e.k.a.a {
        ...
        public d(Parcel parcel, ClassLoader classLoader) {
            ...
            boolean z = false;
            this.f480f = parcel.readInt() == 1;
            this.f481g = parcel.readInt() == 1;
            this.f482h = parcel.readInt() == 1 ? true : z;
        }

        public d(Parcelable parcelable, BottomSheetBehavior<?> bottomSheetBehavior) {
            super(parcelable);
            this.f478d = bottomSheetBehavior.y;
            this.f479e = bottomSheetBehavior.f468d;
            this.f480f = bottomSheetBehavior.b;
            this.f481g = bottomSheetBehavior.v;
            this.f482h = bottomSheetBehavior.w;
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeInt(this.f480f ? 1 : 0);
    ...
    public class e implements Runnable {
        ...
        public void run() {
            ...
            if (eVar == null || !eVar.i(true)) {
                BottomSheetBehavior.this.K(this.f483d);
            } else {
                View view = this.b;
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        int i2;
        int i3;
        this.f471g = context.getResources().getDimensionPixelSize(R$dimen.mtrl_min_touch_target_size);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.BottomSheetBehavior_Layout);
        this.f472h = obtainStyledAttributes.hasValue(R$styleable.BottomSheetBehavior_Layout_shapeAppearance);
        int i4 = R$styleable.BottomSheetBehavior_Layout_backgroundTint;
        boolean hasValue = obtainStyledAttributes.hasValue(i4);
        if (hasValue) {
            D(context, attributeSet, hasValue, f.b.a.c.b.o.b.L0(context, obtainStyledAttributes, i4));
        } else {
        ...
        this.o.addUpdateListener(new f.b.a.d.f.a(this));
        ...
        this.f475k = obtainStyledAttributes.getBoolean(R$styleable.BottomSheetBehavior_Layout_gestureInsetBottomIgnored, false);
    ...
    public final int C() {
        int i2;
        return this.f469e ? Math.min(Math.max(this.f470f, this.F - ((this.E * 9) / 16)), this.D) : (this.f475k || (i2 = this.f474j) <= 0) ? this.f468d : Math.max(this.f468d, i2 + this.f471g);
    }

    public final void D(Context context, AttributeSet attributeSet, boolean z2, ColorStateList colorStateList) {
        if (this.f472h) {
            this.f476l = j.b(context, attributeSet, R$attr.bottomSheetStyle, Q).a();
            g gVar = new g(this.f476l);
            this.f473i = gVar;
            ...
            if (!z2 || colorStateList == null) {
                ...
                this.f473i.setTint(typedValue.data);
                return;
            }
            this.f473i.q(colorStateList);
        }
    }
    ...
    public final void H(V v2, b.a aVar, int i2) {
        l.p(v2, aVar, null, new f.b.a.d.f.c(this, i2));
    }
    ...
    public void I(int i2) {
        ...
        } else if (this.f469e || this.f468d != i2) {
            this.f469e = false;
            this.f468d = Math.max(0, i2);
            if (z2) {
            }
        }
        z2 = false;
    ...
    public void L(View view, int i2) {
        ...
        if (i2 == 4) {
            ...
            throw new IllegalArgumentException(f.a.a.a.a.q("Illegal state argument: ", i2));
        } else {
            i3 = this.F;
        }
        O(view, i2, i3, false);
    ...
    public final void P() {
        ...
        if (!(weakReference == null || (v2 = weakReference.get()) == null)) {
            ...
            if (this.y != 6) {
                ...
                f.b.a.d.f.c cVar = new f.b.a.d.f.c(this, 6);
                List<b.a> h2 = l.h(v2);
                int i4 = 0;
                int i5 = -1;
                while (true) {
                    ...
                    if (i4 < iArr.length && i5 == -1) {
                        ...
                        l.a(v2, new b.a(null, i5, string, cVar, null));
                    }
                }
                if (i5 != -1) {
                }
    ...
    public final void Q(int i2) {
        ...
        if (i2 != 2) {
            ...
            if (this.m != z2) {
                this.m = z2;
                if (this.f473i != null && (valueAnimator = this.o) != null) {
    ...
    public boolean k(CoordinatorLayout coordinatorLayout, V v2, int i2) {
        ...
        if (this.G == null) {
            this.f470f = coordinatorLayout.getResources().getDimensionPixelSize(R$dimen.design_bottom_sheet_peek_height_min);
            if (Build.VERSION.SDK_INT >= 29 && !this.f475k && !this.f469e) {
                l.s(v2, new f.b.a.d.q.m(new f.b.a.d.f.b(this), new p(v2.getPaddingStart(), v2.getPaddingTop(), v2.getPaddingEnd(), v2.getPaddingBottom())));
                if (v2.isAttachedToWindow()) {
            ...
            if (this.f472h && (gVar = this.f473i) != null) {
