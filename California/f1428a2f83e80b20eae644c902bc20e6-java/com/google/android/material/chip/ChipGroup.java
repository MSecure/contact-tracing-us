...
public class ChipGroup extends f.b.a.d.q.e {
    ...
    public final b f522k = new b(null);

    /* renamed from: l  reason: collision with root package name */
    public e f523l = new e(null);
    public int m = -1;
        ...
        public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
            ...
            if (!chipGroup.n) {
                ...
                if (z) {
                    ...
                    int i2 = chipGroup4.m;
                    if (!(i2 == -1 || i2 == id || !chipGroup4.f519h)) {
    ...
    public class e implements ViewGroup.OnHierarchyChangeListener {
        ...
        public void onChildViewAdded(View view, View view2) {
            if (view == ChipGroup.this && (view2 instanceof Chip)) {
                ...
                chip.setOnCheckedChangeListenerInternal(ChipGroup.this.f522k);
            }
    ...
    public ChipGroup(Context context, AttributeSet attributeSet) {
        ...
        d2.recycle();
        super.setOnHierarchyChangeListener(this.f523l);
        AtomicInteger atomicInteger = l.a;
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) b.C0035b.a(getRowCount(), this.f2679d ? getChipCount() : -1, false, this.f519h ? 1 : 2).a);
    }
    ...
    public void setOnHierarchyChangeListener(ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener) {
        this.f523l.a = onHierarchyChangeListener;
    }
