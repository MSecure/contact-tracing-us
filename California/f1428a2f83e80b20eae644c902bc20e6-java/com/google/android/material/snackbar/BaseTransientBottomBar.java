...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public final n f552d;

    /* renamed from: e  reason: collision with root package name */
    public int f553e;

    /* renamed from: f  reason: collision with root package name */
    public final Runnable f554f = new b();
    ...
    public static class Behavior extends SwipeDismissBehavior<View> {
        ...
        /* renamed from: i  reason: collision with root package name */
        public final f f561i = new f(this);

        @Override // com.google.android.material.behavior.SwipeDismissBehavior
        public boolean B(View view) {
            Objects.requireNonNull(this.f561i);
        ...
        public boolean handleMessage(Message message) {
            ...
            if (i2 == 0) {
                ...
                if (baseTransientBottomBar.c.getParent() == null) {
                    ...
                    baseTransientBottomBar.f560l = 0;
    ...
    public class b implements Runnable {
        ...
        public void run() {
            ...
            if (baseTransientBottomBar.c != null && (context = baseTransientBottomBar.b) != null) {
                ...
                if (height < baseTransientBottomBar3.f559k) {
                    ...
                    marginLayoutParams.bottomMargin = (baseTransientBottomBar4.f559k - height) + i3;
    ...
    public class c implements j {
        ...
        public v a(View view, v vVar) {
            BaseTransientBottomBar.this.f556h = vVar.a();
            BaseTransientBottomBar.this.f557i = vVar.b();
            BaseTransientBottomBar.this.f558j = vVar.c();
    ...
    public static class f {
        ...
        public f(SwipeDismissBehavior<?> swipeDismissBehavior) {
            swipeDismissBehavior.f458f = SwipeDismissBehavior.C(0.0f, 0.1f, 1.0f);
            swipeDismissBehavior.f459g = SwipeDismissBehavior.C(0.0f, 0.6f, 1.0f);
            swipeDismissBehavior.f456d = 0;
        }
    }
    ...
    public static class i extends FrameLayout {
        ...
        /* renamed from: i  reason: collision with root package name */
        public static final View.OnTouchListener f563i = new a();
        public h b;
        public g c;
        ...
        public i(Context context, AttributeSet attributeSet) {
            ...
            this.f564d = obtainStyledAttributes.getInt(R$styleable.SnackbarLayout_animationMode, 0);
            this.f565e = obtainStyledAttributes.getFloat(R$styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            ...
            this.f566f = obtainStyledAttributes.getFloat(R$styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            obtainStyledAttributes.recycle();
            setOnTouchListener(f563i);
            setFocusable(true);
            if (getBackground() == null) {
                ...
                if (this.f567g != null) {
                    ...
                    drawable.setTintList(this.f567g);
                } else {
                    drawable = m.h.v1(gradientDrawable);
                }
        ...
        public void onAttachedToWindow() {
            ...
            if (gVar != null) {
                ...
                if (Build.VERSION.SDK_INT >= 29 && (rootWindowInsets = kVar.a.c.getRootWindowInsets()) != null) {
                    kVar.a.f559k = rootWindowInsets.getMandatorySystemGestureInsets().bottom;
                    kVar.a.h();
                }
            }
            AtomicInteger atomicInteger = l.a;
        ...
        public void setOnClickListener(View.OnClickListener onClickListener) {
            setOnTouchListener(onClickListener != null ? null : f563i);
    ...
    public BaseTransientBottomBar(ViewGroup viewGroup, View view, n nVar) {
        if (viewGroup == null) {
            ...
            if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
                this.f555g = new Rect(marginLayoutParams.leftMargin, marginLayoutParams.topMargin, marginLayoutParams.rightMargin, marginLayoutParams.bottomMargin);
            }
            AtomicInteger atomicInteger = l.a;
    ...
    public final void h() {
        Rect rect;
        ViewGroup.LayoutParams layoutParams = this.c.getLayoutParams();
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams) || (rect = this.f555g) == null) {
            Log.w(q, "Unable to update margins because layout params are not MarginLayoutParams");
            return;
        }
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
        marginLayoutParams.bottomMargin = rect.bottom + this.f556h;
        marginLayoutParams.leftMargin = rect.left + this.f557i;
        marginLayoutParams.rightMargin = rect.right + this.f558j;
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (z) {
                this.c.removeCallbacks(this.f554f);
                this.c.post(this.f554f);
            }
        }
    }
}
