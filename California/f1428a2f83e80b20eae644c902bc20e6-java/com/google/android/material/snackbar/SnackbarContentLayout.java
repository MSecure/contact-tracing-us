...
public class SnackbarContentLayout extends LinearLayout implements n {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f569d = obtainStyledAttributes.getDimensionPixelSize(R$styleable.SnackbarLayout_android_maxWidth, -1);
        this.f570e = obtainStyledAttributes.getDimensionPixelSize(R$styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f569d > 0 && getMeasuredWidth() > (i4 = this.f569d)) {
        ...
        if (!z2 || this.f570e <= 0 || this.c.getMeasuredWidth() <= this.f570e) {
            if (!z2) {
