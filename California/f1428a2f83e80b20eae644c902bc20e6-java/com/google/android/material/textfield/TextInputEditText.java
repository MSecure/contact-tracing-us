...
public class TextInputEditText extends k {
    ...
    public final Rect f603e = new Rect();
    ...
    public void getFocusedRect(Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && this.f604f && rect != null) {
            textInputLayout.getFocusedRect(this.f603e);
            rect.bottom = this.f603e.bottom;
        }
    }
    ...
    public boolean getGlobalVisibleRect(Rect rect, Point point) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (!(textInputLayout == null || !this.f604f || rect == null)) {
            textInputLayout.getGlobalVisibleRect(this.f603e, point);
            rect.bottom = this.f603e.bottom;
        }
    ...
    public boolean requestRectangleOnScreen(Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && this.f604f) {
            this.f603e.set(0, textInputLayout.getHeight() - getResources().getDimensionPixelOffset(R$dimen.mtrl_edittext_rectangle_top_offset), textInputLayout.getWidth(), textInputLayout.getHeight());
            textInputLayout.requestRectangleOnScreen(this.f603e, true);
        }
