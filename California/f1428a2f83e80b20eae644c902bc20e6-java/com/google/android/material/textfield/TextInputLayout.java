...
public class TextInputLayout extends LinearLayout {
    ...
    public final LinearLayout f605d;
    public int d0 = 0;

    /* renamed from: e  reason: collision with root package name */
    public final FrameLayout f606e;
    ...
    public class c implements Runnable {
        ...
        public void run() {
            TextInputLayout.this.f607f.requestLayout();
        }
    }
    ...
    public static class e extends e.i.i.a {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final TextInputLayout f614d;

        public e(TextInputLayout textInputLayout) {
            this.f614d = textInputLayout;
        }

        @Override // e.i.i.a
        public void d(View view, e.i.i.w.b bVar) {
            this.a.onInitializeAccessibilityNodeInfo(view, bVar.a);
            EditText editText = this.f614d.getEditText();
            Editable text = editText != null ? editText.getText() : null;
            CharSequence hint = this.f614d.getHint();
            CharSequence error = this.f614d.getError();
            int counterMaxLength = this.f614d.getCounterMaxLength();
            CharSequence counterOverflowDescription = this.f614d.getCounterOverflowDescription();
    ...
    public static class h extends e.k.a.a {
        ...
        public h(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f616e = parcel.readInt() != 1 ? false : true;
            this.f617f = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel);
            this.f618g = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel);
            this.f619h = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel);
        }
        ...
        public String toString() {
            ...
            h2.append(" error=");
            h2.append((Object) this.f615d);
            h2.append(" hint=");
            h2.append((Object) this.f617f);
            h2.append(" helperText=");
            h2.append((Object) this.f618g);
            h2.append(" placeholderText=");
            h2.append((Object) this.f619h);
            h2.append("}");
            return h2.toString();
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            TextUtils.writeToParcel(this.f615d, parcel, i2);
            parcel.writeInt(this.f616e ? 1 : 0);
            TextUtils.writeToParcel(this.f617f, parcel, i2);
            TextUtils.writeToParcel(this.f618g, parcel, i2);
            TextUtils.writeToParcel(this.f619h, parcel, i2);
        }
    }
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f605d = linearLayout2;
        linearLayout2.setOrientation(0);
        linearLayout2.setLayoutParams(new FrameLayout.LayoutParams(-2, -1, 8388613));
        frameLayout.addView(linearLayout2);
        FrameLayout frameLayout2 = new FrameLayout(context2);
        this.f606e = frameLayout2;
        ...
        if (y0Var.o(i30)) {
            setErrorIconTintMode(f.b.a.c.b.o.b.v1(y0Var.j(i30, -1), null));
        }
        ...
        if (y0Var.o(i34)) {
            setStartIconTintMode(f.b.a.c.b.o.b.v1(y0Var.j(i34, -1), null));
        }
        setBoxBackgroundMode(y0Var.j(R$styleable.TextInputLayout_boxBackgroundMode, 0));
        this.f0 = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(i27, (ViewGroup) this.f606e, false);
        this.f606e.addView(this.f0);
        ...
        if (y0Var.o(i35)) {
            ...
            if (y0Var.o(i38)) {
                ...
                if (y0Var.o(i40)) {
                    setEndIconTintMode(f.b.a.c.b.o.b.v1(y0Var.j(i40, -1), null));
                }
            }
        }
        if (!y0Var.o(R$styleable.TextInputLayout_passwordToggleEnabled)) {
            ...
            if (y0Var.o(i42)) {
                attributeSet2 = null;
                setEndIconTintMode(f.b.a.c.b.o.b.v1(y0Var.j(i42, -1), null));
                ...
                this.f605d.addView(zVar2);
                this.f605d.addView(this.q0);
                this.f605d.addView(this.f606e);
    ...
    private void setEditText(EditText editText) {
        if (this.f607f == null) {
            ...
            this.E0.q(this.f607f.getTypeface());
            f.b.a.d.q.c cVar = this.E0;
            float textSize = this.f607f.getTextSize();
            if (cVar.f2675i != textSize) {
                cVar.f2675i = textSize;
                cVar.k();
            }
            int gravity = this.f607f.getGravity();
            this.E0.n((gravity & -113) | 48);
            f.b.a.d.q.c cVar2 = this.E0;
            if (cVar2.f2673g != gravity) {
                cVar2.f2673g = gravity;
                cVar2.k();
            }
            this.f607f.addTextChangedListener(new a());
            if (this.s0 == null) {
                this.s0 = this.f607f.getHintTextColors();
            }
            if (this.z) {
                if (TextUtils.isEmpty(this.A)) {
                    CharSequence hint = this.f607f.getHint();
                    this.f608g = hint;
                    setHint(hint);
                    this.f607f.setHint((CharSequence) null);
                }
                this.B = true;
            }
            if (this.f613l != null) {
                t(this.f607f.getText().length());
            }
            w();
            this.f609h.b();
            this.c.bringToFront();
            this.f605d.bringToFront();
            this.f606e.bringToFront();
    ...
    private void setErrorIconVisible(boolean z2) {
        ...
        FrameLayout frameLayout = this.f606e;
        if (z2) {
            i2 = 8;
        }
    ...
    public final void A() {
        ...
        if (this.f607f != null) {
            if (this.R.getVisibility() == 0) {
                ...
                EditText editText = this.f607f;
                AtomicInteger atomicInteger = l.a;
                i2 = editText.getPaddingStart();
            }
            TextView textView = this.w;
            int compoundPaddingTop = this.f607f.getCompoundPaddingTop();
            int compoundPaddingBottom = this.f607f.getCompoundPaddingBottom();
            AtomicInteger atomicInteger2 = l.a;
            textView.setPaddingRelative(i2, compoundPaddingTop, 0, compoundPaddingBottom);
        }
    }
        ...
        if (this.f607f != null) {
            if (!k()) {
                if (!(this.q0.getVisibility() == 0)) {
                    ...
                    int paddingTop = this.f607f.getPaddingTop();
                    int paddingBottom = this.f607f.getPaddingBottom();
                    AtomicInteger atomicInteger2 = l.a;
            ...
            int paddingTop2 = this.f607f.getPaddingTop();
            int paddingBottom2 = this.f607f.getPaddingBottom();
    ...
    public void F() {
        ...
        if (this.C != null && this.G != 0) {
            boolean z2 = false;
            boolean z3 = isFocused() || ((editText2 = this.f607f) != null && editText2.hasFocus());
            boolean z4 = isHovered() || ((editText = this.f607f) != null && editText.isHovered());
            if (!isEnabled()) {
                i2 = this.C0;
            } else {
                if (this.f609h.e()) {
                ...
                } else if (!this.f612k || (textView = this.f613l) == null) {
                ...
                if (getEndIconDelegate().d()) {
                    if (!this.f609h.e() || getEndIconDrawable() == null) {
                        d();
                    } else {
                        Drawable mutate = m.h.v1(getEndIconDrawable()).mutate();
                        mutate.setTint(this.f609h.g());
        ...
        if (gVar2 != null) {
            ...
            if (this.G == 2) {
                if (this.I > -1 && this.L != 0) {
                    ...
                    if (this.d0 == 3) {
                        this.f607f.getBackground().invalidateSelf();
                    }
                    gVar = this.D;
                    if (gVar != null) {
                        if (this.I > -1 && this.L != 0) {
    ...
    public void dispatchProvideAutofillStructure(ViewStructure viewStructure, int i2) {
        ...
        if (this.f608g != null) {
            ...
            this.f607f.setHint(this.f608g);
            try {
                super.dispatchProvideAutofillStructure(viewStructure, i2);
            } finally {
                this.f607f.setHint(hint);
                this.B = z2;
            }
        } else {
    ...
    public void drawableStateChanged() {
        ...
        if (!this.I0) {
            ...
            if (cVar != null) {
                ...
                ColorStateList colorStateList2 = cVar.f2678l;
                if ((colorStateList2 != null && colorStateList2.isStateful()) || ((colorStateList = cVar.f2677k) != null && colorStateList.isStateful())) {
                    cVar.k();
                    z3 = true;
                } else {
                    z3 = false;
    ...
    public float getBoxCornerRadiusBottomEnd() {
        ...
        return gVar.b.a.f2783h.a(gVar.h());
    }

    public float getBoxCornerRadiusBottomStart() {
        f.b.a.d.v.g gVar = this.C;
        return gVar.b.a.f2782g.a(gVar.h());
    }

    public float getBoxCornerRadiusTopEnd() {
        f.b.a.d.v.g gVar = this.C;
        return gVar.b.a.f2781f.a(gVar.h());
    }
    ...
    public CharSequence getCounterOverflowDescription() {
        TextView textView;
        if (!this.f610i || !this.f612k || (textView = this.f613l) == null) {
            return null;
        }
    ...
    public int getHelperTextCurrentTextColor() {
        TextView textView = this.f609h.r;
        if (textView != null) {
    ...
    public final int h(int i2, boolean z2) {
        int compoundPaddingLeft = this.f607f.getCompoundPaddingLeft() + i2;
    ...
    public final int i(int i2, boolean z2) {
        int compoundPaddingRight = i2 - this.f607f.getCompoundPaddingRight();
    ...
    public boolean k() {
        return this.f606e.getVisibility() == 0 && this.f0.getVisibility() == 0;
    }
    ...
    public final void m() {
        ...
        if (g()) {
            ...
            if (gravity == 17 || (gravity & 7) == 1) {
                ...
                f4 = (float) cVar.f2671e.right;
                f3 = cVar.b();
            } else {
                f2 = (float) cVar.f2671e.left;
                rectF.left = f2;
                Rect rect = cVar.f2671e;
                ...
                float f5 = cVar.f() + ((float) cVar.f2671e.top);
                rectF.bottom = f5;
                float f6 = rectF.left;
            ...
            float f52 = cVar.f() + ((float) cVar.f2671e.top);
            rectF.bottom = f52;
            ...
            if (this.z) {
                ...
                if (this.f607f != null) {
                    ...
                    if (i13 == 1) {
                        ...
                        rect2.left = this.f607f.getPaddingLeft() + rect.left;
                        rect2.top = rect.top - f();
                        i6 = rect.right - this.f607f.getPaddingRight();
                        rect2.right = i6;
                        ...
                        i9 = rect2.right;
                        i10 = rect2.bottom;
                        if (!f.b.a.d.q.c.l(cVar3.f2671e, i7, i8, i9, i10)) {
                            cVar3.f2671e.set(i7, i8, i9, i10);
                            cVar3.D = true;
                            cVar3.j();
                        }
                        ...
                        if (this.f607f == null) {
                            ...
                            textPaint.setTextSize(cVar4.f2675i);
                            textPaint.setTypeface(cVar4.t);
                            textPaint.setLetterSpacing(0.0f);
                            float f2 = -cVar4.F.ascent();
                            rect3.left = this.f607f.getCompoundPaddingLeft() + rect.left;
                            rect3.top = this.G == 1 && this.f607f.getMinLines() <= 1 ? (int) (((float) rect.centerY()) - (f2 / 2.0f)) : rect.top + this.f607f.getCompoundPaddingTop();
                            rect3.right = rect.right - this.f607f.getCompoundPaddingRight();
                            if (this.G == 1 && this.f607f.getMinLines() <= 1) {
                                z3 = true;
                            }
                            int compoundPaddingBottom = z3 ? (int) (((float) rect3.top) + f2) : rect.bottom - this.f607f.getCompoundPaddingBottom();
                            rect3.bottom = compoundPaddingBottom;
                            int i14 = rect3.left;
                            int i15 = rect3.top;
                            int i16 = rect3.right;
                            if (!f.b.a.d.q.c.l(cVar4.f2670d, i14, i15, i16, compoundPaddingBottom)) {
                                cVar4.f2670d.set(i14, i15, i16, compoundPaddingBottom);
                                cVar4.D = true;
                                cVar4.j();
                            }
                            this.E0.k();
    ...
    public void onMeasure(int i2, int i3) {
        ...
        boolean z2 = false;
        if (this.f607f != null && this.f607f.getMeasuredHeight() < (max = Math.max(this.f605d.getMeasuredHeight(), this.c.getMeasuredHeight()))) {
            this.f607f.setMinimumHeight(max);
            z2 = true;
        }
        boolean v2 = v();
        if (z2 || v2) {
            this.f607f.post(new c());
        }
        if (!(this.q == null || (editText = this.f607f) == null)) {
            this.q.setGravity(editText.getGravity());
            this.q.setPadding(this.f607f.getCompoundPaddingLeft(), this.f607f.getCompoundPaddingTop(), this.f607f.getCompoundPaddingRight(), this.f607f.getCompoundPaddingBottom());
        }
        A();
        D();
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        setHint(hVar.f617f);
        setHelperText(hVar.f618g);
        setPlaceholderText(hVar.f619h);
        requestLayout();
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        hVar.f616e = j() && this.f0.isChecked();
        hVar.f617f = getHint();
        hVar.f618g = getHelperText();
        hVar.f619h = getPlaceholderText();
        return hVar;
    }
    ...
    public void r(TextView textView, int i2) {
        ...
        if (z2) {
            m.h.c1(textView, R$style.TextAppearance_AppCompat_Caption);
    ...
    public void setCounterEnabled(boolean z2) {
        if (this.f610i != z2) {
            if (z2) {
                ...
                if (typeface != null) {
                    this.f613l.setTypeface(typeface);
                }
                this.f613l.setMaxLines(1);
                this.f609h.a(this.f613l, 2);
                ((ViewGroup.MarginLayoutParams) this.f613l.getLayoutParams()).setMarginStart(getResources().getDimensionPixelOffset(R$dimen.mtrl_textinput_counter_margin_start));
                u();
                s();
            } else {
                this.f609h.j(this.f613l, 2);
                this.f613l = null;
            }
            this.f610i = z2;
        }
    ...
    public void setError(CharSequence charSequence) {
        ...
        if (!TextUtils.isEmpty(charSequence)) {
            n nVar = this.f609h;
            nVar.c();
            nVar.f2846j = charSequence;
            nVar.f2848l.setText(charSequence);
            int i2 = nVar.f2844h;
            if (i2 != 1) {
                nVar.f2845i = 1;
            }
            nVar.l(i2, nVar.f2845i, nVar.k(nVar.f2848l, charSequence));
            return;
        }
        this.f609h.i();
    }
    ...
    public void setErrorEnabled(boolean z2) {
        ...
        if (nVar.f2847k != z2) {
            ...
            if (z2) {
                ...
                nVar.f2848l.setTextAlignment(5);
                Typeface typeface = nVar.u;
                if (typeface != null) {
                    nVar.f2848l.setTypeface(typeface);
                }
                int i2 = nVar.n;
                nVar.n = i2;
                TextView textView = nVar.f2848l;
                ...
                TextView textView2 = nVar.f2848l;
                if (!(textView2 == null || colorStateList == null)) {
                    textView2.setTextColor(colorStateList);
                }
                CharSequence charSequence = nVar.m;
                nVar.m = charSequence;
                TextView textView3 = nVar.f2848l;
                if (textView3 != null) {
                    textView3.setContentDescription(charSequence);
                }
                nVar.f2848l.setVisibility(4);
                TextView textView4 = nVar.f2848l;
                AtomicInteger atomicInteger = l.a;
                textView4.setAccessibilityLiveRegion(1);
                nVar.a(nVar.f2848l, 0);
            } else {
                nVar.i();
                nVar.j(nVar.f2848l, 0);
                nVar.f2848l = null;
                nVar.b.w();
                nVar.b.F();
            }
    ...
    public void setHelperText(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence)) {
            ...
            nVar.l(i2, nVar.f2845i, nVar.k(nVar.r, charSequence));
        } else if (this.f609h.q) {
    ...
    public void setHelperTextEnabled(boolean z2) {
        ...
        if (nVar.q != z2) {
            ...
            if (z2) {
                ...
                nVar.l(i3, nVar.f2845i, nVar.k(nVar.r, null));
                nVar.j(nVar.r, 1);
                nVar.r = null;
                nVar.b.w();
                nVar.b.F();
    ...
    public void setHintEnabled(boolean z2) {
        if (z2 != this.z) {
            ...
            if (!z2) {
                this.B = false;
                if (!TextUtils.isEmpty(this.A) && TextUtils.isEmpty(this.f607f.getHint())) {
                    this.f607f.setHint(this.A);
                }
    ...
    public void setHintTextAppearance(int i2) {
        ...
        if (colorStateList != null) {
            cVar.f2678l = colorStateList;
        }
        float f2 = bVar.f2742k;
        if (f2 != 0.0f) {
            cVar.f2676j = f2;
        }
    ...
    public void t(int i2) {
        boolean z2 = this.f612k;
        int i3 = this.f611j;
        String str = null;
        if (i3 == -1) {
            this.f613l.setText(String.valueOf(i2));
            this.f613l.setContentDescription(null);
            this.f612k = false;
        } else {
            this.f612k = i2 > i3;
            Context context = getContext();
            this.f613l.setContentDescription(context.getString(this.f612k ? R$string.character_counter_overflowed_content_description : R$string.character_counter_content_description, Integer.valueOf(i2), Integer.valueOf(this.f611j)));
            if (z2 != this.f612k) {
                u();
            }
            e.i.g.a c2 = e.i.g.a.c();
            TextView textView = this.f613l;
            String string = getContext().getString(R$string.character_counter_pattern, Integer.valueOf(i2), Integer.valueOf(this.f611j));
            e.i.g.c cVar = c2.c;
            if (string != null) {
        ...
        if (this.f607f != null && z2 != this.f612k) {
            y(false, false);
            F();
            w();
        }
    ...
    public final void u() {
        ...
        TextView textView = this.f613l;
        if (textView != null) {
            r(textView, this.f612k ? this.m : this.n);
            if (!this.f612k && (colorStateList2 = this.t) != null) {
                this.f613l.setTextColor(colorStateList2);
            }
            if (this.f612k && (colorStateList = this.u) != null) {
                this.f613l.setTextColor(colorStateList);
            }
        }
    }
    ...
    public final boolean v() {
        ...
        if (!(getStartIconDrawable() == null && this.v == null) && this.c.getMeasuredWidth() > 0) {
            int measuredWidth = this.c.getMeasuredWidth() - this.f607f.getPaddingLeft();
            ...
            Drawable[] compoundDrawablesRelative = this.f607f.getCompoundDrawablesRelative();
            Drawable drawable = compoundDrawablesRelative[0];
            Drawable drawable2 = this.W;
            if (drawable != drawable2) {
                this.f607f.setCompoundDrawablesRelative(drawable2, compoundDrawablesRelative[1], compoundDrawablesRelative[2], compoundDrawablesRelative[3]);
            }
            z2 = false;
            if ((this.q0.getVisibility() != 0 || ((j() && k()) || this.x != null)) && this.f605d.getMeasuredWidth() > 0) {
                int measuredWidth2 = this.y.getMeasuredWidth() - this.f607f.getPaddingRight();
                CheckableImageButton endIconToUpdateDummyDrawable = getEndIconToUpdateDummyDrawable();
                if (endIconToUpdateDummyDrawable != null) {
                    measuredWidth2 = ((ViewGroup.MarginLayoutParams) endIconToUpdateDummyDrawable.getLayoutParams()).getMarginStart() + endIconToUpdateDummyDrawable.getMeasuredWidth() + measuredWidth2;
                }
                Drawable[] compoundDrawablesRelative2 = this.f607f.getCompoundDrawablesRelative();
                ...
                if (drawable3 == null || this.m0 == measuredWidth2) {
                    ...
                    if (drawable4 != drawable5) {
                        ...
                        this.f607f.setCompoundDrawablesRelative(compoundDrawablesRelative2[0], compoundDrawablesRelative2[1], drawable5, compoundDrawablesRelative2[3]);
                    } else {
                        z3 = z2;
                    }
                } else {
                    ...
                    this.f607f.setCompoundDrawablesRelative(compoundDrawablesRelative2[0], compoundDrawablesRelative2[1], this.l0, compoundDrawablesRelative2[3]);
                }
            } else if (this.l0 == null) {
                return z2;
            } else {
                Drawable[] compoundDrawablesRelative3 = this.f607f.getCompoundDrawablesRelative();
                if (compoundDrawablesRelative3[2] == this.l0) {
                    this.f607f.setCompoundDrawablesRelative(compoundDrawablesRelative3[0], compoundDrawablesRelative3[1], this.n0, compoundDrawablesRelative3[3]);
                } else {
                    z3 = z2;
                }
                this.l0 = null;
        ...
        if (this.W != null) {
            Drawable[] compoundDrawablesRelative4 = this.f607f.getCompoundDrawablesRelative();
            this.f607f.setCompoundDrawablesRelative(null, compoundDrawablesRelative4[1], compoundDrawablesRelative4[2], compoundDrawablesRelative4[3]);
            this.W = null;
        }
        z2 = false;
        if ((this.q0.getVisibility() != 0 || ((j() && k()) || this.x != null)) && this.f605d.getMeasuredWidth() > 0) {
    ...
    public void w() {
        ...
        if (editText != null && this.G == 0 && (background = editText.getBackground()) != null) {
            ...
            if (this.f609h.e()) {
                currentTextColor = this.f609h.g();
            } else if (!this.f612k || (textView = this.f613l) == null) {
                m.h.t(background);
                this.f607f.refreshDrawableState();
                return;
            } else {
    ...
    public final void y(boolean z2, boolean z3) {
        ...
        EditText editText2 = this.f607f;
        boolean z5 = editText2 != null && editText2.hasFocus();
        boolean e2 = this.f609h.e();
        ColorStateList colorStateList2 = this.s0;
        if (colorStateList2 != null) {
            f.b.a.d.q.c cVar2 = this.E0;
            if (cVar2.f2678l != colorStateList2) {
                cVar2.f2678l = colorStateList2;
                cVar2.k();
            }
            f.b.a.d.q.c cVar3 = this.E0;
            ColorStateList colorStateList3 = this.s0;
            if (cVar3.f2677k != colorStateList3) {
                cVar3.f2677k = colorStateList3;
                cVar3.k();
            }
        }
        if (!isEnabled) {
            ...
            if (cVar4.f2677k != valueOf) {
                cVar4.f2677k = valueOf;
                cVar4.k();
            }
        } else if (e2) {
            f.b.a.d.q.c cVar5 = this.E0;
            TextView textView2 = this.f609h.f2848l;
            cVar5.m(textView2 != null ? textView2.getTextColors() : null);
        } else {
            if (this.f612k && (textView = this.f613l) != null) {
                cVar = this.E0;
    ...
    public void setErrorIconDrawable(Drawable drawable) {
        this.q0.setImageDrawable(drawable);
        setErrorIconVisible(drawable != null && this.f609h.f2847k);
    }
}
