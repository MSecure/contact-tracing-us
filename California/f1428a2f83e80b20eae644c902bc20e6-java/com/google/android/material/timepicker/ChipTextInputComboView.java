...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public final EditText f621d;

    /* renamed from: e  reason: collision with root package name */
    public TextWatcher f622e;
    ...
    public class b extends j {
        ...
        public void afterTextChanged(Editable editable) {
            if (TextUtils.isEmpty(editable)) {
                ...
                int i2 = ChipTextInputComboView.f620f;
                ...
                if (!TextUtils.isEmpty(editText.getText())) {
                    editText.removeTextChangedListener(chipTextInputComboView.f622e);
                    editText.setText((CharSequence) null);
                    editText.setHint(chipTextInputComboView.a("00"));
                    editText.addTextChangedListener(chipTextInputComboView.f622e);
                }
    ...
    public final void b() {
        if (Build.VERSION.SDK_INT >= 24) {
            this.f621d.setImeHintLocales(getContext().getResources().getConfiguration().getLocales());
        }
    }
    ...
    public void setChecked(boolean z) {
        this.b.setChecked(z);
        int i2 = 0;
        this.f621d.setVisibility(z ? 0 : 4);
        Chip chip = this.b;
        if (z) {
            i2 = 8;
        }
