...
public abstract class d {
    ...
    public final transient Map<String, b<?>> f641d = new HashMap();

    /* renamed from: e  reason: collision with root package name */
    public final Bundle f642e = new Bundle();
    ...
    public final boolean a(int i2, int i3, Intent intent) {
        ...
        b<?> bVar2 = this.f641d.get(str);
        if (bVar2 == null || (bVar = bVar2.a) == null) {
            this.f642e.putParcelable(str, new a(i3, intent));
            return true;
        }
    ...
    public final <I, O> c<I> b(String str, e.a.e.f.a<I, O> aVar, b<O> bVar) {
        ...
        this.f641d.put(str, new b<>(bVar, aVar));
        a aVar2 = (a) this.f642e.getParcelable(str);
        if (aVar2 != null) {
