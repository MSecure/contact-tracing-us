...
public final class f extends RecyclerView.r {
    ...
    public final LinearLayoutManager f643d;
    ...
    public f(ViewPager2 viewPager2) {
        this.b = viewPager2;
        RecyclerView recyclerView = viewPager2.f297k;
        this.c = recyclerView;
        this.f643d = (LinearLayoutManager) recyclerView.getLayoutManager();
        e();
    }
    ...
    public void a(RecyclerView recyclerView, int i2) {
        ...
        if (!(i3 == 1 && this.f645f == 1) && i2 == 1) {
            ...
            if (i4 != -1) {
                this.f647h = i4;
                this.f648i = -1;
            } else if (this.f647h == -1) {
                this.f647h = this.f643d.l1();
            }
            d(1);
            return;
        }
        if (!(i3 == 1 || i3 == 4) || i2 != 2) {
            ...
            if (this.f644e == 2 && i2 == 0 && this.f651l) {
                f();
                a aVar2 = this.f646g;
                if (aVar2.c == 0) {
                    int i8 = this.f648i;
    ...
    public void b(RecyclerView recyclerView, int i2, int i3) {
        ...
        if (this.f649j) {
            ...
            i5 = aVar3.a;
            i6 = this.f648i;
            if ((i5 != i6 || i6 == -1) && aVar3.c == 0 && this.f645f != 1) {
                d(0);
                e();
            }
            return;
    ...
    public final void d(int i2) {
        if ((this.f644e != 3 || this.f645f != 0) && this.f645f != i2) {
            this.f645f = i2;
            ViewPager2.e eVar = this.a;
            if (eVar != null) {
                eVar.a(i2);
    ...
    public final void f() {
        ...
        int i7;
        a aVar = this.f646g;
        int l1 = this.f643d.l1();
        aVar.a = l1;
        if (l1 == -1) {
            aVar.a();
            return;
        }
        View t = this.f643d.t(l1);
        if (t == null) {
            aVar.a();
            return;
        }
        Objects.requireNonNull(this.f643d);
        int i8 = ((RecyclerView.n) t.getLayoutParams()).b.left;
        Objects.requireNonNull(this.f643d);
        int i9 = ((RecyclerView.n) t.getLayoutParams()).b.right;
        Objects.requireNonNull(this.f643d);
        int i10 = ((RecyclerView.n) t.getLayoutParams()).b.top;
        Objects.requireNonNull(this.f643d);
        int i11 = ((RecyclerView.n) t.getLayoutParams()).b.bottom;
        ...
        int height = t.getHeight() + i10 + i11;
        int width = t.getWidth() + i8 + i9;
        if (this.f643d.r == 0) {
            i2 = (t.getLeft() - i8) - this.c.getPaddingLeft();
            if (this.b.a()) {
                i2 = -i2;
            }
            height = width;
        } else {
            i2 = (t.getTop() - i10) - this.c.getPaddingTop();
        }
        int i12 = -i2;
        aVar.c = i12;
        if (i12 < 0) {
            LinearLayoutManager linearLayoutManager = this.f643d;
            b bVar = new b(linearLayoutManager);
            int y2 = linearLayoutManager.y();
            if (y2 != 0) {
                boolean z4 = bVar.a.r == 0;
                int[] iArr = new int[2];
                iArr[1] = 2;
                iArr[0] = y2;
