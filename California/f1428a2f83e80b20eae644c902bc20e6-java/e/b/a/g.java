...
public class g extends r implements DialogInterface {
    ...
    public final AlertController f654d = new AlertController(getContext(), this, getWindow());
    ...
    public static class a {
        ...
        public g a() {
            ...
            AlertController alertController = gVar.f654d;
            View view = bVar.f20e;
            if (view != null) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AlertController alertController = this.f654d;
    ...
    public boolean onKeyDown(int i2, KeyEvent keyEvent) {
        NestedScrollView nestedScrollView = this.f654d.A;
