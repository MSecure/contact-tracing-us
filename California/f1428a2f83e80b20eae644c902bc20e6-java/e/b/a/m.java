...
public class m extends l implements g.a, LayoutInflater.Factory2 {
    ...
    public class c implements a.AbstractC0014a {
        ...
        public void d(e.b.e.a aVar) {
            ...
            m mVar = m.this;
            if (mVar.q != null) {
                mVar.f657f.getDecorView().removeCallbacks(m.this.r);
            }
            m mVar2 = m.this;
            if (mVar2.p != null) {
                mVar2.J();
    ...
    public abstract class f {
        ...
        public void a() {
            ...
            if (broadcastReceiver != null) {
                try {
                    m.this.f656e.unregisterReceiver(broadcastReceiver);
        ...
        public void e() {
            ...
            if (b2 != null && b2.countActions() != 0) {
                ...
                m.this.f656e.registerReceiver(this.a, b2);
            }
        }
    }
    ...
    public static class h {
        ...
        /* renamed from: e  reason: collision with root package name */
        public static Field f667e;

        /* renamed from: f  reason: collision with root package name */
        public static boolean f668f;

        /* renamed from: g  reason: collision with root package name */
        public static Field f669g;

        /* renamed from: h  reason: collision with root package name */
        public static boolean f670h;

        /* renamed from: i  reason: collision with root package name */
        public static Method f671i;

        /* renamed from: j  reason: collision with root package name */
        public static boolean f672j;

        /* renamed from: k  reason: collision with root package name */
        public static Method f673k;

        /* renamed from: l  reason: collision with root package name */
        public static boolean f674l;
        ...
        public static void A1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull IBinder iBinder, @RecentlyNonNull boolean z) {
            if (iBinder != null) {
                int H1 = H1(parcel, i2);
        ...
        public static void B1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull int[] iArr, @RecentlyNonNull boolean z) {
            if (iArr != null) {
                int H1 = H1(parcel, i2);
        ...
        public static void C1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull List<Integer> list, @RecentlyNonNull boolean z) {
            int H1 = H1(parcel, i2);
            int size = list.size();
        ...
        public static void D1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull Parcelable parcelable, @RecentlyNonNull int i3, @RecentlyNonNull boolean z) {
            if (parcelable != null) {
                int H1 = H1(parcel, i2);
        ...
        public static <T> ObjectAnimator E0(T t, Property<T, PointF> property, Path path) {
            return ObjectAnimator.ofObject(t, property, (TypeConverter) null, path);
        }

        public static void E1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull String str, @RecentlyNonNull boolean z) {
            if (str != null) {
                int H1 = H1(parcel, i2);
        ...
        public static InputConnection F0(InputConnection inputConnection, EditorInfo editorInfo, View view) {
        ...
        public static <T extends Parcelable> void F1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull T[] tArr, @RecentlyNonNull int i3, @RecentlyNonNull boolean z) {
            if (tArr != null) {
                int H1 = H1(parcel, i2);
        ...
        public static e.i.b.b.b G0(XmlPullParser xmlPullParser, Resources resources) {
            int next;
            do {
                next = xmlPullParser.next();
                if (next == 2) {
            ...
            if (next == 2) {
                ...
                if (xmlPullParser.getName().equals("font-family")) {
                    ...
                    return new e.i.b.b.e(new e.i.f.a(string, string2, string3, P0(resources, resourceId)), integer, integer2);
                }
                i1(xmlPullParser);
                return null;
            }
        ...
        public static <T extends Parcelable> void G1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull List<T> list, @RecentlyNonNull boolean z) {
            if (list != null) {
                int H1 = H1(parcel, i2);
                int size = list.size();
                parcel.writeInt(size);
        ...
        public static b.a H0(f.a.b.k kVar) {
            long j2;
            long j3;
            boolean z;
            long j4;
            ...
            long J02 = str3 != null ? J0(str3) : 0;
            String str4 = map.get("Last-Modified");
            long J03 = str4 != null ? J0(str4) : 0;
            ...
            aVar.c = J03;
            aVar.f2020f = map;
            aVar.f2021g = kVar.f2031d;
            return aVar;
        }

        public static int H1(Parcel parcel, int i2) {
        ...
        public static String I0(Map<String, String> map, String str) {
        ...
        public static void J1(Parcel parcel, int i2, int i3) {
            int U0 = U0(parcel, i2);
            if (U0 != i3) {
                String hexString = Integer.toHexString(U0);
        ...
        public static ExposureNotificationDatabase K0(s sVar, Context context) {
            ...
            if (P.f1868l == null) {
                P.f1868l = new HashSet(34);
            }
            for (int i2 = 0; i2 < 34; i2++) {
                P.f1868l.add(Integer.valueOf(iArr[i2]));
            }
            return (ExposureNotificationDatabase) P.b();
        }

        public static <T extends Parcelable> void K1(Parcel parcel, T t, int i2) {
            int dataPosition = parcel.dataPosition();
            parcel.writeInt(1);
        ...
        public static f.b.a.b.f<f.b.a.a.a.s.e> L0(f.b.a.a.a.m.t tVar, Context context) {
            f.b.a.b.f<f.b.a.a.a.s.e> a2;
            synchronized (tVar) {
                f.b.a.b.i.m.b(context);
                a2 = ((f.b.a.b.i.j) f.b.a.b.i.m.a().c(f.b.a.b.h.a.f2293g)).a("1537", f.b.a.a.a.s.e.class, new f.b.a.b.b("proto"), o.a);
            }
            return a2;
        }

        public static void L1(Parcel parcel, int i2, int i3) {
            if (i3 >= 65535) {
                parcel.writeInt(i2 | -65536);
                parcel.writeInt(i3);
                return;
        ...
        public static f.b.a.a.a.o.g M0(f.b.a.a.a.o.e eVar) {
            Objects.requireNonNull(eVar);
            f.a.b.o oVar = new f.a.b.o(new f.a.b.w.h(), new f.a.b.w.b(new f.a.b.w.e()));
            f.a.b.c cVar = oVar.f2051i;
            if (cVar != null) {
                cVar.f2025f = true;
                cVar.interrupt();
            }
            f.a.b.i[] iVarArr = oVar.f2050h;
            ...
            f.a.b.c cVar2 = new f.a.b.c(oVar.c, oVar.f2046d, oVar.f2047e, oVar.f2049g);
            oVar.f2051i = cVar2;
            cVar2.start();
            for (int i2 = 0; i2 < oVar.f2050h.length; i2++) {
                f.a.b.i iVar2 = new f.a.b.i(oVar.f2046d, oVar.f2048f, oVar.f2047e, oVar.f2049g);
                oVar.f2050h[i2] = iVar2;
                iVar2.start();
            }
            return new f.b.a.a.a.o.f(oVar);
        }

        public static void M1(Parcel parcel, int i2) {
            int dataPosition = parcel.dataPosition();
        ...
        public static f.b.a.a.a.h.s.a N0(f.b.a.a.a.h.s.b bVar) {
        ...
        @RecentlyNonNull
        public static boolean O0(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2) {
            J1(parcel, i2, 4);
            ...
            try {
                ...
                if (obtainTypedArray.getType(0) == 1) {
                    for (int i3 = 0; i3 < obtainTypedArray.length(); i3++) {
                        ...
                        if (resourceId != 0) {
                            arrayList.add(l1(resources.getStringArray(resourceId)));
                        }
                    }
                } else {
                    arrayList.add(l1(resources.getStringArray(i2)));
                }
        ...
        @RecentlyNonNull
        public static double Q0(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2) {
            J1(parcel, i2, 8);
        ...
        @RecentlyNonNull
        public static IBinder R0(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2) {
            int U0 = U0(parcel, i2);
            int dataPosition = parcel.dataPosition();
            if (U0 == 0) {
                return null;
        ...
        public static void S(String str, String str2, Throwable th) {
            Log.e(n0(str), str2, th);
        }

        @RecentlyNonNull
        public static int S0(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2) {
            J1(parcel, i2, 4);
        ...
        @RecentlyNonNull
        public static long T0(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2) {
            J1(parcel, i2, 8);
        ...
        @RecentlyNonNull
        public static int U0(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2) {
        ...
        /* JADX WARNING: Unknown variable types count: 1 */
        public static <TInput, TResult, TException extends Throwable> TResult V0(int i2, TInput tinput, f.b.a.b.h.c<TInput, TResult, TException> cVar, f.b.a.b.i.r.a<TInput, TResult> aVar) {
            TResult tresult;
            if (i2 < 1) {
        ...
        public static void a1(PopupWindow popupWindow, boolean z) {
            if (Build.VERSION.SDK_INT >= 23) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:176:0x02d1, code lost:
            if (r3[r17].f1262f.f1260d == r9) goto L_0x02d5;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:72:0x0149, code lost:
            if (r4[r2].f1262f.f1260d == r5) goto L_0x014d;
         */
        ...
        public static void b(e.g.b.h.e eVar, e.g.b.d dVar, ArrayList<e.g.b.h.d> arrayList, int i2) {
            ...
            while (i20 < i4) {
                ...
                if (!bVar2.t) {
                            ...
                            if (aVarArr[i28] == aVar4) {
                                ...
                                if (iArr[i28] == 0 || iArr[i28] == 3 || iArr[i28] == 2) {
                                    ...
                                    if (dVar15.c0 != 8 && aVarArr[i28] == aVar4 && (iArr[i28] == 0 || iArr[i28] == 3)) {
                                        ...
                                        if (bVar2.f1255h == null) {
                                            bVar2.f1255h = new ArrayList<>();
                                        }
                                        bVar2.f1255h.add(dVar15);
                                    }
                                    if (bVar2.f1253f == null) {
                                        bVar2.f1253f = dVar15;
                                    }
                                    e.g.b.h.d dVar17 = bVar2.f1254g;
                                    if (dVar17 != null) {
                                ...
                                cVar9 = dVar15.L[i23 + 1].f1262f;
                                if (cVar9 != null) {
                                    dVar14 = cVar9.f1260d;
                                    e.g.b.h.c[] cVarArr = dVar14.L;
                                    if (cVarArr[i23].f1262f != null) {
                                    }
                                }
                                dVar14 = null;
                                if (dVar14 == null) {
                    ...
                    e.g.b.h.d dVar19 = bVar2.f1251d;
                    if (dVar19 != null) {
                        bVar2.m -= dVar19.L[i23 + 1].d();
                    }
                    bVar2.c = dVar15;
                    if (bVar2.o != 0 || !bVar2.p) {
                        bVar2.f1252e = bVar2.a;
                    } else {
                        bVar2.f1252e = dVar15;
                    }
                ...
                if (arrayList3 == null || arrayList3.contains(bVar2.a)) {
                    ...
                    e.g.b.h.d dVar23 = bVar2.f1251d;
                    e.g.b.h.d dVar24 = bVar2.f1252e;
                    float f3 = bVar2.f1258k;
                    ...
                    if (i2 == 0) {
                        ...
                        if (i30 == 2) {
                            ...
                            while (!z4) {
                                ...
                                e.g.b.h.c cVar11 = cVar10.f1262f;
                                ...
                                e.g.b.h.c cVar12 = cVar10.f1262f;
                                if (cVar12 != null) {
                                    if (dVar25 == dVar22) {
                                        dVar12 = dVar20;
                                        dVar.f(cVar10.f1265i, cVar12.f1265i, d5, 6);
                                    } else {
                                        dVar12 = dVar20;
                                        dVar.f(cVar10.f1265i, cVar12.f1265i, d5, 8);
                                    }
                                    dVar.d(cVar10.f1265i, cVar10.f1262f.f1265i, d5, (!z12 || z3) ? i31 : 5);
                                } else {
                                    dVar12 = dVar20;
                                }
                                if (z10) {
                                    if (dVar25.c0 == 8 || dVar25.O[i2] != aVar4) {
                                        ...
                                        i19 = 0;
                                        dVar.f(cVarArr2[i3 + 1].f1265i, cVarArr2[i3].f1265i, 0, 5);
                                    }
                                    dVar.f(dVar25.L[i3].f1265i, eVar2.L[i3].f1265i, i19, 8);
                                }
                                e.g.b.h.c cVar13 = dVar25.L[i3 + 1].f1262f;
                                if (cVar13 != null) {
                                    dVar13 = cVar13.f1260d;
                                    e.g.b.h.c[] cVarArr3 = dVar13.L;
                                    if (cVarArr3[i3].f1262f != null) {
                                    }
                                }
                                dVar13 = null;
                                if (dVar13 != null) {
                            ...
                            if (dVar23 != null) {
                                int i32 = i3 + 1;
                                if (dVar21.L[i32].f1262f != null) {
                                    e.g.b.h.c cVar14 = dVar23.L[i32];
                                    if ((dVar23.O[i2] == aVar4 && dVar23.n[i2] == 0) && !z3) {
                                        e.g.b.h.c cVar15 = cVar14.f1262f;
                                        if (cVar15.f1260d == eVar2) {
                                            dVar.d(cVar14.f1265i, cVar15.f1265i, -cVar14.d(), 5);
                                            dVar.g(cVar14.f1265i, dVar21.L[i32].f1262f.f1265i, -cVar14.d(), 6);
                                            if (z10) {
                                                int i33 = i3 + 1;
                                                e.g.b.g gVar10 = eVar2.L[i33].f1265i;
                                                e.g.b.h.c[] cVarArr4 = dVar21.L;
                                                dVar.f(gVar10, cVarArr4[i33].f1265i, cVarArr4[i33].d(), 8);
                                            }
                                            ArrayList<e.g.b.h.d> arrayList4 = bVar2.f1255h;
                                            if (arrayList4 != null && (size = arrayList4.size()) > 1) {
                                                float f4 = (bVar2.q || bVar2.s) ? f3 : (float) bVar2.f1257j;
                                                ...
                                                while (i14 < size) {
                                                    ...
                                                    if (f6 < 0.0f) {
                                                        if (bVar2.s) {
                                                            ...
                                                            e.g.b.g gVar11 = cVarArr5[i3 + 1].f1265i;
                                                            gVar8 = cVarArr5[i3].f1265i;
                                                            aVar2 = aVar4;
                                                            gVar7 = gVar11;
                                                            i17 = 0;
                                                            i16 = 4;
                                                    ...
                                                    if (i34 == 0) {
                                                        ...
                                                        e.g.b.g gVar12 = cVarArr6[i3 + 1].f1265i;
                                                        gVar8 = cVarArr6[i3].f1265i;
                                                        aVar2 = aVar4;
                                                        gVar7 = gVar12;
                                                        i17 = 0;
                                                        i16 = 8;
                                                        ...
                                                        if (dVar26 != null) {
                                                            ...
                                                            e.g.b.g gVar13 = cVarArr7[i3].f1265i;
                                                            int i35 = i3 + 1;
                                                            e.g.b.g gVar14 = cVarArr7[i35].f1265i;
                                                            e.g.b.h.c[] cVarArr8 = dVar27.L;
                                                            arrayList2 = arrayList4;
                                                            e.g.b.g gVar15 = cVarArr8[i3].f1265i;
                                                            e.g.b.g gVar16 = cVarArr8[i35].f1265i;
                                                            i15 = size;
                                                            e.g.b.b m2 = dVar.m();
                                                            dVar11 = dVar27;
                                                            m2.b = 0.0f;
                                                            ...
                                                            float f7 = -1.0f;
                                                            if (f4 == 0.0f || f5 == f6) {
                                                                m2.f1221d.c(gVar13, 1.0f);
                                                                m2.f1221d.c(gVar14, -1.0f);
                                                                m2.f1221d.c(gVar16, 1.0f);
                                                                aVar3 = m2.f1221d;
                                                            } else {
                                                                if (f5 == 0.0f) {
                                                                    m2.f1221d.c(gVar13, 1.0f);
                                                                    ...
                                                                    m2.f1221d.c(gVar15, 1.0f);
                                                                    m2.f1221d.c(gVar16, -1.0f);
                                                                } else {
                                                                    float f8 = (f5 / f4) / (f6 / f4);
                                                                    m2.f1221d.c(gVar13, 1.0f);
                                                                    m2.f1221d.c(gVar14, -1.0f);
                                                                    m2.f1221d.c(gVar16, f8);
                                                                    aVar3 = m2.f1221d;
                                                                    f7 = -f8;
                                                                }
                                                                dVar.c(m2);
                                            ...
                                            if (dVar22 != null || (dVar22 != dVar23 && !z3)) {
                                                ...
                                                if (z2 || dVar3 == null) {
                                                    int i36 = 8;
                                                    if (z && dVar3 != null) {
                                                        int i37 = bVar2.f1257j;
                                                        boolean z13 = i37 <= 0 && bVar2.f1256i == i37;
                                                        ...
                                                        while (dVar5 != null) {
                                                            ...
                                                            if (dVar5 == dVar3 || dVar5 == dVar4 || dVar29 == null) {
                                                                ...
                                                                e.g.b.g gVar17 = cVar16.f1265i;
                                                                int i38 = i3 + 1;
                                                                e.g.b.g gVar18 = dVar28.L[i38].f1265i;
                                                                int d6 = cVar16.d();
                                                                ...
                                                                if (dVar30 != null) {
                                                                    ...
                                                                    dVar8 = dVar30;
                                                                    cVar4 = dVar4.L[i3];
                                                                    gVar3 = cVar4 != null ? cVar4.f1265i : null;
                                                                    cVar5 = dVar5.L[i38];
                                                                }
                                                                gVar4 = cVar5.f1265i;
                                                                if (cVar4 == null) {
                                                        ...
                                                        cVar3 = dVar20.L[i3].f1262f;
                                                        int i40 = i3 + 1;
                                                        e.g.b.h.c cVar18 = dVar4.L[i40];
                                                        e.g.b.h.c cVar19 = dVar21.L[i40].f1262f;
                                                        if (cVar3 != null) {
                                                            if (dVar3 != dVar4) {
                                                                dVar.d(cVar17.f1265i, cVar3.f1265i, cVar17.d(), 5);
                                                            } else if (cVar19 != null) {
                                                                dVar2 = dVar21;
                                                                i10 = 5;
                                                                dVar.b(cVar17.f1265i, cVar3.f1265i, cVar17.d(), 0.5f, cVar18.f1265i, cVar19.f1265i, cVar18.d(), 5);
                                                                if (!(cVar19 == null || dVar3 == dVar4)) {
                                                                    dVar.d(cVar18.f1265i, cVar19.f1265i, -cVar18.d(), i10);
                                                                }
                                                                if (!(!(z2 || z) || dVar3 == null || dVar3 == dVar4)) {
                                                                    ...
                                                                    i8 = i3 + 1;
                                                                    cVar2 = dVar4.L[i8];
                                                                    e.g.b.h.c cVar20 = cVar.f1262f;
                                                                    gVar = cVar20 == null ? cVar20.f1265i : null;
                                                                    e.g.b.h.c cVar21 = cVar2.f1262f;
                                                                    e.g.b.g gVar19 = cVar21 == null ? cVar21.f1265i : null;
                                                                    if (dVar2 == dVar4) {
                                                                        e.g.b.h.c cVar22 = dVar2.L[i8].f1262f;
                                                                        if (cVar22 != null) {
                                                                            gVar9 = cVar22.f1265i;
                                                                        }
                                                                        gVar2 = gVar9;
                                                                    ...
                                                                    if (!(gVar == null || gVar2 == null)) {
                                                                        dVar.b(cVar.f1265i, gVar, cVar.d(), 0.5f, gVar2, cVar2.f1265i, dVar4.L[i8].d(), 5);
                                                                    }
                                                                }
                                                            }
                                                        }
                                                        ...
                                                        i8 = i3 + 1;
                                                        cVar2 = dVar4.L[i8];
                                                        e.g.b.h.c cVar202 = cVar.f1262f;
                                                        if (cVar202 == null) {
                                                        }
                                                        e.g.b.h.c cVar212 = cVar2.f1262f;
                                                        if (cVar212 == null) {
                                                        }
                                                        if (dVar2 == dVar4) {
                                                        }
                                                    ...
                                                    int i41 = bVar2.f1257j;
                                                    boolean z14 = i41 > 0 && bVar2.f1256i == i41;
                                                    ...
                                                    for (e.g.b.h.d dVar32 = dVar31; dVar32 != null; dVar32 = dVar9) {
                                                        ...
                                                        if (dVar33 != null || dVar32 == dVar4) {
                                                            ...
                                                            e.g.b.g gVar20 = cVar23.f1265i;
                                                            e.g.b.h.c cVar24 = cVar23.f1262f;
                                                            e.g.b.g gVar21 = cVar24 != null ? cVar24.f1265i : null;
                                                            if (dVar31 != dVar32) {
                                                                cVar8 = dVar31.L[i3 + 1];
                                                            } else {
                                                                if (dVar32 == dVar3 && dVar31 == dVar32) {
                                                                    e.g.b.h.c[] cVarArr10 = dVar20.L;
                                                                    if (cVarArr10[i3].f1262f != null) {
                                                                        cVar8 = cVarArr10[i3].f1262f;
                                                                    } else {
                                                                        gVar21 = null;
                                                                    }
                                                                }
                                                                ...
                                                                if (dVar33 == null) {
                                                                    ...
                                                                    e.g.b.h.c cVar26 = dVar21.L[i42].f1262f;
                                                                    if (cVar26 != null) {
                                                                        gVar5 = cVar26.f1265i;
                                                                        cVar6 = cVar26;
                                                                    } else {
                                                ...
                                                e.g.b.h.c cVar29 = cVar27.f1262f;
                                                e.g.b.g gVar22 = cVar29 != null ? cVar29.f1265i : null;
                                                e.g.b.h.c cVar30 = cVar28.f1262f;
                                                e.g.b.g gVar23 = cVar30 != null ? cVar30.f1265i : null;
                                                ...
                                                if (gVar22 == null || gVar23 == null) {
                                                    ...
                                                    dVar3 = dVar22;
                                                    i9 = i7;
                                                    dVar.b(cVar31.f1265i, gVar22, cVar31.d(), i2 == 0 ? dVar24.Z : dVar24.a0, gVar23, cVar32.f1265i, cVar32.d(), 7);
                                                }
                                            }
                                            dVar2 = dVar21;
                                            i6 = i9;
                                            ...
                                            i8 = i3 + 1;
                                            cVar2 = dVar4.L[i8];
                                            e.g.b.h.c cVar2022 = cVar.f1262f;
                                            if (cVar2022 == null) {
                                            }
                                            e.g.b.h.c cVar2122 = cVar2.f1262f;
                                            if (cVar2122 == null) {
                                            }
                                            if (dVar2 == dVar4) {
                                            }
                                    ...
                                    if (z3) {
                                        e.g.b.h.c cVar33 = cVar14.f1262f;
                                        if (cVar33.f1260d == eVar2) {
                                            dVar.d(cVar14.f1265i, cVar33.f1265i, -cVar14.d(), 4);
                                            dVar.g(cVar14.f1265i, dVar21.L[i32].f1262f.f1265i, -cVar14.d(), 6);
                                            if (z10) {
                                            }
                                            ArrayList<e.g.b.h.d> arrayList42 = bVar2.f1255h;
                                            if (bVar2.q) {
                                            }
                                            ...
                                            e.g.b.h.c cVar192 = dVar21.L[i402].f1262f;
                                            if (cVar3 != null) {
                                            }
                                            dVar2 = dVar21;
                                            i10 = 5;
                                            dVar.d(cVar182.f1265i, cVar192.f1265i, -cVar182.d(), i10);
                                            e.g.b.h.c[] cVarArr9222 = dVar3.L;
                                            cVar = cVarArr9222[i3];
                                            i8 = i3 + 1;
                                            cVar2 = dVar4.L[i8];
                                            e.g.b.h.c cVar20222 = cVar.f1262f;
                                            if (cVar20222 == null) {
                                            }
                                            e.g.b.h.c cVar21222 = cVar2.f1262f;
                                            if (cVar21222 == null) {
                                            }
                                            if (dVar2 == dVar4) {
                                            }
                                    ...
                                    ArrayList<e.g.b.h.d> arrayList422 = bVar2.f1255h;
                                    if (bVar2.q) {
                                    }
                                    ...
                                    e.g.b.h.c cVar1922 = dVar21.L[i4022].f1262f;
                                    if (cVar3 != null) {
                                    }
                                    dVar2 = dVar21;
                                    i10 = 5;
                                    dVar.d(cVar1822.f1265i, cVar1922.f1265i, -cVar1822.d(), i10);
                                    e.g.b.h.c[] cVarArr92222 = dVar3.L;
                                    cVar = cVarArr92222[i3];
                                    i8 = i3 + 1;
                                    cVar2 = dVar4.L[i8];
                                    e.g.b.h.c cVar202222 = cVar.f1262f;
                                    if (cVar202222 == null) {
                                    }
                                    e.g.b.h.c cVar212222 = cVar2.f1262f;
                                    if (cVar212222 == null) {
                                    }
                                    if (dVar2 == dVar4) {
                                    }
                            ...
                            ArrayList<e.g.b.h.d> arrayList4222 = bVar2.f1255h;
                            if (bVar2.q) {
                            }
                            ...
                            e.g.b.h.c cVar19222 = dVar21.L[i40222].f1262f;
                            if (cVar3 != null) {
                            }
                            dVar2 = dVar21;
                            i10 = 5;
                            dVar.d(cVar18222.f1265i, cVar19222.f1265i, -cVar18222.d(), i10);
                            e.g.b.h.c[] cVarArr922222 = dVar3.L;
                            cVar = cVarArr922222[i3];
                            i8 = i3 + 1;
                            cVar2 = dVar4.L[i8];
                            e.g.b.h.c cVar2022222 = cVar.f1262f;
                            if (cVar2022222 == null) {
                            }
                            e.g.b.h.c cVar2122222 = cVar2.f1262f;
                            if (cVar2122222 == null) {
                            }
                            if (dVar2 == dVar4) {
                            }
                        ...
                        if (i44 == 2) {
                            ...
                            ArrayList<e.g.b.h.d> arrayList42222 = bVar2.f1255h;
                            if (bVar2.q) {
                            }
                            ...
                            e.g.b.h.c cVar192222 = dVar21.L[i402222].f1262f;
                            if (cVar3 != null) {
                            }
                            dVar2 = dVar21;
                            i10 = 5;
                            dVar.d(cVar182222.f1265i, cVar192222.f1265i, -cVar182222.d(), i10);
                            e.g.b.h.c[] cVarArr9222222 = dVar3.L;
                            cVar = cVarArr9222222[i3];
                            i8 = i3 + 1;
                            cVar2 = dVar4.L[i8];
                            e.g.b.h.c cVar20222222 = cVar.f1262f;
                            if (cVar20222222 == null) {
                            }
                            e.g.b.h.c cVar21222222 = cVar2.f1262f;
                    ...
                    ArrayList<e.g.b.h.d> arrayList422222 = bVar2.f1255h;
                    if (bVar2.q) {
                    }
                    ...
                    e.g.b.h.c cVar1922222 = dVar21.L[i4022222].f1262f;
                    if (cVar3 != null) {
                    }
                    dVar2 = dVar21;
                    i10 = 5;
                    dVar.d(cVar1822222.f1265i, cVar1922222.f1265i, -cVar1822222.d(), i10);
                    e.g.b.h.c[] cVarArr92222222 = dVar3.L;
                    cVar = cVarArr92222222[i3];
                    i8 = i3 + 1;
                    cVar2 = dVar4.L[i8];
                    e.g.b.h.c cVar202222222 = cVar.f1262f;
                    if (cVar202222222 == null) {
                    }
                    e.g.b.h.c cVar212222222 = cVar2.f1262f;
        ...
        public static void b1(TextView textView, e.i.g.b bVar) {
        ...
        public static void d1(Drawable drawable, int i2) {
            drawable.setTint(i2);
        }
        ...
        public static String e0(Throwable th) {
            return !(th instanceof u) ? "error_code_not_parsed" : c0((u) th).optString("error", "Call failed; network problem?");
        }

        public static void e1(Drawable drawable, ColorStateList colorStateList) {
        ...
        public static void f1(Drawable drawable, PorterDuff.Mode mode) {
        ...
        public static void g1(View view, CharSequence charSequence) {
        ...
        public static void h1(PopupWindow popupWindow, int i2) {
            if (Build.VERSION.SDK_INT >= 23) {
        ...
        public static void i1(XmlPullParser xmlPullParser) {
            int i2 = 1;
            while (i2 > 0) {
                int next = xmlPullParser.next();
                if (next == 2) {
        ...
        public static Intent j0(Activity activity) {
            ...
            try {
                String l0 = l0(activity, activity.getComponentName());
                if (l0 == null) {
                    return null;
                }
                ComponentName componentName = new ComponentName(activity, l0);
                try {
                    return l0(activity, componentName) == null ? Intent.makeMainActivity(componentName) : new Intent().setComponent(componentName);
                } catch (PackageManager.NameNotFoundException unused) {
                    Log.e("NavUtils", "getParentActivityIntent: bad parentActivityName '" + l0 + "' in manifest");
                    return null;
                }
        ...
        public static void j1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2) {
            parcel.setDataPosition(parcel.dataPosition() + U0(parcel, i2));
        }
        ...
        public static Intent k0(Context context, ComponentName componentName) {
            String l0 = l0(context, componentName);
            if (l0 == null) {
                return null;
            }
            ComponentName componentName2 = new ComponentName(componentName.getPackageName(), l0);
            return l0(context, componentName2) == null ? Intent.makeMainActivity(componentName2) : new Intent().setComponent(componentName2);
        }

        public static int k1(e.b0.s sVar) {
        ...
        public static String l0(Context context, ComponentName componentName) {
            String string;
            PackageManager packageManager = context.getPackageManager();
        ...
        public static List<byte[]> l1(String[] strArr) {
            ArrayList arrayList = new ArrayList();
        ...
        public static String m0(@RecentlyNonNull int i2) {
            switch (i2) {
                case -1:
        ...
        public static b0.b m1(String str) {
            if (str == null) {
                return null;
            }
        ...
        public static l.b.a.e n1(String str) {
            if (str == null) {
                return null;
            }
            l.b.a.e eVar = l.b.a.e.f4033e;
            return l.b.a.e.T(str, l.b.a.u.c.f4112h);
        }
        ...
        public static b0.c o1(String str) {
            if (str == null) {
                return null;
            }
        ...
        public static b0.d p1(String str) {
            if (str == null) {
                return null;
            }
        ...
        public static b0.e q1(String str) {
            if (str == null) {
                return null;
            }
        ...
        @RecentlyNonNull
        public static <ResultT> boolean r1(@RecentlyNonNull Status status, ResultT resultt, @RecentlyNonNull f.b.a.c.i.i<ResultT> iVar) {
        ...
        public static e.b0.a s0(int i2) {
            if (i2 == 0) {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public static <T extends Drawable> T s1(Drawable drawable) {
        ...
        public static e.b0.m t0(int i2) {
            if (i2 == 0) {
        ...
        public static boolean t1(d.a aVar, d.a aVar2, d.a aVar3, d.a aVar4) {
        ...
        public static e.b0.s u0(int i2) {
            if (i2 == 0) {
        ...
        @RecentlyNonNull
        public static int u1(@RecentlyNonNull Parcel parcel) {
            int readInt = parcel.readInt();
        ...
        public static boolean v0(Rect rect, Rect rect2, int i2) {
            if (i2 == 17) {
                int i3 = rect.right;
                int i4 = rect2.right;
        ...
        public static Drawable v1(Drawable drawable) {
        ...
        public static ActionMode.Callback w1(TextView textView, ActionMode.Callback callback) {
            int i2 = Build.VERSION.SDK_INT;
        ...
        public static boolean x0(f.b.a.a.a.h.s.a aVar, long j2) {
            l.b.a.q qVar = l.b.a.q.f4062g;
        ...
        public static void x1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull Bundle bundle, @RecentlyNonNull boolean z) {
            if (bundle != null) {
                int H1 = H1(parcel, i2);
        ...
        public static void y1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull byte[] bArr, @RecentlyNonNull boolean z) {
            if (bArr != null) {
                int H1 = H1(parcel, i2);
        ...
        public static e.m.a.s z0(Context context, e.m.a.l lVar, boolean z) {
            int i2;
            l.b bVar = lVar.I;
            boolean z2 = false;
            int i3 = bVar == null ? 0 : bVar.f1627d;
            int s = lVar.s();
            lVar.u0(0);
            ...
            Animation O = lVar.O();
            if (O != null) {
                return new e.m.a.s(O);
            }
            Animator P = lVar.P();
            if (P != null) {
                return new e.m.a.s(P);
            }
            if (s != 0) {
                ...
                if (equals) {
                    try {
                        ...
                        if (loadAnimation != null) {
                            return new e.m.a.s(loadAnimation);
                        }
                        z2 = true;
            ...
            return new e.m.a.s(AnimationUtils.loadAnimation(context, i2));
        }

        public static void z1(@RecentlyNonNull Parcel parcel, @RecentlyNonNull int i2, @RecentlyNonNull List<Double> list, @RecentlyNonNull boolean z) {
            int H1 = H1(parcel, i2);
            int size = list.size();
            parcel.writeInt(size);
            for (int i3 = 0; i3 < size; i3++) {
    ...
    public static final class j {
        ...
        /* renamed from: h  reason: collision with root package name */
        public e.b.e.i.g f680h;

        /* renamed from: i  reason: collision with root package name */
        public e.b.e.i.e f681i;
        ...
        public void a(e.b.e.i.g gVar) {
            e.b.e.i.e eVar;
            e.b.e.i.g gVar2 = this.f680h;
            if (gVar != gVar2) {
                if (gVar2 != null) {
                    gVar2.u(this.f681i);
                }
                this.f680h = gVar;
                if (gVar != null && (eVar = this.f681i) != null) {
                    gVar.b(eVar, gVar.a);
                }
            }
        }
    ...
    public m(Context context, Window window, k kVar, Object obj) {
        ...
        if (this.M == -100 && (orDefault = (hVar = Z).getOrDefault(this.f655d.getClass().getName(), null)) != null) {
            this.M = orDefault.intValue();
            hVar.remove(this.f655d.getClass().getName());
        }
        if (window != null) {
            C(window);
        }
    ...
    public final boolean B(boolean z2) {
        ...
        int S2 = S(this.f656e, i3);
        int i4 = Build.VERSION.SDK_INT;
        Configuration G2 = G(this.f656e, S2, null);
        boolean z7 = true;
        if (!this.P && (this.f655d instanceof Activity)) {
            PackageManager packageManager = this.f656e.getPackageManager();
            if (packageManager == null) {
                z3 = false;
                int i5 = this.f656e.getResources().getConfiguration().uiMode & 48;
                int i6 = G2.uiMode & 48;
                if (i5 != i6 && z2 && !z3 && this.I && (b0 || this.J)) {
                    Object obj4 = this.f655d;
                    if ((obj4 instanceof Activity) && !((Activity) obj4).isChild()) {
                        Activity activity = (Activity) this.f655d;
                        int i7 = e.i.a.a.b;
                        if (i4 < 28) {
                            Class<?> cls = e.i.a.e.a;
                            if (i4 >= 28) {
                                ...
                                if ((!e.i.a.e.a() || e.i.a.e.f1387f != null) && !(e.i.a.e.f1386e == null && e.i.a.e.f1385d == null)) {
                                    try {
                                        ...
                                        if (obj5 != null) {
                                            ...
                                            if (obj6 != null) {
                                                ...
                                                Handler handler = e.i.a.e.f1388g;
                                                handler.post(new e.i.a.b(aVar, obj5));
                                                try {
                                                    if (e.i.a.e.a()) {
                                                        Method method = e.i.a.e.f1387f;
                                                    ...
                                                    e.i.a.e.f1388g.post(new e.i.a.c(application, aVar));
                                                    throw th;
                                                }
                                            }
                                        }
                        ...
                        if (!z4 || i5 == i6) {
                            ...
                            Resources resources = this.f656e.getResources();
                            ...
                            int i8 = this.N;
                            if (i8 != 0) {
                                this.f656e.setTheme(i8);
                                if (i4 >= 23) {
                                    this.f656e.getTheme().applyStyle(this.N, true);
                                }
                            }
                            if (z3) {
                                Object obj7 = this.f655d;
            ...
            try {
                ActivityInfo activityInfo = packageManager.getActivityInfo(new ComponentName(this.f656e, this.f655d.getClass()), i4 >= 29 ? 269221888 : i4 >= 24 ? 786432 : 0);
        ...
        this.P = true;
        z3 = this.O;
        int i52 = this.f656e.getResources().getConfiguration().uiMode & 48;
        int i62 = G2.uiMode & 48;
        Object obj42 = this.f655d;
        Activity activity3 = (Activity) this.f655d;
        int i72 = e.i.a.a.b;
        if (i4 < 28) {
        }
        activity3.recreate();
    ...
    public void D(int i2, j jVar, Menu menu) {
        ...
        if ((jVar == null || jVar.m) && !this.L) {
            this.f658g.b.onPanelClosed(i2, menu);
        }
    }
    ...
    public void F(j jVar, boolean z2) {
        ViewGroup viewGroup;
        c0 c0Var;
        if (!z2 || jVar.a != 0 || (c0Var = this.f663l) == null || !c0Var.c()) {
            WindowManager windowManager = (WindowManager) this.f656e.getSystemService("window");
            if (!(windowManager == null || !jVar.m || (viewGroup = jVar.f677e) == null)) {
    ...
    public boolean H(KeyEvent keyEvent) {
        ...
        boolean z5 = true;
        if (((obj instanceof d.a) || (obj instanceof r)) && (decorView = this.f657f.getDecorView()) != null && e.i.i.d.a(decorView, keyEvent)) {
            return true;
        }
        if (keyEvent.getKeyCode() == 82 && this.f658g.b.dispatchKeyEvent(keyEvent)) {
            return true;
        }
        ...
        if (keyEvent.getAction() == 0) {
            ...
            j O4 = O(0);
            c0 c0Var = this.f663l;
            if (c0Var == null || !c0Var.g() || ViewConfiguration.get(this.f656e).hasPermanentMenuKey()) {
                boolean z7 = O4.m;
                if (z7 || O4.f684l) {
                    F(O4, true);
                    z3 = z7;
                    ...
                    AudioManager audioManager = (AudioManager) this.f656e.getApplicationContext().getSystemService("audio");
    ...
    public void I(int i2) {
        ...
        O2.p = true;
        O2.o = true;
        if ((i2 == 108 || i2 == 0) && this.f663l != null) {
            j O3 = O(0);
            O3.f683k = false;
            V(O3, null);
        }
    ...
    public final void K() {
        ViewGroup viewGroup;
        if (!this.t) {
            TypedArray obtainStyledAttributes = this.f656e.obtainStyledAttributes(androidx.appcompat.R$styleable.AppCompatTheme);
            ...
            if (obtainStyledAttributes.hasValue(i2)) {
                ...
                L();
                this.f657f.getDecorView();
                LayoutInflater from = LayoutInflater.from(this.f656e);
                if (this.D) {
                    ...
                    this.f656e.getTheme().resolveAttribute(androidx.appcompat.R$attr.actionBarTheme, typedValue, true);
                    viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new e.b.e.c(this.f656e, typedValue.resourceId) : this.f656e).inflate(R$layout.abc_screen_toolbar, (ViewGroup) null);
                ...
                if (viewGroup != null) {
                    ...
                    ViewGroup viewGroup2 = (ViewGroup) this.f657f.findViewById(16908290);
                    if (viewGroup2 != null) {
                    ...
                    this.f657f.setContentView(viewGroup);
                    contentFrameLayout.setAttachListener(new o(this));
                    this.u = viewGroup;
                    Object obj = this.f655d;
                    CharSequence title = obj instanceof Activity ? ((Activity) obj).getTitle() : this.f662k;
                    if (!TextUtils.isEmpty(title)) {
                        c0 c0Var2 = this.f663l;
                        if (c0Var2 != null) {
                    ...
                    TypedArray obtainStyledAttributes2 = this.f656e.obtainStyledAttributes(androidx.appcompat.R$styleable.AppCompatTheme);
    ...
    public final f N(Context context) {
        if (this.Q == null) {
            if (v.f695d == null) {
                ...
                v.f695d = new v(applicationContext, (LocationManager) applicationContext.getSystemService("location"));
            }
            this.Q = new g(v.f695d);
        }
        return this.Q;
    }
    ...
    public final void Q() {
        ...
        w wVar;
        K();
        if (this.z && this.f660i == null) {
            Object obj = this.f655d;
            if (obj instanceof Activity) {
                wVar = new w((Activity) this.f655d, this.A);
            } else {
                if (obj instanceof Dialog) {
                    wVar = new w((Dialog) this.f655d);
                }
                aVar = this.f660i;
                if (aVar == null) {
                    aVar.l(this.V);
    ...
    public final void T(j jVar, KeyEvent keyEvent) {
        ...
        if (!jVar.m && !this.L) {
            if (jVar.a == 0) {
                if ((this.f656e.getResources().getConfiguration().screenLayout & 15) == 4) {
                    return;
                }
            }
            Window.Callback P2 = P();
            if (P2 == null || P2.onMenuOpened(jVar.a, jVar.f680h)) {
                WindowManager windowManager = (WindowManager) this.f656e.getSystemService("window");
                if (windowManager != null && V(jVar, keyEvent)) {
                    ViewGroup viewGroup = jVar.f677e;
                    if (viewGroup == null || jVar.o) {
                        if (viewGroup == null) {
                            ...
                            jVar.f676d = obtainStyledAttributes.getResourceId(androidx.appcompat.R$styleable.AppCompatTheme_android_windowAnimationStyle, 0);
                            obtainStyledAttributes.recycle();
                            jVar.f677e = new i(jVar.f682j);
                            jVar.c = 81;
                        } else if (jVar.o && viewGroup.getChildCount() > 0) {
                            jVar.f677e.removeAllViews();
                        }
                        View view = jVar.f679g;
                        if (view != null) {
                            jVar.f678f = view;
                        } else {
                            if (jVar.f680h != null) {
                                ...
                                k kVar = this.n;
                                if (jVar.f681i == null) {
                                    e.b.e.i.e eVar = new e.b.e.i.e(jVar.f682j, R$layout.abc_list_menu_item_layout);
                                    jVar.f681i = eVar;
                                    eVar.f781g = kVar;
                                    e.b.e.i.g gVar = jVar.f680h;
                                    gVar.b(eVar, gVar.a);
                                }
                                e.b.e.i.e eVar2 = jVar.f681i;
                                ViewGroup viewGroup2 = jVar.f677e;
                                if (eVar2.f779e == null) {
                                    eVar2.f779e = (ExpandedMenuView) eVar2.c.inflate(R$layout.abc_expanded_menu_layout, viewGroup2, false);
                                    if (eVar2.f782h == null) {
                                        eVar2.f782h = new e.a();
                                    }
                                    eVar2.f779e.setAdapter((ListAdapter) eVar2.f782h);
                                    eVar2.f779e.setOnItemClickListener(eVar2);
                                }
                                ExpandedMenuView expandedMenuView = eVar2.f779e;
                                jVar.f678f = expandedMenuView;
                            }
                            z2 = false;
                            if (z2) {
                                if (jVar.f678f != null && (jVar.f679g != null || ((e.a) jVar.f681i.a()).getCount() > 0)) {
                                    ViewGroup.LayoutParams layoutParams2 = jVar.f678f.getLayoutParams();
                                    if (layoutParams2 == null) {
                                        layoutParams2 = new ViewGroup.LayoutParams(-2, -2);
                                    }
                                    jVar.f677e.setBackgroundResource(jVar.b);
                                    ViewParent parent = jVar.f678f.getParent();
                                    if (parent instanceof ViewGroup) {
                                        ((ViewGroup) parent).removeView(jVar.f678f);
                                    }
                                    jVar.f677e.addView(jVar.f678f, layoutParams2);
                                    if (!jVar.f678f.hasFocus()) {
                                        jVar.f678f.requestFocus();
                                    }
                                }
                            }
                            jVar.o = true;
                    ...
                    if (!(view2 == null || (layoutParams = view2.getLayoutParams()) == null || layoutParams.width != -1)) {
                        ...
                        layoutParams3.windowAnimations = jVar.f676d;
                        windowManager.addView(jVar.f677e, layoutParams3);
                        jVar.m = true;
                        return;
                    }
                    i2 = -2;
                    ...
                    layoutParams32.windowAnimations = jVar.f676d;
                    windowManager.addView(jVar.f677e, layoutParams32);
                    jVar.m = true;
                    return;
                }
                return;
    ...
    public final boolean U(j jVar, int i2, KeyEvent keyEvent, int i3) {
        ...
        if ((jVar.f683k || V(jVar, keyEvent)) && (gVar = jVar.f680h) != null) {
            z2 = gVar.performShortcut(i2, keyEvent, i3);
        }
        if (z2 && (i3 & 1) == 0 && this.f663l == null) {
            F(jVar, true);
        }
        return z2;
    }
    ...
    public final boolean V(j jVar, KeyEvent keyEvent) {
        ...
        Window.Callback P2 = P();
        if (P2 != null) {
            jVar.f679g = P2.onCreatePanelView(jVar.a);
        }
        int i2 = jVar.a;
        boolean z2 = i2 == 0 || i2 == 108;
        if (z2 && (c0Var4 = this.f663l) != null) {
            c0Var4.f();
        }
        if (jVar.f679g == null && (!z2 || !(this.f660i instanceof t))) {
            e.b.e.i.g gVar = jVar.f680h;
            if (gVar == null || jVar.p) {
                if (gVar == null) {
                    Context context = this.f656e;
                    int i3 = jVar.a;
                    if ((i3 == 0 || i3 == 108) && this.f663l != null) {
                        TypedValue typedValue = new TypedValue();
                ...
                if (z2 && (c0Var3 = this.f663l) != null) {
                    if (this.m == null) {
                        this.m = new b();
                    }
                    c0Var3.a(jVar.f680h, this.m);
                }
                jVar.f680h.z();
                if (!P2.onCreatePanelMenu(jVar.a, jVar.f680h)) {
                    jVar.a(null);
                    if (z2 && (c0Var2 = this.f663l) != null) {
            ...
            if (!P2.onPreparePanel(0, jVar.f679g, jVar.f680h)) {
                if (z2 && (c0Var = this.f663l) != null) {
                    c0Var.a(null, this.m);
                }
                jVar.f680h.y();
                return false;
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (this.p.isShown()) {
                ...
                if (i5 <= 0 || this.w != null) {
                    ...
                    View view2 = new View(this.f656e);
                    this.w = view2;
    ...
    public void b(e.b.e.i.g gVar) {
        c0 c0Var = this.f663l;
        if (c0Var == null || !c0Var.g() || (ViewConfiguration.get(this.f656e).hasPermanentMenuKey() && !this.f663l.b())) {
            j O2 = O(0);
            O2.o = true;
            F(O2, false);
            T(O2, null);
        ...
        if (this.f663l.c()) {
            this.f663l.d();
            if (!this.L) {
                P2.onPanelClosed(108, O(0).f680h);
            }
        } else if (P2 != null && !this.L) {
            if (this.S && (1 & this.T) != 0) {
                this.f657f.getDecorView().removeCallbacks(this.U);
                this.U.run();
            }
            j O3 = O(0);
            e.b.e.i.g gVar2 = O3.f680h;
            if (gVar2 != null && !O3.p && P2.onPreparePanel(0, O3.f679g, gVar2)) {
                P2.onMenuOpened(108, O3.f680h);
                this.f663l.e();
            }
        }
    }
    ...
    public <T extends View> T e(int i2) {
        K();
        return (T) this.f657f.findViewById(i2);
    }
    ...
    public MenuInflater g() {
        if (this.f661j == null) {
            Q();
            a aVar = this.f660i;
            this.f661j = new e.b.e.f(aVar != null ? aVar.e() : this.f656e);
        }
        return this.f661j;
    }
    ...
    public void k(Configuration configuration) {
        ...
        synchronized (a2) {
            n0 n0Var = a2.a;
            synchronized (n0Var) {
                e.e.e<WeakReference<Drawable.ConstantState>> eVar = n0Var.f921d.get(context);
                if (eVar != null) {
                    eVar.b();
                }
            }
    ...
    public void l(Bundle bundle) {
        ...
        if (obj instanceof Activity) {
            ...
            try {
                ...
                try {
                    str = h.l0(activity, activity.getComponentName());
                } catch (PackageManager.NameNotFoundException e2) {
                    throw new IllegalArgumentException(e2);
                }
            } catch (IllegalArgumentException unused) {
    ...
    public void m() {
        ...
        if (this.f655d instanceof Activity) {
            synchronized (l.c) {
                l.s(this);
            }
        }
        ...
        if (this.M != -100) {
            ...
            if ((obj instanceof Activity) && ((Activity) obj).isChangingConfigurations()) {
                hVar.put(this.f655d.getClass().getName(), Integer.valueOf(this.M));
                aVar = this.f660i;
                if (aVar != null) {
                    aVar.h();
                }
    ...
    public final View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        s sVar;
        if (this.Y == null) {
            String string = this.f656e.obtainStyledAttributes(androidx.appcompat.R$styleable.AppCompatTheme).getString(androidx.appcompat.R$styleable.AppCompatTheme_viewInflaterClass);
            if (string == null) {
                sVar = new s();
            } else {
                try {
    ...
    public boolean t(int i2) {
        ...
        if (i2 == 1) {
            ...
            return this.f657f.requestFeature(i2);
        } else {
            X();
            this.A = true;
            return true;
    ...
    public void u(int i2) {
        ...
        LayoutInflater.from(this.f656e).inflate(i2, viewGroup);
        this.f658g.b.onContentChanged();
    }
    ...
    public void x(Toolbar toolbar) {
        ...
        if (this.f655d instanceof Activity) {
            ...
            if (!(aVar instanceof w)) {
                ...
                if (toolbar != null) {
                    Object obj = this.f655d;
                    t tVar = new t(toolbar, obj instanceof Activity ? ((Activity) obj).getTitle() : this.f662k, this.f658g);
                    this.f660i = tVar;
                    window = this.f657f;
                    callback = tVar.c;
                } else {
    ...
    public class d extends e.b.e.h {
        ...
        public final ActionMode a(ActionMode.Callback callback) {
            ...
            e.b.e.c cVar;
            k kVar2;
            e.a aVar3 = new e.a(m.this.f656e, callback);
            m mVar = m.this;
            ...
            if (aVar5 != null) {
                ...
                mVar.o = r;
                if (!(r == null || (kVar2 = mVar.f659h) == null)) {
                    kVar2.g(r);
                }
            }
            if (mVar.o == null) {
                ...
                if (kVar3 != null && !mVar.L) {
                    ...
                    if (aVar == null) {
                        ...
                        if (mVar.p == null) {
                            if (mVar.C) {
                                TypedValue typedValue = new TypedValue();
                                Resources.Theme theme = mVar.f656e.getTheme();
                                theme.resolveAttribute(androidx.appcompat.R$attr.actionBarTheme, typedValue, true);
                                if (typedValue.resourceId != 0) {
                                    Resources.Theme newTheme = mVar.f656e.getResources().newTheme();
                                    newTheme.setTo(theme);
                                    newTheme.applyStyle(typedValue.resourceId, true);
                                    e.b.e.c cVar3 = new e.b.e.c(mVar.f656e, 0);
                        ...
                        if (mVar.p != null) {
                            ...
                            if (cVar2.c(dVar, dVar.f735i)) {
                                ...
                                if (mVar.q != null) {
                                    mVar.f657f.getDecorView().post(mVar.r);
                                }
                            } else {
                                mVar.o = null;
                            }
                    ...
                    aVar2 = mVar.o;
                    if (!(aVar2 == null || (kVar = mVar.f659h) == null)) {
                        kVar.g(aVar2);
                    }
                    mVar.o = mVar.o;
                }
        ...
        public void onProvideKeyboardShortcuts(List<KeyboardShortcutGroup> list, Menu menu, int i2) {
            e.b.e.i.g gVar = m.this.O(0).f680h;
            if (gVar != null) {
