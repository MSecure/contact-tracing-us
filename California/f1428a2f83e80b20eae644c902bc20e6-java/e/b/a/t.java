...
public class t extends a {
    ...
    public ArrayList<a.b> f691f = new ArrayList<>();

    /* renamed from: g  reason: collision with root package name */
    public final Runnable f692g = new a();

    /* renamed from: h  reason: collision with root package name */
    public final Toolbar.f f693h;
    ...
    public void c(boolean z) {
        if (z != this.f690e) {
            this.f690e = z;
            int size = this.f691f.size();
            for (int i2 = 0; i2 < size; i2++) {
                this.f691f.get(i2).a(z);
            }
        }
    }
    ...
    @Override // e.b.a.a
    public boolean f() {
        this.a.o().removeCallbacks(this.f692g);
        ViewGroup o = this.a.o();
        Runnable runnable = this.f692g;
