...
public class a extends d implements e.i.c.l.a {
    ...
    public static a g(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (name.equals("animated-selector")) {
            ...
            c cVar = aVar.q;
            cVar.f719d |= e2.getChangingConfigurations();
            cVar.f724i = e2.getBoolean(R$styleable.AnimatedStateListDrawableCompat_android_variablePadding, cVar.f724i);
            cVar.f727l = e2.getBoolean(R$styleable.AnimatedStateListDrawableCompat_android_constantSize, cVar.f727l);
