...
public class g implements e.i.d.a.a {
    ...
    public ArrayList<i> f789f;

    /* renamed from: g  reason: collision with root package name */
    public ArrayList<i> f790g;

    /* renamed from: h  reason: collision with root package name */
    public boolean f791h;

    /* renamed from: i  reason: collision with root package name */
    public ArrayList<i> f792i;

    /* renamed from: j  reason: collision with root package name */
    public ArrayList<i> f793j;
    ...
    public MenuItem a(int i2, int i3, int i4, CharSequence charSequence) {
        ...
        if (i6 >= 0) {
            ...
            if (i6 < iArr.length) {
                ...
                i iVar = new i(this, i2, i3, i4, i7, charSequence, this.f795l);
                ArrayList<i> arrayList = this.f789f;
                int size = arrayList.size();
                while (true) {
                    size--;
                    if (size >= 0) {
                        if (arrayList.get(size).f797d <= i7) {
                            i5 = size + 1;
                            break;
                        }
                    } else {
    ...
    public SubMenu addSubMenu(int i2, int i3, int i4, CharSequence charSequence) {
        ...
        iVar.o = rVar;
        rVar.setHeaderTitle(iVar.f798e);
        return rVar;
    }
    ...
    public boolean hasVisibleItems() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            if (this.f789f.get(i2).isVisible()) {
                return true;
            }
        }
        return false;
    ...
    public void i() {
        ...
        if (this.f794k) {
            ...
            if (z) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    i iVar = l2.get(i2);
                    (iVar.g() ? this.f792i : this.f793j).add(iVar);
                }
            } else {
                this.f792i.clear();
                this.f793j.clear();
    ...
    public void removeGroup(int i2) {
        ...
        while (true) {
            if (i3 >= size) {
                i3 = -1;
                break;
            } else if (this.f789f.get(i3).b == i2) {
                break;
            } else {
                i3++;
            }
        ...
        if (i3 >= 0) {
            int size2 = this.f789f.size() - i3;
            int i4 = 0;
            while (true) {
                int i5 = i4 + 1;
                if (i4 >= size2 || this.f789f.get(i3).b != i2) {
                    q(true);
                } else {
                    t(i3, false);
                    i4 = i5;
    ...
    public void removeItem(int i2) {
        ...
        while (true) {
            if (i3 >= size) {
                i3 = -1;
                break;
            } else if (this.f789f.get(i3).a == i2) {
                break;
            } else {
                i3++;
            }
    ...
    public final void t(int i2, boolean z) {
        if (i2 >= 0 && i2 < this.f789f.size()) {
            this.f789f.remove(i2);
            if (z) {
                q(true);
            }
        }
