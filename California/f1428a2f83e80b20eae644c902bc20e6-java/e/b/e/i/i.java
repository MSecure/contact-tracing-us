...
public final class i implements b {
    ...
    public int f802i = 4096;

    /* renamed from: j  reason: collision with root package name */
    public char f803j;

    /* renamed from: k  reason: collision with root package name */
    public int f804k = 4096;
    ...
    public char e() {
        return this.n.n() ? this.f803j : this.f801h;
    }
    ...
    public CharSequence getTitleCondensed() {
        CharSequence charSequence = this.f799f;
        return charSequence != null ? charSequence : this.f798e;
    }
    ...
    public MenuItem setAlphabeticShortcut(char c2) {
        ...
        this.f803j = Character.toLowerCase(c2);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setAlphabeticShortcut(char c2, int i2) {
        if (this.f803j == c2 && this.f804k == i2) {
            return this;
        }
        this.f803j = Character.toLowerCase(c2);
        this.f804k = KeyEvent.normalizeMetaState(i2);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setChecked(boolean z2) {
        if ((this.x & 4) != 0) {
            ...
            int size = gVar.f789f.size();
            gVar.z();
            for (int i2 = 0; i2 < size; i2++) {
                i iVar = gVar.f789f.get(i2);
    ...
    public MenuItem setNumericShortcut(char c2, int i2) {
        if (this.f801h == c2 && this.f802i == i2) {
            return this;
        }
        this.f801h = c2;
        this.f802i = KeyEvent.normalizeMetaState(i2);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setShortcut(char c2, char c3) {
        this.f801h = c2;
        this.f803j = Character.toLowerCase(c3);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setShortcut(char c2, char c3, int i2, int i3) {
        ...
        this.f802i = KeyEvent.normalizeMetaState(i2);
        this.f803j = Character.toLowerCase(c3);
        this.f804k = KeyEvent.normalizeMetaState(i3);
        this.n.q(false);
        return this;
    }
    ...
    public String toString() {
        CharSequence charSequence = this.f798e;
