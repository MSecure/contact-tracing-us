...
public class a1 implements d0 {
    ...
    public a1(Toolbar toolbar, boolean z) {
        ...
        if (i3 != this.o) {
            ...
            if (TextUtils.isEmpty(this.a.getNavigationContentDescription())) {
                int i4 = this.o;
                this.f851k = i4 != 0 ? q().getString(i4) : str;
                y();
            }
        }
        this.f851k = this.a.getNavigationContentDescription();
    ...
    public void m(int i2) {
        this.f846f = i2 != 0 ? e.b.b.a.a.b(q(), i2) : null;
        A();
    }
    ...
    public void setIcon(int i2) {
        this.f845e = i2 != 0 ? e.b.b.a.a.b(q(), i2) : null;
        A();
    }
    ...
    public final void y() {
        ...
        if (TextUtils.isEmpty(this.f851k)) {
            ...
            this.a.setNavigationContentDescription(this.f851k);
        }
    }
