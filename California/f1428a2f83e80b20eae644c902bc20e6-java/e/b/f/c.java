...
public class c extends e.b.e.i.b {
    ...
    public class a extends l {
        public a(Context context, r rVar, View view) {
            ...
            if (!rVar.A.g()) {
                View view2 = c.this.f862j;
                this.f811f = view2 == null ? (View) c.this.f766i : view2;
            }
            d(c.this.y);
        }
    ...
    public class RunnableC0017c implements Runnable {
        ...
        public void run() {
            g.a aVar;
            g gVar = c.this.f761d;
            if (!(gVar == null || (aVar = gVar.f788e) == null)) {
                aVar.b(gVar);
            }
            View view = (View) c.this.f766i;
    ...
    public View c(i iVar, View view, ViewGroup viewGroup) {
        ...
        if (actionView == null || iVar.f()) {
            if (view instanceof n.a) {
                ...
                aVar = (n.a) this.f762e.inflate(this.f765h, viewGroup, false);
            }
            aVar.d(iVar, 0);
            ActionMenuItemView actionMenuItemView = (ActionMenuItemView) aVar;
            actionMenuItemView.setItemInvoker((ActionMenuView) this.f766i);
            if (this.x == null) {
                this.x = new b();
            }
    ...
    public boolean d() {
        ...
        ViewGroup viewGroup = (ViewGroup) this.f766i;
        int i6 = 0;
        boolean z2 = false;
        int i7 = 0;
        int i8 = 0;
    ...
    public void e(Context context, g gVar) {
        ...
        if (this.m) {
            if (this.f862j == null) {
                ...
                this.f862j = dVar;
                if (this.f864l) {
                    dVar.setImageDrawable(this.f863k);
                    this.f863k = null;
                    this.f864l = false;
                }
                int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(0, 0);
                this.f862j.measure(makeMeasureSpec, makeMeasureSpec);
            }
            i5 -= this.f862j.getMeasuredWidth();
        } else {
            this.f862j = null;
        }
        this.p = i5;
    ...
    public void j(boolean z) {
        ...
        if (viewGroup != null) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (iVar.g()) {
                        ...
                        if (c != childAt) {
                            ...
                            ((ViewGroup) this.f766i).addView(c, i2);
                        }
                        i2++;
                    }
                }
            ...
            while (i2 < viewGroup.getChildCount()) {
                if (viewGroup.getChildAt(i2) == this.f862j) {
                    z2 = false;
                } else {
        ...
        ((View) this.f766i).requestLayout();
        g gVar2 = this.f761d;
        if (gVar2 != null) {
            gVar2.i();
            ArrayList<i> arrayList2 = gVar2.f792i;
        ...
        if (z3) {
            if (dVar == null) {
                this.f862j = new d(this.b);
            }
            ViewGroup viewGroup3 = (ViewGroup) this.f862j.getParent();
            if (viewGroup3 != this.f766i) {
                if (viewGroup3 != null) {
                    viewGroup3.removeView(this.f862j);
                }
                ActionMenuView actionMenuView = (ActionMenuView) this.f766i;
                d dVar2 = this.f862j;
                ActionMenuView.c q2 = actionMenuView.h();
                q2.a = true;
                actionMenuView.addView(dVar2, q2);
            }
        } else if (dVar != null && dVar.getParent() == (nVar = this.f766i)) {
            ((ViewGroup) nVar).removeView(this.f862j);
        }
        ((ActionMenuView) this.f766i).setOverflowReserved(this.m);
    }

    public boolean k() {
        n nVar;
        RunnableC0017c cVar = this.w;
        if (cVar == null || (nVar = this.f766i) == null) {
            e eVar = this.u;
            if (eVar == null) {
                return false;
            }
    ...
    public boolean n() {
        g gVar;
        if (!this.m || m() || (gVar = this.f761d) == null || this.f766i == null || this.w != null) {
            return false;
        }
        gVar.i();
        if (gVar.f793j.isEmpty()) {
            return false;
        }
        RunnableC0017c cVar = new RunnableC0017c(new e(this.c, this.f761d, this.f862j, true));
        this.w = cVar;
        ((View) this.f766i).post(cVar);
        return true;
    }
}
