...
public class i0 extends ViewGroup {
    ...
    public i0(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f900h = obtainStyledAttributes.getFloat(R$styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.c = obtainStyledAttributes.getInt(R$styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.f901i = obtainStyledAttributes.getBoolean(R$styleable.LinearLayoutCompat_measureWithLargestChild, false);
    ...
    public void f(Canvas canvas, int i2) {
        this.f904l.setBounds(getPaddingLeft() + this.p, i2, (getWidth() - getPaddingRight()) - this.p, this.n + i2);
        this.f904l.draw(canvas);
    }

    public void g(Canvas canvas, int i2) {
        this.f904l.setBounds(i2, getPaddingTop() + this.p, this.m + i2, (getHeight() - getPaddingBottom()) - this.p);
        this.f904l.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i3) {
            ...
            if (baseline != -1) {
                int i4 = this.f896d;
                if (this.f897e == 1 && (i2 = this.f898f & 112) != 48) {
                    if (i2 == 16) {
                        i4 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f899g) / 2;
                    } else if (i2 == 80) {
                        i4 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f899g;
                    }
                }
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (this.f897e == 1) {
            ...
            int i22 = i21 & 112;
            int i23 = 8388615 & i21;
            int paddingTop = i22 != 16 ? i22 != 80 ? getPaddingTop() : ((getPaddingTop() + i5) - i3) - this.f899g : getPaddingTop() + (((i5 - i3) - this.f899g) / 2);
            int i24 = 0;
        ...
        boolean z3 = this.b;
        int[] iArr = this.f902j;
        int[] iArr2 = this.f903k;
        AtomicInteger atomicInteger2 = l.a;
        int absoluteGravity2 = Gravity.getAbsoluteGravity(i29, getLayoutDirection());
        int paddingLeft2 = absoluteGravity2 != 1 ? absoluteGravity2 != 5 ? getPaddingLeft() : ((getPaddingLeft() + i4) - i2) - this.f899g : getPaddingLeft() + (((i4 - i2) - this.f899g) / 2);
        if (a2) {
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f897e == 1) {
            ...
            while (i45 < virtualChildCount) {
                ...
                if (childAt == null) {
                    ...
                    if (mode2 == i43 && ((LinearLayout.LayoutParams) aVar3).height == 0 && f7 > f5) {
                        int i51 = this.f899g;
                        this.f899g = Math.max(i51, ((LinearLayout.LayoutParams) aVar3).topMargin + i51 + ((LinearLayout.LayoutParams) aVar3).bottomMargin);
                        i34 = i44;
                        i33 = mode2;
                        i37 = mode;
                        ...
                        int measuredHeight = childAt.getMeasuredHeight();
                        int i52 = this.f899g;
                        this.f899g = Math.max(i52, m() + i52 + measuredHeight + ((LinearLayout.LayoutParams) aVar2).topMargin + ((LinearLayout.LayoutParams) aVar2).bottomMargin);
                        if (z9) {
            ...
            int i55 = i49;
            int i56 = i50;
            if (this.f899g > 0 && n(virtualChildCount)) {
                this.f899g += this.n;
            }
            int i57 = mode2;
            if (z9 && (i57 == Integer.MIN_VALUE || i57 == 0)) {
                ...
                while (i58 < virtualChildCount) {
                    ...
                    if (childAt2 == null) {
                        ...
                        int i59 = this.f899g;
                        this.f899g = Math.max(i59, m() + i59 + i47 + ((LinearLayout.LayoutParams) aVar4).topMargin + ((LinearLayout.LayoutParams) aVar4).bottomMargin);
                    }
                    i58++;
                }
            }
            int paddingBottom = getPaddingBottom() + getPaddingTop() + this.f899g;
            this.f899g = paddingBottom;
            int resolveSizeAndState = View.resolveSizeAndState(Math.max(paddingBottom, getSuggestedMinimumHeight()), i3, 0);
            int i60 = (16777215 & resolveSizeAndState) - this.f899g;
            if (z10 || (i60 != 0 && f6 > 0.0f)) {
                    ...
                    if (childAt3.getVisibility() == 8) {
                        ...
                        if (mode != 1073741824) {
                            ...
                            if (((LinearLayout.LayoutParams) aVar5).width == -1) {
                                ...
                                int i65 = this.f899g;
                                this.f899g = Math.max(i65, m() + childAt3.getMeasuredHeight() + i65 + ((LinearLayout.LayoutParams) aVar5).topMargin + ((LinearLayout.LayoutParams) aVar5).bottomMargin);
                                z11 = z14;
                                i60 = i29;
                            }
                        } else {
                        ...
                        int i652 = this.f899g;
                        this.f899g = Math.max(i652, m() + childAt3.getMeasuredHeight() + i652 + ((LinearLayout.LayoutParams) aVar5).topMargin + ((LinearLayout.LayoutParams) aVar5).bottomMargin);
                        z11 = z14;
                        i60 = i29;
                    }
                    i61++;
                ...
                this.f899g = getPaddingBottom() + getPaddingTop() + this.f899g;
            } else {
        ...
        if (this.f902j == null || this.f903k == null) {
            this.f902j = new int[4];
            this.f903k = new int[4];
        }
        int[] iArr = this.f902j;
        int[] iArr2 = this.f903k;
        iArr[3] = -1;
            ...
            if (childAt6 == null) {
                ...
                if (childAt6.getVisibility() == 8) {
                    ...
                    if (mode3 == 1073741824 && ((LinearLayout.LayoutParams) aVar7).width == 0 && f11 > 0.0f) {
                        if (z17) {
                            i27 = i71;
                            this.f899g = ((LinearLayout.LayoutParams) aVar7).leftMargin + ((LinearLayout.LayoutParams) aVar7).rightMargin + this.f899g;
                        } else {
                            i27 = i71;
                            int i75 = this.f899g;
                            this.f899g = Math.max(i75, ((LinearLayout.LayoutParams) aVar7).leftMargin + i75 + ((LinearLayout.LayoutParams) aVar7).rightMargin);
                        }
                        if (z15) {
                        ...
                        if (((LinearLayout.LayoutParams) aVar7).width == 0) {
                            ...
                            if (f11 > 0.0f) {
                                ...
                                z3 = z16;
                                z2 = z15;
                                o(childAt6, i2, f12 != f4 ? this.f899g : 0, i3, 0);
                                ...
                                int i78 = this.f899g;
                                if (!z17) {
                                    this.f899g = m() + ((LinearLayout.LayoutParams) aVar).leftMargin + measuredWidth3 + ((LinearLayout.LayoutParams) aVar).rightMargin + i78;
                                } else {
                                    this.f899g = Math.max(i78, m() + i78 + measuredWidth3 + ((LinearLayout.LayoutParams) aVar).leftMargin + ((LinearLayout.LayoutParams) aVar).rightMargin);
                                }
                                if (z3) {
        ...
        int i79 = i70;
        if (this.f899g > 0 && n(virtualChildCount2)) {
            this.f899g += this.m;
        }
                ...
                if (z16 && (mode3 == Integer.MIN_VALUE || mode3 == 0)) {
                    ...
                    while (i17 < virtualChildCount2) {
                        ...
                        if (childAt7 == null) {
                            ...
                            int i80 = this.f899g;
                            this.f899g = z17 ? m() + ((LinearLayout.LayoutParams) aVar8).leftMargin + i72 + ((LinearLayout.LayoutParams) aVar8).rightMargin + i80 : Math.max(i80, m() + i80 + i72 + ((LinearLayout.LayoutParams) aVar8).leftMargin + ((LinearLayout.LayoutParams) aVar8).rightMargin);
                        }
                        i17++;
                    }
                }
                int paddingRight = getPaddingRight() + getPaddingLeft() + this.f899g;
                this.f899g = paddingRight;
                int resolveSizeAndState2 = View.resolveSizeAndState(Math.max(paddingRight, getSuggestedMinimumWidth()), i2, 0);
                i5 = (16777215 & resolveSizeAndState2) - this.f899g;
                if (!z18 || (i5 != 0 && f10 > 0.0f)) {
                    ...
                    while (i9 < virtualChildCount2) {
                        ...
                        if (childAt8 == null || childAt8.getVisibility() == 8) {
                            ...
                            if (z17) {
                                f3 = f10;
                                i14 = m() + childAt8.getMeasuredWidth() + ((LinearLayout.LayoutParams) aVar9).leftMargin + ((LinearLayout.LayoutParams) aVar9).rightMargin + this.f899g;
                                i13 = i12;
                            } else {
                                f3 = f10;
                                int i85 = this.f899g;
                    ...
                    this.f899g = getPaddingRight() + getPaddingLeft() + this.f899g;
                    if (iArr[1] != -1 && iArr[0] == -1 && iArr[2] == -1) {
                        c2 = 3;
                        if (iArr[3] == -1) {
                            i74 = i82;
        ...
        int paddingRight2 = getPaddingRight() + getPaddingLeft() + this.f899g;
        this.f899g = paddingRight2;
        int resolveSizeAndState22 = View.resolveSizeAndState(Math.max(paddingRight2, getSuggestedMinimumWidth()), i2, 0);
        i5 = (16777215 & resolveSizeAndState22) - this.f899g;
        if (!z18) {
        }
        f2 = this.f900h;
        if (f2 > 0.0f) {
    ...
    public void setVerticalGravity(int i2) {
        ...
        int i4 = this.f898f;
        if ((i4 & 112) != i3) {
            this.f898f = i3 | (i4 & -113);
            requestLayout();
        }
    }

    public void setWeightSum(float f2) {
        this.f900h = Math.max(0.0f, f2);
    }
