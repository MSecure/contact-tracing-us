...
public class k0 implements p {
    ...
    public class e implements Runnable {
        ...
        public void run() {
            ...
            if (f0Var != null) {
                ...
                if (f0Var.isAttachedToWindow() && k0.this.f909d.getCount() > k0.this.f909d.getChildCount()) {
                    int childCount = k0.this.f909d.getChildCount();
                    k0 k0Var = k0.this;
    ...
    public k0(Context context, AttributeSet attributeSet, int i2, int i3) {
        ...
        this.f912g = obtainStyledAttributes.getDimensionPixelOffset(R$styleable.ListPopupWindow_android_dropDownHorizontalOffset, 0);
    ...
    public void a() {
        ...
        if (this.f909d == null) {
            ...
            this.f909d.setOnItemClickListener(this.r);
            this.f909d.setFocusable(true);
            this.f909d.setFocusableInTouchMode(true);
            this.f909d.setOnItemSelectedListener(new j0(this));
            this.f909d.setOnScrollListener(this.u);
            this.A.setContentView(this.f909d);
        } else {
        ...
        if (this.f910e == -1) {
            ...
            int a2 = this.f909d.a(View.MeasureSpec.makeMeasureSpec(i10, i5), i3 - 0, -1);
            i4 = a2 + (a2 > 0 ? this.f909d.getPaddingBottom() + this.f909d.getPaddingTop() + i2 + 0 : 0);
        }
        boolean z3 = this.A.getInputMethodMode() == 2;
        m.h.h1(this.A, this.f914i);
        if (this.A.isShowing()) {
            View view2 = this.q;
            AtomicInteger atomicInteger = l.a;
            if (view2.isAttachedToWindow()) {
                ...
                if (i14 == -1) {
                    ...
                    if (z3) {
                        this.A.setWidth(this.f911f == -1 ? -1 : 0);
                        this.A.setHeight(0);
                    } else {
                ...
                this.A.update(this.q, this.f912g, this.f913h, i13 < 0 ? -1 : i13, i4 < 0 ? -1 : i4);
                return;
            }
            return;
        }
        ...
        this.A.showAsDropDown(this.q, this.f912g, this.f913h, this.m);
        this.f909d.setSelection(-1);
        if ((!this.z || this.f909d.isInTouchMode()) && (f0Var = this.f909d) != null) {
            f0Var.setListSelectionHidden(true);
            f0Var.requestLayout();
        }
        if (!this.z) {
    ...
    public void r(int i2) {
        ...
        if (background != null) {
            background.getPadding(this.x);
            Rect rect = this.x;
            this.f911f = rect.left + rect.right + i2;
            return;
        }
        this.f911f = i2;
    }
