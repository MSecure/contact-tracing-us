...
public final class n0 {
    ...
    public static final PorterDuff.Mode f918h = PorterDuff.Mode.SRC_IN;

    /* renamed from: i  reason: collision with root package name */
    public static n0 f919i;

    /* renamed from: j  reason: collision with root package name */
    public static final c f920j = new c(6);
    public WeakHashMap<Context, i<ColorStateList>> a;
    public h<String, e> b;
    public i<String> c;

    /* renamed from: d  reason: collision with root package name */
    public final WeakHashMap<Context, e.e.e<WeakReference<Drawable.ConstantState>>> f921d = new WeakHashMap<>(0);

    /* renamed from: e  reason: collision with root package name */
    public TypedValue f922e;
    ...
    public final synchronized boolean b(Context context, long j2, Drawable drawable) {
        ...
        if (constantState != null) {
            e.e.e<WeakReference<Drawable.ConstantState>> eVar = this.f921d.get(context);
            if (eVar == null) {
                eVar = new e.e.e<>();
                this.f921d.put(context, eVar);
            }
    ...
    public final Drawable c(Context context, int i2) {
        int i3;
        if (this.f922e == null) {
            this.f922e = new TypedValue();
        }
        TypedValue typedValue = this.f922e;
