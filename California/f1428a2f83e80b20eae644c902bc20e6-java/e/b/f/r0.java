...
public class r0 extends c implements View.OnClickListener {
    ...
    public static final class a {
        ...
        public a(View view) {
            ...
            this.f934d = (ImageView) view.findViewById(16908296);
            this.f935e = (ImageView) view.findViewById(R$id.edit_query);
        }
    }
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.b != null) {
            ...
            if (h3 != null) {
                if (this.s == null) {
                    ...
                    this.f1515e.getTheme().resolveAttribute(R$attr.textColorSearchUrl, typedValue, true);
                    this.s = this.f1515e.getResources().getColorStateList(typedValue.resourceId);
                }
        ...
        if (imageView != null) {
            ...
            if (i4 == -1) {
                ...
                if (drawable == null) {
                    ...
                    if (drawable == null) {
                        drawable = this.f1515e.getPackageManager().getDefaultActivityIcon();
                    }
                }
            }
        ...
        ImageView imageView2 = aVar.f934d;
        if (imageView2 != null) {
            int i5 = this.x;
            if (i5 != -1) {
        ...
        int i6 = this.r;
        if (i6 == 2 || (i6 == 1 && (i3 & 1) != 0)) {
            aVar.f935e.setVisibility(0);
            aVar.f935e.setTag(aVar.a.getText());
            aVar.f935e.setOnClickListener(this);
            return;
        }
        aVar.f935e.setVisibility(8);
    }
    ...
    public View d(Context context, Cursor cursor, ViewGroup viewGroup) {
        View inflate = this.f1522l.inflate(this.f1520j, viewGroup, false);
    ...
    public Drawable e(Uri uri) {
        ...
        if (!TextUtils.isEmpty(authority)) {
            try {
                Resources resourcesForApplication = this.f1515e.getPackageManager().getResourcesForApplication(authority);
    ...
    public Cursor g(SearchableInfo searchableInfo, String str, int i2) {
        ...
        return this.f1515e.getContentResolver().query(fragment.build(), null, suggestSelection, strArr, null);
    }
    ...
    public View getDropDownView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            View inflate = this.f1522l.inflate(this.f1521k, viewGroup, false);
            if (inflate != null) {
    ...
    public View getView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", e2);
            View d2 = d(this.f1515e, this.f1514d, viewGroup);
