...
public class w extends Spinner {
    ...
    public static final int[] f957j = {16843505};
    public final e b;
    ...
    public final Rect f963i = new Rect();
    ...
    public class b implements f, DialogInterface.OnClickListener {
        ...
        public void e(int i2, int i3) {
            if (this.c != null) {
                ...
                CharSequence charSequence = this.f964d;
                ...
                g a = aVar.a();
                this.b = a;
                ListView listView = a.f654d.f13g;
    ...
    public class d extends k0 implements f {
        ...
        public void t() {
            ...
            int i4 = 0;
            if (i3 != null) {
                i3.getPadding(w.this.f963i);
                i4 = e1.a(w.this) ? w.this.f963i.right : -w.this.f963i.left;
            } else {
                Rect rect = w.this.f963i;
                rect.right = 0;
                rect.left = 0;
            }
            ...
            if (i5 == -2) {
                ...
                r(i5);
                this.f912g = !e1.a(w.this) ? (((width - paddingRight) - this.f911f) - this.H) + i4 : paddingLeft + this.H + i4;
            }
            r(i2);
            this.f912g = !e1.a(w.this) ? (((width - paddingRight) - this.f911f) - this.H) + i4 : paddingLeft + this.H + i4;
        }
    ...
    public w(Context context, AttributeSet attributeSet, int i2) {
        ...
        int i3 = -1;
        try {
            typedArray = context.obtainStyledAttributes(attributeSet, f957j, i2, 0);
            try {
        ...
        if (i3 == 0) {
            ...
            this.f962h = q.k(R$styleable.Spinner_android_dropDownWidth, -2);
            ...
            q.b.recycle();
            this.f961g = dVar;
            this.f958d = new v(this, this, dVar);
        }
        ...
        this.f960f = true;
        SpinnerAdapter spinnerAdapter = this.f959e;
        if (spinnerAdapter != null) {
    ...
    public int a(SpinnerAdapter spinnerAdapter, Drawable drawable) {
        ...
        drawable.getPadding(this.f963i);
        Rect rect = this.f963i;
        return i3 + rect.left + rect.right;
    }

    public void b() {
        this.f961g.e(getTextDirection(), getTextAlignment());
    }
    ...
    public int getDropDownWidth() {
        return this.f961g != null ? this.f962h : super.getDropDownWidth();
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f961g != null && View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE) {
    ...
    public void setAdapter(SpinnerAdapter spinnerAdapter) {
        ...
        if (this.f961g != null) {
            ...
            this.f961g.o(new c(spinnerAdapter, context.getTheme()));
        }
    }
