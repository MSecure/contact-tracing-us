...
public class y {
    ...
    public class a extends g {
        ...
        public void d(Typeface typeface) {
            ...
            if (yVar.m) {
                ...
                if (textView != null) {
                    textView.setTypeface(typeface, yVar.f973j);
                }
            }
        }
    }
    ...
    public void b() {
        if (!(this.b == null && this.c == null && this.f967d == null && this.f968e == null)) {
        ...
        if (this.f969f != null || this.f970g != null) {
            ...
            a(compoundDrawablesRelative[0], this.f969f);
            a(compoundDrawablesRelative[2], this.f970g);
        }
    }
    ...
    public void e(AttributeSet attributeSet, int i2) {
            ...
            if (y0Var2.o(i21)) {
                ...
                if (i8 >= 28) {
                    ...
                    if (y0Var2.o(i26)) {
                        ...
                        if (typeface != null) {
                            if (this.f974k == -1) {
                                this.a.setTypeface(typeface, this.f973j);
                            } else {
                        ...
                        if (str2 != null) {
                            if (i8 >= 24) {
                                ...
                                if (a0Var.i()) {
                                    ...
                                    if (!a0Var.f839g) {
                                        DisplayMetrics displayMetrics = a0Var.f842j.getResources().getDisplayMetrics();
                                        if (dimension2 == -1.0f) {
                                ...
                                if (b.a) {
                                    a0 a0Var2 = this.f972i;
                                    if (a0Var2.a != 0) {
                                        int[] iArr4 = a0Var2.f838f;
                                        if (iArr4.length > 0) {
                                            if (((float) this.a.getAutoSizeStepGranularity()) != -1.0f) {
                                                this.a.setAutoSizeTextTypeUniformWithConfiguration(Math.round(this.f972i.f836d), Math.round(this.f972i.f837e), Math.round(this.f972i.c), 0);
                                            } else {
                        ...
                        TextView textView22 = a0Var.f841i;
                ...
                i4 = 0;
                a0Var = this.f972i;
                Context context222 = a0Var.f842j;
                ...
                TextView textView222 = a0Var.f841i;
        ...
        i4 = 0;
        a0Var = this.f972i;
        Context context2222 = a0Var.f842j;
        ...
        TextView textView2222 = a0Var.f841i;
    ...
    public void j(ColorStateList colorStateList) {
        ...
        w0Var.f966d = colorStateList != null;
        this.b = w0Var;
        this.c = w0Var;
        this.f967d = w0Var;
        this.f968e = w0Var;
    ...
    public final void l(Context context, y0 y0Var) {
        ...
        this.f973j = y0Var.j(R$styleable.TextAppearance_android_textStyle, this.f973j);
        boolean z = false;
        if (i2 >= 28) {
        ...
        if (y0Var.o(i3) || y0Var.o(R$styleable.TextAppearance_fontFamily)) {
            ...
            if (!context.isRestricted()) {
                try {
                    Typeface i7 = y0Var.i(i3, this.f973j, new a(i5, i6, new WeakReference(this.a)));
                    if (i7 != null) {
                        if (i2 >= 28 && this.f974k != -1) {
                            i7 = Typeface.create(Typeface.create(i7, 0), this.f974k, (this.f973j & 2) != 0);
                        }
                        this.f975l = i7;
                    }
                    this.m = this.f975l == null;
                } catch (Resources.NotFoundException | UnsupportedOperationException unused) {
                }
            }
            if (this.f975l == null && (m2 = y0Var.m(i3)) != null) {
                if (i2 < 28 || this.f974k == -1) {
                    typeface = Typeface.create(m2, this.f973j);
                } else {
