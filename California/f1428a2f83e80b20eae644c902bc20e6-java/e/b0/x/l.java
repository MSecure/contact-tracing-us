...
public class l extends t {
    ...
    public static final String f1027k = e.b0.l.e("WorkManagerImpl");

    /* renamed from: l  reason: collision with root package name */
    public static l f1028l = null;
    ...
    public BroadcastReceiver.PendingResult f1034i;

    /* renamed from: j  reason: collision with root package name */
    public volatile e.b0.y.a f1035j;
    ...
    public l(Context context, b bVar, a aVar) {
        ...
        if (z) {
            ...
            aVar2.f1863g = new h(applicationContext);
        }
        aVar2.f1861e = iVar;
        i iVar2 = new i();
        if (aVar2.f1860d == null) {
            aVar2.f1860d = new ArrayList<>();
        }
        aVar2.f1860d.add(iVar2);
        aVar2.a(j.a);
        ...
        this.f1030e = asList;
        this.f1031f = dVar;
        this.f1032g = new e.b0.x.t.g(workDatabase);
        this.f1033h = false;
    ...
    public void f() {
        ...
        if (Build.VERSION.SDK_INT >= 23) {
            ...
            String str = e.b0.x.p.c.b.f1081f;
        ...
        q qVar = (q) this.c.r();
        qVar.a.b();
        e.v.a.f.f a2 = qVar.f1128i.a();
        qVar.a.c();
        try {
            a2.d();
            qVar.a.l();
            qVar.a.g();
            e.t.l lVar = qVar.f1128i;
            if (a2 == lVar.c) {
                lVar.a.set(false);
            }
            f.a(this.b, this.c, this.f1030e);
        } catch (Throwable th) {
            qVar.a.g();
            qVar.f1128i.c(a2);
            throw th;
    ...
    public final void h() {
        try {
            this.f1035j = (e.b0.y.a) Class.forName("androidx.work.multiprocess.RemoteWorkManagerClient").getConstructor(Context.class, l.class).newInstance(this.a, this);
        } catch (Throwable th) {
            e.b0.l.c().a(f1027k, "Unable to initialize multi-process support", th);
        }
    }
}
