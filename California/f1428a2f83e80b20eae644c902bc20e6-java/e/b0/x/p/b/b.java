...
public class b implements e.b0.x.b {
    ...
    public static final String f1059e = l.e("CommandHandler");
    ...
    public void e(Intent intent, int i2, e eVar) {
        ...
        if ("ACTION_CONSTRAINTS_CHANGED".equals(action)) {
            l.c().a(f1059e, String.format("Handling constraints changed %s", intent), new Throwable[0]);
            c cVar = new c(this.b, i2, eVar);
            List<o> f2 = ((q) eVar.f1074f.c.r()).f();
            ...
            while (it2.hasNext()) {
                o oVar = (o) it2.next();
                String str3 = oVar.a;
                if (currentTimeMillis >= oVar.a() && (!oVar.b() || cVar.f1062d.a(str3))) {
                    arrayList2.add(oVar);
                }
            }
            ...
            while (it3.hasNext()) {
                ...
                l.c().a(c.f1061e, String.format("Creating a delay_met command for workSpec with id (%s)", str4), new Throwable[0]);
                e eVar2 = cVar.c;
                eVar2.f1076h.post(new e.b(eVar2, c2, cVar.b));
            }
            cVar.f1062d.c();
        } else if ("ACTION_RESCHEDULE".equals(action)) {
            l.c().a(f1059e, String.format("Handling reschedule %s, %s", intent, Integer.valueOf(i2)), new Throwable[0]);
            eVar.f1074f.f();
        } else {
            ...
            if (extras != null && !extras.isEmpty()) {
                ...
                if (z) {
                    l.c().b(f1059e, String.format("Invalid request for %s, requires %s.", action, "KEY_WORKSPEC_ID"), new Throwable[0]);
                    return;
                    ...
                    WorkDatabase workDatabase = eVar.f1074f.c;
                    workDatabase.c();
                    try {
                    ...
                    l.c().a(f1059e, String.format("Handing stopWork work for %s", string3), new Throwable[0]);
                    eVar.f1074f.g(string3);
                    Context context2 = this.b;
                    e.b0.x.l lVar = eVar.f1074f;
                    String str7 = a.a;
                    i iVar = (i) lVar.c.o();
                    g a2 = iVar.a(string3);
                    if (a2 != null) {
                    ...
                    l.c().a(f1059e, String.format("Handling onExecutionCompleted %s, %s", intent, Integer.valueOf(i2)), new Throwable[0]);
                    a(string4, z6);
                    return;
                } else {
                    l.c().f(f1059e, String.format("Ignoring intent %s", intent), new Throwable[0]);
                    return;
                }
            }
            z = false;
