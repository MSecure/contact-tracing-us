...
public class a extends c<Boolean> {
    ...
    public static final String f1089i = l.e("BatteryChrgTracker");
    ...
    public Object a() {
        ...
        if (registerReceiver == null) {
            l.c().b(f1089i, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
    ...
    public void g(Context context, Intent intent) {
        ...
        if (action != null) {
            char c = 0;
            l.c().a(f1089i, String.format("Received %s", action), new Throwable[0]);
