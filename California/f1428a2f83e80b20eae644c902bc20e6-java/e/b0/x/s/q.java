...
public final class q implements p {
    ...
    public final l f1123d;

    /* renamed from: e  reason: collision with root package name */
    public final l f1124e;

    /* renamed from: f  reason: collision with root package name */
    public final l f1125f;

    /* renamed from: g  reason: collision with root package name */
    public final l f1126g;

    /* renamed from: h  reason: collision with root package name */
    public final l f1127h;
    ...
    public class a extends e.t.b<o> {
        ...
        public void d(e.v.a.f.f fVar, o oVar) {
            ...
            fVar.b.bindLong(2, (long) m.h.k1(oVar2.b));
            String str2 = oVar2.c;
            if (str2 == null) {
                fVar.b.bindNull(3);
            } else {
            ...
            byte[] b = e.b0.e.b(oVar2.f1115e);
            if (b == null) {
                fVar.b.bindNull(5);
            } else {
                fVar.b.bindBlob(5, b);
            }
            byte[] b2 = e.b0.e.b(oVar2.f1116f);
            if (b2 == null) {
                fVar.b.bindNull(6);
            } else {
                fVar.b.bindBlob(6, b2);
            }
            fVar.b.bindLong(7, oVar2.f1117g);
            fVar.b.bindLong(8, oVar2.f1118h);
            fVar.b.bindLong(9, oVar2.f1119i);
            fVar.b.bindLong(10, (long) oVar2.f1121k);
            e.b0.a aVar = oVar2.f1122l;
            ...
            if (cVar != null) {
                ...
                fVar.b.bindLong(20, cVar.f987d ? 1 : 0);
                fVar.b.bindLong(21, cVar.f988e ? 1 : 0);
                fVar.b.bindLong(22, cVar.f989f);
                fVar.b.bindLong(23, cVar.f990g);
                e.b0.d dVar = cVar.f991h;
                byte[] bArr = null;
    ...
    public q(e.t.g gVar) {
        ...
        this.f1123d = new c(this, gVar);
        this.f1124e = new d(this, gVar);
        this.f1125f = new e(this, gVar);
        this.f1126g = new f(this, gVar);
        this.f1127h = new g(this, gVar);
        this.f1128i = new h(this, gVar);
        ...
        try {
            ...
            try {
                ...
                while (b2.moveToNext()) {
                    ...
                    cVar.a = m.h.t0(b2.getInt(b0));
                    cVar.b = b2.getInt(b02) != 0;
                    cVar.c = b2.getInt(b03) != 0;
                    cVar.f987d = b2.getInt(b04) != 0;
                    cVar.f988e = b2.getInt(b05) != 0;
                    cVar.f989f = b2.getLong(b06);
                    cVar.f990g = b2.getLong(b07);
                    cVar.f991h = m.h.f(b2.getBlob(b08));
                    o oVar = new o(string, string2);
                    oVar.b = m.h.u0(b2.getInt(b010));
                    oVar.f1114d = b2.getString(b012);
                    oVar.f1115e = e.b0.e.a(b2.getBlob(b013));
                    oVar.f1116f = e.b0.e.a(b2.getBlob(i3));
                    i3 = i3;
                    oVar.f1117g = b2.getLong(b015);
                    oVar.f1118h = b2.getLong(b016);
                    oVar.f1119i = b2.getLong(b017);
                    oVar.f1121k = b2.getInt(b018);
                    oVar.f1122l = m.h.s0(b2.getInt(b019));
                    b017 = b017;
        ...
        try {
            ...
            try {
                ...
                while (b2.moveToNext()) {
                    ...
                    oVar.f1114d = b2.getString(b012);
                    oVar.f1115e = e.b0.e.a(b2.getBlob(b013));
                    oVar.f1116f = e.b0.e.a(b2.getBlob(i2));
                    i2 = i2;
                    oVar.f1117g = b2.getLong(b015);
                    oVar.f1118h = b2.getLong(b016);
                    oVar.f1119i = b2.getLong(b017);
        ...
        try {
            ...
            try {
                ...
                if (b2.moveToFirst()) {
                    ...
                    oVar2.b = m.h.u0(b2.getInt(b010));
                    oVar2.f1114d = b2.getString(b012);
                    oVar2.f1115e = e.b0.e.a(b2.getBlob(b013));
                    oVar2.f1116f = e.b0.e.a(b2.getBlob(b014));
                    oVar2.f1117g = b2.getLong(b015);
                    oVar2.f1118h = b2.getLong(b016);
                    oVar2.f1119i = b2.getLong(b017);
                    oVar2.f1121k = b2.getInt(b018);
                    oVar2.f1122l = m.h.s0(b2.getInt(b019));
    ...
    public int p(s sVar, String... strArr) {
        ...
        d2.b.bindLong(1, (long) m.h.k1(sVar));
        int i3 = 2;
