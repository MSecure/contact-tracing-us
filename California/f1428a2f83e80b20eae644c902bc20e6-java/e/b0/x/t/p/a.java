...
public abstract class a<V> implements u<V> {
    ...
    public static final boolean f1141e = Boolean.parseBoolean(System.getProperty("guava.concurrent.generate_cancellation_cause", "false"));

    /* renamed from: f  reason: collision with root package name */
    public static final Logger f1142f = Logger.getLogger(a.class.getName());

    /* renamed from: g  reason: collision with root package name */
    public static final b f1143g;

    /* renamed from: h  reason: collision with root package name */
    public static final Object f1144h = new Object();
    public volatile Object b;
    public volatile e c;

    /* renamed from: d  reason: collision with root package name */
    public volatile i f1145d;
    ...
    public static final class e {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final e f1147d = new e(null, null);
    ...
    public static final class f extends b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<a, e> f1148d;

        /* renamed from: e  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<a, Object> f1149e;
        ...
        public f(AtomicReferenceFieldUpdater<i, Thread> atomicReferenceFieldUpdater, AtomicReferenceFieldUpdater<i, i> atomicReferenceFieldUpdater2, AtomicReferenceFieldUpdater<a, i> atomicReferenceFieldUpdater3, AtomicReferenceFieldUpdater<a, e> atomicReferenceFieldUpdater4, AtomicReferenceFieldUpdater<a, Object> atomicReferenceFieldUpdater5) {
            ...
            this.f1148d = atomicReferenceFieldUpdater4;
            this.f1149e = atomicReferenceFieldUpdater5;
        }

        @Override // e.b0.x.t.p.a.b
        public boolean a(a<?> aVar, e eVar, e eVar2) {
            return this.f1148d.compareAndSet(aVar, eVar, eVar2);
        }

        @Override // e.b0.x.t.p.a.b
        public boolean b(a<?> aVar, Object obj, Object obj2) {
            return this.f1149e.compareAndSet(aVar, obj, obj2);
        }
    ...
    public static final class g<V> implements Runnable {
        ...
        public void run() {
            if (this.b.b == this) {
                if (a.f1143g.b(this.b, this, a.f(this.c))) {
                    a.c(this.b);
                }
            }
        }
    ...
    public static final class i {
        ...
        public i() {
            a.f1143g.e(this, Thread.currentThread());
        }
    ...
    static {
        ...
        f1143g = bVar;
        if (th != null) {
            f1142f.log(Level.SEVERE, "SafeAtomicHelper is broken!", th);
        }
    }
    ...
    public static void c(a<?> aVar) {
        ...
        e eVar3 = null;
        while (true) {
            i iVar = ((a) aVar).f1145d;
            if (f1143g.c((a) aVar, iVar, i.c)) {
                while (iVar != null) {
                ...
                do {
                    eVar = ((a) aVar).c;
                } while (!f1143g.a((a) aVar, eVar, e.f1147d));
                while (true) {
                    eVar2 = eVar3;
                    eVar3 = eVar;
                    if (eVar3 == null) {
                ...
                while (eVar2 != null) {
                    ...
                    if (runnable instanceof g) {
                        ...
                        aVar = gVar.b;
                        if (aVar.b == gVar) {
                            if (f1143g.b(aVar, gVar, f(gVar.c))) {
                            }
                        } else {
                            continue;
                        }
    ...
    public static Object f(u<?> uVar) {
        if (uVar instanceof a) {
            ...
            c cVar = (c) obj;
            return cVar.a ? cVar.b != null ? new c(false, cVar.b) : c.f1146d : obj;
        }
        boolean isCancelled = uVar.isCancelled();
        if ((!f1141e) && isCancelled) {
            return c.f1146d;
        }
        try {
            Object g2 = g(uVar);
            return g2 == null ? f1144h : g2;
    ...
    public final boolean cancel(boolean z) {
        ...
        c cVar = f1141e ? new c(z, new CancellationException("Future.cancel() was called.")) : z ? c.c : c.f1146d;
        boolean z2 = false;
        a<V> aVar = this;
        while (true) {
            if (f1143g.b(aVar, obj, cVar)) {
                c(aVar);
                if (!(obj instanceof g)) {
                    return true;
                }
        ...
        while (true) {
            ...
            if (iVar2 != i.c) {
                ...
                while (iVar2 != null) {
                    ...
                    } else if (!f1143g.c(this, iVar2, iVar4)) {
                    }
                    iVar2 = iVar4;
                }
                return;
