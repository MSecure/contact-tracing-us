...
public class b<K, V> implements Iterable<Map.Entry<K, V>> {
    ...
    public WeakHashMap<f<K, V>, Boolean> f1152d = new WeakHashMap<>();
    ...
    public class d implements Iterator<Map.Entry<K, V>>, f<K, V> {
        ...
        public boolean hasNext() {
            ...
            c<K, V> cVar = this.b;
            return (cVar == null || cVar.f1154d == null) ? false : true;
        }
        ...
        public Object next() {
            ...
            if (this.c) {
                ...
                c<K, V> cVar2 = this.b;
                cVar = cVar2 != null ? cVar2.f1154d : null;
            }
            this.b = cVar;
            return cVar;
        }
    ...
    public b<K, V>.d i() {
        b<K, V>.d dVar = new d();
        this.f1152d.put(dVar, Boolean.FALSE);
        return dVar;
    }
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        ...
        this.f1152d.put(aVar, Boolean.FALSE);
        return aVar;
    }
    ...
    public V l(K k2) {
        ...
        this.f1153e--;
        if (!this.f1152d.isEmpty()) {
            for (f<K, V> fVar : this.f1152d.keySet()) {
                fVar.b(h2);
            }
        }
        c<K, V> cVar = h2.f1155e;
        c<K, V> cVar2 = h2.f1154d;
        if (cVar != null) {
            cVar.f1154d = cVar2;
        } else {
            this.b = cVar2;
        }
        c<K, V> cVar3 = h2.f1154d;
        if (cVar3 != null) {
            cVar3.f1155e = cVar;
        } else {
            this.c = cVar;
