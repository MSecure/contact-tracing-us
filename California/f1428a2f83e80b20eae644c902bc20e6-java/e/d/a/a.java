...
public class a extends FrameLayout {
    ...
    public static final int[] f1157i = {16842801};

    /* renamed from: j  reason: collision with root package name */
    public static final d f1158j = new b();
    public boolean b;
    public boolean c;
    ...
    public final Rect f1161f;

    /* renamed from: g  reason: collision with root package name */
    public final Rect f1162g;

    /* renamed from: h  reason: collision with root package name */
    public final c f1163h;
    ...
    public class C0024a implements c {
        ...
        public void b(int i2, int i3, int i4, int i5) {
            a.this.f1162g.set(i2, i3, i4, i5);
            a aVar = a.this;
            Rect rect = aVar.f1161f;
    ...
    public a(Context context, AttributeSet attributeSet, int i2) {
        ...
        if (obtainStyledAttributes.hasValue(i4)) {
            ...
            TypedArray obtainStyledAttributes2 = getContext().obtainStyledAttributes(f1157i);
        ...
        this.f1159d = obtainStyledAttributes.getDimensionPixelSize(R$styleable.CardView_android_minWidth, 0);
        this.f1160e = obtainStyledAttributes.getDimensionPixelSize(R$styleable.CardView_android_minHeight, 0);
        ...
        ((b) f1158j).b(aVar, dimension3);
    }

    public ColorStateList getCardBackgroundColor() {
        return ((e) ((C0024a) this.f1163h).a).f1168h;
    }
    ...
    public int getContentPaddingBottom() {
        return this.f1161f.bottom;
    }

    public int getContentPaddingLeft() {
        return this.f1161f.left;
    }

    public int getContentPaddingRight() {
        return this.f1161f.right;
    }

    public int getContentPaddingTop() {
        return this.f1161f.top;
    }

    public float getMaxCardElevation() {
        return ((e) ((C0024a) this.f1163h).a).f1165e;
    }
    ...
    public float getRadius() {
        return ((e) ((C0024a) this.f1163h).a).a;
    }
    ...
    public void setPreventCornerOverlap(boolean z) {
        if (z != this.c) {
            ...
            c cVar = this.f1163h;
            b bVar = (b) dVar;
            bVar.b(cVar, bVar.a(cVar).f1165e);
        }
    }

    public void setRadius(float f2) {
        e eVar = (e) ((C0024a) this.f1163h).a;
        if (f2 != eVar.a) {
            eVar.a = f2;
            eVar.c(null);
            eVar.invalidateSelf();
