...
public abstract class b extends View {
    ...
    public HashMap<Integer, String> f1346h;
    ...
    public final void a(String str) {
        if (str != null && str.length() != 0 && this.f1342d != null) {
            ...
            if (i2 == 0) {
                i2 = this.f1342d.getResources().getIdentifier(trim, "id", this.f1342d.getPackageName());
            }
            if (i2 != 0) {
                this.f1346h.put(Integer.valueOf(i2), trim);
                b(i2);
                return;
            }
    ...
    public final int e(ConstraintLayout constraintLayout, String str) {
        Resources resources;
        if (str == null || constraintLayout == null || (resources = this.f1342d.getResources()) == null) {
            return 0;
        }
        int childCount = constraintLayout.getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
    ...
    public void k() {
        if (this.f1343e != null) {
            ...
            if (layoutParams instanceof ConstraintLayout.a) {
                ((ConstraintLayout.a) layoutParams).l0 = (d) this.f1343e;
            }
        }
    }
