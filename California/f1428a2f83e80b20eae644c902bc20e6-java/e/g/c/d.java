...
public class d {
    ...
    public static final int[] f1351d = {0, 4, 8};

    /* renamed from: e  reason: collision with root package name */
    public static SparseIntArray f1352e;
    ...
    public static class a {
        ...
        public HashMap<String, a> f1355f = new HashMap<>();

        public void a(ConstraintLayout.a aVar) {
            b bVar = this.f1353d;
            aVar.f108d = bVar.f1360h;
            aVar.f109e = bVar.f1361i;
            aVar.f110f = bVar.f1362j;
            aVar.f111g = bVar.f1363k;
            aVar.f112h = bVar.f1364l;
            aVar.f113i = bVar.m;
            aVar.f114j = bVar.n;
            aVar.f115k = bVar.o;
            aVar.f116l = bVar.p;
            ...
            ((ViewGroup.MarginLayoutParams) aVar).height = bVar2.f1356d;
            String str = bVar2.g0;
            if (str != null) {
                aVar.U = str;
            }
            aVar.setMarginStart(this.f1353d.I);
            aVar.setMarginEnd(this.f1353d.H);
            aVar.a();
        }
        ...
        public final void b(int i2, ConstraintLayout.a aVar) {
            this.a = i2;
            b bVar = this.f1353d;
            bVar.f1360h = aVar.f108d;
            bVar.f1361i = aVar.f109e;
            bVar.f1362j = aVar.f110f;
            bVar.f1363k = aVar.f111g;
            bVar.f1364l = aVar.f112h;
            bVar.m = aVar.f113i;
            bVar.n = aVar.f114j;
            bVar.o = aVar.f115k;
            bVar.p = aVar.f116l;
            ...
            bVar2.f1356d = ((ViewGroup.MarginLayoutParams) aVar).height;
            ...
            this.f1353d.I = aVar.getMarginStart();
        }

        public final void c(int i2, e.a aVar) {
            b(i2, aVar);
            this.b.f1370d = aVar.m0;
            e eVar = this.f1354e;
            eVar.b = aVar.p0;
            eVar.c = aVar.q0;
            eVar.f1372d = aVar.r0;
        ...
        public Object clone() {
            ...
            bVar.c = bVar2.c;
            bVar.b = bVar2.b;
            bVar.f1356d = bVar2.f1356d;
            bVar.f1357e = bVar2.f1357e;
            bVar.f1358f = bVar2.f1358f;
            bVar.f1359g = bVar2.f1359g;
            bVar.f1360h = bVar2.f1360h;
            bVar.f1361i = bVar2.f1361i;
            bVar.f1362j = bVar2.f1362j;
            bVar.f1363k = bVar2.f1363k;
            ...
            cVar.b = cVar2.b;
            cVar.c = cVar2.c;
            cVar.f1366d = cVar2.f1366d;
            cVar.f1367e = cVar2.f1367e;
            cVar.f1369g = cVar2.f1369g;
            cVar.f1368f = cVar2.f1368f;
            C0030d dVar = aVar.b;
            C0030d dVar2 = this.b;
            Objects.requireNonNull(dVar);
            dVar.a = dVar2.a;
            dVar.b = dVar2.b;
            dVar.f1370d = dVar2.f1370d;
            dVar.f1371e = dVar2.f1371e;
            dVar.c = dVar2.c;
            e eVar = aVar.f1354e;
            e eVar2 = this.f1354e;
            ...
            eVar.b = eVar2.b;
            eVar.c = eVar2.c;
            eVar.f1372d = eVar2.f1372d;
            eVar.f1373e = eVar2.f1373e;
            eVar.f1374f = eVar2.f1374f;
            eVar.f1375g = eVar2.f1375g;
            eVar.f1376h = eVar2.f1376h;
            eVar.f1377i = eVar2.f1377i;
            eVar.f1378j = eVar2.f1378j;
            eVar.f1379k = eVar2.f1379k;
            eVar.f1380l = eVar2.f1380l;
            eVar.m = eVar2.m;
            aVar.a = this.a;
            return aVar;
        }
                ...
                if (i3 == 80) {
                    ...
                    switch (i3) {
                        ...
                        case 18:
                            ...
                            continue;
                        case 19:
                            this.f1359g = obtainStyledAttributes.getFloat(index, this.f1359g);
                            continue;
                        case 20:
                            this.u = obtainStyledAttributes.getFloat(index, this.u);
                            continue;
                        case 21:
                            this.f1356d = obtainStyledAttributes.getLayoutDimension(index, this.f1356d);
                            continue;
                        case 22:
    ...
    public static class c {
        ...
        /* renamed from: h  reason: collision with root package name */
        public static SparseIntArray f1365h;
        public boolean a = false;
        public int b = -1;
        ...
        /* renamed from: f  reason: collision with root package name */
        public float f1368f = Float.NaN;

        /* renamed from: g  reason: collision with root package name */
        public float f1369g = Float.NaN;

        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            f1365h = sparseIntArray;
            sparseIntArray.append(R$styleable.Motion_motionPathRotate, 1);
            f1365h.append(R$styleable.Motion_pathMotionArc, 2);
            f1365h.append(R$styleable.Motion_transitionEasing, 3);
            f1365h.append(R$styleable.Motion_drawPath, 4);
            f1365h.append(R$styleable.Motion_animate_relativeTo, 5);
            f1365h.append(R$styleable.Motion_motionStagger, 6);
        }
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                switch (f1365h.get(index)) {
                    case 1:
                        ...
                        break;
                    case 2:
                        this.f1366d = obtainStyledAttributes.getInt(index, this.f1366d);
                        break;
                    case 3:
                        ...
                        break;
                    case 4:
                        this.f1367e = obtainStyledAttributes.getInt(index, 0);
                        break;
                    case 5:
                        int i3 = this.b;
                        int[] iArr = d.f1351d;
                        ...
                        break;
                    case 6:
                        this.f1368f = obtainStyledAttributes.getFloat(index, this.f1368f);
                        break;
                }
            }
            obtainStyledAttributes.recycle();
        ...
        public void a(Context context, AttributeSet attributeSet) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == R$styleable.PropertySet_android_alpha) {
                    this.f1370d = obtainStyledAttributes.getFloat(index, this.f1370d);
                    ...
                    this.f1371e = obtainStyledAttributes.getFloat(index, this.f1371e);
                }
            }
            obtainStyledAttributes.recycle();
        }
    ...
    public static class e {
        ...
        /* renamed from: d  reason: collision with root package name */
        public float f1372d = 0.0f;

        /* renamed from: e  reason: collision with root package name */
        public float f1373e = 1.0f;

        /* renamed from: f  reason: collision with root package name */
        public float f1374f = 1.0f;

        /* renamed from: g  reason: collision with root package name */
        public float f1375g = Float.NaN;

        /* renamed from: h  reason: collision with root package name */
        public float f1376h = Float.NaN;

        /* renamed from: i  reason: collision with root package name */
        public float f1377i = 0.0f;

        /* renamed from: j  reason: collision with root package name */
        public float f1378j = 0.0f;

        /* renamed from: k  reason: collision with root package name */
        public float f1379k = 0.0f;
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                switch (n.get(index)) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        this.f1374f = obtainStyledAttributes.getFloat(index, this.f1374f);
                        break;
                    case 6:
                        this.f1375g = obtainStyledAttributes.getDimension(index, this.f1375g);
                        break;
                    case 7:
                        this.f1376h = obtainStyledAttributes.getDimension(index, this.f1376h);
                        break;
                    case 8:
                        this.f1377i = obtainStyledAttributes.getDimension(index, this.f1377i);
                        break;
                    case 9:
                        this.f1378j = obtainStyledAttributes.getDimension(index, this.f1378j);
                        break;
                    case 10:
                        this.f1379k = obtainStyledAttributes.getDimension(index, this.f1379k);
                        break;
                    case 11:
                        this.f1380l = true;
    ...
    static {
        ...
        f1352e.append(R$styleable.Constraint_layout_constraintLeft_toRightOf, 26);
        f1352e.append(R$styleable.Constraint_layout_constraintRight_toLeftOf, 29);
        f1352e.append(R$styleable.Constraint_layout_constraintRight_toRightOf, 30);
        f1352e.append(R$styleable.Constraint_layout_constraintTop_toTopOf, 36);
        f1352e.append(R$styleable.Constraint_layout_constraintTop_toBottomOf, 35);
        f1352e.append(R$styleable.Constraint_layout_constraintBottom_toTopOf, 4);
        f1352e.append(R$styleable.Constraint_layout_constraintBottom_toBottomOf, 3);
        f1352e.append(R$styleable.Constraint_layout_constraintBaseline_toBaselineOf, 1);
        f1352e.append(R$styleable.Constraint_layout_editor_absoluteX, 6);
        f1352e.append(R$styleable.Constraint_layout_editor_absoluteY, 7);
        f1352e.append(R$styleable.Constraint_layout_constraintGuide_begin, 17);
        f1352e.append(R$styleable.Constraint_layout_constraintGuide_end, 18);
        f1352e.append(R$styleable.Constraint_layout_constraintGuide_percent, 19);
        f1352e.append(R$styleable.Constraint_android_orientation, 27);
        f1352e.append(R$styleable.Constraint_layout_constraintStart_toEndOf, 32);
        f1352e.append(R$styleable.Constraint_layout_constraintStart_toStartOf, 33);
        f1352e.append(R$styleable.Constraint_layout_constraintEnd_toStartOf, 10);
        f1352e.append(R$styleable.Constraint_layout_constraintEnd_toEndOf, 9);
        f1352e.append(R$styleable.Constraint_layout_goneMarginLeft, 13);
        f1352e.append(R$styleable.Constraint_layout_goneMarginTop, 16);
        f1352e.append(R$styleable.Constraint_layout_goneMarginRight, 14);
        f1352e.append(R$styleable.Constraint_layout_goneMarginBottom, 11);
        f1352e.append(R$styleable.Constraint_layout_goneMarginStart, 15);
        f1352e.append(R$styleable.Constraint_layout_goneMarginEnd, 12);
        f1352e.append(R$styleable.Constraint_layout_constraintVertical_weight, 40);
        f1352e.append(R$styleable.Constraint_layout_constraintHorizontal_weight, 39);
        f1352e.append(R$styleable.Constraint_layout_constraintHorizontal_chainStyle, 41);
        f1352e.append(R$styleable.Constraint_layout_constraintVertical_chainStyle, 42);
        f1352e.append(R$styleable.Constraint_layout_constraintHorizontal_bias, 20);
        f1352e.append(R$styleable.Constraint_layout_constraintVertical_bias, 37);
        f1352e.append(R$styleable.Constraint_layout_constraintDimensionRatio, 5);
        f1352e.append(R$styleable.Constraint_layout_constraintLeft_creator, 82);
        f1352e.append(R$styleable.Constraint_layout_constraintTop_creator, 82);
        f1352e.append(R$styleable.Constraint_layout_constraintRight_creator, 82);
        f1352e.append(R$styleable.Constraint_layout_constraintBottom_creator, 82);
        f1352e.append(R$styleable.Constraint_layout_constraintBaseline_creator, 82);
        f1352e.append(R$styleable.Constraint_android_layout_marginLeft, 24);
        f1352e.append(R$styleable.Constraint_android_layout_marginRight, 28);
        f1352e.append(R$styleable.Constraint_android_layout_marginStart, 31);
        f1352e.append(R$styleable.Constraint_android_layout_marginEnd, 8);
        f1352e.append(R$styleable.Constraint_android_layout_marginTop, 34);
        f1352e.append(R$styleable.Constraint_android_layout_marginBottom, 2);
        f1352e.append(R$styleable.Constraint_android_layout_width, 23);
        f1352e.append(R$styleable.Constraint_android_layout_height, 21);
        f1352e.append(R$styleable.Constraint_android_visibility, 22);
        f1352e.append(R$styleable.Constraint_android_alpha, 43);
        f1352e.append(R$styleable.Constraint_android_elevation, 44);
        f1352e.append(R$styleable.Constraint_android_rotationX, 45);
        f1352e.append(R$styleable.Constraint_android_rotationY, 46);
        f1352e.append(R$styleable.Constraint_android_rotation, 60);
        f1352e.append(R$styleable.Constraint_android_scaleX, 47);
        f1352e.append(R$styleable.Constraint_android_scaleY, 48);
        f1352e.append(R$styleable.Constraint_android_transformPivotX, 49);
        f1352e.append(R$styleable.Constraint_android_transformPivotY, 50);
        f1352e.append(R$styleable.Constraint_android_translationX, 51);
        f1352e.append(R$styleable.Constraint_android_translationY, 52);
        f1352e.append(R$styleable.Constraint_android_translationZ, 53);
        f1352e.append(R$styleable.Constraint_layout_constraintWidth_default, 54);
        f1352e.append(R$styleable.Constraint_layout_constraintHeight_default, 55);
        f1352e.append(R$styleable.Constraint_layout_constraintWidth_max, 56);
        f1352e.append(R$styleable.Constraint_layout_constraintHeight_max, 57);
        f1352e.append(R$styleable.Constraint_layout_constraintWidth_min, 58);
        f1352e.append(R$styleable.Constraint_layout_constraintHeight_min, 59);
        f1352e.append(R$styleable.Constraint_layout_constraintCircle, 61);
        f1352e.append(R$styleable.Constraint_layout_constraintCircleRadius, 62);
        f1352e.append(R$styleable.Constraint_layout_constraintCircleAngle, 63);
        f1352e.append(R$styleable.Constraint_animate_relativeTo, 64);
        f1352e.append(R$styleable.Constraint_transitionEasing, 65);
        f1352e.append(R$styleable.Constraint_drawPath, 66);
        f1352e.append(R$styleable.Constraint_transitionPathRotate, 67);
        f1352e.append(R$styleable.Constraint_motionStagger, 79);
        f1352e.append(R$styleable.Constraint_android_id, 38);
        f1352e.append(R$styleable.Constraint_motionProgress, 68);
        f1352e.append(R$styleable.Constraint_layout_constraintWidth_percent, 69);
        f1352e.append(R$styleable.Constraint_layout_constraintHeight_percent, 70);
        f1352e.append(R$styleable.Constraint_chainUseRtl, 71);
        f1352e.append(R$styleable.Constraint_barrierDirection, 72);
        f1352e.append(R$styleable.Constraint_barrierMargin, 73);
        f1352e.append(R$styleable.Constraint_constraint_referenced_ids, 74);
        f1352e.append(R$styleable.Constraint_barrierAllowsGoneWidgets, 75);
        f1352e.append(R$styleable.Constraint_pathMotionArc, 76);
        f1352e.append(R$styleable.Constraint_layout_constraintTag, 77);
        f1352e.append(R$styleable.Constraint_visibilityMode, 78);
        f1352e.append(R$styleable.Constraint_layout_constrainedWidth, 80);
        f1352e.append(R$styleable.Constraint_layout_constrainedHeight, 81);
    }
    ...
    public void a(ConstraintLayout constraintLayout, boolean z) {
        ...
        while (i3 < childCount) {
            ...
            if (!this.c.containsKey(Integer.valueOf(id))) {
                ...
                int i4 = aVar.f1353d.d0;
                if (i4 != -1 && i4 == 1) {
                    Barrier barrier = (Barrier) childAt;
                    barrier.setId(id);
                    barrier.setType(aVar.f1353d.b0);
                    barrier.setMargin(aVar.f1353d.c0);
                    barrier.setAllowsGoneWidget(aVar.f1353d.j0);
                    b bVar = aVar.f1353d;
                    int[] iArr = bVar.e0;
                    if (iArr != null) {
                        ...
                        if (str2 != null) {
                            ...
                            barrier.setReferencedIds(aVar.f1353d.e0);
                        }
                    }
                }
                ...
                aVar.a(aVar2);
                if (z) {
                    HashMap<String, a> hashMap = aVar.f1355f;
                    ...
                    while (it2.hasNext()) {
                        ...
                        try {
                            switch (aVar3.b.ordinal()) {
                                ...
                                case 1:
                                    it = it2;
                                    cls.getMethod(t, Float.TYPE).invoke(childAt, Float.valueOf(aVar3.f1332d));
                                    break;
                                case 2:
                                    it = it2;
                                    cls.getMethod(t, Integer.TYPE).invoke(childAt, Integer.valueOf(aVar3.f1335g));
                                    break;
                                case 3:
                                    it = it2;
                                    Method method = cls.getMethod(t, Drawable.class);
                                    ColorDrawable colorDrawable = new ColorDrawable();
                                    colorDrawable.setColor(aVar3.f1335g);
                                    method.invoke(childAt, colorDrawable);
                                    break;
                                case 4:
                                    it = it2;
                                    cls.getMethod(t, CharSequence.class).invoke(childAt, aVar3.f1333e);
                                    break;
                                case 5:
                                    it = it2;
                                    cls.getMethod(t, Boolean.TYPE).invoke(childAt, Boolean.valueOf(aVar3.f1334f));
                                    break;
                                case 6:
                                    it = it2;
                                    try {
                ...
                childAt.setAlpha(aVar.b.f1370d);
                childAt.setRotation(aVar.f1354e.b);
                childAt.setRotationX(aVar.f1354e.c);
                childAt.setRotationY(aVar.f1354e.f1372d);
                childAt.setScaleX(aVar.f1354e.f1373e);
                childAt.setScaleY(aVar.f1354e.f1374f);
                if (!Float.isNaN(aVar.f1354e.f1375g)) {
                    childAt.setPivotX(aVar.f1354e.f1375g);
                }
                if (!Float.isNaN(aVar.f1354e.f1376h)) {
                    childAt.setPivotY(aVar.f1354e.f1376h);
                }
                childAt.setTranslationX(aVar.f1354e.f1377i);
                childAt.setTranslationY(aVar.f1354e.f1378j);
                childAt.setTranslationZ(aVar.f1354e.f1379k);
                e eVar = aVar.f1354e;
                if (eVar.f1380l) {
        ...
        while (it3.hasNext()) {
            ...
            int i5 = aVar4.f1353d.d0;
            if (i5 != -1 && i5 == 1) {
                Barrier barrier2 = new Barrier(constraintLayout.getContext());
                barrier2.setId(num.intValue());
                b bVar2 = aVar4.f1353d;
                int[] iArr2 = bVar2.e0;
                if (iArr2 != null) {
                    ...
                    if (str3 != null) {
                        ...
                        barrier2.setReferencedIds(aVar4.f1353d.e0);
                    }
                }
                barrier2.setType(aVar4.f1353d.b0);
                barrier2.setMargin(aVar4.f1353d.c0);
    ...
    public void b(ConstraintLayout constraintLayout) {
        ...
        while (i2 < childCount) {
            ...
            if (!dVar.b || id != -1) {
                ...
                aVar3.f1355f = hashMap2;
                aVar3.b(id, aVar2);
                aVar3.b.b = childAt.getVisibility();
                aVar3.b.f1370d = childAt.getAlpha();
                aVar3.f1354e.b = childAt.getRotation();
                aVar3.f1354e.c = childAt.getRotationX();
                aVar3.f1354e.f1372d = childAt.getRotationY();
                aVar3.f1354e.f1373e = childAt.getScaleX();
                aVar3.f1354e.f1374f = childAt.getScaleY();
                ...
                aVar3.f1354e.f1377i = childAt.getTranslationX();
                aVar3.f1354e.f1378j = childAt.getTranslationY();
                aVar3.f1354e.f1379k = childAt.getTranslationZ();
                e eVar2 = aVar3.f1354e;
                if (eVar2.f1380l) {
                ...
                if (childAt instanceof Barrier) {
                    ...
                    aVar3.f1353d.b0 = barrier.getType();
                    aVar3.f1353d.c0 = barrier.getMargin();
                }
                i2++;
                dVar = this;
            } else {
        ...
        for (int i2 = 0; i2 < indexCount; i2++) {
            ...
            switch (f1352e.get(index)) {
                ...
                case 4:
                    ...
                    continue;
                case 5:
                    aVar.f1353d.w = obtainStyledAttributes.getString(index);
                    continue;
                case 6:
                    b bVar5 = aVar.f1353d;
                ...
                case 17:
                    ...
                    bVar16.f1357e = obtainStyledAttributes.getDimensionPixelOffset(index, bVar16.f1357e);
                    continue;
                case 18:
                    b bVar17 = aVar.f1353d;
                    bVar17.f1358f = obtainStyledAttributes.getDimensionPixelOffset(index, bVar17.f1358f);
                    continue;
                case 19:
                    b bVar18 = aVar.f1353d;
                    bVar18.f1359g = obtainStyledAttributes.getFloat(index, bVar18.f1359g);
                    continue;
                case 20:
                ...
                case 21:
                    ...
                    bVar20.f1356d = obtainStyledAttributes.getLayoutDimension(index, bVar20.f1356d);
                    continue;
                case 22:
                    C0030d dVar = aVar.b;
                    dVar.b = obtainStyledAttributes.getInt(index, dVar.b);
                    C0030d dVar2 = aVar.b;
                    dVar2.b = f1351d[dVar2.b];
                    continue;
                case 23:
                ...
                case 25:
                    ...
                    int resourceId6 = obtainStyledAttributes.getResourceId(index, bVar23.f1360h);
                    if (resourceId6 == -1) {
                        resourceId6 = obtainStyledAttributes.getInt(index, -1);
                    }
                    bVar23.f1360h = resourceId6;
                    continue;
                case 26:
                    b bVar24 = aVar.f1353d;
                    int resourceId7 = obtainStyledAttributes.getResourceId(index, bVar24.f1361i);
                    if (resourceId7 == -1) {
                        resourceId7 = obtainStyledAttributes.getInt(index, -1);
                    }
                    bVar24.f1361i = resourceId7;
                    continue;
                case 27:
                ...
                case 29:
                    ...
                    int resourceId8 = obtainStyledAttributes.getResourceId(index, bVar27.f1362j);
                    if (resourceId8 == -1) {
                        resourceId8 = obtainStyledAttributes.getInt(index, -1);
                    }
                    bVar27.f1362j = resourceId8;
                    continue;
                case 30:
                    b bVar28 = aVar.f1353d;
                    int resourceId9 = obtainStyledAttributes.getResourceId(index, bVar28.f1363k);
                    if (resourceId9 == -1) {
                        resourceId9 = obtainStyledAttributes.getInt(index, -1);
                    }
                    bVar28.f1363k = resourceId9;
                    continue;
                case 31:
                ...
                case 36:
                    ...
                    int resourceId13 = obtainStyledAttributes.getResourceId(index, bVar34.f1364l);
                    if (resourceId13 == -1) {
                        resourceId13 = obtainStyledAttributes.getInt(index, -1);
                    }
                    bVar34.f1364l = resourceId13;
                    continue;
                case 37:
                ...
                case 43:
                    C0030d dVar3 = aVar.b;
                    dVar3.f1370d = obtainStyledAttributes.getFloat(index, dVar3.f1370d);
                    continue;
                case 44:
                    e eVar = aVar.f1354e;
                    eVar.f1380l = true;
                ...
                case 46:
                    e eVar3 = aVar.f1354e;
                    eVar3.f1372d = obtainStyledAttributes.getFloat(index, eVar3.f1372d);
                    continue;
                case 47:
                    e eVar4 = aVar.f1354e;
                    eVar4.f1373e = obtainStyledAttributes.getFloat(index, eVar4.f1373e);
                    continue;
                case 48:
                    e eVar5 = aVar.f1354e;
                    eVar5.f1374f = obtainStyledAttributes.getFloat(index, eVar5.f1374f);
                    continue;
                case 49:
                    e eVar6 = aVar.f1354e;
                    eVar6.f1375g = obtainStyledAttributes.getDimension(index, eVar6.f1375g);
                    continue;
                case 50:
                    e eVar7 = aVar.f1354e;
                    eVar7.f1376h = obtainStyledAttributes.getDimension(index, eVar7.f1376h);
                    continue;
                case 51:
                    e eVar8 = aVar.f1354e;
                    eVar8.f1377i = obtainStyledAttributes.getDimension(index, eVar8.f1377i);
                    continue;
                case 52:
                    e eVar9 = aVar.f1354e;
                    eVar9.f1378j = obtainStyledAttributes.getDimension(index, eVar9.f1378j);
                    continue;
                case 53:
                    e eVar10 = aVar.f1354e;
                    eVar10.f1379k = obtainStyledAttributes.getDimension(index, eVar10.f1379k);
                    continue;
                case 54:
                ...
                case 65:
                    ...
                    continue;
                case 66:
                    aVar.c.f1367e = obtainStyledAttributes.getInt(index, 0);
                    continue;
                case 67:
                    c cVar3 = aVar.c;
                    cVar3.f1369g = obtainStyledAttributes.getFloat(index, cVar3.f1369g);
                    continue;
                case 68:
                    C0030d dVar4 = aVar.b;
                    dVar4.f1371e = obtainStyledAttributes.getFloat(index, dVar4.f1371e);
                    continue;
                case 69:
                    aVar.f1353d.Z = obtainStyledAttributes.getFloat(index, 1.0f);
                    continue;
                case 70:
                    aVar.f1353d.a0 = obtainStyledAttributes.getFloat(index, 1.0f);
                    continue;
                case 71:
                    Log.e("ConstraintSet", "CURRENTLY UNSUPPORTED");
                    continue;
                ...
                case 73:
                    ...
                    continue;
                case 74:
                    aVar.f1353d.f0 = obtainStyledAttributes.getString(index);
                    continue;
                case 75:
                ...
                case 76:
                    c cVar4 = aVar.c;
                    cVar4.f1366d = obtainStyledAttributes.getInt(index, cVar4.f1366d);
                    continue;
                case 77:
                    aVar.f1353d.g0 = obtainStyledAttributes.getString(index);
                    continue;
                case 78:
                    C0030d dVar5 = aVar.b;
                ...
                case 79:
                    c cVar5 = aVar.c;
                    cVar5.f1368f = obtainStyledAttributes.getFloat(index, cVar5.f1368f);
                    continue;
                case 80:
