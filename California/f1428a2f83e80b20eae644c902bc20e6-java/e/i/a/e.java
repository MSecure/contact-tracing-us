...
public final class e {
    ...
    public static final Method f1385d;

    /* renamed from: e  reason: collision with root package name */
    public static final Method f1386e;

    /* renamed from: f  reason: collision with root package name */
    public static final Method f1387f;

    /* renamed from: g  reason: collision with root package name */
    public static final Handler f1388g = new Handler(Looper.getMainLooper());
    ...
    public static final class a implements Application.ActivityLifecycleCallbacks {
        ...
        public void onActivityPaused(Activity activity) {
            if (this.f1390e && !this.f1391f && !this.f1389d) {
                Object obj = this.b;
                boolean z = false;
                try {
                    Object obj2 = e.c.get(activity);
                    if (obj2 == obj) {
                        e.f1388g.postAtFrontOfQueue(new d(e.b.get(activity), obj2));
                        z = true;
                    }
                } catch (Throwable th) {
