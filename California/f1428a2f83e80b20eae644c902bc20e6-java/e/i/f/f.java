...
public class f {
    ...
    public Handler.Callback f1450e = new a();
    ...
    public class b implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ ReentrantLock f1451d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ AtomicBoolean f1452e;

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ Condition f1453f;
        ...
        public b(f fVar, AtomicReference atomicReference, Callable callable, ReentrantLock reentrantLock, AtomicBoolean atomicBoolean, Condition condition) {
            ...
            this.c = callable;
            this.f1451d = reentrantLock;
            this.f1452e = atomicBoolean;
            this.f1453f = condition;
        }
    ...
    public final void a(Runnable runnable) {
        synchronized (this.a) {
            if (this.b == null) {
                ...
                handlerThread.start();
                this.c = new Handler(this.b.getLooper(), this.f1450e);
                this.f1449d++;
            }
