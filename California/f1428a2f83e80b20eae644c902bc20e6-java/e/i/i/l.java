...
public class l {
    ...
    public static boolean f1468d = false;

    /* renamed from: e  reason: collision with root package name */
    public static ThreadLocal<Rect> f1469e;

    /* renamed from: f  reason: collision with root package name */
    public static final int[] f1470f = {R$id.accessibility_custom_action_0, R$id.accessibility_custom_action_1, R$id.accessibility_custom_action_2, R$id.accessibility_custom_action_3, R$id.accessibility_custom_action_4, R$id.accessibility_custom_action_5, R$id.accessibility_custom_action_6, R$id.accessibility_custom_action_7, R$id.accessibility_custom_action_8, R$id.accessibility_custom_action_9, R$id.accessibility_custom_action_10, R$id.accessibility_custom_action_11, R$id.accessibility_custom_action_12, R$id.accessibility_custom_action_13, R$id.accessibility_custom_action_14, R$id.accessibility_custom_action_15, R$id.accessibility_custom_action_16, R$id.accessibility_custom_action_17, R$id.accessibility_custom_action_18, R$id.accessibility_custom_action_19, R$id.accessibility_custom_action_20, R$id.accessibility_custom_action_21, R$id.accessibility_custom_action_22, R$id.accessibility_custom_action_23, R$id.accessibility_custom_action_24, R$id.accessibility_custom_action_25, R$id.accessibility_custom_action_26, R$id.accessibility_custom_action_27, R$id.accessibility_custom_action_28, R$id.accessibility_custom_action_29, R$id.accessibility_custom_action_30, R$id.accessibility_custom_action_31};
    ...
    public class a implements View.OnApplyWindowInsetsListener {
        ...
        public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
            return this.a.a(view, v.h(windowInsets, view)).f();
        }
    }
    ...
    public static class d {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final ArrayList<WeakReference<View>> f1472d = new ArrayList<>();
    ...
    public static boolean e(View view, KeyEvent keyEvent) {
        ...
        ArrayList<WeakReference<View>> arrayList = d.f1472d;
        ...
        if (keyEvent.getAction() == 0) {
            ...
            ArrayList<WeakReference<View>> arrayList2 = d.f1472d;
            if (!arrayList2.isEmpty()) {
                synchronized (arrayList2) {
                    ...
                    while (true) {
                        ...
                        ArrayList<WeakReference<View>> arrayList3 = d.f1472d;
    ...
    public static a f(View view) {
        ...
        return g2 instanceof a.C0034a ? ((a.C0034a) g2).a : new a(g2);
    }
    ...
    public static Rect i() {
        if (f1469e == null) {
            f1469e = new ThreadLocal<>();
        }
        Rect rect = f1469e.get();
        if (rect == null) {
            rect = new Rect();
            f1469e.set(rect);
        }
    ...
    public static void k(View view, int i2) {
        if (((AccessibilityManager) view.getContext().getSystemService("accessibility")).isEnabled()) {
            boolean z = ((CharSequence) new n(R$id.tag_accessibility_pane_title, CharSequence.class, 8, 28).c(view)) != null;
    ...
    public static void p(View view, b.a aVar, CharSequence charSequence, e.i.i.w.d dVar) {
        if (dVar == null) {
            o(aVar.a(), view);
            k(view, 0);
            return;
    ...
    public static void r(View view, a aVar) {
        if (aVar == null && (g(view) instanceof a.C0034a)) {
            aVar = new a();
        }
