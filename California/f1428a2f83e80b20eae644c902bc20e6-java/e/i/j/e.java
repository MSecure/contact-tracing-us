    ...
    public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        ...
        if (!this.f1513f) {
            ...
            try {
                ...
                this.c = cls;
                this.f1511d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                this.f1512e = true;
        ...
        Method declaredMethod = (!this.f1512e || !this.c.isInstance(menu)) ? menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE) : this.f1511d;
