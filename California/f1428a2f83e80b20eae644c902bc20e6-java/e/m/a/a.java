...
public final class a extends l0 implements c0.m {
    ...
    public static boolean n(l0.a aVar) {
        l lVar = aVar.b;
        return lVar != null && lVar.f1626l && lVar.F != null && !lVar.A && !lVar.z && lVar.F();
    }
    ...
    public boolean a(ArrayList<a> arrayList, ArrayList<Boolean> arrayList2) {
        ...
        c0 c0Var = this.q;
        if (c0Var.f1571d == null) {
            c0Var.f1571d = new ArrayList<>();
        }
        c0Var.f1571d.add(this);
        return true;
    }
    ...
    public int h(boolean z) {
        if (!this.r) {
            ...
            this.r = true;
            this.s = this.f1639g ? this.q.f1576i.getAndIncrement() : -1;
            this.q.B(this, z);
            return this.s;
        }
    ...
    public void i(String str, PrintWriter printWriter, boolean z) {
        ...
        if (z) {
            ...
            if (this.f1638f != 0) {
                ...
                printWriter.print(Integer.toHexString(this.f1638f));
            }
            ...
            if (!(this.f1636d == 0 && this.f1637e == 0)) {
                printWriter.print(str);
                printWriter.print("mPopEnterAnim=#");
                printWriter.print(Integer.toHexString(this.f1636d));
                printWriter.print(" mPopExitAnim=#");
                printWriter.println(Integer.toHexString(this.f1637e));
            }
            if (!(this.f1642j == 0 && this.f1643k == null)) {
                printWriter.print(str);
                printWriter.print("mBreadCrumbTitleRes=#");
                printWriter.print(Integer.toHexString(this.f1642j));
                printWriter.print(" mBreadCrumbTitleText=");
                printWriter.println(this.f1643k);
            }
            if (!(this.f1644l == 0 && this.m == null)) {
                printWriter.print(str);
                printWriter.print("mBreadCrumbShortTitleRes=#");
                printWriter.print(Integer.toHexString(this.f1644l));
        ...
        if (!this.a.isEmpty()) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (z) {
                    if (!(aVar.c == 0 && aVar.f1645d == 0)) {
                        printWriter.print(str);
                        printWriter.print("enterAnim=#");
                        printWriter.print(Integer.toHexString(aVar.c));
                        printWriter.print(" exitAnim=#");
                        printWriter.println(Integer.toHexString(aVar.f1645d));
                    }
                    if (aVar.f1646e != 0 || aVar.f1647f != 0) {
                        printWriter.print(str);
                        printWriter.print("popEnterAnim=#");
                        printWriter.print(Integer.toHexString(aVar.f1646e));
                        printWriter.print(" popExitAnim=#");
                        printWriter.println(Integer.toHexString(aVar.f1647f));
                    }
                }
            }
        }
    ...
    public void j() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (lVar != null) {
                ...
                lVar.f();
                l.b bVar = lVar.I;
                bVar.f1628e = arrayList;
                bVar.f1629f = arrayList2;
            }
            switch (aVar.a) {
                case 1:
                    lVar.u0(aVar.c);
    ...
    public l0 p(l lVar, g.b bVar) {
        if (lVar.s == this.q) {
            g.b bVar2 = g.b.CREATED;
            if (bVar.compareTo(bVar2) >= 0) {
                b(new l0.a(10, lVar, bVar));
                return this;
            }
