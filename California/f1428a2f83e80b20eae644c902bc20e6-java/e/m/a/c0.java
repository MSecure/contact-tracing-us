...
public abstract class c0 {
    ...
    public ArrayList<a> f1571d;

    /* renamed from: e  reason: collision with root package name */
    public ArrayList<l> f1572e;

    /* renamed from: f  reason: collision with root package name */
    public final a0 f1573f = new a0(this);

    /* renamed from: g  reason: collision with root package name */
    public OnBackPressedDispatcher f1574g;

    /* renamed from: h  reason: collision with root package name */
    public final e.a.b f1575h = new c(false);

    /* renamed from: i  reason: collision with root package name */
    public final AtomicInteger f1576i = new AtomicInteger();

    /* renamed from: j  reason: collision with root package name */
    public final Map<String, Bundle> f1577j = Collections.synchronizedMap(new HashMap());

    /* renamed from: k  reason: collision with root package name */
    public final Map<String, Object> f1578k = Collections.synchronizedMap(new HashMap());

    /* renamed from: l  reason: collision with root package name */
    public Map<l, HashSet<e.i.e.a>> f1579l = Collections.synchronizedMap(new HashMap());
    ...
    public class d implements s0.a {
        ...
        public void a(l lVar, e.i.e.a aVar) {
            if (!aVar.b()) {
                c0 c0Var = c0.this;
                HashSet<e.i.e.a> hashSet = c0Var.f1579l.get(lVar);
                if (hashSet != null && hashSet.remove(aVar) && hashSet.isEmpty()) {
                    c0Var.f1579l.remove(lVar);
                    if (lVar.b < 5) {
                        c0Var.j(lVar);
        ...
        public void b(l lVar, e.i.e.a aVar) {
            c0 c0Var = c0.this;
            if (c0Var.f1579l.get(lVar) == null) {
                c0Var.f1579l.put(lVar, new HashSet<>());
            }
            c0Var.f1579l.get(lVar).add(aVar);
        }
    }
    ...
    public final void A() {
        ...
        } else if (!this.f1579l.isEmpty()) {
            for (l lVar : this.f1579l.keySet()) {
                e(lVar);
                X(lVar);
            }
        }
    ...
    public final void C(boolean z2) {
        if (this.b) {
            ...
            throw new IllegalStateException("FragmentManager has not been attached to a host.");
        } else if (Looper.myLooper() != this.q.f1693d.getLooper()) {
        ...
        while (true) {
            ...
            synchronized (this.a) {
                if (this.a.isEmpty()) {
                    ...
                    this.a.clear();
                    this.q.f1693d.removeCallbacks(this.K);
                }
            }
            if (z3) {
                this.b = true;
                            ...
                            if (i13 == 2) {
                                ...
                                while (size >= 0) {
                                    ...
                                    if (lVar3.x != i14) {
                                        ...
                                        aVar3.c = aVar2.c;
                                        aVar3.f1646e = aVar2.f1646e;
                                        aVar3.f1645d = aVar2.f1645d;
                                        aVar3.f1647f = aVar2.f1647f;
    ...
    public void V(l lVar) {
        ...
        if (this.c.c(lVar.f1620f)) {
            ...
            if (!(view == null || !lVar.J || lVar.E == null)) {
                ...
                lVar.L = 0.0f;
                lVar.J = false;
                s z0 = m.h.z0(this.q.c, lVar, true);
                if (z0 != null) {
                    Animation animation = z0.a;
                    if (animation != null) {
                        lVar.F.startAnimation(animation);
                    } else {
                        z0.b.setTarget(lVar.F);
                        z0.b.start();
                    }
                }
            }
            if (lVar.K) {
                if (lVar.F != null) {
                    s z02 = m.h.z0(this.q.c, lVar, !lVar.z);
                    if (z02 == null || (animator = z02.b) == null) {
                        if (z02 != null) {
                            lVar.F.startAnimation(z02.a);
                            z02.a.start();
                        }
                        ...
                        if (!lVar.z) {
                            ...
                            z02.b.addListener(new d0(this, viewGroup, view2, lVar));
                        }
                        z02.b.start();
                    }
                }
                if (lVar.f1626l && R(lVar)) {
                    this.A = true;
                }
                lVar.K = false;
                lVar.U();
    ...
    public void W(int i2, boolean z2) {
        ...
        if (this.q == null && i2 != -1) {
            ...
            if (L) {
                ...
                while (it.hasNext()) {
                    j0 j0Var = k0Var.b.get(it.next().f1620f);
                    if (j0Var != null) {
                        j0Var.j();
                    }
                }
                ...
                if (i5 != 1) {
                    if (i5 != 2) {
                        ...
                        if (min < 4) {
                            ...
                            if (lVar.F != null && this.q.l(lVar) && lVar.f1618d == null) {
                                i3.o();
                            }
                        }
                    }
                        ...
                        if (!(view == null || (viewGroup = lVar.E) == null)) {
                            ...
                            if (!lVar.G()) {
                                if (this.p > -1 && !this.D && lVar.F.getVisibility() == 0 && lVar.L >= 0.0f) {
                                    sVar = m.h.z0(this.q.c, lVar, false);
                                }
                                lVar.L = 0.0f;
        ...
        if (this.q == null) {
            ...
            if (lVar != null) {
                ...
                if (zVar instanceof e.a.c) {
                    ...
                    b2.a(jVar, this.f1575h);
                }
                if (lVar == null) {
                    g0 g0Var = lVar.s.J;
                    g0 g0Var2 = g0Var.f1596d.get(lVar.f1620f);
                    if (g0Var2 == null) {
                        g0Var2 = new g0(g0Var.f1598f);
                        g0Var.f1596d.put(lVar.f1620f, g0Var2);
                    }
                    this.J = g0Var2;
                ...
                if (!(zVar2 instanceof e.a.e.e)) {
                    ...
                    String t3 = f.a.a.a.a.t("FragmentManager:", lVar != null ? f.a.a.a.a.e(new StringBuilder(), lVar.f1620f, ":") : "");
    ...
    public boolean c0(ArrayList<a> arrayList, ArrayList<Boolean> arrayList2, String str, int i2, int i3) {
        ...
        ArrayList<a> arrayList3 = this.f1571d;
        if (arrayList3 == null) {
            return false;
        }
        if (str == null && i2 < 0 && (i3 & 1) == 0) {
            ...
            if (str != null || i2 >= 0) {
                ...
                while (size2 >= 0) {
                    a aVar = this.f1571d.get(size2);
                    if ((str != null && str.equals(aVar.f1641i)) || (i2 >= 0 && i2 == aVar.s)) {
                        break;
                    }
                    size2--;
                }
                ...
                if ((i3 & 1) != 0) {
                    while (true) {
                        ...
                        a aVar2 = this.f1571d.get(size2);
                        if ((str == null || !str.equals(aVar2.f1641i)) && (i2 < 0 || i2 != aVar2.s)) {
                            break;
                        }
                    }
                }
            ...
            if (i4 == this.f1571d.size() - 1) {
                return false;
            }
            for (int size3 = this.f1571d.size() - 1; size3 > i4; size3--) {
                arrayList.add(this.f1571d.remove(size3));
                arrayList2.add(bool);
            }
        }
        return true;
    ...
    public void d0(Bundle bundle, String str, l lVar) {
        if (lVar.s == this) {
            bundle.putString(str, lVar.f1620f);
        } else {
    ...
    public final void e(l lVar) {
        HashSet<e.i.e.a> hashSet = this.f1579l.get(lVar);
        if (hashSet != null) {
    ...
    public void g0(Parcelable parcelable) {
        ...
        if (parcelable != null) {
            ...
            if (f0Var.b != null) {
                ...
                if (f0Var.f1589d != null) {
                    this.f1571d = new ArrayList<>(f0Var.f1589d.length);
                    int i2 = 0;
                    while (true) {
                        b[] bVarArr = f0Var.f1589d;
                        ...
                        while (true) {
                            ...
                            aVar2.f1648g = g.b.values()[bVar.f1562d[i4]];
                            aVar2.f1649h = g.b.values()[bVar.f1563e[i4]];
                            int[] iArr2 = bVar.b;
                            int i6 = i5 + 1;
                            int i7 = iArr2[i5];
                            aVar2.c = i7;
                        ...
                        aVar.f1638f = bVar.f1564f;
                        aVar.f1641i = bVar.f1565g;
                        aVar.s = bVar.f1566h;
                        aVar.f1639g = true;
                        aVar.f1642j = bVar.f1567i;
                        aVar.f1643k = bVar.f1568j;
                        aVar.f1644l = bVar.f1569k;
                        aVar.m = bVar.f1570l;
                        aVar.n = bVar.m;
                        aVar.o = bVar.n;
                        aVar.p = bVar.o;
                ...
                this.f1576i.set(f0Var.f1590e);
                String str8 = f0Var.f1591f;
                if (str8 != null) {
                    l H2 = H(str8);
                    this.t = H2;
                    u(H2);
                }
                ArrayList<String> arrayList2 = f0Var.f1592g;
                if (arrayList2 != null) {
                    for (int i13 = 0; i13 < arrayList2.size(); i13++) {
                        this.f1577j.put(arrayList2.get(i13), f0Var.f1593h.get(i13));
                    }
                }
                this.z = new ArrayDeque<>(f0Var.f1594i);
            }
        }
    }
    ...
    public Parcelable h0() {
        ...
        for (j0 j0Var : k0Var.b.values()) {
            if (j0Var != null) {
                ...
                if (lVar2.b <= -1 || i0Var.n != null) {
                    ...
                    Bundle n2 = j0Var.n();
                    i0Var.n = n2;
                    if (j0Var.c.f1623i != null) {
                        if (n2 == null) {
                            i0Var.n = new Bundle();
                        }
                        i0Var.n.putString("android:target_state", j0Var.c.f1623i);
                        int i2 = j0Var.c.f1624j;
                        if (i2 != 0) {
        ...
        synchronized (k0Var2.a) {
            if (k0Var2.a.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    l next = it2.next();
                    arrayList.add(next.f1620f);
                    if (Q(2)) {
                        String str2 = "saveAllState: adding fragment (" + next.f1620f + "): " + next;
                    }
                }
            }
        }
        ...
        if (arrayList3 != null && (size = arrayList3.size()) > 0) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                bVarArr[i3] = new b(this.f1571d.get(i3));
                if (Q(2)) {
                    String str3 = "saveAllState: adding back stack #" + i3 + ": " + this.f1571d.get(i3);
                }
            }
        }
        f0 f0Var = new f0();
        f0Var.b = arrayList2;
        f0Var.c = arrayList;
        f0Var.f1589d = bVarArr;
        f0Var.f1590e = this.f1576i.get();
        l lVar3 = this.t;
        if (lVar3 != null) {
            f0Var.f1591f = lVar3.f1620f;
        }
        f0Var.f1592g.addAll(this.f1577j.keySet());
        f0Var.f1593h.addAll(this.f1577j.values());
        f0Var.f1594i = new ArrayList<>(this.z);
        return f0Var;
    }

    public j0 i(l lVar) {
        j0 i2 = this.c.i(lVar.f1620f);
        if (i2 != null) {
            return i2;
        }
    ...
    public void k0(l lVar, g.b bVar) {
        if (!lVar.equals(H(lVar.f1620f)) || !(lVar.t == null || lVar.s == this)) {
    ...
    public void l0(l lVar) {
        if (lVar == null || (lVar.equals(H(lVar.f1620f)) && (lVar.t == null || lVar.s == this))) {
            l lVar2 = this.t;
            this.t = lVar;
            u(lVar2);
            u(this.t);
    ...
    public boolean o(Menu menu, MenuInflater menuInflater) {
        ...
        if (this.f1572e != null) {
            for (int i2 = 0; i2 < this.f1572e.size(); i2++) {
                l lVar2 = this.f1572e.get(i2);
    ...
    public final void u(l lVar) {
        if (lVar != null && lVar.equals(H(lVar.f1620f))) {
            boolean T = lVar.s.T(lVar);
            Boolean bool = lVar.f1625k;
            if (bool == null || bool.booleanValue() != T) {
                lVar.f1625k = Boolean.valueOf(T);
                lVar.a0(T);
                c0 c0Var = lVar.u;
                c0Var.q0();
                c0Var.u(c0Var.t);
    ...
    public void z(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (!k0Var.b.isEmpty()) {
            ...
            for (j0 j0Var : k0Var.b.values()) {
                ...
                if (j0Var != null) {
                    ...
                    printWriter.print(lVar.f1620f);
                    printWriter.print(" mBackStackNesting=");
                    printWriter.println(lVar.r);
                    printWriter.print(str3);
                    printWriter.print("mAdded=");
                    printWriter.print(lVar.f1626l);
                    ...
                    if (lVar.f1621g != null) {
                        ...
                        printWriter.println(lVar.f1621g);
                    }
                    if (lVar.c != null) {
                        printWriter.print(str3);
                    ...
                    if (lVar.f1618d != null) {
                        ...
                        printWriter.println(lVar.f1618d);
                    }
                    if (lVar.f1619e != null) {
                        printWriter.print(str3);
                        printWriter.print("mSavedViewRegistryState=");
                        printWriter.println(lVar.f1619e);
                    }
                    Object obj = lVar.f1622h;
                    if (obj == null) {
                        c0 c0Var = lVar.s;
                        obj = (c0Var == null || (str2 = lVar.f1623i) == null) ? null : c0Var.c.d(str2);
                    }
                    if (obj != null) {
                        printWriter.print(str3);
                        ...
                        printWriter.println(lVar.f1624j);
                    }
                    if (lVar.s() != 0) {
                        printWriter.print(str3);
        ...
        ArrayList<l> arrayList = this.f1572e;
        if (arrayList != null && (size2 = arrayList.size()) > 0) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                printWriter.print(": ");
                printWriter.println(this.f1572e.get(i3).toString());
            }
        }
        ArrayList<a> arrayList2 = this.f1571d;
        if (arrayList2 != null && (size = arrayList2.size()) > 0) {
            printWriter.print(str);
            printWriter.println("Back Stack:");
            for (int i4 = 0; i4 < size; i4++) {
                a aVar = this.f1571d.get(i4);
                printWriter.print(str);
                printWriter.print("  #");
        ...
        printWriter.print(str);
        printWriter.println("Back Stack Index: " + this.f1576i.get());
        synchronized (this.a) {
