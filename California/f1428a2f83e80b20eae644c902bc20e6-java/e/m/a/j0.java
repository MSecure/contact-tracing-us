...
public class j0 {
    ...
    public e.i.e.a f1615f;

    /* renamed from: g  reason: collision with root package name */
    public e.i.e.a f1616g;

    /* renamed from: h  reason: collision with root package name */
    public e.i.e.a f1617h;
    ...
    public j0(b0 b0Var, k0 k0Var, l lVar, i0 i0Var) {
        ...
        lVar.f1626l = false;
        l lVar2 = lVar.f1622h;
        lVar.f1623i = lVar2 != null ? lVar2.f1620f : null;
        lVar.f1622h = null;
    ...
    public void a() {
        ...
        if (lVar.D) {
            ...
            if (view != null) {
                ...
                SparseArray<Parcelable> sparseArray = lVar.f1618d;
                if (sparseArray != null) {
                    view.restoreHierarchyState(sparseArray);
                    lVar.f1618d = null;
                }
                if (lVar.F != null) {
                    lVar.Q.c.a(lVar.f1619e);
                    lVar.f1619e = null;
                }
                lVar.D = false;
                lVar.h0(bundle2);
    ...
    public void b() {
        ...
        j0 j0Var = null;
        if (lVar2 != null) {
            j0 i2 = this.b.i(lVar2.f1620f);
            if (i2 != null) {
                l lVar3 = this.c;
                lVar3.f1623i = lVar3.f1622h.f1620f;
                lVar3.f1622h = null;
                j0Var = i2;
            } else {
    ...
    public int c() {
        ...
        z0.d.b bVar = null;
        if (c0.L && (viewGroup = (lVar = this.c).E) != null && (dVar = z0.e(viewGroup, lVar.t().O()).c.get(this.c)) != null && !dVar.f1698d.b()) {
            bVar = dVar.b;
        }
    ...
    public void e() {
        ...
        if (!this.c.n) {
            ...
            if (view != null) {
                ...
                if (c0.L) {
                    this.c.f().f1633j = visibility;
                    l lVar9 = this.c;
                    if (lVar9.E != null && visibility == 0) {
                        lVar9.f().f1634k = lVar9.F.findFocus();
    ...
    public void f() {
        ...
        if (z2 || this.b.c.d(this.c)) {
            ...
            if (z2 || z) {
                ...
                g0 g0Var2 = g0Var.f1596d.get(lVar2.f1620f);
                if (g0Var2 != null) {
                    g0Var2.a();
                    g0Var.f1596d.remove(lVar2.f1620f);
                }
                c0 c0Var = g0Var.f1597e.get(lVar2.f1620f);
                if (c0Var != null) {
                    c0Var.a();
                    g0Var.f1597e.remove(lVar2.f1620f);
                }
            }
            l lVar3 = this.c;
            lVar3.u.p();
            ...
            while (it.hasNext()) {
                ...
                if (j0Var != null) {
                    l lVar4 = j0Var.c;
                    if (this.c.f1620f.equals(lVar4.f1623i)) {
                        lVar4.f1622h = this.c;
                        lVar4.f1623i = null;
                    }
                }
            ...
            l lVar5 = this.c;
            String str2 = lVar5.f1623i;
            if (str2 != null) {
                lVar5.f1622h = this.b.d(str2);
            }
            this.b.l(this);
            return;
        }
        String str3 = this.c.f1623i;
    ...
    public void h() {
        ...
        if (lVar.D) {
            ...
            if ((lVar2.m && !lVar2.E()) || this.b.c.d(this.c)) {
                ...
                lVar3.P = new k(lVar3);
                lVar3.T = new b(lVar3);
                lVar3.f1620f = UUID.randomUUID().toString();
                lVar3.f1626l = false;
                lVar3.m = false;
                lVar3.n = false;
                lVar3.o = false;
                    ...
                    if (c2 == i2) {
                        ...
                        switch (i3) {
                            ...
                            case 4:
                                ...
                                if (!(view == null || lVar4.E == null)) {
                                    ...
                                    e.i.e.a aVar4 = this.f1616g;
                                    if (aVar4 != null) {
                                        aVar4.a();
                                    }
                                    this.f1615f = new e.i.e.a();
                                    l.b bVar2 = this.c.I;
                                    e3.a(z0.d.c.b(bVar2 == null ? 0 : bVar2.f1633j), z0.d.b.ADDING, this, this.f1615f);
                                }
                                this.c.b = 4;
                                continue;
                            case 5:
                        ...
                        switch (i4) {
                            ...
                            case 3:
                                ...
                                l lVar7 = this.c;
                                if (lVar7.F != null && lVar7.f1618d == null) {
                                    o();
                                }
                                l lVar8 = this.c;
                                if (!(lVar8.F == null || (viewGroup = lVar8.E) == null || this.f1614e <= -1)) {
                                    z0 e4 = z0.e(viewGroup, lVar8.t().O());
                                    e.i.e.a aVar6 = this.f1616g;
                                    if (aVar6 != null) {
                                        aVar6.a();
                                    }
    ...
    public void l(ClassLoader classLoader) {
        ...
        if (bundle != null) {
            bundle.setClassLoader(classLoader);
            l lVar = this.c;
            lVar.f1618d = lVar.c.getSparseParcelableArray("android:view_state");
            l lVar2 = this.c;
            lVar2.f1619e = lVar2.c.getBundle("android:view_registry_state");
            l lVar3 = this.c;
            lVar3.f1623i = lVar3.c.getString("android:target_state");
            l lVar4 = this.c;
            if (lVar4.f1623i != null) {
                lVar4.f1624j = lVar4.c.getInt("android:target_req_state", 0);
            }
            l lVar5 = this.c;
    ...
    public final Bundle n() {
        ...
        if (this.c.f1618d != null) {
            if (bundle == null) {
                bundle = new Bundle();
            }
            bundle.putSparseParcelableArray("android:view_state", this.c.f1618d);
        }
        if (this.c.f1619e != null) {
            if (bundle == null) {
                bundle = new Bundle();
            }
            bundle.putBundle("android:view_registry_state", this.c.f1619e);
        }
        if (!this.c.H) {
            if (bundle == null) {
                bundle = new Bundle();
    ...
    public void o() {
        if (this.c.F != null) {
            ...
            if (sparseArray.size() > 0) {
                this.c.f1618d = sparseArray;
            }
            Bundle bundle = new Bundle();
            this.c.Q.c.b(bundle);
            if (!bundle.isEmpty()) {
                this.c.f1619e = bundle;
            }
        }
    }
