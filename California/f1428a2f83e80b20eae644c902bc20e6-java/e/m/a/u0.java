...
public abstract class u0 {
    ...
    public class a implements Runnable {
        ...
        public final /* synthetic */ ArrayList f1689d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ ArrayList f1690e;

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ ArrayList f1691f;
        ...
        public a(u0 u0Var, int i2, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
            ...
            this.f1690e = arrayList3;
            this.f1691f = arrayList4;
        }

        public void run() {
            for (int i2 = 0; i2 < this.b; i2++) {
                AtomicInteger atomicInteger = l.a;
                ((View) this.c.get(i2)).setTransitionName((String) this.f1689d.get(i2));
                ((View) this.f1690e.get(i2)).setTransitionName((String) this.f1691f.get(i2));
            }
        }
    }
