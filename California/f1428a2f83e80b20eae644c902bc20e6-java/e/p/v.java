...
public final class v extends b0.c {
    ...
    public static final Class<?>[] f1719f = {Application.class, u.class};

    /* renamed from: g  reason: collision with root package name */
    public static final Class<?>[] f1720g = {u.class};
    ...
    public void b(a0 a0Var) {
        SavedStateHandleController.h(a0Var, this.f1722e, this.f1721d);
    }
    ...
    public <T extends a0> T c(String str, Class<T> cls) {
        ...
        Constructor d2 = (!isAssignableFrom || this.a == null) ? d(cls, f1720g) : d(cls, f1719f);
        if (d2 == null) {
            return (T) this.b.a(cls);
        }
        SavedStateHandleController j2 = SavedStateHandleController.j(this.f1722e, this.f1721d, str, this.c);
        if (isAssignableFrom) {
            try {
