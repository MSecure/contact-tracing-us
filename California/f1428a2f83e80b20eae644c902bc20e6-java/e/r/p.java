...
public abstract class p<T> {
    ...
    public static final p<int[]> f1762d = new e(true);

    /* renamed from: e  reason: collision with root package name */
    public static final p<Long> f1763e = new f(false);

    /* renamed from: f  reason: collision with root package name */
    public static final p<long[]> f1764f = new g(true);

    /* renamed from: g  reason: collision with root package name */
    public static final p<Float> f1765g = new h(false);

    /* renamed from: h  reason: collision with root package name */
    public static final p<float[]> f1766h = new i(true);

    /* renamed from: i  reason: collision with root package name */
    public static final p<Boolean> f1767i = new j(false);

    /* renamed from: j  reason: collision with root package name */
    public static final p<boolean[]> f1768j = new k(true);

    /* renamed from: k  reason: collision with root package name */
    public static final p<String> f1769k = new a(true);

    /* renamed from: l  reason: collision with root package name */
    public static final p<String[]> f1770l = new b(true);
    ...
    public static final class l<D extends Enum> extends C0047p<D> {
    ...
    public static class C0047p<D extends Serializable> extends p<D> {
        public final Class<D> m;

        public C0047p(Class<D> cls) {
            super(true);
            if (!Serializable.class.isAssignableFrom(cls)) {
                throw new IllegalArgumentException(cls + " does not implement Serializable.");
            } else if (!cls.isEnum()) {
        ...
        public C0047p(boolean z, Class<D> cls) {
            super(z);
            if (Serializable.class.isAssignableFrom(cls)) {
                this.m = cls;
                return;
        ...
        public boolean equals(Object obj) {
            ...
            return this.m.equals(((C0047p) obj).m);
        }
