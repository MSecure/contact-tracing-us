...
public class c extends v {
    ...
    public ArrayList<RecyclerView.b0> f1777h = new ArrayList<>();

    /* renamed from: i  reason: collision with root package name */
    public ArrayList<RecyclerView.b0> f1778i = new ArrayList<>();

    /* renamed from: j  reason: collision with root package name */
    public ArrayList<e> f1779j = new ArrayList<>();

    /* renamed from: k  reason: collision with root package name */
    public ArrayList<d> f1780k = new ArrayList<>();

    /* renamed from: l  reason: collision with root package name */
    public ArrayList<ArrayList<RecyclerView.b0>> f1781l = new ArrayList<>();
        ...
        public void run() {
            ...
            while (it.hasNext()) {
                ...
                if (view2 != null) {
                    ...
                    cVar.r.add(dVar.a);
                    duration.translationX((float) (dVar.f1783e - dVar.c));
                    duration.translationY((float) (dVar.f1784f - dVar.f1782d));
    ...
    public static class d {
        ...
        public String toString() {
            ...
            h2.append(this.c);
            h2.append(", fromY=");
            h2.append(this.f1782d);
            h2.append(", toX=");
            h2.append(this.f1783e);
            h2.append(", toY=");
            h2.append(this.f1784f);
            h2.append('}');
            return h2.toString();
        }
    }
    ...
    public void i(RecyclerView.b0 b0Var) {
        ...
        while (true) {
            ...
            if (size < 0) {
                break;
            } else if (this.f1779j.get(size).a == b0Var) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                g(b0Var);
                this.f1779j.remove(size);
            }
        }
        r(this.f1780k, b0Var);
        if (this.f1777h.remove(b0Var)) {
            view.setAlpha(1.0f);
            g(b0Var);
        }
        if (this.f1778i.remove(b0Var)) {
            view.setAlpha(1.0f);
            g(b0Var);
        }
        ...
        int size5 = this.f1781l.size();
        while (true) {
            size5--;
            if (size5 >= 0) {
                ArrayList<RecyclerView.b0> arrayList3 = this.f1781l.get(size5);
                if (arrayList3.remove(b0Var)) {
                    view.setAlpha(1.0f);
                    g(b0Var);
                    if (arrayList3.isEmpty()) {
                        this.f1781l.remove(size5);
                    }
                }
            } else {
                this.q.remove(b0Var);
    ...
    public void j() {
        ...
        int size2 = this.f1777h.size();
        while (true) {
            size2--;
            if (size2 < 0) {
                break;
            }
            g(this.f1777h.get(size2));
            this.f1777h.remove(size2);
        }
        int size3 = this.f1778i.size();
        while (true) {
            size3--;
            if (size3 < 0) {
                break;
            }
            RecyclerView.b0 b0Var = this.f1778i.get(size3);
            b0Var.a.setAlpha(1.0f);
            g(b0Var);
            this.f1778i.remove(size3);
        }
        int size4 = this.f1780k.size();
        while (true) {
            size4--;
            if (size4 < 0) {
                break;
            }
            d dVar = this.f1780k.get(size4);
        ...
        if (k()) {
            ...
            int size7 = this.f1781l.size();
            while (true) {
                size7--;
                if (size7 < 0) {
                    break;
                }
                ArrayList<RecyclerView.b0> arrayList2 = this.f1781l.get(size7);
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.j
    public boolean k() {
        return !this.f1778i.isEmpty() || !this.f1780k.isEmpty() || !this.f1779j.isEmpty() || !this.f1777h.isEmpty() || !this.p.isEmpty() || !this.q.isEmpty() || !this.o.isEmpty() || !this.r.isEmpty() || !this.m.isEmpty() || !this.f1781l.isEmpty() || !this.n.isEmpty();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.j
    public void m() {
        boolean z = !this.f1777h.isEmpty();
        boolean z2 = !this.f1779j.isEmpty();
        boolean z3 = !this.f1780k.isEmpty();
        boolean z4 = !this.f1778i.isEmpty();
        if (z || z2 || z4 || z3) {
            Iterator<RecyclerView.b0> it = this.f1777h.iterator();
            while (it.hasNext()) {
            ...
            if (z4) {
                ...
                arrayList3.addAll(this.f1778i);
                this.f1781l.add(arrayList3);
                this.f1778i.clear();
    ...
    public boolean n(RecyclerView.b0 b0Var, int i2, int i3, int i4, int i5) {
        ...
        this.f1779j.add(new e(b0Var, translationX, translationY, i4, i5));
        return true;
    }
