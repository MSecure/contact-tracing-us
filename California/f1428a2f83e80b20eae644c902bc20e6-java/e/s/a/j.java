...
public final class j implements Runnable {
    ...
    public static final ThreadLocal<j> f1803f = new ThreadLocal<>();

    /* renamed from: g  reason: collision with root package name */
    public static Comparator<c> f1804g = new a();
    ...
    public ArrayList<c> f1806e = new ArrayList<>();
    ...
    public static class a implements Comparator<c> {
        ...
        public int compare(c cVar, c cVar2) {
            c cVar3 = cVar;
            c cVar4 = cVar2;
            RecyclerView recyclerView = cVar3.f1808d;
            int i2 = 1;
            if ((recyclerView == null) == (cVar4.f1808d == null)) {
                boolean z = cVar3.a;
                if (z == cVar4.a) {
    ...
    public void b(long j2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            if (recyclerView3.getWindowVisibility() == 0) {
                ...
                i2 += recyclerView3.h0.f1807d;
            }
        }
        this.f1806e.ensureCapacity(i2);
        int i4 = 0;
        for (int i5 = 0; i5 < size; i5++) {
            ...
            if (recyclerView4.getWindowVisibility() == 0) {
                ...
                for (int i6 = 0; i6 < bVar.f1807d * 2; i6 += 2) {
                    if (i4 >= this.f1806e.size()) {
                        cVar2 = new c();
                        this.f1806e.add(cVar2);
                    } else {
                        cVar2 = this.f1806e.get(i4);
                    }
                    int[] iArr = bVar.c;
                    int i7 = iArr[i6 + 1];
                    cVar2.a = i7 <= abs;
                    cVar2.b = abs;
                    cVar2.c = i7;
                    cVar2.f1808d = recyclerView4;
                    cVar2.f1809e = iArr[i6];
                    i4++;
                }
            }
        }
        Collections.sort(this.f1806e, f1804g);
        int i8 = 0;
        while (i8 < this.f1806e.size() && (recyclerView = (cVar = this.f1806e.get(i8)).f1808d) != null) {
            RecyclerView.b0 c2 = c(recyclerView, cVar.f1809e, cVar.a ? Long.MAX_VALUE : j2);
            if (!(c2 == null || c2.b == null || !c2.j() || c2.k() || (recyclerView2 = c2.b.get()) == null)) {
                ...
                if (bVar2.f1807d != 0) {
                    try {
                        ...
                        yVar.f255h = false;
                        yVar.f256i = false;
                        for (int i10 = 0; i10 < bVar2.f1807d * 2; i10 += 2) {
    ...
    public void run() {
        try {
            ...
            b(TimeUnit.MILLISECONDS.toNanos(j2) + this.f1805d);
            this.c = 0;
            Trace.endSection();
        } catch (Throwable th) {
            this.c = 0;
