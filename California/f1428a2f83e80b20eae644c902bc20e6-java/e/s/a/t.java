...
public class t implements a.AbstractC0049a {
    ...
    public void a(a.b bVar) {
        ...
        if (i2 == 1) {
            ...
            recyclerView.n.p0(recyclerView, bVar.b, bVar.f1776d);
        } else if (i2 == 2) {
            RecyclerView recyclerView2 = this.a;
            recyclerView2.n.s0(recyclerView2, bVar.b, bVar.f1776d);
        } else if (i2 == 4) {
            RecyclerView recyclerView3 = this.a;
            recyclerView3.n.u0(recyclerView3, bVar.b, bVar.f1776d, bVar.c);
        } else if (i2 == 8) {
            RecyclerView recyclerView4 = this.a;
            recyclerView4.n.r0(recyclerView4, bVar.b, bVar.f1776d, 1);
        }
    }
