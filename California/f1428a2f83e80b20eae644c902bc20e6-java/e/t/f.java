...
public class f {
    ...
    public static final String[] f1841l = {"UPDATE", "DELETE", "INSERT"};
    ...
    public AtomicBoolean f1843e = new AtomicBoolean(false);

    /* renamed from: f  reason: collision with root package name */
    public volatile boolean f1844f = false;

    /* renamed from: g  reason: collision with root package name */
    public volatile e.v.a.f.f f1845g;
    ...
    public final e.c.a.b.b<c, d> f1848j = new e.c.a.b.b<>();
    ...
    public class a implements Runnable {
        ...
        public final Set<Integer> a() {
            ...
            Cursor k2 = f.this.f1842d.k(new e.v.a.a("SELECT * FROM room_table_modification_log WHERE invalidated = 1;"), null);
            while (k2.moveToNext()) {
                try {
        ...
        public void run() {
            ...
            Throwable th;
            Set<Integer> a;
            ReentrantReadWriteLock.ReadLock readLock = f.this.f1842d.f1858i.readLock();
            try {
                readLock.lock();
                if (!f.this.c()) {
                    readLock.unlock();
                } else if (!f.this.f1843e.compareAndSet(true, false)) {
                    readLock.unlock();
                } else if (f.this.f1842d.h()) {
                    readLock.unlock();
                } else {
                    g gVar = f.this.f1842d;
                    if (gVar.f1856g) {
                        e.v.a.b I = gVar.f1853d.I();
                    ...
                    if (set == null && !set.isEmpty()) {
                        synchronized (f.this.f1848j) {
                            Iterator<Map.Entry<c, d>> it = f.this.f1848j.iterator();
                            while (true) {
                                b.e eVar = (b.e) it;
                                if (eVar.hasNext()) {
    ...
    public static class d {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final Set<String> f1852d;
    ...
    public f(g gVar, Map<String, String> map, Map<String, Set<String>> map2, String... strArr) {
        this.f1842d = gVar;
        this.f1846h = new b(strArr.length);
        this.a = new HashMap<>();
        this.c = map2;
        this.f1847i = new e(gVar);
    ...
    public void i(e.v.a.b bVar) {
        if (!((e.v.a.f.a) bVar).b.inTransaction()) {
            while (true) {
                try {
                    ReentrantReadWriteLock.ReadLock readLock = this.f1842d.f1858i.readLock();
                    readLock.lock();
                    try {
                        int[] a2 = this.f1846h.a();
                        if (a2 == null) {
                            readLock.unlock();
                            return;
                        }
