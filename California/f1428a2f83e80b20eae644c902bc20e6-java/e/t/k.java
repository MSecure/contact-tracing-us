...
public class k implements c {
    ...
    public final void c(File file) {
        ...
        } else if (this.f1881d != null) {
            readableByteChannel = new FileInputStream(this.f1881d).getChannel();
        } else {
    ...
    public final void d() {
        String databaseName = this.f1883f.getDatabaseName();
        File databasePath = this.b.getDatabasePath(databaseName);
        e.t.p.a aVar = new e.t.p.a(databaseName, this.b.getFilesDir(), this.f1884g == null);
        try {
            aVar.b.lock();
            if (aVar.c) {
                try {
    ...
    public String getDatabaseName() {
        return this.f1883f.getDatabaseName();
    }

    @Override // e.v.a.c
    public void setWriteAheadLoggingEnabled(boolean z) {
        this.f1883f.setWriteAheadLoggingEnabled(z);
    }
}
