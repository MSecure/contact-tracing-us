...
public class c implements e.v.a.c {
                ...
                try {
                    ...
                    if (z) {
                        ...
                        try {
                            ...
                            d4.close();
                            if (!hVar.f1871d.equals(string) && !hVar.f1872e.equals(string)) {
    ...
    public final a c() {
        ...
        synchronized (this.f1903f) {
            if (this.f1904g == null) {
                a[] aVarArr = new a[1];
                if (Build.VERSION.SDK_INT < 23 || this.c == null || !this.f1902e) {
                    this.f1904g = new a(this.b, this.c, aVarArr, this.f1901d);
                } else {
                    this.f1904g = new a(this.b, new File(this.b.getNoBackupFilesDir(), this.c).getAbsolutePath(), aVarArr, this.f1901d);
                }
                this.f1904g.setWriteAheadLoggingEnabled(this.f1905h);
            }
            aVar = this.f1904g;
        }
        return aVar;
