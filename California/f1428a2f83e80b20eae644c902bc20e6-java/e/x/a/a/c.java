...
public class c extends f implements Animatable {
    ...
    public ArgbEvaluator f1950e;

    /* renamed from: f  reason: collision with root package name */
    public final Drawable.Callback f1951f;
    ...
    public static class b extends Drawable.ConstantState {
        ...
        /* renamed from: d  reason: collision with root package name */
        public ArrayList<Animator> f1952d;

        /* renamed from: e  reason: collision with root package name */
        public e.e.a<Animator, String> f1953e;
        ...
        public b(b bVar, Drawable.Callback callback, Resources resources) {
            if (bVar != null) {
                ...
                ArrayList<Animator> arrayList = bVar.f1952d;
                if (arrayList != null) {
                    int size = arrayList.size();
                    this.f1952d = new ArrayList<>(size);
                    this.f1953e = new e.e.a<>(size);
                    for (int i2 = 0; i2 < size; i2++) {
                        Animator animator = bVar.f1952d.get(i2);
                        Animator clone = animator.clone();
                        String orDefault = bVar.f1953e.getOrDefault(animator, null);
                        clone.setTarget(this.b.c.b.p.getOrDefault(orDefault, null));
                        this.f1952d.add(clone);
                        this.f1953e.put(clone, orDefault);
                    }
                    if (this.c == null) {
                        this.c = new AnimatorSet();
                    }
                    this.c.playTogether(this.f1952d);
                }
            }
        }
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    TypedArray e4 = h.e(resources, theme, attributeSet, a.f1941e);
                    ...
                    TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, a.f1942f);
                    String string = obtainAttributes.getString(0);
                    int resourceId2 = obtainAttributes.getResourceId(1, 0);
                    if (resourceId2 != 0) {
                        Context context = this.f1949d;
                        if (context != null) {
                            if (i2 >= 24) {
                            ...
                            b bVar = this.c;
                            if (bVar.f1952d == null) {
                                bVar.f1952d = new ArrayList<>();
                                this.c.f1953e = new e.e.a<>();
                            }
                            this.c.f1952d.add(animator);
                            this.c.f1953e.put(animator, string);
                        } else {
        ...
        bVar2.c.playTogether(bVar2.f1952d);
    }
    ...
    public static class C0061c extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            ...
            cVar.b = newDrawable;
            newDrawable.setCallback(cVar.f1951f);
            return cVar;
        }
