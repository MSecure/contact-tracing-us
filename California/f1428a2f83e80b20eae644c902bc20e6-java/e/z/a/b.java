...
public class b extends ViewGroup {
    ...
    public static class g extends e.k.a.a {
        ...
        /* renamed from: e  reason: collision with root package name */
        public Parcelable f2016e;

        /* renamed from: f  reason: collision with root package name */
        public ClassLoader f2017f;
        ...
        public g(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f2016e = parcel.readParcelable(classLoader);
            this.f2017f = classLoader;
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeParcelable(this.f2016e, i2);
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f2008f > 0 && this.f2009g != null) {
            throw null;
        }
    }
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        this.f2010h = paddingTop;
        this.f2011i = i11 - paddingBottom;
        this.x = i12;
        if (!this.w) {
            this.w = false;
            return;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        this.f2012j = View.MeasureSpec.makeMeasureSpec(measuredHeight, 1073741824);
        this.f2013k = true;
        f();
        this.f2013k = false;
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8 && ((dVar = (d) childAt2.getLayoutParams()) == null || !dVar.a)) {
                ...
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) paddingLeft) * 0.0f), 1073741824), this.f2012j);
            }
        }
    }
    ...
    public boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.f2009g;
    }
}
