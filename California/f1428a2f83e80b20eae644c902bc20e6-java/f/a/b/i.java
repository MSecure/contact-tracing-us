...
public class i extends Thread {
    ...
    public final q f2029e;

    /* renamed from: f  reason: collision with root package name */
    public volatile boolean f2030f = false;
    ...
    public final void a() {
        ...
        try {
            ...
            take.m();
            TrafficStats.setThreadStatsTag(take.f2034e);
            k f2 = ((b) this.c).f(take);
            take.a("network-http-complete");
            if (f2.f2032e) {
                synchronized (take.f2035f) {
                    z = take.f2040k;
                }
                if (z) {
                    take.c("not-modified");
            ...
            ((f) this.f2029e).a(take, q, null);
            take.o(q);
        } catch (u e2) {
            SystemClock.elapsedRealtime();
            Objects.requireNonNull(take);
            f fVar = (f) this.f2029e;
