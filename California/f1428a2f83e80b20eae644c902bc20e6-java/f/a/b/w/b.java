...
public class b implements h {
    ...
    public static List<g> b(List<g> list, b.a aVar) {
        ...
        List<g> list2 = aVar.f2021g;
        if (list2 != null) {
            if (!list2.isEmpty()) {
                for (g gVar2 : aVar.f2021g) {
                    if (!treeSet.contains(gVar2.a)) {
                        arrayList.add(gVar2);
                    }
                }
            }
        } else if (!aVar.f2020f.isEmpty()) {
            for (Map.Entry<String, String> entry : aVar.f2020f.entrySet()) {
    ...
    public final void e(long j2, n<?> nVar, byte[] bArr, int i2) {
        if (c || j2 > 3000) {
            ...
            objArr[4] = Integer.valueOf(nVar.f2041l.c());
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x00bb, code lost:
        r0 = r2.a;
        f.a.b.v.b("Unexpected response code %d for %s", java.lang.Integer.valueOf(r0), r29.f2033d);
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:70:0x0122 A[ExcHandler: MalformedURLException (r0v2 'e' java.net.MalformedURLException A[CUSTOM_DECLARE]), Splitter:B:2:0x000e] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:79:0x011c A[SYNTHETIC] */
    public k f(n<?> nVar) {
        String str;
        u uVar;
        d a2;
        ...
        while (true) {
            ...
            try {
                ...
                InputStream inputStream = a2.f2055d;
