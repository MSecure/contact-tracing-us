...
public class c {
    ...
    public static final Comparator<byte[]> f2053e = new a();
    ...
    public synchronized void b(byte[] bArr) {
        if (bArr != null) {
            if (bArr.length <= this.f2054d) {
                this.a.add(bArr);
                int binarySearch = Collections.binarySearch(this.b, bArr, f2053e);
                if (binarySearch < 0) {
