...
public final /* synthetic */ class b implements d {
    ...
    public final Object a(e.f.a.b bVar) {
        ...
        JSONObject put = new JSONObject().put("code", tVar.q()).put("accept", r.f2116i);
        m.h.a(put);
        String str = "Submitting verification code: " + put;
        r.a aVar = new r.a(rVar.f2117d, rVar.a, put, new d(rVar, put, bVar, tVar), new e(rVar, bVar), rVar.f2118e, tVar.f());
        rVar.c.a(aVar);
        return aVar;
    }
}
