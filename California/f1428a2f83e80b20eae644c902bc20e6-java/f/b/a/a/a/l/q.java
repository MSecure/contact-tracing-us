...
public final class q extends t {
    ...
    public final c<d> f2096d;

    /* renamed from: e  reason: collision with root package name */
    public final String f2097e;

    /* renamed from: f  reason: collision with root package name */
    public final c<String> f2098f;
    ...
    public final e f2103k;

    /* renamed from: l  reason: collision with root package name */
    public final e f2104l;
    ...
    public static final class b extends t.a {
        ...
        public b(t tVar, a aVar) {
            ...
            this.b = qVar.f2096d;
            this.c = qVar.f2097e;
            this.f2105d = qVar.f2098f;
            this.f2106e = qVar.f2099g;
            this.f2107f = qVar.f2100h;
            this.f2108g = qVar.f2101i;
            this.f2109h = qVar.f2102j;
            this.f2110i = qVar.f2103k;
            this.f2111j = qVar.f2104l;
            this.f2112k = qVar.m;
            this.f2113l = Boolean.valueOf(qVar.n);
        ...
        public t a() {
            ...
            if (str.isEmpty()) {
                return new q(this.a, this.b, this.c, this.f2105d, this.f2106e, this.f2107f, this.f2108g, this.f2109h, this.f2110i, this.f2111j, this.f2112k, this.f2113l.booleanValue(), this.m.intValue(), this.n.booleanValue(), null);
            }
    ...
    public boolean equals(Object obj) {
        ...
        t tVar = (t) obj;
        return this.c.equals(tVar.q()) && ((cVar = this.f2096d) != null ? cVar.equals(tVar.g()) : tVar.g() == null) && ((str = this.f2097e) != null ? str.equals(tVar.e()) : tVar.e() == null) && ((cVar2 = this.f2098f) != null ? cVar2.equals(tVar.l()) : tVar.l() == null) && ((str2 = this.f2099g) != null ? str2.equals(tVar.h()) : tVar.h() == null) && ((str3 = this.f2100h) != null ? str3.equals(tVar.o()) : tVar.o() == null) && ((str4 = this.f2101i) != null ? str4.equals(tVar.d()) : tVar.d() == null) && ((str5 = this.f2102j) != null ? str5.equals(tVar.a()) : tVar.a() == null) && ((eVar = this.f2103k) != null ? eVar.equals(tVar.n()) : tVar.n() == null) && ((eVar2 = this.f2104l) != null ? eVar2.equals(tVar.b()) : tVar.b() == null) && ((str6 = this.m) != null ? str6.equals(tVar.m()) : tVar.m() == null) && this.n == tVar.c() && this.o == tVar.k() && this.p == tVar.f();
    }
    ...
    public int hashCode() {
        ...
        c<d> cVar = this.f2096d;
        int i2 = 0;
        int hashCode2 = (hashCode ^ (cVar == null ? 0 : cVar.hashCode())) * 1000003;
        String str = this.f2097e;
        int hashCode3 = (hashCode2 ^ (str == null ? 0 : str.hashCode())) * 1000003;
        c<String> cVar2 = this.f2098f;
        int hashCode4 = (hashCode3 ^ (cVar2 == null ? 0 : cVar2.hashCode())) * 1000003;
        String str2 = this.f2099g;
        int hashCode5 = (hashCode4 ^ (str2 == null ? 0 : str2.hashCode())) * 1000003;
        String str3 = this.f2100h;
        int hashCode6 = (hashCode5 ^ (str3 == null ? 0 : str3.hashCode())) * 1000003;
        String str4 = this.f2101i;
        int hashCode7 = (hashCode6 ^ (str4 == null ? 0 : str4.hashCode())) * 1000003;
        String str5 = this.f2102j;
    ...
    public String toString() {
        ...
        h2.append(this.c);
        h2.append(", keys=");
        h2.append(this.f2096d);
        h2.append(", homeRegion=");
        h2.append(this.f2097e);
        h2.append(", regions=");
        h2.append(this.f2098f);
        h2.append(", longTermToken=");
        h2.append(this.f2099g);
        h2.append(", testType=");
        h2.append(this.f2100h);
        h2.append(", hmacKeyBase64=");
        h2.append(this.f2101i);
        h2.append(", certificate=");
        h2.append(this.f2102j);
        h2.append(", symptomOnset=");
        h2.append(this.f2103k);
        h2.append(", diagnosisDate=");
        h2.append(this.f2104l);
