...
public final class v implements b<UploadCoverTrafficWorker> {
    ...
    public final a<SecureRandom> f2125d;

    /* renamed from: e  reason: collision with root package name */
    public final a<l> f2126e;
    ...
    public UploadCoverTrafficWorker a(Context context, WorkerParameters workerParameters) {
        return new UploadCoverTrafficWorker(context, workerParameters, this.a.get(), this.b.get(), this.c.get(), this.f2125d.get(), this.f2126e.get());
    }
}
