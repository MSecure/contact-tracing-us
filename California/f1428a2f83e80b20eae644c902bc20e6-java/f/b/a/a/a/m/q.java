...
public class q implements p {
    ...
    public final u0 f2137h;

    public q(Context context, n0 n0Var, f<e> fVar, g gVar, a aVar, u0 u0Var, v vVar) {
    ...
    public void a(s.c cVar) {
        ...
        l x = l.x(this.f2136g.submit((Runnable) new e(this, (e) e.newBuilder().addUiInteraction((s) s.newBuilder().setEventType(cVar).build()).build())));
        b bVar = new b(this);
        v vVar = this.f2136g;
    ...
    public u<?> b(i.d dVar, int i2) {
        ...
        return this.f2136g.submit((Runnable) new g(this, n));
    }
    ...
    public u<Void> c() {
        ...
        d b2 = this.f2134e.b();
        f.b.b.a.l<d> d2 = this.c.d();
        if (!d2.b()) {
            Log.i(this.b, "Skipped firelog upload - no last timestamp, resetting");
            this.c.e();
            return f.b.b.f.a.s.c;
        } else if (c.b(d2.a(), b2).o() < 4) {
            Log.i(this.b, "Skipped firelog upload - less than 4 hours");
            return f.b.b.f.a.s.c;
        } else {
            int o = (int) c.b(d2.a(), b2).n(30).o();
            this.c.e();
            f.b.a.a.a.w.d dVar = (f.b.a.a.a.w.d) this.f2135f.a;
            ...
            try {
                ...
                return l.x(m.h.f0(new j(this, (e) newBuilder.setBuildId(14020).setHoursSinceLastBatch(o).setRegionIdentifier(this.a).build()))).y(new h(this), this.f2136g);
            } catch (Throwable th) {
                b3.close();
                v.V();
                throw th;
    ...
    public u<?> d(a.b bVar, Exception exc) {
        ...
        return this.f2136g.submit((Runnable) new f(this, (e) e.newBuilder().addApiCall((f.b.a.a.a.s.a) f.b.a.a.a.s.a.newBuilder().setApiCallType(bVar).setStatusCode(i2).build()).build()));
    }

    @Override // f.b.a.a.a.m.p
    public u<?> e(i.d dVar, Throwable th) {
        return this.f2136g.submit((Runnable) new i(this, m(dVar, th)));
    }
    ...
    public u<?> f(a.b bVar) {
        ...
        return this.f2136g.submit((Runnable) new a(this, (e) e.newBuilder().addApiCall((f.b.a.a.a.s.a) f.b.a.a.a.s.a.newBuilder().setApiCallType(bVar).setStatusCode(0).build()).build()));
    }
    ...
    public void i(u.d dVar) {
        ...
        Long l2 = null;
        int i2 = 0;
        Cursor b2 = e.t.p.b.b(s0Var.a, v, false, null);
        try {
            if (b2.moveToFirst()) {
                if (!b2.isNull(0)) {
            ...
            if (c2.b()) {
                i2 = (int) c.b((l.b.a.w.d) c2.a(), this.f2134e.b()).n(30).o();
            }
            u0 u0Var2 = this.f2137h;
    ...
    public final void o(e eVar) {
        if (this.c.a.getBoolean("ExposureNotificationSharedPreferences.SHARE_ANALYTICS_KEY", false)) {
            f.b.a.a.a.w.c cVar = this.f2135f.a;
