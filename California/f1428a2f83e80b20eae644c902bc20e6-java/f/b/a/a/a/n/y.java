...
public final /* synthetic */ class y implements g {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:158:0x00e5 A[SYNTHETIC] */
    ...
    public final Object a(Object obj) {
        ...
        while (true) {
            ...
            while (i8 < length) {
                b bVar2 = bVarArr2[i8];
                if (f.a.a.a.a.l(b0Var2, i7, cVar, bVar2.c) || f.a.a.a.a.l(b0Var2, 2, cVar, bVar2.f2242d) || f.a.a.a.a.l(b0Var2, 3, cVar, bVar2.f2243e) || f.a.a.a.a.l(b0Var2, 4, cVar, bVar2.f2244f)) {
                    it = it2;
                } else {
                    it = it2;
                    if (!cVar.a(bVar2.f2245g, b0Var2.c().b())) {
                        bVarArr = bVarArr2;
                        if (!cVar.a(bVar2.f2246h, b0Var2.c().a()) && !cVar.a(bVar2.f2247i, b0Var2.c().c())) {
                            z3 = false;
                            if (z3) {
        ...
        if (z4 || z5) {
            if (a2.b() == 0 || aVar.b() != 0) {
                ...
                if (!(i2 == 0 && i3 == 0)) {
                    ...
                    iVar.f1401e = i.b(context.getString(i2));
                    iVar.f1402f = i.b(context.getString(i3));
                    h hVar = new h();
                    hVar.b = i.b(context.getString(i3));
                    iVar.d(hVar);
                    iVar.f1404h = 2;
                    iVar.f1403g = activity;
                    iVar.c(8, true);
                    iVar.c(16, true);
                    ...
                    if (bundle == null && bundle.getBoolean("android.support.useSideChannel")) {
                        m.a aVar2 = new m.a(mVar.a.getPackageName(), 0, null, a3);
                        synchronized (m.f1412f) {
                            if (m.f1413g == null) {
                                m.f1413g = new m.c(mVar.a.getApplicationContext());
                            }
                            m.f1413g.c.obtainMessage(0, aVar2).sendToTarget();
                        }
                        mVar.b.cancel(null, 0);
                    } else {
                        mVar.b.notify(null, 0, a3);
                    }
                    stateUpdatedWorker.q.a.edit().putInt("ExposureNotificationSharedPreferences.EXPOSURE_NOTIFICATION_LAST_SHOWN_CLASSIFICATION_KEY", aVar.b()).putLong("ExposureNotificationSharedPreferences.EXPOSURE_NOTIFICATION_LAST_SHOWN_TIME_KEY", stateUpdatedWorker.p.b().D()).apply();
            ...
            i0Var2.a.b();
            Cursor b3 = e.t.p.b.b(i0Var2.a, v, false, null);
            try {
                int b0 = m.h.b0(b3, "dateDaysSinceEpoch");
                int b02 = m.h.b0(b3, "exposureScore");
                ArrayList arrayList2 = new ArrayList(b3.getCount());
                while (b3.moveToNext()) {
                    arrayList2.add(j0.a(b3.getLong(b0), b3.getDouble(b02)));
                }
                b3.close();
                v.V();
                ...
                while (true) {
                    ...
                    j0Var = (j0) it4.next();
                    if (l.b.a.e.O(q.f4062g).M(j0Var.b()).x() > j3 || ((d2 = (Double) hashMap.get(Long.valueOf(j0Var.b()))) != null && d2.doubleValue() >= j0Var.c())) {
                    }
                }
                j0Var.b();
                z2 = true;
                if (z2) {
                    ...
                    iVar2.f1401e = i.b(context.getString(i2));
                    iVar2.f1402f = i.b(context.getString(i3));
                    h hVar2 = new h();
                    hVar2.b = i.b(context.getString(i3));
                    iVar2.d(hVar2);
                    iVar2.f1404h = 2;
                    iVar2.f1403g = activity2;
                    iVar2.c(8, true);
                    iVar2.c(16, true);
                    iVar2.q.deleteIntent = broadcast2;
                    iVar2.n = -1;
                    e.i.a.m mVar2 = new e.i.a.m(context);
                    Notification a32 = iVar2.a();
                    bundle = a32.extras;
                    if (bundle == null && bundle.getBoolean("android.support.useSideChannel")) {
                    }
                    stateUpdatedWorker.q.a.edit().putInt("ExposureNotificationSharedPreferences.EXPOSURE_NOTIFICATION_LAST_SHOWN_CLASSIFICATION_KEY", aVar.b()).putLong("ExposureNotificationSharedPreferences.EXPOSURE_NOTIFICATION_LAST_SHOWN_TIME_KEY", stateUpdatedWorker.p.b().D()).apply();
        ...
        iVar22.f1401e = i.b(context.getString(i2));
        iVar22.f1402f = i.b(context.getString(i3));
        h hVar22 = new h();
        hVar22.b = i.b(context.getString(i3));
        iVar22.d(hVar22);
        iVar22.f1404h = 2;
        iVar22.f1403g = activity22;
        iVar22.c(8, true);
        iVar22.c(16, true);
        iVar22.q.deleteIntent = broadcast22;
        iVar22.n = -1;
        e.i.a.m mVar22 = new e.i.a.m(context);
        Notification a322 = iVar22.a();
        bundle = a322.extras;
        if (bundle == null && bundle.getBoolean("android.support.useSideChannel")) {
        }
        stateUpdatedWorker.q.a.edit().putInt("ExposureNotificationSharedPreferences.EXPOSURE_NOTIFICATION_LAST_SHOWN_CLASSIFICATION_KEY", aVar.b()).putLong("ExposureNotificationSharedPreferences.EXPOSURE_NOTIFICATION_LAST_SHOWN_TIME_KEY", stateUpdatedWorker.p.b().D()).apply();
