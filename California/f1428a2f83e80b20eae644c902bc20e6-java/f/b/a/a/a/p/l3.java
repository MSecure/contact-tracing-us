...
public class l3 extends y2 {
    ...
    public void g0(View view, Bundle bundle) {
        ...
        Intent intent = (Intent) this.f1621g.getParcelable("ShareDiagnosisActivity.ACTIVITY_START_INTENT");
        ...
        if (progressIndicator.f541f > 0) {
            progressIndicator.removeCallbacks(progressIndicator.f547l);
            progressIndicator.postDelayed(progressIndicator.f547l, (long) progressIndicator.f541f);
        } else {
            progressIndicator.f547l.run();
        }
