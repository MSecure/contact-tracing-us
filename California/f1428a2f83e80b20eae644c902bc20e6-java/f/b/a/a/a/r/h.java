...
public final /* synthetic */ class h implements g {
    ...
    public /* synthetic */ h(z zVar, String str, a0 a0Var) {
        this.a = zVar;
        this.b = str;
        this.c = a0Var;
    }
    ...
    public final Object a(Object obj) {
        ...
        long a2 = a0Var.a();
        d b3 = tVar.b();
        f.b.a.a.a.s.g prioParameters = tVar.a().getPrioParameters();
        if (b3.getResponseStatus().getStatusCode() != h.c.OK) {
            ...
            try {
                hashMap.put("payload", wVar.a(tVar, uuid, a0Var));
                if (!wVar.a.c(str, hashMap, prioParameters, b3, a2)) {
                    c0Var = new c0();
                    c0Var.r();
                }
            } catch (Exception e2) {
            ...
            h3.append(wVar.f2231e.nextInt(100));
            ...
            if (fVar.f2983h == null) {
                synchronized (fVar.b) {
                    if (fVar.f2983h == null) {
                        ...
                        String str2 = fVar.c;
                        f.b.c.k.h hVar = fVar.f2982g;
                        fVar.f2983h = new n(fVar.a, new e(bVar, str2, hVar.a, hVar.b), hVar, fVar.f2979d, fVar.f2980e, fVar.f2984i);
                    }
                }
            }
            l s = l.s(sb);
            ...
            if (s.n() % 2 == 1) {
                ...
                l lVar = (l) a3.f3059e.a(l.s(uuid));
                if (lVar.n() % 2 == 0) {
                    f.b.c.k.u.f fVar2 = new f.b.c.k.u.f(lVar);
                    String b4 = w.f2228g.b(wVar.c.b());
        ...
        return f.b.b.f.a.l.x(m.h.g0(c0Var, w.f2227f, wVar.f2230d));
    }
}
