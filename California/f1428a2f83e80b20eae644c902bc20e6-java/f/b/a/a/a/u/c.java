...
public final class c implements b<CountryCheckingWorker> {
    ...
    public final a<p> f2248d;

    public c(a<ExecutorService> aVar, a<d> aVar2, a<l> aVar3, a<p> aVar4) {
        this.a = aVar;
        this.b = aVar2;
        this.c = aVar3;
        this.f2248d = aVar4;
    ...
    public CountryCheckingWorker a(Context context, WorkerParameters workerParameters) {
        return new CountryCheckingWorker(context, workerParameters, this.a.get(), this.b.get(), this.c.get(), this.f2248d.get());
    }
}
