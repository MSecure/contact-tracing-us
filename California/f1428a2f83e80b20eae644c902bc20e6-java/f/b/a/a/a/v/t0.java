...
public class t0 extends p0 {
    ...
    public void g0(View view, Bundle bundle) {
        ...
        n0 n0Var = ((AppAnalyticsViewModel) new b0(this).a(AppAnalyticsViewModel.class)).c;
        Objects.requireNonNull(n0Var);
        new h(n0Var.a, "ExposureNotificationSharedPreferences.SHARE_ANALYTICS_KEY", false).f(B(), new f0((TextView) view.findViewById(R.id.app_analytics_status)));
        View findViewById = view.findViewById(R.id.private_analytics_link);
        findViewById.setOnClickListener(new x(this));
        n0 n0Var2 = ((PrivateAnalyticsViewModel) new b0(this).a(PrivateAnalyticsViewModel.class)).c;
        Objects.requireNonNull(n0Var2);
        new h(n0Var2.a, "ExposureNotificationSharedPreferences.SHARE_PRIVATE_ANALYTICS_KEY", false).f(B(), new y((TextView) view.findViewById(R.id.private_analytics_status)));
