...
public class z implements Callable<List<b0>> {
    public final /* synthetic */ i a;
    public final /* synthetic */ u b;

    public z(u uVar, i iVar) {
        this.b = uVar;
        this.a = iVar;
    }
    ...
    public List<b0> call() {
        ...
        try {
            ...
            while (b2.moveToNext()) {
                arrayList.add(b0.a(b2.getLong(b0), b2.getLong(b02), m.h.o1(b2.getString(b03)), b2.getString(b04), b2.getString(b05), b2.getString(b06), m.h.p1(b2.getString(b07)), b2.getInt(b09) != 0, m.h.n1(b2.getString(b08)), m.h.m1(b2.getString(b010)), b2.getString(b011), m.h.q1(b2.getString(b012)), b2.getInt(b013) != 0));
            }
            return arrayList;
        } finally {
            b2.close();
