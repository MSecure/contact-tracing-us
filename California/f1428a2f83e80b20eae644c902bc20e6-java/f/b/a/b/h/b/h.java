...
public final class h extends a {
        ...
        if (num != null ? num.equals(((h) obj).a) : ((h) obj).a == null) {
            ...
            if (str != null ? str.equals(((h) obj).b) : ((h) obj).b == null) {
                ...
                if (str2 != null ? str2.equals(((h) obj).c) : ((h) obj).c == null) {
                    ...
                    if (str3 != null ? str3.equals(((h) obj).f2294d) : ((h) obj).f2294d == null) {
                        String str4 = this.f2295e;
                        if (str4 != null ? str4.equals(((h) obj).f2295e) : ((h) obj).f2295e == null) {
                            String str5 = this.f2296f;
                            if (str5 != null ? str5.equals(((h) obj).f2296f) : ((h) obj).f2296f == null) {
                                String str6 = this.f2297g;
                                if (str6 != null ? str6.equals(((h) obj).f2297g) : ((h) obj).f2297g == null) {
                                    String str7 = this.f2298h;
                                    String str8 = ((h) obj).f2298h;
                                    if (str7 == null) {
                                        if (str8 == null) {
                                            return true;
                                        }
    ...
    public String toString() {
        ...
        h2.append(this.c);
        h2.append(", device=");
        h2.append(this.f2294d);
        h2.append(", product=");
        h2.append(this.f2295e);
        h2.append(", osBuild=");
        h2.append(this.f2296f);
        h2.append(", manufacturer=");
        h2.append(this.f2297g);
        h2.append(", fingerprint=");
        return a.e(h2, this.f2298h, "}");
    }
}
