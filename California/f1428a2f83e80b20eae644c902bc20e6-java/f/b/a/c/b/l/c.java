...
public class c<O extends a.c> {
    ...
    public final b<O> f2399d;

    /* renamed from: e  reason: collision with root package name */
    public final int f2400e;

    /* renamed from: f  reason: collision with root package name */
    public final f.b.a.c.b.l.l.a f2401f;
    ...
    public c(@RecentlyNonNull Context context, @RecentlyNonNull a<O> aVar, @RecentlyNonNull O o, @RecentlyNonNull a aVar2) {
        ...
        if (i2 >= 29) {
            if (i2 < 30 || !Build.VERSION.CODENAME.equals("REL")) {
                ...
                if (str.length() == 1 && str.charAt(0) >= 'R' && str.charAt(0) <= 'Z') {
                    Boolean bool = f.b.a.c.b.o.b.f2488e;
                    if (bool == null) {
                        try {
                            ...
                            f.b.a.c.b.o.b.f2488e = Boolean.valueOf(z);
                        } catch (NumberFormatException unused) {
                            f.b.a.c.b.o.b.f2488e = Boolean.TRUE;
                        }
                        if (!f.b.a.c.b.o.b.f2488e.booleanValue()) {
                            Log.w("PlatformVersion", "Build version must be at least 6301457 to support R in gmscore");
                        }
                        bool = f.b.a.c.b.o.b.f2488e;
                    }
                    z = bool.booleanValue();
                }
            }
            ...
            this.b = aVar;
            this.c = null;
            this.f2399d = new b<>(aVar, null);
            e a2 = e.a(this.a);
            this.f2402g = a2;
            this.f2400e = a2.f2408e.getAndIncrement();
            this.f2401f = aVar2.a;
            Handler handler = a2.f2413j;
        ...
        e a22 = e.a(this.a);
        this.f2402g = a22;
        this.f2400e = a22.f2408e.getAndIncrement();
        this.f2401f = aVar2.a;
        Handler handler2 = a22.f2413j;
    ...
    public c.a j() {
        ...
        } else if (b3.f401e != null) {
            account = new Account(b3.f401e, "com.google");
        }
        aVar.a = account;
        O o3 = this.c;
        ...
        aVar.f2453d = this.a.getClass().getName();
        aVar.c = this.a.getPackageName();
        return aVar;
    }

    public final <TResult, A> h<TResult> k(int i2, l<A, TResult> lVar) {
        i iVar = new i();
        e eVar = this.f2402g;
        f.b.a.c.b.l.l.a aVar = this.f2401f;
        Objects.requireNonNull(eVar);
        e0 e0Var = new e0(i2, lVar, iVar, aVar);
        Handler handler = eVar.f2413j;
        handler.sendMessage(handler.obtainMessage(4, new u(e0Var, eVar.f2409f.get(), this)));
        return iVar.a;
    }
}
