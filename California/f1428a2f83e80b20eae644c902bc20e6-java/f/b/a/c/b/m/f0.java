...
public final class f0 implements ServiceConnection {
    ...
    public final g.a f2472e;

    /* renamed from: f  reason: collision with root package name */
    public ComponentName f2473f;

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ d0 f2474g;
    ...
    public final void a(String str) {
        ...
        a aVar = d0Var.f2459f;
        Context context = d0Var.f2457d;
        g.a aVar2 = this.f2472e;
        Intent intent = null;
        if (aVar2.a != null) {
            if (aVar2.f2476d) {
                ...
                try {
                    bundle = context.getContentResolver().call(g.a.f2475e, "serviceIntentCall", (String) null, bundle2);
        ...
        if (component != null) {
            ...
            try {
                if ((b.a(context).a.getPackageManager().getApplicationInfo(packageName, 0).flags & 2097152) != 0) {
                    ...
                    this.c = z2;
                    if (!z2) {
                        Message obtainMessage = this.f2474g.f2458e.obtainMessage(1, this.f2472e);
                        d0 d0Var2 = this.f2474g;
                        d0Var2.f2458e.sendMessageDelayed(obtainMessage, d0Var2.f2461h);
                        return;
                    }
                    this.b = 2;
                    try {
                        d0 d0Var3 = this.f2474g;
                        d0Var3.f2459f.a(d0Var3.f2457d, this);
                        return;
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        synchronized (this.f2474g.c) {
            this.f2474g.f2458e.removeMessages(1, this.f2472e);
            this.f2471d = iBinder;
            this.f2473f = componentName;
