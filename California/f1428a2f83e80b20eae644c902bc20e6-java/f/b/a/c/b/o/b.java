...
public final class b {
    ...
    public static l1 O() {
        return l2.f3641e == null ? new l2() : new h.a.j1.h();
    }
    ...
    public static int S(int i2, byte[] bArr, int i3, int i4, z.c<?, ?> cVar, z.e<?, ?> eVar, r1<s1, s1> r1Var, f fVar) {
        ...
        if (!dVar2.f3408e || !dVar2.f3409f) {
            ...
            if (y1Var == y1.ENUM) {
                i6 = m0(bArr, i3, fVar);
                if (eVar.f3410d.b.findValueByNumber(fVar.a) == null) {
        ...
        switch (dVar2.f3407d.ordinal()) {
            ...
            case 13:
                ...
                s1 s1Var = (s1) f.b.f.l1.y(i10, b0Var3, eVar.f3410d.b, obj4, r1Var);
                if (s1Var != null) {
                    cVar.unknownFields = s1Var;
                }
                vVar.o(eVar.f3410d, b0Var3);
                return f0;
            case 16:
    ...
    public static c1 S1(q qVar) {
        ...
        Throwable A = qVar.A();
        if (A == null) {
            return c1.f3510g.g("io.grpc.Context was cancelled without error");
        }
        if (A instanceof TimeoutException) {
            return c1.f3512i.g(A.getMessage()).f(A);
        }
        c1 d2 = c1.d(A);
        return (!c1.b.UNKNOWN.equals(d2.a) || d2.c != A) ? d2.f(A) : c1.f3510g.g("Context cancelled").f(A);
    }
