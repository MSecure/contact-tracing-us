...
public abstract class k2<E> extends j2<E> implements List<E>, RandomAccess {
    public static final o2<Object> c = new m2(n2.f2505f, 0);
    ...
    public static <E> k2<E> q(Object[] objArr, int i2) {
        return i2 == 0 ? (k2<E>) n2.f2505f : new n2(objArr, i2);
    }
    ...
    public k2<E> subList(int i2, int i3) {
        b.b2(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? (k2<E>) n2.f2505f : new l2(this, i2, i4);
    }
