...
public final class s2 extends c<a.c.C0082c> implements f.b.a.c.f.b.c {
    ...
    public static final a<a.c.C0082c> f2508h = new a<>("Nearby.EXPOSURE_NOTIFICATION_API", new k(), new a.f());

    public s2(Context context) {
        super(context, f2508h, null, c.a.c);
    }

    @Override // f.b.a.c.f.b.c
    public final h<Void> a(List<File> list) {
        b.a aVar = new b.a();
        b bVar = new b(4, aVar.a, 50, aVar.b, 50, aVar.c, 50, aVar.f2521d, 50, aVar.f2522e);
        h<Long> f2 = f();
    ...
    public final h<List<TemporaryExposureKey>> b() {
        l.a a = l.a();
        a.a = new e(this);
        a.b = new f.b.a.c.b.c[]{f.b.a.c.f.c.f2532f};
        return k(0, a.a());
    }
    ...
    public final h<List<DailySummary>> d(DailySummariesConfig dailySummariesConfig) {
        ...
        a.b = new f.b.a.c.b.c[]{f.b.a.c.f.c.f2536j};
        return k(0, a.a());
    }
    ...
    public final h<Long> f() {
        l.a a = l.a();
        a.a = new t2(this);
        a.b = new f.b.a.c.b.c[]{f.b.a.c.f.c.f2534h};
        return k(0, a.a());
    }
    ...
    public final h<DiagnosisKeysDataMapping> g() {
        l.a a = l.a();
        a.a = new v2(this);
        a.b = new f.b.a.c.b.c[]{f.b.a.c.f.c.f2538l};
        return k(0, a.a());
    }
