...
public final class c0<TResult> extends h<TResult> {
    ...
    public volatile boolean f2542d;

    /* renamed from: e  reason: collision with root package name */
    public TResult f2543e;

    /* renamed from: f  reason: collision with root package name */
    public Exception f2544f;
    ...
    public final TResult k() {
        ...
        synchronized (this.a) {
            ...
            } else if (this.f2544f == null) {
                tresult = this.f2543e;
            } else {
                throw new g(this.f2544f);
            }
        }
        return tresult;
    }
    ...
    public final boolean n() {
        boolean z;
        synchronized (this.a) {
            z = this.c && !this.f2542d && this.f2544f == null;
        }
        return z;
    }
