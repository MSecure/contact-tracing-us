...
public class a extends Drawable implements i.b {
    ...
    public static final class C0088a implements Parcelable {
        ...
        public C0088a(Context context) {
            ...
            this.f2576g = context.getString(R$string.mtrl_badge_numberless_content_description);
            this.f2577h = R$plurals.mtrl_badge_content_description;
            this.f2578i = R$string.mtrl_exceed_max_badge_number_content_description;
        }
        ...
        public C0088a(Parcel parcel) {
            ...
            this.f2576g = parcel.readString();
            this.f2577h = parcel.readInt();
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeString(this.f2576g.toString());
            parcel.writeInt(this.f2577h);
    ...
    public a(Context context) {
        ...
        this.f2566f = (float) resources.getDimensionPixelSize(R$dimen.mtrl_badge_radius);
        this.f2568h = (float) resources.getDimensionPixelSize(R$dimen.mtrl_badge_long_text_horizontal_padding);
        this.f2567g = (float) resources.getDimensionPixelSize(R$dimen.mtrl_badge_with_text_radius);
        i iVar = new i(this);
        this.f2564d = iVar;
        iVar.a.setTextAlign(Paint.Align.CENTER);
        this.f2569i = new C0088a(context);
        int i2 = R$style.TextAppearance_MaterialComponents_Badge;
        Context context3 = weakReference.get();
        if (context3 != null && iVar.f2693f != (bVar = new f.b.a.d.s.b(context3, i2)) && (context2 = weakReference.get()) != null) {
    ...
    public final String b() {
        ...
        return context.getString(R$string.mtrl_exceed_max_badge_number_suffix, Integer.valueOf(this.f2572l), "+");
    }
    ...
    public int c() {
        ...
        return this.f2569i.f2574e;
    }

    public boolean d() {
        return this.f2569i.f2574e != -1;
    }

    public void draw(Canvas canvas) {
        if (!getBounds().isEmpty() && this.f2569i.f2573d != 0 && isVisible()) {
            this.c.draw(canvas);
            if (d()) {
                Rect rect = new Rect();
                String b2 = b();
                this.f2564d.a.getTextBounds(b2, 0, b2.length(), rect);
                canvas.drawText(b2, this.f2570j, this.f2571k + ((float) (rect.height() / 2)), this.f2564d.a);
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x00c7, code lost:
        r1 = ((((float) r4.right) + r8.n) - ((float) r0)) - ((float) r8.f2569i.f2580k);
     */
    public final void e() {
        int i2;
        float f2;
        ...
        if (context != null && view != null) {
            ...
            C0088a aVar = this.f2569i;
            int i3 = aVar.f2579j;
            if (i3 == 8388691 || i3 == 8388693) {
                i2 = rect2.bottom - aVar.f2581l;
            } else {
                i2 = rect2.top + aVar.f2581l;
            }
            this.f2571k = (float) i2;
            if (c() <= 9) {
                f2 = !d() ? this.f2566f : this.f2567g;
                this.m = f2;
                this.o = f2;
            } else {
                float f3 = this.f2567g;
                this.m = f3;
                this.o = f3;
                f2 = (this.f2564d.a(b()) / 2.0f) + this.f2568h;
            }
            this.n = f2;
            int dimensionPixelSize = context.getResources().getDimensionPixelSize(d() ? R$dimen.mtrl_badge_text_horizontal_edge_offset : R$dimen.mtrl_badge_horizontal_edge_offset);
            int i4 = this.f2569i.f2579j;
            if (i4 == 8388659 || i4 == 8388691) {
                AtomicInteger atomicInteger = l.a;
            } else {
                AtomicInteger atomicInteger2 = l.a;
            }
            float f4 = (((float) rect2.left) - this.n) + ((float) dimensionPixelSize) + ((float) this.f2569i.f2580k);
            this.f2570j = f4;
            Rect rect3 = this.f2565e;
            float f5 = this.f2571k;
            float f6 = this.n;
            float f7 = this.o;
            ...
            gVar.invalidateSelf();
            if (!rect.equals(this.f2565e)) {
                this.c.setBounds(this.f2565e);
            }
        }
    }

    public int getAlpha() {
        return this.f2569i.f2573d;
    }

    public int getIntrinsicHeight() {
        return this.f2565e.height();
    }

    public int getIntrinsicWidth() {
        return this.f2565e.width();
    }
    ...
    public void setAlpha(int i2) {
        this.f2569i.f2573d = i2;
        this.f2564d.a.setAlpha(i2);
        invalidateSelf();
    }
