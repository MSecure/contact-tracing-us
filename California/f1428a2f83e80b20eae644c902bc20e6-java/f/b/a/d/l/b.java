...
public final class b {
    ...
    public final ColorStateList f2619d;
    ...
    public void b(TextView textView) {
        g gVar = new g();
        g gVar2 = new g();
        gVar.setShapeAppearanceModel(this.f2621f);
        gVar2.setShapeAppearanceModel(this.f2621f);
        gVar.q(this.c);
        gVar.u((float) this.f2620e, this.f2619d);
