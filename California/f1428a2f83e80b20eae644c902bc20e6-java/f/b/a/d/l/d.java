...
public abstract class d extends j {
    ...
    public final Runnable f2629f;

    /* renamed from: g  reason: collision with root package name */
    public Runnable f2630g;
    ...
    public d(String str, DateFormat dateFormat, TextInputLayout textInputLayout, a aVar) {
        ...
        this.f2627d = aVar;
        this.f2628e = textInputLayout.getContext().getString(R$string.mtrl_picker_out_of_range);
        this.f2629f = new a(str);
    }
    ...
    public void onTextChanged(CharSequence charSequence, int i2, int i3, int i4) {
        this.b.removeCallbacks(this.f2629f);
        this.b.removeCallbacks(this.f2630g);
        ...
        if (!TextUtils.isEmpty(charSequence)) {
            try {
                ...
                if (this.f2627d.f2610d.f(time)) {
                    a aVar = this.f2627d;
                    boolean z = true;
                    if (aVar.b.t(1) <= time) {
                        u uVar = aVar.c;
                        if (time <= uVar.t(uVar.f2637f)) {
                            if (z) {
                ...
                this.b.postDelayed(this.f2629f, 1000);
            }
        }
    }
}
