...
public final class f extends i {
    ...
    public void draw(Canvas canvas) {
        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(rect)) {
            canvas.save();
            this.o.c(canvas, this.c, this.f2709i);
            s sVar = this.c;
            float f2 = this.f2709i;
            float f3 = ((float) sVar.b) * f2;
            float f4 = f2 * ((float) sVar.c);
            this.o.d(canvas, this.f2712l, sVar.f2729e, 0.0f, 1.0f, f3, f4);
            this.o.d(canvas, this.f2712l, this.f2711k[0], 0.0f, this.r, f3, f4);
            canvas.restore();
        }
    }
    ...
    public boolean f(boolean z, boolean z2, boolean z3) {
        ...
        float a2 = this.f2704d.a(this.b.getContentResolver());
        if (a2 == 0.0f) {
            this.s = true;
        } else {
            this.s = false;
    ...
    public boolean onLevelChange(int i2) {
        if (this.s) {
            ...
            if (dVar.f1549f) {
                ...
                } else if (d3 >= ((double) dVar.f1550g)) {
                    double abs = Math.abs((double) (dVar.f1552i * 0.75f));
                    eVar.f1555d = abs;
                    eVar.f1556e = abs * 62.5d;
                    if (Looper.myLooper() == Looper.getMainLooper()) {
                        boolean z = dVar.f1549f;
                        if (!z && !z) {
                            dVar.f1549f = true;
                            if (!dVar.c) {
                                dVar.b = dVar.f1548e.a(dVar.f1547d);
                            }
                            float f3 = dVar.b;
                            if (f3 > Float.MAX_VALUE || f3 < dVar.f1550g) {
                                throw new IllegalArgumentException("Starting value need to be in between min value and max value");
                            }
                            e.l.a.a a2 = e.l.a.a.a();
                            if (a2.b.size() == 0) {
                                if (a2.f1543d == null) {
                                    a2.f1543d = new a.d(a2.c);
                                }
                                a.d dVar2 = (a.d) a2.f1543d;
