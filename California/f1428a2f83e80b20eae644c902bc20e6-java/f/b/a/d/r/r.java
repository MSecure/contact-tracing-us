...
public final class r extends k<AnimatorSet> {
    ...
    public static final Property<r, Float> f2722h = new a(Float.class, "lineConnectPoint1Fraction");

    /* renamed from: i  reason: collision with root package name */
    public static final Property<r, Float> f2723i = new b(Float.class, "lineConnectPoint2Fraction");

    /* renamed from: d  reason: collision with root package name */
    public AnimatorSet f2724d;
    ...
    public static class a extends Property<r, Float> {
        ...
        public Float get(r rVar) {
            return Float.valueOf(rVar.f2726f);
        }
    ...
    public static class b extends Property<r, Float> {
        ...
        @Override // android.util.Property
        public Float get(r rVar) {
            return Float.valueOf(rVar.f2727g);
        }
    ...
    public void a() {
        AnimatorSet animatorSet = this.f2724d;
        if (animatorSet != null) {
            animatorSet.cancel();
        }
    }
    ...
    public void g() {
        if (this.f2724d == null) {
            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, f2722h, 0.0f, 1.0f);
            ...
            Property<r, Float> property = f2723i;
    ...
    public final void j() {
        float[] fArr = this.b;
        fArr[0] = 0.0f;
        float min = Math.min(this.f2726f, this.f2727g);
        fArr[2] = min;
        fArr[1] = min;
        float[] fArr2 = this.b;
        float max = Math.max(this.f2726f, this.f2727g);
        fArr2[4] = max;
        fArr2[3] = max;
        this.b[5] = 1.0f;
    }
