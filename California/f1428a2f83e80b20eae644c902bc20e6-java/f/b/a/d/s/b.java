...
public class b {
    ...
    public class a extends g {
        ...
        public void d(Typeface typeface) {
            b bVar = b.this;
            bVar.n = Typeface.create(typeface, bVar.f2735d);
            b bVar2 = b.this;
            bVar2.m = true;
    ...
    public b(Context context, int i2) {
        ...
        this.f2742k = obtainStyledAttributes.getDimension(R$styleable.TextAppearance_android_textSize, 0.0f);
        ...
        this.f2735d = obtainStyledAttributes.getInt(R$styleable.TextAppearance_android_textStyle, 0);
        this.f2736e = obtainStyledAttributes.getInt(R$styleable.TextAppearance_android_typeface, 1);
        int i3 = R$styleable.TextAppearance_fontFamily;
        i3 = !obtainStyledAttributes.hasValue(i3) ? R$styleable.TextAppearance_android_fontFamily : i3;
        this.f2743l = obtainStyledAttributes.getResourceId(i3, 0);
        ...
        this.f2737f = obtainStyledAttributes.getFloat(R$styleable.TextAppearance_android_shadowDx, 0.0f);
        this.f2738g = obtainStyledAttributes.getFloat(R$styleable.TextAppearance_android_shadowDy, 0.0f);
        this.f2739h = obtainStyledAttributes.getFloat(R$styleable.TextAppearance_android_shadowRadius, 0.0f);
        obtainStyledAttributes.recycle();
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(i2, R$styleable.MaterialTextAppearance);
        int i4 = R$styleable.MaterialTextAppearance_android_letterSpacing;
        this.f2740i = obtainStyledAttributes2.hasValue(i4);
        this.f2741j = obtainStyledAttributes2.getFloat(i4, 0.0f);
    ...
    public void c(Context context, TextPaint textPaint, d dVar) {
        ...
        float f2 = this.f2739h;
        float f3 = this.f2737f;
        float f4 = this.f2738g;
    ...
    public void d(TextPaint textPaint, Typeface typeface) {
        ...
        int i2 = (~typeface.getStyle()) & this.f2735d;
        textPaint.setFakeBoldText((i2 & 1) != 0);
        textPaint.setTextSkewX((i2 & 2) != 0 ? -0.25f : 0.0f);
        textPaint.setTextSize(this.f2742k);
        if (this.f2740i) {
            textPaint.setLetterSpacing(this.f2741j);
        }
    }
}
