...
public class p extends d {
    ...
    public final k0 f2851e;

    /* renamed from: f  reason: collision with root package name */
    public final AccessibilityManager f2852f;

    /* renamed from: g  reason: collision with root package name */
    public final Rect f2853g = new Rect();
    ...
    public p(Context context, AttributeSet attributeSet) {
        ...
        this.f2852f = (AccessibilityManager) context2.getSystemService("accessibility");
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE) {
            ...
            if (!(adapter == null || b == null)) {
                ...
                k0 k0Var = this.f2851e;
                int min = Math.min(adapter.getCount(), Math.max(0, !k0Var.c() ? -1 : k0Var.f909d.getSelectedItemPosition()) + 15);
                View view = null;
                int i5 = 0;
                ...
                Drawable i6 = this.f2851e.i();
                if (i6 != null) {
                    i6.getPadding(this.f2853g);
                    Rect rect = this.f2853g;
    ...
    public <T extends ListAdapter & Filterable> void setAdapter(T t) {
        super.setAdapter(t);
        this.f2851e.o(getAdapter());
    }

    public void showDropDown() {
        AccessibilityManager accessibilityManager = this.f2852f;
