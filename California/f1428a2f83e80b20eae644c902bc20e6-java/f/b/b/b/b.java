...
public abstract class b<E> extends AbstractCollection<E> implements Serializable {
    ...
    public static abstract class a<E> extends AbstractC0100b<E> {
        public Object[] a;
        public int b = 0;
        public boolean c;
        ...
        public AbstractC0100b<E> d(Iterable<? extends E> iterable) {
        ...
        public final void e(int i2) {
            Object[] objArr = this.a;
            if (objArr.length < i2) {
                this.a = Arrays.copyOf(objArr, AbstractC0100b.b(objArr.length, i2));
            } else if (this.c) {
    ...
    public static abstract class AbstractC0100b<E> {
        ...
        public abstract AbstractC0100b<E> a(E e2);
    }
