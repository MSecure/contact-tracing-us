...
public abstract class c<E> extends b<E> implements List<E>, RandomAccess {
    public static final a<Object> c = new b(g.f2874f, 0);
    ...
    public class C0101c extends c<E> {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final transient int f2869d;

        /* renamed from: e  reason: collision with root package name */
        public final transient int f2870e;
        ...
        public E get(int i2) {
            f.b.a.c.b.o.b.w(i2, this.f2870e);
            return (E) c.this.get(i2 + this.f2869d);
        }
        ...
        @Override // f.b.b.b.b
        public int k() {
            return c.this.l() + this.f2869d + this.f2870e;
        }

        @Override // f.b.b.b.b
        public int l() {
            return c.this.l() + this.f2869d;
        }
        ...
        public c<E> subList(int i2, int i3) {
            f.b.a.c.b.o.b.E(i2, i3, this.f2870e);
            c cVar = c.this;
            int i4 = this.f2869d;
    ...
    public static <E> c<E> p(Object[] objArr, int i2) {
        return i2 == 0 ? (c<E>) g.f2874f : new g(objArr, i2);
    }
    ...
    public c<E> subList(int i2, int i3) {
        ...
        return i4 == 0 ? (c<E>) g.f2874f : new C0101c(i2, i4);
    }
}
