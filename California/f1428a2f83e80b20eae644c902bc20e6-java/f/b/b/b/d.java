...
public abstract class d<K, V> implements Map<K, V>, Serializable {
    ...
    public e<Map.Entry<K, V>> entrySet() {
        ...
        h hVar = (h) this;
        h.a aVar = new h.a(hVar, hVar.f2879f, 0, hVar.f2880g);
        this.b = aVar;
        return aVar;
    }
    ...
    /* renamed from: c */
    public b<V> values() {
        b<V> bVar = this.f2872d;
        if (bVar != null) {
            return bVar;
        }
        h hVar = (h) this;
        h.c cVar = new h.c(hVar.f2879f, 1, hVar.f2880g);
        this.f2872d = cVar;
        return cVar;
    }
    ...
    public Set keySet() {
        ...
        h hVar = (h) this;
        h.b bVar = new h.b(hVar, new h.c(hVar.f2879f, 0, hVar.f2880g));
        this.c = bVar;
        return bVar;
    }
