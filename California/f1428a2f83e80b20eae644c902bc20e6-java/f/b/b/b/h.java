...
public final class h<K, V> extends d<K, V> {
    ...
    public static final d<Object, Object> f2877h = new h(null, new Object[0], 0);

    /* renamed from: e  reason: collision with root package name */
    public final transient Object f2878e;

    /* renamed from: f  reason: collision with root package name */
    public final transient Object[] f2879f;

    /* renamed from: g  reason: collision with root package name */
    public final transient int f2880g;

    public static class a<K, V> extends e<Map.Entry<K, V>> {

        /* renamed from: e  reason: collision with root package name */
        public final transient d<K, V> f2881e;

        /* renamed from: f  reason: collision with root package name */
        public final transient Object[] f2882f;

        /* renamed from: g  reason: collision with root package name */
        public final transient int f2883g;

        /* renamed from: h  reason: collision with root package name */
        public final transient int f2884h;
        ...
        public class C0102a extends c<Map.Entry<K, V>> {
            ...
            public Object get(int i2) {
                f.b.a.c.b.o.b.w(i2, a.this.f2884h);
                a aVar = a.this;
                Object[] objArr = aVar.f2882f;
                int i3 = i2 * 2;
                int i4 = aVar.f2883g;
        ...
        public boolean contains(Object obj) {
            ...
            return value != null && value.equals(this.f2881e.get(key));
        }
    ...
    public static final class b<K> extends e<K> {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final transient d<K, ?> f2886e;

        /* renamed from: f  reason: collision with root package name */
        public final transient c<K> f2887f;
        ...
        @Override // f.b.b.b.b
        public boolean contains(Object obj) {
            return this.f2886e.get(obj) != null;
        }
        ...
        @Override // f.b.b.b.b
        public int i(Object[] objArr, int i2) {
            return this.f2887f.i(objArr, i2);
        }
        ...
        /* renamed from: n */
        public k<K> iterator() {
            return this.f2887f.listIterator();
        }

        public int size() {
            return ((h) this.f2886e).f2880g;
        }
    }
    ...
    public static final class c extends c<Object> {
        ...
        public final transient Object[] f2888d;

        /* renamed from: e  reason: collision with root package name */
        public final transient int f2889e;

        /* renamed from: f  reason: collision with root package name */
        public final transient int f2890f;
        ...
        @Override // java.util.List
        public Object get(int i2) {
            f.b.a.c.b.o.b.w(i2, this.f2890f);
            return this.f2888d[(i2 * 2) + this.f2889e];
        }
    ...
    public V get(Object obj) {
        Object obj2 = this.f2878e;
        Object[] objArr = this.f2879f;
        int i2 = this.f2880g;
        if (obj == null) {
            return null;
        }
