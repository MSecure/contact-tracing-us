...
public abstract class a<V, X extends Throwable, F, T> extends l.a<V> implements Runnable {
    ...
    public u<? extends V> f2909i;

    /* renamed from: j  reason: collision with root package name */
    public Class<X> f2910j;

    /* renamed from: k  reason: collision with root package name */
    public F f2911k;

    /* renamed from: f.b.b.f.a.a$a  reason: collision with other inner class name */
    public static final class C0105a<V, X extends Throwable> extends a<V, X, i<? super X, ? extends V>, u<? extends V>> {
        public C0105a(u<? extends V> uVar, Class<X> cls, i<? super X, ? extends V> iVar) {
            super(uVar, cls, iVar);
        }
    ...
    public String r() {
        String str;
        u<? extends V> uVar = this.f2909i;
        Class<X> cls = this.f2910j;
        F f2 = this.f2911k;
        String r = super.r();
        if (uVar != null) {
    ...
    public final void run() {
        ...
        if ((!z && !z2) && !isCancelled()) {
            this.f2909i = null;
            try {
                th = uVar instanceof f.b.b.f.a.d0.a ? ((f.b.b.f.a.d0.a) uVar).b() : null;
                if (th == null) {
                    obj = f.b.a.c.b.o.b.N0(uVar);
                    if (th != null) {
                        t(obj);
                        return;
