...
public abstract class b<V> extends f.b.b.f.a.d0.a implements u<V> {
    ...
    public static final boolean f2914e;

    /* renamed from: f  reason: collision with root package name */
    public static final Logger f2915f = Logger.getLogger(b.class.getName());

    /* renamed from: g  reason: collision with root package name */
    public static final AbstractC0106b f2916g;

    /* renamed from: h  reason: collision with root package name */
    public static final Object f2917h = new Object();
    private volatile Object b;
    private volatile e c;

    /* renamed from: d  reason: collision with root package name */
    private volatile l f2918d;
    ...
    public static final class e {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final e f2920d = new e(null, null);
    ...
    public static final class f extends AbstractC0106b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<b, e> f2921d;

        /* renamed from: e  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<b, Object> f2922e;
        ...
        public f(AtomicReferenceFieldUpdater<l, Thread> atomicReferenceFieldUpdater, AtomicReferenceFieldUpdater<l, l> atomicReferenceFieldUpdater2, AtomicReferenceFieldUpdater<b, l> atomicReferenceFieldUpdater3, AtomicReferenceFieldUpdater<b, e> atomicReferenceFieldUpdater4, AtomicReferenceFieldUpdater<b, Object> atomicReferenceFieldUpdater5) {
            ...
            this.f2921d = atomicReferenceFieldUpdater4;
            this.f2922e = atomicReferenceFieldUpdater5;
        }

        @Override // f.b.b.f.a.b.AbstractC0106b
        public boolean a(b<?> bVar, e eVar, e eVar2) {
            return this.f2921d.compareAndSet(bVar, eVar, eVar2);
        }

        @Override // f.b.b.f.a.b.AbstractC0106b
        public boolean b(b<?> bVar, Object obj, Object obj2) {
            return this.f2922e.compareAndSet(bVar, obj, obj2);
        }
    ...
    public static final class g<V> implements Runnable {
        ...
        public void run() {
            if (((b) this.b).b == this) {
                if (b.f2916g.b(this.b, this, b.o(this.c))) {
                    b.l(this.b);
                }
            }
        }
    ...
    public static final class k extends AbstractC0106b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final long f2923d;

        /* renamed from: e  reason: collision with root package name */
        public static final long f2924e;

        /* renamed from: f  reason: collision with root package name */
        public static final long f2925f;
        ...
        static {
            ...
            try {
                ...
                try {
                    ...
                    f2923d = unsafe.objectFieldOffset(b.class.getDeclaredField("b"));
                    f2924e = unsafe.objectFieldOffset(l.class.getDeclaredField("a"));
                    f2925f = unsafe.objectFieldOffset(l.class.getDeclaredField("b"));
                    a = unsafe;
                } catch (Exception e2) {
                    u.c(e2);
        ...
        @Override // f.b.b.f.a.b.AbstractC0106b
        public boolean b(b<?> bVar, Object obj, Object obj2) {
            return a.compareAndSwapObject(bVar, f2923d, obj, obj2);
        }
        ...
        @Override // f.b.b.f.a.b.AbstractC0106b
        public void d(l lVar, l lVar2) {
            a.putObject(lVar, f2925f, lVar2);
        }

        @Override // f.b.b.f.a.b.AbstractC0106b
        public void e(l lVar, Thread thread) {
            a.putObject(lVar, f2924e, thread);
        }
    }
    ...
    public static final class l {
        ...
        public l() {
            b.f2916g.e(this, Thread.currentThread());
        }
    ...
    public static void l(b<?> bVar) {
        ...
        e eVar3 = null;
        while (true) {
            l lVar = ((b) bVar).f2918d;
            if (f2916g.c((b) bVar, lVar, l.c)) {
                while (lVar != null) {
                ...
                do {
                    eVar = ((b) bVar).c;
                } while (!f2916g.a((b) bVar, eVar, e.f2920d));
                while (true) {
                    eVar2 = eVar3;
                    eVar3 = eVar;
                    if (eVar3 == null) {
                ...
                while (eVar2 != null) {
                    ...
                    if (runnable instanceof g) {
                        ...
                        bVar = gVar.b;
                        if (((b) bVar).b == gVar) {
                            if (f2916g.b(bVar, gVar, o(gVar.c))) {
                            }
                        } else {
                            continue;
                        }
    ...
    public static Object o(u<?> uVar) {
        ...
        if (uVar instanceof i) {
            ...
            c cVar = (c) obj;
            if (cVar.a) {
                return cVar.b != null ? new c(false, cVar.b) : c.f2919d;
            }
            return obj;
            ...
            if ((!f2914e) && isCancelled) {
                return c.f2919d;
            }
            try {
                Object p = p(uVar);
                if (!isCancelled) {
                    return p == null ? f2917h : p;
                }
    ...
    public boolean cancel(boolean z) {
        ...
        c cVar = f2914e ? new c(z, new CancellationException("Future.cancel() was called.")) : z ? c.c : c.f2919d;
        boolean z2 = false;
        b<V> bVar = this;
        while (true) {
            if (f2916g.b(bVar, obj, cVar)) {
                l(bVar);
                if (!(obj instanceof g)) {
                    return true;
                }
        ...
        while (true) {
            ...
            if (lVar2 != l.c) {
                ...
                while (lVar2 != null) {
                    ...
                    } else if (!f2916g.c(this, lVar2, lVar4)) {
                    }
                    lVar2 = lVar4;
                }
                return;
    ...
    public boolean u(Throwable th) {
        Objects.requireNonNull(th);
        if (!f2916g.b(this, null, new d(th))) {
            return false;
        }
        l(this);
        return true;
