...
public final class b0<V> extends l.a<V> {
    ...
    public static final class b<V> implements Runnable {
        ...
        public void run() {
            u<V> uVar;
            b0<V> b0Var = this.b;
            if (b0Var != null && (uVar = b0Var.f2926i) != null) {
                this.b = null;
                if (uVar.isDone()) {
                    b0Var.v(uVar);
                    return;
                ...
                try {
                    ScheduledFuture<?> scheduledFuture = b0Var.f2927j;
                    b0Var.f2927j = null;
    ...
    public void j() {
        q(this.f2926i);
        ScheduledFuture<?> scheduledFuture = this.f2927j;
        if (scheduledFuture != null) {
