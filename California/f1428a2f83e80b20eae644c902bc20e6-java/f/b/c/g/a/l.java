...
public class l<K, V> extends d<K, V> {
    ...
    public static class b<A, B, C> {
        ...
        public final d.a.AbstractC0108a<A, B> c;
        ...
        public b(List<A> list, Map<B, C> map, d.a.AbstractC0108a<A, B> aVar) {
            this.a = list;
            this.b = map;
            this.c = aVar;
        }

        public static <A, B, C> l<A, C> b(List<A> list, Map<B, C> map, d.a.AbstractC0108a<A, B> aVar, Comparator<A> comparator) {
            i.a aVar2 = i.a.BLACK;
            ...
            int size = list.size();
            while (aVar3.hasNext()) {
                C0110b bVar2 = (C0110b) aVar3.next();
                int i2 = bVar2.b;
                size -= i2;
                boolean z = bVar2.a;
