...
public class b0 implements l0.c {
    ...
    public final Map<Integer, List<x>> f2999d = new HashMap();

    /* renamed from: e  reason: collision with root package name */
    public final int f3000e;

    /* renamed from: f  reason: collision with root package name */
    public final Queue<f> f3001f = new ArrayDeque();

    /* renamed from: g  reason: collision with root package name */
    public final Map<f, Integer> f3002g = new HashMap();

    /* renamed from: h  reason: collision with root package name */
    public final Map<Integer, a> f3003h = new HashMap();

    /* renamed from: i  reason: collision with root package name */
    public final j0 f3004i = new j0();

    /* renamed from: j  reason: collision with root package name */
    public final Map<f.b.c.k.r.f, Map<Integer, i<Void>>> f3005j = new HashMap();

    /* renamed from: k  reason: collision with root package name */
    public final Map<Integer, List<i<Void>>> f3006k;

    /* renamed from: l  reason: collision with root package name */
    public final d0 f3007l = new d0(1, 1);
    ...
    public void b(g0 g0Var) {
        ...
        for (Map.Entry<Integer, o0> entry : g0Var.b.entrySet()) {
            ...
            a aVar = this.f3003h.get(entry.getKey());
            if (aVar != null) {
                f.b.a.c.b.o.b.a1(value.f3152e.size() + (value.f3151d.size() + value.c.size()) <= 1, "Limbo resolution for single document contains multiple changes.", new Object[0]);
                if (value.c.size() > 0) {
                    aVar.b = true;
                } else if (value.f3151d.size() > 0) {
                    f.b.a.c.b.o.b.a1(aVar.b, "Received change for limbo target document without add.", new Object[0]);
                } else if (value.f3152e.size() > 0) {
    ...
    public f.b.c.g.a.f<f> d(int i2) {
        a aVar = this.f3003h.get(Integer.valueOf(i2));
        if (aVar != null && aVar.b) {
            return f.c.h(aVar.a);
        }
        f.b.c.g.a.f<f> fVar = f.c;
        if (this.f2999d.containsKey(Integer.valueOf(i2))) {
            for (x xVar : this.f2999d.get(Integer.valueOf(i2))) {
    ...
    public void e(int i2, c1 c1Var) {
        ...
        if (fVar != null) {
            this.f3002g.remove(fVar);
            this.f3003h.remove(Integer.valueOf(i2));
            k();
        ...
        this.f2999d.remove(Integer.valueOf(i2));
        f.b.c.g.a.f<f> d2 = this.f3004i.d(i2);
        this.f3004i.g(i2);
    ...
    public final void j(int i2, c1 c1Var) {
        Integer valueOf;
        i<Void> iVar;
        Map<Integer, i<Void>> map = this.f3005j.get(this.m);
    ...
    public final void k() {
        while (!this.f3001f.isEmpty() && this.f3002g.size() < this.f3000e) {
            f.b.c.k.u.f remove = this.f3001f.remove();
            d0 d0Var = this.f3007l;
            int i2 = d0Var.a;
            d0Var.a = i2 + 2;
            this.f3003h.put(Integer.valueOf(i2), new a(remove));
            this.f3002g.put(remove, Integer.valueOf(i2));
            l0 l0Var = this.b;
    ...
    public final void l(f.b.c.k.u.f fVar) {
        Integer num = this.f3002g.get(fVar);
        if (num != null) {
            l0 l0Var = this.b;
            ...
            if (l0Var.c.isEmpty()) {
                if (l0Var.f3143f.c()) {
                    l0Var.f3143f.e();
                } else if (l0Var.f3142e) {
                    l0Var.f3141d.c(v.UNKNOWN);
                }
            }
            this.f3002g.remove(fVar);
            this.f3003h.remove(num);
            k();
        }
    }

    public final void m(int i2) {
        if (this.f3006k.containsKey(Integer.valueOf(i2))) {
            for (i<Void> iVar : this.f3006k.get(Integer.valueOf(i2))) {
                iVar.a.q(null);
            }
            this.f3006k.remove(Integer.valueOf(i2));
        }
    }
}
