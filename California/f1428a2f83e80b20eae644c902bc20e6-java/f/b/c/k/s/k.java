...
public final /* synthetic */ class k implements Runnable {
    ...
    public void run() {
        ...
        f fVar = this.c;
        m.a aVar = m.a.DEBUG;
        b.a1(nVar.f3046d != null, "SyncEngine not yet initialized", new Object[0]);
        m.a(aVar, "FirestoreClient", "Credential changed. Current user: %s", fVar.a);
        b0 b0Var = nVar.f3046d;
        boolean z = !b0Var.m.equals(fVar);
        b0Var.m = fVar;
        if (z) {
            for (Map.Entry<Integer, List<i<Void>>> entry : b0Var.f3006k.entrySet()) {
                for (i<Void> iVar : entry.getValue()) {
                    iVar.a.p(new g("'waitForPendingWrites' task is cancelled due to User change.", g.a.CANCELLED));
                }
            }
            b0Var.f3006k.clear();
            r rVar = b0Var.a;
