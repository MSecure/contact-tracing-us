...
public class i implements o {
    ...
    public i(s sVar) {
        b.a1(o.h(sVar), "NumericIncrementTransformOperation expects a NumberValue operand", new Object[0]);
        this.a = sVar;
    }
    ...
    public s c(s sVar, d dVar) {
        ...
        if (!o.f(a2) || !o.f(this.a)) {
            if (o.f(a2)) {
                ...
                b.a1(o.e(a2), "Expected NumberValue to be of type DoubleValue, but was ", sVar.getClass().getCanonicalName());
                d2 = a2.r();
            }
            double d3 = d() + d2;
            bVar = s.z();
