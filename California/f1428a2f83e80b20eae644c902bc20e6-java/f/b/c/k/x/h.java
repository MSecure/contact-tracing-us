...
public class h {
    ...
    public static class a<T> {
        ...
        public final Map<String, Method> f3177d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        public final Map<String, Field> f3178e = new HashMap();

        /* renamed from: f  reason: collision with root package name */
        public final HashSet<String> f3179f = new HashSet<>();

        /* renamed from: g  reason: collision with root package name */
        public final HashSet<String> f3180g = new HashSet<>();
        ...
        public a(Class<T> cls) {
            ...
            do {
                ...
                for (Method method2 : declaredMethods) {
                    if (method2.getName().startsWith("set") && !method2.getDeclaringClass().equals(Object.class) && !Modifier.isStatic(method2.getModifiers()) && method2.getReturnType().equals(Void.TYPE) && method2.getParameterTypes().length == 1 && !method2.isAnnotationPresent(d.class)) {
                        ...
                        if (str == null) {
                            ...
                            Method method3 = this.f3177d.get(f3);
                            if (method3 == null) {
                                method2.setAccessible(true);
                                this.f3177d.put(f3, method2);
                ...
                for (Field field2 : declaredFields) {
                    String e2 = e(field2);
                    if (this.b.containsKey(e2.toLowerCase(Locale.US)) && !this.f3178e.containsKey(e2)) {
                        field2.setAccessible(true);
                        this.f3178e.put(e2, field2);
                        c(field2);
                    }
                }
            ...
            if (!this.b.isEmpty()) {
                Iterator<String> it = this.f3180g.iterator();
                while (it.hasNext()) {
                    String next = it.next();
                    if (!(this.f3177d.containsKey(next) || this.f3178e.containsKey(next))) {
    ...
    public static class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f3181d = new b(null, null, 0);
        public final int a;
        public final b b;
                        ...
                        for (String str2 : aVar.b.values()) {
                            if (!aVar.f3180g.contains(str2)) {
                                if (aVar.c.containsKey(str2)) {
                                    ...
                                    Field field = aVar.f3178e.get(str2);
                                    if (field != null) {
                                        try {
                                            obj = field.get(t);
                                ...
                                if (!aVar.f3179f.contains(str2) || obj != null) {
