...
public final class f1<E> extends c<E> implements RandomAccess {
    ...
    public static final f1<Object> f3286e;
    public E[] c;
    ...
    public void add(int i2, E e2) {
        ...
        if (i3 < eArr.length) {
            ...
            System.arraycopy(this.c, i2, eArr2, i2 + 1, this.f3287d - i2);
            this.c = eArr2;
        }
        this.c[i2] = e2;
        this.f3287d++;
    ...
    public c0.i d(int i2) {
        if (i2 >= this.f3287d) {
            return new f1(Arrays.copyOf(this.c, i2), this.f3287d);
        }
    ...
    public final void i(int i2) {
        if (i2 < 0 || i2 >= this.f3287d) {
            throw new IndexOutOfBoundsException(j(i2));
        }
    }

    public final String j(int i2) {
        return "Index:" + i2 + ", Size:" + this.f3287d;
    }
