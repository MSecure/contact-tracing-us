...
public abstract class j implements Iterable<Byte>, Serializable {
    ...
    public static final e f3307d = (d.a() ? new i(null) : new c(null));
    public int b = 0;
    ...
    public static final class d extends h {
        ...
        public byte i(int i2) {
            j.j(i2, this.f3310g);
            return this.f3311e[this.f3309f + i2];
        }

        @Override // f.b.f.j, f.b.f.j.h
        public void p(byte[] bArr, int i2, int i3, int i4) {
            System.arraycopy(this.f3311e, this.f3309f + i2, bArr, i3, i4);
        }
    ...
    public static class h extends g {
        ...
        public final String A(Charset charset) {
            return new String(this.f3311e, E(), size(), charset);
        }

        @Override // f.b.f.j
        public final void C(i iVar) {
            iVar.a(this.f3311e, E(), size());
        }
        ...
        public final boolean D(j jVar, int i2, int i3) {
            if (i3 <= jVar.size()) {
                ...
                if (i4 > jVar.size()) {
                    ...
                    h hVar = (h) jVar;
                    byte[] bArr = this.f3311e;
                    byte[] bArr2 = hVar.f3311e;
                    int E = E() + i3;
                    int E2 = E();
                    int E3 = hVar.E() + i2;
                    while (E2 < E) {
        ...
        @Override // f.b.f.j
        public byte i(int i2) {
            return this.f3311e[i2];
        }

        @Override // f.b.f.j
        public void p(byte[] bArr, int i2, int i3, int i4) {
            System.arraycopy(this.f3311e, i2, bArr, i3, i4);
        }
        ...
        @Override // f.b.f.j
        public int size() {
            return this.f3311e.length;
        }

        @Override // f.b.f.j
        public final boolean t() {
            int E = E();
            return w1.h(this.f3311e, E, size() + E);
        }

        @Override // f.b.f.j
        public final k v() {
            return k.h(this.f3311e, E(), size(), true);
        }
        ...
        public final int x(int i2, int i3, int i4) {
            int E = E() + i3;
            return w1.a.e(i2, this.f3311e, E, i4 + E);
        }

        @Override // f.b.f.j
        public final j y(int i2, int i3) {
            int k2 = j.k(i2, i3, size());
            return k2 == 0 ? j.c : new d(this.f3311e, E() + i2, k2);
        }
    }
    ...
    public static j h(Iterator<j> it, int i2) {
        ...
        if (i2 < 1) {
            ...
            if (Integer.MAX_VALUE - h2.size() < h3.size()) {
                ...
                if (h2 instanceof i1) {
                    i1 i1Var2 = (i1) h2;
                    if (h3.size() + i1Var2.f3298g.size() < 128) {
                        i1Var = new i1(i1Var2.f3297f, i1.D(i1Var2.f3298g, h3));
                        return i1Var;
                    } else if (i1Var2.f3297f.q() > i1Var2.f3298g.q() && i1Var2.f3300i > h3.q()) {
                        return new i1(i1Var2.f3297f, new i1(i1Var2.f3298g, h3));
                    }
                }
    ...
    public static j m(byte[] bArr, int i2, int i3) {
        ...
        return new h(f3307d.a(bArr, i2, i3));
    }
