...
public class n1<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public static final /* synthetic */ int f3350h = 0;
    public final int b;
    public List<n1<K, V>.b> c = Collections.emptyList();

    /* renamed from: d  reason: collision with root package name */
    public Map<K, V> f3351d = Collections.emptyMap();

    /* renamed from: e  reason: collision with root package name */
    public boolean f3352e;

    /* renamed from: f  reason: collision with root package name */
    public volatile n1<K, V>.d f3353f;

    /* renamed from: g  reason: collision with root package name */
    public Map<K, V> f3354g = Collections.emptyMap();

    public static class a {
        public static final Iterator<Object> a = new C0122a();
        public static final Iterable<Object> b = new b();

        /* renamed from: f.b.f.n1$a$a  reason: collision with other inner class name */
        public static class C0122a implements Iterator<Object> {
    ...
    public class c implements Iterator<Map.Entry<K, V>> {
        ...
        /* renamed from: d  reason: collision with root package name */
        public Iterator<Map.Entry<K, V>> f3356d;
        ...
        public final Iterator<Map.Entry<K, V>> b() {
            if (this.f3356d == null) {
                this.f3356d = n1.this.f3351d.entrySet().iterator();
            }
            return (Iterator<Map.Entry<K, V>>) this.f3356d;
        }
        ...
        public boolean hasNext() {
            ...
            if (n1.this.f3351d.isEmpty() || !b().hasNext()) {
                return false;
            }
            return true;
        }
    ...
    public class d extends AbstractSet<Map.Entry<K, V>> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r0v1, resolved type: f.b.f.n1 */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: f.b.f.n1<K extends java.lang.Comparable<K>, V> */
    /* JADX WARN: Multi-variable type inference failed */
    public boolean containsKey(Object obj) {
        Comparable comparable = (Comparable) obj;
        return a(comparable) >= 0 || this.f3351d.containsKey(comparable);
    }
    ...
    public Iterable<Map.Entry<K, V>> e() {
        return this.f3351d.isEmpty() ? (Iterable<Map.Entry<K, V>>) a.b : this.f3351d.entrySet();
    }

    @Override // java.util.AbstractMap, java.util.Map
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.f3353f == null) {
            this.f3353f = new d(null);
        }
        return this.f3353f;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (d2 != size) {
            return this.f3351d.equals(n1Var.f3351d);
        }
        return true;
    }
    ...
    public final SortedMap<K, V> f() {
        b();
        if (this.f3351d.isEmpty() && !(this.f3351d instanceof TreeMap)) {
            TreeMap treeMap = new TreeMap();
            this.f3351d = treeMap;
            this.f3354g = treeMap.descendingMap();
        }
        return (SortedMap) this.f3351d;
    }

    public void g() {
        if (!this.f3352e) {
            this.f3351d = this.f3351d.isEmpty() ? Collections.emptyMap() : Collections.unmodifiableMap(this.f3351d);
            this.f3354g = this.f3354g.isEmpty() ? Collections.emptyMap() : Collections.unmodifiableMap(this.f3354g);
            this.f3352e = true;
        }
    }
    ...
    public V get(Object obj) {
        ...
        return this.f3351d.get(comparable);
    }
    ...
    public int hashCode() {
        ...
        return this.f3351d.size() > 0 ? i2 + this.f3351d.hashCode() : i2;
    }
    ...
    public V remove(Object obj) {
        ...
        return this.f3351d.remove(comparable);
    }

    public int size() {
        return this.f3351d.size() + this.c.size();
    }
}
