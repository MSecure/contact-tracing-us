...
public final class w0<T> implements j1<T> {
    ...
    public void a(T t, T t2) {
        ...
        if (this.c) {
            l1.B(this.f3395d, t, t2);
        }
    }

    @Override // f.b.f.j1
    public final boolean b(T t) {
        return this.f3395d.c(t).j();
    }

    @Override // f.b.f.j1
    public void c(T t, h1 h1Var, r rVar) {
        r1<UT, UB> r1Var = (r1<UT, UB>) this.b;
        s<ET> sVar = (s<ET>) this.f3395d;
        UB f2 = r1Var.f(t);
        v<ET> d2 = sVar.d(t);
        do {
            try {
    ...
    public boolean d(T t, T t2) {
        ...
        if (this.c) {
            return this.f3395d.c(t).equals(this.f3395d.c(t2));
        }
        return true;
    }
            ...
            if (i4 == 11) {
                ...
                while (m0 < i3) {
                    ...
                    if (i7 != 2) {
                        ...
                        m0 = b.m0(bArr, m0, fVar);
                        i5 = fVar.a;
                        eVar = (z.e) this.f3395d.b(fVar.f3285d, this.a, i5);
                    }
                    if (i6 == 12) {
                        break;
                    }
                ...
                z.e eVar2 = (z.e) this.f3395d.b(fVar.f3285d, this.a, i4 >>> 3);
                if (eVar2 != null) {
                    i2 = b.W(e1.c.a(eVar2.c.getClass()), bArr, m0, i3, fVar);
                    b2.o(eVar2.f3410d, fVar.c);
                } else {
    ...
    public void h(T t, a2 a2Var) {
        Iterator<Map.Entry<?, Object>> l2 = this.f3395d.c(t).l();
        while (l2.hasNext()) {
    ...
    public int j(T t) {
        ...
        return this.c ? (hashCode * 53) + this.f3395d.c(t).hashCode() : hashCode;
    }
