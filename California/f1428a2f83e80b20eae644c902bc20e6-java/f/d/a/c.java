...
public final class c {
    ...
    public ArrayList<f.d.a.d.a> f3447d = new ArrayList<>();
    ...
    public final class a extends AsyncTask<String, g, g> {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ c f3450e;
        ...
        public g doInBackground(String[] strArr) {
            ...
            boolean z4;
            e.c(strArr, "strings");
            if (c.a(this.f3450e).b.length == 0) {
                Context context2 = this.f3449d;
                HashMap<String, String> hashMap = c.a(this.f3450e).s;
                ...
                aVar = new a(this.f3449d, c.a(this.f3450e).b, c.a(this.f3450e).s);
            }
            b a2 = c.a(this.f3450e);
            Boolean x0 = f.b.a.c.b.o.b.x0(this.f3449d, Boolean.valueOf(c.a(this.f3450e).f3440f), "aboutLibraries_description_showIcon");
            a2.f3440f = x0 != null ? x0.booleanValue() : false;
            b a3 = c.a(this.f3450e);
            Boolean x02 = f.b.a.c.b.o.b.x0(this.f3449d, Boolean.valueOf(c.a(this.f3450e).f3442h), "aboutLibraries_description_showVersion");
            a3.f3442h = x02 != null ? x02.booleanValue() : false;
            b a4 = c.a(this.f3450e);
            Boolean x03 = f.b.a.c.b.o.b.x0(this.f3449d, Boolean.valueOf(c.a(this.f3450e).f3444j), "aboutLibraries_description_showVersionName");
            a4.f3444j = x03 != null ? x03.booleanValue() : false;
            b a5 = c.a(this.f3450e);
            Boolean x04 = f.b.a.c.b.o.b.x0(this.f3449d, Boolean.valueOf(c.a(this.f3450e).f3445k), "aboutLibraries_description_showVersionCode");
            a5.f3445k = x04 != null ? x04.booleanValue() : false;
            b a6 = c.a(this.f3450e);
            String y0 = f.b.a.c.b.o.b.y0(this.f3449d, c.a(this.f3450e).f3441g, "aboutLibraries_description_name");
            if (y0 == null) {
                y0 = "";
            }
            a6.f3441g = y0;
            b a7 = c.a(this.f3450e);
            String y02 = f.b.a.c.b.o.b.y0(this.f3449d, c.a(this.f3450e).f3443i, "aboutLibraries_description_text");
            if (y02 == null) {
                y02 = "";
            }
            a7.f3443i = y02;
            c.a(this.f3450e).f3446l = f.b.a.c.b.o.b.y0(this.f3449d, c.a(this.f3450e).f3446l, "aboutLibraries_description_special1_name");
            c.a(this.f3450e).m = f.b.a.c.b.o.b.y0(this.f3449d, c.a(this.f3450e).m, "aboutLibraries_description_special1_text");
            c.a(this.f3450e).n = f.b.a.c.b.o.b.y0(this.f3449d, c.a(this.f3450e).n, "aboutLibraries_description_special2_name");
            c.a(this.f3450e).o = f.b.a.c.b.o.b.y0(this.f3449d, c.a(this.f3450e).o, "aboutLibraries_description_special2_text");
            c.a(this.f3450e).p = f.b.a.c.b.o.b.y0(this.f3449d, c.a(this.f3450e).p, "aboutLibraries_description_special3_name");
            c.a(this.f3450e).q = f.b.a.c.b.o.b.y0(this.f3449d, c.a(this.f3450e).q, "aboutLibraries_description_special3_text");
            HashMap<String, HashMap<String, String>> hashMap2 = c.a(this.f3450e).r;
            if (hashMap2 != null) {
            ...
            Objects.requireNonNull(c.a(this.f3450e));
            Objects.requireNonNull(c.a(this.f3450e));
            Objects.requireNonNull(this.f3450e);
            c cVar2 = this.f3450e;
            Context context3 = this.f3449d;
            String[] strArr6 = c.a(cVar2).c;
            String[] strArr7 = c.a(this.f3450e).f3438d;
            Objects.requireNonNull(c.a(this.f3450e));
            Objects.requireNonNull(c.a(this.f3450e));
            e.c(context3, "ctx");
            ...
            cVar.f3447d = arrayList2;
            Objects.requireNonNull(this.f3450e);
            Objects.requireNonNull(c.a(this.f3450e));
            boolean z7 = c.a(this.f3450e).f3442h || c.a(this.f3450e).f3444j || c.a(this.f3450e).f3445k;
            if (c.a(this.f3450e).f3440f && z7) {
                PackageManager packageManager = this.f3449d.getPackageManager();
                String packageName2 = this.f3449d.getPackageName();
                try {
                ...
                if (c.a(this.f3450e).f3440f && applicationInfo != null) {
                    this.c = applicationInfo.loadIcon(packageManager);
                }
                this.a = null;
                this.b = null;
        ...
        public void onPostExecute(g gVar) {
            g gVar2 = gVar;
            e.c(gVar2, "nothing");
            f.d.b.p.a b2 = c.b(this.f3450e);
            l<Item> lVar = b2.f3479g;
            b<Item> bVar = b2.a;
            lVar.d(bVar != null ? bVar.t(b2.b) : 0);
            boolean z = c.a(this.f3450e).f3442h || c.a(this.f3450e).f3444j || c.a(this.f3450e).f3445k;
            if (c.a(this.f3450e).f3440f && z) {
                f.d.b.p.a b3 = c.b(this.f3450e);
                f.d.a.e.b.a aVar = new f.d.a.e.b.a(c.a(this.f3450e));
                aVar.c = this.a;
                aVar.b = this.b;
                aVar.f3462d = this.c;
                b3.e(aVar);
            ...
            Iterator<f.d.a.d.a> it = this.f3450e.f3447d.iterator();
            while (it.hasNext()) {
                f.d.a.d.a next = it.next();
                Objects.requireNonNull(c.a(this.f3450e));
                e.b(next, "library");
                arrayList.add(new f.d.a.e.b.d(next, c.a(this.f3450e)));
            }
            c.b(this.f3450e).d(arrayList);
