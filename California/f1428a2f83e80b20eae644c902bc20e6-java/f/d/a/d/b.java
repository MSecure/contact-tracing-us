...
public final class b {
    ...
    public static b a(b bVar, String str, String str2, String str3, String str4, String str5, int i2) {
        ...
        String str10 = (i2 & 8) != 0 ? bVar.f3460d : null;
        if ((i2 & 16) != 0) {
            str6 = bVar.f3461e;
        }
    ...
    public boolean equals(Object obj) {
        ...
        b bVar = (b) obj;
        return e.a(this.a, bVar.a) && e.a(this.b, bVar.b) && e.a(this.c, bVar.c) && e.a(this.f3460d, bVar.f3460d) && e.a(this.f3461e, bVar.f3461e);
    }
    ...
    public int hashCode() {
        ...
        String str4 = this.f3460d;
        int hashCode4 = (hashCode3 + (str4 != null ? str4.hashCode() : 0)) * 31;
        String str5 = this.f3461e;
        if (str5 != null) {
            i2 = str5.hashCode();
        }
        return hashCode4 + i2;
    ...
    public String toString() {
        ...
        h2.append(this.f3460d);
        h2.append(", licenseDescription=");
        return a.e(h2, this.f3461e, ")");
    }
}
