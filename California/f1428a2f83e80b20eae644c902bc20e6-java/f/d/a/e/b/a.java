...
public final class a extends f.d.b.q.a<C0126a> {
    ...
    public static final class C0126a extends RecyclerView.b0 {
        ...
        public static final class C0127a extends f implements j.j.a.b<TypedArray, g> {
            ...
            /* renamed from: d  reason: collision with root package name */
            public final /* synthetic */ Context f3464d;
    ...
    public void g(RecyclerView.b0 b0Var, List list) {
        ...
        if (!this.f3463e.f3440f || (drawable = this.f3462d) == null) {
        ...
        String str = this.f3463e.f3441g;
        boolean z = true;
        if (!(str == null || str.length() == 0)) {
            aVar.u.setText(this.f3463e.f3441g);
        } else {
        ...
        if (!TextUtils.isEmpty(this.f3463e.f3446l) && !TextUtils.isEmpty(this.f3463e.m)) {
            aVar.w.setText(this.f3463e.f3446l);
            aVar.w.setVisibility(0);
            aVar.w.setOnClickListener(new b(0, this, context));
            aVar.v.setVisibility(0);
        }
        if (!TextUtils.isEmpty(this.f3463e.n) && !TextUtils.isEmpty(this.f3463e.o)) {
            aVar.x.setText(this.f3463e.n);
            aVar.x.setVisibility(0);
            aVar.x.setOnClickListener(new b(1, this, context));
            aVar.v.setVisibility(0);
        }
        if (!TextUtils.isEmpty(this.f3463e.p) && !TextUtils.isEmpty(this.f3463e.q)) {
            aVar.y.setText(this.f3463e.p);
        ...
        if (bVar2.f3442h) {
            ...
            sb.append(this.b);
            sb.append(')');
        } else if (bVar2.f3444j) {
            textView = aVar.z;
            sb = new StringBuilder();
            sb.append(context.getString(R$string.version));
            sb.append(' ');
            sb.append(this.c);
        } else if (bVar2.f3445k) {
            textView = aVar.z;
            sb = new StringBuilder();
            sb.append(context.getString(R$string.version));
            sb.append(' ');
            ...
            String str2 = this.f3463e.f3443i;
            if (!(str2 == null || str2.length() == 0)) {
                z = false;
            }
            if (z) {
                aVar.B.setText(Html.fromHtml(this.f3463e.f3443i));
            ...
            bVar = this.f3463e;
            if ((bVar.f3440f && !bVar.f3442h) || TextUtils.isEmpty(bVar.f3443i)) {
                aVar.A.setVisibility(8);
                return;
            }
        }
        textView.setText(sb.toString());
        String str22 = this.f3463e.f3443i;
        z = false;
        if (z) {
        }
        bVar = this.f3463e;
