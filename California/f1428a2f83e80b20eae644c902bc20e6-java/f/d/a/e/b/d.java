...
public final class d extends f.d.b.q.a<a> {
    ...
    public static final class a extends RecyclerView.b0 {
        ...
        public static final class C0128a extends f implements j.j.a.b<TypedArray, g> {
            ...
            public final /* synthetic */ Context f3465d;
            ...
            public g d(TypedArray typedArray) {
                ...
                Context context = this.f3465d;
                e.b(context, "ctx");
                int i3 = R$attr.aboutLibrariesCardBackground;
                Context context2 = this.f3465d;
                e.b(context2, "ctx");
                ...
                Context context3 = this.f3465d;
                e.b(context3, "ctx");
                int i6 = R$attr.aboutLibrariesOpenSourceDivider;
                Context context4 = this.f3465d;
                e.b(context4, "ctx");
                ...
                View view2 = this.c.y;
                Context context5 = this.f3465d;
                e.b(context5, "ctx");
                Context context6 = this.f3465d;
                e.b(context6, "ctx");
    ...
    public void g(RecyclerView.b0 b0Var, List list) {
        ...
        Context context = view.getContext();
        aVar.u.setText(this.b.f3452e);
        aVar.v.setText(this.b.f3453f);
        if (TextUtils.isEmpty(this.b.f3455h)) {
            textView = aVar.x;
            charSequence = this.b.f3455h;
        } else {
            textView = aVar.x;
            charSequence = Html.fromHtml(this.b.f3455h);
        }
        textView.setText(charSequence);
        Objects.requireNonNull(this.c);
        boolean z = false;
        if (!(!(this.b.f3456i.length() == 0) || (a3 = this.b.a()) == null || (str3 = a3.b) == null)) {
            if (str3.length() == 0) {
                aVar.y.setVisibility(8);
                aVar.z.setVisibility(8);
                aVar.A.setVisibility(8);
                if (this.b.f3454g.length() > 0) {
        ...
        String str4 = "";
        if (this.b.f3456i.length() > 0) {
            Objects.requireNonNull(this.c);
            aVar.z.setText(this.b.f3456i);
        } else {
            aVar.z.setText(str4);
        }
        if (!(this.b.a() == null || (a2 = this.b.a()) == null || (str2 = a2.b) == null)) {
            if ((str2.length() > 0) && this.c.f3439e) {
                textView2 = aVar.A;
