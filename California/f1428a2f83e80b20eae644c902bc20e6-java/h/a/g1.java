...
public final class g1 implements Executor {
    ...
    public final AtomicReference<Thread> f3529d = new AtomicReference<>();
    ...
    public final void a() {
        while (this.f3529d.compareAndSet(null, Thread.currentThread())) {
            while (true) {
                try {
    ...
    public void d() {
        f.b.a.c.b.o.b.G(Thread.currentThread() == this.f3529d.get(), "Not called from the SynchronizationContext");
    }
