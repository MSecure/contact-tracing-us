...
public abstract class a extends d implements u, a2.d {
    ...
    public static final Logger f3538f = Logger.getLogger(a.class.getName());
    public final c3 a;
    public final o0 b;
    public boolean c;
    ...
    public class C0139a implements o0 {
        ...
        public void close() {
            ...
            ((f.a) a.this.o()).a(this.a, this.f3541d);
            this.f3541d = null;
            this.a = null;
        }
        ...
        public void d(InputStream inputStream) {
            f.b.a.c.b.o.b.G(this.f3541d == null, "writePayload should not be called multiple times");
            try {
                this.f3541d = f.b.b.c.b.b(inputStream);
                for (f1 f1Var : this.c.a) {
                    Objects.requireNonNull(f1Var);
                }
                w2 w2Var = this.c;
                int length = this.f3541d.length;
                for (f1 f1Var2 : w2Var.a) {
                    Objects.requireNonNull(f1Var2);
                }
                w2 w2Var2 = this.c;
                int length2 = this.f3541d.length;
                for (f1 f1Var3 : w2Var2.a) {
                    Objects.requireNonNull(f1Var3);
                }
                w2 w2Var3 = this.c;
                long length3 = (long) this.f3541d.length;
    ...
    public static abstract class c extends d.a {
        ...
        public class RunnableC0140a implements Runnable {
            ...
            /* renamed from: d  reason: collision with root package name */
            public final /* synthetic */ n0 f3548d;
            ...
            public void run() {
                c.this.g(this.b, this.c, this.f3548d);
            }
        }
        ...
        public final void g(c1 c1Var, v.a aVar, n0 n0Var) {
            if (!this.f3544i) {
                this.f3544i = true;
                w2 w2Var = this.f3543h;
                if (w2Var.b.compareAndSet(false, true)) {
                    for (f1 f1Var : w2Var.a) {
                        Objects.requireNonNull(f1Var);
                    }
                }
                this.f3545j.d(c1Var, aVar, n0Var);
                c3 c3Var = this.f3580d;
                if (c3Var == null) {
                    return;
                }
                if (c1Var.e()) {
        ...
        public void h(n0 n0Var) {
            ...
            String str2 = (String) n0Var.d(q0.f3710e);
            if (this.f3546k && str2 != null) {
                if (str2.equalsIgnoreCase("gzip")) {
                    ...
                    if (str != null) {
                        t.a aVar = this.f3547l.a.get(str);
    ...
    public a(e3 e3Var, w2 w2Var, c3 c3Var, n0 n0Var, h.a.c cVar, boolean z) {
        ...
        this.a = c3Var;
        this.c = !Boolean.TRUE.equals(cVar.a(q0.f3717l));
        this.f3539d = z;
        if (!z) {
    ...
    public void e(r rVar) {
        n0 n0Var = this.f3540e;
        n0.f<Long> fVar = q0.b;
        n0Var.b(fVar);
        this.f3540e.h(fVar, Long.valueOf(Math.max(0L, rVar.e(TimeUnit.NANOSECONDS))));
    }

    @Override // h.a.j1.u
    public final void f(t tVar) {
        c p = p();
        f.b.a.c.b.o.b.G(p.f3545j == null, "Already called start");
    ...
    public final void i(v vVar) {
        c p = p();
        f.b.a.c.b.o.b.G(p.f3545j == null, "Already called setListener");
        f.b.a.c.b.o.b.A(vVar, "listener");
        p.f3545j = vVar;
        if (!this.f3539d) {
            ((f.a) o()).a(this.f3540e, null);
            this.f3540e = null;
        }
    }
