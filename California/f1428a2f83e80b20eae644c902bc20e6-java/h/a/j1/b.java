...
public abstract class b<T extends b<T>> extends l0<T> {
    ...
    public static final t B = t.f3978d;
        ...
        synchronized (u0.class) {
            if (u0.f3980e == null) {
                ...
                try {
                    ...
                    u0.f3979d.log(Level.FINE, "Unable to find DNS NameResolver", (Throwable) e2);
                }
                List<s0> q1 = f.b.a.c.b.o.b.q1(s0.class, Collections.unmodifiableList(arrayList), s0.class.getClassLoader(), new u0.b(null));
                if (q1.isEmpty()) {
                    u0.f3979d.warning("No NameResolverProviders found via ServiceLoader, including for DNS. This is probably due to a broken build. If using ProGuard, check your configuration");
                }
                u0.f3980e = new u0();
                for (s0 s0Var : q1) {
                    Logger logger2 = u0.f3979d;
