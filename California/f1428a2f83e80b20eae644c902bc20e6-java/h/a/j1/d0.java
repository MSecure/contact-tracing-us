...
public final class d0 implements y1 {
    ...
    public final g1 f3584d;

    /* renamed from: e  reason: collision with root package name */
    public Runnable f3585e;

    /* renamed from: f  reason: collision with root package name */
    public Runnable f3586f;

    /* renamed from: g  reason: collision with root package name */
    public Runnable f3587g;

    /* renamed from: h  reason: collision with root package name */
    public y1.a f3588h;

    /* renamed from: i  reason: collision with root package name */
    public Collection<f> f3589i = new LinkedHashSet();
    ...
    public class f extends e0 {
        ...
        /* renamed from: i  reason: collision with root package name */
        public final h0.f f3593i;

        /* renamed from: j  reason: collision with root package name */
        public final q f3594j = q.P();
        ...
        public void g(c1 c1Var) {
            ...
            synchronized (d0.this.b) {
                d0 d0Var = d0.this;
                if (d0Var.f3587g != null) {
                    boolean remove = d0Var.f3589i.remove(this);
                    if (!d0.this.h() && remove) {
                        d0 d0Var2 = d0.this;
                        d0Var2.f3584d.b(d0Var2.f3586f);
                        d0 d0Var3 = d0.this;
                        if (d0Var3.f3590j != null) {
                            d0Var3.f3584d.b(d0Var3.f3587g);
                            d0.this.f3587g = null;
                        }
                    }
                }
    ...
    public final void a(c1 c1Var) {
        ...
        d(c1Var);
        synchronized (this.b) {
            collection = this.f3589i;
            runnable = this.f3587g;
            this.f3587g = null;
            if (!collection.isEmpty()) {
                this.f3589i = Collections.emptyList();
            }
        }
        if (runnable != null) {
    ...
    public final f b(h0.f fVar) {
        ...
        this.f3589i.add(fVar2);
        synchronized (this.b) {
            size = this.f3589i.size();
        }
        if (size == 1) {
            this.f3584d.b(this.f3585e);
        }
        return fVar2;
    }
    ...
    public final void d(c1 c1Var) {
        ...
        synchronized (this.b) {
            if (this.f3590j == null) {
                ...
                queue.add(dVar);
                if (!h() && (runnable = this.f3587g) != null) {
                    this.f3584d.b(runnable);
                    this.f3587g = null;
                }
                this.f3584d.a();
            }
    ...
    public final Runnable e(y1.a aVar) {
        this.f3588h = aVar;
        this.f3585e = new a(this, aVar);
        this.f3586f = new b(this, aVar);
        this.f3587g = new c(this, aVar);
        return null;
    }
    ...
    public final u g(o0<?, ?> o0Var, n0 n0Var, h.a.c cVar) {
        ...
        try {
            ...
            while (true) {
                synchronized (this.b) {
                    c1 c1Var = this.f3590j;
                    if (c1Var == null) {
                        h0.i iVar2 = this.f3591k;
                        if (iVar2 != null) {
                            if (iVar != null && j2 == this.f3592l) {
                                break;
                            }
                            j2 = this.f3592l;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0067, code lost:
        r6.f3589i.removeAll(r0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0072, code lost:
        if (r6.f3589i.isEmpty() == false) goto L_0x007b;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0074, code lost:
        r6.f3589i = new java.util.LinkedHashSet();
     */
    ...
    public final void i(h0.i iVar) {
        synchronized (this.b) {
            ...
            if (iVar != null) {
                if (h()) {
                    ArrayList arrayList = new ArrayList(this.f3589i);
                }
            }
        }
    }
