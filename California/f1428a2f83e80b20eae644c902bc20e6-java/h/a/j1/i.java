...
public final class i {
    ...
    public i(String str) {
        ...
        synchronized (j0.class) {
            if (j0.f3536d == null) {
                List<i0> q1 = f.b.a.c.b.o.b.q1(i0.class, j0.f3537e, i0.class.getClassLoader(), new j0.a());
                j0.f3536d = new j0();
                for (i0 i0Var : q1) {
                    Logger logger2 = j0.c;
    ...
    public q0.b b(Map<String, ?> map, h.a.e eVar) {
        ...
        if (map != null) {
            try {
                ...
                return new q0.b(c1.f3511h.g("can't parse load balancer configuration").f(e2));
            }
        } else {
            list = null;
        }
        ...
        return new q0.b(c1.f3511h.g("None of " + arrayList + " specified by Service Config are available."));
    }
}
