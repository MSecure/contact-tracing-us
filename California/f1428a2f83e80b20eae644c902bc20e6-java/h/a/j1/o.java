...
public final class o {
    ...
    public static final Logger f3688e = Logger.getLogger(e.class.getName());
    ...
    public o(d0 d0Var, int i2, long j2, String str) {
        ...
        String t = f.a.a.a.a.t(str, " created");
        ...
        b(new b0(t, aVar, valueOf.longValue(), null, null, null));
    }

    public static void a(d0 d0Var, Level level, String str) {
        Logger logger = f3688e;
