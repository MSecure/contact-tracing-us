...
public final class p<ReqT, RespT> extends f<ReqT, RespT> {
    ...
    public final m f3693d;

    /* renamed from: e  reason: collision with root package name */
    public final q f3694e;

    /* renamed from: f  reason: collision with root package name */
    public final boolean f3695f;

    /* renamed from: g  reason: collision with root package name */
    public final h.a.c f3696g;
    ...
    public volatile boolean f3699j;
            ...
            public final void b() {
                ...
                if (!bVar.b) {
                    try {
                        ...
                        c1 g2 = c1.f3510g.f(th).g("Failed to read headers");
                        p.this.f3698i.g(g2);
                    ...
                    while (true) {
                        try {
                            ...
                            if (next2 != null) {
                                try {
                                    b bVar = b.this;
                                    bVar.a.c(p.this.a.f3951e.a(next2));
                                    next2.close();
                                } catch (Throwable th) {
                                    q0.b(next2);
                                    throw th;
                            ...
                            while (true) {
                                ...
                                if (next3 != null) {
                                    ...
                                    c1 g2 = c1.f3510g.f(th2).g("Failed to read message.");
                                    p.this.f3698i.g(g2);
                                    b.f(b.this, g2, new n0());
                                    return;
                                }
        ...
        public final class c extends b0 {
            ...
            public final void b() {
                try {
                    ...
                    c1 g2 = c1.f3510g.f(th).g("Failed to call onReady.");
                    p.this.f3698i.g(g2);
                    b.f(b.this, g2, new n0());
                }
            }
    ...
    public final class d implements q.b {
        ...
        public void a(q qVar) {
            if (qVar.W() == null || !qVar.W().c()) {
                p.this.f3698i.g(f.b.a.c.b.o.b.S1(qVar));
                return;
            }
    ...
    public p(o0<ReqT, RespT> o0Var, Executor executor, h.a.c cVar, c cVar2, ScheduledExecutorService scheduledExecutorService, m mVar, boolean z) {
        ...
        this.f3694e = q.P();
        o0.c cVar3 = o0Var.a;
        this.f3695f = (cVar3 == o0.c.UNARY || cVar3 == o0.c.SERVER_STREAMING) ? true : z2;
        this.f3696g = cVar;
        this.f3701l = cVar2;
    ...
    public void a() {
        ...
        Objects.requireNonNull(aVar);
        try {
            f.b.a.c.b.o.b.G(this.f3698i != null, "Not started");
            f.b.a.c.b.o.b.G(true, "call was cancelled");
            f.b.a.c.b.o.b.G(!this.f3700k, "call already half-closed");
            this.f3700k = true;
            this.f3698i.l();
            Objects.requireNonNull(aVar);
        } catch (Throwable th) {
    ...
    public final void h(ReqT reqt) {
        f.b.a.c.b.o.b.G(this.f3698i != null, "Not started");
        f.b.a.c.b.o.b.G(true, "call was cancelled");
        f.b.a.c.b.o.b.G(!this.f3700k, "call was half-closed");
        try {
            u uVar = this.f3698i;
            if (uVar instanceof n2) {
                ((n2) uVar).y(reqt);
            } else {
                uVar.h(this.a.f3950d.b(reqt));
            }
            if (!this.f3695f) {
                this.f3698i.flush();
            }
        } catch (RuntimeException e2) {
            this.f3698i.g(c1.f3510g.f(e2).g("Failed to stream message"));
        } catch (Error e3) {
            this.f3698i.g(c1.f3510g.g("Client sendMessage() failed with Error"));
            throw e3;
        }
    }
    ...
    public final void i(f.a<RespT> aVar, n0 n0Var) {
        ...
        h.a.k kVar = k.b.a;
        c2 c2Var = c2.a;
        f.b.a.c.b.o.b.G(this.f3698i == null, "Already started");
        f.b.a.c.b.o.b.G(true, "call was cancelled");
        f.b.a.c.b.o.b.A(aVar, "observer");
        f.b.a.c.b.o.b.A(n0Var, "headers");
        if (this.f3694e.X()) {
            this.f3698i = c2Var;
            c1 S1 = f.b.a.c.b.o.b.S1(this.f3694e);
            executor = this.c;
            qVar = new q(this, aVar, S1);
        } else {
            String str = this.f3696g.f3501e;
            if (str != null) {
            ...
            if (!(f2 != null && f2.c())) {
                ...
                if (this.f3697h) {
                    ...
                    h.a.c cVar2 = this.f3696g;
                    q qVar2 = this.f3694e;
                    m1.h hVar = (m1.h) cVar;
                    Objects.requireNonNull(m1.this);
                    f.b.a.c.b.o.b.G(false, "retry should be enabled");
                    this.f3698i = new r1(hVar, o0Var, n0Var, cVar2, m1.this.Q.b.c, qVar2);
                } else {
                    w a2 = ((m1.h) this.f3701l).a(new h2(this.a, n0Var, this.f3696g));
                    q d2 = this.f3694e.d();
                    try {
                        this.f3698i = a2.g(this.a, n0Var, this.f3696g);
                    } finally {
                        this.f3694e.V(d2);
                    }
                }
                ...
                c1 c1Var = c1.f3512i;
                this.f3698i = new i0(c1Var.g("ClientCall started after deadline exceeded: " + f2));
            }
            String str2 = this.f3696g.c;
            if (str2 != null) {
                this.f3698i.j(str2);
            }
            Integer num = this.f3696g.f3505i;
            if (num != null) {
                this.f3698i.d(num.intValue());
            }
            Integer num2 = this.f3696g.f3506j;
            if (num2 != null) {
                this.f3698i.a(num2.intValue());
            }
            if (f2 != null) {
                this.f3698i.e(f2);
            }
            ...
            this.f3698i.f(this.p);
            m mVar = this.f3693d;
            mVar.b.a(1);
            mVar.a.a();
            this.m = new d(aVar, null);
            this.f3698i.i(new b(aVar));
            this.f3694e.c(this.m, f.b.b.f.a.k.INSTANCE);
            if (f2 != null && !f2.equals(this.f3694e.W()) && this.n != null && !(this.f3698i instanceof i0)) {
