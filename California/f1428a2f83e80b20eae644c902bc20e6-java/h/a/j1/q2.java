...
public final class q2 implements Executor, Runnable {
    ...
    public static final Logger f3727e = Logger.getLogger(q2.class.getName());

    /* renamed from: f  reason: collision with root package name */
    public static final b f3728f;
    public final Executor b;
    public final Queue<Runnable> c = new ConcurrentLinkedQueue();

    /* renamed from: d  reason: collision with root package name */
    private volatile int f3729d = 0;
    ...
    static {
        ...
        try {
            ...
            f3727e.log(Level.SEVERE, "FieldUpdaterAtomicHelper failed", th);
            bVar = new d(null);
        }
        f3728f = bVar;
    }
