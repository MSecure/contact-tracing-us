...
public class z1 implements Closeable, c0 {
    ...
    public final w2 f3785d;

    /* renamed from: e  reason: collision with root package name */
    public final c3 f3786e;
    ...
    public static final class d extends FilterInputStream {
        ...
        public final void d() {
            ...
            int i2 = this.b;
            if (j2 > ((long) i2)) {
                throw new e1(c1.f3515l.g(String.format("Compressed gRPC message exceeds maximum size %d: %d bytes read", Integer.valueOf(i2), Long.valueOf(this.f3795e))));
            }
        }
    ...
    public void A(s sVar) {
        f.b.a.c.b.o.b.G(this.f3788g == null, "Already set full stream decompressor");
    ...
    public void N(r0 r0Var) {
        boolean z = true;
        f.b.a.c.b.o.b.G(this.f3787f == k.b.a, "per-message decompressor already set");
        if (this.f3788g != null) {
            z = false;
        }
        ...
        try {
            if (!W()) {
                if (!this.s) {
                    z = false;
                    if (z) {
                        r0 r0Var = this.f3788g;
                        if (r0Var != null) {
                            f.b.a.c.b.o.b.G(!r0Var.f3737j, "GzipInflatingBuffer is closed");
                            r0Var.b.d(j2Var);
                            r0Var.p = false;
                        } else {
                            this.n.d(j2Var);
    ...
    public final void V() {
        if (!this.p) {
            ...
            while (!this.t && this.o > 0 && a0()) {
                try {
                    int ordinal = this.f3791j.ordinal();
                    if (ordinal == 0) {
                        Z();
                    } else if (ordinal == 1) {
                        Y();
                        ...
                        throw new AssertionError("Invalid state: " + this.f3791j);
                    }
                } finally {
                    this.p = false;
                }
    ...
    public boolean W() {
        return this.n == null && this.f3788g == null;
    }

    public final boolean X() {
        r0 r0Var = this.f3788g;
        if (r0Var != null) {
            f.b.a.c.b.o.b.G(true ^ r0Var.f3737j, "GzipInflatingBuffer is closed");
            return r0Var.p;
        } else if (this.n.b == 0) {
            return true;
        } else {
        ...
        if (this.f3793l) {
            ...
            if (sVar != k.b.a) {
                try {
                    y yVar = this.m;
                    int i2 = k2.a;
                    inputStream = new d(sVar.b(new k2.a(yVar)), this.c, this.f3785d);
    ...
    public final void Z() {
        ...
        if ((E & 254) == 0) {
            ...
            this.f3792k = E2;
            if (E2 < 0 || E2 > this.c) {
                throw new e1(c1.f3515l.g(String.format("gRPC message exceeds maximum size %d: %d", Integer.valueOf(this.c), Integer.valueOf(this.f3792k))));
            }
            this.q++;
            for (f1 f1Var : this.f3785d.a) {
                Objects.requireNonNull(f1Var);
            }
            c3 c3Var = this.f3786e;
            c3Var.f3579g.a(1);
            c3Var.a.a();
            this.f3791j = e.BODY;
            return;
    ...
    public final boolean a0() {
        ...
        try {
            ...
            while (true) {
                try {
                    int i9 = this.f3792k - this.m.b;
                    if (i9 <= 0) {
                        if (i8 > 0) {
                            this.b.f(i8);
                            if (this.f3791j == eVar) {
                                if (this.f3788g != null) {
                                    this.f3785d.a((long) i2);
                                    i4 = this.r + i2;
                                } else {
                                    this.f3785d.a((long) i8);
                                    i4 = this.r + i8;
                                }
                                this.r = i4;
                            }
                        ...
                        return true;
                    } else if (this.f3788g != null) {
                        try {
                            byte[] bArr = this.f3789h;
                            if (bArr == null || this.f3790i == bArr.length) {
                                this.f3789h = new byte[Math.min(i9, 2097152)];
                                this.f3790i = 0;
                            }
                            int c2 = this.f3788g.c(this.f3789h, this.f3790i, Math.min(i9, this.f3789h.length - this.f3790i));
                            r0 r0Var = this.f3788g;
                            int i10 = r0Var.n;
                            r0Var.n = 0;
                            i8 += i10;
        ...
        if (!W()) {
            ...
            try {
                ...
                if (r0Var != null) {
                    if (!z3) {
                        f.b.a.c.b.o.b.G(!r0Var.f3737j, "GzipInflatingBuffer is closed");
                        if (r0.b.c(r0Var.f3731d) == 0) {
                            if (r0Var.f3736i == r0.c.HEADER) {
                                z = false;
                                if (z) {
                                    z2 = false;
                                }
