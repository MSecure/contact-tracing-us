...
public class i {
    ...
    public static final h.a.k1.p.i c = h.a.k1.p.i.f3877d;

    /* renamed from: d  reason: collision with root package name */
    public static i f3848d;
    public final h.a.k1.p.i a;

    public static final class a extends i {

        /* renamed from: e  reason: collision with root package name */
        public static final e<Socket> f3849e = new e<>(null, "setUseSessionTickets", Boolean.TYPE);

        /* renamed from: f  reason: collision with root package name */
        public static final e<Socket> f3850f = new e<>(null, "setHostname", String.class);

        /* renamed from: g  reason: collision with root package name */
        public static final e<Socket> f3851g = new e<>(byte[].class, "getAlpnSelectedProtocol", new Class[0]);

        /* renamed from: h  reason: collision with root package name */
        public static final e<Socket> f3852h = new e<>(null, "setAlpnProtocols", byte[].class);

        /* renamed from: i  reason: collision with root package name */
        public static final e<Socket> f3853i = new e<>(byte[].class, "getNpnSelectedProtocol", new Class[0]);

        /* renamed from: j  reason: collision with root package name */
        public static final e<Socket> f3854j = new e<>(null, "setNpnProtocols", byte[].class);
        ...
        public void a(SSLSocket sSLSocket, String str, List<j> list) {
            if (str != null) {
                f3849e.d(sSLSocket, Boolean.TRUE);
                f3850f.d(sSLSocket, str);
            }
            Object[] objArr = {h.a.k1.p.i.b(list)};
            if (this.a.e() == i.e.ALPN_AND_NPN) {
                f3852h.e(sSLSocket, objArr);
            }
            if (this.a.e() != i.e.NONE) {
                f3854j.e(sSLSocket, objArr);
                return;
            }
        ...
        public String b(SSLSocket sSLSocket) {
            if (this.a.e() == i.e.ALPN_AND_NPN) {
                try {
                    byte[] bArr = (byte[]) f3851g.e(sSLSocket, new Object[0]);
                    if (bArr != null) {
            ...
            try {
                byte[] bArr2 = (byte[]) f3853i.e(sSLSocket, new Object[0]);
                if (bArr2 != null) {
