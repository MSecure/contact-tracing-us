...
public final class k {
    ...
    public static SSLSocket a(SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier, Socket socket, String str, int i2, b bVar) {
        f.b.a.c.b.o.b.A(sSLSocketFactory, "sslSocketFactory");
        f.b.a.c.b.o.b.A(socket, "socket");
        f.b.a.c.b.o.b.A(bVar, "spec");
        ...
        b.C0145b bVar2 = new b.C0145b(bVar);
        if (bVar2.a) {
            if (strArr == null) {
                bVar2.b = null;
            } else {
            ...
            if (bVar2.a) {
                    ...
                    if (!c.equals("http/1.1")) {
                        ...
                        if (!c.equals("h2")) {
                            ...
                            if (!c.equals("spdy/3.1")) {
                                throw new IOException(a.t("Unexpected protocol: ", c));
                            }
                        }
                    }
                }
                boolean contains = list2.contains(jVar);
                f.b.a.c.b.o.b.H(contains, "Only " + list2 + " are supported, but negotiated protocol is %s", c);
                ...
                throw new SSLPeerUnverifiedException(a.t("Cannot verify hostname: ", str));
            }
