...
public class n {
    ...
    public final a f3855d = new a(0, 65535);
    ...
    public final class a {
        ...
        public int b() {
            return Math.max(0, Math.min(this.c, (int) this.a.c)) - this.f3856d;
        }

        public int c() {
            return Math.min(this.c, n.this.f3855d.c);
        }
        ...
        public void d(e eVar, int i2, boolean z) {
            do {
                ...
                try {
                    ...
                    f.b bVar = this.f3857e.m;
                    synchronized (bVar.c) {
                        b.G(bVar.f3582f, "onStreamAllocated was not called, but it seems the stream is active");
                        int i4 = bVar.f3581e;
                        boolean z3 = i4 < 32768;
                        int i5 = i4 - min;
                        bVar.f3581e = i5;
    ...
    public boolean c(int i2) {
        if (i2 >= 0) {
            ...
            f[] l2 = this.a.l();
            for (f fVar : l2) {
                a aVar = (a) fVar.f3826k;
                if (aVar == null) {
                    fVar.f3826k = new a(this, fVar, this.c);
                } else {
                    aVar.a(i3);
                }
            }
