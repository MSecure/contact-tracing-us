...
public final class e {
    ...
    public static final class a {
        ...
        public final void a() {
            Arrays.fill(this.f3915e, (Object) null);
            this.f3916f = this.f3915e.length - 1;
            this.f3917g = 0;
            this.f3918h = 0;
        }

        public final int b(int i2) {
            return this.f3916f + 1 + i2;
        }
        ...
        public final int c(int i2) {
            ...
            if (i2 > 0) {
                ...
                while (true) {
                    ...
                    i3 = this.f3916f;
                    if (length < i3 || i2 <= 0) {
                        d[] dVarArr = this.f3915e;
                        System.arraycopy(dVarArr, i3 + 1, dVarArr, i3 + 1 + i4, this.f3917g);
                        this.f3916f += i4;
                    } else {
                        d[] dVarArr2 = this.f3915e;
                        i2 -= dVarArr2[length].c;
                        this.f3918h -= dVarArr2[length].c;
                        this.f3917g--;
                        i4++;
                    }
                }
                d[] dVarArr3 = this.f3915e;
                System.arraycopy(dVarArr3, i3 + 1, dVarArr3, i3 + 1 + i4, this.f3917g);
                this.f3916f += i4;
            }
            return i4;
        }
        ...
        public final void e(int i2, d dVar) {
            ...
            int i3 = dVar.c;
            if (i2 != -1) {
                i3 -= this.f3915e[(this.f3916f + 1) + i2].c;
            }
            int i4 = this.f3914d;
            if (i3 > i4) {
                a();
            ...
            int c2 = c((this.f3918h + i3) - i4);
            if (i2 == -1) {
                int i5 = this.f3917g + 1;
                d[] dVarArr = this.f3915e;
                if (i5 > dVarArr.length) {
                    d[] dVarArr2 = new d[(dVarArr.length * 2)];
                    System.arraycopy(dVarArr, 0, dVarArr2, dVarArr.length, dVarArr.length);
                    this.f3916f = this.f3915e.length - 1;
                    this.f3915e = dVarArr2;
                }
                int i6 = this.f3916f;
                this.f3916f = i6 - 1;
                this.f3915e[i6] = dVar;
                ...
                this.f3915e[this.f3916f + 1 + i2 + c2 + i2] = dVar;
            }
            this.f3918h += i3;
        }
    ...
    public static final class b {
        ...
        public final void a(d dVar) {
            ...
            if (i3 > 4096) {
                ...
                this.f3920e = this.c.length - 1;
                this.f3919d = 0;
                this.f3921f = 0;
                return;
            }
            int i4 = (this.f3921f + i3) - 4096;
            if (i4 > 0) {
                ...
                while (true) {
                    ...
                    if (length < i2 || i4 <= 0) {
                        d[] dVarArr = this.c;
                        int i6 = i2 + 1;
                        System.arraycopy(dVarArr, i6, dVarArr, i6 + i5, this.f3919d);
                        this.f3920e += i5;
                    } else {
                        d[] dVarArr2 = this.c;
                        i4 -= dVarArr2[length].c;
                        this.f3921f -= dVarArr2[length].c;
                        this.f3919d--;
                        i5++;
                        length--;
                    }
                ...
                d[] dVarArr3 = this.c;
                int i62 = i2 + 1;
                System.arraycopy(dVarArr3, i62, dVarArr3, i62 + i5, this.f3919d);
                this.f3920e += i5;
            }
            int i7 = this.f3919d + 1;
            d[] dVarArr4 = this.c;
