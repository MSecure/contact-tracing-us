...
public final class f implements i {
        ...
        public long m(e eVar, long j2) {
            ...
            do {
                ...
                if (i3 == 0) {
                    ...
                    this.f3922d = (byte) (this.b.Q() & 255);
                    Logger logger = f.a;
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine(b.a(true, this.f3923e, this.c, Q, this.f3922d));
                    }
    ...
    public static final class c implements b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final e.a f3926d;

        public c(g gVar, int i2, boolean z) {
            this.b = gVar;
            a aVar = new a(gVar);
            this.c = aVar;
            this.f3926d = new e.a(i2, aVar);
        }
        ...
        public final void A(b.a aVar, int i2, byte b2, int i3) {
            ...
            if (i3 != 0) {
                ...
                synchronized (h.a.k1.g.this.f3834j) {
                    h.a.k1.g.this.f3832h.T(i3, a.PROTOCOL_ERROR);
                }
                return;
            }
            ...
            if (i3 != 0) {
                ...
                while (true) {
                    ...
                    if (i4 < i2) {
                        ...
                        synchronized (h.a.k1.g.this.f3834j) {
                            if (hVar.a(4)) {
                                h.a.k1.g.this.B = hVar.f3932d[4];
                            }
                            boolean c2 = hVar.a(7) ? h.a.k1.g.this.f3833i.c(hVar.f3932d[7]) : false;
                            if (eVar.f3839d) {
                                h.a.k1.g.this.f3831g.b();
                                eVar.f3839d = false;
                            }
                            h.a.k1.g.this.f3832h.e(hVar);
                            if (c2) {
                                h.a.k1.g.this.f3833i.f();
                            }
                            h.a.k1.g.this.w();
                        }
                        int i5 = hVar.a & 2;
                        int i6 = -1;
                        if ((i5 != 0 ? hVar.f3932d[1] : -1) >= 0) {
                            e.a aVar2 = this.f3926d;
                            if (i5 != 0) {
                                i6 = hVar.f3932d[1];
                            }
                            aVar2.c = i6;
            ...
            if (i2 == 4) {
                ...
                if (i4 != 0) {
                    ...
                    if (i4 == 0) {
                        ...
                        synchronized (h.a.k1.g.this.f3834j) {
                            if (i3 == 0) {
                                h.a.k1.g.this.f3833i.e(null, (int) w);
                                return;
                            }
                            h.a.k1.f fVar = h.a.k1.g.this.m.get(Integer.valueOf(i3));
                            if (fVar != null) {
                                h.a.k1.g.this.f3833i.e(fVar, (int) w);
                    ...
                    case 0:
                        ...
                        if (!((Q2 & 32) != 0)) {
                            ...
                            if (p != null) {
                                ...
                                synchronized (h.a.k1.g.this.f3834j) {
                                    h.a.k1.g.this.f3832h.T(w, aVar2);
                                }
                                gVar.p((long) c2);
                            } else {
                            ...
                            int i2 = gVar2.q + c2;
                            gVar2.q = i2;
                            if (((float) i2) >= ((float) gVar2.f3830f) * 0.5f) {
                                synchronized (gVar2.f3834j) {
                                    h.a.k1.g gVar3 = h.a.k1.g.this;
                                    gVar3.f3832h.u(0, (long) gVar3.q);
                                }
                                h.a.k1.g.this.q = 0;
                            }
                            this.b.p((long) Q3);
                        ...
                        if (w != 0) {
                            ...
                            synchronized (h.a.k1.g.this.f3834j) {
                                ...
                                if (fVar == null) {
                                    ...
                                    if (!z3) {
                                        h.a.k1.g.this.f3832h.T(w, a.CANCEL);
                                    }
        ...
        public final void v(b.a aVar, int i2, byte b2, int i3) {
            ...
            if (i2 != 8) {
                ...
                if (!z) {
                    synchronized (h.a.k1.g.this.f3834j) {
                        h.a.k1.g.this.f3832h.C(true, w, w2);
                    }
                    return;
                }
                synchronized (h.a.k1.g.this.f3834j) {
    ...
    public static final class d implements c {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final k.e f3927d;

        /* renamed from: e  reason: collision with root package name */
        public final e.b f3928e;

        /* renamed from: f  reason: collision with root package name */
        public int f3929f = 16384;
        ...
        public void d(boolean z, int i2, List<d> list) {
            ...
            if (!this.f3930g) {
                ...
                while (true) {
                        ...
                        while (true) {
                            ...
                            if (dVarArr2[i7].a.equals(n)) {
                                if (bVar.c[i7].b.equals(hVar)) {
                                    i4 = e.b.length + (i7 - bVar.f3920e);
                                    break;
                                } else if (i3 == -1) {
                                    i3 = (i7 - bVar.f3920e) + e.b.length;
                                }
                            }
                            i6 = 1;
                        }
                    ...
                    if (i4 != -1) {
                        ...
                        if (i3 == -1) {
                            ...
                            if (!n.h(0, hVar2, 0, hVar2.l()) || d.f3913h.equals(n)) {
                                bVar.c(i3, 63, 64);
                            } else {
                                bVar.c(i3, 15, 0);
                                bVar.b(hVar);
                ...
                long j2 = this.f3927d.c;
                int min = (int) Math.min((long) this.f3929f, j2);
                long j3 = (long) min;
                ...
                c(i2, min, (byte) 1, b2);
                this.b.h(this.f3927d, j3);
                if (i8 > 0) {
                    long j4 = j2 - j3;
                    while (j4 > 0) {
                        int min2 = (int) Math.min((long) this.f3929f, j4);
                        long j5 = (long) min2;
                        j4 -= j5;
                        c(i2, min2, (byte) 9, j4 == 0 ? (byte) 4 : 0);
                        this.b.h(this.f3927d, j5);
                    }
                    return;
                }
                return;
