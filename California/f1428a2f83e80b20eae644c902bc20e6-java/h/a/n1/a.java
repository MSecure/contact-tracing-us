...
public final class a extends h0 {
    ...
    public static final a.c<d<o>> f3945g = new a.c<>("state-info");

    /* renamed from: h  reason: collision with root package name */
    public static final c1 f3946h = c1.f3509f.g("no subchannels ready");
    public final h0.d b;
    public final Map<v, h0.h> c = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    public final Random f3947d;

    /* renamed from: e  reason: collision with root package name */
    public n f3948e;

    /* renamed from: f  reason: collision with root package name */
    public e f3949f = new b(f3946h);

    /* renamed from: h.a.n1.a$a  reason: collision with other inner class name */
    public class C0146a implements h0.j {
        public final /* synthetic */ h0.h a;

        public C0146a(h0.h hVar) {
            this.a = hVar;
        }
        ...
        public void a(o oVar) {
            ...
            f.b.a.c.b.o.b.H(z, "%s does not have exactly one group", a2);
    ...
    public static final class b extends e {
        ...
        public boolean b(e eVar) {
            if (eVar instanceof b) {
                b bVar = (b) eVar;
                if (f.b.a.c.b.o.b.t0(this.a, bVar.a) || (this.a.e() && bVar.a.e())) {
                    return true;
                }
            }
            return false;
    ...
    public a(h0.d dVar) {
        ...
        this.b = dVar;
        this.f3947d = new Random();
    }

    public static d<o> e(h0.h hVar) {
        h.a.a b2 = hVar.b();
        Object obj = b2.a.get(f3945g);
    ...
    public final void g() {
        ...
        h(nVar2, new c(arrayList, this.f3947d.nextInt(arrayList.size())));
    }

    public final void h(n nVar, e eVar) {
        if (nVar != this.f3948e || !eVar.b(this.f3949f)) {
            this.b.d(nVar, eVar);
            this.f3948e = nVar;
            this.f3949f = eVar;
        }
