...
public final class r implements Comparable<r> {
    ...
    public static final b f3973e = new b(null);

    /* renamed from: f  reason: collision with root package name */
    public static final long f3974f;

    /* renamed from: g  reason: collision with root package name */
    public static final long f3975g;

    /* renamed from: h  reason: collision with root package name */
    public static final long f3976h = TimeUnit.SECONDS.toNanos(1);
    public final c b;
    public final long c;

    /* renamed from: d  reason: collision with root package name */
    public volatile boolean f3977d;
    ...
    public r(c cVar, long j2, boolean z) {
        ...
        this.b = cVar;
        long min = Math.min(f3974f, Math.max(f3975g, j2));
        this.c = nanoTime + min;
        this.f3977d = z && min <= 0;
    }
    ...
    public long e(TimeUnit timeUnit) {
        Objects.requireNonNull((b) this.b);
        long nanoTime = System.nanoTime();
        if (!this.f3977d && this.c - nanoTime <= 0) {
            this.f3977d = true;
        }
