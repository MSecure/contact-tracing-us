...
public final class f extends c<e> implements d, l.b.a.w.f, Serializable {
    ...
    public static final f f4037d = F(e.f4033e, g.f4039f);

    /* renamed from: e  reason: collision with root package name */
    public static final f f4038e = F(e.f4034f, g.f4040g);
    public final e b;
    public final g c;
    ...
    public void Q(DataOutput dataOutput) {
        ...
        dataOutput.writeByte(eVar.f4036d);
        this.c.J(dataOutput);
    }
    ...
    public <R> R c(l<R> lVar) {
        return lVar == k.f4200f ? (R) this.b : (R) super.c(lVar);
    }
