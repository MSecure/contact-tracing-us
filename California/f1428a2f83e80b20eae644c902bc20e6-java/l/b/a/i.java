...
public final class i extends c implements e, f, Comparable<i>, Serializable {
    ...
    public static final /* synthetic */ int f4054d = 0;
    public final int b;
    public final int c;
    ...
    public <R> R c(l<R> lVar) {
        return lVar == k.b ? (R) m.f4084d : (R) super.c(lVar);
    }
    ...
    public l.b.a.w.d n(l.b.a.w.d dVar) {
        if (h.l(dVar).equals(m.f4084d)) {
            l.b.a.w.d l2 = dVar.l(a.MONTH_OF_YEAR, (long) this.b);
            a aVar = a.DAY_OF_MONTH;
            return l2.l(aVar, Math.min(l2.a(aVar).f4203e, (long) this.c));
        }
