            ...
            switch (b2) {
                ...
                case 7:
                    ...
                    if (readUTF.equals("Z") || readUTF.startsWith("+") || readUTF.startsWith("-")) {
                        ...
                        return new r(readUTF, q.f4062g.s());
                    } else {
                        if (readUTF.startsWith("UTC+") || readUTF.startsWith("GMT+") || readUTF.startsWith("UTC-") || readUTF.startsWith("GMT-")) {
                            ...
                            if (x.c == 0) {
                                ...
                                rVar = new r(readUTF.substring(0, 3) + x.f4065d, x.s());
                            }
                            return rVar;
        ...
        if (b2 != 64) {
            switch (b2) {
                ...
                case 3:
                    ...
                    objectOutput.writeByte(eVar.f4036d);
                    return;
                case 4:
