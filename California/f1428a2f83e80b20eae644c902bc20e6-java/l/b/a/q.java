...
public final class q extends p implements e, f, Comparable<q>, Serializable {
    ...
    public static final ConcurrentMap<Integer, q> f4060e = new ConcurrentHashMap(16, 0.75f, 4);

    /* renamed from: f  reason: collision with root package name */
    public static final ConcurrentMap<String, q> f4061f = new ConcurrentHashMap(16, 0.75f, 4);

    /* renamed from: g  reason: collision with root package name */
    public static final q f4062g = z(0);

    /* renamed from: h  reason: collision with root package name */
    public static final q f4063h = z(-64800);

    /* renamed from: i  reason: collision with root package name */
    public static final q f4064i = z(64800);
    public final int c;

    /* renamed from: d  reason: collision with root package name */
    public final transient String f4065d;
    ...
    public static q z(int i2) {
        if (Math.abs(i2) > 64800) {
            ...
            ConcurrentMap<Integer, q> concurrentMap = f4060e;
            ...
            f4061f.putIfAbsent(qVar2.f4065d, qVar2);
            return qVar2;
        }
    }
    ...
    public <R> R c(l<R> lVar) {
        if (lVar == k.f4199e || lVar == k.f4198d) {
            return this;
        }
        if (lVar == k.f4200f || lVar == k.f4201g || lVar == k.c || lVar == k.b || lVar == k.a) {
            return null;
        }
        return lVar.a(this);
    }
