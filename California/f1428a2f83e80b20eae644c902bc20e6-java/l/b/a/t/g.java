...
public final class g<D extends b> extends f<D> implements Serializable {
    ...
    public static <R extends b> f<R> E(d<R> dVar, p pVar, q qVar) {
        ...
        if (c2.size() != 1) {
            if (c2.size() == 0) {
                d b2 = s.b(C);
                dVar = dVar.E(dVar.b, 0, 0, c.l((long) (b2.f4224d.c - b2.c.c)).b, 0);
                qVar = b2.f4224d;
            } else if (qVar != null) {
            }
            f.b.a.c.b.o.b.B1(qVar, "offset");
    ...
    public f<D> l(j jVar, long j2) {
        ...
        if (ordinal != 29) {
            return E(this.b.l(jVar, j2), this.f4069d, this.c);
        }
        return F(x().s(), this.b.w(q.z(aVar.f4182e.a(j2, aVar))), this.f4069d);
    }

    @Override // l.b.a.t.f
    public f<D> C(p pVar) {
        f.b.a.c.b.o.b.B1(pVar, "zone");
        if (this.f4069d.equals(pVar)) {
            return this;
        }
    ...
    @Override // l.b.a.t.f
    public int hashCode() {
        return (this.b.hashCode() ^ this.c.c) ^ Integer.rotateLeft(this.f4069d.hashCode(), 3);
    }
    ...
    public String toString() {
        ...
        if (this.c == this.f4069d) {
            return str;
        }
        return str + '[' + this.f4069d.toString() + ']';
    }
