...
public final class o extends h implements Serializable {
    ...
    public static final Locale f4086d = new Locale("ja", "JP", "JP");

    /* renamed from: e  reason: collision with root package name */
    public static final o f4087e = new o();

    /* renamed from: f  reason: collision with root package name */
    public static final Map<String, String[]> f4088f;

    /* renamed from: g  reason: collision with root package name */
    public static final Map<String, String[]> f4089g;

    /* renamed from: h  reason: collision with root package name */
    public static final Map<String, String[]> f4090h;
        ...
        if (!(ordinal == 15 || ordinal == 18 || ordinal == 20 || ordinal == 24)) {
            switch (ordinal) {
                ...
                case 13:
                    break;
                default:
                    Calendar instance = Calendar.getInstance(f4086d);
                    ...
                    if (ordinal2 == 19) {
                        ...
                        switch (ordinal2) {
                            ...
                            case 26:
                                q[] t3 = q.t();
                                return l.b.a.w.o.d((long) p.f4091e.b, (long) t3[t3.length - 1].q().b);
                            case 27:
                                q[] t4 = q.t();
