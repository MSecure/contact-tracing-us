...
public final class p extends a<p> implements Serializable {
    ...
    public static final e f4091e = e.P(1873, 1, 1);
    public final e b;
    public transient q c;

    /* renamed from: d  reason: collision with root package name */
    public transient int f4092d;

    public p(e eVar) {
        if (!eVar.J(f4091e)) {
            q r = q.r(eVar);
            this.c = r;
            this.f4092d = eVar.b - (r.c.b - 1);
            this.b = eVar;
            return;
        }
    ...
    public final o E(int i2) {
        Calendar instance = Calendar.getInstance(o.f4086d);
        instance.set(0, this.c.b + 2);
        int i3 = this.f4092d;
        e eVar = this.b;
        instance.set(i3, eVar.c - 1, eVar.f4036d);
        return o.d((long) instance.getActualMinimum(i2), (long) instance.getActualMaximum(i2));
    }

    public final long F() {
        return (long) (this.f4092d == 1 ? (this.b.H() - this.c.c.H()) + 1 : this.b.H());
    }
    ...
    public p z(j jVar, long j2) {
        ...
        if (ordinal == 19 || ordinal == 25 || ordinal == 27) {
            int a = o.f4087e.u(aVar).a(j2, aVar);
    ...
    public d e(f fVar) {
        return (p) o.f4087e.e(fVar.n(this));
    }
    ...
    @Override // l.b.a.t.b
    public b w(i iVar) {
        return (p) o.f4087e.e(((l) iVar).b(this));
    }
