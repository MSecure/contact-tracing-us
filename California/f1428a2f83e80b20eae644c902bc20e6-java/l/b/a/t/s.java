...
public final class s extends a<s> implements Serializable {
    ...
    public s z(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            case 24:
                r.f4100d.u(aVar).b(j2, aVar);
                return G(this.b.W(j2 - E()));
            case 25:
            case 26:
            case 27:
                int a = r.f4100d.u(aVar).a(j2, aVar);
                switch (aVar.ordinal()) {
                    case 25:
    ...
    public o a(j jVar) {
        ...
        if (f(jVar)) {
            ...
            if (ordinal != 25) {
                return r.f4100d.u(aVar);
            }
            o oVar = a.YEAR.f4182e;
            if (F() <= 0) {
                j2 = (-oVar.b) + 1 + 1911;
            } else {
                j2 = oVar.f4203e - 1911;
    ...
    public d e(f fVar) {
        return (s) r.f4100d.e(fVar.n(this));
    }
    ...
    @Override // l.b.a.t.b
    public b w(i iVar) {
        return (s) r.f4100d.e(((l) iVar).b(this));
    }
