...
public final class d {
    ...
    public static final l.b.a.w.l<l.b.a.p> f4121h = new a();

    /* renamed from: i  reason: collision with root package name */
    public static final Map<Character, l.b.a.w.j> f4122i;

    /* renamed from: j  reason: collision with root package name */
    public static final Comparator<String> f4123j = new c();
    public d a;
    public final d b;
    ...
    public static final class e implements f {
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            if (this.c) {
                ArrayList<e.a> arrayList = eVar.f4149g;
                e.a b2 = eVar.b();
                e.a aVar = new e.a();
                aVar.b = b2.b;
                aVar.c = b2.c;
                aVar.f4150d.putAll(b2.f4150d);
                aVar.f4151e = b2.f4151e;
                arrayList.add(aVar);
                int i3 = i2;
                for (f fVar : this.b) {
    ...
    public static final class g implements f {
        ...
        public g(l.b.a.w.j jVar, int i2, int i3, boolean z) {
            ...
            l.b.a.w.o h2 = jVar.h();
            if (!(h2.b == h2.c && h2.f4202d == h2.f4203e)) {
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            BigDecimal divide = BigDecimal.valueOf(longValue).subtract(valueOf).divide(BigDecimal.valueOf(h2.f4203e).subtract(valueOf).add(BigDecimal.ONE), 9, RoundingMode.FLOOR);
            BigDecimal stripTrailingZeros = divide.compareTo(BigDecimal.ZERO) == 0 ? BigDecimal.ZERO : divide.stripTrailingZeros();
            if (stripTrailingZeros.scale() != 0) {
                String a = jVar.a(stripTrailingZeros.setScale(Math.min(Math.max(stripTrailingZeros.scale(), this.c), this.f4128d), RoundingMode.FLOOR).toPlainString().substring(2));
                if (this.f4129e) {
                    sb.append(jVar.f4159d);
                }
                sb.append(a);
                return true;
            } else if (this.c <= 0) {
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            int i3;
            boolean z = eVar.f4148f;
            int i4 = z ? this.c : 0;
            int i5 = z ? this.f4128d : 9;
            int length = charSequence.length();
            if (i2 == length) {
                return i4 > 0 ? ~i2 : i2;
            }
            if (this.f4129e) {
                if (charSequence.charAt(i2) != eVar.b.f4159d) {
                    return i4 > 0 ? ~i2 : i2;
                }
                i2++;
            }
            ...
            l.b.a.w.o h2 = this.b.h();
            BigDecimal valueOf = BigDecimal.valueOf(h2.b);
            return eVar.g(this.b, movePointLeft.multiply(BigDecimal.valueOf(h2.f4203e).subtract(valueOf).add(BigDecimal.ONE)).setScale(0, RoundingMode.FLOOR).add(valueOf).longValueExact(), i2, i3);
        }

        public String toString() {
            String str = this.f4129e ? ",DecimalPoint" : "";
            StringBuilder h2 = f.a.a.a.a.h("Fraction(");
            h2.append(this.b);
            h2.append(",");
            h2.append(this.c);
            h2.append(",");
            h2.append(this.f4128d);
            h2.append(str);
            h2.append(")");
            return h2.toString();
        }
    ...
    public static final class h implements f {
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            if (longValue >= -62167219200L) {
                ...
                l.b.a.f G = l.b.a.f.G(f.b.a.c.b.o.b.D0(j2, 315569520000L) - 62167219200L, 0, l.b.a.q.f4062g);
                if (B0 > 0) {
                    sb.append('+');
                    sb.append(B0);
                }
                ...
                l.b.a.f G2 = l.b.a.f.G(j5 - 62167219200L, 0, l.b.a.q.f4062g);
                int length = sb.length();
                sb.append(G2);
                if (G2.c.f4043d == 0) {
                    sb.append(":00");
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            try {
                l.b.a.f fVar = l.b.a.f.f4037d;
                return eVar.g(aVar4, (long) intValue6, i2, eVar.g(l.b.a.w.a.INSTANT_SECONDS, new l.b.a.f(l.b.a.e.P(i4, intValue, intValue2), l.b.a.g.v(intValue3, intValue4, intValue5, 0)).I((long) i3).v(l.b.a.q.f4062g) + f.b.a.c.b.o.b.J1(longValue / 10000, 315569520000L), i2, b));
    ...
    public static class k implements f {
        ...
        /* renamed from: g  reason: collision with root package name */
        public static final int[] f4130g = {0, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000};
        public final l.b.a.w.j b;
        public final int c;
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            if (str.length() <= this.f4131d) {
                String a = jVar.a(str);
                int i3 = (c3 > 0 ? 1 : (c3 == 0 ? 0 : -1));
                int ordinal = this.f4132e.ordinal();
                if (i3 >= 0) {
                    if (ordinal == 1 || (ordinal == 4 && (i2 = this.c) < 19 && c3 >= ((long) f4130g[i2]))) {
                        c2 = jVar.b;
                    }
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            int i8 = 0;
            if (charAt == jVar.b) {
                if (!this.f4132e.a(true, eVar.f4148f, this.c == this.f4131d)) {
                    return ~i7;
                }
                i3 = i7 + 1;
                z2 = true;
                ...
                if (charAt == jVar.c) {
                    if (!this.f4132e.a(false, eVar.f4148f, this.c == this.f4131d)) {
                        return ~i7;
                    }
                    i7++;
                    z = true;
                } else if (this.f4132e == m.ALWAYS && eVar.f4148f) {
                    return ~i7;
                } else {
                    z = false;
                }
            ...
            int i9 = (eVar.f4148f || d(eVar)) ? this.c : 1;
            int i10 = i3 + i9;
            if (i10 > length) {
                return ~i3;
            }
            int i11 = 9;
            int max = Math.max(this.f4133f, 0) + ((eVar.f4148f || d(eVar)) ? this.f4131d : 9);
            while (true) {
                bigInteger = null;
                if (i8 >= 2) {
                    i4 = i3;
            ...
            if (z) {
                if (bigInteger != null) {
                    if (bigInteger.equals(BigInteger.ZERO) && eVar.f4148f) {
                        return ~(i3 - 1);
                    }
                    bigInteger = bigInteger.negate();
                } else if (j2 == 0 && eVar.f4148f) {
                    return ~(i3 - 1);
                } else {
                    j3 = -j2;
                    if (bigInteger != null) {
            ...
            } else if (this.f4132e == m.EXCEEDS_PAD && eVar.f4148f) {
                int i14 = i4 - i3;
                int i15 = this.c;
                if (z2) {
                    if (i14 <= i15) {
        ...
        public boolean d(e eVar) {
            int i2 = this.f4133f;
            return i2 == -1 || (i2 > 0 && this.c == this.f4131d && this.f4132e == m.NOT_NEGATIVE);
        }
        ...
        public k f() {
            return this.f4133f == -1 ? this : new k(this.b, this.c, this.f4131d, this.f4132e, -1);
        }

        public k g(int i2) {
            return new k(this.b, this.c, this.f4131d, this.f4132e, this.f4133f + i2);
        }
        ...
        public String toString() {
            ...
            Object obj;
            int i2 = this.c;
            if (i2 == 1 && this.f4131d == 19 && this.f4132e == m.NORMAL) {
                sb = f.a.a.a.a.h("Value(");
                obj = this.b;
            } else if (i2 == this.f4131d && this.f4132e == m.NOT_NEGATIVE) {
                sb = f.a.a.a.a.h("Value(");
                sb.append(this.b);
                sb.append(",");
                sb.append(this.c);
    ...
    public static final class l implements f {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final String[] f4134d = {"+HH", "+HHmm", "+HH:mm", "+HHMM", "+HH:MM", "+HHMMss", "+HH:MM:ss", "+HHMMSS", "+HH:MM:SS"};

        /* renamed from: e  reason: collision with root package name */
        public static final l f4135e = new l("Z", "+HH:MM:ss");
    ...
    public static final class n extends k {
        ...
        /* renamed from: j  reason: collision with root package name */
        public static final l.b.a.e f4137j = l.b.a.e.P(2000, 1, 1);

        /* renamed from: h  reason: collision with root package name */
        public final int f4138h;

        /* renamed from: i  reason: collision with root package name */
        public final l.b.a.t.b f4139i;
        ...
        public n(l.b.a.w.j jVar, int i2, int i3, int i4, l.b.a.t.b bVar) {
            ...
            if (i2 < 1 || i2 > 10) {
                ...
                if (bVar == null) {
                    ...
                    } else if (j2 + ((long) k.f4130g[i2]) > 2147483647L) {
        ...
        public long c(h hVar, long j2) {
            ...
            int i3 = this.f4138h;
            if (this.f4139i != null) {
                i3 = l.b.a.t.h.l(hVar.a).c(this.f4139i).b(this.b);
            }
            if (j2 >= ((long) i3)) {
                int i4 = this.c;
        ...
        public int e(e eVar, long j2, int i2, int i3) {
            int i4 = this.f4138h;
            if (this.f4139i != null) {
                i4 = eVar.d().c(this.f4139i).b(this.b);
                e.a b = eVar.b();
                if (b.f4153g == null) {
                    b.f4153g = new ArrayList(2);
                }
                b.f4153g.add(new Object[]{this, Long.valueOf(j2), Integer.valueOf(i2), Integer.valueOf(i3)});
            }
            int i5 = i3 - i2;
            int i6 = this.c;
            if (i5 == i6 && j2 >= 0) {
                long j3 = (long) k.f4130g[i6];
                long j4 = (long) i4;
                long j5 = j4 - (j4 % j3);
                j2 = i4 > 0 ? j5 + j2 : j5 - j2;
                if (j2 < j4) {
        ...
        @Override // l.b.a.u.d.k
        public k f() {
            return this.f4133f == -1 ? this : new n(this.b, this.c, this.f4131d, this.f4138h, this.f4139i, -1);
        }

        @Override // l.b.a.u.d.k
        public k g(int i2) {
            return new n(this.b, this.c, this.f4131d, this.f4138h, this.f4139i, this.f4133f + i2);
        }
        ...
        public String toString() {
            ...
            h2.append(this.c);
            h2.append(",");
            h2.append(this.f4131d);
            h2.append(",");
            Object obj = this.f4139i;
            if (obj == null) {
                obj = Integer.valueOf(this.f4138h);
            }
            h2.append(obj);
            h2.append(")");
            return h2.toString();
    ...
    public static final class q implements f {
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            String a = this.f4143d.a(this.b, b2.longValue(), this.c, hVar.b);
            if (a == null) {
                return c().a(hVar, sb);
            }
            sb.append(a);
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            Iterator<Map.Entry<String, Long>> b2 = this.f4143d.b(this.b, eVar.f4148f ? this.c : null, eVar.a);
            if (b2 != null) {
                while (b2.hasNext()) {
        ...
        public final k c() {
            if (this.f4144e == null) {
                this.f4144e = new k(this.b, 1, 19, m.NORMAL);
            }
            return this.f4144e;
        }
    ...
    public static final class r implements f {
        ...
        public final f c(l.b.a.w.p pVar) {
            ...
            char c2 = this.b;
            if (c2 == 'W') {
                kVar = new k(pVar.f4206e, 1, 2, mVar);
            } else if (c2 == 'Y') {
                int i2 = this.c;
                if (i2 == 2) {
                    kVar2 = new n(pVar.f4208g, 2, 2, 0, n.f4137j);
                } else {
                    kVar2 = new k(pVar.f4208g, i2, 19, i2 < 4 ? m.NORMAL : m.EXCEEDS_PAD, -1, null);
                }
                return kVar2;
            } else if (c2 == 'c') {
                kVar = new k(pVar.f4205d, this.c, 2, mVar);
            } else if (c2 == 'e') {
                kVar = new k(pVar.f4205d, this.c, 2, mVar);
            } else if (c2 != 'w') {
                return null;
            } else {
                kVar = new k(pVar.f4207f, this.c, 2, mVar);
            }
            return kVar;
        }
    ...
    public static final class s implements f {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static volatile Map.Entry<Integer, a> f4145d;
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            if (i2 > length) {
                ...
                if (charAt == '+' || charAt == '-') {
                    Objects.requireNonNull(eVar);
                    e eVar2 = new e(eVar);
                    int b2 = l.f4135e.b(eVar2, charSequence, i2);
                    if (b2 < 0) {
                        return b2;
                    }
                ...
                Map.Entry<Integer, a> entry = f4145d;
                String str2 = null;
                if (entry == null || entry.getKey().intValue() != size) {
                    synchronized (this) {
                        ...
                        if (entry == null || entry.getKey().intValue() != size) {
                            ...
                            Collections.sort(arrayList, d.f4123j);
                ...
                l.b.a.p c2 = c(unmodifiableSet, str3, eVar.f4147e);
                if (c2 == null) {
                    c2 = c(unmodifiableSet, str2, eVar.f4147e);
                    if (c2 == null) {
                        if (!eVar.a(charAt, 'Z')) {
                            return ~i2;
                        }
                        eVar.f(l.b.a.q.f4062g);
                        return i2 + 1;
                    }
                } else {
                    str2 = str3;
        ...
        public final int d(e eVar, CharSequence charSequence, int i2, int i3) {
            ...
            e eVar2 = new e(eVar);
            if ((i3 >= charSequence.length() || !eVar.a(charSequence.charAt(i3), 'Z')) && (b2 = l.f4135e.b(eVar2, charSequence, i3)) >= 0) {
                eVar.f(l.b.a.p.u(upperCase, l.b.a.q.z((int) eVar2.e(l.b.a.w.a.OFFSET_SECONDS).longValue())));
                return b2;
            }
            eVar.f(l.b.a.p.u(upperCase, l.b.a.q.f4062g));
            return i3;
        }
    ...
    public final int c(f fVar) {
        ...
        int i2 = dVar.f4125e;
        if (i2 > 0) {
            m mVar = new m(fVar, i2, dVar.f4126f);
            dVar.f4125e = 0;
            dVar.f4126f = 0;
            fVar = mVar;
        }
    ...
    public d h(String str) {
        ...
        while (i3 < str.length()) {
            ...
            if ((charAt >= 'A' && charAt <= 'Z') || (charAt >= 'a' && charAt <= 'z')) {
                ...
                l.b.a.w.j jVar = f4122i.get(Character.valueOf(charAt));
                if (jVar != null) {
    ...
    public final d k(k kVar) {
        ...
        if (i2 < 0 || !(dVar.c.get(i2) instanceof k)) {
            ...
            int i4 = kVar.c;
            int i5 = kVar.f4131d;
            if (i4 == i5 && kVar.f4132e == m.NOT_NEGATIVE) {
                kVar2 = kVar3.g(i5);
                c(kVar.f());
                this.a.f4127g = i3;
            } else {
    ...
    public d o() {
        ...
        if (dVar.b != null) {
            if (dVar.c.size() > 0) {
                d dVar2 = this.a;
                e eVar = new e(dVar2.c, dVar2.f4124d);
                this.a = this.a.b;
                c(eVar);
            } else {
                this.a = this.a.b;
    ...
    public c r(Locale locale) {
        ...
        return new c(new e(this.c, false), locale, j.f4158e, l.SMART, null, null, null);
    }

    public c s(l lVar) {
        c q2 = q();
        f.b.a.c.b.o.b.B1(lVar, "resolverStyle");
        return f.b.a.c.b.o.b.v0(q2.f4117d, lVar) ? q2 : new c(q2.a, q2.b, q2.c, lVar, q2.f4118e, q2.f4119f, q2.f4120g);
    }
}
