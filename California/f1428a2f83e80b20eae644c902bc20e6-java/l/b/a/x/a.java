...
public final class a implements Externalizable {
    ...
    public void writeExternal(ObjectOutput objectOutput) {
        ...
        if (b2 == 1) {
            ...
            objectOutput.writeInt(bVar.f4217d.length);
            for (long j3 : bVar.f4217d) {
                d(j3, objectOutput);
            }
            for (q qVar2 : bVar.f4219f) {
                e(qVar2, objectOutput);
            }
            objectOutput.writeByte(bVar.f4220g.length);
            for (e eVar : bVar.f4220g) {
                eVar.b(objectOutput);
            }
        } else if (b2 == 2) {
            d dVar = (d) obj;
