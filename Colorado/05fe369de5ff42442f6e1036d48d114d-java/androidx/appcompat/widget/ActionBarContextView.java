...
public class ActionBarContextView extends e.b.f.a {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        ...
        this.f824f = obtainStyledAttributes.getLayoutDimension(R$styleable.ActionMode_height, 0);
    ...
    public void f(e.b.e.a aVar) {
        ...
        if (view2 == null) {
            ...
            this.f65l.findViewById(R$id.action_mode_close_button).setOnClickListener(new a(this, aVar));
            g gVar = (g) aVar.e();
            cVar = this.f823e;
            if (cVar != null) {
                cVar.a();
            ...
            gVar.b(this.f823e, this.c);
            c cVar3 = this.f823e;
            nVar = cVar3.f759i;
            if (nVar == null) {
                n nVar3 = (n) cVar3.f755e.inflate(cVar3.f757g, (ViewGroup) this, false);
                cVar3.f759i = nVar3;
                nVar3.b(cVar3.f754d);
                cVar3.j(true);
            }
            ...
            this.f822d = actionMenuView;
            AtomicInteger atomicInteger = m.a;
            actionMenuView.setBackground(null);
            addView(this.f822d, layoutParams);
        }
        addView(view);
        this.f65l.findViewById(R$id.action_mode_close_button).setOnClickListener(new a(this, aVar));
        g gVar2 = (g) aVar.e();
        ...
        this.f822d = actionMenuView2;
        AtomicInteger atomicInteger2 = m.a;
        actionMenuView2.setBackground(null);
        addView(this.f822d, layoutParams2);
    }
    ...
    public final void g() {
        ...
        this.o.setText(this.f63j);
        this.p.setText(this.f64k);
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        ActionMenuView actionMenuView = this.f822d;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (View.MeasureSpec.getMode(i2) != 1073741824) {
            ...
            if (actionMenuView != null && actionMenuView.getParent() == this) {
                paddingLeft = c(this.f822d, paddingLeft, makeMeasureSpec, 0);
            }
            LinearLayout linearLayout = this.n;
