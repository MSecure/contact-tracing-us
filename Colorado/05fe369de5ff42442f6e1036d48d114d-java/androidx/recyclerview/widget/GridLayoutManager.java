...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public final void O1(View view, int i2, boolean z) {
        ...
        int K1 = K1(bVar.f194e, bVar.f195f);
        if (this.r == 1) {
    ...
    public void Q1(int i2) {
        if (i2 != this.H) {
            ...
            throw new IllegalArgumentException(f.a.a.a.a.v("Span count should be at least 1. Provided ", i2));
        }
    }
    ...
    public void b1(RecyclerView.y yVar, LinearLayoutManager.c cVar, RecyclerView.m.c cVar2) {
        ...
        for (int i3 = 0; i3 < this.H && cVar.b(yVar) && i2 > 0; i3++) {
            ((j.b) cVar2).a(cVar.f199d, Math.max(0, cVar.f202g));
            Objects.requireNonNull(this.M);
            i2--;
            cVar.f199d += cVar.f200e;
        }
    }
    ...
    public void v0(RecyclerView.t tVar, RecyclerView.y yVar) {
        if (yVar.f265g) {
            ...
            for (int i2 = 0; i2 < z; i2++) {
                ...
                int a2 = bVar.a();
                this.K.put(a2, bVar.f195f);
                this.L.put(a2, bVar.f194e);
            }
        }
        super.v0(tVar, yVar);
        this.K.clear();
    ...
    public void w1(RecyclerView.t tVar, RecyclerView.y yVar, LinearLayoutManager.c cVar, LinearLayoutManager.b bVar) {
        ...
        boolean z2 = cVar.f200e == 1;
        int i20 = this.H;
        if (!z2) {
            i20 = M1(tVar, yVar, cVar.f199d) + N1(tVar, yVar, cVar.f199d);
        }
        int i21 = 0;
        ...
        for (int i24 = 0; i24 < i21; i24++) {
            ...
            float d2 = (((float) this.t.d(view2)) * 1.0f) / ((float) ((b) view2.getLayoutParams()).f195f);
            if (d2 > f2) {
                f2 = d2;
            }
        }
        ...
        for (int i26 = 0; i26 < i21; i26++) {
            ...
            if (this.t.c(view4) != i23) {
                ...
                int K1 = K1(bVar3.f194e, bVar3.f195f);
                if (this.r == 1) {
        ...
        while (i29 < i21) {
            ...
            if (this.r != 1) {
                i7 = this.I[bVar4.f194e] + R();
                i9 = this.t.d(view5) + i7;
            } else if (v1()) {
                i8 = P() + this.I[this.H - bVar4.f194e];
                i6 = i8 - this.t.d(view5);
            } else {
                int P = P() + this.I[bVar4.f194e];
                i13 = i9;
                i10 = P;
                i11 = i7;
