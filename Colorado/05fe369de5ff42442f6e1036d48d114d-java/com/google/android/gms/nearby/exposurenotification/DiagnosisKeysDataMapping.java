...
public class DiagnosisKeysDataMapping extends a implements ReflectedParcelable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DiagnosisKeysDataMapping) {
            ...
            return this.b.equals(diagnosisKeysDataMapping.b) && this.c == diagnosisKeysDataMapping.c && this.f479d == diagnosisKeysDataMapping.f479d;
        }
    }

    public int hashCode() {
        return Arrays.hashCode(new Object[]{this.b, Integer.valueOf(this.c), Integer.valueOf(this.f479d)});
    }
    ...
    public String toString() {
        ...
        objArr[2] = Integer.valueOf(this.f479d);
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        m.h.J1(parcel, 1, new ArrayList(this.b), false);
        int i3 = this.c;
        m.h.S1(parcel, 2, 4);
        parcel.writeInt(i3);
        int i4 = this.f479d;
