...
public class SnackbarContentLayout extends LinearLayout implements n {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f604d = obtainStyledAttributes.getDimensionPixelSize(R$styleable.SnackbarLayout_android_maxWidth, -1);
        this.f605e = obtainStyledAttributes.getDimensionPixelSize(R$styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f604d > 0 && getMeasuredWidth() > (i4 = this.f604d)) {
        ...
        if (!z2 || this.f605e <= 0 || this.c.getMeasuredWidth() <= this.f605e) {
            if (!z2) {
