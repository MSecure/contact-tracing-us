...
public class SwitchMaterial extends s0 {
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.R == null) {
            int v0 = b.v0(this, R$attr.colorSurface);
            int v02 = b.v0(this, R$attr.colorControlActivated);
            float dimension = getResources().getDimension(R$dimen.mtrl_switch_thumb_elevation);
            if (this.Q.a) {
                dimension += b.G0(this);
            }
            int a = this.Q.a(v0, dimension);
            int[][] iArr = V;
            int[] iArr2 = new int[iArr.length];
            iArr2[0] = b.X0(v0, v02, 1.0f);
            iArr2[1] = a;
            iArr2[2] = b.X0(v0, v02, 0.38f);
            iArr2[3] = a;
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.S == null) {
            ...
            iArr2[0] = b.X0(v0, v02, 0.54f);
            iArr2[1] = b.X0(v0, v03, 0.32f);
            iArr2[2] = b.X0(v0, v02, 0.12f);
            iArr2[3] = b.X0(v0, v03, 0.12f);
