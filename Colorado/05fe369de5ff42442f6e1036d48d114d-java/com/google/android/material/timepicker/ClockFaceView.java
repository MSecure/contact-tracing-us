...
public class ClockFaceView extends c implements ClockHandView.c {
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet) {
        ...
        ColorStateList w0 = b.w0(context, obtainStyledAttributes, R$styleable.ClockFaceView_clockNumberTextColor);
        this.H = w0;
        ...
        int colorForState = w0.getColorForState(new int[]{16842913}, w0.getDefaultColor());
        this.C = new int[]{colorForState, colorForState, w0.getDefaultColor()};
        clockHandView.f628g.add(this);
        int defaultColor = e.b.b.a.a.a(context, R$color.material_timepicker_clockface).getDefaultColor();
        ColorStateList w02 = b.w0(context, obtainStyledAttributes, R$styleable.ClockFaceView_clockFaceBackgroundColor);
        setBackgroundColor(w02 != null ? w02.getDefaultColor() : defaultColor);
        getViewTreeObserver().addOnPreDrawListener(new f.b.a.e.z.a(this));
        setFocusable(true);
        obtainStyledAttributes.recycle();
        this.B = new f.b.a.e.z.b(this);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) b.C0034b.a(1, this.F.length, false, 1).a);
    }
