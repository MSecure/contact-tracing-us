...
public class ClockHandView extends View {
    ...
    public final List<c> f628g = new ArrayList();
    ...
    public final Paint f631j;

    /* renamed from: k  reason: collision with root package name */
    public final RectF f632k;
    ...
    public ClockHandView(Context context, AttributeSet attributeSet) {
        ...
        this.f629h = obtainStyledAttributes.getDimensionPixelSize(R$styleable.ClockHandView_selectorSize, 0);
        Resources resources = getResources();
        this.f633l = resources.getDimensionPixelSize(R$dimen.material_clock_hand_stroke_width);
        this.f630i = (float) resources.getDimensionPixelSize(R$dimen.material_clock_hand_center_dot_radius);
        int color = obtainStyledAttributes.getColor(R$styleable.ClockHandView_clockHandColor, 0);
        paint.setAntiAlias(true);
        paint.setColor(color);
        b(0.0f, false);
        this.f627f = ViewConfiguration.get(context).getScaledTouchSlop();
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.f631j.setStrokeWidth(0.0f);
        canvas.drawCircle((((float) this.p) * ((float) Math.cos(this.o))) + f2, (((float) this.p) * ((float) Math.sin(this.o))) + f3, (float) this.f629h, this.f631j);
        double sin = Math.sin(this.o);
        double cos = Math.cos(this.o);
        double d2 = (double) ((float) (this.p - this.f629h));
        this.f631j.setStrokeWidth((float) this.f633l);
        canvas.drawLine(f2, f3, (float) (width + ((int) (cos * d2))), (float) (height + ((int) (d2 * sin))), this.f631j);
        canvas.drawCircle(f2, f3, this.f630i, this.f631j);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1 || actionMasked == 2) {
                int i2 = (int) (x - this.c);
                int i3 = (int) (y - this.f625d);
                this.f626e = (i3 * i3) + (i2 * i2) > this.f627f;
                z2 = this.n;
                if (actionMasked == 1) {
                }
            } else {
