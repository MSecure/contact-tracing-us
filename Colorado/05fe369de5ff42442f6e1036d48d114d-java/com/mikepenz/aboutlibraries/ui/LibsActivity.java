        ...
        if (extras != null && extras.getBoolean("ABOUT_LIBRARIES_EDGE_TO_EDGE")) {
            ...
            if ((resources.getConfiguration().uiMode & 48) != 32) {
                ...
                if (i2 >= 23) {
                    ...
                    window3.setStatusBarColor(b.J0(contextThemeWrapper, R$attr.colorSurface));
                    Window window4 = getWindow();
                    e.b(window4, "this.window");
                    window4.setNavigationBarColor(b.J0(contextThemeWrapper, 16842801));
                    if (i2 >= 28) {
                        Window window5 = getWindow();
                        e.b(window5, "this.window");
                        window5.setNavigationBarDividerColor(b.J0(contextThemeWrapper, 16843820));
                    }
                }
                Window window6 = getWindow();
                e.b(window6, "this.window");
                window6.setStatusBarColor(b.I0(this, R$color.immersive_bars));
                Window window7 = getWindow();
                e.b(window7, "this.window");
                int i3 = R$color.nav_bar;
                window7.setNavigationBarColor(b.I0(this, i3));
                if (i2 >= 28) {
                    Window window8 = getWindow();
                    e.b(window8, "this.window");
                    window8.setNavigationBarDividerColor(b.I0(this, i3));
                }
            } else {
                ...
                if (i4 >= 23) {
                    ...
                    window11.setStatusBarColor(b.J0(contextThemeWrapper2, R$attr.colorSurface));
                    Window window12 = getWindow();
                    e.b(window12, "this.window");
                    window12.setNavigationBarColor(b.J0(contextThemeWrapper2, 16842801));
                    if (i4 >= 28) {
                        Window window13 = getWindow();
                        e.b(window13, "this.window");
                        window13.setNavigationBarDividerColor(b.J0(contextThemeWrapper2, 16843820));
                    }
                }
                Window window14 = getWindow();
                e.b(window14, "this.window");
                window14.setStatusBarColor(b.I0(this, R$color.dark_immersive_bars));
                Window window15 = getWindow();
                e.b(window15, "this.window");
                int i5 = R$color.dark_nav_bar;
                window15.setNavigationBarColor(b.I0(this, i5));
                if (i4 >= 28) {
                    Window window16 = getWindow();
                    e.b(window16, "this.window");
                    window16.setNavigationBarDividerColor(b.I0(this, i5));
                }
            }
        }
