...
public class s {
    ...
    public static final String[] f678d = {"android.widget.", "android.view.", "android.webkit."};

    /* renamed from: e  reason: collision with root package name */
    public static final h<String, Constructor<? extends View>> f679e = new h<>();
        ...
        public void onClick(View view) {
            ...
            if (this.f680d == null) {
                ...
                if (id == -1) {
                    ...
                    StringBuilder i2 = f.a.a.a.a.i(" with id '");
                    i2.append(this.b.getContext().getResources().getResourceEntryName(id));
                    i2.append("'");
                    str = i2.toString();
                }
                StringBuilder i3 = f.a.a.a.a.i("Could not find method ");
                i3.append(this.c);
            ...
            try {
                this.f680d.invoke(this.f681e, view);
    ...
    public final View g(Context context, String str, String str2) {
        String str3;
        h<String, Constructor<? extends View>> hVar = f679e;
