...
public class b1 implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    public static b1 f846k;

    /* renamed from: l  reason: collision with root package name */
    public static b1 f847l;
    public final View b;
    ...
    public final Runnable f849e = new a();

    /* renamed from: f  reason: collision with root package name */
    public final Runnable f850f = new b();
    ...
    public b1(View view, CharSequence charSequence) {
        ...
        Method method = r.a;
        this.f848d = Build.VERSION.SDK_INT >= 28 ? viewConfiguration.getScaledHoverSlop() : viewConfiguration.getScaledTouchSlop() / 2;
        a();
    ...
    public static void c(b1 b1Var) {
        b1 b1Var2 = f846k;
        if (b1Var2 != null) {
            b1Var2.b.removeCallbacks(b1Var2.f849e);
        }
        f846k = b1Var;
        if (b1Var != null) {
            b1Var.b.postDelayed(b1Var.f849e, (long) ViewConfiguration.getLongPressTimeout());
        }
    }

    public final void a() {
        this.f851g = Integer.MAX_VALUE;
        this.f852h = Integer.MAX_VALUE;
    }
    ...
    public void b() {
        ...
        this.b.removeCallbacks(this.f850f);
    }
    ...
    public void d(boolean z) {
        ...
        if (view.isAttachedToWindow()) {
            ...
            int i4 = this.f851g;
            int i5 = this.f852h;
            boolean z2 = this.f854j;
            CharSequence charSequence = this.c;
            if (c1Var.b.getParent() != null) {
                c1Var.a();
            }
            c1Var.c.setText(charSequence);
            WindowManager.LayoutParams layoutParams = c1Var.f860d;
            ...
            if (rootView != null) {
                rootView.getWindowVisibleDisplayFrame(c1Var.f861e);
                Rect rect = c1Var.f861e;
                if (rect.left < 0 && rect.top < 0) {
                    Resources resources = c1Var.a.getResources();
                    int identifier = resources.getIdentifier("status_bar_height", "dimen", "android");
                    int dimensionPixelSize = identifier != 0 ? resources.getDimensionPixelSize(identifier) : 0;
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    c1Var.f861e.set(0, dimensionPixelSize, displayMetrics.widthPixels, displayMetrics.heightPixels);
                }
                rootView.getLocationOnScreen(c1Var.f863g);
                view2.getLocationOnScreen(c1Var.f862f);
                int[] iArr = c1Var.f862f;
                int i6 = iArr[0];
                int[] iArr2 = c1Var.f863g;
                iArr[0] = i6 - iArr2[0];
                ...
                int[] iArr3 = c1Var.f862f;
                int i7 = ((iArr3[1] + i3) - dimensionPixelOffset3) - measuredHeight;
                int i8 = iArr3[1] + i2 + dimensionPixelOffset3;
                if (!z2 ? measuredHeight + i8 > c1Var.f861e.height() : i7 >= 0) {
                    layoutParams.y = i7;
                } else {
                    layoutParams.y = i8;
                }
            }
            ((WindowManager) c1Var.a.getSystemService("window")).addView(c1Var.b, c1Var.f860d);
            ...
            this.b.removeCallbacks(this.f850f);
            this.b.postDelayed(this.f850f, j2);
        }
    }

    public boolean onHover(View view, MotionEvent motionEvent) {
        boolean z;
        if (this.f853i != null && this.f854j) {
            return false;
        }
        ...
        } else if (this.b.isEnabled() && this.f853i == null) {
            int x = (int) motionEvent.getX();
            int y = (int) motionEvent.getY();
            if (Math.abs(x - this.f851g) > this.f848d || Math.abs(y - this.f852h) > this.f848d) {
                this.f851g = x;
                this.f852h = y;
                z = true;
            } else {
    ...
    public boolean onLongClick(View view) {
        this.f851g = view.getWidth() / 2;
        this.f852h = view.getHeight() / 2;
        d(true);
        return true;
    }
