...
public final class j {
    ...
    public class a implements n0.f {
        ...
        public final int[] f898d = {R$drawable.abc_popup_background_mtrl_mult, R$drawable.abc_cab_background_internal_bg, R$drawable.abc_menu_hardkey_panel_mtrl_mult};

        /* renamed from: e  reason: collision with root package name */
        public final int[] f899e = {R$drawable.abc_tab_indicator_material, R$drawable.abc_textfield_search_material};

        /* renamed from: f  reason: collision with root package name */
        public final int[] f900f = {R$drawable.abc_btn_check_material, R$drawable.abc_btn_radio_material, R$drawable.abc_btn_check_material_anim, R$drawable.abc_btn_radio_material_anim};
        ...
        public final ColorStateList b(Context context, int i2) {
            ...
            return new ColorStateList(new int[][]{t0.b, t0.f938d, t0.c, t0.f940f}, new int[]{b2, e.i.c.a.a(c2, i2), e.i.c.a.a(c2, i2), i2});
        }
    ...
    public static void f(Drawable drawable, w0 w0Var, int[] iArr) {
        PorterDuff.Mode mode = n0.f911h;
        if (!e0.a(drawable) || drawable.mutate() == drawable) {
            boolean z = w0Var.f959d;
            if (z || w0Var.c) {
                PorterDuffColorFilter porterDuffColorFilter = null;
                ColorStateList colorStateList = z ? w0Var.a : null;
                PorterDuff.Mode mode2 = w0Var.c ? w0Var.b : n0.f911h;
