...
public class w extends Spinner {
    ...
    public static final int[] f950j = {16843505};
    public final e b;
    ...
    public final Rect f956i = new Rect();
    ...
    public class b implements f, DialogInterface.OnClickListener {
        ...
        public void e(int i2, int i3) {
            if (this.c != null) {
                ...
                CharSequence charSequence = this.f957d;
                if (charSequence != null) {
                    aVar.a.f30d = charSequence;
                }
                ...
                g a = aVar.a();
                this.b = a;
                ListView listView = a.f647d.f24g;
    ...
    public class d extends k0 implements f {
        ...
        public void t() {
            ...
            int i4 = 0;
            if (i3 != null) {
                i3.getPadding(w.this.f956i);
                i4 = e1.a(w.this) ? w.this.f956i.right : -w.this.f956i.left;
            } else {
                Rect rect = w.this.f956i;
                rect.right = 0;
                rect.left = 0;
            }
            ...
            if (i5 == -2) {
                ...
                r(i5);
                this.f905g = !e1.a(w.this) ? (((width - paddingRight) - this.f904f) - this.H) + i4 : paddingLeft + this.H + i4;
            }
            r(i2);
            this.f905g = !e1.a(w.this) ? (((width - paddingRight) - this.f904f) - this.H) + i4 : paddingLeft + this.H + i4;
        }
    ...
    public w(Context context, AttributeSet attributeSet, int i2) {
        ...
        int i3 = -1;
        try {
            typedArray = context.obtainStyledAttributes(attributeSet, f950j, i2, 0);
            try {
        ...
        if (i3 == 0) {
            ...
            this.f955h = q.k(R$styleable.Spinner_android_dropDownWidth, -2);
            ...
            q.b.recycle();
            this.f954g = dVar;
            this.f951d = new v(this, this, dVar);
        }
        ...
        this.f953f = true;
        SpinnerAdapter spinnerAdapter = this.f952e;
        if (spinnerAdapter != null) {
    ...
    public int a(SpinnerAdapter spinnerAdapter, Drawable drawable) {
        ...
        drawable.getPadding(this.f956i);
        Rect rect = this.f956i;
        return i3 + rect.left + rect.right;
    }

    public void b() {
        this.f954g.e(getTextDirection(), getTextAlignment());
    }
    ...
    public int getDropDownWidth() {
        return this.f954g != null ? this.f955h : super.getDropDownWidth();
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f954g != null && View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE) {
    ...
    public void setAdapter(SpinnerAdapter spinnerAdapter) {
        ...
        if (this.f954g != null) {
            ...
            this.f954g.o(new c(spinnerAdapter, context.getTheme()));
        }
    }
