...
public class y {
    ...
    public class a extends g {
        ...
        public void d(Typeface typeface) {
            ...
            if (yVar.m) {
                ...
                if (textView != null) {
                    textView.setTypeface(typeface, yVar.f966j);
                }
            }
        }
    }
    ...
    public void b() {
        if (!(this.b == null && this.c == null && this.f960d == null && this.f961e == null)) {
    ...
    public void e(AttributeSet attributeSet, int i2) {
        ...
        m.p(textView, textView.getContext(), iArr, attributeSet, q.b, i2, 0);
            ...
            if (!z5) {
                ...
                if (y0Var.o(i15)) {
                    ...
                    if (i12 >= 23) {
                        ...
                        colorStateList = y0Var.o(i16) ? y0Var.c(i16) : null;
                        int i17 = R$styleable.TextAppearance_android_textColorHint;
                        colorStateList3 = y0Var.o(i17) ? y0Var.c(i17) : null;
                        int i18 = R$styleable.TextAppearance_android_textColorLink;
                        colorStateList2 = y0Var.o(i18) ? y0Var.c(i18) : null;
                    } else {
            ...
            if (y0Var2.o(i21)) {
                ...
                if (i12 >= 28) {
                    ...
                    if (y0Var2.o(i26)) {
                        ...
                        if (typeface != null) {
                            if (this.f967k == -1) {
                                this.a.setTypeface(typeface, this.f966j);
                            } else {
                        ...
                        if (str2 != null) {
                            if (i12 >= 24) {
                                ...
                                a0Var = this.f965i;
                                Context context2 = a0Var.f835j;
                                int[] iArr2 = R$styleable.AppCompatTextView;
                                obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, iArr2, i2, i4);
                                TextView textView2 = a0Var.f834i;
                                m.p(textView2, textView2.getContext(), iArr2, attributeSet, obtainStyledAttributes, i2, 0);
                                ...
                                if (a0Var.i()) {
                                    ...
                                    if (!a0Var.f832g) {
                                        DisplayMetrics displayMetrics = a0Var.f835j.getResources().getDisplayMetrics();
                                        if (dimension2 == -1.0f) {
                                ...
                                if (b.a) {
                                    a0 a0Var2 = this.f965i;
                                    if (a0Var2.a != 0) {
                                        int[] iArr4 = a0Var2.f831f;
                                        if (iArr4.length > 0) {
                                            if (((float) this.a.getAutoSizeStepGranularity()) != -1.0f) {
                                                this.a.setAutoSizeTextTypeUniformWithConfiguration(Math.round(this.f965i.f829d), Math.round(this.f965i.f830e), Math.round(this.f965i.c), 0);
                                            } else {
                                ...
                                if (dimensionPixelSize != -1) {
                                    m.h.d1(this.a, dimensionPixelSize);
                                }
                                if (dimensionPixelSize2 != -1) {
                                    m.h.e1(this.a, dimensionPixelSize2);
                                }
                                if (dimensionPixelSize3 == -1) {
                                    m.h.g1(this.a, dimensionPixelSize3);
                                    return;
                                }
                                return;
                            }
                        ...
                        TextView textView22 = a0Var.f834i;
                        e.i.i.m.p(textView22, textView22.getContext(), iArr22, attributeSet, obtainStyledAttributes, i2, 0);
                        i5 = R$styleable.AppCompatTextView_autoSizeTextType;
                        if (obtainStyledAttributes.hasValue(i5)) {
                        }
                ...
                i4 = 0;
                a0Var = this.f965i;
                Context context222 = a0Var.f835j;
                ...
                TextView textView222 = a0Var.f834i;
                e.i.i.m.p(textView222, textView222.getContext(), iArr222, attributeSet, obtainStyledAttributes, i2, 0);
                i5 = R$styleable.AppCompatTextView_autoSizeTextType;
                if (obtainStyledAttributes.hasValue(i5)) {
                }
        ...
        i4 = 0;
        a0Var = this.f965i;
        Context context2222 = a0Var.f835j;
        ...
        TextView textView2222 = a0Var.f834i;
        e.i.i.m.p(textView2222, textView2222.getContext(), iArr2222, attributeSet, obtainStyledAttributes, i2, 0);
        i5 = R$styleable.AppCompatTextView_autoSizeTextType;
        if (obtainStyledAttributes.hasValue(i5)) {
        }
    ...
    public void h(int[] iArr, int i2) {
        ...
        if (a0Var.i()) {
            ...
            if (length > 0) {
                ...
                a0Var.f831f = a0Var.b(iArr2);
                if (!a0Var.h()) {
                    StringBuilder i4 = f.a.a.a.a.i("None of the preset sizes is valid: ");
    ...
    public void i(int i2) {
        ...
        if (i2 == 0) {
            ...
            throw new IllegalArgumentException(f.a.a.a.a.v("Unknown auto-size text type: ", i2));
        }
    }
    ...
    public void j(ColorStateList colorStateList) {
        ...
        w0Var.f959d = colorStateList != null;
        this.b = w0Var;
        this.c = w0Var;
        this.f960d = w0Var;
        this.f961e = w0Var;
    ...
    public final void l(Context context, y0 y0Var) {
        ...
        Typeface typeface;
        Typeface typeface2;
        this.f966j = y0Var.j(R$styleable.TextAppearance_android_textStyle, this.f966j);
        ...
        if (y0Var.o(i3) || y0Var.o(R$styleable.TextAppearance_fontFamily)) {
            ...
            if (!context.isRestricted()) {
                try {
                    Typeface i7 = y0Var.i(i3, this.f966j, new a(i5, i6, new WeakReference(this.a)));
                    if (i7 != null) {
                        if (i2 >= 28 && this.f967k != -1) {
                            i7 = Typeface.create(Typeface.create(i7, 0), this.f967k, (this.f966j & 2) != 0);
                        }
                        this.f968l = i7;
                    }
                    this.m = this.f968l == null;
                } catch (Resources.NotFoundException | UnsupportedOperationException unused) {
                }
            }
            if (this.f968l == null && (m2 = y0Var.m(i3)) != null) {
                if (Build.VERSION.SDK_INT < 28 || this.f967k == -1) {
                    typeface = Typeface.create(m2, this.f966j);
                } else {
