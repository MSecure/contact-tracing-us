...
public class e extends k {
    ...
    public b.AbstractC0026b o0 = null;
    ...
    public static boolean X(d dVar, b.AbstractC0026b bVar, b.a aVar, int i2) {
        int i3;
        int i4;
        ...
        if (z && dVar.u(0) && dVar.f1105l == 0 && !z3) {
            aVar.a = aVar2;
            if (z2 && dVar.m == 0) {
                aVar.a = aVar3;
            }
        ...
        if (z4) {
            if (dVar.n[1] == 4) {
                ...
                aVar.b = aVar3;
                int i6 = dVar.T;
                aVar.f1109d = (int) ((i6 == 0 || i6 == -1) ? ((float) i3) / dVar.S : ((float) i3) * dVar.S);
            }
        }
        ((ConstraintLayout.b) bVar).b(dVar, aVar);
        dVar.M(aVar.f1110e);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:366:0x063d  */
    /* JADX WARNING: Removed duplicated region for block: B:376:0x0662  */
    /* JADX WARNING: Removed duplicated region for block: B:382:0x0676  */
    /* JADX WARNING: Removed duplicated region for block: B:388:0x0693  */
    /* JADX WARNING: Removed duplicated region for block: B:437:0x07a0  */
    /* JADX WARNING: Removed duplicated region for block: B:440:0x07c8  */
    /* JADX WARNING: Removed duplicated region for block: B:444:0x07e0  */
    /* JADX WARNING: Removed duplicated region for block: B:464:0x0859  */
    /* JADX WARNING: Removed duplicated region for block: B:467:0x0874  */
    /* JADX WARNING: Removed duplicated region for block: B:468:0x0880  */
    /* JADX WARNING: Removed duplicated region for block: B:470:0x0883  */
    /* JADX WARNING: Removed duplicated region for block: B:486:0x08c6  */
    ...
    public void P() {
        ...
        if (i.b(this.x0, 1)) {
            ...
            for (int i20 = 0; i20 < size; i20++) {
                d dVar8 = this.l0.get(i20);
                if (dVar8.y() && !(dVar8 instanceof f) && !(dVar8 instanceof a) && !(dVar8 instanceof j) && !dVar8.A) {
                    if (!(dVar8.k(0) == aVar11 && dVar8.f1105l != 1 && dVar8.k(1) == aVar11 && dVar8.m != 1)) {
        ...
        if (size > 2) {
            d.a aVar18 = aVar;
            if ((aVar15 == aVar12 || aVar18 == aVar12) && i.b(this.x0, 1024)) {
                b.AbstractC0026b bVar2 = this.o0;
                ...
                while (true) {
                    if (i21 < size3) {
                        d dVar9 = arrayList3.get(i21);
                        if (!m.h.A1(m(), q(), dVar9.m(), dVar9.q())) {
                            aVar4 = aVar12;
                            aVar2 = aVar13;
                            i4 = size;
                            aVar6 = aVar18;
                        ...
                        while (i22 < size3) {
                            ...
                            if (!m.h.A1(m(), q(), dVar10.m(), dVar10.q())) {
                            ...
                            if (dVar10.D.f1085f == null && dVar10.F.f1085f == null && !z12 && !(dVar10 instanceof a)) {
                                if (arrayList8 == null) {
                                    arrayList8 = new ArrayList();
                                }
                                arrayList8.add(dVar10);
                            }
                            if (dVar10.E.f1085f == null && dVar10.G.f1085f == null && dVar10.H.f1085f == null && !z12 && !(dVar10 instanceof a)) {
                                if (arrayList9 == null) {
                        ...
                        if (arrayList5 != null) {
                            ...
                            while (it2.hasNext()) {
                                h hVar2 = (h) it2.next();
                                n V = m.h.V(hVar2, i23, arrayList10, nVar3);
                                hVar2.P(arrayList10, i23, V);
                                V.b(arrayList10);
                                nVar3 = null;
                                i23 = 0;
                            }
                        ...
                        if (hashSet != null) {
                            ...
                            while (it3.hasNext()) {
                                m.h.V(it3.next().f1083d, 0, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet2 != null) {
                            ...
                            while (it4.hasNext()) {
                                m.h.V(it4.next().f1083d, 0, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet3 != null) {
                            ...
                            while (it5.hasNext()) {
                                m.h.V(it5.next().f1083d, 0, arrayList10, null);
                            }
                        }
                        n nVar4 = null;
                        if (arrayList8 != null) {
                        ...
                        if (arrayList7 != null) {
                            ...
                            while (it8.hasNext()) {
                                h hVar3 = (h) it8.next();
                                n V2 = m.h.V(hVar3, i24, arrayList10, nVar4);
                                hVar3.P(arrayList10, i24, V2);
                                V2.b(arrayList10);
                                nVar4 = null;
                                i24 = 1;
                            }
                        ...
                        if (hashSet4 != null) {
                            ...
                            while (it9.hasNext()) {
                                m.h.V(it9.next().f1083d, 1, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet5 != null) {
                            ...
                            while (it10.hasNext()) {
                                m.h.V(it10.next().f1083d, 1, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet6 != null) {
                            ...
                            while (it11.hasNext()) {
                                m.h.V(it11.next().f1083d, 1, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet7 != null) {
                            ...
                            while (it12.hasNext()) {
                                m.h.V(it12.next().f1083d, 1, arrayList10, null);
                            }
                        }
                        char c = 1;
                        if (arrayList9 != null) {
                            ...
                            while (z3) {
                                ...
                                if (z3) {
                                    ...
                                    for (int i32 = 0; i32 < size4; i32++) {
                                        this.l0.get(i32).O(dVar142222, Y2);
                                    }
                                } else {
                                    O(dVar142222, Y);
                                    for (int i33 = 0; i33 < i4; i33++) {
                                        this.l0.get(i33).O(this.q0, Y);
                                    }
                                }
                                if (z14 || i30 >= 8 || !i.a[2]) {
                                    z5 = false;
                                    ...
                                    for (int i36 = 0; i36 < i4; i36++) {
                                        d dVar15 = this.l0.get(i36);
                                        i34 = Math.max(i34, dVar15.r() + dVar15.U);
                                        i35 = Math.max(i35, dVar15.l() + dVar15.V);
                                    }
                                    int max5 = Math.max(this.X, i34);
                                    int max6 = Math.max(this.Y, i35);
        ...
        dVar1222.f1050g = false;
        dVar1222.f1050g = true;
    ...
    public boolean V(boolean z, int i2) {
        ...
        if (z4 && (k2 == aVar2 || k3 == aVar2)) {
            Iterator<o> it3 = eVar.f1119e.iterator();
            while (true) {
                if (!it3.hasNext()) {
                    break;
                }
                o next = it3.next();
                if (next.f1147f == i2 && !next.k()) {
                    z4 = false;
                    break;
                }
            }
        ...
        if (i2 == 0) {
            if (aVarArr[0] == aVar3 || aVarArr[0] == aVar) {
                int r = eVar6.r() + s;
                eVar.a.f1097d.f1150i.c(r);
                gVar = eVar.a.f1097d.f1146e;
                i3 = r - s;
                gVar.c(i3);
                z2 = true;
                eVar.g();
                it = eVar.f1119e.iterator();
                while (it.hasNext()) {
                    o next2 = it.next();
                    if (next2.f1147f == i2 && (next2.b != eVar.a || next2.f1148g)) {
                        next2.e();
                    }
                }
                it2 = eVar.f1119e.iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        break;
                    }
                    o next3 = it2.next();
                    if (next3.f1147f == i2 && ((z2 || next3.b != eVar.a) && (!next3.f1149h.f1129j || !next3.f1150i.f1129j || (!(next3 instanceof e.g.b.h.l.c) && !next3.f1146e.f1129j)))) {
                        z3 = false;
                    }
                }
                z3 = false;
            ...
            int l2 = eVar6.l() + t;
            eVar.a.f1098e.f1150i.c(l2);
            gVar = eVar.a.f1098e.f1146e;
            i3 = l2 - t;
            gVar.c(i3);
            z2 = true;
            eVar.g();
