...
public abstract class b extends View {
    ...
    public HashMap<Integer, String> f1169h;

    public b(Context context) {
        super(context);
        this.b = new int[32];
        this.f1169h = new HashMap<>();
        this.f1165d = context;
        f(null);
    }
    ...
    public final void a(String str) {
        if (str != null && str.length() != 0 && this.f1165d != null) {
            ...
            if (i2 == 0) {
                i2 = this.f1165d.getResources().getIdentifier(trim, "id", this.f1165d.getPackageName());
            }
            if (i2 != 0) {
                this.f1169h.put(Integer.valueOf(i2), trim);
                b(i2);
            }
        }
    }
    ...
    public final int e(ConstraintLayout constraintLayout, String str) {
        Resources resources;
        if (str == null || constraintLayout == null || (resources = this.f1165d.getResources()) == null) {
            return 0;
        }
        int childCount = constraintLayout.getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
    ...
    public void k() {
        if (this.f1166e != null) {
            ...
            if (layoutParams instanceof ConstraintLayout.a) {
                ((ConstraintLayout.a) layoutParams).l0 = (d) this.f1166e;
            }
        }
    }
