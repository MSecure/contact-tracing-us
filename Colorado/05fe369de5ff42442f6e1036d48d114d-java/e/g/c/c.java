        ...
        public b(Context context, XmlPullParser xmlPullParser) {
            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == R$styleable.Variant_constraints) {
                    this.f1172e = obtainStyledAttributes.getResourceId(index, this.f1172e);
                    String resourceTypeName = context.getResources().getResourceTypeName(this.f1172e);
                    context.getResources().getResourceName(this.f1172e);
                    if ("layout".equals(resourceTypeName)) {
                        d dVar = new d();
                        this.f1173f = dVar;
                        dVar.b((ConstraintLayout) LayoutInflater.from(context).inflate(this.f1172e, (ViewGroup) null));
                    }
                } else if (index == R$styleable.Variant_region_heightLessThan) {
                    this.f1171d = obtainStyledAttributes.getDimension(index, this.f1171d);
                        ...
                        if (eventType != 0) {
                            ...
                            if (eventType == 2) {
                                ...
                                switch (c) {
                                    ...
                                    case 4:
                                        if (aVar2 != null) {
                                            aVar2.f1177e.a(context, Xml.asAttributeSet(xmlPullParser));
                                            break;
                                        } else {
                                            throw new RuntimeException("XML parser error must be within a Constraint " + xmlPullParser.getLineNumber());
                                        }
                                    case 5:
                                        if (aVar2 != null) {
                                            aVar2.f1176d.a(context, Xml.asAttributeSet(xmlPullParser));
                                            break;
                                        } else {
                                            throw new RuntimeException("XML parser error must be within a Constraint " + xmlPullParser.getLineNumber());
                                        }
                                    ...
                                    case 7:
                                        if (aVar2 != null) {
                                            a.a(context, xmlPullParser, aVar2.f1178f);
                                            break;
                                        } else {
                                            throw new RuntimeException("XML parser error must be within a Constraint " + xmlPullParser.getLineNumber());
                                        }
