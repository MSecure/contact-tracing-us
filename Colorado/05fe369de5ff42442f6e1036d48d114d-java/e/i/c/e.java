...
public class e extends k {
    ...
    public static Method f1248d = null;

    /* renamed from: e  reason: collision with root package name */
    public static Method f1249e = null;

    /* renamed from: f  reason: collision with root package name */
    public static boolean f1250f = false;

    public static boolean f(Object obj, String str, int i2, boolean z) {
        g();
        try {
            return ((Boolean) f1248d.invoke(obj, str, Integer.valueOf(i2), Boolean.valueOf(z))).booleanValue();
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        try {
            ...
            for (d dVar : dVarArr) {
                ...
                try {
                    if (!m.h.y(t0, resources, dVar.f1245f)) {
                        t0.delete();
                        return null;
                    }
                    if (!f(newInstance, t0.getPath(), dVar.b, dVar.c)) {
                        return null;
                    }
            ...
            try {
                ...
                return (Typeface) f1249e.invoke(null, newInstance2);
            } catch (IllegalAccessException | InvocationTargetException e2) {
                throw new RuntimeException(e2);
            }
