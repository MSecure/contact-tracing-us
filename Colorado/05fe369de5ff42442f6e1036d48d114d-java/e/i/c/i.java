...
public class i extends k {
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        while (true) {
            ...
            d dVar = dVarArr[i4];
            try {
                Font.Builder weight = new Font.Builder(resources, dVar.f1245f).setWeight(dVar.b);
                if (!dVar.c) {
                    i5 = 0;
                }
                Font build = weight.setSlant(i5).setTtcIndex(dVar.f1244e).setFontVariationSettings(dVar.f1243d).build();
                if (builder == null) {
