...
public class e {
    ...
    public void a() {
        this.c = -1;
        float[] fArr = this.f1357d;
        if (fArr != null) {
            Arrays.fill(fArr, 0.0f);
            Arrays.fill(this.f1358e, 0.0f);
            Arrays.fill(this.f1359f, 0.0f);
            Arrays.fill(this.f1360g, 0.0f);
            Arrays.fill(this.f1361h, 0);
            Arrays.fill(this.f1362i, 0);
            Arrays.fill(this.f1363j, 0);
            this.f1364k = 0;
        }
        VelocityTracker velocityTracker = this.f1365l;
    ...
    public void b(View view, int i2) {
        ...
        StringBuilder i3 = f.a.a.a.a.i("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
        i3.append(this.t);
        i3.append(")");
    ...
    public final boolean c(float f2, float f3, int i2, int i3) {
        ...
        if ((this.f1361h[i2] & i3) != i3 || (0 & i3) == 0 || (this.f1363j[i2] & i3) == i3 || (this.f1362i[i2] & i3) == i3) {
            return false;
        }
        int i4 = this.b;
        ...
        return (this.f1362i[i2] & i3) == 0 && abs > ((float) this.b);
    }
    ...
    public void n(MotionEvent motionEvent) {
        ...
        if (this.f1365l == null) {
            this.f1365l = VelocityTracker.obtain();
        }
        this.f1365l.addMovement(motionEvent);
        int i3 = 0;
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    if (this.a != 1) {
                        ...
                        while (i3 < pointerCount) {
                            ...
                            if (m(pointerId)) {
                                ...
                                float f2 = x - this.f1357d[pointerId];
                                float f3 = y - this.f1358e[pointerId];
                                p(f2, f3, pointerId);
                                if (this.a != 1) {
                        ...
                        float[] fArr = this.f1359f;
                        int i4 = this.c;
                        int i5 = (int) (x2 - fArr[i4]);
                        int i6 = (int) (y2 - this.f1360g[i4]);
    ...
    public final void o() {
        this.f1365l.computeCurrentVelocity(1000, this.m);
        j(e(this.f1365l.getXVelocity(this.c), this.n, this.m), e(this.f1365l.getYVelocity(this.c), this.n, this.m));
    }
    ...
    public final void q(float f2, float f3, int i2) {
        ...
        if (fArr == null || fArr.length <= i2) {
            ...
            if (fArr != null) {
                ...
                float[] fArr6 = this.f1358e;
                System.arraycopy(fArr6, 0, fArr3, 0, fArr6.length);
                float[] fArr7 = this.f1359f;
                System.arraycopy(fArr7, 0, fArr4, 0, fArr7.length);
                float[] fArr8 = this.f1360g;
                System.arraycopy(fArr8, 0, fArr5, 0, fArr8.length);
                int[] iArr4 = this.f1361h;
                System.arraycopy(iArr4, 0, iArr, 0, iArr4.length);
                int[] iArr5 = this.f1362i;
                System.arraycopy(iArr5, 0, iArr2, 0, iArr5.length);
                int[] iArr6 = this.f1363j;
        ...
        float[] fArr9 = this.f1357d;
        this.f1359f[i2] = f2;
        fArr9[i2] = f2;
        float[] fArr10 = this.f1358e;
        this.f1360g[i2] = f3;
        fArr10[i2] = f3;
        int[] iArr7 = this.f1361h;
        int i5 = (int) f2;
        int i6 = (int) f3;
    ...
    public final void r(MotionEvent motionEvent) {
        ...
        for (int i2 = 0; i2 < pointerCount; i2++) {
            ...
            if (m(pointerId)) {
                ...
                this.f1359f[pointerId] = x;
                this.f1360g[pointerId] = y;
            }
        }
    }
    ...
    public boolean t(int i2, int i3) {
        if (this.s) {
            return l(i2, i3, (int) this.f1365l.getXVelocity(this.c), (int) this.f1365l.getYVelocity(this.c));
        }
    ...
    public boolean u(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked != 2) {
                ...
                } else if (!(this.f1357d == null || this.f1358e == null)) {
                    int pointerCount = motionEvent.getPointerCount();
                    for (int i3 = 0; i3 < pointerCount; i3++) {
                        ...
                        if (m(pointerId2)) {
                            ...
                            float f2 = x2 - this.f1357d[pointerId2];
                            float f3 = y2 - this.f1358e[pointerId2];
