...
public abstract class b<T extends b<T>> implements a.b {
    ...
    public static final k f1370l = new c("scaleX");
    ...
    public final c f1372e;

    /* renamed from: f  reason: collision with root package name */
    public boolean f1373f = false;

    /* renamed from: g  reason: collision with root package name */
    public float f1374g = -3.4028235E38f;
    ...
    public final ArrayList<i> f1377j = new ArrayList<>();

    /* renamed from: k  reason: collision with root package name */
    public final ArrayList<j> f1378k = new ArrayList<>();
    ...
    public static abstract class k extends c<View> {
        public k(String str, C0042b bVar) {
            super(str);
        }
    }
    ...
    public <K> b(K k2, c<K> cVar) {
        ...
        if (cVar == n || cVar == o || cVar == p) {
            f2 = 0.1f;
        } else if (cVar == q || cVar == f1370l || cVar == m) {
            this.f1376i = 0.00390625f;
            return;
        } else {
            f2 = 1.0f;
        }
    ...
    public boolean a(long j2) {
        ...
        e eVar = dVar.r;
        if (i2 != 0) {
            double d3 = eVar.f1384i;
            j4 /= 2;
            h b2 = eVar.b((double) dVar.b, (double) dVar.a, j4);
            eVar = dVar.r;
            eVar.f1384i = (double) dVar.s;
        ...
        dVar.b = f3;
        dVar.a = b3.b;
        float max = Math.max(f3, dVar.f1374g);
        dVar.b = max;
        ...
        boolean z = true;
        if (((double) Math.abs(f4)) < eVar2.f1380e && ((double) Math.abs(min - ((float) eVar2.f1384i))) < eVar2.f1379d) {
            dVar.b = (float) dVar.r.f1384i;
            dVar.a = 0.0f;
        } else {
            z = false;
        }
        ...
        this.b = min2;
        float max2 = Math.max(min2, this.f1374g);
        this.b = max2;
        e(max2);
        if (z) {
            c(false);
    ...
    public final void c(boolean z) {
        ...
        this.f1375h = 0;
        this.c = false;
        for (int i2 = 0; i2 < this.f1377j.size(); i2++) {
            if (this.f1377j.get(i2) != null) {
                this.f1377j.get(i2).a(this, z, this.b, this.a);
            }
        }
        d(this.f1377j);
    }
    ...
    public void e(float f2) {
        this.f1372e.b(this.f1371d, f2);
        for (int i2 = 0; i2 < this.f1378k.size(); i2++) {
            if (this.f1378k.get(i2) != null) {
                this.f1378k.get(i2).a(this, this.b, this.a);
            }
        }
        d(this.f1378k);
    }
