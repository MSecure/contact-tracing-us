...
public class a extends q<C0045a> {
    ...
    public static class C0045a extends j {
        ...
        public void k(Context context, AttributeSet attributeSet) {
            ...
            if (this.f1555j == null) {
                this.f1555j = new Intent();
            }
            this.f1555j.setPackage(string);
            ...
            if (string4 != null) {
                ...
                this.f1555j.setData(parse);
            }
            this.f1556k = obtainAttributes.getString(R$styleable.ActivityNavigator_dataPattern);
    ...
    @Override // e.r.q
    public j b(C0045a aVar, Bundle bundle, o oVar, q.a aVar2) {
        Activity activity;
        Intent intent;
        int intExtra;
        C0045a aVar3 = aVar;
        if (aVar3.f1555j != null) {
            Intent intent2 = new Intent(aVar3.f1555j);
            if (bundle != null) {
                intent2.putExtras(bundle);
                String str = aVar3.f1556k;
            ...
            intent2.putExtra("android-support-navigation:ActivityNavigator:current", aVar3.f1575d);
            if (oVar != null) {
                intent2.putExtra("android-support-navigation:ActivityNavigator:popEnterAnim", oVar.f1590f);
                intent2.putExtra("android-support-navigation:ActivityNavigator:popExitAnim", oVar.f1591g);
            }
            if (z) {
                Objects.requireNonNull((b) aVar2);
            }
        ...
        StringBuilder i5 = f.a.a.a.a.i("Destination ");
        i5.append(aVar3.f1575d);
