...
public class c implements e.v.a.c {
    ...
    public static class a extends SQLiteOpenHelper {
        ...
        public class C0056a implements DatabaseErrorHandler {
            ...
            public C0056a(c.a aVar, a[] aVarArr) {
                this.a = aVar;
                this.b = aVarArr;
            }
        ...
        public void onCreate(SQLiteDatabase sQLiteDatabase) {
            ...
            try {
                ...
                if (!z) {
                    h.b g2 = hVar.c.g(d2);
                    if (!g2.a) {
                        StringBuilder i2 = f.a.a.a.a.i("Pre-packaged database has an invalid schema: ");
                        i2.append(g2.b);
                ...
                try {
                    ...
                    if (z) {
                        ...
                        try {
                            ...
                            d4.close();
                            if (!hVar.f1719d.equals(string) && !hVar.f1720e.equals(string)) {
    ...
    public final a c() {
        ...
        synchronized (this.f1751f) {
            if (this.f1752g == null) {
                a[] aVarArr = new a[1];
                if (Build.VERSION.SDK_INT < 23 || this.c == null || !this.f1750e) {
                    this.f1752g = new a(this.b, this.c, aVarArr, this.f1749d);
                } else {
                    this.f1752g = new a(this.b, new File(this.b.getNoBackupFilesDir(), this.c).getAbsolutePath(), aVarArr, this.f1749d);
                }
                this.f1752g.setWriteAheadLoggingEnabled(this.f1753h);
            }
            aVar = this.f1752g;
        }
        return aVar;
