...
public class c extends f implements Animatable {
    ...
    public Context f1797d;

    /* renamed from: e  reason: collision with root package name */
    public ArgbEvaluator f1798e;

    /* renamed from: f  reason: collision with root package name */
    public final Drawable.Callback f1799f;
    ...
    public static class b extends Drawable.ConstantState {
        ...
        /* renamed from: d  reason: collision with root package name */
        public ArrayList<Animator> f1800d;

        /* renamed from: e  reason: collision with root package name */
        public e.e.a<Animator, String> f1801e;
        ...
        public b(b bVar, Drawable.Callback callback, Resources resources) {
            if (bVar != null) {
                ...
                ArrayList<Animator> arrayList = bVar.f1800d;
                if (arrayList != null) {
                    int size = arrayList.size();
                    this.f1800d = new ArrayList<>(size);
                    this.f1801e = new e.e.a<>(size);
                    for (int i2 = 0; i2 < size; i2++) {
                        Animator animator = bVar.f1800d.get(i2);
                        Animator clone = animator.clone();
                        String orDefault = bVar.f1801e.getOrDefault(animator, null);
                        clone.setTarget(this.b.c.b.p.getOrDefault(orDefault, null));
                        this.f1800d.add(clone);
                        this.f1801e.put(clone, orDefault);
                    }
                    if (this.c == null) {
                        this.c = new AnimatorSet();
                    }
                    this.c.playTogether(this.f1800d);
                }
            }
        }
    ...
    public Drawable.ConstantState getConstantState() {
        ...
        return new C0060c(this.b.getConstantState());
    }
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    typedArray = h.e(resources, theme, attributeSet, a.f1789e);
                    ...
                    typedArray = resources.obtainAttributes(attributeSet, a.f1790f);
                    ...
                    if (resourceId2 != 0) {
                        ...
                        if (context != null) {
                            ...
                            b bVar = this.c;
                            if (bVar.f1800d == null) {
                                bVar.f1800d = new ArrayList<>();
                                this.c.f1801e = new e.e.a<>();
                            }
                            this.c.f1800d.add(animator);
                            this.c.f1801e.put(animator, string);
                        } else {
                            typedArray.recycle();
        ...
        bVar2.c.playTogether(bVar2.f1800d);
    }
    ...
    public static class C0060c extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            ...
            cVar.b = newDrawable;
            newDrawable.setCallback(cVar.f1799f);
            return cVar;
        }
