...
public class i extends Thread {
    ...
    public final q f2035e;

    /* renamed from: f  reason: collision with root package name */
    public volatile boolean f2036f = false;
    ...
    public final void a() {
        ...
        try {
            ...
            ((f) this.f2035e).a(take, q, null);
            take.o(q);
        } catch (u e2) {
            SystemClock.elapsedRealtime();
            Objects.requireNonNull(take);
            f fVar = (f) this.f2035e;
