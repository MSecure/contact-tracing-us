...
public class v {
    ...
    public static class a {
        ...
        public final List<C0066a> a = new ArrayList();
        ...
        public static class C0066a {
            ...
            public C0066a(String str, long j2, long j3) {
                this.a = str;
                this.b = j2;
                this.c = j3;
            }
        ...
        public synchronized void a(String str, long j2) {
            if (!this.b) {
                this.a.add(new C0066a(str, j2, SystemClock.elapsedRealtime()));
            } else {
    ...
    public static String a(String str, Object... objArr) {
        ...
        while (true) {
            if (i2 >= stackTrace.length) {
                ...
                StringBuilder j2 = f.a.a.a.a.j(substring.substring(substring.lastIndexOf(36) + 1), ".");
