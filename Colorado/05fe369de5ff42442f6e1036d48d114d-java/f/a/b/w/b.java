...
public class b implements h {
    ...
    public static List<g> b(List<g> list, b.a aVar) {
        ...
        List<g> list2 = aVar.f2027g;
        if (list2 != null) {
            if (!list2.isEmpty()) {
                for (g gVar2 : aVar.f2027g) {
                    if (!treeSet.contains(gVar2.a)) {
                        arrayList.add(gVar2);
                    }
                }
            }
        } else if (!aVar.f2026f.isEmpty()) {
            for (Map.Entry<String, String> entry : aVar.f2026f.entrySet()) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x00bb, code lost:
        r0 = r2.a;
        f.a.b.v.a("Unexpected response code %d for %s", java.lang.Integer.valueOf(r0), r29.f2039d);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:63:0x0102, code lost:
        if (r29.f2047l != false) goto L_0x0104;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:74:0x012f, code lost:
        r2 = f.a.a.a.a.i("Bad URL ");
        r2.append(r29.f2039d);
     */
    ...
    public k f(n<?> nVar) {
        ...
        while (true) {
            ...
            try {
                ...
                InputStream inputStream = a2.f2061d;
