...
public class c {
    ...
    public static final Comparator<byte[]> f2059e = new a();
    ...
    public synchronized void b(byte[] bArr) {
        if (bArr != null) {
            if (bArr.length <= this.f2060d) {
                this.a.add(bArr);
                int binarySearch = Collections.binarySearch(this.b, bArr, f2059e);
                if (binarySearch < 0) {
