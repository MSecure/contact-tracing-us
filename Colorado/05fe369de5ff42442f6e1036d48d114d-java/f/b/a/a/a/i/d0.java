...
public class d0<R, S, T> extends q<e<R, S, T>> {
    public R m = null;
    public S n = null;
    public T o = null;
    ...
    public d0(LiveData<R> liveData, LiveData<S> liveData2, LiveData<T> liveData3) {
        m(liveData, new k(this));
        m(liveData2, new j(this));
        m(liveData3, new m(this));
    }

    /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: f.b.a.a.a.i.d0<R, S, T> */
    /* JADX WARN: Multi-variable type inference failed */
    public final void n() {
        R r = this.m;
        S s = this.n;
