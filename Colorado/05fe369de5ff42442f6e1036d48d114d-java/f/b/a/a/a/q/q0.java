...
public final /* synthetic */ class q0 implements i {
    ...
    public final u a(Object obj) {
        ...
        f.b.b.f.a.l y = f.b.b.f.a.l.x(smsVerificationWorker.f383f.c(str)).z(new w0(smsVerificationWorker, str), smsVerificationWorker.f387j).z(new s0(smsVerificationWorker, str), smsVerificationWorker.f386i).y(t0.a, smsVerificationWorker.f387j);
        p0 p0Var = p0.a;
        ExecutorService executorService = smsVerificationWorker.f387j;
        a.C0108a aVar = new a.C0108a(y, f0.c.class, p0Var);
        y.a(aVar, b.g1(executorService, aVar));
        u0 u0Var = u0.a;
        ExecutorService executorService2 = smsVerificationWorker.f387j;
        a.C0108a aVar2 = new a.C0108a(aVar, f0.d.class, u0Var);
        aVar.a(aVar2, b.g1(executorService2, aVar2));
        return aVar2;
    }
}
