...
public class l {
    ...
    public void a(i iVar, int i2) {
        ...
        Iterable<h> iterable = (Iterable) this.f2554f.c(new h(this, iVar));
        if (iterable.iterator().hasNext()) {
            if (a2 == null) {
                m.h.P("Uploader", "Unknown backend for %s, deleting event batch for it...", iVar);
                b2 = g.a();
            } else {
                ...
                if (1 != 0) {
                    ...
                    throw new IllegalStateException(f.a.a.a.a.c("Missing required properties:", ""));
                }
            }
            this.f2554f.c(new i(this, b2, iterable, iVar, i2));
        }
    }
}
