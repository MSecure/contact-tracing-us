...
public class t implements c, f.b.a.b.i.t.b {
    ...
    public static final f.b.a.b.b f2565f = new f.b.a.b.b("proto");
    public final z b;
    public final f.b.a.b.i.u.a c;

    /* renamed from: d  reason: collision with root package name */
    public final f.b.a.b.i.u.a f2566d;
    ...
    public final <T> T J(d<T> dVar, b<Throwable, T> bVar) {
        long a2 = this.f2566d.a();
        while (true) {
            try {
                return dVar.a();
            } catch (SQLiteDatabaseLockedException e2) {
                if (this.f2566d.a() >= ((long) this.f2567e.a()) + a2) {
                    return bVar.a(e2);
                }
    ...
    public h N(i iVar, f fVar) {
        ...
        m.h.s0("SQLiteEventStore");
        String.format("Storing event with priority=%s, name=%s for destination %s", objArr);
        long longValue = ((Long) x(new s(this, iVar, fVar))).longValue();
        if (longValue < 1) {
            return null;
        }
    ...
    public SQLiteDatabase d() {
        z zVar = this.b;
        zVar.getClass();
        return (SQLiteDatabase) J(new o(zVar), r.a);
    }

    /* JADX INFO: finally extract failed */
    @Override // f.b.a.b.i.s.i.c
    public int g() {
        long a2 = this.c.a() - this.f2567e.b();
        SQLiteDatabase d2 = d();
        d2.beginTransaction();
        try {
    ...
    public void j(Iterable<h> iterable) {
        if (iterable.iterator().hasNext()) {
            StringBuilder i2 = f.a.a.a.a.i("DELETE FROM events WHERE _id in ");
            i2.append(L(iterable));
            d().compileStatement(i2.toString()).execute();
        }
    }
    ...
    public boolean r(i iVar) {
        ...
        try {
            ...
            if (t == null) {
                ...
                bool = (Boolean) Q(d().rawQuery("SELECT 1 FROM events WHERE context_id = ? LIMIT 1", new String[]{t.toString()}), q.a);
            }
            d2.setTransactionSuccessful();
            d2.endTransaction();
    ...
    public Iterable<h> w(i iVar) {
        return (Iterable) x(new j(this, iVar));
    }
    ...
    public void y(Iterable<h> iterable) {
        if (iterable.iterator().hasNext()) {
            StringBuilder i2 = f.a.a.a.a.i("UPDATE events SET num_attempts = num_attempts + 1 WHERE _id in ");
            i2.append(L(iterable));
