...
public class d extends e {
    ...
    public static final d f2575d = new d();
    ...
    public boolean c(@RecentlyNonNull Activity activity, @RecentlyNonNull int i2, @RecentlyNonNull int i3, DialogInterface.OnCancelListener onCancelListener) {
        ...
        if (activity instanceof r) {
            ...
            kVar.D0(p, "GooglePlayServicesErrorDialog");
        } else {
    ...
    public final void d(Context context, int i2, PendingIntent pendingIntent) {
        ...
        if (i2 == 18) {
            ...
            if (b.V0(context)) {
                ...
                kVar.r.icon = 17301642;
                kVar.r.tickerText = k.b(resources.getString(R$string.common_google_play_services_notification_ticker));
