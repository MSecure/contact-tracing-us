...
public interface f extends IInterface {
    ...
    public static abstract class a extends f.b.a.c.e.a.a implements f {
        ...
        @RecentlyNonNull
        public static f I(@RecentlyNonNull IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        @RecentlyNonNull
        public final boolean H(@RecentlyNonNull int i2, @RecentlyNonNull Parcel parcel, @RecentlyNonNull Parcel parcel2, @RecentlyNonNull int i3) {
            if (i2 != 1) {
                return false;
            }
