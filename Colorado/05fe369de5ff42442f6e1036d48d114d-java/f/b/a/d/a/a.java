...
public final /* synthetic */ class a implements g {
    ...
    public final Object a(Object obj) {
        ...
        if (jSONObject == null) {
            ((q) sVar.f2774e).a.c("Invalid jsonObj, using default remote configs");
        } else {
            h0.a f2 = h0.f();
            try {
                ...
                if (jSONObject.has("encryption_key_id_facilitator")) {
                    ...
                    ((q.b) f2).f2768g = string4;
                }
                return f2.a();
            } catch (JSONException e2) {
                ((f.b.a.a.a.u.q) sVar.f2774e).a.d("Failed to parse remote config json, using defaults", e2);
            }
        }
        return s.f2772g;
    }
