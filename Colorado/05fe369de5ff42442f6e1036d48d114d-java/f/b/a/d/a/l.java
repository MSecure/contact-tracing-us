...
public final /* synthetic */ class l implements g {
    ...
    public final Object a(Object obj) {
        ...
        if (b3.d().g() != e.c.OK) {
            d0 d0Var = c0Var2.c;
            StringBuilder i2 = a.i("Cannot write failed response: ");
            i2.append(b3.d().f());
            ((q) d0Var).a.g(i2.toString());
            c0Var = new c0();
            c0Var.s();
        } else {
            ...
            ((q) c0Var2.c).a.a(a.c("Writing packets to Firestore for metric=", str));
            String str2 = "uuid" + c0Var2.f2747e.nextInt(100);
            f fVar = c0Var2.b;
            ...
            if (fVar.f3182h == null) {
                synchronized (fVar.b) {
                    if (fVar.f3182h == null) {
                        ...
                        String str3 = fVar.c;
                        f.b.c.k.h hVar = fVar.f3181g;
                        fVar.f3182h = new n(fVar.a, new f.b.c.k.s.e(bVar, str3, hVar.a, hVar.b), hVar, fVar.f3178d, fVar.f3179e, fVar.f3183i);
                    }
                }
            }
            ...
            if (s.n() % 2 == 1) {
                ...
                f.b.c.k.u.l lVar = (f.b.c.k.u.l) a3.f3258e.a(f.b.c.k.u.l.s(uuid));
                if (lVar.n() % 2 == 0) {
                    f.b.c.k.u.f fVar2 = new f.b.c.k.u.f(lVar);
                    String b4 = c0.f2744g.b(l.b.a.e.y());
                    ...
                    if (lVar2.n() % 2 == 1) {
                        ...
                        f.b.c.k.u.l lVar3 = (f.b.c.k.u.l) a4.f3258e.a(f.b.c.k.u.l.s(str));
                        if (lVar3.n() % 2 == 0) {
                            ...
                            if (oVar.a) {
                                ...
                                if (cVar != null) {
                                    ...
                                    StringBuilder i3 = a.i("Field '");
                                    i3.append(next.c());
                                    i3.append("' is specified in your field mask but not in your input data.");
                                    throw new IllegalArgumentException(i3.toString());
                                }
                                h0Var = new h0(a5, new c(f0Var.b), Collections.unmodifiableList(f0Var.c));
                            } else {
                                f.b.c.k.q qVar2 = fVar.f3180f;
                            ...
                            throw new IllegalArgumentException(a.s(lVar3, a.i("Invalid document reference. Document references must have an even number of segments, but "), " has "));
                        }
                    } else {
                        throw new IllegalArgumentException(a.s(lVar2, a.i("Invalid collection reference. Collection references must have an odd number of segments, but "), " has "));
                    }
                } else {
                    throw new IllegalArgumentException(a.s(lVar, a.i("Invalid document reference. Document references must have an even number of segments, but "), " has "));
                }
            } else {
                throw new IllegalArgumentException(a.s(s, a.i("Invalid collection reference. Collection references must have an odd number of segments, but "), " has "));
            }
        }
        l.b.a.d dVar = c0.f2743f;
        ScheduledExecutorService scheduledExecutorService = c0Var2.f2746d;
        return f.b.b.f.a.l.x(f.b.b.f.a.l.x(m.h.h0(new f.b.a.d.a.j0.b(c0Var, scheduledExecutorService))).A(dVar.t(), TimeUnit.MILLISECONDS, scheduledExecutorService));
    }
}
