...
public class s implements f0 {
    ...
    public static final d f2771f = d.n(10);

    /* renamed from: g  reason: collision with root package name */
    public static final h0 f2772g = h0.f().a();
    public f.b.a.d.a.j0.d a;
    public final Uri b;
    public final w c = t.f2775d;

    /* renamed from: d  reason: collision with root package name */
    public final l<b0> f2773d;
    ...
    public static class a extends e {
        public a(Uri uri, p.b<JSONObject> bVar, p.a aVar) {
            ...
            this.m = new f.a.b.e((int) s.f2771f.t(), 3, 1.0f);
        }
    }
    ...
    public s(Uri uri, l<b0> lVar, d0.a aVar) {
        this.b = uri;
        this.f2773d = lVar;
        this.f2774e = aVar.a("PAPrioRemoteConfig");
    ...
    public u<h0> a() {
        f.b.b.f.a.l y = f.b.b.f.a.l.x(m.h.h0(new c(this))).y(new a(this), this.c);
        e eVar = new e(this);
        w wVar = this.c;
