...
public class b extends g implements e.i.c.l.a, Drawable.Callback, i.b {
    ...
    public final void A(Rect rect, RectF rectF) {
        ...
        if (r0() || q0()) {
            ...
            if (f6 <= 0.0f && drawable != null) {
                f6 = (float) Math.ceil((double) TypedValue.applyDimension(1, (float) 24, this.g0.getResources().getDisplayMetrics()));
    ...
    public final boolean L(int[] iArr, int[] iArr2) {
        ...
        if ((this.p0 != a2) || (this.b.f2971d == null)) {
            this.p0 = a2;
        ...
        int colorForState3 = (this.C0 == null || !f.b.a.e.s.a.b(iArr)) ? 0 : this.C0.getColorForState(iArr, this.r0);
        ...
        f.b.a.e.r.b bVar = this.m0.f2906f;
        int colorForState4 = (bVar == null || (colorStateList = bVar.a) == null) ? 0 : colorStateList.getColorForState(iArr, this.s0);
        ...
        if (!(this.t0 == z5 || this.U == null)) {
            ...
            if (B2 != B()) {
                ...
                if (this.u0 == colorForState) {
                    ...
                    this.x0 = f.b.a.c.b.o.b.s1(this, this.y0, this.z0);
                } else {
                    z4 = onStateChange;
                }
                if (J(this.I)) {
    ...
    public void T(Drawable drawable) {
        ...
        Drawable z1 = drawable2 != null ? m.h.z1(drawable2) : null;
        if (z1 != drawable) {
            float B2 = B();
            if (drawable != null) {
                drawable3 = m.h.C1(drawable).mutate();
            }
            this.I = drawable3;
            float B3 = B();
            t0(z1);
    ...
    public void b0(Drawable drawable) {
        ...
        if (G2 != drawable) {
            float E2 = E();
            this.N = drawable != null ? m.h.C1(drawable).mutate() : null;
            int[] iArr = f.b.a.e.s.a.a;
            this.O = new RippleDrawable(f.b.a.e.s.a.a(this.F), this.N, J0);
            float E3 = E();
            t0(G2);
            if (s0()) {
                z(this.N);
        ...
        if (!bounds.isEmpty() && (i2 = this.v0) != 0) {
            ...
            if (!this.F0 || this.G == null) {
                ...
                if (iVar.f2906f != null) {
                    ...
                    i iVar2 = this.m0;
                    iVar2.f2906f.c(this.g0, iVar2.a, iVar2.b);
                }
    ...
    public void k0(ColorStateList colorStateList) {
        if (this.F != colorStateList) {
            ...
            this.C0 = this.B0 ? f.b.a.e.s.a.a(colorStateList) : null;
            onStateChange(getState());
        }
    }
    ...
    public void m0(f.b.a.e.r.b bVar) {
        i iVar = this.m0;
    ...
    public boolean onLayoutDirectionChanged(int i2) {
        ...
        if (r0()) {
            onLayoutDirectionChanged |= m.h.f1(this.I, i2);
        }
        if (q0()) {
            onLayoutDirectionChanged |= m.h.f1(this.U, i2);
        }
        if (s0()) {
            onLayoutDirectionChanged |= m.h.f1(this.N, i2);
        }
    ...
    @Override // f.b.a.e.p.i.b, f.b.a.e.u.g
    ...
    public void p0(boolean z2) {
        if (this.B0 != z2) {
            this.B0 = z2;
            this.C0 = z2 ? f.b.a.e.s.a.a(this.F) : null;
            onStateChange(getState());
        }
    }
    ...
    public void setTintMode(PorterDuff.Mode mode) {
        if (this.z0 != mode) {
            this.z0 = mode;
            this.x0 = f.b.a.c.b.o.b.s1(this, this.y0, mode);
            invalidateSelf();
        }
    }
