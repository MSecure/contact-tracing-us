...
public final class i<S> extends z<S> {
    ...
    @Override // f.b.a.e.k.z
    public boolean A0(y<S> yVar) {
    ...
    public void E0(e eVar) {
        this.b0 = eVar;
        if (eVar == e.YEAR) {
            this.d0.getLayoutManager().N0(((f0) this.d0.getAdapter()).m(this.a0.f2848d));
    ...
    public View P(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        m.q(gridView, new b(this));
        gridView.setAdapter((ListAdapter) new h());
        gridView.setNumColumns(uVar.f2849e);
        ...
        if (!q.F0(contextThemeWrapper) && (recyclerView2 = tVar.a) != (recyclerView = this.e0)) {
