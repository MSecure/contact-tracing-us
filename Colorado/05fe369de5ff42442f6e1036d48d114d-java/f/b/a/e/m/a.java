...
public class a {
    ...
    public a(Context context) {
        this.a = b.i1(context, R$attr.elevationOverlayEnabled, false);
        this.b = b.u0(context, R$attr.elevationOverlayColor, 0);
        this.c = b.u0(context, R$attr.colorSurface, 0);
        this.f2867d = context.getResources().getDisplayMetrics().density;
    }
    ...
    public int a(int i2, float f2) {
        ...
        float f3 = this.f2867d;
        float f4 = 0.0f;
        if (f3 > 0.0f && f2 > 0.0f) {
            f4 = Math.min(((((float) Math.log1p((double) (f2 / f3))) * 4.5f) + 2.0f) / 100.0f, 1.0f);
        }
        return e.i.c.a.c(b.X0(e.i.c.a.c(i2, 255), this.b, f4), Color.alpha(i2));
    }
}
