...
public final class c {
    ...
    public final Rect f2883d;

    /* renamed from: e  reason: collision with root package name */
    public final Rect f2884e;

    /* renamed from: f  reason: collision with root package name */
    public final RectF f2885f;

    /* renamed from: g  reason: collision with root package name */
    public int f2886g = 16;

    /* renamed from: h  reason: collision with root package name */
    public int f2887h = 16;

    /* renamed from: i  reason: collision with root package name */
    public float f2888i = 15.0f;

    /* renamed from: j  reason: collision with root package name */
    public float f2889j = 15.0f;

    /* renamed from: k  reason: collision with root package name */
    public ColorStateList f2890k;

    /* renamed from: l  reason: collision with root package name */
    public ColorStateList f2891l;
    public float m;
    public float n;
    public float o;
    public float p;
    ...
    public c(View view) {
        ...
        this.f2884e = new Rect();
        this.f2883d = new Rect();
        this.f2885f = new RectF();
    }
    ...
    public static float i(float f2, float f3, float f4, TimeInterpolator timeInterpolator) {
        ...
        TimeInterpolator timeInterpolator2 = f.b.a.e.a.a.a;
    ...
    public float b() {
        ...
        textPaint.setTextSize(this.f2889j);
    ...
    public final boolean c(CharSequence charSequence) {
        ...
        return ((d.c) (z2 ? d.f1287d : d.c)).b(charSequence, 0, charSequence.length());
    }
    ...
    public final void d(float f2) {
        ...
        this.f2885f.left = i((float) this.f2883d.left, (float) this.f2884e.left, f2, this.G);
        this.f2885f.top = i(this.m, this.n, f2, this.G);
        this.f2885f.right = i((float) this.f2883d.right, (float) this.f2884e.right, f2, this.G);
        this.f2885f.bottom = i((float) this.f2883d.bottom, (float) this.f2884e.bottom, f2, this.G);
        this.q = i(this.o, this.p, f2, this.G);
        this.r = i(this.m, this.n, f2, this.G);
        p(i(this.f2888i, this.f2889j, f2, this.H));
        ...
        ColorStateList colorStateList = this.f2891l;
        ColorStateList colorStateList2 = this.f2890k;
    ...
    public final void e(float f2) {
        ...
        if (this.w != null) {
            float width = (float) this.f2884e.width();
            float width2 = (float) this.f2883d.width();
            if (Math.abs(f2 - this.f2889j) < 0.001f) {
                f3 = this.f2889j;
                this.A = 1.0f;
                ...
                if (Math.abs(f2 - f4) < 0.001f) {
                    ...
                    this.A = f2 / this.f2888i;
                }
                float f5 = this.f2889j / this.f2888i;
            ...
            if (this.x == null || z2) {
                ...
                try {
                    ...
                    hVar.f2903i = TextUtils.TruncateAt.END;
                    hVar.f2902h = c2;
                    hVar.f2899e = Layout.Alignment.ALIGN_NORMAL;
                    hVar.f2901g = false;
                    hVar.f2900f = 1;
                    staticLayout = hVar.a();
                } catch (h.a e2) {
    ...
    public void j() {
        this.b = this.f2884e.width() > 0 && this.f2884e.height() > 0 && this.f2883d.width() > 0 && this.f2883d.height() > 0;
    }
    ...
    public void k() {
        ...
        if (this.a.getHeight() > 0 && this.a.getWidth() > 0) {
            ...
            int absoluteGravity = Gravity.getAbsoluteGravity(this.f2887h, this.y ? 1 : 0);
            int i4 = absoluteGravity & 112;
            if (i4 != 48) {
                this.n = i4 != 80 ? ((float) this.f2884e.centerY()) - ((this.E.descent() - this.E.ascent()) / 2.0f) : this.E.ascent() + ((float) this.f2884e.bottom);
            } else {
                this.n = (float) this.f2884e.top;
            }
            int i5 = absoluteGravity & 8388615;
            if (i5 == 1) {
                f5 = (float) this.f2884e.centerX();
                measureText /= 2.0f;
            } else if (i5 != 5) {
                this.p = (float) this.f2884e.left;
                e(this.f2888i);
                ...
                this.Q = f7;
                int absoluteGravity2 = Gravity.getAbsoluteGravity(this.f2886g, this.y ? 1 : 0);
                i2 = absoluteGravity2 & 112;
                if (i2 != 48) {
                    f4 = (float) this.f2883d.top;
                } else if (i2 != 80) {
                    this.m = ((float) this.f2883d.centerY()) - (height / 2.0f);
                    i3 = absoluteGravity2 & 8388615;
                    if (i3 == 1) {
                        f3 = (float) this.f2883d.centerX();
                        measureText2 /= 2.0f;
                    } else if (i3 != 5) {
                        f2 = (float) this.f2883d.left;
                        this.o = f2;
                        bitmap = this.z;
                        if (bitmap != null) {
                            bitmap.recycle();
                    ...
                    f4 = this.E.descent() + (((float) this.f2883d.bottom) - height);
                }
                this.m = f4;
                i3 = absoluteGravity2 & 8388615;
                if (i3 == 1) {
            ...
            this.Q = f7;
            int absoluteGravity22 = Gravity.getAbsoluteGravity(this.f2886g, this.y ? 1 : 0);
    ...
    public void m(ColorStateList colorStateList) {
        if (this.f2891l != colorStateList) {
            this.f2891l = colorStateList;
            k();
        }
    }
