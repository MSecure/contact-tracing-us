...
public final class i<S extends c> extends l {
    ...
    public void draw(Canvas canvas) {
        ...
        if (!getBounds().isEmpty() && isVisible() && canvas.getClipBounds(rect)) {
            ...
            this.m.a(canvas, this.f2942j, 0.0f, this.p, b.H(this.c.c[0], this.f2943k));
            canvas.restore();
        }
    }
    ...
    public boolean i(boolean z, boolean z2, boolean z3) {
        ...
        float a2 = this.f2936d.a(this.b.getContentResolver());
        if (a2 == 0.0f) {
            this.q = true;
        } else {
            this.q = false;
    ...
    public boolean onLevelChange(int i2) {
        if (this.q) {
            ...
            if (dVar.f1373f) {
                ...
                } else if (d3 >= ((double) dVar.f1374g)) {
                    double abs = Math.abs((double) (dVar.f1376i * 0.75f));
                    eVar.f1379d = abs;
                    eVar.f1380e = abs * 62.5d;
                    if (Looper.myLooper() == Looper.getMainLooper()) {
                        boolean z = dVar.f1373f;
                        if (!z && !z) {
                            dVar.f1373f = true;
                            if (!dVar.c) {
                                dVar.b = dVar.f1372e.a(dVar.f1371d);
                            }
                            float f3 = dVar.b;
                            if (f3 > Float.MAX_VALUE || f3 < dVar.f1374g) {
                                throw new IllegalArgumentException("Starting value need to be in between min value and max value");
                            }
                            e.l.a.a a2 = e.l.a.a.a();
                            if (a2.b.size() == 0) {
                                if (a2.f1367d == null) {
                                    a2.f1367d = new a.d(a2.c);
                                }
                                a.d dVar2 = (a.d) a2.f1367d;
