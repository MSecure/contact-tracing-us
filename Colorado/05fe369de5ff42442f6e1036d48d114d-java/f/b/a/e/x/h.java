...
public class h extends m {
    ...
    public final TextWatcher f3027d = new a();

    /* renamed from: e  reason: collision with root package name */
    public final View.OnFocusChangeListener f3028e = new b();

    /* renamed from: f  reason: collision with root package name */
    public final TextInputLayout.e f3029f = new c(this.a);

    /* renamed from: g  reason: collision with root package name */
    public final TextInputLayout.f f3030g = new d();

    /* renamed from: h  reason: collision with root package name */
    public final TextInputLayout.g f3031h = new e();
    ...
    public long f3034k = Long.MAX_VALUE;

    /* renamed from: l  reason: collision with root package name */
    public StateListDrawable f3035l;
    public g m;
    ...
    public class a extends j {
        ...
        /* renamed from: f.b.a.e.x.h$a$a  reason: collision with other inner class name */
        ...
        public void a(TextInputLayout textInputLayout) {
            ...
            if (boxBackgroundMode == 2) {
                ...
                if (!(e2.getKeyListener() == null)) {
                    ...
                    int v0 = f.b.a.c.b.o.b.v0(e2, R$attr.colorControlHighlight);
                    int[][] iArr = {new int[]{16842919}, new int[0]};
                    if (boxBackgroundMode2 == 2) {
                        int v02 = f.b.a.c.b.o.b.v0(e2, R$attr.colorSurface);
                        g gVar = new g(boxBackground.b.a);
                        int X0 = f.b.a.c.b.o.b.X0(v0, v02, 0.1f);
                        gVar.q(new ColorStateList(iArr, new int[]{X0, 0}));
                        gVar.setTint(v02);
                        ColorStateList colorStateList = new ColorStateList(iArr, new int[]{X0, v02});
                        ...
                        RippleDrawable rippleDrawable = new RippleDrawable(new ColorStateList(iArr, new int[]{f.b.a.c.b.o.b.X0(v0, boxBackgroundColor, 0.1f), boxBackgroundColor}), boxBackground, boxBackground);
                ...
                e2.setOnFocusChangeListener(hVar3.f3028e);
                e2.setOnDismissListener(new k(hVar3));
                e2.setThreshold(0);
                e2.removeTextChangedListener(h.this.f3027d);
                e2.addTextChangedListener(h.this.f3027d);
                ...
                textInputLayout.setTextInputAccessibilityDelegate(h.this.f3029f);
            ...
            e2.setOnFocusChangeListener(hVar32.f3028e);
    ...
    public class e implements TextInputLayout.g {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                this.b.removeTextChangedListener(h.this.f3027d);
            }
        }
        ...
        public void a(TextInputLayout textInputLayout, int i2) {
            ...
            if (autoCompleteTextView != null && i2 == 3) {
                ...
                if (autoCompleteTextView.getOnFocusChangeListener() == h.this.f3028e) {
    ...
    public final g i(float f2, float f3, float f4, int i2) {
        j.b bVar = new j.b();
        bVar.f2990e = new f.b.a.e.u.a(f2);
        bVar.f2991f = new f.b.a.e.u.a(f2);
        bVar.f2993h = new f.b.a.e.u.a(f3);
        bVar.f2992g = new f.b.a.e.u.a(f3);
        f.b.a.e.u.j a2 = bVar.a();
        Context context = this.b;
        String str = g.x;
        int j1 = f.b.a.c.b.o.b.j1(context, R$attr.colorSurface, g.class.getSimpleName());
        g gVar = new g();
        ...
        gVar.invalidateSelf();
        g.b bVar3 = gVar.b;
        if (bVar3.f2976i == null) {
            bVar3.f2976i = new Rect();
        }
        gVar.b.f2976i.set(0, i2, 0, i2);
        gVar.invalidateSelf();
        return gVar;
    }
