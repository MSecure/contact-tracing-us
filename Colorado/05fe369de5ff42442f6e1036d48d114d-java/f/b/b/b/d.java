...
public abstract class d<K, V> implements Map<K, V>, Serializable {
    ...
    public static class a<K, V> {
        ...
        public a<K, V> b(K k2, V v) {
            ...
            if (i2 > objArr.length) {
                this.a = Arrays.copyOf(objArr, b.AbstractC0103b.b(objArr.length, i2));
                this.c = false;
            }
            f.b.a.c.b.o.b.x(k2, v);
    ...
    public e<Map.Entry<K, V>> entrySet() {
        ...
        h hVar = (h) this;
        h.a aVar = new h.a(hVar, hVar.f3077f, 0, hVar.f3078g);
        this.b = aVar;
        return aVar;
    }
    ...
    /* renamed from: c */
    public b<V> values() {
        b<V> bVar = this.f3070d;
        if (bVar != null) {
            return bVar;
        }
        h hVar = (h) this;
        h.c cVar = new h.c(hVar.f3077f, 1, hVar.f3078g);
        this.f3070d = cVar;
        return cVar;
    }
    ...
    public int hashCode() {
        return f.b.a.c.b.o.b.N0(entrySet());
    }
    ...
    public Set keySet() {
        ...
        h hVar = (h) this;
        h.b bVar = new h.b(hVar, new h.c(hVar.f3077f, 0, hVar.f3078g));
        this.c = bVar;
        return bVar;
    }
