...
public abstract class a<V, X extends Throwable, F, T> extends l.a<V> implements Runnable {
    ...
    public u<? extends V> f3107i;

    /* renamed from: j  reason: collision with root package name */
    public Class<X> f3108j;

    /* renamed from: k  reason: collision with root package name */
    public F f3109k;

    /* renamed from: f.b.b.f.a.a$a  reason: collision with other inner class name */
    public static final class C0108a<V, X extends Throwable> extends a<V, X, i<? super X, ? extends V>, u<? extends V>> {
        public C0108a(u<? extends V> uVar, Class<X> cls, i<? super X, ? extends V> iVar) {
            super(uVar, cls, iVar);
        }
    ...
    public String r() {
        String str;
        u<? extends V> uVar = this.f3107i;
        Class<X> cls = this.f3108j;
        F f2 = this.f3109k;
        String r = super.r();
        if (uVar != null) {
    ...
    public final void run() {
        ...
        if ((!z && !z2) && !isCancelled()) {
            ...
            try {
                ...
                if (cause == null) {
                    StringBuilder i2 = f.a.a.a.a.i("Future type ");
                    i2.append(uVar.getClass());
                    i2.append(" threw ");
                    i2.append(e2.getClass());
                    i2.append(" without a cause");
                    cause = new NullPointerException(i2.toString());
                }
                th = cause;
            } catch (Throwable th3) {
                th = th3;
