...
public final class b0 implements ThreadFactory {
    ...
    public final /* synthetic */ AtomicLong f3123d;

    /* renamed from: e  reason: collision with root package name */
    public final /* synthetic */ Boolean f3124e;
    ...
    public Thread newThread(Runnable runnable) {
        ...
        String str = this.c;
        if (str != null) {
            newThread.setName(String.format(Locale.ROOT, str, Long.valueOf(this.f3123d.getAndIncrement())));
        }
        Boolean bool = this.f3124e;
        if (bool != null) {
