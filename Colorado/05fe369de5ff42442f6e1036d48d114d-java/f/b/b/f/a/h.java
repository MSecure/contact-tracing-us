...
public abstract class h<OutputT> extends b.j<OutputT> {
    ...
    public static final b f3135k;

    /* renamed from: l  reason: collision with root package name */
    public static final Logger f3136l = Logger.getLogger(h.class.getName());

    /* renamed from: i  reason: collision with root package name */
    private volatile Set<Throwable> f3137i = null;

    /* renamed from: j  reason: collision with root package name */
    private volatile int f3138j;
    ...
    static {
        ...
        f3135k = bVar;
        if (th != null) {
            f3136l.log(Level.SEVERE, "SafeAtomicHelper is broken!", th);
        }
    }
    ...
    public final Set<Throwable> C() {
        Set<Throwable> set = this.f3137i;
        if (set != null) {
            return set;
        }
        Set<Throwable> newSetFromMap = Collections.newSetFromMap(new ConcurrentHashMap());
        A(newSetFromMap);
        f3135k.a(this, null, newSetFromMap);
        return this.f3137i;
    }
}
