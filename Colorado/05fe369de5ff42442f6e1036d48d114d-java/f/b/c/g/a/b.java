...
public class b<K, V> extends d<K, V> {
    ...
    public final Comparator<K> f3167d;
    ...
    public d<K, V> l(K k2, V v) {
        ...
        if (p != -1) {
            ...
            objArr2[p] = v;
            return new b(this.f3167d, objArr, objArr2);
            ...
            while (true) {
                ...
                if (i2 < kArr2.length) {
                    ...
                    hashMap.put(k2, v);
                    Comparator<K> comparator = this.f3167d;
            ...
            int q = q(k2);
            return new b(this.f3167d, o(this.b, q, k2), o(this.c, q, v));
        }
    }
    ...
    public final int p(K k2) {
        int i2 = 0;
        for (K k3 : this.b) {
            if (this.f3167d.compare(k2, k3) == 0) {
                return i2;
            }
            i2++;
        }
    ...
    public final int q(K k2) {
        ...
        while (true) {
            K[] kArr = this.b;
            if (i2 >= kArr.length || this.f3167d.compare(kArr[i2], k2) >= 0) {
                return i2;
            }
            i2++;
        }
