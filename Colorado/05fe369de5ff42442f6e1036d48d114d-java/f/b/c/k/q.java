...
public final class q {
    ...
    public final k a(Object obj, g0 g0Var) {
        if (!obj.getClass().isArray()) {
            s c = c(h.b(obj, h.b.f3380d), g0Var);
            if (c.y() == s.c.MAP_VALUE) {
                return new k(c);
            }
            StringBuilder j2 = a.j("Invalid data. Data must be a Map<String, Object> or a suitable POJO object, but it was ", "of type: ");
            j2.append(r.d(obj));
            throw new IllegalArgumentException(j2.toString());
        }
        throw new IllegalArgumentException(a.c("Invalid data. Data must be a Map<String, Object> or a suitable POJO object, but it was ", "an array"));
    }
                ...
                if (hVar3 != null) {
                    if (eVar instanceof e.c) {
                        ...
                        if (i0Var == i0.MergeSet) {
                            ...
                            f.b.a.c.b.o.b.M0(z, "FieldValue.delete() at the top level should have already been handled.", new Object[0]);
                        ...
                        if (eVar instanceof e.C0114e) {
                            ...
                            if (eVar instanceof e.b) {
                                ...
                                oVar2 = new a.C0115a(b(null));
                            } else if (eVar instanceof e.d) {
                                Objects.requireNonNull((e.d) eVar);
                                f0 f0Var = new f0(i0.Argument);
                                s c2 = c(h.b(null, h.b.f3380d), f0Var.a());
                                if (c2 == null) {
                                    z = false;
                                }
                                f.b.a.c.b.o.b.M0(z, "Parsed data should not be null.", new Object[0]);
                                f.b.a.c.b.o.b.M0(f0Var.c.isEmpty(), "Field transforms should have been disallowed.", new Object[0]);
                                oVar = new i(c2);
                                hVar3 = g0Var.b;
                            } else {
                                f.b.a.c.b.o.b.q0("Unknown FieldValue type: %s", r.d(eVar));
                                throw null;
                            }
                        ...
                        if (obj instanceof Float) {
                            ...
                            if (obj instanceof Boolean) {
                                ...
                                if (obj instanceof k) {
                                    ...
                                    a.b h2 = f.b.i.a.h();
                                    h2.copyOnWrite();
                                    f.b.i.a.c((f.b.i.a) h2.instance, 0.0d);
                                    h2.copyOnWrite();
                                    f.b.i.a.d((f.b.i.a) h2.instance, 0.0d);
                                    bVar.copyOnWrite();
                                    s.g((s) bVar.instance, (f.b.i.a) h2.build());
                                    ...
                                    StringBuilder i3 = f.a.a.a.a.i("Unsupported type: ");
                                    i3.append(r.d(obj));
                                    throw g0Var.c(i3.toString());
                                }
                            }
                            zVar = bVar2.build();
                            return (s) zVar;
