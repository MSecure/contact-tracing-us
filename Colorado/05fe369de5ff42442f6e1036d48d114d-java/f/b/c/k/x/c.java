...
public class c {
    public final ExecutorC0120c a = new ExecutorC0120c();
    ...
    public class b {
        ...
        public final void b() {
            f.b.a.c.b.o.b.M0(this.b != null, "Caller should have verified scheduledFuture is non-null.", new Object[0]);
            this.b = null;
            f.b.a.c.b.o.b.M0(c.this.b.remove(this), "Delayed task not found.", new Object[0]);
        }
    }

    /* renamed from: f.b.c.k.x.c$c  reason: collision with other inner class name */
    public class ExecutorC0120c implements Executor {
        ...
        public class b implements Runnable, ThreadFactory {
            ...
            public Thread newThread(Runnable runnable) {
                f.b.a.c.b.o.b.M0(this.c == null, "Only one thread may be created in an AsyncQueue.", new Object[0]);
                this.c = runnable;
                this.b.countDown();
                return ExecutorC0120c.this.c;
            }
    ...
    public void d() {
        ...
        if (thread != currentThread) {
            f.b.a.c.b.o.b.q0("We are running on the wrong thread. Expected to be on the AsyncQueue thread %s/%d but was %s/%d", thread.getName(), Long.valueOf(this.a.c.getId()), currentThread.getName(), Long.valueOf(currentThread.getId()));
            throw null;
        }
    }
}
