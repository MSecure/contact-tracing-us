...
public abstract class a<MessageType extends a<MessageType, BuilderType>, BuilderType extends AbstractC0124a<MessageType, BuilderType>> implements t0 {
    ...
    public static abstract class AbstractC0124a<MessageType extends a<MessageType, BuilderType>, BuilderType extends AbstractC0124a<MessageType, BuilderType>> implements t0.a {
        ...
        /* renamed from: f.b.g.a$a$a  reason: collision with other inner class name */
        ...
        public static <T> void addAll(Iterable<T> iterable, List<? super T> list) {
            ...
            if (iterable instanceof i0) {
                ...
                for (Object obj : f2) {
                    if (obj == null) {
                        StringBuilder i2 = f.a.a.a.a.i("Element at index ");
                        i2.append(i0Var.size() - size);
                        i2.append(" is null.");
        ...
        private String getReadingExceptionMessage(String str) {
            StringBuilder i2 = f.a.a.a.a.i("Reading ");
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: f.b.g.a$a<MessageType extends f.b.g.a<MessageType, BuilderType>, BuilderType extends f.b.g.a$a<MessageType, BuilderType>> */
    ...
    private String getSerializingExceptionMessage(String str) {
        StringBuilder i2 = f.a.a.a.a.i("Serializing ");
        i2.append(getClass().getName());
        i2.append(" to a ");
        i2.append(str);
        i2.append(" threw an IOException (should never happen).");
