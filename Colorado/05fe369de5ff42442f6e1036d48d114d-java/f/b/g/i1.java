...
public final class i1 extends j {
    ...
    public static class b {
        ...
        public final void a(j jVar) {
            if (jVar.s()) {
                int binarySearch = Arrays.binarySearch(i1.f3553j, jVar.size());
                if (binarySearch < 0) {
                ...
                while (!this.a.isEmpty()) {
                    int binarySearch2 = Arrays.binarySearch(i1.f3553j, i1Var.f3554e);
                    if (binarySearch2 < 0) {
                ...
                StringBuilder i2 = f.a.a.a.a.i("Has a new type of ByteString been created? Found ");
    ...
    public static final class c implements Iterator<j.g> {
        ...
        public c(j jVar, a aVar) {
            ...
            if (jVar instanceof i1) {
                i1 i1Var = (i1) jVar;
                ArrayDeque<i1> arrayDeque = new ArrayDeque<>(i1Var.f3558i);
                this.b = arrayDeque;
                arrayDeque.push(i1Var);
                j jVar2 = i1Var.f3555f;
    ...
    public class d extends InputStream {
        ...
        public int available() {
            return i1.this.f3554e - (this.f3562f + this.f3561e);
        }

        public final void c() {
            int i2;
            if (this.c != null && this.f3561e == (i2 = this.f3560d)) {
                this.f3562f += i2;
                int i3 = 0;
                this.f3561e = 0;
                if (this.b.hasNext()) {
        ...
        public void mark(int i2) {
            this.f3563g = this.f3562f + this.f3561e;
        }
        ...
        public final int t(byte[] bArr, int i2, int i3) {
            ...
            while (i4 > 0) {
                ...
                int min = Math.min(this.f3560d - this.f3561e, i4);
                if (bArr != null) {
                    this.c.o(bArr, this.f3561e, i2, min);
                    i2 += min;
                }
                this.f3561e += min;
                i4 -= min;
    ...
    public i1(j jVar, j jVar2) {
        ...
        int size = jVar.size();
        this.f3557h = size;
        this.f3554e = jVar2.size() + size;
        this.f3558i = Math.max(jVar.q(), jVar2.q()) + 1;
    }
    ...
    public void p(byte[] bArr, int i2, int i3, int i4) {
        ...
        if (i5 <= i6) {
            ...
            int i7 = i6 - i2;
            this.f3555f.p(bArr, i2, i3, i7);
            this.f3556g.p(bArr, 0, i3 + i7, i4 - i7);
            return;
        }
    ...
    public byte r(int i2) {
        int i3 = this.f3557h;
        return i2 < i3 ? this.f3555f.r(i2) : this.f3556g.r(i2 - i3);
    }

    @Override // f.b.g.j
    public boolean s() {
        return this.f3554e >= E(this.f3558i);
    }
    ...
    @Override // f.b.g.j
    public boolean t() {
        int x = this.f3555f.x(0, 0, this.f3557h);
        j jVar = this.f3556g;
    ...
    public int w(int i2, int i3, int i4) {
        ...
        int i6 = this.f3557h;
        if (i5 <= i6) {
            return this.f3555f.w(i2, i3, i4);
        }
        if (i3 >= i6) {
            return this.f3556g.w(i2, i3 - i6, i4);
        }
        int i7 = i6 - i3;
        return this.f3556g.w(this.f3555f.w(i2, i3, i7), 0, i4 - i7);
    }
    ...
    public int x(int i2, int i3, int i4) {
        ...
        int i6 = this.f3557h;
        if (i5 <= i6) {
            return this.f3555f.x(i2, i3, i4);
        }
        if (i3 >= i6) {
            return this.f3556g.x(i2, i3 - i6, i4);
        }
        int i7 = i6 - i3;
        return this.f3556g.x(this.f3555f.x(i2, i3, i7), 0, i4 - i7);
    }

    @Override // f.b.g.j
    public j y(int i2, int i3) {
        int k2 = j.k(i2, i3, this.f3554e);
        if (k2 == 0) {
            return j.c;
        }
        if (k2 == this.f3554e) {
        ...
        int i4 = this.f3557h;
        if (i3 <= i4) {
            return this.f3555f.y(i2, i3);
        }
        if (i2 >= i4) {
            return this.f3556g.y(i2 - i4, i3 - i4);
        }
        j jVar = this.f3555f;
        return new i1(jVar.y(i2, jVar.size()), this.f3556g.y(0, i3 - this.f3557h));
    }
}
