...
public abstract class m extends i {
    ...
    public static final boolean c = v1.f3636h;
    public n a;
    ...
    public static abstract class b extends m {
        ...
        public final void f0(int i2) {
            if (m.c) {
                ...
                this.f3602g += (int) (((long) this.f3601f) - j2);
                return;
            }
            while ((i2 & -128) != 0) {
                byte[] bArr3 = this.f3599d;
                int i5 = this.f3601f;
                this.f3601f = i5 + 1;
        ...
        public final void g0(long j2) {
            if (m.c) {
                ...
                this.f3602g += (int) (((long) this.f3601f) - j3);
                return;
            }
            while ((j2 & -128) != 0) {
                byte[] bArr3 = this.f3599d;
    ...
    public static class c extends m {
        ...
        @Override // f.b.g.m
        public final int G() {
            return this.f3604e - this.f3605f;
        }

        @Override // f.b.g.m
        public final void H(byte b) {
            try {
                byte[] bArr = this.f3603d;
                int i2 = this.f3605f;
                this.f3605f = i2 + 1;
                bArr[i2] = b;
            } catch (IndexOutOfBoundsException e2) {
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3605f), Integer.valueOf(this.f3604e), 1), e2);
            }
        }
        ...
        public final void X(String str) {
            ...
            try {
                ...
                if (A2 == A) {
                    int i3 = i2 + A2;
                    this.f3605f = i3;
                    c = w1.c(str, this.f3603d, i3, G());
                    this.f3605f = i2;
                    a0((c - i2) - A2);
                } else {
                    a0(w1.d(str));
                    c = w1.c(str, this.f3603d, this.f3605f, G());
                }
                this.f3605f = c;
            } catch (w1.c e2) {
                this.f3605f = i2;
        ...
        public final void d0(byte[] bArr, int i2, int i3) {
            try {
                System.arraycopy(bArr, i2, this.f3603d, this.f3605f, i3);
                this.f3605f += i3;
            } catch (IndexOutOfBoundsException e2) {
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3605f), Integer.valueOf(this.f3604e), Integer.valueOf(i3)), e2);
            }
        }
    }
    ...
    public static class d extends IOException {
        public d(String str, Throwable th) {
            super(f.a.a.a.a.c("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str), th);
        }
    ...
    public static final class e extends b {
        ...
        public final OutputStream f3606h;

        public e(OutputStream outputStream, int i2) {
            super(i2);
            Objects.requireNonNull(outputStream, "out");
            this.f3606h = outputStream;
        }

        @Override // f.b.g.m
        public void H(byte b) {
            if (this.f3601f == this.f3600e) {
                h0();
            }
            byte[] bArr = this.f3599d;
            int i2 = this.f3601f;
        ...
        public void X(String str) {
            ...
            try {
                ...
                if (A2 == A) {
                    ...
                    try {
                        this.f3601f = i6;
                        int c2 = w1.c(str, this.f3599d, i6, this.f3600e - i6);
                        this.f3601f = i5;
                        i2 = (c2 - i5) - A2;
                        f0(i2);
                        this.f3601f = c2;
                    } catch (w1.c e2) {
                        this.f3602g -= this.f3601f - i5;
                        this.f3601f = i5;
                        throw e2;
                    ...
                    i2 = w1.d(str);
                    f0(i2);
                    this.f3601f = w1.c(str, this.f3599d, this.f3601f, i2);
                }
                this.f3602g += i2;
            } catch (w1.c e4) {
                F(str, e4);
        ...
        public final void h0() {
            this.f3606h.write(this.f3599d, 0, this.f3601f);
            this.f3601f = 0;
        }
        ...
        public void k0(byte[] bArr, int i2, int i3) {
            ...
            int i5 = this.f3601f;
            if (i4 - i5 >= i3) {
                System.arraycopy(bArr, i2, this.f3599d, i5, i3);
                this.f3601f += i3;
            } else {
                int i6 = i4 - i5;
                System.arraycopy(bArr, i2, this.f3599d, i5, i6);
                int i7 = i2 + i6;
                i3 -= i6;
                this.f3601f = this.f3600e;
                this.f3602g += i6;
                h0();
                if (i3 <= this.f3600e) {
                    System.arraycopy(bArr, i7, this.f3599d, 0, i3);
                    this.f3601f = i3;
                } else {
                    this.f3606h.write(bArr, i7, i3);
                }
            }
            this.f3602g += i3;
        }
