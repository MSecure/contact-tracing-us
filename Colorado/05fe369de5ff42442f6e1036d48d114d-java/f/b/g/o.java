...
public final class o extends c<Double> implements c0.b, RandomAccess, c1 {
    ...
    public void add(int i2, Object obj) {
        ...
        if (i3 < dArr.length) {
            ...
            System.arraycopy(this.c, i2, dArr2, i2 + 1, this.f3617d - i2);
            this.c = dArr2;
        }
    ...
    public boolean addAll(Collection<? extends Double> collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(oVar.c, 0, this.c, this.f3617d, oVar.f3617d);
            this.f3617d = i4;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public boolean equals(Object obj) {
        ...
        o oVar = (o) obj;
        if (this.f3617d != oVar.f3617d) {
            return false;
        }
        double[] dArr = oVar.c;
        for (int i2 = 0; i2 < this.f3617d; i2++) {
    ...
    public int hashCode() {
        int i2 = 1;
        for (int i3 = 0; i3 < this.f3617d; i3++) {
    ...
    public final void j(int i2) {
        if (i2 < 0 || i2 >= this.f3617d) {
            throw new IndexOutOfBoundsException(k(i2));
        }
    }

    public final String k(int i2) {
        return "Index:" + i2 + ", Size:" + this.f3617d;
    }

    /* renamed from: l */
    public c0.b d(int i2) {
        if (i2 >= this.f3617d) {
            return new o(Arrays.copyOf(this.c, i2), this.f3617d);
        }
    ...
    public boolean remove(Object obj) {
        ...
        for (int i2 = 0; i2 < this.f3617d; i2++) {
            if (obj.equals(Double.valueOf(this.c[i2]))) {
                double[] dArr = this.c;
                System.arraycopy(dArr, i2 + 1, dArr, i2, (this.f3617d - i2) - 1);
                this.f3617d--;
                ((AbstractList) this).modCount++;
                return true;
            }
    ...
    public void removeRange(int i2, int i3) {
        ...
        if (i3 >= i2) {
            double[] dArr = this.c;
            System.arraycopy(dArr, i3, dArr, i2, this.f3617d - i3);
            this.f3617d -= i3 - i2;
            ((AbstractList) this).modCount++;
            return;
        }
