...
public final class v0<T> implements j1<T> {
    ...
    public v0(int[] iArr, Object[] objArr, int i2, int i3, t0 t0Var, boolean z, boolean z2, int[] iArr2, int i4, int i5, x0 x0Var, j0 j0Var, r1<?, ?> r1Var, s<?> sVar, o0 o0Var) {
        ...
        this.c = i2;
        this.f3623d = i3;
        this.f3626g = t0Var instanceof z;
        this.f3627h = z;
        this.f3625f = sVar != null && sVar.e(t0Var);
        this.f3628i = z2;
        this.f3629j = iArr2;
        this.f3630k = i4;
        this.f3631l = i5;
    ...
    public static <T> v0<T> B(g1 g1Var, x0 x0Var, j0 j0Var, r1<?, ?> r1Var, s<?> sVar, o0 o0Var) {
        ...
        d1 d1Var = d1.PROTO3;
        int i35 = 0;
        boolean z2 = ((g1Var.f3549d & 1) == 1 ? d1.PROTO2 : d1Var) == d1Var;
        String str2 = g1Var.b;
    ...
    public static Field S(Class<?> cls, String str) {
        try {
            ...
            StringBuilder k2 = a.k("Field ", str, " for ");
    ...
    public final <K, V> int I(T t, byte[] bArr, int i2, int i3, int i4, long j2, f fVar) {
        ...
        int i7 = g0 + i6;
        Object obj2 = h2.b;
        Object obj3 = h2.f3607d;
        while (g0 < i7) {
            int i8 = g0 + 1;
            byte b2 = bArr[g0];
            if (b2 < 0) {
                i5 = b.f0(b2, bArr, i8, fVar);
                b2 = fVar.a;
            } else {
                i5 = i8;
            }
            ...
            if (i9 == 1) {
                y1 y1Var = h2.a;
                if (i10 == y1Var.c) {
                    g0 = l(bArr, i5, i3, y1Var, null, fVar);
                    obj3 = obj3;
                    obj2 = fVar.c;
                }
            } else if (i9 == 2) {
                y1 y1Var2 = h2.c;
                if (i10 == y1Var2.c) {
                    g0 = l(bArr, i5, i3, y1Var2, h2.f3607d.getClass(), fVar);
                    obj3 = fVar.c;
                }
            }
            g0 = b.n1(b2, bArr, i5, i3, fVar);
        }
        if (g0 == i7) {
            e2.put(obj2, obj3);
            return i7;
    ...
    public final int J(T t, byte[] bArr, int i2, int i3, int i4, int i5, int i6, int i7, int i8, long j2, int i9, f fVar) {
        ...
        switch (i8) {
            case 51:
                if (i6 == 1) {
                    obj = Double.valueOf(Double.longBitsToDouble(b.O(bArr, i2)));
            ...
            case 52:
                if (i6 == 5) {
                    obj2 = Float.valueOf(Float.intBitsToFloat(b.N(bArr, i2)));
            ...
            case 64:
                if (i6 == 5) {
                    obj2 = Integer.valueOf(b.N(bArr, i2));
                    unsafe.putObject(t, j2, obj2);
                    i10 = i2 + 4;
                    unsafe.putInt(t, j4, i5);
                    return i10;
            ...
            case 68:
                if (i6 == 3) {
                    i10 = b.P(p(i9), bArr, i2, i3, (i4 & -8) | 4, fVar);
    ...
    public int K(T t, byte[] bArr, int i2, int i3, int i4, f fVar) {
        ...
        while (true) {
            if (i27 < i26) {
                ...
                if (i35 > i29) {
                    int i37 = i30 / 3;
                    if (i35 < v0Var3.c || i35 > v0Var3.f3623d) {
                        i7 = -1;
                        i6 = -1;
                        if (i6 != i7) {
                            i10 = i35;
                            ...
                            if (i12 == i13 || i13 == 0) {
                                ...
                                if (v0Var2.f3625f) {
                                    fVar4 = fVar;
                                    if (fVar4.f3543d != r.a()) {
                                        t0 t0Var = v0Var2.f3624e;
                                        r1<?, ?> r1Var = v0Var2.o;
                                        i15 = i10;
                                        z.e<?, ?> eVar = fVar4.f3543d.a.get(new r.a(t0Var, i15));
                                        if (eVar == null) {
                                            i27 = b.e0(i12, bArr, i14, i3, q(t), fVar);
                                            t3 = t;
                                        } else {
                                            t3 = t;
                                            T t5 = t3;
                                            t5.b();
                                            i27 = b.M(i12, bArr, i14, i3, t5, eVar, r1Var, fVar);
                                        }
                                        i28 = i13;
                                        i32 = i11;
                                    } else {
                            ...
                            if (W <= 17) {
                                ...
                                switch (W) {
                                    case 0:
                                        ...
                                        i16 = b2;
                                        if (i36 == 1) {
                                            v1.v(t4, C, Double.longBitsToDouble(b.O(bArr2, i5)));
                                            i21 = i5 + 8;
                                            i27 = i21;
                                            i33 |= i20;
                                            break;
                                    ...
                                    case 1:
                                        ...
                                        i16 = b2;
                                        if (i36 == 5) {
                                            v1.f3634f.p(t4, C, Float.intBitsToFloat(b.N(bArr2, i5)));
                                            i21 = i5 + 4;
                                            i27 = i21;
                                            i33 |= i20;
                                            break;
                                    ...
                                    case 14:
                                        ...
                                        if (i36 == 1) {
                                            fVar2 = fVar3;
                                            i16 = i24;
                                            unsafe2.putLong(t, C, b.O(bArr2, i5));
                                            i21 = i5 + 8;
                                            i27 = i21;
                                            i33 |= i20;
                                            break;
                                    ...
                                    case 13:
                                        ...
                                        fVar3 = fVar;
                                        if (i36 == 5) {
                                            unsafe2.putInt(t4, C, b.N(bArr2, i5));
                                            i27 = i5 + 4;
                                            i33 |= i20;
                                            i16 = i24;
                                            fVar2 = fVar3;
                                    ...
                                    case 7:
                                        ...
                                        fVar3 = fVar;
                                        if (i36 == 0) {
                                            i27 = b.i0(bArr2, i5, fVar3);
                                            v1.f3634f.m(t4, C, fVar3.b != 0);
                                            i33 |= i20;
                                            i16 = i24;
                                            fVar2 = fVar3;
                                            break;
                                    ...
                                    case 8:
                                        ...
                                        fVar3 = fVar;
                                        if (i36 == 2) {
                                            i27 = (536870912 & i38) == 0 ? b.c0(bArr2, i5, fVar3) : b.d0(bArr2, i5, fVar3);
                                            obj = fVar3.c;
                                            j5 = C;
                                    ...
                                    case 9:
                                        ...
                                        fVar3 = fVar;
                                        if (i36 == 2) {
                                            i27 = b.Q(v0Var3.p(i17), bArr2, i5, i26, fVar3);
                                    ...
                                    case 17:
                                        if (i36 == 3) {
                                            i17 = i6;
                                            i18 = i35;
                                            i27 = b.P(v0Var3.p(i6), bArr, i5, i3, (i35 << 3) | 4, fVar);
                                            if ((i33 & i20) == 0) {
                                                j7 = C;
                                                obj2 = fVar.c;
                                            } else {
                                ...
                                if (W != 27) {
                                    ...
                                    i27 = b.R(v0Var3.p(i17), i16, bArr, i5, i3, iVar, fVar);
                                } else {
                                    i19 = i5;
                                    i11 = i32;
                                    i9 = i33;
        ...
        s1 s1Var = null;
        for (int i42 = v0Var.f3630k; i42 < v0Var.f3631l; i42++) {
            s1Var = (s1) v0Var.m(t2, v0Var.f3629j[i42], s1Var, (r1<UT, UB>) v0Var.o);
        }
        if (s1Var != null) {
            v0Var.o.n(t2, s1Var);
        }
    ...
    public final int L(T t, byte[] bArr, int i2, int i3, f fVar) {
        ...
        while (i14 < i15) {
            ...
            if (i20 > i16) {
                int i22 = i17 / 3;
                if (i20 < v0Var.c || i20 > v0Var.f3623d) {
                    i4 = -1;
                    if (i4 != i13) {
                        i5 = i20;
                        i7 = i18;
                        ...
                        if (W <= 17) {
                            ...
                            switch (W) {
                                case 0:
                                    i9 = i4;
                                    if (i21 == 1) {
                                        v1.v(t2, C, Double.longBitsToDouble(b.O(bArr2, i18)));
                                        i14 = i18 + 8;
                                        i5 = i20;
                                        i17 = i9;
                                        break;
                                ...
                                case 1:
                                    i9 = i4;
                                    if (i21 == 5) {
                                        v1.f3634f.p(t2, C, Float.intBitsToFloat(b.N(bArr2, i18)));
                                        i14 = i18 + 4;
                                        i5 = i20;
                                        i17 = i9;
                                        break;
                                ...
                                case 14:
                                    if (i21 == 1) {
                                        i9 = i4;
                                        unsafe.putLong(t, C, b.O(bArr2, i18));
                                        i14 = i18 + 8;
                                        i5 = i20;
                                        i17 = i9;
                                        break;
                                ...
                                case 13:
                                    if (i21 == 5) {
                                        unsafe.putInt(t2, C, b.N(bArr2, i18));
                                        i14 = i18 + 4;
                                        i5 = i20;
                                        bArr2 = bArr2;
                                        i17 = i4;
                                ...
                                case 8:
                                    if (i21 == 2) {
                                        i14 = (536870912 & i23) == 0 ? b.c0(bArr2, i18, fVar2) : b.d0(bArr2, i18, fVar2);
                                        obj = fVar2.c;
                                ...
                                case 9:
                                    if (i21 == 2) {
                                        i14 = b.Q(v0Var.p(i4), bArr2, i18, i15, fVar2);
                            ...
                            if (i21 == 2) {
                                ...
                                i5 = i20;
                                i14 = b.R(v0Var.p(i4), i19, bArr, i18, i3, iVar, fVar);
                                bArr2 = bArr2;
                                i17 = i4;
                                i16 = i5;
                                i13 = -1;
                    ...
                    i6 = b.e0(i19, bArr, i7, i3, q(t), fVar);
                    v0Var = this;
                    t2 = t;
                    bArr2 = bArr;
                    i15 = i3;
        ...
        switch (i8) {
            ...
            case 35:
                ...
                if (i6 == 1) {
                    ...
                    long O = b.O(bArr, i2);
                    while (true) {
                        oVar.i(Double.longBitsToDouble(O));
                        int i15 = i13 + 8;
                        if (i15 >= i3) {
                            return i15;
                        }
                        i13 = b.g0(bArr3, i15, fVar);
                        if (i14 != fVar.a) {
                            return i15;
                        }
                        O = b.O(bArr3, i13);
            ...
            case 36:
                ...
                if (i6 == 5) {
                    ...
                    int N = b.N(bArr, i2);
                    while (true) {
                        xVar.i(Float.intBitsToFloat(N));
                        int i16 = i13 + 4;
                        if (i16 >= i3) {
                            return i16;
                        }
                        i13 = b.g0(bArr3, i16, fVar);
                        if (i14 != fVar.a) {
                            return i16;
                        }
                        N = b.N(bArr3, i13);
            ...
            case 38:
                ...
                if (i6 == 0) {
                    k0 k0Var = (k0) iVar;
                    do {
                        i0 = b.i0(bArr3, i13, fVar);
                        k0Var.i(fVar.b);
                        if (i0 >= i3) {
                            return i0;
                        }
                        i13 = b.g0(bArr3, i0, fVar);
                    } while (i14 == fVar.a);
                    return i0;
                }
                break;
            ...
            case 43:
                ...
                if (i6 == 0) {
                    return b.h0(i4, bArr, i2, i3, iVar, fVar);
                }
                break;
            case 23:
            case 32:
            ...
            case 42:
                if (i6 != 2) {
                    if (i6 == 0) {
                        h hVar = (h) iVar;
                        int i03 = b.i0(bArr3, i13, fVar);
                        break;
                    }
                } else {
                    return b.S(bArr3, i13, iVar, fVar);
                }
                break;
            case 26:
                if (i6 == 2) {
                    ...
                    if ((j2 & 536870912) == 0) {
                        ...
                        if (i19 >= 0) {
                            if (i19 != 0) {
                                ...
                                i13 += i19;
                                if (i13 < i3) {
                                    int g02 = b.g0(bArr3, i13, fVar);
                                    if (i14 == fVar.a) {
                                        i13 = b.g0(bArr3, g02, fVar);
                                        i19 = fVar.a;
                                        if (i19 >= 0) {
                                            if (i19 != 0) {
                        ...
                        if (i20 >= 0) {
                            if (i20 == 0) {
                                ...
                                iVar.add(str);
                                if (i10 < i3) {
                                    int g04 = b.g0(bArr2, i10, fVar);
                                    if (i9 != fVar.a) {
                                        return i10;
                                    }
                                    i10 = b.g0(bArr2, g04, fVar);
                                    int i21 = fVar.a;
                                    if (i21 >= 0) {
                                        if (i21 != 0) {
                                            i11 = i10 + i21;
                            ...
                            i11 = g03 + i20;
                            if (w1.h(bArr3, g03, i11)) {
                                str2 = new String(bArr3, g03, i20, c0.a);
                            } else {
                                throw d0.c();
                            }
                            iVar.add(str2);
            ...
            case 27:
                if (i6 == 2) {
                    return b.R(p(i7), i4, bArr, i2, i3, iVar, fVar);
                }
                break;
            case 28:
                if (i6 == 2) {
                    int g05 = b.g0(bArr3, i13, fVar);
                    int i22 = fVar.a;
                    if (i22 < 0) {
                        throw d0.f();
                    } else if (i22 > bArr3.length - g05) {
                        throw d0.h();
                    }
                }
                break;
            ...
            case 44:
                if (i6 == 2) {
                    i12 = b.Z(bArr3, i13, iVar, fVar);
                } else if (i6 == 0) {
                    i12 = b.h0(i4, bArr, i2, i3, iVar, fVar);
                }
                T t2 = t;
            ...
            case 47:
                ...
                if (i6 == 0) {
                    b0 b0Var2 = (b0) iVar;
                    do {
                        g0 = b.g0(bArr3, i13, fVar);
                        b0Var2.i(k.b(fVar.a));
                        if (g0 >= i3) {
                            return g0;
                        }
                        i13 = b.g0(bArr3, g0, fVar);
                    } while (i14 == fVar.a);
                    return g0;
                }
                break;
            ...
            case 48:
                ...
                if (i6 == 0) {
                    k0 k0Var3 = (k0) iVar;
                    do {
                        i02 = b.i0(bArr3, i13, fVar);
                        k0Var3.i(k.c(fVar.b));
                        if (i02 >= i3) {
                            return i02;
                        }
                        i13 = b.g0(bArr3, i02, fVar);
                    } while (i14 == fVar.a);
                    return i02;
                }
                break;
            case 49:
                if (i6 == 3) {
                    j1 p2 = p(i7);
                    int i23 = (i14 & -8) | 4;
                    i13 = b.P(p2, bArr, i2, i3, i23, fVar);
                    while (true) {
                        iVar.add(fVar.c);
                        if (i13 >= i3) {
                            break;
                        } else {
                            int g06 = b.g0(bArr3, i13, fVar);
                            if (i14 != fVar.a) {
                                break;
                            } else {
                                i13 = b.P(p2, bArr, g06, i3, i23, fVar);
                            }
                        }
                    }
                }
    ...
    public final void T(T t, int i2) {
        if (!this.f3627h) {
            ...
            v1.f3634f.q(t, j2, v1.n(t, j2) | (1 << (i3 >>> 20)));
        }
    }

    public final void U(T t, int i2, int i3) {
        v1.f3634f.q(t, (long) (this.a[i3 + 2] & 1048575), i2);
    }
            ...
            if (i2 < iArr.length) {
                ...
                switch (W(i3)) {
                    ...
                    case 50:
                        o0 o0Var = this.q;
                        Class<?> cls = l1.a;
                        v1.f3634f.s(t, C, o0Var.a(v1.p(t, C), v1.p(t2, C)));
                        break;
                    case 51:
                    case 52:
                    case 53:
    ...
    public final boolean b(T t) {
        ...
        while (true) {
            boolean z = true;
            if (i4 >= this.f3630k) {
                return !this.f3625f || this.p.c(t).j();
            }
            int i6 = this.f3629j[i4];
            int i7 = this.a[i6];
            int X = X(i6);
            if (!this.f3627h) {
                int i8 = this.a[i6 + 2];
    ...
    /*  JADX ERROR: StackOverflowError in pass: MarkFinallyVisitor
        ...
        */
    @Override // f.b.g.j1
    public void c(T r17, f.b.g.h1 r18, f.b.g.r r19) {
        /*
        // Method dump skipped, instructions count: 1436
        */
        throw new UnsupportedOperationException("Method not decompiled: f.b.g.v0.c(java.lang.Object, f.b.g.h1, f.b.g.r):void");
    }
    ...
    @Override // f.b.g.j1
    public int f(T t) {
        return this.f3627h ? s(t) : r(t);
    }

    @Override // f.b.g.j1
    public T g() {
        return (T) this.m.a(this.f3624e);
    }
    ...
    public void i(T t) {
        ...
        while (true) {
            ...
            long C = C(X(this.f3629j[i3]));
            Object p2 = v1.p(t, C);
            if (p2 != null) {
                v1.f3634f.s(t, C, this.q.g(p2));
            }
            i3++;
        }
        int length = this.f3629j.length;
        while (i2 < length) {
            this.n.a(t, (long) this.f3629j[i2]);
            i2++;
        }
        this.o.j(t);
        if (this.f3625f) {
    ...
    public int j(T t) {
        ...
        return this.f3625f ? (hashCode * 53) + this.p.c(t).hashCode() : hashCode;
    }
    ...
    public final int l(byte[] bArr, int i2, int i3, y1 y1Var, Class<?> cls, f fVar) {
        ...
        switch (y1Var.ordinal()) {
            ...
            case 7:
                ...
                return i4;
            case 8:
                return b.d0(bArr, i2, fVar);
            case 9:
            default:
                throw new RuntimeException("unsupported field type.");
            case 10:
                return b.Q(e1.c.a(cls), bArr, i2, i3, fVar);
            case 11:
                return b.L(bArr, i2, fVar);
            case 16:
                i4 = b.g0(bArr, i2, fVar);
                i5 = k.b(fVar.a);
                obj3 = Integer.valueOf(i5);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:101:0x01d0, code lost:
        if (r16.f3628i != false) goto L_0x0227;
     */
    ...
    public final int r(T t) {
        ...
        for (int i13 = 0; i13 < this.a.length; i13 += 3) {
            ...
            if (W <= 17) {
                ...
                i3 = (!this.f3628i || W < w.DOUBLE_LIST_PACKED.b || W > w.SINT64_LIST_PACKED.b) ? 0 : this.a[i13 + 2] & 1048575;
                i2 = 0;
            }
            long C = C(X);
            switch (W) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:101:0x01ce, code lost:
        if (r13.f3628i != false) goto L_0x0203;
     */
    ...
    public final boolean u(T t, int i2, int i3, int i4) {
        return this.f3627h ? t(t, i2) : (i3 & i4) != 0;
    }
    ...
    public final <K, V> void x(Object obj, int i2, Object obj2, r rVar, h1 h1Var) {
        ...
        if (p2 == null) {
            p2 = this.q.c(obj2);
            v1.f3634f.s(obj, C, p2);
        } else if (this.q.f(p2)) {
            Object c2 = this.q.c(obj2);
            this.q.a(c2, p2);
            v1.f3634f.s(obj, C, c2);
            p2 = c2;
        }
