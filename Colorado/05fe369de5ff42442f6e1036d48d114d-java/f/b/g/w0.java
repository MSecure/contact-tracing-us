...
public final class w0<T> implements j1<T> {
    ...
    public void a(T t, T t2) {
        ...
        if (this.c) {
            l1.B(this.f3653d, t, t2);
        }
    }

    @Override // f.b.g.j1
    public final boolean b(T t) {
        return this.f3653d.c(t).j();
    }

    @Override // f.b.g.j1
    public void c(T t, h1 h1Var, r rVar) {
        r1<UT, UB> r1Var = (r1<UT, UB>) this.b;
        s<ET> sVar = (s<ET>) this.f3653d;
        UB f2 = r1Var.f(t);
        v<ET> d2 = sVar.d(t);
        do {
            try {
    ...
    public boolean d(T t, T t2) {
        ...
        if (this.c) {
            return this.f3653d.c(t).equals(this.f3653d.c(t2));
        }
        return true;
    }
            ...
            if (i4 == 11) {
                ...
                while (g0 < i3) {
                    ...
                    if (i7 != 2) {
                        ...
                        g0 = b.g0(bArr, g0, fVar);
                        i5 = fVar.a;
                        eVar = (z.e) this.f3653d.b(fVar.f3543d, this.a, i5);
                    }
                    if (i6 == 12) {
                        break;
                    }
                    g0 = b.n1(i6, bArr, g0, i3, fVar);
                }
                if (jVar != null) {
                    s1Var.f((i5 << 3) | 2, jVar);
                }
                ...
                z.e eVar2 = (z.e) this.f3653d.b(fVar.f3543d, this.a, i4 >>> 3);
                if (eVar2 != null) {
                    i2 = b.Q(e1.c.a(eVar2.c.getClass()), bArr, g0, i3, fVar);
                    b2.o(eVar2.f3668d, fVar.c);
                } else {
                    i2 = b.e0(i4, bArr, g0, i3, s1Var, fVar);
                }
                eVar = eVar2;
            } else {
                i2 = b.n1(i4, bArr, g0, i3, fVar);
            }
        }
        if (i2 != i3) {
            throw d0.g();
    ...
    public void h(T t, a2 a2Var) {
        Iterator<Map.Entry<?, Object>> l2 = this.f3653d.c(t).l();
        while (l2.hasNext()) {
    ...
    public int j(T t) {
        ...
        return this.c ? (hashCode * 53) + this.f3653d.c(t).hashCode() : hashCode;
    }
