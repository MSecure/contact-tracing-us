...
public final class w1 {
    public static final a a = ((!(v1.f3636h && v1.f3635g) || d.a()) ? new b() : new d());
    ...
    public static final class d extends a {
        ...
        public int d(CharSequence charSequence, byte[] bArr, int i2, int i3) {
            ...
            if (length > i3 || bArr.length - i3 < i2) {
                StringBuilder i5 = f.a.a.a.a.i("Failed writing ");
                i5.append(charSequence.charAt(length - 1));
                i5.append(" at index ");
                i5.append(i2 + i3);
            ...
            while (true) {
                ...
                if (i6 < length && (charAt = charSequence.charAt(i6)) < 128) {
                    ...
                    while (i6 < length) {
                        ...
                        } else if (55296 > charAt2 || charAt2 > 57343 || ((i4 = i6 + 1) != length && Character.isSurrogatePair(charAt2, charSequence.charAt(i4)))) {
    ...
    public static int d(CharSequence charSequence) {
        ...
        StringBuilder i5 = f.a.a.a.a.i("UTF-8 length does not fit in int: ");
