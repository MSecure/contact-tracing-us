...
public final class a {
    ...
    public final List<f.d.a.d.b> f3685d = new ArrayList();
    ...
    public static final class b extends f implements j.k.a.b<String, String> {
        ...
        public String d(String str) {
            ...
            StringBuilder i2 = f.a.a.a.a.i(str2);
            i2.append(this.f3695d);
            return f.b.a.c.b.o.b.H0(context, i2.toString());
        }
    }
    ...
    public a(Context context, String[] strArr, Map<String, String> map) {
        ...
        while (it.hasNext()) {
            ...
            f.d.a.d.b bVar = null;
            try {
                String H0 = f.b.a.c.b.o.b.H0(context, "license_" + m + "_licenseDescription");
                if (h.o(H0, "raw:", false, 2)) {
                    Resources resources = context.getResources();
                    String l2 = h.l(H0, "raw:");
                    ...
                    g.b.a.c.c.c.c(bufferedReader, null);
                    str = stringWriter2;
                } else {
                    str = H0;
                }
                bVar = new f.d.a.d.b(m, f.b.a.c.b.o.b.H0(context, "license_" + m + "_licenseName"), f.b.a.c.b.o.b.H0(context, "license_" + m + "_licenseWebsite"), f.b.a.c.b.o.b.H0(context, "license_" + m + "_licenseShortDescription"), str);
            } catch (Exception e2) {
                String str4 = "Failed to generateLicense from file: " + e2;
            }
            if (bVar != null) {
                this.f3685d.add(bVar);
            }
            i2 = 4;
        }
        ...
        while (it2.hasNext()) {
            ...
            if (b3 != null) {
                ...
                if (!(str6 == null || (b2 = b(context, str6)) == null)) {
                    e.c(b2, "enchantWith");
                    String b4 = b3.b(b2.f3710e);
                    b3.f3710e = b4 == null ? b3.f3710e : b4;
                    String b5 = b3.b(b2.f3711f);
                    b3.f3711f = b5 == null ? b3.f3711f : b5;
                    String b6 = b3.b(b2.f3712g);
                    b3.f3712g = b6 == null ? b3.f3712g : b6;
                    String b7 = b3.b(b2.f3713h);
                    b3.f3713h = b7 == null ? b3.f3713h : b7;
                    String b8 = b3.b(b2.f3714i);
                    b3.f3714i = b8 == null ? b3.f3714i : b8;
                    String b9 = b3.b(b2.f3715j);
                    b3.f3715j = b9 == null ? b3.f3715j : b9;
                    String b10 = b3.b(b2.f3716k);
                    b3.f3716k = b10 == null ? b3.f3716k : b10;
                    Set<f.d.a.d.b> set = b2.f3717l;
                    b3.f3717l = set == null ? b3.f3717l : set;
                    b3.m = b2.m;
    ...
    public final List<f.d.a.d.a> a(List<f.d.a.d.a> list, String str, boolean z, int i2) {
        ...
        for (f.d.a.d.a aVar : list) {
            ...
            } else if (h.a(aVar.f3710e, str, true) || h.a(aVar.b, str, true)) {
                arrayList.add(aVar);
                i3++;
                if (i2 != -1 && i2 < i3) {
                    break;
    ...
    public final f.d.a.d.a b(Context context, String str) {
        ...
        try {
            f.d.a.d.a aVar = new f.d.a.d.a(m, false, false, f.b.a.c.b.o.b.H0(context, "library_" + m + "_libraryName"), null, null, null, null, null, null, null, false, null, null, 16374);
            HashMap<String, String> c2 = c(context, m);
            String H0 = f.b.a.c.b.o.b.H0(context, "library_" + m + "_author");
            e.c(H0, "<set-?>");
            aVar.f3711f = H0;
            String H02 = f.b.a.c.b.o.b.H0(context, "library_" + m + "_authorWebsite");
            e.c(H02, "<set-?>");
            aVar.f3712g = H02;
            String f2 = f(f.b.a.c.b.o.b.H0(context, "library_" + m + "_libraryDescription"), c2);
            e.c(f2, "<set-?>");
            aVar.f3713h = f2;
            String H03 = f.b.a.c.b.o.b.H0(context, "library_" + m + "_libraryVersion");
            e.c(H03, "<set-?>");
            aVar.f3714i = H03;
            String H04 = f.b.a.c.b.o.b.H0(context, "library_" + m + "_libraryArtifactId");
            e.c(H04, "<set-?>");
            aVar.f3715j = H04;
            String H05 = f.b.a.c.b.o.b.H0(context, "library_" + m + "_libraryWebsite");
            e.c(H05, "<set-?>");
            aVar.f3716k = H05;
            String H06 = f.b.a.c.b.o.b.H0(context, "library_" + m + "_licenseIds");
            String H07 = f.b.a.c.b.o.b.H0(context, "library_" + m + "_licenseId");
            if (!h.h(H06) || !h.h(H07)) {
                set = new LinkedHashSet<>();
                for (String str2 : h.h(H06) ? g.b.a.c.c.c.p(H07) : h.n(H06, new String[]{","}, false, 0, 6)) {
                    e.c(str2, "licenseName");
                    Iterator it = new ArrayList(this.f3685d).iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            bVar = null;
                            break;
                    ...
                    if (bVar != null) {
                        ...
                        String f3 = f(a2.f3718d, c2);
                        e.c(f3, "<set-?>");
                        a2.f3718d = f3;
                        String f4 = f(a2.f3719e, c2);
                        e.c(f4, "<set-?>");
                        a2.f3719e = f4;
                        set.add(a2);
                    }
                ...
                set = Collections.singleton(new f.d.a.d.b("", f.b.a.c.b.o.b.H0(context, "library_" + m + "_licenseVersion"), f.b.a.c.b.o.b.H0(context, "library_" + m + "_licenseLink"), f(f.b.a.c.b.o.b.H0(context, "library_" + m + "_licenseContent"), c2), f(f.b.a.c.b.o.b.H0(context, "library_" + m + "_licenseContent"), c2)));
                e.b(set, "java.util.Collections.singleton(element)");
            }
            aVar.f3717l = set;
            Boolean valueOf = Boolean.valueOf(f.b.a.c.b.o.b.H0(context, "library_" + m + "_isOpenSource"));
            e.b(valueOf, "java.lang.Boolean.valueO… name + \"_isOpenSource\"))");
            aVar.m = valueOf.booleanValue();
            String H08 = f.b.a.c.b.o.b.H0(context, "library_" + m + "_repositoryLink");
            e.c(H08, "<set-?>");
            aVar.n = H08;
            String H09 = f.b.a.c.b.o.b.H0(context, "library_" + m + "_classPath");
            e.c(H09, "<set-?>");
            aVar.o = H09;
            if (!h.h(aVar.f3710e) || !h.h(aVar.f3713h)) {
                return aVar;
            }
            return null;
        } catch (Exception e2) {
    ...
    public final HashMap<String, String> c(Context context, String str) {
        ...
        a.C0153a aVar3 = new a.C0153a(aVar2);
        String str2 = (String) (!aVar3.hasNext() ? null : aVar3.next());
        if (str2 == null) {
            str2 = "";
        }
        if (str2.length() > 0) {
            List<String> a2 = new j.n.c(";").a(str2, 0);
            if (!a2.isEmpty()) {
                ...
                while (true) {
                    ...
                    if (!z) {
                        collection = j.i.b.b(a2, listIterator.nextIndex() + 1);
                        break;
                    }
                }
                ...
                if (!(strArr.length != 0)) {
                    for (String str3 : strArr) {
                        String H0 = f.b.a.c.b.o.b.H0(context, "library_" + str + "_" + str3);
                        if (H0.length() > 0) {
                            hashMap.put(str3, H0);
                        }
                    }
    ...
    public final f.d.a.d.a e(String str) {
        ...
        while (it.hasNext()) {
            ...
            if (h.b(aVar.f3710e, str, true) || h.b(aVar.b, str, true)) {
                return aVar;
            }
            while (it.hasNext()) {
            }
    ...
    public final String f(String str, HashMap<String, String> hashMap) {
        ...
        for (Map.Entry<String, String> entry : hashMap.entrySet()) {
            ...
            if (value.length() > 0) {
                ...
                i2.append(upperCase);
                i2.append(">>>");
                str = h.m(str, i2.toString(), value, false, 4);
            }
        }
