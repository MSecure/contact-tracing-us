...
public class b<Item extends k<? extends RecyclerView.b0>> extends RecyclerView.e<RecyclerView.b0> {
    ...
    public n<m<?>> f3725d = new f.d.b.s.d();

    /* renamed from: e  reason: collision with root package name */
    public final SparseArray<c<Item>> f3726e = new SparseArray<>();

    /* renamed from: f  reason: collision with root package name */
    public int f3727f;

    /* renamed from: g  reason: collision with root package name */
    public List<f.d.b.r.c<? extends Item>> f3728g;

    /* renamed from: h  reason: collision with root package name */
    public final e.e.a<Class<?>, d<Item>> f3729h = new e.e.a<>();

    /* renamed from: i  reason: collision with root package name */
    public boolean f3730i = true;

    /* renamed from: j  reason: collision with root package name */
    public final o f3731j = new o("FastAdapter");

    /* renamed from: k  reason: collision with root package name */
    public g<Item> f3732k = new h();

    /* renamed from: l  reason: collision with root package name */
    public f.d.b.r.e f3733l = new f();
        ...
        public void c(View view, int i2, b<Item> bVar, Item item) {
            ...
            if (item.isEnabled() && (n = bVar.n(i2)) != null) {
                ...
                if (gVar2 == null || (b = gVar2.b()) == null || !b.a(view, n, item, Integer.valueOf(i2)).booleanValue()) {
                    Iterator it = ((g.e) bVar.f3729h.values()).iterator();
                    do {
                        aVar = (g.a) it;
                        if (!aVar.hasNext()) {
                            if (z) {
    ...
    public int c(int i2) {
        ...
        if (!this.f3725d.b(p2.h())) {
            j.k.b.e.c(p2, "item");
            if (p2 instanceof m) {
                int h2 = p2.h();
                m<?> mVar = (m) p2;
                j.k.b.e.c(mVar, "item");
                this.f3725d.a(h2, mVar);
            } else {
                m<?> a2 = p2.a();
                if (a2 != null) {
                    int h3 = p2.h();
    ...
    public void d(RecyclerView recyclerView) {
        ...
        Objects.requireNonNull(this.f3731j);
    ...
    public RecyclerView.b0 g(ViewGroup viewGroup, int i2) {
        ...
        m<?> mVar = this.f3725d.get(i2);
        RecyclerView.b0 a2 = this.f3732k.a(this, viewGroup, i2, mVar);
        ...
        return this.f3732k.b(this, a2, mVar);
    }
    ...
    public boolean i(RecyclerView.b0 b0Var) {
        j.k.b.e.c(b0Var, "holder");
        o oVar = this.f3731j;
        StringBuilder i2 = f.a.a.a.a.i("onFailedToRecycleView: ");
        i2.append(b0Var.f225f);
        String sb = i2.toString();
        Objects.requireNonNull(oVar);
        j.k.b.e.c(sb, "message");
        return this.f3733l.c(b0Var, b0Var.e());
    }
    ...
    public void j(RecyclerView.b0 b0Var) {
        j.k.b.e.c(b0Var, "holder");
        o oVar = this.f3731j;
        StringBuilder i2 = f.a.a.a.a.i("onViewAttachedToWindow: ");
        i2.append(b0Var.f225f);
        String sb = i2.toString();
        Objects.requireNonNull(oVar);
        j.k.b.e.c(sb, "message");
        this.f3733l.a(b0Var, b0Var.e());
    }
    ...
    public void k(RecyclerView.b0 b0Var) {
        j.k.b.e.c(b0Var, "holder");
        o oVar = this.f3731j;
        StringBuilder i2 = f.a.a.a.a.i("onViewDetachedFromWindow: ");
        i2.append(b0Var.f225f);
        String sb = i2.toString();
        Objects.requireNonNull(oVar);
        j.k.b.e.c(sb, "message");
        this.f3733l.e(b0Var, b0Var.e());
    }
    ...
    public void l(RecyclerView.b0 b0Var) {
        j.k.b.e.c(b0Var, "holder");
        o oVar = this.f3731j;
        StringBuilder i2 = f.a.a.a.a.i("onViewRecycled: ");
        i2.append(b0Var.f225f);
        String sb = i2.toString();
        Objects.requireNonNull(oVar);
        j.k.b.e.c(sb, "message");
        this.f3733l.d(b0Var, b0Var.e());
    }
    ...
    public final void m() {
        ...
        while (it.hasNext()) {
            c<Item> next = it.next();
            if (next.c() > 0) {
                this.f3726e.append(i2, next);
                i2 += next.c();
            }
        }
        if (i2 == 0 && this.c.size() > 0) {
            this.f3726e.append(0, this.c.get(0));
        }
        this.f3727f = i2;
    }

    public c<Item> n(int i2) {
        if (i2 < 0 || i2 >= this.f3727f) {
            return null;
        }
        Objects.requireNonNull(this.f3731j);
        j.k.b.e.c("getAdapter", "message");
        SparseArray<c<Item>> sparseArray = this.f3726e;
    ...
    public Item p(int i2) {
        ...
        int indexOfKey = this.f3726e.indexOfKey(i2);
        if (indexOfKey < 0) {
            indexOfKey = (~indexOfKey) - 1;
        }
        return this.f3726e.valueAt(indexOfKey).a(i2 - this.f3726e.keyAt(indexOfKey));
    }
    ...
    public void r() {
        Iterator it = ((g.e) this.f3729h.values()).iterator();
        while (true) {
            g.a aVar = (g.a) it;
            if (aVar.hasNext()) {
                ((d) aVar.next()).h();
