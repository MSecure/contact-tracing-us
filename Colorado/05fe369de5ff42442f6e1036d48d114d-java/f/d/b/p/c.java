...
public class c<Model, Item extends k<? extends RecyclerView.b0>> extends a<Item> implements Object<Model, Item> {
    ...
    public i<Item> f3734d;

    /* renamed from: e  reason: collision with root package name */
    public boolean f3735e;

    /* renamed from: f  reason: collision with root package name */
    public b<Model, Item> f3736f;

    /* renamed from: g  reason: collision with root package name */
    public final l<Item> f3737g;

    /* renamed from: h  reason: collision with root package name */
    public b<? super Model, ? extends Item> f3738h;
    ...
    public c(b<? super Model, ? extends Item> bVar) {
        ...
        this.f3734d = iVar;
        this.f3735e = true;
        this.f3736f = new b<>(this);
    }

    @Override // f.d.b.c
    public Item a(int i2) {
        Item item = this.f3737g.get(i2);
        if (item != null) {
            return item;
        }
    ...
    public c<Model, Item> d(List<? extends Model> list) {
        ...
        while (it.hasNext()) {
            k kVar = (k) this.f3738h.d(it.next());
            if (kVar != null) {
                arrayList.add(kVar);
            }
        }
        e.c(arrayList, "items");
        if (this.f3735e) {
            this.f3734d.a(arrayList);
        }
        f.d.b.b<Item> bVar = this.a;
        if (bVar != null) {
            this.f3737g.a(arrayList, bVar.q(this.b));
        } else {
            this.f3737g.a(arrayList, 0);
        }
        return this;
    }
