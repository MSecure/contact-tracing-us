...
public final class c implements Object<b.e> {
    ...
    public static c1 D(q qVar) {
        f.b.a.c.b.o.b.z(qVar, "context must not be null");
        if (!qVar.S()) {
            return null;
        }
        Throwable x = qVar.x();
        if (x == null) {
            return c1.f3768g.g("io.grpc.Context was cancelled without error");
        }
        if (x instanceof TimeoutException) {
            return c1.f3770i.g(x.getMessage()).f(x);
        }
        c1 d2 = c1.d(x);
        return (!c1.b.UNKNOWN.equals(d2.a) || d2.c != x) ? d2.f(x) : c1.f3768g.g("Context cancelled").f(x);
    }
    ...
    public static List<s2> E(List<Map<String, ?>> list) {
        ...
        for (Map<String, ?> map : list) {
            if (map.size() == 1) {
                ...
                StringBuilder i2 = a.i("There are ");
                i2.append(map.size());
    ...
    public static l1 f() {
        return l2.f3899e == null ? new l2() : new h();
    }
    ...
    public static Object m(Context context) {
        ...
        boolean z = application instanceof g.b.b.b;
        Object[] objArr = {application.getClass()};
        if (z) {
            return ((g.b.b.b) application).e();
        }
    ...
    public static Set<c1.b> n(Map<String, ?> map, String str) {
        ...
        for (Object obj : b) {
            if (obj instanceof Double) {
                ...
                boolean z = true;
                f.b.a.c.b.o.b.t1(((double) intValue) == d2.doubleValue(), "Status code %s is not integral", obj);
                bVar = c1.c(intValue).a;
                if (bVar.b != d2.intValue()) {
                    z = false;
                }
                f.b.a.c.b.o.b.t1(z, "Status code %s is not valid", obj);
