...
public final class g1 implements Executor {
    ...
    public final AtomicReference<Thread> f3787d = new AtomicReference<>();
    ...
    public final void a() {
        while (this.f3787d.compareAndSet(null, Thread.currentThread())) {
            while (true) {
                try {
    ...
    public void d() {
        f.b.a.c.b.o.b.F(Thread.currentThread() == this.f3787d.get(), "Not called from the SynchronizationContext");
    }
