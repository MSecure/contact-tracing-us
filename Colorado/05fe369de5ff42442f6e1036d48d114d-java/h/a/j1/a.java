...
public abstract class a extends d implements u, a2.d {
    ...
    public static final Logger f3796f = Logger.getLogger(a.class.getName());
    public final c3 a;
    public final o0 b;
    public boolean c;
    ...
    public class C0144a implements o0 {
        public n0 a;
        public boolean b;
        public final w2 c;
        ...
        public C0144a(n0 n0Var, w2 w2Var) {
        ...
        public void close() {
            ...
            f.b.a.c.b.o.b.F(z, "Lack of request message. GET request is only supported for unary requests");
            ((f.a) a.this.o()).a(this.a, this.f3799d);
            this.f3799d = null;
            this.a = null;
        }
        ...
        public void d(InputStream inputStream) {
            f.b.a.c.b.o.b.F(this.f3799d == null, "writePayload should not be called multiple times");
            try {
                this.f3799d = f.b.b.c.b.b(inputStream);
                for (f1 f1Var : this.c.a) {
                    Objects.requireNonNull(f1Var);
                }
                w2 w2Var = this.c;
                int length = this.f3799d.length;
                for (f1 f1Var2 : w2Var.a) {
                    Objects.requireNonNull(f1Var2);
                }
                w2 w2Var2 = this.c;
                int length2 = this.f3799d.length;
                for (f1 f1Var3 : w2Var2.a) {
                    Objects.requireNonNull(f1Var3);
                }
                w2 w2Var3 = this.c;
                long length3 = (long) this.f3799d.length;
    ...
    public static abstract class c extends d.a {
        ...
        public class RunnableC0145a implements Runnable {
            ...
            /* renamed from: d  reason: collision with root package name */
            public final /* synthetic */ n0 f3806d;

            public RunnableC0145a(c1 c1Var, v.a aVar, n0 n0Var) {
                this.b = c1Var;
                this.c = aVar;
                this.f3806d = n0Var;
            }
            ...
            public void run() {
                c.this.g(this.b, this.c, this.f3806d);
            }
        }
        ...
        public final void g(c1 c1Var, v.a aVar, n0 n0Var) {
            if (!this.f3802i) {
                this.f3802i = true;
                w2 w2Var = this.f3801h;
                if (w2Var.b.compareAndSet(false, true)) {
                    for (f1 f1Var : w2Var.a) {
                        Objects.requireNonNull(f1Var);
                    }
                }
                this.f3803j.d(c1Var, aVar, n0Var);
                c3 c3Var = this.f3838d;
                if (c3Var == null) {
                    return;
                }
                if (c1Var.e()) {
        ...
        public void h(n0 n0Var) {
            ...
            boolean z;
            String str;
            f.b.a.c.b.o.b.F(!this.p, "Received headers on closed stream");
            for (f1 f1Var : this.f3801h.a) {
                Objects.requireNonNull((j) f1Var);
            }
            String str2 = (String) n0Var.d(q0.f3968e);
            if (this.f3804k && str2 != null) {
                if (str2.equalsIgnoreCase("gzip")) {
                    ...
                    if (str != null) {
                        t.a aVar = this.f3805l.a.get(str);
        ...
        public final void i(c1 c1Var, v.a aVar, boolean z, n0 n0Var) {
            ...
            if (!this.p || z) {
                ...
                this.n = new RunnableC0145a(c1Var, aVar, n0Var);
                c0 c0Var = this.b;
                if (z) {
                    c0Var.close();
                } else {
    ...
    public a(e3 e3Var, w2 w2Var, c3 c3Var, n0 n0Var, h.a.c cVar, boolean z) {
        ...
        this.a = c3Var;
        this.c = !Boolean.TRUE.equals(cVar.a(q0.f3975l));
        this.f3797d = z;
        if (!z) {
    ...
    public void e(r rVar) {
        ...
        n0.f<Long> fVar = q0.b;
        n0Var.b(fVar);
        this.f3798e.h(fVar, Long.valueOf(Math.max(0L, rVar.e(TimeUnit.NANOSECONDS))));
    }

    @Override // h.a.j1.u
    public final void f(t tVar) {
        c p = p();
        f.b.a.c.b.o.b.F(p.f3803j == null, "Already called start");
    ...
    public final void i(v vVar) {
        c p = p();
        f.b.a.c.b.o.b.F(p.f3803j == null, "Already called setListener");
        f.b.a.c.b.o.b.z(vVar, "listener");
        p.f3803j = vVar;
        if (!this.f3797d) {
            ((f.a) o()).a(this.f3798e, null);
            this.f3798e = null;
        }
    }
