...
public final class d0 implements y1 {
    ...
    public final g1 f3842d;

    /* renamed from: e  reason: collision with root package name */
    public Runnable f3843e;

    /* renamed from: f  reason: collision with root package name */
    public Runnable f3844f;

    /* renamed from: g  reason: collision with root package name */
    public Runnable f3845g;

    /* renamed from: h  reason: collision with root package name */
    public y1.a f3846h;

    /* renamed from: i  reason: collision with root package name */
    public Collection<f> f3847i = new LinkedHashSet();
    ...
    public class f extends e0 {
        ...
        /* renamed from: i  reason: collision with root package name */
        public final h0.f f3851i;

        /* renamed from: j  reason: collision with root package name */
        public final q f3852j = q.L();
        ...
        public void g(c1 c1Var) {
            ...
            synchronized (d0.this.b) {
                d0 d0Var = d0.this;
                if (d0Var.f3845g != null) {
                    boolean remove = d0Var.f3847i.remove(this);
                    if (!d0.this.h() && remove) {
                        d0 d0Var2 = d0.this;
                        d0Var2.f3842d.b(d0Var2.f3844f);
                        d0 d0Var3 = d0.this;
                        if (d0Var3.f3848j != null) {
                            d0Var3.f3842d.b(d0Var3.f3845g);
                            d0.this.f3845g = null;
                        }
                    }
                }
    ...
    public final void a(c1 c1Var) {
        ...
        d(c1Var);
        synchronized (this.b) {
            collection = this.f3847i;
            runnable = this.f3845g;
            this.f3845g = null;
            if (!collection.isEmpty()) {
                this.f3847i = Collections.emptyList();
            }
        }
        if (runnable != null) {
    ...
    public final f b(h0.f fVar) {
        ...
        this.f3847i.add(fVar2);
        synchronized (this.b) {
            size = this.f3847i.size();
        }
        if (size == 1) {
            this.f3842d.b(this.f3843e);
        }
        return fVar2;
    }
    ...
    public final void d(c1 c1Var) {
        ...
        synchronized (this.b) {
            if (this.f3848j == null) {
                ...
                queue.add(dVar);
                if (!h() && (runnable = this.f3845g) != null) {
                    this.f3842d.b(runnable);
                    this.f3845g = null;
                }
                this.f3842d.a();
            }
    ...
    public final Runnable e(y1.a aVar) {
        this.f3846h = aVar;
        this.f3843e = new a(this, aVar);
        this.f3844f = new b(this, aVar);
        this.f3845g = new c(this, aVar);
        return null;
    }
    ...
    public final u g(o0<?, ?> o0Var, n0 n0Var, h.a.c cVar) {
        ...
        try {
            ...
            while (true) {
                synchronized (this.b) {
                    c1 c1Var = this.f3848j;
                    if (c1Var == null) {
                        h0.i iVar2 = this.f3849k;
                        if (iVar2 != null) {
                            if (iVar != null && j2 == this.f3850l) {
                                break;
                            }
                            j2 = this.f3850l;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0067, code lost:
        r6.f3847i.removeAll(r0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0072, code lost:
        if (r6.f3847i.isEmpty() == false) goto L_0x007b;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0074, code lost:
        r6.f3847i = new java.util.LinkedHashSet();
     */
    ...
    public final void i(h0.i iVar) {
        synchronized (this.b) {
            ...
            if (iVar != null) {
                if (h()) {
                    ArrayList arrayList = new ArrayList(this.f3847i);
                }
            }
        }
    }
