...
public final class p<ReqT, RespT> extends f<ReqT, RespT> {
    ...
    public final m f3951d;

    /* renamed from: e  reason: collision with root package name */
    public final q f3952e;

    /* renamed from: f  reason: collision with root package name */
    public final boolean f3953f;

    /* renamed from: g  reason: collision with root package name */
    public final h.a.c f3954g;
            ...
            public final void b() {
                ...
                if (!bVar.b) {
                    try {
                        ...
                        c1 g2 = c1.f3768g.f(th).g("Failed to read headers");
                        p.this.f3956i.g(g2);
                    ...
                    while (true) {
                        try {
                            ...
                            if (next2 != null) {
                                try {
                                    b bVar = b.this;
                                    bVar.a.c(p.this.a.f4209e.a(next2));
                                    next2.close();
                                } catch (Throwable th) {
                                    q0.b(next2);
                                    throw th;
                            ...
                            while (true) {
                                ...
                                if (next3 != null) {
                                    ...
                                    c1 g2 = c1.f3768g.f(th2).g("Failed to read message.");
                                    p.this.f3956i.g(g2);
                                    b.f(b.this, g2, new n0());
                                    return;
                                }
        ...
        public final class c extends b0 {
            ...
            public final void b() {
                try {
                    ...
                    c1 g2 = c1.f3768g.f(th).g("Failed to call onReady.");
                    p.this.f3956i.g(g2);
                    b.f(b.this, g2, new n0());
                }
            }
    ...
    public final class d implements q.b {
        ...
        public void a(q qVar) {
            if (qVar.R() == null || !qVar.R().c()) {
                p.this.f3956i.g(g.b.a.c.c.c.D(qVar));
                return;
            }
            p.e(p.this, g.b.a.c.c.c.D(qVar), this.a);
        }
    }
    ...
    public p(o0<ReqT, RespT> o0Var, Executor executor, h.a.c cVar, c cVar2, ScheduledExecutorService scheduledExecutorService, m mVar, boolean z) {
        ...
        this.f3952e = q.L();
        o0.c cVar3 = o0Var.a;
        this.f3953f = (cVar3 == o0.c.UNARY || cVar3 == o0.c.SERVER_STREAMING) ? true : z2;
        this.f3954g = cVar;
        this.f3959l = cVar2;
    ...
    public void a() {
        ...
        Objects.requireNonNull(aVar);
        try {
            f.b.a.c.b.o.b.F(this.f3956i != null, "Not started");
            f.b.a.c.b.o.b.F(true, "call was cancelled");
            f.b.a.c.b.o.b.F(!this.f3958k, "call already half-closed");
            this.f3958k = true;
            this.f3956i.l();
            Objects.requireNonNull(aVar);
        } catch (Throwable th) {
    ...
    public final void h(ReqT reqt) {
        f.b.a.c.b.o.b.F(this.f3956i != null, "Not started");
        f.b.a.c.b.o.b.F(true, "call was cancelled");
        f.b.a.c.b.o.b.F(!this.f3958k, "call was half-closed");
        try {
            u uVar = this.f3956i;
            if (uVar instanceof n2) {
                ((n2) uVar).y(reqt);
            } else {
                uVar.h(this.a.f4208d.b(reqt));
            }
            if (!this.f3953f) {
                this.f3956i.flush();
            }
        } catch (RuntimeException e2) {
            this.f3956i.g(c1.f3768g.f(e2).g("Failed to stream message"));
        } catch (Error e3) {
            this.f3956i.g(c1.f3768g.g("Client sendMessage() failed with Error"));
            throw e3;
        }
    }
    ...
    public final void i(f.a<RespT> aVar, n0 n0Var) {
        ...
        Executor executor;
        q qVar;
        f.b.a.c.b.o.b.F(this.f3956i == null, "Already started");
        f.b.a.c.b.o.b.F(true, "call was cancelled");
        f.b.a.c.b.o.b.z(aVar, "observer");
        f.b.a.c.b.o.b.z(n0Var, "headers");
        if (this.f3952e.S()) {
            this.f3956i = c2.a;
            c1 D = g.b.a.c.c.c.D(this.f3952e);
            executor = this.c;
            qVar = new q(this, aVar, D);
        } else {
            String str = this.f3954g.f3759e;
            if (str != null) {
            ...
            if (!(f2 != null && f2.c())) {
                ...
                if (this.f3955h) {
                    ...
                    h.a.c cVar2 = this.f3954g;
                    q qVar2 = this.f3952e;
                    m1.h hVar = (m1.h) cVar;
                    Objects.requireNonNull(m1.this);
                    f.b.a.c.b.o.b.F(false, "retry should be enabled");
                    this.f3956i = new r1(hVar, o0Var, n0Var, cVar2, m1.this.Q.b.c, qVar2);
                } else {
                    w a2 = ((m1.h) this.f3959l).a(new h2(this.a, n0Var, this.f3954g));
                    q d2 = this.f3952e.d();
                    try {
                        this.f3956i = a2.g(this.a, n0Var, this.f3954g);
                    } finally {
                        this.f3952e.Q(d2);
                    }
                }
                ...
                c1 c1Var = c1.f3770i;
                this.f3956i = new i0(c1Var.g("ClientCall started after deadline exceeded: " + f2));
            }
            String str2 = this.f3954g.c;
            if (str2 != null) {
                this.f3956i.j(str2);
            }
            Integer num = this.f3954g.f3763i;
            if (num != null) {
                this.f3956i.d(num.intValue());
            }
            Integer num2 = this.f3954g.f3764j;
            if (num2 != null) {
                this.f3956i.a(num2.intValue());
            }
            if (f2 != null) {
                this.f3956i.e(f2);
            }
            ...
            this.f3956i.f(this.p);
            m mVar = this.f3951d;
            mVar.b.a(1);
            mVar.a.a();
            this.m = new d(aVar, null);
            this.f3956i.i(new b(aVar));
            this.f3952e.c(this.m, f.b.b.f.a.k.INSTANCE);
            if (f2 != null && !f2.equals(this.f3952e.R()) && this.n != null && !(this.f3956i instanceof i0)) {
