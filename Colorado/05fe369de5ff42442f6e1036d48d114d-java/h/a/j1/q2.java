...
public final class q2 implements Executor, Runnable {
    ...
    public static final Logger f3985e = Logger.getLogger(q2.class.getName());

    /* renamed from: f  reason: collision with root package name */
    public static final b f3986f;
    public final Executor b;
    public final Queue<Runnable> c = new ConcurrentLinkedQueue();

    /* renamed from: d  reason: collision with root package name */
    private volatile int f3987d = 0;
    ...
    static {
        ...
        try {
            ...
            f3985e.log(Level.SEVERE, "FieldUpdaterAtomicHelper failed", th);
            bVar = new d(null);
        }
        f3986f = bVar;
    }
    ...
    public q2(Executor executor) {
        f.b.a.c.b.o.b.z(executor, "'executor' must not be null.");
        this.b = executor;
    }

    public final void c(Runnable runnable) {
        if (f3986f.a(this, 0, -1)) {
            try {
                this.b.execute(this);
            } catch (Throwable th) {
                if (runnable != null) {
    ...
    public void execute(Runnable runnable) {
        ...
        f.b.a.c.b.o.b.z(runnable, "'r' must not be null.");
        queue.add(runnable);
        c(runnable);
    }
