...
public abstract class t0 extends a.c {
    ...
    public class a implements e0.a<Integer> {
        ...
        public Object b(byte[] bArr) {
            ...
            StringBuilder i3 = f.a.a.a.a.i("Malformed status code ");
            i3.append(new String(bArr, e0.a));
            throw new NumberFormatException(i3.toString());
        }
    }
    ...
    public static Charset j(n0 n0Var) {
        String str = (String) n0Var.d(q0.f3970g);
        if (str != null) {
