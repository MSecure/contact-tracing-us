...
public final class z0 implements c0<Object>, b3 {
    ...
    public final a0 f4038h;

    /* renamed from: i  reason: collision with root package name */
    public final m f4039i;

    /* renamed from: j  reason: collision with root package name */
    public final h.a.e f4040j;

    /* renamed from: k  reason: collision with root package name */
    public final g1 f4041k;
    ...
    public class b implements Runnable {
        ...
        public void run() {
            if (z0.this.u.a == n.IDLE) {
                z0.this.f4040j.a(e.a.INFO, "CONNECTING as requested");
    ...
    public class g implements y1.a {
                ...
                if (z0.this.u.a != n.SHUTDOWN) {
                    ...
                    if (z0Var.s == zVar) {
                        ...
                        if (!(fVar2.b < fVar2.a.size())) {
                            ...
                            if (z0Var3.n == null) {
                                Objects.requireNonNull((h0.a) z0Var3.f4034d);
                                z0Var3.n = new h0();
                            }
                            ...
                            z0Var3.f4040j.b(e.a.INFO, "TRANSIENT_FAILURE ({0}). Will reconnect after {1} ns", z0Var3.k(c1Var), Long.valueOf(a2));
                            if (z0Var3.p != null) {
                                z = false;
                            }
                            f.b.a.c.b.o.b.F(z, "previous reconnectTask is not done");
                            z0Var3.p = z0Var3.f4041k.c(new a1(z0Var3), a2, timeUnit, z0Var3.f4037g);
                            return;
                        }
                        z0.i(z0.this);
                    }
        ...
        public void a() {
            ...
            z0.this.f4040j.b(e.a.INFO, "{0} Terminated", this.a.c());
            a0 a0Var = z0.this.f4038h;
            a0.b(a0Var.c, this.a);
            z0 z0Var = z0.this;
            z zVar = this.a;
            g1 g1Var = z0Var.f4041k;
        ...
        @Override // h.a.j1.y1.a
        public void b() {
            z0.this.f4040j.a(e.a.INFO, "READY");
            g1 g1Var = z0.this.f4041k;
            a aVar = new a();
            Queue<Runnable> queue = g1Var.c;
        ...
        public void d(c1 c1Var) {
            z0.this.f4040j.b(e.a.INFO, "{0} SHUTDOWN with {1}", this.a.c(), z0.this.k(c1Var));
            this.b = true;
            g1 g1Var = z0.this.f4041k;
            b bVar = new b(c1Var);
            Queue<Runnable> queue = g1Var.c;
    ...
    public z0(List<h.a.v> list, String str, String str2, j.a aVar, x xVar, ScheduledExecutorService scheduledExecutorService, u<s> uVar, g1 g1Var, e eVar, a0 a0Var, m mVar, o oVar, d0 d0Var, h.a.e eVar2) {
        ...
        this.f4042l = new f(unmodifiableList);
        this.b = str;
        this.c = str2;
        this.f4034d = aVar;
        this.f4036f = xVar;
    ...
    public static void i(z0 z0Var) {
        ...
        SocketAddress a2 = z0Var.f4042l.a();
        if (a2 instanceof z) {
            zVar = (z) a2;
        ...
        f fVar2 = z0Var.f4042l;
        h.a.a aVar = fVar2.a.get(fVar2.b).b;
        String str = (String) aVar.a.get(h.a.v.f4240d);
        x.a aVar2 = new x.a();
        if (str == null) {
            str = z0Var.b;
        }
        ...
        h hVar = new h();
        hVar.a = z0Var.a;
        d dVar = new d(z0Var.f4036f.f(socketAddress, aVar2, hVar), z0Var.f4039i, null);
        hVar.a = dVar.c();
        a0.a(z0Var.f4038h.c, dVar);
        z0Var.s = dVar;
        z0Var.q.add(dVar);
        Runnable e2 = dVar.b().e(new g(dVar, socketAddress));
        if (e2 != null) {
            Queue<Runnable> queue = z0Var.f4041k.c;
            f.b.a.c.b.o.b.z(e2, "runnable is null");
            queue.add(e2);
        }
        z0Var.f4040j.b(e.a.INFO, "Started transport {0}", hVar.a);
    }
