...
public class n {
    ...
    public final a f4113d = new a(0, 65535);
    ...
    public final class a {
        ...
        public int a(int i2) {
            ...
            StringBuilder i4 = f.a.a.a.a.i("Window size overflow for stream: ");
            i4.append(this.b);
            throw new IllegalArgumentException(i4.toString());
        }

        public int b() {
            return Math.max(0, Math.min(this.c, (int) this.a.c)) - this.f4114d;
        }

        public int c() {
            return Math.min(this.c, n.this.f4113d.c);
        }
        ...
        public void d(e eVar, int i2, boolean z) {
            do {
                ...
                try {
                    ...
                    f.b bVar = this.f4115e.m;
                    synchronized (bVar.c) {
                        b.F(bVar.f3840f, "onStreamAllocated was not called, but it seems the stream is active");
                        int i4 = bVar.f3839e;
                        boolean z3 = i4 < 32768;
                        int i5 = i4 - min;
                        bVar.f3839e = i5;
    ...
    public boolean c(int i2) {
        if (i2 >= 0) {
            ...
            f[] l2 = this.a.l();
            for (f fVar : l2) {
                a aVar = (a) fVar.f4084k;
                if (aVar == null) {
                    fVar.f4084k = new a(this, fVar, this.c);
                } else {
                    aVar.a(i3);
                }
            }
        ...
        throw new IllegalArgumentException(f.a.a.a.a.v("Invalid initial window size: ", i2));
    }
