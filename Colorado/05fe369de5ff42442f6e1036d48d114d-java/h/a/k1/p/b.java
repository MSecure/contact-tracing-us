...
public final class b {
    ...
    public static final a[] f4127e;

    /* renamed from: f  reason: collision with root package name */
    public static final b f4128f;
    ...
    public b(C0150b bVar, a aVar) {
        this.a = bVar.a;
        this.b = bVar.b;
        this.c = bVar.c;
        this.f4129d = bVar.f4130d;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return !z || (Arrays.equals(this.b, bVar.b) && Arrays.equals(this.c, bVar.c) && this.f4129d == bVar.f4129d);
    }

    public int hashCode() {
        if (this.a) {
            return ((((527 + Arrays.hashCode(this.b)) * 31) + Arrays.hashCode(this.c)) * 31) + (!this.f4129d ? 1 : 0);
        }
        return 17;
    }
    ...
    public String toString() {
        ...
        if (strArr == null) {
            ...
            while (true) {
                ...
                if (str2.startsWith("SSL_")) {
                    StringBuilder i4 = f.a.a.a.a.i("TLS_");
                    i4.append(str2.substring(4));
                    str2 = i4.toString();
                }
        ...
        StringBuilder k2 = f.a.a.a.a.k("ConnectionSpec(cipherSuites=", str, ", tlsVersions=");
        ...
        while (true) {
            ...
            if (i2 < strArr4.length) {
                ...
                if ("TLSv1.2".equals(str3)) {
                    ...
                    throw new IllegalArgumentException(f.a.a.a.a.c("Unexpected TLS version: ", str3));
                }
                kVarArr[i2] = kVar;
                i2++;
            } else {
