...
public final class f implements i {
        ...
        public long m(e eVar, long j2) {
            ...
            do {
                ...
                if (i3 == 0) {
                    ...
                    this.f4180d = (byte) (this.b.readByte() & 255);
                    Logger logger = f.a;
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine(b.a(true, this.f4181e, this.c, readByte, this.f4180d));
                    }
    ...
    public static final class b {
        ...
        static {
            ...
            for (int i4 = 0; i4 < 1; i4++) {
                int i5 = iArr[i4];
                String[] strArr3 = b;
                strArr3[i5 | 8] = f.a.a.a.a.f(new StringBuilder(), strArr3[i5], "|PADDED");
            }
            String[] strArr4 = b;
            ...
            for (int i6 = 0; i6 < 3; i6++) {
                ...
                for (int i8 = 0; i8 < 1; i8++) {
                    ...
                    sb.append('|');
                    strArr5[i10 | 8] = f.a.a.a.a.f(sb, strArr5[i7], "|PADDED");
                }
            }
            while (true) {
                String[] strArr6 = b;
    ...
    public static final class c implements b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final e.a f4184d;

        public c(g gVar, int i2, boolean z) {
            this.b = gVar;
            a aVar = new a(gVar);
            this.c = aVar;
            this.f4184d = new e.a(i2, aVar);
        }
        ...
        public final void J(b.a aVar, int i2, int i3) {
            if (i2 != 4) {
                ...
                if (a != null) {
                    ...
                    synchronized (h.a.k1.g.this.f4092j) {
            ...
            if (i3 != 0) {
                ...
                while (true) {
                    ...
                    if (i4 < i2) {
                        ...
                        synchronized (h.a.k1.g.this.f4092j) {
                            if (hVar.a(4)) {
                                h.a.k1.g.this.B = hVar.f4190d[4];
                            }
                            boolean c2 = hVar.a(7) ? h.a.k1.g.this.f4091i.c(hVar.f4190d[7]) : false;
                            if (eVar.f4097d) {
                                h.a.k1.g.this.f4089g.b();
                                eVar.f4097d = false;
                            }
                            h.a.k1.g.this.f4090h.e(hVar);
                            if (c2) {
                                h.a.k1.g.this.f4091i.f();
                            }
                            h.a.k1.g.this.w();
                        }
                        int i5 = hVar.a & 2;
                        int i6 = -1;
                        if ((i5 != 0 ? hVar.f4190d[1] : -1) >= 0) {
                            e.a aVar2 = this.f4184d;
                            if (i5 != 0) {
                                i6 = hVar.f4190d[1];
                            }
                            aVar2.c = i6;
                ...
                if (i4 != 0) {
                    ...
                    if (i4 == 0) {
                        ...
                        if (i3 != 0) {
                            ...
                            synchronized (gVar.f4092j) {
                                h.a.k1.f remove = gVar.m.remove(Integer.valueOf(i3));
                                if (remove != null) {
                                    gVar.f4090h.O(i3, a.CANCEL);
                        ...
                        synchronized (h.a.k1.g.this.f4092j) {
                            if (i3 == 0) {
                                h.a.k1.g.this.f4091i.e(null, (int) readInt);
                                return;
                            }
                            h.a.k1.f fVar = h.a.k1.g.this.m.get(Integer.valueOf(i3));
                            if (fVar != null) {
                                h.a.k1.g.this.f4091i.e(fVar, (int) readInt);
                ...
                switch (readByte) {
                    case 0:
                        ...
                        if (!((readByte2 & 32) != 0)) {
                            ...
                            k.g gVar = this.b;
                            g.e eVar = (g.e) aVar;
                            eVar.b.b(aVar4, readInt, gVar.l(), c2, z2);
                            ...
                            if (p != null) {
                                ...
                                synchronized (h.a.k1.g.this.f4092j) {
                                    h.a.k1.g.this.f4090h.O(readInt, aVar2);
                                }
                                gVar.skip((long) c2);
                            } else {
                            ...
                            int i2 = gVar2.q + c2;
                            gVar2.q = i2;
                            if (((float) i2) >= ((float) gVar2.f4088f) * 0.5f) {
                                synchronized (gVar2.f4092j) {
                                    h.a.k1.g gVar3 = h.a.k1.g.this;
                                    gVar3.f4090h.s(0, (long) gVar3.q);
                                }
                                h.a.k1.g.this.q = 0;
                            }
                            this.b.skip((long) readByte3);
                    ...
                    case 1:
                        if (readInt != 0) {
                            ...
                            List<d> d2 = d(f.c(b2, readByte2, readByte4), readByte4, readByte2, readInt);
                            g.e eVar4 = (g.e) aVar;
                            ...
                            synchronized (h.a.k1.g.this.f4092j) {
                                ...
                                if (fVar == null) {
                                    ...
                                    if (!z3) {
                                        h.a.k1.g.this.f4090h.O(readInt, a.CANCEL);
                                    }
                    ...
                    case 3:
                        ...
                        return true;
                    case 4:
                        L(aVar, b2, readByte2, readInt);
                        return true;
                    case 5:
                        x(aVar, b2, readByte2, readInt);
                        return true;
                    case 6:
                        t(aVar, b2, readByte2, readInt);
                        return true;
                    case 7:
                        if (b2 < 8) {
        ...
        public final void t(b.a aVar, int i2, byte b2, int i3) {
            ...
            if (i2 != 8) {
                ...
                if (!z) {
                    synchronized (h.a.k1.g.this.f4092j) {
                        h.a.k1.g.this.f4090h.z(true, readInt, readInt2);
                    }
                    return;
                }
                synchronized (h.a.k1.g.this.f4092j) {
        ...
        public final void x(b.a aVar, int i2, byte b2, int i3) {
            ...
            if (i3 != 0) {
                ...
                synchronized (h.a.k1.g.this.f4092j) {
                    h.a.k1.g.this.f4090h.O(i3, a.PROTOCOL_ERROR);
                }
                return;
            }
    ...
    public static final class d implements c {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final k.e f4185d;

        /* renamed from: e  reason: collision with root package name */
        public final e.b f4186e;

        /* renamed from: f  reason: collision with root package name */
        public int f4187f = 16384;
        ...
        public void d(boolean z, int i2, List<d> list) {
            ...
            if (!this.f4188g) {
                ...
                while (true) {
                        ...
                        while (true) {
                            ...
                            if (dVarArr2[i7].a.equals(n)) {
                                if (bVar.c[i7].b.equals(hVar)) {
                                    i4 = e.b.length + (i7 - bVar.f4178e);
                                    break;
                                } else if (i3 == -1) {
                                    i3 = (i7 - bVar.f4178e) + e.b.length;
                                }
                            }
                            i6 = 1;
                        }
                    ...
                    if (i4 != -1) {
                        ...
                        if (i3 == -1) {
                            ...
                            if (!n.h(0, hVar2, 0, hVar2.l()) || d.f4171h.equals(n)) {
                                bVar.c(i3, 63, 64);
                            } else {
                                bVar.c(i3, 15, 0);
                                bVar.b(hVar);
                ...
                long j2 = this.f4185d.c;
                int min = (int) Math.min((long) this.f4187f, j2);
                long j3 = (long) min;
                ...
                c(i2, min, (byte) 1, b2);
                this.b.h(this.f4185d, j3);
                if (i8 > 0) {
                    long j4 = j2 - j3;
                    while (j4 > 0) {
                        int min2 = (int) Math.min((long) this.f4187f, j4);
                        long j5 = (long) min2;
                        j4 -= j5;
                        c(i2, min2, (byte) 9, j4 == 0 ? (byte) 4 : 0);
                        this.b.h(this.f4185d, j5);
                    }
                    return;
                }
                return;
