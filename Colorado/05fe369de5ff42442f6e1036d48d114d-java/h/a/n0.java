...
public final class n0 {
    ...
    public static final f.b.b.c.a f4198d;
    public Object[] a;
    public int b;
    ...
    public static class c<T> extends f<T> {
        ...
        public c(String str, boolean z, d dVar, a aVar) {
            ...
            f.b.a.c.b.o.b.z(dVar, "marshaller");
            this.f4199f = dVar;
        }

        @Override // h.a.n0.f
        public T c(byte[] bArr) {
            return this.f4199f.b(new String(bArr, f.b.b.a.d.a));
        }

        @Override // h.a.n0.f
        public byte[] d(T t) {
            return this.f4199f.a(t).getBytes(f.b.b.a.d.a);
        }
    }
    ...
    public static abstract class f<T> {
        ...
        public static final BitSet f4200e;
        ...
        public String toString() {
            return f.a.a.a.a.f(f.a.a.a.a.i("Key{name='"), this.b, "'}");
        }
    }
    ...
    public static final class h<T> extends f<T> {
        ...
        /* renamed from: f  reason: collision with root package name */
        public final i<T> f4202f;

        public h(String str, boolean z, i iVar, a aVar) {
            super(str, z, iVar, null);
            f.b.a.c.b.o.b.t(!str.endsWith("-bin"), "ASCII header is named %s.  Only binary headers may end with %s", str, "-bin");
            f.b.a.c.b.o.b.z(iVar, "marshaller");
            this.f4202f = iVar;
        }

        @Override // h.a.n0.f
        public T c(byte[] bArr) {
            return this.f4202f.b(bArr);
        }

        @Override // h.a.n0.f
        public byte[] d(T t) {
            return this.f4202f.a(t);
        }
    }
    ...
    public <T> void h(f<T> fVar, T t) {
        f.b.a.c.b.o.b.z(fVar, "key");
        f.b.a.c.b.o.b.z(t, "value");
        int i2 = this.b * 2;
        if (i2 == 0 || i2 == a()) {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.b; i2++) {
            ...
            sb.append(str);
            sb.append('=');
            sb.append(str.endsWith("-bin") ? f4198d.c(k(i2)) : new String(k(i2), charset));
        }
        sb.append(')');
        return sb.toString();
    }
