...
public final class a extends h0 {
    ...
    public static final a.c<d<o>> f4203g = new a.c<>("state-info");

    /* renamed from: h  reason: collision with root package name */
    public static final c1 f4204h = c1.f3767f.g("no subchannels ready");
    public final h0.d b;
    public final Map<v, h0.h> c = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    public final Random f4205d;

    /* renamed from: e  reason: collision with root package name */
    public n f4206e;

    /* renamed from: f  reason: collision with root package name */
    public e f4207f = new b(f4204h);
    ...
    public a(h0.d dVar) {
        ...
        this.b = dVar;
        this.f4205d = new Random();
    }

    public static d<o> e(h0.h hVar) {
        h.a.a b2 = hVar.b();
        Object obj = b2.a.get(f4203g);
    ...
    public final void g() {
        ...
        h(nVar2, new c(arrayList, this.f4205d.nextInt(arrayList.size())));
    }

    public final void h(n nVar, e eVar) {
        if (nVar != this.f4206e || !eVar.b(this.f4207f)) {
            this.b.d(nVar, eVar);
            this.f4206e = nVar;
            this.f4207f = eVar;
        }
