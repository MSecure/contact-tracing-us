...
public final class r implements Comparable<r> {
    ...
    public static final long f4233g;

    /* renamed from: h  reason: collision with root package name */
    public static final long f4234h = TimeUnit.SECONDS.toNanos(1);
    public final c b;
    public final long c;
    ...
    public r(c cVar, long j2, boolean z) {
        ...
        this.b = cVar;
        long min = Math.min(f4232f, Math.max(f4233g, j2));
        this.c = nanoTime + min;
        this.f4235d = z && min <= 0;
    }
    ...
    public final void a(r rVar) {
        if (this.b != rVar.b) {
            StringBuilder i2 = f.a.a.a.a.i("Tickers (");
            i2.append(this.b);
            i2.append(" and ");
            i2.append(rVar.b);
    ...
    public long e(TimeUnit timeUnit) {
        Objects.requireNonNull((b) this.b);
        long nanoTime = System.nanoTime();
        if (!this.f4235d && this.c - nanoTime <= 0) {
            this.f4235d = true;
        }
    ...
    public String toString() {
        ...
        if (this.b != f4231e) {
            StringBuilder i2 = f.a.a.a.a.i(" (ticker=");
            i2.append(this.b);
            i2.append(")");
