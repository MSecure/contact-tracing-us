...
public final class b implements j.m.b<c> {
    ...
    public final j.k.a.c<CharSequence, Integer, j.c<Integer, Integer>> f4258d;
    ...
    public static final class a implements Iterator<c> {
        ...
        public final /* synthetic */ b f4262g;
        ...
        public final void b() {
            ...
            int i4 = bVar.c;
            if (i4 > 0) {
                int i5 = this.f4261f + 1;
                this.f4261f = i5;
            }
            if (i2 <= bVar.a.length()) {
                b bVar2 = this.f4262g;
                j.c<Integer, Integer> c2 = bVar2.f4258d.c(bVar2.a, Integer.valueOf(this.f4259d));
                if (c2 == null) {
                    cVar = new c(this.c, h.c(this.f4262g.a));
                    this.f4260e = cVar;
                    this.f4259d = -1;
                    this.b = 1;
                }
