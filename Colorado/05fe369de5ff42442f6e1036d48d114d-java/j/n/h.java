...
public class h extends g {
    ...
    public static int g(CharSequence charSequence, char c, int i2, boolean z, int i3) {
        ...
        e.c(cArr, "chars");
        if (!z) {
            return ((String) charSequence).indexOf(g.b.a.c.c.c.C(cArr), i2);
        }
        if (i2 < 0) {
            i2 = 0;
        }
            ...
            while (true) {
                ...
                while (true) {
                    if (i4 >= 1) {
                        z2 = false;
                        break;
                    } else if (g.b.a.c.c.c.g(cArr[i4], charAt, z)) {
                        z2 = true;
                        break;
                    } else {
                        i4++;
    ...
    public static final boolean h(CharSequence charSequence) {
        ...
        if (!(cVar instanceof Collection) || !((Collection) cVar).isEmpty()) {
            ...
            while (true) {
                ...
                char charAt = charSequence.charAt(((j.i.e) it).b());
    ...
    public static j.m.b i(CharSequence charSequence, String[] strArr, int i2, boolean z, int i3, int i4) {
        boolean z2 = false;
        if ((i4 & 2) != 0) {
            i2 = 0;
        }
    ...
    public static final boolean k(CharSequence charSequence, int i2, CharSequence charSequence2, int i3, int i4, boolean z) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            if (!g.b.a.c.c.c.g(charSequence.charAt(i2 + i5), charSequence2.charAt(i3 + i5), z)) {
                return false;
            }
        }
        return true;
    ...
    public static String m(String str, String str2, String str3, boolean z, int i2) {
        ...
        j.m.b i4 = i(str, strArr, 0, z2, 0, 2);
        j jVar = new j(str);
        e.c(i4, "$this$map");
        e.c(jVar, "transform");
    ...
    public static List n(CharSequence charSequence, String[] strArr, boolean z, int i2, int i3) {
        ...
        if (strArr.length == 1) {
            ...
            if (!(str.length() == 0)) {
                if (i5 >= 0) {
                    ...
                    if (d2 == -1 || i5 == 1) {
                        return g.b.a.c.c.c.p(charSequence.toString());
                    }
                    if (i5 <= 0) {
                        z3 = false;
                    }
        ...
        j.m.b i7 = i(charSequence, strArr, 0, z2, i5, 2);
        e.c(i7, "$this$asIterable");
        j.m.c cVar = new j.m.c(i7);
