...
public final class d implements i, Comparable<d>, Serializable {
    ...
    public static final d f4290d = new d(0, 0);
    public final long b;
    public final int c;
    ...
    public static d e(long j2, int i2) {
        return (((long) i2) | j2) == 0 ? f4290d : new d(j2, i2);
    }

    public static d f(long j2) {
        return e(c.x(j2, 86400), 0);
    }

    public static d h(long j2) {
        return e(c.x(j2, 3600), 0);
    }
    ...
    public static d o(long j2, long j3) {
        return e(c.w(j2, c.i(j3, 1000000000)), c.k(j3, 1000000000));
    }
    ...
    public final d q(long j2, long j3) {
        ...
        return o(c.w(c.w(this.b, j2), j3 / 1000000000), ((long) this.c) + (j3 % 1000000000));
    }

    public d r(long j2) {
        return q(c.x(j2, 60), 0);
    }
    ...
    public long t() {
        return c.w(c.x(this.b, 1000), (long) (this.c / 1000000));
    }
