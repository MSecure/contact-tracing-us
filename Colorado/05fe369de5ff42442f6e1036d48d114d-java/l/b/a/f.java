...
public final class f extends b implements d, l.b.a.x.f, Serializable {
    ...
    public static final f f4292e = P(-999999999, 1, 1);

    /* renamed from: f  reason: collision with root package name */
    public static final f f4293f = P(999999999, 12, 31);

    /* renamed from: g  reason: collision with root package name */
    public static final l<f> f4294g = new a();
    public final int b;
    public final short c;

    /* renamed from: d  reason: collision with root package name */
    public final short f4295d;
    ...
    public f(int i2, int i3, int i4) {
        this.b = i2;
        this.c = (short) i3;
        this.f4295d = (short) i4;
    }

    public static f C(int i2, i iVar, int i3) {
        if (i3 <= 28 || i3 <= iVar.s(m.f4343d.u((long) i2))) {
            return new f(i2, iVar.r(), i3);
        }
        if (i3 == 29) {
            throw new b(f.a.a.a.a.w("Invalid date 'February 29' as '", i2, "' is not a leap year"));
        }
        StringBuilder i4 = f.a.a.a.a.i("Invalid date '");
        i4.append(iVar.name());
        i4.append(" ");
        i4.append(i3);
        i4.append("'");
        throw new b(i4.toString());
    }

    public static f E(e eVar) {
        f fVar = (f) eVar.c(k.f4459f);
        if (fVar != null) {
            return fVar;
        }
        throw new b(f.a.a.a.a.g(eVar, f.a.a.a.a.l("Unable to obtain LocalDate from TemporalAccessor: ", eVar, ", type ")));
    }

    public static f O(a aVar) {
        c.u(aVar, "clock");
        e a2 = aVar.a();
        return R(c.i(a2.b + ((long) ((a.C0154a) aVar).b.s().a(a2).c), 86400));
    }

    public static f P(int i2, int i3, int i4) {
        l.b.a.x.a aVar = l.b.a.x.a.YEAR;
        aVar.f4441e.b((long) i2, aVar);
        l.b.a.x.a aVar2 = l.b.a.x.a.MONTH_OF_YEAR;
        aVar2.f4441e.b((long) i3, aVar2);
        l.b.a.x.a aVar3 = l.b.a.x.a.DAY_OF_MONTH;
        aVar3.f4441e.b((long) i4, aVar3);
    ...
    public static f S(int i2, int i3) {
        ...
        throw new b(f.a.a.a.a.w("Invalid date 'DayOfYear 366' as '", i2, "' is not a leap year"));
    }

    public static f T(CharSequence charSequence, l.b.a.v.c cVar) {
        c.u(cVar, "formatter");
        l<f> lVar = f4294g;
        c.u(charSequence, "text");
        c.u(lVar, "type");
        try {
            l.b.a.v.a d2 = cVar.d(charSequence, null);
            d2.x(cVar.f4376d, cVar.f4377e);
            return lVar.a(d2);
        } catch (l.b.a.v.f e2) {
            throw e2;
    ...
    public t A(q qVar) {
        l.b.a.y.d b2;
        c.u(qVar, "zone");
        g F = g.F(this, h.f4300h);
        if (!(qVar instanceof r) && (b2 = qVar.s().b(F)) != null && b2.b()) {
            F = b2.a();
        }
        return t.H(F, qVar);
    }
    ...
    public int B(f fVar) {
        ...
        return i3 == 0 ? this.f4295d - fVar.f4295d : i3;
    }
    ...
    public final int F(j jVar) {
        switch (((l.b.a.x.a) jVar).ordinal()) {
            ...
            case 19:
                return H();
            case 20:
                throw new b(f.a.a.a.a.e("Field too large for an int: ", jVar));
            case 21:
                return ((this.f4295d - 1) / 7) + 1;
            case 22:
                return ((H() - 1) / 7) + 1;
    ...
    public c G() {
        return c.r(c.k(x() + 3, 7) + 1);
    }

    public int H() {
        return (i.u(this.c).q(K()) + this.f4295d) - 1;
    }
    ...
    public final long N(f fVar) {
        return (((fVar.I() * 32) + ((long) fVar.f4295d)) - ((I() * 32) + ((long) this.f4295d))) / 32;
    }
    ...
    public f v(long j2, l.b.a.x.m mVar) {
        ...
        switch (((l.b.a.x.b) mVar).ordinal()) {
            ...
            case 12:
                return Y(c.x(j2, 100));
            case 13:
                return Y(c.x(j2, 1000));
            case 14:
                l.b.a.x.a aVar = l.b.a.x.a.ERA;
                return z(aVar, c.w(i(aVar), j2));
            default:
    ...
    public f W(long j2) {
        ...
        return Z(l.b.a.x.a.YEAR.m(c.i(j3, 12)), c.k(j3, 12) + 1, this.f4295d);
    }
    ...
    public f Y(long j2) {
        return j2 == 0 ? this : Z(l.b.a.x.a.YEAR.m(((long) this.b) + j2), this.c, this.f4295d);
    }
    ...
    public f z(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            ...
            case 18:
                int i2 = (int) j2;
                return this.f4295d == i2 ? this : P(this.b, this.c, i2);
            case 19:
                int i3 = (int) j2;
            ...
            case 23:
                ...
                l.b.a.x.a aVar2 = l.b.a.x.a.MONTH_OF_YEAR;
                aVar2.f4441e.b((long) i4, aVar2);
                return Z(this.b, i4, this.f4295d);
            case 24:
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: l.b.a.f */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // l.b.a.x.e, l.b.a.w.c, l.b.a.u.b
    public <R> R c(l<R> lVar) {
        return lVar == k.f4459f ? this : (R) super.c(lVar);
    }
    ...
    public f c0(int i2) {
        ...
        l.b.a.x.a aVar = l.b.a.x.a.YEAR;
        aVar.f4441e.b((long) i2, aVar);
        return Z(i2, this.c, this.f4295d);
    }
    ...
    public int hashCode() {
        int i2 = this.b;
        return (((i2 << 11) + (this.c << 6)) + this.f4295d) ^ (i2 & -2048);
    }
    ...
    public long x() {
        ...
        long j6 = (((367 * j4) - 362) / 12) + j2 + ((long) (this.f4295d - 1));
        if (j4 > 2) {
            j6--;
            if (!K()) {
                j6--;
