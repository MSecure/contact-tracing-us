...
public final class h extends c implements d, f, Comparable<h>, Serializable {
    ...
    public static final h f4299g = new h(23, 59, 59, 999999999);

    /* renamed from: h  reason: collision with root package name */
    public static final h f4300h;

    /* renamed from: i  reason: collision with root package name */
    public static final h[] f4301i = new h[24];
    public final byte b;
    public final byte c;
    ...
    public static h r(int i2, int i3, int i4, int i5) {
        return ((i3 | i4) | i5) == 0 ? f4301i[i2] : new h(i2, i3, i4, i5);
    }
    ...
    public static h s(e eVar) {
        h hVar = (h) eVar.c(k.f4460g);
        if (hVar != null) {
            return hVar;
        }
        throw new b(a.g(eVar, a.l("Unable to obtain LocalTime from TemporalAccessor: ", eVar, ", type ")));
    }
    ...
    public h A(long j2) {
        ...
        return i2 == i3 ? this : r(i3 / 60, i3 % 60, this.f4302d, this.f4303e);
    }
    ...
    public h C(long j2) {
        ...
        int i2 = (this.c * 60) + (this.b * 3600) + this.f4302d;
        int i3 = ((((int) (j2 % 86400)) + i2) + 86400) % 86400;
        return i2 == i3 ? this : r(i3 / 3600, (i3 / 60) % 60, i3 % 60, this.f4303e);
    }

    public long E() {
        return (((long) this.f4302d) * 1000000000) + (((long) this.c) * 60000000000L) + (((long) this.b) * 3600000000000L) + ((long) this.f4303e);
    }

    public int F() {
        return (this.c * 60) + (this.b * 3600) + this.f4302d;
    }
    ...
    public h l(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            ...
            case 6:
                ...
                return r(this.b, this.c, i2, this.f4303e);
            case 7:
                return C(j2 - ((long) F()));
            case 8:
                int i3 = (int) j2;
                ...
                aVar3.f4441e.b((long) i3, aVar3);
                return r(this.b, i3, this.f4302d, this.f4303e);
            case 9:
    ...
    public h H(int i2) {
        ...
        l.b.a.x.a aVar = l.b.a.x.a.HOUR_OF_DAY;
        aVar.f4441e.b((long) i2, aVar);
        return r(i2, this.c, this.f4302d, this.f4303e);
    }
    ...
    public h I(int i2) {
        ...
        aVar.f4441e.b((long) i2, aVar);
        return r(this.b, this.c, this.f4302d, i2);
    }
    ...
    public void J(DataOutput dataOutput) {
        ...
        dataOutput.writeByte(this.b);
        dataOutput.writeByte(this.c);
        dataOutput.writeByte(this.f4302d);
        dataOutput.writeInt(this.f4303e);
    }
    ...
    public <R> R c(l<R> lVar) {
        ...
        if (lVar == k.b || lVar == k.a || lVar == k.f4457d || lVar == k.f4458e || lVar == k.f4459f) {
            return null;
        }
        return lVar.a(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        h hVar = (h) obj;
        return this.b == hVar.b && this.c == hVar.c && this.f4302d == hVar.f4302d && this.f4303e == hVar.f4303e;
    }
    ...
    public int compareTo(h hVar) {
        int d2 = g.b.a.c.c.c.d(this.b, hVar.b);
        if (d2 != 0) {
            return d2;
        }
        int d3 = g.b.a.c.c.c.d(this.c, hVar.c);
        if (d3 != 0) {
            return d3;
        }
        int d4 = g.b.a.c.c.c.d(this.f4302d, hVar.f4302d);
        return d4 == 0 ? g.b.a.c.c.c.d(this.f4303e, hVar.f4303e) : d4;
    }
    ...
    public final int t(j jVar) {
        switch (((l.b.a.x.a) jVar).ordinal()) {
            case 0:
                return this.f4303e;
            case 1:
                throw new b(a.e("Field too large for an int: ", jVar));
            case 2:
                return this.f4303e / 1000;
            case 3:
                throw new b(a.e("Field too large for an int: ", jVar));
            case 4:
                return this.f4303e / 1000000;
            case 5:
    ...
    public h z(long j2) {
        return j2 == 0 ? this : r(((((int) (j2 % 24)) + this.b) + 24) % 24, this.c, this.f4302d, this.f4303e);
    }
}
