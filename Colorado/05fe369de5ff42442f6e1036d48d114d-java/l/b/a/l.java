...
public final class l extends c implements d, f, Comparable<l>, Serializable {
    ...
    public static final /* synthetic */ int f4315d = 0;
    public final h b;
    public final r c;
    ...
    public static l q(e eVar) {
        ...
        try {
            ...
            throw new b(a.g(eVar, a.l("Unable to obtain OffsetTime from TemporalAccessor: ", eVar, ", type ")));
        }
    }
    ...
    public <R> R c(l.b.a.x.l<R> lVar) {
        ...
        if (lVar == k.b || lVar == k.f4459f || lVar == k.a) {
            return null;
        }
    ...
    public int compareTo(l lVar) {
        int e2;
        l lVar2 = lVar;
        return (!this.c.equals(lVar2.c) && (e2 = g.b.a.c.c.c.e(s(), lVar2.s())) != 0) ? e2 : this.b.compareTo(lVar2.b);
    }
    ...
    public d l(j jVar, long j2) {
        ...
        return t(this.b, r.z(aVar.f4441e.a(j2, aVar)));
    }
