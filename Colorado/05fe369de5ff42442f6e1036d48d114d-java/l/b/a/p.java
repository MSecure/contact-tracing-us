...
public final class p extends c implements d, f, Comparable<p>, Serializable {
    ...
    public static p q(e eVar) {
        ...
        try {
            if (!l.b.a.u.m.f4343d.equals(h.l(eVar))) {
                eVar = f.E(eVar);
            }
            return s(eVar.b(a.YEAR), eVar.b(a.MONTH_OF_YEAR));
        } catch (b unused) {
            throw new b(f.a.a.a.a.g(eVar, f.a.a.a.a.l("Unable to obtain YearMonth from TemporalAccessor: ", eVar, ", type ")));
        }
    }
    ...
    @Override // l.b.a.x.f
    public d n(d dVar) {
        if (h.l(dVar).equals(l.b.a.u.m.f4343d)) {
    ...
    public p m(long j2, l.b.a.x.m mVar) {
        ...
        switch (((b) mVar).ordinal()) {
            ...
            case 10:
                return v(j2);
            case 11:
                return v(g.b.a.c.c.c.x(j2, 10));
            case 12:
                return v(g.b.a.c.c.c.x(j2, 100));
            case 13:
                return v(g.b.a.c.c.c.x(j2, 1000));
            case 14:
                a aVar = a.ERA;
                return l(aVar, g.b.a.c.c.c.w(i(aVar), j2));
            default:
                throw new n("Unsupported unit: " + mVar);
        }
    }
    ...
    public p u(long j2) {
        ...
        return w(a.YEAR.m(g.b.a.c.c.c.i(j3, 12)), g.b.a.c.c.c.k(j3, 12) + 1);
    }
