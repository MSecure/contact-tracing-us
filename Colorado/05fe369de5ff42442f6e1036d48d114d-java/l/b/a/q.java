...
public abstract class q implements Serializable {
    ...
    public static q q(e eVar) {
        q qVar = (q) eVar.c(k.f4457d);
        if (qVar != null) {
            return qVar;
        }
        throw new b(a.g(eVar, a.l("Unable to obtain ZoneId from TemporalAccessor: ", eVar, ", type ")));
    }
    ...
    public static q t(String str) {
        ...
        if (str.length() == 1) {
            throw new b(a.c("Invalid zone: ", str));
        } else if (str.startsWith("+") || str.startsWith("-")) {
            return r.x(str);
        } else {
            if (str.equals("UTC") || str.equals("GMT") || str.equals("UT")) {
                return new s(str, r.f4321g.s());
            }
            if (str.startsWith("UTC+") || str.startsWith("GMT+") || str.startsWith("UTC-") || str.startsWith("GMT-")) {
                ...
                return new s(str.substring(0, 3) + x.f4324d, x.s());
    ...
    public static q u(String str, r rVar) {
        ...
        if (!str.equals("GMT") && !str.equals("UTC") && !str.equals("UT")) {
            throw new IllegalArgumentException(a.c("Invalid prefix, must be GMT, UTC or UT: ", str));
        } else if (rVar.c == 0) {
            return new s(str, rVar.s());
        } else {
            StringBuilder i2 = a.i(str);
            i2.append(rVar.f4324d);
            return new s(i2.toString(), rVar.s());
        }
    }
