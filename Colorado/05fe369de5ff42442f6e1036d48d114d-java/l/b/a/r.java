...
public final class r extends q implements e, f, Comparable<r>, Serializable {
    ...
    public static final ConcurrentMap<Integer, r> f4319e = new ConcurrentHashMap(16, 0.75f, 4);

    /* renamed from: f  reason: collision with root package name */
    public static final ConcurrentMap<String, r> f4320f = new ConcurrentHashMap(16, 0.75f, 4);

    /* renamed from: g  reason: collision with root package name */
    public static final r f4321g = z(0);

    /* renamed from: h  reason: collision with root package name */
    public static final r f4322h = z(-64800);

    /* renamed from: i  reason: collision with root package name */
    public static final r f4323i = z(64800);
    public final int c;

    /* renamed from: d  reason: collision with root package name */
    public final transient String f4324d;
    ...
    public static r w(e eVar) {
        r rVar = (r) eVar.c(k.f4458e);
        if (rVar != null) {
            return rVar;
        }
        throw new b(a.g(eVar, a.l("Unable to obtain ZoneOffset from TemporalAccessor: ", eVar, ", type ")));
    }
        ...
        if (length == 2) {
            ...
            if (length == 5) {
                ...
                if (length == 7) {
                    ...
                    throw new b(a.c("Invalid ID for ZoneOffset, invalid format: ", str));
                }
                charAt = str.charAt(0);
                if (charAt != '+' || charAt == '-') {
                    return charAt == '-' ? y(-i4, -i3, -i2) : y(i4, i3, i2);
                }
                throw new b(a.c("Invalid ID for ZoneOffset, plus/minus not found when expected: ", str));
            } else {
                i4 = A(str, 1, false);
                i3 = A(str, 4, true);
            }
    ...
    public static r y(int i2, int i3, int i4) {
        if (i2 < -18 || i2 > 18) {
            throw new b(a.w("Zone offset hours not in valid range: value ", i2, " is not in the range -18 to 18"));
        }
        if (i2 > 0) {
            if (i3 < 0 || i4 < 0) {
        ...
        if (Math.abs(i3) > 59) {
            StringBuilder i5 = a.i("Zone offset minutes not in valid range: abs(value) ");
            i5.append(Math.abs(i3));
            i5.append(" is not in the range 0 to 59");
            throw new b(i5.toString());
        } else if (Math.abs(i4) > 59) {
            StringBuilder i6 = a.i("Zone offset seconds not in valid range: abs(value) ");
            i6.append(Math.abs(i4));
            i6.append(" is not in the range 0 to 59");
    ...
    public static r z(int i2) {
        if (Math.abs(i2) > 64800) {
            ...
            ConcurrentMap<Integer, r> concurrentMap = f4319e;
            ...
            f4320f.putIfAbsent(rVar2.f4324d, rVar2);
            return rVar2;
        }
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: l.b.a.r */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // l.b.a.x.e
    public <R> R c(l<R> lVar) {
        if (lVar == k.f4458e || lVar == k.f4457d) {
            return this;
        }
        if (lVar == k.f4459f || lVar == k.f4460g || lVar == k.c || lVar == k.b || lVar == k.a) {
            return null;
        }
        return lVar.a(this);
    }
    ...
    public long i(j jVar) {
        ...
        throw new b(a.e("Unsupported field: ", jVar));
    }
