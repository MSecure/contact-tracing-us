...
public final class p extends a<p> implements Serializable {
    ...
    public static final f f4350e = f.P(1873, 1, 1);
    public final f b;
    public transient q c;

    /* renamed from: d  reason: collision with root package name */
    public transient int f4351d;

    public p(f fVar) {
        if (!fVar.J(f4350e)) {
            q r = q.r(fVar);
            this.c = r;
            this.f4351d = fVar.b - (r.c.b - 1);
            this.b = fVar;
            return;
        }
    ...
    public final o E(int i2) {
        Calendar instance = Calendar.getInstance(o.f4345d);
        instance.set(0, this.c.b + 2);
        int i3 = this.f4351d;
        f fVar = this.b;
        instance.set(i3, fVar.c - 1, fVar.f4295d);
        return o.d((long) instance.getActualMinimum(i2), (long) instance.getActualMaximum(i2));
    }

    public final long F() {
        return (long) (this.f4351d == 1 ? (this.b.H() - this.c.c.H()) + 1 : this.b.H());
    }
    ...
    public p z(j jVar, long j2) {
        ...
        if (ordinal == 19 || ordinal == 25 || ordinal == 27) {
            int a = o.f4346e.u(aVar).a(j2, aVar);
    ...
    public final p I(q qVar, int i2) {
        Objects.requireNonNull(o.f4346e);
    ...
    public d e(l.b.a.x.f fVar) {
        return (p) o.f4346e.e(fVar.n(this));
    }
    ...
    @Override // l.b.a.u.b
    public b w(i iVar) {
        return (p) o.f4346e.e(((l.b.a.m) iVar).b(this));
    }
