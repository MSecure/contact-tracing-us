...
public class ContentFrameLayout extends FrameLayout {
    ...
    public void onDetachedFromWindow() {
        ...
        if (aVar != null) {
            ...
            if (mVar.q != null) {
                mVar.f653f.getDecorView().removeCallbacks(mVar.r);
                if (mVar.q.isShowing()) {
                    try {
                        mVar.q.dismiss();
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (mode == Integer.MIN_VALUE) {
            TypedValue typedValue = z3 ? this.f80e : this.f79d;
                ...
                if (i8 == 5) {
                    ...
                    if (i9 > 0) {
                        ...
                        if (mode2 == Integer.MIN_VALUE) {
                            TypedValue typedValue2 = z3 ? this.f81f : this.f82g;
