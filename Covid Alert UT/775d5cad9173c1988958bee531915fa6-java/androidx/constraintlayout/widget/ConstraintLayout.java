...
public class ConstraintLayout extends ViewGroup {
    ...
    public int o = -1;
    public int p = -1;
    public SparseArray<e.g.a.i.d> q = new SparseArray<>();
    ...
    public static class a extends ViewGroup.MarginLayoutParams {
        ...
        public float o0;
        public int p = 0;
        public e.g.a.i.d p0 = new e.g.a.i.d();
        public float q = 0.0f;
        public int r = -1;
        public int s = -1;
        public int t = -1;
    ...
    public class b implements b.AbstractC0028b {
        ...
        public final void b(e.g.a.i.d dVar, b.a aVar) {
            int i2;
            int ordinal;
            int i3;
            int i4;
                ...
                if (dVar.h0 == 8 && !dVar.E) {
                    ...
                    if (ordinal2 == 0) {
                        ...
                        if (ordinal2 != 3) {
                            ...
                            int i18 = cVar != null ? cVar.f1296g + 0 : 0;
                            e.g.a.i.c cVar2 = dVar.K;
                            if (cVar2 != null) {
                                i18 += cVar2.f1296g;
                            }
                        ...
                        if (ordinal == 0) {
                            if (ordinal == 1) {
                                ...
                                int i19 = aVar.f1325j;
                                if (i19 == 1 || i19 == 2) {
                                    if (aVar.f1325j == 2 || !z || (z && (view.getMeasuredWidth() == dVar.r())) || (view instanceof g) || dVar.B()) {
                                ...
                                if (view != null) {
                                    ...
                                    if (i20 == 1 || i20 == 2 || !z2 || dVar.q != 0 || !z3 || dVar.r != 0) {
                                        if (!(view instanceof e.g.c.i) || !(dVar instanceof j)) {
                                            view.measure(i2, i3);
                                        } else {
                                            j jVar = (j) dVar;
                                            ((e.g.c.i) view).o();
                                    ...
                                    boolean z8 = i6 != i7;
                                    aVar.f1324i = (i5 == aVar.c && i4 == aVar.f1319d) ? false : true;
                                    if (aVar7.b0) {
                                        z8 = true;
                                    }
                                ...
                                i11 = this.f132g;
                                int i25 = dVar.I != null ? dVar.J.f1296g + 0 : 0;
                                if (dVar.K != null) {
                                    i25 += dVar.L.f1296g;
                                }
                                i15 += i25;
                        ...
                        int i26 = aVar.f1325j;
                        if (i26 == 1 || i26 == 2) {
                            if (aVar.f1325j == 2 || !z9 || (z9 && (view.getMeasuredHeight() == dVar.l())) || (view instanceof g) || dVar.A()) {
    ...
    public final e.g.a.i.d e(View view) {
        if (view == this) {
            return this.f111d;
        }
        if (view == null) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:266:0x0581  */
    /* JADX WARNING: Removed duplicated region for block: B:279:0x05c7  */
    /* JADX WARNING: Removed duplicated region for block: B:282:0x05d8  */
    /* JADX WARNING: Removed duplicated region for block: B:284:0x05de  */
    /* JADX WARNING: Removed duplicated region for block: B:35:0x00e0  */
    /* JADX WARNING: Removed duplicated region for block: B:400:0x0585 A[SYNTHETIC] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:92:0x01f9 A[ADDED_TO_REGION] */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (mode != Integer.MIN_VALUE) {
            if (mode != 0) {
                if (mode != 1073741824) {
                    ...
                    if (mode2 == i5) {
                            ...
                            if (mode2 != 1073741824) {
                                ...
                                if (z) {
                                    ...
                                    while (true) {
                                        ...
                                        e.g.a.i.d dVar = eVar3.q0.get(i30);
                                    ...
                                    if (!z3) {
                                        ...
                                        if (mode == 1073741824 && mode2 == 1073741824) {
                                            e.g.a.i.l.e eVar4 = eVar3.s0;
                                            d.a aVar14 = d.a.MATCH_PARENT;
                                            boolean z10 = b2 & true;
                                            if (eVar4.b || eVar4.c) {
                                                for (Iterator<e.g.a.i.d> it = eVar4.a.q0.iterator(); it.hasNext(); it = it) {
                                                    e.g.a.i.d next = it.next();
                                                    next.h();
                                                    next.a = false;
                                                    next.f1307d.n();
                                                    next.f1308e.m();
                                            ...
                                            int t2 = eVar4.a.t();
                                            bVar2 = bVar9;
                                            eVar4.a.f1307d.f1359h.c(s2);
                                            eVar4.a.f1308e.f1359h.c(t2);
                                            eVar4.g();
                                            if (k2 == aVar2 || k3 == aVar2) {
                                                boolean z11 = z10;
                                                if (z10) {
                                                    Iterator<o> it2 = eVar4.f1329e.iterator();
                                                    while (true) {
                                                        if (it2.hasNext()) {
                                                            if (!it2.next().k()) {
                                                                z11 = false;
                                                ...
                                                if (z11 && k3 == aVar2) {
                                                    ...
                                                    e eVar10 = eVar4.a;
                                                    eVar10.f1308e.f1356e.c(eVar10.l());
                                                }
                                            } else {
                                                i10 = r2;
                                                i9 = l2;
                                            ...
                                            if (aVarArr[0] == aVar3 || aVarArr[0] == aVar14) {
                                                int r3 = eVar11.r() + s2;
                                                eVar4.a.f1307d.f1360i.c(r3);
                                                eVar4.a.f1307d.f1356e.c(r3 - s2);
                                                eVar4.g();
                                                e eVar12 = eVar4.a;
                                                d.a[] aVarArr2 = eVar12.T;
                                                if (aVarArr2[1] == aVar3 || aVarArr2[1] == aVar14) {
                                                    int l3 = eVar12.l() + t2;
                                                    eVar4.a.f1308e.f1360i.c(l3);
                                                    eVar4.a.f1308e.f1356e.c(l3 - t2);
                                                }
                                                eVar4.g();
                                                z7 = true;
                                            } else {
                                            ...
                                            Iterator<o> it3 = eVar4.f1329e.iterator();
                                            while (it3.hasNext()) {
                                                o next2 = it3.next();
                                                if (next2.b != eVar4.a || next2.f1358g) {
                                                    next2.e();
                                                }
                                            }
                                            Iterator<o> it4 = eVar4.f1329e.iterator();
                                            while (true) {
                                                if (!it4.hasNext()) {
                                                    z8 = true;
                                                    break;
                                                ...
                                                o next3 = it4.next();
                                                if ((z7 || next3.b != eVar4.a) && (!next3.f1359h.f1339j || ((!next3.f1360i.f1339j && !(next3 instanceof e.g.a.i.l.i)) || (!next3.f1356e.f1339j && !(next3 instanceof e.g.a.i.l.c) && !(next3 instanceof e.g.a.i.l.i))))) {
                                                    z8 = false;
                                                }
                                            }
                                            z8 = false;
                                            ...
                                            i10 = r2;
                                            i9 = l2;
                                            e.g.a.i.l.e eVar13 = eVar3.s0;
                                            if (eVar13.b) {
                                                Iterator<e.g.a.i.d> it5 = eVar13.a.q0.iterator();
                                                while (it5.hasNext()) {
                                                    e.g.a.i.d next4 = it5.next();
                                                    next4.h();
                                                    next4.a = false;
                                                    k kVar2 = next4.f1307d;
                                                    kVar2.f1356e.f1339j = false;
                                                    kVar2.f1358g = false;
                                                    kVar2.n();
                                                    m mVar2 = next4.f1308e;
                                                    mVar2.f1356e.f1339j = false;
                                                    mVar2.f1358g = false;
                                                    mVar2.m();
                                                }
                                                i17 = 0;
                                                ...
                                                e eVar14 = eVar13.a;
                                                eVar14.a = false;
                                                k kVar3 = eVar14.f1307d;
                                                kVar3.f1356e.f1339j = false;
                                                kVar3.f1358g = false;
                                                kVar3.n();
                                                m mVar3 = eVar13.a.f1308e;
                                                mVar3.f1356e.f1339j = false;
                                                mVar3.f1358g = false;
                                                mVar3.m();
                                                eVar13.c();
                                            } else {
                                            ...
                                            eVar13.b(eVar13.f1328d);
                                            e eVar15 = eVar13.a;
                                            eVar15.Z = i17;
                                            eVar15.a0 = i17;
                                            eVar15.f1307d.f1359h.c(i17);
                                            eVar13.a.f1308e.f1359h.c(i17);
                                            i16 = 1073741824;
                                            if (mode == 1073741824) {
                                                i18 = 1;
                                    ...
                                    if (!z5 || i11 != 2) {
                                        ...
                                        if (size <= 0) {
                                            ...
                                            b.AbstractC0028b bVar10 = eVar3.u0;
                                            int i32 = 0;
                                            while (i32 < size5) {
                                                e.g.a.i.d dVar2 = eVar3.q0.get(i32);
                                                if (!(dVar2 instanceof f) && !(dVar2 instanceof e.g.a.i.a) && !dVar2.F && (!a0 || (kVar = dVar2.f1307d) == null || (mVar = dVar2.f1308e) == null || !kVar.f1356e.f1339j || !mVar.f1356e.f1339j)) {
                                                    d.a k4 = dVar2.k(0);
                                                    d.a k5 = dVar2.k(1);
                                        ...
                                        if (size2 > 0) {
                                            ...
                                            boolean z15 = false;
                                            while (i37 < size2) {
                                                e.g.a.i.d dVar3 = bVar3.a.get(i37);
                                            ...
                                            while (true) {
                                                ...
                                                int i41 = 0;
                                                while (i41 < size2) {
                                                    e.g.a.i.d dVar4 = bVar3.a.get(i41);
                                                    if ((!(dVar4 instanceof e.g.a.i.g) || (dVar4 instanceof j)) && !(dVar4 instanceof f)) {
                                                        eVar = eVar3;
                                                        if (dVar4.h0 != 8 && ((!z4 || !dVar4.f1307d.f1356e.f1339j || !dVar4.f1308e.f1356e.f1339j) && !(dVar4 instanceof j))) {
                                                            int r6 = dVar4.r();
                                                            int l6 = dVar4.l();
                                                            i13 = i35;
                                                            int i42 = dVar4.b0;
                                                            ...
                                                            boolean a3 = z17 | bVar3.a(bVar2, dVar4, i43);
                                                            int r7 = dVar4.r();
                                                            boolean z18 = a3;
                                                            int l7 = dVar4.l();
                                                            if (r7 != r6) {
                                                            ...
                                                            if (l7 != l6) {
                                                                dVar4.I(l7);
                                                                if (z14 && dVar4.j() > i40) {
                                                                    i40 = Math.max(i40, dVar4.i(aVar6).d() + dVar4.j());
                                                                }
                                                                z17 = true;
                                                            } else {
                                                                z17 = z18;
                                                            }
                                                            if (dVar4.D && i42 != dVar4.b0) {
                                                                z17 = true;
                                                            }
                                                            i41++;
                                                            size2 = size2;
                                    ...
                                    int l8 = this.f111d.l();
                                    e eVar16 = this.f111d;
                                    l(i2, i3, r8, l8, eVar16.E0, eVar16.F0);
                                }
                                z2 = z;
                                i8 = 1073741824;
                                z3 = z2 & ((mode != i8 && mode2 == i8) || b2);
                                ...
                                eVar3.b0(i312);
                                int r82 = this.f111d.r();
                                int l82 = this.f111d.l();
                                e eVar162 = this.f111d;
                                l(i2, i3, r82, l82, eVar162.E0, eVar162.F0);
                            }
                        ...
                        eVar3.b0(i3122);
                        int r822 = this.f111d.r();
                        int l822 = this.f111d.l();
                        e eVar1622 = this.f111d;
                        l(i2, i3, r822, l822, eVar1622.E0, eVar1622.F0);
                    } else if (childCount2 != 0) {
                        aVar3 = aVar9;
                        i20 = i27;
                        i6 = i20;
                        ...
                        eVar3.b0(i31222);
                        int r8222 = this.f111d.r();
                        int l8222 = this.f111d.l();
                        e eVar16222 = this.f111d;
                        l(i2, i3, r8222, l8222, eVar16222.E0, eVar16222.F0);
                    }
                    aVar3 = aVar9;
                    ...
                    eVar3.b0(i312222);
                    int r82222 = this.f111d.r();
                    int l82222 = this.f111d.l();
                    e eVar162222 = this.f111d;
                    l(i2, i3, r82222, l82222, eVar162222.E0, eVar162222.F0);
                }
            } else if (childCount2 != 0) {
                aVar = aVar10;
            }
            ...
            eVar3.b0(i3122222);
            int r822222 = this.f111d.r();
            int l822222 = this.f111d.l();
            e eVar1622222 = this.f111d;
            l(i2, i3, r822222, l822222, eVar1622222.E0, eVar1622222.F0);
        } else if (childCount2 != 0) {
            i21 = i26;
            i4 = i21;
            aVar = aVar10;
            ...
            eVar3.b0(i31222222);
            int r8222222 = this.f111d.r();
            int l8222222 = this.f111d.l();
            e eVar16222222 = this.f111d;
            l(i2, i3, r8222222, l8222222, eVar16222222.E0, eVar16222222.F0);
        }
        ...
        eVar3.x0 = max3;
        eVar3.y0 = max;
        e.g.a.i.l.b bVar8222222 = eVar3.r0;
        ...
        b.AbstractC0028b bVar9222222 = eVar3.u0;
        size = eVar3.q0.size();
        int r2222222 = eVar3.r();
        ...
        eVar3.b0(i312222222);
        int r82222222 = this.f111d.r();
        int l82222222 = this.f111d.l();
        e eVar162222222 = this.f111d;
        l(i2, i3, r82222222, l82222222, eVar162222222.E0, eVar162222222.F0);
    }
    ...
    public final void q(e.g.a.i.d dVar, a aVar, SparseArray<e.g.a.i.d> sparseArray, int i2, c.a aVar2) {
        View view = this.b.get(i2);
        e.g.a.i.d dVar2 = sparseArray.get(i2);
    ...
    /* JADX WARNING: Removed duplicated region for block: B:148:0x02fd A[ADDED_TO_REGION] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:166:0x0350  */
    /* JADX WARNING: Removed duplicated region for block: B:170:0x0366  */
    /* JADX WARNING: Removed duplicated region for block: B:178:0x0387  */
    /* JADX WARNING: Removed duplicated region for block: B:179:0x038b  */
    /* JADX WARNING: Removed duplicated region for block: B:190:0x03b0  */
    /* JADX WARNING: Removed duplicated region for block: B:193:0x03b8  */
    /* JADX WARNING: Removed duplicated region for block: B:267:0x04e9  */
    public final boolean r() {
        ...
        if (z2) {
            ...
            for (int i21 = 0; i21 < childCount2; i21++) {
                e.g.a.i.d e2 = constraintLayout.e(constraintLayout.getChildAt(i21));
                if (e2 != null) {
                    e2.C();
                }
            }
            ...
            if (constraintLayout.m != -1) {
                for (int i24 = 0; i24 < childCount2; i24++) {
                    ...
                    if (childAt2.getId() == constraintLayout.m && (childAt2 instanceof e.g.c.e)) {
                        constraintLayout.f118k = ((e.g.c.e) childAt2).getConstraintSet();
                    }
                }
            }
            e.g.c.d dVar6 = constraintLayout.f118k;
            if (dVar6 != null) {
            ...
            if (size > 0) {
                int i25 = 0;
                while (i25 < size) {
                    e.g.c.b bVar = constraintLayout.c.get(i25);
                    if (bVar.isInEditMode()) {
                        bVar.setIds(bVar.f1387f);
                    }
                    e.g.a.i.g gVar = bVar.f1386e;
                    if (gVar != null) {
                        e.g.a.i.h hVar = (e.g.a.i.h) gVar;
                        hVar.r0 = i19;
                        Arrays.fill(hVar.q0, obj);
                        for (int i26 = 0; i26 < bVar.c; i26++) {
                            int i27 = bVar.b[i26];
                            View d2 = constraintLayout.d(i27);
                            if (d2 == null && (h2 = bVar.h(constraintLayout, (str = bVar.f1390i.get(Integer.valueOf(i27))))) != 0) {
                                bVar.b[i26] = h2;
                                bVar.f1390i.put(Integer.valueOf(h2), str);
                                d2 = constraintLayout.d(h2);
                            }
                            if (d2 != null) {
                                e.g.a.i.g gVar2 = bVar.f1386e;
                                e.g.a.i.d e3 = constraintLayout.e(d2);
                                e.g.a.i.h hVar2 = (e.g.a.i.h) gVar2;
                                Objects.requireNonNull(hVar2);
                                if (!(e3 == hVar2 || e3 == null)) {
                                    int i28 = hVar2.r0 + 1;
                                    e.g.a.i.d[] dVarArr = hVar2.q0;
                                    if (i28 > dVarArr.length) {
                                        hVar2.q0 = (e.g.a.i.d[]) Arrays.copyOf(dVarArr, dVarArr.length * 2);
                                    }
                                    e.g.a.i.d[] dVarArr2 = hVar2.q0;
                                    int i29 = hVar2.r0;
                                    dVarArr2[i29] = e3;
                                    hVar2.r0 = i29 + 1;
                                }
                        ...
                        bVar.f1386e.a(constraintLayout.f111d);
                    }
                    i25++;
                    obj = null;
                    i19 = 0;
            ...
            for (int i30 = 0; i30 < childCount2; i30++) {
                ...
                if (childAt3 instanceof g) {
                    ...
                    if (gVar3.b == -1 && !gVar3.isInEditMode()) {
                        gVar3.setVisibility(gVar3.f1442d);
                    }
            ...
            while (i32 < childCount2) {
                ...
                e.g.a.i.d e4 = constraintLayout.e(childAt5);
                if (e4 != null) {
                    a aVar6 = (a) childAt5.getLayoutParams();
                    e eVar = constraintLayout.f111d;
                    eVar.q0.add(e4);
                    e.g.a.i.d dVar7 = e4.U;
                    if (dVar7 != null) {
                        ((e.g.a.i.k) dVar7).q0.remove(e4);
                        e4.C();
                    }
                    e4.U = eVar;
                    SparseArray<e.g.a.i.d> sparseArray = constraintLayout.q;
                    ...
                    if (childAt5 instanceof e.g.c.b) {
                        ((e.g.c.b) childAt5).j(e4, constraintLayout.f111d.v0);
                    }
                    if (aVar6.c0) {
                        f fVar = (f) e4;
                        int i33 = aVar6.m0;
                        ...
                        z3 = isInEditMode;
                        if (i42 != -1) {
                            e.g.a.i.d dVar8 = sparseArray.get(i42);
                            if (dVar8 != null) {
                                float f6 = aVar6.q;
                                int i43 = aVar6.p;
                            ...
                            if (i36 != -1) {
                                e.g.a.i.d dVar9 = sparseArray.get(i36);
                                if (dVar9 != null) {
                                ...
                                if (i38 != -1) {
                                    e.g.a.i.d dVar10 = sparseArray.get(i38);
                                    if (dVar10 != null) {
                                    ...
                                    i7 = aVar6.f124h;
                                    if (i7 != -1) {
                                        e.g.a.i.d dVar11 = sparseArray.get(i7);
                                        if (dVar11 != null) {
                                        ...
                                        i8 = aVar6.f126j;
                                        if (i8 != -1) {
                                            e.g.a.i.d dVar12 = sparseArray.get(i8);
                                            if (dVar12 != null) {
                        ...
                        if (aVar6.Z) {
                            ...
                            e4.i(aVar).f1296g = ((ViewGroup.MarginLayoutParams) aVar6).leftMargin;
                            e4.i(aVar4).f1296g = ((ViewGroup.MarginLayoutParams) aVar6).rightMargin;
                        } else {
                            e4.T[0] = aVar10;
                            e4.N(0);
                        }
                        if (aVar6.a0) {
                            ...
                            e4.i(aVar3).f1296g = ((ViewGroup.MarginLayoutParams) aVar6).topMargin;
                            e4.i(aVar2).f1296g = ((ViewGroup.MarginLayoutParams) aVar6).bottomMargin;
                        } else {
                            e4.T[1] = aVar10;
                            e4.I(0);
                        }
