...
public class NestedScrollView extends FrameLayout implements l, i {
    ...
    public static class a extends e.i.i.c {
        @Override // e.i.i.c
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                    ...
                    if (!(i3 == -1 || (findPointerIndex = motionEvent.findPointerIndex(i3)) == -1)) {
                        ...
                        if (Math.abs(y2 - this.f167g) > this.o && (2 & getNestedScrollAxes()) == 0) {
                            this.f171k = true;
                            this.f167g = y2;
                            if (this.f172l == null) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
                    ...
                    if (this.f171k) {
                        ...
                        if (z2) {
                            ...
                            if (i8 < 0) {
                                ...
                                EdgeEffect edgeEffect2 = this.f165e;
                                if (edgeEffect2 != null && (!edgeEffect2.isFinished() || !this.f166f.isFinished())) {
                                    AtomicInteger atomicInteger = v.a;
                                    v.d.k(this);
                                }
                            } else {
                                ...
                                EdgeEffect edgeEffect22 = this.f165e;
                                AtomicInteger atomicInteger2 = v.a;
                                v.d.k(this);
                            }
                            edgeEffect.onRelease();
                            EdgeEffect edgeEffect222 = this.f165e;
                            AtomicInteger atomicInteger22 = v.a;
                            v.d.k(this);
                        }
                    }
                }
            ...
            boolean z3 = !this.f164d.isFinished();
            this.f171k = z3;
