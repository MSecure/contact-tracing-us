...
public class RecyclerView extends ViewGroup implements e.i.i.i {
    ...
    public e.t.a.a f211e;
    public boolean e0;

    /* renamed from: f  reason: collision with root package name */
    public e.t.a.b f212f;
    public final a0 f0;

    /* renamed from: g  reason: collision with root package name */
    public final e.t.a.a0 f213g;
    public e.t.a.j g0;
        ...
        public final void g(b0 b0Var) {
            ...
            if (bVar != null) {
                ...
                if (!((b0Var.f230j & 16) != 0)) {
                    ...
                    View view = b0Var.a;
                    recyclerView.m0();
                    e.t.a.b bVar2 = recyclerView.f212f;
                    int indexOfChild = ((e.t.a.u) bVar2.a).a.indexOfChild(view);
                    if (indexOfChild == -1) {
                        bVar2.l(view);
                    } else if (bVar2.b.d(indexOfChild)) {
                        bVar2.b.f(indexOfChild);
                        bVar2.l(view);
                        ((e.t.a.u) bVar2.a).c(indexOfChild);
                    } else {
                        z = false;
                    }
                    if (z) {
    ...
    public static abstract class m {
        ...
        /* renamed from: e  reason: collision with root package name */
        public e.t.a.z f237e;

        /* renamed from: f  reason: collision with root package name */
        public e.t.a.z f238f;
        ...
        public m() {
            ...
            b bVar = new b();
            this.f236d = bVar;
            this.f237e = new e.t.a.z(aVar);
            this.f238f = new e.t.a.z(bVar);
        }
        ...
        public void H0(View view, t tVar) {
            e.t.a.b bVar = this.a;
            int indexOfChild = ((e.t.a.u) bVar.a).a.indexOfChild(view);
            if (indexOfChild >= 0) {
                if (bVar.b.f(indexOfChild)) {
                    bVar.l(view);
                }
                ((e.t.a.u) bVar.a).c(indexOfChild);
            }
            tVar.g(view);
        }
        ...
        public void J0(int i2) {
            ...
            int f2;
            View a2;
            if (y(i2) != null && (a2 = ((e.t.a.u) bVar.a).a((f2 = (bVar = this.a).f(i2)))) != null) {
                if (bVar.b.f(f2)) {
                    bVar.l(a2);
                }
                ((e.t.a.u) bVar.a).c(f2);
        ...
        public void m0(View view, e.i.i.c0.b bVar) {
            b0 K = RecyclerView.K(view);
        ...
        public void n0(t tVar, y yVar, View view, e.i.i.c0.b bVar) {
        ...
        public View y(int i2) {
            ...
            return ((e.t.a.u) bVar.a).a(bVar.f(i2));
        }
    ...
    public final class t {
        ...
        public void a(b0 b0Var, boolean z) {
            ...
            View view = b0Var.a;
            e.t.a.w wVar = RecyclerView.this.p0;
            if (wVar != null) {
                w.a aVar = wVar.f1949e;
                e.i.i.v.u(view, aVar instanceof w.a ? aVar.f1951e.remove(view) : null);
            }
            if (z) {
        ...
        public b0 j(int i2, boolean z, long j2) {
                ...
                if (arrayList != null && (size = arrayList.size()) != 0) {
                    ...
                    if (b0Var != null) {
                        ...
                        if (b0Var == null) {
                            ...
                            while (true) {
                                if (i5 < size2) {
                                    ...
                                    if (!z) {
                                        e.t.a.b bVar = RecyclerView.this.f212f;
                                        ...
                                        while (true) {
                                            ...
                                            view = bVar.c.get(i6);
                                            Objects.requireNonNull((e.t.a.u) bVar.a);
                                            b0 K = RecyclerView.K(view);
                                            if (!(K.f() != i2 || K.k() || K.m())) {
                                                break;
                                            }
                                        ...
                                        if (view != null) {
                                            ...
                                            e.t.a.b bVar2 = RecyclerView.this.f212f;
                                            int indexOfChild = ((e.t.a.u) bVar2.a).a.indexOfChild(view);
                                            if (indexOfChild < 0) {
                        ...
                        if (RecyclerView.this.i0.f266g || !b0Var.j()) {
                            ...
                            s.a a3 = sVar2.a(b0Var.f226f);
                            a3.f247d = sVar2.b(a3.f247d, j7);
                            ...
                            if (accessibilityManager == null && accessibilityManager.isEnabled()) {
                                ...
                                e.t.a.w wVar = RecyclerView.this.p0;
                                if (wVar != null) {
                                    w.a aVar2 = wVar.f1949e;
                                    if (aVar2 instanceof w.a) {
                                        Objects.requireNonNull(aVar2);
                                        e.i.i.c g3 = e.i.i.v.g(view2);
                                        if (!(g3 == null || g3 == aVar2)) {
                                            aVar2.f1951e.put(view2, g3);
                                        }
                                    }
                                    e.i.i.v.u(view2, aVar2);
                                }
                            }
                            if (RecyclerView.this.i0.f266g) {
                                b0Var.f227g = i2;
            ...
            s.a a32 = sVar22.a(b0Var.f226f);
            a32.f247d = sVar22.b(a32.f247d, j72);
            accessibilityManager = RecyclerView.this.C;
            if (accessibilityManager == null && accessibilityManager.isEnabled()) {
            }
            if (RecyclerView.this.i0.f266g) {
    ...
    public class v extends g {
        ...
        public void b(int i2, int i3, Object obj) {
            RecyclerView.this.i(null);
            e.t.a.a aVar = RecyclerView.this.f211e;
                    ...
                    if (i6 == 0 && i8 == 0) {
                        ...
                        if (pointF != null) {
                            ...
                            if (!(f3 == 0.0f && pointF.y == 0.0f)) {
                                ...
                                aVar.b((int) (((float) nVar.o) * 1.2f), (int) (((float) nVar.p) * 1.2f), (int) (((float) nVar.f(10000)) * 1.2f), nVar.f1943i);
                            }
                        }
                        aVar.f259d = nVar.a;
                        nVar.c();
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i2) {
        ...
        Method method = e.i.i.w.a;
        int i3 = Build.VERSION.SDK_INT;
        this.c0 = i3 >= 26 ? viewConfiguration.getScaledHorizontalScrollFactor() : e.i.i.w.a(viewConfiguration, context);
        this.d0 = i3 >= 26 ? viewConfiguration.getScaledVerticalScrollFactor() : e.i.i.w.a(viewConfiguration, context);
        this.a0 = viewConfiguration.getScaledMinimumFlingVelocity();
        this.b0 = viewConfiguration.getScaledMaximumFlingVelocity();
        setWillNotDraw(getOverScrollMode() == 2);
        this.N.a = this.n0;
        this.f211e = new e.t.a.a(new e.t.a.v(this));
        this.f212f = new e.t.a.b(new e.t.a.u(this));
        AtomicInteger atomicInteger = e.i.i.v.a;
        ...
        setAccessibilityDelegateCompat(new e.t.a.w(this));
        ...
        if (z2) {
            ...
            new e.t.a.i(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(R$dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(R$dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(R$dimen.fastscroll_margin));
        } else {
            typedArray = obtainStyledAttributes;
            c2 = 2;
        }
    ...
    public e.t.a.w getCompatAccessibilityDelegate() {
        return this.p0;
    }
        ...
        if (getOverScrollMode() != 2) {
            if (motionEvent != null) {
                if (!((motionEvent.getSource() & 8194) == 8194)) {
                    ...
                    z2 = true;
                    AtomicInteger atomicInteger22 = e.i.i.v.a;
                    v.d.k(this);
                }
            }
            m(i2, i3);
    ...
    public void i0(int i2, int i3, int[] iArr) {
        ...
        for (int i5 = 0; i5 < e2; i5++) {
            ...
            b0 J2 = J(d2);
            if (!(J2 == null || (b0Var = J2.f229i) == null)) {
                View view = b0Var.a;
                int left = d2.getLeft();
                int top = d2.getTop();
    ...
    public boolean isNestedScrollingEnabled() {
        return getScrollingChildHelper().f1553d;
    }
    ...
    public void onAttachedToWindow() {
        ...
        this.o0 = false;
        if (C0) {
            ThreadLocal<e.t.a.j> threadLocal = e.t.a.j.f1909f;
            e.t.a.j jVar = threadLocal.get();
            this.g0 = jVar;
            if (jVar == null) {
                this.g0 = new e.t.a.j();
                AtomicInteger atomicInteger = e.i.i.v.a;
                ...
                e.t.a.j jVar2 = this.g0;
                jVar2.f1911d = (long) (1.0E9f / f2);
                        ...
                        if (!recyclerView.dispatchNestedPreFling(f6, f7)) {
                            ...
                            if (pVar != null) {
                                ...
                                if (layoutManager == null || yVar.a.getAdapter() == null || (Math.abs(i14) <= (minFlingVelocity = yVar.a.getMinFlingVelocity()) && Math.abs(i13) <= minFlingVelocity)) {
                                    ...
                                    if (z13) {
                                        e.t.a.t tVar = (e.t.a.t) yVar;
                                        if (!z13) {
                                            sVar = null;
                                        } else {
                                            sVar = new e.t.a.s(tVar, tVar.a.getContext());
                                        }
                                        if (sVar != null) {
                    ...
                    if (yVar.f269j) {
                        for (int e2 = this.f212f.e() - 1; e2 >= 0; e2--) {
                            ...
                            if (!K2.u()) {
                                ...
                                view3.getRight();
                                view3.getBottom();
                                b0 f2 = this.f213g.b.f(I2, null);
                                if (f2 != null && !f2.u()) {
                                    boolean d2 = this.f213g.d(f2);
                                    boolean d3 = this.f213g.d(K2);
                                    if (!d2 || f2 != K2) {
                                        j.c e3 = this.f213g.e(f2, 4);
                                        this.f213g.b(K2, cVar3);
                                        j.c e4 = this.f213g.e(K2, 8);
                                        if (e3 == null) {
                                            int e5 = this.f212f.e();
                                            for (int i3 = 0; i3 < e5; i3++) {
                                                b0 K3 = K(this.f212f.d(i3));
                                                if (K3 != K2 && I(K3) == I2) {
                                                    e eVar = this.m;
                                                    if (eVar == null || !eVar.b) {
                                                        StringBuilder sb = new StringBuilder();
                        ...
                        e.t.a.a0 a0Var = this.f213g;
                        a0.b bVar = this.y0;
                        for (int i4 = a0Var.a.f1232d - 1; i4 >= 0; i4--) {
                            b0 h2 = a0Var.a.h(i4);
    ...
    public final void r() {
        ...
        if (J2 == null) {
            ...
            yVar2.m = j2;
            yVar2.f271l = this.E ? -1 : J2.m() ? J2.f224d : J2.e();
            y yVar3 = this.i0;
            View view = J2.a;
            loop0:
            while (true) {
        ...
        if (this.i0.f269j) {
            ...
            for (int i2 = 0; i2 < e2; i2++) {
                b0 K2 = K(this.f212f.d(i2));
                if (!K2.u() && (!K2.k() || this.m.b)) {
                    j jVar = this.N;
                    j.e(K2);
                    K2.g();
                    this.f213g.c(K2, jVar.l(K2));
                    if (this.i0.f267h && K2.p() && !K2.m() && !K2.u() && !K2.k()) {
                        this.f213g.b.g(I(K2), K2);
                    }
                }
            }
        }
        if (this.i0.f270k) {
            ...
            for (int i4 = 0; i4 < this.f212f.e(); i4++) {
                b0 K4 = K(this.f212f.d(i4));
                if (!K4.u()) {
                    a0.a orDefault = this.f213g.a.getOrDefault(K4, null);
    ...
    public void setAccessibilityDelegateCompat(e.t.a.w wVar) {
        this.p0 = wVar;
        e.i.i.v.u(this, wVar);
    }
    ...
    public void setNestedScrollingEnabled(boolean z2) {
        ...
        if (scrollingChildHelper.f1553d) {
            View view = scrollingChildHelper.c;
            AtomicInteger atomicInteger = e.i.i.v.a;
            v.i.z(view);
        }
        scrollingChildHelper.f1553d = z2;
    }
