...
public class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public final EditText f617d;

    /* renamed from: e  reason: collision with root package name */
    public TextWatcher f618e;
    ...
    public final void b() {
        if (Build.VERSION.SDK_INT >= 24) {
            this.f617d.setImeHintLocales(getContext().getResources().getConfiguration().getLocales());
        }
    }
    ...
    public void setChecked(boolean z) {
        this.b.setChecked(z);
        int i2 = 0;
        this.f617d.setVisibility(z ? 0 : 4);
        Chip chip = this.b;
        if (z) {
            i2 = 8;
        }
        ...
        if (isChecked()) {
            ...
            if (!TextUtils.isEmpty(this.f617d.getText())) {
