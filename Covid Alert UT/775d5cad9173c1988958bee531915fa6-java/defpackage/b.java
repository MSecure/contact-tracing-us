    ...
    public final void onClick(View view) {
        ...
        if (i2 != 0) {
            if (i2 != 1) {
                if (i2 != 2) {
                    throw null;
                } else if (!TextUtils.isEmpty(((a) this.c).f3785e.q)) {
                    try {
                        g.a aVar = new g.a((Context) this.f327d);
                        aVar.a.f33f = Html.fromHtml(((a) this.c).f3785e.q);
                        g a = aVar.a();
            ...
            } else if (!TextUtils.isEmpty(((a) this.c).f3785e.o)) {
                try {
                    g.a aVar2 = new g.a((Context) this.f327d);
                    aVar2.a.f33f = Html.fromHtml(((a) this.c).f3785e.o);
                    g a2 = aVar2.a();
        ...
        } else if (!TextUtils.isEmpty(((a) this.c).f3785e.m)) {
            try {
                g.a aVar3 = new g.a((Context) this.f327d);
                aVar3.a.f33f = Html.fromHtml(((a) this.c).f3785e.m);
                g a3 = aVar3.a();
