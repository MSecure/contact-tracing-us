...
public class j extends r implements k {
    ...
    @Override // e.b.a.k
    public a k(a.AbstractC0015a aVar) {
        return null;
    }
    ...
    public final boolean onMenuItemSelected(int i2, MenuItem menuItem) {
        ...
        a v = v();
        if (menuItem.getItemId() != 16908332 || v == null || (v.d() & 4) == 0 || (w0 = m.e.w0(this)) == null) {
            return false;
        }
        if (shouldUpRecreateTask(w0)) {
            ...
            if (w != null) {
                ...
                while (true) {
                    try {
                        Intent x0 = m.e.x0(this, component);
                        if (x0 == null) {
                            break;
                        }
            ...
            if (!arrayList.isEmpty()) {
                ...
                a.C0033a.a(this, intentArr, null);
                try {
                    int i3 = c.b;
                    finishAffinity();
                    return true;
    ...
    public l u() {
        if (this.p == null) {
            e.e.c<WeakReference<l>> cVar = l.b;
