...
public class f extends MenuInflater {
    ...
    public static final Class<?>[] f738e;

    /* renamed from: f  reason: collision with root package name */
    public static final Class<?>[] f739f;
    ...
    public class b {
        ...
        public SubMenu a() {
            this.f745h = true;
            SubMenu addSubMenu = this.a.addSubMenu(this.b, this.f746i, this.f747j, this.f748k);
        ...
        public final void c(MenuItem menuItem) {
            boolean z2 = false;
            menuItem.setChecked(this.s).setVisible(this.t).setEnabled(this.u).setCheckable(this.r >= 1).setTitleCondensed(this.f749l).setIcon(this.m);
            int i2 = this.v;
            if (i2 >= 0) {
            ...
            if (this.z != null) {
                if (!f.this.c.isRestricted()) {
                    f fVar = f.this;
                    if (fVar.f740d == null) {
                        fVar.f740d = fVar.a(fVar.c);
                    }
                    menuItem.setOnMenuItemClickListener(new a(fVar.f740d, this.z));
                } else {
            ...
            if (this.r >= 2) {
                if (menuItem instanceof i) {
                    ...
                    try {
                        if (jVar.f808e == null) {
                            jVar.f808e = jVar.f807d.getClass().getDeclaredMethod("setExclusiveCheckable", Boolean.TYPE);
                        }
                        jVar.f808e.invoke(jVar.f807d, Boolean.TRUE);
                    } catch (Exception unused) {
                    }
                }
            }
            String str = this.x;
            if (str != null) {
                menuItem.setActionView((View) b(str, f.f738e, f.this.a));
                z2 = true;
            }
            int i3 = this.w;
            if (i3 > 0 && !z2) {
            ...
            d dVar = this.A;
            if (dVar != null && (menuItem instanceof e.i.d.a.b)) {
                ((e.i.d.a.b) menuItem).a(dVar);
            }
        ...
        while (true) {
            if (eventType == 2) {
                ...
                if (name.equals("menu")) {
                    ...
                    throw new RuntimeException(f.a.a.a.a.w("Expecting menu, got ", name));
                }
            } else {
                eventType = xmlPullParser.next();
                if (eventType == 1) {
            ...
            if (eventType != 1) {
                if (eventType != 2) {
                    if (eventType == 3) {
                        ...
                        if (z2 && name2.equals(str)) {
                            ...
                            if (!bVar.f745h) {
                                ...
                                if (dVar == null || !dVar.a()) {
                                    bVar.f745h = true;
                                    bVar.c(bVar.a.add(bVar.b, bVar.f746i, bVar.f747j, bVar.f748k));
                                } else {
                                    bVar.a();
                                }
                            }
                    ...
                    if (name3.equals("group")) {
                        ...
                        bVar.f741d = obtainStyledAttributes.getInt(R$styleable.MenuGroup_android_orderInCategory, 0);
                        bVar.f742e = obtainStyledAttributes.getInt(R$styleable.MenuGroup_android_checkableBehavior, 0);
                        bVar.f743f = obtainStyledAttributes.getBoolean(R$styleable.MenuGroup_android_visible, true);
                        bVar.f744g = obtainStyledAttributes.getBoolean(R$styleable.MenuGroup_android_enabled, true);
                        obtainStyledAttributes.recycle();
                    } else if (name3.equals("item")) {
                        c1 p = c1.p(f.this.c, attributeSet, R$styleable.MenuItem);
                        bVar.f746i = p.l(R$styleable.MenuItem_android_id, 0);
                        bVar.f747j = (p.j(R$styleable.MenuItem_android_menuCategory, bVar.c) & -65536) | (p.j(R$styleable.MenuItem_android_orderInCategory, bVar.f741d) & 65535);
                        bVar.f748k = p.n(R$styleable.MenuItem_android_title);
                        bVar.f749l = p.n(R$styleable.MenuItem_android_titleCondensed);
                        ...
                        bVar.r = p.o(i2) ? p.a(i2, false) : bVar.f742e ? 1 : 0;
                        bVar.s = p.a(R$styleable.MenuItem_android_checked, false);
                        bVar.t = p.a(R$styleable.MenuItem_android_visible, bVar.f743f);
                        bVar.u = p.a(R$styleable.MenuItem_android_enabled, bVar.f744g);
                        ...
                        if ((m3 != null) && bVar.w == 0 && bVar.x == null) {
                            bVar.A = (d) bVar.b(m3, f739f, f.this.b);
                        } else {
                            bVar.A = null;
                        }
