...
public class c extends e.b.e.i.b {
    ...
    public class a extends l {
        public a(Context context, r rVar, View view) {
            ...
            if (!rVar.A.g()) {
                View view2 = c.this.f847j;
                this.f812f = view2 == null ? (View) c.this.f767i : view2;
            }
            d(c.this.y);
        }
    ...
    public class RunnableC0018c implements Runnable {
        ...
        public void run() {
            g.a aVar;
            g gVar = c.this.f762d;
            if (!(gVar == null || (aVar = gVar.f789e) == null)) {
                aVar.b(gVar);
            }
            View view = (View) c.this.f767i;
    ...
    public class d extends q implements ActionMenuView.a {
        ...
        public d(Context context) {
            ...
            setVisibility(0);
            setEnabled(true);
            m.e.z1(this, getContentDescription());
    ...
    public View c(i iVar, View view, ViewGroup viewGroup) {
        ...
        if (actionView == null || iVar.f()) {
            if (view instanceof n.a) {
                ...
                aVar = (n.a) this.f763e.inflate(this.f766h, viewGroup, false);
            }
            aVar.d(iVar, 0);
    ...
    public void e(Context context, g gVar) {
        ...
        if (this.m) {
            if (this.f847j == null) {
                ...
                this.f847j = dVar;
                if (this.f849l) {
                    dVar.setImageDrawable(this.f848k);
                    this.f848k = null;
                    this.f849l = false;
                }
                int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(0, 0);
                this.f847j.measure(makeMeasureSpec, makeMeasureSpec);
            }
            i5 -= this.f847j.getMeasuredWidth();
        } else {
            this.f847j = null;
        }
        this.p = i5;
    ...
    public void j(boolean z) {
        ...
        if (viewGroup != null) {
                ...
                for (int i3 = 0; i3 < size; i3++) {
                    ...
                    if (iVar.g()) {
                        ...
                        if (c != childAt) {
                            ...
                            ((ViewGroup) this.f767i).addView(c, i2);
                        }
                        i2++;
                    }
                }
            ...
            while (i2 < viewGroup.getChildCount()) {
                if (viewGroup.getChildAt(i2) == this.f847j) {
                    z2 = false;
                } else {
        ...
        if (gVar2 != null) {
            gVar2.i();
            ArrayList<i> arrayList2 = gVar2.f793i;
            int size2 = arrayList2.size();
            for (int i4 = 0; i4 < size2; i4++) {
                e.i.i.d dVar = arrayList2.get(i4).A;
            }
        }
        g gVar3 = this.f762d;
        if (gVar3 != null) {
            gVar3.i();
            arrayList = gVar3.f794j;
        }
        ...
        if (z3) {
            if (dVar2 == null) {
                this.f847j = new d(this.b);
            }
            ViewGroup viewGroup3 = (ViewGroup) this.f847j.getParent();
            if (viewGroup3 != this.f767i) {
                if (viewGroup3 != null) {
                    viewGroup3.removeView(this.f847j);
                }
                ActionMenuView actionMenuView = (ActionMenuView) this.f767i;
                d dVar3 = this.f847j;
                ActionMenuView.c q2 = actionMenuView.h();
                q2.a = true;
                actionMenuView.addView(dVar3, q2);
            }
        } else if (dVar2 != null && dVar2.getParent() == (nVar = this.f767i)) {
            ((ViewGroup) nVar).removeView(this.f847j);
        }
        ((ActionMenuView) this.f767i).setOverflowReserved(this.m);
    }

    public boolean k() {
        n nVar;
        RunnableC0018c cVar = this.w;
        if (cVar == null || (nVar = this.f767i) == null) {
            e eVar = this.u;
            if (eVar == null) {
                return false;
            }
    ...
    public boolean n() {
        g gVar;
        if (!this.m || m() || (gVar = this.f762d) == null || this.f767i == null || this.w != null) {
            return false;
        }
        gVar.i();
        if (gVar.f794j.isEmpty()) {
            return false;
        }
        RunnableC0018c cVar = new RunnableC0018c(new e(this.c, this.f762d, this.f847j, true));
        this.w = cVar;
        ((View) this.f767i).post(cVar);
        return true;
    }
}
