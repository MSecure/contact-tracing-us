...
public class s extends PopupWindow {
    public s(Context context, AttributeSet attributeSet, int i2, int i3) {
        ...
        if (obtainStyledAttributes.hasValue(i4)) {
            m.e.t1(this, obtainStyledAttributes.getBoolean(i4, false));
        }
        int i5 = R$styleable.PopupWindow_android_popupBackground;
        setBackgroundDrawable((!obtainStyledAttributes.hasValue(i5) || (resourceId = obtainStyledAttributes.getResourceId(i5, 0)) == 0) ? obtainStyledAttributes.getDrawable(i5) : m.e.h0(context, resourceId));
