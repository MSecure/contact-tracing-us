...
public class a extends c<Boolean> {
    ...
    public static final String f1087i = n.e("BatteryChrgTracker");

    public a(Context context, e.b0.a0.t.t.a aVar) {
        super(context, aVar);
    }
    ...
    public Object a() {
        ...
        if (registerReceiver == null) {
            n.c().b(f1087i, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
    ...
    public void g(Context context, Intent intent) {
        ...
        if (action != null) {
            char c = 0;
            n.c().a(f1087i, String.format("Received %s", action), new Throwable[0]);
