...
public class e implements Runnable {
    ...
    public static final String f1130d = n.e("EnqueueRunnable");
    public final g b;
    ...
    public static boolean a(g gVar) {
        ...
        if (list != null) {
            ...
            for (g gVar3 : list) {
                if (!gVar3.f1018h) {
                    ...
                    n.c().f(f1130d, String.format("Already enqueued work ids (%s).", TextUtils.join(", ", gVar3.f1015e)), new Throwable[0]);
                }
            }
        } else {
            z = false;
        ...
        l lVar = gVar.a;
        List<? extends x> list2 = gVar.f1014d;
        ...
        if (z12) {
            ...
            while (i2 < length) {
                ...
                if (i3 == null) {
                    n.c().b(f1130d, String.format("Prerequisite %s doesn't exist; not enqueuing", str2), new Throwable[0]);
                    break;
                }
                v vVar6 = i3.b;
                z4 &= vVar6 == vVar3;
            ...
            if (!arrayList2.isEmpty()) {
                if (hVar == h.APPEND || hVar == hVar2) {
                    ...
                    while (it.hasNext()) {
                        ...
                        String str3 = aVar.a;
                        e.b0.a0.s.c cVar = (e.b0.a0.s.c) m;
                        ...
                        cVar.a.b();
                        Cursor b2 = e.u.p.b.b(cVar.a, t, false, null);
                        try {
                            if (!(b2.moveToFirst() && b2.getInt(0) != 0)) {
                                v vVar7 = aVar.b;
                                boolean z14 = z4 & (vVar7 == vVar3);
                                if (vVar7 == vVar5) {
                                    z5 = true;
                                } else if (vVar7 == vVar4) {
                                    z6 = true;
                        ...
                        if (i4 < 23 || i4 > 25) {
                            if (i4 <= 22) {
                                try {
                                    ...
                                    Iterator<e.b0.a0.e> it3 = lVar.f1028e.iterator();
                                    while (true) {
                                        if (!it3.hasNext()) {
                                            break;
                            ...
                            if (z9) {
                                ...
                                while (i5 < length2) {
                                    ...
                                    e.b0.a0.s.c cVar2 = (e.b0.a0.s.c) workDatabase.m();
                                    cVar2.a.b();
                                    cVar2.a.c();
                                    try {
                                        cVar2.b.e(aVar2);
                            ...
                            if (!z7) {
                                ...
                                e.b0.a0.s.l lVar2 = (e.b0.a0.s.l) p;
                                lVar2.a.b();
                                lVar2.a.c();
                                try {
                                    lVar2.b.e(jVar);
    ...
    public static void b(o oVar) {
        ...
        if (dVar.f1162d || dVar.f1163e) {
            f.a aVar = new f.a();
            aVar.b(oVar.f1113e.a);
            ...
            if (!g.b(gVar, new HashSet())) {
                ...
                try {
                    ...
                    if (a) {
                        ...
                        l lVar = this.b.a;
                        e.b0.a0.f.a(lVar.b, lVar.c, lVar.f1028e);
                    }
                    this.c.a(e.b0.q.a);
                } finally {
                    workDatabase.g();
