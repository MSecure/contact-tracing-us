...
public class c {
    ...
    public static final class a extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            Boolean bool = (Boolean) new r(R$id.tag_screen_reader_focusable, Boolean.class, 28).d(view);
            boolean z = true;
            ...
            Boolean bool2 = (Boolean) new u(R$id.tag_accessibility_heading, Boolean.class, 28).d(view);
            ...
            CharSequence charSequence = (CharSequence) new t(R$id.tag_state_description, CharSequence.class, 64, 30).d(view);
            if (i3 < 30) {
                z = false;
            }
            if (z) {
                bVar.a.setStateDescription(charSequence);
            } else {
                bVar.a.getExtras().putCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.STATE_DESCRIPTION_KEY", charSequence);
            }
            this.a.d(view, bVar);
            ...
            if (i3 < 26) {
                ...
                if (d2 != null && d2.length > 0) {
                    ...
                    for (int i8 = 0; i8 < d2.length; i8++) {
                        ClickableSpan clickableSpan = d2[i8];
                        int i9 = 0;
                        while (true) {
                        ...
                        sparseArray2.put(i2, new WeakReference(d2[i8]));
                        ClickableSpan clickableSpan2 = d2[i8];
    ...
    public e.i.i.c0.c b(View view) {
        ...
        if (accessibilityNodeProvider != null) {
            return new e.i.i.c0.c(accessibilityNodeProvider);
        }
        return null;
    }
