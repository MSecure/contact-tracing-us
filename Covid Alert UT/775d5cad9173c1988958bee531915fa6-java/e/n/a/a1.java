...
public abstract class a1 {
    ...
    public static class c extends d {
        ...
        public void d() {
            if (this.b == d.b.ADDING) {
                ...
                m.d dVar = mVar.I;
                u0.setAlpha(dVar == null ? 1.0f : dVar.n);
            }
        }
    }
    ...
    public static class d {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final HashSet<e.i.e.a> f1662e = new HashSet<>();
        ...
        public class a implements a.AbstractC0034a {
            public a() {
            }
        ...
        public enum c {
            ...
            public static c b(int i2) {
                ...
                throw new IllegalArgumentException(f.a.a.a.a.t("Unknown visibility ", i2));
            }
        ...
        public void b() {
            if (!this.f1664g) {
                ...
                this.f1664g = true;
                for (Runnable runnable : this.f1661d) {
                    runnable.run();
                }
            }
        }
    ...
    public final void a(d.c cVar, d.b bVar, k0 k0Var) {
        synchronized (this.b) {
            ...
            this.b.add(cVar2);
            cVar2.f1661d.add(new a(cVar2));
            cVar2.f1661d.add(new b(cVar2));
        }
    }
    ...
    public final d d(m mVar) {
        ...
        while (it.hasNext()) {
            d next = it.next();
            if (next.c.equals(mVar) && !next.f1663f) {
                return next;
            }
        }
        return null;
    ...
    public final void i() {
        ...
        while (it.hasNext()) {
            ...
            if (next.b == d.b.ADDING) {
                next.c(d.c.b(next.c.u0().getVisibility()), d.b.NONE);
            }
        }
    }
}
