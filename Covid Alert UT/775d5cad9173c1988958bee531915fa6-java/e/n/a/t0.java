...
public class t0 {
    ...
    static {
        v0 v0Var;
        try {
            v0Var = (v0) Class.forName("e.y.d").getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
    ...
    public static void a(ArrayList<View> arrayList, e.e.a<String, View> aVar, Collection<String> collection) {
        for (int i2 = aVar.f1232d - 1; i2 >= 0; i2--) {
            View k2 = aVar.k(i2);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0038, code lost:
        if (r0.f1732l != false) goto L_0x0086;
     */
            ...
            if (i3 != 1) {
                if (i3 != 3) {
                    if (i3 != 4) {
                        ...
                        if (z4 && (bVar == null || bVar.f1784d == null)) {
                            if (bVar == null) {
                                b bVar3 = new b();
                            ...
                            if (mVar8 == null || mVar9 == null) {
                                ...
                                if (i14 == null && j2 == null && obj8 == null) {
                                    ...
                                    if (obj8 != null) {
                                        ...
                                        arrayList5 = arrayList12;
                                        n(g2, obj8, j2, f2, bVar.f1785e, bVar.f1786f);
                                        Rect rect3 = new Rect();
                                    ...
                                    if (!(i14 == null && obj6 == null && j2 == null)) {
                                        ...
                                        if (m2 != null) {
                                            if (mVar7 != null && j2 != null && mVar7.f1732l && mVar7.z && mVar7.J) {
                                                mVar7.A0(true);
                                                g2.q(j2, mVar7.F, h2);
                                                q.a(mVar7.E, new o0(h2));
                                            }
                            ...
                            if (mVar12 == null || mVar13 == null) {
                                ...
                                if (i15 == null && j3 == null && obj4 == null) {
                                    ...
                                    if (obj4 != null) {
                                        ...
                                        n(g3, obj5, j3, f3, bVar.f1785e, bVar.f1786f);
                                        if (i15 != null) {
                                            g3.s(i15, rect);
                                        }
                                    } else {
                                    ...
                                    if (i15 == null || obj != null || obj2 != null) {
                                        ...
                                        if (m == null) {
                                            ...
                                            q.a(viewGroup, new q0(i15, g3, view2, mVar2, arrayList4, arrayList16, h4, obj2));
