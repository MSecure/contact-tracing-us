...
public class l extends q<k> {
    ...
    public j b(k kVar, Bundle bundle, o oVar, q.a aVar) {
        ...
        if (i2 == 0) {
            ...
            int i3 = kVar2.f1850d;
            if (i3 != 0) {
                if (kVar2.f1851e == null) {
                    kVar2.f1851e = Integer.toString(i3);
                }
                str = kVar2.f1851e;
            } else {
        ...
        if (kVar2.f1861l == null) {
            kVar2.f1861l = Integer.toString(kVar2.f1860k);
        }
        throw new IllegalArgumentException(a.c("navigation destination ", kVar2.f1861l, " is not a direct child of this NavGraph"));
    }
