...
public abstract class p<T> {
    ...
    public static final p<int[]> f1867d = new e(true);

    /* renamed from: e  reason: collision with root package name */
    public static final p<Long> f1868e = new f(false);

    /* renamed from: f  reason: collision with root package name */
    public static final p<long[]> f1869f = new g(true);

    /* renamed from: g  reason: collision with root package name */
    public static final p<Float> f1870g = new h(false);

    /* renamed from: h  reason: collision with root package name */
    public static final p<float[]> f1871h = new i(true);

    /* renamed from: i  reason: collision with root package name */
    public static final p<Boolean> f1872i = new j(false);

    /* renamed from: j  reason: collision with root package name */
    public static final p<boolean[]> f1873j = new k(true);

    /* renamed from: k  reason: collision with root package name */
    public static final p<String> f1874k = new a(true);

    /* renamed from: l  reason: collision with root package name */
    public static final p<String[]> f1875l = new b(true);
    ...
    public static final class l<D extends Enum> extends C0052p<D> {
    ...
    /* renamed from: e.s.p$p  reason: collision with other inner class name */
    public static class C0052p<D extends Serializable> extends p<D> {
        public final Class<D> m;

        public C0052p(Class<D> cls) {
            super(true);
            if (!Serializable.class.isAssignableFrom(cls)) {
                throw new IllegalArgumentException(cls + " does not implement Serializable.");
            } else if (!cls.isEnum()) {
        ...
        public C0052p(boolean z, Class<D> cls) {
            super(z);
            if (Serializable.class.isAssignableFrom(cls)) {
                this.m = cls;
                return;
        ...
        public boolean equals(Object obj) {
            ...
            return this.m.equals(((C0052p) obj).m);
        }
