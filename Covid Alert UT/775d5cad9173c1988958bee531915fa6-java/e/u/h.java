...
public class h extends c.a {
    ...
    public static abstract class a {
        ...
        public abstract void b(e.w.a.b bVar);

        public abstract void c(e.w.a.b bVar);

        public abstract void d(e.w.a.b bVar);

        public abstract void e(e.w.a.b bVar);

        public abstract void f(e.w.a.b bVar);

        public abstract b g(e.w.a.b bVar);
    }
    ...
    @Override // e.w.a.c.a
    public void b(e.w.a.b bVar, int i2, int i3) {
        List<e.u.o.a> list;
        int i4;
        boolean z;
        boolean z2;
        ...
        if (aVar != null) {
            ...
            if (i2 == i3) {
                ...
                while (true) {
                    ...
                    TreeMap<Integer, e.u.o.a> treeMap = dVar.a.get(Integer.valueOf(i5));
                    if (treeMap == null) {
                        break;
                    }
    ...
    public final void c(e.w.a.b bVar) {
        e.w.a.f.a aVar = (e.w.a.f.a) bVar;
        aVar.b.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        aVar.b.execSQL(f.a.a.a.a.c("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '", this.f1994d, "')"));
    }
}
