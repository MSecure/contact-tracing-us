...
public abstract class h implements Cloneable {
    ...
    public long f2046d = -1;

    /* renamed from: e  reason: collision with root package name */
    public TimeInterpolator f2047e = null;

    /* renamed from: f  reason: collision with root package name */
    public ArrayList<Integer> f2048f = new ArrayList<>();

    /* renamed from: g  reason: collision with root package name */
    public ArrayList<View> f2049g = new ArrayList<>();

    /* renamed from: h  reason: collision with root package name */
    public q f2050h = new q();

    /* renamed from: i  reason: collision with root package name */
    public q f2051i = new q();

    /* renamed from: j  reason: collision with root package name */
    public n f2052j = null;

    /* renamed from: k  reason: collision with root package name */
    public int[] f2053k = v;

    /* renamed from: l  reason: collision with root package name */
    public ArrayList<p> f2054l;
    ...
    public static void c(q qVar, View view, p pVar) {
        ...
        if (k2 != null) {
            if (qVar.f2057d.e(k2) >= 0) {
                qVar.f2057d.put(k2, null);
            } else {
                qVar.f2057d.put(k2, view);
            }
        }
        if (view.getParent() instanceof ListView) {
            ...
            if (listView.getAdapter().hasStableIds()) {
                ...
                if (e.e.d.b(eVar.c, eVar.f1218e, itemIdAtPosition) >= 0) {
    ...
    public String G(String str) {
        ...
        if (this.f2047e != null) {
            ...
            i4.append(this.f2047e);
            i4.append(") ");
            sb = i4.toString();
        }
        if (this.f2048f.size() <= 0 && this.f2049g.size() <= 0) {
            return sb;
        }
        String w2 = f.a.a.a.a.w(sb, "tgts(");
        if (this.f2048f.size() > 0) {
            for (int i5 = 0; i5 < this.f2048f.size(); i5++) {
                if (i5 > 0) {
                    w2 = f.a.a.a.a.w(w2, ", ");
                }
                StringBuilder h3 = f.a.a.a.a.h(w2);
                h3.append(this.f2048f.get(i5));
                w2 = h3.toString();
            }
        }
        if (this.f2049g.size() > 0) {
            for (int i6 = 0; i6 < this.f2049g.size(); i6++) {
                if (i6 > 0) {
                    w2 = f.a.a.a.a.w(w2, ", ");
                }
                StringBuilder h4 = f.a.a.a.a.h(w2);
                h4.append(this.f2049g.get(i6));
                w2 = h4.toString();
            }
        }
        return f.a.a.a.a.w(w2, ")");
    }
    ...
    public final void e(View view, boolean z) {
        if (view != null) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                pVar.c.add(this);
                f(pVar);
                c(z ? this.f2050h : this.f2051i, view, pVar);
            }
    ...
    public void h(ViewGroup viewGroup, boolean z) {
        i(z);
        if (this.f2048f.size() > 0 || this.f2049g.size() > 0) {
            for (int i2 = 0; i2 < this.f2048f.size(); i2++) {
                View findViewById = viewGroup.findViewById(this.f2048f.get(i2).intValue());
                if (findViewById != null) {
                    ...
                    pVar.c.add(this);
                    f(pVar);
                    c(z ? this.f2050h : this.f2051i, findViewById, pVar);
                }
            }
            for (int i3 = 0; i3 < this.f2049g.size(); i3++) {
                View view = this.f2049g.get(i3);
                p pVar2 = new p(view);
                if (z) {
                    g(pVar2);
                } else {
                ...
                pVar2.c.add(this);
                f(pVar2);
                c(z ? this.f2050h : this.f2051i, view, pVar2);
            }
            return;
        }
        e(viewGroup, z);
    ...
    public void m() {
        ...
        if (i2 == 0) {
            ...
            for (int i4 = 0; i4 < this.f2050h.c.h(); i4++) {
                View i5 = this.f2050h.c.i(i4);
                if (i5 != null) {
                    AtomicInteger atomicInteger = v.a;
                    v.d.r(i5, false);
                }
            }
            for (int i6 = 0; i6 < this.f2051i.c.h(); i6++) {
                View i7 = this.f2051i.c.i(i6);
                if (i7 != null) {
    ...
    public p n(View view, boolean z) {
        ...
        ArrayList<p> arrayList = z ? this.f2054l : this.m;
        if (arrayList == null) {
            return null;
        }
        int size = arrayList.size();
        ...
        return (z ? this.m : this.f2054l).get(i2);
    }
    ...
    public p q(View view, boolean z) {
        ...
        return (z ? this.f2050h : this.f2051i).a.getOrDefault(view, null);
    }
    ...
    public boolean s(View view) {
        return (this.f2048f.size() == 0 && this.f2049g.size() == 0) || this.f2048f.contains(Integer.valueOf(view.getId())) || this.f2049g.contains(view);
    }
    ...
    public void u(View view) {
        if (!this.q) {
            ...
            for (int i3 = i2 - 1; i3 >= 0; i3--) {
                b k2 = o2.k(i3);
                if (k2.a != null && b0Var.equals(k2.f2055d)) {
                    o2.h(i3).pause();
                }
            }
            ArrayList<d> arrayList = this.r;
        ...
        while (it.hasNext()) {
            ...
            if (o2.containsKey(next)) {
                ...
                if (next != null) {
                    ...
                    TimeInterpolator timeInterpolator = this.f2047e;
