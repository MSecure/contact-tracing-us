...
public class c extends f implements Animatable {
    ...
    public final Drawable.Callback f2076f;
    ...
    public static class b extends Drawable.ConstantState {
        ...
        /* renamed from: d  reason: collision with root package name */
        public ArrayList<Animator> f2077d;

        /* renamed from: e  reason: collision with root package name */
        public e.e.a<Animator, String> f2078e;
        ...
        public b(b bVar, Drawable.Callback callback, Resources resources) {
            if (bVar != null) {
                ...
                ArrayList<Animator> arrayList = bVar.f2077d;
                if (arrayList != null) {
                    int size = arrayList.size();
                    this.f2077d = new ArrayList<>(size);
                    this.f2078e = new e.e.a<>(size);
                    for (int i2 = 0; i2 < size; i2++) {
                        Animator animator = bVar.f2077d.get(i2);
                        Animator clone = animator.clone();
                        String orDefault = bVar.f2078e.getOrDefault(animator, null);
                        clone.setTarget(this.b.c.b.p.getOrDefault(orDefault, null));
                        this.f2077d.add(clone);
                        this.f2078e.put(clone, orDefault);
                    }
                    if (this.c == null) {
                        this.c = new AnimatorSet();
                    }
                    this.c.playTogether(this.f2077d);
                }
            }
        }
    ...
    public Drawable.ConstantState getConstantState() {
        ...
        return new C0066c(this.b.getConstantState());
    }
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    typedArray = m.e.W0(resources, theme, attributeSet, a.f2066e);
                    ...
                    typedArray = resources.obtainAttributes(attributeSet, a.f2067f);
                    String string = typedArray.getString(0);
                    int resourceId2 = typedArray.getResourceId(1, 0);
                    if (resourceId2 != 0) {
                        Context context = this.f2074d;
                        if (context != null) {
                            if (Build.VERSION.SDK_INT >= 24) {
                            ...
                            b bVar = this.c;
                            if (bVar.f2077d == null) {
                                bVar.f2077d = new ArrayList<>();
                                this.c.f2078e = new e.e.a<>();
                            }
                            this.c.f2077d.add(animator);
                            this.c.f2078e.put(animator, string);
                        } else {
                            typedArray.recycle();
        ...
        bVar2.c.playTogether(bVar2.f2077d);
    }
    ...
    /* renamed from: e.z.a.a.c$c  reason: collision with other inner class name */
    public static class C0066c extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            ...
            cVar.b = newDrawable;
            newDrawable.setCallback(cVar.f2076f);
            return cVar;
        }
