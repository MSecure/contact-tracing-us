    ...
    public final void b(Object obj) {
        ...
        if (set != null) {
            if (set.contains(dVar)) {
                sVar = exposureNotificationViewModel.f343h;
                bool = Boolean.TRUE;
            } else {
                sVar = exposureNotificationViewModel.f343h;
                bool = Boolean.FALSE;
        ...
        if (!z) {
            ...
            v0 v0Var = exposureNotificationViewModel.f345j;
