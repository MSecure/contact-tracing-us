...
public final class e implements m {
    ...
    public final f.b.a.b.i.u.a f2565d;

    /* renamed from: e  reason: collision with root package name */
    public final f.b.a.b.i.u.a f2566e;
    ...
    public static URL c(String str) {
        try {
            ...
            throw new IllegalArgumentException(f.a.a.a.a.w("Invalid url: ", str), e2);
        }
    }
    ...
    public f.b.a.b.i.p.g b(f.b.a.b.i.p.f fVar) {
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                u uVar = u.b;
                Long valueOf = Long.valueOf(this.f2566e.a());
                Long valueOf2 = Long.valueOf(this.f2565d.a());
                ...
                while (it2.hasNext()) {
                    ...
                    aVar.f2536f = Long.valueOf(str6 == null ? 0 : Long.valueOf(str6).longValue());
                    aVar.f2537g = new n(t.b.v.get(fVar4.f("net-type")), t.a.x.get(fVar4.f("mobile-subtype")));
                    if (fVar4.c() != null) {
                        aVar.b = fVar4.c();
                    }
                    if (aVar.a == null) {
                    ...
                    if (aVar.c == null) {
                        str3 = f.a.a.a.a.w(str3, " eventUptimeMs");
                    }
                    if (aVar.f2536f == null) {
                        str3 = f.a.a.a.a.w(str3, " timezoneOffsetSeconds");
                    }
                    if (str3.isEmpty()) {
                        arrayList3.add(new k(aVar.a.longValue(), aVar.b, aVar.c.longValue(), aVar.f2534d, aVar.f2535e, aVar.f2536f.longValue(), aVar.f2537g));
                        it2 = it2;
                        it = it;
                    } else {
                        throw new IllegalStateException(f.a.a.a.a.w("Missing required properties:", str3));
                    }
                }
                if (valueOf == null) {
                    str2 = " requestTimeMs";
                ...
                if (valueOf2 == null) {
                    str2 = f.a.a.a.a.w(str2, " requestUptimeMs");
                }
                if (str2.isEmpty()) {
                    arrayList2.add(new l(valueOf.longValue(), valueOf2.longValue(), jVar, num, str, arrayList3, uVar));
                    it = it;
                } else {
                    throw new IllegalStateException(f.a.a.a.a.w("Missing required properties:", str2));
                }
            } else {
                ...
                try {
                    b bVar2 = (b) m.e.o1(5, new a(url, iVar, str4), new c(this), d.a);
                    int i2 = bVar2.a;
                    if (i2 == 200) {
