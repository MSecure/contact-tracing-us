    ...
    public final y1 createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < O1) {
            ...
            switch (65535 & readInt) {
                case 1:
                    arrayList = m.e.Q(parcel, readInt, TemporaryExposureKey.CREATOR);
                    break;
                case 2:
                    iBinder = m.e.k1(parcel, readInt);
                    break;
                case 3:
                    arrayList2 = m.e.Q(parcel, readInt, ParcelFileDescriptor.CREATOR);
                    break;
                case 4:
                    bVar = (b) m.e.L(parcel, readInt, b.CREATOR);
                    break;
                case 5:
