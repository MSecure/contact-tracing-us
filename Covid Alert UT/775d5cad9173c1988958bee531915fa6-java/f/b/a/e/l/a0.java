...
public class a0 implements f<Long> {
    ...
    public class a extends d {
        ...
        public final /* synthetic */ y f2886h;
    ...
    public String b(Context context) {
        ...
        String N0 = f.b.a.c.b.o.b.N0(l2.longValue());
        return resources.getString(R$string.mtrl_picker_date_header_selected, N0);
    }

    @Override // f.b.a.e.l.f
    public int c(Context context) {
        return f.b.a.c.b.o.b.m1(context, R$attr.materialCalendarTheme, q.class.getCanonicalName());
    }
    ...
    @Override // f.b.a.e.l.f
    public Collection<e.i.h.b<Long, Long>> e() {
    ...
    public View l(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, a aVar, y<Long> yVar) {
        ...
        editText.addTextChangedListener(new a(replace, simpleDateFormat, textInputLayout, aVar, yVar));
