...
public abstract class b<S extends c> extends ProgressBar {
    ...
    public final Runnable f2980l = new a();
    public final Runnable m = new RunnableC0095b();
    public final e.z.a.a.b n = new c();
    public final e.z.a.a.b o = new d();
    ...
    public class a implements Runnable {
        ...
        public void run() {
            b bVar = b.this;
            if (bVar.f2975g > 0) {
                bVar.f2976h = SystemClock.uptimeMillis();
            }
            bVar.setVisibility(0);
        }
    }

    /* renamed from: f.b.a.e.r.b$b  reason: collision with other inner class name */
    ...
    public class c extends e.z.a.a.b {
        public c() {
        }
        ...
        public void a(Drawable drawable) {
            ...
            b bVar = b.this;
            bVar.c(bVar.c, bVar.f2972d);
        }
    }

    public class d extends e.z.a.a.b {
        public d() {
        }
        ...
        public void a(Drawable drawable) {
            b bVar = b.this;
            if (!bVar.f2978j) {
                bVar.setVisibility(bVar.f2979k);
            }
        }
    }
    ...
    public b(Context context, AttributeSet attributeSet, int i2, int i3) {
        ...
        this.f2974f = obtainStyledAttributes.getInt(R$styleable.BaseProgressIndicator_showDelay, -1);
        this.f2975g = Math.min(obtainStyledAttributes.getInt(R$styleable.BaseProgressIndicator_minHideDelay, -1), 1000);
    ...
    public void b() {
        if (getVisibility() != 0) {
            removeCallbacks(this.f2980l);
            return;
        }
        removeCallbacks(this.m);
        long uptimeMillis = SystemClock.uptimeMillis() - this.f2976h;
        int i2 = this.f2975g;
    ...
    public void c(int i2, boolean z) {
        if (!isIndeterminate()) {
            ...
            this.f2972d = z;
            this.f2978j = true;
            if (!getIndeterminateDrawable().isVisible() || this.f2977i.a(getContext().getContentResolver()) == 0.0f) {
                this.n.a(getIndeterminateDrawable());
                return;
            }
            g gVar = (g) getIndeterminateDrawable().n;
            if (!gVar.f2989e.isRunning()) {
                if (gVar.a.isVisible()) {
                    gVar.f2989e.start();
                } else {
                    gVar.a();
    ...
    public int getShowAnimationBehavior() {
        return this.b.f2982e;
    }

    public int getTrackColor() {
        return this.b.f2981d;
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (!(getProgressDrawable() == null || getIndeterminateDrawable() == null)) {
            ((g) getIndeterminateDrawable().n).f2995k = this.n;
        }
        ...
        if (d()) {
            if (this.f2975g > 0) {
                this.f2976h = SystemClock.uptimeMillis();
            }
            setVisibility(0);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        if (getIndeterminateDrawable() != null) {
            ...
            ((g) getIndeterminateDrawable().n).f2995k = null;
        }
        if (getProgressDrawable() != null) {
    ...
    public void setAnimatorDurationScaleProvider(a aVar) {
        this.f2977i = aVar;
        if (getProgressDrawable() != null) {
            getProgressDrawable().f3000d = aVar;
        }
        if (getIndeterminateDrawable() != null) {
            getIndeterminateDrawable().f3000d = aVar;
        }
    }
    ...
    public void setIndicatorColor(int... iArr) {
        if (iArr.length == 0) {
            iArr = new int[]{f.b.a.c.b.o.b.v0(getContext(), R$attr.colorPrimary, -1)};
        }
