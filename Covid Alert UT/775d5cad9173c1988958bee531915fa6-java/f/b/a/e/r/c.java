...
public abstract class c {
    ...
    public c(Context context, AttributeSet attributeSet, int i2, int i3) {
        ...
        this.a = b.B0(context, obtainStyledAttributes, R$styleable.BaseProgressIndicator_trackThickness, dimensionPixelSize);
        this.b = Math.min(b.B0(context, obtainStyledAttributes, R$styleable.BaseProgressIndicator_trackCornerRadius, 0), this.a / 2);
        this.f2982e = obtainStyledAttributes.getInt(R$styleable.BaseProgressIndicator_showAnimationBehavior, 0);
        this.f2983f = obtainStyledAttributes.getInt(R$styleable.BaseProgressIndicator_hideAnimationBehavior, 0);
        int i5 = R$styleable.BaseProgressIndicator_indicatorColor;
        if (!obtainStyledAttributes.hasValue(i5)) {
            this.c = new int[]{b.v0(context, R$attr.colorPrimary, -1)};
        ...
        if (obtainStyledAttributes.hasValue(i6)) {
            ...
            i4 = b.H(this.f2981d, (int) (f2 * 255.0f));
        }
        this.f2981d = i4;
