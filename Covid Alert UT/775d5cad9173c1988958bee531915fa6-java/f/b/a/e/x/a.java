...
public class a extends e.k.a.a {
    ...
    public final h<String, Bundle> f3084d;
    ...
    public a(Parcel parcel, ClassLoader classLoader, C0098a aVar) {
        ...
        this.f3084d = new h<>(readInt);
        for (int i2 = 0; i2 < readInt; i2++) {
            this.f3084d.put(strArr[i2], bundleArr[i2]);
        }
    }
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        int i3 = this.f3084d.f1232d;
        parcel.writeInt(i3);
        String[] strArr = new String[i3];
        Bundle[] bundleArr = new Bundle[i3];
        for (int i4 = 0; i4 < i3; i4++) {
            strArr[i4] = this.f3084d.h(i4);
            bundleArr[i4] = this.f3084d.k(i4);
        }
