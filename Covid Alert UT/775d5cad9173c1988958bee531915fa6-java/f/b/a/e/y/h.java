...
public class h extends m {
    ...
    public final TextWatcher f3091e = new a();

    /* renamed from: f  reason: collision with root package name */
    public final View.OnFocusChangeListener f3092f = new b();

    /* renamed from: g  reason: collision with root package name */
    public final TextInputLayout.e f3093g = new c(this.a);

    /* renamed from: h  reason: collision with root package name */
    public final TextInputLayout.f f3094h = new d();

    /* renamed from: i  reason: collision with root package name */
    public final TextInputLayout.g f3095i = new e();

    /* renamed from: j  reason: collision with root package name */
    public boolean f3096j = false;

    /* renamed from: k  reason: collision with root package name */
    public boolean f3097k = false;

    /* renamed from: l  reason: collision with root package name */
    public long f3098l = Long.MAX_VALUE;
    ...
    public class a extends j {
        ...
        /* renamed from: f.b.a.e.y.h$a$a  reason: collision with other inner class name */
    ...
    public class c extends TextInputLayout.e {
        ...
        @Override // e.i.i.c, com.google.android.material.textfield.TextInputLayout.e
        ...
        public void a(TextInputLayout textInputLayout) {
            ...
            if (boxBackgroundMode == 2) {
                ...
                if (!(e2.getKeyListener() == null)) {
                    ...
                    int w0 = f.b.a.c.b.o.b.w0(e2, R$attr.colorControlHighlight);
                    int[][] iArr = {new int[]{16842919}, new int[0]};
                    if (boxBackgroundMode2 == 2) {
                        int w02 = f.b.a.c.b.o.b.w0(e2, R$attr.colorSurface);
                        g gVar = new g(boxBackground.b.a);
                        int a1 = f.b.a.c.b.o.b.a1(w0, w02, 0.1f);
                        gVar.q(new ColorStateList(iArr, new int[]{a1, 0}));
                        gVar.setTint(w02);
                        ColorStateList colorStateList = new ColorStateList(iArr, new int[]{a1, w02});
                        ...
                        RippleDrawable rippleDrawable = new RippleDrawable(new ColorStateList(iArr, new int[]{f.b.a.c.b.o.b.a1(w0, boxBackgroundColor, 0.1f), boxBackgroundColor}), boxBackground, boxBackground);
                ...
                e2.setOnFocusChangeListener(hVar3.f3092f);
                e2.setOnDismissListener(new k(hVar3));
                e2.setThreshold(0);
                e2.removeTextChangedListener(h.this.f3091e);
                e2.addTextChangedListener(h.this.f3091e);
                ...
                textInputLayout.setTextInputAccessibilityDelegate(h.this.f3093g);
            ...
            e2.setOnFocusChangeListener(hVar32.f3092f);
    ...
    public class e implements TextInputLayout.g {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                this.b.removeTextChangedListener(h.this.f3091e);
            }
        }
        ...
        public void a(TextInputLayout textInputLayout, int i2) {
            ...
            if (autoCompleteTextView != null && i2 == 3) {
                ...
                if (autoCompleteTextView.getOnFocusChangeListener() == h.this.f3092f) {
    ...
    public void a() {
        ...
        this.a.a(this.f3094h);
        TextInputLayout textInputLayout2 = this.a;
        textInputLayout2.l0.add(this.f3095i);
    ...
    public final g i(float f2, float f3, float f4, int i2) {
        j.b bVar = new j.b();
        bVar.f3054e = new f.b.a.e.v.a(f2);
        bVar.f3055f = new f.b.a.e.v.a(f2);
        bVar.f3057h = new f.b.a.e.v.a(f3);
        bVar.f3056g = new f.b.a.e.v.a(f3);
        f.b.a.e.v.j a2 = bVar.a();
        Context context = this.b;
        String str = g.y;
        int m1 = f.b.a.c.b.o.b.m1(context, R$attr.colorSurface, g.class.getSimpleName());
        g gVar = new g();
        gVar.b.b = new f.b.a.e.n.a(context);
        gVar.y();
        gVar.q(ColorStateList.valueOf(m1));
        g.b bVar2 = gVar.b;
        if (bVar2.o != f4) {
            bVar2.o = f4;
            gVar.y();
        ...
        gVar.invalidateSelf();
        g.b bVar3 = gVar.b;
        if (bVar3.f3040i == null) {
            bVar3.f3040i = new Rect();
        }
        gVar.b.f3040i.set(0, i2, 0, i2);
        gVar.invalidateSelf();
        return gVar;
    }

    public final boolean j() {
        long currentTimeMillis = System.currentTimeMillis() - this.f3098l;
