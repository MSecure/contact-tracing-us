...
public abstract class d<K, V> implements Map<K, V>, Serializable {
    ...
    public e<Map.Entry<K, V>> entrySet() {
        ...
        h hVar = (h) this;
        h.a aVar = new h.a(hVar, hVar.f3140f, 0, hVar.f3141g);
        this.b = aVar;
        return aVar;
    }
    ...
    /* renamed from: c */
    public b<V> values() {
        b<V> bVar = this.f3133d;
        if (bVar != null) {
            return bVar;
        }
        h hVar = (h) this;
        h.c cVar = new h.c(hVar.f3140f, 1, hVar.f3141g);
        this.f3133d = cVar;
        return cVar;
    }
    ...
    public int hashCode() {
        return f.b.a.c.b.o.b.P0(entrySet());
    }
    ...
    public Set keySet() {
        ...
        h hVar = (h) this;
        h.b bVar = new h.b(hVar, new h.c(hVar.f3140f, 0, hVar.f3141g));
        this.c = bVar;
        return bVar;
    }
