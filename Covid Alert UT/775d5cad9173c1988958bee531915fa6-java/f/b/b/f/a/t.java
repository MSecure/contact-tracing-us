...
public abstract class t<T> extends AtomicReference<Runnable> implements Runnable {
    ...
    public static final Runnable f3204d = new b(null);
        ...
        if (compareAndSet(null, currentThread)) {
                ...
                try {
                    ...
                    if (!compareAndSet(currentThread, b)) {
                        ...
                        while (true) {
                            ...
                            if (runnable != runnable2 && runnable != f3204d) {
                                break;
                            }
                            i2++;
                            if (i2 > 1000) {
                                Runnable runnable3 = f3204d;
            ...
            if (!compareAndSet(currentThread, b)) {
                ...
                while (true) {
                    ...
                    if (runnable4 != runnable5 && runnable4 != f3204d) {
                        break;
                    }
                    i3++;
                    if (i3 > 1000) {
                        Runnable runnable6 = f3204d;
    ...
    public final String toString() {
        ...
        i2.append(((d0.a) this).f3194e.toString());
        return i2.toString();
    }
}
