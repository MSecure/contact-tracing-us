...
public class b0 implements l0.c {
    ...
    public final Map<Integer, List<x>> f3261d = new HashMap();

    /* renamed from: e  reason: collision with root package name */
    public final int f3262e;

    /* renamed from: f  reason: collision with root package name */
    public final Queue<f> f3263f = new ArrayDeque();

    /* renamed from: g  reason: collision with root package name */
    public final Map<f, Integer> f3264g = new HashMap();

    /* renamed from: h  reason: collision with root package name */
    public final Map<Integer, a> f3265h = new HashMap();

    /* renamed from: i  reason: collision with root package name */
    public final j0 f3266i = new j0();

    /* renamed from: j  reason: collision with root package name */
    public final Map<f.b.c.k.r.f, Map<Integer, i<Void>>> f3267j = new HashMap();

    /* renamed from: k  reason: collision with root package name */
    public final Map<Integer, List<i<Void>>> f3268k;

    /* renamed from: l  reason: collision with root package name */
    public final d0 f3269l = new d0(1, 1);
    ...
    public void b(g0 g0Var) {
        ...
        for (Map.Entry<Integer, o0> entry : g0Var.b.entrySet()) {
            ...
            a aVar = this.f3265h.get(entry.getKey());
            if (aVar != null) {
                f.b.a.c.b.o.b.O0(value.f3414e.size() + (value.f3413d.size() + value.c.size()) <= 1, "Limbo resolution for single document contains multiple changes.", new Object[0]);
                if (value.c.size() > 0) {
                    aVar.b = true;
                } else if (value.f3413d.size() > 0) {
                    f.b.a.c.b.o.b.O0(aVar.b, "Received change for limbo target document without add.", new Object[0]);
                } else if (value.f3414e.size() > 0) {
                    f.b.a.c.b.o.b.O0(aVar.b, "Received remove for limbo target document without add.", new Object[0]);
                    aVar.b = false;
                }
            }
        }
    ...
    public f.b.c.g.a.f<f> d(int i2) {
        a aVar = this.f3265h.get(Integer.valueOf(i2));
        if (aVar != null && aVar.b) {
            return f.c.h(aVar.a);
        }
        f.b.c.g.a.f<f> fVar = f.c;
        if (this.f3261d.containsKey(Integer.valueOf(i2))) {
            for (x xVar : this.f3261d.get(Integer.valueOf(i2))) {
    ...
    public void e(int i2, c1 c1Var) {
        ...
        if (fVar != null) {
            this.f3264g.remove(fVar);
            this.f3265h.remove(Integer.valueOf(i2));
            k();
        ...
        this.f3261d.remove(Integer.valueOf(i2));
        f.b.c.g.a.f<f> d2 = this.f3266i.d(i2);
        this.f3266i.g(i2);
    ...
    public final void g(String str) {
        f.b.a.c.b.o.b.O0(this.n != null, "Trying to call %s before setting callback", str);
    }
    ...
    public final void j(int i2, c1 c1Var) {
        Integer valueOf;
        i<Void> iVar;
        Map<Integer, i<Void>> map = this.f3267j.get(this.m);
    ...
    public final void k() {
        while (!this.f3263f.isEmpty() && this.f3264g.size() < this.f3262e) {
            f.b.c.k.u.f remove = this.f3263f.remove();
            d0 d0Var = this.f3269l;
            int i2 = d0Var.a;
            d0Var.a = i2 + 2;
            this.f3265h.put(Integer.valueOf(i2), new a(remove));
            this.f3264g.put(remove, Integer.valueOf(i2));
            l0 l0Var = this.b;
    ...
    public final void l(f.b.c.k.u.f fVar) {
        Integer num = this.f3264g.get(fVar);
        if (num != null) {
            l0 l0Var = this.b;
            int intValue = num.intValue();
            f.b.a.c.b.o.b.O0(l0Var.c.remove(Integer.valueOf(intValue)) != null, "stopListening called on target no currently watched: %d", Integer.valueOf(intValue));
            if (l0Var.f3405f.c()) {
                l0Var.e(intValue);
            }
            if (l0Var.c.isEmpty()) {
                if (l0Var.f3405f.c()) {
                    l0Var.f3405f.e();
                } else if (l0Var.f3404e) {
                    l0Var.f3403d.c(v.UNKNOWN);
                }
            }
            this.f3264g.remove(fVar);
            this.f3265h.remove(num);
            k();
        }
    }

    public final void m(int i2) {
        if (this.f3268k.containsKey(Integer.valueOf(i2))) {
            for (i<Void> iVar : this.f3268k.get(Integer.valueOf(i2))) {
                iVar.a.r(null);
            }
