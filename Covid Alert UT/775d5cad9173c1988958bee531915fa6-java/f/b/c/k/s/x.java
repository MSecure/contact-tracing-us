...
public final class x {
    ...
    public static final w f3318k;

    /* renamed from: l  reason: collision with root package name */
    public static final w f3319l;
    public final List<w> a;
    public List<w> b;
    public c0 c;

    /* renamed from: d  reason: collision with root package name */
    public final List<i> f3320d;
    ...
    static {
        ...
        h hVar = h.c;
        f3318k = new w(aVar, hVar);
        f3319l = new w(w.a.DESCENDING, hVar);
    }
    ...
    public List<w> c() {
        ...
        if (this.b == null) {
            Iterator<i> it = this.f3320d.iterator();
            while (true) {
                z = false;
                if (!it.hasNext()) {
                    hVar = null;
            ...
            if (hVar == null || b2 != null) {
                ...
                if (!z) {
                    ...
                    arrayList.add(aVar.equals(aVar2) ? f3318k : f3319l);
                }
                this.b = arrayList;
            } else {
                if (hVar.s()) {
                    list = Collections.singletonList(f3318k);
                } else {
                    list = Arrays.asList(new w(aVar2, hVar), f3318k);
                }
                this.b = list;
            }
        }
    ...
    public c0 d() {
        if (this.c == null) {
            if (this.f3324h == a.LIMIT_TO_FIRST) {
                this.c = new c0(this.f3321e, this.f3322f, this.f3320d, c(), this.f3323g, this.f3325i, this.f3326j);
            } else {
                ArrayList arrayList = new ArrayList();
                for (w wVar : c()) {
                    w.a aVar = wVar.a;
                ...
                this.c = new c0(this.f3321e, this.f3322f, this.f3320d, arrayList, this.f3323g, cVar3, cVar2);
            }
        }
        return this.c;
    }
    ...
    public int hashCode() {
        return this.f3324h.hashCode() + (d().hashCode() * 31);
    }
    ...
    public String toString() {
        ...
        h2.append(";limitType=");
        h2.append(this.f3324h.toString());
        h2.append(")");
        return h2.toString();
    }
}
