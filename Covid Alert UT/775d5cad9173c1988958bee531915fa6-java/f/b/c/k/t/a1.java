...
public class a1 {
    ...
    public void c(int i2) {
        ...
        if (i2 < 7) {
            try {
                ...
                try {
                    ...
                    b.O0(l2 != null, "Missing highest sequence number", new Object[0]);
                    ...
                    while (true) {
                        ...
                        while (rawQueryWithFactory.moveToNext()) {
                            try {
                                ...
                                b.O0(compileStatement.executeInsert() != -1, "Failed to insert a sentinel row", new Object[0]);
                                z = true;
                            } catch (Throwable unused2) {
                            }
                        }
        ...
        if (i2 < 8) {
            ...
            while (rawQuery4.moveToNext()) {
                try {
                    ...
                    b.O0(lVar3.n() % 2 == 1, "Expected a collection path.", new Object[0]);
                    String h4 = lVar3.h();
                    l lVar4 = (l) lVar3.q();
        ...
        if (i2 < 9) {
            ...
            b.O0(d2 == d3, "Table contained just one of read_time_seconds or read_time_nanos", new Object[0]);
            if (!(d2 && d3)) {
