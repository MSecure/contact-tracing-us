...
public final /* synthetic */ class i implements n {
    ...
    public Object get() {
        ...
        r rVar = this.a;
        v vVar = this.b;
        SparseArray<d1> sparseArray = rVar.f3357h;
        m.a aVar = m.a.DEBUG;
        long j3 = -1;
        int i2 = 0;
        if (vVar.b.a == -1) {
        ...
        Cursor cursor = null;
        try {
            Cursor rawQuery = r0Var.f3364i.rawQuery("PRAGMA page_count", null);
            try {
                Long valueOf = rawQuery.moveToFirst() ? Long.valueOf(rawQuery.getLong(0)) : null;
                rawQuery.close();
                long longValue = valueOf.longValue();
                try {
                    Cursor rawQuery2 = r0Var.f3364i.rawQuery("PRAGMA page_size", null);
                    try {
                        ...
                        long j4 = r0Var2.f3359d.f3336f;
                        try {
                            Cursor rawQuery3 = r0Var2.f3364i.rawQuery("SELECT COUNT(*) FROM (SELECT sequence_number FROM target_documents GROUP BY path HAVING COUNT(*) = 1 AND target_id = 0)", null);
                            try {
                                ...
                                if (longValue3 == 0) {
                                    ...
                                    b1 b1Var = ((n0) vVar.a).a.f3359d;
                                    Cursor rawQuery4 = b1Var.a.f3364i.rawQuery("SELECT target_proto FROM targets", null);
                                    ...
                                    j2 = currentTimeMillis2;
                                    rawQuery4.close();
                                    Cursor rawQuery5 = ((n0) vVar.a).a.f3364i.rawQuery("select sequence_number from target_documents group by path having COUNT(*) = 1 AND target_id = 0", null);
                                ...
                                b1 b1Var2 = ((n0) vVar.a).a.f3359d;
                                int[] iArr = new int[1];
                                Cursor rawQueryWithFactory = b1Var2.a.f3364i.rawQueryWithFactory(new s0(new Object[]{Long.valueOf(j3)}), "SELECT target_id FROM targets WHERE last_listen_sequence_number <= ?", null, null);
                                while (rawQueryWithFactory.moveToNext()) {
                                    try {
                                        int i3 = rawQueryWithFactory.getInt(0);
                                        if (sparseArray.get(i3) == null) {
                                            b1Var2.a.f3364i.execSQL("DELETE FROM target_documents WHERE target_id = ?", new Object[]{Integer.valueOf(i3)});
                                            b1Var2.a.f3364i.execSQL("DELETE FROM targets WHERE target_id = ?", new Object[]{Integer.valueOf(i3)});
                                            b1Var2.f3336f--;
                                            iArr[0] = iArr[0] + 1;
                                ...
                                while (true) {
                                    ...
                                    while (true) {
                                        if (z) {
                                            SQLiteDatabase sQLiteDatabase = n0Var.a.f3364i;
