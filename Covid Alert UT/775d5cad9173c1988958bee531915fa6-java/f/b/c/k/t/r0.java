...
public final class r0 extends f0 {
    ...
    public final b1 f3359d;

    /* renamed from: e  reason: collision with root package name */
    public final l0 f3360e;

    /* renamed from: f  reason: collision with root package name */
    public final u0 f3361f;

    /* renamed from: g  reason: collision with root package name */
    public final n0 f3362g;

    /* renamed from: h  reason: collision with root package name */
    public final SQLiteTransactionListener f3363h;

    /* renamed from: i  reason: collision with root package name */
    public SQLiteDatabase f3364i;
    ...
    public r0(Context context, String str, f.b.c.k.u.b bVar, h hVar, v.a aVar) {
        try {
            ...
            this.b = bVar2;
            this.c = hVar;
            this.f3359d = new b1(this, hVar);
            this.f3360e = new l0(this);
            this.f3361f = new u0(this, hVar);
            this.f3362g = new n0(this, aVar);
    ...
    public <T> T g(String str, n<T> nVar) {
        ...
        this.f3364i.beginTransactionWithListener(this.f3363h);
        try {
            T t = nVar.get();
            this.f3364i.setTransactionSuccessful();
            return t;
        } finally {
            this.f3364i.endTransaction();
        }
    }
    ...
    public void i() {
        boolean z;
        boolean z2 = true;
        f.b.a.c.b.o.b.O0(!this.f3365j, "SQLitePersistence double-started!", new Object[0]);
        this.f3365j = true;
        try {
            this.f3364i = this.b.getWritableDatabase();
            b1 b1Var = this.f3359d;
            Cursor cursor = null;
            try {
                Cursor rawQuery = b1Var.a.f3364i.rawQuery("SELECT highest_target_id, highest_listen_sequence_number, last_remote_snapshot_version_seconds, last_remote_snapshot_version_nanos, target_count FROM target_globals LIMIT 1", null);
                if (rawQuery.moveToFirst()) {
                    b1Var.c = rawQuery.getInt(0);
                    b1Var.f3334d = (long) rawQuery.getInt(1);
                    b1Var.f3335e = new f.b.c.k.u.m(new d(rawQuery.getLong(2), rawQuery.getInt(3)));
                    b1Var.f3336f = rawQuery.getLong(4);
                    rawQuery.close();
                    z = true;
                } else {
                    rawQuery.close();
                ...
                f.b.a.c.b.o.b.O0(z2, "Missing target_globals entry", new Object[0]);
                this.f3362g.b = new s(this.f3359d.f3334d);
            } catch (Throwable th) {
                if (0 != 0) {
                    cursor.close();
                }
