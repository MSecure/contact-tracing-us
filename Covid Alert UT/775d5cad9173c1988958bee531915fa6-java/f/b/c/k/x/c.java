...
public class c {
    ...
    public class b {
        ...
        public final void b() {
            f.b.a.c.b.o.b.O0(this.b != null, "Caller should have verified scheduledFuture is non-null.", new Object[0]);
            this.b = null;
            f.b.a.c.b.o.b.O0(c.this.b.remove(this), "Delayed task not found.", new Object[0]);
        }
    }
    ...
    public class ExecutorC0120c implements Executor {
        ...
        public class b implements Runnable, ThreadFactory {
            ...
            public Thread newThread(Runnable runnable) {
                f.b.a.c.b.o.b.O0(this.c == null, "Only one thread may be created in an AsyncQueue.", new Object[0]);
                this.c = runnable;
                this.b.countDown();
