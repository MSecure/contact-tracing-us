...
public abstract class m extends i {
    ...
    public static final boolean c = v1.f3700h;
    public n a;
    ...
    public static abstract class b extends m {
        ...
        public final void f0(int i2) {
            if (m.c) {
                ...
                byte[] bArr2 = this.f3663d;
                int i4 = this.f3665f;
                this.f3665f = i4 + 1;
                v1.s(bArr2, (long) i4, (byte) i2);
                this.f3666g += (int) (((long) this.f3665f) - j2);
                return;
            }
            while ((i2 & -128) != 0) {
                byte[] bArr3 = this.f3663d;
                int i5 = this.f3665f;
                this.f3665f = i5 + 1;
        ...
        public final void g0(long j2) {
            if (m.c) {
                ...
                this.f3666g += (int) (((long) this.f3665f) - j3);
                return;
            }
            while ((j2 & -128) != 0) {
                byte[] bArr3 = this.f3663d;
    ...
    public static class c extends m {
        ...
        public final void H(byte b) {
            try {
                byte[] bArr = this.f3667d;
                int i2 = this.f3669f;
                this.f3669f = i2 + 1;
                bArr[i2] = b;
            } catch (IndexOutOfBoundsException e2) {
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3669f), Integer.valueOf(this.f3668e), 1), e2);
            }
        }
        ...
        public final void X(String str) {
            ...
            try {
                ...
                if (A2 == A) {
                    int i3 = i2 + A2;
                    this.f3669f = i3;
                    c = w1.c(str, this.f3667d, i3, G());
                    this.f3669f = i2;
                    a0((c - i2) - A2);
                } else {
                    a0(w1.d(str));
                    c = w1.c(str, this.f3667d, this.f3669f, G());
                }
                this.f3669f = c;
            } catch (w1.c e2) {
                this.f3669f = i2;
        ...
        public final void d0(byte[] bArr, int i2, int i3) {
            try {
                System.arraycopy(bArr, i2, this.f3667d, this.f3669f, i3);
                this.f3669f += i3;
            } catch (IndexOutOfBoundsException e2) {
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3669f), Integer.valueOf(this.f3668e), Integer.valueOf(i3)), e2);
            }
        }
    }
    ...
    public static class d extends IOException {
        public d(String str, Throwable th) {
            super(f.a.a.a.a.w("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str), th);
        }
    ...
    public static final class e extends b {
        ...
        public final OutputStream f3670h;

        public e(OutputStream outputStream, int i2) {
            super(i2);
            Objects.requireNonNull(outputStream, "out");
            this.f3670h = outputStream;
        }

        @Override // f.b.g.m
        public void H(byte b) {
            if (this.f3665f == this.f3664e) {
                h0();
            }
            byte[] bArr = this.f3663d;
            int i2 = this.f3665f;
        ...
        public void X(String str) {
            ...
            try {
                ...
                if (A2 == A) {
                    ...
                    try {
                        this.f3665f = i6;
                        int c2 = w1.c(str, this.f3663d, i6, this.f3664e - i6);
                        this.f3665f = i5;
                        i2 = (c2 - i5) - A2;
                        f0(i2);
                        this.f3665f = c2;
                    } catch (w1.c e2) {
                        this.f3666g -= this.f3665f - i5;
                        this.f3665f = i5;
                        throw e2;
                    ...
                    i2 = w1.d(str);
                    f0(i2);
                    this.f3665f = w1.c(str, this.f3663d, this.f3665f, i2);
                }
                this.f3666g += i2;
            } catch (w1.c e4) {
                F(str, e4);
        ...
        public final void h0() {
            this.f3670h.write(this.f3663d, 0, this.f3665f);
            this.f3665f = 0;
        }
        ...
        public void k0(byte[] bArr, int i2, int i3) {
            ...
            int i5 = this.f3665f;
            if (i4 - i5 >= i3) {
                System.arraycopy(bArr, i2, this.f3663d, i5, i3);
                this.f3665f += i3;
            } else {
                int i6 = i4 - i5;
                System.arraycopy(bArr, i2, this.f3663d, i5, i6);
                int i7 = i2 + i6;
                i3 -= i6;
                this.f3665f = this.f3664e;
                this.f3666g += i6;
                h0();
                if (i3 <= this.f3664e) {
                    System.arraycopy(bArr, i7, this.f3663d, 0, i3);
                    this.f3665f = i3;
                } else {
                    this.f3670h.write(bArr, i7, i3);
                }
            }
            this.f3666g += i3;
        }
