...
public class n1<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public static final /* synthetic */ int f3672h = 0;
    public final int b;
    public List<n1<K, V>.b> c = Collections.emptyList();

    /* renamed from: d  reason: collision with root package name */
    public Map<K, V> f3673d = Collections.emptyMap();

    /* renamed from: e  reason: collision with root package name */
    public boolean f3674e;

    /* renamed from: f  reason: collision with root package name */
    public volatile n1<K, V>.d f3675f;

    /* renamed from: g  reason: collision with root package name */
    public Map<K, V> f3676g = Collections.emptyMap();
    ...
    public class c implements Iterator<Map.Entry<K, V>> {
        ...
        /* renamed from: d  reason: collision with root package name */
        public Iterator<Map.Entry<K, V>> f3678d;
        ...
        public final Iterator<Map.Entry<K, V>> b() {
            if (this.f3678d == null) {
                this.f3678d = n1.this.f3673d.entrySet().iterator();
            }
            return (Iterator<Map.Entry<K, V>>) this.f3678d;
        }
        ...
        public boolean hasNext() {
            ...
            if (n1.this.f3673d.isEmpty() || !b().hasNext()) {
                return false;
            }
            return true;
        }
    ...
    public boolean containsKey(Object obj) {
        ...
        return a(comparable) >= 0 || this.f3673d.containsKey(comparable);
    }
    ...
    public Iterable<Map.Entry<K, V>> e() {
        return this.f3673d.isEmpty() ? (Iterable<Map.Entry<K, V>>) a.b : this.f3673d.entrySet();
    }

    @Override // java.util.AbstractMap, java.util.Map
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.f3675f == null) {
            this.f3675f = new d(null);
        }
        return this.f3675f;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (d2 != size) {
            return this.f3673d.equals(n1Var.f3673d);
        }
        return true;
    }
    ...
    public final SortedMap<K, V> f() {
        b();
        if (this.f3673d.isEmpty() && !(this.f3673d instanceof TreeMap)) {
            TreeMap treeMap = new TreeMap();
            this.f3673d = treeMap;
            this.f3676g = treeMap.descendingMap();
        }
        return (SortedMap) this.f3673d;
    }

    public void g() {
        if (!this.f3674e) {
            this.f3673d = this.f3673d.isEmpty() ? Collections.emptyMap() : Collections.unmodifiableMap(this.f3673d);
            this.f3676g = this.f3676g.isEmpty() ? Collections.emptyMap() : Collections.unmodifiableMap(this.f3676g);
            this.f3674e = true;
        }
    }
    ...
    public V get(Object obj) {
        ...
        return this.f3673d.get(comparable);
    }
    ...
    public int hashCode() {
        ...
        return this.f3673d.size() > 0 ? i2 + this.f3673d.hashCode() : i2;
    }
    ...
    public V remove(Object obj) {
        ...
        return this.f3673d.remove(comparable);
    }

    public int size() {
        return this.f3673d.size() + this.c.size();
    }
}
