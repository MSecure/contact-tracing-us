...
public final class x extends c<Float> implements c0.f, RandomAccess, c1 {
    ...
    public void add(int i2, Object obj) {
        ...
        if (i3 < fArr.length) {
            ...
            System.arraycopy(this.c, i2, fArr2, i2 + 1, this.f3719d - i2);
            this.c = fArr2;
        }
    ...
    public boolean addAll(Collection<? extends Float> collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(xVar.c, 0, this.c, this.f3719d, xVar.f3719d);
            this.f3719d = i4;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public int hashCode() {
        int i2 = 1;
        for (int i3 = 0; i3 < this.f3719d; i3++) {
    ...
    public final void j(int i2) {
        if (i2 < 0 || i2 >= this.f3719d) {
            throw new IndexOutOfBoundsException(k(i2));
        }
    }

    public final String k(int i2) {
        return "Index:" + i2 + ", Size:" + this.f3719d;
    }

    /* renamed from: l */
    public c0.f d(int i2) {
        if (i2 >= this.f3719d) {
            return new x(Arrays.copyOf(this.c, i2), this.f3719d);
        }
    ...
    public boolean remove(Object obj) {
        ...
        for (int i2 = 0; i2 < this.f3719d; i2++) {
            if (obj.equals(Float.valueOf(this.c[i2]))) {
                float[] fArr = this.c;
                System.arraycopy(fArr, i2 + 1, fArr, i2, (this.f3719d - i2) - 1);
                this.f3719d--;
                ((AbstractList) this).modCount++;
                return true;
            }
    ...
    public void removeRange(int i2, int i3) {
        ...
        if (i3 >= i2) {
            float[] fArr = this.c;
            System.arraycopy(fArr, i3, fArr, i2, this.f3719d - i3);
            this.f3719d -= i3 - i2;
            ((AbstractList) this).modCount++;
            return;
        }
