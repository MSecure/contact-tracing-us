...
public final class a {
    ...
    public final List<f.d.a.d.b> f3749d = new ArrayList();
    ...
    public static final class b extends f implements j.k.a.b<String, String> {
        ...
        public String d(String str) {
            ...
            h2.append(this.f3759d);
            return f.b.a.c.b.o.b.I0(context, h2.toString());
        }
    }
    ...
    public a(Context context, String[] strArr, Map<String, String> map) {
        ...
        while (it.hasNext()) {
            ...
            f.d.a.d.b bVar = null;
            try {
                String I0 = f.b.a.c.b.o.b.I0(context, "license_" + m + "_licenseDescription");
                if (h.o(I0, "raw:", false, 2)) {
                    Resources resources = context.getResources();
                    String l2 = h.l(I0, "raw:");
                ...
                bVar = new f.d.a.d.b(m, f.b.a.c.b.o.b.I0(context, "license_" + m + "_licenseName"), f.b.a.c.b.o.b.I0(context, "license_" + m + "_licenseWebsite"), f.b.a.c.b.o.b.I0(context, "license_" + m + "_licenseShortDescription"), str);
            } catch (Exception e2) {
        ...
        while (it2.hasNext()) {
            ...
            if (b3 != null) {
                ...
                if (!(str6 == null || (b2 = b(context, str6)) == null)) {
                    e.c(b2, "enchantWith");
                    String b4 = b3.b(b2.f3774e);
                    b3.f3774e = b4 == null ? b3.f3774e : b4;
                    String b5 = b3.b(b2.f3775f);
                    b3.f3775f = b5 == null ? b3.f3775f : b5;
                    String b6 = b3.b(b2.f3776g);
                    b3.f3776g = b6 == null ? b3.f3776g : b6;
                    String b7 = b3.b(b2.f3777h);
                    b3.f3777h = b7 == null ? b3.f3777h : b7;
                    String b8 = b3.b(b2.f3778i);
                    b3.f3778i = b8 == null ? b3.f3778i : b8;
                    String b9 = b3.b(b2.f3779j);
                    b3.f3779j = b9 == null ? b3.f3779j : b9;
                    String b10 = b3.b(b2.f3780k);
                    b3.f3780k = b10 == null ? b3.f3780k : b10;
                    Set<f.d.a.d.b> set = b2.f3781l;
                    b3.f3781l = set == null ? b3.f3781l : set;
                    b3.m = b2.m;
    ...
    public final List<f.d.a.d.a> a(List<f.d.a.d.a> list, String str, boolean z, int i2) {
        ...
        for (f.d.a.d.a aVar : list) {
            ...
            } else if (h.a(aVar.f3774e, str, true) || h.a(aVar.b, str, true)) {
                arrayList.add(aVar);
                i3++;
                if (i2 != -1 && i2 < i3) {
                    break;
    ...
    public final f.d.a.d.a b(Context context, String str) {
        ...
        try {
            f.d.a.d.a aVar = new f.d.a.d.a(m, false, false, f.b.a.c.b.o.b.I0(context, "library_" + m + "_libraryName"), null, null, null, null, null, null, null, false, null, null, 16374);
            HashMap<String, String> c2 = c(context, m);
            String I0 = f.b.a.c.b.o.b.I0(context, "library_" + m + "_author");
            e.c(I0, "<set-?>");
            aVar.f3775f = I0;
            String I02 = f.b.a.c.b.o.b.I0(context, "library_" + m + "_authorWebsite");
            e.c(I02, "<set-?>");
            aVar.f3776g = I02;
            String f2 = f(f.b.a.c.b.o.b.I0(context, "library_" + m + "_libraryDescription"), c2);
            e.c(f2, "<set-?>");
            aVar.f3777h = f2;
            String I03 = f.b.a.c.b.o.b.I0(context, "library_" + m + "_libraryVersion");
            e.c(I03, "<set-?>");
            aVar.f3778i = I03;
            String I04 = f.b.a.c.b.o.b.I0(context, "library_" + m + "_libraryArtifactId");
            e.c(I04, "<set-?>");
            aVar.f3779j = I04;
            String I05 = f.b.a.c.b.o.b.I0(context, "library_" + m + "_libraryWebsite");
            e.c(I05, "<set-?>");
            aVar.f3780k = I05;
            String I06 = f.b.a.c.b.o.b.I0(context, "library_" + m + "_licenseIds");
            String I07 = f.b.a.c.b.o.b.I0(context, "library_" + m + "_licenseId");
            if (!h.h(I06) || !h.h(I07)) {
                set = new LinkedHashSet<>();
                for (String str2 : h.h(I06) ? d.p(I07) : h.n(I06, new String[]{","}, false, 0, 6)) {
                    e.c(str2, "licenseName");
                    Iterator it = new ArrayList(this.f3749d).iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            bVar = null;
                            break;
                    ...
                    if (bVar != null) {
                        ...
                        String f3 = f(a2.f3782d, c2);
                        e.c(f3, "<set-?>");
                        a2.f3782d = f3;
                        String f4 = f(a2.f3783e, c2);
                        e.c(f4, "<set-?>");
                        a2.f3783e = f4;
                        set.add(a2);
                    }
                ...
                set = Collections.singleton(new f.d.a.d.b("", f.b.a.c.b.o.b.I0(context, "library_" + m + "_licenseVersion"), f.b.a.c.b.o.b.I0(context, "library_" + m + "_licenseLink"), f(f.b.a.c.b.o.b.I0(context, "library_" + m + "_licenseContent"), c2), f(f.b.a.c.b.o.b.I0(context, "library_" + m + "_licenseContent"), c2)));
                e.b(set, "java.util.Collections.singleton(element)");
            }
            aVar.f3781l = set;
            Boolean valueOf = Boolean.valueOf(f.b.a.c.b.o.b.I0(context, "library_" + m + "_isOpenSource"));
            e.b(valueOf, "java.lang.Boolean.valueO… name + \"_isOpenSource\"))");
            aVar.m = valueOf.booleanValue();
            String I08 = f.b.a.c.b.o.b.I0(context, "library_" + m + "_repositoryLink");
            e.c(I08, "<set-?>");
            aVar.n = I08;
            String I09 = f.b.a.c.b.o.b.I0(context, "library_" + m + "_classPath");
            e.c(I09, "<set-?>");
            aVar.o = I09;
            if (!h.h(aVar.f3774e) || !h.h(aVar.f3777h)) {
                return aVar;
            }
            return null;
        } catch (Exception e2) {
            ...
            if (!a2.isEmpty()) {
                ...
                if (!(strArr.length != 0)) {
                    for (String str3 : strArr) {
                        String I0 = f.b.a.c.b.o.b.I0(context, "library_" + str + "_" + str3);
                        if (I0.length() > 0) {
                            hashMap.put(str3, I0);
                        }
                    }
    ...
    public final f.d.a.d.a e(String str) {
        ...
        while (it.hasNext()) {
            ...
            if (h.b(aVar.f3774e, str, true) || h.b(aVar.b, str, true)) {
                return aVar;
            }
            while (it.hasNext()) {
            }
