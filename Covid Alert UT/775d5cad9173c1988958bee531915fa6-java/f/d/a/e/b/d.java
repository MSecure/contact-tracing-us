...
public final class d extends f.d.b.q.a<a> {
    ...
    public static final class a extends RecyclerView.b0 {
        ...
        public static final class C0132a extends f implements j.k.a.b<TypedArray, h> {
            ...
            public h d(TypedArray typedArray) {
                ...
                Context context = this.f3787d;
                e.b(context, "ctx");
                int i3 = R$attr.aboutLibrariesCardBackground;
                Context context2 = this.f3787d;
                e.b(context2, "ctx");
                materialCardView.setCardBackgroundColor(typedArray2.getColor(i2, f.b.a.c.b.o.b.M0(context, i3, f.b.a.c.b.o.b.J0(context2, R$color.about_libraries_card))));
                ...
                Context context3 = this.f3787d;
                e.b(context3, "ctx");
                int i6 = R$attr.aboutLibrariesOpenSourceDivider;
                Context context4 = this.f3787d;
                e.b(context4, "ctx");
                int i7 = R$color.about_libraries_dividerLight_openSource;
                view.setBackgroundColor(typedArray2.getColor(i5, f.b.a.c.b.o.b.M0(context3, i6, f.b.a.c.b.o.b.J0(context4, i7))));
                this.c.x.setTextColor(typedArray2.getColorStateList(i4));
                View view2 = this.c.y;
                Context context5 = this.f3787d;
                e.b(context5, "ctx");
                Context context6 = this.f3787d;
                e.b(context6, "ctx");
                view2.setBackgroundColor(typedArray2.getColor(i5, f.b.a.c.b.o.b.M0(context5, i6, f.b.a.c.b.o.b.J0(context6, i7))));
        ...
        public a(View view) {
            ...
            e.b(context, "ctx");
            f.b.a.c.b.o.b.n1(context, null, 0, 0, new C0132a(this, context), 7);
        }
    }
    ...
    public void g(RecyclerView.b0 b0Var, List list) {
        ...
        Context context = view.getContext();
        aVar.u.setText(this.b.f3774e);
        aVar.v.setText(this.b.f3775f);
        if (TextUtils.isEmpty(this.b.f3777h)) {
            textView = aVar.x;
            charSequence = this.b.f3777h;
        } else {
            textView = aVar.x;
            charSequence = Html.fromHtml(this.b.f3777h);
        }
        textView.setText(charSequence);
        Objects.requireNonNull(this.c);
        boolean z = false;
        if (!(!(this.b.f3778i.length() == 0) || (a3 = this.b.a()) == null || (str3 = a3.b) == null)) {
            if (str3.length() == 0) {
                aVar.y.setVisibility(8);
                aVar.z.setVisibility(8);
                aVar.A.setVisibility(8);
                if (this.b.f3776g.length() > 0) {
        ...
        String str4 = "";
        if (this.b.f3778i.length() > 0) {
            Objects.requireNonNull(this.c);
            aVar.z.setText(this.b.f3778i);
        } else {
            aVar.z.setText(str4);
        }
        if (!(this.b.a() == null || (a2 = this.b.a()) == null || (str2 = a2.b) == null)) {
            if ((str2.length() > 0) && this.c.f3761e) {
                textView2 = aVar.A;
