...
public final class d0 implements y1 {
    ...
    public final g1 f3907d;

    /* renamed from: e  reason: collision with root package name */
    public Runnable f3908e;

    /* renamed from: f  reason: collision with root package name */
    public Runnable f3909f;

    /* renamed from: g  reason: collision with root package name */
    public Runnable f3910g;

    /* renamed from: h  reason: collision with root package name */
    public y1.a f3911h;

    /* renamed from: i  reason: collision with root package name */
    public Collection<f> f3912i = new LinkedHashSet();
    ...
    public class f extends e0 {
        ...
        /* renamed from: i  reason: collision with root package name */
        public final h0.f f3916i;

        /* renamed from: j  reason: collision with root package name */
        public final q f3917j = q.L();
        ...
        public void g(c1 c1Var) {
            ...
            synchronized (d0.this.b) {
                d0 d0Var = d0.this;
                if (d0Var.f3910g != null) {
                    boolean remove = d0Var.f3912i.remove(this);
                    if (!d0.this.h() && remove) {
                        d0 d0Var2 = d0.this;
                        d0Var2.f3907d.b(d0Var2.f3909f);
                        d0 d0Var3 = d0.this;
                        if (d0Var3.f3913j != null) {
                            d0Var3.f3907d.b(d0Var3.f3910g);
                            d0.this.f3910g = null;
                        }
                    }
                }
    ...
    public final void a(c1 c1Var) {
        ...
        d(c1Var);
        synchronized (this.b) {
            collection = this.f3912i;
            runnable = this.f3910g;
            this.f3910g = null;
            if (!collection.isEmpty()) {
                this.f3912i = Collections.emptyList();
            }
        }
        if (runnable != null) {
    ...
    public final f b(h0.f fVar) {
        ...
        this.f3912i.add(fVar2);
        synchronized (this.b) {
            size = this.f3912i.size();
        }
        if (size == 1) {
            this.f3907d.b(this.f3908e);
        }
        return fVar2;
    }
    ...
    public final void d(c1 c1Var) {
        ...
        synchronized (this.b) {
            if (this.f3913j == null) {
                ...
                queue.add(dVar);
                if (!h() && (runnable = this.f3910g) != null) {
                    this.f3907d.b(runnable);
                    this.f3910g = null;
                }
                this.f3907d.a();
            }
    ...
    public final Runnable e(y1.a aVar) {
        this.f3911h = aVar;
        this.f3908e = new a(this, aVar);
        this.f3909f = new b(this, aVar);
        this.f3910g = new c(this, aVar);
        return null;
    }
    ...
    public final u g(o0<?, ?> o0Var, n0 n0Var, h.a.c cVar) {
        ...
        try {
            ...
            while (true) {
                synchronized (this.b) {
                    c1 c1Var = this.f3913j;
                    if (c1Var == null) {
                        h0.i iVar2 = this.f3914k;
                        if (iVar2 != null) {
                            if (iVar != null && j2 == this.f3915l) {
                                break;
                            }
                            j2 = this.f3915l;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0067, code lost:
        r6.f3912i.removeAll(r0);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0072, code lost:
        if (r6.f3912i.isEmpty() == false) goto L_0x007b;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0074, code lost:
        r6.f3912i = new java.util.LinkedHashSet();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x0090, code lost:
        r1 = r6.f3907d.c;
        f.b.a.c.b.o.b.z(r0, "runnable is null");
        r1.add(r0);
        r6.f3910g = null;
     */
    ...
    public final void i(h0.i iVar) {
        synchronized (this.b) {
            ...
            if (iVar != null) {
                if (h()) {
                    ArrayList arrayList = new ArrayList(this.f3912i);
                }
            }
        }
    }
