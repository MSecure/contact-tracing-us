...
public class e0 implements u {
    ...
    public List<Runnable> f3920e = new ArrayList();
    ...
    public static class n implements v {
        ...
        public class e implements Runnable {
            ...
            /* renamed from: d  reason: collision with root package name */
            public final /* synthetic */ n0 f3925d;
            ...
            public void run() {
                n.this.a.d(this.b, this.c, this.f3925d);
            }
        }
    ...
    public void k(y0 y0Var) {
        synchronized (this) {
            if (this.b != null) {
                if (this.c != null) {
                    y0Var.b("buffered_nanos", Long.valueOf(this.f3923h - this.f3922g));
                    this.c.k(y0Var);
                } else {
                    y0Var.b("buffered_nanos", Long.valueOf(System.nanoTime() - this.f3922g));
