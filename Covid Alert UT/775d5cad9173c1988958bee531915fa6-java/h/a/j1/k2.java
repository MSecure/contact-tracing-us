...
public final class k2 {
    ...
    public static class b extends c {
        ...
        public void K(byte[] bArr, int i2, int i3) {
            System.arraycopy(this.f3962d, this.b, bArr, i2, i3);
            this.b += i3;
        }
        ...
        public j2 v(int i2) {
            if (b() >= i2) {
                int i3 = this.b;
                this.b = i3 + i2;
                return new b(this.f3962d, i3, i2);
            }
