...
public final class m1 extends k0 implements c0<Object> {
    ...
    public final q0.a f3966d;

    /* renamed from: e  reason: collision with root package name */
    public final i f3967e;

    /* renamed from: f  reason: collision with root package name */
    public final x f3968f;

    /* renamed from: g  reason: collision with root package name */
    public final r f3969g;

    /* renamed from: h  reason: collision with root package name */
    public final Executor f3970h;

    /* renamed from: i  reason: collision with root package name */
    public final d2<? extends Executor> f3971i;

    /* renamed from: j  reason: collision with root package name */
    public final d2<? extends Executor> f3972j;
    ...
    public final class c implements Runnable {
        ...
        public void run() {
            ...
            Executor executor = m1Var.f3970h;
            h.a.n nVar = this.c;
    ...
    public final class o extends q0.e {
        ...
        public final void d() {
            ...
            m1 m1Var2 = m1.this;
            m1Var2.Y = m1Var2.n.c(new i(), a2, TimeUnit.NANOSECONDS, m1Var2.f3968f.p());
        }
    }
    ...
    public class p extends h.a.d {
        ...
        public <ReqT, RespT> h.a.f<ReqT, RespT> h(o0<ReqT, RespT> o0Var, h.a.c cVar) {
            ...
            Executor executor2 = executor == null ? m1Var.f3970h : executor;
            m1 m1Var2 = m1.this;
            p.c cVar2 = m1Var2.a0;
            if (m1Var2.I) {
                scheduledExecutorService = null;
            } else {
                scheduledExecutorService = m1.this.f3968f.p();
            }
    ...
    public static final class s extends q0.g {
        ...
        public q0.b a(Map<String, ?> map) {
            Object obj;
            try {
                q0.b b2 = this.c.b(map, this.f3979d);
                if (b2 == null) {
                    obj = null;
                } else {
                    c1 c1Var = b2.a;
                ...
                return new q0.b(c1.f3834h.g("failed to parse service config").f(e2));
            }
        }
    }
    ...
    public final class u extends e {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                if (!uVar.f3983g) {
                    uVar.f3983g = true;
                } else if (m1.this.H && (cVar = uVar.f3984h) != null) {
                    cVar.a();
                    uVar.f3984h = null;
                } else {
                    return;
                ...
                if (!m1.this.H) {
                    uVar.f3984h = m1.this.n.c(new k1(new u1(uVar)), 5, TimeUnit.SECONDS, m1.this.f3968f.p());
                } else {
                    uVar.f3981e.d(m1.f0);
                }
            }
        ...
        public List<h.a.v> a() {
            ...
            f.b.a.c.b.o.b.F(this.f3982f, "not started");
            return this.f3981e.m;
        }
        ...
        @Override // h.a.h0.h
        public Object c() {
            f.b.a.c.b.o.b.F(this.f3982f, "Subchannel is not started");
            return this.f3981e;
        }
        ...
        public void f(h0.j jVar) {
            m1.this.n.d();
            f.b.a.c.b.o.b.F(!this.f3982f, "already started");
            f.b.a.c.b.o.b.F(!this.f3983g, "already shutdown");
            this.f3982f = true;
            if (m1.this.H) {
                g1 g1Var = m1.this.n;
            ...
            m1 m1Var2 = m1.this;
            z0 z0Var = new z0(list, b2, null, aVar, xVar, p, m1Var2.q, m1Var2.n, new t1(this, jVar), m1Var2.O, m1Var2.K.a(), this.f3980d, this.b, this.c);
            m1 m1Var3 = m1.this;
            o oVar = m1Var3.M;
    ...
    public m1(b<?> bVar, x xVar, j.a aVar, d2<? extends Executor> d2Var, f.b.b.a.u<f.b.b.a.s> uVar, List<h.a.g> list, z2 z2Var) {
        ...
        this.N = nVar;
        q0.c cVar = bVar.f3884e;
        this.c = cVar;
        y0 y0Var = q0.f4039k;
        i iVar = new i(bVar.f3886g);
        this.f3967e = iVar;
        d2<? extends Executor> d2Var3 = bVar.b;
        f.b.a.c.b.o.b.z(d2Var3, "offloadExecutorPool");
        this.f3974l = new k(d2Var3);
        s sVar = new s(false, bVar.f3890k, bVar.f3891l, iVar, nVar);
        ...
        h.a.t tVar = bVar.f3887h;
        f.b.a.c.b.o.b.z(tVar, "decompressorRegistry");
        this.o = tVar;
        h.a.m mVar = bVar.f3888i;
    ...
    public final void r(boolean z2) {
        ...
        m2 m2Var = this.b0;
        m2Var.f3989f = false;
        if (z2 && (scheduledFuture = m2Var.f3990g) != null) {
    ...
    public final void v() {
        ...
        if (j2 != -1) {
            ...
            f.b.b.a.s sVar = m2Var.f3987d;
            TimeUnit timeUnit2 = TimeUnit.NANOSECONDS;
            long a2 = sVar.a(timeUnit2) + nanos;
            m2Var.f3989f = true;
            if (a2 - m2Var.f3988e < 0 || m2Var.f3990g == null) {
                ScheduledFuture<?> scheduledFuture = m2Var.f3990g;
                if (scheduledFuture != null) {
                    scheduledFuture.cancel(false);
                }
                m2Var.f3990g = m2Var.a.schedule(new m2.c(null), nanos, timeUnit2);
            }
            m2Var.f3988e = a2;
        }
    }
    ...
    public final void w(boolean z2) {
        ...
        if (this.w != null) {
            ...
            this.x = false;
            if (z2) {
                this.w = t(this.b, this.c, this.f3966d);
            } else {
                this.w = null;
            }
        }
