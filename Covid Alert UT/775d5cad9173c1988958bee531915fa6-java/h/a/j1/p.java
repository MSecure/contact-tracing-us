...
public final class p<ReqT, RespT> extends f<ReqT, RespT> {
            ...
            public final void b() {
                ...
                if (!bVar.b) {
                    try {
                        ...
                        c1 g2 = c1.f3833g.f(th).g("Failed to read headers");
                        p.this.f4021i.g(g2);
                    ...
                    while (true) {
                        try {
                            ...
                            if (next2 != null) {
                                try {
                                    b bVar = b.this;
                                    bVar.a.c(p.this.a.f4274e.a(next2));
                                    next2.close();
                                } catch (Throwable th) {
                                    q0.b(next2);
                                    throw th;
                            ...
                            while (true) {
                                ...
                                if (next3 != null) {
                                    ...
                                    c1 g2 = c1.f3833g.f(th2).g("Failed to read message.");
                                    p.this.f4021i.g(g2);
                                    b.f(b.this, g2, new n0());
                                    return;
                                }
        ...
        public final class c extends b0 {
            ...
            public final void b() {
                try {
                    ...
                    c1 g2 = c1.f3833g.f(th).g("Failed to call onReady.");
                    p.this.f4021i.g(g2);
                    b.f(b.this, g2, new n0());
                }
            }
    ...
    public final class d implements q.b {
        ...
        public void a(q qVar) {
            if (qVar.R() == null || !qVar.R().c()) {
                p.this.f4021i.g(g.b.a.c.c.d.D(qVar));
                return;
            }
    ...
    public p(o0<ReqT, RespT> o0Var, Executor executor, h.a.c cVar, c cVar2, ScheduledExecutorService scheduledExecutorService, m mVar, boolean z) {
        ...
        this.f4017e = q.L();
        o0.c cVar3 = o0Var.a;
        this.f4018f = (cVar3 == o0.c.UNARY || cVar3 == o0.c.SERVER_STREAMING) ? true : z2;
        this.f4019g = cVar;
        this.f4024l = cVar2;
    ...
    public void a() {
        ...
        Objects.requireNonNull(aVar);
        try {
            f.b.a.c.b.o.b.F(this.f4021i != null, "Not started");
            f.b.a.c.b.o.b.F(true, "call was cancelled");
            f.b.a.c.b.o.b.F(!this.f4023k, "call already half-closed");
            this.f4023k = true;
            this.f4021i.l();
            Objects.requireNonNull(aVar);
        } catch (Throwable th) {
    ...
    public final void h(ReqT reqt) {
        f.b.a.c.b.o.b.F(this.f4021i != null, "Not started");
        f.b.a.c.b.o.b.F(true, "call was cancelled");
        f.b.a.c.b.o.b.F(!this.f4023k, "call was half-closed");
        try {
            u uVar = this.f4021i;
            if (uVar instanceof n2) {
                ((n2) uVar).y(reqt);
            } else {
                uVar.h(this.a.f4273d.b(reqt));
            }
            if (!this.f4018f) {
                this.f4021i.flush();
            }
        } catch (RuntimeException e2) {
            this.f4021i.g(c1.f3833g.f(e2).g("Failed to stream message"));
        } catch (Error e3) {
            this.f4021i.g(c1.f3833g.g("Client sendMessage() failed with Error"));
            throw e3;
        }
    }
    ...
    public final void i(f.a<RespT> aVar, n0 n0Var) {
        ...
        Executor executor;
        q qVar;
        f.b.a.c.b.o.b.F(this.f4021i == null, "Already started");
        f.b.a.c.b.o.b.F(true, "call was cancelled");
        f.b.a.c.b.o.b.z(aVar, "observer");
        f.b.a.c.b.o.b.z(n0Var, "headers");
        if (this.f4017e.S()) {
            this.f4021i = c2.a;
            c1 D = g.b.a.c.c.d.D(this.f4017e);
            executor = this.c;
            qVar = new q(this, aVar, D);
        } else {
            String str = this.f4019g.f3824e;
            if (str != null) {
            ...
            if (!(f2 != null && f2.c())) {
                ...
                if (this.f4020h) {
                    ...
                    h.a.c cVar2 = this.f4019g;
                    q qVar2 = this.f4017e;
                    m1.h hVar = (m1.h) cVar;
                    Objects.requireNonNull(m1.this);
                    f.b.a.c.b.o.b.F(false, "retry should be enabled");
                    this.f4021i = new r1(hVar, o0Var, n0Var, cVar2, m1.this.Q.b.c, qVar2);
                } else {
                    w a2 = ((m1.h) this.f4024l).a(new h2(this.a, n0Var, this.f4019g));
                    q d2 = this.f4017e.d();
                    try {
                        this.f4021i = a2.g(this.a, n0Var, this.f4019g);
                    } finally {
                        this.f4017e.Q(d2);
                    }
                }
                ...
                c1 c1Var = c1.f3835i;
                this.f4021i = new i0(c1Var.g("ClientCall started after deadline exceeded: " + f2));
            }
            String str2 = this.f4019g.c;
            if (str2 != null) {
                this.f4021i.j(str2);
            }
            Integer num = this.f4019g.f3828i;
            if (num != null) {
                this.f4021i.d(num.intValue());
            }
            Integer num2 = this.f4019g.f3829j;
            if (num2 != null) {
                this.f4021i.a(num2.intValue());
            }
            if (f2 != null) {
                this.f4021i.e(f2);
            }
            ...
            this.f4021i.f(this.p);
            m mVar = this.f4016d;
            mVar.b.a(1);
            mVar.a.a();
            this.m = new d(aVar, null);
            this.f4021i.i(new b(aVar));
            this.f4017e.c(this.m, f.b.b.f.a.k.INSTANCE);
            if (f2 != null && !f2.equals(this.f4017e.R()) && this.n != null && !(this.f4021i instanceof i0)) {
