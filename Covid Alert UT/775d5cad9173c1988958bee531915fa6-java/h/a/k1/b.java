...
public final class b implements c {
    ...
    public static final Logger f4130e = Logger.getLogger(g.class.getName());
    public final a b;
    public final c c;
    ...
    public void M(int i2, h.a.k1.p.m.a aVar, byte[] bArr) {
        this.f4131d.c(h.a.OUTBOUND, i2, aVar, k.h.f(bArr));
        try {
    ...
    public void O(int i2, h.a.k1.p.m.a aVar) {
        this.f4131d.e(h.a.OUTBOUND, i2, aVar);
        try {
            this.c.O(i2, aVar);
        } catch (IOException e2) {
            this.b.b(e2);
    ...
    public void close() {
        try {
            ...
            f4130e.log(e2.getClass().equals(IOException.class) ? Level.FINE : Level.INFO, "Failed closing connection", (Throwable) e2);
        }
    }
    ...
    public void i(boolean z, int i2, e eVar, int i3) {
        this.f4131d.b(h.a.OUTBOUND, i2, eVar, i3, z);
        try {
    ...
    public void o(h.a.k1.p.m.h hVar) {
        this.f4131d.f(h.a.OUTBOUND, hVar);
        try {
            this.c.o(hVar);
        } catch (IOException e2) {
            this.b.b(e2);
    ...
    public void s(int i2, long j2) {
        this.f4131d.g(h.a.OUTBOUND, i2, j2);
        try {
            this.c.s(i2, j2);
        } catch (IOException e2) {
            this.b.b(e2);
