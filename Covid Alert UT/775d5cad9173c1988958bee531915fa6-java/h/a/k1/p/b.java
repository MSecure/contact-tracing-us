...
public final class b {
    ...
    public static final a[] f4192e;

    /* renamed from: f  reason: collision with root package name */
    public static final b f4193f;
    ...
    public boolean equals(Object obj) {
        ...
        return !z || (Arrays.equals(this.b, bVar.b) && Arrays.equals(this.c, bVar.c) && this.f4194d == bVar.f4194d);
    }

    public int hashCode() {
        if (this.a) {
            return ((((527 + Arrays.hashCode(this.b)) * 31) + Arrays.hashCode(this.c)) * 31) + (!this.f4194d ? 1 : 0);
        }
        return 17;
    }
        ...
        while (true) {
            ...
            if (i2 < strArr4.length) {
                ...
                if ("TLSv1.2".equals(str3)) {
                    ...
                    throw new IllegalArgumentException(f.a.a.a.a.w("Unexpected TLS version: ", str3));
                }
                kVarArr[i2] = kVar;
                i2++;
            } else {
