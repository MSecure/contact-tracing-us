...
public final class d implements HostnameVerifier {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:52:0x0121, code lost:
        r1 = r2.f4199g;
        r3 = r2.f4196d;
        r0 = new java.lang.String(r1, r3, r2.f4198f - r3);
     */
    ...
    public boolean b(String str, X509Certificate x509Certificate) {
        ...
        if (!z) {
            ...
            cVar.f4197e = 0;
            cVar.f4198f = 0;
            cVar.f4199g = cVar.a.toCharArray();
            String c = cVar.c();
            if (c != null) {
                while (true) {
                    int i7 = cVar.c;
                    ...
                    if (c2 == '\"') {
                        ...
                        while (true) {
                            ...
                            if (i10 != cVar.b) {
                                ...
                                if (cArr[i10] == '\"') {
                                    ...
                                    } while (cVar.f4199g[i10] == ' ');
                                    char[] cArr2 = cVar.f4199g;
                                    int i11 = cVar.f4196d;
                                    str2 = new String(cArr2, i11, cVar.f4197e - i11);
                                } else {
                                    if (cArr[i10] == '\\') {
                                        cArr[i9] = cVar.b();
                                    } else {
                        ...
                        if (c2 == '+' || c2 == ',' || c2 == ';') {
                            ...
                            while (true) {
                                int i12 = cVar.c;
                                if (i12 >= cVar.b) {
                                    char[] cArr3 = cVar.f4199g;
                                    int i13 = cVar.f4196d;
                                    str2 = new String(cArr3, i13, cVar.f4197e - i13);
                                    break;
                                }
                                char[] cArr4 = cVar.f4199g;
                                char c3 = cArr4[i12];
                                if (c3 == ' ') {
                                    int i14 = cVar.f4197e;
                                    cVar.f4198f = i14;
                            ...
                            char[] cArr7 = cVar.f4199g;
                            int i18 = cVar.f4196d;
                            str2 = new String(cArr7, i18, cVar.f4197e - i18);
                        }
                    } else if (i7 + 4 < i8) {
                        cVar.f4196d = i7;
                        while (true) {
                        ...
                        if (i21 < 5 || (i21 & 1) == 0) {
                            ...
                            str2 = new String(cVar.f4199g, cVar.f4196d, i21);
                        }
                    } else {
