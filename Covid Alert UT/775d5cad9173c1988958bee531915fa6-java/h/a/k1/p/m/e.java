...
public final class e {
    ...
    public static final class a {
        ...
        public final int c(int i2) {
            ...
            if (i2 > 0) {
                ...
                while (true) {
                    ...
                    i3 = this.f4239f;
                    if (length < i3 || i2 <= 0) {
                        d[] dVarArr = this.f4238e;
                        System.arraycopy(dVarArr, i3 + 1, dVarArr, i3 + 1 + i4, this.f4240g);
                        this.f4239f += i4;
                    } else {
                        d[] dVarArr2 = this.f4238e;
                        i2 -= dVarArr2[length].c;
                        this.f4241h -= dVarArr2[length].c;
                        this.f4240g--;
                        i4++;
                    }
                }
                d[] dVarArr3 = this.f4238e;
                System.arraycopy(dVarArr3, i3 + 1, dVarArr3, i3 + 1 + i4, this.f4240g);
                this.f4239f += i4;
            }
            return i4;
        }
        ...
        public final void e(int i2, d dVar) {
            ...
            int i3 = dVar.c;
            if (i2 != -1) {
                i3 -= this.f4238e[(this.f4239f + 1) + i2].c;
            }
            int i4 = this.f4237d;
            if (i3 > i4) {
                a();
            ...
            int c2 = c((this.f4241h + i3) - i4);
            if (i2 == -1) {
                int i5 = this.f4240g + 1;
                d[] dVarArr = this.f4238e;
                if (i5 > dVarArr.length) {
                    d[] dVarArr2 = new d[(dVarArr.length * 2)];
                    System.arraycopy(dVarArr, 0, dVarArr2, dVarArr.length, dVarArr.length);
                    this.f4239f = this.f4238e.length - 1;
                    this.f4238e = dVarArr2;
                }
                int i6 = this.f4239f;
                this.f4239f = i6 - 1;
                this.f4238e[i6] = dVar;
                ...
                this.f4238e[this.f4239f + 1 + i2 + c2 + i2] = dVar;
            }
            this.f4241h += i3;
        }
    ...
    public static final class b {
        ...
        public final void a(d dVar) {
            ...
            if (i3 > 4096) {
                ...
                this.f4243e = this.c.length - 1;
                this.f4242d = 0;
                this.f4244f = 0;
                return;
            }
            int i4 = (this.f4244f + i3) - 4096;
            if (i4 > 0) {
                ...
                while (true) {
                    ...
                    if (length < i2 || i4 <= 0) {
                        d[] dVarArr = this.c;
                        int i6 = i2 + 1;
                        System.arraycopy(dVarArr, i6, dVarArr, i6 + i5, this.f4242d);
                        this.f4243e += i5;
                    } else {
                        d[] dVarArr2 = this.c;
                        i4 -= dVarArr2[length].c;
                        this.f4244f -= dVarArr2[length].c;
                        this.f4242d--;
                        i5++;
                        length--;
                    }
                ...
                d[] dVarArr3 = this.c;
                int i62 = i2 + 1;
                System.arraycopy(dVarArr3, i62, dVarArr3, i62 + i5, this.f4242d);
                this.f4243e += i5;
            }
            int i7 = this.f4242d + 1;
            d[] dVarArr4 = this.c;
