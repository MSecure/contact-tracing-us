...
public final class n0 {
    ...
    public static final f.b.b.c.a f4263d;
    public Object[] a;
    public int b;
    ...
    public static class c<T> extends f<T> {
        ...
        public T c(byte[] bArr) {
            return this.f4264f.b(new String(bArr, f.b.b.a.d.a));
        }

        @Override // h.a.n0.f
        public byte[] d(T t) {
            return this.f4264f.a(t).getBytes(f.b.b.a.d.a);
        }
    }
    ...
    public static abstract class f<T> {
        ...
        public static final BitSet f4265e;
        ...
        public f(String str, boolean z, Object obj, a aVar) {
            ...
            for (int i2 = 0; i2 < lowerCase.length(); i2++) {
                ...
                if (!(z && charAt == ':' && i2 == 0) && !f4265e.get(charAt)) {
    ...
    public static final class h<T> extends f<T> {
        ...
        @Override // h.a.n0.f
        public T c(byte[] bArr) {
            return this.f4267f.b(bArr);
        }

        @Override // h.a.n0.f
        public byte[] d(T t) {
            return this.f4267f.a(t);
        }
    }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.b; i2++) {
            ...
            sb.append(str);
            sb.append('=');
            sb.append(str.endsWith("-bin") ? f4263d.c(k(i2)) : new String(k(i2), charset));
        }
        sb.append(')');
        return sb.toString();
    }
