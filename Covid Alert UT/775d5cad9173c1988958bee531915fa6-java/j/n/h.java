...
public class h extends g {
    ...
    public static int g(CharSequence charSequence, char c, int i2, boolean z, int i3) {
        ...
        e.c(cArr, "chars");
        if (!z) {
            return ((String) charSequence).indexOf(d.C(cArr), i2);
        }
        if (i2 < 0) {
            i2 = 0;
        }
    ...
    public static final boolean k(CharSequence charSequence, int i2, CharSequence charSequence2, int i3, int i4, boolean z) {
        ...
        for (int i5 = 0; i5 < i4; i5++) {
            if (!d.g(charSequence.charAt(i2 + i5), charSequence2.charAt(i3 + i5), z)) {
                return false;
            }
        }
        return true;
        ...
        if (strArr.length == 1) {
            ...
            if (!(str.length() == 0)) {
                if (i5 >= 0) {
                    ...
                    if (d2 == -1 || i5 == 1) {
                        return g.b.a.c.c.d.p(charSequence.toString());
                    }
                    if (i5 <= 0) {
                        z3 = false;
                    }
