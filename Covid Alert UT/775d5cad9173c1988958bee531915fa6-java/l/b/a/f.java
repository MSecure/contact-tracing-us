...
public final class f extends b implements d, l.b.a.x.f, Serializable {
    ...
    public static final f f4357e = P(-999999999, 1, 1);

    /* renamed from: f  reason: collision with root package name */
    public static final f f4358f = P(999999999, 12, 31);

    /* renamed from: g  reason: collision with root package name */
    public static final l<f> f4359g = new a();
    public final int b;
    public final short c;

    /* renamed from: d  reason: collision with root package name */
    public final short f4360d;
    ...
    public f(int i2, int i3, int i4) {
        this.b = i2;
        this.c = (short) i3;
        this.f4360d = (short) i4;
    }

    public static f C(int i2, i iVar, int i3) {
        if (i3 <= 28 || i3 <= iVar.s(m.f4408d.u((long) i2))) {
            return new f(i2, iVar.r(), i3);
        }
        if (i3 == 29) {
            throw new b(f.a.a.a.a.u("Invalid date 'February 29' as '", i2, "' is not a leap year"));
        }
    ...
    public static f O(a aVar) {
        ...
        e a2 = aVar.a();
        return R(g.b.a.c.c.d.i(a2.b + ((long) ((a.C0154a) aVar).b.s().a(a2).c), 86400));
    }
    ...
    public static f S(int i2, int i3) {
        ...
        throw new b(f.a.a.a.a.u("Invalid date 'DayOfYear 366' as '", i2, "' is not a leap year"));
    }
    ...
    public int B(f fVar) {
        ...
        return i3 == 0 ? this.f4360d - fVar.f4360d : i3;
    }
    ...
    public int H() {
        return (i.u(this.c).q(K()) + this.f4360d) - 1;
    }
    ...
    public final long N(f fVar) {
        return (((fVar.I() * 32) + ((long) fVar.f4360d)) - ((I() * 32) + ((long) this.f4360d))) / 32;
    }
    ...
    public f W(long j2) {
        ...
        return Z(l.b.a.x.a.YEAR.m(g.b.a.c.c.d.i(j3, 12)), g.b.a.c.c.d.k(j3, 12) + 1, this.f4360d);
    }
    ...
    public f Y(long j2) {
        return j2 == 0 ? this : Z(l.b.a.x.a.YEAR.m(((long) this.b) + j2), this.c, this.f4360d);
    }
    ...
    public f z(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            ...
            case 18:
                int i2 = (int) j2;
                return this.f4360d == i2 ? this : P(this.b, this.c, i2);
            case 19:
                int i3 = (int) j2;
            ...
            case 23:
                ...
                l.b.a.x.a aVar2 = l.b.a.x.a.MONTH_OF_YEAR;
                aVar2.f4506e.b((long) i4, aVar2);
                return Z(this.b, i4, this.f4360d);
            case 24:
    ...
    public <R> R c(l<R> lVar) {
        return lVar == k.f4524f ? this : (R) super.c(lVar);
    }
    ...
    public f c0(int i2) {
        ...
        l.b.a.x.a aVar = l.b.a.x.a.YEAR;
        aVar.f4506e.b((long) i2, aVar);
        return Z(i2, this.c, this.f4360d);
    }
    ...
    public int hashCode() {
        int i2 = this.b;
        return (((i2 << 11) + (this.c << 6)) + this.f4360d) ^ (i2 & -2048);
    }
    ...
    public long x() {
        ...
        long j6 = (((367 * j4) - 362) / 12) + j2 + ((long) (this.f4360d - 1));
        if (j4 > 2) {
            j6--;
            if (!K()) {
                j6--;
