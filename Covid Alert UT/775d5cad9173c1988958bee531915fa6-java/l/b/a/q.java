...
public abstract class q implements Serializable {
    ...
    public static q t(String str) {
        ...
        if (str.length() == 1) {
            throw new b(a.w("Invalid zone: ", str));
        } else if (str.startsWith("+") || str.startsWith("-")) {
            return r.x(str);
        } else {
            if (str.equals("UTC") || str.equals("GMT") || str.equals("UT")) {
                return new s(str, r.f4386g.s());
            }
            if (str.startsWith("UTC+") || str.startsWith("GMT+") || str.startsWith("UTC-") || str.startsWith("GMT-")) {
                ...
                return new s(str.substring(0, 3) + x.f4389d, x.s());
    ...
    public static q u(String str, r rVar) {
        ...
        if (!str.equals("GMT") && !str.equals("UTC") && !str.equals("UT")) {
            throw new IllegalArgumentException(a.w("Invalid prefix, must be GMT, UTC or UT: ", str));
        } else if (rVar.c == 0) {
            return new s(str, rVar.s());
        } else {
            StringBuilder h2 = a.h(str);
            h2.append(rVar.f4389d);
