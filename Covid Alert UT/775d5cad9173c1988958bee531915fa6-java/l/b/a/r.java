...
public final class r extends q implements e, f, Comparable<r>, Serializable {
    ...
    public static final ConcurrentMap<Integer, r> f4384e = new ConcurrentHashMap(16, 0.75f, 4);

    /* renamed from: f  reason: collision with root package name */
    public static final ConcurrentMap<String, r> f4385f = new ConcurrentHashMap(16, 0.75f, 4);

    /* renamed from: g  reason: collision with root package name */
    public static final r f4386g = z(0);

    /* renamed from: h  reason: collision with root package name */
    public static final r f4387h = z(-64800);

    /* renamed from: i  reason: collision with root package name */
    public static final r f4388i = z(64800);
    public final int c;

    /* renamed from: d  reason: collision with root package name */
    public final transient String f4389d;
        ...
        if (length == 2) {
            ...
            if (length == 5) {
                ...
                if (length == 7) {
                    ...
                    throw new b(a.w("Invalid ID for ZoneOffset, invalid format: ", str));
                }
                charAt = str.charAt(0);
                if (charAt != '+' || charAt == '-') {
                    return charAt == '-' ? y(-i4, -i3, -i2) : y(i4, i3, i2);
                }
                throw new b(a.w("Invalid ID for ZoneOffset, plus/minus not found when expected: ", str));
            } else {
                i4 = A(str, 1, false);
                i3 = A(str, 4, true);
            }
    ...
    public static r y(int i2, int i3, int i4) {
        if (i2 < -18 || i2 > 18) {
            throw new b(a.u("Zone offset hours not in valid range: value ", i2, " is not in the range -18 to 18"));
        }
        if (i2 > 0) {
            if (i3 < 0 || i4 < 0) {
    ...
    public static r z(int i2) {
        if (Math.abs(i2) > 64800) {
            ...
            ConcurrentMap<Integer, r> concurrentMap = f4384e;
            ...
            f4385f.putIfAbsent(rVar2.f4389d, rVar2);
            return rVar2;
        }
    }
    ...
    public <R> R c(l<R> lVar) {
        ...
        if (lVar == k.f4524f || lVar == k.f4525g || lVar == k.c || lVar == k.b || lVar == k.a) {
            return null;
        }
        return lVar.a(this);
    }
