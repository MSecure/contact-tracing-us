...
public final class o extends h implements Serializable {
    ...
    public static final Locale f4410d = new Locale("ja", "JP", "JP");

    /* renamed from: e  reason: collision with root package name */
    public static final o f4411e = new o();

    /* renamed from: f  reason: collision with root package name */
    public static final Map<String, String[]> f4412f;

    /* renamed from: g  reason: collision with root package name */
    public static final Map<String, String[]> f4413g;

    /* renamed from: h  reason: collision with root package name */
    public static final Map<String, String[]> f4414h;
        ...
        if (!(ordinal == 15 || ordinal == 18 || ordinal == 20 || ordinal == 24)) {
            switch (ordinal) {
                ...
                case 13:
                    break;
                default:
                    Calendar instance = Calendar.getInstance(f4410d);
                    ...
                    if (ordinal2 == 19) {
                        ...
                        switch (ordinal2) {
                            ...
                            case 26:
                                q[] t3 = q.t();
                                return l.b.a.x.o.d((long) p.f4415e.b, (long) t3[t3.length - 1].q().b);
                            case 27:
                                q[] t4 = q.t();
