...
public final class w extends a<w> implements Serializable {
    ...
    public w z(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            case 24:
                v.f4426d.u(aVar).b(j2, aVar);
                return G(this.b.W(j2 - E()));
            case 25:
            case 26:
            case 27:
                int a = v.f4426d.u(aVar).a(j2, aVar);
                switch (aVar.ordinal()) {
                    case 25:
                        f fVar = this.b;
                        if (F() < 1) {
    ...
    public o a(j jVar) {
        ...
        if (f(jVar)) {
            ...
            if (ordinal != 25) {
                return v.f4426d.u(aVar);
            }
            o oVar = a.YEAR.f4506e;
            if (F() <= 0) {
                j2 = (-(oVar.b + 543)) + 1;
            } else {
                j2 = 543 + oVar.f4527e;
    ...
    public l.b.a.x.d e(l.b.a.x.f fVar) {
        return (w) v.f4426d.e(fVar.n(this));
    }
    ...
    @Override // l.b.a.u.b
    public b w(i iVar) {
        return (w) v.f4426d.e(((l.b.a.m) iVar).b(this));
    }
