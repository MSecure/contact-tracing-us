...
public class AppCompatSpinner extends Spinner {
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        public DropdownPopup(Context context, AttributeSet attributeSet, int i) {
            ...
            this.mItemClickListener = new AdapterView.OnItemClickListener(AppCompatSpinner.this) {
    ...
    public AppCompatSpinner(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (i2 == 0) {
            ...
            dropdownPopup.mPopup.setBackgroundDrawable(obtainStyledAttributes2.getDrawable(R$styleable.Spinner_android_popupBackground));
            dropdownPopup.mHintText = obtainStyledAttributes.getString(R$styleable.Spinner_android_prompt);
