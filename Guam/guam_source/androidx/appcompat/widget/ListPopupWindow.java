...
public class ListPopupWindow implements ShowableListMenu {
    ...
    public void show() {
        ...
        if (Build.VERSION.SDK_INT <= 23) {
            ...
            if (method != null) {
                try {
                    i2 = ((Integer) method.invoke(this.mPopup, view, Integer.valueOf(i6), Boolean.valueOf(z2))).intValue();
        ...
        if (this.mDropDownAlwaysVisible || this.mDropDownHeight == -1) {
            ...
            if (i7 == -2) {
                ...
                i4 = View.MeasureSpec.makeMeasureSpec(i8 - (rect2.left + rect2.right), RecyclerView.UNDEFINED_DURATION);
            } else if (i7 != -1) {
