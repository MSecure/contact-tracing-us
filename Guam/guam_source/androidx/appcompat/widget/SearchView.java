...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("SearchView.SavedState{");
            outline15.append(Integer.toHexString(System.identityHashCode(this)));
            outline15.append(" isIconified=");
            outline15.append(this.isIconified);
            outline15.append("}");
        ...
        if (cursor != null && cursor.moveToPosition(i)) {
            ...
            try {
                ...
                if (!(stringOrNull2 == null || (stringOrNull = SuggestionsAdapter.getStringOrNull(cursor, cursor.getColumnIndex("suggest_intent_data_id"))) == null)) {
                    stringOrNull2 = stringOrNull2 + ColorPropConverter.PATH_DELIMITER + Uri.encode(stringOrNull);
                }
                if (stringOrNull2 == null) {
                    uri = null;
                } else {
                    uri = Uri.parse(stringOrNull2);
                }
                intent = createIntent(columnString, uri, SuggestionsAdapter.getStringOrNull(cursor, cursor.getColumnIndex("suggest_intent_extra_data")), SuggestionsAdapter.getStringOrNull(cursor, cursor.getColumnIndex("suggest_intent_query")), 0, null);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x009c, code lost:
        if (getContext().getPackageManager().resolveActivity(r2, okio.AsyncTimeout.TIMEOUT_WRITE_SIZE) != null) goto L_0x00a0;
     */
        ...
        if (searchableInfo != null) {
            ...
            if ((inputType & 15) == 1) {
                ...
                if (this.mSearchable.getSuggestAuthority() != null) {
                    inputType = inputType | AsyncTimeout.TIMEOUT_WRITE_SIZE | 524288;
                }
            }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(tintTypedArray.getResourceId(R$styleable.SearchView_layout, R$layout.abc_search_view), (ViewGroup) this, true);
        ...
        AppCompatDelegateImpl.ConfigurationImplApi17.setTooltipText(this.mSearchButton, getResources().getString(R$string.abc_searchview_description_search));
