...
public class ArrayLinkedVariables implements ArrayRow.ArrayRowVariables {
    ...
    public void add(SolverVariable solverVariable, float f, boolean z) {
        if (f <= -0.001f || f >= 0.001f) {
            ...
            while (i != -1 && i3 < this.currentSize) {
                ...
                if (i5 == i6) {
                    float f2 = this.mArrayValues[i] + f;
    ...
    public String toString() {
        ...
        int i2 = 0;
        while (i != -1 && i2 < this.currentSize) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15(GeneratedOutlineSupport.outline8(str, " -> "));
            outline15.append(this.mArrayValues[i]);
            outline15.append(" : ");
            StringBuilder outline152 = GeneratedOutlineSupport.outline15(outline15.toString());
            outline152.append(this.mCache.mIndexedVariables[this.mArrayIndices[i]]);
