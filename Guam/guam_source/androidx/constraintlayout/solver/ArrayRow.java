...
public class ArrayRow implements LinearSystem.Row {
    ...
    public String toString() {
        ...
        if (this.variable == null) {
            ...
            outline15.append(this.variable);
        ...
        if (this.constantValue != BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER) {
            ...
            outline152.append(this.constantValue);
        ...
        for (int i2 = 0; i2 < currentSize; i2++) {
            ...
            if (!(variable2 == null || (variableValue = this.variables.getVariableValue(i2)) == BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER)) {
                ...
                if (!z) {
                    ...
                    outline8 = variableValue == 1.0f ? GeneratedOutlineSupport.outline8(outline8, solverVariable) : outline8 + variableValue + " " + solverVariable;
                    z = true;
                } else if (i > 0) {
                    outline8 = GeneratedOutlineSupport.outline8(outline8, " + ");
        ...
        return !z ? GeneratedOutlineSupport.outline8(outline8, "0.0") : outline8;
    }
