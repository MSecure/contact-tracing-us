...
public class ViewDragHelper {
    ...
    public static ViewDragHelper create(ViewGroup viewGroup, float f, Callback callback) {
        ...
        viewDragHelper.mTouchSlop = (int) ((1.0f / f) * ((float) viewDragHelper.mTouchSlop));
    ...
    public void cancel() {
        ...
        if (fArr != null) {
            ...
            Arrays.fill(this.mInitialMotionY, (float) BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
            Arrays.fill(this.mLastMotionX, (float) BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
            Arrays.fill(this.mLastMotionY, (float) BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
    ...
    public void captureChildView(View view, int i) {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view (");
        outline15.append(this.mParentView);
        outline15.append(")");
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 3) {
                if (this.mDragState == 1) {
                    dispatchViewReleased(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
                }
                cancel();
    ...
    public final float clampMag(float f, float f2, float f3) {
        ...
        if (abs > f3) {
            return f > BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER ? f3 : -f3;
        }
        return f;
    }
}
