...
public class ClassesInfoCache {
    ...
    public final void verifyAndPutHandler(Map<MethodReference, Lifecycle.Event> map, MethodReference methodReference, Lifecycle.Event event, Class<?> cls) {
        ...
        if (event2 != null && event != event2) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Method ");
            outline15.append(method.getName());
            outline15.append(" in ");
            outline15.append(cls.getName());
            outline15.append(" already declared with different @OnLifecycleEvent value: previous value ");
            outline15.append(event2);
            outline15.append(", new value ");
            outline15.append(event);
