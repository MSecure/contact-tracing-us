...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("ChangeInfo{oldHolder=");
            outline15.append(this.oldHolder);
            outline15.append(", newHolder=");
            outline15.append(this.newHolder);
            outline15.append(", fromX=");
            outline15.append(this.fromX);
            outline15.append(", fromY=");
            outline15.append(this.fromY);
            outline15.append(", toX=");
            outline15.append(this.toX);
            outline15.append(", toY=");
            outline15.append(this.toY);
            outline15.append('}');
    ...
    public final boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, RecyclerView.ViewHolder viewHolder) {
        ...
        viewHolder.itemView.setTranslationY(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
        dispatchAnimationFinished(viewHolder);
        return true;
    }
