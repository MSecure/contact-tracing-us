...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public static class AnchorInfo {
        ...
        public String toString() {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("AnchorInfo{mPosition=");
            outline15.append(this.mPosition);
            outline15.append(", mCoordinate=");
            outline15.append(this.mCoordinate);
            outline15.append(", mLayoutFromEnd=");
            outline15.append(this.mLayoutFromEnd);
            outline15.append(", mValid=");
            outline15.append(this.mValid);
            outline15.append('}');
    ...
    public void setOrientation(int i) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline4("invalid orientation:", i));
    }
