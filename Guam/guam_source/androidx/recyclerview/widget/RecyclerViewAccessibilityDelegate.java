...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    ...
    public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (!shouldIgnore() && this.mRecyclerView.getLayoutManager() != null) {
            ...
            accessibilityNodeInfoCompat.setCollectionInfo(new AccessibilityNodeInfoCompat.CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(layoutManager.getRowCountForAccessibility(recycler, state), layoutManager.getColumnCountForAccessibility(recycler, state), layoutManager.isLayoutHierarchical(), layoutManager.getSelectionModeForAccessibility())));
        }
    }
