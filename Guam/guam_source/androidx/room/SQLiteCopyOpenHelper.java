    ...
    public final void copyDatabaseFile(File file) throws IOException {
        ...
        try {
            ...
            if (parentFile != null && !parentFile.exists() && !parentFile.mkdirs()) {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Failed to create directories for ");
                outline15.append(file.getAbsolutePath());
                throw new IOException(outline15.toString());
            } else if (!createTempFile.renameTo(file)) {
                StringBuilder outline152 = GeneratedOutlineSupport.outline15("Failed to move intermediate file (");
                outline152.append(createTempFile.getAbsolutePath());
                outline152.append(") to destination (");
