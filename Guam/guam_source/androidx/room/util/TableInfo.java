...
public class TableInfo {
    ...
    public static class Column {
        ...
        public String toString() {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Column{name='");
            outline15.append(this.name);
            outline15.append('\'');
            outline15.append(", type='");
            outline15.append(this.type);
            outline15.append('\'');
            outline15.append(", affinity='");
            outline15.append(this.affinity);
            outline15.append('\'');
            outline15.append(", notNull=");
            outline15.append(this.notNull);
            outline15.append(", primaryKeyPosition=");
            outline15.append(this.primaryKeyPosition);
            outline15.append(", defaultValue='");
            outline15.append(this.defaultValue);
            outline15.append('\'');
            outline15.append('}');
    ...
    public static class ForeignKey {
        ...
        public String toString() {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("ForeignKey{referenceTable='");
            outline15.append(this.referenceTable);
            outline15.append('\'');
            outline15.append(", onDelete='");
            outline15.append(this.onDelete);
            outline15.append('\'');
            outline15.append(", onUpdate='");
            outline15.append(this.onUpdate);
            outline15.append('\'');
            outline15.append(", columnNames=");
            outline15.append(this.columnNames);
            outline15.append(", referenceColumnNames=");
            outline15.append(this.referenceColumnNames);
            outline15.append('}');
            return outline15.toString();
        }
    }
    ...
    public static class Index {
        ...
        public String toString() {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Index{name='");
            outline15.append(this.name);
            outline15.append('\'');
            outline15.append(", unique=");
            outline15.append(this.unique);
            outline15.append(", columns=");
            outline15.append(this.columns);
            outline15.append('}');
            return outline15.toString();
        }
    }
    ...
    public static TableInfo read(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        Cursor query = frameworkSQLiteDatabase.query(GeneratedOutlineSupport.outline9("PRAGMA table_info(`", str, "`)"));
    ...
    public static Index readIndex(SupportSQLiteDatabase supportSQLiteDatabase, String str, boolean z) {
        Cursor query = ((FrameworkSQLiteDatabase) supportSQLiteDatabase).query(GeneratedOutlineSupport.outline9("PRAGMA index_xinfo(`", str, "`)"));
        try {
    ...
    public String toString() {
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("TableInfo{name='");
        outline15.append(this.name);
        outline15.append('\'');
        outline15.append(", columns=");
        outline15.append(this.columns);
        outline15.append(", foreignKeys=");
        outline15.append(this.foreignKeys);
        outline15.append(", indices=");
        outline15.append(this.indices);
        outline15.append('}');
        return outline15.toString();
    }
}
