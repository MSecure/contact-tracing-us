        ...
        public OpenHelper(Context context, String str, final FrameworkSQLiteDatabase[] frameworkSQLiteDatabaseArr, final SupportSQLiteOpenHelper.Callback callback) {
            super(context, str, null, callback.version, new DatabaseErrorHandler() {
                ...
                public void onCorruption(SQLiteDatabase sQLiteDatabase) {
                    ...
                    if (callback != null) {
                        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Corruption reported by sqlite on database: ");
                        outline15.append(wrappedDb.getPath());
                        Log.e("SupportSQLite", outline15.toString());
                ...
                try {
                    ...
                    if (!z) {
                        ...
                        if (!onValidateSchema.isValid) {
                            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Pre-packaged database has an invalid schema: ");
