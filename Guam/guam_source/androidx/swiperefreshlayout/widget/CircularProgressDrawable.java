...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    public static class Ring {
        ...
        public float mEndTrim = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        public final Paint mPaint = new Paint();
        public float mRingCenterRadius;
        public float mRotation = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        public boolean mShowArrow;
        public float mStartTrim = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        ...
        if (context != null) {
            ...
            ofFloat.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationStart(Animator animator) {
                    CircularProgressDrawable.this.mRotationCount = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
                }
            });
    ...
    public void draw(Canvas canvas) {
        ...
        if (ring.mShowArrow) {
            ...
            ring.mArrow.moveTo(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
            ring.mArrow.lineTo(((float) ring.mArrowWidth) * ring.mArrowScale, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
    ...
    public void start() {
        ...
        ring.setColorIndex(0);
        Ring ring2 = this.mRing;
        ring2.mStartingStartTrim = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        ring2.mStartingEndTrim = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        ring2.mStartingRotation = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        ring2.mStartTrim = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        ring2.mEndTrim = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        ring2.mRotation = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
    ...
    public void stop() {
        this.mAnimator.cancel();
        this.mRotation = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        this.mRing.setShowArrow(false);
        this.mRing.setColorIndex(0);
        Ring ring = this.mRing;
        ring.mStartingStartTrim = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        ring.mStartingEndTrim = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        ring.mStartingRotation = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        ...
        ring.mRotation = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
        invalidateSelf();
    }
    ...
    public void updateRingColor(float f, Ring ring) {
        if (f > 0.75f) {
            ...
            int i6 = (i2 >> 8) & 255;
            int i7 = i2 & 255;
            ring.mCurrentColor = ((i4 + ((int) (((float) (((i3 >> 24) & 255) - i4)) * f2))) << 24) | ((i5 + ((int) (((float) (((i3 >> 16) & 255) - i5)) * f2))) << 16) | ((i6 + ((int) (((float) (((i3 >> 8) & 255) - i6)) * f2))) << 8) | (i7 + ((int) (f2 * ((float) ((i3 & 255) - i7)))));
            return;
        }
