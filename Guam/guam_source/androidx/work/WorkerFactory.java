...
public abstract class WorkerFactory {
    ...
    public final ListenableWorker createWorkerWithDefaultFallback(Context context, String str, WorkerParameters workerParameters) {
        ...
        try {
            ...
            Logger.get().error(TAG, GeneratedOutlineSupport.outline8("Invalid class: ", str), th);
            cls = null;
        }
        if (cls != null) {
            try {
                ...
                Logger.get().error(TAG, GeneratedOutlineSupport.outline8("Could not instantiate ", str), th2);
            }
        }
