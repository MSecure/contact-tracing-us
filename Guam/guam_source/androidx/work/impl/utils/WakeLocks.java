...
public class WakeLocks {
    ...
    public static PowerManager.WakeLock newWakeLock(Context context, String str) {
        String outline8 = GeneratedOutlineSupport.outline8("WorkManager: ", str);
        PowerManager.WakeLock newWakeLock = ((PowerManager) context.getApplicationContext().getSystemService("power")).newWakeLock(1, outline8);
        synchronized (sWakeLocks) {
            sWakeLocks.put(newWakeLock, outline8);
        }
        return newWakeLock;
    }
}
