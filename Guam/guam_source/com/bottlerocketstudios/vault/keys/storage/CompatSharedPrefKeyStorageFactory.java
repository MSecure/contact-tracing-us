...
public class CompatSharedPrefKeyStorageFactory {
            ...
            if (androidKeystoreTester.mCurrentSdkInt >= 18) {
                ...
                try {
                    ...
                    if (createKeystoreSecretKeyWrapper.getKeyPair() != null) {
                        ...
                        SecretKeySpec secretKeySpec = new SecretKeySpec(bArr, RCTAes.KEY_ALGORITHM);
                        SecretKey unwrap = createKeystoreSecretKeyWrapper.unwrap(createKeystoreSecretKeyWrapper.wrap(secretKeySpec), RCTAes.KEY_ALGORITHM);
                        if (unwrap != null && Arrays.equals(unwrap.getEncoded(), secretKeySpec.getEncoded())) {
                            z = true;
                        }
                    }
    ...
    public static KeyStorage createKeyStorageForWrapperType(Context context, int i, String str, String str2, int i2, String str3, String str4, PrngSaltGenerator prngSaltGenerator) throws GeneralSecurityException {
        ...
        if (i == 1) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline5("Wrapper type ", i, " is invalid."));
        }
