...
public final class BugsnagReactNative extends ReactContextBaseJavaModule {
    ...
    public final void emitEvent(MessageEvent messageEvent) {
        ...
        if (logger2 != null) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Received MessageEvent: ");
            outline15.append(messageEvent.type);
            logger2.d(outline15.toString());
            ...
            if (logger3 != null) {
                StringBuilder outline152 = GeneratedOutlineSupport.outline15("Received unknown message event ");
                outline152.append(messageEvent.type);
                outline152.append(", ignoring");
                logger3.w(outline152.toString());
                rCTDeviceEventEmitter = this.bridge;
                if (rCTDeviceEventEmitter == null) {
                }
            } else {
