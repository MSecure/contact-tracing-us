    ...
    public void update(Observable observable, Object obj) {
        ...
        if (obj instanceof StateEvent) {
            if (obj instanceof StateEvent.UpdateContext) {
                ...
                messageEvent = new MessageEvent(BugsnagReactNative.UPDATE_USER, PathParser.mapOf(new Pair("id", updateUser.user.id), new Pair("email", updateUser.user.email), new Pair("name", updateUser.user.name)));
            } else {
                messageEvent = null;
            }
