...
public class Client {
    ...
    public Client(Context context, Configuration configuration) {
        ...
        try {
            ...
            obj = PathParser.createFailure(th);
        }
        ...
        try {
            ...
            obj2 = PathParser.createFailure(th2);
        }
        ...
        if (configuration.impl.projectPackages.isEmpty()) {
            ...
            configuration.setProjectPackages(PathParser.setOf(packageName));
        }
        ...
        if (logger4 != null) {
            ...
            if (set8 != null) {
                set = CollectionsKt__CollectionsKt.toSet(set8);
                str = str6;
            } else {
                str = str6;
                set = null;
                        ...
                        if (!arrayList.isEmpty()) {
                            ...
                            try {
                                ...
                                /*  JADX ERROR: Method code generation error
                                    jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x046a: INVOKE  
                                      (wrap: java.util.concurrent.ThreadPoolExecutor : 0x0468: SGET  (r2v31 java.util.concurrent.ThreadPoolExecutor) =  com.bugsnag.android.Async.EXECUTOR java.util.concurrent.ThreadPoolExecutor)
                                      (wrap: com.bugsnag.android.EventStore$2 : 0x0465: CONSTRUCTOR  (r0v68 com.bugsnag.android.EventStore$2) = (r1v38 'eventStore2' com.bugsnag.android.EventStore), (r2v24 'arrayList' java.util.ArrayList) call: com.bugsnag.android.EventStore.2.<init>(com.bugsnag.android.EventStore, java.util.List):void type: CONSTRUCTOR)
                                     type: VIRTUAL call: java.util.concurrent.ThreadPoolExecutor.execute(java.lang.Runnable):void in method: com.bugsnag.android.Client.<init>(android.content.Context, com.bugsnag.android.Configuration):void, file: classes.dex
                                    ...
                                    Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0465: CONSTRUCTOR  (r0v68 com.bugsnag.android.EventStore$2) = (r1v38 'eventStore2' com.bugsnag.android.EventStore), (r2v24 'arrayList' java.util.ArrayList) call: com.bugsnag.android.EventStore.2.<init>(com.bugsnag.android.EventStore, java.util.List):void type: CONSTRUCTOR in method: com.bugsnag.android.Client.<init>(android.content.Context, com.bugsnag.android.Configuration):void, file: classes.dex
                                    	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:255)
                                    	...
                                    	... 50 more
                                    Caused by: jadx.core.utils.exceptions.JadxRuntimeException: Expected class to be processed at this point, class: com.bugsnag.android.EventStore, state: GENERATED_AND_UNLOADED
                                    ...
                                    if (callbackState2 != null) {
                                        ...
                                        public void notifyUnhandledException(Throwable th, Metadata metadata, String str, String str2) {
                                            ...
                                            for (int i2 = 0; i2 < 2; i2++) {
                                                PathParser.addAll(arrayList2, metadataArr[i2].jsonStreamer.redactedKeys);
                                            }
                                            Metadata metadata2 = new Metadata(Metadata.mergeMaps$bugsnag_android_core_release(arrayList), null, null, 6);
                                            metadata2.setRedactedKeys(CollectionsKt__CollectionsKt.toSet(arrayList2));
