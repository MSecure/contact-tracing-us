...
public class DefaultDiskStorage implements DiskStorage {
    ...
    public static class FileInfo {
        ...
        public String toString() {
            ...
            sb.append(this.type);
            sb.append("(");
            return GeneratedOutlineSupport.outline12(sb, this.resourceId, ")");
        }
    }
                ...
                if (this.mRootDirectory.exists()) {
                    ...
                    if (z2) {
                        try {
                            ...
                            StringBuilder outline15 = GeneratedOutlineSupport.outline15("version directory could not be created: ");
                            outline15.append(this.mVersionDirectory);
                            outline15.toString();
    ...
    public File getContentFileFor(String str) {
        StringBuilder outline15 = GeneratedOutlineSupport.outline15(getSubdirectoryPath(str));
        outline15.append(File.separator);
        outline15.append(str);
        outline15.append(".cnt");
        return new File(outline15.toString());
    }
    ...
    public final String getSubdirectoryPath(String str) {
        ...
        return GeneratedOutlineSupport.outline12(sb, File.separator, valueOf);
    }
