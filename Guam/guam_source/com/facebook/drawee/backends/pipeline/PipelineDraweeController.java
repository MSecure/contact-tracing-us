...
public class PipelineDraweeController extends AbstractDraweeController<CloseableReference<CloseableImage>, ImageInfo> {
    ...
    public Drawable createDrawable(CloseableReference<CloseableImage> closeableReference) {
        ...
        try {
            ...
            AppCompatDelegateImpl.ConfigurationImplApi17.checkState(CloseableReference.isValid(closeableReference2));
    ...
    public final void maybeUpdateDebugOverlay(CloseableImage closeableImage) {
        ...
        if (this.mDrawDebugOverlay) {
            ...
            if (drawable instanceof DebugControllerOverlayDrawable) {
                ...
                if (!(settableDraweeHierarchy2 == null || (activeScaleTypeDrawable = AppCompatDelegateImpl.ConfigurationImplApi17.getActiveScaleTypeDrawable(settableDraweeHierarchy2.getTopLevelDrawable())) == null)) {
                ...
                if (closeableImage != null) {
                    ...
                    debugControllerOverlayDrawable2.invalidateSelf();
                    debugControllerOverlayDrawable2.mImageSizeBytes = BitmapUtil.getSizeInBytes(((CloseableStaticBitmap) closeableImage).mBitmap);
                    return;
                }
