...
public class ArrayDrawable extends Drawable implements Drawable.Callback, TransformCallback, TransformAwareDrawable {
        ...
        if (drawableArr != null) {
            ...
            while (true) {
                ...
                if (i < drawableArr2.length) {
                    AppCompatDelegateImpl.ConfigurationImplApi17.setCallbacks(drawableArr2[i], this, this);
                    i++;
                } else {
    ...
    public Drawable setDrawable(int i, Drawable drawable) {
        ...
        if (drawable != drawable2) {
            ...
            AppCompatDelegateImpl.ConfigurationImplApi17.setCallbacks(this.mLayers[i], null, null);
            AppCompatDelegateImpl.ConfigurationImplApi17.setCallbacks(drawable, null, null);
            AppCompatDelegateImpl.ConfigurationImplApi17.setDrawableProperties(drawable, this.mDrawableProperties);
            AppCompatDelegateImpl.ConfigurationImplApi17.copyProperties(drawable, this);
            AppCompatDelegateImpl.ConfigurationImplApi17.setCallbacks(drawable, this, this);
            this.mIsStatefulCalculated = false;
