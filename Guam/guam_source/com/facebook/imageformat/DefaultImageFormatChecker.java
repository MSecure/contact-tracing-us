...
public class DefaultImageFormatChecker implements ImageFormat.FormatChecker {
    ...
    static {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("ftyp");
        outline15.append(HEIF_HEADER_SUFFIXES[0]);
        HEIF_HEADER_LENGTH = AppCompatDelegateImpl.ConfigurationImplApi17.asciiBytes(outline15.toString()).length;
    }
