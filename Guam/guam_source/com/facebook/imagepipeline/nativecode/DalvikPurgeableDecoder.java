...
public abstract class DalvikPurgeableDecoder implements PlatformDecoder {
    ...
    public CloseableReference<Bitmap> decodeFromEncodedImageWithColorSpace(EncodedImage encodedImage, Bitmap.Config config, Rect rect, ColorSpace colorSpace) {
        ...
        AppCompatDelegateImpl.ConfigurationImplApi17.checkNotNull1(byteBufferRef);
        try {
        ...
        if (bitmap != null) {
            try {
                ...
                synchronized (bitmapCounter) {
                    ...
                    if (bitmapCounter.mCount < bitmapCounter.mMaxCount) {
                        long j2 = (long) sizeInBytes;
                        if (bitmapCounter.mSize + j2 <= ((long) bitmapCounter.mMaxSize)) {
                            bitmapCounter.mCount++;
