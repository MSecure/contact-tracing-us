...
public class ThumbnailBranchProducer implements Producer<EncodedImage> {
    ...
    public class ThumbnailConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        public void onNewResultImpl(Object obj, int i) {
            ...
            if (encodedImage != null && (BaseConsumer.isNotLast(i) || AppCompatDelegateImpl.ConfigurationImplApi17.isImageBigEnough(encodedImage, this.mResizeOptions))) {
    ...
    public ThumbnailBranchProducer(ThumbnailProducer<EncodedImage>... thumbnailProducerArr) {
        if (thumbnailProducerArr != null) {
            ...
            if (length >= 0) {
                throw new IndexOutOfBoundsException(AppCompatDelegateImpl.ConfigurationImplApi17.format("%s (%s) must be less than size (%s)", "index", 0, Integer.valueOf(length)));
            }
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline4("negative size: ", length));
        }
        throw null;
    }
