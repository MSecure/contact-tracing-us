            ...
            public void execute(NativeAnimatedNodesManager nativeAnimatedNodesManager) {
                ...
                if (nativeAnimatedNodesManager != null) {
                    ...
                    if (animatedNode == null) {
                        ...
                        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Animated node connected to event should beof type ");
    ...
    public void connectAnimatedNodeToView(double d, double d2) {
        ...
        this.mOperations.add(new UIThreadOperation(this) {
            ...
            public void execute(NativeAnimatedNodesManager nativeAnimatedNodesManager) {
                ...
                if (animatedNode == null) {
                    throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline5("Animated node with tag ", i, " does not exists"));
                    ...
                    throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline11(GeneratedOutlineSupport.outline15("Animated node "), propsAnimatedNode.mTag, " is already attached to a view"));
                } else {
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("Animated node connected to view should beof type ");
                    outline15.append(PropsAnimatedNode.class.getName());
                    throw new JSApplicationIllegalArgumentException(outline15.toString());
                }
            }
        });
    ...
    public void createAnimatedNode(double d, final ReadableMap readableMap) {
        ...
        this.mOperations.add(new UIThreadOperation(this) {
            ...
            public void execute(NativeAnimatedNodesManager nativeAnimatedNodesManager) {
                ...
                throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline5("Animated node with tag ", i, " already exists"));
            }
        });
    }
        ...
        this.mOperations.add(new UIThreadOperation(this) {
            ...
            public void execute(NativeAnimatedNodesManager nativeAnimatedNodesManager) {
                ...
                if (animatedNode == null || !(animatedNode instanceof ValueAnimatedNode)) {
                    throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline5("Animated node with tag ", i, " does not exists or is not a 'value' node"));
                }
