...
public class ModuleSpec {
    ...
    public static ModuleSpec nativeModuleSpec(Class<? extends NativeModule> cls, Provider<? extends NativeModule> provider) {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Could not find @ReactModule annotation on ");
        outline15.append(cls.getName());
        outline15.append(". So creating the module eagerly to get the name. Consider adding an annotation to make this Lazy");
        FLog.w(TAG, outline15.toString());
