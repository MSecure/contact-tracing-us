...
public class NativeModuleRegistry {
    ...
    public <T extends NativeModule> T getModule(Class<T> cls) {
        ...
        if (reactModule != null) {
            ...
            AppCompatDelegateImpl.ConfigurationImplApi17.assertNotNull(moduleHolder, reactModule.name() + " could not be found. Is it defined in " + cls.getName());
            return (T) moduleHolder.getModule();
        }
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Could not find @ReactModule annotation in class ");
    ...
    public void registerModules(NativeModuleRegistry nativeModuleRegistry) {
        AppCompatDelegateImpl.ConfigurationImplApi17.assertCondition(this.mReactApplicationContext.equals(nativeModuleRegistry.getReactApplicationContext()), "Extending native modules with non-matching application contexts.");
    ...
    public NativeModule getModule(String str) {
        ...
        AppCompatDelegateImpl.ConfigurationImplApi17.assertNotNull(moduleHolder, "Could not find module with name " + str);
