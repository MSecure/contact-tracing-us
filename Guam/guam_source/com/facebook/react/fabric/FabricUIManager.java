...
public class FabricUIManager implements UIManager, LifecycleEventListener {
    ...
    public void onHostPause() {
        ReactChoreographer.getInstance().removeFrameCallback(ReactChoreographer.CallbackType.DISPATCH_UI, null);
    }

    @Override // com.facebook.react.bridge.LifecycleEventListener
    public void onHostResume() {
        ReactChoreographer.getInstance().postFrameCallback(ReactChoreographer.CallbackType.DISPATCH_UI, null);
    }
    ...
    public void synchronouslyUpdateViewOnUIThread(int i, ReadableMap readableMap) {
        ...
        try {
            ...
            str = "FabricUIManager";
            try {
                scheduleMountItem(updatePropsMountItem(i, readableMap), i3, uptimeMillis, 0, 0, 0, 0, 0, 0);
    ...
    private long measure(int i, String str, ReadableMap readableMap, ReadableMap readableMap2, ReadableMap readableMap3, float f, float f2, float f3, float f4, int[] iArr) {
        if (i < 0) {
            AppCompatDelegateImpl.ConfigurationImplApi17.getYogaSize(f, f2);
            AppCompatDelegateImpl.ConfigurationImplApi17.getYogaMeasureMode(f, f2);
            AppCompatDelegateImpl.ConfigurationImplApi17.getYogaSize(f3, f4);
            AppCompatDelegateImpl.ConfigurationImplApi17.getYogaMeasureMode(f3, f4);
            throw null;
        }
        throw null;
    }
