        ...
        if (i2 > 0) {
            for (int i4 = 0; i4 < i - i2; i4++) {
                ...
                if (i4 < longArray.mLength) {
                    ...
                    StringBuilder outline16 = GeneratedOutlineSupport.outline16("", i4, " >= ");
                    outline16.append(longArray.mLength);
            ...
            StringBuilder outline162 = GeneratedOutlineSupport.outline16("Trying to drop ", i2, " items from array of length ");
            outline162.append(longArray.mLength);
            throw new IndexOutOfBoundsException(outline162.toString());
        }
    }
