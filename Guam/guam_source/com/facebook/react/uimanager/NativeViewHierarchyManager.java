...
public class NativeViewHierarchyManager {
    ...
    public static String constructManageChildrenErrorMessage(ViewGroup viewGroup, ViewGroupManager viewGroupManager, int[] iArr, ViewAtIndex[] viewAtIndexArr, int[] iArr2) {
        ...
        if (viewGroup != null) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("View tag:");
            outline15.append(viewGroup.getId());
            outline15.append("\n");
        ...
        if (iArr != null) {
            StringBuilder outline152 = GeneratedOutlineSupport.outline15("  indicesToRemove(");
            outline152.append(iArr.length);
            outline152.append("): [\n");
        ...
        if (viewAtIndexArr != null) {
            StringBuilder outline153 = GeneratedOutlineSupport.outline15("  viewsToAdd(");
            outline153.append(viewAtIndexArr.length);
            outline153.append("): [\n");
            ...
            for (int i7 = 0; i7 < viewAtIndexArr.length; i7 += 16) {
                ...
                while (true) {
                    ...
                    if (i9 >= viewAtIndexArr.length || i8 >= 16) {
                        ...
                        outline154.append(viewAtIndexArr[i9].mIndex);
                        outline154.append(",");
                        outline154.append(viewAtIndexArr[i9].mTag);
                        outline154.append("],");
        ...
        if (iArr2 != null) {
            StringBuilder outline155 = GeneratedOutlineSupport.outline15("  tagsToDelete(");
            outline155.append(iArr2.length);
            outline155.append("): [\n");
    ...
    public final void computeBoundingBox(View view, int[] iArr) {
        this.mBoundingBox.set(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, (float) view.getWidth(), (float) view.getHeight());
    ...
    public synchronized void measure(int i, int[] iArr) {
        ...
        View view = this.mTagsToViews.get(i);
        if (view != null) {
            View view2 = (View) ReactYogaConfigProvider.getRootView(view);
            if (view2 != null) {
    ...
    public final void updateLayout(View view, int i, int i2, int i3, int i4) {
        ...
        if (layoutAnimationController != null) {
            ...
            if (createAnimation instanceof LayoutHandlingAnimation) {
                createAnimation.setAnimationListener(new Animation.AnimationListener(id) {
