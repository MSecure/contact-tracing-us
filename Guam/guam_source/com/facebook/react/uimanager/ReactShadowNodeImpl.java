...
public class ReactShadowNodeImpl implements ReactShadowNode<ReactShadowNodeImpl> {
    ...
    public int getNativeOffsetForChild(ReactShadowNodeImpl reactShadowNodeImpl) {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Child ");
        outline15.append(reactShadowNodeImpl2.mReactTag);
        outline15.append(" was not a child of ");
    ...
    public ReactShadowNodeImpl removeChildAt(int i) {
        ...
        throw new ArrayIndexOutOfBoundsException(GeneratedOutlineSupport.outline5("Index ", i, " out of bounds: node has no children"));
    }
    ...
    public String toString() {
        ...
        outline15.append(this.mViewClassName);
        outline15.append(" ");
        return GeneratedOutlineSupport.outline11(outline15, this.mReactTag, "]");
    }
    ...
    public void addChildAt(ReactShadowNodeImpl reactShadowNodeImpl, int i) {
        ...
        if (this.mYogaNode != null && !isYogaLeafNode()) {
            ...
            if (yogaNode != null) {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Cannot add a child that doesn't have a YogaNode to a parent without a measure function! (Trying to add a '");
                outline15.append(reactShadowNodeImpl.toString());
                outline15.append("' to a '");
