...
public class UIManagerModule extends ReactContextBaseJavaModule implements OnBatchCompleteListener, LifecycleEventListener, UIManager {
    ...
    public <T extends View> int addRootView(T t, WritableMap writableMap, String str) {
        ...
        public void removeSubviewsFromContainerWithID(int i) {
            ...
            throw new IllegalViewOperationException(GeneratedOutlineSupport.outline4("Trying to remove subviews of an unknown view tag: ", i));
        }
            ...
            if (!shadowNodeRegistry.mRootTags.get(i)) {
                ...
                if (!shadowNodeRegistry2.mRootTags.get(i2)) {
                    ...
                    if (reactShadowNode != null) {
                        ...
                        throw new IllegalViewOperationException(GeneratedOutlineSupport.outline4("Node is not attached to a parent: ", i));
                    }
                    throw new IllegalViewOperationException(GeneratedOutlineSupport.outline4("Trying to replace unknown view tag: ", i));
                }
            }
        ...
        public void updateView(final int i, String str, final ReadableMap readableMap) {
            ...
            ReactShadowNode reactShadowNode = shadowNodeRegistry.mTagsToCSSNodes.get(i);
            if (reactShadowNode == null) {
                throw new IllegalViewOperationException(GeneratedOutlineSupport.outline4("Trying to update non-existent view with tag ", i));
