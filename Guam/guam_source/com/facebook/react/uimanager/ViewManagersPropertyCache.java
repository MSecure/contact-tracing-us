        ...
        for (Method method : declaredMethods) {
            ...
            if (reactProp != null) {
                ...
                if (parameterTypes.length == 1) {
                    ...
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("Wrong number of args for prop setter: ");
                    outline15.append(cls.getName());
                    outline15.append("#");
                    outline15.append(method.getName());
            ...
            if (reactPropGroup != null) {
                ...
                if (parameterTypes2.length != 2) {
                    StringBuilder outline152 = GeneratedOutlineSupport.outline15("Wrong number of args for group prop setter: ");
                    outline152.append(cls.getName());
                    outline152.append("#");
                    outline152.append(method.getName());
                    ...
                    StringBuilder outline153 = GeneratedOutlineSupport.outline15("Second argument should be property index: ");
                    outline153.append(cls.getName());
                    outline153.append("#");
                    outline153.append(method.getName());
        ...
        for (Method method : declaredMethods) {
            ...
            if (reactProp != null) {
                ...
                if (parameterTypes.length != 2) {
                    ...
                    StringBuilder outline152 = GeneratedOutlineSupport.outline15("First param should be a view subclass to be updated: ");
                    outline152.append(cls.getName());
                    outline152.append("#");
                    outline152.append(method.getName());
                    throw new RuntimeException(outline152.toString());
            ...
            if (reactPropGroup != null) {
                ...
                if (parameterTypes2.length != 3) {
                    StringBuilder outline153 = GeneratedOutlineSupport.outline15("Wrong number of args for group prop setter: ");
                    outline153.append(cls.getName());
                    outline153.append("#");
                    outline153.append(method.getName());
                    throw new RuntimeException(outline153.toString());
                } else if (!View.class.isAssignableFrom(parameterTypes2[0])) {
                    StringBuilder outline154 = GeneratedOutlineSupport.outline15("First param should be a view subclass to be updated: ");
                    outline154.append(cls.getName());
                    outline154.append("#");
                    outline154.append(method.getName());
                    throw new RuntimeException(outline154.toString());
                } else if (parameterTypes2[1] == Integer.TYPE) {
                    createPropSetters(reactPropGroup, method, parameterTypes2[2], hashMap);
                } else {
                    StringBuilder outline155 = GeneratedOutlineSupport.outline15("Second argument should be property index: ");
                    outline155.append(cls.getName());
                    outline155.append("#");
                    outline155.append(method.getName());
                    throw new RuntimeException(outline155.toString());
                }
            }
        }
        CLASS_PROPS_CACHE.put(cls, hashMap);
