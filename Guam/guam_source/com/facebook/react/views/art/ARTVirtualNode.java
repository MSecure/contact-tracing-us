...
public abstract class ARTVirtualNode extends ReactShadowNodeImpl {
    ...
    public final float mScale = AppCompatDelegateImpl.ConfigurationImplApi17.sWindowDisplayMetrics.density;
    ...
    public void setTransform(ReadableArray readableArray) {
        if (readableArray != null) {
            int floatArray = ReactYogaConfigProvider.toFloatArray(readableArray, sMatrixData);
            if (floatArray == 6) {
