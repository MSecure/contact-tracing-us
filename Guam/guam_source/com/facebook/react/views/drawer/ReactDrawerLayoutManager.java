...
public class ReactDrawerLayoutManager extends ViewGroupManager<ReactDrawerLayout> {
    ...
    public void addView(ReactDrawerLayout reactDrawerLayout, View view, int i) {
        if (getChildCount(reactDrawerLayout) >= 2) {
            ...
            throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline5("The only valid indices for drawer's child are 0 or 1. Got ", i, " instead."));
        }
    }
    ...
    public void setDrawerPosition(ReactDrawerLayout reactDrawerLayout, Dynamic dynamic) {
        if (dynamic.isNull()) {
            ...
            throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline4("Unknown drawerPosition ", asInt));
