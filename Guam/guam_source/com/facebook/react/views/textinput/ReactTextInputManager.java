...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
                        ...
                        if (javaOnlyMap != null && javaOnlyMap.hasKey("fragments")) {
                            ...
                            while (i9 < javaOnlyArray.size() && !z) {
                                ...
                                if (length < i5) {
                                    ...
                                    str3 = str4;
                                    GeneratedOutlineSupport.outline20(string2, 0, i12, sb2, charSequence2);
    ...
    public void setColor(ReactEditText reactEditText, Integer num) {
        if (num == null) {
            ...
            String str = TAG;
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Could not get default text color from View Context: ");
            outline15.append(context != null ? context.getClass().getCanonicalName() : "null");
            ReactSoftException.logSoftException(str, new IllegalStateException(outline15.toString()));
            return;
        }
    ...
    public Object updateState(ReactEditText reactEditText, ReactStylesDiffMap reactStylesDiffMap, StateWrapper stateWrapper) {
        ...
        if (!state.getBoolean("hasThemeData")) {
            ...
            if (reactContext instanceof ThemedReactContext) {
                ...
                String str = TAG;
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("ReactContext is not a ThemedReactContent: ");
                outline15.append(reactContext != null ? reactContext.getClass().getName() : "null");
                ReactSoftException.logSoftException(str, new IllegalStateException(outline15.toString()));
            }
        }
