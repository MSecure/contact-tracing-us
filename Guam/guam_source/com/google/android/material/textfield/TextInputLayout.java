...
public class TextInputLayout extends LinearLayout {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("TextInputLayout.SavedState{");
            outline15.append(Integer.toHexString(System.identityHashCode(this)));
            outline15.append(" error=");
            outline15.append((Object) this.error);
            outline15.append("}");
    ...
    public final void onApplyBoxBackgroundMode() {
        ...
        if (i == 0) {
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline11(new StringBuilder(), this.boxBackgroundMode, " is illegal; only @BoxBackgroundMode constants are supported."));
        }
        EditText editText2 = this.editText;
    ...
    public void setEndIconMode(int i) {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("The current box background mode ");
        outline15.append(this.boxBackgroundMode);
        outline15.append(" is not supported by the end icon mode ");
        outline15.append(i);
