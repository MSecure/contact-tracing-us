...
public final class C$Gson$Types {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type type, Type type2, Type... typeArr) {
            ...
            if (type2 instanceof Class) {
                ...
                ReactYogaConfigProvider.checkArgument2(z);
            }
            if (type == null) {
                type3 = null;
            } else {
            ...
            for (int i = 0; i < length; i++) {
                ReactYogaConfigProvider.checkNotNull2(this.typeArguments[i]);
    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public WildcardTypeImpl(Type[] typeArr, Type[] typeArr2) {
            boolean z = true;
            ReactYogaConfigProvider.checkArgument2(typeArr2.length <= 1);
            ReactYogaConfigProvider.checkArgument2(typeArr.length == 1);
            if (typeArr2.length == 1) {
                ReactYogaConfigProvider.checkNotNull2(typeArr2[0]);
                C$Gson$Types.checkNotPrimitive(typeArr2[0]);
                ReactYogaConfigProvider.checkArgument2(typeArr[0] != Object.class ? false : z);
                this.lowerBound = C$Gson$Types.canonicalize(typeArr2[0]);
                this.upperBound = Object.class;
                return;
            }
            ReactYogaConfigProvider.checkNotNull2(typeArr[0]);
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("? super ");
                outline15.append(C$Gson$Types.typeToString(this.lowerBound));
                return outline15.toString();
            } else if (this.upperBound == Object.class) {
                return ColorPropConverter.PREFIX_ATTR;
            } else {
                StringBuilder outline152 = GeneratedOutlineSupport.outline15("? extends ");
                outline152.append(C$Gson$Types.typeToString(this.upperBound));
    ...
    public static void checkNotPrimitive(Type type) {
        ReactYogaConfigProvider.checkArgument2(!(type instanceof Class) || !((Class) type).isPrimitive());
    }
    ...
    public static Class<?> getRawType(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            ReactYogaConfigProvider.checkArgument2(rawType instanceof Class);
    ...
    public static Type getSupertype(Type type, Class<?> cls, Class<?> cls2) {
        ...
        ReactYogaConfigProvider.checkArgument2(cls2.isAssignableFrom(cls));
            ...
            if (type2 instanceof TypeVariable) {
                ...
                if (type2 instanceof Class) {
                    ...
                    if (cls3.isArray()) {
                        ...
                        return componentType == resolve ? cls3 : new GenericArrayTypeImpl(resolve);
                    }
                }
                if (type2 instanceof GenericArrayType) {
