...
public class JsonReader implements Closeable {
    ...
    public void beginArray() throws IOException {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected BEGIN_ARRAY but was ");
        outline15.append(peek());
        outline15.append(locationString());
    ...
    public void beginObject() throws IOException {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected BEGIN_OBJECT but was ");
        outline15.append(peek());
        outline15.append(locationString());
        throw new IllegalStateException(outline15.toString());
    }
    ...
    public int doPeek() throws IOException {
        ...
        if (nextNonWhitespace5 == 34) {
            ...
            if (nextNonWhitespace5 == 44 || nextNonWhitespace5 == 59) {
                ...
                if (c4 == 't' || c4 == 'T') {
                    str2 = BuildConfig.DISPLAY_CALL_EMERGENCY_SERVICES;
                    str = "TRUE";
                    i2 = 5;
                } else if (c4 == 'f' || c4 == 'F') {
                    str2 = "false";
    ...
    public void endArray() throws IOException {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected END_ARRAY but was ");
        outline15.append(peek());
        outline15.append(locationString());
        throw new IllegalStateException(outline15.toString());
    }
    ...
    public void endObject() throws IOException {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected END_OBJECT but was ");
        outline15.append(peek());
        outline15.append(locationString());
        throw new IllegalStateException(outline15.toString());
    }
    ...
    public boolean nextBoolean() throws IOException {
        ...
        if (i == 5) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected a boolean but was ");
            outline15.append(peek());
            outline15.append(locationString());
            throw new IllegalStateException(outline15.toString());
        }
    ...
    public double nextDouble() throws IOException {
        ...
        if (i == 16) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected a double but was ");
            outline15.append(peek());
            outline15.append(locationString());
            throw new IllegalStateException(outline15.toString());
        }
    ...
    public int nextInt() throws IOException {
        ...
        if (i == 15) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected an int but was ");
            outline15.append(this.peekedLong);
            outline15.append(locationString());
            throw new NumberFormatException(outline15.toString());
        }
        if (i == 16) {
            this.peekedString = new String(this.buffer, this.pos, this.peekedNumberLength);
            this.pos += this.peekedNumberLength;
            ...
            StringBuilder outline152 = GeneratedOutlineSupport.outline15("Expected an int but was ");
            outline152.append(peek());
            outline152.append(locationString());
        ...
        StringBuilder outline153 = GeneratedOutlineSupport.outline15("Expected an int but was ");
        outline153.append(this.peekedString);
        outline153.append(locationString());
        throw new NumberFormatException(outline153.toString());
    }
    ...
    public long nextLong() throws IOException {
        ...
        if (i == 16) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected a long but was ");
            outline15.append(peek());
            outline15.append(locationString());
            throw new IllegalStateException(outline15.toString());
        }
        ...
        StringBuilder outline152 = GeneratedOutlineSupport.outline15("Expected a long but was ");
        outline152.append(this.peekedString);
        outline152.append(locationString());
        throw new NumberFormatException(outline152.toString());
    }
        ...
        while (true) {
            ...
            if (i == i2) {
                ...
                if (fillBuffer(1)) {
                    ...
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("End of input");
                    outline15.append(locationString());
                    throw new EOFException(outline15.toString());
                }
            }
            int i3 = i + 1;
            char c = cArr[i];
    ...
    public void nextNull() throws IOException {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected null but was ");
        outline15.append(peek());
        outline15.append(locationString());
        throw new IllegalStateException(outline15.toString());
    }
    ...
    public String nextString() throws IOException {
        ...
        if (i == 10) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected a string but was ");
            outline15.append(peek());
            outline15.append(locationString());
            throw new IllegalStateException(outline15.toString());
        }
                    ...
                    while (i5 < i6) {
                        ...
                        if (c3 < '0' || c3 > '9') {
                            if (c3 >= 'a' && c3 <= 'f') {
                                ...
                                StringBuilder outline15 = GeneratedOutlineSupport.outline15("\\u");
                                outline15.append(new String(this.buffer, this.pos, 4));
                                throw new NumberFormatException(outline15.toString());
                            } else {
                                i2 = c3 - 'A';
                            }
    ...
    public final IOException syntaxError(String str) throws IOException {
        ...
        outline15.append(locationString());
        throw new MalformedJsonException(outline15.toString());
    }
