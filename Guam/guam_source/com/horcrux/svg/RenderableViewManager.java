...
public class RenderableViewManager extends ViewGroupManager<VirtualView> {
    ...
    public static final MatrixDecompositionContext sMatrixDecompositionContext = new MatrixDecompositionContext();
    ...
    public static class CircleViewManager extends RenderableViewManager {
        ...
        @Override // com.facebook.react.uimanager.BaseViewManager, com.horcrux.svg.RenderableViewManager
    ...
    public class RenderableShadowNode extends LayoutShadowNode {
        ...
        @ReactPropGroup(names = {"alignSelf", "alignItems", "collapsable", "flex", "flexBasis", "flexDirection", "flexGrow", "flexShrink", "flexWrap", "justifyContent", "overflow", "alignContent", "display", "position", RNGestureHandlerModule.KEY_HIT_SLOP_RIGHT, RNGestureHandlerModule.KEY_HIT_SLOP_TOP, RNGestureHandlerModule.KEY_HIT_SLOP_BOTTOM, RNGestureHandlerModule.KEY_HIT_SLOP_LEFT, "start", "end", RNGestureHandlerModule.KEY_HIT_SLOP_WIDTH, RNGestureHandlerModule.KEY_HIT_SLOP_HEIGHT, "minWidth", "maxWidth", "minHeight", "maxHeight", "margin", "marginVertical", "marginHorizontal", "marginLeft", "marginRight", "marginTop", "marginBottom", "marginStart", "marginEnd", "padding", "paddingVertical", "paddingHorizontal", "paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "paddingStart", "paddingEnd", "borderWidth", "borderStartWidth", "borderEndWidth", "borderTopWidth", "borderBottomWidth", "borderLeftWidth", "borderRightWidth"})
    ...
    public static void decomposeMatrix() {
        ...
        if (!isZero(sTransformDecompositionArray[15])) {
            ...
            dArr7[15] = 1.0d;
            if (!isZero(AppCompatDelegateImpl.ConfigurationImplApi17.determinant(dArr7))) {
                if (!isZero(dArr6[0][3]) || !isZero(dArr6[1][3]) || !isZero(dArr6[2][3])) {
                    AppCompatDelegateImpl.ConfigurationImplApi17.multiplyVectorByMatrix(new double[]{dArr6[0][3], dArr6[1][3], dArr6[2][3], dArr6[3][3]}, AppCompatDelegateImpl.ConfigurationImplApi17.transpose(AppCompatDelegateImpl.ConfigurationImplApi17.inverse(dArr7)), dArr);
                } else {
                    dArr[2] = 0.0d;
                    dArr[1] = 0.0d;
                    dArr[0] = 0.0d;
                ...
                dArr2[0] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Length(dArr9[0]);
                dArr9[0] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Normalize(dArr9[0], dArr2[0]);
                dArr3[0] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Dot(dArr9[0], dArr9[1]);
                dArr9[1] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Combine(dArr9[1], dArr9[0], 1.0d, -dArr3[0]);
                dArr3[0] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Dot(dArr9[0], dArr9[1]);
                dArr9[1] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Combine(dArr9[1], dArr9[0], 1.0d, -dArr3[0]);
                dArr2[1] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Length(dArr9[1]);
                dArr9[1] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Normalize(dArr9[1], dArr2[1]);
                dArr3[0] = dArr3[0] / dArr2[1];
                dArr3[1] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Dot(dArr9[0], dArr9[2]);
                dArr9[2] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Combine(dArr9[2], dArr9[0], 1.0d, -dArr3[1]);
                dArr3[2] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Dot(dArr9[1], dArr9[2]);
                dArr9[2] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Combine(dArr9[2], dArr9[1], 1.0d, -dArr3[2]);
                dArr2[2] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Length(dArr9[2]);
                dArr9[2] = AppCompatDelegateImpl.ConfigurationImplApi17.v3Normalize(dArr9[2], dArr2[2]);
                dArr3[1] = dArr3[1] / dArr2[2];
                dArr3[2] = dArr3[2] / dArr2[2];
                if (AppCompatDelegateImpl.ConfigurationImplApi17.v3Dot(dArr9[0], AppCompatDelegateImpl.ConfigurationImplApi17.v3Cross(dArr9[1], dArr9[2])) < 0.0d) {
                ...
                dArr5[0] = AppCompatDelegateImpl.ConfigurationImplApi17.roundTo3Places((-Math.atan2(dArr9[2][1], dArr9[2][2])) * 57.29577951308232d);
                dArr5[1] = AppCompatDelegateImpl.ConfigurationImplApi17.roundTo3Places((-Math.atan2(-dArr9[2][0], Math.sqrt((dArr9[2][2] * dArr9[2][2]) + (dArr9[2][1] * dArr9[2][1])))) * 57.29577951308232d);
                dArr5[2] = AppCompatDelegateImpl.ConfigurationImplApi17.roundTo3Places((-Math.atan2(dArr9[1][0], dArr9[0][0])) * 57.29577951308232d);
            }
        }
    }
    ...
    public static void setTransformProperty(View view, ReadableArray readableArray) {
        ...
        decomposeMatrix();
        view.setTranslationX(AppCompatDelegateImpl.ConfigurationImplApi17.toPixelFromDIP((float) sMatrixDecompositionContext.translation[0]));
        view.setTranslationY(AppCompatDelegateImpl.ConfigurationImplApi17.toPixelFromDIP((float) sMatrixDecompositionContext.translation[1]));
    ...
    public VirtualView createViewInstance(ThemedReactContext themedReactContext) {
        switch (this.svgClass.ordinal()) {
            ...
            default:
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unexpected type ");
                outline15.append(this.svgClass.toString());
    ...
    public void onDropViewInstance(VirtualView virtualView) {
        super.onDropViewInstance((View) virtualView);
