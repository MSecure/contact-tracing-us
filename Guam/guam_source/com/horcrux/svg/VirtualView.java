...
public abstract class VirtualView extends ReactViewGroup {
    ...
    public SvgView getSvgView() {
        ...
        if (parent instanceof SvgView) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("RNSVG: ");
            outline15.append(getClass().getName());
            outline15.append(" should be descendant of a SvgView.");
    ...
    public void setMatrix(Dynamic dynamic) {
        ...
        if (dynamic.isNull() || !type.equals(ReadableType.Array)) {
            ...
            int matrixData = PathParser.toMatrixData(dynamic.asArray(), sRawMatrix, this.mScale);
            if (matrixData == 6) {
        ...
        if (this.mClipPath != null) {
            ...
            if (clipPathView != null) {
                ...
                if (i == 0) {
                    ...
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("RNSVG: clipRule: ");
                    outline15.append(this.mClipRule);
                    outline15.append(" unrecognized");
                    FLog.w("ReactNative", outline15.toString());
                }
                this.mCachedClipPath = path;
            } else {
                StringBuilder outline152 = GeneratedOutlineSupport.outline15("RNSVG: Undefined clipPath: ");
                outline152.append(this.mClipPath);
                FLog.w("ReactNative", outline152.toString());
            }
        }
        return getClipPath();
    }
