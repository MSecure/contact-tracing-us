    ...
    public final void fixSpinner(Context context, int i, int i2, int i3, RNDatePickerDisplay rNDatePickerDisplay) {
        if (Build.VERSION.SDK_INT == 24 && rNDatePickerDisplay == RNDatePickerDisplay.SPINNER) {
            try {
                ...
                DatePicker datePicker = (DatePicker) PathParser.findField(DatePickerDialog.class, DatePicker.class, "mDatePicker").get(this);
                Field findField = PathParser.findField(DatePicker.class, Class.forName("android.widget.DatePickerSpinnerDelegate"), "mDelegate");
