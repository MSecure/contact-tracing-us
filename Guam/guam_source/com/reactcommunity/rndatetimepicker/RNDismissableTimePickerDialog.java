...
public class RNDismissableTimePickerDialog extends TimePickerDialog {
    public RNDismissableTimePickerDialog(Context context, TimePickerDialog.OnTimeSetListener onTimeSetListener, int i, int i2, boolean z, RNTimePickerDisplay rNTimePickerDisplay) {
    ...
    public final void fixSpinner(Context context, int i, int i2, boolean z, RNTimePickerDisplay rNTimePickerDisplay) {
        if (Build.VERSION.SDK_INT == 24 && rNTimePickerDisplay == RNTimePickerDisplay.SPINNER) {
            try {
                ...
                TimePicker timePicker = (TimePicker) PathParser.findField(TimePickerDialog.class, TimePicker.class, "mTimePicker").get(this);
                Field findField = PathParser.findField(TimePicker.class, Class.forName("android.widget.TimePicker$TimePickerDelegate"), "mDelegate");
    ...
    public RNDismissableTimePickerDialog(Context context, int i, TimePickerDialog.OnTimeSetListener onTimeSetListener, int i2, int i3, boolean z, RNTimePickerDisplay rNTimePickerDisplay) {
