...
public class GestureHandlerOrchestrator {
    ...
    public final RNGestureHandlerRegistry mHandlerRegistry;
    ...
    public GestureHandlerOrchestrator(ViewGroup viewGroup, RNGestureHandlerRegistry rNGestureHandlerRegistry, ViewConfigurationHelper viewConfigurationHelper) {
        this.mWrapperView = viewGroup;
        this.mHandlerRegistry = rNGestureHandlerRegistry;
    ...
    public final boolean recordViewHandlersForPointer(View view, float[] fArr, int i) {
        ...
        RNGestureHandlerRegistry rNGestureHandlerRegistry = this.mHandlerRegistry;
        ...
        if (((RNViewConfigurationHelper) this.mViewConfigHelper) != null) {
            ...
            if (!view.isEnabled()) {
                ...
                if (pointerEventsConfig == pointerEventsConfig3) {
                    ...
                    outline15.append(pointerEventsConfig.toString());
