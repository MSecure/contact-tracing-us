...
public class RotationGestureHandler extends GestureHandler<RotationGestureHandler> {
    public RotationGestureDetector.OnRotationGestureListener mGestureListener = new RotationGestureDetector.OnRotationGestureListener() {
        /* class com.swmansion.gesturehandler.RotationGestureHandler.AnonymousClass1 */
    };
            ...
            if (actionMasked == 0) {
                ...
                if (actionMasked != 2) {
                    ...
                    if (onRotationGestureListener3 != null) {
                        ...
                        if (j > 0) {
                            rotationGestureHandler.mLastVelocity = (d2 - d) / ((double) j);
                        }
                        if (Math.abs(RotationGestureHandler.this.mLastRotation) >= 0.08726646259971647d) {
