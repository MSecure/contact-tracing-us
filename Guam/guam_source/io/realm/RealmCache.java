...
public final class RealmCache {
    ...
    public static class GlobalReferenceCounter extends ReferenceCounter {
        ...
        public void clearThreadLocalCache() {
            ...
            if (this.globalCount.decrementAndGet() < 0) {
                throw new IllegalStateException(GeneratedOutlineSupport.outline9("Global reference counter of Realm", str, " not be negative."));
            }
        }
    ...
    public static class ThreadConfinedReferenceCounter extends ReferenceCounter {
        ...
        public void clearThreadLocalCache() {
            ...
            if (this.globalCount.decrementAndGet() < 0) {
                throw new IllegalStateException(GeneratedOutlineSupport.outline9("Global reference counter of Realm", str, " can not be negative."));
            }
        }
    ...
    public static void deleteRealmFileOnDisk(RealmConfiguration realmConfiguration) {
        ...
        while (i > 0 && !z) {
            try {
                ...
                i--;
                RealmLog.warn(GeneratedOutlineSupport.outline5("Sync server still holds a reference to the Realm. It cannot be deleted. Retrying ", i, " more times"), new Object[0]);
                if (i > 0) {
        ...
        if (!z) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Failed to delete the underlying Realm file: ");
            outline15.append(realmConfiguration.canonicalPath);
        ...
        if (!this.configuration.equals(realmConfiguration)) {
            if (Arrays.equals(this.configuration.getEncryptionKey(), realmConfiguration.getEncryptionKey())) {
                ...
                if (realmMigration2 == null || realmMigration == null || !realmMigration2.getClass().equals(realmMigration.getClass()) || realmMigration.equals(realmMigration2)) {
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("Configurations cannot be different if used to open the same file. \nCached configuration: \n");
                    outline15.append(this.configuration);
                    outline15.append("\n\nNew configuration: \n");
                    outline15.append(realmConfiguration);
                    throw new IllegalArgumentException(outline15.toString());
                }
                StringBuilder outline152 = GeneratedOutlineSupport.outline15("Configurations cannot be different if used to open the same file. The most likely cause is that equals() and hashCode() are not overridden in the migration class: ");
                outline152.append(realmConfiguration.migration.getClass().getCanonicalName());
