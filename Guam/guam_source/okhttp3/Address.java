...
public final class Address {
    ...
    public String toString() {
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Address{");
        outline15.append(this.url.host());
        outline15.append(ColorPropConverter.PACKAGE_DELIMITER);
        outline15.append(this.url.port());
        if (this.proxy != null) {
            outline15.append(", proxy=");
            outline15.append(this.proxy);
        } else {
            outline15.append(", proxySelector=");
            outline15.append(this.proxySelector);
        }
        outline15.append("}");
