...
public final class Cache implements Closeable, Flushable {
        ...
        return new Iterator<String>() {
            ...
            public boolean hasNext() {
                ...
                while (this.delegate.hasNext()) {
                    ...
                    try {
                        this.nextUrl = ((RealBufferedSource) Okio.buffer(next.getSource(0))).readUtf8LineStrict();
                        return true;
                    } catch (IOException unused) {
                    } finally {
                        next.close();
    ...
    public static final class Entry {
        ...
        public void writeTo(DiskLruCache.Editor editor) throws IOException {
            ...
            realBufferedSink.writeByte(10);
            realBufferedSink.writeDecimalLong((long) this.varyHeaders.size());
            realBufferedSink.writeByte(10);
            ...
            realBufferedSink.writeByte(10);
            realBufferedSink.writeDecimalLong((long) (this.responseHeaders.size() + 2));
            realBufferedSink.writeByte(10);
