...
public final class HttpUrl {
    ...
    public static final class Builder {
        ...
        public Builder parse(HttpUrl httpUrl, String str) {
            ...
            if (schemeDelimiterOffset != -1) {
                if (str.regionMatches(true, skipLeadingAsciiWhitespace, "https:", 0, 6)) {
                    ...
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected URL scheme 'http' or 'https' but was '");
                    outline15.append(str.substring(0, schemeDelimiterOffset));
                    outline15.append("'");
            ...
            if (slashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                if (i22 < delimiterOffset) {
                    ...
                    this.port = parsePort;
                    if (parsePort == -1) {
                        StringBuilder outline152 = GeneratedOutlineSupport.outline15("Invalid URL port: \"");
                        outline152.append(str.substring(i22, delimiterOffset));
                        outline152.append('\"');
                ...
                if (this.host != null) {
                    ...
                    StringBuilder outline153 = GeneratedOutlineSupport.outline15("Invalid URL host: \"");
                    outline153.append(str.substring(i, portColonOffset2));
                    outline153.append('\"');
        ...
        public Builder port(int i) {
            if (i <= 0 || i > 65535) {
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline4("unexpected port: ", i));
            }
            this.port = i;
            return this;
        }
