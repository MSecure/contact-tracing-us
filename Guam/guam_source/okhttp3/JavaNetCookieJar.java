...
public final class JavaNetCookieJar implements CookieJar {
    ...
    public List<Cookie> loadForRequest(HttpUrl httpUrl) {
        try {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Loading cookies failed for ");
            outline15.append(httpUrl.resolve("/..."));
            platform.log(5, outline15.toString(), e);
            return Collections.emptyList();
        }
    }
    ...
    public void saveFromResponse(HttpUrl httpUrl, List<Cookie> list) {
        if (this.cookieHandler != null) {
            ...
            try {
                ...
                Platform platform = Platform.get();
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Saving cookies failed for ");
                outline15.append(httpUrl.resolve("/..."));
                platform.log(5, outline15.toString(), e);
            }
        }
