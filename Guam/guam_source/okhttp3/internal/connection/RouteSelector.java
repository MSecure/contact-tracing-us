...
public final class RouteSelector {
    ...
    private Proxy nextProxy() throws IOException {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("No route to ");
        outline15.append(this.address.url().host());
        outline15.append("; exhausted proxy configurations: ");
        outline15.append(this.proxies);
        throw new SocketException(outline15.toString());
    }
    ...
    private void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (proxy.type() == Proxy.Type.DIRECT || proxy.type() == Proxy.Type.SOCKS) {
            ...
            if (address2 instanceof InetSocketAddress) {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Proxy.address() is not an InetSocketAddress: ");
                outline15.append(address2.getClass());
                throw new IllegalArgumentException(outline15.toString());
            }
        }
        if (i < 1 || i > 65535) {
            throw new SocketException("No route to " + str + ColorPropConverter.PACKAGE_DELIMITER + i + "; port is out of range");
