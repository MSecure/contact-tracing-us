...
public final class HttpHeaders {
    ...
    public static void parseChallengeHeader(List<Challenge> list, Buffer buffer) {
        ...
        while (true) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15(readToken);
            outline15.append(repeat('=', skipAll));
            list.add(new Challenge(str2, Collections.singletonMap(null, outline15.toString())));
        }
    }
