...
public final class Http1Codec implements HttpCodec {
    ...
    public abstract class AbstractSource implements Source {
        ...
        public final void endOfInput(boolean z, IOException iOException) throws IOException {
            ...
            if (i != 6) {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("state: ");
                outline15.append(Http1Codec.this.state);
    ...
    public final class ChunkedSink implements Sink {
        ...
        public void write(Buffer buffer, long j) throws IOException {
            if (this.closed) {
                ...
                Http1Codec.this.sink.writeUtf8(MultipartStreamReader.CRLF);
    ...
    public class ChunkedSource extends AbstractSource {
        ...
        @Override // okio.Source, java.io.Closeable, okhttp3.internal.http1.Http1Codec.AbstractSource, java.lang.AutoCloseable
    ...
    public final class FixedLengthSink implements Sink {
        ...
        public void write(Buffer buffer, long j) throws IOException {
            if (!this.closed) {
                ...
                outline15.append(this.bytesRemaining);
                outline15.append(" bytes but received ");
                outline15.append(j);
    ...
    public Response.Builder readResponseHeaders(boolean z) throws IOException {
        ...
        if (i == 1 || i == 3) {
            try {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("unexpected end of stream on ");
                outline15.append(this.streamAllocation);
                IOException iOException = new IOException(outline15.toString());
                iOException.initCause(e);
                throw iOException;
            }
        } else {
            StringBuilder outline152 = GeneratedOutlineSupport.outline15("state: ");
            outline152.append(this.state);
    ...
    public void writeRequest(Headers headers, String str) throws IOException {
        if (this.state == 0) {
            this.sink.writeUtf8(str).writeUtf8(MultipartStreamReader.CRLF);
            int size = headers.size();
            for (int i = 0; i < size; i++) {
                this.sink.writeUtf8(headers.name(i)).writeUtf8(": ").writeUtf8(headers.value(i)).writeUtf8(MultipartStreamReader.CRLF);
            }
            this.sink.writeUtf8(MultipartStreamReader.CRLF);
            this.state = 1;
            return;
        }
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("state: ");
