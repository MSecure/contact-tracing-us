...
public final class Hpack {
    ...
    public static final Header[] STATIC_HEADER_TABLE = {new Header(Header.TARGET_AUTHORITY, ""), new Header(Header.TARGET_METHOD, "GET"), new Header(Header.TARGET_METHOD, "POST"), new Header(Header.TARGET_PATH, ColorPropConverter.PATH_DELIMITER), new Header(Header.TARGET_PATH, "/index.html"), new Header(Header.TARGET_SCHEME, "http"), new Header(Header.TARGET_SCHEME, "https"), new Header(Header.RESPONSE_STATUS, "200"), new Header(Header.RESPONSE_STATUS, "204"), new Header(Header.RESPONSE_STATUS, "206"), new Header(Header.RESPONSE_STATUS, "304"), new Header(Header.RESPONSE_STATUS, "400"), new Header(Header.RESPONSE_STATUS, "404"), new Header(Header.RESPONSE_STATUS, "500"), new Header("accept-charset", ""), new Header("accept-encoding", "gzip, deflate"), new Header("accept-language", ""), new Header("accept-ranges", ""), new Header("accept", ""), new Header("access-control-allow-origin", ""), new Header("age", ""), new Header("allow", ""), new Header("authorization", ""), new Header("cache-control", ""), new Header("content-disposition", ""), new Header(NetworkingModule.CONTENT_ENCODING_HEADER_NAME, ""), new Header("content-language", ""), new Header("content-length", ""), new Header("content-location", ""), new Header("content-range", ""), new Header(NetworkingModule.CONTENT_TYPE_HEADER_NAME, ""), new Header("cookie", ""), new Header(DatePickerDialogModule.ARG_DATE, ""), new Header("etag", ""), new Header("expect", ""), new Header("expires", ""), new Header("from", ""), new Header(Http2Codec.HOST, ""), new Header("if-match", ""), new Header("if-modified-since", ""), new Header("if-none-match", ""), new Header("if-range", ""), new Header("if-unmodified-since", ""), new Header("last-modified", ""), new Header("link", ""), new Header("location", ""), new Header("max-forwards", ""), new Header("proxy-authenticate", ""), new Header("proxy-authorization", ""), new Header("range", ""), new Header("referer", ""), new Header("refresh", ""), new Header("retry-after", ""), new Header("server", ""), new Header("set-cookie", ""), new Header("strict-transport-security", ""), new Header(Http2Codec.TRANSFER_ENCODING, ""), new Header(NetworkingModule.USER_AGENT_HEADER_NAME, ""), new Header("vary", ""), new Header("via", ""), new Header("www-authenticate", "")};
    ...
    public static final class Reader {
        ...
        private ByteString getName(int i) throws IOException {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Header index too large ");
            outline15.append(i + 1);
            ...
            while (!this.source.exhausted()) {
                ...
                if (readByte == 128) {
                    ...
                    if (readInt < 0 || readInt > this.headerTableSizeSetting) {
                        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Invalid dynamic table size update ");
                        outline15.append(this.maxDynamicTableByteCount);
                        throw new IOException(outline15.toString());
                    }
    ...
    public static ByteString checkLowercase(ByteString byteString) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (b >= 65 && b <= 90) {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("PROTOCOL_ERROR response malformed: mixed case name: ");
                outline15.append(byteString.utf8());
                throw new IOException(outline15.toString());
            }
        }
        return byteString;
