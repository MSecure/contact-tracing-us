...
public final class DistinguishedNameParser {
    ...
    private int getByte(int i) {
        ...
        if (i4 < this.length) {
            ...
            if (c >= '0' && c <= '9') {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Malformed DN: ");
                outline15.append(this.dn);
            ...
            if (c2 >= '0' && c2 <= '9') {
                ...
                StringBuilder outline152 = GeneratedOutlineSupport.outline15("Malformed DN: ");
                outline152.append(this.dn);
        ...
        StringBuilder outline153 = GeneratedOutlineSupport.outline15("Malformed DN: ");
        outline153.append(this.dn);
        throw new IllegalStateException(outline153.toString());
    }
    ...
    private char getEscaped() {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unexpected end of DN: ");
        outline15.append(this.dn);
        throw new IllegalStateException(outline15.toString());
    }
    ...
    private String hexAV() {
        ...
        StringBuilder outline152 = GeneratedOutlineSupport.outline15("Unexpected end of DN: ");
        outline152.append(this.dn);
        throw new IllegalStateException(outline152.toString());
    }
