...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Request must be GET: ");
        outline15.append(request.method());
    ...
    public void checkResponse(Response response) throws ProtocolException {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected HTTP 101 response but was '");
        outline15.append(response.code());
        outline15.append(" ");
        outline15.append(response.message());
        outline15.append("'");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x001e, code lost:
        r2 = com.android.tools.r8.GeneratedOutlineSupport.outline15("sent ping but didn't receive pong within ");
