...
public final class WebSocketReader {
    ...
    private void readControlFrame() throws IOException {
        ...
        switch (this.opcode) {
            ...
            case 10:
                ...
                return;
            default:
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unknown control opcode: ");
                outline15.append(Integer.toHexString(this.opcode));
            ...
            try {
                ...
                if (!z2 || this.isFinalFrame) {
                    ...
                    if (j == 126) {
                        ...
                        if (readLong < 0) {
                            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Frame length 0x");
                            outline15.append(Long.toHexString(this.frameLength));
                            outline15.append(" > 0x7FFFFFFFFFFFFFFF");
                            throw new ProtocolException(outline15.toString());
                        }
                    }
    ...
    private void readMessage() throws IOException {
        while (!this.closed) {
            ...
            if (!this.isFinalFrame) {
                ...
                if (this.opcode != 0) {
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected continuation opcode. Got: ");
                    outline15.append(Integer.toHexString(this.opcode));
                    throw new ProtocolException(outline15.toString());
                }
            } else {
    ...
    private void readMessageFrame() throws IOException {
        ...
        if (i == 1 || i == 2) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unknown opcode: ");
