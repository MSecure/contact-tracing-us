...
public class AsyncTimeout extends Timeout {
    ...
    public final Sink sink(final Sink sink) {
        return new Sink() {
            ...
            public String toString() {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("AsyncTimeout.sink(");
                outline15.append(sink);
                outline15.append(")");
    ...
    public final Source source(final Source source) {
        return new Source() {
            ...
            public String toString() {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("AsyncTimeout.source(");
                outline15.append(source);
                outline15.append(")");
                return outline15.toString();
            }
        };
