...
public final class RealBufferedSource implements BufferedSource {
    ...
    public long readAll(Sink sink) throws IOException {
        ...
        while (this.source.read(this.buffer, 8192) != -1) {
            ...
            if (completeSegmentByteCount > 0) {
                ...
                ((Okio.AnonymousClass1) sink).write(this.buffer, completeSegmentByteCount);
            }
        }
        ...
        long j3 = j + j2;
        ((Okio.AnonymousClass1) sink).write(buffer2, j2);
        return j3;
    }
    ...
    public String toString() {
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("buffer(");
        outline15.append(this.source);
        outline15.append(")");
    ...
    public String readUtf8LineStrict(long j) throws IOException {
        if (j >= 0) {
            ...
            outline15.append(Math.min(this.buffer.size, j));
            outline15.append(" content=");
            outline15.append(buffer2.readByteString().hex());
