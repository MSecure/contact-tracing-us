...
public class Timeout {
    ...
    public final Timeout deadline(long j, TimeUnit timeUnit) {
        if (j <= 0) {
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline6("duration <= 0: ", j));
    ...
    public Timeout timeout(long j, TimeUnit timeUnit) {
        if (j < 0) {
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline6("timeout < 0: ", j));
        } else if (timeUnit != null) {
