...
public class ExposureNotificationClientWrapper {
    ...
    public static final Duration PROVIDE_KEYS_TIMEOUT = Duration.create(PathParser.safeMultiply(30L, 60), 0);
    ...
    public Object lambda$requestPermissionToGetExposureKeys$5$ExposureNotificationClientWrapper(ReactContext reactContext, CallbackToFutureAdapter$Completer callbackToFutureAdapter$Completer) throws Exception {
        ...
        if (zzt != null) {
            ...
            zaa.addOnSuccessListener(new OnSuccessListener(callbackToFutureAdapter$Completer) {
            ...
            zaa.addOnFailureListener(new OnFailureListener(callbackToFutureAdapter$Completer, reactContext) {
    ...
    public /* synthetic */ Object lambda$requestPermissionToStartTracing$2$ExposureNotificationClientWrapper(ReactContext reactContext, CallbackToFutureAdapter$Completer callbackToFutureAdapter$Completer) throws Exception {
        Task<Void> start = ((zzt) this.exposureNotificationClient).start();
        start.addOnSuccessListener(new OnSuccessListener(reactContext, callbackToFutureAdapter$Completer) {
        ...
        start.addOnFailureListener(new OnFailureListener(callbackToFutureAdapter$Completer, reactContext) {
    ...
    public void onExposureNotificationStateChanged(ReactContext reactContext, boolean z) {
        ...
        if (reactContext != null && (rCTDeviceEventEmitter = (DeviceEventManagerModule.RCTDeviceEventEmitter) reactContext.getJSModule(DeviceEventManagerModule.RCTDeviceEventEmitter.class)) != null) {
            rCTDeviceEventEmitter.emit("onEnabledStatusUpdated", PathParser.getEnStatusWritableArray(z));
        }
    }
    ...
    public final ListenableFuture<Void> provideDiagnosisKeysFuture(List<File> list) {
        ...
        if (zzt != null) {
            ...
            TaskApiCall.Builder builder = TaskApiCall.builder();
            builder.zaa = new zzu(zzt);
            builder.zac = new Feature[]{zza.zzd};
            Task zaa = zzt.zaa(0, builder.build());
            zzah zzah = new zzah(zzt, list, exposureConfiguration, "TYZWQ32170AXEUVCDW7A");
            com.google.android.gms.tasks.zzu zzu = (com.google.android.gms.tasks.zzu) zaa;
            if (zzu != null) {
                Executor executor = TaskExecutors.MAIN_THREAD;
                com.google.android.gms.tasks.zzu zzu2 = new com.google.android.gms.tasks.zzu();
                zzq<TResult> zzq = zzu.zzb;
                zzv.zza(executor);
                zzq.zza(new zzd(executor, zzah, zzu2));
                zzu.zze();
                return PathParser.getFutureWithTimeout(zzu2, PROVIDE_KEYS_TIMEOUT.toMillis(), TimeUnit.MILLISECONDS, AppExecutors.getScheduledExecutor());
            }
            throw null;
        }
        throw null;
    ...
    public final ListenableFuture<Void> setDiagnosisKeysDataMapping() {
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("setDiagnosisKeysDataMapping called with config ");
        outline15.append(this.config.getDiagnosisKeysDataMapping());
        outline15.toString();
        ...
        if (zzt != null) {
            ...
            return PathParser.getFutureWithTimeout(zzt.zaa(1, builder.build()), SET_DIAGNOSIS_KEY_DATA_MAPPING_TIMEOUT.toMillis(), TimeUnit.MILLISECONDS, AppExecutors.getScheduledExecutor());
        }
        throw null;
    }
    ...
    public Task<Void> stopTracing(ReactContext reactContext) {
        ...
        stop.addOnSuccessListener(new OnSuccessListener(reactContext) {
        ...
        stop.addOnFailureListener(new OnFailureListener(reactContext) {
        ...
        stop.addOnCanceledListener(new OnCanceledListener(reactContext) {
