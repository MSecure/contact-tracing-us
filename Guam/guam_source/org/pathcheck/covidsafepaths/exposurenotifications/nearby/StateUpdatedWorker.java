...
public class StateUpdatedWorker extends ListenableWorker {
    ...
    public ListenableFuture<ListenableWorker.Result> startWork() {
        ...
        if (zzt != null) {
            ...
            FluentFuture from = FluentFuture.from(FluentFuture.from(PathParser.getFutureWithTimeout(zzt.zaa(0, builder.build()), ExposureNotificationClientWrapper.GET_DAILY_SUMMARIES_TIMEOUT.toMillis(), TimeUnit.MILLISECONDS, AppExecutors.getScheduledExecutor())).transform(new Function() {
