...
public class ExposureKeyModule extends ReactContextBaseJavaModule {
            ...
            if (num != null) {
                ...
                if (num3 != null) {
                    ...
                    if (builder.intervalNumber == null) {
                        str = GeneratedOutlineSupport.outline8(str, " intervalNumber");
                    }
                    if (builder.rollingPeriod == null) {
                        str = GeneratedOutlineSupport.outline8(str, " rollingPeriod");
                    }
                    if (builder.transmissionRisk == null) {
                        str = GeneratedOutlineSupport.outline8(str, " transmissionRisk");
                    }
                    if (str.isEmpty()) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0030, code lost:
        com.horcrux.svg.PathParser.closeFinally(r0, r5);
     */
