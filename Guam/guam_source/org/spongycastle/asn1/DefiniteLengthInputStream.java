...
public class DefiniteLengthInputStream extends LimitedInputStream {
    ...
    public int read() throws IOException {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("DEF length ");
        outline15.append(this._originalLength);
        outline15.append(" object truncated by ");
        outline15.append(this._remaining);
