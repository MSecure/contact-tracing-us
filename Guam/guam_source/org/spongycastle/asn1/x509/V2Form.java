...
public class V2Form extends ASN1Object {
    ...
    public V2Form(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() <= 3) {
            ...
            while (i != aSN1Sequence.size()) {
                ...
                if (i2 == 0) {
                    ...
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("Bad tag number: ");
                    outline15.append(instance.tagNo);
        ...
        StringBuilder outline152 = GeneratedOutlineSupport.outline15("Bad sequence size: ");
        outline152.append(aSN1Sequence.size());
