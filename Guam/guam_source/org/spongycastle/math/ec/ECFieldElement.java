...
public abstract class ECFieldElement implements ECConstants {
    ...
    public static class Fp extends ECFieldElement {
        ...
        public BigInteger modInverse(BigInteger bigInteger) {
            ...
            int[] fromBigInteger = PathParser.fromBigInteger(bitLength, this.q);
            int[] fromBigInteger2 = PathParser.fromBigInteger(bitLength, bigInteger);
            int[] iArr = new int[i];
            ...
            if (!z) {
                if (PathParser.isOne(length, fromBigInteger2)) {
                    ...
                    iArr3[0] = 1;
                    int inversionStep = (iArr2[0] & 1) == 0 ? PathParser.inversionStep(fromBigInteger, iArr2, length, iArr3, 0) : 0;
                    if (PathParser.isOne(length, iArr2)) {
                        PathParser.inversionResult(fromBigInteger, inversionStep, iArr3, iArr);
                    } else {
                        ...
                        while (true) {
                            ...
                            if (iArr2[i5] != 0 || iArr4[i5] != 0) {
                                ...
                                z2 = true;
                                if (z2) {
                                    PathParser.subFrom(i3, iArr4, iArr2);
                                    inversionStep = PathParser.inversionStep(fromBigInteger, iArr2, i3, iArr3, (PathParser.subFrom(length, iArr5, iArr3) - i4) + inversionStep);
                                    if (PathParser.isOne(i3, iArr2)) {
                                        PathParser.inversionResult(fromBigInteger, inversionStep, iArr3, iArr);
                                        break;
                                    }
                                } else {
                                    PathParser.subFrom(i3, iArr2, iArr4);
                                    i4 = PathParser.inversionStep(fromBigInteger, iArr4, i3, iArr5, (PathParser.subFrom(length, iArr3, iArr5) - inversionStep) + i4);
                                    if (PathParser.isOne(i3, iArr4)) {
                                        PathParser.inversionResult(fromBigInteger, i4, iArr5, iArr);
                                        break;
                                    }
                                }
                            } else {
                ...
                for (int i8 = 0; i8 < i; i8++) {
                    int i9 = iArr[i8];
                    if (i9 != 0) {
                        PathParser.intToBigEndian(i9, bArr, ((i - 1) - i8) << 2);
                    }
                }
    ...
    public static class F2m extends ECFieldElement {
        ...
        public static void checkFieldElements(ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2) {
            ...
            } else if (f2m.m != f2m2.m || !PathParser.areEqual(f2m.ks, f2m2.ks)) {
        ...
        public boolean equals(Object obj) {
            ...
            F2m f2m = (F2m) obj;
            return this.m == f2m.m && this.representation == f2m.representation && PathParser.areEqual(this.ks, f2m.ks) && this.x.equals(f2m.x);
        }
        ...
        public int hashCode() {
            return (this.x.hashCode() ^ this.m) ^ PathParser.hashCode(this.ks);
        }
