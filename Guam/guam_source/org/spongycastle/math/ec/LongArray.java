...
public class LongArray implements Cloneable {
    ...
    public static int reduceInPlace(long[] jArr, int i, int i2, int i3, int[] iArr) {
        ...
        if (min2 > 1) {
            ...
            while (true) {
                ...
                flipVector(jArr, i, jArr, i + i10, i7 - i10, i12 + iArr[i13]);
                i10 = i10;
                length2 = i13;
            }
            flipVector(jArr, i, jArr, i + i10, i7 - i10, i12);
            while (i7 > i10) {
                i7--;
                jArr[i + i7] = 0;
            }
        ...
        if (min > max) {
            ...
            while (true) {
                ...
                if (j != 0) {
                    ...
                    while (true) {
                        ...
                        flipWord(jArr, i, iArr[length3] + i16, j);
                    }
                    flipWord(jArr, i, i16, j);
                }
            }
            int i17 = max & 63;
            int i18 = i14 + i;
            ...
            if (j2 != 0) {
                ...
                while (true) {
                    ...
                    flipWord(jArr, i, iArr[length4] + i19, j2);
                }
                flipWord(jArr, i, i19, j2);
            }
        } else {
            max = min;
        }
    ...
    public LongArray multiply(LongArray longArray) {
        ...
        for (int i13 = 0; i13 < i4; i13++) {
            ...
            while (true) {
                long j3 = j2 >>> 4;
                addBoth(jArr6, i14, jArr3, iArr[((int) j2) & 15], jArr4, iArr[((int) j3) & 15], i7);
                j2 = j3 >>> 4;
                if (j2 == 0) {
                    break;
                }
        ...
        while (true) {
            i12 -= i6;
            if (i12 == 0) {
                return new LongArray(jArr6, 0, i6);
            }
