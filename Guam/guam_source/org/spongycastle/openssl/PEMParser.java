...
public class PEMParser extends PemReader {
    ...
    public class DSAKeyPairParser implements PEMKeyPairParser {
        ...
        public PEMKeyPair parse(byte[] bArr) throws IOException {
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e2, GeneratedOutlineSupport.outline15("problem creating DSA private key: ")), e2);
            }
        }
    }
    ...
    public class ECCurveParamsParser implements PemObjectParser {
        ...
        public Object parseObject(PemObject pemObject) throws IOException {
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e2, GeneratedOutlineSupport.outline15("exception extracting EC named curve: ")));
            }
        }
    }
    ...
    public class ECDSAKeyPairParser implements PEMKeyPairParser {
        ...
        public PEMKeyPair parse(byte[] bArr) throws IOException {
            ...
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e2, GeneratedOutlineSupport.outline15("problem creating EC private key: ")), e2);
            }
        }
    }
    ...
    public class EncryptedPrivateKeyParser implements PemObjectParser {
        ...
        public Object parseObject(PemObject pemObject) throws IOException {
            ...
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e, GeneratedOutlineSupport.outline15("problem parsing ENCRYPTED PRIVATE KEY: ")), e);
            }
        }
    }
    ...
    public class PKCS10CertificationRequestParser implements PemObjectParser {
        ...
        public Object parseObject(PemObject pemObject) throws IOException {
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e, GeneratedOutlineSupport.outline15("problem parsing certrequest: ")), e);
            }
        }
    }
    ...
    public class PKCS7Parser implements PemObjectParser {
        ...
        public Object parseObject(PemObject pemObject) throws IOException {
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e, GeneratedOutlineSupport.outline15("problem parsing PKCS7 object: ")), e);
            }
        }
    }
    ...
    public class PrivateKeyParser implements PemObjectParser {
        ...
        public Object parseObject(PemObject pemObject) throws IOException {
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e, GeneratedOutlineSupport.outline15("problem parsing PRIVATE KEY: ")), e);
            }
        }
    }
    ...
    public class RSAKeyPairParser implements PEMKeyPairParser {
        ...
        public PEMKeyPair parse(byte[] bArr) throws IOException {
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e2, GeneratedOutlineSupport.outline15("problem creating RSA private key: ")), e2);
            }
        }
    }
    ...
    public class RSAPublicKeyParser implements PemObjectParser {
        ...
        public Object parseObject(PemObject pemObject) throws IOException {
            ...
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e2, GeneratedOutlineSupport.outline15("problem extracting key: ")), e2);
            }
        }
    }
    ...
    public class X509CRLParser implements PemObjectParser {
        ...
        public Object parseObject(PemObject pemObject) throws IOException {
            try {
                ...
                throw new PEMException(GeneratedOutlineSupport.outline3(e, GeneratedOutlineSupport.outline15("problem parsing cert: ")), e);
            }
        }
    }
    ...
    public Object readObject() throws IOException {
        ...
        throw new IOException(GeneratedOutlineSupport.outline8("unrecognised object: ", str));
    }
}
