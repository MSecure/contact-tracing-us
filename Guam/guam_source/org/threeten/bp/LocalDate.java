...
public final class LocalDate extends ChronoLocalDate implements Temporal, TemporalAdjuster, Serializable {
    ...
    public static LocalDate create(int i, Month month2, int i2) {
        ...
        if (i2 == 29) {
            throw new DateTimeException(GeneratedOutlineSupport.outline5("Invalid date 'February 29' as '", i, "' is not a leap year"));
        }
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Invalid date '");
        outline15.append(month2.name());
        outline15.append(" ");
        outline15.append(i2);
        outline15.append("'");
    ...
    public static LocalDate from(TemporalAccessor temporalAccessor) {
        ...
        throw new DateTimeException(GeneratedOutlineSupport.outline13(temporalAccessor, GeneratedOutlineSupport.outline18("Unable to obtain LocalDate from TemporalAccessor: ", temporalAccessor, ", type ")));
    }

    public static LocalDate of(int i, Month month2, int i2) {
        ChronoField chronoField = ChronoField.YEAR;
        chronoField.range.checkValidValue((long) i, chronoField);
        PathParser.requireNonNull(month2, "month");
    ...
    public DayOfWeek getDayOfWeek() {
        return DayOfWeek.of(PathParser.floorMod(toEpochDay() + 3, 7) + 1);
    }
    ...
    public LocalDate plusDays(long j) {
        ...
        return ofEpochDay(PathParser.safeAdd(toEpochDay(), j));
    }
    ...
    public LocalDate plusMonths(long j) {
        ...
        return resolvePreviousValid(ChronoField.YEAR.checkValidIntValue(PathParser.floorDiv(j2, 12)), PathParser.floorMod(j2, 12) + 1, this.day);
    }
    ...
    public LocalDate withDayOfYear(int i) {
        ...
        throw new DateTimeException(GeneratedOutlineSupport.outline5("Invalid date 'DayOfYear 366' as '", i2, "' is not a leap year"));
    }
    ...
    public LocalDate plus(long j, TemporalUnit temporalUnit) {
        ...
        switch (((ChronoUnit) temporalUnit).ordinal()) {
            ...
            case 14:
                ...
                return with((TemporalField) chronoField, PathParser.safeAdd(getLong(chronoField), j));
            default:
