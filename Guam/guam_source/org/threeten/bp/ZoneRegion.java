...
public final class ZoneRegion extends ZoneId implements Serializable {
    ...
    public static ZoneId readExternal(DataInput dataInput) throws IOException {
        ...
        if (readUTF.equals("Z") || readUTF.startsWith("+") || readUTF.startsWith("-")) {
            throw new DateTimeException(GeneratedOutlineSupport.outline8("Invalid ID for region-based ZoneId, invalid format: ", readUTF));
            ...
            if (readUTF.startsWith("UTC+") || readUTF.startsWith("GMT+") || readUTF.startsWith("UTC-") || readUTF.startsWith("GMT-")) {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("UT");
                outline15.append(of2.id);
                return new ZoneRegion(outline15.toString(), of2.getRules());
            } else {
                PathParser.requireNonNull(readUTF, "zoneId");
