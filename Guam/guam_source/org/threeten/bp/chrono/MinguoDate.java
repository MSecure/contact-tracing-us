...
public final class MinguoDate extends ChronoDateImpl<MinguoDate> implements Serializable {
    ...
    public Temporal m22minus(long j, TemporalUnit temporalUnit) {
        return (MinguoDate) super.minus(j, temporalUnit);
    }
    ...
    public ChronoDateImpl<MinguoDate> m23plus(long j, TemporalUnit temporalUnit) {
        return (MinguoDate) super.plus(j, temporalUnit);
    }
    ...
    public Temporal m25with(TemporalAdjuster temporalAdjuster) {
