...
public final class DecimalStyle {
    ...
    public String toString() {
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("DecimalStyle[");
        outline15.append(this.zeroDigit);
        outline15.append(this.positiveSign);
        outline15.append(this.negativeSign);
        outline15.append(this.decimalSeparator);
        outline15.append("]");
