        ...
        if (dataInputStream.readByte() != 1) {
            ...
            while (it.hasNext()) {
                ...
                if (putIfAbsent == null || putIfAbsent.versionId.equals(version.versionId)) {
                    ...
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("Data already loaded for TZDB time-zone rules version: ");
                    outline15.append(version.versionId);
                    throw new ZoneRulesException(outline15.toString());
                }
            }
            return z;
        } else {
