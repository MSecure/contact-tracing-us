                ...
                if (alertParams.mOnClickListener != null) {
                    ...
                    /*  JADX ERROR: Method code generation error
                        jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0091: INVOKE  
                          (r3v4 'recycleListView' androidx.appcompat.app.AlertController$RecycleListView)
                          (wrap: androidx.appcompat.app.AlertController$AlertParams$3 : 0x008e: CONSTRUCTOR  (r4v3 androidx.appcompat.app.AlertController$AlertParams$3) = 
                          (r1v2 'alertParams' androidx.appcompat.app.AlertController$AlertParams)
                          (r2v1 'alertController' androidx.appcompat.app.AlertController)
                         call: androidx.appcompat.app.AlertController.AlertParams.3.<init>(androidx.appcompat.app.AlertController$AlertParams, androidx.appcompat.app.AlertController):void type: CONSTRUCTOR)
                         type: VIRTUAL call: android.widget.ListView.setOnItemClickListener(android.widget.AdapterView$OnItemClickListener):void in method: androidx.appcompat.app.AlertDialog.Builder.create():androidx.appcompat.app.AlertDialog, file: classes.dex
                        ...
                        Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x008e: CONSTRUCTOR  (r4v3 androidx.appcompat.app.AlertController$AlertParams$3) = 
                          (r1v2 'alertParams' androidx.appcompat.app.AlertController$AlertParams)
                          (r2v1 'alertController' androidx.appcompat.app.AlertController)
                         call: androidx.appcompat.app.AlertController.AlertParams.3.<init>(androidx.appcompat.app.AlertController$AlertParams, androidx.appcompat.app.AlertController):void type: CONSTRUCTOR in method: androidx.appcompat.app.AlertDialog.Builder.create():androidx.appcompat.app.AlertDialog, file: classes.dex
                        	at jadx.core.codegen.InsnGen.makeInsn(InsnGen.java:255)
            ...
            public void onCreate(Bundle bundle) {
                ...
                if (z2) {
                    ...
                    if (alertController.mListView != null) {
                        ((LinearLayoutCompat.LayoutParams) viewGroup.getLayoutParams()).weight = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
                    }
                } else {
