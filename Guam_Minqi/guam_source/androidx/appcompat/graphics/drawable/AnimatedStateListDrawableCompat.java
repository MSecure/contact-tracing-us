...
public class AnimatedStateListDrawableCompat extends StateListDrawable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:70:0x01d3, code lost:
        throw new org.xmlpull.v1.XmlPullParserException(com.android.tools.r8.GeneratedOutlineSupport.outline14(r19, new java.lang.StringBuilder(), ": <transition> tag requires 'fromId' & 'toId' attributes"));
     */
                ...
                if (next3 == i || ((depth = xmlPullParser.getDepth()) < depth2 && next3 == 3)) {
                    ...
                    if (xmlPullParser.getName().equals("item")) {
                        ...
                        if (drawable2 == null) {
                            ...
                            if (next2 != 2) {
                                throw new XmlPullParserException(GeneratedOutlineSupport.outline14(xmlPullParser, new StringBuilder(), ": <item> tag requires a 'drawable' attribute or child tag defining a drawable"));
                        ...
                        if (drawable3 == null) {
                            ...
                            if (next != 2) {
                                throw new XmlPullParserException(GeneratedOutlineSupport.outline14(xmlPullParser, new StringBuilder(), ": <transition> tag requires a 'drawable' attribute or child tag defining a drawable"));
