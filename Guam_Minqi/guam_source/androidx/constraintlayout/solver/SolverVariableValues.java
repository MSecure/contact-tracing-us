        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (variable != null) {
                ...
                if (this.previous[indexOf] != -1) {
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15(outline8);
                    outline15.append(this.mCache.mIndexedVariables[this.variables[this.previous[indexOf]]]);
                ...
                if (this.next[indexOf] != -1) {
                    StringBuilder outline152 = GeneratedOutlineSupport.outline15(outline82);
                    outline152.append(this.mCache.mIndexedVariables[this.variables[this.next[indexOf]]]);
