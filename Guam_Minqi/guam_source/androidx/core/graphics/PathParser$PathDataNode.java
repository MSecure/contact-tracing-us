...
public class PathParser$PathDataNode {
    ...
    public static void drawArc(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
        ...
        while (i2 < ceil) {
            ...
            double d36 = (((d7 * cos2) * cos4) + d25) - (d29 * sin4);
            double d37 = (d32 * sin4) + (d7 * sin2 * cos4) + d26;
            double d38 = (d28 * sin4) - (d29 * cos4);
            double d39 = (cos4 * d32) + (sin4 * d31);
            ...
            path.cubicTo((float) ((d30 * sqrt3) + d6), (float) ((d33 * sqrt3) + d11), (float) (d36 - (sqrt3 * d38)), (float) (d37 - (sqrt3 * d39)), (float) d36, (float) d37);
            i2++;
            atan2 = d35;
            cos2 = cos2;
            d31 = d31;
    ...
    public static void nodesToPath(PathParser$PathDataNode[] pathParser$PathDataNodeArr, Path path) {
        ...
        char c3 = 'm';
        int i6 = 0;
        while (i6 < pathParser$PathDataNodeArr2.length) {
            char c4 = pathParser$PathDataNodeArr2[i6].mType;
            float[] fArr3 = pathParser$PathDataNodeArr2[i6].mParams;
            float f20 = fArr2[i5];
            float f21 = fArr2[1];
            float f22 = fArr2[2];
            float f23 = fArr2[3];
            ...
            while (i7 < fArr3.length) {
                if (c4 != 'A') {
                        ...
                        if (c4 == 'H') {
                            ...
                            if (c4 != 'c') {
                                if (c4 == 'h') {
                                    i2 = i7;
                                    int i14 = i2 + 0;
                                    path.rLineTo(fArr3[i14], BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
                                    f28 += fArr3[i14];
                                } else if (c4 != 'q') {
                                    if (c4 == 'v') {
                                        i2 = i7;
                                        f10 = f29;
                                        int i15 = i2 + 0;
                                        path.rLineTo(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, fArr3[i15]);
                                        f11 = fArr3[i15];
                                    } else if (c4 != 'L') {
                                        if (c4 == 'M') {
                                            i2 = i7;
                                            ...
                                            if (c3 == 'c' || c3 == 's' || c3 == 'C' || c3 == 'S') {
                                                ...
                                                f17 = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
                                                f16 = BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER;
                                            }
                                            int i30 = i7 + 0;
                                            int i31 = i7 + 1;
                                            int i32 = i7 + 2;
                            ...
                            c = c4;
                            i3 = i6;
                            drawArc(path, f28, f29, fArr3[i44] + f28, fArr3[i45] + f29, fArr3[i2 + 0], fArr3[i2 + 1], fArr3[i2 + 2], fArr3[i2 + 3] != BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, fArr3[i2 + 4] != BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
                            f28 += fArr[i44];
                            f29 += fArr[i45];
                        }
                        i7 = i2 + i;
                    ...
                    int i50 = i2 + 5;
                    int i51 = i2 + 6;
                    drawArc(path, f28, f29, fArr[i50], fArr[i51], fArr[i2 + 0], fArr[i2 + 1], fArr[i2 + 2], fArr[i2 + 3] != BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, fArr[i2 + 4] != BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
                    f28 = fArr[i50];
                    f29 = fArr[i51];
                }
                f23 = f29;
            ...
            i4 = 6;
            c2 = 'm';
            c3 = pathParser$PathDataNodeArr[i6].mType;
    ...
    public PathParser$PathDataNode(PathParser$PathDataNode pathParser$PathDataNode) {
        ...
        this.mParams = AppCompatDelegateImpl.ConfigurationImplApi17.copyOfRange(fArr, 0, fArr.length);
    }
}
