...
public class TypefaceCompatBaseImpl {
    ...
    public Typeface createFromInputStream(Context context, InputStream inputStream) {
        ...
        try {
            if (!AppCompatDelegateImpl.ConfigurationImplApi17.copyToFile(tempFile, inputStream)) {
                return null;
            }
    ...
    public Typeface createFromResourcesFontFile(Context context, Resources resources, int i, String str, int i2) {
        ...
        try {
            if (!AppCompatDelegateImpl.ConfigurationImplApi17.copyToFile(tempFile, resources, i)) {
                return null;
            }
            Typeface createFromFile = Typeface.createFromFile(tempFile.getPath());
            tempFile.delete();
    ...
    public FontsContractCompat.FontInfo findBestInfo(FontsContractCompat.FontInfo[] fontInfoArr, int i) {
        return (FontsContractCompat.FontInfo) findBestFont(fontInfoArr, i, new StyleExtractor<FontsContractCompat.FontInfo>(this) {
            ...
            public int getWeight(FontsContractCompat.FontInfo fontInfo) {
                return fontInfo.mWeight;
            }

            /* JADX DEBUG: Method arguments types fixed to match base method, original types: [java.lang.Object] */
            @Override // androidx.core.graphics.TypefaceCompatBaseImpl.StyleExtractor
            public boolean isItalic(FontsContractCompat.FontInfo fontInfo) {
                return fontInfo.mItalic;
            }
        });
    }
}
