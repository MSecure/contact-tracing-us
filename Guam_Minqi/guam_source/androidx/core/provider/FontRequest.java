...
public final class FontRequest {
    ...
    public String toString() {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("FontRequest {mProviderAuthority: ");
        outline15.append(this.mProviderAuthority);
        outline15.append(", mProviderPackage: ");
        outline15.append(this.mProviderPackage);
        outline15.append(", mQuery: ");
        outline15.append(this.mQuery);
        outline15.append(", mCertificates:");
