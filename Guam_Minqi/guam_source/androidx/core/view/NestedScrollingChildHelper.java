...
public class NestedScrollingChildHelper {
    ...
    public boolean dispatchNestedFling(float f, float f2, boolean z) {
        ...
        return AppCompatDelegateImpl.ConfigurationImplApi17.onNestedFling(nestedScrollingParentForType, this.mView, f, f2, z);
    }
    ...
    public boolean dispatchNestedPreFling(float f, float f2) {
        ...
        return AppCompatDelegateImpl.ConfigurationImplApi17.onNestedPreFling(nestedScrollingParentForType, this.mView, f, f2);
    }
    ...
    public boolean dispatchNestedPreScroll(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        ...
        if (i != 0 || i2 != 0) {
            ...
            iArr[0] = 0;
            iArr[1] = 0;
            AppCompatDelegateImpl.ConfigurationImplApi17.onNestedPreScroll(nestedScrollingParentForType, this.mView, i, i2, iArr, i3);
            if (iArr2 != null) {
                this.mView.getLocationInWindow(iArr2);
                iArr2[0] = iArr2[0] - i5;
                iArr2[1] = iArr2[1] - i4;
    ...
    public final boolean dispatchNestedScrollInternal(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        AppCompatDelegateImpl.ConfigurationImplApi17.onNestedScroll(nestedScrollingParentForType, this.mView, i, i2, i3, i4, i5, iArr3);
        if (iArr != null) {
            this.mView.getLocationInWindow(iArr);
            iArr[0] = iArr[0] - i7;
            iArr[1] = iArr[1] - i6;
