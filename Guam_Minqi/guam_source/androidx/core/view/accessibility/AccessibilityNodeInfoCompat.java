...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public static final AccessibilityActionCompat ACTION_EXPAND = new AccessibilityActionCompat(Http1Codec.HEADER_LIMIT, null);
        ...
        static {
            ...
            if ((Build.VERSION.SDK_INT >= 30 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_PRESS_AND_HOLD : null) == null) {
                new AccessibilityNodeInfo.AccessibilityAction(16908362, null);
            }
            if ((Build.VERSION.SDK_INT >= 30 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_IME_ENTER : null) == null) {
    ...
    public static String getActionSymbolicName(int i) {
        ...
        switch (i) {
            ...
            case Http1Codec.HEADER_LIMIT /*{ENCODED_INT: 262144}*/:
