...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.OpGenerator {
        ...
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (fragment != null) {
                    ...
                    if (FragmentManager.isLoggingEnabled(2)) {
                        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Bump nesting of ");
                        outline15.append(op.mFragment);
                        outline15.append(" to ");
                        outline15.append(op.mFragment.mBackStackNesting);
                        outline15.toString();
                    }
                }
            }
            ...
            for (int i = 0; i < size; i++) {
                ...
                switch (op.mCmd) {
                    ...
                    case 10:
                        ...
                        break;
                    default:
                        StringBuilder outline15 = GeneratedOutlineSupport.outline15("cmd=");
                        outline15.append(op.mCmd);
                        str2 = outline15.toString();
                        break;
                }
                printWriter.print(str);
    ...
    public void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (op.mCmd) {
                ...
                case 2:
                default:
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unknown cmd: ");
                    outline15.append(op.mCmd);
    ...
    public FragmentTransaction remove(Fragment fragment) {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Cannot remove Fragment attached to a different FragmentManager. Fragment ");
        outline15.append(fragment.toString());
