...
public class FragmentLayoutInflaterFactory implements LayoutInflater.Factory2 {
    ...
    public View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("onCreateView: id=0x");
            outline15.append(Integer.toHexString(resourceId));
            outline15.append(" fname=");
            outline15.append(attributeValue);
            outline15.append(" existing=");
            outline15.append(fragment);
            outline15.toString();
        }
        if (fragment == null) {
