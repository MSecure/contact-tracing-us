...
public class RecyclerView extends ViewGroup implements NestedScrollingChild {
    ...
    public final class Recycler {
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            if (i < 0 || i >= RecyclerView.this.mState.getItemCount()) {
                StringBuilder outline16 = GeneratedOutlineSupport.outline16("invalid position ", i, ". State item count is ");
                outline16.append(RecyclerView.this.mState.getItemCount());
                throw new IndexOutOfBoundsException(GeneratedOutlineSupport.outline2(RecyclerView.this, outline16));
            }
            RecyclerView recyclerView = RecyclerView.this;
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Scrapped or attached views may not be recycled. isScrap:");
                outline15.append(viewHolder.isScrap());
                outline15.append(" isAttached:");
                if (viewHolder.itemView.getParent() != null) {
                    z3 = true;
                }
                outline15.append(z3);
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline2(RecyclerView.this, outline15));
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline2(RecyclerView.this, GeneratedOutlineSupport.outline15("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
            }
        }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline2(RecyclerView.this, GeneratedOutlineSupport.outline15("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public PointF computeScrollVectorForPosition(int i) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("You should override computeScrollVectorForPosition when the LayoutManager does not implement ");
            outline15.append(ScrollVectorProvider.class.getCanonicalName());
            Log.w(RecyclerView.TAG, outline15.toString());
            return null;
        }
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i) {
            if ((this.mLayoutStep & i) == 0) {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Layout state should be one of ");
                outline15.append(Integer.toBinaryString(i));
                outline15.append(" but it is ");
                outline15.append(Integer.toBinaryString(this.mLayoutStep));
        ...
        public String toString() {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("State{mTargetPosition=");
            outline15.append(this.mTargetPosition);
            outline15.append(", mData=");
            outline15.append((Object) null);
            outline15.append(", mItemCount=");
            outline15.append(this.mItemCount);
            outline15.append(", mIsMeasuring=");
            outline15.append(this.mIsMeasuring);
            outline15.append(", mPreviousLayoutItemCount=");
            outline15.append(this.mPreviousLayoutItemCount);
            outline15.append(", mDeletedInvisibleItemCountSincePreviousLayout=");
            outline15.append(this.mDeletedInvisibleItemCountSincePreviousLayout);
            outline15.append(", mStructureChanged=");
            outline15.append(this.mStructureChanged);
            outline15.append(", mInPreLayout=");
            outline15.append(this.mInPreLayout);
            outline15.append(", mRunSimpleAnimations=");
            outline15.append(this.mRunSimpleAnimations);
            outline15.append(", mRunPredictiveAnimations=");
            outline15.append(this.mRunPredictiveAnimations);
            outline15.append('}');
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            ...
            if (!isRecyclable()) {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15(" not recyclable(");
                outline15.append(this.mIsRecyclableCount);
                outline15.append(")");
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            throw new IllegalStateException(GeneratedOutlineSupport.outline2(this, GeneratedOutlineSupport.outline15("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        }
        throw new IllegalStateException(GeneratedOutlineSupport.outline2(this, GeneratedOutlineSupport.outline15(str)));
    }

    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(GeneratedOutlineSupport.outline2(this, GeneratedOutlineSupport.outline15("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        } else if (this.mDispatchScrollCounter > 0) {
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(GeneratedOutlineSupport.outline2(this, GeneratedOutlineSupport.outline15(""))));
        }
    }
    ...
    public String exceptionLabel() {
        ...
        outline15.append(super.toString());
        outline15.append(", adapter:");
        outline15.append(this.mAdapter);
        outline15.append(", layout:");
        outline15.append(this.mLayout);
        outline15.append(", context:");
        outline15.append(getContext());
        return outline15.toString();
    }
                    ...
                    if (!(layoutManager2 == null || snapHelper.mRecyclerView.getAdapter() == null || (Math.abs(i8) <= (minFlingVelocity = snapHelper.mRecyclerView.getMinFlingVelocity()) && Math.abs(i7) <= minFlingVelocity))) {
                        ...
                        if (z4) {
                            ...
                            public ViewGroup.LayoutParams generateDefaultLayoutParams() {
                                ...
                                throw new IllegalStateException(GeneratedOutlineSupport.outline2(this, GeneratedOutlineSupport.outline15("RecyclerView has no LayoutManager")));
                            }
                            ...
                            public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
                                if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
                                    throw new IllegalArgumentException(GeneratedOutlineSupport.outline2(this, GeneratedOutlineSupport.outline15("Trying to set fast scroller without both required drawables.")));
                                }
                            ...
                            public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
                                ...
                                if (actionMasked == 0) {
                                    ...
                                    if (findPointerIndex < 0) {
                                        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Error processing scroll; pointer index for id ");
                                        outline15.append(this.mScrollPointerId);
                                        outline15.append(" not found. Did any MotionEvents get skipped?");
                                        Log.e(TAG, outline15.toString());
                                        return false;
                                    }
                            ...
                            public static abstract class LayoutManager {
                                ...
                                public final void addViewInt(View view, int i, boolean z) {
                                    ...
                                    if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                                        ...
                                        if (indexOfChild == -1) {
                                            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                                            outline15.append(this.mRecyclerView.indexOfChild(view));
                                            throw new IllegalStateException(GeneratedOutlineSupport.outline2(this.mRecyclerView, outline15));
                                ...
                                public void startSmoothScroll(SmoothScroller smoothScroller) {
                                    ...
                                    if (smoothScroller != null) {
                                        ...
                                        if (smoothScroller.mStarted) {
                                            StringBuilder outline15 = GeneratedOutlineSupport.outline15("An instance of ");
                                            outline15.append(smoothScroller.getClass().getSimpleName());
                                            outline15.append(" was started more than once. Each instance of");
                                            outline15.append(smoothScroller.getClass().getSimpleName());
                                            outline15.append(" is intended to only be used once. You should create a new instance for each use.");
                                            Log.w(RecyclerView.TAG, outline15.toString());
                                        }
