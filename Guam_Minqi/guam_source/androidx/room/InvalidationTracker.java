...
public class InvalidationTracker {
    ...
    public void addObserver(Observer observer) {
        ...
        for (int i = 0; i < length2; i++) {
            ...
            if (num != null) {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("There is no table with name ");
                outline15.append(strArr2[i]);
    ...
    public final void startTrackingTable(SupportSQLiteDatabase supportSQLiteDatabase, int i) {
        ...
        frameworkSQLiteDatabase.mDelegate.execSQL(GeneratedOutlineSupport.outline5("INSERT OR IGNORE INTO room_table_modification_log VALUES(", i, ", 0)"));
