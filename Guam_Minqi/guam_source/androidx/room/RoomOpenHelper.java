...
public class RoomOpenHelper extends SupportSQLiteOpenHelper.Callback {
                    ...
                    if (((WorkDatabase_Impl.AnonymousClass1) this.mDelegate) != null) {
                        ...
                        while (it2.hasNext()) {
                            ...
                            if (str.startsWith("room_fts_content_sync_")) {
                                frameworkSQLiteDatabase.mDelegate.execSQL(GeneratedOutlineSupport.outline8("DROP TRIGGER IF EXISTS ", str));
                            }
                        }
                        ...
                        if (!onValidateSchema.isValid) {
                            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Migration didn't properly handle: ");
                            outline15.append(onValidateSchema.expectedFoundMsg);
    ...
    public final void updateIdentity(SupportSQLiteDatabase supportSQLiteDatabase) {
        ...
        frameworkSQLiteDatabase.mDelegate.execSQL(GeneratedOutlineSupport.outline9("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '", this.mIdentityHash, "')"));
    }
}
