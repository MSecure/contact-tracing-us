...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("FragmentPager.SavedState{");
            outline15.append(Integer.toHexString(System.identityHashCode(this)));
            outline15.append(" position=");
            return GeneratedOutlineSupport.outline11(outline15, this.position, "}");
        }
        ...
        if (findFocus != this) {
            if (findFocus != null) {
                ...
                if (!z) {
                    ...
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("arrowScroll tried to find focus based on non-child current focused view ");
                    outline15.append(sb.toString());
                    Log.e("ViewPager", outline15.toString());
                }
            }
    ...
    public void populate(int i) {
        ...
        if (!(this.mAdapter == null || this.mPopulatePending || getWindowToken() == null)) {
            if (this.mAdapter != null) {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("The application's PagerAdapter changed the adapter's contents without calling PagerAdapter#notifyDataSetChanged! Expected adapter item count: ");
                outline15.append(this.mExpectedAdapterCount);
                outline15.append(", found: ");
                outline15.append(count);
                outline15.append(" Pager id: ");
                outline15.append(str);
                outline15.append(" Pager class: ");
                outline15.append(getClass());
                outline15.append(" Problematic adapter: ");
                outline15.append(this.mAdapter.getClass());
