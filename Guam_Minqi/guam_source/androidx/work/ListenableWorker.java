    ...
    public static abstract class Result {
        ...
        public static final class Failure extends Result {
            ...
            public String toString() {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Failure {mOutputData=");
                outline15.append(this.mOutputData);
                outline15.append('}');
        ...
        public static final class Success extends Result {
            ...
            public String toString() {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Success {mOutputData=");
                outline15.append(this.mOutputData);
                outline15.append('}');
                return outline15.toString();
            }
