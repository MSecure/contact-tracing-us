...
public class WorkTimer {
    ...
    public final ThreadFactory mBackgroundThreadFactory = new ThreadFactory(this) {
        ...
        public Thread newThread(Runnable runnable) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("WorkManager-WorkTimer-thread-");
            outline15.append(this.mThreadsCreated);
            newThread.setName(outline15.toString());
