...
public class Async {
    ...
    public static final ThreadFactory THREAD_FACTORY = new ThreadFactory() {
        ...
        public Thread newThread(Runnable runnable) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Bugsnag Thread #");
            outline15.append(this.count.getAndIncrement());
            return new Thread(runnable, outline15.toString());
        }
    };
