...
public final class EventInternal implements JsonStream.Streamable {
    ...
    public EventInternal(Throwable th, ImmutableConfig immutableConfig, HandledState handledState2, Metadata metadata2) {
        ...
        this.discardClasses = CollectionsKt__CollectionsKt.toSet(immutableConfig.discardClasses);
        ...
        if (th2 == null) {
            ...
            list = CollectionsKt__CollectionsKt.toMutableList(arrayList2);
        ...
        if (threadSendPolicy == ThreadSendPolicy.ALWAYS || (threadSendPolicy == ThreadSendPolicy.UNHANDLED_ONLY && z)) {
            ...
            if (keySet.size() <= 1) {
                ...
                if (size == 0) {
                    ...
                    iterable = CollectionsKt__CollectionsKt.toMutableList(keySet);
                } else {
                    iterable = PathParser.listOf(keySet instanceof List ? ((List) keySet).get(0) : keySet.iterator().next());
                }
            } else {
                ...
                if (array != null) {
                    ...
                    iterable = PathParser.asList(array);
                } else {
                    throw new NullPointerException("null cannot be cast to non-null type kotlin.Array<T>");
                }
            }
            ArrayList arrayList3 = new ArrayList(PathParser.collectionSizeOrDefault(iterable, 10));
            ...
            list2 = CollectionsKt__CollectionsKt.toMutableList(arrayList3);
        } else {
            list2 = new ArrayList<>();
        }
        this.threads = list2;
