...
public final class ImmutableConfig {
    ...
    public String toString() {
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("ImmutableConfig(apiKey=");
        outline15.append(this.apiKey);
        outline15.append(", autoDetectErrors=");
        outline15.append(this.autoDetectErrors);
        outline15.append(", enabledErrorTypes=");
        outline15.append(this.enabledErrorTypes);
        outline15.append(", autoTrackSessions=");
        outline15.append(this.autoTrackSessions);
        outline15.append(", sendThreads=");
        outline15.append(this.sendThreads);
        outline15.append(", discardClasses=");
        outline15.append(this.discardClasses);
        outline15.append(", enabledReleaseStages=");
        outline15.append(this.enabledReleaseStages);
        outline15.append(", projectPackages=");
        outline15.append(this.projectPackages);
        outline15.append(", enabledBreadcrumbTypes=");
        outline15.append(this.enabledBreadcrumbTypes);
        outline15.append(", releaseStage=");
        outline15.append(this.releaseStage);
        outline15.append(", buildUuid=");
        outline15.append(this.buildUuid);
        outline15.append(", appVersion=");
        outline15.append(this.appVersion);
        outline15.append(", versionCode=");
        outline15.append(this.versionCode);
        outline15.append(", appType=");
        outline15.append(this.appType);
        outline15.append(", delivery=");
        outline15.append(this.delivery);
        outline15.append(", endpoints=");
        outline15.append(this.endpoints);
        outline15.append(", persistUser=");
        outline15.append(this.persistUser);
        outline15.append(", launchCrashThresholdMs=");
        outline15.append(this.launchCrashThresholdMs);
        outline15.append(", logger=");
        outline15.append(this.logger);
        outline15.append(", maxBreadcrumbs=");
        return GeneratedOutlineSupport.outline11(outline15, this.maxBreadcrumbs, ")");
    }
}
