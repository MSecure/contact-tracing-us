...
public final class ObjectJsonStreamer {
    ...
    public ObjectJsonStreamer() {
        ...
        LinkedHashSet linkedHashSet = new LinkedHashSet(PathParser.mapCapacity(1));
        PathParser.toCollection(strArr, linkedHashSet);
                ...
                if (key instanceof String) {
                    ...
                    if (z) {
                        ...
                        if (!(set instanceof Collection) || !set.isEmpty()) {
                            ...
                            while (true) {
                                if (it.hasNext()) {
                                    if (StringsKt__StringsKt.contains$default(str, it.next(), false, 2)) {
                                        z2 = true;
                                        break;
                                    }
                                } else {
