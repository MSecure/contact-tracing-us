...
public class PooledByteBufferInputStream extends InputStream {
    ...
    public int read(byte[] bArr, int i, int i2) {
        if (i < 0 || i2 < 0 || i + i2 > bArr.length) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("length=");
            outline15.append(bArr.length);
            outline15.append("; regionStart=");
            outline15.append(i);
            outline15.append("; regionLength=");
            outline15.append(i2);
            throw new ArrayIndexOutOfBoundsException(outline15.toString());
        }
