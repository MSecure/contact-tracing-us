...
public class ProducerSequenceFactory {
    ...
    public Producer<CloseableReference<CloseableImage>> getDecodedImageProducerSequence(ImageRequest imageRequest) {
        ...
        try {
            if (imageRequest != null) {
                ...
                AppCompatDelegateImpl.ConfigurationImplApi17.checkNotNull1(uri, "Uri is null.");
    ...
    public Producer<Void> getEncodedImagePrefetchProducerSequence(ImageRequest imageRequest) {
        ...
        if (imageRequest != null) {
            AppCompatDelegateImpl.ConfigurationImplApi17.checkArgument(imageRequest.mLowestPermittedRequestLevel.mValue <= ImageRequest.RequestLevel.ENCODED_MEMORY_CACHE.mValue);
            int i = imageRequest.mSourceUriType;
            if (i == 0) {
                synchronized (this) {
                    FrescoSystrace.isTracing();
                ...
                Uri uri = imageRequest.mSourceUri;
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unsupported uri scheme for encoded image fetch! Uri is: ");
                outline15.append(getShortenedUriString(uri));
    ...
    public final synchronized Producer<CloseableReference<CloseableImage>> getLocalContentUriFetchSequence() {
        if (this.mLocalContentUriFetchSequence == null) {
            ...
            ThumbnailProducer<EncodedImage>[] thumbnailProducerArr = new ThumbnailProducer[2];
            ProducerFactory producerFactory2 = this.mProducerFactory;
            if (producerFactory2 != null) {
                thumbnailProducerArr[0] = new LocalContentUriThumbnailFetchProducer(producerFactory2.mExecutorSupplier.forLocalStorageRead(), producerFactory2.mPooledByteBufferFactory, producerFactory2.mContentResolver);
                ProducerFactory producerFactory3 = this.mProducerFactory;
                thumbnailProducerArr[1] = new LocalExifThumbnailProducer(producerFactory3.mExecutorSupplier.forLocalStorageRead(), producerFactory3.mPooledByteBufferFactory, producerFactory3.mContentResolver);
                this.mLocalContentUriFetchSequence = newBitmapCacheGetToLocalTransformSequence(localContentUriFetchProducer, thumbnailProducerArr);
            } else {
                throw null;
            }
        }
    ...
    public final Producer<CloseableReference<CloseableImage>> newBitmapCacheGetToBitmapCacheSequence(Producer<CloseableReference<CloseableImage>> producer) {
        ProducerFactory producerFactory = this.mProducerFactory;
        BitmapMemoryCacheKeyMultiplexProducer bitmapMemoryCacheKeyMultiplexProducer = new BitmapMemoryCacheKeyMultiplexProducer(this.mProducerFactory.mCacheKeyFactory, new BitmapMemoryCacheProducer(producerFactory.mBitmapMemoryCache, producerFactory.mCacheKeyFactory, producer));
        ProducerFactory producerFactory2 = this.mProducerFactory;
        ThreadHandoffProducerQueue threadHandoffProducerQueue = this.mThreadHandoffProducerQueue;
        if (producerFactory2 != null) {
    ...
    public final Producer<EncodedImage> newEncodedCacheMultiplexToTranscodeSequence(Producer<EncodedImage> producer) {
        ...
        if (this.mDiskCacheEnabled) {
            ...
            if (this.mPartialImageCachingEnabled) {
                ProducerFactory producerFactory = this.mProducerFactory;
                PartialDiskCacheProducer partialDiskCacheProducer = new PartialDiskCacheProducer(producerFactory.mDefaultBufferedDiskCache, producerFactory.mCacheKeyFactory, producerFactory.mPooledByteBufferFactory, producerFactory.mByteArrayPool, producer);
                ProducerFactory producerFactory2 = this.mProducerFactory;
                diskCacheWriteProducer = new DiskCacheWriteProducer(producerFactory2.mDefaultBufferedDiskCache, producerFactory2.mSmallImageBufferedDiskCache, producerFactory2.mCacheKeyFactory, partialDiskCacheProducer);
            } else {
                ProducerFactory producerFactory3 = this.mProducerFactory;
                diskCacheWriteProducer = new DiskCacheWriteProducer(producerFactory3.mDefaultBufferedDiskCache, producerFactory3.mSmallImageBufferedDiskCache, producerFactory3.mCacheKeyFactory, producer);
            }
            ProducerFactory producerFactory4 = this.mProducerFactory;
            DiskCacheReadProducer diskCacheReadProducer = new DiskCacheReadProducer(producerFactory4.mDefaultBufferedDiskCache, producerFactory4.mSmallImageBufferedDiskCache, producerFactory4.mCacheKeyFactory, diskCacheWriteProducer);
            FrescoSystrace.isTracing();
            producer = diskCacheReadProducer;
        }
        ProducerFactory producerFactory5 = this.mProducerFactory;
        return new EncodedCacheKeyMultiplexProducer(this.mProducerFactory.mCacheKeyFactory, new EncodedMemoryCacheProducer(producerFactory5.mEncodedMemoryCache, producerFactory5.mCacheKeyFactory, producer));
    }
