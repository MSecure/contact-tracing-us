...
public class NativeMemoryChunk implements MemoryChunk, Closeable {
    ...
    public void copy(int i, MemoryChunk memoryChunk, int i2, int i3) {
        if (memoryChunk != null) {
            if (memoryChunk.getUniqueId() == this.mNativePtr) {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Copying from NativeMemoryChunk ");
                outline15.append(Integer.toHexString(System.identityHashCode(this)));
                outline15.append(" to NativeMemoryChunk ");
                outline15.append(Integer.toHexString(System.identityHashCode(memoryChunk)));
                outline15.append(" which share the same address ");
                outline15.append(Long.toHexString(this.mNativePtr));
                Log.w("NativeMemoryChunk", outline15.toString());
    ...
    public void finalize() throws Throwable {
        if (!isClosed()) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("finalize: Chunk ");
            outline15.append(Integer.toHexString(System.identityHashCode(this)));
            outline15.append(" still active. ");
            Log.w("NativeMemoryChunk", outline15.toString());
            try {
                close();
            } finally {
