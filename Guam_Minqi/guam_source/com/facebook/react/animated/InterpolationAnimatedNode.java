                ...
                if (hashCode != -135761730) {
                    if (hashCode == 94742715 && str.equals("clamp")) {
                        ...
                        if (c2 != 0) {
                            if (c2 != 1) {
                                if (c2 != 2) {
                                    throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline9("Invalid extrapolation type ", str, "for left extrapolation"));
                                }
                                d2 = d;
                                if (d2 > d5) {
                                            ...
                                            if (hashCode2 == 94742715 && str2.equals("clamp")) {
                                                ...
                                                if (c != 0) {
                                                    if (c == 1) {
                                                        ...
                                                        throw new JSApplicationIllegalArgumentException(GeneratedOutlineSupport.outline9("Invalid extrapolation type ", str2, "for right extrapolation"));
                                                    }
                                                }
                                            }
