...
public class Arguments {
    ...
    public static void addEntry(WritableNativeMap writableNativeMap, String str, Object obj) {
        ...
        if (makeNativeObject == null) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Could not convert ");
            outline15.append(makeNativeObject.getClass());
        ...
        if (obj instanceof String[]) {
            ...
            while (i < length7) {
                ...
                if (parcelable instanceof Bundle) {
                    ...
                    StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unexpected array member type ");
                    outline15.append(parcelable.getClass());
                    throw new IllegalArgumentException(outline15.toString());
                }
            }
        } else {
            StringBuilder outline152 = GeneratedOutlineSupport.outline15("Unknown array type ");
            outline152.append(obj.getClass());
    ...
    public static WritableArray fromList(List list) {
        ...
        for (Object obj : list) {
            if (obj == null) {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unknown value type ");
                outline15.append(obj.getClass());
                throw new IllegalArgumentException(outline15.toString());
            }
        }
