...
public class JavaOnlyMap implements ReadableMap, WritableMap {
    ...
    public ReadableType getType(String str) {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Invalid value ");
        outline15.append(obj.toString());
        outline15.append(" for key ");
        outline15.append(str);
        outline15.append("contained in JavaOnlyMap");
