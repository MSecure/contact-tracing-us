...
public class MultipartStreamReader {
    ...
    public boolean readAllParts(ChunkListener chunkListener) throws IOException {
        ...
        outline15.append(this.mBoundary);
        outline15.append(CRLF);
        ByteString encodeUtf8 = ByteString.encodeUtf8(outline15.toString());
        StringBuilder outline152 = GeneratedOutlineSupport.outline15("\r\n--");
        outline152.append(this.mBoundary);
        outline152.append("--");
        outline152.append(CRLF);
        ByteString encodeUtf82 = ByteString.encodeUtf8(outline152.toString());
