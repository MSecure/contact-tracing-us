...
public class AndroidInfoModule extends NativePlatformConstantsAndroidSpec implements TurboModule {
    ...
    private String getServerHost() {
        return AndroidInfoHelpers.getServerIpAddress(Integer.valueOf(getReactApplicationContext().getApplicationContext().getResources().getInteger(R$integer.react_native_dev_server_port)).intValue());
    }
    ...
    public Map<String, Object> getTypedExportedConstants() {
        ...
        hashMap.put("isTesting", Boolean.valueOf(BuildConfig.DISPLAY_CALL_EMERGENCY_SERVICES.equals(System.getProperty(IS_TESTING)) || isRunningScreenshotTest().booleanValue()));
