...
public class JSTouchDispatcher {
    ...
    public final void dispatchCancelEvent(MotionEvent motionEvent, EventDispatcher eventDispatcher) {
        ...
        AppCompatDelegateImpl.ConfigurationImplApi17.assertCondition(!this.mChildIsHandlingNativeGesture, "Expected to not have already sent a cancel for this gesture");
        AppCompatDelegateImpl.ConfigurationImplApi17.assertNotNull(eventDispatcher);
    ...
    public void handleTouchEvent(MotionEvent motionEvent, EventDispatcher eventDispatcher) {
        ...
        if (action == 0) {
            ...
            if (i == -1) {
                ...
                StringBuilder outline16 = GeneratedOutlineSupport.outline16("Warning : touch event was ignored. Action=", action, " Target=");
                outline16.append(this.mTargetTag);
                FLog.w("ReactNative", outline16.toString());
            }
        }
    }
}
