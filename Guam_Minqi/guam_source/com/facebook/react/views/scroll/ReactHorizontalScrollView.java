...
public class ReactHorizontalScrollView extends HorizontalScrollView implements ReactClippingViewGroup {
        ...
        if (getChildCount() > 0) {
            if (this.mSnapInterval == 0 && this.mSnapOffsets == null) {
                ...
                if (d2 != scrollX) {
                    ...
                    updateStateOnScroll(i7, scrollY);
                    return;
                }
                return;
            }
            ...
            if (overScroller != null) {
                ...
                overScroller.fling(scrollX3, scrollY2, i6, 0, min, min, 0, 0, i8, 0);
                postInvalidateOnAnimation();
                return;
            }
            int scrollY3 = getScrollY();
            smoothScrollTo(min, scrollY3);
            updateStateOnScroll(min, scrollY3);
        }
    }
    ...
    public final void smoothScrollToNextPage(int i) {
        ...
        updateStateOnScroll(i4, scrollY);
        handlePostTouchScrolling(0, 0);
    }
