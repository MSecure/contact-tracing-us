...
public class ReactSwitchManager extends SimpleViewManager<ReactSwitch> {
    ...
    public long measure(Context context, ReadableMap readableMap, ReadableMap readableMap2, ReadableMap readableMap3, float f, YogaMeasureMode yogaMeasureMode, float f2, YogaMeasureMode yogaMeasureMode2, int[] iArr) {
        ...
        return ReactYogaConfigProvider.make(AppCompatDelegateImpl.ConfigurationImplApi17.toDIPFromPixel((float) reactSwitch.getMeasuredWidth()), AppCompatDelegateImpl.ConfigurationImplApi17.toDIPFromPixel((float) reactSwitch.getMeasuredHeight()));
    }
