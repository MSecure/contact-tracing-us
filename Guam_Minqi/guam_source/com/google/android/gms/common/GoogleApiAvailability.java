...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public class zaa extends zap {
        ...
        public final void handleMessage(Message message) {
            ...
            int isGooglePlayServicesAvailable = GoogleApiAvailability.this.isGooglePlayServicesAvailable(this.zaa, GoogleApiAvailabilityLight.GOOGLE_PLAY_SERVICES_VERSION_CODE);
