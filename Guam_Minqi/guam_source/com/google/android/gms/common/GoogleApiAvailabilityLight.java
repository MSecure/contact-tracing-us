...
public class GoogleApiAvailabilityLight {
    ...
    public Intent getErrorResolutionIntent(Context context, @RecentlyNonNull int i, String str) {
        if (i == 1 || i == 2) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("gcore_");
            outline15.append(GOOGLE_PLAY_SERVICES_VERSION_CODE);
            outline15.append("-");
            ...
            if (context != null) {
                try {
                    ...
                    outline15.append(packageManager.zza.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionCode);
                } catch (PackageManager.NameNotFoundException unused) {
                }
            }
            return zzj.zza("com.google.android.gms", outline15.toString());
        } else if (i != 3) {
            return null;
        } else {
