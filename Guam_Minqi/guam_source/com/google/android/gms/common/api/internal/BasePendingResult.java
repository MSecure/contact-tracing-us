...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    public final CallbackHandler<R> zac = new CallbackHandler<>(Looper.getMainLooper());
    public final CountDownLatch zae = new CountDownLatch(1);
    public final ArrayList<PendingResult.StatusListener> zaf = new ArrayList<>();
    public ResultCallback<? super R> zag;
    public final AtomicReference<zacn> zah = new AtomicReference<>();
    public R zai;
    public Status zaj;
    ...
    public final void zab(R r) {
        ...
        if (resultCallback != null) {
            ...
            ReactYogaConfigProvider.checkNotNull(r2);
