                ...
                if (cArr != null) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Illegal alphabet ");
                            outline15.append(new String(cArr));
                            throw new IllegalArgumentException(outline15.toString(), e);
                        }
                    } catch (ArithmeticException e2) {
                        StringBuilder outline152 = GeneratedOutlineSupport.outline15("Illegal alphabet length ");
                        outline152.append(cArr.length);
                        throw new IllegalArgumentException(outline152.toString(), e2);
                    }
                } else {
                    throw null;
                }
            ...
            if (baseEncoding == null) {
                ...
                if (z) {
                    ...
                    if (!z2) {
                        ...
                        alphabet2 = new Alphabet(GeneratedOutlineSupport.outline12(new StringBuilder(), alphabet2.name, ".lowerCase()"), cArr3);
                    } else {
