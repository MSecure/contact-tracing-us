    ...
    public TypeAdapter<?> getTypeAdapter(ConstructorConstructor constructorConstructor2, Gson gson, TypeToken<?> typeToken, JsonAdapter jsonAdapter) {
        ...
        if (construct instanceof TypeAdapter) {
            ...
            if (z || (construct instanceof JsonDeserializer)) {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Invalid attempt to bind an instance of ");
                outline15.append(construct.getClass().getName());
                outline15.append(" as a @JsonAdapter for ");
                outline15.append(typeToken.toString());
                outline15.append(". @JsonAdapter value must be a TypeAdapter, TypeAdapterFactory, JsonSerializer or JsonDeserializer.");
