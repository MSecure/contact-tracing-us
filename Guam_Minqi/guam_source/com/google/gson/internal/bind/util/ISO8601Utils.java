    ...
    public static int parseInt(String str, int i, int i2) throws NumberFormatException {
        ...
        if (i < i2) {
            ...
            if (digit >= 0) {
                ...
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("Invalid number: ");
                outline15.append(str.substring(i, i2));
        ...
        while (i4 < i2) {
            ...
            if (digit2 >= 0) {
                ...
                StringBuilder outline152 = GeneratedOutlineSupport.outline15("Invalid number: ");
                outline152.append(str.substring(i, i2));
