...
public class TSpanView extends TextView {
    ...
    public final void applySpacingAndFeatures(Paint paint, FontData fontData) {
        ...
        if (d == 0.0d && fontData.fontVariantLigatures == TextProperties$FontVariantLigatures.normal) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("'rlig', 'liga', 'clig', 'calt', 'locl', 'ccmp', 'mark', 'mkmk','kern', 'hlig', 'cala', ");
            outline15.append(fontData.fontFeatureSettings);
            paint.setFontFeatureSettings(outline15.toString());
        } else {
            StringBuilder outline152 = GeneratedOutlineSupport.outline15("'rlig', 'liga', 'clig', 'calt', 'locl', 'ccmp', 'mark', 'mkmk','kern', 'liga' 0, 'clig' 0, 'dlig' 0, 'hlig' 0, 'cala' 0, ");
            outline152.append(fontData.fontFeatureSettings);
            paint.setFontFeatureSettings(outline152.toString());
        }
        if (Build.VERSION.SDK_INT >= 26) {
            StringBuilder outline153 = GeneratedOutlineSupport.outline15("'wght' ");
            outline153.append(fontData.absoluteFontWeight);
            outline153.append(fontData.fontVariationSettings);
            paint.setFontVariationSettings(outline153.toString());
        }
    }
    ...
    public final void drawWrappedText(Canvas canvas, Paint paint) {
        ...
        StaticLayout build = StaticLayout.Builder.obtain(spannableString, 0, spannableString.length(), textPaint, (int) PathParser.fromRelative(this.mInlineSize, (double) canvas.getWidth(), 0.0d, (double) this.mScale, d)).setAlignment(alignment).setLineSpacing(BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, 1.0f).setIncludePad(true).setBreakStrategy(1).setHyphenationFrequency(1).build();
                ...
                if (fontData.fontVariantLigatures == TextProperties$FontVariantLigatures.normal) {
                    ...
                    if (ordinal != 1) {
                        ...
                        if (z8) {
                            ...
                            fArr = fArr4;
                            double fromRelative = PathParser.fromRelative(tSpanView3.textPath.mStartOffset, d, 0.0d, (double) tSpanView3.mScale, d29);
                            d3 += fromRelative;
                            if (z7) {
                                z3 = z6;
                                ...
                                if (sVGLength == null) {
                                    d8 = d;
                                    double fromRelative2 = PathParser.fromRelative(sVGLength, (double) canvas.getWidth(), 0.0d, (double) tSpanView3.mScale, d29);
                                                        ...
                                                        if (hashCode == 109801339 && str.equals("super")) {
                                                            ...
                                                            if (c != 0) {
                                                                ...
                                                                if (c != 2) {
                                                                    ...
                                                                    d10 -= PathParser.fromRelative(str, d39 * d29, d39, d29);
                                                                }
                                                            ...
                                                            while (i3 < i) {
                                                                ...
                                                                if (z10) {
                                                                    ...
                                                                    while (true) {
                                                                        ...
                                                                        if (i16 < i && fArr[i16] <= BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER) {
                                                                            StringBuilder outline154 = GeneratedOutlineSupport.outline15(valueOf);
                                                                            outline154.append(charArray[i16]);
                                                                            valueOf = outline154.toString();
                                                                            zArr[i16] = true;
                                                                            z4 = true;
                                                                            i = i;
                                                                            i15 = i16;
                                                                ...
                                                                if (i17 < sVGLengthArr.length) {
                                                                    ...
                                                                    matrix = matrix6;
                                                                    d13 = nextX;
                                                                    glyphContext.mDX += PathParser.fromRelative(sVGLengthArr[i17], (double) glyphContext.mWidth, 0.0d, (double) glyphContext.mScale, glyphContext.mFontSize);
                                                                } else {
                                                                    d13 = nextX;
                                                                    matrix2 = matrix5;
                                                                    matrix = matrix6;
                                                                ...
                                                                if (i18 < sVGLengthArr2.length) {
                                                                    ...
                                                                    d14 = d42;
                                                                    glyphContext.mDY += PathParser.fromRelative(sVGLengthArr2[i18], (double) glyphContext.mHeight, 0.0d, (double) glyphContext.mScale, glyphContext.mFontSize);
                                                                } else {
                                                                    d14 = d42;
                                                                }
