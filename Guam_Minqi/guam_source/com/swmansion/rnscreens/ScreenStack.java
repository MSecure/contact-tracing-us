...
public class ScreenStack extends ScreenContainer<ScreenStackFragment> {
                ...
                if (fragmentManager3 != null) {
                    ...
                    if (fragmentManager4 == null || fragmentManager4 == backStackRecord.mManager) {
                        ...
                        if (backStackRecord.mAllowAddToBackStack) {
                            ...
                            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Cannot setPrimaryNavigation for Fragment attached to a different FragmentManager. Fragment ");
                            outline15.append(screenStackFragment.toString());
                            outline15.append(" is already attached to a FragmentManager.");
                            throw new IllegalStateException(outline15.toString());
                        }
                        throw new IllegalStateException("This FragmentTransaction is not allowed to be added to the back stack.");
                    }
                    StringBuilder outline152 = GeneratedOutlineSupport.outline15("Cannot show Fragment attached to a different FragmentManager. Fragment ");
                    outline152.append(screenStackFragment.toString());
                    outline152.append(" is already attached to a FragmentManager.");
    ...
    public void performUpdate() {
        ...
        if (screenStackFragment != null && !screenStackFragment.isAdded()) {
            ...
            orCreateTransaction.mCommitRunnables.add(r2);
        }
        ...
        if (this.mStack.contains(screenStackFragment2)) {
            ...
            int ordinal2 = screenStackFragment2.mScreenView.getStackAnimation().ordinal();
            if (ordinal2 == 1) {
                i = 0;
            } else if (ordinal2 != 2) {
                i = 4097;
