    ...
    public static boolean deleteRealm(final RealmConfiguration realmConfiguration) {
        ...
        if (OsObjectStore.nativeCallWithLock(realmConfiguration.canonicalPath, new Runnable() {
            ...
            public void run() {
                ...
                File file2 = new File(file, GeneratedOutlineSupport.outline8(str2, ".management"));
                File file3 = new File(str);
                File file4 = new File(GeneratedOutlineSupport.outline8(str, ".note"));
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("It's not allowed to delete the file associated with an open Realm. Remember to close() all the instances of the Realm before deleting its file: ");
