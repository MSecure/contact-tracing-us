...
public class MutableRealmSchema extends RealmSchema {
    ...
    public void remove(String str) {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline8("Cannot remove class because it is not in this Realm: ", str));
    }
    ...
    public RealmObjectSchema rename(String str, String str2) {
        ...
        String outline8 = GeneratedOutlineSupport.outline8("Cannot rename class because it doesn't exist in this Realm: ", str);
        if (!this.realm.sharedRealm.hasTable(Table.getTableNameForClass(str))) {
            throw new IllegalArgumentException(outline8);
            ...
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline9(str, " cannot be renamed because the new class already exists: ", str2));
        }
    }
}
