...
public class RealmList<E> extends AbstractList<E> implements OrderedRealmCollection<E> {
    ...
    public class RealmItr implements Iterator<E> {
        ...
        public E next() {
            ...
            try {
                ...
                checkConcurrentModification();
                StringBuilder outline16 = GeneratedOutlineSupport.outline16("Cannot access index ", i, " when size is ");
                outline16.append(RealmList.this.size());
                outline16.append(". Remember to check hasNext() before using next().");
                throw new NoSuchElementException(outline16.toString());
            }
        }
    ...
    public class RealmListItr extends RealmList<E>.RealmItr implements ListIterator<E> {
        public RealmListItr(int i) {
            ...
            if (i < 0 || i > RealmList.this.size()) {
                ...
                outline15.append(RealmList.this.size() - 1);
                outline15.append("]. Index was ");
                outline15.append(i);
        ...
        public E previous() {
            ...
            try {
                ...
                checkConcurrentModification();
                throw new NoSuchElementException(GeneratedOutlineSupport.outline5("Cannot access index less than zero. This was ", i, ". Remember to check hasPrevious() before using previous()."));
            }
        }
    ...
    public RealmList(Class<E> cls, OsList osList, BaseRealm baseRealm) {
        ...
        if (isClassForRealmModel(cls)) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unexpected value class: ");
