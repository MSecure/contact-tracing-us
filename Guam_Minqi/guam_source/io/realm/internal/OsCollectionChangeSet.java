...
public class OsCollectionChangeSet implements OrderedCollectionChangeSet, NativeObject {
    ...
    public String toString() {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Deletion Ranges: ");
        outline15.append(Arrays.toString(getDeletionRanges()));
        outline15.append("\nInsertion Ranges: ");
        outline15.append(Arrays.toString(getInsertionRanges()));
        outline15.append("\nChange Ranges: ");
        outline15.append(Arrays.toString(getChangeRanges()));
