...
public final class CipherSuite {
    ...
    public static String secondaryName(String str) {
        if (str.startsWith("TLS_")) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("SSL_");
            outline15.append(str.substring(4));
            return outline15.toString();
        } else if (!str.startsWith("SSL_")) {
            return str;
        } else {
            StringBuilder outline152 = GeneratedOutlineSupport.outline15("TLS_");
