...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public OkHttpClient(Builder builder) {
        ...
        if (this.interceptors.contains(null)) {
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Null interceptor: ");
            outline15.append(this.interceptors);
            throw new IllegalStateException(outline15.toString());
        } else if (this.networkInterceptors.contains(null)) {
            StringBuilder outline152 = GeneratedOutlineSupport.outline15("Null network interceptor: ");
            outline152.append(this.networkInterceptors);
