...
public final class Request {
        ...
        public Builder url(String str) {
            if (str != null) {
                if (str.regionMatches(true, 0, "ws:", 0, 3)) {
                    ...
                    outline15.append(str.substring(3));
                    str = outline15.toString();
                } else if (str.regionMatches(true, 0, "wss:", 0, 4)) {
                    StringBuilder outline152 = GeneratedOutlineSupport.outline15("https:");
                    outline152.append(str.substring(4));
    ...
    public String toString() {
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Request{method=");
        outline15.append(this.method);
        outline15.append(", url=");
        outline15.append(this.url);
