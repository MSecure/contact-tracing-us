    ...
    public Response proceed(Request request2, StreamAllocation streamAllocation2, HttpCodec httpCodec2, RealConnection realConnection) throws IOException {
        if (this.index < this.interceptors.size()) {
            ...
            if (this.httpCodec != null && !this.connection.supportsUrl(request2.url())) {
                StringBuilder outline15 = GeneratedOutlineSupport.outline15("network interceptor ");
                outline15.append(this.interceptors.get(this.index - 1));
                outline15.append(" must retain the same host and port");
                ...
                StringBuilder outline152 = GeneratedOutlineSupport.outline15("network interceptor ");
                outline152.append(this.interceptors.get(this.index - 1));
                outline152.append(" must call proceed() exactly once");
