...
public class Platform {
    ...
    public CertificateChainCleaner buildCertificateChainCleaner(SSLSocketFactory sSLSocketFactory) {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unable to extract the trust manager on ");
        outline15.append(get());
        outline15.append(", sslSocketFactory is ");
        outline15.append(sSLSocketFactory.getClass());
