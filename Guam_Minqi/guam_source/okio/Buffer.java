...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public long readAll(Sink sink) throws IOException {
        long j = this.size;
        if (j > 0) {
            ((Okio.AnonymousClass1) sink).write(this, j);
        }
        return j;
    }
    ...
    public long readDecimalLong() {
        ...
        if (this.size != 0) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    if (b >= 48 && b <= 57) {
                        ...
                        StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected leading [0-9] or '-' character but was 0x");
                        outline15.append(Integer.toHexString(b));
            ...
            StringBuilder outline152 = GeneratedOutlineSupport.outline15("Number too large: ");
            outline152.append(writeDecimalLong2.readUtf8());
                ...
                while (true) {
                    ...
                    if (b < 48 || b > 57) {
                        if (b >= 97 && b <= 102) {
                            ...
                            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Expected leading [0-9a-fA-F] character but was 0x");
                            outline15.append(Integer.toHexString(b));
                            throw new NumberFormatException(outline15.toString());
                        }
                        i = i2 + 10;
                    ...
                    if ((-1152921504606846976L & j) == 0) {
                        ...
                        StringBuilder outline152 = GeneratedOutlineSupport.outline15("Number too large: ");
                        outline152.append(writeHexadecimalUnsignedLong.readUtf8());
                        throw new NumberFormatException(outline152.toString());
                    }
                }
                if (i3 == 0) {
    ...
    public int readInt() {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("size < 4: ");
        outline15.append(this.size);
    ...
    public long readLong() {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("size < 8: ");
        outline15.append(this.size);
        throw new IllegalStateException(outline15.toString());
    }
    ...
    public short readShort() {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("size < 2: ");
        outline15.append(this.size);
        throw new IllegalStateException(outline15.toString());
    }
    ...
    public String toString() {
        ...
        StringBuilder outline15 = GeneratedOutlineSupport.outline15("size > Integer.MAX_VALUE: ");
        outline15.append(this.size);
    ...
    public Buffer writeString(String str, int i, int i2, Charset charset) {
        if (i < 0) {
            throw new IllegalAccessError(GeneratedOutlineSupport.outline4("beginIndex < 0: ", i));
        } else if (i2 < i) {
            throw new IllegalArgumentException("endIndex < beginIndex: " + i2 + " < " + i);
        } else if (i2 > str.length()) {
            StringBuilder outline16 = GeneratedOutlineSupport.outline16("endIndex > string.length: ", i2, " > ");
            outline16.append(str.length());
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("Unexpected code point: ");
    ...
    public String readUtf8LineStrict(long j) throws EOFException {
        if (j >= 0) {
            ...
            outline15.append(Math.min(this.size, j));
            outline15.append(" content=");
            outline15.append(buffer.readByteString().hex());
            outline15.append((char) 8230);
            throw new EOFException(outline15.toString());
        }
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline6("limit < 0: ", j));
    }
    ...
    public byte[] readByteArray(long j) throws EOFException {
        ...
        throw new IllegalArgumentException(GeneratedOutlineSupport.outline6("byteCount > Integer.MAX_VALUE: ", j));
    }
    ...
    public Buffer writeUtf8(String str, int i, int i2) {
        char charAt;
        if (i < 0) {
            throw new IllegalArgumentException(GeneratedOutlineSupport.outline4("beginIndex < 0: ", i));
        } else if (i2 < i) {
            throw new IllegalArgumentException("endIndex < beginIndex: " + i2 + " < " + i);
        } else if (i2 <= str.length()) {
            while (i < i2) {
