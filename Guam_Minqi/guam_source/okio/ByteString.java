...
public class ByteString implements Serializable, Comparable<ByteString> {
    ...
    public ByteString substring(int i, int i2) {
        if (i >= 0) {
            ...
            if (i2 <= bArr.length) {
                ...
                throw new IllegalArgumentException(GeneratedOutlineSupport.outline11(GeneratedOutlineSupport.outline15("endIndex > length("), this.data.length, ")"));
            }
        } else {
    ...
    public String toString() {
        ...
        if (i != -1) {
            ...
            outline15.append(this.data.length);
            outline15.append(" text=");
            outline15.append(replace);
            outline15.append("…]");
            return outline15.toString();
        } else if (this.data.length <= 64) {
            StringBuilder outline152 = GeneratedOutlineSupport.outline15("[hex=");
            outline152.append(hex());
            outline152.append("]");
            return outline152.toString();
        } else {
            StringBuilder outline153 = GeneratedOutlineSupport.outline15("[size=");
            outline153.append(this.data.length);
            outline153.append(" hex=");
            outline153.append(substring(0, 64).hex());
            outline153.append("…]");
