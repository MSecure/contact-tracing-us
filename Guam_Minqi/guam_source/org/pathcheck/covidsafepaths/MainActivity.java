...
public class MainActivity extends ReactActivity {
    ...
    public void onCreate(Bundle bundle) {
        PathParser.mActivity = new WeakReference<>(this);
    ...
    public void onResume() {
        ...
        super.onResume();
        ExposureNotificationClientWrapper exposureNotificationClientWrapper = ExposureNotificationClientWrapper.get(this);
        exposureNotificationClientWrapper.isEnabled().addOnSuccessListener(new OnSuccessListener(exposureNotificationClientWrapper) {
