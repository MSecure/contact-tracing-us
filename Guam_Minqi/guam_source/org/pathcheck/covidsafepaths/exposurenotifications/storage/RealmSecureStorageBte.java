...
public final class RealmSecureStorageBte {
    ...
    static {
        ...
        if (!TextUtils.equals("safepathsbte_enc_prefs", "safepathsbte_enc_key")) {
            ...
            if (i != 0 && i < i7) {
                ...
                try {
                    SharedPrefKeyStorage sharedPrefKeyStorage = (SharedPrefKeyStorage) CompatSharedPrefKeyStorageFactory.createKeyStorageForWrapperType(context, i, "safepathsbte_enc_key", "safepathsbte", 2, RCTAes.KEY_ALGORITHM, "", prngSaltGenerator);
                    SecretKey loadKey = sharedPrefKeyStorage.loadKey(context);
                    z3 = false;
                    if (loadKey != null) {
                        sharedPrefKeyStorage.clearKey(context);
                        keyStorage = CompatSharedPrefKeyStorageFactory.createKeyStorageForWrapperType(context, i3, "safepathsbte_enc_key", "safepathsbte", 2, RCTAes.KEY_ALGORITHM, "", prngSaltGenerator);
                        z3 = false;
                        z2 = false;
                    }
                ...
                if (i != 0) {
                    ...
                    r1 = false;
                    if (keyStorage == null) {
                        keyStorage = CompatSharedPrefKeyStorageFactory.createKeyStorageForWrapperType(context, i2, "safepathsbte_enc_key", "safepathsbte", 2, RCTAes.KEY_ALGORITHM, "", prngSaltGenerator);
                    }
                    int i8 = r1 == true ? 1 : 0;
                    int i9 = r1 == true ? 1 : 0;
                    int i10 = r1 == true ? 1 : 0;
                    ...
                    if (!z) {
                        ...
                        SecretKeySpec secretKeySpec = new SecretKeySpec(bArr2, RCTAes.KEY_ALGORITHM);
                        ...
                        ((SharedPrefKeyStorage) standardSharedPreferenceVault.mKeyStorage).saveKey(standardSharedPreferenceVault.mContext, secretKeySpec);
                    }
                    ...
                    if (string == null) {
                        ...
                        String encodeToString = Base64.encodeToString(bArr3, r1);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x002b, code lost:
        com.horcrux.svg.PathParser.closeFinally(r0, r1);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:9:0x0023, code lost:
        com.horcrux.svg.PathParser.closeFinally(r1, r4);
     */
