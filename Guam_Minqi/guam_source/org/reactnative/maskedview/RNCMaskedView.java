...
public class RNCMaskedView extends ReactViewGroup {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.mBitmapMask != null) {
            ...
            canvas.drawBitmap(this.mBitmapMask, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, BaseViewManager.CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER, this.mPaint);
