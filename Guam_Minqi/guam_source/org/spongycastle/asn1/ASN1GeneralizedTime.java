...
public class ASN1GeneralizedTime extends ASN1Primitive {
    ...
    public boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        ...
        return PathParser.areEqual(this.time, ((ASN1GeneralizedTime) aSN1Primitive).time);
    }
    ...
    public final String calculateGMTOffset() {
        ...
        return "GMT" + str + convert(i) + ColorPropConverter.PACKAGE_DELIMITER + convert(i2);
    }

    public final String convert(int i) {
        if (i < 10) {
            return GeneratedOutlineSupport.outline4("0", i);
        }
    ...
    public Date getDate() throws ParseException {
        ...
        if (hasFractionalSeconds()) {
            ...
            if (i2 > 3) {
                ...
                GeneratedOutlineSupport.outline20(substring, 0, i, sb, "00");
                sb.append(substring.substring(i));
                fromByteArray = fromByteArray.substring(0, 14) + sb.toString();
            } else if (i2 == 2) {
                StringBuilder sb2 = new StringBuilder();
                GeneratedOutlineSupport.outline20(substring, 0, i, sb2, "0");
    ...
    public String getTime() {
        ...
        if (charAt == '-' || charAt == '+') {
            ...
            sb.append("GMT");
            int i = length + 3;
            GeneratedOutlineSupport.outline20(fromByteArray, length, i, sb, ColorPropConverter.PACKAGE_DELIMITER);
        ...
        if (charAt2 == '-' || charAt2 == '+') {
            StringBuilder sb2 = new StringBuilder();
            GeneratedOutlineSupport.outline20(fromByteArray, 0, length2, sb2, "GMT");
            sb2.append(fromByteArray.substring(length2));
            sb2.append(":00");
            return sb2.toString();
        }
        StringBuilder outline15 = GeneratedOutlineSupport.outline15(fromByteArray);
        outline15.append(calculateGMTOffset());
