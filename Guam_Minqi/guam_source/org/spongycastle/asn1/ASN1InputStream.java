        ...
        if (i == 10) {
            ...
            if (buffer.length != 0) {
                ...
                if (i2 >= aSN1EnumeratedArr.length) {
                    return new ASN1Enumerated(PathParser.clone(buffer));
                }
                ASN1Enumerated aSN1Enumerated = aSN1EnumeratedArr[i2];
                if (aSN1Enumerated == null) {
                    aSN1Enumerated = new ASN1Enumerated(PathParser.clone(buffer));
                ...
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            ...
                            default:
                                throw new IOException(GeneratedOutlineSupport.outline5("unknown tag ", i, " encountered"));
                        }
                }
            } else {
    ...
    public static int readLength(InputStream inputStream, int i) throws IOException {
        ...
        if (read < 0) {
            ...
            if (i2 <= 4) {
                ...
                throw new IOException(GeneratedOutlineSupport.outline4("DER length more than 4 bytes: ", i2));
            }
        }
    }
    ...
    public ASN1Primitive buildObject(int i, int i2, int i3) throws IOException {
        ...
        if (i2 == 4) {
            ...
            if (i2 != 16) {
                ...
                throw new IOException(GeneratedOutlineSupport.outline5("unknown tag ", i2, " encountered"));
