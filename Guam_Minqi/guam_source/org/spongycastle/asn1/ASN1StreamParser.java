    ...
    public ASN1Encodable readObject() throws IOException {
        ...
        if (readLength >= 0) {
            ...
            if (z) {
                ...
                throw new IOException(GeneratedOutlineSupport.outline5("unknown tag ", readTagNumber, " encountered"));
            ...
            StringBuilder outline15 = GeneratedOutlineSupport.outline15("unknown BER object encountered: 0x");
            outline15.append(Integer.toHexString(readTagNumber));
            throw new ASN1Exception(outline15.toString());
        } else {
