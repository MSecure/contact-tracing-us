...
public final class IsoFields {
    ...
    public enum Field implements TemporalField {
        ...
        WEEK_OF_WEEK_BASED_YEAR {
            ...
            public <R extends Temporal> R adjustInto(R r, long j) {
                range().checkValidValue(j, this);
                return (R) r.plus(PathParser.safeSubtract(j, getFrom(r)), ChronoUnit.WEEKS);
            }
    ...
    public enum Unit implements TemporalUnit {
        ...
        public <R extends Temporal> R addTo(R r, long j) {
            int ordinal = ordinal();
            if (ordinal == 0) {
                return (R) r.with(IsoFields.WEEK_BASED_YEAR, PathParser.safeAdd((long) r.get(IsoFields.WEEK_BASED_YEAR), j));
            } else if (ordinal == 1) {
