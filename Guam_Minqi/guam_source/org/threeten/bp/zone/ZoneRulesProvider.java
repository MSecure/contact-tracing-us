...
public abstract class ZoneRulesProvider {
    ...
    public static ZoneRules getRules(String str, boolean z) {
        ZoneRules zoneRules;
        PathParser.requireNonNull(str, "zoneId");
        ...
        if (zoneRulesProvider != null) {
            ...
            if (binarySearch < 0) {
                ...
                try {
                    ...
                    StringBuilder outline17 = GeneratedOutlineSupport.outline17("Invalid binary time-zone data: TZDB:", str, ", version: ");
                    outline17.append(value.versionId);
                    throw new ZoneRulesException(outline17.toString(), e);
                }
            }
            if (zoneRules != null) {
                return zoneRules;
            }
            throw new ZoneRulesException(GeneratedOutlineSupport.outline8("Unknown time-zone ID: ", str));
    ...
    public static void registerProvider(ZoneRulesProvider zoneRulesProvider) {
        PathParser.requireNonNull(zoneRulesProvider, "provider");
