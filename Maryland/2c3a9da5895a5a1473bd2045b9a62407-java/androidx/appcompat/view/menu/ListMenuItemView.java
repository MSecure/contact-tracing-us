...
public class ListMenuItemView extends LinearLayout implements n.a, AbsListView.SelectionBoundsAdjuster {
    ...
    public ImageView f48i;

    /* renamed from: j  reason: collision with root package name */
    public LinearLayout f49j;

    /* renamed from: k  reason: collision with root package name */
    public Drawable f50k;
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet) {
        ...
        this.f50k = q2.g(R$styleable.MenuView_android_itemBackground);
        this.f51l = q2.l(R$styleable.MenuView_android_itemTextAppearance, -1);
    ...
    public final void a() {
        ...
        this.f45f = checkBox;
        LinearLayout linearLayout = this.f49j;
    ...
    public void adjustListItemSelectionBounds(Rect rect) {
        ImageView imageView = this.f48i;
        if (imageView != null && imageView.getVisibility() == 0) {
            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) this.f48i.getLayoutParams();
            rect.top = this.f48i.getHeight() + layoutParams.topMargin + layoutParams.bottomMargin + rect.top;
        }
    }

    public final void b() {
        RadioButton radioButton = (RadioButton) getInflater().inflate(R$layout.abc_list_menu_item_radio, (ViewGroup) this, false);
        this.f43d = radioButton;
        LinearLayout linearLayout = this.f49j;
        if (linearLayout != null) {
    ...
    public void c(boolean z) {
        ...
        if (i3 == 0) {
            ...
            if (e2 == 0) {
                ...
                int i4 = iVar.n.n() ? iVar.f807k : iVar.f805i;
        ...
        if (this.f46g.getVisibility() != i3) {
            this.f46g.setVisibility(i3);
        }
    }
    ...
    public void onFinishInflate() {
        ...
        this.f46g = (TextView) findViewById(R$id.shortcut);
        ImageView imageView = (ImageView) findViewById(R$id.submenuarrow);
        this.f47h = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.o);
        }
        this.f48i = (ImageView) findViewById(R$id.group_divider);
        this.f49j = (LinearLayout) findViewById(R$id.content);
    }
    ...
    public void setCheckable(boolean z) {
        ...
        if (z || this.f43d != null || this.f45f != null) {
            if (this.b.h()) {
                if (this.f43d == null) {
                    b();
                }
                compoundButton2 = this.f43d;
            ...
            RadioButton radioButton = this.f43d;
            if (radioButton != null) {
