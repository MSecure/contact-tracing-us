...
public class ActionBarContextView extends e.b.f.a {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        ...
        this.f834f = obtainStyledAttributes.getLayoutDimension(R$styleable.ActionMode_height, 0);
    ...
    public void f(e.b.e.a aVar) {
        ...
        if (view2 == null) {
            ...
            this.f62l.findViewById(R$id.action_mode_close_button).setOnClickListener(new a(this, aVar));
            g gVar = (g) aVar.e();
            cVar = this.f833e;
            if (cVar != null) {
                cVar.a();
            ...
            gVar.b(this.f833e, this.c);
            c cVar3 = this.f833e;
            nVar = cVar3.f769i;
            if (nVar == null) {
                n nVar3 = (n) cVar3.f765e.inflate(cVar3.f767g, (ViewGroup) this, false);
                cVar3.f769i = nVar3;
                nVar3.b(cVar3.f764d);
                cVar3.j(true);
            }
            ...
            this.f832d = actionMenuView;
            AtomicInteger atomicInteger = m.a;
            actionMenuView.setBackground(null);
            addView(this.f832d, layoutParams);
        }
        addView(view);
        this.f62l.findViewById(R$id.action_mode_close_button).setOnClickListener(new a(this, aVar));
        g gVar2 = (g) aVar.e();
        ...
        this.f832d = actionMenuView2;
        AtomicInteger atomicInteger2 = m.a;
        actionMenuView2.setBackground(null);
        addView(this.f832d, layoutParams2);
    }
    ...
    public final void g() {
        ...
        this.o.setText(this.f60j);
        this.p.setText(this.f61k);
        boolean z = !TextUtils.isEmpty(this.f60j);
        boolean z2 = !TextUtils.isEmpty(this.f61k);
        int i2 = 0;
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        if (accessibilityEvent.getEventType() == 32) {
            ...
            accessibilityEvent.setContentDescription(this.f60j);
            return;
        }
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (!(view == null || view.getVisibility() == 8)) {
            ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) this.f62l.getLayoutParams();
            ...
            int d2 = i8 + d(this.f62l, i8, paddingTop, paddingTop2, a2);
        ...
        ActionMenuView actionMenuView = this.f832d;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (View.MeasureSpec.getMode(i2) != 1073741824) {
            ...
            if (actionMenuView != null && actionMenuView.getParent() == this) {
                paddingLeft = c(this.f832d, paddingLeft, makeMeasureSpec, 0);
            }
            LinearLayout linearLayout = this.n;
