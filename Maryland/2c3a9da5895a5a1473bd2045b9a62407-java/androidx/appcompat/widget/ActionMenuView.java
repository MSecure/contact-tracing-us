    ...
    public void onMeasure(int i2, int i3) {
        ...
        while (i18 < childCount2) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                cVar2.f73e = z7 && ((ActionMenuItemView) childAt).c();
        ...
        if (i11 > 0 && j2 != 0 && (i11 < i14 - 1 || z10 || i16 > 1)) {
            ...
            if (!z10) {
                if ((j2 & 1) != 0 && !((c) getChildAt(0).getLayoutParams()).f73e) {
                    bitCount -= 0.5f;
                }
                int i31 = childCount2 - 1;
                if ((j2 & ((long) (1 << i31))) != 0 && !((c) getChildAt(i31).getLayoutParams()).f73e) {
                    bitCount -= 0.5f;
                }
            }
