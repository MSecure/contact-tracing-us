...
public class SearchView extends i0 implements e.b.e.b {
    ...
    public static class SearchAutoComplete extends e.b.f.d {
        ...
        public int f81e = getThreshold();

        /* renamed from: f  reason: collision with root package name */
        public SearchView f82f;

        /* renamed from: g  reason: collision with root package name */
        public boolean f83g;

        /* renamed from: h  reason: collision with root package name */
        public final Runnable f84h = new a();
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                if (searchAutoComplete.f83g) {
                    ((InputMethodManager) searchAutoComplete.getContext().getSystemService("input_method")).showSoftInput(searchAutoComplete, 0);
                    searchAutoComplete.f83g = false;
                }
            }
        }
        ...
        public boolean enoughToFilter() {
            return this.f81e <= 0 || super.enoughToFilter();
        }
        ...
        public void onFocusChanged(boolean z, int i2, Rect rect) {
            ...
            SearchView searchView = this.f82f;
        ...
        public void onWindowFocusChanged(boolean z) {
            ...
            if (z && this.f82f.hasFocus() && getVisibility() == 0) {
                boolean z2 = true;
                this.f83g = true;
    ...
    public static class o extends e.k.a.a {
        ...
        public o(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f85d = ((Boolean) parcel.readValue(null)).booleanValue();
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeValue(Boolean.valueOf(this.f85d));
        }
    }
    ...
    public static class p extends TouchDelegate {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final Rect f86d = new Rect();
        ...
        public p(Rect rect, Rect rect2, View view) {
            super(rect, view);
            this.f87e = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
            a(rect, rect2);
            this.a = view;
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i2) {
        ...
        m.h.h1(imageView, getResources().getString(R$string.abc_searchview_description_search));
