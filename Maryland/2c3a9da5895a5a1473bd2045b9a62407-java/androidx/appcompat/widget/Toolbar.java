...
public class Toolbar extends ViewGroup {
    ...
    public class d implements m {
        ...
        public boolean f(e.b.e.i.g gVar, i iVar) {
            View view = Toolbar.this.f95j;
            if (view instanceof e.b.e.b) {
                ((e.b.e.b) view).e();
            }
            Toolbar toolbar = Toolbar.this;
            toolbar.removeView(toolbar.f95j);
            Toolbar toolbar2 = Toolbar.this;
            toolbar2.removeView(toolbar2.f94i);
        ...
        public boolean g(e.b.e.i.g gVar, i iVar) {
            Toolbar.this.c();
            ViewParent parent = Toolbar.this.f94i.getParent();
            Toolbar toolbar = Toolbar.this;
            if (parent != toolbar) {
                if (parent instanceof ViewGroup) {
                    ((ViewGroup) parent).removeView(toolbar.f94i);
                }
                Toolbar toolbar2 = Toolbar.this;
                toolbar2.addView(toolbar2.f94i);
            }
            Toolbar.this.f95j = iVar.getActionView();
            this.c = iVar;
            ViewParent parent2 = Toolbar.this.f95j.getParent();
            Toolbar toolbar3 = Toolbar.this;
            if (parent2 != toolbar3) {
                if (parent2 instanceof ViewGroup) {
                    ((ViewGroup) parent2).removeView(toolbar3.f95j);
                }
                e h2 = Toolbar.this.generateDefaultLayoutParams();
                Toolbar toolbar4 = Toolbar.this;
                h2.a = 8388611 | (toolbar4.o & 112);
                h2.b = 2;
                toolbar4.f95j.setLayoutParams(h2);
                Toolbar toolbar5 = Toolbar.this;
                toolbar5.addView(toolbar5.f95j);
            }
    ...
    public static class g extends e.k.a.a {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeInt(this.f100e ? 1 : 0);
        }
    }
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i2) {
        ...
        e.i.i.m.q(this, context, iArr, attributeSet, q2.b, i2, 0);
        ...
        this.f92g = q2.g(R$styleable.Toolbar_collapseIcon);
        this.f93h = q2.n(R$styleable.Toolbar_collapseContentDescription);
    ...
    public void c() {
        if (this.f94i == null) {
            ...
            this.f94i = lVar;
            lVar.setImageDrawable(this.f92g);
            this.f94i.setContentDescription(this.f93h);
            e h2 = generateDefaultLayoutParams();
            h2.a = 8388611 | (this.o & 112);
            h2.b = 2;
            this.f94i.setLayoutParams(h2);
            this.f94i.setOnClickListener(new c());
        }
    }
    ...
    public final void f() {
        if (this.b == null) {
            ...
            actionMenuView.setPopupTheme(this.f97l);
    ...
    public final void g() {
        if (this.f90e == null) {
            this.f90e = new l(getContext(), null, R$attr.toolbarNavigationButtonStyle);
            e h2 = generateDefaultLayoutParams();
            h2.a = 8388611 | (this.o & 112);
            this.f90e.setLayoutParams(h2);
        }
    }
    ...
    public CharSequence getCollapseContentDescription() {
        ImageButton imageButton = this.f94i;
        if (imageButton != null) {
    ...
    public int getContentInsetEnd() {
        p0 p0Var = this.u;
        if (p0Var != null) {
            return p0Var.f932g ? p0Var.a : p0Var.b;
        }
        return 0;
    }
    ...
    public int getContentInsetStart() {
        p0 p0Var = this.u;
        if (p0Var != null) {
            return p0Var.f932g ? p0Var.b : p0Var.a;
        }
        return 0;
    }
    ...
    public CharSequence getNavigationContentDescription() {
        ImageButton imageButton = this.f90e;
        if (imageButton != null) {
            return imageButton.getContentDescription();
        }
        return null;
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (u(this.f90e)) {
            ...
            if (z3) {
                ...
                i7 = paddingLeft;
                if (u(this.f94i)) {
                    ImageButton imageButton2 = this.f94i;
                    if (z3) {
                ...
                if (!u3) {
                    e eVar2 = (e) this.f89d.getLayoutParams();
                    i10 = width;
                    i9 += this.f89d.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) eVar2).topMargin + ((ViewGroup.MarginLayoutParams) eVar2).bottomMargin;
                } else {
                    i10 = width;
                }
                if (!u2 || u3) {
                    TextView textView = !u2 ? this.c : this.f89d;
                    TextView textView2 = !u3 ? this.f89d : this.c;
                    e eVar3 = (e) textView.getLayoutParams();
                    e eVar4 = (e) textView2.getLayoutParams();
                    boolean z4 = (!u2 && this.c.getMeasuredWidth() > 0) || (u3 && this.f89d.getMeasuredWidth() > 0);
                    i19 = this.x & 112;
                    i12 = paddingLeft;
                    if (i19 != 48) {
                        i20 = max;
                    ...
                    if (!z3) {
                        ...
                        if (u3) {
                            int i34 = i21 + ((ViewGroup.MarginLayoutParams) ((e) this.f89d.getLayoutParams())).topMargin;
                            this.f89d.layout(min2 - this.f89d.getMeasuredWidth(), i34, min2, this.f89d.getMeasuredHeight() + i34);
                            i25 = min2 - this.r;
                        } else {
                            i25 = min2;
                        }
                        ...
                        if (u3) {
                            int i36 = i21 + ((ViewGroup.MarginLayoutParams) ((e) this.f89d.getLayoutParams())).topMargin;
                            int measuredWidth3 = this.f89d.getMeasuredWidth() + max2;
                            this.f89d.layout(max2, i36, measuredWidth3, this.f89d.getMeasuredHeight() + i36);
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (u(this.f90e)) {
            t(this.f90e, i2, 0, i3, 0, this.p);
            i6 = l(this.f90e) + this.f90e.getMeasuredWidth();
            i5 = Math.max(0, m(this.f90e) + this.f90e.getMeasuredHeight());
            i4 = View.combineMeasuredStates(0, this.f90e.getMeasuredState());
        } else {
            i6 = 0;
            i5 = 0;
            i4 = 0;
        ...
        if (u(this.f94i)) {
            t(this.f94i, i2, 0, i3, 0, this.p);
            i6 = l(this.f94i) + this.f94i.getMeasuredWidth();
            i5 = Math.max(i5, m(this.f94i) + this.f94i.getMeasuredHeight());
            i4 = View.combineMeasuredStates(i4, this.f94i.getMeasuredState());
        }
        ...
        if (u(this.f95j)) {
            max2 += s(this.f95j, i2, max2, i3, 0, iArr);
            i5 = Math.max(i5, m(this.f95j) + this.f95j.getMeasuredHeight());
            i4 = View.combineMeasuredStates(i4, this.f95j.getMeasuredState());
        }
        if (u(this.f91f)) {
            max2 += s(this.f91f, i2, max2, i3, 0, iArr);
            i5 = Math.max(i5, m(this.f91f) + this.f91f.getMeasuredHeight());
            i4 = View.combineMeasuredStates(i4, this.f91f.getMeasuredState());
        }
        int childCount = getChildCount();
        ...
        if (u(this.f89d)) {
            i9 = Math.max(i9, s(this.f89d, i2, max2 + i14, i3, i8 + i13, iArr));
            i8 = m(this.f89d) + this.f89d.getMeasuredHeight() + i8;
            i10 = View.combineMeasuredStates(i10, this.f89d.getMeasuredState());
        }
    ...
    public void setCollapseIcon(Drawable drawable) {
        if (drawable != null) {
            c();
            this.f94i.setImageDrawable(drawable);
            return;
        }
        ImageButton imageButton = this.f94i;
        if (imageButton != null) {
            imageButton.setImageDrawable(this.f92g);
        }
    }
    ...
    public void setLogo(Drawable drawable) {
        if (drawable != null) {
            if (this.f91f == null) {
                this.f91f = new n(getContext(), null, 0);
            }
            if (!o(this.f91f)) {
                b(this.f91f, true);
            }
            ...
            if (imageView != null && o(imageView)) {
                removeView(this.f91f);
                this.F.remove(this.f91f);
            }
        }
        ImageView imageView2 = this.f91f;
        if (imageView2 != null) {
    ...
    public void setLogoDescription(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence) && this.f91f == null) {
            this.f91f = new n(getContext(), null, 0);
        }
        ImageView imageView = this.f91f;
        if (imageView != null) {
    ...
    public void setNavigationIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (imageButton != null && o(imageButton)) {
                removeView(this.f90e);
                this.F.remove(this.f90e);
            }
        }
        ImageButton imageButton2 = this.f90e;
    ...
    public void setPopupTheme(int i2) {
        if (this.f97l != i2) {
            ...
            if (i2 == 0) {
                ...
                this.f96k = new ContextThemeWrapper(getContext(), i2);
            }
        }
    }
    ...
    public void setSubtitle(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence)) {
            if (this.f89d == null) {
                ...
                this.f89d = zVar;
                zVar.setSingleLine();
                this.f89d.setEllipsize(TextUtils.TruncateAt.END);
                int i2 = this.n;
                if (i2 != 0) {
                    this.f89d.setTextAppearance(context, i2);
                }
                ColorStateList colorStateList = this.B;
                if (colorStateList != null) {
                    this.f89d.setTextColor(colorStateList);
                }
            }
            if (!o(this.f89d)) {
                b(this.f89d, true);
            ...
            if (textView != null && o(textView)) {
                removeView(this.f89d);
                this.F.remove(this.f89d);
            }
        }
        TextView textView2 = this.f89d;
        if (textView2 != null) {
