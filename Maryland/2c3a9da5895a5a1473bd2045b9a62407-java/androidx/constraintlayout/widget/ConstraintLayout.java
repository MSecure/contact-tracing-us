...
public class ConstraintLayout extends ViewGroup {
    ...
    public int f110g = Integer.MAX_VALUE;

    /* renamed from: h  reason: collision with root package name */
    public int f111h = Integer.MAX_VALUE;

    /* renamed from: i  reason: collision with root package name */
    public boolean f112i = true;

    /* renamed from: j  reason: collision with root package name */
    public int f113j = 257;
        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                switch (i4) {
                    ...
                    case 10:
                        int resourceId4 = obtainStyledAttributes.getResourceId(index, this.f118f);
                        this.f118f = resourceId4;
                        if (resourceId4 == -1) {
                            this.f118f = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 11:
                        int resourceId5 = obtainStyledAttributes.getResourceId(index, this.f119g);
                        this.f119g = resourceId5;
                        if (resourceId5 == -1) {
                            this.f119g = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 12:
                        int resourceId6 = obtainStyledAttributes.getResourceId(index, this.f120h);
                        this.f120h = resourceId6;
                        if (resourceId6 == -1) {
                            this.f120h = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 13:
                        int resourceId7 = obtainStyledAttributes.getResourceId(index, this.f121i);
                        this.f121i = resourceId7;
                        if (resourceId7 == -1) {
                            this.f121i = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 14:
                        int resourceId8 = obtainStyledAttributes.getResourceId(index, this.f122j);
                        this.f122j = resourceId8;
                        if (resourceId8 == -1) {
                            this.f122j = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 15:
                        int resourceId9 = obtainStyledAttributes.getResourceId(index, this.f123k);
                        this.f123k = resourceId9;
                        if (resourceId9 == -1) {
                            this.f123k = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 16:
                        int resourceId10 = obtainStyledAttributes.getResourceId(index, this.f124l);
                        this.f124l = resourceId10;
                        if (resourceId10 == -1) {
                            this.f124l = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 17:
            ...
            if (dVar != null) {
                if (dVar.c0 == 8 && !dVar.z) {
                    ...
                    if (ordinal2 == 0) {
                        ...
                        i12 = ViewGroup.getChildMeasureSpec(this.f127f, i16, -2);
                    } else if (ordinal2 != 2) {
                        if (ordinal2 != 3) {
                            i2 = 0;
                        } else {
                            ...
                            int i18 = cVar != null ? cVar.f1275g + 0 : 0;
                        ...
                        if (ordinal == 0) {
                            if (ordinal == 1) {
                                ...
                                i9 = ViewGroup.getChildMeasureSpec(this.f128g, i15, -2);
                                boolean z = dVar.m == 1;
                                int i19 = aVar.f1304j;
                                if (i19 == 1 || i19 == 2) {
                                    if (aVar.f1304j == 2 || !z || (z && (view.getMeasuredWidth() == dVar.r())) || (view instanceof g) || dVar.A()) {
                                ...
                                i3 = 0;
                                e eVar = (e) dVar.P;
                                if (eVar != null && i.b(ConstraintLayout.this.f113j, 256) && view.getMeasuredWidth() == dVar.r() && view.getMeasuredWidth() < eVar.r() && view.getMeasuredHeight() == dVar.l() && view.getMeasuredHeight() < eVar.l() && view.getBaseline() == dVar.W && !dVar.y()) {
                                ...
                                if (view != null) {
                                    ...
                                    int i20 = aVar.f1304j;
                                    if (i20 == 1 || i20 == 2 || !z2 || dVar.f1294l != 0 || !z3 || dVar.m != 0) {
                                        ...
                                        if (!i.b(ConstraintLayout.this.f113j, 1)) {
                                            if (z6 && z4) {
                                    ...
                                    boolean z8 = i6 != i7;
                                    aVar.f1303i = (i5 == aVar.c && i4 == aVar.f1298d) ? false : true;
                                    if (aVar7.X) {
                                        z8 = true;
                                    }
                                ...
                                i11 = this.f128g;
                                int i25 = dVar.D != null ? dVar.E.f1275g + 0 : 0;
                                if (dVar.F != null) {
                                    i25 += dVar.G.f1275g;
                                }
                                i15 += i25;
                        ...
                        i12 = ViewGroup.getChildMeasureSpec(this.f127f, i16, -2);
                        boolean z9 = dVar.f1294l == 1;
                        int i26 = aVar.f1304j;
                        if (i26 == 1 || i26 == 2) {
                            if (aVar.f1304j == 2 || !z9 || (z9 && (view.getMeasuredHeight() == dVar.l())) || (view instanceof g) || dVar.z()) {
        ...
        if (attributeSet != null) {
            ...
            for (int i4 = 0; i4 < indexCount; i4++) {
                ...
                if (index == R$styleable.ConstraintLayout_Layout_android_minWidth) {
                    this.f108e = obtainStyledAttributes.getDimensionPixelOffset(index, this.f108e);
                } else if (index == R$styleable.ConstraintLayout_Layout_android_minHeight) {
                    this.f109f = obtainStyledAttributes.getDimensionPixelOffset(index, this.f109f);
                } else if (index == R$styleable.ConstraintLayout_Layout_android_maxWidth) {
                    this.f110g = obtainStyledAttributes.getDimensionPixelOffset(index, this.f110g);
                } else if (index == R$styleable.ConstraintLayout_Layout_android_maxHeight) {
                    this.f111h = obtainStyledAttributes.getDimensionPixelOffset(index, this.f111h);
                } else if (index == R$styleable.ConstraintLayout_Layout_layout_optimizationLevel) {
                    this.f113j = obtainStyledAttributes.getInt(index, this.f113j);
                } else if (index == R$styleable.ConstraintLayout_Layout_layoutDescription) {
                    int resourceId = obtainStyledAttributes.getResourceId(index, 0);
                    if (resourceId != 0) {
                        try {
                            this.f115l = new c(getContext(), this, resourceId);
    ...
    public int getOptimizationLevel() {
        return this.f107d.x0;
    }

    public void h(int i2, int i3, int i4, int i5, boolean z, boolean z2) {
        b bVar = this.r;
        int i6 = bVar.f126e;
        int resolveSizeAndState = ViewGroup.resolveSizeAndState(i4 + bVar.f125d, i2, 0);
        int min = Math.min(this.f110g, resolveSizeAndState & 16777215);
        int min2 = Math.min(this.f111h, ViewGroup.resolveSizeAndState(i5 + i6, i3, 0) & 16777215);
        if (z) {
            min |= 16777216;
        }
        if (z2) {
    ...
    public final boolean j() {
        ...
        if (z) {
            ...
            if (this.m != -1) {
                for (int i20 = 0; i20 < childCount2; i20++) {
                    ...
                    if (childAt2.getId() == this.m && (childAt2 instanceof e.g.c.e)) {
                        this.f114k = ((e.g.c.e) childAt2).getConstraintSet();
                    }
                }
            }
            e.g.c.d dVar6 = this.f114k;
            if (dVar6 != null) {
                dVar6.a(this, true);
            }
            this.f107d.l0.clear();
            ...
            if (size > 0) {
                ...
                while (i21 < size) {
                    ...
                    if (bVar.isInEditMode()) {
                        bVar.setIds(bVar.f1356f);
                    }
                    e.g.b.h.g gVar = bVar.f1355e;
                    if (gVar != null) {
                        ...
                        for (int i22 = 0; i22 < bVar.c; i22++) {
                            int i23 = bVar.b[i22];
                            View d2 = d(i23);
                            if (d2 == null && (e2 = bVar.e(this, (str = bVar.f1358h.get(Integer.valueOf(i23))))) != 0) {
                                bVar.b[i22] = e2;
                                bVar.f1358h.put(Integer.valueOf(e2), str);
                                d2 = d(e2);
                            }
                            if (d2 != null) {
                                e.g.b.h.g gVar2 = bVar.f1355e;
                                e.g.b.h.d e4 = e(d2);
            ...
            for (int i26 = 0; i26 < childCount2; i26++) {
                ...
                if (childAt3 instanceof g) {
                    ...
                    if (gVar3.b == -1 && !gVar3.isInEditMode()) {
                        gVar3.setVisibility(gVar3.f1393d);
                    }
            ...
            this.q.clear();
            this.q.put(0, this.f107d);
            this.q.put(getId(), this.f107d);
            ...
            while (i28 < childCount2) {
                ...
                if (e5 == null) {
                    ...
                    if (childAt5 instanceof e.g.c.b) {
                        ((e.g.c.b) childAt5).g(e5, this.f107d.p0);
                    }
                    if (aVar.Y) {
                        f fVar = (f) e5;
                        int i29 = aVar.i0;
                                    ...
                                    if (i7 != -1) {
                                        ...
                                        if (i8 != -1) {
                                            ...
                                            if (i9 != -1) {
                                                ...
                                                e.g.b.h.d dVar13 = sparseArray.get(aVar.f124l);
                        ...
                        if (aVar.V) {
                            ...
                            e5.i(aVar7).f1275g = ((ViewGroup.MarginLayoutParams) aVar).leftMargin;
                            e5.i(aVar6).f1275g = ((ViewGroup.MarginLayoutParams) aVar).rightMargin;
                        } else {
                            e5.O[0] = aVar5;
                            e5.M(0);
                        }
                        if (aVar.W) {
                            ...
                            e5.i(aVar9).f1275g = ((ViewGroup.MarginLayoutParams) aVar).topMargin;
                            e5.i(aVar8).f1275g = ((ViewGroup.MarginLayoutParams) aVar).bottomMargin;
                        } else {
                            e5.O[1] = aVar5;
                            e5.H(0);
                        }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (!this.f112i) {
            ...
            if (i25 == i2 && this.t == i3) {
                ...
                eVar2 = this.f107d;
                z6 = eVar2.y0;
            } else if (i25 == i2 && View.MeasureSpec.getMode(i2) == 1073741824 && View.MeasureSpec.getMode(i3) == Integer.MIN_VALUE && View.MeasureSpec.getMode(this.t) == Integer.MIN_VALUE && View.MeasureSpec.getSize(i3) >= this.f107d.l()) {
                this.s = i2;
                this.t = i3;
                r2 = this.f107d.r();
                l2 = this.f107d.l();
        ...
        if (mode != Integer.MIN_VALUE) {
            if (mode != 0) {
                if (mode != 1073741824) {
                    ...
                    i4 = Math.min(this.f110g - i31, i28);
                    aVar = aVar9;
                    if (mode2 == Integer.MIN_VALUE) {
                        if (mode2 != 0) {
                            if (mode2 != 1073741824) {
                                ...
                                aVar2 = aVar10;
                                aVar3 = aVar9;
                                i5 = Math.min(this.f111h - i30, i29);
                                aVar4 = aVar3;
                                ...
                                eVar4.V = i7;
                                int[] iArr = eVar4.w;
                                iArr[i7] = this.f110g - i31;
                                iArr[1] = this.f111h - i30;
                                eVar4.K(i7);
                                eVar4.J(i7);
                                eVar4.O[i7] = aVar;
                                eVar4.M(i4);
                                eVar4.O[1] = aVar4;
                                eVar4.H(i5);
                                eVar4.K(this.f108e - i31);
                                eVar4.J(this.f109f - i30);
                                eVar4.r0 = max3;
                                eVar4.s0 = max;
                                ...
                                b.AbstractC0031b bVar10 = eVar4.o0;
                                size = eVar4.l0.size();
                                int r3 = eVar4.r();
                                int l3 = eVar4.l();
                                ...
                                if (z) {
                                    ...
                                    if (!z3) {
                                        ...
                                        if (mode == 1073741824 && mode2 == 1073741824) {
                                            ...
                                            int t2 = eVar5.a.t();
                                            bVar2 = bVar10;
                                            eVar5.a.f1286d.f1338h.c(s2);
                                            eVar5.a.f1287e.f1338h.c(t2);
                                            eVar5.g();
                                            if (k2 == aVar2 || k3 == aVar2) {
                                                boolean z14 = z13;
                                                if (z13) {
                                                    Iterator<o> it2 = eVar5.f1308e.iterator();
                                                    while (true) {
                                                        if (it2.hasNext()) {
                                                            if (!it2.next().k()) {
                                                                z14 = false;
                                                ...
                                                if (z14 && k3 == aVar2) {
                                                    ...
                                                    e eVar11 = eVar5.a;
                                                    eVar11.f1287e.f1335e.c(eVar11.l());
                                                }
                                            } else {
                                                i10 = r3;
                                                i9 = l3;
                                            ...
                                            if (aVarArr[0] == aVar3 || aVarArr[0] == aVar14) {
                                                int r4 = eVar12.r() + s2;
                                                eVar5.a.f1286d.f1339i.c(r4);
                                                eVar5.a.f1286d.f1335e.c(r4 - s2);
                                                eVar5.g();
                                                e eVar13 = eVar5.a;
                                                d.a[] aVarArr2 = eVar13.O;
                                                if (aVarArr2[1] == aVar3 || aVarArr2[1] == aVar14) {
                                                    int l4 = eVar13.l() + t2;
                                                    eVar5.a.f1287e.f1339i.c(l4);
                                                    eVar5.a.f1287e.f1335e.c(l4 - t2);
                                                }
                                                eVar5.g();
                                                z10 = true;
                                            } else {
                                            ...
                                            Iterator<o> it3 = eVar5.f1308e.iterator();
                                            while (it3.hasNext()) {
                                                o next2 = it3.next();
                                                if (next2.b != eVar5.a || next2.f1337g) {
                                                    next2.e();
                                                }
                                            }
                                            Iterator<o> it4 = eVar5.f1308e.iterator();
                                            while (true) {
                                                if (!it4.hasNext()) {
                                                    z11 = true;
                                                    break;
                                                ...
                                                o next3 = it4.next();
                                                if ((z10 || next3.b != eVar5.a) && (!next3.f1338h.f1318j || ((!next3.f1339i.f1318j && !(next3 instanceof e.g.b.h.l.i)) || (!next3.f1335e.f1318j && !(next3 instanceof e.g.b.h.l.c) && !(next3 instanceof e.g.b.h.l.i))))) {
                                                    z11 = false;
                                                }
                                            }
                                            z11 = false;
                                            ...
                                            if (eVar14.b) {
                                                ...
                                                while (it5.hasNext()) {
                                                    ...
                                                    next4.h();
                                                    next4.a = false;
                                                    e.g.b.h.l.k kVar2 = next4.f1286d;
                                                    kVar2.f1335e.f1318j = false;
                                                    kVar2.f1337g = false;
                                                    kVar2.n();
                                                    m mVar2 = next4.f1287e;
                                                    mVar2.f1335e.f1318j = false;
                                                    mVar2.f1337g = false;
                                                    mVar2.m();
                                                }
                                                i19 = 0;
                                                ...
                                                e eVar15 = eVar14.a;
                                                eVar15.a = false;
                                                e.g.b.h.l.k kVar3 = eVar15.f1286d;
                                                kVar3.f1335e.f1318j = false;
                                                kVar3.f1337g = false;
                                                kVar3.n();
                                                m mVar3 = eVar14.a.f1287e;
                                                mVar3.f1335e.f1318j = false;
                                                mVar3.f1337g = false;
                                                mVar3.m();
                                                eVar14.c();
                                            } else {
                                            ...
                                            eVar14.b(eVar14.f1307d);
                                            e eVar16 = eVar14.a;
                                            eVar16.U = i19;
                                            eVar16.V = i19;
                                            eVar16.f1286d.f1338h.c(i19);
                                            eVar14.a.f1287e.f1338h.c(i19);
                                            i18 = 1073741824;
                                            if (mode == 1073741824) {
                                                i20 = 1;
                                    ...
                                    if (!z5 || i11 != 2) {
                                        ...
                                        if (size <= 0) {
                                            ...
                                            b.AbstractC0031b bVar11 = eVar4.o0;
                                            int i34 = 0;
                                            while (i34 < size5) {
                                                e.g.b.h.d dVar2 = eVar4.l0.get(i34);
                                                if (!(dVar2 instanceof f) && !(dVar2 instanceof e.g.b.h.a) && !dVar2.A && (!Y || (kVar = dVar2.f1286d) == null || (mVar = dVar2.f1287e) == null || !kVar.f1335e.f1318j || !mVar.f1335e.f1318j)) {
                                                    d.a k4 = dVar2.k(0);
                                                    d.a k5 = dVar2.k(1);
                                                    boolean z15 = k4 == aVar13 && dVar2.f1294l != 1 && k5 == aVar13 && dVar2.m != 1;
                                                    if (!z15 && eVar4.Y(1) && !(dVar2 instanceof j)) {
                                                        if (k4 == aVar13 && dVar2.f1294l == 0 && k5 != aVar13 && !dVar2.w()) {
                                                            z15 = true;
                                                        }
                                            ...
                                            while (true) {
                                                ...
                                                while (i40 < size2) {
                                                    ...
                                                    if ((!(dVar4 instanceof e.g.b.h.g) || (dVar4 instanceof j)) && !(dVar4 instanceof f)) {
                                                        i16 = size2;
                                                        if (dVar4.c0 != 8 && ((!z4 || !dVar4.f1286d.f1335e.f1318j || !dVar4.f1287e.f1335e.f1318j) && !(dVar4 instanceof j))) {
                                                            int r7 = dVar4.r();
                                                            int l7 = dVar4.l();
                                                            eVar = eVar4;
                                                            int i41 = dVar4.W;
                        ...
                        eVar4.V = i7;
                        int[] iArr2 = eVar4.w;
                        iArr2[i7] = this.f110g - i31;
                        iArr2[1] = this.f111h - i30;
                        eVar4.K(i7);
                        eVar4.J(i7);
                        eVar4.O[i7] = aVar;
                        eVar4.M(i4);
                        ...
                        b.AbstractC0031b bVar102 = eVar4.o0;
                        size = eVar4.l0.size();
                        int r32 = eVar4.r();
                        int l32 = eVar4.l();
                        ...
                        eVar4.V = i7;
                        int[] iArr22 = eVar4.w;
                        iArr22[i7] = this.f110g - i31;
                        iArr22[1] = this.f111h - i30;
                        eVar4.K(i7);
                        eVar4.J(i7);
                        eVar4.O[i7] = aVar;
                        eVar4.M(i4);
                        ...
                        b.AbstractC0031b bVar1022 = eVar4.o0;
                        size = eVar4.l0.size();
                        int r322 = eVar4.r();
                        int l322 = eVar4.l();
                    ...
                    eVar4.V = i7;
                    int[] iArr222 = eVar4.w;
                    iArr222[i7] = this.f110g - i31;
                    iArr222[1] = this.f111h - i30;
                    eVar4.K(i7);
                    eVar4.J(i7);
                    eVar4.O[i7] = aVar;
                    eVar4.M(i4);
                    ...
                    b.AbstractC0031b bVar10222 = eVar4.o0;
                    size = eVar4.l0.size();
                    int r3222 = eVar4.r();
                    int l3222 = eVar4.l();
            ...
            iArr2222[i7] = this.f110g - i31;
            iArr2222[1] = this.f111h - i30;
            eVar4.K(i7);
            eVar4.J(i7);
            eVar4.O[i7] = aVar;
            eVar4.M(i4);
            ...
            b.AbstractC0031b bVar102222 = eVar4.o0;
            size = eVar4.l0.size();
            int r32222 = eVar4.r();
            int l32222 = eVar4.l();
            ...
            iArr22222[i7] = this.f110g - i31;
            iArr22222[1] = this.f111h - i30;
            eVar4.K(i7);
            eVar4.J(i7);
            eVar4.O[i7] = aVar;
            eVar4.M(i4);
            ...
            b.AbstractC0031b bVar1022222 = eVar4.o0;
            size = eVar4.l0.size();
            int r322222 = eVar4.r();
            int l322222 = eVar4.l();
        ...
        iArr222222[i7] = this.f110g - i31;
        iArr222222[1] = this.f111h - i30;
        eVar4.K(i7);
        eVar4.J(i7);
        eVar4.O[i7] = aVar;
        eVar4.M(i4);
        ...
        b.AbstractC0031b bVar10222222 = eVar4.o0;
        size = eVar4.l0.size();
