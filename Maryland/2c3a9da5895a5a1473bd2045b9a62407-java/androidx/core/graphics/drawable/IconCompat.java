...
public class IconCompat extends CustomVersionedParcelable {
    ...
    public static final PorterDuff.Mode f152k = PorterDuff.Mode.SRC_IN;
    public int a = -1;
    public Object b;
    public byte[] c = null;

    /* renamed from: d  reason: collision with root package name */
    public Parcelable f153d = null;
    ...
    public ColorStateList f156g = null;

    /* renamed from: h  reason: collision with root package name */
    public PorterDuff.Mode f157h = f152k;

    /* renamed from: i  reason: collision with root package name */
    public String f158i = null;
    ...
    public Icon e() {
        ...
        switch (i3) {
            ...
            case 2:
                ...
                icon = Icon.createWithResource(str, this.f154e);
                break;
            case 3:
                icon = Icon.createWithData((byte[]) this.b, this.f154e, this.f155f);
                break;
            case 4:
        ...
        ColorStateList colorStateList = this.f156g;
        if (colorStateList != null) {
            icon.setTintList(colorStateList);
        }
        PorterDuff.Mode mode = this.f157h;
        if (mode == f152k) {
            return icon;
        }
