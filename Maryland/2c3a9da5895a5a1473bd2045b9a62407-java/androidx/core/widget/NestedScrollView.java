...
public class NestedScrollView extends FrameLayout implements i, f {
    ...
    public OverScroller f160d = new OverScroller(getContext());

    /* renamed from: e  reason: collision with root package name */
    public EdgeEffect f161e;

    /* renamed from: f  reason: collision with root package name */
    public EdgeEffect f162f;

    /* renamed from: g  reason: collision with root package name */
    public int f163g;

    /* renamed from: h  reason: collision with root package name */
    public boolean f164h = true;

    /* renamed from: i  reason: collision with root package name */
    public boolean f165i = false;

    /* renamed from: j  reason: collision with root package name */
    public View f166j = null;

    /* renamed from: k  reason: collision with root package name */
    public boolean f167k = false;

    /* renamed from: l  reason: collision with root package name */
    public VelocityTracker f168l;
    public boolean m;
    ...
    public final void B(int i2, int i3, int i4, boolean z2) {
        if (getChildCount() != 0) {
            if (AnimationUtils.currentAnimationTimeMillis() - this.b > 250) {
                ...
                OverScroller overScroller = this.f160d;
    ...
    public void computeScroll() {
        ...
        if (!this.f160d.isFinished()) {
            this.f160d.computeScrollOffset();
            int currY = this.f160d.getCurrY();
            int i2 = currY - this.v;
            this.v = currY;
            int[] iArr = this.t;
            boolean z2 = false;
            ...
            if (i3 != 0) {
                ...
                if (z2) {
                    k();
                    if (i3 < 0) {
                        if (this.f161e.isFinished()) {
                            edgeEffect = this.f161e;
                        }
                    } else if (this.f162f.isFinished()) {
                        edgeEffect = this.f162f;
                    }
                    edgeEffect.onAbsorb((int) this.f160d.getCurrVelocity());
                }
                a();
            }
            if (!this.f160d.isFinished()) {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f161e != null) {
            ...
            if (!this.f161e.isFinished()) {
                ...
                this.f161e.setSize(width, height);
                if (this.f161e.draw(canvas)) {
                    AtomicInteger atomicInteger = m.a;
                    postInvalidateOnAnimation();
                }
                canvas.restoreToCount(save);
            }
            if (!this.f162f.isFinished()) {
                ...
                this.f162f.setSize(width2, height2);
                if (this.f162f.draw(canvas)) {
    ...
    public final void g() {
        ...
        x();
        this.y.j(0);
        EdgeEffect edgeEffect = this.f161e;
        if (edgeEffect != null) {
            edgeEffect.onRelease();
            this.f162f.onRelease();
        }
    }
    ...
    public final void k() {
        if (getOverScrollMode() == 2) {
            this.f161e = null;
            this.f162f = null;
        } else if (this.f161e == null) {
            Context context = getContext();
            this.f161e = new EdgeEffect(context);
            this.f162f = new EdgeEffect(context);
        }
    }
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        if ((motionEvent.getSource() & 2) != 0 && motionEvent.getAction() == 8 && !this.f167k) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (i2 != 0) {
                ...
                if (i2 == 2) {
                    ...
                    if (i3 != -1) {
                        ...
                        if (findPointerIndex == -1) {
                            ...
                            if (Math.abs(y2 - this.f163g) > this.o && (2 & getNestedScrollAxes()) == 0) {
                                this.f167k = true;
                                this.f163g = y2;
                                if (this.f168l == null) {
                                    this.f168l = VelocityTracker.obtain();
                                }
                                this.f168l.addMovement(motionEvent);
                                this.u = 0;
            ...
            this.r = -1;
            x();
            if (this.f160d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                AtomicInteger atomicInteger = m.a;
                postInvalidateOnAnimation();
            }
            this.y.j(0);
            ...
            if (getChildCount() > 0) {
                ...
                if (y3 >= childAt.getTop() - scrollY && y3 < childAt.getBottom() - scrollY && x2 >= childAt.getLeft() && x2 < childAt.getRight()) {
                    ...
                    if (z2) {
                        ...
                        VelocityTracker velocityTracker = this.f168l;
                        ...
                        this.f168l.addMovement(motionEvent);
                        this.f160d.computeScrollOffset();
                        this.f167k = !this.f160d.isFinished();
                        C(2, 0);
                    }
                }
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x007d, code lost:
        if (r22.f160d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange()) != false) goto L_0x020b;
     */
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    ...
                    int y2 = (int) motionEvent.getY(findPointerIndex);
                    int i3 = this.f163g - y2;
                    if (!this.f167k && Math.abs(i3) > this.o) {
                    ...
                    if (this.f167k) {
                        ...
                        if (z2) {
                            ...
                            int i8 = scrollY + i7;
                            if (i8 < 0) {
                                this.f161e.onPull(((float) i7) / ((float) getHeight()), motionEvent.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.f162f.isFinished()) {
                                    edgeEffect = this.f162f;
                                }
                                EdgeEffect edgeEffect2 = this.f161e;
                                if (edgeEffect2 != null && (!edgeEffect2.isFinished() || !this.f162f.isFinished())) {
                                    AtomicInteger atomicInteger = m.a;
                                    postInvalidateOnAnimation();
                                }
                            } else {
                                if (i8 > scrollRange) {
                                    this.f162f.onPull(((float) i7) / ((float) getHeight()), 1.0f - (motionEvent.getX(findPointerIndex) / ((float) getWidth())));
                                    if (!this.f161e.isFinished()) {
                                        edgeEffect = this.f161e;
                                    }
                                }
                                EdgeEffect edgeEffect22 = this.f161e;
                                AtomicInteger atomicInteger2 = m.a;
                                postInvalidateOnAnimation();
                            }
                            edgeEffect.onRelease();
                            EdgeEffect edgeEffect222 = this.f161e;
                ...
                this.f163g = (int) motionEvent.getY(actionIndex);
                this.r = motionEvent.getPointerId(actionIndex);
            } else if (actionMasked == 6) {
                v(motionEvent);
                this.f163g = (int) motionEvent.getY(motionEvent.findPointerIndex(this.r));
            }
            ...
            boolean z3 = !this.f160d.isFinished();
            this.f167k = z3;
            ...
            this.f163g = (int) motionEvent.getY();
            this.r = motionEvent.getPointerId(0);
            C(2, 0);
        }
        VelocityTracker velocityTracker2 = this.f168l;
    ...
    public void p(int i2) {
        if (getChildCount() > 0) {
            this.f160d.fling(getScrollX(), getScrollY(), 0, i2, 0, 0, Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 0);
            y(true);
        }
    }
    ...
    public final void v(MotionEvent motionEvent) {
        ...
        if (motionEvent.getPointerId(actionIndex) == this.r) {
            ...
            this.f163g = (int) motionEvent.getY(i2);
    ...
    public boolean w(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
        ...
        if (i10 > i15) {
            ...
            if (i12 <= i17) {
                ...
                z3 = false;
                if (z3 && !r(1)) {
                    this.f160d.springBack(i10, i12, 0, 0, 0, getScrollRange());
                }
