...
public abstract class LiveData<T> {
    ...
    public static final Object f169k = new Object();
    ...
    public class LifecycleBoundObserver extends LiveData<T>.c implements h {
        ...
        public void d(j jVar, g.a aVar) {
            ...
            while (bVar2 != bVar) {
                h(k());
                bVar2 = bVar;
                bVar = ((k) this.f177e.a()).b;
            }
        }

        @Override // androidx.lifecycle.LiveData.c
        public void i() {
            k kVar = (k) this.f177e.a();
        ...
        public boolean j(j jVar) {
            return this.f177e == jVar;
        }

        @Override // androidx.lifecycle.LiveData.c
        public boolean k() {
            return ((k) this.f177e.a()).b.compareTo(g.b.STARTED) >= 0;
        }
    }
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            synchronized (LiveData.this.a) {
                obj = LiveData.this.f172f;
                LiveData.this.f172f = LiveData.f169k;
            }
            LiveData.this.l(obj);
        }
    }
