...
public final class DialogFragmentNavigator extends q<a> {
    ...
    public void c(Bundle bundle) {
        ...
        for (int i2 = 0; i2 < this.c; i2++) {
            f0 f0Var = this.b;
            k kVar = (k) f0Var.J("androidx-nav-fragment:navigator:dialog:" + i2);
            if (kVar != null) {
                kVar.P.a(this.f189d);
            } else {
