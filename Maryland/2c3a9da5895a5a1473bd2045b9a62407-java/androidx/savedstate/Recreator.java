            ...
            if (a2 != null) {
                ...
                if (stringArrayList != null) {
                    ...
                    while (it.hasNext()) {
                        ...
                        try {
                            try {
                                Constructor<? extends U> declaredConstructor = Class.forName(next, false, Recreator.class.getClassLoader()).asSubclass(a.AbstractC0058a.class).getDeclaredConstructor(new Class[0]);
                                declaredConstructor.setAccessible(true);
                                try {
                                    ((a.AbstractC0058a) declaredConstructor.newInstance(new Object[0])).a(this.a);
                                } catch (Exception e2) {
