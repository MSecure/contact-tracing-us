...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public class a extends h.a {
        ...
        public void b(e.v.a.b bVar) {
            ...
            List<g.b> list = workDatabase_Impl.f1889h;
            if (list != null) {
                int size = list.size();
                for (int i3 = 0; i3 < size; i3++) {
                    Objects.requireNonNull(WorkDatabase_Impl.this.f1889h.get(i3));
                }
            }
        }
        ...
        public void d(e.v.a.b bVar) {
            ...
            List<g.b> list = WorkDatabase_Impl.this.f1889h;
            if (list != null) {
                int size = list.size();
                for (int i3 = 0; i3 < size; i3++) {
                    WorkDatabase_Impl.this.f1889h.get(i3).a(bVar);
                }
            }
        }
