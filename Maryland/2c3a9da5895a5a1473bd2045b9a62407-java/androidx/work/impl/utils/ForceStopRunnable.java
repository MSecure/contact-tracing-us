...
public class ForceStopRunnable implements Runnable {
    ...
    public static final String f325e = l.e("ForceStopRunnable");

    /* renamed from: f  reason: collision with root package name */
    public static final long f326f = TimeUnit.DAYS.toMillis(3650);
    ...
    public static void c(Context context) {
        ...
        long currentTimeMillis = System.currentTimeMillis() + f326f;
    ...
    public void a() {
                ...
                while (true) {
                    if (it.hasNext()) {
                        if (!hashSet.contains((String) it.next())) {
                            l.c().a(b.f1100f, "Reconciling jobs", new Throwable[0]);
                            z = true;
                            break;
                        }
                    } else {
        ...
        try {
            ...
            workDatabase2.l();
            boolean z4 = z3 || z;
            Long a = ((f) this.c.f1051g.a.n()).a("reschedule_needed");
            if (a != null && a.longValue() == 1) {
                l.c().a(f325e, "Rescheduling Workers.", new Throwable[0]);
                this.c.f();
                g gVar = this.c.f1051g;
                ...
                if (z2) {
                    l.c().a(f325e, "Application was force-stopped, rescheduling.", new Throwable[0]);
                    this.c.f();
                } else if (z4) {
                    l.c().a(f325e, "Found unfinished work, scheduling it.", new Throwable[0]);
                    e.c0.x.l lVar2 = this.c;
                    e.c0.x.f.a(lVar2.b, lVar2.c, lVar2.f1049e);
                }
            }
            e.c0.x.l lVar3 = this.c;
            Objects.requireNonNull(lVar3);
            synchronized (e.c0.x.l.n) {
                lVar3.f1052h = true;
                BroadcastReceiver.PendingResult pendingResult = lVar3.f1053i;
    ...
    public void run() {
        ...
        if (z) {
            while (true) {
                ...
                l.c().a(f325e, "Performing cleanup operations.", new Throwable[0]);
                try {
                    a();
                    return;
                    ...
                    this.f327d = i3;
                    if (i3 >= 3) {
                        l.c().b(f325e, "The file system on the device is in a bad state. WorkManager cannot access the app's internal data store.", e2);
                        IllegalStateException illegalStateException = new IllegalStateException("The file system on the device is in a bad state. WorkManager cannot access the app's internal data store.", e2);
                        Objects.requireNonNull(this.c.b);
                        throw illegalStateException;
                    }
                    l.c().a(f325e, String.format("Retrying after %s", Long.valueOf(((long) i3) * 300)), e2);
                    try {
                        Thread.sleep(((long) this.f327d) * 300);
