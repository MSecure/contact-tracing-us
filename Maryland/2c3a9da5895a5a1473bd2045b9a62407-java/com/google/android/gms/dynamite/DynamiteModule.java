...
public final class DynamiteModule {
    ...
    public static g f436d = null;

    /* renamed from: e  reason: collision with root package name */
    public static String f437e = null;

    /* renamed from: f  reason: collision with root package name */
    public static int f438f = -1;

    /* renamed from: g  reason: collision with root package name */
    public static final ThreadLocal<c> f439g = new ThreadLocal<>();

    /* renamed from: h  reason: collision with root package name */
    public static final b.AbstractC0004b f440h = new f.b.a.c.d.a();
    @RecentlyNonNull

    /* renamed from: i  reason: collision with root package name */
    public static final b f441i = new f.b.a.c.d.b();
    ...
    public static DynamiteModule a(@RecentlyNonNull Context context, @RecentlyNonNull b bVar, @RecentlyNonNull String str) {
        Cursor cursor;
        ThreadLocal<c> threadLocal = f439g;
        c cVar = threadLocal.get();
        c cVar2 = new c(null);
        threadLocal.set(cVar2);
        try {
            b.a a2 = bVar.a(context, str, f440h);
            int i2 = a2.a;
            int i3 = a2.b;
            ...
            if (bool == null) {
                ...
                if (d2 != null) {
                    ...
                    if (a2 >= 3) {
                        ...
                        aVar = d2.u(new f.b.a.c.c.b(context), str, i2);
                    } else {
    ...
    public static int g(Context context, String str, boolean z) {
        ...
        try {
            ...
            if (a2 >= 3) {
                try {
                    Cursor cursor2 = (Cursor) f.b.a.c.c.b.E(d2.l(new f.b.a.c.c.b(context), str, z));
                    if (cursor2 != null) {
                        try {
                ...
                return d2.o(new f.b.a.c.c.b(context), str, z);
            }
    ...
    public static DynamiteModule h(Context context, String str, int i2) {
        ...
        if (gVar != null) {
            ...
            synchronized (DynamiteModule.class) {
                valueOf = Boolean.valueOf(f438f >= 2);
            }
            if (valueOf.booleanValue()) {
                aVar = gVar.n(new f.b.a.c.c.b(applicationContext), str, i2, new f.b.a.c.c.b(cursor));
            } else {
            ...
            if (query != null) {
                try {
                    if (query.moveToFirst()) {
                        ...
                        if (i2 > 0) {
                            synchronized (DynamiteModule.class) {
                                f437e = query.getString(2);
                                int columnIndex = query.getColumnIndex("loaderVersion");
                                if (columnIndex >= 0) {
                                    f438f = query.getInt(columnIndex);
                                }
                            }
                        }
                        cursor2 = query;
