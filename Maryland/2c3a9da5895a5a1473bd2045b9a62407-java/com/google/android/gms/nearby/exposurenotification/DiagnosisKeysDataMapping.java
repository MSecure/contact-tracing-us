...
public class DiagnosisKeysDataMapping extends a implements ReflectedParcelable {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof DiagnosisKeysDataMapping) {
            ...
            return this.b.equals(diagnosisKeysDataMapping.b) && this.c == diagnosisKeysDataMapping.c && this.f451d == diagnosisKeysDataMapping.f451d;
        }
    }

    public int hashCode() {
        return Arrays.hashCode(new Object[]{this.b, Integer.valueOf(this.c), Integer.valueOf(this.f451d)});
    }
    ...
    public String toString() {
        ...
        objArr[2] = Integer.valueOf(this.f451d);
