...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.b {
    ...
    public WeakReference<View> f464l;
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends e<T> {
        ...
        public static class a extends e.k.a.a {
            ...
            public a(Parcel parcel, ClassLoader classLoader) {
                ...
                this.f469e = parcel.readFloat();
                this.f470f = parcel.readByte() != 0;
            }
            ...
            public void writeToParcel(Parcel parcel, int i2) {
                ...
                parcel.writeFloat(this.f469e);
                parcel.writeByte(this.f470f ? (byte) 1 : 0);
            }
        }
            ...
            if (i3 == 0 || E < i3 || E > i4) {
                ...
                if (E != s) {
                    if (appBarLayout.f458f) {
                        ...
                        int i10 = E - s;
                        this.f465j = s - i5;
                        if (!D && appBarLayout.f458f && (orDefault = coordinatorLayout.c.b.getOrDefault(appBarLayout, null)) != null && !orDefault.isEmpty()) {
        ...
        public final void I(CoordinatorLayout coordinatorLayout, T t, int i2, float f2) {
            ...
            int E = E();
            if (E == i2) {
                ValueAnimator valueAnimator = this.f467l;
            ...
            ValueAnimator valueAnimator2 = this.f467l;
            if (valueAnimator2 == null) {
                ValueAnimator valueAnimator3 = new ValueAnimator();
                this.f467l = valueAnimator3;
                valueAnimator3.setInterpolator(f.b.a.d.a.a.f2654e);
                this.f467l.addUpdateListener(new b(this, coordinatorLayout, t));
            } else {
                valueAnimator2.cancel();
            }
            this.f467l.setDuration((long) Math.min(round, 600));
            this.f467l.setIntValues(E, i2);
            this.f467l.start();
        }
        ...
        public boolean N(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, View view, int i2, int i3) {
            ...
            if ((i2 & 2) != 0) {
                ...
                if (z && (valueAnimator = this.f467l) != null) {
        ...
        public final void P(CoordinatorLayout coordinatorLayout, T t) {
            b.a aVar = b.a.f1499f;
            e.i.i.m.o(aVar.a(), coordinatorLayout);
            e.i.i.m.k(coordinatorLayout, 0);
            b.a aVar2 = b.a.f1500g;
            e.i.i.m.o(aVar2.a(), coordinatorLayout);
            e.i.i.m.k(coordinatorLayout, 0);
            ...
            if (K != null && t.getTotalScrollRange() != 0 && (((CoordinatorLayout.f) K.getLayoutParams()).a instanceof ScrollingViewBehavior)) {
                if (E() != (-t.getTotalScrollRange()) && K.canScrollVertically(1)) {
                    e.i.i.m.p(coordinatorLayout, aVar, null, new d(this, t, false));
                }
                if (E() == 0) {
                    return;
                }
                if (K.canScrollVertically(-1)) {
                    ...
                    if (i2 != 0) {
                        e.i.i.m.p(coordinatorLayout, aVar2, null, new c(this, coordinatorLayout, t, K, i2));
                        return;
                    }
                    return;
                }
                e.i.i.m.p(coordinatorLayout, aVar2, null, new d(this, t, true));
            }
        }
                            ...
                            if (c) {
                                ...
                                while (true) {
                                    ...
                                    if (!(cVar instanceof ScrollingViewBehavior)) {
                                        i6++;
                                    } else if (((ScrollingViewBehavior) cVar).f2668f != 0) {
                                        z3 = true;
                                    }
                                }
                                if (!z3) {
        ...
        public Parcelable v(CoordinatorLayout coordinatorLayout, View view) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (childAt.getTop() + B <= 0 && bottom >= 0) {
                    ...
                    aVar.f470f = z;
                    aVar.f469e = ((float) bottom) / ((float) childAt.getHeight());
                    return aVar;
                }
            }
    ...
    public static class ScrollingViewBehavior extends f.b.a.d.b.f {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            ...
            this.f2668f = obtainStyledAttributes.getDimensionPixelSize(R$styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0);
        ...
        public boolean g(CoordinatorLayout coordinatorLayout, View view, View view2) {
            ...
            if (cVar instanceof BaseBehavior) {
                e.i.i.m.m(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) cVar).f465j) + this.f2667e) - E(view2));
            }
        ...
        public void h(CoordinatorLayout coordinatorLayout, View view, View view2) {
            if (view2 instanceof AppBarLayout) {
                e.i.i.m.o(b.a.f1499f.a(), coordinatorLayout);
                e.i.i.m.k(coordinatorLayout, 0);
                e.i.i.m.o(b.a.f1500g.a(), coordinatorLayout);
                e.i.i.m.k(coordinatorLayout, 0);
            }
        }
    ...
    public boolean c(boolean z) {
        ...
        if (this.f462j && (getBackground() instanceof g)) {
    ...
    public boolean d(View view) {
        int i2;
        View view2 = null;
        if (this.f464l == null && (i2 = this.f463k) != -1) {
            View findViewById = view != null ? view.findViewById(i2) : null;
            if (findViewById == null && (getParent() instanceof ViewGroup)) {
                findViewById = ((ViewGroup) getParent()).findViewById(this.f463k);
            }
            if (findViewById != null) {
                this.f464l = new WeakReference<>(findViewById);
            }
        }
        WeakReference<View> weakReference = this.f464l;
    ...
    public void onAttachedToWindow() {
        ...
        if (background instanceof g) {
            f.b.a.c.b.o.b.N1(this, (g) background);
        }
    }
    ...
    public int[] onCreateDrawableState(int i2) {
        ...
        iArr[0] = i3;
        iArr[1] = (!z || !this.f461i) ? -R$attr.state_lifted : R$attr.state_lifted;
        int i4 = R$attr.state_collapsible;
        if (!z) {
            i4 = -i4;
        }
        iArr[2] = i4;
        iArr[3] = (!z || !this.f461i) ? -R$attr.state_collapsed : R$attr.state_collapsed;
