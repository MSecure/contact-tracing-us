...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.b {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        public final Rect f478e = new Rect();

        /* renamed from: f  reason: collision with root package name */
        public WeakReference<BottomAppBar> f479f;

        /* renamed from: g  reason: collision with root package name */
        public int f480g;

        /* renamed from: h  reason: collision with root package name */
        public final View.OnLayoutChangeListener f481h = new a();
        ...
        public class a implements View.OnLayoutChangeListener {
            ...
            public void onLayoutChange(View view, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
                if (Behavior.this.f479f.get() == null || !(view instanceof FloatingActionButton)) {
                    view.removeOnLayoutChangeListener(this);
                    return;
                }
                FloatingActionButton floatingActionButton = (FloatingActionButton) view;
                Behavior.this.f478e.set(0, 0, floatingActionButton.getMeasuredWidth(), floatingActionButton.getMeasuredHeight());
                throw null;
            }
        }
        ...
        public boolean k(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i2) {
            ...
            this.f479f = new WeakReference<>(bottomAppBar2);
            ...
            if (z != null) {
                ...
                if (!z.isLaidOut()) {
                    ...
                    fVar.f139d = 49;
                    this.f480g = ((ViewGroup.MarginLayoutParams) fVar).bottomMargin;
                    if (z instanceof FloatingActionButton) {
                        FloatingActionButton floatingActionButton = (FloatingActionButton) z;
                        floatingActionButton.addOnLayoutChangeListener(this.f481h);
    ...
    public static class a extends e.k.a.a {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeInt(this.f483e ? 1 : 0);
        }
    }
    ...
    private float getFabTranslationY() {
        return -getTopEdgeTreatment().f2694d;
    }
    ...
    public int A(ActionMenuView actionMenuView, int i2, boolean z) {
        ...
        boolean h1 = b.h1(this);
        int measuredWidth = h1 ? getMeasuredWidth() : 0;
        for (int i3 = 0; i3 < getChildCount(); i3++) {
            View childAt = getChildAt(i3);
            if ((childAt.getLayoutParams() instanceof Toolbar.e) && (((Toolbar.e) childAt.getLayoutParams()).a & 8388615) == 8388611) {
                measuredWidth = h1 ? Math.min(measuredWidth, childAt.getLeft()) : Math.max(measuredWidth, childAt.getRight());
            }
        }
        return measuredWidth - ((h1 ? actionMenuView.getRight() : actionMenuView.getLeft()) + 0);
    }
    ...
    public final void D() {
        getTopEdgeTreatment().f2695e = getFabTranslationX();
        z();
        if (this.a0) {
            C();
        }
    ...
    public void setFabAlignmentMode(int i2) {
        ...
        if (this.S != i2 && isLaidOut()) {
            ...
            this.Q = animatorSet3;
            animatorSet3.addListener(new f.b.a.d.e.a(this));
            this.Q.start();
        }
        this.S = i2;
    }
    ...
    public void x(int i2) {
        ...
        if (y != null && !y.j()) {
            this.V++;
            y.i(new f.b.a.d.e.b(this, i2), true);
        }
    }
