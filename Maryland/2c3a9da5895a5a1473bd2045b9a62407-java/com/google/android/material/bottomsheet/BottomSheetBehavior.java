...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    public static class d extends e.k.a.a {
        ...
        public d(Parcel parcel, ClassLoader classLoader) {
            ...
            boolean z = false;
            this.f496f = parcel.readInt() == 1;
            this.f497g = parcel.readInt() == 1;
            this.f498h = parcel.readInt() == 1 ? true : z;
        }

        public d(Parcelable parcelable, BottomSheetBehavior<?> bottomSheetBehavior) {
            super(parcelable);
            this.f494d = bottomSheetBehavior.y;
            this.f495e = bottomSheetBehavior.f484d;
            this.f496f = bottomSheetBehavior.b;
            this.f497g = bottomSheetBehavior.v;
            this.f498h = bottomSheetBehavior.w;
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeInt(this.f497g ? 1 : 0);
    ...
    public class e implements Runnable {
        ...
        public void run() {
            ...
            if (eVar == null || !eVar.i(true)) {
                BottomSheetBehavior.this.K(this.f499d);
            } else {
                View view = this.b;
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        int i2;
        int i3;
        this.f487g = context.getResources().getDimensionPixelSize(R$dimen.mtrl_min_touch_target_size);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.BottomSheetBehavior_Layout);
        this.f488h = obtainStyledAttributes.hasValue(R$styleable.BottomSheetBehavior_Layout_shapeAppearance);
        ...
        this.f491k = obtainStyledAttributes.getBoolean(R$styleable.BottomSheetBehavior_Layout_gestureInsetBottomIgnored, false);
    ...
    public final int C() {
        int i2;
        return this.f485e ? Math.min(Math.max(this.f486f, this.F - ((this.E * 9) / 16)), this.D) : (this.f491k || (i2 = this.f490j) <= 0) ? this.f484d : Math.max(this.f484d, i2 + this.f487g);
    }

    public final void D(Context context, AttributeSet attributeSet, boolean z2, ColorStateList colorStateList) {
        if (this.f488h) {
            this.f492l = j.b(context, attributeSet, R$attr.bottomSheetStyle, Q).a();
            g gVar = new g(this.f492l);
            this.f489i = gVar;
            ...
            if (!z2 || colorStateList == null) {
                ...
                this.f489i.setTint(typedValue.data);
                return;
            }
            this.f489i.q(colorStateList);
        }
    }
    ...
    public final void H(V v2, b.a aVar, int i2) {
        e.i.i.m.p(v2, aVar, null, new f.b.a.d.f.c(this, i2));
    }
    ...
    public void I(int i2) {
        ...
        } else if (this.f485e || this.f484d != i2) {
            this.f485e = false;
            this.f484d = Math.max(0, i2);
            if (z2) {
            }
        }
        z2 = false;
    ...
    public final void Q(int i2) {
        ...
        if (i2 != 2) {
            ...
            if (this.m != z2) {
                this.m = z2;
                if (this.f489i != null && (valueAnimator = this.o) != null) {
    ...
    public boolean k(CoordinatorLayout coordinatorLayout, V v2, int i2) {
        ...
        if (this.G == null) {
            this.f486f = coordinatorLayout.getResources().getDimensionPixelSize(R$dimen.design_bottom_sheet_peek_height_min);
            if (Build.VERSION.SDK_INT >= 29 && !this.f491k && !this.f485e) {
                e.i.i.m.s(v2, new f.b.a.d.q.m(new f.b.a.d.f.b(this), new p(v2.getPaddingStart(), v2.getPaddingTop(), v2.getPaddingEnd(), v2.getPaddingBottom())));
                if (v2.isAttachedToWindow()) {
            ...
            if (this.f488h && (gVar = this.f489i) != null) {
