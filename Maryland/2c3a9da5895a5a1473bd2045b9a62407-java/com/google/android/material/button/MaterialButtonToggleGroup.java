...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public static final String f511l = MaterialButtonToggleGroup.class.getSimpleName();
    public static final int m = R$style.Widget_MaterialComponents_MaterialButtonToggleGroup;
    public final List<d> b = new ArrayList();
    public final c c = new c(null);

    /* renamed from: d  reason: collision with root package name */
    public final f f512d = new f(null);

    /* renamed from: e  reason: collision with root package name */
    public final LinkedHashSet<e> f513e = new LinkedHashSet<>();

    /* renamed from: f  reason: collision with root package name */
    public final Comparator<MaterialButton> f514f = new a();

    /* renamed from: g  reason: collision with root package name */
    public Integer[] f515g;

    /* renamed from: h  reason: collision with root package name */
    public boolean f516h = false;
    ...
    public class b extends e.i.i.a {
        ...
        public void d(View view, e.i.i.x.b bVar) {
            ...
            String str = MaterialButtonToggleGroup.f511l;
    ...
    public class c implements MaterialButton.a {
        ...
        public void a(MaterialButton materialButton, boolean z) {
            MaterialButtonToggleGroup materialButtonToggleGroup = MaterialButtonToggleGroup.this;
            if (!materialButtonToggleGroup.f516h) {
                if (materialButtonToggleGroup.f517i) {
                    materialButtonToggleGroup.f519k = z ? materialButton.getId() : -1;
                }
    ...
    public static class d {
        ...
        /* renamed from: e  reason: collision with root package name */
        public static final f.b.a.d.v.c f521e = new f.b.a.d.v.a(0.0f);
        public f.b.a.d.v.c a;
        public f.b.a.d.v.c b;
        public f.b.a.d.v.c c;

        /* renamed from: d  reason: collision with root package name */
        public f.b.a.d.v.c f522d;
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        ...
        this.f519k = d2.getResourceId(R$styleable.MaterialButtonToggleGroup_checkedButton, -1);
        this.f518j = d2.getBoolean(R$styleable.MaterialButtonToggleGroup_selectionRequired, false);
    ...
    private void setupButtonChild(MaterialButton materialButton) {
        ...
        materialButton.f502e.add(this.c);
        materialButton.setOnPressedChangeListenerInternal(this.f512d);
    ...
    public void addView(View view, int i2, ViewGroup.LayoutParams layoutParams) {
        if (!(view instanceof MaterialButton)) {
            Log.e(f511l, "Child views must be of type MaterialButton.");
            return;
        }
        ...
        this.b.add(new d(shapeAppearanceModel.f2884e, shapeAppearanceModel.f2887h, shapeAppearanceModel.f2885f, shapeAppearanceModel.f2886g));
        m.r(materialButton, new b());
    }

    public final void b(int i2, boolean z) {
        Iterator<e> it = this.f513e.iterator();
        while (it.hasNext()) {
            it.next().a(this, i2, z);
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        TreeMap treeMap = new TreeMap(this.f514f);
        int childCount = getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
            treeMap.put(c(i2), Integer.valueOf(i2));
        }
        this.f515g = (Integer[]) treeMap.values().toArray(new Integer[0]);
    ...
    public final boolean f(int i2, boolean z) {
        ...
        if (!this.f518j || !checkedButtonIds.isEmpty()) {
            if (z && this.f517i) {
            ...
            if (c2.getVisibility() != 8) {
                ...
                if (firstVisibleChildIndex != lastVisibleChildIndex) {
                    ...
                    if (i2 == firstVisibleChildIndex) {
                        ...
                        } else if (f.b.a.c.b.o.b.h1(this)) {
                            dVar = new d(cVar, cVar, dVar2.b, dVar2.c);
                        } else {
                            dVar = new d(dVar2.a, dVar2.f522d, cVar, cVar);
                        }
                    } else if (i2 != lastVisibleChildIndex) {
                        dVar2 = null;
                    } else if (!z) {
                        dVar = new d(cVar, dVar2.f522d, cVar, dVar2.c);
                    } else if (f.b.a.c.b.o.b.h1(this)) {
                        dVar = new d(dVar2.a, dVar2.f522d, cVar, cVar);
                    } else {
                        dVar = new d(cVar, cVar, dVar2.b, dVar2.c);
    ...
    public int getChildDrawingOrder(int i2, int i3) {
        Integer[] numArr = this.f515g;
        if (numArr != null && i3 < numArr.length) {
            return numArr[i3].intValue();
        }
        Log.w(f511l, "Child order wasn't updated");
        return i3;
    }
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) b.C0039b.a(1, getVisibleButtonCount(), false, this.f517i ? 1 : 2).a);
    }
    ...
    public void onViewRemoved(View view) {
        ...
        if (view instanceof MaterialButton) {
            MaterialButton materialButton = (MaterialButton) view;
            materialButton.f502e.remove(this.c);
