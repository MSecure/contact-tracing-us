...
public class Chip extends g implements b.a, n {
    ...
    public f.b.a.d.j.b f525e;

    /* renamed from: f  reason: collision with root package name */
    public InsetDrawable f526f;

    /* renamed from: g  reason: collision with root package name */
    public RippleDrawable f527g;

    /* renamed from: h  reason: collision with root package name */
    public View.OnClickListener f528h;

    /* renamed from: i  reason: collision with root package name */
    public CompoundButton.OnCheckedChangeListener f529i;
    ...
    public class b extends e.k.b.a {
        ...
        public void o(List<Integer> list) {
            ...
            if (chip.e()) {
                ...
                f.b.a.d.j.b bVar = chip2.f525e;
                if (bVar != null && bVar.M) {
                    z = true;
                }
                if (z && chip2.f528h != null) {
                    list.add(1);
                }
            }
        }
        ...
        public boolean r(int i2, int i3, Bundle bundle) {
            ...
            if (i3 == 16) {
                ...
                if (i2 == 1) {
                    ...
                    View.OnClickListener onClickListener = chip.f528h;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        ...
        bVar2.f2846k = d2.getDimension(R$styleable.Chip_android_textSize, bVar2.f2846k);
        ...
        if (i9 == 1) {
            ...
            bVar.T(f.b.a.c.b.o.b.P0(bVar.g0, d2, R$styleable.Chip_chipIcon));
            ...
            bVar.b0(f.b.a.c.b.o.b.P0(bVar.g0, d2, R$styleable.Chip_closeIcon));
            ...
            bVar.N(f.b.a.c.b.o.b.P0(bVar.g0, d2, R$styleable.Chip_checkedIcon));
    ...
    private RectF getCloseIconTouchBounds() {
        this.s.setEmpty();
        if (e() && this.f528h != null) {
            f.b.a.d.j.b bVar = this.f525e;
    ...
    public boolean d(int i2) {
        ...
        int max = Math.max(0, i2 - ((int) this.f525e.B));
        int max2 = Math.max(0, i2 - this.f525e.getIntrinsicWidth());
        if (max2 > 0 || max > 0) {
            int i3 = max2 > 0 ? max2 / 2 : 0;
            int i4 = max > 0 ? max / 2 : 0;
            if (this.f526f != null) {
                Rect rect = new Rect();
                this.f526f.getPadding(rect);
                if (rect.top == i4) {
                    if (rect.bottom == i4) {
                        if (rect.left == i3) {
                        }
            ...
            this.f526f = new InsetDrawable((Drawable) this.f525e, i3, i4, i3, i4);
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        if (!z || this.q.f1544l == Integer.MIN_VALUE) {
    ...
    public Drawable getBackgroundDrawable() {
        InsetDrawable insetDrawable = this.f526f;
        return insetDrawable == null ? this.f525e : insetDrawable;
    }
    ...
    public void getFocusedRect(Rect rect) {
        b bVar = this.q;
        if (bVar.f1544l == 1 || bVar.f1543k == 1) {
    ...
    public final void h() {
        ...
        if (e()) {
            f.b.a.d.j.b bVar2 = this.f525e;
            if ((bVar2 != null && bVar2.M) && this.f528h != null) {
                bVar = this.q;
                e.i.i.m.r(this, bVar);
            }
        }
    ...
    public final void i() {
        this.f527g = new RippleDrawable(f.b.a.d.t.a.b(this.f525e.F), getBackgroundDrawable(), null);
        this.f525e.o0(false);
        RippleDrawable rippleDrawable = this.f527g;
    ...
    public final void j() {
        f.b.a.d.j.b bVar;
        if (!TextUtils.isEmpty(getText()) && (bVar = this.f525e) != null) {
    ...
    public void onAttachedToWindow() {
        ...
        f.b.a.c.b.o.b.N1(this, this.f525e);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                ...
                playSoundEffect(0);
                View.OnClickListener onClickListener = this.f528h;
                if (onClickListener != null) {
    ...
    public void setBackground(Drawable drawable) {
        if (drawable == getBackgroundDrawable() || drawable == this.f527g) {
    ...
    public void setChecked(boolean z) {
        ...
        if (bVar == null) {
            ...
            super.setChecked(z);
            if (isChecked != z && (onCheckedChangeListener = this.f529i) != null) {
    ...
    public void setOnCheckedChangeListenerInternal(CompoundButton.OnCheckedChangeListener onCheckedChangeListener) {
        this.f529i = onCheckedChangeListener;
    }

    public void setOnCloseIconClickListener(View.OnClickListener onClickListener) {
        this.f528h = onClickListener;
        h();
    }
