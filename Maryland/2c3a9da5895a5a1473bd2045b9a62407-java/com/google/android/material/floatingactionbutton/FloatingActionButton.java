...
public class FloatingActionButton extends q implements f.b.a.d.o.a, n, CoordinatorLayout.b {
    ...
    public PorterDuff.Mode f540d;

    /* renamed from: e  reason: collision with root package name */
    public ColorStateList f541e;

    /* renamed from: f  reason: collision with root package name */
    public PorterDuff.Mode f542f;

    /* renamed from: g  reason: collision with root package name */
    public ColorStateList f543g;
    ...
    public static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.c<T> {
        ...
        public final boolean C(View view, FloatingActionButton floatingActionButton) {
            ...
            if (this.b && fVar.f141f == view.getId() && floatingActionButton.getUserSetVisibility() == 0) {
                return true;
            }
            return false;
        }
    ...
    public float getCompatHoveredFocusedTranslationZ() {
        return getImpl().f2765e;
    }

    public float getCompatPressedTranslationZ() {
        return getImpl().f2766f;
    }
    ...
    public f.b.a.d.a.g getHideMotionSpec() {
        return getImpl().f2772l;
    }

    @Deprecated
    public int getRippleColor() {
        ColorStateList colorStateList = this.f543g;
    ...
    public void i(a aVar, boolean z) {
        ...
        if (!impl.e()) {
            Animator animator = impl.f2770j;
            if (animator != null) {
                animator.cancel();
            }
            if (impl.q()) {
                f.b.a.d.a.g gVar = impl.f2772l;
                if (gVar == null) {
                    if (impl.f2769i == null) {
                        impl.f2769i = f.b.a.d.a.g.b(impl.s.getContext(), R$animator.design_fab_hide_motion_spec);
                    }
                    gVar = impl.f2769i;
    ...
    public final void l() {
        ...
        if (drawable != null) {
            ColorStateList colorStateList = this.f541e;
            if (colorStateList == null) {
                m.h.t(drawable);
                return;
            }
            int colorForState = colorStateList.getColorForState(getDrawableState(), 0);
            PorterDuff.Mode mode = this.f542f;
            if (mode == null) {
    ...
    public void m(a aVar, boolean z) {
        ...
        if (!impl.f()) {
            ...
            if (impl.q()) {
                ...
                f.b.a.d.a.g gVar = impl.f2771k;
                if (gVar == null) {
                    if (impl.f2768h == null) {
                        impl.f2768h = f.b.a.d.a.g.b(impl.s.getContext(), R$animator.design_fab_show_motion_spec);
                    }
                    gVar = impl.f2768h;
                    Objects.requireNonNull(gVar);
                }
    ...
    public void onMeasure(int i2, int i3) {
        this.f546j = (getSizeDimension() + 0) / 2;
        getImpl().t();
        throw null;
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        Objects.requireNonNull(aVar.f2923d.getOrDefault("expandableWidgetHelper", null));
        throw null;
    }
    ...
    public void setCompatElevation(float f2) {
        ...
        if (impl.f2764d != f2) {
            impl.f2764d = f2;
            impl.j(f2, impl.f2765e, impl.f2766f);
        }
    }
    ...
    public void setCompatHoveredFocusedTranslationZ(float f2) {
        ...
        if (impl.f2765e != f2) {
            impl.f2765e = f2;
            impl.j(impl.f2764d, f2, impl.f2766f);
        }
    }
    ...
    public void setCompatPressedTranslationZ(float f2) {
        ...
        if (impl.f2766f != f2) {
            impl.f2766f = f2;
            impl.j(impl.f2764d, impl.f2765e, f2);
        }
    }
    ...
    public void setRippleColor(ColorStateList colorStateList) {
        if (this.f543g != colorStateList) {
            this.f543g = colorStateList;
            getImpl().o(this.f543g);
        }
    }
    ...
    public void setSupportImageTintList(ColorStateList colorStateList) {
        if (this.f541e != colorStateList) {
            this.f541e = colorStateList;
            l();
        }
    }
