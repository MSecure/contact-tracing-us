...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public final Runnable f561f = new b();
    ...
    public static class Behavior extends SwipeDismissBehavior<View> {
        ...
        /* renamed from: i  reason: collision with root package name */
        public final f f568i = new f(this);

        @Override // com.google.android.material.behavior.SwipeDismissBehavior
        public boolean B(View view) {
            Objects.requireNonNull(this.f568i);
        ...
        public boolean handleMessage(Message message) {
            ...
            if (i2 == 0) {
                ...
                if (baseTransientBottomBar.c.getParent() == null) {
                    ...
                    baseTransientBottomBar.f567l = 0;
    ...
    public class b implements Runnable {
        ...
        public void run() {
            ...
            if (baseTransientBottomBar.c != null && (context = baseTransientBottomBar.b) != null) {
                ...
                if (height < baseTransientBottomBar3.f566k) {
                    ...
                    marginLayoutParams.bottomMargin = (baseTransientBottomBar4.f566k - height) + i3;
    ...
    public class c implements e.i.i.k {
        ...
        public w a(View view, w wVar) {
            BaseTransientBottomBar.this.f563h = wVar.a();
            BaseTransientBottomBar.this.f564i = wVar.b();
            BaseTransientBottomBar.this.f565j = wVar.c();
    ...
    public static class f {
        ...
        public f(SwipeDismissBehavior<?> swipeDismissBehavior) {
            swipeDismissBehavior.f474f = SwipeDismissBehavior.C(0.0f, 0.1f, 1.0f);
            swipeDismissBehavior.f475g = SwipeDismissBehavior.C(0.0f, 0.6f, 1.0f);
            swipeDismissBehavior.f472d = 0;
        }
    }
    ...
    public static class i extends FrameLayout {
        ...
        /* renamed from: i  reason: collision with root package name */
        public static final View.OnTouchListener f570i = new a();
        public h b;
        public g c;
        ...
        /* renamed from: g  reason: collision with root package name */
        public ColorStateList f574g;

        /* renamed from: h  reason: collision with root package name */
        public PorterDuff.Mode f575h;
        ...
        public i(Context context, AttributeSet attributeSet) {
            ...
            this.f571d = obtainStyledAttributes.getInt(R$styleable.SnackbarLayout_animationMode, 0);
            this.f572e = obtainStyledAttributes.getFloat(R$styleable.SnackbarLayout_backgroundOverlayColorAlpha, 1.0f);
            setBackgroundTintList(f.b.a.c.b.o.b.L0(context2, obtainStyledAttributes, R$styleable.SnackbarLayout_backgroundTint));
            setBackgroundTintMode(f.b.a.c.b.o.b.u1(obtainStyledAttributes.getInt(R$styleable.SnackbarLayout_backgroundTintMode, -1), PorterDuff.Mode.SRC_IN));
            this.f573f = obtainStyledAttributes.getFloat(R$styleable.SnackbarLayout_actionTextColorAlpha, 1.0f);
            obtainStyledAttributes.recycle();
            setOnTouchListener(f570i);
            setFocusable(true);
            if (getBackground() == null) {
                ...
                if (this.f574g != null) {
                    drawable = m.h.w1(gradientDrawable);
                    drawable.setTintList(this.f574g);
                } else {
                    drawable = m.h.w1(gradientDrawable);
                }
        ...
        public void onAttachedToWindow() {
            ...
            if (gVar != null) {
                ...
                if (Build.VERSION.SDK_INT >= 29 && (rootWindowInsets = kVar.a.c.getRootWindowInsets()) != null) {
                    kVar.a.f566k = rootWindowInsets.getMandatorySystemGestureInsets().bottom;
                    kVar.a.h();
                }
            }
            AtomicInteger atomicInteger = e.i.i.m.a;
        ...
        public void setBackgroundDrawable(Drawable drawable) {
            if (!(drawable == null || this.f574g == null)) {
                drawable = m.h.w1(drawable.mutate());
                drawable.setTintList(this.f574g);
                drawable.setTintMode(this.f575h);
            }
            super.setBackgroundDrawable(drawable);
        }

        public void setBackgroundTintList(ColorStateList colorStateList) {
            this.f574g = colorStateList;
            if (getBackground() != null) {
                Drawable w1 = m.h.w1(getBackground().mutate());
                w1.setTintList(colorStateList);
                w1.setTintMode(this.f575h);
                if (w1 != getBackground()) {
                    super.setBackgroundDrawable(w1);
                }
            }
        }
        ...
        public void setOnClickListener(View.OnClickListener onClickListener) {
            setOnTouchListener(onClickListener != null ? null : f570i);
    ...
    public BaseTransientBottomBar(Context context, ViewGroup viewGroup, View view, n nVar) {
        if (viewGroup == null) {
            ...
            if (layoutParams instanceof ViewGroup.MarginLayoutParams) {
                ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
                this.f562g = new Rect(marginLayoutParams.leftMargin, marginLayoutParams.topMargin, marginLayoutParams.rightMargin, marginLayoutParams.bottomMargin);
            }
            AtomicInteger atomicInteger = e.i.i.m.a;
            iVar.setAccessibilityLiveRegion(1);
            iVar.setImportantForAccessibility(1);
            iVar.setFitsSystemWindows(true);
            e.i.i.m.s(iVar, new c());
            e.i.i.m.r(iVar, new d());
    ...
    public final void h() {
        Rect rect;
        ViewGroup.LayoutParams layoutParams = this.c.getLayoutParams();
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams) || (rect = this.f562g) == null) {
            Log.w(q, "Unable to update margins because layout params are not MarginLayoutParams");
            return;
        }
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
        marginLayoutParams.bottomMargin = rect.bottom + this.f563h;
        marginLayoutParams.leftMargin = rect.left + this.f564i;
        marginLayoutParams.rightMargin = rect.right + this.f565j;
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (z) {
                this.c.removeCallbacks(this.f561f);
                this.c.post(this.f561f);
            }
        }
    }
}
