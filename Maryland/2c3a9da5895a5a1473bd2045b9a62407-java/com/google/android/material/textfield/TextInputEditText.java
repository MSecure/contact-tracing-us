...
public class TextInputEditText extends k {
    ...
    public final Rect f604e = new Rect();
    ...
    public void getFocusedRect(Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && this.f605f && rect != null) {
            textInputLayout.getFocusedRect(this.f604e);
            rect.bottom = this.f604e.bottom;
        }
    }
    ...
    public boolean getGlobalVisibleRect(Rect rect, Point point) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (!(textInputLayout == null || !this.f605f || rect == null)) {
            textInputLayout.getGlobalVisibleRect(this.f604e, point);
            rect.bottom = this.f604e.bottom;
        }
    ...
    public boolean requestRectangleOnScreen(Rect rect) {
        ...
        TextInputLayout textInputLayout = getTextInputLayout();
        if (textInputLayout != null && this.f605f) {
            this.f604e.set(0, textInputLayout.getHeight() - getResources().getDimensionPixelOffset(R$dimen.mtrl_edittext_rectangle_top_offset), textInputLayout.getWidth(), textInputLayout.getHeight());
            textInputLayout.requestRectangleOnScreen(this.f604e, true);
        }
