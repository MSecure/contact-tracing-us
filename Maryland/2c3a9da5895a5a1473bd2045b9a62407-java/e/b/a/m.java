...
public class m extends l implements g.a, LayoutInflater.Factory2 {
    ...
    public class c implements a.AbstractC0017a {
        ...
        public void d(e.b.e.a aVar) {
            ...
            m mVar = m.this;
            if (mVar.q != null) {
                mVar.f660f.getDecorView().removeCallbacks(m.this.r);
            }
            m mVar2 = m.this;
            if (mVar2.p != null) {
                mVar2.J();
    ...
    public abstract class f {
        ...
        public void a() {
            ...
            if (broadcastReceiver != null) {
                try {
                    m.this.f659e.unregisterReceiver(broadcastReceiver);
        ...
        public void e() {
            ...
            if (b2 != null && b2.countActions() != 0) {
                ...
                m.this.f659e.registerReceiver(this.a, b2);
            }
        }
    }
    ...
    public static class h {
        ...
        /* renamed from: e  reason: collision with root package name */
        public static Field f670e;

        /* renamed from: f  reason: collision with root package name */
        public static boolean f671f;

        /* renamed from: g  reason: collision with root package name */
        public static Field f672g;

        /* renamed from: h  reason: collision with root package name */
        public static boolean f673h;

        /* renamed from: i  reason: collision with root package name */
        public static Method f674i;

        /* renamed from: j  reason: collision with root package name */
        public static boolean f675j;

        /* renamed from: k  reason: collision with root package name */
        public static Method f676k;

        /* renamed from: l  reason: collision with root package name */
        public static boolean f677l;
        ...
        public static <X, Y> LiveData<Y> A0(LiveData<X> liveData, e.c.a.c.a<X, Y> aVar) {
            o oVar = new o();
            oVar.m(liveData, new x(oVar, aVar));
            return oVar;
        }
        ...
        public static void K0(e.z.a aVar, f.b.a.a.a.y.c0 c0Var, String str, boolean z) {
            int i2;
            int ordinal;
            int i3;
            View a2 = aVar.a();
            ...
            if (c0Var.l() != null) {
                ...
                if (ordinal2 == 1) {
                    i2 = R.string.share_review_status_likely;
                } else if (ordinal2 == 2) {
                    i2 = R.string.share_review_status_negative;
                }
                textView.setText(i2);
                if (!z) {
                    ...
                    if (c0Var.m() != null) {
                        int ordinal3 = c0Var.m().ordinal();
                        if (ordinal3 == 1) {
                            i3 = R.string.share_review_travel_confirmed;
                        } else if (ordinal3 == 2) {
                            i3 = R.string.share_review_travel_no_travel;
                        }
                        textView3.setText(i3);
                    }
                    textView3.setText(R.string.share_review_travel_no_answer);
                }
                ordinal = c0Var.d().ordinal();
                if (ordinal == 1) {
        ...
        public static f.b.a.b.f<f.b.a.a.a.u.e> M0(f.b.a.a.a.o.t tVar, Context context) {
            f.b.a.b.f<f.b.a.a.a.u.e> a2;
            synchronized (tVar) {
                f.b.a.b.i.m.b(context);
                a2 = ((f.b.a.b.i.j) f.b.a.b.i.m.a().c(f.b.a.b.h.a.f2381g)).a("1537", f.b.a.a.a.u.e.class, new f.b.a.b.b("proto"), f.b.a.a.a.o.o.a);
            }
            return a2;
        }
        ...
        public static f.b.a.a.a.q.g N0(f.b.a.a.a.q.e eVar) {
            Objects.requireNonNull(eVar);
            f.a.b.o oVar = new f.a.b.o(new f.a.b.w.h(), new f.a.b.w.b(new f.a.b.w.e()));
            f.a.b.c cVar = oVar.f2071i;
            if (cVar != null) {
                cVar.f2045f = true;
                cVar.interrupt();
            }
            f.a.b.i[] iVarArr = oVar.f2070h;
            ...
            f.a.b.c cVar2 = new f.a.b.c(oVar.c, oVar.f2066d, oVar.f2067e, oVar.f2069g);
            oVar.f2071i = cVar2;
            cVar2.start();
            for (int i2 = 0; i2 < oVar.f2070h.length; i2++) {
                f.a.b.i iVar2 = new f.a.b.i(oVar.f2066d, oVar.f2068f, oVar.f2067e, oVar.f2069g);
                oVar.f2070h[i2] = iVar2;
                iVar2.start();
            }
            return new f.b.a.a.a.q.f(oVar);
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:176:0x02d1, code lost:
            if (r3[r17].f1274f.f1272d == r9) goto L_0x02d5;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:72:0x0149, code lost:
            if (r4[r2].f1274f.f1272d == r5) goto L_0x014d;
         */
        ...
        public static void b(e.g.b.h.e eVar, e.g.b.d dVar, ArrayList<e.g.b.h.d> arrayList, int i2) {
            ...
            while (i20 < i4) {
                ...
                if (!bVar2.t) {
                            ...
                            if (aVarArr[i28] == aVar4) {
                                ...
                                if (iArr[i28] == 0 || iArr[i28] == 3 || iArr[i28] == 2) {
                                    ...
                                    if (dVar15.c0 != 8 && aVarArr[i28] == aVar4 && (iArr[i28] == 0 || iArr[i28] == 3)) {
                                        ...
                                        if (bVar2.f1267h == null) {
                                            bVar2.f1267h = new ArrayList<>();
                                        }
                                        bVar2.f1267h.add(dVar15);
                                    }
                                    if (bVar2.f1265f == null) {
                                        bVar2.f1265f = dVar15;
                                    }
                                    e.g.b.h.d dVar17 = bVar2.f1266g;
                                    if (dVar17 != null) {
                                ...
                                cVar9 = dVar15.L[i23 + 1].f1274f;
                                if (cVar9 != null) {
                                    dVar14 = cVar9.f1272d;
                                    e.g.b.h.c[] cVarArr = dVar14.L;
                                    if (cVarArr[i23].f1274f != null) {
                                    }
                                }
                                dVar14 = null;
                                if (dVar14 == null) {
                    ...
                    e.g.b.h.d dVar19 = bVar2.f1263d;
                    if (dVar19 != null) {
                        bVar2.m -= dVar19.L[i23 + 1].d();
                    }
                    bVar2.c = dVar15;
                    if (bVar2.o != 0 || !bVar2.p) {
                        bVar2.f1264e = bVar2.a;
                    } else {
                        bVar2.f1264e = dVar15;
                    }
                ...
                if (arrayList3 == null || arrayList3.contains(bVar2.a)) {
                    ...
                    e.g.b.h.d dVar23 = bVar2.f1263d;
                    e.g.b.h.d dVar24 = bVar2.f1264e;
                    float f3 = bVar2.f1270k;
                    ...
                    if (i2 == 0) {
                        ...
                        if (i30 == 2) {
                            ...
                            while (!z4) {
                                ...
                                e.g.b.h.c cVar11 = cVar10.f1274f;
                                ...
                                e.g.b.h.c cVar12 = cVar10.f1274f;
                                if (cVar12 != null) {
                                    if (dVar25 == dVar22) {
                                        dVar12 = dVar20;
                                        dVar.f(cVar10.f1277i, cVar12.f1277i, d5, 6);
                                    } else {
                                        dVar12 = dVar20;
                                        dVar.f(cVar10.f1277i, cVar12.f1277i, d5, 8);
                                    }
                                    dVar.d(cVar10.f1277i, cVar10.f1274f.f1277i, d5, (!z12 || z3) ? i31 : 5);
                                } else {
                                    dVar12 = dVar20;
                                }
                                if (z10) {
                                    if (dVar25.c0 == 8 || dVar25.O[i2] != aVar4) {
                                        ...
                                        i19 = 0;
                                        dVar.f(cVarArr2[i3 + 1].f1277i, cVarArr2[i3].f1277i, 0, 5);
                                    }
                                    dVar.f(dVar25.L[i3].f1277i, eVar2.L[i3].f1277i, i19, 8);
                                }
                                e.g.b.h.c cVar13 = dVar25.L[i3 + 1].f1274f;
                                if (cVar13 != null) {
                                    dVar13 = cVar13.f1272d;
                                    e.g.b.h.c[] cVarArr3 = dVar13.L;
                                    if (cVarArr3[i3].f1274f != null) {
                                    }
                                }
                                dVar13 = null;
                                if (dVar13 != null) {
                            ...
                            if (dVar23 != null) {
                                int i32 = i3 + 1;
                                if (dVar21.L[i32].f1274f != null) {
                                    e.g.b.h.c cVar14 = dVar23.L[i32];
                                    if ((dVar23.O[i2] == aVar4 && dVar23.n[i2] == 0) && !z3) {
                                        e.g.b.h.c cVar15 = cVar14.f1274f;
                                        if (cVar15.f1272d == eVar2) {
                                            dVar.d(cVar14.f1277i, cVar15.f1277i, -cVar14.d(), 5);
                                            dVar.g(cVar14.f1277i, dVar21.L[i32].f1274f.f1277i, -cVar14.d(), 6);
                                            if (z10) {
                                                int i33 = i3 + 1;
                                                e.g.b.g gVar10 = eVar2.L[i33].f1277i;
                                                e.g.b.h.c[] cVarArr4 = dVar21.L;
                                                dVar.f(gVar10, cVarArr4[i33].f1277i, cVarArr4[i33].d(), 8);
                                            }
                                            ArrayList<e.g.b.h.d> arrayList4 = bVar2.f1267h;
                                            if (arrayList4 != null && (size = arrayList4.size()) > 1) {
                                                float f4 = (bVar2.q || bVar2.s) ? f3 : (float) bVar2.f1269j;
                                                ...
                                                while (i14 < size) {
                                                    ...
                                                    if (f6 < 0.0f) {
                                                        if (bVar2.s) {
                                                            ...
                                                            e.g.b.g gVar11 = cVarArr5[i3 + 1].f1277i;
                                                            gVar8 = cVarArr5[i3].f1277i;
                                                            aVar2 = aVar4;
                                                            gVar7 = gVar11;
                                                            i17 = 0;
                                                            i16 = 4;
                                                    ...
                                                    if (i34 == 0) {
                                                        ...
                                                        e.g.b.g gVar12 = cVarArr6[i3 + 1].f1277i;
                                                        gVar8 = cVarArr6[i3].f1277i;
                                                        aVar2 = aVar4;
                                                        gVar7 = gVar12;
                                                        i17 = 0;
                                                        i16 = 8;
                                                        ...
                                                        if (dVar26 != null) {
                                                            ...
                                                            e.g.b.g gVar13 = cVarArr7[i3].f1277i;
                                                            int i35 = i3 + 1;
                                                            e.g.b.g gVar14 = cVarArr7[i35].f1277i;
                                                            e.g.b.h.c[] cVarArr8 = dVar27.L;
                                                            arrayList2 = arrayList4;
                                                            e.g.b.g gVar15 = cVarArr8[i3].f1277i;
                                                            e.g.b.g gVar16 = cVarArr8[i35].f1277i;
                                                            i15 = size;
                                                            e.g.b.b m2 = dVar.m();
                                                            dVar11 = dVar27;
                                                            m2.b = 0.0f;
                                                            ...
                                                            float f7 = -1.0f;
                                                            if (f4 == 0.0f || f5 == f6) {
                                                                m2.f1233d.c(gVar13, 1.0f);
                                                                m2.f1233d.c(gVar14, -1.0f);
                                                                m2.f1233d.c(gVar16, 1.0f);
                                                                aVar3 = m2.f1233d;
                                                            } else {
                                                                if (f5 == 0.0f) {
                                                                    m2.f1233d.c(gVar13, 1.0f);
                                                                    ...
                                                                    m2.f1233d.c(gVar15, 1.0f);
                                                                    m2.f1233d.c(gVar16, -1.0f);
                                                                } else {
                                                                    float f8 = (f5 / f4) / (f6 / f4);
                                                                    m2.f1233d.c(gVar13, 1.0f);
                                                                    m2.f1233d.c(gVar14, -1.0f);
                                                                    m2.f1233d.c(gVar16, f8);
                                                                    aVar3 = m2.f1233d;
                                                                    f7 = -f8;
                                                                }
                                                                dVar.c(m2);
                                            ...
                                            if (dVar22 != null || (dVar22 != dVar23 && !z3)) {
                                                ...
                                                if (z2 || dVar3 == null) {
                                                    int i36 = 8;
                                                    if (z && dVar3 != null) {
                                                        int i37 = bVar2.f1269j;
                                                        boolean z13 = i37 <= 0 && bVar2.f1268i == i37;
                                                        ...
                                                        while (dVar5 != null) {
                                                            ...
                                                            if (dVar5 == dVar3 || dVar5 == dVar4 || dVar29 == null) {
                                                                ...
                                                                e.g.b.g gVar17 = cVar16.f1277i;
                                                                int i38 = i3 + 1;
                                                                e.g.b.g gVar18 = dVar28.L[i38].f1277i;
                                                                int d6 = cVar16.d();
                                                                ...
                                                                if (dVar30 != null) {
                                                                    ...
                                                                    dVar8 = dVar30;
                                                                    cVar4 = dVar4.L[i3];
                                                                    gVar3 = cVar4 != null ? cVar4.f1277i : null;
                                                                    cVar5 = dVar5.L[i38];
                                                                }
                                                                gVar4 = cVar5.f1277i;
                                                                if (cVar4 == null) {
                                                        ...
                                                        cVar3 = dVar20.L[i3].f1274f;
                                                        int i40 = i3 + 1;
                                                        e.g.b.h.c cVar18 = dVar4.L[i40];
                                                        e.g.b.h.c cVar19 = dVar21.L[i40].f1274f;
                                                        if (cVar3 != null) {
                                                            if (dVar3 != dVar4) {
                                                                dVar.d(cVar17.f1277i, cVar3.f1277i, cVar17.d(), 5);
                                                            } else if (cVar19 != null) {
                                                                dVar2 = dVar21;
                                                                i10 = 5;
                                                                dVar.b(cVar17.f1277i, cVar3.f1277i, cVar17.d(), 0.5f, cVar18.f1277i, cVar19.f1277i, cVar18.d(), 5);
                                                                if (!(cVar19 == null || dVar3 == dVar4)) {
                                                                    dVar.d(cVar18.f1277i, cVar19.f1277i, -cVar18.d(), i10);
                                                                }
                                                                if (!(!(z2 || z) || dVar3 == null || dVar3 == dVar4)) {
                                                                    ...
                                                                    i8 = i3 + 1;
                                                                    cVar2 = dVar4.L[i8];
                                                                    e.g.b.h.c cVar20 = cVar.f1274f;
                                                                    gVar = cVar20 == null ? cVar20.f1277i : null;
                                                                    e.g.b.h.c cVar21 = cVar2.f1274f;
                                                                    e.g.b.g gVar19 = cVar21 == null ? cVar21.f1277i : null;
                                                                    if (dVar2 == dVar4) {
                                                                        e.g.b.h.c cVar22 = dVar2.L[i8].f1274f;
                                                                        if (cVar22 != null) {
                                                                            gVar9 = cVar22.f1277i;
                                                                        }
                                                                        gVar2 = gVar9;
                                                                    ...
                                                                    if (!(gVar == null || gVar2 == null)) {
                                                                        dVar.b(cVar.f1277i, gVar, cVar.d(), 0.5f, gVar2, cVar2.f1277i, dVar4.L[i8].d(), 5);
                                                                    }
                                                                }
                                                            }
                                                        }
                                                        ...
                                                        i8 = i3 + 1;
                                                        cVar2 = dVar4.L[i8];
                                                        e.g.b.h.c cVar202 = cVar.f1274f;
                                                        if (cVar202 == null) {
                                                        }
                                                        e.g.b.h.c cVar212 = cVar2.f1274f;
                                                        if (cVar212 == null) {
                                                        }
                                                        if (dVar2 == dVar4) {
                                                        }
                                                    ...
                                                    int i41 = bVar2.f1269j;
                                                    boolean z14 = i41 > 0 && bVar2.f1268i == i41;
                                                    ...
                                                    for (e.g.b.h.d dVar32 = dVar31; dVar32 != null; dVar32 = dVar9) {
                                                        ...
                                                        if (dVar33 != null || dVar32 == dVar4) {
                                                            ...
                                                            e.g.b.g gVar20 = cVar23.f1277i;
                                                            e.g.b.h.c cVar24 = cVar23.f1274f;
                                                            e.g.b.g gVar21 = cVar24 != null ? cVar24.f1277i : null;
                                                            if (dVar31 != dVar32) {
                                                                cVar8 = dVar31.L[i3 + 1];
                                                            } else {
                                                                if (dVar32 == dVar3 && dVar31 == dVar32) {
                                                                    e.g.b.h.c[] cVarArr10 = dVar20.L;
                                                                    if (cVarArr10[i3].f1274f != null) {
                                                                        cVar8 = cVarArr10[i3].f1274f;
                                                                    } else {
                                                                        gVar21 = null;
                                                                    }
                                                                }
                                                                ...
                                                                if (dVar33 == null) {
                                                                    ...
                                                                    e.g.b.h.c cVar26 = dVar21.L[i42].f1274f;
                                                                    if (cVar26 != null) {
                                                                        gVar5 = cVar26.f1277i;
                                                                        cVar6 = cVar26;
                                                                    } else {
                                                ...
                                                e.g.b.h.c cVar29 = cVar27.f1274f;
                                                e.g.b.g gVar22 = cVar29 != null ? cVar29.f1277i : null;
                                                e.g.b.h.c cVar30 = cVar28.f1274f;
                                                e.g.b.g gVar23 = cVar30 != null ? cVar30.f1277i : null;
                                                ...
                                                if (gVar22 == null || gVar23 == null) {
                                                    ...
                                                    dVar3 = dVar22;
                                                    i9 = i7;
                                                    dVar.b(cVar31.f1277i, gVar22, cVar31.d(), i2 == 0 ? dVar24.Z : dVar24.a0, gVar23, cVar32.f1277i, cVar32.d(), 7);
                                                }
                                            }
                                            dVar2 = dVar21;
                                            i6 = i9;
                                            ...
                                            i8 = i3 + 1;
                                            cVar2 = dVar4.L[i8];
                                            e.g.b.h.c cVar2022 = cVar.f1274f;
                                            if (cVar2022 == null) {
                                            }
                                            e.g.b.h.c cVar2122 = cVar2.f1274f;
                                            if (cVar2122 == null) {
                                            }
                                            if (dVar2 == dVar4) {
                                            }
                                    ...
                                    if (z3) {
                                        e.g.b.h.c cVar33 = cVar14.f1274f;
                                        if (cVar33.f1272d == eVar2) {
                                            dVar.d(cVar14.f1277i, cVar33.f1277i, -cVar14.d(), 4);
                                            dVar.g(cVar14.f1277i, dVar21.L[i32].f1274f.f1277i, -cVar14.d(), 6);
                                            if (z10) {
                                            }
                                            ArrayList<e.g.b.h.d> arrayList42 = bVar2.f1267h;
                                            if (bVar2.q) {
                                            }
                                            ...
                                            e.g.b.h.c cVar192 = dVar21.L[i402].f1274f;
                                            if (cVar3 != null) {
                                            }
                                            dVar2 = dVar21;
                                            i10 = 5;
                                            dVar.d(cVar182.f1277i, cVar192.f1277i, -cVar182.d(), i10);
                                            e.g.b.h.c[] cVarArr9222 = dVar3.L;
                                            cVar = cVarArr9222[i3];
                                            i8 = i3 + 1;
                                            cVar2 = dVar4.L[i8];
                                            e.g.b.h.c cVar20222 = cVar.f1274f;
                                            if (cVar20222 == null) {
                                            }
                                            e.g.b.h.c cVar21222 = cVar2.f1274f;
                                            if (cVar21222 == null) {
                                            }
                                            if (dVar2 == dVar4) {
                                            }
                                    ...
                                    ArrayList<e.g.b.h.d> arrayList422 = bVar2.f1267h;
                                    if (bVar2.q) {
                                    }
                                    ...
                                    e.g.b.h.c cVar1922 = dVar21.L[i4022].f1274f;
                                    if (cVar3 != null) {
                                    }
                                    dVar2 = dVar21;
                                    i10 = 5;
                                    dVar.d(cVar1822.f1277i, cVar1922.f1277i, -cVar1822.d(), i10);
                                    e.g.b.h.c[] cVarArr92222 = dVar3.L;
                                    cVar = cVarArr92222[i3];
                                    i8 = i3 + 1;
                                    cVar2 = dVar4.L[i8];
                                    e.g.b.h.c cVar202222 = cVar.f1274f;
                                    if (cVar202222 == null) {
                                    }
                                    e.g.b.h.c cVar212222 = cVar2.f1274f;
                                    if (cVar212222 == null) {
                                    }
                                    if (dVar2 == dVar4) {
                                    }
                            ...
                            ArrayList<e.g.b.h.d> arrayList4222 = bVar2.f1267h;
                            if (bVar2.q) {
                            }
                            ...
                            e.g.b.h.c cVar19222 = dVar21.L[i40222].f1274f;
                            if (cVar3 != null) {
                            }
                            dVar2 = dVar21;
                            i10 = 5;
                            dVar.d(cVar18222.f1277i, cVar19222.f1277i, -cVar18222.d(), i10);
                            e.g.b.h.c[] cVarArr922222 = dVar3.L;
                            cVar = cVarArr922222[i3];
                            i8 = i3 + 1;
                            cVar2 = dVar4.L[i8];
                            e.g.b.h.c cVar2022222 = cVar.f1274f;
                            if (cVar2022222 == null) {
                            }
                            e.g.b.h.c cVar2122222 = cVar2.f1274f;
                            if (cVar2122222 == null) {
                            }
                            if (dVar2 == dVar4) {
                            }
                        ...
                        if (i44 == 2) {
                            ...
                            ArrayList<e.g.b.h.d> arrayList42222 = bVar2.f1267h;
                            if (bVar2.q) {
                            }
                            ...
                            e.g.b.h.c cVar192222 = dVar21.L[i402222].f1274f;
                            if (cVar3 != null) {
                            }
                            dVar2 = dVar21;
                            i10 = 5;
                            dVar.d(cVar182222.f1277i, cVar192222.f1277i, -cVar182222.d(), i10);
                            e.g.b.h.c[] cVarArr9222222 = dVar3.L;
                            cVar = cVarArr9222222[i3];
                            i8 = i3 + 1;
                            cVar2 = dVar4.L[i8];
                            e.g.b.h.c cVar20222222 = cVar.f1274f;
                            if (cVar20222222 == null) {
                            }
                            e.g.b.h.c cVar21222222 = cVar2.f1274f;
                    ...
                    ArrayList<e.g.b.h.d> arrayList422222 = bVar2.f1267h;
                    if (bVar2.q) {
                    }
                    ...
                    e.g.b.h.c cVar1922222 = dVar21.L[i4022222].f1274f;
                    if (cVar3 != null) {
                    }
                    dVar2 = dVar21;
                    i10 = 5;
                    dVar.d(cVar1822222.f1277i, cVar1922222.f1277i, -cVar1822222.d(), i10);
                    e.g.b.h.c[] cVarArr92222222 = dVar3.L;
                    cVar = cVarArr92222222[i3];
                    i8 = i3 + 1;
                    cVar2 = dVar4.L[i8];
                    e.g.b.h.c cVar202222222 = cVar.f1274f;
                    if (cVar202222222 == null) {
                    }
                    e.g.b.h.c cVar212222222 = cVar2.f1274f;
        ...
        public static String e0(Throwable th) {
            return !(th instanceof f.a.b.u) ? "Call failed, unknown reason." : c0((f.a.b.u) th).optString("error", "Call failed, unknown reason.");
        }
        ...
        public static e.c0.d f(byte[] bArr) {
            Throwable th;
        ...
        public static <T> f.b.b.f.a.u<T> g0(f.b.a.c.i.h<T> hVar, l.b.a.c cVar, ScheduledExecutorService scheduledExecutorService) {
            return l.x(f0(new f.b.a.a.a.h.f(hVar, scheduledExecutorService))).A(cVar.r(), TimeUnit.MILLISECONDS, scheduledExecutorService);
        }
        ...
        public static int l1(e.c0.s sVar) {
        ...
        public static c0.b n1(String str) {
            if (str == null) {
                return null;
            }
            return c0.b.valueOf(str);
        }
        ...
        public static l.b.a.e o1(String str) {
            ...
            l.b.a.e eVar = l.b.a.e.f4137e;
            return l.b.a.e.T(str, l.b.a.u.c.f4216h);
        }
        ...
        public static c0.c p1(String str) {
            if (str == null) {
                return null;
            }
            return c0.c.valueOf(str);
        }
        ...
        public static c0.d q1(String str) {
            if (str == null) {
                return null;
            }
            return c0.d.valueOf(str);
        }
        ...
        public static boolean r0(f.b.a.a.a.y.c0 c0Var) {
            return !TextUtils.isEmpty(c0Var.n()) && !TextUtils.isEmpty(c0Var.h());
        }

        public static c0.e r1(String str) {
            if (str == null) {
                return null;
            }
            return c0.e.valueOf(str);
        }
        ...
        public static e.c0.a t0(int i2) {
            if (i2 == 0) {
        ...
        public static e.c0.m u0(int i2) {
            if (i2 == 0) {
                return e.c0.m.NOT_REQUIRED;
            }
            if (i2 == 1) {
                return e.c0.m.CONNECTED;
            }
            if (i2 == 2) {
                return e.c0.m.UNMETERED;
            }
            if (i2 == 3) {
                return e.c0.m.NOT_ROAMING;
            }
            if (i2 == 4) {
                return e.c0.m.METERED;
            }
        ...
        public static e.c0.s v0(int i2) {
            if (i2 == 0) {
                return e.c0.s.ENQUEUED;
            }
            if (i2 == 1) {
                return e.c0.s.RUNNING;
            }
            if (i2 == 2) {
                return e.c0.s.SUCCEEDED;
            }
            if (i2 == 3) {
                return e.c0.s.FAILED;
            }
            if (i2 == 4) {
                return e.c0.s.BLOCKED;
            }
            if (i2 == 5) {
                return e.c0.s.CANCELLED;
            }
        ...
        public static boolean x0(f.b.a.a.a.h.s.a aVar, long j2) {
            q qVar = q.f4166g;
            if (j2 < l.b.a.e.O(qVar).A(qVar).K(-14).w().E()) {
                return false;
            }
            if (j2 <= aVar.a()) {
                return true;
        ...
        public static e.m.a.v y0(Context context, e.m.a.l lVar, boolean z) {
            int i2;
            l.c cVar = lVar.I;
            boolean z2 = false;
            int i3 = cVar == null ? 0 : cVar.f1638d;
            int s = lVar.s();
            lVar.u0(0);
            ...
            return new e.m.a.v(AnimationUtils.loadAnimation(context, i2));
        }
        ...
        public static int z0(int i2, Rect rect, Rect rect2) {
            int i3;
            int i4;
            if (i2 == 17) {
                i4 = rect.left;
    ...
    public static final class j {
        ...
        /* renamed from: h  reason: collision with root package name */
        public e.b.e.i.g f683h;

        /* renamed from: i  reason: collision with root package name */
        public e.b.e.i.e f684i;

        /* renamed from: j  reason: collision with root package name */
        public Context f685j;
        ...
        public void a(e.b.e.i.g gVar) {
            e.b.e.i.e eVar;
            e.b.e.i.g gVar2 = this.f683h;
            if (gVar != gVar2) {
                if (gVar2 != null) {
                    gVar2.u(this.f684i);
                }
                this.f683h = gVar;
                if (gVar != null && (eVar = this.f684i) != null) {
                    gVar.b(eVar, gVar.a);
                }
            }
        }
    ...
    public m(Context context, Window window, k kVar, Object obj) {
        ...
        if (this.M == -100 && (orDefault = (hVar = Z).getOrDefault(this.f658d.getClass().getName(), null)) != null) {
            this.M = orDefault.intValue();
            hVar.remove(this.f658d.getClass().getName());
        }
        if (window != null) {
            C(window);
        }
    ...
    public final boolean B(boolean z2) {
        ...
        int S2 = S(this.f659e, i3);
        int i4 = Build.VERSION.SDK_INT;
        Configuration G2 = G(this.f659e, S2, null);
        boolean z7 = true;
        if (!this.P && (this.f658d instanceof Activity)) {
            PackageManager packageManager = this.f659e.getPackageManager();
            if (packageManager == null) {
                z3 = false;
                int i5 = this.f659e.getResources().getConfiguration().uiMode & 48;
                int i6 = G2.uiMode & 48;
                if (i5 != i6 && z2 && !z3 && this.I && (b0 || this.J)) {
                    Object obj4 = this.f658d;
                    if ((obj4 instanceof Activity) && !((Activity) obj4).isChild()) {
                        Activity activity = (Activity) this.f658d;
                        int i7 = e.i.a.b.b;
                        if (i4 < 28) {
                            Class<?> cls = e.i.a.g.a;
                            if (i4 >= 28) {
                                ...
                                if ((!e.i.a.g.a() || e.i.a.g.f1400f != null) && !(e.i.a.g.f1399e == null && e.i.a.g.f1398d == null)) {
                                    try {
                                        ...
                                        if (obj5 != null) {
                                            ...
                                            if (obj6 != null) {
                                                ...
                                                Handler handler = e.i.a.g.f1401g;
                                                handler.post(new e.i.a.d(aVar, obj5));
                                                try {
                                                    if (e.i.a.g.a()) {
                                                        Method method = e.i.a.g.f1400f;
                                                    ...
                                                    e.i.a.g.f1401g.post(new e.i.a.e(application, aVar));
                                                    throw th;
                                                }
                                            }
                                        }
                        ...
                        if (!z4 || i5 == i6) {
                            ...
                            Resources resources = this.f659e.getResources();
                            ...
                            int i8 = this.N;
                            if (i8 != 0) {
                                this.f659e.setTheme(i8);
                                if (i4 >= 23) {
                                    this.f659e.getTheme().applyStyle(this.N, true);
                                }
                            }
                            if (z3) {
                                Object obj7 = this.f658d;
            ...
            try {
                ActivityInfo activityInfo = packageManager.getActivityInfo(new ComponentName(this.f659e, this.f658d.getClass()), i4 >= 29 ? 269221888 : i4 >= 24 ? 786432 : 0);
        ...
        this.P = true;
        z3 = this.O;
        int i52 = this.f659e.getResources().getConfiguration().uiMode & 48;
        int i62 = G2.uiMode & 48;
        Object obj42 = this.f658d;
        Activity activity3 = (Activity) this.f658d;
        int i72 = e.i.a.b.b;
        if (i4 < 28) {
        }
        activity3.recreate();
    ...
    public void D(int i2, j jVar, Menu menu) {
        ...
        if ((jVar == null || jVar.m) && !this.L) {
            this.f661g.b.onPanelClosed(i2, menu);
        }
    }
    ...
    public void F(j jVar, boolean z2) {
        ViewGroup viewGroup;
        e.b.f.c0 c0Var;
        if (!z2 || jVar.a != 0 || (c0Var = this.f666l) == null || !c0Var.c()) {
            WindowManager windowManager = (WindowManager) this.f659e.getSystemService("window");
            if (!(windowManager == null || !jVar.m || (viewGroup = jVar.f680e) == null)) {
    ...
    public boolean H(KeyEvent keyEvent) {
        ...
        boolean z5 = true;
        if (((obj instanceof e.a) || (obj instanceof r)) && (decorView = this.f660f.getDecorView()) != null && e.i.i.e.a(decorView, keyEvent)) {
            return true;
        }
        if (keyEvent.getKeyCode() == 82 && this.f661g.b.dispatchKeyEvent(keyEvent)) {
            return true;
        }
        ...
        if (keyEvent.getAction() == 0) {
            ...
            j O4 = O(0);
            e.b.f.c0 c0Var = this.f666l;
            if (c0Var == null || !c0Var.g() || ViewConfiguration.get(this.f659e).hasPermanentMenuKey()) {
                boolean z7 = O4.m;
                if (z7 || O4.f687l) {
                    F(O4, true);
                    z3 = z7;
                    ...
                    AudioManager audioManager = (AudioManager) this.f659e.getApplicationContext().getSystemService("audio");
    ...
    public void I(int i2) {
        ...
        O2.p = true;
        O2.o = true;
        if ((i2 == 108 || i2 == 0) && this.f666l != null) {
            j O3 = O(0);
            O3.f686k = false;
            V(O3, null);
        }
    ...
    public final void K() {
        ViewGroup viewGroup;
        if (!this.t) {
            TypedArray obtainStyledAttributes = this.f659e.obtainStyledAttributes(androidx.appcompat.R$styleable.AppCompatTheme);
            ...
            if (obtainStyledAttributes.hasValue(i2)) {
                ...
                L();
                this.f660f.getDecorView();
                LayoutInflater from = LayoutInflater.from(this.f659e);
                if (this.D) {
                    ...
                    this.f659e.getTheme().resolveAttribute(androidx.appcompat.R$attr.actionBarTheme, typedValue, true);
                    viewGroup = (ViewGroup) LayoutInflater.from(typedValue.resourceId != 0 ? new e.b.e.c(this.f659e, typedValue.resourceId) : this.f659e).inflate(R$layout.abc_screen_toolbar, (ViewGroup) null);
                    e.b.f.c0 c0Var = (e.b.f.c0) viewGroup.findViewById(androidx.appcompat.R$id.decor_content_parent);
                    this.f666l = c0Var;
                ...
                if (viewGroup != null) {
                    e.i.i.m.s(viewGroup, new n(this));
                    if (this.f666l == null) {
                    ...
                    ViewGroup viewGroup2 = (ViewGroup) this.f660f.findViewById(16908290);
                    if (viewGroup2 != null) {
                    ...
                    this.f660f.setContentView(viewGroup);
                    contentFrameLayout.setAttachListener(new o(this));
                    this.u = viewGroup;
                    Object obj = this.f658d;
                    CharSequence title = obj instanceof Activity ? ((Activity) obj).getTitle() : this.f665k;
                    if (!TextUtils.isEmpty(title)) {
                        e.b.f.c0 c0Var2 = this.f666l;
                        if (c0Var2 != null) {
                    ...
                    View decorView = this.f660f.getDecorView();
                    contentFrameLayout2.f79h.set(decorView.getPaddingLeft(), decorView.getPaddingTop(), decorView.getPaddingRight(), decorView.getPaddingBottom());
                    AtomicInteger atomicInteger = e.i.i.m.a;
                    if (contentFrameLayout2.isLaidOut()) {
                        contentFrameLayout2.requestLayout();
                    }
                    TypedArray obtainStyledAttributes2 = this.f659e.obtainStyledAttributes(androidx.appcompat.R$styleable.AppCompatTheme);
    ...
    public final f N(Context context) {
        if (this.Q == null) {
            if (v.f698d == null) {
                ...
                v.f698d = new v(applicationContext, (LocationManager) applicationContext.getSystemService("location"));
            }
            this.Q = new g(v.f698d);
        }
        return this.Q;
    }
    ...
    public final void Q() {
        ...
        w wVar;
        K();
        if (this.z && this.f663i == null) {
            Object obj = this.f658d;
            if (obj instanceof Activity) {
                wVar = new w((Activity) this.f658d, this.A);
            } else {
                if (obj instanceof Dialog) {
                    wVar = new w((Dialog) this.f658d);
                }
                aVar = this.f663i;
                if (aVar == null) {
                    aVar.l(this.V);
    ...
    public final void T(j jVar, KeyEvent keyEvent) {
        ...
        if (!jVar.m && !this.L) {
            if (jVar.a == 0) {
                if ((this.f659e.getResources().getConfiguration().screenLayout & 15) == 4) {
                    return;
                }
            }
            Window.Callback P2 = P();
            if (P2 == null || P2.onMenuOpened(jVar.a, jVar.f683h)) {
                WindowManager windowManager = (WindowManager) this.f659e.getSystemService("window");
                if (windowManager != null && V(jVar, keyEvent)) {
                    ViewGroup viewGroup = jVar.f680e;
                    if (viewGroup == null || jVar.o) {
                        if (viewGroup == null) {
                            ...
                            jVar.f679d = obtainStyledAttributes.getResourceId(androidx.appcompat.R$styleable.AppCompatTheme_android_windowAnimationStyle, 0);
                            obtainStyledAttributes.recycle();
                            jVar.f680e = new i(jVar.f685j);
                            jVar.c = 81;
                        } else if (jVar.o && viewGroup.getChildCount() > 0) {
                            jVar.f680e.removeAllViews();
                        }
                        View view = jVar.f682g;
                        if (view != null) {
                            jVar.f681f = view;
                        } else {
                            if (jVar.f683h != null) {
                                ...
                                k kVar = this.n;
                                if (jVar.f684i == null) {
                                    e.b.e.i.e eVar = new e.b.e.i.e(jVar.f685j, R$layout.abc_list_menu_item_layout);
                                    jVar.f684i = eVar;
                                    eVar.f784g = kVar;
                                    e.b.e.i.g gVar = jVar.f683h;
                                    gVar.b(eVar, gVar.a);
                                }
                                e.b.e.i.e eVar2 = jVar.f684i;
                                ViewGroup viewGroup2 = jVar.f680e;
                                if (eVar2.f782e == null) {
                                    eVar2.f782e = (ExpandedMenuView) eVar2.c.inflate(R$layout.abc_expanded_menu_layout, viewGroup2, false);
                                    if (eVar2.f785h == null) {
                                        eVar2.f785h = new e.a();
                                    }
                                    eVar2.f782e.setAdapter((ListAdapter) eVar2.f785h);
                                    eVar2.f782e.setOnItemClickListener(eVar2);
                                }
                                ExpandedMenuView expandedMenuView = eVar2.f782e;
                                jVar.f681f = expandedMenuView;
                            }
                            z2 = false;
                            if (z2) {
                                if (jVar.f681f != null && (jVar.f682g != null || ((e.a) jVar.f684i.a()).getCount() > 0)) {
                                    ViewGroup.LayoutParams layoutParams2 = jVar.f681f.getLayoutParams();
                                    if (layoutParams2 == null) {
                                        layoutParams2 = new ViewGroup.LayoutParams(-2, -2);
                                    }
                                    jVar.f680e.setBackgroundResource(jVar.b);
                                    ViewParent parent = jVar.f681f.getParent();
                                    if (parent instanceof ViewGroup) {
                                        ((ViewGroup) parent).removeView(jVar.f681f);
                                    }
                                    jVar.f680e.addView(jVar.f681f, layoutParams2);
                                    if (!jVar.f681f.hasFocus()) {
                                        jVar.f681f.requestFocus();
                                    }
                                }
                            }
                            jVar.o = true;
                    ...
                    if (!(view2 == null || (layoutParams = view2.getLayoutParams()) == null || layoutParams.width != -1)) {
                        ...
                        layoutParams3.windowAnimations = jVar.f679d;
                        windowManager.addView(jVar.f680e, layoutParams3);
                        jVar.m = true;
                        return;
                    }
                    i2 = -2;
                    ...
                    layoutParams32.windowAnimations = jVar.f679d;
                    windowManager.addView(jVar.f680e, layoutParams32);
                    jVar.m = true;
                    return;
                }
                return;
    ...
    public final boolean U(j jVar, int i2, KeyEvent keyEvent, int i3) {
        ...
        if ((jVar.f686k || V(jVar, keyEvent)) && (gVar = jVar.f683h) != null) {
            z2 = gVar.performShortcut(i2, keyEvent, i3);
        }
        if (z2 && (i3 & 1) == 0 && this.f666l == null) {
            F(jVar, true);
        }
        return z2;
    }
    ...
    public final boolean V(j jVar, KeyEvent keyEvent) {
        ...
        Window.Callback P2 = P();
        if (P2 != null) {
            jVar.f682g = P2.onCreatePanelView(jVar.a);
        }
        int i2 = jVar.a;
        boolean z2 = i2 == 0 || i2 == 108;
        if (z2 && (c0Var4 = this.f666l) != null) {
            c0Var4.f();
        }
        if (jVar.f682g == null && (!z2 || !(this.f663i instanceof t))) {
            e.b.e.i.g gVar = jVar.f683h;
            if (gVar == null || jVar.p) {
                if (gVar == null) {
                    Context context = this.f659e;
                    int i3 = jVar.a;
                    if ((i3 == 0 || i3 == 108) && this.f666l != null) {
                        TypedValue typedValue = new TypedValue();
                ...
                if (z2 && (c0Var3 = this.f666l) != null) {
                    if (this.m == null) {
                        this.m = new b();
                    }
                    c0Var3.a(jVar.f683h, this.m);
                }
                jVar.f683h.z();
                if (!P2.onCreatePanelMenu(jVar.a, jVar.f683h)) {
                    jVar.a(null);
                    if (z2 && (c0Var2 = this.f666l) != null) {
            ...
            if (!P2.onPreparePanel(0, jVar.f682g, jVar.f683h)) {
                if (z2 && (c0Var = this.f666l) != null) {
                    c0Var.a(null, this.m);
                }
                jVar.f683h.y();
                return false;
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (this.p.isShown()) {
                ...
                if (i5 <= 0 || this.w != null) {
                    ...
                    View view2 = new View(this.f659e);
                    this.w = view2;
    ...
    public void b(e.b.e.i.g gVar) {
        e.b.f.c0 c0Var = this.f666l;
        if (c0Var == null || !c0Var.g() || (ViewConfiguration.get(this.f659e).hasPermanentMenuKey() && !this.f666l.b())) {
            j O2 = O(0);
            O2.o = true;
            F(O2, false);
            T(O2, null);
        ...
        if (this.f666l.c()) {
            this.f666l.d();
            if (!this.L) {
                P2.onPanelClosed(108, O(0).f683h);
            }
        } else if (P2 != null && !this.L) {
            if (this.S && (1 & this.T) != 0) {
                this.f660f.getDecorView().removeCallbacks(this.U);
                this.U.run();
            }
            j O3 = O(0);
            e.b.e.i.g gVar2 = O3.f683h;
            if (gVar2 != null && !O3.p && P2.onPreparePanel(0, O3.f682g, gVar2)) {
                P2.onMenuOpened(108, O3.f683h);
                this.f666l.e();
            }
        }
    }
    ...
    public <T extends View> T e(int i2) {
        K();
        return (T) this.f660f.findViewById(i2);
    }
    ...
    public MenuInflater g() {
        if (this.f664j == null) {
            Q();
            a aVar = this.f663i;
            this.f664j = new e.b.e.f(aVar != null ? aVar.e() : this.f659e);
        }
        return this.f664j;
    }
    ...
    public void k(Configuration configuration) {
        ...
        synchronized (a2) {
            n0 n0Var = a2.a;
            synchronized (n0Var) {
                e.e.e<WeakReference<Drawable.ConstantState>> eVar = n0Var.f924d.get(context);
                if (eVar != null) {
                    eVar.b();
                }
            }
    ...
    public void m() {
        ...
        if (this.f658d instanceof Activity) {
            synchronized (l.c) {
                l.s(this);
            }
        }
        ...
        if (this.M != -100) {
            ...
            if ((obj instanceof Activity) && ((Activity) obj).isChangingConfigurations()) {
                hVar.put(this.f658d.getClass().getName(), Integer.valueOf(this.M));
                aVar = this.f663i;
                if (aVar != null) {
                    aVar.h();
                }
    ...
    public final View onCreateView(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        s sVar;
        if (this.Y == null) {
            String string = this.f659e.obtainStyledAttributes(androidx.appcompat.R$styleable.AppCompatTheme).getString(androidx.appcompat.R$styleable.AppCompatTheme_viewInflaterClass);
            if (string == null) {
                sVar = new s();
            } else {
                try {
    ...
    public boolean t(int i2) {
        ...
        if (i2 == 1) {
            ...
            return this.f660f.requestFeature(i2);
        } else {
            X();
            this.A = true;
            return true;
    ...
    public void u(int i2) {
        ...
        LayoutInflater.from(this.f659e).inflate(i2, viewGroup);
        this.f661g.b.onContentChanged();
    }
    ...
    public void x(Toolbar toolbar) {
        ...
        if (this.f658d instanceof Activity) {
            ...
            if (!(aVar instanceof w)) {
                ...
                if (toolbar != null) {
                    Object obj = this.f658d;
                    t tVar = new t(toolbar, obj instanceof Activity ? ((Activity) obj).getTitle() : this.f665k, this.f661g);
                    this.f663i = tVar;
                    window = this.f660f;
                    callback = tVar.c;
                } else {
    ...
    public class d extends e.b.e.h {
        ...
        public final ActionMode a(ActionMode.Callback callback) {
            ...
            e.b.e.c cVar;
            k kVar2;
            e.a aVar3 = new e.a(m.this.f659e, callback);
            m mVar = m.this;
            ...
            if (aVar5 != null) {
                ...
                mVar.o = r;
                if (!(r == null || (kVar2 = mVar.f662h) == null)) {
                    kVar2.h(r);
                }
            }
            if (mVar.o == null) {
                ...
                if (kVar3 != null && !mVar.L) {
                    ...
                    if (aVar == null) {
                        ...
                        if (mVar.p == null) {
                            if (mVar.C) {
                                TypedValue typedValue = new TypedValue();
                                Resources.Theme theme = mVar.f659e.getTheme();
                                theme.resolveAttribute(androidx.appcompat.R$attr.actionBarTheme, typedValue, true);
                                if (typedValue.resourceId != 0) {
                                    Resources.Theme newTheme = mVar.f659e.getResources().newTheme();
                                    newTheme.setTo(theme);
                                    newTheme.applyStyle(typedValue.resourceId, true);
                                    e.b.e.c cVar3 = new e.b.e.c(mVar.f659e, 0);
                        ...
                        if (mVar.p != null) {
                            ...
                            if (cVar2.c(dVar, dVar.f738i)) {
                                ...
                                if (mVar.q != null) {
                                    mVar.f660f.getDecorView().post(mVar.r);
                                }
                            } else {
                                mVar.o = null;
                            }
                    ...
                    aVar2 = mVar.o;
                    if (!(aVar2 == null || (kVar = mVar.f662h) == null)) {
                        kVar.h(aVar2);
                    }
                    mVar.o = mVar.o;
                }
        ...
        public void onProvideKeyboardShortcuts(List<KeyboardShortcutGroup> list, Menu menu, int i2) {
            e.b.e.i.g gVar = m.this.O(0).f683h;
            if (gVar != null) {
