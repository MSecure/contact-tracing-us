...
public class s {
    ...
    public static final String[] f688d = {"android.widget.", "android.view.", "android.webkit."};

    /* renamed from: e  reason: collision with root package name */
    public static final h<String, Constructor<? extends View>> f689e = new h<>();
    ...
    public static class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            try {
                this.f690d.invoke(this.f691e, view);
    ...
    public final View g(Context context, String str, String str2) {
        String str3;
        h<String, Constructor<? extends View>> hVar = f689e;
