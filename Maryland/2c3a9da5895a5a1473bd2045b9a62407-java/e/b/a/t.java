...
public class t extends a {
    ...
    public ArrayList<a.b> f694f = new ArrayList<>();

    /* renamed from: g  reason: collision with root package name */
    public final Runnable f695g = new a();

    /* renamed from: h  reason: collision with root package name */
    public final Toolbar.f f696h;
    ...
    public void c(boolean z) {
        if (z != this.f693e) {
            this.f693e = z;
            int size = this.f694f.size();
            for (int i2 = 0; i2 < size; i2++) {
                this.f694f.get(i2).a(z);
            }
        }
    }
    ...
    @Override // e.b.a.a
    public boolean f() {
        this.a.o().removeCallbacks(this.f695g);
