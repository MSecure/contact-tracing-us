...
public final class a {
    ...
    public static final WeakHashMap<Context, SparseArray<C0014a>> b = new WeakHashMap<>(0);
    ...
    public static class C0014a {
        ...
        public C0014a(ColorStateList colorStateList, Configuration configuration) {
    ...
    public static ColorStateList a(Context context, int i2) {
        ...
        synchronized (c) {
            SparseArray<C0014a> sparseArray = b.get(context);
            colorStateList = null;
        ...
        if (colorStateList != null) {
            synchronized (c) {
                WeakHashMap<Context, SparseArray<C0014a>> weakHashMap = b;
                SparseArray<C0014a> sparseArray2 = weakHashMap.get(context);
                if (sparseArray2 == null) {
                    sparseArray2 = new SparseArray<>();
                    weakHashMap.put(context, sparseArray2);
                }
                sparseArray2.append(i2, new C0014a(colorStateList, context.getResources().getConfiguration()));
            }
