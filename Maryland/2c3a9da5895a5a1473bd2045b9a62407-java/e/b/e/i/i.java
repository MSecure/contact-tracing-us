...
public final class i implements b {
    ...
    public int f805i = 4096;

    /* renamed from: j  reason: collision with root package name */
    public char f806j;

    /* renamed from: k  reason: collision with root package name */
    public int f807k = 4096;

    /* renamed from: l  reason: collision with root package name */
    public Drawable f808l;
    public int m = 0;
    public g n;
    public r o;
    ...
    public char e() {
        return this.n.n() ? this.f806j : this.f804h;
    }
    ...
    public CharSequence getTitleCondensed() {
        CharSequence charSequence = this.f802f;
        return charSequence != null ? charSequence : this.f801e;
    }
    ...
    public MenuItem setAlphabeticShortcut(char c2) {
        ...
        this.f806j = Character.toLowerCase(c2);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setAlphabeticShortcut(char c2, int i2) {
        if (this.f806j == c2 && this.f807k == i2) {
            return this;
        }
        this.f806j = Character.toLowerCase(c2);
        this.f807k = KeyEvent.normalizeMetaState(i2);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setChecked(boolean z2) {
        if ((this.x & 4) != 0) {
            ...
            int size = gVar.f792f.size();
            gVar.z();
            for (int i2 = 0; i2 < size; i2++) {
                i iVar = gVar.f792f.get(i2);
    ...
    public MenuItem setNumericShortcut(char c2, int i2) {
        if (this.f804h == c2 && this.f805i == i2) {
            return this;
        }
        this.f804h = c2;
        this.f805i = KeyEvent.normalizeMetaState(i2);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setShortcut(char c2, char c3) {
        this.f804h = c2;
        this.f806j = Character.toLowerCase(c3);
        this.n.q(false);
        return this;
    }
    ...
    public MenuItem setShortcut(char c2, char c3, int i2, int i3) {
        ...
        this.f805i = KeyEvent.normalizeMetaState(i2);
        this.f806j = Character.toLowerCase(c3);
        this.f807k = KeyEvent.normalizeMetaState(i3);
        this.n.q(false);
        return this;
    }
    ...
    public String toString() {
        CharSequence charSequence = this.f801e;
