...
public class a1 implements d0 {
    ...
    public a1(Toolbar toolbar, boolean z) {
        ...
        if (z) {
            ...
            if (l4 != 0) {
                ...
                toolbar4.n = l4;
                TextView textView2 = toolbar4.f89d;
                if (textView2 != null) {
        ...
        if (i3 != this.o) {
            ...
            if (TextUtils.isEmpty(this.a.getNavigationContentDescription())) {
                int i4 = this.o;
                this.f854k = i4 != 0 ? q().getString(i4) : str;
                y();
            }
        }
        this.f854k = this.a.getNavigationContentDescription();
    ...
    public final void A() {
        ...
        if ((i2 & 2) == 0) {
            drawable = null;
        } else if ((i2 & 1) == 0 || (drawable = this.f849f) == null) {
            drawable = this.f848e;
        }
    ...
    public void a(Menu menu, m.a aVar) {
        ...
        if (gVar != null || toolbar.b != null) {
            ...
            if (gVar2 != gVar) {
                ...
                cVar2.r = true;
                if (gVar != null) {
                    gVar.b(cVar2, toolbar.f96k);
                    gVar.b(toolbar.L, toolbar.f96k);
                } else {
                    cVar2.e(toolbar.f96k, null);
                ...
                toolbar.b.setPopupTheme(toolbar.f97l);
    ...
    public void m(int i2) {
        this.f849f = i2 != 0 ? e.b.b.a.a.b(q(), i2) : null;
        A();
    }
    ...
    public void setIcon(int i2) {
        this.f848e = i2 != 0 ? e.b.b.a.a.b(q(), i2) : null;
        A();
    }
    ...
    public void x(int i2) {
        ...
        if (i3 != 0) {
            ...
            if ((i3 & 16) != 0 && (view = this.f847d) != null) {
                if ((i2 & 16) != 0) {
                    this.a.addView(view);
                } else {
                    this.a.removeView(view);
    ...
    public final void y() {
        ...
        if (TextUtils.isEmpty(this.f854k)) {
            ...
            this.a.setNavigationContentDescription(this.f854k);
        }
    }
