...
public class f0 extends ListView {
    ...
    public boolean b(MotionEvent motionEvent, int i2) {
        ...
        if (findPointerIndex >= 0) {
            ...
            if (pointToPosition != -1) {
                ...
                rect.left -= this.c;
                rect.top -= this.f879d;
                rect.right += this.f880e;
                rect.bottom += this.f881f;
                try {
                    boolean z4 = this.f883h.getBoolean(this);
                    if (childAt3.isEnabled() != z4) {
                        this.f883h.set(this, Boolean.valueOf(!z4));
                        if (pointToPosition != -1) {
            ...
            if (!z || z2) {
                ...
                childAt = getChildAt(this.f882g - getFirstVisiblePosition());
                if (childAt != null) {
    ...
    public final void c() {
        Drawable selector = getSelector();
        if (selector != null && this.f887l && isPressed()) {
    ...
    public boolean hasFocus() {
        return this.f886k || super.hasFocus();
    }

    public boolean hasWindowFocus() {
        return this.f886k || super.hasWindowFocus();
    }

    public boolean isFocused() {
        return this.f886k || super.isFocused();
    }

    public boolean isInTouchMode() {
        return (this.f886k && this.f885j) || super.isInTouchMode();
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f882g = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY());
        }
        b bVar = this.n;
        if (bVar != null) {
            f0 f0Var = f0.this;
    ...
    public void setSelector(Drawable drawable) {
        ...
        this.c = rect.left;
        this.f879d = rect.top;
        this.f880e = rect.right;
        this.f881f = rect.bottom;
    }
}
