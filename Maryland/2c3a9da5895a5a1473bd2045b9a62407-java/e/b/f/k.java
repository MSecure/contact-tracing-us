...
public class k extends EditText {
    ...
    public TextClassifier getTextClassifier() {
        x xVar;
        return (Build.VERSION.SDK_INT >= 28 || (xVar = this.f911d) == null) ? super.getTextClassifier() : xVar.a();
    }
    ...
    public void setTextClassifier(TextClassifier textClassifier) {
        x xVar;
        if (Build.VERSION.SDK_INT >= 28 || (xVar = this.f911d) == null) {
