...
public class y {
    ...
    public class a extends g {
        ...
        public void d(Typeface typeface) {
            ...
            if (yVar.m) {
                ...
                if (textView != null) {
                    textView.setTypeface(typeface, yVar.f976j);
                }
            }
        }
    }
    ...
    public void b() {
        if (!(this.b == null && this.c == null && this.f970d == null && this.f971e == null)) {
    ...
    public void e(AttributeSet attributeSet, int i2) {
        ...
        m.q(textView, textView.getContext(), iArr, attributeSet, q.b, i2, 0);
            ...
            if (y0Var2.o(i21)) {
                ...
                if (i8 >= 28) {
                    ...
                    if (y0Var2.o(i26)) {
                        ...
                        if (typeface != null) {
                            if (this.f977k == -1) {
                                this.a.setTypeface(typeface, this.f976j);
                            } else {
                        ...
                        if (str2 != null) {
                            if (i8 >= 24) {
                                ...
                                a0Var = this.f975i;
                                Context context2 = a0Var.f845j;
                                int[] iArr2 = R$styleable.AppCompatTextView;
                                obtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, iArr2, i2, i4);
                                TextView textView2 = a0Var.f844i;
                                m.q(textView2, textView2.getContext(), iArr2, attributeSet, obtainStyledAttributes, i2, 0);
                                ...
                                if (a0Var.i()) {
                                    ...
                                    if (!a0Var.f842g) {
                                        DisplayMetrics displayMetrics = a0Var.f845j.getResources().getDisplayMetrics();
                                        if (dimension2 == -1.0f) {
                                ...
                                if (b.a) {
                                    a0 a0Var2 = this.f975i;
                                    if (a0Var2.a != 0) {
                                        int[] iArr4 = a0Var2.f841f;
                                        if (iArr4.length > 0) {
                                            if (((float) this.a.getAutoSizeStepGranularity()) != -1.0f) {
                                                this.a.setAutoSizeTextTypeUniformWithConfiguration(Math.round(this.f975i.f839d), Math.round(this.f975i.f840e), Math.round(this.f975i.c), 0);
                                            } else {
                                ...
                                if (dimensionPixelSize != -1) {
                                    m.h.X0(this.a, dimensionPixelSize);
                                }
                                if (dimensionPixelSize2 != -1) {
                                    m.h.Y0(this.a, dimensionPixelSize2);
                                }
                                if (dimensionPixelSize3 == -1) {
                                    m.h.a1(this.a, dimensionPixelSize3);
                                    return;
                                }
                                return;
                            }
                        ...
                        TextView textView22 = a0Var.f844i;
                        e.i.i.m.q(textView22, textView22.getContext(), iArr22, attributeSet, obtainStyledAttributes, i2, 0);
                        i5 = R$styleable.AppCompatTextView_autoSizeTextType;
                        if (obtainStyledAttributes.hasValue(i5)) {
                        }
                ...
                i4 = 0;
                a0Var = this.f975i;
                Context context222 = a0Var.f845j;
                ...
                TextView textView222 = a0Var.f844i;
                e.i.i.m.q(textView222, textView222.getContext(), iArr222, attributeSet, obtainStyledAttributes, i2, 0);
                i5 = R$styleable.AppCompatTextView_autoSizeTextType;
                if (obtainStyledAttributes.hasValue(i5)) {
                }
        ...
        i4 = 0;
        a0Var = this.f975i;
        Context context2222 = a0Var.f845j;
        ...
        TextView textView2222 = a0Var.f844i;
        e.i.i.m.q(textView2222, textView2222.getContext(), iArr2222, attributeSet, obtainStyledAttributes, i2, 0);
        i5 = R$styleable.AppCompatTextView_autoSizeTextType;
        if (obtainStyledAttributes.hasValue(i5)) {
        }
    ...
    public void j(ColorStateList colorStateList) {
        ...
        w0Var.f969d = colorStateList != null;
        this.b = w0Var;
        this.c = w0Var;
        this.f970d = w0Var;
        this.f971e = w0Var;
    ...
    public final void l(Context context, y0 y0Var) {
        ...
        this.f976j = y0Var.j(R$styleable.TextAppearance_android_textStyle, this.f976j);
        boolean z = false;
        if (i2 >= 28) {
        ...
        if (y0Var.o(i3) || y0Var.o(R$styleable.TextAppearance_fontFamily)) {
            ...
            if (!context.isRestricted()) {
                try {
                    Typeface i7 = y0Var.i(i3, this.f976j, new a(i5, i6, new WeakReference(this.a)));
                    if (i7 != null) {
                        if (i2 >= 28 && this.f977k != -1) {
                            i7 = Typeface.create(Typeface.create(i7, 0), this.f977k, (this.f976j & 2) != 0);
                        }
                        this.f978l = i7;
                    }
                    this.m = this.f978l == null;
                } catch (Resources.NotFoundException | UnsupportedOperationException unused) {
                }
            }
            if (this.f978l == null && (m2 = y0Var.m(i3)) != null) {
                if (i2 < 28 || this.f977k == -1) {
                    typeface = Typeface.create(m2, this.f976j);
                } else {
