...
public final class q implements p {
    ...
    public final l f1143e;

    /* renamed from: f  reason: collision with root package name */
    public final l f1144f;

    /* renamed from: g  reason: collision with root package name */
    public final l f1145g;

    /* renamed from: h  reason: collision with root package name */
    public final l f1146h;

    /* renamed from: i  reason: collision with root package name */
    public final l f1147i;
    ...
    public class a extends e.t.b<o> {
        ...
        public void d(e.v.a.f.f fVar, o oVar) {
            ...
            byte[] b = e.c0.e.b(oVar2.f1134e);
            if (b == null) {
                fVar.b.bindNull(5);
            } else {
                fVar.b.bindBlob(5, b);
            }
            byte[] b2 = e.c0.e.b(oVar2.f1135f);
            if (b2 == null) {
                fVar.b.bindNull(6);
            } else {
                fVar.b.bindBlob(6, b2);
            }
            fVar.b.bindLong(7, oVar2.f1136g);
            fVar.b.bindLong(8, oVar2.f1137h);
            fVar.b.bindLong(9, oVar2.f1138i);
            fVar.b.bindLong(10, (long) oVar2.f1140k);
            e.c0.a aVar = oVar2.f1141l;
            ...
            if (cVar != null) {
                ...
                fVar.b.bindLong(20, cVar.f1006d ? 1 : 0);
                fVar.b.bindLong(21, cVar.f1007e ? 1 : 0);
                fVar.b.bindLong(22, cVar.f1008f);
                fVar.b.bindLong(23, cVar.f1009g);
                e.c0.d dVar = cVar.f1010h;
                byte[] bArr = null;
    ...
    public q(e.t.g gVar) {
        ...
        this.f1142d = new c(this, gVar);
        this.f1143e = new d(this, gVar);
        this.f1144f = new e(this, gVar);
        this.f1145g = new f(this, gVar);
        this.f1146h = new g(this, gVar);
        this.f1147i = new h(this, gVar);
        ...
        try {
            ...
            try {
                ...
                while (b2.moveToNext()) {
                    ...
                    cVar.f1006d = b2.getInt(b04) != 0;
                    cVar.f1007e = b2.getInt(b05) != 0;
                    cVar.f1008f = b2.getLong(b06);
                    cVar.f1009g = b2.getLong(b07);
                    cVar.f1010h = m.h.f(b2.getBlob(b08));
                    o oVar = new o(string, string2);
                    oVar.b = m.h.v0(b2.getInt(b010));
                    oVar.f1133d = b2.getString(b012);
                    oVar.f1134e = e.c0.e.a(b2.getBlob(b013));
                    oVar.f1135f = e.c0.e.a(b2.getBlob(i3));
                    i3 = i3;
                    oVar.f1136g = b2.getLong(b015);
                    oVar.f1137h = b2.getLong(b016);
                    oVar.f1138i = b2.getLong(b017);
                    oVar.f1140k = b2.getInt(b018);
                    oVar.f1141l = m.h.t0(b2.getInt(b019));
                    b017 = b017;
        ...
        try {
            ...
            try {
                ...
                while (b2.moveToNext()) {
                    ...
                    oVar.f1133d = b2.getString(b012);
                    oVar.f1134e = e.c0.e.a(b2.getBlob(b013));
                    oVar.f1135f = e.c0.e.a(b2.getBlob(i2));
                    i2 = i2;
                    oVar.f1136g = b2.getLong(b015);
                    oVar.f1137h = b2.getLong(b016);
                    oVar.f1138i = b2.getLong(b017);
        ...
        try {
            ...
            try {
                ...
                if (b2.moveToFirst()) {
                    ...
                    oVar2.f1133d = b2.getString(b012);
                    oVar2.f1134e = e.c0.e.a(b2.getBlob(b013));
                    oVar2.f1135f = e.c0.e.a(b2.getBlob(b014));
                    oVar2.f1136g = b2.getLong(b015);
                    oVar2.f1137h = b2.getLong(b016);
                    oVar2.f1138i = b2.getLong(b017);
                    oVar2.f1140k = b2.getInt(b018);
                    oVar2.f1141l = m.h.t0(b2.getInt(b019));
    ...
    public void n(String str, e.c0.e eVar) {
        this.a.b();
        e.v.a.f.f a2 = this.f1142d.a();
        byte[] b2 = e.c0.e.b(eVar);
        if (b2 == null) {
            a2.b.bindNull(1);
        } else {
            a2.b.bindBlob(1, b2);
