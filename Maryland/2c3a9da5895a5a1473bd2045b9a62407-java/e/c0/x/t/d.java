...
public class d implements Runnable {
    ...
    public static final String f1151d = l.e("EnqueueRunnable");
    public final g b;
    ...
    public static boolean a(g gVar) {
        ...
        if (list != null) {
            ...
            for (g gVar3 : list) {
                if (!gVar3.f1041h) {
                    ...
                    l.c().f(f1151d, String.format("Already enqueued work ids (%s).", TextUtils.join(", ", gVar3.f1038e)), new Throwable[0]);
                }
            }
        } else {
            z = false;
        ...
        e.c0.x.l lVar = gVar.a;
        List<? extends u> list2 = gVar.f1037d;
        String[] strArr = (String[]) c2.toArray(new String[0]);
        String str = gVar.b;
        e.c0.g gVar4 = gVar.c;
        s sVar2 = s.ENQUEUED;
        e.c0.g gVar5 = e.c0.g.APPEND_OR_REPLACE;
        s sVar3 = s.SUCCEEDED;
        s sVar4 = s.CANCELLED;
        s sVar5 = s.FAILED;
        ...
        if (z12) {
            ...
            while (i2 < length) {
                ...
                if (i3 == null) {
                    l.c().b(f1151d, String.format("Prerequisite %s doesn't exist; not enqueuing", str2), new Throwable[0]);
                    break;
                }
                s sVar6 = i3.b;
                z4 &= sVar6 == sVar3;
        ...
        if (z13 && !z12) {
            ...
            if (!arrayList2.isEmpty()) {
                if (gVar4 == e.c0.g.APPEND || gVar4 == gVar5) {
                    b m = workDatabase.m();
                        ...
                        if (i4 < 23 || i4 > 25) {
                            if (i4 <= 22) {
                                try {
                                    ...
                                    Iterator<e> it3 = lVar.f1049e.iterator();
                                    while (true) {
                                        if (!it3.hasNext()) {
                                            break;
                            ...
                            if (z9) {
                                ...
                                while (i5 < length2) {
                                    ...
                                    e.c0.x.s.c cVar2 = (e.c0.x.s.c) workDatabase.m();
                                    cVar2.a.b();
                                    cVar2.a.c();
                                    try {
                                        cVar2.b.e(aVar2);
    ...
    public static void b(o oVar) {
        e.c0.c cVar = oVar.f1139j;
        if (cVar.f1006d || cVar.f1007e) {
            String str = oVar.c;
            e.a aVar = new e.a();
            aVar.b(oVar.f1134e.a);
