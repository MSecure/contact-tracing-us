...
public class b implements d.a {
    ...
    public b c(d dVar, int i2) {
        this.f1233d.c(dVar.k(i2, "ep"), 1.0f);
        this.f1233d.c(dVar.k(i2, "em"), -1.0f);
        return this;
    }
    ...
    public b d(g gVar, g gVar2, g gVar3, g gVar4, float f2) {
        this.f1233d.c(gVar, -1.0f);
        this.f1233d.c(gVar2, 1.0f);
        this.f1233d.c(gVar3, f2);
        this.f1233d.c(gVar4, -f2);
        return this;
    }
    ...
    public b g(g gVar, g gVar2, g gVar3, g gVar4, float f2) {
        this.f1233d.c(gVar3, 0.5f);
        this.f1233d.c(gVar4, 0.5f);
        this.f1233d.c(gVar, -0.5f);
        this.f1233d.c(gVar2, -0.5f);
        this.b = -f2;
        return this;
    }

    public final boolean h(g gVar) {
        return gVar.f1258l <= 1;
    }

    public final g i(boolean[] zArr, g gVar) {
        g.a aVar;
        int k2 = this.f1233d.k();
        g gVar2 = null;
        float f2 = 0.0f;
        for (int i2 = 0; i2 < k2; i2++) {
            float a2 = this.f1233d.a(i2);
            if (a2 < 0.0f) {
                g f3 = this.f1233d.f(i2);
                if ((zArr == null || !zArr[f3.b]) && f3 != gVar && (((aVar = f3.f1255i) == g.a.SLACK || aVar == g.a.ERROR) && a2 < f2)) {
                    f2 = a2;
                    gVar2 = f3;
                }
            }
    ...
    public boolean isEmpty() {
        return this.a == null && this.b == 0.0f && this.f1233d.k() == 0;
    }
    ...
    public void j(g gVar) {
        ...
        float d2 = this.f1233d.d(gVar, true) * -1.0f;
        this.a = gVar;
        if (d2 != 1.0f) {
            this.b /= d2;
            this.f1233d.i(d2);
    ...
    public void k(d dVar, g gVar, boolean z) {
        if (gVar.f1252f) {
            float g2 = this.f1233d.g(gVar);
            this.b = (gVar.f1251e * g2) + this.b;
            this.f1233d.d(gVar, z);
            if (z) {
                gVar.b(this);
            }
            if (this.f1233d.k() == 0) {
    ...
    public void l(d dVar, b bVar, boolean z) {
        float b2 = this.f1233d.b(bVar, z);
        this.b = (bVar.b * b2) + this.b;
        if (z) {
            bVar.a.b(this);
        }
        if (this.a != null && this.f1233d.k() == 0) {
            this.f1234e = true;
            dVar.a = true;
        }
    }
    ...
    public String toString() {
        ...
        for (int i3 = 0; i3 < k2; i3++) {
            g f2 = this.f1233d.f(i3);
            if (!(f2 == null || (a2 = this.f1233d.a(i3)) == 0.0f)) {
