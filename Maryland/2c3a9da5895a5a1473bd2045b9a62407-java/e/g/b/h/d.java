...
public class d {
    ...
    public boolean A() {
        return this.f1291i || (this.E.c && this.G.c);
    }
    ...
    public void N(boolean z2, boolean z3) {
        ...
        a aVar = a.FIXED;
        k kVar = this.f1286d;
        boolean z4 = z2 & kVar.f1337g;
        m mVar = this.f1287e;
        boolean z5 = z3 & mVar.f1337g;
        int i4 = kVar.f1338h.f1315g;
        int i5 = mVar.f1338h.f1315g;
        int i6 = kVar.f1339i.f1315g;
        int i7 = mVar.f1339i.f1315g;
        int i8 = i7 - i5;
    ...
    public void b(e eVar, e.g.b.d dVar, HashSet<d> hashSet, int i2, boolean z2) {
        ...
        if (i2 == 0) {
            ...
            if (hashSet2 != null) {
                ...
                while (it.hasNext()) {
                    it.next().f1272d.b(eVar, dVar, hashSet, i2, true);
                }
            }
            ...
            if (hashSet3 != null) {
                ...
                while (it2.hasNext()) {
                    it2.next().f1272d.b(eVar, dVar, hashSet, i2, true);
                }
                return;
            }
            return;
        ...
        if (hashSet4 != null) {
            ...
            while (it3.hasNext()) {
                it3.next().f1272d.b(eVar, dVar, hashSet, i2, true);
            }
        }
        ...
        if (hashSet5 != null) {
            ...
            while (it4.hasNext()) {
                it4.next().f1272d.b(eVar, dVar, hashSet, i2, true);
            }
        }
        ...
        if (hashSet6 != null) {
            ...
            while (it5.hasNext()) {
                it5.next().f1272d.b(eVar, dVar, hashSet, i2, true);
            }
        }
    }
    ...
    public void d(e.g.b.d dVar, boolean z2) {
        ...
        if (!(!z2 || (kVar2 = this.f1286d) == null || (mVar = this.f1287e) == null)) {
            f fVar = kVar2.f1338h;
            if (fVar.f1318j && kVar2.f1339i.f1318j && mVar.f1338h.f1318j && mVar.f1339i.f1318j) {
                dVar.e(l2, fVar.f1315g);
                dVar.e(l3, this.f1286d.f1339i.f1315g);
                dVar.e(l4, this.f1287e.f1338h.f1315g);
                dVar.e(l5, this.f1287e.f1339i.f1315g);
                dVar.e(l6, this.f1287e.f1329k.f1315g);
                if (this.P != null) {
                    if (z3 && this.f1288f[0] && !w()) {
                        dVar.f(dVar.l(this.P.F), l3, 0, 8);
                    }
                    if (z4 && this.f1288f[1] && !x()) {
        ...
        if (this.P != null) {
            ...
            if (!z11 && z3 && this.c0 != 8 && this.D.f1274f == null && this.F.f1274f == null) {
                dVar.f(dVar.l(this.P.F), l3, 0, 1);
            }
            if (!z12 && z4 && this.c0 != 8 && this.E.f1274f == null && this.G.f1274f == null && this.H == null) {
                    ...
                    if (aVar6 != aVar5) {
                        ...
                        if (!z7) {
                            ...
                            if (i21 == 0 || i21 == -1) {
                                ...
                                if (this.f1292j != 2 && !this.f1290h) {
                                    if (z2 && (kVar = this.f1286d) != null) {
                                        f fVar222 = kVar.f1338h;
                                        if (fVar222.f1318j && kVar.f1339i.f1318j) {
                                            if (z2) {
                                                dVar.e(l2, fVar222.f1315g);
                                                dVar.e(gVar, this.f1286d.f1339i.f1315g);
                                                if (this.P != null && z3 && this.f1288f[0] && !w()) {
                                                ...
                                                if (z2) {
                                                    dVar2 = this;
                                                    m mVar2 = dVar2.f1287e;
                                                    if (mVar2 != null) {
                                                        f fVar3 = mVar2.f1338h;
                                                        if (fVar3.f1318j && mVar2.f1339i.f1318j) {
                                                            dVar3 = dVar;
                                                            gVar6 = gVar2;
                                                            dVar3.e(gVar6, fVar3.f1315g);
                                                            gVar7 = gVar3;
                                                            dVar3.e(gVar7, dVar2.f1287e.f1339i.f1315g);
                                                            gVar8 = gVar4;
                                                            dVar3.e(gVar8, dVar2.f1287e.f1329k.f1315g);
                                                            d dVar9 = dVar2.P;
                                                            if (dVar9 == null || z6 || !z4) {
                                                                i8 = 8;
                                                                i7 = 0;
                                                            ...
                                                            z9 = false;
                                                            if ((dVar2.f1293k != 2 ? false : z9) || dVar2.f1291i) {
                                                                gVar10 = gVar7;
                                                                gVar9 = gVar6;
                                                            } else {
                                                                ...
                                                                if (i23 > 0 || dVar2.c0 == i8) {
                                                                    if (dVar2.H.f1274f != null) {
                                                                        dVar3.d(gVar8, gVar6, i23, i8);
                                                                        dVar3.d(gVar8, dVar3.l(dVar2.H.f1274f), i7, i8);
                                                                        if (z4) {
                                                                            dVar3.f(l7, dVar3.l(dVar2.G), i7, 5);
                                                                        }
                                                                        z10 = false;
                                                                        boolean z24 = dVar2.f1288f[c3];
                                                                        a[] aVarArr2 = dVar2.O;
                                                                        gVar10 = gVar7;
                                                                        gVar9 = gVar6;
                                                            ...
                                                            if (dVar4.K.g()) {
                                                                d dVar12 = dVar4.K.f1274f.f1272d;
                                                                int d2 = dVar4.K.d();
                                                                c.a aVar7 = c.a.LEFT;
    ...
    public final void f(e.g.b.d dVar, boolean z2, boolean z3, boolean z4, boolean z5, g gVar, g gVar2, a aVar, boolean z6, c cVar, c cVar2, int i2, int i3, int i4, int i5, float f2, boolean z7, boolean z8, boolean z9, boolean z10, boolean z11, int i6, int i7, int i8, int i9, float f3, boolean z12) {
        ...
        g l2 = dVar.l(cVar);
        g l3 = dVar.l(cVar2);
        g l4 = dVar.l(cVar.f1274f);
        g l5 = dVar.l(cVar2.f1274f);
        boolean g2 = cVar.g();
        boolean g3 = cVar2.g();
        boolean g4 = this.K.g();
        if (g3) {
                            ...
                            if (i10 == 2 || z7 || !(i38 == 1 || i38 == 0)) {
                                ...
                                if (i38 == 1) {
                                    ...
                                    if (!z12) {
                                        ...
                                        if ((g2 || g3 || z15) && (!g2 || g3)) {
                                            if (g2 || !g3) {
                                                gVar10 = l5;
                                                if (g2 && g3) {
                                                    d dVar6 = cVar.f1274f.f1272d;
                                                    d dVar7 = cVar2.f1274f.f1272d;
                                                    d dVar8 = this.P;
                                                    int i39 = 6;
                                                    if (z14) {
                                                        if (i38 == 0) {
                                                            if (i37 != 0 || i13 != 0) {
                                                                ...
                                                                i31 = 5;
                                                                i34 = 5;
                                                            } else if (!l4.f1252f || !gVar10.f1252f) {
                                                                z32 = false;
                                                                z33 = false;
                                                                z29 = true;
                                                                i31 = 8;
                                    ...
                                    if (i15 >= i14 && z3 && z17) {
                                        ...
                                        boolean z34 = z2 || this.H.f1274f == null;
                                        if (!z2 && (cVar3 = this.H.f1274f) != null) {
                                            d dVar9 = cVar3.f1272d;
    ...
    public d n(int i2) {
        ...
        if (i2 == 0) {
            c cVar3 = this.F;
            c cVar4 = cVar3.f1274f;
            if (cVar4 == null || cVar4.f1274f != cVar3) {
                return null;
            }
            return cVar4.f1272d;
        } else if (i2 == 1 && (cVar2 = (cVar = this.G).f1274f) != null && cVar2.f1274f == cVar) {
            return cVar2.f1272d;
        } else {
            return null;
        }
    ...
    public d o(int i2) {
        ...
        if (i2 == 0) {
            ...
            return cVar4.f1272d;
        } else if (i2 == 1 && (cVar2 = (cVar = this.E).f1274f) != null && cVar2.f1274f == cVar) {
            return cVar2.f1272d;
        } else {
            return null;
        }
    ...
    public boolean u(int i2) {
        if (i2 == 0) {
            return (this.D.f1274f != null ? 1 : 0) + (this.F.f1274f != null ? 1 : 0) < 2;
        }
        return ((this.E.f1274f != null ? 1 : 0) + (this.G.f1274f != null ? 1 : 0)) + (this.H.f1274f != null ? 1 : 0) < 2;
    }

    public final boolean v(int i2) {
        int i3 = i2 * 2;
        c[] cVarArr = this.L;
        if (!(cVarArr[i3].f1274f == null || cVarArr[i3].f1274f.f1274f == cVarArr[i3])) {
            int i4 = i3 + 1;
            return cVarArr[i4].f1274f != null && cVarArr[i4].f1274f.f1274f == cVarArr[i4];
        }
    }
    ...
    public boolean w() {
        c cVar = this.D;
        c cVar2 = cVar.f1274f;
        if (cVar2 != null && cVar2.f1274f == cVar) {
            return true;
        }
        c cVar3 = this.F;
        c cVar4 = cVar3.f1274f;
        return cVar4 != null && cVar4.f1274f == cVar3;
    }
    ...
    public boolean y() {
        return this.f1289g && this.c0 != 8;
    }

    public boolean z() {
        return this.f1290h || (this.D.c && this.F.c);
    }
}
