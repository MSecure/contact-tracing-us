...
public class e extends k {
    ...
    public b.AbstractC0031b o0 = null;
    ...
    public static boolean X(d dVar, b.AbstractC0031b bVar, b.a aVar, int i2) {
        int i3;
        int i4;
        ...
        if (z && dVar.u(0) && dVar.f1294l == 0 && !z3) {
            aVar.a = aVar2;
            if (z2 && dVar.m == 0) {
                aVar.a = aVar3;
            }
        ...
        if (z4) {
            if (dVar.n[1] == 4) {
                ...
                aVar.b = aVar3;
                int i6 = dVar.T;
                aVar.f1298d = (int) ((i6 == 0 || i6 == -1) ? ((float) i3) / dVar.S : ((float) i3) * dVar.S);
            }
        }
        ((ConstraintLayout.b) bVar).b(dVar, aVar);
        dVar.M(aVar.f1299e);
    ...
    public void P() {
        ...
        if (i.b(this.x0, 1)) {
            ...
            for (int i22 = 0; i22 < size; i22++) {
                ...
                if (dVar8.y() && !(dVar8 instanceof f) && !(dVar8 instanceof a) && !(dVar8 instanceof j) && !dVar8.A) {
                    if (!(dVar8.k(0) == aVar12 && dVar8.f1294l != 1 && dVar8.k(1) == aVar12 && dVar8.m != 1)) {
        ...
        if (size > 2) {
            ...
            if ((aVar16 == aVar19 || aVar20 == aVar19) && i.b(this.x0, 1024)) {
                b.AbstractC0031b bVar2 = this.o0;
                ...
                while (true) {
                    if (i23 < size3) {
                        ...
                        while (i24 < size3) {
                            ...
                            if (!m.h.u1(m(), q(), dVar10.m(), dVar10.q())) {
                            ...
                            if (dVar10.D.f1274f == null && dVar10.F.f1274f == null && !z12 && !(dVar10 instanceof a)) {
                                if (arrayList8 == null) {
                            ...
                            if (dVar10.E.f1274f == null && dVar10.G.f1274f == null && dVar10.H.f1274f == null && !z12 && !(dVar10 instanceof a)) {
                                if (arrayList9 == null) {
                        ...
                        if (hashSet != null) {
                            ...
                            while (it3.hasNext()) {
                                m.h.V(it3.next().f1272d, 0, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet2 != null) {
                            ...
                            while (it4.hasNext()) {
                                m.h.V(it4.next().f1272d, 0, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet3 != null) {
                            ...
                            while (it5.hasNext()) {
                                m.h.V(it5.next().f1272d, 0, arrayList10, null);
                            }
                        }
                        n nVar4 = null;
                        if (arrayList8 != null) {
                        ...
                        if (hashSet4 != null) {
                            ...
                            while (it9.hasNext()) {
                                m.h.V(it9.next().f1272d, 1, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet5 != null) {
                            ...
                            while (it10.hasNext()) {
                                m.h.V(it10.next().f1272d, 1, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet6 != null) {
                            ...
                            while (it11.hasNext()) {
                                m.h.V(it11.next().f1272d, 1, arrayList10, null);
                            }
                        }
                        ...
                        if (hashSet7 != null) {
                            ...
                            while (it12.hasNext()) {
                                m.h.V(it12.next().f1272d, 1, arrayList10, null);
                            }
                        }
                        char c = 1;
                        if (arrayList9 != null) {
                ...
                if (z6) {
                    ...
                    dVar1222.f1239g = false;
                    dVar1222.f1239g = true;
        ...
        dVar12222.f1239g = false;
        dVar12222.f1239g = true;
    ...
    public boolean V(boolean z, int i2) {
        ...
        if (z4 && (k2 == aVar2 || k3 == aVar2)) {
            Iterator<o> it3 = eVar.f1308e.iterator();
            while (true) {
                if (!it3.hasNext()) {
                    break;
                }
                o next = it3.next();
                if (next.f1336f == i2 && !next.k()) {
                    z4 = false;
                    break;
                }
            }
        ...
        if (i2 == 0) {
            if (aVarArr[0] == aVar3 || aVarArr[0] == aVar) {
                int r = eVar6.r() + s;
                eVar.a.f1286d.f1339i.c(r);
                gVar = eVar.a.f1286d.f1335e;
                i3 = r - s;
                gVar.c(i3);
                z2 = true;
                eVar.g();
                it = eVar.f1308e.iterator();
                while (it.hasNext()) {
                    o next2 = it.next();
                    if (next2.f1336f == i2 && (next2.b != eVar.a || next2.f1337g)) {
                        next2.e();
                    }
                }
                it2 = eVar.f1308e.iterator();
                while (true) {
                    if (!it2.hasNext()) {
                        break;
                    }
                    o next3 = it2.next();
                    if (next3.f1336f == i2 && ((z2 || next3.b != eVar.a) && (!next3.f1338h.f1318j || !next3.f1339i.f1318j || (!(next3 instanceof e.g.b.h.l.c) && !next3.f1335e.f1318j)))) {
                        z3 = false;
                    }
                }
                z3 = false;
            ...
            int l2 = eVar6.l() + t;
            eVar.a.f1287e.f1339i.c(l2);
            gVar = eVar.a.f1287e.f1335e;
            i3 = l2 - t;
            gVar.c(i3);
            z2 = true;
            eVar.g();
