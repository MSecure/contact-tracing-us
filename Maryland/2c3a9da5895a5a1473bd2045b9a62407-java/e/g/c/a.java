...
public class a {
    ...
    public a(String str, EnumC0032a aVar, Object obj) {
        this.a = str;
        this.b = aVar;
        b(obj);
    }
    ...
    public static void a(Context context, XmlPullParser xmlPullParser, HashMap<String, a> hashMap) {
        ...
        int i2;
        float f2;
        EnumC0032a aVar2 = EnumC0032a.DIMENSION_TYPE;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(xmlPullParser), R$styleable.CustomAttribute);
        int indexCount = obtainStyledAttributes.getIndexCount();
        String str = null;
        Object obj2 = null;
        EnumC0032a aVar3 = null;
        for (int i3 = 0; i3 < indexCount; i3++) {
            ...
            if (index == R$styleable.CustomAttribute_attributeName) {
                ...
                aVar3 = EnumC0032a.BOOLEAN_TYPE;
            } else {
                if (index == R$styleable.CustomAttribute_customColorValue) {
                    aVar = EnumC0032a.COLOR_TYPE;
                } else if (index == R$styleable.CustomAttribute_customColorDrawableValue) {
                    aVar = EnumC0032a.COLOR_DRAWABLE_TYPE;
                } else {
