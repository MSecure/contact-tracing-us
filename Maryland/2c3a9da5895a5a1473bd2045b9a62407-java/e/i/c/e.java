...
public class e extends k {
    ...
    public static Method f1437d = null;

    /* renamed from: e  reason: collision with root package name */
    public static Method f1438e = null;
    ...
    public static boolean f(Object obj, String str, int i2, boolean z) {
        g();
        try {
            return ((Boolean) f1437d.invoke(obj, str, Integer.valueOf(i2), Boolean.valueOf(z))).booleanValue();
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        try {
            ...
            for (d dVar : dVarArr) {
                ...
                try {
                    if (!m.h.y(p0, resources, dVar.f1434f)) {
                        p0.delete();
                        return null;
                    }
            ...
            try {
                ...
                return (Typeface) f1438e.invoke(null, newInstance2);
            } catch (IllegalAccessException | InvocationTargetException e2) {
                throw new RuntimeException(e2);
            }
