...
public class f extends k {
    ...
    public static final Method f1440d;

    /* renamed from: e  reason: collision with root package name */
    public static final Method f1441e;
    ...
    public static boolean f(Object obj, ByteBuffer byteBuffer, int i2, int i3, boolean z) {
        try {
            return ((Boolean) f1440d.invoke(obj, byteBuffer, Integer.valueOf(i2), null, Integer.valueOf(i3), Boolean.valueOf(z))).booleanValue();
    ...
    public static Typeface g(Object obj) {
        try {
            ...
            return (Typeface) f1441e.invoke(null, newInstance);
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return null;
        }
    }
                    ...
                    if (m.h.y(p0, resources, i3)) {
                        try {
                            ...
                            try {
                                ...
                                p0.delete();
                                if (!(mappedByteBuffer == null && f(obj, mappedByteBuffer, dVar.f1433e, dVar.b, dVar.c))) {
                                    return null;
                                }
                            } catch (Throwable th) {
                                th.addSuppressed(th);
    ...
    public Typeface b(Context context, CancellationSignal cancellationSignal, e.c[] cVarArr, int i2) {
        ...
        for (e.c cVar : cVarArr) {
            ...
            if (byteBuffer == null || !f(obj, byteBuffer, cVar.b, cVar.c, cVar.f1460d)) {
                return null;
            }
        }
        Typeface g2 = g(obj);
