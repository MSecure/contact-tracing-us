...
public class g extends e {
    ...
    public final Constructor<?> f1443h;

    /* renamed from: i  reason: collision with root package name */
    public final Method f1444i;

    /* renamed from: j  reason: collision with root package name */
    public final Method f1445j;

    /* renamed from: k  reason: collision with root package name */
    public final Method f1446k;

    /* renamed from: l  reason: collision with root package name */
    public final Method f1447l;
    ...
    private Object m() {
        try {
            return this.f1443h.newInstance(new Object[0]);
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        d[] dVarArr = cVar.a;
        for (d dVar : dVarArr) {
            if (!i(context, m2, dVar.a, dVar.f1433e, dVar.b, dVar.c ? 1 : 0, FontVariationAxis.fromFontVariationSettings(dVar.f1432d))) {
                h(m2);
                return null;
            }
        }
    ...
    public Typeface b(Context context, CancellationSignal cancellationSignal, e.c[] cVarArr, int i2) {
        ...
        if (!l()) {
            ...
            try {
                ...
                try {
                    Typeface build = new Typeface.Builder(openFileDescriptor.getFileDescriptor()).setWeight(cVar.c).setItalic(cVar.f1460d).build();
                    openFileDescriptor.close();
                    return build;
                } catch (Throwable th) {
                    th.addSuppressed(th);
            ...
            for (e.c cVar3 : cVarArr) {
                ...
                if (byteBuffer != null) {
                    try {
                        z = ((Boolean) this.f1445j.invoke(m2, byteBuffer, Integer.valueOf(cVar3.b), null, Integer.valueOf(cVar3.c), Integer.valueOf(cVar3.f1460d ? 1 : 0))).booleanValue();
    ...
    public final void h(Object obj) {
        try {
            this.f1447l.invoke(obj, new Object[0]);
    ...
    public final boolean i(Context context, Object obj, String str, int i2, int i3, int i4, FontVariationAxis[] fontVariationAxisArr) {
        try {
            return ((Boolean) this.f1444i.invoke(obj, context.getAssets(), str, 0, Boolean.FALSE, Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), fontVariationAxisArr)).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
    ...
    public Typeface j(Object obj) {
        try {
            Object newInstance = Array.newInstance(this.f1442g, 1);
    ...
    public final boolean k(Object obj) {
        try {
            return ((Boolean) this.f1446k.invoke(obj, new Object[0])).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
