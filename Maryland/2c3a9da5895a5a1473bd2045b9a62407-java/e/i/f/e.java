...
public class e {
    ...
    public static final h<String, ArrayList<f.c<d>>> f1458d = new h<>();

    /* renamed from: e  reason: collision with root package name */
    public static final Comparator<byte[]> f1459e = new a();
    ...
    public static b a(Context context, CancellationSignal cancellationSignal, a aVar) {
        ...
        if (resolveContentProvider == null) {
            ...
            Collections.sort(arrayList, f1459e);
            List<List<byte[]>> list = aVar.f1455d;
            if (list == null) {
            ...
            while (true) {
                ...
                Collections.sort(arrayList2, f1459e);
