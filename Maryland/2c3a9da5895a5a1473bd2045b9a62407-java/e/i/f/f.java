...
public class f {
    ...
    public Handler.Callback f1463e = new a();
    ...
    public class b implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ ReentrantLock f1464d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ AtomicBoolean f1465e;

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ Condition f1466f;
        ...
        public b(f fVar, AtomicReference atomicReference, Callable callable, ReentrantLock reentrantLock, AtomicBoolean atomicBoolean, Condition condition) {
            ...
            this.c = callable;
            this.f1464d = reentrantLock;
            this.f1465e = atomicBoolean;
            this.f1466f = condition;
        }
    ...
    public final void a(Runnable runnable) {
        synchronized (this.a) {
            if (this.b == null) {
                ...
                handlerThread.start();
                this.c = new Handler(this.b.getLooper(), this.f1463e);
                this.f1462d++;
            }
