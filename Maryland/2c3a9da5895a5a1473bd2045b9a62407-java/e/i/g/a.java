...
public final class a {
    ...
    public static final String f1469e = Character.toString(8206);

    /* renamed from: f  reason: collision with root package name */
    public static final String f1470f = Character.toString(8207);

    /* renamed from: g  reason: collision with root package name */
    public static final a f1471g;

    /* renamed from: h  reason: collision with root package name */
    public static final a f1472h;
    ...
    public static class C0036a {
        ...
        /* renamed from: e  reason: collision with root package name */
        public static final byte[] f1473e = new byte[1792];
        ...
        static {
            for (int i2 = 0; i2 < 1792; i2++) {
                f1473e[i2] = Character.getDirectionality(i2);
            }
        }

        public C0036a(CharSequence charSequence, boolean z) {
            this.a = charSequence;
        ...
        public byte a() {
            ...
            this.c--;
            char c2 = this.f1474d;
            return c2 < 1792 ? f1473e[c2] : Character.getDirectionality(c2);
        }
    }
    ...
    static {
        c cVar = d.c;
        f1468d = cVar;
        f1471g = new a(false, 2, cVar);
        f1472h = new a(true, 2, cVar);
    }
    ...
    public static int a(CharSequence charSequence) {
        byte b2;
        C0036a aVar = new C0036a(charSequence, false);
        aVar.c = 0;
        int i2 = 0;
        int i3 = 0;
        int i4 = 0;
        while (true) {
            ...
            if (i5 < aVar.b && i2 == 0) {
                ...
                if (Character.isHighSurrogate(charAt)) {
                    ...
                    aVar.c++;
                    char c2 = aVar.f1474d;
                    b2 = c2 < 1792 ? C0036a.f1473e[c2] : Character.getDirectionality(c2);
                }
                if (b2 != 0) {
                    if (b2 == 1 || b2 == 2) {
                        if (i4 == 0) {
    ...
    public CharSequence d(CharSequence charSequence, c cVar, boolean z) {
        ...
        if (((this.b & 2) != 0) && z) {
            ...
            spannableStringBuilder.append((CharSequence) ((this.a || (!b3 && a(charSequence) != 1)) ? (!this.a || (b3 && a(charSequence) != -1)) ? str : f1470f : f1469e));
        }
        if (b2 != this.a) {
