...
public class a {
    ...
    public static final class C0038a extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            Boolean bool = (Boolean) new n(R$id.tag_screen_reader_focusable, Boolean.class, 28).c(view);
            ...
            Boolean bool2 = (Boolean) new q(R$id.tag_accessibility_heading, Boolean.class, 28).c(view);
            ...
            CharSequence charSequence = (CharSequence) new o(R$id.tag_accessibility_pane_title, CharSequence.class, 8, 28).c(view);
            ...
            CharSequence charSequence2 = (CharSequence) new p(R$id.tag_state_description, CharSequence.class, 64, 30).c(view);
