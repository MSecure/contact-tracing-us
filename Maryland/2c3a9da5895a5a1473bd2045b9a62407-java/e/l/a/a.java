...
public class a {
    ...
    public static final ThreadLocal<a> f1555g = new ThreadLocal<>();
    ...
    public class C0045a {
        ...
        public void a() {
            boolean z;
            a.this.f1557e = SystemClock.uptimeMillis();
            a aVar = a.this;
            long j2 = aVar.f1557e;
            ...
            if (a.this.b.size() > 0) {
                ...
                if (aVar2.f1556d == null) {
                    aVar2.f1556d = new d(aVar2.c);
                }
                d dVar = (d) aVar2.f1556d;
    ...
    public static class d extends c {
        ...
        public final Choreographer.FrameCallback c = new Choreographer$FrameCallbackC0046a();

        /* renamed from: e.l.a.a$d$a  reason: collision with other inner class name */
        public class Choreographer$FrameCallbackC0046a implements Choreographer.FrameCallback {
            public Choreographer$FrameCallbackC0046a() {
            }
        ...
        public d(C0045a aVar) {
            super(aVar);
        }
    }

    public static a a() {
        ThreadLocal<a> threadLocal = f1555g;
