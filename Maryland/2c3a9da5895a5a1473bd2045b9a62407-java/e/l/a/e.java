...
public final class e {
    ...
    public double f1570f;

    /* renamed from: g  reason: collision with root package name */
    public double f1571g;

    /* renamed from: h  reason: collision with root package name */
    public double f1572h;

    /* renamed from: i  reason: collision with root package name */
    public double f1573i = Double.MAX_VALUE;

    /* renamed from: j  reason: collision with root package name */
    public final b.h f1574j = new b.h();

    public e() {
    }

    public e(float f2) {
        this.f1573i = (double) f2;
    }
    ...
    public b.h b(double d2, double d3, long j2) {
        ...
        double d5;
        if (!this.c) {
            if (this.f1573i != Double.MAX_VALUE) {
                double d6 = this.b;
                if (d6 > 1.0d) {
                    double d7 = this.a;
                    this.f1570f = (Math.sqrt((d6 * d6) - 1.0d) * d7) + ((-d6) * d7);
                    double d8 = this.b;
                    double d9 = this.a;
                    this.f1571g = ((-d8) * d9) - (Math.sqrt((d8 * d8) - 1.0d) * d9);
                } else if (d6 >= 0.0d && d6 < 1.0d) {
                    this.f1572h = Math.sqrt(1.0d - (d6 * d6)) * this.a;
                }
                this.c = true;
            } else {
        ...
        double d11 = d2 - this.f1573i;
        double d12 = this.b;
        if (d12 > 1.0d) {
            double d13 = this.f1571g;
            double d14 = this.f1570f;
            double d15 = d11 - (((d13 * d11) - d3) / (d13 - d14));
            double d16 = ((d11 * d13) - d3) / (d13 - d14);
            d4 = (Math.pow(2.718281828459045d, this.f1570f * d10) * d16) + (Math.pow(2.718281828459045d, d13 * d10) * d15);
            double d17 = this.f1571g;
            double pow = Math.pow(2.718281828459045d, d17 * d10) * d15 * d17;
            double d18 = this.f1570f;
            ...
            double d23 = 1.0d / this.f1572h;
            double d24 = this.a;
            double d25 = ((d12 * d24 * d11) + d3) * d23;
            double sin = ((Math.sin(this.f1572h * d10) * d25) + (Math.cos(this.f1572h * d10) * d11)) * Math.pow(2.718281828459045d, (-d12) * d24 * d10);
            double d26 = this.a;
            double d27 = this.b;
            double d28 = (-d26) * sin * d27;
            double pow4 = Math.pow(2.718281828459045d, (-d27) * d26 * d10);
            double d29 = this.f1572h;
            double d30 = (-d29) * d11;
            double d31 = this.f1572h;
            d5 = (((Math.cos(d31 * d10) * d25 * d31) + (Math.sin(d29 * d10) * d30)) * pow4) + d28;
            d4 = sin;
        }
        b.h hVar = this.f1574j;
        hVar.a = (float) (d4 + this.f1573i);
        hVar.b = (float) d5;
        return hVar;
    }
}
