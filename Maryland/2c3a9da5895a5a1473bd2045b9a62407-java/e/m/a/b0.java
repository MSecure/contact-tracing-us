...
public class b0 {
    ...
    public static Class<? extends l> c(ClassLoader classLoader, String str) {
        try {
            ...
            throw new l.d(a.c("Unable to instantiate fragment ", str, ": make sure class name exists"), e2);
        } catch (ClassCastException e3) {
            throw new l.d(a.c("Unable to instantiate fragment ", str, ": make sure class is a valid subclass of Fragment"), e3);
        }
    }
