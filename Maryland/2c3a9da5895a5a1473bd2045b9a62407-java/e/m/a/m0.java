...
public class m0 {
    ...
    public e.i.e.a f1658f;

    /* renamed from: g  reason: collision with root package name */
    public e.i.e.a f1659g;

    /* renamed from: h  reason: collision with root package name */
    public e.i.e.a f1660h;
    ...
    public m0(e0 e0Var, n0 n0Var, l lVar, l0 l0Var) {
        ...
        lVar.f1637l = false;
        l lVar2 = lVar.f1633h;
        lVar.f1634i = lVar2 != null ? lVar2.f1631f : null;
        lVar.f1633h = null;
    ...
    public m0(e0 e0Var, n0 n0Var, ClassLoader classLoader, b0 b0Var, l0 l0Var) {
        this.a = e0Var;
        this.b = n0Var;
        l a2 = b0Var.a(classLoader, l0Var.b);
        this.c = a2;
        Bundle bundle = l0Var.f1654k;
        if (bundle != null) {
    ...
    public void a() {
        ...
        if (lVar.D) {
            ...
            if (view != null) {
                ...
                SparseArray<Parcelable> sparseArray = lVar.f1629d;
                if (sparseArray != null) {
                    view.restoreHierarchyState(sparseArray);
                    lVar.f1629d = null;
                }
                if (lVar.F != null) {
                    lVar.Q.c.a(lVar.f1630e);
                    lVar.f1630e = null;
                }
                lVar.D = false;
                lVar.h0(bundle2);
                if (!lVar.D) {
                    throw new f1(f.a.a.a.a.s("Fragment ", lVar, " did not call through to super.onViewStateRestored()"));
                } else if (lVar.F != null) {
                    lVar.Q.b(g.a.ON_CREATE);
                }
            }
            lVar.c = null;
            f0 f0Var = lVar.u;
            ...
            e0 e0Var = this.a;
            l lVar2 = this.c;
            e0Var.a(lVar2, lVar2.c, false);
            return;
        }
        throw new f1(f.a.a.a.a.s("Fragment ", lVar, " did not call through to super.onActivityCreated()"));
    }
    ...
    public void b() {
        ...
        m0 m0Var = null;
        if (lVar2 != null) {
            m0 i2 = this.b.i(lVar2.f1631f);
            if (i2 != null) {
                l lVar3 = this.c;
                lVar3.f1634i = lVar3.f1633h.f1631f;
                lVar3.f1633h = null;
                m0Var = i2;
            } else {
                ...
                h3.append(this.c.f1633h);
                h3.append(" that does not belong to this FragmentManager!");
                throw new IllegalStateException(h3.toString());
            }
        } else {
            String str = lVar.f1634i;
            if (str != null && (m0Var = this.b.i(str)) == null) {
                StringBuilder h4 = f.a.a.a.a.h("Fragment ");
                h4.append(this.c);
                h4.append(" declared target fragment ");
                throw new IllegalStateException(f.a.a.a.a.e(h4, this.c.f1634i, " that does not belong to this FragmentManager!"));
            }
        }
        if (m0Var != null && (f0.L || m0Var.c.b < 1)) {
            m0Var.j();
        }
        l lVar4 = this.c;
        f0 f0Var = lVar4.s;
        ...
        l lVar5 = this.c;
        Iterator<l.e> it = lVar5.V.iterator();
        while (it.hasNext()) {
            it.next().a();
        }
        lVar5.V.clear();
        lVar5.u.c(lVar5.t, lVar5.b(), lVar5);
        lVar5.b = 0;
        lVar5.D = false;
        lVar5.K(lVar5.t.c);
        if (lVar5.D) {
            f0 f0Var2 = lVar5.s;
            Iterator<k0> it2 = f0Var2.o.iterator();
            while (it2.hasNext()) {
                it2.next().b(f0Var2, lVar5);
            }
            f0 f0Var3 = lVar5.u;
            f0Var3.B = false;
            f0Var3.C = false;
            f0Var3.J.f1628h = false;
            f0Var3.x(0);
            this.a.b(this.c, false);
            return;
        }
        throw new f1(f.a.a.a.a.s("Fragment ", lVar5, " did not call through to super.onAttach()"));
    }
    ...
    public int c() {
        ...
        c1.d.b bVar = null;
        if (f0.L && (viewGroup = (lVar = this.c).E) != null && (dVar = c1.e(viewGroup, lVar.t().O()).c.get(this.c)) != null && !dVar.f1589d.b()) {
            bVar = dVar.b;
        }
    ...
    public void d() {
        ...
        if (!lVar.N) {
            ...
            if (lVar2.D) {
                ...
                e0 e0Var = this.a;
                l lVar3 = this.c;
                e0Var.c(lVar3, lVar3.c, false);
                return;
            }
            throw new f1(f.a.a.a.a.s("Fragment ", lVar2, " did not call through to super.onCreate()"));
        }
        lVar.p0(lVar.c);
        this.c.b = 1;
    }
    ...
    public void e() {
        ...
        if (!this.c.n) {
            ...
            if (viewGroup2 != null) {
                ...
                if (i2 != 0) {
                    if (i2 != -1) {
                        viewGroup = (ViewGroup) lVar2.s.r.e(i2);
                        if (viewGroup == null) {
                            l lVar3 = this.c;
                            if (!lVar3.p) {
                                try {
            ...
            if (view != null) {
                ...
                e0 e0Var = this.a;
                l lVar8 = this.c;
                e0Var.m(lVar8, lVar8.F, lVar8.c, false);
                int visibility = this.c.F.getVisibility();
                if (f0.L) {
                    this.c.f().f1644j = visibility;
                    l lVar9 = this.c;
                    if (lVar9.E != null && visibility == 0) {
                        lVar9.f().f1645k = lVar9.F.findFocus();
    ...
    public void f() {
        ...
        if (z2 || this.b.c.d(this.c)) {
            ...
            if (z2 || z) {
                ...
                j0 j0Var2 = j0Var.f1624d.get(lVar2.f1631f);
                if (j0Var2 != null) {
                    j0Var2.a();
                    j0Var.f1624d.remove(lVar2.f1631f);
                }
                c0 c0Var2 = j0Var.f1625e.get(lVar2.f1631f);
                if (c0Var2 != null) {
                    c0Var2.a();
                    j0Var.f1625e.remove(lVar2.f1631f);
                }
            }
            l lVar3 = this.c;
            lVar3.u.p();
            ...
            while (it.hasNext()) {
                ...
                if (m0Var != null) {
                    l lVar4 = m0Var.c;
                    if (this.c.f1631f.equals(lVar4.f1634i)) {
                        lVar4.f1633h = this.c;
                        lVar4.f1634i = null;
                    }
                }
            ...
            l lVar5 = this.c;
            String str2 = lVar5.f1634i;
            if (str2 != null) {
                lVar5.f1633h = this.b.d(str2);
            }
            this.b.l(this);
            return;
        }
        String str3 = this.c.f1634i;
    ...
    public void h() {
        ...
        if (lVar.D) {
            ...
            if ((lVar2.m && !lVar2.E()) || this.b.c.d(this.c)) {
                ...
                lVar3.P = new k(lVar3);
                lVar3.T = new b(lVar3);
                lVar3.f1631f = UUID.randomUUID().toString();
                lVar3.f1637l = false;
                lVar3.m = false;
                lVar3.n = false;
                lVar3.o = false;
        ...
        throw new f1(f.a.a.a.a.s("Fragment ", lVar, " did not call through to super.onDetach()"));
    }
    ...
    public void i() {
        ...
        if (lVar.n && lVar.o && !lVar.q) {
            ...
            if (view != null) {
                ...
                e0 e0Var = this.a;
                l lVar6 = this.c;
                e0Var.m(lVar6, lVar6.F, lVar6.c, false);
                this.c.b = 2;
            }
        }
    }
                    ...
                    if (c2 == i2) {
                        if (f0.L && lVar.K) {
                            if (!(lVar.F == null || lVar.E == null)) {
                                e.i.e.a aVar = this.f1659g;
                                if (aVar != null) {
                                    aVar.a();
                                }
                                l lVar2 = this.c;
                                c1 e2 = c1.e(lVar2.E, lVar2.t().O());
                                e.i.e.a aVar2 = new e.i.e.a();
                                this.f1659g = aVar2;
                                if (this.c.z) {
                                    e2.a(c1.d.c.GONE, bVar, this, aVar2);
                                } else {
                                    e2.a(c1.d.c.VISIBLE, bVar, this, aVar2);
                                }
                            }
                            l lVar3 = this.c;
                            lVar3.K = z;
                        ...
                        switch (i3) {
                            ...
                            case 4:
                                ...
                                if (!(view == null || lVar4.E == null)) {
                                    ...
                                    l lVar6 = this.c;
                                    c1 e3 = c1.e(lVar6.E, lVar6.t().O());
                                    e.i.e.a aVar4 = this.f1659g;
                                    if (aVar4 != null) {
                                        aVar4.a();
                                    }
                                    this.f1658f = new e.i.e.a();
                                    l.c cVar = this.c.I;
                                    e3.a(c1.d.c.b(cVar == null ? 0 : cVar.f1644j), c1.d.b.ADDING, this, this.f1658f);
                                }
                                this.c.b = 4;
                                continue;
                            case 5:
                        ...
                        switch (i4) {
                            ...
                            case 3:
                                ...
                                l lVar7 = this.c;
                                if (lVar7.F != null && lVar7.f1629d == null) {
                                    o();
                                }
                                l lVar8 = this.c;
                                if (!(lVar8.F == null || (viewGroup = lVar8.E) == null || this.f1657e <= -1)) {
                                    c1 e4 = c1.e(viewGroup, lVar8.t().O());
                                    e.i.e.a aVar6 = this.f1659g;
                                    if (aVar6 != null) {
                                        aVar6.a();
                                    }
                                    e.i.e.a aVar7 = new e.i.e.a();
                                    this.f1660h = aVar7;
                                    e4.a(c1.d.c.REMOVED, c1.d.b.REMOVING, this, aVar7);
                                }
                                this.c.b = 3;
                                continue;
                            case 4:
    ...
    public void k() {
        ...
        throw new f1(f.a.a.a.a.s("Fragment ", lVar, " did not call through to super.onPause()"));
    }
    ...
    public void l(ClassLoader classLoader) {
        ...
        if (bundle != null) {
            bundle.setClassLoader(classLoader);
            l lVar = this.c;
            lVar.f1629d = lVar.c.getSparseParcelableArray("android:view_state");
            l lVar2 = this.c;
            lVar2.f1630e = lVar2.c.getBundle("android:view_registry_state");
            l lVar3 = this.c;
            lVar3.f1634i = lVar3.c.getString("android:target_state");
            l lVar4 = this.c;
            if (lVar4.f1634i != null) {
                lVar4.f1635j = lVar4.c.getInt("android:target_req_state", 0);
            }
            l lVar5 = this.c;
    ...
    public void m() {
        ...
        throw new f1(f.a.a.a.a.s("Fragment ", lVar, " did not call through to super.onResume()"));
    }
    ...
    public final Bundle n() {
        ...
        if (this.c.f1629d != null) {
            if (bundle == null) {
                bundle = new Bundle();
            }
            bundle.putSparseParcelableArray("android:view_state", this.c.f1629d);
        }
        if (this.c.f1630e != null) {
            if (bundle == null) {
                bundle = new Bundle();
            }
            bundle.putBundle("android:view_registry_state", this.c.f1630e);
        }
        if (!this.c.H) {
            if (bundle == null) {
                bundle = new Bundle();
    ...
    public void o() {
        if (this.c.F != null) {
            ...
            if (sparseArray.size() > 0) {
                this.c.f1629d = sparseArray;
            }
            Bundle bundle = new Bundle();
            this.c.Q.c.b(bundle);
            if (!bundle.isEmpty()) {
                this.c.f1630e = bundle;
            }
        }
    }
    ...
    public void p() {
        ...
        throw new f1(f.a.a.a.a.s("Fragment ", lVar, " did not call through to super.onStart()"));
    }
    ...
    public void q() {
        ...
        throw new f1(f.a.a.a.a.s("Fragment ", lVar, " did not call through to super.onStop()"));
    }
}
