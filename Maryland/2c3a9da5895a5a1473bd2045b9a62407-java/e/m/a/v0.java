...
public class v0 {
    ...
    public static final x0 b = new w0();
    ...
    static {
        x0 x0Var;
        try {
            x0Var = (x0) Class.forName("e.w.d").getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
    ...
    public static void a(ArrayList<View> arrayList, e.e.a<String, View> aVar, Collection<String> collection) {
        for (int i2 = aVar.f1211d - 1; i2 >= 0; i2--) {
            View k2 = aVar.k(i2);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0038, code lost:
        if (r0.f1637l != false) goto L_0x0087;
     */
    ...
    public static void b(a aVar, o0.a aVar2, SparseArray<b> sparseArray, boolean z, boolean z2) {
        int i2;
        boolean z3;
        boolean z4;
        b bVar;
            ...
            if (i3 != 1) {
                if (i3 != 3) {
                    if (i3 != 4) {
                        ...
                        if (!z2 && z3) {
                            if (bVar != null && bVar.f1705d == lVar) {
                                bVar.f1705d = null;
                            }
                            if (!aVar.p) {
                                f0 f0Var = aVar.q;
                                f0Var.c.k(f0Var.i(lVar));
                                f0Var.Y(lVar, f0Var.p);
                            }
                        }
                        if (z4 && (bVar == null || bVar.f1705d == null)) {
                            if (bVar == null) {
                                b bVar3 = new b();
    ...
    public static boolean d(x0 x0Var, List<Object> list) {
        int size = list.size();
        for (int i2 = 0; i2 < size; i2++) {
            if (!x0Var.e(list.get(i2))) {
                return false;
            }
        }
        return true;
    ...
    public static e.e.a<String, View> e(x0 x0Var, e.e.a<String, String> aVar, Object obj, b bVar) {
    ...
    public static e.e.a<String, View> f(x0 x0Var, e.e.a<String, String> aVar, Object obj, b bVar) {
        ArrayList<String> arrayList;
    ...
    public static x0 g(l lVar, l lVar2) {
        ...
        x0 x0Var = b;
        if (d(x0Var, arrayList)) {
            return x0Var;
        }
        x0 x0Var2 = c;
        if (x0Var2 != null && d(x0Var2, arrayList)) {
            return x0Var2;
        }
        throw new IllegalArgumentException("Invalid Transition types");
    }

    public static ArrayList<View> h(x0 x0Var, Object obj, l lVar, ArrayList<View> arrayList, View view) {
        if (obj == null) {
            return null;
        }
        ...
        arrayList2.add(view);
        x0Var.b(obj, arrayList2);
        return arrayList2;
    }

    public static Object i(x0 x0Var, l lVar, boolean z) {
        Object obj = null;
        if (lVar == null) {
            return null;
        }
    ...
    public static Object j(x0 x0Var, l lVar, boolean z) {
        Object obj = null;
        if (lVar == null) {
            return null;
        }
    ...
    public static Object l(x0 x0Var, l lVar, l lVar2, boolean z) {
        Object obj;
        if (z) {
            obj = lVar2.y();
        } else {
    ...
    public static void n(x0 x0Var, Object obj, Object obj2, e.e.a<String, View> aVar, boolean z, a aVar2) {
    ...
    public static void p(Context context, y yVar, ArrayList<a> arrayList, ArrayList<Boolean> arrayList2, int i2, int i3, boolean z, a aVar) {
        int i4;
        ...
        if (sparseArray2.size() != 0) {
            ...
            while (i12 < size3) {
                ...
                if (!yVar.g() || (viewGroup = (ViewGroup) yVar.e(keyAt)) == null) {
                    ...
                    if (z3) {
                        ...
                        if (g2 == null) {
                            ...
                            if (lVar8 == null || lVar9 == null) {
                                ...
                                if (i14 == null && j2 == null && obj8 == null) {
                                    ...
                                    if (obj8 != null) {
                                        ...
                                        arrayList5 = arrayList12;
                                        n(g2, obj8, j2, f2, bVar.f1706e, bVar.f1707f);
                                        Rect rect3 = new Rect();
                                    ...
                                    l.a(viewGroup, new t0(lVar8, lVar9, z6, e2, view, g2, rect2));
                                    obj6 = obj8;
                                    if (!(i14 == null && obj6 == null && j2 == null)) {
                                        ...
                                        if (!(lVar7 == null || h2 == null || (h2.size() <= 0 && arrayList13.size() <= 0))) {
                                            ...
                                            f0.d dVar = (f0.d) aVar;
                                            dVar.b(lVar7, aVar8);
                                            g2.u(lVar7, m2, aVar8, new p0(dVar, lVar7, aVar8));
                                        }
                                        if (m2 != null) {
                                            if (lVar7 != null && j2 != null && lVar7.f1637l && lVar7.z && lVar7.K) {
                                                lVar7.t0(true);
                                                g2.q(j2, lVar7.F, h2);
                                                l.a(lVar7.E, new q0(h2));
                                            }
                            ...
                            f0.d dVar2 = (f0.d) aVar;
                            dVar2.b(lVar7, aVar82);
                            g2.u(lVar7, m2, aVar82, new p0(dVar2, lVar7, aVar82));
                            if (m2 != null) {
                            }
                        }
                    } else {
                        ...
                        i7 = size3;
                        l lVar10 = bVar.a;
                        l lVar11 = bVar.f1705d;
                        x0 g3 = g(lVar11, lVar10);
                        if (g3 != null) {
                            boolean z7 = bVar.b;
                            boolean z8 = bVar.f1706e;
                            Object i15 = i(g3, lVar10, z7);
                            Object j3 = j(g3, lVar11, z8);
                            ArrayList<View> arrayList14 = new ArrayList<>();
                            ArrayList<View> arrayList15 = new ArrayList<>();
                            l lVar12 = bVar.a;
                            l lVar13 = bVar.f1705d;
                            if (lVar12 == null || lVar13 == null) {
                                ...
                                if (i15 == null && j3 == null && obj4 == null) {
                                    ...
                                    if (obj4 != null) {
                                        ...
                                        n(g3, obj5, j3, f3, bVar.f1706e, bVar.f1707f);
                                        if (i15 != null) {
                                            g3.s(i15, rect);
                                        }
                                    } else {
                                    ...
                                    obj2 = j3;
                                    i5 = i7;
                                    l.a(viewGroup, new u0(g3, aVar3, obj5, bVar, arrayList4, view2, lVar4, lVar3, z2, arrayList3, i15, rect));
                                    obj = obj5;
                                    if (i15 == null || obj != null || obj2 != null) {
                                        ...
                                        if (!(lVar == null || h4 == null || (h4.size() <= 0 && arrayList3.size() <= 0))) {
                                            ...
                                            f0.d dVar3 = (f0.d) aVar;
                                            dVar3.b(lVar, aVar10);
                                            g3.u(lVar, m, aVar10, new r0(dVar3, lVar, aVar10));
                                        }
                                        if (m == null) {
                                            ArrayList<View> arrayList16 = new ArrayList<>();
                                            g3.r(m, i15, arrayList16, obj2, h4, obj, arrayList4);
                                            l.a(viewGroup, new s0(i15, g3, view2, lVar2, arrayList4, arrayList16, h4, obj2));
                                            l.a(viewGroup, new y0(g3, arrayList4, aVar9));
                                            g3.c(viewGroup, m);
                                            l.a(viewGroup, new z0(g3, arrayList4, aVar9));
                                        }
                                    }
                                }
                            }
                            ...
                            f0.d dVar32 = (f0.d) aVar;
                            dVar32.b(lVar, aVar102);
                            g3.u(lVar, m, aVar102, new r0(dVar32, lVar, aVar102));
                            if (m == null) {
                            }
                        }
                    }
