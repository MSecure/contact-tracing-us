...
public abstract class x0 {
    ...
    public class a implements Runnable {
        ...
        public final /* synthetic */ ArrayList f1715d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ ArrayList f1716e;

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ ArrayList f1717f;

        public a(x0 x0Var, int i2, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
            this.b = i2;
            this.c = arrayList;
            this.f1715d = arrayList2;
            this.f1716e = arrayList3;
            this.f1717f = arrayList4;
        }

        public void run() {
            for (int i2 = 0; i2 < this.b; i2++) {
                AtomicInteger atomicInteger = m.a;
                ((View) this.c.get(i2)).setTransitionName((String) this.f1715d.get(i2));
                ((View) this.f1716e.get(i2)).setTransitionName((String) this.f1717f.get(i2));
            }
        }
    }
    ...
    public void v(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        l.a(view, new a(this, size, arrayList2, arrayList3, arrayList, arrayList4));
    }
