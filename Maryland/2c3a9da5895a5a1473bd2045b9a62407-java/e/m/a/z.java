...
public final class z extends FrameLayout {
    ...
    public z(Context context, AttributeSet attributeSet, f0 f0Var) {
        ...
        if (classAttribute != null && I == null) {
            ...
            l a = f0Var.M().a(context.getClassLoader(), classAttribute);
    ...
    public boolean drawChild(Canvas canvas, View view, long j2) {
        ArrayList<View> arrayList;
        if (!this.f1718d || (arrayList = this.b) == null || arrayList.size() <= 0 || !this.b.contains(view)) {
