...
public final class c {
    ...
    public static class a {
        public final Map<g.a, List<b>> a = new HashMap();
        public final Map<b, g.a> b;

        public a(Map<b, g.a> map) {
            this.b = map;
        ...
        public static void a(List<b> list, j jVar, g.a aVar, Object obj) {
            if (list != null) {
                for (int size = list.size() - 1; size >= 0; size--) {
                    ...
                    try {
                        ...
                        if (i2 == 0) {
                            ...
                            bVar.b.invoke(obj, jVar);
                        } else if (i2 == 2) {
                            bVar.b.invoke(obj, jVar, aVar);
                        }
    ...
    public final a a(Class<?> cls, Method[] methodArr) {
        ...
        for (Class<?> cls2 : cls.getInterfaces()) {
            for (Map.Entry<b, g.a> entry : b(cls2).b.entrySet()) {
    ...
    public final void c(Map<b, g.a> map, b bVar, g.a aVar, Class<?> cls) {
