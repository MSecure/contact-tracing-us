...
public class b extends a {
    ...
    public static class C0049b extends a0 {

        /* renamed from: d  reason: collision with root package name */
        public static final b0.b f1738d = new a();
        public i<a> c = new i<>();
    ...
    public b(j jVar, c0 c0Var) {
        ...
        if (canonicalName != null) {
            ...
            if (!C0049b.class.isInstance(a0Var)) {
                a0Var = bVar instanceof b0.c ? ((b0.c) bVar).c(t, C0049b.class) : ((C0049b.a) bVar).a(C0049b.class);
