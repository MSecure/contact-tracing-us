...
public class a extends q<C0050a> {
    ...
    public static class C0050a extends j {
        ...
        public void k(Context context, AttributeSet attributeSet) {
            ...
            if (this.f1739j == null) {
                this.f1739j = new Intent();
            }
            this.f1739j.setPackage(string);
            ...
            if (string4 != null) {
                ...
                this.f1739j.setData(parse);
            }
            this.f1740k = obtainAttributes.getString(R$styleable.ActivityNavigator_dataPattern);
    ...
    @Override // e.r.q
    public j b(C0050a aVar, Bundle bundle, o oVar, q.a aVar2) {
        Activity activity;
        Intent intent;
        int intExtra;
        C0050a aVar3 = aVar;
        if (aVar3.f1739j != null) {
            Intent intent2 = new Intent(aVar3.f1739j);
            if (bundle != null) {
                intent2.putExtras(bundle);
                String str = aVar3.f1740k;
            ...
            intent2.putExtra("android-support-navigation:ActivityNavigator:current", aVar3.f1759d);
            if (oVar != null) {
                intent2.putExtra("android-support-navigation:ActivityNavigator:popEnterAnim", oVar.f1774f);
                intent2.putExtra("android-support-navigation:ActivityNavigator:popExitAnim", oVar.f1775g);
            }
            if (z) {
                Objects.requireNonNull((b) aVar2);
            }
