...
public class a implements o.a {
    ...
    public final AbstractC0053a f1787d;
    ...
    public static class b {
        ...
        public boolean equals(Object obj) {
            ...
            if (i2 == 8 && Math.abs(this.f1790d - this.b) == 1 && this.f1790d == bVar.b && this.b == bVar.f1790d) {
                return true;
            }
            if (this.f1790d != bVar.f1790d || this.b != bVar.b) {
                return false;
            }
            Object obj2 = this.c;
            Object obj3 = bVar.c;
        ...
        public int hashCode() {
            return (((this.a * 31) + this.b) * 31) + this.f1790d;
        }
    ...
    public final boolean a(int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            ...
            int i4 = bVar.a;
            if (i4 == 8) {
                if (f(bVar.f1790d, i3 + 1) == i2) {
                    return true;
                }
            } else if (i4 == 1) {
                int i5 = bVar.b;
                int i6 = bVar.f1790d + i5;
                while (i5 < i6) {
                    if (f(i5, i3 + 1) == i2) {
                        return true;
                    }
    ...
    public void c() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            int i3 = bVar.a;
            if (i3 == 1) {
                ((v) this.f1787d).a(bVar);
                ((v) this.f1787d).d(bVar.b, bVar.f1790d);
            } else if (i3 == 2) {
                ((v) this.f1787d).a(bVar);
                AbstractC0053a aVar = this.f1787d;
                int i4 = bVar.b;
                int i5 = bVar.f1790d;
                v vVar = (v) aVar;
                vVar.a.R(i4, i5, true);
                ...
                ((v) this.f1787d).a(bVar);
                ((v) this.f1787d).c(bVar.b, bVar.f1790d, bVar.c);
            } else if (i3 == 8) {
                ((v) this.f1787d).a(bVar);
                ((v) this.f1787d).e(bVar.b, bVar.f1790d);
            }
        }
        l(this.b);
        this.f1789f = 0;
    ...
    public final void d(b bVar) {
        ...
        int i6 = 1;
        for (int i7 = 1; i7 < bVar.f1790d; i7++) {
    ...
    public void e(b bVar, int i2) {
        ...
        if (i3 == 2) {
            ...
            ((v) this.f1787d).c(i2, bVar.f1790d, bVar.c);
        } else {
    ...
    public final void i(b bVar) {
        ...
        if (i2 == 1) {
            ...
            AbstractC0053a aVar = this.f1787d;
            v vVar = (v) aVar;
            vVar.a.R(bVar.b, bVar.f1790d, false);
            vVar.a.l0 = true;
        } else if (i2 == 4) {
            ((v) this.f1787d).c(bVar.b, bVar.f1790d, bVar.c);
        } else if (i2 == 8) {
    ...
    public void j() {
        ...
        while (true) {
            ...
            if (i8 == 1) {
                ...
                if (i10 <= i12) {
                    bVar3.b = i12 + bVar4.f1790d;
                }
                int i13 = bVar4.b;
                if (i13 <= i9) {
                    bVar3.f1790d = i9 + bVar4.f1790d;
                }
                bVar4.b = i13 + i11;
                ...
                int i14 = bVar3.b;
                int i15 = bVar3.f1790d;
                int i16 = bVar4.b;
                if (i14 < i15) {
                    if (i16 == i14 && bVar4.f1790d == i15 - i14) {
                        z4 = false;
                    } else {
                        z3 = false;
                        z2 = false;
                        ...
                        if (i2 <= i3) {
                            ...
                            int i18 = i3 + bVar4.f1790d;
                            if (i2 < i18) {
                                bVar2 = ((a) oVar.a).h(2, i2 + 1, i18 - i2, null);
                                bVar4.f1790d = bVar3.b - bVar4.b;
                            }
                        }
                        if (z3) {
                            arrayList.set(size, bVar4);
                            ...
                            if (z2) {
                                if (bVar2 != null) {
                                    int i19 = bVar3.b;
                                    if (i19 > bVar2.b) {
                                        bVar3.b = i19 - bVar2.f1790d;
                                    }
                                    int i20 = bVar3.f1790d;
                                    if (i20 > bVar2.b) {
                                        bVar3.f1790d = i20 - bVar2.f1790d;
                                    }
                                }
                                int i21 = bVar3.b;
                                if (i21 > bVar4.b) {
                                    bVar3.b = i21 - bVar4.f1790d;
                                }
                                i4 = bVar3.f1790d;
                            } else {
                                if (bVar2 != null) {
                                    int i22 = bVar3.b;
                                    if (i22 >= bVar2.b) {
                                        bVar3.b = i22 - bVar2.f1790d;
                                    }
                                    int i23 = bVar3.f1790d;
                                    if (i23 >= bVar2.b) {
                                        bVar3.f1790d = i23 - bVar2.f1790d;
                                    }
                                }
                                int i24 = bVar3.b;
                                if (i24 >= bVar4.b) {
                                    bVar3.b = i24 - bVar4.f1790d;
                                }
                                i4 = bVar3.f1790d;
                            }
                            bVar3.f1790d = i4 - bVar4.f1790d;
                            arrayList.set(size, bVar4);
                            if (bVar3.b != bVar3.f1790d) {
                                arrayList.set(i7, bVar3);
                            } else {
                                arrayList.remove(i7);
                            }
                ...
                } else if (i16 == i15 + 1 && bVar4.f1790d == i14 - i15) {
                    z4 = true;
                } else {
                    z3 = false;
                    z2 = true;
                ...
                int i25 = bVar3.f1790d;
                int i26 = bVar4.b;
                if (i25 < i26) {
                    bVar4.b = i26 - 1;
                } else {
                    int i27 = bVar4.f1790d;
                    if (i25 < i26 + i27) {
                        bVar4.f1790d = i27 - 1;
        ...
        for (int i30 = 0; i30 < size2; i30++) {
            ...
            if (i31 == 1) {
                ...
                int i32 = bVar5.b;
                int i33 = bVar5.f1790d + i32;
                int i34 = i32;
                int i35 = 0;
                char c3 = 65535;
                while (i34 < i33) {
                    if (((v) this.f1787d).b(i34) != null || a(i34)) {
                        if (c3 == 0) {
                            d(h(2, i32, i35, null));
                            z = true;
                        } else {
                ...
                int i36 = bVar5.b;
                int i37 = bVar5.f1790d + i36;
                int i38 = i36;
                int i39 = 0;
                char c4 = 65535;
                while (i36 < i37) {
                    if (((v) this.f1787d).b(i36) != null || a(i36)) {
                        if (c4 == 0) {
    ...
    public final int m(int i2, int i3) {
        ...
        for (int size2 = this.c.size() - 1; size2 >= 0; size2--) {
            ...
            if (bVar2.a == 8) {
                int i14 = bVar2.f1790d;
                if (i14 != bVar2.b && i14 >= 0) {
                }
            } else if (bVar2.f1790d > 0) {
            }
            this.c.remove(size2);
            k(bVar2);
        }
