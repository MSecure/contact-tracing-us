...
public class c extends x {
    ...
    public ArrayList<RecyclerView.b0> f1792h = new ArrayList<>();

    /* renamed from: i  reason: collision with root package name */
    public ArrayList<RecyclerView.b0> f1793i = new ArrayList<>();

    /* renamed from: j  reason: collision with root package name */
    public ArrayList<e> f1794j = new ArrayList<>();

    /* renamed from: k  reason: collision with root package name */
    public ArrayList<d> f1795k = new ArrayList<>();

    /* renamed from: l  reason: collision with root package name */
    public ArrayList<ArrayList<RecyclerView.b0>> f1796l = new ArrayList<>();
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            while (it.hasNext()) {
                ...
                cVar.p.add(b0Var);
                animate.setDuration(cVar.f230e).setListener(new f(cVar, b0Var, i6, view, i7, animate)).start();
            }
            this.b.clear();
    ...
    public class b implements Runnable {
        ...
        public void run() {
            ...
            while (it.hasNext()) {
                ...
                if (view2 != null) {
                    ViewPropertyAnimator duration = view2.animate().setDuration(cVar.f231f);
                    cVar.r.add(dVar.a);
                    duration.translationX((float) (dVar.f1798e - dVar.c));
                    duration.translationY((float) (dVar.f1799f - dVar.f1797d));
                    duration.alpha(0.0f).setListener(new g(cVar, dVar, duration, view2)).start();
                }
                if (view != null) {
                    ViewPropertyAnimator animate = view.animate();
                    cVar.r.add(dVar.b);
                    animate.translationX(0.0f).translationY(0.0f).setDuration(cVar.f231f).alpha(1.0f).setListener(new h(cVar, dVar, animate, view)).start();
                }
            }
            this.b.clear();
    ...
    public class RunnableC0055c implements Runnable {
        ...
        public RunnableC0055c(ArrayList arrayList) {
            this.b = arrayList;
        }
    ...
    public static class d {
        ...
        public String toString() {
            ...
            h2.append(this.c);
            h2.append(", fromY=");
            h2.append(this.f1797d);
            h2.append(", toX=");
            h2.append(this.f1798e);
            h2.append(", toY=");
            h2.append(this.f1799f);
            h2.append('}');
            return h2.toString();
        }
    }
    ...
    public void i(RecyclerView.b0 b0Var) {
        ...
        while (true) {
            ...
            if (size < 0) {
                break;
            } else if (this.f1794j.get(size).a == b0Var) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                g(b0Var);
                this.f1794j.remove(size);
            }
        }
        r(this.f1795k, b0Var);
        if (this.f1792h.remove(b0Var)) {
            view.setAlpha(1.0f);
            g(b0Var);
        }
        if (this.f1793i.remove(b0Var)) {
            view.setAlpha(1.0f);
            g(b0Var);
        }
        ...
        int size5 = this.f1796l.size();
        while (true) {
            size5--;
            if (size5 >= 0) {
                ArrayList<RecyclerView.b0> arrayList3 = this.f1796l.get(size5);
                if (arrayList3.remove(b0Var)) {
                    view.setAlpha(1.0f);
                    g(b0Var);
                    if (arrayList3.isEmpty()) {
                        this.f1796l.remove(size5);
                    }
                }
            } else {
                this.q.remove(b0Var);
    ...
    public void j() {
        ...
        int size2 = this.f1792h.size();
        while (true) {
            size2--;
            if (size2 < 0) {
                break;
            }
            g(this.f1792h.get(size2));
            this.f1792h.remove(size2);
        }
        int size3 = this.f1793i.size();
        while (true) {
            size3--;
            if (size3 < 0) {
                break;
            }
            RecyclerView.b0 b0Var = this.f1793i.get(size3);
            b0Var.a.setAlpha(1.0f);
            g(b0Var);
            this.f1793i.remove(size3);
        }
        int size4 = this.f1795k.size();
        while (true) {
            size4--;
            if (size4 < 0) {
                break;
            }
            d dVar = this.f1795k.get(size4);
        ...
        if (k()) {
            ...
            int size7 = this.f1796l.size();
            while (true) {
                size7--;
                if (size7 < 0) {
                    break;
                }
                ArrayList<RecyclerView.b0> arrayList2 = this.f1796l.get(size7);
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.j
    public boolean k() {
        return !this.f1793i.isEmpty() || !this.f1795k.isEmpty() || !this.f1794j.isEmpty() || !this.f1792h.isEmpty() || !this.p.isEmpty() || !this.q.isEmpty() || !this.o.isEmpty() || !this.r.isEmpty() || !this.m.isEmpty() || !this.f1796l.isEmpty() || !this.n.isEmpty();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.j
    public void m() {
        boolean z = !this.f1792h.isEmpty();
        boolean z2 = !this.f1794j.isEmpty();
        boolean z3 = !this.f1795k.isEmpty();
        boolean z4 = !this.f1793i.isEmpty();
        if (z || z2 || z4 || z3) {
            Iterator<RecyclerView.b0> it = this.f1792h.iterator();
            while (it.hasNext()) {
                RecyclerView.b0 next = it.next();
                View view = next.a;
                ViewPropertyAnimator animate = view.animate();
                this.q.add(next);
                animate.setDuration(this.f229d).alpha(0.0f).setListener(new d(this, next, animate, view)).start();
            }
            this.f1792h.clear();
            if (z2) {
                ArrayList<e> arrayList = new ArrayList<>();
                arrayList.addAll(this.f1794j);
            ...
            if (z4) {
                ...
                arrayList3.addAll(this.f1793i);
                this.f1796l.add(arrayList3);
                this.f1793i.clear();
                RunnableC0055c cVar = new RunnableC0055c(arrayList3);
                if (z || z2 || z3) {
                    long j4 = 0;
                    long j5 = z ? this.f229d : 0;
                    long j6 = z2 ? this.f230e : 0;
                    if (z3) {
                        j4 = this.f231f;
                    }
    ...
    public boolean n(RecyclerView.b0 b0Var, int i2, int i3, int i4, int i5) {
        ...
        this.f1794j.add(new e(b0Var, translationX, translationY, i4, i5));
        return true;
    }
