...
public class n extends RecyclerView.x {
    ...
    public final DisplayMetrics f1855l;
    ...
    public n(Context context) {
        this.f1855l = context.getResources().getDisplayMetrics();
    }
    ...
    public void c(View view, RecyclerView.y yVar, RecyclerView.x.a aVar) {
        ...
        if (mVar2 != null && mVar2.g()) {
            ...
            i5 = e(mVar2.I(view) - ((ViewGroup.MarginLayoutParams) nVar2).topMargin, mVar2.C(view) + ((ViewGroup.MarginLayoutParams) nVar2).bottomMargin, mVar2.R(), mVar2.q - mVar2.O(), i7);
        }
        int ceil = (int) Math.ceil(((double) g((int) Math.sqrt((double) ((i5 * i5) + (i2 * i2))))) / 0.3356d);
        if (ceil > 0) {
            aVar.b(-i2, -i5, ceil, this.f1853j);
        }
    }
