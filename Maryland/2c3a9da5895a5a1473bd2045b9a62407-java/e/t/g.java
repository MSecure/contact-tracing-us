...
public abstract class g {
    ...
    public List<b> f1889h;

    /* renamed from: i  reason: collision with root package name */
    public final ReentrantReadWriteLock f1890i = new ReentrantReadWriteLock();

    /* renamed from: j  reason: collision with root package name */
    public final ThreadLocal<Integer> f1891j = new ThreadLocal<>();
    ...
    public static class a<T extends g> {
        ...
        /* renamed from: d  reason: collision with root package name */
        public ArrayList<b> f1892d;

        /* renamed from: e  reason: collision with root package name */
        public Executor f1893e;

        /* renamed from: f  reason: collision with root package name */
        public Executor f1894f;

        /* renamed from: g  reason: collision with root package name */
        public c.AbstractC0059c f1895g;
        ...
        public final d f1899k = new d();

        /* renamed from: l  reason: collision with root package name */
        public Set<Integer> f1900l;
        ...
        public T b() {
            ...
            if (this.c == null) {
                ...
                Executor executor2 = this.f1893e;
                if (executor2 == null && this.f1894f == null) {
                    executor = e.c.a.a.a.f992d;
                    this.f1894f = executor;
                } else if (executor2 == null || this.f1894f != null) {
                    if (executor2 == null) {
                        executor = this.f1894f;
                    }
                    set = this.m;
                    if (!(set == null || this.f1900l == null)) {
                        for (Integer num : set) {
                            if (this.f1900l.contains(num)) {
                                throw new IllegalArgumentException("Inconsistency detected. A Migration was supplied to addMigration(Migration... migrations) that has a start or end version equal to a start version supplied to fallbackToDestructiveMigrationFrom(int... startVersions). Start version: " + num);
                            }
                        }
                    }
                    if (this.f1895g == null) {
                        this.f1895g = new e.v.a.f.d();
                    }
                    Context context = this.c;
                    String str2 = this.b;
                    c.AbstractC0059c cVar3 = this.f1895g;
                    d dVar = this.f1899k;
                    ArrayList<b> arrayList = this.f1892d;
                    boolean z = this.f1896h;
                    ...
                    aVar = new a(context, str2, cVar3, dVar, arrayList, z, cVar, this.f1893e, this.f1894f, false, this.f1897i, this.f1898j, this.f1900l, null, null);
                    Class<T> cls = this.a;
                    ...
                    if (aVar.f1867g != cVar2) {
                        z2 = false;
                    }
                    f2.setWriteAheadLoggingEnabled(z2);
                    t.f1889h = aVar.f1865e;
                    t.b = aVar.f1868h;
                    t.c = new m(aVar.f1869i);
                    t.f1887f = aVar.f1866f;
                    t.f1888g = z2;
                    return t;
                } else {
                    this.f1894f = executor2;
                    set = this.m;
                    while (r2.hasNext()) {
                    }
                    if (this.f1895g == null) {
                    ...
                    String str22 = this.b;
                    c.AbstractC0059c cVar32 = this.f1895g;
                    d dVar2 = this.f1899k;
                    ArrayList<b> arrayList2 = this.f1892d;
                    boolean z3 = this.f1896h;
                    activityManager = (ActivityManager) context2.getSystemService("activity");
                    if (activityManager != null) {
                    }
                    cVar = c.TRUNCATE;
                    aVar = new a(context2, str22, cVar32, dVar2, arrayList2, z3, cVar, this.f1893e, this.f1894f, false, this.f1897i, this.f1898j, this.f1900l, null, null);
                    Class<T> cls2 = this.a;
                    ...
                    t2.f1889h = aVar.f1865e;
                    t2.b = aVar.f1868h;
                    t2.c = new m(aVar.f1869i);
                    t2.f1887f = aVar.f1866f;
                    t2.f1888g = z22;
                    return t2;
                }
                ...
                c.AbstractC0059c cVar322 = this.f1895g;
                d dVar22 = this.f1899k;
                ArrayList<b> arrayList22 = this.f1892d;
                boolean z32 = this.f1896h;
                activityManager = (ActivityManager) context22.getSystemService("activity");
                if (activityManager != null) {
                }
                cVar = c.TRUNCATE;
                aVar = new a(context22, str222, cVar322, dVar22, arrayList22, z32, cVar, this.f1893e, this.f1894f, false, this.f1897i, this.f1898j, this.f1900l, null, null);
                ...
                try {
                    ...
                    t22.f1889h = aVar.f1865e;
                    t22.b = aVar.f1868h;
                    t22.c = new m(aVar.f1869i);
                    t22.f1887f = aVar.f1866f;
                    t22.f1888g = z222;
                    return t22;
    ...
    public f d(String str) {
        a();
        b();
        return new f(((e.v.a.f.a) this.f1885d.I()).b.compileStatement(str));
    }
    ...
    @Deprecated
    public void g() {
        ((e.v.a.f.a) this.f1885d.I()).b.endTransaction();
        if (!h()) {
            f fVar = this.f1886e;
            if (fVar.f1875e.compareAndSet(false, true)) {
                fVar.f1874d.b.execute(fVar.f1881k);
            }
        }
    }

    public boolean h() {
        return ((e.v.a.f.a) this.f1885d.I()).b.inTransaction();
    }
    ...
    public void i(e.v.a.b bVar) {
        ...
        synchronized (fVar) {
            if (fVar.f1876f) {
                ...
                fVar.i(bVar);
                fVar.f1877g = new f(((e.v.a.f.a) bVar).b.compileStatement("UPDATE room_table_modification_log SET invalidated = 0 WHERE invalidated = 1 "));
                fVar.f1876f = true;
            }
        }
    }
    ...
    public Cursor k(e eVar, CancellationSignal cancellationSignal) {
        ...
        if (cancellationSignal == null) {
            return ((e.v.a.f.a) this.f1885d.I()).d(eVar);
        }
        e.v.a.f.a aVar = (e.v.a.f.a) this.f1885d.I();
        return aVar.b.rawQueryWithFactory(new e.v.a.f.b(aVar, eVar), eVar.c(), e.v.a.f.a.c, null, cancellationSignal);
    }

    @Deprecated
    public void l() {
        ((e.v.a.f.a) this.f1885d.I()).b.setTransactionSuccessful();
    }
}
