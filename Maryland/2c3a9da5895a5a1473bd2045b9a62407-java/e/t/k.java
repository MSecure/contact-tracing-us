...
public class k implements c {
    ...
    public final void c(File file) {
        ...
        if (this.c != null) {
            ...
            readableByteChannel = new FileInputStream(this.f1913d).getChannel();
        } else {
    ...
    public final void d() {
        String databaseName = this.f1915f.getDatabaseName();
        File databasePath = this.b.getDatabasePath(databaseName);
        e.t.p.a aVar = new e.t.p.a(databaseName, this.b.getFilesDir(), this.f1916g == null);
        try {
            aVar.b.lock();
            if (aVar.c) {
                try {
    ...
    public String getDatabaseName() {
        return this.f1915f.getDatabaseName();
    }

    @Override // e.v.a.c
    public void setWriteAheadLoggingEnabled(boolean z) {
        this.f1915f.setWriteAheadLoggingEnabled(z);
    }
}
