...
public class c {
    ...
    public static class a {
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            if (this.f1923e != aVar.f1923e || !this.a.equals(aVar.a) || this.f1922d != aVar.f1922d) {
                return false;
            }
            if (this.f1925g == 1 && aVar.f1925g == 2 && (str3 = this.f1924f) != null && !str3.equals(aVar.f1924f)) {
                return false;
            }
            if (this.f1925g == 2 && aVar.f1925g == 1 && (str2 = aVar.f1924f) != null && !str2.equals(this.f1924f)) {
                return false;
            }
            int i2 = this.f1925g;
            return (i2 == 0 || i2 != aVar.f1925g || ((str = this.f1924f) == null ? aVar.f1924f == null : str.equals(aVar.f1924f))) && this.c == aVar.c;
        }

        public int hashCode() {
            return (((((this.a.hashCode() * 31) + this.c) * 31) + (this.f1922d ? 1231 : 1237)) * 31) + this.f1923e;
        }
        ...
        public String toString() {
            ...
            h2.append('\'');
            h2.append(", notNull=");
            h2.append(this.f1922d);
            h2.append(", primaryKeyPosition=");
            h2.append(this.f1923e);
            h2.append(", defaultValue='");
            h2.append(this.f1924f);
            h2.append('\'');
            h2.append('}');
            return h2.toString();
        }
    ...
    public static class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final List<String> f1926d;

        /* renamed from: e  reason: collision with root package name */
        public final List<String> f1927e;

        public b(String str, String str2, String str3, List<String> list, List<String> list2) {
            this.a = str;
            this.b = str2;
            this.c = str3;
            this.f1926d = Collections.unmodifiableList(list);
            this.f1927e = Collections.unmodifiableList(list2);
        }
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            if (this.a.equals(bVar.a) && this.b.equals(bVar.b) && this.c.equals(bVar.c) && this.f1926d.equals(bVar.f1926d)) {
                return this.f1927e.equals(bVar.f1927e);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            int hashCode3 = this.f1926d.hashCode();
            return this.f1927e.hashCode() + ((hashCode3 + ((hashCode2 + ((hashCode + (this.a.hashCode() * 31)) * 31)) * 31)) * 31);
        }
        ...
        public String toString() {
            ...
            h2.append(this.f1926d);
            h2.append(", referenceColumnNames=");
            h2.append(this.f1927e);
            h2.append('}');
            return h2.toString();
        }
    }
    ...
    public static class C0057c implements Comparable<C0057c> {
        ...
        public int compareTo(C0057c cVar) {
            C0057c cVar2 = cVar;
    ...
    public c(String str, Map<String, a> map, Set<b> set, Set<d> set2) {
        ...
        this.f1921d = set2 == null ? null : Collections.unmodifiableSet(set2);
    }
            ...
            try {
                ...
                while (i5 < count) {
                    ...
                    if (v2.getInt(columnIndex7) != 0) {
                        ...
                        while (it.hasNext()) {
                            C0057c cVar = (C0057c) it.next();
                            if (cVar.b == i6) {
                                arrayList.add(cVar.f1928d);
                                arrayList2.add(cVar.f1929e);
                            }
                            b2 = b2;
                            count = count;
                        }
    ...
    public boolean equals(Object obj) {
        ...
        Set<d> set3 = this.f1921d;
        if (set3 == null || (set = cVar.f1921d) == null) {
            return true;
        }
