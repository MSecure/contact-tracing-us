...
public final class a {
    ...
    public Recreator.a f1930d;

    /* renamed from: e  reason: collision with root package name */
    public boolean f1931e = true;
    ...
    public void c(Class<? extends AbstractC0058a> cls) {
        if (this.f1931e) {
            if (this.f1930d == null) {
                this.f1930d = new Recreator.a(this);
            }
            try {
                cls.getDeclaredConstructor(new Class[0]);
                Recreator.a aVar = this.f1930d;
