...
public class b extends h {
    ...
    public static final Property<i, PointF> B = new C0062b(PointF.class, "topLeft");
    ...
    public static class C0062b extends Property<i, PointF> {
        public C0062b(Class cls, String str) {
            super(cls, str);
        }
        ...
        public void set(i iVar, PointF pointF) {
            ...
            iVar2.b = round;
            int i2 = iVar2.f1947f + 1;
            iVar2.f1947f = i2;
            if (i2 == iVar2.f1948g) {
                s.b(iVar2.f1946e, iVar2.a, round, iVar2.c, iVar2.f1945d);
                iVar2.f1947f = 0;
                iVar2.f1948g = 0;
            }
        }
    ...
    public static class c extends Property<i, PointF> {
        ...
        public void set(i iVar, PointF pointF) {
            ...
            int round = Math.round(pointF2.y);
            iVar2.f1945d = round;
            int i2 = iVar2.f1948g + 1;
            iVar2.f1948g = i2;
            if (iVar2.f1947f == i2) {
                s.b(iVar2.f1946e, iVar2.a, iVar2.b, iVar2.c, round);
                iVar2.f1947f = 0;
                iVar2.f1948g = 0;
            }
        }
    ...
    public Animator k(ViewGroup viewGroup, p pVar, p pVar2) {
        ...
        if (i2 != 2) {
            ...
            bVar = this;
            i iVar = new i(view);
            ObjectAnimator E0 = m.h.E0(iVar, B, bVar.u.a((float) i3, (float) i5, (float) i4, (float) i6));
            ObjectAnimator E02 = m.h.E0(iVar, C, bVar.u.a((float) i7, (float) i9, (float) i8, (float) i10));
        ...
        objectAnimator = m.h.E0(view, property, path);
        if (view.getParent() instanceof ViewGroup) {
        }
        return objectAnimator;
    }
