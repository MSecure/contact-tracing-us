...
public abstract class h implements Cloneable {
    ...
    public long f1953d = -1;

    /* renamed from: e  reason: collision with root package name */
    public TimeInterpolator f1954e = null;

    /* renamed from: f  reason: collision with root package name */
    public ArrayList<Integer> f1955f = new ArrayList<>();

    /* renamed from: g  reason: collision with root package name */
    public ArrayList<View> f1956g = new ArrayList<>();

    /* renamed from: h  reason: collision with root package name */
    public q f1957h = new q();

    /* renamed from: i  reason: collision with root package name */
    public q f1958i = new q();

    /* renamed from: j  reason: collision with root package name */
    public n f1959j = null;

    /* renamed from: k  reason: collision with root package name */
    public int[] f1960k = v;

    /* renamed from: l  reason: collision with root package name */
    public ArrayList<p> f1961l;
    ...
    public static void c(q qVar, View view, p pVar) {
        ...
        if (transitionName != null) {
            if (qVar.f1964d.e(transitionName) >= 0) {
                qVar.f1964d.put(transitionName, null);
            } else {
                qVar.f1964d.put(transitionName, view);
            }
        }
        if (view.getParent() instanceof ListView) {
            ...
            if (listView.getAdapter().hasStableIds()) {
                ...
                if (e.e.d.b(eVar.c, eVar.f1197e, itemIdAtPosition) >= 0) {
    ...
    public String G(String str) {
        ...
        if (this.f1954e != null) {
            ...
            i4.append(this.f1954e);
            i4.append(") ");
            sb = i4.toString();
        }
        if (this.f1955f.size() <= 0 && this.f1956g.size() <= 0) {
            return sb;
        }
        String t2 = f.a.a.a.a.t(sb, "tgts(");
        if (this.f1955f.size() > 0) {
            for (int i5 = 0; i5 < this.f1955f.size(); i5++) {
                if (i5 > 0) {
                    t2 = f.a.a.a.a.t(t2, ", ");
                }
                StringBuilder h3 = f.a.a.a.a.h(t2);
                h3.append(this.f1955f.get(i5));
                t2 = h3.toString();
            }
        }
        if (this.f1956g.size() > 0) {
            for (int i6 = 0; i6 < this.f1956g.size(); i6++) {
                if (i6 > 0) {
                    t2 = f.a.a.a.a.t(t2, ", ");
                }
                StringBuilder h4 = f.a.a.a.a.h(t2);
                h4.append(this.f1956g.get(i6));
                t2 = h4.toString();
            }
        }
    ...
    public final void e(View view, boolean z) {
        if (view != null) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                pVar.c.add(this);
                f(pVar);
                c(z ? this.f1957h : this.f1958i, view, pVar);
            }
    ...
    public void h(ViewGroup viewGroup, boolean z) {
        i(z);
        if (this.f1955f.size() > 0 || this.f1956g.size() > 0) {
            for (int i2 = 0; i2 < this.f1955f.size(); i2++) {
                View findViewById = viewGroup.findViewById(this.f1955f.get(i2).intValue());
                if (findViewById != null) {
                    ...
                    pVar.c.add(this);
                    f(pVar);
                    c(z ? this.f1957h : this.f1958i, findViewById, pVar);
                }
            }
            for (int i3 = 0; i3 < this.f1956g.size(); i3++) {
                View view = this.f1956g.get(i3);
                p pVar2 = new p(view);
                if (z) {
                    g(pVar2);
                } else {
                ...
                pVar2.c.add(this);
                f(pVar2);
                c(z ? this.f1957h : this.f1958i, view, pVar2);
            }
            return;
        }
        e(viewGroup, z);
    ...
    public void m() {
        ...
        if (i2 == 0) {
            ...
            for (int i4 = 0; i4 < this.f1957h.c.l(); i4++) {
                View m2 = this.f1957h.c.m(i4);
                if (m2 != null) {
                    AtomicInteger atomicInteger = m.a;
                    m2.setHasTransientState(false);
                }
            }
            for (int i5 = 0; i5 < this.f1958i.c.l(); i5++) {
                View m3 = this.f1958i.c.m(i5);
                if (m3 != null) {
    ...
    public p n(View view, boolean z) {
        ...
        ArrayList<p> arrayList = z ? this.f1961l : this.m;
        if (arrayList == null) {
            return null;
        }
        int size = arrayList.size();
        ...
        return (z ? this.m : this.f1961l).get(i2);
    }
    ...
    public p q(View view, boolean z) {
        ...
        return (z ? this.f1957h : this.f1958i).a.getOrDefault(view, null);
    }
    ...
    public boolean s(View view) {
        return (this.f1955f.size() == 0 && this.f1956g.size() == 0) || this.f1955f.contains(Integer.valueOf(view.getId())) || this.f1956g.contains(view);
    }
    ...
    public void u(View view) {
        if (!this.q) {
            ...
            for (int i3 = i2 - 1; i3 >= 0; i3--) {
                b k2 = o2.k(i3);
                if (k2.a != null && b0Var.equals(k2.f1962d)) {
                    o2.h(i3).pause();
                }
            }
            ArrayList<d> arrayList = this.r;
        ...
        while (it.hasNext()) {
            ...
            if (o2.containsKey(next)) {
                ...
                if (next != null) {
                    ...
                    TimeInterpolator timeInterpolator = this.f1954e;
