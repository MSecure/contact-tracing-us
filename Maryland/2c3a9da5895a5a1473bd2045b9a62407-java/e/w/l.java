    ...
    public static class a implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public boolean onPreDraw() {
            ...
            if (arrayList2 == null) {
                    ...
                    if (i7 == i6) {
                        ...
                        while (true) {
                            ...
                            if (view3 != null && hVar.s(view3) && (pVar = (p) aVar2.remove(view3)) != null && hVar.s(pVar.b)) {
                                hVar.f1961l.add((p) aVar.i(i8));
                                hVar.m.add(pVar);
                            }
                        }
                    } else if (i7 == 2) {
                        qVar2 = qVar;
                        e.e.a<String, View> aVar3 = qVar2.f1964d;
                        e.e.a<String, View> aVar4 = qVar4.f1964d;
                        int i9 = aVar3.f1211d;
                ...
                for (i3 = 0; i3 < aVar.f1211d; i3++) {
                    p pVar8 = (p) aVar.k(i3);
                    if (hVar.s(pVar8.b)) {
                        hVar.f1961l.add(pVar8);
                        hVar.m.add(null);
                    }
                }
                for (i4 = 0; i4 < aVar2.f1211d; i4++) {
                    p pVar9 = (p) aVar2.k(i4);
                    if (hVar.s(pVar9.b)) {
                        hVar.m.add(pVar9);
                        hVar.f1961l.add(null);
                    }
                }
                ...
                for (i5 = i13 - 1; i5 >= 0; i5--) {
                    Animator h2 = o.h(i5);
                    if (!(h2 == null || (orDefault = o.getOrDefault(h2, null)) == null || orDefault.a == null || !b0Var.equals(orDefault.f1962d))) {
                        p pVar10 = orDefault.c;
                        View view4 = orDefault.a;
                        p q = hVar.q(view4, true);
                        p n = hVar.n(view4, true);
                        if (q == null && n == null) {
                            n = hVar.f1958i.a.get(view4);
                        }
                        if (!(q == null && n == null) && orDefault.f1963e.r(pVar10, n)) {
                ...
                hVar.l(viewGroup, hVar.f1957h, hVar.f1958i, hVar.f1961l, hVar.m);
                hVar.y();
                return true;
            }
            arrayList = null;
            ...
            while (i3 < aVar.f1211d) {
            }
            while (i4 < aVar2.f1211d) {
            }
            ...
            hVar.l(viewGroup2, hVar.f1957h, hVar.f1958i, hVar.f1961l, hVar.m);
            hVar.y();
            return true;
        }
