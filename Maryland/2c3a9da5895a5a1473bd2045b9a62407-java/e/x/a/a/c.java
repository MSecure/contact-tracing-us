...
public class c extends f implements Animatable {
    ...
    public ArgbEvaluator f1982e;

    /* renamed from: f  reason: collision with root package name */
    public final Drawable.Callback f1983f;
    ...
    public static class b extends Drawable.ConstantState {
        ...
        /* renamed from: d  reason: collision with root package name */
        public ArrayList<Animator> f1984d;

        /* renamed from: e  reason: collision with root package name */
        public e.e.a<Animator, String> f1985e;
        ...
        public b(b bVar, Drawable.Callback callback, Resources resources) {
            if (bVar != null) {
                ...
                ArrayList<Animator> arrayList = bVar.f1984d;
                if (arrayList != null) {
                    int size = arrayList.size();
                    this.f1984d = new ArrayList<>(size);
                    this.f1985e = new e.e.a<>(size);
                    for (int i2 = 0; i2 < size; i2++) {
                        Animator animator = bVar.f1984d.get(i2);
                        Animator clone = animator.clone();
                        String orDefault = bVar.f1985e.getOrDefault(animator, null);
                        clone.setTarget(this.b.c.b.p.getOrDefault(orDefault, null));
                        this.f1984d.add(clone);
                        this.f1985e.put(clone, orDefault);
                    }
                    if (this.c == null) {
                        this.c = new AnimatorSet();
                    }
                    this.c.playTogether(this.f1984d);
                }
            }
        }
    ...
    public Drawable.ConstantState getConstantState() {
        ...
        return new C0065c(this.b.getConstantState());
    }
    ...
    public void inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        while (eventType != 1 && (xmlPullParser.getDepth() >= depth || eventType != 3)) {
            if (eventType == 2) {
                ...
                if ("animated-vector".equals(name)) {
                    TypedArray e4 = h.e(resources, theme, attributeSet, a.f1973e);
                    ...
                    TypedArray obtainAttributes = resources.obtainAttributes(attributeSet, a.f1974f);
                    ...
                    if (resourceId2 != 0) {
                        ...
                        if (context != null) {
                            ...
                            b bVar = this.c;
                            if (bVar.f1984d == null) {
                                bVar.f1984d = new ArrayList<>();
                                this.c.f1985e = new e.e.a<>();
                            }
                            this.c.f1984d.add(animator);
                            this.c.f1985e.put(animator, string);
                        } else {
        ...
        bVar2.c.playTogether(bVar2.f1984d);
    }
    ...
    public static class C0065c extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            ...
            cVar.b = newDrawable;
            newDrawable.setCallback(cVar.f1983f);
            return cVar;
        }
