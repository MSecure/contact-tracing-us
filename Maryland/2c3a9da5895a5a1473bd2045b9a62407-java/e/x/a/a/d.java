...
public class d {
            ...
            if (next == 2) {
                ...
                if (name.equals("objectAnimator")) {
                    ...
                    if (name.equals("set")) {
                        ...
                        TypedArray e2 = h.e(resources2, theme2, attributeSet, a.f1976h);
                            ...
                            while (true) {
                                ...
                                if (eventType == i7 || eventType == i8) {
                                    ...
                                    if (xmlPullParser.getName().equals(str2)) {
                                        TypedArray e3 = h.e(resources2, theme2, asAttributeSet, a.f1977i);
    ...
    public static ValueAnimator e(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) {
        ...
        PropertyValuesHolder propertyValuesHolder;
        TypedArray e2 = h.e(resources, theme, attributeSet, a.f1975g);
        TypedArray e3 = h.e(resources, theme, attributeSet, a.f1979k);
