...
public class c extends Thread {
    ...
    public static final boolean f2042h = v.a;
    ...
    public void run() {
        ...
        Objects.requireNonNull((h) this.f2043d);
        while (true) {
            try {
                a();
