...
public abstract class p<T> extends LiveData<T> {
    ...
    public final SharedPreferences f2095l;
    ...
    public void h() {
        m();
        this.f2095l.registerOnSharedPreferenceChangeListener(this.n);
    }

    @Override // androidx.lifecycle.LiveData
    public void i() {
        this.f2095l.unregisterOnSharedPreferenceChangeListener(this.n);
    }
