...
public final /* synthetic */ class i implements e {
    ...
    public final void d(Exception exc) {
        ...
        exposureNotificationViewModel.c(false);
        exposureNotificationViewModel.f343g.l(Boolean.FALSE);
        exposureNotificationViewModel.f344h.a.edit().putBoolean("ExposureNotificationSharedPreferences.IS_ENABLED_CACHE_KEY", false).apply();
