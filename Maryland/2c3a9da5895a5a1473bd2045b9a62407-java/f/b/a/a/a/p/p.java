...
public final /* synthetic */ class p implements i {
    ...
    public final u a(Object obj) {
        ...
        cVar.size();
        if (!d0Var.f2221d.h().isEmpty()) {
            d0Var.f2221d.h();
            String h2 = d0Var.f2221d.h();
            ...
            while (t.hasNext()) {
                ...
                try {
                    ...
                    a2.a.getKeysCount();
                    for (f.b.a.a.a.u.p pVar : a2.a.getKeysList()) {
                        if (d0.f2219i.c(pVar.getKeyData().z()).contains(h2.toLowerCase())) {
                            d0.f2220j.c(pVar.getKeyData().z());
        ...
        u g0 = m.h.g0(a3, d0.f2218h, d0Var.f2223f);
        g0.a(new f.b.b.f.a.q(g0, new c0(d0Var, cVar)), d0Var.f2222e);
        return g0;
    }
}
