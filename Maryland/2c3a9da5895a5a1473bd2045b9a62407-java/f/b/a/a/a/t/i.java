...
public final /* synthetic */ class i implements g {
    ...
    public /* synthetic */ i(a0 a0Var, String str, b0 b0Var) {
        this.a = a0Var;
        this.b = str;
        this.c = b0Var;
    }
    ...
    public final Object a(Object obj) {
        ...
        long c2 = b0Var.c();
        d b2 = uVar.b();
        f.b.a.a.a.u.g prioParameters = uVar.a().getPrioParameters();
        if (b2.getResponseStatus().getStatusCode() != h.c.OK) {
            StringBuilder h2 = a.h("Cannot write failed response: ");
            h2.append(b2.getResponseStatus().getErrorDetails());
            ...
            try {
                hashMap.put("payload", xVar.a(uVar, uuid, b0Var));
                if (!xVar.a.c(str, hashMap, prioParameters, b2, c2) && d2) {
                    c0Var = new c0();
                    c0Var.r();
                }
            } catch (Exception e2) {
                Log.w("PrioFirestoreRepository", "Device attestation failed, requireAttestation=" + d2, e2);
                if (d2) {
                    c0 c0Var2 = new c0();
                    c0Var2.p(e2);
                    c0Var = c0Var2;
            ...
            h3.append(xVar.f2315e.nextInt(100));
            ...
            if (fVar.f3087h == null) {
                synchronized (fVar.b) {
                    if (fVar.f3087h == null) {
                        ...
                        String str2 = fVar.c;
                        f.b.c.k.h hVar = fVar.f3086g;
                        fVar.f3087h = new n(fVar.a, new e(bVar, str2, hVar.a, hVar.b), hVar, fVar.f3083d, fVar.f3084e, fVar.f3088i);
                    }
                }
            }
            l s = l.s(sb);
            ...
            if (s.n() % 2 == 1) {
                ...
                l lVar = (l) a2.f3163e.a(l.s(uuid));
                if (lVar.n() % 2 == 0) {
                    f.b.c.k.u.f fVar2 = new f.b.c.k.u.f(lVar);
                    String b3 = x.f2312g.b(xVar.c.b());
                    b.C(b3, "Provided collection path must not be null.");
                    l lVar2 = (l) fVar2.b.a(l.s(b3));
                    x a3 = x.a(lVar2);
                    if (lVar2.n() % 2 == 1) {
                        b.C(str, "Provided document path must not be null.");
                        l lVar3 = (l) a3.f3163e.a(l.s(str));
                        if (lVar3.n() % 2 == 0) {
                            ...
                            if (oVar.a) {
                                ...
                                if (cVar != null) {
                                    ...
                                    do {
                                        ...
                                        if (it.hasNext()) {
                                            ...
                                            h0Var = new h0(a4, cVar, Collections.unmodifiableList(arrayList));
                                        }
                                    } while (z);
                                ...
                                h0Var = new h0(a4, new c(f0Var.b), Collections.unmodifiableList(f0Var.c));
                            } else {
                                q qVar2 = fVar.f3085f;
                            ...
                            c0<TResult> c0Var3 = iVar.a;
                            Executor executor = f.b.c.k.x.j.b;
                            f.b.a.c.i.a<Void, Void> aVar = r.b;
                            Objects.requireNonNull(c0Var3);
                            c0 c0Var4 = new c0();
                            c0Var3.b.b(new f.b.a.c.i.l(executor, aVar, c0Var4));
                            c0Var3.t();
                            c0Var = c0Var4;
                        } else {
        ...
        return f.b.b.f.a.l.x(m.h.g0(c0Var, x.f2311f, xVar.f2314d));
    }
}
