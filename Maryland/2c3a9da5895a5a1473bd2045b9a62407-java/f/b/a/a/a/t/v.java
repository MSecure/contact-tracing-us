...
public class v {
    ...
    public static final a f2310d = a.a;
    ...
    static {
        ...
        d dVar = new d();
        dVar.h("yyyyMMdd");
        c = dVar.r(locale).h(q.f4166g);
    }

    public v(Context context, f.b.a.a.a.h.s.a aVar) {
        this.a = context;
        this.b = aVar;
    }
    ...
    public boolean c(String str, Map<String, Object> map, g gVar, f.b.a.a.a.u.d dVar, long j2) {
        ...
        l.b.a.d v = this.b.b().m(j2, b.HOURS).h(30, b.MINUTES);
        ...
        try {
            KeyGenParameterSpec.Builder keyValidityEnd = new KeyGenParameterSpec.Builder(c2, 12).setDigests("SHA-256").setAttestationChallenge(a2).setKeyValidityEnd(new Date(v.E()));
            ...
            for (Certificate certificate : certificateChain) {
                arrayList.add(f2310d.c(certificate.getEncoded()));
            }
