...
public final class k extends q {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.a == qVar.b() && ((num = this.b) != null ? num.equals(((k) qVar).b) : ((k) qVar).b == null) && this.c == qVar.c()) {
            if (Arrays.equals(this.f2387d, qVar instanceof k ? ((k) qVar).f2387d : qVar.e()) && ((str = this.f2388e) != null ? str.equals(((k) qVar).f2388e) : ((k) qVar).f2388e == null) && this.f2389f == qVar.g()) {
                t tVar = this.f2390g;
                t tVar2 = ((k) qVar).f2390g;
                if (tVar == null) {
                    if (tVar2 == null) {
                        return true;
                    }
    ...
    public int hashCode() {
        ...
        long j3 = this.c;
        int hashCode2 = (((((i2 ^ hashCode) * 1000003) ^ ((int) (j3 ^ (j3 >>> 32)))) * 1000003) ^ Arrays.hashCode(this.f2387d)) * 1000003;
    ...
    public String toString() {
        ...
        h2.append(Arrays.toString(this.f2387d));
        h2.append(", sourceExtensionJsonProto3=");
        h2.append(this.f2388e);
        h2.append(", timezoneOffsetSeconds=");
        h2.append(this.f2389f);
        h2.append(", networkConnectionInfo=");
        h2.append(this.f2390g);
        h2.append("}");
        return h2.toString();
    }
}
