...
public final /* synthetic */ class s implements t.b {
    ...
    public Object a(Object obj) {
        ...
        b bVar = t.f2476f;
        if (tVar.d().compileStatement("PRAGMA page_size").simpleQueryForLong() * tVar.d().compileStatement("PRAGMA page_count").simpleQueryForLong() >= tVar.f2478e.e()) {
            return -1L;
        }
