...
public final class a<O extends c> {
    ...
    public interface c {
        ...
        public interface AbstractC0084a extends c {
            @RecentlyNonNull
            Account a();
        }
    ...
    public <C extends e> a(@RecentlyNonNull String str, @RecentlyNonNull AbstractC0083a<C, O> aVar, @RecentlyNonNull f<C> fVar) {
