...
public final class f0 implements ServiceConnection {
    ...
    public IBinder f2559d;

    /* renamed from: e  reason: collision with root package name */
    public final g.a f2560e;

    /* renamed from: f  reason: collision with root package name */
    public ComponentName f2561f;

    /* renamed from: g  reason: collision with root package name */
    public final /* synthetic */ d0 f2562g;
    ...
    public final void a(String str) {
        ...
        Bundle bundle;
        this.b = 3;
        d0 d0Var = this.f2562g;
        a aVar = d0Var.f2547f;
        Context context = d0Var.f2545d;
        g.a aVar2 = this.f2560e;
        Intent intent = null;
        if (aVar2.a != null) {
            if (aVar2.f2564d) {
                ...
                try {
                    bundle = context.getContentResolver().call(g.a.f2563e, "serviceIntentCall", (String) null, bundle2);
        ...
        if (component != null) {
            ...
            try {
                if ((b.a(context).a.getPackageManager().getApplicationInfo(packageName, 0).flags & 2097152) != 0) {
                    ...
                    this.c = z2;
                    if (!z2) {
                        Message obtainMessage = this.f2562g.f2546e.obtainMessage(1, this.f2560e);
                        d0 d0Var2 = this.f2562g;
                        d0Var2.f2546e.sendMessageDelayed(obtainMessage, d0Var2.f2549h);
                        return;
                    }
                    this.b = 2;
                    try {
                        d0 d0Var3 = this.f2562g;
                        d0Var3.f2547f.a(d0Var3.f2545d, this);
                        return;
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        synchronized (this.f2562g.c) {
            this.f2562g.f2546e.removeMessages(1, this.f2560e);
            this.f2559d = iBinder;
            this.f2561f = componentName;
