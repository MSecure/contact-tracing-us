...
public abstract class q1 extends u implements r1 {
    public q1() {
    ...
    public final boolean k(int i2, Parcel parcel, Parcel parcel2, int i3) {
        ...
        m.h.s1((Status) i0.a(parcel, Status.CREATOR), parcel.createTypedArrayList(TemporaryExposureKey.CREATOR), ((p) this).a);
        return true;
    }
}
