...
public abstract class e<V extends View> extends g<V> {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (this.c != null && (overScroller = e.this.f2659d) != null) {
                if (overScroller.computeScrollOffset()) {
                    e eVar = e.this;
                    eVar.G(this.b, this.c, eVar.f2659d.getCurrY());
    ...
    public boolean A(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        if (actionMasked != 1) {
            if (actionMasked == 2) {
                int findPointerIndex = motionEvent.findPointerIndex(this.f2661f);
                if (findPointerIndex == -1) {
                    return false;
                }
                int y = (int) motionEvent.getY(findPointerIndex);
                this.f2662g = y;
                F(coordinatorLayout, v, this.f2662g - y, -((AppBarLayout) v).getDownNestedScrollRange(), 0);
            } else if (actionMasked != 3) {
                if (actionMasked == 6) {
                    int i2 = motionEvent.getActionIndex() == 0 ? 1 : 0;
                    this.f2661f = motionEvent.getPointerId(i2);
                    this.f2662g = (int) (motionEvent.getY(i2) + 0.5f);
                }
            }
            z = false;
            velocityTracker = this.f2664i;
        ...
        VelocityTracker velocityTracker3 = this.f2664i;
        if (velocityTracker3 != null) {
            velocityTracker3.addMovement(motionEvent);
            this.f2664i.computeCurrentVelocity(1000);
            float yVelocity = this.f2664i.getYVelocity(this.f2661f);
            ...
            if (this.f2659d == null) {
                this.f2659d = new OverScroller(v.getContext());
            }
            this.f2659d.fling(0, B(), 0, Math.round(yVelocity), 0, 0, i3, 0);
            if (this.f2659d.computeScrollOffset()) {
    ...
    public boolean j(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        if (this.f2663h < 0) {
            this.f2663h = ViewConfiguration.get(coordinatorLayout.getContext()).getScaledTouchSlop();
        }
        if (motionEvent.getActionMasked() == 2 && this.f2660e) {
            int i2 = this.f2661f;
            if (i2 == -1 || (findPointerIndex = motionEvent.findPointerIndex(i2)) == -1) {
                return false;
            }
            int y = (int) motionEvent.getY(findPointerIndex);
            if (Math.abs(y - this.f2662g) > this.f2663h) {
                this.f2662g = y;
                return true;
            }
        }
        if (motionEvent.getActionMasked() == 0) {
            ...
            if (z) {
                this.f2662g = y2;
                this.f2661f = motionEvent.getPointerId(0);
                if (this.f2664i == null) {
                    this.f2664i = VelocityTracker.obtain();
                }
                OverScroller overScroller = this.f2659d;
                if (overScroller != null && !overScroller.isFinished()) {
                    this.f2659d.abortAnimation();
                    return true;
                }
            }
        }
        VelocityTracker velocityTracker = this.f2664i;
        if (velocityTracker != null) {
            velocityTracker.addMovement(motionEvent);
        }
        return false;
