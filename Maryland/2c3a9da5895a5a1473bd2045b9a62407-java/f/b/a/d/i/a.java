...
public class a extends g {
    ...
    public static final int f2714g = R$style.Widget_MaterialComponents_CompoundButton_CheckBox;

    /* renamed from: h  reason: collision with root package name */
    public static final int[][] f2715h = {new int[]{16842910, 16842912}, new int[]{16842910, -16842912}, new int[]{-16842910, 16842912}, new int[]{-16842910, -16842912}};
    ...
    public a(Context context, AttributeSet attributeSet) {
        ...
        this.f2717f = d2.getBoolean(R$styleable.MaterialCheckBox_useMaterialThemeColors, false);
        d2.recycle();
    }
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.f2716e == null) {
            ...
            this.f2716e = new ColorStateList(iArr, iArr2);
        }
        return this.f2716e;
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (this.f2717f && getButtonTintList() == null) {
