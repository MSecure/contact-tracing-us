...
public class b extends g implements e.i.c.l.a, Drawable.Callback, i.b {
    ...
    public final boolean L(int[] iArr, int[] iArr2) {
        ...
        if ((this.p0 != a2) || (this.b.f2874d == null)) {
            this.p0 = a2;
        ...
        int colorForState3 = (this.C0 == null || !f.b.a.d.t.a.c(iArr)) ? 0 : this.C0.getColorForState(iArr, this.r0);
        ...
        f.b.a.d.s.b bVar = this.m0.f2801f;
        ...
        if (!(this.t0 == z5 || this.U == null)) {
            ...
            if (B2 != B()) {
                ...
                if (this.u0 == colorForState) {
                    ...
                    this.x0 = f.b.a.c.b.o.b.V1(this, this.y0, this.z0);
                } else {
                    z4 = onStateChange;
                }
                if (J(this.I)) {
    ...
    public void T(Drawable drawable) {
        ...
        Drawable t1 = drawable2 != null ? m.h.t1(drawable2) : null;
        if (t1 != drawable) {
            float B2 = B();
            if (drawable != null) {
                drawable3 = m.h.w1(drawable).mutate();
            }
            this.I = drawable3;
            float B3 = B();
            s0(t1);
    ...
    public void b0(Drawable drawable) {
        ...
        if (G2 != drawable) {
            float E2 = E();
            this.N = drawable != null ? m.h.w1(drawable).mutate() : null;
        ...
        if (!bounds.isEmpty() && (i2 = this.v0) != 0) {
            ...
            if (!this.F0 || this.G == null) {
                ...
                if (iVar.f2801f != null) {
                    ...
                    i iVar2 = this.m0;
                    iVar2.f2801f.c(this.g0, iVar2.a, iVar2.b);
                }
    ...
    public boolean onLayoutDirectionChanged(int i2) {
        ...
        if (q0()) {
            onLayoutDirectionChanged |= m.h.Z0(this.I, i2);
        }
        if (p0()) {
            onLayoutDirectionChanged |= m.h.Z0(this.U, i2);
        }
        if (r0()) {
            onLayoutDirectionChanged |= m.h.Z0(this.N, i2);
        }
    ...
    public void setTintMode(PorterDuff.Mode mode) {
        if (this.z0 != mode) {
            this.z0 = mode;
            this.x0 = f.b.a.c.b.o.b.V1(this, this.y0, mode);
            invalidateSelf();
        }
    }
