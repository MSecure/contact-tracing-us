...
public final class b {
    ...
    public final ColorStateList f2727d;
    ...
    public void b(TextView textView) {
        g gVar = new g();
        g gVar2 = new g();
        gVar.setShapeAppearanceModel(this.f2729f);
        gVar2.setShapeAppearanceModel(this.f2729f);
        gVar.q(this.c);
        gVar.u((float) this.f2728e, this.f2727d);
