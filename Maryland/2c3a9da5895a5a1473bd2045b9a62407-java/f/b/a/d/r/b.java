...
public abstract class b<S extends c> extends ProgressBar {
    ...
    public final Runnable f2811l = new a();
    ...
    public class a implements Runnable {
        ...
        public void run() {
            b bVar = b.this;
            if (bVar.f2806g > 0) {
                bVar.f2807h = SystemClock.uptimeMillis();
            }
    ...
    public class d extends e.x.a.a.b {
        ...
        public void a(Drawable drawable) {
            b bVar = b.this;
            if (!bVar.f2809j) {
                bVar.setVisibility(bVar.f2810k);
            }
        }
    }

    public b(Context context, AttributeSet attributeSet, int i2, int i3) {
        super(f.b.a.d.a0.a.a.a(context, attributeSet, i2, p), attributeSet, i2);
        ...
        this.f2805f = obtainStyledAttributes.getInt(R$styleable.BaseProgressIndicator_showDelay, -1);
        this.f2806g = Math.min(obtainStyledAttributes.getInt(R$styleable.BaseProgressIndicator_minHideDelay, -1), 1000);
    ...
    public void b() {
        ...
        long uptimeMillis = SystemClock.uptimeMillis() - this.f2807h;
        int i2 = this.f2806g;
    ...
    public void c(int i2, boolean z) {
        if (!isIndeterminate()) {
            ...
            this.f2803d = z;
            this.f2809j = true;
            if (!getIndeterminateDrawable().isVisible() || this.f2808i.a(getContext().getContentResolver()) == 0.0f) {
                this.n.a(getIndeterminateDrawable());
                return;
            }
            g gVar = (g) getIndeterminateDrawable().n;
            if (!gVar.f2820e.isRunning()) {
                if (gVar.a.isVisible()) {
                    gVar.f2820e.start();
                } else {
                    gVar.a();
    ...
    public int getShowAnimationBehavior() {
        return this.b.f2813e;
    }

    public int getTrackColor() {
        return this.b.f2812d;
    }
    ...
    public void onAttachedToWindow() {
        ...
        if (!(getProgressDrawable() == null || getIndeterminateDrawable() == null)) {
            ((g) getIndeterminateDrawable().n).f2826k = this.n;
        }
    ...
    public void onDetachedFromWindow() {
        ...
        if (getIndeterminateDrawable() != null) {
            ...
            ((g) getIndeterminateDrawable().n).f2826k = null;
        }
        if (getProgressDrawable() != null) {
    ...
    public void setAnimatorDurationScaleProvider(a aVar) {
        this.f2808i = aVar;
        if (getProgressDrawable() != null) {
            getProgressDrawable().f2831d = aVar;
        }
        if (getIndeterminateDrawable() != null) {
            getIndeterminateDrawable().f2831d = aVar;
        }
    }
    ...
    public void setIndicatorColor(int... iArr) {
        if (iArr.length == 0) {
            iArr = new int[]{f.b.a.c.b.o.b.J0(getContext(), R$attr.colorPrimary, -1)};
        }
