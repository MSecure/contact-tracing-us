...
public class h extends m {
    ...
    public final TextWatcher f2934d = new a();

    /* renamed from: e  reason: collision with root package name */
    public final View.OnFocusChangeListener f2935e = new b();

    /* renamed from: f  reason: collision with root package name */
    public final TextInputLayout.e f2936f = new c(this.a);

    /* renamed from: g  reason: collision with root package name */
    public final TextInputLayout.f f2937g = new d();

    /* renamed from: h  reason: collision with root package name */
    public final TextInputLayout.g f2938h = new e();
    ...
    public long f2941k = Long.MAX_VALUE;

    /* renamed from: l  reason: collision with root package name */
    public StateListDrawable f2942l;
    public g m;
    ...
    public class d implements TextInputLayout.f {
        ...
        public void a(TextInputLayout textInputLayout) {
            ...
            if (boxBackgroundMode == 2) {
                ...
                e2.setOnFocusChangeListener(hVar3.f2935e);
                e2.setOnDismissListener(new k(hVar3));
                e2.setThreshold(0);
                e2.removeTextChangedListener(h.this.f2934d);
                e2.addTextChangedListener(h.this.f2934d);
                ...
                textInputLayout.setTextInputAccessibilityDelegate(h.this.f2936f);
            ...
            e2.setOnFocusChangeListener(hVar32.f2935e);
    ...
    public class e implements TextInputLayout.g {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                this.b.removeTextChangedListener(h.this.f2934d);
            }
        }
        ...
        public void a(TextInputLayout textInputLayout, int i2) {
            ...
            if (autoCompleteTextView != null && i2 == 3) {
                ...
                if (autoCompleteTextView.getOnFocusChangeListener() == h.this.f2935e) {
    ...
    public final g i(float f2, float f3, float f4, int i2) {
        j.b bVar = new j.b();
        bVar.f2893e = new f.b.a.d.v.a(f2);
        bVar.f2894f = new f.b.a.d.v.a(f2);
        bVar.f2896h = new f.b.a.d.v.a(f3);
        bVar.f2895g = new f.b.a.d.v.a(f3);
        f.b.a.d.v.j a2 = bVar.a();
        Context context = this.b;
        String str = g.x;
        int D1 = f.b.a.c.b.o.b.D1(context, R$attr.colorSurface, g.class.getSimpleName());
        g gVar = new g();
        ...
        gVar.invalidateSelf();
        g.b bVar3 = gVar.b;
        if (bVar3.f2879i == null) {
            bVar3.f2879i = new Rect();
        }
        gVar.b.f2879i.set(0, i2, 0, i2);
        gVar.invalidateSelf();
        return gVar;
    }

    public final boolean j() {
        long currentTimeMillis = System.currentTimeMillis() - this.f2941k;
