...
public abstract class c<E> extends b<E> implements List<E>, RandomAccess {
    public static final a<Object> c = new b(g.f2978f, 0);
    ...
    public static final class a<E> extends b.a<E> {
        ...
        public b.AbstractC0104b a(Object obj) {
            c(obj);
            return this;
        }
    ...
    public class C0105c extends c<E> {

        /* renamed from: d  reason: collision with root package name */
        public final transient int f2973d;

        /* renamed from: e  reason: collision with root package name */
        public final transient int f2974e;

        public C0105c(int i2, int i3) {
            this.f2973d = i2;
            this.f2974e = i3;
        }
        ...
        public E get(int i2) {
            f.b.a.c.b.o.b.w(i2, this.f2974e);
            return (E) c.this.get(i2 + this.f2973d);
        }
        ...
        @Override // f.b.b.b.b
        public int k() {
            return c.this.l() + this.f2973d + this.f2974e;
        }

        @Override // f.b.b.b.b
        public int l() {
            return c.this.l() + this.f2973d;
        }
        ...
        public c<E> subList(int i2, int i3) {
            f.b.a.c.b.o.b.E(i2, i3, this.f2974e);
            c cVar = c.this;
            int i4 = this.f2973d;
    ...
    public static <E> c<E> p(Object[] objArr, int i2) {
        return i2 == 0 ? (c<E>) g.f2978f : new g(objArr, i2);
    }
    ...
    public c<E> subList(int i2, int i3) {
        ...
        return i4 == 0 ? (c<E>) g.f2978f : new C0105c(i2, i4);
    }
}
