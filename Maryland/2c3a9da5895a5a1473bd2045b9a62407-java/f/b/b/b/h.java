...
public final class h<K, V> extends d<K, V> {
    ...
    public static final d<Object, Object> f2981h = new h(null, new Object[0], 0);

    /* renamed from: e  reason: collision with root package name */
    public final transient Object f2982e;

    /* renamed from: f  reason: collision with root package name */
    public final transient Object[] f2983f;

    /* renamed from: g  reason: collision with root package name */
    public final transient int f2984g;

    public static class a<K, V> extends e<Map.Entry<K, V>> {

        /* renamed from: e  reason: collision with root package name */
        public final transient d<K, V> f2985e;

        /* renamed from: f  reason: collision with root package name */
        public final transient Object[] f2986f;

        /* renamed from: g  reason: collision with root package name */
        public final transient int f2987g;

        /* renamed from: h  reason: collision with root package name */
        public final transient int f2988h;

        /* renamed from: f.b.b.b.h$a$a  reason: collision with other inner class name */
        public class C0106a extends c<Map.Entry<K, V>> {
            public C0106a() {
            }

            @Override // java.util.List
            public Object get(int i2) {
                f.b.a.c.b.o.b.w(i2, a.this.f2988h);
                a aVar = a.this;
                Object[] objArr = aVar.f2986f;
                int i3 = i2 * 2;
                int i4 = aVar.f2987g;
        ...
        public boolean contains(Object obj) {
            ...
            return value != null && value.equals(this.f2985e.get(key));
        }
    ...
    public static final class b<K> extends e<K> {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final transient d<K, ?> f2990e;

        /* renamed from: f  reason: collision with root package name */
        public final transient c<K> f2991f;
        ...
        @Override // f.b.b.b.b
        public boolean contains(Object obj) {
            return this.f2990e.get(obj) != null;
        }
        ...
        @Override // f.b.b.b.b
        public int i(Object[] objArr, int i2) {
            return this.f2991f.i(objArr, i2);
        }
        ...
        /* renamed from: n */
        public k<K> iterator() {
            return this.f2991f.listIterator();
        }

        public int size() {
            return ((h) this.f2990e).f2984g;
        }
    }
    ...
    public static final class c extends c<Object> {
        ...
        public final transient Object[] f2992d;

        /* renamed from: e  reason: collision with root package name */
        public final transient int f2993e;

        /* renamed from: f  reason: collision with root package name */
        public final transient int f2994f;
        ...
        @Override // java.util.List
        public Object get(int i2) {
            f.b.a.c.b.o.b.w(i2, this.f2994f);
            return this.f2992d[(i2 * 2) + this.f2993e];
        }
        ...
        if (i2 == 1) {
            ...
            if (o <= 128) {
                ...
                while (i4 < i2) {
                    ...
                    int Q1 = f.b.a.c.b.o.b.Q1(obj2.hashCode());
                    while (true) {
                        int i6 = Q1 & i3;
                        int i7 = bArr[i6] & 255;
                        if (i7 == 255) {
                ...
                while (i8 < i2) {
                    ...
                    int Q12 = f.b.a.c.b.o.b.Q1(obj4.hashCode());
                    while (true) {
                        int i10 = Q12 & i3;
                ...
                while (i12 < i2) {
                    ...
                    int Q13 = f.b.a.c.b.o.b.Q1(obj6.hashCode());
                    while (true) {
                        int i14 = Q13 & i3;
                        ?? r9 = bArr[i14];
                        if (r9 == -1) {
    ...
    public V get(Object obj) {
        Object obj2 = this.f2982e;
        Object[] objArr = this.f2983f;
        int i2 = this.f2984g;
        if (obj == null) {
            return null;
        }
        if (i2 == 1) {
            ...
            if (obj2 instanceof byte[]) {
                ...
                int Q1 = f.b.a.c.b.o.b.Q1(obj.hashCode());
                while (true) {
                    int i3 = Q1 & length;
                    int i4 = bArr[i3] & 255;
                    if (i4 == 255) {
                ...
                int Q12 = f.b.a.c.b.o.b.Q1(obj.hashCode());
                while (true) {
                    int i5 = Q12 & length2;
                ...
                int Q13 = f.b.a.c.b.o.b.Q1(obj.hashCode());
                while (true) {
                    int i7 = Q13 & length3;
                    int i8 = iArr[i7];
                    if (i8 == -1) {
