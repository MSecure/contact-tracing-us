...
public abstract class b<V> extends f.b.b.f.a.e0.a implements u<V> {
    ...
    public static final boolean f3017e;

    /* renamed from: f  reason: collision with root package name */
    public static final Logger f3018f = Logger.getLogger(b.class.getName());

    /* renamed from: g  reason: collision with root package name */
    public static final AbstractC0110b f3019g;

    /* renamed from: h  reason: collision with root package name */
    public static final Object f3020h = new Object();
    private volatile Object b;
    private volatile e c;

    /* renamed from: d  reason: collision with root package name */
    private volatile l f3021d;
    ...
    public static final class e {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final e f3023d = new e(null, null);
    ...
    public static final class f extends AbstractC0110b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<b, e> f3024d;

        /* renamed from: e  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<b, Object> f3025e;
        ...
        public f(AtomicReferenceFieldUpdater<l, Thread> atomicReferenceFieldUpdater, AtomicReferenceFieldUpdater<l, l> atomicReferenceFieldUpdater2, AtomicReferenceFieldUpdater<b, l> atomicReferenceFieldUpdater3, AtomicReferenceFieldUpdater<b, e> atomicReferenceFieldUpdater4, AtomicReferenceFieldUpdater<b, Object> atomicReferenceFieldUpdater5) {
            ...
            this.f3024d = atomicReferenceFieldUpdater4;
            this.f3025e = atomicReferenceFieldUpdater5;
        }

        @Override // f.b.b.f.a.b.AbstractC0110b
        public boolean a(b<?> bVar, e eVar, e eVar2) {
            return this.f3024d.compareAndSet(bVar, eVar, eVar2);
        }

        @Override // f.b.b.f.a.b.AbstractC0110b
        public boolean b(b<?> bVar, Object obj, Object obj2) {
            return this.f3025e.compareAndSet(bVar, obj, obj2);
        }
    ...
    public static final class g<V> implements Runnable {
        ...
        public void run() {
            if (((b) this.b).b == this) {
                if (b.f3019g.b(this.b, this, b.o(this.c))) {
                    b.l(this.b);
                }
            }
        }
    ...
    public static final class k extends AbstractC0110b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final long f3026d;

        /* renamed from: e  reason: collision with root package name */
        public static final long f3027e;

        /* renamed from: f  reason: collision with root package name */
        public static final long f3028f;
        ...
        static {
            ...
            try {
                ...
                try {
                    ...
                    f3026d = unsafe.objectFieldOffset(b.class.getDeclaredField("b"));
                    f3027e = unsafe.objectFieldOffset(l.class.getDeclaredField("a"));
                    f3028f = unsafe.objectFieldOffset(l.class.getDeclaredField("b"));
                    a = unsafe;
                } catch (Exception e2) {
                    v.c(e2);
        ...
        @Override // f.b.b.f.a.b.AbstractC0110b
        public boolean b(b<?> bVar, Object obj, Object obj2) {
            return a.compareAndSwapObject(bVar, f3026d, obj, obj2);
        }
        ...
        @Override // f.b.b.f.a.b.AbstractC0110b
        public void d(l lVar, l lVar2) {
            a.putObject(lVar, f3028f, lVar2);
        }

        @Override // f.b.b.f.a.b.AbstractC0110b
        public void e(l lVar, Thread thread) {
            a.putObject(lVar, f3027e, thread);
        }
    }
    ...
    public static final class l {
        ...
        public l() {
            b.f3019g.e(this, Thread.currentThread());
        }
    ...
    public static void l(b<?> bVar) {
        ...
        e eVar3 = null;
        while (true) {
            l lVar = ((b) bVar).f3021d;
            if (f3019g.c((b) bVar, lVar, l.c)) {
                while (lVar != null) {
                ...
                do {
                    eVar = ((b) bVar).c;
                } while (!f3019g.a((b) bVar, eVar, e.f3023d));
                while (true) {
                    eVar2 = eVar3;
                    eVar3 = eVar;
                    if (eVar3 == null) {
                ...
                while (eVar2 != null) {
                    ...
                    if (runnable instanceof g) {
                        ...
                        bVar = gVar.b;
                        if (((b) bVar).b == gVar) {
                            if (f3019g.b(bVar, gVar, o(gVar.c))) {
                            }
                        } else {
                            continue;
                        }
    ...
    public static Object o(u<?> uVar) {
        ...
        if (uVar instanceof i) {
            ...
            c cVar = (c) obj;
            if (cVar.a) {
                return cVar.b != null ? new c(false, cVar.b) : c.f3022d;
            }
            return obj;
            ...
            if ((!f3017e) && isCancelled) {
                return c.f3022d;
            }
            try {
                Object p = p(uVar);
                if (!isCancelled) {
                    return p == null ? f3020h : p;
                }
    ...
    public boolean cancel(boolean z) {
        ...
        c cVar = f3017e ? new c(z, new CancellationException("Future.cancel() was called.")) : z ? c.c : c.f3022d;
        boolean z2 = false;
        b<V> bVar = this;
        while (true) {
            if (f3019g.b(bVar, obj, cVar)) {
                l(bVar);
                if (!(obj instanceof g)) {
                    return true;
                }
        ...
        while (true) {
            ...
            if (lVar2 != l.c) {
                ...
                while (lVar2 != null) {
                    ...
                    } else if (!f3019g.c(this, lVar2, lVar4)) {
                    }
                    lVar2 = lVar4;
                }
                return;
    ...
    public boolean u(Throwable th) {
        Objects.requireNonNull(th);
        if (!f3019g.b(this, null, new d(th))) {
            return false;
        }
        l(this);
        return true;
