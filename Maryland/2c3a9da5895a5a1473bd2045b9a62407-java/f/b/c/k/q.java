...
public final class q {
    ...
    public final k a(Object obj, g0 g0Var) {
        if (!obj.getClass().isArray()) {
            s c = c(h.b(obj, h.b.f3285d), g0Var);
                ...
                if (hVar3 != null) {
                    if (eVar instanceof e.c) {
                        ...
                        if (i0Var == i0.MergeSet) {
                            ...
                            f.b.a.c.b.o.b.b1(z, "FieldValue.delete() at the top level should have already been handled.", new Object[0]);
                        ...
                        if (eVar instanceof e.C0115e) {
                            ...
                            if (eVar instanceof e.b) {
                                ...
                                oVar2 = new a.C0116a(b(null));
                            } else if (eVar instanceof e.d) {
                                Objects.requireNonNull((e.d) eVar);
                                f0 f0Var = new f0(i0.Argument);
                                s c2 = c(h.b(null, h.b.f3285d), f0Var.a());
                                if (c2 == null) {
                                    z = false;
                                }
                                f.b.a.c.b.o.b.b1(z, "Parsed data should not be null.", new Object[0]);
                                f.b.a.c.b.o.b.b1(f0Var.c.isEmpty(), "Field transforms should have been disallowed.", new Object[0]);
                                oVar = new i(c2);
                                hVar3 = g0Var.b;
                            } else {
