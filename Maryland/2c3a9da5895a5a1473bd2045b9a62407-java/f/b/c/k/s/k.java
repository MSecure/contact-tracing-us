...
public final /* synthetic */ class k implements Runnable {
    ...
    public void run() {
        ...
        f fVar = this.c;
        m.a aVar = m.a.DEBUG;
        b.b1(nVar.f3150d != null, "SyncEngine not yet initialized", new Object[0]);
        m.a(aVar, "FirestoreClient", "Credential changed. Current user: %s", fVar.a);
        b0 b0Var = nVar.f3150d;
        boolean z = !b0Var.m.equals(fVar);
        b0Var.m = fVar;
        if (z) {
            for (Map.Entry<Integer, List<i<Void>>> entry : b0Var.f3110k.entrySet()) {
