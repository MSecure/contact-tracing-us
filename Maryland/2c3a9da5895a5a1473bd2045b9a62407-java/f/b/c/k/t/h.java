...
public final class h {
    ...
    public i a(a aVar) {
        ...
        if (ordinal == 0) {
            ...
            f.b.a.c.b.o.b.z0("Unknown MaybeDocument %s", aVar);
            throw null;
        }
    }
    ...
    public d1 c(f.b.c.k.v.c cVar) {
        ...
        if (ordinal == 0) {
            ...
            int l2 = g2.l();
            if (l2 > 0) {
                f.b.a.c.b.o.b.b1(l2 == 1, "StructuredQuery.from with more than one collection is not supported.", new Object[0]);
                p.c k2 = g2.k(0);
                boolean e4 = k2.e();
                String f2 = k2.f();
                if (e4) {
                    ...
                    if (!g2.u()) {
                        ...
                        if (q2.i() == p.h.b.COMPOSITE_FILTER) {
                            f.b.a.c.b.o.b.b1(q2.f().g() == p.d.b.AND, "Only AND-type composite filters are supported, got %d", q2.f().g());
                            list2 = q2.f().f();
                        } else {
                        ...
                        while (it2.hasNext()) {
                            ...
                            if (ordinal2 != 0) {
                                if (ordinal2 == 1) {
                                    ...
                                    switch (h3.ordinal()) {
                                        ...
                                        case 10:
                                            ...
                                            break;
                                        default:
                                            f.b.a.c.b.o.b.z0("Unhandled FieldFilter.operator %d", h3);
                                            throw null;
                                    }
                                    ...
                                    if (ordinal3 == 1) {
                                        ...
                                        if (ordinal3 == 3) {
                                            ...
                                            f.b.a.c.b.o.b.z0("Unrecognized UnaryFilter.operator %d", j2.g());
                                            throw null;
                                        }
                                    ...
                                    f.b.a.c.b.o.b.z0("Unrecognized Filter.filterType %d", next.i());
                                    throw null;
                                }
                                arrayList2.add(hVar);
                                it2 = it;
                                ...
                                f.b.a.c.b.o.b.z0("Nested composite filters are not supported.", new Object[0]);
                                throw null;
                            }
                        }
                        jVar = o2;
                    ...
                    if (o <= 0) {
                        ...
                        for (int i2 = 0; i2 < o; i2++) {
                            ...
                            if (ordinal4 == 1) {
                                ...
                                f.b.a.c.b.o.b.z0("Unrecognized direction %d", n2.e());
                                throw null;
                            }
            ...
            int f3 = k3.f();
            f.b.a.c.b.o.b.b1(f3 == 1, "DocumentsTarget contained other than 1 document %d", Integer.valueOf(f3));
            c0Var = x.a(h0Var2.c(k3.e(0))).d();
            jVar = o2;
        } else {
            f.b.a.c.b.o.b.z0("Unknown targetType %d", cVar.r());
            throw null;
        }
