...
public final class u0 implements k0 {
    ...
    public void a(i iVar, m mVar) {
        boolean z;
        b.b1(!mVar.equals(m.c), "Cannot add document to the RemoteDocumentCache with a read time of zero", new Object[0]);
        String f2 = f(iVar.a);
        d dVar = mVar.b;
        h hVar = this.b;
        ...
        if (iVar instanceof j) {
            ...
            Map<String, s> f3 = cVar.f3211d.a.u().f();
            j3.copyOnWrite();
            ...
            l2.b(true);
            r0 r0Var = this.a;
            r0Var.f3206i.execSQL("INSERT OR REPLACE INTO remote_documents (path, read_time_seconds, read_time_nanos, contents) VALUES (?, ?, ?, ?)", new Object[]{f2, Long.valueOf(dVar.b), Integer.valueOf(dVar.c), ((a) l2.build()).toByteArray()});
            this.a.f3202e.a((l) iVar.a.b.q());
        } else {
        ...
        l2.b(z);
        r0 r0Var2 = this.a;
        r0Var2.f3206i.execSQL("INSERT OR REPLACE INTO remote_documents (path, read_time_seconds, read_time_nanos, contents) VALUES (?, ?, ?, ?)", new Object[]{f2, Long.valueOf(dVar.b), Integer.valueOf(dVar.c), ((a) l2.build()).toByteArray()});
        this.a.f3202e.a((l) iVar.a.b.q());
    }
    ...
    public i b(f fVar) {
        ...
        i iVar = null;
        try {
            Cursor rawQueryWithFactory = this.a.f3206i.rawQueryWithFactory(new s0(new Object[]{f2}), "SELECT contents FROM remote_documents WHERE path = ?", null, null);
            try {
    ...
    public void c(f fVar) {
        String f2 = f(fVar);
        Object[] objArr = {f2};
        this.a.f3206i.execSQL("DELETE FROM remote_documents WHERE path = ?", objArr);
    }
