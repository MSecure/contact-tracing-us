...
public final class k {
    ...
    public k(m mVar, Boolean bool) {
        b.b1(mVar == null || bool == null, "Precondition can specify \"exists\" or \"updateTime\" but not both", new Object[0]);
        this.a = mVar;
        this.b = bool;
    }
    ...
    public boolean c(i iVar) {
        ...
        if (mVar == null) {
            Boolean bool = this.b;
            if (bool == null) {
                b.b1(b(), "Precondition should be empty", new Object[0]);
                return true;
    ...
    public String toString() {
        ...
        if (this.a != null) {
            ...
            b.z0("Invalid Precondition", new Object[0]);
            throw null;
        }
        sb.append(obj);
        sb.append("}");
