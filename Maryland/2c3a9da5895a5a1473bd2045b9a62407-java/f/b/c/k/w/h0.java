...
public final class h0 {
    ...
    public static l r(l lVar) {
        f.b.a.c.b.o.b.b1(lVar.n() > 4 && lVar.i(4).equals("documents"), "Tried to deserialize invalid key %s", lVar);
        return (l) lVar.o(5);
    }

    public f a(String str) {
        l d2 = d(str);
        f.b.a.c.b.o.b.b1(d2.i(1).equals(this.a.b), "Tried to deserialize key from different project.", new Object[0]);
        f.b.a.c.b.o.b.b1(d2.i(3).equals(this.a.c), "Tried to deserialize key from different database.", new Object[0]);
        return new f(r(d2));
    }
        ...
        if (ordinal2 != 0) {
            ...
            if (ordinal2 == 3) {
                ...
                for (i.c cVar : tVar.l().g()) {
                    ...
                    if (ordinal3 == 0) {
                        f.b.a.c.b.o.b.b1(cVar.l() == i.c.b.REQUEST_TIME, "Unknown transform setToServerValue: %s", cVar.l());
                        ...
                        dVar = new d(h.r(cVar.i()), new a.C0116a(cVar.k().a()));
                    } else {
                ...
                f.b.a.c.b.o.b.b1(z, "Transforms only support precondition \"exists == true\"", new Object[0]);
    ...
    public final l d(String str) {
        l s = l.s(str);
        f.b.a.c.b.o.b.b1(s.n() >= 4 && s.i(0).equals("projects") && s.i(2).equals("databases"), "Tried to deserialize invalid key %s", s);
        return s;
    }
    ...
    public t k(e eVar) {
        ...
        if (eVar instanceof m) {
            ...
            r.copyOnWrite();
            t.f((t) r.instance, g3);
            f.b.c.k.u.p.c cVar = jVar.f3218d;
            g.b g4 = g.g();
            for (h hVar : cVar.a) {
                String c = hVar.c();
                g4.copyOnWrite();
            ...
            for (f.b.c.k.u.p.d dVar : nVar.c) {
                ...
                if (oVar instanceof f.b.c.k.u.p.l) {
                    ...
                    } else if (oVar instanceof a.C0116a) {
                        aVar = i.c.n();
                        aVar.b(dVar.a.c());
                        a.b j4 = f.b.d.a.a.j();
                        List<s> list2 = ((a.C0116a) oVar).a;
                        j4.copyOnWrite();
        ...
        if (!eVar.b.b()) {
            k kVar = eVar.b;
            f.b.a.c.b.o.b.b1(!kVar.b(), "Can't serialize an empty precondition", new Object[0]);
            o.b i2 = o.i();
    ...
    public q.d m(c0 c0Var) {
        ...
        if (c0Var.f3113e != null) {
            f.b.a.c.b.o.b.b1(lVar.n() % 2 == 0, "Collection Group queries should be within a document path or root.", new Object[0]);
            String n = n(this.a, lVar);
            h2.copyOnWrite();
            q.d.d((q.d) h2.instance, n);
            p.c.a g2 = p.c.g();
            String str = c0Var.f3113e;
            g2.copyOnWrite();
            ...
            f.b.a.c.b.o.b.b1(lVar.n() % 2 != 0, "Document queries with filters are not supported.", new Object[0]);
        ...
        if (c0Var.b()) {
            a0.b f2 = a0.f();
            f.b.a.c.b.o.b.b1(c0Var.b(), "Called getLimit when no limit was set", new Object[0]);
            int i5 = (int) c0Var.f3114f;
            f2.copyOnWrite();
            a0.c((a0) f2.instance, i5);
            v.copyOnWrite();
            f.b.d.a.p.h((f.b.d.a.p) v.instance, (a0) f2.build());
        }
        f.b.c.k.s.c cVar = c0Var.f3115g;
        if (cVar != null) {
            f.b.d.a.c f3 = f(cVar);
            v.copyOnWrite();
            f.b.d.a.p.f((f.b.d.a.p) v.instance, f3);
        }
        f.b.c.k.s.c cVar2 = c0Var.f3116h;
        if (cVar2 != null) {
