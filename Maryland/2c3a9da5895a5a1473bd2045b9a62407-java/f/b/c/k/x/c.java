...
public class c {
    public final ExecutorC0121c a = new ExecutorC0121c();
    ...
    public class b {
        ...
        public final void b() {
            f.b.a.c.b.o.b.b1(this.b != null, "Caller should have verified scheduledFuture is non-null.", new Object[0]);
            this.b = null;
            f.b.a.c.b.o.b.b1(c.this.b.remove(this), "Delayed task not found.", new Object[0]);
        }
    }

    /* renamed from: f.b.c.k.x.c$c  reason: collision with other inner class name */
    public class ExecutorC0121c implements Executor {
        ...
        public class b implements Runnable, ThreadFactory {
            ...
            public Thread newThread(Runnable runnable) {
                f.b.a.c.b.o.b.b1(this.c == null, "Only one thread may be created in an AsyncQueue.", new Object[0]);
                this.c = runnable;
                this.b.countDown();
                return ExecutorC0121c.this.c;
            }
