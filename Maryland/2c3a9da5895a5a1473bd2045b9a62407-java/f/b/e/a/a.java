...
public class a implements Closeable {
    ...
    public String V() {
        return " at line " + (this.f3359f + 1) + " column " + ((this.f3357d - this.f3360g) + 1) + " path " + A();
    }
    ...
    public final String X(char c2) {
            ...
            while (true) {
                if (i6 < i5) {
                    ...
                    if (c3 == '\\') {
                        ...
                        if (this.f3357d != this.f3358e || v(1)) {
                            char[] cArr2 = this.c;
                            int i10 = this.f3357d;
                            int i11 = i10 + 1;
                            this.f3357d = i11;
                                        ...
                                        while (i12 < i13) {
                                            ...
                                            if (c6 < '0' || c6 > '9') {
                                                if (c6 >= 'a' && c6 <= 'f') {
                                                    ...
                                                    h2.append(new String(this.c, this.f3357d, 4));
                                                } else {
                                                    i3 = c6 - 'A';
                                                }
                                                i2 = i3 + 10;
        ...
        h22.append(new String(this.c, this.f3357d, 4));
    ...
    public final String Y() {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (i4 + i2 < this.f3358e) {
                    ...
                    sb.append(this.c, this.f3357d, i2);
                    this.f3357d += i2;
                    if (!v(1)) {
                    }
                } else if (v(i2 + 1)) {
        ...
        i3 = i2;
        if (sb == null) {
            str = new String(this.c, this.f3357d, i3);
        } else {
            sb.append(this.c, this.f3357d, i3);
            str = sb.toString();
        }
        this.f3357d += i3;
        return str;
    ...
    public final void a0(int i2) {
        int i3 = this.m;
        int[] iArr = this.f3365l;
        if (i3 == iArr.length) {
            int i4 = i3 * 2;
            this.f3365l = Arrays.copyOf(iArr, i4);
            this.o = Arrays.copyOf(this.o, i4);
            this.n = (String[]) Arrays.copyOf(this.n, i4);
        }
        int[] iArr2 = this.f3365l;
        int i5 = this.m;
        this.m = i5 + 1;
        iArr2[i5] = i2;
    }
        ...
        if (i6 == 1) {
            ...
            if (W != 34) {
                ...
                if (W == 44 || W == 59) {
                    ...
                    while (true) {
                        if (i13 < length) {
                            if ((this.f3357d + i13 >= this.f3358e && !v(i13 + 1)) || ((c2 = this.c[this.f3357d + i13]) != str2.charAt(i13) && c2 != str.charAt(i13))) {
                                break;
                            }
                            i13++;
                        } else if ((this.f3357d + length >= this.f3358e && !v(length + 1)) || !P(this.c[this.f3357d + length])) {
                            this.f3357d += length;
                            this.f3361h = i4;
                        }
                    }
    ...
    public final boolean v(int i2) {
        ...
        do {
            ...
            i3 = this.f3358e + read;
            this.f3358e = i3;
            if (this.f3359f == 0 && (i4 = this.f3360g) == 0 && i3 > 0 && cArr[0] == 65279) {
                this.f3357d++;
                this.f3360g = i4 + 1;
                i2++;
                continue;
