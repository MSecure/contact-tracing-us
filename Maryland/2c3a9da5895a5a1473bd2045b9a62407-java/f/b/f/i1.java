...
public final class i1 extends j {
    ...
    public static class b {
        ...
        public final void a(j jVar) {
            if (jVar.s()) {
                int binarySearch = Arrays.binarySearch(i1.f3399j, jVar.size());
                if (binarySearch < 0) {
                ...
                while (!this.a.isEmpty()) {
                    int binarySearch2 = Arrays.binarySearch(i1.f3399j, i1Var.f3400e);
                    if (binarySearch2 < 0) {
    ...
    public static final class c implements Iterator<j.g> {
        ...
        public c(j jVar, a aVar) {
            ...
            if (jVar instanceof i1) {
                i1 i1Var = (i1) jVar;
                ArrayDeque<i1> arrayDeque = new ArrayDeque<>(i1Var.f3404i);
                this.b = arrayDeque;
                arrayDeque.push(i1Var);
                j jVar2 = i1Var.f3401f;
    ...
    public class d extends InputStream {
        ...
        public int available() {
            return i1.this.f3400e - (this.f3408f + this.f3407e);
        }

        public final void c() {
            int i2;
            if (this.c != null && this.f3407e == (i2 = this.f3406d)) {
                this.f3408f += i2;
                int i3 = 0;
                this.f3407e = 0;
                if (this.b.hasNext()) {
        ...
        public void mark(int i2) {
            this.f3409g = this.f3408f + this.f3407e;
        }
        ...
        public final int v(byte[] bArr, int i2, int i3) {
            ...
            while (i4 > 0) {
                ...
                int min = Math.min(this.f3406d - this.f3407e, i4);
                if (bArr != null) {
                    this.c.o(bArr, this.f3407e, i2, min);
                    i2 += min;
                }
                this.f3407e += min;
                i4 -= min;
    ...
    public i1(j jVar, j jVar2) {
        ...
        int size = jVar.size();
        this.f3403h = size;
        this.f3400e = jVar2.size() + size;
        this.f3404i = Math.max(jVar.q(), jVar2.q()) + 1;
    }
    ...
    public void p(byte[] bArr, int i2, int i3, int i4) {
        ...
        if (i5 <= i6) {
            ...
            int i7 = i6 - i2;
            this.f3401f.p(bArr, i2, i3, i7);
            this.f3402g.p(bArr, 0, i3 + i7, i4 - i7);
            return;
        }
    ...
    public byte r(int i2) {
        int i3 = this.f3403h;
        return i2 < i3 ? this.f3401f.r(i2) : this.f3402g.r(i2 - i3);
    }

    @Override // f.b.f.j
    public boolean s() {
        return this.f3400e >= E(this.f3404i);
    }
    ...
    @Override // f.b.f.j
    public boolean t() {
        int x = this.f3401f.x(0, 0, this.f3403h);
        j jVar = this.f3402g;
    ...
    public int w(int i2, int i3, int i4) {
        ...
        int i6 = this.f3403h;
        if (i5 <= i6) {
            return this.f3401f.w(i2, i3, i4);
        }
        if (i3 >= i6) {
            return this.f3402g.w(i2, i3 - i6, i4);
        }
        int i7 = i6 - i3;
        return this.f3402g.w(this.f3401f.w(i2, i3, i7), 0, i4 - i7);
    }
    ...
    public int x(int i2, int i3, int i4) {
        ...
        int i6 = this.f3403h;
        if (i5 <= i6) {
            return this.f3401f.x(i2, i3, i4);
        }
        if (i3 >= i6) {
            return this.f3402g.x(i2, i3 - i6, i4);
        }
        int i7 = i6 - i3;
        return this.f3402g.x(this.f3401f.x(i2, i3, i7), 0, i4 - i7);
    }

    @Override // f.b.f.j
    public j y(int i2, int i3) {
        int k2 = j.k(i2, i3, this.f3400e);
        if (k2 == 0) {
            return j.c;
        }
        if (k2 == this.f3400e) {
        ...
        int i4 = this.f3403h;
        if (i3 <= i4) {
            return this.f3401f.y(i2, i3);
        }
        if (i2 >= i4) {
            return this.f3402g.y(i2 - i4, i3 - i4);
        }
        j jVar = this.f3401f;
        return new i1(jVar.y(i2, jVar.size()), this.f3402g.y(0, i3 - this.f3403h));
    }
}
