...
public abstract class j implements Iterable<Byte>, Serializable {
    ...
    public static final e f3411d = (d.a() ? new i(null) : new c(null));
    public int b = 0;
    ...
    public static final class d extends h {
        ...
        public byte i(int i2) {
            j.j(i2, this.f3414g);
            return this.f3415e[this.f3413f + i2];
        }

        @Override // f.b.f.j, f.b.f.j.h
        public void p(byte[] bArr, int i2, int i3, int i4) {
            System.arraycopy(this.f3415e, this.f3413f + i2, bArr, i3, i4);
        }
    ...
    public static class h extends g {
        ...
        public final String A(Charset charset) {
            return new String(this.f3415e, E(), size(), charset);
        }

        @Override // f.b.f.j
        public final void C(i iVar) {
            iVar.a(this.f3415e, E(), size());
        }
        ...
        @Override // f.b.f.j
        public byte i(int i2) {
            return this.f3415e[i2];
        }

        @Override // f.b.f.j
        public void p(byte[] bArr, int i2, int i3, int i4) {
            System.arraycopy(this.f3415e, i2, bArr, i3, i4);
        }
        ...
        @Override // f.b.f.j
        public int size() {
            return this.f3415e.length;
        }

        @Override // f.b.f.j
        public final boolean t() {
            int E = E();
            return w1.h(this.f3415e, E, size() + E);
        }

        @Override // f.b.f.j
        public final k v() {
            return k.h(this.f3415e, E(), size(), true);
        }
        ...
        public final int x(int i2, int i3, int i4) {
            int E = E() + i3;
            return w1.a.e(i2, this.f3415e, E, i4 + E);
        }

        @Override // f.b.f.j
        public final j y(int i2, int i3) {
            int k2 = j.k(i2, i3, size());
            return k2 == 0 ? j.c : new d(this.f3415e, E() + i2, k2);
        }
    }
    ...
    public static j h(Iterator<j> it, int i2) {
        ...
        if (i2 < 1) {
            ...
            if (Integer.MAX_VALUE - h2.size() < h3.size()) {
                ...
                if (h2 instanceof i1) {
                    i1 i1Var2 = (i1) h2;
                    if (h3.size() + i1Var2.f3402g.size() < 128) {
                        i1Var = new i1(i1Var2.f3401f, i1.D(i1Var2.f3402g, h3));
                        return i1Var;
                    } else if (i1Var2.f3401f.q() > i1Var2.f3402g.q() && i1Var2.f3404i > h3.q()) {
                        return new i1(i1Var2.f3401f, new i1(i1Var2.f3402g, h3));
                    }
                }
    ...
    public static j m(byte[] bArr, int i2, int i3) {
        ...
        return new h(f3411d.a(bArr, i2, i3));
    }
