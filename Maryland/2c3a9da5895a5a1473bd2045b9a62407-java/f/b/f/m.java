...
public abstract class m extends i {
    ...
    public static final boolean c = v1.f3482h;
    public n a;
    ...
    public static abstract class b extends m {
        ...
        public final void f0(int i2) {
            if (m.c) {
                ...
                byte[] bArr2 = this.f3445d;
                int i4 = this.f3447f;
                this.f3447f = i4 + 1;
                v1.s(bArr2, (long) i4, (byte) i2);
                this.f3448g += (int) (((long) this.f3447f) - j2);
                return;
            }
            while ((i2 & -128) != 0) {
                byte[] bArr3 = this.f3445d;
                int i5 = this.f3447f;
                this.f3447f = i5 + 1;
        ...
        public final void g0(long j2) {
            if (m.c) {
                ...
                this.f3448g += (int) (((long) this.f3447f) - j3);
                return;
            }
            while ((j2 & -128) != 0) {
                byte[] bArr3 = this.f3445d;
    ...
    public static class c extends m {
        ...
        @Override // f.b.f.m
        public final int G() {
            return this.f3450e - this.f3451f;
        }

        @Override // f.b.f.m
        public final void H(byte b) {
            try {
                byte[] bArr = this.f3449d;
                int i2 = this.f3451f;
                this.f3451f = i2 + 1;
                bArr[i2] = b;
            } catch (IndexOutOfBoundsException e2) {
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3451f), Integer.valueOf(this.f3450e), 1), e2);
            }
        }
        ...
        public final void X(String str) {
            ...
            try {
                ...
                if (A2 == A) {
                    int i3 = i2 + A2;
                    this.f3451f = i3;
                    c = w1.c(str, this.f3449d, i3, G());
                    this.f3451f = i2;
                    a0((c - i2) - A2);
                } else {
                    a0(w1.d(str));
                    c = w1.c(str, this.f3449d, this.f3451f, G());
                }
                this.f3451f = c;
            } catch (w1.c e2) {
                this.f3451f = i2;
        ...
        public final void d0(byte[] bArr, int i2, int i3) {
            try {
                System.arraycopy(bArr, i2, this.f3449d, this.f3451f, i3);
                this.f3451f += i3;
            } catch (IndexOutOfBoundsException e2) {
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3451f), Integer.valueOf(this.f3450e), Integer.valueOf(i3)), e2);
            }
        }
    }
    ...
    public static final class e extends b {
        ...
        public final OutputStream f3452h;

        public e(OutputStream outputStream, int i2) {
            super(i2);
            Objects.requireNonNull(outputStream, "out");
            this.f3452h = outputStream;
        }

        @Override // f.b.f.m
        public void H(byte b) {
            if (this.f3447f == this.f3446e) {
                h0();
            }
            byte[] bArr = this.f3445d;
            int i2 = this.f3447f;
        ...
        public void X(String str) {
            ...
            try {
                ...
                if (A2 == A) {
                    ...
                    try {
                        this.f3447f = i6;
                        int c2 = w1.c(str, this.f3445d, i6, this.f3446e - i6);
                        this.f3447f = i5;
                        i2 = (c2 - i5) - A2;
                        f0(i2);
                        this.f3447f = c2;
                    } catch (w1.c e2) {
                        this.f3448g -= this.f3447f - i5;
                        this.f3447f = i5;
                        throw e2;
                    ...
                    i2 = w1.d(str);
                    f0(i2);
                    this.f3447f = w1.c(str, this.f3445d, this.f3447f, i2);
                }
                this.f3448g += i2;
            } catch (w1.c e4) {
                F(str, e4);
        ...
        public final void h0() {
            this.f3452h.write(this.f3445d, 0, this.f3447f);
            this.f3447f = 0;
        }
        ...
        public void k0(byte[] bArr, int i2, int i3) {
            ...
            int i5 = this.f3447f;
            if (i4 - i5 >= i3) {
                System.arraycopy(bArr, i2, this.f3445d, i5, i3);
                this.f3447f += i3;
            } else {
                int i6 = i4 - i5;
                System.arraycopy(bArr, i2, this.f3445d, i5, i6);
                int i7 = i2 + i6;
                i3 -= i6;
                ...
                h0();
                if (i3 <= this.f3446e) {
                    System.arraycopy(bArr, i7, this.f3445d, 0, i3);
                    this.f3447f = i3;
                } else {
                    this.f3452h.write(bArr, i7, i3);
                }
            }
            this.f3448g += i3;
        }
