...
public class n1<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public Map<K, V> f3455d = Collections.emptyMap();

    /* renamed from: e  reason: collision with root package name */
    public boolean f3456e;

    /* renamed from: f  reason: collision with root package name */
    public volatile n1<K, V>.d f3457f;

    /* renamed from: g  reason: collision with root package name */
    public Map<K, V> f3458g = Collections.emptyMap();
    ...
    public class c implements Iterator<Map.Entry<K, V>> {
        ...
        /* renamed from: d  reason: collision with root package name */
        public Iterator<Map.Entry<K, V>> f3460d;
        ...
        public final Iterator<Map.Entry<K, V>> b() {
            if (this.f3460d == null) {
                this.f3460d = n1.this.f3455d.entrySet().iterator();
            }
            return (Iterator<Map.Entry<K, V>>) this.f3460d;
        }
        ...
        public boolean hasNext() {
            ...
            if (n1.this.f3455d.isEmpty() || !b().hasNext()) {
                return false;
            }
            return true;
        }
    ...
    public boolean containsKey(Object obj) {
        ...
        return a(comparable) >= 0 || this.f3455d.containsKey(comparable);
    }
    ...
    public Iterable<Map.Entry<K, V>> e() {
        return this.f3455d.isEmpty() ? (Iterable<Map.Entry<K, V>>) a.b : this.f3455d.entrySet();
    }

    @Override // java.util.AbstractMap, java.util.Map
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.f3457f == null) {
            this.f3457f = new d(null);
        }
        return this.f3457f;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (d2 != size) {
            return this.f3455d.equals(n1Var.f3455d);
        }
        return true;
    }
    ...
    public final SortedMap<K, V> f() {
        b();
        if (this.f3455d.isEmpty() && !(this.f3455d instanceof TreeMap)) {
            TreeMap treeMap = new TreeMap();
            this.f3455d = treeMap;
            this.f3458g = treeMap.descendingMap();
        }
        return (SortedMap) this.f3455d;
    }

    public void g() {
        if (!this.f3456e) {
            this.f3455d = this.f3455d.isEmpty() ? Collections.emptyMap() : Collections.unmodifiableMap(this.f3455d);
            this.f3458g = this.f3458g.isEmpty() ? Collections.emptyMap() : Collections.unmodifiableMap(this.f3458g);
            this.f3456e = true;
        }
    }
    ...
    public V get(Object obj) {
        ...
        return this.f3455d.get(comparable);
    }
    ...
    public int hashCode() {
        ...
        return this.f3455d.size() > 0 ? i2 + this.f3455d.hashCode() : i2;
    }
    ...
    public V remove(Object obj) {
        ...
        return this.f3455d.remove(comparable);
    }

    public int size() {
        return this.f3455d.size() + this.c.size();
    }
}
