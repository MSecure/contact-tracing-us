...
public final class t extends s<z.d> {
    ...
    public <UT, UB> UB g(h1 h1Var, Object obj, r rVar, v<z.d> vVar, UB ub, r1<UT, UB> r1Var) {
        ...
        if (!dVar2.f3512e || !dVar2.f3513f) {
            ...
            if (y1Var == y1.ENUM) {
                i2 = h1Var.j();
                if (eVar.f3514d.b.findValueByNumber(i2) == null) {
                    Class<?> cls = l1.a;
                    if (ub == null) {
                        ub = r1Var.m();
                    }
            ...
            switch (dVar2.f3511d.ordinal()) {
                ...
                case 13:
                    arrayList = new ArrayList();
                    h1Var.N(arrayList);
                    ub = (UB) l1.y(i3, arrayList, eVar.f3514d.b, ub, r1Var);
                    break;
                case 14:
                    arrayList = new ArrayList();
                    h1Var.p(arrayList);
    ...
    public void h(h1 h1Var, Object obj, r rVar, v<z.d> vVar) {
        z.e eVar = (z.e) obj;
        vVar.o(eVar.f3514d, h1Var.A(eVar.c.getClass(), rVar));
    }
    ...
    public void i(j jVar, Object obj, r rVar, v<z.d> vVar) {
        ...
        if (wrap.hasArray()) {
            ...
            vVar.o(eVar.f3514d, buildPartial);
    ...
    public void j(a2 a2Var, Map.Entry<?, ?> entry) {
        ...
        if (dVar.f3512e) {
            switch (dVar.f3511d.ordinal()) {
                case 0:
                    l1.G(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 1:
                    l1.K(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 2:
                    l1.N(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 3:
                    l1.V(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 4:
                case 13:
                    l1.M(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 5:
                    l1.J(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 6:
                    l1.I(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 7:
                    l1.E(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 8:
                ...
                case 11:
                    ...
                    return;
                case 12:
                    l1.U(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 14:
                    l1.P(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 15:
                    l1.Q(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 16:
                    l1.R(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                case 17:
                    l1.S(dVar.c, (List) entry.getValue(), a2Var, dVar.f3513f);
                    return;
                default:
                    return;
            }
