...
public final class a {
    ...
    public final List<f.d.a.d.b> f3531d = new ArrayList();
    ...
    public static final class b extends f implements j.j.a.b<String, String> {
        ...
        public String d(String str) {
            ...
            h2.append(this.f3541d);
            return f.b.a.c.b.o.b.W0(context, h2.toString());
        }
    }
    ...
    public a(Context context, String[] strArr, Map<String, String> map) {
        ...
        while (it.hasNext()) {
            ...
            f.d.a.d.b bVar = null;
            try {
                String W0 = f.b.a.c.b.o.b.W0(context, "license_" + m + "_licenseDescription");
                if (h.o(W0, "raw:", false, 2)) {
                    Resources resources = context.getResources();
                    String l2 = h.l(W0, "raw:");
                ...
                String W02 = f.b.a.c.b.o.b.W0(context, "license_" + m + "_licenseName");
                String W03 = f.b.a.c.b.o.b.W0(context, "license_" + m + "_licenseWebsite");
                bVar = new f.d.a.d.b(m, W02, W03, f.b.a.c.b.o.b.W0(context, "license_" + m + "_licenseShortDescription"), str);
            } catch (Exception e2) {
                Log.e("aboutlibraries", "Failed to generateLicense from file: " + e2);
            }
            if (bVar != null) {
                this.f3531d.add(bVar);
            }
            i2 = 4;
        }
        ...
        while (it2.hasNext()) {
            ...
            if (b3 != null) {
                ...
                if (!(str5 == null || (b2 = b(context, str5)) == null)) {
                    e.c(b2, "enchantWith");
                    String b4 = b3.b(b2.f3556e);
                    b3.f3556e = b4 == null ? b3.f3556e : b4;
                    String b5 = b3.b(b2.f3557f);
                    b3.f3557f = b5 == null ? b3.f3557f : b5;
                    String b6 = b3.b(b2.f3558g);
                    b3.f3558g = b6 == null ? b3.f3558g : b6;
                    String b7 = b3.b(b2.f3559h);
                    b3.f3559h = b7 == null ? b3.f3559h : b7;
                    String b8 = b3.b(b2.f3560i);
                    b3.f3560i = b8 == null ? b3.f3560i : b8;
                    String b9 = b3.b(b2.f3561j);
                    b3.f3561j = b9 == null ? b3.f3561j : b9;
                    String b10 = b3.b(b2.f3562k);
                    b3.f3562k = b10 == null ? b3.f3562k : b10;
                    Set<f.d.a.d.b> set = b2.f3563l;
                    b3.f3563l = set == null ? b3.f3563l : set;
                    b3.m = b2.m;
    ...
    public final List<f.d.a.d.a> a(List<f.d.a.d.a> list, String str, boolean z, int i2) {
        ...
        for (f.d.a.d.a aVar : list) {
            ...
            } else if (h.a(aVar.f3556e, str, true) || h.a(aVar.b, str, true)) {
                arrayList.add(aVar);
                i3++;
                if (i2 != -1 && i2 < i3) {
                    break;
    ...
    public final f.d.a.d.a b(Context context, String str) {
        ...
        try {
            f.d.a.d.a aVar = new f.d.a.d.a(m, false, false, f.b.a.c.b.o.b.W0(context, "library_" + m + "_libraryName"), null, null, null, null, null, null, null, false, null, null, 16374);
            HashMap<String, String> c2 = c(context, m);
            String W0 = f.b.a.c.b.o.b.W0(context, "library_" + m + "_author");
            e.c(W0, "<set-?>");
            aVar.f3557f = W0;
            String W02 = f.b.a.c.b.o.b.W0(context, "library_" + m + "_authorWebsite");
            e.c(W02, "<set-?>");
            aVar.f3558g = W02;
            String f2 = f(f.b.a.c.b.o.b.W0(context, "library_" + m + "_libraryDescription"), c2);
            e.c(f2, "<set-?>");
            aVar.f3559h = f2;
            String W03 = f.b.a.c.b.o.b.W0(context, "library_" + m + "_libraryVersion");
            e.c(W03, "<set-?>");
            aVar.f3560i = W03;
            String W04 = f.b.a.c.b.o.b.W0(context, "library_" + m + "_libraryArtifactId");
            e.c(W04, "<set-?>");
            aVar.f3561j = W04;
            String W05 = f.b.a.c.b.o.b.W0(context, "library_" + m + "_libraryWebsite");
            e.c(W05, "<set-?>");
            aVar.f3562k = W05;
            String W06 = f.b.a.c.b.o.b.W0(context, "library_" + m + "_licenseIds");
            String W07 = f.b.a.c.b.o.b.W0(context, "library_" + m + "_licenseId");
            if (!h.h(W06) || !h.h(W07)) {
                set = new LinkedHashSet<>();
                for (String str2 : h.h(W06) ? f.b.a.c.b.o.b.o1(W07) : h.n(W06, new String[]{","}, false, 0, 6)) {
                    e.c(str2, "licenseName");
                    Iterator it = new ArrayList(this.f3531d).iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            bVar = null;
                            break;
                    ...
                    if (bVar != null) {
                        ...
                        String f3 = f(a2.f3564d, c2);
                        e.c(f3, "<set-?>");
                        a2.f3564d = f3;
                        String f4 = f(a2.f3565e, c2);
                        e.c(f4, "<set-?>");
                        a2.f3565e = f4;
                        set.add(a2);
                    }
                ...
                set = Collections.singleton(new f.d.a.d.b("", f.b.a.c.b.o.b.W0(context, "library_" + m + "_licenseVersion"), f.b.a.c.b.o.b.W0(context, "library_" + m + "_licenseLink"), f(f.b.a.c.b.o.b.W0(context, "library_" + m + "_licenseContent"), c2), f(f.b.a.c.b.o.b.W0(context, "library_" + m + "_licenseContent"), c2)));
                e.b(set, "java.util.Collections.singleton(element)");
            }
            aVar.f3563l = set;
            Boolean valueOf = Boolean.valueOf(f.b.a.c.b.o.b.W0(context, "library_" + m + "_isOpenSource"));
            e.b(valueOf, "java.lang.Boolean.valueO… name + \"_isOpenSource\"))");
            aVar.m = valueOf.booleanValue();
            String W08 = f.b.a.c.b.o.b.W0(context, "library_" + m + "_repositoryLink");
            e.c(W08, "<set-?>");
            aVar.n = W08;
            String W09 = f.b.a.c.b.o.b.W0(context, "library_" + m + "_classPath");
            e.c(W09, "<set-?>");
            aVar.o = W09;
            if (!h.h(aVar.f3556e) || !h.h(aVar.f3559h)) {
                return aVar;
            }
            return null;
        } catch (Exception e2) {
            ...
            if (!a2.isEmpty()) {
                ...
                if (!(strArr.length != 0)) {
                    for (String str3 : strArr) {
                        String W0 = f.b.a.c.b.o.b.W0(context, "library_" + str + "_" + str3);
                        if (W0.length() > 0) {
                            hashMap.put(str3, W0);
                        }
                    }
    ...
    public final f.d.a.d.a e(String str) {
        ...
        while (it.hasNext()) {
            ...
            if (h.b(aVar.f3556e, str, true) || h.b(aVar.b, str, true)) {
                return aVar;
            }
            while (it.hasNext()) {
            }
