...
public final class c {
    ...
    public ArrayList<f.d.a.d.a> f3551d = new ArrayList<>();
    ...
    public final class a extends AsyncTask<String, g, g> {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ c f3554e;
        ...
        public g doInBackground(String[] strArr) {
            ...
            boolean z4;
            e.c(strArr, "strings");
            if (c.a(this.f3554e).b.length == 0) {
                Context context2 = this.f3553d;
                HashMap<String, String> hashMap = c.a(this.f3554e).s;
                ...
                aVar = new a(this.f3553d, c.a(this.f3554e).b, c.a(this.f3554e).s);
            }
            b a2 = c.a(this.f3554e);
            Boolean x0 = f.b.a.c.b.o.b.x0(this.f3553d, Boolean.valueOf(c.a(this.f3554e).f3544f), "aboutLibraries_description_showIcon");
            a2.f3544f = x0 != null ? x0.booleanValue() : false;
            b a3 = c.a(this.f3554e);
            Boolean x02 = f.b.a.c.b.o.b.x0(this.f3553d, Boolean.valueOf(c.a(this.f3554e).f3546h), "aboutLibraries_description_showVersion");
            a3.f3546h = x02 != null ? x02.booleanValue() : false;
            b a4 = c.a(this.f3554e);
            Boolean x03 = f.b.a.c.b.o.b.x0(this.f3553d, Boolean.valueOf(c.a(this.f3554e).f3548j), "aboutLibraries_description_showVersionName");
            a4.f3548j = x03 != null ? x03.booleanValue() : false;
            b a5 = c.a(this.f3554e);
            Boolean x04 = f.b.a.c.b.o.b.x0(this.f3553d, Boolean.valueOf(c.a(this.f3554e).f3549k), "aboutLibraries_description_showVersionCode");
            a5.f3549k = x04 != null ? x04.booleanValue() : false;
            b a6 = c.a(this.f3554e);
            String y0 = f.b.a.c.b.o.b.y0(this.f3553d, c.a(this.f3554e).f3545g, "aboutLibraries_description_name");
            if (y0 == null) {
                y0 = "";
            }
            a6.f3545g = y0;
            b a7 = c.a(this.f3554e);
            String y02 = f.b.a.c.b.o.b.y0(this.f3553d, c.a(this.f3554e).f3547i, "aboutLibraries_description_text");
            if (y02 == null) {
                y02 = "";
            }
            a7.f3547i = y02;
            c.a(this.f3554e).f3550l = f.b.a.c.b.o.b.y0(this.f3553d, c.a(this.f3554e).f3550l, "aboutLibraries_description_special1_name");
            c.a(this.f3554e).m = f.b.a.c.b.o.b.y0(this.f3553d, c.a(this.f3554e).m, "aboutLibraries_description_special1_text");
            c.a(this.f3554e).n = f.b.a.c.b.o.b.y0(this.f3553d, c.a(this.f3554e).n, "aboutLibraries_description_special2_name");
            c.a(this.f3554e).o = f.b.a.c.b.o.b.y0(this.f3553d, c.a(this.f3554e).o, "aboutLibraries_description_special2_text");
            c.a(this.f3554e).p = f.b.a.c.b.o.b.y0(this.f3553d, c.a(this.f3554e).p, "aboutLibraries_description_special3_name");
            c.a(this.f3554e).q = f.b.a.c.b.o.b.y0(this.f3553d, c.a(this.f3554e).q, "aboutLibraries_description_special3_text");
            HashMap<String, HashMap<String, String>> hashMap2 = c.a(this.f3554e).r;
            if (hashMap2 != null) {
            ...
            Objects.requireNonNull(c.a(this.f3554e));
            Objects.requireNonNull(c.a(this.f3554e));
            Objects.requireNonNull(this.f3554e);
            c cVar2 = this.f3554e;
            Context context3 = this.f3553d;
            String[] strArr6 = c.a(cVar2).c;
            String[] strArr7 = c.a(this.f3554e).f3542d;
            Objects.requireNonNull(c.a(this.f3554e));
            Objects.requireNonNull(c.a(this.f3554e));
            e.c(context3, "ctx");
            ...
            cVar.f3551d = arrayList2;
            Objects.requireNonNull(this.f3554e);
            Objects.requireNonNull(c.a(this.f3554e));
            boolean z7 = c.a(this.f3554e).f3546h || c.a(this.f3554e).f3548j || c.a(this.f3554e).f3549k;
            if (c.a(this.f3554e).f3544f && z7) {
                PackageManager packageManager = this.f3553d.getPackageManager();
                String packageName2 = this.f3553d.getPackageName();
                try {
                ...
                if (c.a(this.f3554e).f3544f && applicationInfo != null) {
                    this.c = applicationInfo.loadIcon(packageManager);
                }
                this.a = null;
                this.b = null;
        ...
        public void onPostExecute(g gVar) {
            g gVar2 = gVar;
            e.c(gVar2, "nothing");
            f.d.b.p.a b2 = c.b(this.f3554e);
            l<Item> lVar = b2.f3583g;
            b<Item> bVar = b2.a;
            lVar.d(bVar != null ? bVar.t(b2.b) : 0);
            boolean z = c.a(this.f3554e).f3546h || c.a(this.f3554e).f3548j || c.a(this.f3554e).f3549k;
            if (c.a(this.f3554e).f3544f && z) {
                f.d.b.p.a b3 = c.b(this.f3554e);
                f.d.a.e.b.a aVar = new f.d.a.e.b.a(c.a(this.f3554e));
                aVar.c = this.a;
                aVar.b = this.b;
                aVar.f3566d = this.c;
                b3.e(aVar);
            ...
            Iterator<f.d.a.d.a> it = this.f3554e.f3551d.iterator();
            while (it.hasNext()) {
                f.d.a.d.a next = it.next();
                Objects.requireNonNull(c.a(this.f3554e));
                e.b(next, "library");
                arrayList.add(new f.d.a.e.b.d(next, c.a(this.f3554e)));
            }
            c.b(this.f3554e).d(arrayList);
