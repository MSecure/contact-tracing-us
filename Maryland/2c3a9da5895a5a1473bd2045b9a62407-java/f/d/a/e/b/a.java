...
public final class a extends f.d.b.q.a<C0130a> {
    ...
    public static final class C0130a extends RecyclerView.b0 {
        ...
        public static final class C0131a extends f implements j.j.a.b<TypedArray, g> {
            public final /* synthetic */ C0130a c;

            /* renamed from: d  reason: collision with root package name */
            public final /* synthetic */ Context f3568d;
            ...
            public g d(TypedArray typedArray) {
                ...
                Context context2 = this.f3568d;
                e.b(context2, "ctx");
                view.setBackgroundColor(typedArray2.getColor(i3, f.b.a.c.b.o.b.Z0(context, i4, f.b.a.c.b.o.b.X0(context2, R$color.about_libraries_dividerLight_openSource))));
        ...
        public C0130a(View view) {
            ...
            e.b(context, "ctx");
            f.b.a.c.b.o.b.E1(context, null, 0, 0, new C0131a(this, context), 7);
        }
    }
    ...
    public void g(RecyclerView.b0 b0Var, List list) {
        ...
        if (!this.f3567e.f3544f || (drawable = this.f3566d) == null) {
        ...
        String str = this.f3567e.f3545g;
        boolean z = true;
        if (!(str == null || str.length() == 0)) {
            aVar.u.setText(this.f3567e.f3545g);
        } else {
        ...
        if (!TextUtils.isEmpty(this.f3567e.f3550l) && !TextUtils.isEmpty(this.f3567e.m)) {
            aVar.w.setText(this.f3567e.f3550l);
            aVar.w.setVisibility(0);
            aVar.w.setOnClickListener(new b(0, this, context));
            aVar.v.setVisibility(0);
        }
        if (!TextUtils.isEmpty(this.f3567e.n) && !TextUtils.isEmpty(this.f3567e.o)) {
            aVar.x.setText(this.f3567e.n);
            aVar.x.setVisibility(0);
            aVar.x.setOnClickListener(new b(1, this, context));
            aVar.v.setVisibility(0);
        }
        if (!TextUtils.isEmpty(this.f3567e.p) && !TextUtils.isEmpty(this.f3567e.q)) {
            aVar.y.setText(this.f3567e.p);
        ...
        if (bVar2.f3546h) {
            ...
            sb.append(this.b);
            sb.append(')');
        } else if (bVar2.f3548j) {
            textView = aVar.z;
            sb = new StringBuilder();
            sb.append(context.getString(R$string.version));
            sb.append(' ');
            sb.append(this.c);
        } else if (bVar2.f3549k) {
            textView = aVar.z;
            sb = new StringBuilder();
            sb.append(context.getString(R$string.version));
            sb.append(' ');
            ...
            String str2 = this.f3567e.f3547i;
            if (!(str2 == null || str2.length() == 0)) {
                z = false;
            }
            if (z) {
                aVar.B.setText(Html.fromHtml(this.f3567e.f3547i));
            ...
            bVar = this.f3567e;
            if ((bVar.f3544f && !bVar.f3546h) || TextUtils.isEmpty(bVar.f3547i)) {
                aVar.A.setVisibility(8);
                return;
            }
        }
        textView.setText(sb.toString());
        String str22 = this.f3567e.f3547i;
        z = false;
        if (z) {
        }
        bVar = this.f3567e;
