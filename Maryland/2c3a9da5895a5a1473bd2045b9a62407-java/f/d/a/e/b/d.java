...
public final class d extends f.d.b.q.a<a> {
    ...
    public static final class a extends RecyclerView.b0 {
        ...
        public static final class C0132a extends f implements j.j.a.b<TypedArray, g> {
            public final /* synthetic */ a c;

            /* renamed from: d  reason: collision with root package name */
            public final /* synthetic */ Context f3569d;

            /* JADX INFO: super call moved to the top of the method (can break code semantics) */
            public C0132a(a aVar, Context context) {
                super(1);
                this.c = aVar;
                this.f3569d = context;
            }
            ...
            public g d(TypedArray typedArray) {
                ...
                Context context2 = this.f3569d;
                e.b(context2, "ctx");
                materialCardView.setCardBackgroundColor(typedArray2.getColor(i2, f.b.a.c.b.o.b.Z0(context, i3, f.b.a.c.b.o.b.X0(context2, R$color.about_libraries_card))));
                ...
                Context context3 = this.f3569d;
                e.b(context3, "ctx");
                int i6 = R$attr.aboutLibrariesOpenSourceDivider;
                Context context4 = this.f3569d;
                e.b(context4, "ctx");
                int i7 = R$color.about_libraries_dividerLight_openSource;
                view.setBackgroundColor(typedArray2.getColor(i5, f.b.a.c.b.o.b.Z0(context3, i6, f.b.a.c.b.o.b.X0(context4, i7))));
                this.c.x.setTextColor(typedArray2.getColorStateList(i4));
                View view2 = this.c.y;
                Context context5 = this.f3569d;
                e.b(context5, "ctx");
                Context context6 = this.f3569d;
                e.b(context6, "ctx");
                view2.setBackgroundColor(typedArray2.getColor(i5, f.b.a.c.b.o.b.Z0(context5, i6, f.b.a.c.b.o.b.X0(context6, i7))));
        ...
        public a(View view) {
            ...
            e.b(context, "ctx");
            f.b.a.c.b.o.b.E1(context, null, 0, 0, new C0132a(this, context), 7);
        }
    }
        ...
        try {
            ...
            if (!(a2 == null || (str = a2.f3565e) == null)) {
                if (str.length() > 0) {
                    ...
                    aVar2.a.f29f = Html.fromHtml(str2);
                    aVar2.a().show();
                    return;
                }
            }
    ...
    public void g(RecyclerView.b0 b0Var, List list) {
        ...
        Context context = view.getContext();
        aVar.u.setText(this.b.f3556e);
        aVar.v.setText(this.b.f3557f);
        if (TextUtils.isEmpty(this.b.f3559h)) {
            textView = aVar.x;
            charSequence = this.b.f3559h;
        } else {
            textView = aVar.x;
            charSequence = Html.fromHtml(this.b.f3559h);
        }
        textView.setText(charSequence);
        Objects.requireNonNull(this.c);
        boolean z = false;
        if (!(!(this.b.f3560i.length() == 0) || (a3 = this.b.a()) == null || (str3 = a3.b) == null)) {
            if (str3.length() == 0) {
                aVar.y.setVisibility(8);
                aVar.z.setVisibility(8);
                aVar.A.setVisibility(8);
                if (this.b.f3558g.length() > 0) {
        ...
        String str4 = "";
        if (this.b.f3560i.length() > 0) {
            Objects.requireNonNull(this.c);
            aVar.z.setText(this.b.f3560i);
        } else {
            aVar.z.setText(str4);
        }
        if (!(this.b.a() == null || (a2 = this.b.a()) == null || (str2 = a2.b) == null)) {
            if ((str2.length() > 0) && this.c.f3543e) {
                textView2 = aVar.A;
