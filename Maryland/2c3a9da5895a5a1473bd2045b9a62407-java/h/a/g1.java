...
public final class g1 implements Executor {
    ...
    public final AtomicReference<Thread> f3633d = new AtomicReference<>();
    ...
    public final void a() {
        while (this.f3633d.compareAndSet(null, Thread.currentThread())) {
            while (true) {
                try {
    ...
    public void d() {
        f.b.a.c.b.o.b.G(Thread.currentThread() == this.f3633d.get(), "Not called from the SynchronizationContext");
    }
