...
public final class i {
    ...
    public i(String str) {
        ...
        synchronized (j0.class) {
            if (j0.f3640d == null) {
                List<i0> p1 = f.b.a.c.b.o.b.p1(i0.class, j0.f3641e, i0.class.getClassLoader(), new j0.a());
                j0.f3640d = new j0();
                for (i0 i0Var : p1) {
                    Logger logger2 = j0.c;
    ...
    public q0.b b(Map<String, ?> map, h.a.e eVar) {
        ...
        if (map != null) {
            try {
                list = f.b.a.c.b.o.b.U1(f.b.a.c.b.o.b.T0(map));
            } catch (RuntimeException e2) {
                return new q0.b(c1.f3615h.g("can't parse load balancer configuration").f(e2));
            }
        } else {
            list = null;
        }
        ...
        return new q0.b(c1.f3615h.g("None of " + arrayList + " specified by Service Config are available."));
    }
}
