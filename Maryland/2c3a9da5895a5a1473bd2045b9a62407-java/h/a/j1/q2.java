...
public final class q2 implements Executor, Runnable {
    ...
    public static final Logger f3831e = Logger.getLogger(q2.class.getName());

    /* renamed from: f  reason: collision with root package name */
    public static final b f3832f;
    public final Executor b;
    public final Queue<Runnable> c = new ConcurrentLinkedQueue();

    /* renamed from: d  reason: collision with root package name */
    private volatile int f3833d = 0;
    ...
    static {
        ...
        try {
            ...
            f3831e.log(Level.SEVERE, "FieldUpdaterAtomicHelper failed", th);
            bVar = new d(null);
        }
        f3832f = bVar;
    }
