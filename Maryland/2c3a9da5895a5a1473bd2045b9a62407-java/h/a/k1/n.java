...
public class n {
    ...
    public final a f3959d = new a(0, 65535);
    ...
    public final class a {
        ...
        public int b() {
            return Math.max(0, Math.min(this.c, (int) this.a.c)) - this.f3960d;
        }

        public int c() {
            return Math.min(this.c, n.this.f3959d.c);
        }
        ...
        public void d(e eVar, int i2, boolean z) {
            do {
                ...
                try {
                    ...
                    f.b bVar = this.f3961e.m;
                    synchronized (bVar.c) {
                        b.G(bVar.f3686f, "onStreamAllocated was not called, but it seems the stream is active");
                        int i4 = bVar.f3685e;
                        boolean z3 = i4 < 32768;
                        int i5 = i4 - min;
                        bVar.f3685e = i5;
    ...
    public boolean c(int i2) {
        if (i2 >= 0) {
            ...
            f[] l2 = this.a.l();
            for (f fVar : l2) {
                a aVar = (a) fVar.f3930k;
                if (aVar == null) {
                    fVar.f3930k = new a(this, fVar, this.c);
                } else {
                    aVar.a(i3);
                }
            }
