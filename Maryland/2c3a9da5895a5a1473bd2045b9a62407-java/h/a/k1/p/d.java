...
public final class d implements HostnameVerifier {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:52:0x0121, code lost:
        r1 = r2.f3980g;
        r3 = r2.f3977d;
        r0 = new java.lang.String(r1, r3, r2.f3979f - r3);
     */
    ...
    public boolean b(String str, X509Certificate x509Certificate) {
        ...
        if (!z) {
            ...
            cVar.f3978e = 0;
            cVar.f3979f = 0;
            cVar.f3980g = cVar.a.toCharArray();
            String c = cVar.c();
            if (c != null) {
                while (true) {
                    int i7 = cVar.c;
                    ...
                    if (c2 == '\"') {
                        ...
                        while (true) {
                            ...
                            if (i10 != cVar.b) {
                                ...
                                if (cArr[i10] == '\"') {
                                    ...
                                    } while (cVar.f3980g[i10] == ' ');
                                    char[] cArr2 = cVar.f3980g;
                                    int i11 = cVar.f3977d;
                                    str2 = new String(cArr2, i11, cVar.f3978e - i11);
                                } else {
                                    if (cArr[i10] == '\\') {
                                        cArr[i9] = cVar.b();
                                    } else {
                        ...
                        if (c2 == '+' || c2 == ',' || c2 == ';') {
                            ...
                            while (true) {
                                int i12 = cVar.c;
                                if (i12 >= cVar.b) {
                                    char[] cArr3 = cVar.f3980g;
                                    int i13 = cVar.f3977d;
                                    str2 = new String(cArr3, i13, cVar.f3978e - i13);
                                    break;
                                }
                                char[] cArr4 = cVar.f3980g;
                                char c3 = cArr4[i12];
                                if (c3 == ' ') {
                                    int i14 = cVar.f3978e;
                                    cVar.f3979f = i14;
                            ...
                            char[] cArr7 = cVar.f3980g;
                            int i18 = cVar.f3977d;
                            str2 = new String(cArr7, i18, cVar.f3978e - i18);
                        }
                    } else if (i7 + 4 < i8) {
                        cVar.f3977d = i7;
                        while (true) {
                        ...
                        if (i21 < 5 || (i21 & 1) == 0) {
                            ...
                            str2 = new String(cVar.f3980g, cVar.f3977d, i21);
                        }
                    } else {
