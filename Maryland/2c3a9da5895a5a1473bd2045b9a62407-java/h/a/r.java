...
public final class r implements Comparable<r> {
    ...
    public static final b f4077e = new b(null);

    /* renamed from: f  reason: collision with root package name */
    public static final long f4078f;

    /* renamed from: g  reason: collision with root package name */
    public static final long f4079g;

    /* renamed from: h  reason: collision with root package name */
    public static final long f4080h = TimeUnit.SECONDS.toNanos(1);
    public final c b;
    public final long c;

    /* renamed from: d  reason: collision with root package name */
    public volatile boolean f4081d;
    ...
    public r(c cVar, long j2, boolean z) {
        ...
        this.b = cVar;
        long min = Math.min(f4078f, Math.max(f4079g, j2));
        this.c = nanoTime + min;
        this.f4081d = z && min <= 0;
    }
    ...
    public long e(TimeUnit timeUnit) {
        Objects.requireNonNull((b) this.b);
        long nanoTime = System.nanoTime();
        if (!this.f4081d && this.c - nanoTime <= 0) {
            this.f4081d = true;
        }
