...
public final class b implements j.l.b<c> {
    ...
    public final j.j.a.c<CharSequence, Integer, j.c<Integer, Integer>> f4103d;
    ...
    public static final class a implements Iterator<c> {
        ...
        public final void b() {
            ...
            int i4 = bVar.c;
            if (i4 > 0) {
                int i5 = this.f4106f + 1;
                this.f4106f = i5;
            }
            if (i2 <= bVar.a.length()) {
                b bVar2 = this.f4107g;
                j.c<Integer, Integer> c2 = bVar2.f4103d.c(bVar2.a, Integer.valueOf(this.f4104d));
                if (c2 == null) {
                    cVar = new c(this.c, h.c(this.f4107g.a));
                    this.f4105e = cVar;
                    this.f4104d = -1;
                    this.b = 1;
                }
