...
public final class j extends b implements d, f, Comparable<j>, Serializable {
    ...
    public j(f fVar, q qVar) {
        f.b.a.c.b.o.b.A1(fVar, "dateTime");
        this.b = fVar;
    ...
    public int compareTo(j jVar) {
        ...
        if (this.c.equals(jVar2.c)) {
            ...
            fVar2 = this.b;
            int i2 = fVar2.c.f4148e;
            fVar = jVar2.b;
            int i3 = i2 - fVar.c.f4148e;
            if (i3 != 0) {
                return i3;
            }
        }
    ...
    public d l(l.b.a.w.j jVar, long j2) {
        ...
        if (ordinal != 29) {
            ...
            fVar = this.b;
            qVar = q.z(aVar.f4286e.a(j2, aVar));
        }
        return v(fVar, qVar);
    }
