    ...
    public static Object a(byte b2, DataInput dataInput) {
        ...
        if (b2 != 64) {
            switch (b2) {
                case 1:
                    c cVar = c.f4135d;
                    return c.n(dataInput.readLong(), (long) dataInput.readInt());
                case 2:
                    d dVar = d.f4136d;
                    return d.z(dataInput.readLong(), (long) dataInput.readInt());
                case 3:
                    e eVar = e.f4137e;
                ...
                case 7:
                    ...
                    if (readUTF.equals("Z") || readUTF.startsWith("+") || readUTF.startsWith("-")) {
                        ...
                        return new r(readUTF, q.f4166g.s());
                    } else {
                        if (readUTF.startsWith("UTC+") || readUTF.startsWith("GMT+") || readUTF.startsWith("UTC-") || readUTF.startsWith("GMT-")) {
                            ...
                            if (x.c == 0) {
                                ...
                                rVar = new r(readUTF.substring(0, 3) + x.f4169d, x.s());
                            }
                            return rVar;
        ...
        if (b2 != 64) {
            switch (b2) {
                ...
                case 3:
                    ...
                    objectOutput.writeByte(eVar.f4140d);
                    return;
                case 4:
