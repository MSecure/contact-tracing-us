...
public final class o extends c implements d, f, Comparable<o>, Serializable {
    ...
    public static final /* synthetic */ int f4163d = 0;
    public final int b;
    public final int c;
    ...
    public static o q(e eVar) {
        ...
        try {
            if (!l.b.a.t.m.f4188d.equals(h.l(eVar))) {
                eVar = e.E(eVar);
            }
    ...
    public <R> R c(l<R> lVar) {
        if (lVar == k.b) {
            return (R) l.b.a.t.m.f4188d;
        }
        if (lVar == k.c) {
            return (R) b.MONTHS;
        }
        if (lVar == k.f4304f || lVar == k.f4305g || lVar == k.f4302d || lVar == k.a || lVar == k.f4303e) {
            return null;
        }
    ...
    @Override // l.b.a.w.f
    public d n(d dVar) {
        if (h.l(dVar).equals(l.b.a.t.m.f4188d)) {
    ...
    public o m(long j2, l.b.a.w.m mVar) {
        ...
        switch (((b) mVar).ordinal()) {
            ...
            case 10:
                return v(j2);
            case 11:
                return v(f.b.a.c.b.o.b.H1(j2, 10));
            case 12:
                return v(f.b.a.c.b.o.b.H1(j2, 100));
            case 13:
                return v(f.b.a.c.b.o.b.H1(j2, 1000));
            case 14:
                a aVar = a.ERA;
                return l(aVar, f.b.a.c.b.o.b.G1(i(aVar), j2));
            default:
                throw new n("Unsupported unit: " + mVar);
        }
    }
    ...
    public o u(long j2) {
        ...
        return w(a.YEAR.m(f.b.a.c.b.o.b.B0(j3, 12)), f.b.a.c.b.o.b.D0(j3, 12) + 1);
    }
