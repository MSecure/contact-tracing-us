...
public abstract class f<D extends b> extends l.b.a.v.b implements d, Comparable<f<?>> {
    ...
    public <R> R c(l<R> lVar) {
        return (lVar == k.a || lVar == k.f4302d) ? (R) s() : lVar == k.b ? (R) x().s() : lVar == k.c ? (R) l.b.a.w.b.NANOS : lVar == k.f4303e ? (R) r() : lVar == k.f4304f ? (R) e.R(x().x()) : lVar == k.f4305g ? (R) z() : (R) super.c(lVar);
    }
    ...
    public String toString() {
        String str = y().toString() + r().f4169d;
        if (r() == s()) {
            return str;
        }
    ...
    public l.b.a.d w() {
        return l.b.a.d.z(v(), (long) ((s) this).b.c.f4148e);
    }
