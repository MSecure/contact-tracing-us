...
public final class g<D extends b> extends f<D> implements Serializable {
    ...
    public final p f4173d;

    public g(d<D> dVar, q qVar, p pVar) {
        f.b.a.c.b.o.b.A1(dVar, "dateTime");
        this.b = dVar;
        f.b.a.c.b.o.b.A1(qVar, "offset");
        this.c = qVar;
    ...
    public static <R extends b> f<R> E(d<R> dVar, p pVar, q qVar) {
        f.b.a.c.b.o.b.A1(dVar, "localDateTime");
        f.b.a.c.b.o.b.A1(pVar, "zone");
        ...
        if (c2.size() != 1) {
            if (c2.size() == 0) {
                d b2 = s.b(C);
                dVar = dVar.E(dVar.b, 0, 0, c.m((long) (b2.f4328d.c - b2.c.c)).b, 0);
                qVar = b2.f4328d;
            } else if (qVar != null) {
            }
            f.b.a.c.b.o.b.A1(qVar, "offset");
    ...
    public f<D> l(j jVar, long j2) {
        ...
        if (ordinal != 29) {
            return E(this.b.l(jVar, j2), this.f4173d, this.c);
        }
        return F(x().s(), this.b.w(q.z(aVar.f4286e.a(j2, aVar))), this.f4173d);
    }

    @Override // l.b.a.t.f
    public f<D> C(p pVar) {
        f.b.a.c.b.o.b.A1(pVar, "zone");
        if (this.f4173d.equals(pVar)) {
            return this;
        }
    ...
    @Override // l.b.a.t.f
    public int hashCode() {
        return (this.b.hashCode() ^ this.c.c) ^ Integer.rotateLeft(this.f4173d.hashCode(), 3);
    }
    ...
    public String toString() {
        ...
        if (this.c == this.f4173d) {
            return str;
        }
        return str + '[' + this.f4173d.toString() + ']';
    }
