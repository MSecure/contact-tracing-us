...
public final class k extends a<k> implements Serializable {
    ...
    public static final Integer[] B = new Integer[f4179j.length];
    public static final Integer[] C = new Integer[f4180k.length];
    public static final Integer[] D = new Integer[f4181l.length];
    public static final Integer[] E = new Integer[p.length];

    /* renamed from: i  reason: collision with root package name */
    public static final int[] f4178i;

    /* renamed from: j  reason: collision with root package name */
    public static final int[] f4179j = {0, 30, 59, 89, 118, 148, 177, 207, 236, 266, 295, 325};

    /* renamed from: k  reason: collision with root package name */
    public static final int[] f4180k = {30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 29};

    /* renamed from: l  reason: collision with root package name */
    public static final int[] f4181l = {30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 30};
    ...
    public final transient int f4182d;

    /* renamed from: e  reason: collision with root package name */
    public final transient int f4183e;

    /* renamed from: f  reason: collision with root package name */
    public final transient int f4184f;

    /* renamed from: g  reason: collision with root package name */
    public final transient b f4185g;

    /* renamed from: h  reason: collision with root package name */
    public final long f4186h;
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                if (parseInt2 == -1 || parseInt3 == -1 || parseInt4 == -1 || parseInt5 == -1) {
                                                    ...
                                                    if (numArr == null) {
                                                        if (!M) {
                                                            numArr = new Integer[f4178i.length];
                                                            int i4 = 0;
                                                            while (true) {
                                                                int[] iArr = f4178i;
                                                                if (i4 >= iArr.length) {
                                                            ...
                                                            numArr = new Integer[f4179j.length];
                                                            int i5 = 0;
                                                            while (true) {
                                                                int[] iArr2 = f4179j;
                                                                if (i5 >= iArr2.length) {
                                                    ...
                                                    if (numArr3 == null) {
                                                        if (!M) {
                                                            numArr3 = new Integer[f4180k.length];
                                                            int i7 = 0;
                                                            while (true) {
                                                                int[] iArr3 = f4180k;
                                                                if (i7 >= iArr3.length) {
                                                            ...
                                                            numArr3 = new Integer[f4181l.length];
                                                            int i8 = 0;
                                                            while (true) {
                                                                int[] iArr4 = f4181l;
                                                                if (i8 >= iArr4.length) {
                                                    ...
                                                    if (numArr9 == null) {
                                                        if (!M2) {
                                                            numArr9 = new Integer[f4178i.length];
                                                            int i21 = 0;
                                                            while (true) {
                                                                int[] iArr5 = f4178i;
                                                                if (i21 >= iArr5.length) {
                                                            ...
                                                            numArr9 = new Integer[f4179j.length];
                                                            int i22 = 0;
                                                            while (true) {
                                                                int[] iArr6 = f4179j;
                                                                if (i22 >= iArr6.length) {
                                                    ...
                                                    if (numArr11 == null) {
                                                        if (!M2) {
                                                            numArr11 = new Integer[f4180k.length];
                                                            int i24 = 0;
                                                            while (true) {
                                                                int[] iArr7 = f4180k;
                                                                if (i24 >= iArr7.length) {
                                                            ...
                                                            numArr11 = new Integer[f4181l.length];
                                                            int i25 = 0;
                                                            while (true) {
                                                                int[] iArr8 = f4181l;
                                                                if (i25 >= iArr8.length) {
    ...
    public a<k> C(long j2) {
        ...
        int i2 = (this.f4182d - 1) + ((int) j2);
        int i3 = i2 / 12;
        int i4 = i2 % 12;
        while (i4 < 0) {
            i4 += 12;
            i3 = f.b.a.c.b.o.b.J1(i3, 1);
        }
        return O(this.b, f.b.a.c.b.o.b.F1(this.c, i3), i4 + 1, this.f4183e);
    }
    ...
    public a<k> D(long j2) {
        ...
        return O(this.b, f.b.a.c.b.o.b.F1(this.c, (int) j2), this.f4182d, this.f4183e);
    }
    ...
    public k z(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            ...
            case 23:
                return S(this.c, i2, this.f4183e);
            case 24:
            default:
            ...
            case 25:
                ...
                return S(i2, this.f4182d, this.f4183e);
            case 26:
                return S(i2, this.f4182d, this.f4183e);
            case 27:
                return S(1 - this.c, this.f4182d, this.f4183e);
        }
    }
    ...
    public d e(f fVar) {
        return (k) j.f4174d.e(fVar.n(this));
    }
    ...
    @Override // l.b.a.t.b
    public b w(i iVar) {
        return (k) j.f4174d.e(((l) iVar).b(this));
    }

    @Override // l.b.a.t.b
    public long x() {
        return J(this.c, this.f4182d, this.f4183e);
    }
