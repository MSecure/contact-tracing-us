...
public final class c {
    ...
    public static final c f4216h;

    /* renamed from: i  reason: collision with root package name */
    public static final c f4217i;

    /* renamed from: j  reason: collision with root package name */
    public static final c f4218j;

    /* renamed from: k  reason: collision with root package name */
    public static final c f4219k;

    /* renamed from: l  reason: collision with root package name */
    public static final c f4220l;
    ...
    public final Set<j> f4222e;

    /* renamed from: f  reason: collision with root package name */
    public final h f4223f;
    ...
    public c(d.e eVar, Locale locale, j jVar, l lVar, Set<j> set, h hVar, p pVar) {
        b.A1(eVar, "printerParser");
        this.a = eVar;
        b.A1(locale, "locale");
        this.b = locale;
        b.A1(jVar, "decimalStyle");
        this.c = jVar;
        b.A1(lVar, "resolverStyle");
        this.f4221d = lVar;
        this.f4222e = set;
        this.f4223f = hVar;
        this.f4224g = pVar;
    ...
    public final a d(CharSequence charSequence, ParsePosition parsePosition) {
        ...
        aVar2.f4211d = pVar;
        aVar2.f4214g = aVar.f4255e;
        aVar2.f4215h = aVar.f4256f;
        return aVar2;
    }
    ...
    public c f(h hVar) {
        return b.v0(this.f4223f, hVar) ? this : new c(this.a, this.b, this.c, this.f4221d, this.f4222e, hVar, this.f4224g);
    }

    public c g(Locale locale) {
        return this.b.equals(locale) ? this : new c(this.a, locale, this.c, this.f4221d, this.f4222e, this.f4223f, this.f4224g);
    }

    public c h(p pVar) {
        return b.v0(this.f4224g, pVar) ? this : new c(this.a, this.b, this.c, this.f4221d, this.f4222e, this.f4223f, pVar);
    }
