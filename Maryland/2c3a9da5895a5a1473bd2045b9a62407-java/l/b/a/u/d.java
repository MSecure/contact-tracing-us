...
public final class d {
    ...
    public static final l.b.a.w.l<l.b.a.p> f4225h = new a();

    /* renamed from: i  reason: collision with root package name */
    public static final Map<Character, l.b.a.w.j> f4226i;

    /* renamed from: j  reason: collision with root package name */
    public static final Comparator<String> f4227j = new c();
    public d a;
    public final d b;
    ...
    public static final class C0154d implements f {
        public final char b;

        public C0154d(char c) {
            this.b = c;
        }
    ...
    public static final class e implements f {
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            if (this.c) {
                ArrayList<e.a> arrayList = eVar.f4253g;
                e.a b2 = eVar.b();
                e.a aVar = new e.a();
                aVar.b = b2.b;
                aVar.c = b2.c;
                aVar.f4254d.putAll(b2.f4254d);
                aVar.f4255e = b2.f4255e;
                arrayList.add(aVar);
                int i3 = i2;
                for (f fVar : this.b) {
    ...
    public static final class g implements f {
        ...
        public g(l.b.a.w.j jVar, int i2, int i3, boolean z) {
            ...
            l.b.a.w.o h2 = jVar.h();
            if (!(h2.b == h2.c && h2.f4306d == h2.f4307e)) {
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            BigDecimal divide = BigDecimal.valueOf(longValue).subtract(valueOf).divide(BigDecimal.valueOf(h2.f4307e).subtract(valueOf).add(BigDecimal.ONE), 9, RoundingMode.FLOOR);
            BigDecimal stripTrailingZeros = divide.compareTo(BigDecimal.ZERO) == 0 ? BigDecimal.ZERO : divide.stripTrailingZeros();
            if (stripTrailingZeros.scale() != 0) {
                String a = jVar.a(stripTrailingZeros.setScale(Math.min(Math.max(stripTrailingZeros.scale(), this.c), this.f4232d), RoundingMode.FLOOR).toPlainString().substring(2));
                if (this.f4233e) {
                    sb.append(jVar.f4263d);
                }
                sb.append(a);
                return true;
            } else if (this.c <= 0) {
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            int i3;
            boolean z = eVar.f4252f;
            int i4 = z ? this.c : 0;
            int i5 = z ? this.f4232d : 9;
            int length = charSequence.length();
            if (i2 == length) {
                return i4 > 0 ? ~i2 : i2;
            }
            if (this.f4233e) {
                if (charSequence.charAt(i2) != eVar.b.f4263d) {
                    return i4 > 0 ? ~i2 : i2;
                }
                i2++;
            }
            ...
            l.b.a.w.o h2 = this.b.h();
            BigDecimal valueOf = BigDecimal.valueOf(h2.b);
            return eVar.g(this.b, movePointLeft.multiply(BigDecimal.valueOf(h2.f4307e).subtract(valueOf).add(BigDecimal.ONE)).setScale(0, RoundingMode.FLOOR).add(valueOf).longValueExact(), i2, i3);
        }

        public String toString() {
            String str = this.f4233e ? ",DecimalPoint" : "";
    ...
    public static final class h implements f {
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            if (longValue >= -62167219200L) {
                ...
                l.b.a.f G = l.b.a.f.G(f.b.a.c.b.o.b.E0(j2, 315569520000L) - 62167219200L, 0, l.b.a.q.f4166g);
                if (B0 > 0) {
                    sb.append('+');
                    sb.append(B0);
                }
                ...
                l.b.a.f G2 = l.b.a.f.G(j5 - 62167219200L, 0, l.b.a.q.f4166g);
                int length = sb.length();
                sb.append(G2);
                if (G2.c.f4147d == 0) {
                    sb.append(":00");
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            try {
                l.b.a.f fVar = l.b.a.f.f4141d;
                return eVar.g(aVar4, (long) intValue6, i2, eVar.g(l.b.a.w.a.INSTANT_SECONDS, new l.b.a.f(l.b.a.e.P(i4, intValue, intValue2), l.b.a.g.v(intValue3, intValue4, intValue5, 0)).I((long) i3).v(l.b.a.q.f4166g) + f.b.a.c.b.o.b.I1(longValue / 10000, 315569520000L), i2, b));
    ...
    public static final class i implements f {
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            int L1 = f.b.a.c.b.o.b.L1(b2.longValue());
            if (L1 == 0) {
                return true;
            }
            int abs = Math.abs((L1 / 3600) % 100);
            int abs2 = Math.abs((L1 / 60) % 60);
            int abs3 = Math.abs(L1 % 60);
            sb.append(L1 < 0 ? "-" : "+");
            sb.append(abs);
            if (abs2 <= 0 && abs3 <= 0) {
                return true;
    ...
    public static class k implements f {
        ...
        /* renamed from: g  reason: collision with root package name */
        public static final int[] f4234g = {0, 10, 100, 1000, 10000, 100000, 1000000, 10000000, 100000000, 1000000000};
        public final l.b.a.w.j b;
        public final int c;
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            if (str.length() <= this.f4235d) {
                String a = jVar.a(str);
                int i3 = (c3 > 0 ? 1 : (c3 == 0 ? 0 : -1));
                int ordinal = this.f4236e.ordinal();
                if (i3 >= 0) {
                    if (ordinal == 1 || (ordinal == 4 && (i2 = this.c) < 19 && c3 >= ((long) f4234g[i2]))) {
                        c2 = jVar.b;
                    }
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            int i8 = 0;
            if (charAt == jVar.b) {
                if (!this.f4236e.a(true, eVar.f4252f, this.c == this.f4235d)) {
                    return ~i7;
                }
                i3 = i7 + 1;
                z2 = true;
                ...
                if (charAt == jVar.c) {
                    if (!this.f4236e.a(false, eVar.f4252f, this.c == this.f4235d)) {
                        return ~i7;
                    }
                    i7++;
                    z = true;
                } else if (this.f4236e == m.ALWAYS && eVar.f4252f) {
                    return ~i7;
                } else {
                    z = false;
                }
            ...
            int i9 = (eVar.f4252f || d(eVar)) ? this.c : 1;
            int i10 = i3 + i9;
            if (i10 > length) {
                return ~i3;
            }
            int i11 = 9;
            int max = Math.max(this.f4237f, 0) + ((eVar.f4252f || d(eVar)) ? this.f4235d : 9);
            while (true) {
                bigInteger = null;
                if (i8 >= 2) {
                    i4 = i3;
            ...
            if (z) {
                if (bigInteger != null) {
                    if (bigInteger.equals(BigInteger.ZERO) && eVar.f4252f) {
                        return ~(i3 - 1);
                    }
                    bigInteger = bigInteger.negate();
                } else if (j2 == 0 && eVar.f4252f) {
                    return ~(i3 - 1);
                } else {
                    j3 = -j2;
                    if (bigInteger != null) {
            ...
            } else if (this.f4236e == m.EXCEEDS_PAD && eVar.f4252f) {
                int i14 = i4 - i3;
                int i15 = this.c;
                if (z2) {
                    if (i14 <= i15) {
        ...
        public boolean d(e eVar) {
            int i2 = this.f4237f;
            return i2 == -1 || (i2 > 0 && this.c == this.f4235d && this.f4236e == m.NOT_NEGATIVE);
        }
        ...
        public k f() {
            return this.f4237f == -1 ? this : new k(this.b, this.c, this.f4235d, this.f4236e, -1);
        }

        public k g(int i2) {
            return new k(this.b, this.c, this.f4235d, this.f4236e, this.f4237f + i2);
        }
        ...
        public String toString() {
            ...
            Object obj;
            int i2 = this.c;
            if (i2 == 1 && this.f4235d == 19 && this.f4236e == m.NORMAL) {
                sb = f.a.a.a.a.h("Value(");
                obj = this.b;
            } else if (i2 == this.f4235d && this.f4236e == m.NOT_NEGATIVE) {
                sb = f.a.a.a.a.h("Value(");
                sb.append(this.b);
                sb.append(",");
                sb.append(this.c);
    ...
    public static final class l implements f {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final String[] f4238d = {"+HH", "+HHmm", "+HH:mm", "+HHMM", "+HH:MM", "+HHMMss", "+HH:MM:ss", "+HHMMSS", "+HH:MM:SS"};

        /* renamed from: e  reason: collision with root package name */
        public static final l f4239e = new l("Z", "+HH:MM:ss");
        public final String b;
        public final int c;

        public l(String str, String str2) {
            f.b.a.c.b.o.b.A1(str, "noOffsetText");
            f.b.a.c.b.o.b.A1(str2, "pattern");
            this.b = str;
            int i2 = 0;
            while (true) {
                String[] strArr = f4238d;
                if (i2 >= strArr.length) {
    ...
    public static final class n extends k {
        ...
        /* renamed from: j  reason: collision with root package name */
        public static final l.b.a.e f4241j = l.b.a.e.P(2000, 1, 1);

        /* renamed from: h  reason: collision with root package name */
        public final int f4242h;

        /* renamed from: i  reason: collision with root package name */
        public final l.b.a.t.b f4243i;
        ...
        public n(l.b.a.w.j jVar, int i2, int i3, int i4, l.b.a.t.b bVar) {
            ...
            if (i2 < 1 || i2 > 10) {
                ...
                if (bVar == null) {
                    ...
                    } else if (j2 + ((long) k.f4234g[i2]) > 2147483647L) {
        ...
        public long c(h hVar, long j2) {
            ...
            int i3 = this.f4242h;
            if (this.f4243i != null) {
                i3 = l.b.a.t.h.l(hVar.a).c(this.f4243i).b(this.b);
            }
            if (j2 >= ((long) i3)) {
                int i4 = this.c;
        ...
        public int e(e eVar, long j2, int i2, int i3) {
            int i4 = this.f4242h;
            if (this.f4243i != null) {
                i4 = eVar.d().c(this.f4243i).b(this.b);
                e.a b = eVar.b();
                if (b.f4257g == null) {
                    b.f4257g = new ArrayList(2);
                }
                b.f4257g.add(new Object[]{this, Long.valueOf(j2), Integer.valueOf(i2), Integer.valueOf(i3)});
            }
            int i5 = i3 - i2;
            int i6 = this.c;
            if (i5 == i6 && j2 >= 0) {
                long j3 = (long) k.f4234g[i6];
                long j4 = (long) i4;
                long j5 = j4 - (j4 % j3);
                j2 = i4 > 0 ? j5 + j2 : j5 - j2;
                if (j2 < j4) {
        ...
        @Override // l.b.a.u.d.k
        public k f() {
            return this.f4237f == -1 ? this : new n(this.b, this.c, this.f4235d, this.f4242h, this.f4243i, -1);
        }

        @Override // l.b.a.u.d.k
        public k g(int i2) {
            return new n(this.b, this.c, this.f4235d, this.f4242h, this.f4243i, this.f4237f + i2);
        }
        ...
        public String toString() {
            ...
            h2.append(this.c);
            h2.append(",");
            h2.append(this.f4235d);
            h2.append(",");
            Object obj = this.f4243i;
            if (obj == null) {
                obj = Integer.valueOf(this.f4242h);
            }
            h2.append(obj);
            h2.append(")");
            return h2.toString();
    ...
    public static final class q implements f {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final i f4247d;

        /* renamed from: e  reason: collision with root package name */
        public volatile k f4248e;
        ...
        public boolean a(h hVar, StringBuilder sb) {
            ...
            String a = this.f4247d.a(this.b, b2.longValue(), this.c, hVar.b);
            if (a == null) {
                return c().a(hVar, sb);
            }
            sb.append(a);
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            Iterator<Map.Entry<String, Long>> b2 = this.f4247d.b(this.b, eVar.f4252f ? this.c : null, eVar.a);
            if (b2 != null) {
                while (b2.hasNext()) {
        ...
        public final k c() {
            if (this.f4248e == null) {
                this.f4248e = new k(this.b, 1, 19, m.NORMAL);
            }
            return this.f4248e;
        }
    ...
    public static final class r implements f {
        ...
        public final f c(l.b.a.w.p pVar) {
            ...
            char c2 = this.b;
            if (c2 == 'W') {
                kVar = new k(pVar.f4310e, 1, 2, mVar);
            } else if (c2 == 'Y') {
                int i2 = this.c;
                if (i2 == 2) {
                    kVar2 = new n(pVar.f4312g, 2, 2, 0, n.f4241j);
                } else {
                    kVar2 = new k(pVar.f4312g, i2, 19, i2 < 4 ? m.NORMAL : m.EXCEEDS_PAD, -1, null);
                }
                return kVar2;
            } else if (c2 == 'c') {
                kVar = new k(pVar.f4309d, this.c, 2, mVar);
            } else if (c2 == 'e') {
                kVar = new k(pVar.f4309d, this.c, 2, mVar);
            } else if (c2 != 'w') {
                return null;
            } else {
                kVar = new k(pVar.f4311f, this.c, 2, mVar);
            }
            return kVar;
        }
    ...
    public static final class s implements f {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static volatile Map.Entry<Integer, a> f4249d;
        ...
        public int b(e eVar, CharSequence charSequence, int i2) {
            ...
            if (i2 > length) {
                ...
                if (charAt == '+' || charAt == '-') {
                    Objects.requireNonNull(eVar);
                    e eVar2 = new e(eVar);
                    int b2 = l.f4239e.b(eVar2, charSequence, i2);
                    if (b2 < 0) {
                        return b2;
                    }
                ...
                Map.Entry<Integer, a> entry = f4249d;
                String str2 = null;
                if (entry == null || entry.getKey().intValue() != size) {
                    synchronized (this) {
                        ...
                        if (entry == null || entry.getKey().intValue() != size) {
                            ...
                            Collections.sort(arrayList, d.f4227j);
                ...
                l.b.a.p c2 = c(unmodifiableSet, str3, eVar.f4251e);
                if (c2 == null) {
                    c2 = c(unmodifiableSet, str2, eVar.f4251e);
                    if (c2 == null) {
                        if (!eVar.a(charAt, 'Z')) {
                            return ~i2;
                        }
                        eVar.f(l.b.a.q.f4166g);
                        return i2 + 1;
                    }
                } else {
                    str2 = str3;
        ...
        public final int d(e eVar, CharSequence charSequence, int i2, int i3) {
            ...
            e eVar2 = new e(eVar);
            if ((i3 >= charSequence.length() || !eVar.a(charSequence.charAt(i3), 'Z')) && (b2 = l.f4239e.b(eVar2, charSequence, i3)) >= 0) {
                eVar.f(l.b.a.p.u(upperCase, l.b.a.q.z((int) eVar2.e(l.b.a.w.a.OFFSET_SECONDS).longValue())));
                return b2;
            }
            eVar.f(l.b.a.p.u(upperCase, l.b.a.q.f4166g));
            return i3;
        }
    ...
    public static final class t implements f {
        ...
        public t(p pVar) {
            f.b.a.c.b.o.b.A1(pVar, "textStyle");
            this.b = pVar;
        }
    ...
    public final int c(f fVar) {
        f.b.a.c.b.o.b.A1(fVar, "pp");
        d dVar = this.a;
        int i2 = dVar.f4229e;
        if (i2 > 0) {
            m mVar = new m(fVar, i2, dVar.f4230f);
            dVar.f4229e = 0;
            dVar.f4230f = 0;
            fVar = mVar;
        }
    ...
    public d e(String str) {
        f.b.a.c.b.o.b.A1(str, "literal");
        if (str.length() > 0) {
            c(str.length() == 1 ? new C0154d(str.charAt(0)) : new p(str));
        }
        return this;
    }

    public d f(p pVar) {
        f.b.a.c.b.o.b.A1(pVar, "style");
    ...
    public d h(String str) {
        ...
        while (i3 < str.length()) {
            ...
            if ((charAt >= 'A' && charAt <= 'Z') || (charAt >= 'a' && charAt <= 'z')) {
                ...
                l.b.a.w.j jVar = f4226i.get(Character.valueOf(charAt));
                if (jVar != null) {
                                    ...
                                    if (charAt != 'q') {
                                        if (charAt != 's') {
                                            if (charAt != 'u' && charAt != 'y') {
                                                ...
                                                l.b.a.e eVar = n.f4241j;
                                                f.b.a.c.b.o.b.A1(jVar, "field");
                                                f.b.a.c.b.o.b.A1(eVar, "baseDate");
    ...
    public d i(l.b.a.w.j jVar, Map<Long, String> map) {
        f.b.a.c.b.o.b.A1(jVar, "field");
        f.b.a.c.b.o.b.A1(map, "textLookup");
    ...
    public final d k(k kVar) {
        ...
        if (i2 < 0 || !(dVar.c.get(i2) instanceof k)) {
            ...
            int i4 = kVar.c;
            int i5 = kVar.f4235d;
            if (i4 == i5 && kVar.f4236e == m.NOT_NEGATIVE) {
                kVar2 = kVar3.g(i5);
                c(kVar.f());
                this.a.f4231g = i3;
            } else {
    ...
    public d n(l.b.a.w.j jVar, int i2, int i3, m mVar) {
        ...
        f.b.a.c.b.o.b.A1(jVar, "field");
        f.b.a.c.b.o.b.A1(mVar, "signStyle");
        if (i2 < 1 || i2 > 19) {
    ...
    public d o() {
        ...
        if (dVar.b != null) {
            if (dVar.c.size() > 0) {
                d dVar2 = this.a;
                e eVar = new e(dVar2.c, dVar2.f4228d);
                this.a = this.a.b;
                c(eVar);
            } else {
                this.a = this.a.b;
    ...
    public c r(Locale locale) {
        f.b.a.c.b.o.b.A1(locale, "locale");
        while (this.a.b != null) {
            o();
        }
        return new c(new e(this.c, false), locale, j.f4262e, l.SMART, null, null, null);
    }

    public c s(l lVar) {
        c q2 = q();
        f.b.a.c.b.o.b.A1(lVar, "resolverStyle");
        return f.b.a.c.b.o.b.v0(q2.f4221d, lVar) ? q2 : new c(q2.a, q2.b, q2.c, lVar, q2.f4222e, q2.f4223f, q2.f4224g);
    }
}
