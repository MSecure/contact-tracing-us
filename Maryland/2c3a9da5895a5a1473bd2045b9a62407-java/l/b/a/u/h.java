            ...
            if (!(hVar == null && pVar == null)) {
                ...
                if (pVar != null) {
                    if (eVar.f(a.INSTANT_SECONDS)) {
                        eVar = (hVar3 == null ? m.f4188d : hVar3).s(d.s(eVar), pVar);
                    } else {
                        try {
                            f s = pVar.s();
                            if (s.e()) {
                                qVar = s.a(d.f4136d);
                                q qVar2 = (q) eVar.c(k.f4303e);
                ...
                if (hVar != null) {
                    if (eVar.f(a.EPOCH_DAY)) {
                        bVar = hVar3.c(eVar);
                    } else if (!(hVar == m.f4188d && hVar2 == null)) {
                        a[] values = a.values();
