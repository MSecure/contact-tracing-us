...
public final class o implements Serializable {
    ...
    public int a(long j2, j jVar) {
        boolean z = false;
        if ((this.b >= -2147483648L && this.f4307e <= 2147483647L) && c(j2)) {
            z = true;
        }
        if (z) {
            return (int) j2;
    ...
    public boolean c(long j2) {
        return j2 >= this.b && j2 <= this.f4307e;
    }
    ...
    public boolean equals(Object obj) {
        ...
        o oVar = (o) obj;
        return this.b == oVar.b && this.c == oVar.c && this.f4306d == oVar.f4306d && this.f4307e == oVar.f4307e;
    }
