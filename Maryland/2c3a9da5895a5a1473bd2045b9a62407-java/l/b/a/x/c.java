...
public final class c extends i {
    ...
    public final ConcurrentNavigableMap<String, a> f4326d = new ConcurrentSkipListMap();
    ...
    public f b(String str, boolean z) {
        f fVar;
        b.A1(str, "zoneId");
        a value = this.f4326d.lastEntry().getValue();
    ...
    public final boolean e(InputStream inputStream) {
        ...
        if (dataInputStream.readByte() != 1) {
            ...
            while (it.hasNext()) {
                a aVar = (a) it.next();
                a putIfAbsent = this.f4326d.putIfAbsent(aVar.a, aVar);
