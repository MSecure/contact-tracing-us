...
public class ActionBarContextView extends b.b.q.a {
    ...
    public class a implements View.OnClickListener {
        ...
        public final /* synthetic */ b.b.p.a f83b;
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        ...
        m.X(this, (!obtainStyledAttributes.hasValue(i2) || (resourceId = obtainStyledAttributes.getResourceId(i2, 0)) == 0) ? obtainStyledAttributes.getDrawable(i2) : b.b.l.a.a.b(context, resourceId));
        ...
        this.f772f = obtainStyledAttributes.getLayoutDimension(j.ActionMode_height, 0);
    ...
    public void f(b.b.p.a aVar) {
        ...
        if (view2 == null) {
            ...
            gVar.b(this.f771e, this.f769c);
            c cVar3 = this.f771e;
            nVar = cVar3.i;
            if (nVar == null) {
                n nVar3 = (n) cVar3.f687e.inflate(cVar3.f689g, (ViewGroup) this, false);
                cVar3.i = nVar3;
                nVar3.b(cVar3.f686d);
                cVar3.j(true);
            }
            ...
            this.f770d = actionMenuView;
            m.X(actionMenuView, null);
            addView(this.f770d, layoutParams);
        }
        addView(view);
        this.l.findViewById(f.action_mode_close_button).setOnClickListener(new a(this, aVar));
        ...
        this.f770d = actionMenuView2;
        m.X(actionMenuView2, null);
        addView(this.f770d, layoutParams2);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        ActionMenuView actionMenuView = this.f770d;
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i5, BleSignal.UNKNOWN_TX_POWER);
            View view = this.l;
            if (view != null) {
            ...
            if (actionMenuView != null && actionMenuView.getParent() == this) {
                paddingLeft = c(this.f770d, paddingLeft, makeMeasureSpec, 0);
            }
            LinearLayout linearLayout = this.n;
