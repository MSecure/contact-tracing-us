...
public class SearchView extends i0 implements b.b.p.b {
    ...
    public static class SearchAutoComplete extends b.b.q.d {
        ...
        public int f111e = getThreshold();

        /* renamed from: f  reason: collision with root package name */
        public SearchView f112f;
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                if (searchAutoComplete.f113g) {
                    ((InputMethodManager) searchAutoComplete.getContext().getSystemService("input_method")).showSoftInput(searchAutoComplete, 0);
                    searchAutoComplete.f113g = false;
                }
            }
        }
        ...
        public boolean enoughToFilter() {
            return this.f111e <= 0 || super.enoughToFilter();
        }
        ...
        public void onFocusChanged(boolean z, int i, Rect rect) {
            ...
            SearchView searchView = this.f112f;
        ...
        public void onWindowFocusChanged(boolean z) {
            ...
            if (z && this.f112f.hasFocus() && getVisibility() == 0) {
                this.f113g = true;
    ...
    public static class n {
        ...
        public Method f125a = null;

        /* renamed from: b  reason: collision with root package name */
        public Method f126b = null;

        /* renamed from: c  reason: collision with root package name */
        public Method f127c = null;
        ...
        public n() {
            ...
            try {
                ...
                this.f125a = declaredMethod;
                declaredMethod.setAccessible(true);
            } catch (NoSuchMethodException unused) {
            }
            try {
                Method declaredMethod2 = AutoCompleteTextView.class.getDeclaredMethod("doAfterTextChanged", new Class[0]);
                this.f126b = declaredMethod2;
    ...
    public static class o extends b.k.a.a {
        ...
        public o(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f128d = ((Boolean) parcel.readValue(null)).booleanValue();
        }
        ...
        public String toString() {
            StringBuilder h = c.a.a.a.a.h("SearchView.SavedState{");
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeValue(Boolean.valueOf(this.f128d));
        }
    }
    ...
    public static class p extends TouchDelegate {
        ...
        /* renamed from: b  reason: collision with root package name */
        public final Rect f130b = new Rect();

        /* renamed from: c  reason: collision with root package name */
        public final Rect f131c = new Rect();

        /* renamed from: d  reason: collision with root package name */
        public final Rect f132d = new Rect();
        ...
        public p(Rect rect, Rect rect2, View view) {
            super(rect, view);
            this.f133e = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
            a(rect, rect2);
            this.f129a = view;
        }
        ...
        public void a(Rect rect, Rect rect2) {
            this.f130b.set(rect);
            this.f132d.set(rect);
            Rect rect3 = this.f132d;
            int i = this.f133e;
            rect3.inset(-i, -i);
            this.f131c.set(rect2);
        }
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    z2 = this.f134f;
                    if (z2 && !this.f132d.contains(x, y)) {
                        z3 = z2;
                        z = false;
                        if (z3) {
                            return false;
                        }
                        if (!z || this.f131c.contains(x, y)) {
                            Rect rect = this.f131c;
                            f2 = (float) (x - rect.left);
                            i = y - rect.top;
                        } else {
                            f2 = (float) (this.f129a.getWidth() / 2);
                            i = this.f129a.getHeight() / 2;
                        }
                        motionEvent.setLocation(f2, (float) i);
                        return this.f129a.dispatchTouchEvent(motionEvent);
                    }
                } else if (action == 3) {
                    z2 = this.f134f;
                    this.f134f = false;
            ...
            } else if (this.f130b.contains(x, y)) {
                this.f134f = true;
                z = true;
                if (z3) {
                }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i2) {
        ...
        b.i.l.m.X(this.s, y0Var.g(b.b.j.SearchView_queryBackground));
        ...
        i.j.i0(this.u, getResources().getString(b.b.h.abc_searchview_description_search));
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        o oVar = (o) parcelable;
        super.onRestoreInstanceState(oVar.f1952b);
        I(oVar.f128d);
        requestLayout();
    }
