...
public class Toolbar extends ViewGroup {
    ...
    public class d implements m {
        ...
        public void e(Context context, b.b.p.i.g gVar) {
            i iVar;
            b.b.p.i.g gVar2 = this.f144b;
            if (!(gVar2 == null || (iVar = this.f145c) == null)) {
                gVar2.d(iVar);
            }
            this.f144b = gVar;
        }
        ...
        public boolean g(b.b.p.i.g gVar, i iVar) {
            ...
            if (parent2 != toolbar3) {
                ...
                h.f509a = 8388611 | (toolbar4.o & 112);
                h.f147b = 2;
            ...
            while (true) {
                ...
                if (!(((e) childAt.getLayoutParams()).f147b == 2 || childAt == toolbar6.f135b)) {
            ...
            if (this.f145c != null) {
                ...
                if (gVar != null) {
                    ...
                    while (true) {
                        if (i >= size) {
                            break;
                        } else if (this.f144b.getItem(i) == this.f145c) {
                            z2 = true;
                            break;
                        } else {
                            i++;
    ...
    public static class g extends b.k.a.a {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeInt(this.f149e ? 1 : 0);
        }
    }
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i2) {
        ...
        b.i.l.m.T(this, context, j.Toolbar, attributeSet, q2.f986b, i2, 0);
        this.m = q2.l(j.Toolbar_titleTextAppearance, 0);
        this.n = q2.l(j.Toolbar_subtitleTextAppearance, 0);
        this.x = q2.f986b.getInteger(j.Toolbar_android_gravity, this.x);
        this.o = q2.f986b.getInteger(j.Toolbar_buttonGravity, 48);
        ...
        int e7 = q2.e(j.Toolbar_contentInsetStart, BleSignal.UNKNOWN_TX_POWER);
        int e8 = q2.e(j.Toolbar_contentInsetEnd, BleSignal.UNKNOWN_TX_POWER);
        ...
        this.v = q2.e(j.Toolbar_contentInsetStartWithNavigation, BleSignal.UNKNOWN_TX_POWER);
        this.w = q2.e(j.Toolbar_contentInsetEndWithActions, BleSignal.UNKNOWN_TX_POWER);
        this.f140g = q2.g(j.Toolbar_collapseIcon);
    ...
    public final void a(List<View> list, int i2) {
        ...
        if (z2) {
            for (int i3 = childCount - 1; i3 >= 0; i3--) {
                ...
                if (eVar.f147b == 0 && u(childAt) && j(eVar.f509a) == absoluteGravity) {
                    list.add(childAt);
                }
            }
            return;
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (eVar2.f147b == 0 && u(childAt2) && j(eVar2.f509a) == absoluteGravity) {
                list.add(childAt2);
            }
        }
    }
    ...
    public void c() {
        if (this.i == null) {
            ...
            this.i = lVar;
            lVar.setImageDrawable(this.f140g);
            this.i.setContentDescription(this.h);
            e h2 = generateDefaultLayoutParams();
            h2.f509a = 8388611 | (this.o & 112);
            h2.f147b = 2;
    ...
    public final void e() {
        f();
        ActionMenuView actionMenuView = this.f135b;
        if (actionMenuView.q == null) {
            b.b.p.i.g gVar = (b.b.p.i.g) actionMenuView.getMenu();
            if (this.L == null) {
                this.L = new d();
            }
            this.f135b.setExpandedActionViewsExclusive(true);
    ...
    public final void f() {
        if (this.f135b == null) {
            ...
            this.f135b = actionMenuView;
            actionMenuView.setPopupTheme(this.l);
            this.f135b.setOnMenuItemClickListener(this.I);
            ActionMenuView actionMenuView2 = this.f135b;
            m.a aVar = this.M;
            g.a aVar2 = this.N;
            actionMenuView2.v = aVar;
            actionMenuView2.w = aVar2;
            e h2 = generateDefaultLayoutParams();
            h2.f509a = 8388613 | (this.o & 112);
            this.f135b.setLayoutParams(h2);
            b(this.f135b, false);
        }
    }
    ...
    public final void g() {
        if (this.f138e == null) {
            this.f138e = new l(getContext(), null, b.b.a.toolbarNavigationButtonStyle);
            e h2 = generateDefaultLayoutParams();
            h2.f509a = 8388611 | (this.o & 112);
            this.f138e.setLayoutParams(h2);
        }
    }
    ...
    public int getContentInsetEnd() {
        p0 p0Var = this.u;
        if (p0Var != null) {
            return p0Var.f910g ? p0Var.f904a : p0Var.f905b;
        }
        return 0;
    }
    ...
    public int getContentInsetStart() {
        p0 p0Var = this.u;
        if (p0Var != null) {
            return p0Var.f910g ? p0Var.f905b : p0Var.f904a;
        }
        return 0;
    }
    ...
    public int getCurrentContentInsetLeft() {
        return b.i.l.m.p(this) == 1 ? getCurrentContentInsetEnd() : getCurrentContentInsetStart();
    }

    public int getCurrentContentInsetRight() {
        return b.i.l.m.p(this) == 1 ? getCurrentContentInsetStart() : getCurrentContentInsetEnd();
    }
    ...
    public Drawable getLogo() {
        ImageView imageView = this.f139f;
        if (imageView != null) {
    ...
    public Menu getMenu() {
        e();
        return this.f135b.getMenu();
    }

    public CharSequence getNavigationContentDescription() {
        ImageButton imageButton = this.f138e;
        if (imageButton != null) {
            return imageButton.getContentDescription();
        }
        return null;
    ...
    public Drawable getOverflowIcon() {
        e();
        return this.f135b.getOverflowIcon();
    }
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (u(this.f138e)) {
            ...
            if (z3) {
                ...
                u3 = u(this.f137d);
                if (!u2) {
                    e eVar = (e) this.f136c.getLayoutParams();
                    i8 = paddingRight;
                    i9 = this.f136c.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) eVar).topMargin + ((ViewGroup.MarginLayoutParams) eVar).bottomMargin + 0;
                } else {
                    i8 = paddingRight;
                    i9 = 0;
                }
                if (!u3) {
                    e eVar2 = (e) this.f137d.getLayoutParams();
                    i10 = width;
                    i9 += this.f137d.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) eVar2).topMargin + ((ViewGroup.MarginLayoutParams) eVar2).bottomMargin;
                } else {
                    i10 = width;
                }
                if (!u2 || u3) {
                    TextView textView = !u2 ? this.f136c : this.f137d;
                    TextView textView2 = !u3 ? this.f137d : this.f136c;
                    e eVar3 = (e) textView.getLayoutParams();
                    e eVar4 = (e) textView2.getLayoutParams();
                    boolean z4 = (!u2 && this.f136c.getMeasuredWidth() > 0) || (u3 && this.f137d.getMeasuredWidth() > 0);
                    i19 = this.x & 112;
                    i12 = paddingLeft;
                    if (i19 != 48) {
                        i20 = max;
                    ...
                    if (!z3) {
                        ...
                        if (u2) {
                            int measuredWidth = min2 - this.f136c.getMeasuredWidth();
                            int measuredHeight = this.f136c.getMeasuredHeight() + i21;
                            this.f136c.layout(measuredWidth, i21, min2, measuredHeight);
                            i24 = measuredWidth - this.r;
                            i21 = measuredHeight + ((ViewGroup.MarginLayoutParams) ((e) this.f136c.getLayoutParams())).bottomMargin;
                        } else {
                            i24 = min2;
                        }
                        if (u3) {
                            int i34 = i21 + ((ViewGroup.MarginLayoutParams) ((e) this.f137d.getLayoutParams())).topMargin;
                            this.f137d.layout(min2 - this.f137d.getMeasuredWidth(), i34, min2, this.f137d.getMeasuredHeight() + i34);
                            i25 = min2 - this.r;
                        } else {
                            i25 = min2;
                        }
                        ...
                        if (u2) {
                            int measuredWidth2 = this.f136c.getMeasuredWidth() + max2;
                            int measuredHeight2 = this.f136c.getMeasuredHeight() + i21;
                            this.f136c.layout(max2, i21, measuredWidth2, measuredHeight2);
                            i22 = measuredWidth2 + this.r;
                            i21 = measuredHeight2 + ((ViewGroup.MarginLayoutParams) ((e) this.f136c.getLayoutParams())).bottomMargin;
                        } else {
                            i22 = max2;
                        }
                        if (u3) {
                            int i36 = i21 + ((ViewGroup.MarginLayoutParams) ((e) this.f137d.getLayoutParams())).topMargin;
                            int measuredWidth3 = this.f137d.getMeasuredWidth() + max2;
                            this.f137d.layout(max2, i36, measuredWidth3, this.f137d.getMeasuredHeight() + i36);
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (u(this.f138e)) {
            t(this.f138e, i2, 0, i3, 0, this.p);
            i6 = l(this.f138e) + this.f138e.getMeasuredWidth();
            i5 = Math.max(0, m(this.f138e) + this.f138e.getMeasuredHeight());
            i4 = View.combineMeasuredStates(0, this.f138e.getMeasuredState());
        } else {
            i6 = 0;
            i5 = 0;
            i4 = 0;
        ...
        if (u(this.f135b)) {
            t(this.f135b, i2, max, i3, 0, this.p);
            i7 = l(this.f135b) + this.f135b.getMeasuredWidth();
            i5 = Math.max(i5, m(this.f135b) + this.f135b.getMeasuredHeight());
            i4 = View.combineMeasuredStates(i4, this.f135b.getMeasuredState());
        } else {
            i7 = 0;
        }
        ...
        if (u(this.j)) {
            max2 += s(this.j, i2, max2, i3, 0, iArr);
            i5 = Math.max(i5, m(this.j) + this.j.getMeasuredHeight());
            i4 = View.combineMeasuredStates(i4, this.j.getMeasuredState());
        }
        if (u(this.f139f)) {
            max2 += s(this.f139f, i2, max2, i3, 0, iArr);
            i5 = Math.max(i5, m(this.f139f) + this.f139f.getMeasuredHeight());
            i4 = View.combineMeasuredStates(i4, this.f139f.getMeasuredState());
        }
        int childCount = getChildCount();
        for (int i12 = 0; i12 < childCount; i12++) {
            View childAt = getChildAt(i12);
            if (((e) childAt.getLayoutParams()).f147b == 0 && u(childAt)) {
        ...
        if (u(this.f136c)) {
            s(this.f136c, i2, max2 + i14, i3, i13, iArr);
            int l2 = l(this.f136c) + this.f136c.getMeasuredWidth();
            i8 = m(this.f136c) + this.f136c.getMeasuredHeight();
            i10 = View.combineMeasuredStates(i4, this.f136c.getMeasuredState());
            i9 = l2;
        } else {
            i8 = 0;
            i10 = i4;
        ...
        if (u(this.f137d)) {
            i9 = Math.max(i9, s(this.f137d, i2, max2 + i14, i3, i8 + i13, iArr));
            i8 = m(this.f137d) + this.f137d.getMeasuredHeight() + i8;
            i10 = View.combineMeasuredStates(i10, this.f137d.getMeasuredState());
        }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        g gVar = (g) parcelable;
        super.onRestoreInstanceState(gVar.f1952b);
        ActionMenuView actionMenuView = this.f135b;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        d dVar = this.L;
        if (!(dVar == null || (iVar = dVar.f145c) == null)) {
            gVar.f148d = iVar.f732a;
        }
        gVar.f149e = p();
        return gVar;
    }
    ...
    public void setCollapseIcon(Drawable drawable) {
        ...
        ImageButton imageButton = this.i;
        if (imageButton != null) {
            imageButton.setImageDrawable(this.f140g);
        }
    }
    ...
    public void setLogo(Drawable drawable) {
        if (drawable != null) {
            if (this.f139f == null) {
                this.f139f = new n(getContext(), null, 0);
            }
            if (!o(this.f139f)) {
                b(this.f139f, true);
            }
            ...
            if (imageView != null && o(imageView)) {
                removeView(this.f139f);
                this.F.remove(this.f139f);
            }
        }
        ImageView imageView2 = this.f139f;
        if (imageView2 != null) {
    ...
    public void setLogoDescription(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence) && this.f139f == null) {
            this.f139f = new n(getContext(), null, 0);
        }
        ImageView imageView = this.f139f;
        if (imageView != null) {
    ...
    public void setNavigationIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (imageButton != null && o(imageButton)) {
                removeView(this.f138e);
                this.F.remove(this.f138e);
            }
        }
        ImageButton imageButton2 = this.f138e;
    ...
    public void setOverflowIcon(Drawable drawable) {
        e();
        this.f135b.setOverflowIcon(drawable);
    }
    ...
    public void setSubtitle(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence)) {
            if (this.f137d == null) {
                ...
                this.f137d = zVar;
                zVar.setSingleLine();
                this.f137d.setEllipsize(TextUtils.TruncateAt.END);
                int i2 = this.n;
                if (i2 != 0) {
                    this.f137d.setTextAppearance(context, i2);
                }
                ColorStateList colorStateList = this.B;
                if (colorStateList != null) {
                    this.f137d.setTextColor(colorStateList);
                }
            }
            if (!o(this.f137d)) {
                b(this.f137d, true);
            ...
            TextView textView = this.f137d;
            if (textView != null && o(textView)) {
                removeView(this.f137d);
                this.F.remove(this.f137d);
            }
        }
        TextView textView2 = this.f137d;
        if (textView2 != null) {
    ...
    public void setTitle(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence)) {
            if (this.f136c == null) {
                ...
                this.f136c = zVar;
                zVar.setSingleLine();
                this.f136c.setEllipsize(TextUtils.TruncateAt.END);
                int i2 = this.m;
                if (i2 != 0) {
                    this.f136c.setTextAppearance(context, i2);
                }
                ColorStateList colorStateList = this.A;
                if (colorStateList != null) {
                    this.f136c.setTextColor(colorStateList);
                }
            }
            if (!o(this.f136c)) {
                b(this.f136c, true);
            ...
            TextView textView = this.f136c;
            if (textView != null && o(textView)) {
                removeView(this.f136c);
                this.F.remove(this.f136c);
            }
        }
        TextView textView2 = this.f136c;
        if (textView2 != null) {
            textView2.setText(charSequence);
        }
        this.y = charSequence;
