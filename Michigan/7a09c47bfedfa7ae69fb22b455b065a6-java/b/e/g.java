...
public abstract class g<K, V> {
    ...
    public g<K, V>.b f1393a;

    /* renamed from: b  reason: collision with root package name */
    public g<K, V>.c f1394b;

    /* renamed from: c  reason: collision with root package name */
    public g<K, V>.e f1395c;
    ...
    public final class a<T> implements Iterator<T> {
        ...
        public a(int i) {
            this.f1396b = i;
            this.f1397c = g.this.d();
        }

        public boolean hasNext() {
            return this.f1398d < this.f1397c;
        }

        @Override // java.util.Iterator
        public T next() {
            if (hasNext()) {
                T t = (T) g.this.b(this.f1398d, this.f1396b);
                this.f1398d++;
                this.f1399e = true;
                return t;
            }
    ...
    public final class d implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public boolean equals(Object obj) {
            if (!this.f1405d) {
                ...
                Map.Entry entry = (Map.Entry) obj;
                return d.c(entry.getKey(), g.this.b(this.f1404c, 0)) && d.c(entry.getValue(), g.this.b(this.f1404c, 1));
            }
        }
        ...
        public K getKey() {
            if (this.f1405d) {
                return (K) g.this.b(this.f1404c, 0);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public V getValue() {
            if (this.f1405d) {
                return (V) g.this.b(this.f1404c, 1);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
        ...
        public int hashCode() {
            if (this.f1405d) {
                int i = 0;
                Object b2 = g.this.b(this.f1404c, 0);
                Object b3 = g.this.b(this.f1404c, 1);
        ...
        public V setValue(V v) {
            if (this.f1405d) {
                return (V) g.this.i(this.f1404c, v);
            }
            throw new IllegalStateException("This container does not support retaining Map.Entry objects");
        }
