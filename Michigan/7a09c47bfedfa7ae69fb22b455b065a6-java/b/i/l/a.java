...
public class a {
    ...
    public static final View.AccessibilityDelegate f1846c = new View.AccessibilityDelegate();

    /* renamed from: a  reason: collision with root package name */
    public final View.AccessibilityDelegate f1847a;

    /* renamed from: b  reason: collision with root package name */
    public final View.AccessibilityDelegate f1848b;
    ...
    public static final class C0035a extends View.AccessibilityDelegate {
        ...
        public boolean dispatchPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            return this.f1849a.a(view, accessibilityEvent);
        }

        public AccessibilityNodeProvider getAccessibilityNodeProvider(View view) {
            c b2 = this.f1849a.b(view);
            if (b2 != null) {
                return (AccessibilityNodeProvider) b2.f1918a;
            }
            return null;
        }

        public void onInitializeAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            this.f1849a.c(view, accessibilityEvent);
        }
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                bVar.f1906a.setScreenReaderFocusable(F);
            } else {
                bVar.h(1, F);
            }
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                bVar.f1906a.setHeading(booleanValue);
            } else {
            ...
            if (Build.VERSION.SDK_INT >= 28) {
                bVar.f1906a.setPaneTitle(charSequence);
            } else {
                bVar.f1906a.getExtras().putCharSequence("androidx.view.accessibility.AccessibilityNodeInfoCompat.PANE_TITLE_KEY", charSequence);
            }
            this.f1849a.d(view, bVar);
            CharSequence text = accessibilityNodeInfo.getText();
            if (Build.VERSION.SDK_INT < 26) {
                bVar.f1906a.getExtras().remove("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_START_KEY");
                bVar.f1906a.getExtras().remove("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_END_KEY");
                bVar.f1906a.getExtras().remove("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_FLAGS_KEY");
                bVar.f1906a.getExtras().remove("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ID_KEY");
        ...
        public void onPopulateAccessibilityEvent(View view, AccessibilityEvent accessibilityEvent) {
            this.f1849a.e(view, accessibilityEvent);
        }

        public boolean onRequestSendAccessibilityEvent(ViewGroup viewGroup, View view, AccessibilityEvent accessibilityEvent) {
            return this.f1849a.f(viewGroup, view, accessibilityEvent);
        }

        public boolean performAccessibilityAction(View view, int i, Bundle bundle) {
            return this.f1849a.g(view, i, bundle);
        }

        public void sendAccessibilityEvent(View view, int i) {
            this.f1849a.h(view, i);
        }

        public void sendAccessibilityEventUnchecked(View view, AccessibilityEvent accessibilityEvent) {
            this.f1849a.i(view, accessibilityEvent);
        }
    }

    public a() {
        this.f1847a = f1846c;
        this.f1848b = new C0035a(this);
    }

    public a(View.AccessibilityDelegate accessibilityDelegate) {
        this.f1847a = accessibilityDelegate;
        this.f1848b = new C0035a(this);
    }

    public boolean a(View view, AccessibilityEvent accessibilityEvent) {
        return this.f1847a.dispatchPopulateAccessibilityEvent(view, accessibilityEvent);
    }

    public c b(View view) {
        AccessibilityNodeProvider accessibilityNodeProvider = this.f1847a.getAccessibilityNodeProvider(view);
    ...
    public boolean f(ViewGroup viewGroup, View view, AccessibilityEvent accessibilityEvent) {
        return this.f1847a.onRequestSendAccessibilityEvent(viewGroup, view, accessibilityEvent);
    }
    ...
    public boolean g(View view, int i, Bundle bundle) {
        ...
        while (true) {
            ...
            if (aVar.a() != i) {
                i2++;
            } else if (aVar.f1915d != null) {
                d.a aVar2 = null;
                Class<? extends d.a> cls = aVar.f1914c;
                if (cls != null) {
                    try {
                ...
                z = aVar.f1915d.a(view, aVar2);
            }
        }
        z = false;
        if (!z) {
            z = this.f1847a.performAccessibilityAction(view, i, bundle);
        }
