...
public abstract class o<T> implements Comparable<o<T>> {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            o.this.mEventLog.a(this.f2832b, this.f2833c);
    ...
    public o(int i, String str, @Nullable q.a aVar) {
        this.mEventLog = w.a.f2854c ? new w.a() : null;
    ...
    private byte[] encodeParameters(Map<String, String> map, String str) {
        ...
        try {
            ...
            throw new RuntimeException(c.a.a.a.a.q("Encoding not supported: ", str), e2);
        }
    }
    ...
    public void finish(String str) {
        ...
        if (pVar != null) {
            synchronized (pVar.f2841b) {
                pVar.f2841b.remove(this);
            }
            synchronized (pVar.j) {
                for (p.a aVar : pVar.j) {
                    aVar.a(this);
    ...
    public String getBodyContentType() {
        StringBuilder h = c.a.a.a.a.h("application/x-www-form-urlencoded; charset=");
        h.append(getParamsEncoding());
        return h.toString();
    }
    ...
    public final int getTimeoutMs() {
        return ((f) getRetryPolicy()).f2811a;
    }
    ...
    public void notifyListenerResponseReceived(q<?> qVar) {
        ...
        if (bVar != null) {
            d.a aVar = (d.a) bVar;
            b.a aVar2 = qVar.f2848b;
            if (aVar2 != null) {
                if (!(aVar2.f2798e < System.currentTimeMillis())) {
                    String cacheKey = getCacheKey();
                    synchronized (aVar) {
                        remove = aVar.f2809a.remove(cacheKey);
                    }
                    if (remove != null) {
                        if (w.f2852a) {
                        ...
                        for (o<?> oVar : remove) {
                            ((g) aVar.f2810b.f2806e).a(oVar, qVar);
                        }
                        return;
                    }
                    return;
    ...
    public String toString() {
        ...
        h.append(Integer.toHexString(getTrafficStatsTag()));
