...
public class b implements i {
    ...
    public static final boolean f2860c = w.f2852a;

    /* renamed from: a  reason: collision with root package name */
    public final a f2861a;

    /* renamed from: b  reason: collision with root package name */
    public final c f2862b;
    ...
    public static void a(String str, o<?> oVar, v vVar) {
        ...
        try {
            ...
            fVar.f2812b = i;
            int i2 = fVar.f2811a;
            fVar.f2811a = i2 + ((int) (((float) i2) * fVar.f2814d));
            if (i <= fVar.f2813c) {
    ...
    public static List<h> b(List<h> list, b.a aVar) {
        ...
        if (list2 != null) {
            if (!list2.isEmpty()) {
                for (h hVar2 : aVar.h) {
                    if (!treeSet.contains(hVar2.f2820a)) {
                        arrayList.add(hVar2);
                    }
                }
            }
        } else if (!aVar.f2800g.isEmpty()) {
            for (Map.Entry<String, String> entry : aVar.f2800g.entrySet()) {
    ...
    public final byte[] d(InputStream inputStream, int i) {
        j jVar = new j(this.f2862b, i);
        try {
            byte[] a2 = this.f2862b.a(1024);
            while (true) {
    ...
    public final void e(long j, o<?> oVar, byte[] bArr, int i) {
        if (f2860c || j > 3000) {
            ...
            objArr[4] = Integer.valueOf(((f) oVar.getRetryPolicy()).f2812b);
    ...
    public l f(o<?> oVar) {
        ...
        while (true) {
            ...
            e eVar = null;
            try {
                executeRequest = this.f2861a.executeRequest(oVar, c(oVar.getCacheEntry()));
                int i = executeRequest.f2881a;
                unmodifiableList = Collections.unmodifiableList(executeRequest.f2882b);
                if (i == 304) {
                    b.a cacheEntry = oVar.getCacheEntry();
                    if (cacheEntry == null) {
                        return new l(304, null, true, SystemClock.elapsedRealtime() - elapsedRealtime, unmodifiableList);
                    }
                    return new l(304, cacheEntry.f2794a, true, SystemClock.elapsedRealtime() - elapsedRealtime, b(unmodifiableList, cacheEntry));
                }
                InputStream inputStream = executeRequest.f2884d;
                byte[] d2 = inputStream != null ? d(inputStream, executeRequest.f2883c) : new byte[0];
