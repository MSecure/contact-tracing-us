...
public class j extends ByteArrayOutputStream {
    ...
    public j(c cVar, int i) {
        this.f2886b = cVar;
        ((ByteArrayOutputStream) this).buf = cVar.a(Math.max(i, (int) RecyclerView.a0.FLAG_TMP_DETACHED));
    }

    public final void a(int i) {
        int i2 = ((ByteArrayOutputStream) this).count;
        if (i2 + i > ((ByteArrayOutputStream) this).buf.length) {
            byte[] a2 = this.f2886b.a((i2 + i) * 2);
            System.arraycopy(((ByteArrayOutputStream) this).buf, 0, a2, 0, ((ByteArrayOutputStream) this).count);
            this.f2886b.b(((ByteArrayOutputStream) this).buf);
