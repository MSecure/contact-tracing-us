...
public final class u extends a implements m1 {
    ...
    public final /* synthetic */ DiagnosisKeyFileProvider f3744a;
    ...
    public u(DiagnosisKeyFileProvider diagnosisKeyFileProvider) {
        ...
        this.f3744a = diagnosisKeyFileProvider;
    }
    ...
    public final boolean zza(int i, Parcel parcel, Parcel parcel2, int i2) {
        ...
        if (i == 1) {
            boolean zza = this.f3744a.zza();
            parcel2.writeNoException();
            s1.c(parcel2, zza);
        } else if (i == 2) {
            try {
                parcelFileDescriptor = ParcelFileDescriptor.open(this.f3744a.zzb(), 268435456);
