...
public final class v9 {
    ...
    public final List<ParcelUuid> f3784b;

    /* renamed from: c  reason: collision with root package name */
    public final SparseArray<byte[]> f3785c;

    /* renamed from: d  reason: collision with root package name */
    public final Map<ParcelUuid, byte[]> f3786d;
    ...
    public final boolean equals(Object obj) {
        ...
        return Arrays.equals(this.f3789g, ((v9) obj).f3789g);
    }

    public final int hashCode() {
        return Arrays.hashCode(this.f3789g);
    }

    public final String toString() {
        String str;
        int i = this.f3783a;
        String valueOf = String.valueOf(this.f3784b);
        SparseArray<byte[]> sparseArray = this.f3785c;
        ...
        if (sparseArray.size() <= 0) {
            ...
            for (int i3 = 0; i3 < sparseArray.size(); i3++) {
                ...
                sb.append(keyAt);
                sb.append('=');
                sb.append(valueAt == null ? null : c.a(valueAt));
            }
            sb.append('}');
            str = sb.toString();
        }
        Map<ParcelUuid, byte[]> map = this.f3786d;
        ...
        if (map.keySet().size() > 0) {
            ...
            for (Map.Entry<ParcelUuid, byte[]> entry : map.entrySet()) {
                ...
                sb2.append(value == null ? null : c.a(value));
                i2++;
            }
            sb2.append('}');
            str2 = sb2.toString();
