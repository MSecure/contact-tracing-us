...
public abstract class a<T> implements Iterator<T> {
    ...
    public EnumC0083a f4646b = EnumC0083a.NOT_READY;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0079, code lost:
        if (r0.f4674e.a(r0.f4673d.charAt(r4)) == false) goto L_0x007e;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x008e, code lost:
        if (r0.f4674e.a(r0.f4673d.charAt(r9)) == false) goto L_0x0092;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0094, code lost:
        if (r0.f4675f == false) goto L_0x0099;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:41:0x00b5, code lost:
        if (r0.f4674e.a(r0.f4673d.charAt(r8)) == false) goto L_0x00bc;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:44:0x00bc, code lost:
        r0 = (T) r0.f4673d.subSequence(r4, r5).toString();
     */
    ...
    public final T next() {
        if (hasNext()) {
            this.f4646b = EnumC0083a.NOT_READY;
            T t = this.f4647c;
            this.f4647c = null;
            return t;
        }
