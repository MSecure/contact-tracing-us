...
public abstract class h<OutputT> extends b.j<OutputT> {
    ...
    public static final class c extends b {
        ...
        public final AtomicReferenceFieldUpdater<h, Set<Throwable>> f4753a;

        /* renamed from: b  reason: collision with root package name */
        public final AtomicIntegerFieldUpdater<h> f4754b;

        public c(AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, AtomicIntegerFieldUpdater atomicIntegerFieldUpdater) {
            super(null);
            this.f4753a = atomicReferenceFieldUpdater;
            this.f4754b = atomicIntegerFieldUpdater;
        }

        @Override // c.b.b.e.a.h.b
        public void a(h hVar, Set<Throwable> set, Set<Throwable> set2) {
            this.f4753a.compareAndSet(hVar, null, set2);
        }

        @Override // c.b.b.e.a.h.b
        public int b(h hVar) {
            return this.f4754b.decrementAndGet(hVar);
        }
    }
