...
public final class b extends i<s0> {
    ...
    public class a extends i.b<o, s0> {
        ...
        public o a(s0 s0Var) {
            s0 s0Var2 = s0Var;
            o0 n = s0Var2.p().n();
            SecretKeySpec secretKeySpec = new SecretKeySpec(s0Var2.keyValue_.q(), "HMAC");
    ...
    public class C0096b extends i.a<t0, s0> {
        public C0096b(Class cls) {
            super(cls);
        }
