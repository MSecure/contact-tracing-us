...
public final class t0<T> implements f1<T> {
    ...
    public t0(int[] iArr, Object[] objArr, int i2, int i3, r0 r0Var, boolean z, boolean z2, int[] iArr2, int i4, int i5, v0 v0Var, h0 h0Var, l1<?, ?> l1Var, r<?> rVar, m0 m0Var) {
        ...
        this.f5025c = i2;
        this.f5026d = i3;
        this.f5029g = r0Var instanceof y;
        this.h = z;
        this.f5028f = rVar != null && (r0Var instanceof y.c);
        this.i = z2;
        this.j = iArr2;
        this.k = i4;
        this.l = i5;
    ...
    public static <T> t0<T> A(d1 d1Var, v0 v0Var, h0 h0Var, l1<?, ?> l1Var, r<?> rVar, m0 m0Var) {
        ...
        a1 a1Var = a1.PROTO3;
        int i36 = 0;
        boolean z2 = ((d1Var.f4910d & 1) == 1 ? a1.PROTO2 : a1Var) == a1Var;
        String str2 = d1Var.f4908b;
        ...
        Unsafe unsafe = s;
        Object[] objArr = d1Var.f4909c;
        Class<?> cls = d1Var.f4907a.getClass();
        int i70 = i5;
        ...
        while (i73 < length) {
            ...
            int i85 = charAt24 & BuildConfig.VERSION_CODE;
            if ((charAt24 & 1024) != 0) {
                iArr[i75] = i76;
                i75++;
            }
            ...
            iArr2[i76] = charAt23;
            int i101 = i100 + 1;
            iArr2[i100] = ((i12 & RecyclerView.a0.FLAG_ADAPTER_POSITION_UNKNOWN) != 0 ? 536870912 : 0) | ((i12 & RecyclerView.a0.FLAG_TMP_DETACHED) != 0 ? 268435456 : 0) | (i85 << 20) | i15;
            int i102 = i101 + 1;
        ...
        return new t0<>(iArr2, objArr2, i6, i7, d1Var.f4907a, z2, false, iArr, i3, i71, v0Var, h0Var, l1Var, rVar, m0Var);
    }
    ...
    public final int I(T t, byte[] bArr, int i2, int i3, int i4, int i5, int i6, int i7, int i8, long j2, int i9, e eVar) {
        ...
        int i11;
        Unsafe unsafe = s;
        long j4 = (long) (this.f5023a[i9 + 2] & 1048575);
        switch (i8) {
            case 51:
                if (i6 == 1) {
                    obj = Double.valueOf(t.j0(bArr, i2));
            ...
            case 52:
                if (i6 == 5) {
                    obj2 = Float.valueOf(t.p0(bArr, i2));
            ...
            case 64:
                if (i6 == 5) {
                    obj2 = Integer.valueOf(t.l0(bArr, i2));
                    unsafe.putObject(t, j2, obj2);
                    i10 = i2 + 4;
                    unsafe.putInt(t, j4, i5);
                    return i10;
            ...
            case 58:
                if (i6 == 0) {
                    i10 = t.b1(bArr, i2, eVar);
                    obj3 = Boolean.valueOf(eVar.f4912b != 0);
                    unsafe.putObject(t, j2, obj3);
                    unsafe.putInt(t, j4, i5);
                    return i10;
                }
            ...
            case 59:
                if (i6 == 2) {
                    ...
                    if (i12 == 0) {
                        ...
                        unsafe.putObject(t, j2, new String(bArr, i10, i12, a0.f4885a));
                        i10 += i12;
                        unsafe.putInt(t, j4, i5);
                        return i10;
                    } else {
            ...
            case 63:
                if (i6 == 0) {
                    int X0 = t.X0(bArr, i2, eVar);
                    int i13 = eVar.f4911a;
                    a0.b bVar = (a0.b) this.f5024b[((i9 / 3) * 2) + 1];
            ...
            case 68:
                if (i6 == 3) {
                    i10 = t.r0(o(i9), bArr, i2, i3, (i4 & -8) | 4, eVar);
    ...
    public int J(T t, byte[] bArr, int i2, int i3, int i4, e eVar) {
        ...
        while (true) {
            if (i36 < i35) {
                ...
                byte b3 = bArr6[i36];
                if (b3 < 0) {
                    int V0 = t.V0(b3, bArr6, i43, eVar2);
                    b2 = eVar2.f4911a;
                    i43 = V0;
                } else {
                    b2 = b3;
                ...
                if (i44 > i41) {
                    int i46 = i38 / 3;
                    if (i44 < t0Var3.f5025c || i44 > t0Var3.f5026d) {
                        i6 = -1;
                        i5 = -1;
                        if (i5 != i6) {
                            i10 = i44;
                            ...
                            int i47 = t0Var3.f5023a[i5 + 1];
                            int V = V(i47);
                            long B = B(i47);
                            if (V <= 17) {
                                int i48 = t0Var3.f5023a[i5 + 2];
                                int i49 = 1 << (i48 >>> 20);
                                int i50 = i48 & 1048575;
                                if (i50 != i42) {
                                    if (i42 != -1) {
                                ...
                                switch (V) {
                                    ...
                                    case 1:
                                        ...
                                        i25 = i43;
                                        if (i45 == 5) {
                                            p1.f5006f.n(t4, B, t.p0(bArr, i25));
                                            i36 = i25 + 4;
                                            i26 = i22 | i49;
                                            i16 = i26;
                                            i13 = i24;
                                    ...
                                    case 14:
                                        ...
                                        bArr4 = bArr;
                                        if (i45 == 1) {
                                            unsafe2.putLong(t, B, t.n0(bArr4, i43));
                                            i24 = i33;
                                            i25 = i43;
                                            i36 = i25 + 8;
                                            i26 = i22 | i49;
                                    ...
                                    case 13:
                                        ...
                                        bArr4 = bArr;
                                        if (i45 == 5) {
                                            unsafe2.putInt(t4, B, t.l0(bArr4, i43));
                                            i36 = i43 + 4;
                                            i30 = i22 | i49;
                                            bArr3 = bArr4;
                                            i29 = i33;
                                    ...
                                    case 7:
                                        ...
                                        bArr4 = bArr;
                                        if (i45 == 0) {
                                            int b1 = t.b1(bArr4, i43, eVar2);
                                            p1.f5006f.k(t4, B, eVar2.f4912b != 0);
                                            i36 = b1;
                                            i30 = i22 | i49;
                                            bArr3 = bArr4;
                                            i29 = i33;
                                    ...
                                    case 8:
                                        ...
                                        bArr4 = bArr;
                                        if (i45 == 2) {
                                            i36 = (i47 & 536870912) == 0 ? t.P0(bArr4, i43, eVar2) : t.R0(bArr4, i43, eVar2);
                                            obj = eVar2.f4913c;
                                    ...
                                    case 9:
                                        ...
                                        if (i45 != 2) {
                                            ...
                                            i36 = t.t0(t0Var3.o(i33), bArr4, i43, i3, eVar2);
                                            if ((i22 & i49) != 0) {
                                                obj = a0.f(unsafe2.getObject(t4, B), eVar2.f4913c);
                                                unsafe2.putObject(t4, B, obj);
                                                i30 = i22 | i49;
                                                bArr3 = bArr4;
                                                i29 = i33;
                                    ...
                                    case 10:
                                        ...
                                        bArr5 = bArr;
                                        if (i45 == 2) {
                                            i36 = t.h0(bArr5, i43, eVar2);
                                            unsafe2.putObject(t4, B, eVar2.f4913c);
                                            i24 = i28;
                                            i26 = i22 | i49;
                                            i16 = i26;
                                            i13 = i24;
                                    ...
                                    case 17:
                                        if (i45 == 3) {
                                            ...
                                            i14 = i23;
                                            i17 = b2;
                                            i36 = t.r0(t0Var3.o(i5), bArr, i43, i3, (i44 << 3) | 4, eVar);
                                            unsafe2.putObject(t4, B, (i22 & i49) == 0 ? eVar2.f4913c : a0.f(unsafe2.getObject(t4, B), eVar2.f4913c));
                                            i26 = i22 | i49;
                                            i24 = i5;
                                            i16 = i26;
                                            i13 = i24;
                                ...
                                if (V != 27) {
                                    ...
                                    if (!cVar.m()) {
                                        int size = cVar.size();
                                        cVar = cVar.i(size == 0 ? 10 : size * 2);
                                        unsafe2.putObject(t4, B, cVar);
                                    }
                                    i14 = i42;
                                    i13 = i5;
                                    i36 = t.v0(t0Var3.o(i5), i17, bArr, i43, i3, cVar, eVar);
                                } else {
                                    i9 = i5;
                                    i19 = i42;
                                    i21 = i43;
                        ...
                        if (i8 == i11 || i11 == 0) {
                            ...
                            if (!t0Var2.f5028f) {
                                ...
                                if (eVar2.f4914d != q.a()) {
                                    i7 = i10;
                                    y.e<?, ?> eVar3 = eVar2.f4914d.f5011a.get(new q.a(t0Var2.f5027e, i7));
                                    if (eVar3 == null) {
                                        i36 = t.T0(i8, bArr, i12, i3, p(t), eVar);
                                        t3 = t;
                                        i37 = i11;
                                        i38 = i9;
                                        i39 = i8;
    ...
    public final int K(T t, byte[] bArr, int i2, int i3, e eVar) {
        ...
        while (i18 < i16) {
            ...
            if (i22 > i19) {
                int i24 = i20 / 3;
                if (i22 < t0Var.f5025c || i22 > t0Var.f5026d) {
                    i5 = i17;
                    if (i5 != i17) {
                        i7 = i22;
                        i9 = i4;
                        ...
                        if (V <= 17) {
                            ...
                            switch (V) {
                                ...
                                case 1:
                                    i12 = i5;
                                    if (i23 == 5) {
                                        p1.f5006f.n(t2, B, t.p0(bArr2, i4));
                                        i18 = i4 + 4;
                                        i11 = i12;
                                        break;
                                    }
                                ...
                                case 14:
                                    if (i23 == 1) {
                                        i12 = i5;
                                        unsafe2.putLong(t, B, t.n0(bArr2, i4));
                                        i18 = i4 + 8;
                                        i11 = i12;
                                        break;
                                    }
                                ...
                                case 13:
                                    if (i23 == 5) {
                                        unsafe2.putInt(t2, B, t.l0(bArr2, i4));
                                        i18 = i4 + 4;
                                        i11 = i5;
                                        break;
                                    }
                                ...
                                case 8:
                                    if (i23 == 2) {
                                        i18 = (536870912 & i25) == 0 ? t.P0(bArr2, i4, eVar2) : t.R0(bArr2, i4, eVar2);
                                        obj = eVar2.f4913c;
                                ...
                                case 9:
                                    if (i23 == 2) {
                                        i18 = t.t0(t0Var.o(i5), bArr2, i4, i16, eVar2);
                                        Object object = unsafe2.getObject(t2, B);
                                        if (object != null) {
                                            obj = a0.f(object, eVar2.f4913c);
                                            unsafe2.putObject(t2, B, obj);
                                            i11 = i5;
                                            break;
                                        }
                            ...
                            if (i23 == 2) {
                                ...
                                i11 = i5;
                                i18 = t.v0(t0Var.o(i5), b2, bArr, i4, i3, cVar, eVar);
                            }
                            i8 = i5;
                            i7 = i22;
                            i10 = i4;
                    ...
                    i18 = t.T0(b2, bArr, i9, i3, p(t), eVar);
                    i20 = i8;
                    t0Var = this;
                    t2 = t;
                    bArr2 = bArr;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:49:0x0113, code lost:
        r11.add(c.b.c.a.j0.a.i.g(r18, r1, r4));
        r1 = r1 + r4;
     */
    ...
    public final int L(T t, byte[] bArr, int i2, int i3, int i4, int i5, int i6, int i7, long j2, int i8, long j3, e eVar) {
        ...
        switch (i8) {
            ...
            case 35:
                if (i6 == 2) {
                    return t.z0(bArr, i10, cVar, eVar);
                }
                if (i6 == 1) {
                    n nVar = (n) cVar;
                    double j0 = t.j0(bArr, i2);
                    while (true) {
                        nVar.c(j0);
                        int i11 = i10 + 8;
                        if (i11 >= i3) {
            ...
            case 36:
                if (i6 == 2) {
                    return t.F0(bArr, i10, cVar, eVar);
                }
                if (i6 == 5) {
                    w wVar = (w) cVar;
                    float p0 = t.p0(bArr, i2);
                    while (true) {
                        wVar.c(p0);
                        int i12 = i10 + 4;
                        if (i12 >= i3) {
            ...
            case 38:
                if (i6 == 2) {
                    return t.N0(bArr, i10, cVar, eVar);
                }
                if (i6 == 0) {
                    i0 i0Var = (i0) cVar;
                    do {
                        b1 = t.b1(bArr, i10, eVar);
                        i0Var.c(eVar.f4912b);
                        if (b1 >= i3) {
                            return b1;
                        }
                        i10 = t.X0(bArr, b1, eVar);
                    } while (i4 == eVar.f4911a);
                    return b1;
                }
                break;
            case 22:
            ...
            case 43:
                if (i6 == 2) {
                    return t.L0(bArr, i10, cVar, eVar);
                }
                if (i6 == 0) {
                    return t.Z0(i4, bArr, i2, i3, cVar, eVar);
                }
                break;
            case 23:
            case 32:
            ...
            case 46:
                if (i6 == 2) {
                    return t.D0(bArr, i10, cVar, eVar);
                }
                if (i6 == 1) {
                    i0 i0Var2 = (i0) cVar;
                    long n0 = t.n0(bArr, i2);
                    while (true) {
                        i0Var2.c(n0);
                        int i13 = i10 + 8;
                        if (i13 >= i3) {
            ...
            case 45:
                if (i6 == 2) {
                    return t.B0(bArr, i10, cVar, eVar);
                }
                if (i6 == 5) {
                    z zVar = (z) cVar;
                    int l0 = t.l0(bArr, i2);
            ...
            case 42:
                if (i6 != 2) {
                    if (i6 == 0) {
                        f fVar = (f) cVar;
                        int b13 = t.b1(bArr, i10, eVar);
                        break;
                    }
                } else {
                    return t.x0(bArr, i10, cVar, eVar);
                }
                break;
            case 26:
                if (i6 == 2) {
                    if ((j2 & 536870912) == 0) {
                        int X02 = t.X0(bArr, i10, eVar);
                        int i15 = eVar.f4911a;
                        if (i15 >= 0) {
                            if (i15 != 0) {
                                String str = new String(bArr, X02, i15, a0.f4885a);
                                cVar.add(str);
                                X02 += i15;
                                if (X02 < i3) {
                                    int X03 = t.X0(bArr, X02, eVar);
                                    if (i4 != eVar.f4911a) {
                                        return X02;
                                    }
                                    X02 = t.X0(bArr, X03, eVar);
                                    i15 = eVar.f4911a;
                                    if (i15 >= 0) {
                                        if (i15 != 0) {
                                            str = new String(bArr, X02, i15, a0.f4885a);
                                            cVar.add(str);
                                            X02 += i15;
                                            if (X02 < i3) {
                                                return X02;
                    ...
                    int X04 = t.X0(bArr, i10, eVar);
                    int i16 = eVar.f4911a;
                    if (i16 >= 0) {
                        if (i16 != 0) {
                            int i17 = X04 + i16;
                            if (q1.f(bArr, X04, i17)) {
                                String str2 = new String(bArr, X04, i16, a0.f4885a);
                                cVar.add(str2);
                                X04 = i17;
                                if (X04 < i3) {
                                    int X05 = t.X0(bArr, X04, eVar);
                                    if (i4 != eVar.f4911a) {
                                        return X04;
                                    }
                                    X04 = t.X0(bArr, X05, eVar);
                                    int i18 = eVar.f4911a;
                                    if (i18 >= 0) {
                                        if (i18 != 0) {
                                            i17 = X04 + i18;
                                            if (q1.f(bArr, X04, i17)) {
                                                str2 = new String(bArr, X04, i18, a0.f4885a);
                                                cVar.add(str2);
                                                X04 = i17;
                                                if (X04 < i3) {
                                                    return X04;
            ...
            case 27:
                if (i6 == 2) {
                    return t.v0(o(i7), i4, bArr, i2, i3, cVar, eVar);
                }
                break;
            case 28:
                if (i6 == 2) {
                    int X06 = t.X0(bArr, i10, eVar);
                    int i19 = eVar.f4911a;
                    if (i19 < 0) {
                        throw b0.f();
                    } else if (i19 > bArr.length - X06) {
                        throw b0.h();
                    }
                }
                break;
            ...
            case 44:
                if (i6 == 2) {
                    i9 = t.L0(bArr, i10, cVar, eVar);
                } else if (i6 == 0) {
                    i9 = t.Z0(i4, bArr, i2, i3, cVar, eVar);
                }
                T t2 = t;
                ...
                m1 m1Var2 = (m1) h1.z(i5, cVar, (a0.b) this.f5024b[((i7 / 3) * 2) + 1], m1Var, this.o);
                if (m1Var2 != null) {
            ...
            case 47:
                if (i6 == 2) {
                    return t.H0(bArr, i10, cVar, eVar);
                }
                if (i6 == 0) {
                    z zVar2 = (z) cVar;
                    do {
                        X0 = t.X0(bArr, i10, eVar);
                        zVar2.c(j.b(eVar.f4911a));
                        if (X0 >= i3) {
                            return X0;
                        }
                        i10 = t.X0(bArr, X0, eVar);
                    } while (i4 == eVar.f4911a);
                    return X0;
                }
                break;
            ...
            case 48:
                if (i6 == 2) {
                    return t.J0(bArr, i10, cVar, eVar);
                }
                if (i6 == 0) {
                    i0 i0Var3 = (i0) cVar;
                    do {
                        b12 = t.b1(bArr, i10, eVar);
                        i0Var3.c(j.c(eVar.f4912b));
                        if (b12 >= i3) {
                            return b12;
                        }
                        i10 = t.X0(bArr, b12, eVar);
                    } while (i4 == eVar.f4911a);
                    return b12;
                }
                break;
            case 49:
                if (i6 == 3) {
                    f1 o2 = o(i7);
                    int i20 = (i4 & -8) | 4;
                    i10 = t.r0(o2, bArr, i2, i3, i20, eVar);
                    while (true) {
                        cVar.add(eVar.f4913c);
                        if (i10 >= i3) {
                            break;
                        } else {
                            int X07 = t.X0(bArr, i10, eVar);
                            if (i4 != eVar.f4911a) {
                                break;
                            } else {
                                i10 = t.r0(o2, bArr, X07, i3, i20, eVar);
                            }
                        }
                    }
                }
    ...
    public final int M(int i2) {
        if (i2 < this.f5025c || i2 > this.f5026d) {
            return -1;
        }
        return U(i2, 0);
    }
    ...
    public final <E> void N(Object obj, long j2, e1 e1Var, f1<E> f1Var, q qVar) {
        e1Var.M(this.n.c(obj, j2), f1Var, qVar);
    }

    public final <E> void O(Object obj, int i2, e1 e1Var, f1<E> f1Var, q qVar) {
        e1Var.N(this.n.c(obj, B(i2)), f1Var, qVar);
    }
    ...
    public final void Q(Object obj, int i2, e1 e1Var) {
        if ((536870912 & i2) != 0) {
            ...
            e1Var.H(this.n.c(obj, B(i2)));
        }
    }

    public final void S(T t, int i2) {
        if (!this.h) {
            int i3 = this.f5023a[i2 + 2];
            long j2 = (long) (i3 & 1048575);
            p1.f5006f.o(t, j2, p1.l(t, j2) | (1 << (i3 >>> 20)));
        }
    }

    public final void T(T t, int i2, int i3) {
        p1.f5006f.o(t, (long) (this.f5023a[i3 + 2] & 1048575), i2);
    }

    public final int U(int i2, int i3) {
        int length = (this.f5023a.length / 3) - 1;
        while (i3 <= length) {
            int i4 = (length + i3) >>> 1;
            int i5 = i4 * 3;
            int i6 = this.f5023a[i5];
            if (i2 == i6) {
                return i5;
            }
            if (i2 < i6) {
        ...
        if (this.f5028f) {
            if (((s) this.p) != null) {
                ...
                if (!uVar.h()) {
                    entry = uVar.k().next();
                    int i4 = -1;
                    length = this.f5023a.length;
                    Unsafe unsafe = s;
                    i2 = 0;
                    int i5 = 0;
                    while (i2 < length) {
                        int W = W(i2);
                        int i6 = this.f5023a[i2];
                        int V = V(W);
                        if (this.h || V > 17) {
                            i3 = 0;
                        } else {
                            int i7 = this.f5023a[i2 + 2];
                            int i8 = i7 & 1048575;
                            if (i8 != i4) {
                        ...
                        switch (V) {
                            ...
                            case 4:
                                if ((i3 & i5) != 0) {
                                    ((m) u1Var).f4982a.T(i6, unsafe.getInt(t, B));
                                } else {
                                    continue;
                                }
                                i2 += 3;
                            ...
                            case 17:
                                ...
                                i4 = i4;
                            case 18:
                                h1.J(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 19:
                                h1.N(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 20:
                                h1.Q(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 21:
                                h1.Y(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 22:
                                h1.P(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 23:
                                h1.M(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 24:
                                h1.L(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 25:
                                h1.H(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 26:
                                h1.W(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var);
                                break;
                            case 27:
                                h1.R(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, o(i2));
                                break;
                            case 28:
                                h1.I(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var);
                                break;
                            case 29:
                                h1.X(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 30:
                                h1.K(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 31:
                                h1.S(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 32:
                                h1.T(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 33:
                                h1.U(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 34:
                                h1.V(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, false);
                                continue;
                                i2 += 3;
                                length = length;
                                i4 = i4;
                            case 35:
                                h1.J(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 36:
                                h1.N(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 37:
                                h1.Q(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 38:
                                h1.Y(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 39:
                                h1.P(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 40:
                                h1.M(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 41:
                                h1.L(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 42:
                                h1.H(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 43:
                                h1.X(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 44:
                                h1.K(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 45:
                                h1.S(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 46:
                                h1.T(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 47:
                                h1.U(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 48:
                                h1.V(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, true);
                                break;
                            case 49:
                                h1.O(this.f5023a[i2], (List) unsafe.getObject(t, B), u1Var, o(i2));
                                break;
                            case 50:
    ...
    public final void Z(int i2, Object obj, u1 u1Var) {
        if (obj instanceof String) {
            l.b bVar = (l.b) ((m) u1Var).f4982a;
            bVar.V((i2 << 3) | 2);
            bVar.a0((String) obj);
            return;
        }
        l.b bVar2 = (l.b) ((m) u1Var).f4982a;
        bVar2.V((i2 << 3) | 2);
        bVar2.Z((i) obj);
    }
        ...
        while (true) {
            ...
            if (i2 < length) {
                ...
                switch (V(i3)) {
                    ...
                    case 67:
                    case 68:
                        long j2 = (long) (this.f5023a[i2 + 2] & 1048575);
    ...
    public final boolean e(T t) {
        ...
        while (true) {
            ...
            if (i4 < this.k) {
                int i6 = this.j[i4];
                int i7 = this.f5023a[i6];
                int W = W(i6);
                if (!this.h) {
                    int i8 = this.f5023a[i6 + 2];
                    int i9 = 1048575 & i8;
                    i2 = 1 << (i8 >>> 20);
                    if (i9 != i3) {
                ...
                if (V != 9 && V != 17) {
                    if (V != 27) {
                        if (V == 60 || V == 68) {
                            if (u(t, i7, i6) && !o(i6).e(p1.n(t, B(W)))) {
                                return false;
                            }
                        } else if (V != 49) {
                            if (V == 50 && !this.q.b(p1.n(t, B(W))).isEmpty()) {
                                this.q.h(this.f5024b[(i6 / 3) * 2]);
                                throw null;
                            }
                        }
                    }
                ...
                } else if (t(t, i6, i5, i2) && !o(i6).e(p1.n(t, B(W)))) {
                    return false;
                }
                i4++;
            } else {
                        ...
                        for (i2 = 0; i2 < length; i2 += 3) {
                            ...
                            switch (V(W)) {
                                ...
                                case 17:
                                    ...
                                    break;
                                case 18:
                                    h1.J(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 19:
                                    h1.N(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 20:
                                    h1.Q(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 21:
                                    h1.Y(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 22:
                                    h1.P(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 23:
                                    h1.M(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 24:
                                    h1.L(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 25:
                                    h1.H(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 26:
                                    h1.W(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var);
                                    break;
                                case 27:
                                    h1.R(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, o(i2));
                                    break;
                                case 28:
                                    h1.I(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var);
                                    break;
                                case 29:
                                    h1.X(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 30:
                                    h1.K(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 31:
                                    h1.S(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 32:
                                    h1.T(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 33:
                                    h1.U(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 34:
                                    h1.V(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, false);
                                    break;
                                case 35:
                                    h1.J(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 36:
                                    h1.N(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 37:
                                    h1.Q(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 38:
                                    h1.Y(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 39:
                                    h1.P(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 40:
                                    h1.M(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 41:
                                    h1.L(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 42:
                                    h1.H(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 43:
                                    h1.X(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 44:
                                    h1.K(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 45:
                                    h1.S(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 46:
                                    h1.T(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 47:
                                    h1.U(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 48:
                                    h1.V(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, true);
                                    break;
                                case 49:
                                    h1.O(this.f5023a[i2], (List) p1.n(t, B(W)), u1Var, o(i2));
                                    break;
                                case 50:
    ...
    public final <UT, UB> UB l(Object obj, int i2, UB ub, l1<UT, UB> l1Var) {
        ...
        int i4 = (i2 / 3) * 2;
        a0.b bVar = (a0.b) this.f5024b[i4 + 1];
        if (bVar == null) {
            return ub;
        }
        Map<?, ?> e2 = this.q.e(n2);
        this.q.h(this.f5024b[i4]);
    ...
    public final a0.b m(int i2) {
        return (a0.b) this.f5024b[((i2 / 3) * 2) + 1];
    }

    public final Object n(int i2) {
        return this.f5024b[(i2 / 3) * 2];
    }

    public final f1 o(int i2) {
        int i3 = (i2 / 3) * 2;
        Object[] objArr = this.f5024b;
        f1 f1Var = (f1) objArr[i3];
        if (f1Var != null) {
            return f1Var;
        }
        f1<T> a2 = b1.f4890c.a((Class) objArr[i3 + 1]);
        this.f5024b[i3] = a2;
        return a2;
    }
    ...
    public final int q(T t) {
        ...
        int i10 = 0;
        int i11 = 0;
        for (int i12 = 0; i12 < this.f5023a.length; i12 += 3) {
            int W = W(i12);
            int i13 = this.f5023a[i12];
            int V = V(W);
            if (V <= 17) {
                i3 = this.f5023a[i12 + 2];
                int i14 = 1048575 & i3;
                i2 = 1 << (i3 >>> 20);
                if (i14 != i9) {
                ...
                i3 = (!this.i || V < v.DOUBLE_LIST_PACKED.f5048b || V > v.SINT64_LIST_PACKED.f5048b) ? 0 : this.f5023a[i12 + 2] & 1048575;
                i2 = 0;
            }
            long B = B(W);
            switch (V) {
        ...
        if (((n1) this.o) != null) {
            ...
            if (((s) this.p) != null) {
                u<y.d> uVar = t.extensions;
                int i15 = 0;
                for (int i16 = 0; i16 < uVar.f5037a.e(); i16++) {
                    Map.Entry<T, Object> d2 = uVar.f5037a.d(i16);
                    i15 += u.e(d2.getKey(), d2.getValue());
                }
                for (Map.Entry<T, Object> entry : uVar.f5037a.f()) {
    ...
    public final int r(T t) {
        ...
        Unsafe unsafe = s;
        int i8 = 0;
        for (int i9 = 0; i9 < this.f5023a.length; i9 += 3) {
            int W = W(i9);
            int V = V(W);
            int i10 = this.f5023a[i9];
            long B = B(W);
            int i11 = (V < v.DOUBLE_LIST_PACKED.f5048b || V > v.SINT64_LIST_PACKED.f5048b) ? 0 : this.f5023a[i9 + 2] & 1048575;
            switch (V) {
                case 0:
                    if (!s(t, i9)) {
                        break;
        ...
        if (this.h) {
            ...
            switch (V(i3)) {
                ...
                case 8:
                    ...
                    if (n2 instanceof i) {
                        return !i.f4933c.equals(n2);
                    }
                    throw new IllegalArgumentException();
                case 9:
                    return p1.n(t, B) != null;
                case 10:
                    return !i.f4933c.equals(p1.n(t, B));
                case 11:
                    return p1.l(t, B) != 0;
                case 12:
                    return p1.l(t, B) != 0;
    ...
    public final boolean u(T t, int i2, int i3) {
        return p1.l(t, (long) (this.f5023a[i3 + 2] & 1048575)) == i2;
    }

    public final <K, V> void w(Object obj, int i2, Object obj2, q qVar, e1 e1Var) {
        long B = B(this.f5023a[i2 + 1]);
        Object n2 = p1.n(obj, B);
        if (n2 == null) {
            n2 = this.q.c(obj2);
            p1.f5006f.q(obj, B, n2);
        } else if (this.q.f(n2)) {
            Object c2 = this.q.c(obj2);
            this.q.a(c2, n2);
            p1.f5006f.q(obj, B, c2);
            n2 = c2;
        }
        e1Var.L(this.q.e(n2), this.q.h(obj2), qVar);
    }
