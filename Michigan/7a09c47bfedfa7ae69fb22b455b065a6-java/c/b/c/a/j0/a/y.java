...
public abstract class y<MessageType extends y<MessageType, BuilderType>, BuilderType extends a<MessageType, BuilderType>> extends a<MessageType, BuilderType> {
    ...
    public m1 unknownFields = m1.f4983f;

    public static abstract class a<MessageType extends y<MessageType, BuilderType>, BuilderType extends a<MessageType, BuilderType>> extends a.AbstractC0100a<MessageType, BuilderType> {

        /* renamed from: b  reason: collision with root package name */
        public final MessageType f5062b;

        /* renamed from: c  reason: collision with root package name */
        public MessageType f5063c;
        ...
        public a(MessageType messagetype) {
            ...
            this.f5063c = (MessageType) ((y) messagetype.f(f.NEW_MUTABLE_INSTANCE, null, null));
        }
        ...
        public MessageType c() {
            ...
            MessageType messagetype = this.f5063c;
            if (messagetype != null) {
                b1.f4890c.b(messagetype).g(messagetype);
                this.f5064d = true;
                return this.f5063c;
            }
            throw null;
        ...
        public Object clone() {
            a aVar = (a) this.f5062b.f(f.NEW_BUILDER, null, null);
            aVar.e(c());
            return aVar;
        }
        ...
        public final void d() {
            if (this.f5064d) {
                MessageType messagetype = (MessageType) ((y) this.f5063c.f(f.NEW_MUTABLE_INSTANCE, null, null));
                b1.f4890c.b(messagetype).a(messagetype, this.f5063c);
                this.f5063c = messagetype;
                this.f5064d = false;
            }
        }
        ...
        public BuilderType e(MessageType messagetype) {
            d();
            f(this.f5063c, messagetype);
            return this;
        }

        public final void f(MessageType messagetype, MessageType messagetype2) {
            b1.f4890c.b(messagetype).a(messagetype, messagetype2);
        }
    ...
    public static class b<T extends y<T, ?>> extends b<T> {
        ...
        public Object b(j jVar, q qVar) {
            return y.m(this.f5065a, jVar, qVar);
        }
    }
    ...
    public static abstract class c<MessageType extends c<MessageType, BuilderType>, BuilderType extends Object<MessageType, BuilderType>> extends y<MessageType, BuilderType> implements Object<MessageType, BuilderType> {
        public u<d> extensions = u.f5036d;
    ...
    public static final <T extends y<T, ?>> boolean j(T t, boolean z) {
        ...
        boolean e2 = b1.f4890c.b(t).e(t);
        if (z) {
            t.f(f.SET_MEMOIZED_IS_INITIALIZED, e2 ? t : null, null);
        }
        return e2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return b1.f4890c.b(this).b(this, (y) obj);
    }
    ...
    public int getSerializedSize() {
        if (this.memoizedSerializedSize == -1) {
            this.memoizedSerializedSize = b1.f4890c.b(this).f(this);
        }
    ...
    public int hashCode() {
        ...
        int d2 = b1.f4890c.b(this).d(this);
