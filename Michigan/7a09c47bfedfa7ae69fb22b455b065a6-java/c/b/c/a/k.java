...
public final class k {
    ...
    public synchronized int a(x0 x0Var, boolean z) {
        z0.c c2;
        c2 = c(x0Var);
        z0.b bVar = this.f5077a;
        bVar.d();
        z0.n((z0) bVar.f5063c, c2);
        if (z) {
            z0.b bVar2 = this.f5077a;
            int i = c2.keyId_;
            bVar2.d();
            ((z0) bVar2.f5063c).primaryKeyId_ = i;
        }
        return c2.keyId_;
    }

    public synchronized j b() {
        return j.a((z0) this.f5077a.b());
    }
    ...
    public final synchronized z0.c c(x0 x0Var) {
        ...
        aVar.d();
        z0.c.n((z0.c) aVar.f5063c, g2);
        aVar.d();
        ((z0.c) aVar.f5063c).keyId_ = d2;
        w0 w0Var = w0.ENABLED;
        aVar.d();
        z0.c.p((z0.c) aVar.f5063c, w0Var);
        aVar.d();
        z0.c.o((z0.c) aVar.f5063c, b2);
        return (z0.c) aVar.b();
    }
    ...
    public final synchronized int d() {
        ...
        do {
            int e2 = e();
            synchronized (this) {
                Iterator it = Collections.unmodifiableList(((z0) this.f5077a.f5063c).key_).iterator();
                while (true) {
                    if (it.hasNext()) {
