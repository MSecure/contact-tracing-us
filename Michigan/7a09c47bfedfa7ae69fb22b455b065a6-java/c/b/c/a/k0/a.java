...
public final class a extends s<a0, b0> {
    ...
    public class C0102a extends i.b<t, a0> {
        ...
        public t a(a0 a0Var) {
            a0 a0Var2 = a0Var;
            return new n(b.x.t.G1(b.x.t.T2(a0Var2.p().q().n()), a0Var2.keyValue_.q()), b.x.t.W2(a0Var2.p().q().p()), b.x.t.V2(a0Var2.p().q().o()));
        }
    }
    ...
    public class b extends i.a<y, a0> {
        ...
        public a0 a(y yVar) {
            ...
            KeyPair y1 = b.x.t.y1(b.x.t.T2(zVar.n()));
            ECPrivateKey eCPrivateKey = (ECPrivateKey) y1.getPrivate();
            ECPoint w = ((ECPublicKey) y1.getPublic()).getW();
            b0.b bVar = (b0.b) b0.DEFAULT_INSTANCE.e();
            if (a.this != null) {
                bVar.d();
                ((b0) bVar.f5063c).version_ = 0;
                bVar.d();
                b0.n((b0) bVar.f5063c, zVar);
                c.b.c.a.j0.a.i e2 = c.b.c.a.j0.a.i.e(w.getAffineX().toByteArray());
                bVar.d();
                b0.o((b0) bVar.f5063c, e2);
                c.b.c.a.j0.a.i e3 = c.b.c.a.j0.a.i.e(w.getAffineY().toByteArray());
                bVar.d();
                b0.p((b0) bVar.f5063c, e3);
                b0 b0Var = (b0) bVar.b();
                a0.b bVar2 = (a0.b) a0.DEFAULT_INSTANCE.e();
                if (a.this != null) {
                    bVar2.d();
                    ((a0) bVar2.f5063c).version_ = 0;
                    bVar2.d();
                    a0.n((a0) bVar2.f5063c, b0Var);
                    c.b.c.a.j0.a.i e4 = c.b.c.a.j0.a.i.e(eCPrivateKey.getS().toByteArray());
                    bVar2.d();
                    a0.o((a0) bVar2.f5063c, e4);
                    return (a0) bVar2.b();
                }
                throw null;
            }
    ...
    public a() {
        super(a0.class, b0.class, new C0102a(t.class));
    }
