...
public class h extends i<k1> {
    ...
    public class a extends i.b<u, k1> {
        ...
        public u a(k1 k1Var) {
            k1 k1Var2 = k1Var;
            return new k0((RSAPublicKey) a0.k.a("RSA").generatePublic(new RSAPublicKeySpec(new BigInteger(1, k1Var2.n_.q()), new BigInteger(1, k1Var2.e_.q()))), t.W2(k1Var2.q().n()));
        }
    }
    ...
    public void g(k1 k1Var) {
        ...
        n0.c(new BigInteger(1, k1Var2.n_.q()).bitLength());
        t.g3(k1Var2.q());
    }
}
