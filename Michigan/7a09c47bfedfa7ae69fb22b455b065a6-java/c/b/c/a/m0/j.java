...
public abstract class j implements e0 {
    ...
    public static final int[] f5147c = m(new byte[]{101, 120, 112, 97, 110, 100, 32, 51, 50, 45, 98, 121, 116, 101, 32, 107});
    ...
    public static void k(int[] iArr, int[] iArr2) {
        ...
        System.arraycopy(iArr2, 0, iArr, f5147c.length, 8);
    }
    ...
    public final void h(byte[] bArr, ByteBuffer byteBuffer, ByteBuffer byteBuffer2) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer c2 = c(bArr, this.f5149b + i2);
            if (i2 == i - 1) {
                t.A3(byteBuffer, byteBuffer2, c2, remaining % 64);
            } else {
                t.A3(byteBuffer, byteBuffer2, c2, 64);
            }
        }
    }
}
