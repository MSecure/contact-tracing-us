...
public final class ConnectionsStatusCodes extends c {
    ...
    public static String getStatusCodeString(int i) {
        ...
        switch (i) {
            case STATUS_NETWORK_NOT_CONNECTED /*{ENCODED_INT: 8000}*/:
                return "STATUS_NETWORK_NOT_CONNECTED";
            case STATUS_ALREADY_ADVERTISING /*{ENCODED_INT: 8001}*/:
                return "STATUS_ALREADY_ADVERTISING";
            case STATUS_ALREADY_DISCOVERING /*{ENCODED_INT: 8002}*/:
                return "STATUS_ALREADY_DISCOVERING";
            case STATUS_ALREADY_CONNECTED_TO_ENDPOINT /*{ENCODED_INT: 8003}*/:
                return "STATUS_ALREADY_CONNECTED_TO_ENDPOINT";
            case STATUS_CONNECTION_REJECTED /*{ENCODED_INT: 8004}*/:
                return "STATUS_CONNECTION_REJECTED";
            case STATUS_NOT_CONNECTED_TO_ENDPOINT /*{ENCODED_INT: 8005}*/:
                return "STATUS_NOT_CONNECTED_TO_ENDPOINT";
            default:
                switch (i) {
                    case 8007:
                        return "STATUS_RADIO_ERROR";
                    case STATUS_ALREADY_HAVE_ACTIVE_STRATEGY /*{ENCODED_INT: 8008}*/:
                        return "STATUS_ALREADY_HAVE_ACTIVE_STRATEGY";
                    case STATUS_OUT_OF_ORDER_API_CALL /*{ENCODED_INT: 8009}*/:
                        return "STATUS_OUT_OF_ORDER_API_CALL";
                    case 8010:
                        return "STATUS_UNSUPPORTED_PAYLOAD_TYPE_FOR_STRATEGY";
                    case STATUS_ENDPOINT_UNKNOWN /*{ENCODED_INT: 8011}*/:
                        return "STATUS_ENDPOINT_UNKNOWN";
                    case STATUS_ENDPOINT_IO_ERROR /*{ENCODED_INT: 8012}*/:
                        return "STATUS_ENDPOINT_IO_ERROR";
                    case STATUS_PAYLOAD_IO_ERROR /*{ENCODED_INT: 8013}*/:
                        return "STATUS_PAYLOAD_IO_ERROR";
                    case 8014:
                        return "STATUS_PAYLOAD_UNKNOWN";
                    default:
                        switch (i) {
                            case MISSING_PERMISSION_BLUETOOTH /*{ENCODED_INT: 8030}*/:
                                return "MISSING_PERMISSION_BLUETOOTH";
                            case MISSING_PERMISSION_BLUETOOTH_ADMIN /*{ENCODED_INT: 8031}*/:
                                return "MISSING_PERMISSION_BLUETOOTH_ADMIN";
                            case MISSING_PERMISSION_ACCESS_WIFI_STATE /*{ENCODED_INT: 8032}*/:
                                return "MISSING_PERMISSION_ACCESS_WIFI_STATE";
                            case MISSING_PERMISSION_CHANGE_WIFI_STATE /*{ENCODED_INT: 8033}*/:
                                return "MISSING_PERMISSION_CHANGE_WIFI_STATE";
                            case MISSING_PERMISSION_ACCESS_COARSE_LOCATION /*{ENCODED_INT: 8034}*/:
                                return "MISSING_PERMISSION_ACCESS_COARSE_LOCATION";
                            case MISSING_PERMISSION_RECORD_AUDIO /*{ENCODED_INT: 8035}*/:
                                return "MISSING_PERMISSION_RECORD_AUDIO";
                            case MISSING_PERMISSION_ACCESS_FINE_LOCATION /*{ENCODED_INT: 8036}*/:
