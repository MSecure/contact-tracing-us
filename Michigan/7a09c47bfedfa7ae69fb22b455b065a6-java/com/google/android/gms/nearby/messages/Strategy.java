...
public class Strategy extends a {
    ...
    public static class Builder {
        ...
        public Builder setTtlSeconds(int i) {
            t.u(i == Integer.MAX_VALUE || (i > 0 && i <= 86400), "mTtlSeconds(%d) must either be TTL_SECONDS_INFINITE, or it must be between 1 and TTL_SECONDS_MAX(%d) inclusive", Integer.valueOf(i), Integer.valueOf((int) Strategy.TTL_SECONDS_MAX));
            this.zzb = i;
            return this;
        }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        int m = t.m(parcel);
        t.q3(parcel, 1, this.zzc);
        t.q3(parcel, 2, this.zzd);
        t.q3(parcel, 3, this.zze);
        t.j3(parcel, 4, this.zzf);
        t.q3(parcel, 5, this.zzg);
        t.q3(parcel, 6, this.zzh);
        t.q3(parcel, 7, this.zzi);
