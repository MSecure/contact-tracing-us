...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            BottomSheetBehavior.this.N(this.f6037b, this.f6038c);
        }
    }
    ...
    public class b extends e.c {
        ...
        public int b(View view, int i, int i2) {
            ...
            return i.j.j(i, I, bottomSheetBehavior.u ? bottomSheetBehavior.D : bottomSheetBehavior.s);
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x0080, code lost:
            if (java.lang.Math.abs(r8.getTop() - r7.f6040a.o) < java.lang.Math.abs(r8.getTop() - r7.f6040a.q)) goto L_0x0082;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:37:0x00b8, code lost:
            if (java.lang.Math.abs(r9 - r7.f6040a.q) < java.lang.Math.abs(r9 - r7.f6040a.s)) goto L_0x00ba;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:51:0x0102, code lost:
            if (java.lang.Math.abs(r9 - r0) < java.lang.Math.abs(r9 - r7.f6040a.s)) goto L_0x00ba;
         */
        @Override // b.k.b.e.c
        public void h(View view, float f2, float f3) {
            ...
            if (f3 < 0.0f) {
                ...
                if (!bottomSheetBehavior4.u || !bottomSheetBehavior4.P(view, f3)) {
                    if (f3 == 0.0f || Math.abs(f2) > Math.abs(f3)) {
                        int top2 = view.getTop();
                        BottomSheetBehavior bottomSheetBehavior5 = BottomSheetBehavior.this;
                        if (!bottomSheetBehavior5.f6031b) {
                        ...
                        bottomSheetBehavior2 = BottomSheetBehavior.this;
                        if (!bottomSheetBehavior2.f6031b) {
    ...
    public class c implements b.i.l.w.d {
        ...
        public boolean a(View view, d.a aVar) {
            BottomSheetBehavior.this.L(this.f6041a);
            return true;
        }
    }
    ...
    public static class e extends b.k.a.a {
        ...
        public e(Parcel parcel, ClassLoader classLoader) {
            ...
            boolean z = false;
            this.f6045f = parcel.readInt() == 1;
            this.f6046g = parcel.readInt() == 1;
            this.h = parcel.readInt() == 1 ? true : z;
        }

        public e(Parcelable parcelable, BottomSheetBehavior<?> bottomSheetBehavior) {
            super(parcelable);
            this.f6043d = bottomSheetBehavior.x;
            this.f6044e = bottomSheetBehavior.f6034e;
            this.f6045f = bottomSheetBehavior.f6031b;
            this.f6046g = bottomSheetBehavior.u;
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeInt(this.f6045f ? 1 : 0);
    ...
    public class f implements Runnable {
        ...
        public void run() {
            ...
            if (eVar == null || !eVar.i(true)) {
                BottomSheetBehavior.this.M(this.f6049d);
            } else {
                m.N(this.f6047b, this);
            }
            this.f6048c = false;
        }
    }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        if (hasValue) {
            E(context, attributeSet, hasValue, t.B1(context, obtainStyledAttributes, l.BottomSheetBehavior_Layout_backgroundTint));
        } else {
        ...
        if (this.f6031b != z2) {
            ...
            M((!this.f6031b || this.x != 6) ? this.x : 3);
            R();
        }
        ...
        this.f6030a = obtainStyledAttributes.getInt(l.BottomSheetBehavior_Layout_behavior_saveFlags, 0);
        ...
        this.f6033d = (float) ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
    }

    public static <V extends View> BottomSheetBehavior<V> H(V v2) {
        ViewGroup.LayoutParams layoutParams = v2.getLayoutParams();
        if (layoutParams instanceof CoordinatorLayout.f) {
            CoordinatorLayout.c cVar = ((CoordinatorLayout.f) layoutParams).f186a;
    ...
    public final int D() {
        return this.f6035f ? Math.max(this.f6036g, this.D - ((this.C * 9) / 16)) : this.f6034e;
    }
    ...
    public int I() {
        return this.f6031b ? this.p : this.o;
    }
    ...
    public void K(int i2) {
        ...
        } else if (this.f6035f || this.f6034e != i2) {
            this.f6035f = false;
            this.f6034e = Math.max(0, i2);
            if (!z2) {
                return;
            }
            return;
    ...
    public void N(View view, int i2) {
        ...
        if (i2 == 4) {
            ...
            throw new IllegalArgumentException(c.a.a.a.a.n("Illegal state argument: ", i2));
        } else {
            i3 = this.D;
        }
        Q(view, i2, i3, false);
    ...
    public final void O(int i2) {
        ...
        if (v2 != null) {
            ...
            if (parent == null || !parent.isLayoutRequested() || !m.B(v2)) {
                N(v2, i2);
            } else {
                v2.post(new a(v2, i2));
            }
    ...
    public void Q(View view, int i2, int i3, boolean z2) {
        ...
        if (z2) {
            ...
            if (!z3 && eVar.f1962a == 0 && eVar.r != null) {
                eVar.r = null;
            }
        }
        if (z3) {
            ...
            if (parent instanceof CoordinatorLayout) {
                ...
                for (int i2 = 0; i2 < childCount; i2++) {
                    ...
                    if (childAt != this.E.get()) {
                        ...
                        } else if (this.f6032c && (map = this.L) != null && map.containsKey(childAt)) {
    ...
    public boolean j(CoordinatorLayout coordinatorLayout, V v2, MotionEvent motionEvent) {
        ...
        return actionMasked == 2 && view != null && !this.z && this.x != 1 && !coordinatorLayout.l(view, (int) motionEvent.getX(), (int) motionEvent.getY()) && this.y != null && Math.abs(((float) this.J) - motionEvent.getY()) > ((float) this.y.f1963b);
    }
    ...
    public boolean k(CoordinatorLayout coordinatorLayout, V v2, int i2) {
        int i3;
        g gVar;
        if (m.m(coordinatorLayout) && !v2.getFitsSystemWindows()) {
            v2.setFitsSystemWindows(true);
        }
        if (this.E == null) {
            this.f6036g = coordinatorLayout.getResources().getDimensionPixelSize(c.b.a.b.d.design_bottom_sheet_peek_height_min);
            if (Build.VERSION.SDK_INT >= 29 && !this.j && !this.f6035f) {
                m.c0(v2, new c.b.a.b.c0.l(new c.b.a.b.r.b(this), new o(v2.getPaddingStart(), v2.getPaddingTop(), v2.getPaddingEnd(), v2.getPaddingBottom())));
                if (v2.isAttachedToWindow()) {
                    v2.requestApplyInsets();
                } else {
                    v2.addOnAttachStateChangeListener(new c.b.a.b.c0.m());
                }
            }
    ...
    public void u(CoordinatorLayout coordinatorLayout, V v2, Parcelable parcelable) {
        ...
        if (i2 != 0) {
            if (i2 == -1 || (i2 & 1) == 1) {
                this.f6034e = eVar.f6044e;
            }
            int i3 = this.f6030a;
            if (i3 == -1 || (i3 & 2) == 2) {
                this.f6031b = eVar.f6045f;
            }
            int i4 = this.f6030a;
            if (i4 == -1 || (i4 & 4) == 4) {
                this.u = eVar.f6046g;
            ...
            if (this.A <= 0) {
                if (this.u) {
                    ...
                    if (velocityTracker == null) {
                        ...
                        velocityTracker.computeCurrentVelocity(1000, this.f6033d);
