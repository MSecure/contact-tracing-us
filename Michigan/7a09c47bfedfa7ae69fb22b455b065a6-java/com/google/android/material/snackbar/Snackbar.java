...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar i(View view, CharSequence charSequence, int i) {
        ...
        if (viewGroup != null) {
            ...
            ((SnackbarContentLayout) snackbar.f6103c.getChildAt(0)).getMessageView().setText(charSequence);
            snackbar.f6105e = i;
            return snackbar;
        }
    ...
    public void j() {
        ...
        synchronized (b2.f4340a) {
            if (b2.c(bVar)) {
                b2.f4342c.f4346b = i2;
                b2.f4341b.removeCallbacksAndMessages(b2.f4342c);
                b2.g(b2.f4342c);
            } else {
                if (b2.d(bVar)) {
                    b2.f4343d.f4346b = i2;
                } else {
                    b2.f4343d = new o.c(i2, bVar);
                }
                if (b2.f4342c == null || !b2.a(b2.f4342c, 4)) {
                    b2.f4342c = null;
                    b2.h();
                }
            }
