...
public final class c extends i {
    ...
    public final ConcurrentNavigableMap<String, a> f6688d = new ConcurrentSkipListMap();
    ...
    public static class a {
        ...
        /* renamed from: c  reason: collision with root package name */
        public final short[] f6691c;

        /* renamed from: d  reason: collision with root package name */
        public final AtomicReferenceArray<Object> f6692d;

        public a(String str, String[] strArr, short[] sArr, AtomicReferenceArray<Object> atomicReferenceArray) {
            this.f6692d = atomicReferenceArray;
            this.f6689a = str;
            this.f6690b = strArr;
            this.f6691c = sArr;
        }
    ...
    public final boolean c(InputStream inputStream) {
        ...
        if (dataInputStream.readByte() != 1) {
            ...
            this.f6687c = Arrays.asList(strArr2);
            ...
            while (it.hasNext()) {
                a aVar = (a) it.next();
                a putIfAbsent = this.f6688d.putIfAbsent(aVar.f6689a, aVar);
                if (putIfAbsent == null || putIfAbsent.f6689a.equals(aVar.f6689a)) {
                    z = true;
                } else {
                    StringBuilder h = c.a.a.a.a.h("Data already loaded for TZDB time-zone rules version: ");
                    h.append(aVar.f6689a);
