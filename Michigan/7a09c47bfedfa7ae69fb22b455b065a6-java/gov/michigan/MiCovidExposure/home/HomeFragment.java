...
public class HomeFragment extends Fragment {
    ...
    public static void transitionToHomeFragment(Fragment fragment) {
        fragment.getParentFragmentManager().Z(null, 1);
        z parentFragmentManager = fragment.getParentFragmentManager();
        if (parentFragmentManager != null) {
            a aVar = new a(parentFragmentManager);
            aVar.h(R.id.home_fragment, newInstance(), ExposureNotificationActivity.HOME_FRAGMENT_TAG);
            aVar.f2040f = 4097;
            aVar.d();
            return;
        }
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        tabLayout.g(0).a(R.drawable.ic_exclamation_circle);
        tabLayout.g(0).c(R.string.home_tab_exposures_text);
        tabLayout.g(1).a(R.drawable.ic_flag);
        tabLayout.g(1).c(R.string.home_tab_notify_text);
        tabLayout.g(3).a(R.drawable.ic_baseline_share_24);
        tabLayout.g(3).c(R.string.share);
        tabLayout.g(4).a(R.drawable.stats);
        tabLayout.g(4).c(R.string.stats);
        tabLayout.g(2).a(R.drawable.ic_virtual);
        tabLayout.g(2).c(R.string.home_tab_virtual_agent);
    }
}
