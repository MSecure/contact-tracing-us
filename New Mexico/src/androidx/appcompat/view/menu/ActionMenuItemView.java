...
public class ActionMenuItemView extends d0 implements n.a, View.OnClickListener, ActionMenuView.a {
    ...
    public final void f() {
        ...
        if (TextUtils.isEmpty(charSequence3)) {
            if (!z3) {
                charSequence = this.f40h.f863e;
            }
            m.e.H1(this, charSequence);
            return;
        }
        m.e.H1(this, charSequence3);
    }
    ...
    @Override // e.b.f.d0, android.widget.TextView, android.view.View
