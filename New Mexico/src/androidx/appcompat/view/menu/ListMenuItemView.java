...
public class ListMenuItemView extends LinearLayout implements n.a, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet) {
        ...
        c1 q = c1.q(getContext(), attributeSet, R$styleable.MenuView, i2, 0);
        this.f53k = q.g(R$styleable.MenuView_android_itemBackground);
        this.f54l = q.l(R$styleable.MenuView_android_itemTextAppearance, -1);
        this.n = q.a(R$styleable.MenuView_preserveIconSpacing, false);
        this.m = context;
        this.o = q.g(R$styleable.MenuView_subMenuArrow);
    ...
    public void c(boolean z) {
        ...
        if (i3 == 0) {
            ...
            if (e2 == 0) {
                ...
                int i4 = iVar.n.n() ? iVar.f869k : iVar.f867i;
