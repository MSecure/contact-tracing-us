...
public class ActionBarOverlayLayout extends ViewGroup implements g0, k, l {
    ...
    public final AnimatorListenerAdapter C = new a();
    ...
    public WindowInsets onApplyWindowInsets(WindowInsets windowInsets) {
        ...
        boolean p = p(this.f67e, new Rect(i2.b(), i2.d(), i2.c(), i2.a()), true, true, false, true);
        Rect rect = this.o;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        this.x = b0Var2;
        if (this.f71i || z) {
            e.j.c.b a2 = e.j.c.b.a(b0Var2.b(), this.x.d() + i4, this.x.c(), this.x.a() + 0);
            b0 b0Var3 = this.x;
    ...
    public final boolean p(View view, Rect rect, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (!z || ((ViewGroup.MarginLayoutParams) eVar).leftMargin == (i5 = rect.left)) {
            z5 = false;
        } else {
            ((ViewGroup.MarginLayoutParams) eVar).leftMargin = i5;
            z5 = true;
        }
        if (z2 && ((ViewGroup.MarginLayoutParams) eVar).topMargin != (i4 = rect.top)) {
            ((ViewGroup.MarginLayoutParams) eVar).topMargin = i4;
            z5 = true;
        }
        if (z4 && ((ViewGroup.MarginLayoutParams) eVar).rightMargin != (i3 = rect.right)) {
            ((ViewGroup.MarginLayoutParams) eVar).rightMargin = i3;
            z5 = true;
        }
        if (!z3 || ((ViewGroup.MarginLayoutParams) eVar).bottomMargin == (i2 = rect.bottom)) {
            return z5;
        }
    ...
    public void setOverlayMode(boolean z) {
        this.f71i = z;
        this.f70h = z && getContext().getApplicationInfo().targetSdkVersion < 19;
    }
