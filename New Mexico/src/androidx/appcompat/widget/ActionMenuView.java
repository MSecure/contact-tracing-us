...
public class ActionMenuView extends m0 implements g.b, n {
    public int A;
    public e B;
    public g q;
    public Context r;
    ...
    public class d implements g.a {
        ...
        public boolean a(g gVar, MenuItem menuItem) {
            ...
            if (fVar != null ? t.this.b.onMenuItemSelected(0, menuItem) : false) {
                return true;
            }
            return false;
        }
    ...
    @Override // e.b.f.m0, android.view.ViewGroup
    ...
    public void onMeasure(int i2, int i3) {
        ...
        while (i18 < childCount2) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                cVar2.f76e = z6 && ((ActionMenuItemView) childAt).c();
        ...
        z = z8;
        boolean z9 = !z5 && i14 == 1;
        if (i11 > 0 && j2 != 0 && (i11 < i14 - 1 || z9 || i16 > 1)) {
