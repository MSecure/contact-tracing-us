...
public class SearchView extends m0 implements e.b.e.b {
    ...
    public static class SearchAutoComplete extends e.b.f.d {
        ...
        /* renamed from: g */
        public SearchView f86g;

        /* renamed from: h */
        public boolean f87h;

        /* renamed from: i */
        public final Runnable f88i = new a();

        /* renamed from: f */
        public int f85f = getThreshold();
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                if (searchAutoComplete.f87h) {
                    ((InputMethodManager) searchAutoComplete.getContext().getSystemService("input_method")).showSoftInput(searchAutoComplete, 0);
                    searchAutoComplete.f87h = false;
                }
            }
        }
        ...
        public boolean enoughToFilter() {
            return this.f85f <= 0 || super.enoughToFilter();
        }

        @Override // e.b.f.d, android.widget.TextView, android.view.View
        public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
            InputConnection onCreateInputConnection = super.onCreateInputConnection(editorInfo);
            if (this.f87h) {
                removeCallbacks(this.f88i);
                post(this.f88i);
            }
        ...
        public void onFocusChanged(boolean z, int i2, Rect rect) {
            ...
            SearchView searchView = this.f86g;
        ...
        public void onWindowFocusChanged(boolean z) {
            ...
            if (z && this.f86g.hasFocus() && getVisibility() == 0) {
                boolean z2 = true;
                this.f87h = true;
    ...
    public class c implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            e.k.a.a aVar = SearchView.this.S;
    ...
    /* loaded from: classes.dex */
    public static class o extends e.l.a.a {
    ...
    public static class p extends TouchDelegate {
        ...
        /* renamed from: d */
        public final Rect f90d = new Rect();
        public final Rect c = new Rect();

        public p(Rect rect, Rect rect2, View view) {
            super(rect, view);
            this.f91e = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
            a(rect, rect2);
            this.a = view;
        }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i2) {
        ...
        LayoutInflater.from(context).inflate(c1Var.l(R$styleable.SearchView_layout, R$layout.abc_search_view), (ViewGroup) this, true);
        ...
        this.E = imageView5;
        v.d.q(findViewById, c1Var.g(R$styleable.SearchView_queryBackground));
        v.d.q(findViewById2, c1Var.g(R$styleable.SearchView_submitBackground));
        int i3 = R$styleable.SearchView_searchIcon;
        imageView.setImageDrawable(c1Var.g(i3));
        imageView2.setImageDrawable(c1Var.g(R$styleable.SearchView_goIcon));
        imageView3.setImageDrawable(c1Var.g(R$styleable.SearchView_closeIcon));
        imageView4.setImageDrawable(c1Var.g(R$styleable.SearchView_voiceIcon));
        imageView5.setImageDrawable(c1Var.g(i3));
        this.F = c1Var.g(R$styleable.SearchView_searchHintIcon);
        m.e.H1(imageView, getResources().getString(R$string.abc_searchview_description_search));
        this.G = c1Var.l(R$styleable.SearchView_suggestionRowLayout, R$layout.abc_search_dropdown_item_icons_2line);
        this.H = c1Var.l(R$styleable.SearchView_commitIcon, 0);
        ...
        setIconifiedByDefault(c1Var.a(R$styleable.SearchView_iconifiedByDefault, true));
        int f2 = c1Var.f(R$styleable.SearchView_android_maxWidth, -1);
        if (f2 != -1) {
            setMaxWidth(f2);
        }
        this.K = c1Var.n(R$styleable.SearchView_defaultQueryHint);
        this.U = c1Var.n(R$styleable.SearchView_queryHint);
        int j2 = c1Var.j(R$styleable.SearchView_android_imeOptions, -1);
        if (j2 != -1) {
            setImeOptions(j2);
        }
        int j3 = c1Var.j(R$styleable.SearchView_android_inputType, -1);
        if (j3 != -1) {
            setInputType(j3);
        }
        setFocusable(c1Var.a(R$styleable.SearchView_android_focusable, true));
        c1Var.b.recycle();
    ...
    public void setSearchableInfo(SearchableInfo searchableInfo) {
        ...
        if (searchableInfo != null) {
            ...
            if (this.g0.getSuggestAuthority() != null) {
                v0 v0Var = new v0(getContext(), this, this.g0, this.k0);
                this.S = v0Var;
                this.q.setAdapter(v0Var);
                ((v0) this.S).r = this.V ? 2 : 1;
            }
            D();
        }
        ...
        if (cursor != null && cursor.moveToPosition(i2)) {
            ...
            try {
                try {
                    ...
                    intent = q(h3, h4 == null ? null : Uri.parse(h4), v0.h(cursor, cursor.getColumnIndex("suggest_intent_extra_data")), v0.h(cursor, cursor.getColumnIndex("suggest_intent_query")), 0, null);
