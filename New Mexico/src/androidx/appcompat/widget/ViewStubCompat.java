...
public final class ViewStubCompat extends View {
    ...
    public WeakReference<View> f105d;

    /* renamed from: e  reason: collision with root package name */
    public LayoutInflater f106e;
    ...
    public View a() {
        ...
        if (!(parent instanceof ViewGroup)) {
            ...
            LayoutInflater layoutInflater = this.f106e;
            ...
            this.f105d = new WeakReference<>(inflate);
            a aVar = this.f107f;
            if (aVar != null) {
                aVar.a(this, inflate);
            }
    ...
    public void setVisibility(int i2) {
        WeakReference<View> weakReference = this.f105d;
