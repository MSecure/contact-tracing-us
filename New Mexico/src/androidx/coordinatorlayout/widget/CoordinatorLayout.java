...
public class CoordinatorLayout extends ViewGroup implements k, l {
    ...
    public static final e.j.i.c<Rect> z;
    ...
    public final e.i.a.a<View> c = new e.i.a.a<>();

    /* renamed from: d */
    public final List<View> f134d = new ArrayList();

    /* renamed from: e */
    public final List<View> f135e = new ArrayList();
    ...
    public class a implements n {
        ...
        public b0 a(View view, b0 b0Var) {
            ...
            if (!Objects.equals(coordinatorLayout.p, b0Var)) {
                ...
                if (!b0Var.f()) {
                    ...
                    for (int i2 = 0; i2 < childCount; i2++) {
                        ...
                        if (v.d.b(childAt) && (cVar = ((f) childAt.getLayoutParams()).a) != null) {
                            b0Var = cVar.e(b0Var);
                            if (b0Var.f()) {
                                break;
                            }
    ...
    public static class f extends ViewGroup.MarginLayoutParams {
        ...
        public f(Context context, AttributeSet attributeSet) {
            ...
            this.f145f = obtainStyledAttributes.getResourceId(R$styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.f143d = obtainStyledAttributes.getInteger(R$styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.f144e = obtainStyledAttributes.getInteger(R$styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.f146g = obtainStyledAttributes.getInt(R$styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.f147h = obtainStyledAttributes.getInt(R$styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            ...
            if (hasValue) {
                ...
                if (TextUtils.isEmpty(string)) {
                    ...
                    try {
                        ...
                        throw new RuntimeException(f.a.a.a.a.x("Could not inflate Behavior subclass ", string), e2);
                    }
                }
                this.a = cVar;
            }
    ...
    public static class h extends e.l.a.a {
        ...
        /* renamed from: d */
        public SparseArray<Parcelable> f152d;
        ...
        public h(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f152d = new SparseArray<>(readInt);
            for (int i2 = 0; i2 < readInt; i2++) {
                this.f152d.append(iArr[i2], readParcelableArray[i2]);
            }
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            SparseArray<Parcelable> sparseArray = this.f152d;
            int size = sparseArray != null ? sparseArray.size() : 0;
            parcel.writeInt(size);
            int[] iArr = new int[size];
            Parcelable[] parcelableArr = new Parcelable[size];
            for (int i3 = 0; i3 < size; i3++) {
                iArr[i3] = this.f152d.keyAt(i3);
                parcelableArr[i3] = this.f152d.valueAt(i3);
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet) {
        ...
        if (resourceId != 0) {
            ...
            this.f141k = resources.getIntArray(resourceId);
            float f2 = resources.getDisplayMetrics().density;
            int length = this.f141k.length;
            for (int i3 = 0; i3 < length; i3++) {
                int[] iArr2 = this.f141k;
    ...
    public List<View> d(View view) {
        e.i.a.a<View> aVar = this.c;
        int i2 = aVar.b.f1316d;
        ArrayList arrayList = null;
        for (int i3 = 0; i3 < i2; i3++) {
            ArrayList<View> k2 = aVar.b.k(i3);
    ...
    public boolean drawChild(Canvas canvas, View view, long j2) {
        ...
        if (cVar != null) {
            ...
            if (c2 > 0.0f) {
                if (this.f136f == null) {
                    this.f136f = new Paint();
                }
                this.f136f.setColor(fVar.a.b());
                Paint paint = this.f136f;
                ...
                canvas.drawRect((float) getPaddingLeft(), (float) getPaddingTop(), (float) (getWidth() - getPaddingRight()), (float) (getHeight() - getPaddingBottom()), this.f136f);
    ...
    public List<View> e(View view) {
        ArrayList<View> orDefault = this.c.b.getOrDefault(view, null);
        this.f135e.clear();
        if (orDefault != null) {
            this.f135e.addAll(orDefault);
        }
        return this.f135e;
    }

    public void f(View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = e.i.a.b.a;
        rect.set(0, 0, view.getWidth(), view.getHeight());
        ThreadLocal<Matrix> threadLocal2 = e.i.a.b.a;
        ...
        e.i.a.b.a(this, view, matrix);
        ThreadLocal<RectF> threadLocal3 = e.i.a.b.b;
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (fVar.a(i6) && (cVar = fVar.a) != null) {
                    ...
                    i8 = i5 > 0 ? Math.max(i8, this.f137g[1]) : Math.min(i8, this.f137g[1]);
                    z2 = true;
                }
            }
        }
    ...
    public void n(View view, int i2, int i3, int i4, int i5, int i6) {
        m(view, i2, i3, i4, i5, 0, this.f138h);
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        while (true) {
            ...
            e.i.a.a<View> aVar = this.c;
            int i15 = aVar.b.f1316d;
            int i16 = 0;
            while (true) {
                if (i16 < i15) {
                    ArrayList<View> k2 = aVar.b.k(i16);
        ...
        boolean z5 = this.p != null && v.d.b(this);
        ...
        while (i22 < size3) {
            ...
            if (view.getVisibility() == 8) {
                ...
                if (i23 < 0 || mode == 0) {
                    ...
                    int absoluteGravity = Gravity.getAbsoluteGravity(i24, d2) & 7;
                    i7 = i21;
                    ...
                    i19 = Math.max(i13, view.getMeasuredWidth() + i17 + ((ViewGroup.MarginLayoutParams) fVar).leftMargin + ((ViewGroup.MarginLayoutParams) fVar).rightMargin);
                    i20 = Math.max(i11, view.getMeasuredHeight() + i18 + ((ViewGroup.MarginLayoutParams) fVar).topMargin + ((ViewGroup.MarginLayoutParams) fVar).bottomMargin);
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        SparseArray<Parcelable> sparseArray = hVar.f152d;
        int childCount = getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        c cVar = ((f) this.f142l.getLayoutParams()).a;
        if (cVar != null) {
            z2 = cVar.A(this, this.f142l, motionEvent);
            motionEvent2 = null;
            if (this.f142l != null) {
    ...
    public final void q(int i2) {
        ...
        while (i14 < size) {
            ...
            if (i2 == 0 && view.getVisibility() == 8) {
                    ...
                    if (fVar2.f151l == this.b.get(i15)) {
                        ...
                        if (fVar3.f150k != null) {
                            ...
                            if (z5 && (cVar = fVar3.a) != null) {
                                cVar.g(this, view, fVar3.f150k);
                            }
                            a5.setEmpty();
                            e.j.i.c<Rect> cVar2 = z;
                            cVar2.b(a5);
                            a6.setEmpty();
                            cVar2.b(a6);
                            a7.setEmpty();
                ...
                i3 = i14;
                c(view, true, a3);
                if (fVar2.f146g != 0 && !a3.isEmpty()) {
                    int absoluteGravity = Gravity.getAbsoluteGravity(fVar2.f146g, d2);
                ...
                if (fVar2.f147h != 0 && view.getVisibility() == 0) {
                    ...
                    if (v.g.c(view) && view.getWidth() > 0 && view.getHeight() > 0) {
                        ...
                        a9.setEmpty();
                        e.j.i.c<Rect> cVar4 = z;
                        cVar4.b(a9);
                        if (!a8.isEmpty()) {
                            int absoluteGravity2 = Gravity.getAbsoluteGravity(fVar4.f147h, d2);
                            if ((absoluteGravity2 & 48) != 48 || (i9 = (a8.top - ((ViewGroup.MarginLayoutParams) fVar4).topMargin) - fVar4.f149j) >= (i10 = a2.top)) {
                                z3 = false;
                            } else {
                                x(view, i10 - i9);
                                z3 = true;
                            }
                            if ((absoluteGravity2 & 80) == 80 && (height = ((getHeight() - a8.bottom) - ((ViewGroup.MarginLayoutParams) fVar4).bottomMargin) + fVar4.f149j) < (i8 = a2.bottom)) {
                                x(view, height - i8);
                                z3 = true;
                            }
                            if (!z3) {
                            ...
                            if ((absoluteGravity2 & 3) != 3 || (i6 = (a8.left - ((ViewGroup.MarginLayoutParams) fVar4).leftMargin) - fVar4.f148i) >= (i7 = a2.left)) {
                                z4 = false;
                            } else {
                                w(view, i7 - i6);
                                z4 = true;
                            }
                            if ((absoluteGravity2 & 5) == 5 && (width = ((getWidth() - a8.right) - ((ViewGroup.MarginLayoutParams) fVar4).rightMargin) + fVar4.f148i) < (i5 = a2.right)) {
                                w(view, width - i5);
                                z4 = true;
                            }
                            if (!z4) {
    ...
    public void r(View view, int i2) {
        ...
        e.j.i.c<Rect> cVar;
        f fVar = (f) view.getLayoutParams();
        View view2 = fVar.f150k;
        int i3 = 0;
        if (view2 == null && fVar.f145f != -1) {
            ...
            if (this.p != null) {
                AtomicInteger atomicInteger = v.a;
                if (v.d.b(this) && !v.d.b(view)) {
                    a2.left = this.p.b() + a2.left;
                    a2.top = this.p.d() + a2.top;
                    a2.right -= this.p.c();
                    a2.bottom -= this.p.a();
                }
            }
     ...
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:125:0x0162 A[SYNTHETIC] */
    ...
    public final void u() {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (l2.f145f == -1) {
                ...
                View findViewById = findViewById(l2.f145f);
                l2.f150k = findViewById;
            ...
            for (int i5 = 0; i5 < childCount; i5++) {
                if (i5 != i4) {
                    ...
                    if (childAt2 != l2.f151l) {
                        AtomicInteger atomicInteger = v.a;
                        int d2 = v.e.d(this);
                        int absoluteGravity = Gravity.getAbsoluteGravity(((f) childAt2.getLayoutParams()).f146g, d2);
                        if (!(absoluteGravity != 0 && (Gravity.getAbsoluteGravity(l2.f147h, d2) & absoluteGravity) == absoluteGravity) && ((cVar = l2.a) == null || !cVar.d(this, childAt, childAt2))) {
                            z2 = false;
                            if (!z2) {
                                continue;
                            } else {
                                ...
                                e.i.a.a<View> aVar2 = this.c;
                                if (aVar2.b.e(childAt2) >= 0) {
                                    if (aVar2.b.e(childAt) >= 0) {
                                        ArrayList<View> orDefault = aVar2.b.getOrDefault(childAt2, null);
                                        if (orDefault == null) {
                                            orDefault = aVar2.a.a();
                                            if (orDefault == null) {
        ...
        e.i.a.a<View> aVar3 = this.c;
        aVar3.c.clear();
        aVar3.f1529d.clear();
        int i6 = aVar3.b.f1316d;
        for (int i7 = 0; i7 < i6; i7++) {
            aVar3.b(aVar3.b.h(i7), aVar3.c, aVar3.f1529d);
        }
        list.addAll(aVar3.c);
