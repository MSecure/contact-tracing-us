...
public final class SavedStateHandleController implements j {
    ...
    /* loaded from: classes.dex */
    public static final class a implements a.AbstractC0063a {
        @Override // e.w.a.AbstractC0063a
    ...
    public static void h(e0 e0Var, e.w.a aVar, h hVar) {
        Object obj;
    ...
    public static SavedStateHandleController j(e.w.a aVar, h hVar, String str, Bundle bundle) {
        y yVar;
        Bundle a2 = aVar.a(str);
        Class[] clsArr = y.f1907e;
    ...
    public static void k(final e.w.a aVar, final h hVar) {
        h.b bVar = ((m) hVar).b;
