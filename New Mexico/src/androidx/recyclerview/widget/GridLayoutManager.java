...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public GridLayoutManager(Context context, AttributeSet attributeSet, int i2, int i3) {
        ...
        Q1(RecyclerView.m.T(context, attributeSet, i2, i3).b);
    }
    ...
    public final void O1(View view, int i2, boolean z) {
        ...
        int K1 = K1(bVar.f195e, bVar.f196f);
        if (this.r == 1) {
            i3 = RecyclerView.m.A(K1, i2, i6, ((ViewGroup.MarginLayoutParams) bVar).width, false);
            i4 = RecyclerView.m.A(this.t.l(), this.o, i5, ((ViewGroup.MarginLayoutParams) bVar).height, true);
        } else {
            int A = RecyclerView.m.A(K1, i2, i5, ((ViewGroup.MarginLayoutParams) bVar).height, false);
            i3 = RecyclerView.m.A(this.t.l(), this.n, i6, ((ViewGroup.MarginLayoutParams) bVar).width, true);
            i4 = A;
        }
        P1(view, i3, i4, z);
    }
    ...
    public void Q1(int i2) {
        if (i2 != this.H) {
            ...
            throw new IllegalArgumentException(f.a.a.a.a.u("Span count should be at least 1. Provided ", i2));
        }
    }
    ...
    public void b1(RecyclerView.y yVar, LinearLayoutManager.c cVar, RecyclerView.m.c cVar2) {
        ...
        for (int i3 = 0; i3 < this.H && cVar.b(yVar) && i2 > 0; i3++) {
            ((j.b) cVar2).a(cVar.f200d, Math.max(0, cVar.f203g));
            Objects.requireNonNull(this.M);
            i2--;
            cVar.f200d += cVar.f201e;
        }
    }
    ...
    public View j0(View view, int i2, RecyclerView.t tVar, RecyclerView.y yVar) {
        ...
        View view3 = null;
        while (i8 != i4) {
            int L12 = L1(tVar2, yVar2, i8);
            View y = y(i8);
            if (y == t) {
                break;
            }
            if (!y.hasFocusable() || L12 == L1) {
                b bVar2 = (b) y.getLayoutParams();
                int i13 = bVar2.f195e;
                t = t;
                int i14 = bVar2.f196f + i13;
                if (y.hasFocusable() && i13 == i6 && i14 == i7) {
                    return y;
                }
                if ((!y.hasFocusable() || view2 != null) && (y.hasFocusable() || view3 != null)) {
                    view3 = view3;
    ...
    public void v0(RecyclerView.t tVar, RecyclerView.y yVar) {
        if (yVar.f266g) {
            ...
            for (int i2 = 0; i2 < z; i2++) {
                ...
                int a2 = bVar.a();
                this.K.put(a2, bVar.f196f);
                this.L.put(a2, bVar.f195e);
            }
        }
        super.v0(tVar, yVar);
        this.K.clear();
    ...
    public void w1(RecyclerView.t tVar, RecyclerView.y yVar, LinearLayoutManager.c cVar, LinearLayoutManager.b bVar) {
        ...
        boolean z2 = cVar.f201e == 1;
        int i20 = this.H;
        if (!z2) {
            i20 = M1(tVar, yVar, cVar.f200d) + N1(tVar, yVar, cVar.f200d);
        }
        int i21 = 0;
        ...
        for (int i24 = 0; i24 < i21; i24++) {
            ...
            float d2 = (((float) this.t.d(view2)) * 1.0f) / ((float) ((b) view2.getLayoutParams()).f196f);
            if (d2 > f2) {
                f2 = d2;
            }
        }
        ...
        for (int i26 = 0; i26 < i21; i26++) {
            ...
            if (this.t.c(view4) != i23) {
                ...
                int K1 = K1(bVar3.f195e, bVar3.f196f);
                if (this.r == 1) {
                    i18 = RecyclerView.m.A(K1, 1073741824, i28, ((ViewGroup.MarginLayoutParams) bVar3).width, false);
                    i17 = View.MeasureSpec.makeMeasureSpec(i23 - i27, 1073741824);
                } else {
                    i18 = View.MeasureSpec.makeMeasureSpec(i23 - i28, 1073741824);
                    i17 = RecyclerView.m.A(K1, 1073741824, i27, ((ViewGroup.MarginLayoutParams) bVar3).height, false);
                }
        ...
        while (i29 < i21) {
            ...
            if (this.r != 1) {
                i7 = this.I[bVar4.f195e] + R();
                i9 = this.t.d(view5) + i7;
            } else if (v1()) {
                i8 = P() + this.I[this.H - bVar4.f195e];
                i6 = i8 - this.t.d(view5);
            } else {
                int P = P() + this.I[bVar4.f195e];
