...
public class LinearLayoutManager extends RecyclerView.m implements RecyclerView.x.b {
    ...
    public static class a {
        ...
        public void a() {
            this.c = this.f197d ? this.a.g() : this.a.k();
        }
        ...
        public String toString() {
            ...
            h2.append(this.f197d);
            h2.append(", mValid=");
            h2.append(this.f198e);
            h2.append('}');
            return h2.toString();
        }
    }
    ...
    public static class c {
        ...
        /* renamed from: k */
        public List<RecyclerView.b0> f207k = null;

        public void a(View view) {
            int i2;
            int a;
            int size = this.f207k.size();
            View view2 = null;
            int i3 = Integer.MAX_VALUE;
            for (int i4 = 0; i4 < size; i4++) {
                View view3 = this.f207k.get(i4).a;
                RecyclerView.n nVar = (RecyclerView.n) view3.getLayoutParams();
                if (view3 != view && !nVar.c() && (a = (nVar.a() - this.f200d) * this.f201e) >= 0 && a < i3) {
                    view2 = view3;
                    if (a == 0) {
                        break;
                    }
        ...
        public View c(RecyclerView.t tVar) {
            List<RecyclerView.b0> list = this.f207k;
            if (list != null) {
                int size = list.size();
                for (int i2 = 0; i2 < size; i2++) {
                    View view = this.f207k.get(i2).a;
                    RecyclerView.n nVar = (RecyclerView.n) view.getLayoutParams();
                    if (!nVar.c() && this.f200d == nVar.a()) {
                        a(view);
                        return view;
                    }
                }
            ...
            View view2 = tVar.j(this.f200d, false, Long.MAX_VALUE).a;
            this.f200d += this.f201e;
            return view2;
        }
    }
    ...
    public static class d implements Parcelable {
        ...
        public d(Parcel parcel) {
            ...
            this.f209d = parcel.readInt() != 1 ? false : true;
        }
    ...
    public int C1(int i2, RecyclerView.t tVar, RecyclerView.y yVar) {
        ...
        F1(i3, abs, true, yVar);
        c cVar = this.s;
        int h1 = h1(tVar, cVar, yVar, false) + cVar.f203g;
        if (h1 < 0) {
            return 0;
        }
        if (abs > h1) {
    ...
    public final void F1(int i2, int i3, boolean z, RecyclerView.y yVar) {
        ...
        if (z2) {
            ...
            int S = S(t1);
            c cVar3 = this.s;
            cVar2.f200d = S + cVar3.f201e;
            cVar3.b = this.t.b(t1);
            i4 = this.t.b(t1) - this.t.g();
        } else {
            View u1 = u1();
            c cVar4 = this.s;
            cVar4.f204h = this.t.k() + cVar4.f204h;
            c cVar5 = this.s;
            if (!this.w) {
                i5 = -1;
            }
    ...
    public final void G1(int i2, int i3) {
        ...
        c cVar = this.s;
        cVar.f201e = this.w ? -1 : 1;
        cVar.f200d = i2;
        cVar.f202f = 1;
        cVar.b = i3;
        cVar.f203g = Integer.MIN_VALUE;
    }
    ...
    public void b1(RecyclerView.y yVar, c cVar, RecyclerView.m.c cVar2) {
        int i2 = cVar.f200d;
        if (i2 >= 0 && i2 < yVar.b()) {
            ((j.b) cVar2).a(i2, Math.max(0, cVar.f203g));
        }
    }
    ...
    public final int c1(RecyclerView.y yVar) {
        ...
        g1();
        return m.e.x(yVar, this.t, k1(!this.y, true), j1(!this.y, true), this, this.y);
    }
    ...
    public final int d1(RecyclerView.y yVar) {
        ...
        g1();
        return m.e.y(yVar, this.t, k1(!this.y, true), j1(!this.y, true), this, this.y, this.w);
    }
    ...
    public final int e1(RecyclerView.y yVar) {
        ...
        g1();
        return m.e.z(yVar, this.t, k1(!this.y, true), j1(!this.y, true), this, this.y);
    }
    ...
    public int h1(RecyclerView.t tVar, c cVar, RecyclerView.y yVar, boolean z) {
        ...
        int i4 = cVar.c + cVar.f204h;
        b bVar = this.D;
        while (true) {
            if ((!cVar.f208l && i4 <= 0) || !cVar.b(yVar)) {
                break;
            }
            bVar.a = 0;
            bVar.b = false;
            ...
            if (!bVar.b) {
                int i5 = cVar.b;
                int i6 = bVar.a;
                cVar.b = (cVar.f202f * i6) + i5;
                if (!bVar.c || cVar.f207k != null || !yVar.f266g) {
                    cVar.c -= i6;
                    i4 -= i6;
                }
                int i7 = cVar.f203g;
    ...
    public View o1(int i2, int i3) {
        ...
        return (this.r == 0 ? this.f237e : this.f238f).a(i2, i3, i5, i4);
    }
    ...
    public void v0(RecyclerView.t tVar, RecyclerView.y yVar) {
        ...
        View J = J();
        a aVar = this.C;
        if (!aVar.f198e || this.z != -1 || this.B != null) {
            aVar.d();
            a aVar2 = this.C;
            aVar2.f197d = this.w ^ this.x;
            if (!yVar.f266g && (i10 = this.z) != -1) {
                if (i10 < 0 || i10 >= yVar.b()) {
                    this.z = -1;
                    this.A = Integer.MIN_VALUE;
                } else {
                    ...
                    if (dVar2 != null && dVar2.d()) {
                        ...
                        if (u2 != null) {
                            if (this.t.c(u2) <= this.t.l()) {
                                if (this.t.e(u2) - this.t.k() < 0) {
                                    aVar2.c = this.t.k();
                                    aVar2.f197d = false;
                                } else if (this.t.g() - this.t.b(u2) < 0) {
                                    aVar2.c = this.t.g();
                                    aVar2.f197d = true;
                                } else {
                                    aVar2.c = aVar2.f197d ? this.t.m() + this.t.b(u2) : this.t.e(u2);
                                }
                                z = true;
                                if (!z) {
                                    if (z() != 0) {
                                            ...
                                            if (view != null) {
                                                ...
                                                if (!yVar.f266g && Z0()) {
                                                    if (this.t.e(view) >= this.t.g() || this.t.b(view) < this.t.k()) {
                                                        aVar2.c = aVar2.f197d ? this.t.g() : this.t.k();
                                                    }
                                                }
                                                z2 = true;
                                                if (!z2) {
                            ...
                            aVar2.f197d = (this.z < S(y(0))) == this.w;
                        }
                        aVar2.a();
                        z = true;
                        if (!z) {
        ...
        if (!(!yVar.f266g || (i7 = this.z) == -1 || this.A == Integer.MIN_VALUE || (u = u(i7)) == null)) {
            if (this.w) {
                i8 = this.t.g() - this.t.b(u);
                i9 = this.A;
            } else {
                i9 = this.t.e(u) - this.t.k();
                i8 = this.A;
            }
            int i16 = i8 - i9;
            if (i16 > 0) {
        ...
        a aVar3 = this.C;
        x1(tVar, yVar, aVar3, (!aVar3.f197d ? !this.w : this.w) ? 1 : -1);
        r(tVar);
        this.s.f208l = A1();
        ...
        if (yVar.f270k && z() != 0 && !yVar.f266g && Z0()) {
            List<RecyclerView.b0> list = tVar.f248d;
            int size = list.size();
            int S = S(y(0));
            int i23 = 0;
            int i24 = 0;
    ...
    public void w1(RecyclerView.t tVar, RecyclerView.y yVar, c cVar, b bVar) {
        ...
        Rect L = this.b.L(c2);
        int A = RecyclerView.m.A(this.p, this.n, Q() + P() + ((ViewGroup.MarginLayoutParams) nVar2).leftMargin + ((ViewGroup.MarginLayoutParams) nVar2).rightMargin + L.left + L.right + 0, ((ViewGroup.MarginLayoutParams) nVar2).width, f());
        int A2 = RecyclerView.m.A(this.q, this.o, O() + R() + ((ViewGroup.MarginLayoutParams) nVar2).topMargin + ((ViewGroup.MarginLayoutParams) nVar2).bottomMargin + L.top + L.bottom + 0, ((ViewGroup.MarginLayoutParams) nVar2).height, g());
        if (U0(c2, A, A2, nVar2)) {
            c2.measure(A, A2);
        }
        bVar.a = this.t.c(c2);
