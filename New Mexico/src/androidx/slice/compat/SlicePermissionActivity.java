...
public class SlicePermissionActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f297d = getIntent().getStringExtra("provider_pkg");
        try {
            PackageManager packageManager = getPackageManager();
            String e2 = a.c().e(a(packageManager, packageManager.getApplicationInfo(this.c, 0)).toString());
            String e3 = a.c().e(a(packageManager, packageManager.getApplicationInfo(this.f297d, 0)).toString());
            g.a aVar = new g.a(this);
            String string = getString(R$string.abc_slice_permission_title, new Object[]{e2, e3});
            AlertController.b bVar = aVar.a;
            bVar.f31d = string;
            int i2 = R$layout.abc_slice_permission_request;
            bVar.r = null;
            bVar.q = i2;
            bVar.f36i = bVar.a.getText(R$string.abc_slice_permission_deny);
            AlertController.b bVar2 = aVar.a;
            bVar2.f37j = this;
            bVar2.f34g = bVar2.a.getText(R$string.abc_slice_permission_allow);
            AlertController.b bVar3 = aVar.a;
            bVar3.f35h = this;
            bVar3.m = this;
            g b = aVar.b();
            this.f298e = b;
            ((TextView) b.getWindow().getDecorView().findViewById(R$id.text1)).setText(getString(R$string.abc_slice_permission_text_1, new Object[]{e3}));
            ((TextView) this.f298e.getWindow().getDecorView().findViewById(R$id.text2)).setText(getString(R$string.abc_slice_permission_text_2, new Object[]{e3}));
