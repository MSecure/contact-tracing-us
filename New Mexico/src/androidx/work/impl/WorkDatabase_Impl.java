...
public final class WorkDatabase_Impl extends WorkDatabase {
    ...
    public class a extends h.a {
        ...
        public void a(e.x.a.b bVar) {
            ((e.x.a.f.a) bVar).b.execSQL("CREATE TABLE IF NOT EXISTS `Dependency` (`work_spec_id` TEXT NOT NULL, `prerequisite_id` TEXT NOT NULL, PRIMARY KEY(`work_spec_id`, `prerequisite_id`), FOREIGN KEY(`work_spec_id`) REFERENCES `WorkSpec`(`id`) ON UPDATE CASCADE ON DELETE CASCADE , FOREIGN KEY(`prerequisite_id`) REFERENCES `WorkSpec`(`id`) ON UPDATE CASCADE ON DELETE CASCADE )");
        ...
        public void b(e.x.a.b bVar) {
            ...
            List<g.b> list = workDatabase_Impl.f2065h;
            if (list != null) {
                int size = list.size();
                for (int i3 = 0; i3 < size; i3++) {
                    Objects.requireNonNull(WorkDatabase_Impl.this.f2065h.get(i3));
                }
            }
        }
        ...
        public void d(e.x.a.b bVar) {
            ...
            ((e.x.a.f.a) bVar).b.execSQL("PRAGMA foreign_keys = ON");
            WorkDatabase_Impl.this.i(bVar);
            List<g.b> list = WorkDatabase_Impl.this.f2065h;
            if (list != null) {
                int size = list.size();
                for (int i3 = 0; i3 < size; i3++) {
                    WorkDatabase_Impl.this.f2065h.get(i3).a(bVar);
                }
            }
        }
        ...
        public h.b g(e.x.a.b bVar) {
            ...
            hashSet2.add(new d.C0062d("index_Dependency_work_spec_id", false, Arrays.asList("work_spec_id")));
            hashSet2.add(new d.C0062d("index_Dependency_prerequisite_id", false, Arrays.asList("prerequisite_id")));
            ...
            hashSet4.add(new d.C0062d("index_WorkSpec_schedule_requested_at", false, Arrays.asList("schedule_requested_at")));
            hashSet4.add(new d.C0062d("index_WorkSpec_period_start_time", false, Arrays.asList("period_start_time")));
            ...
            hashSet6.add(new d.C0062d("index_WorkTag_work_spec_id", false, Arrays.asList("work_spec_id")));
            ...
            hashSet9.add(new d.C0062d("index_WorkName_work_spec_id", false, Arrays.asList("work_spec_id")));
    ...
    @Override // e.v.g
    public c f(e.v.a aVar) {
        e.v.h hVar = new e.v.h(aVar, new a(12), "c103703e120ae8cc73c9248622f3cd1e", "49f946663a8deb7054212b8adda248c6");
