...
public class HideBottomViewOnScrollBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    public ViewPropertyAnimator f507d;
    ...
    public class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            HideBottomViewOnScrollBehavior.this.f507d = null;
        }
    }
    ...
    public final void B(V v, int i2, long j2, TimeInterpolator timeInterpolator) {
        this.f507d = v.animate().translationY((float) i2).setInterpolator(timeInterpolator).setDuration(j2).setListener(new a());
    }
    ...
    public void r(CoordinatorLayout coordinatorLayout, V v, View view, int i2, int i3, int i4, int i5, int i6, int[] iArr) {
        ...
        if (i3 > 0) {
            ...
            if (!z2) {
                ViewPropertyAnimator viewPropertyAnimator = this.f507d;
            ...
            if (!z) {
                ViewPropertyAnimator viewPropertyAnimator2 = this.f507d;
                if (viewPropertyAnimator2 != null) {
                    viewPropertyAnimator2.cancel();
                    v.clearAnimation();
                }
                this.b = 2;
                B(v, 0, 225, f.b.a.e.a.a.f2873d);
            }
        }
    }
