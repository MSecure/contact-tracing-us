...
public class SwitchMaterial extends w0 {
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.V == null) {
            int x0 = b.x0(this, R$attr.colorSurface);
            int x02 = b.x0(this, R$attr.colorControlActivated);
            float dimension = getResources().getDimension(R$dimen.mtrl_switch_thumb_elevation);
            if (this.U.a) {
                dimension += b.I0(this);
            }
            int a = this.U.a(x0, dimension);
            int[][] iArr = c0;
            int[] iArr2 = new int[iArr.length];
            iArr2[0] = b.b1(x0, x02, 1.0f);
            iArr2[1] = a;
            iArr2[2] = b.b1(x0, x02, 0.38f);
            iArr2[3] = a;
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.W == null) {
            ...
            iArr2[0] = b.b1(x0, x02, 0.54f);
            iArr2[1] = b.b1(x0, x03, 0.32f);
            iArr2[2] = b.b1(x0, x02, 0.12f);
            iArr2[3] = b.b1(x0, x03, 0.12f);
