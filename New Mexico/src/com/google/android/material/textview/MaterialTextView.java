...
public class MaterialTextView extends d0 {
    public MaterialTextView(Context context, AttributeSet attributeSet) {
        ...
        boolean z = true;
        if (b.m1(context2, R$attr.textAppearanceLineHeightEnabled, true)) {
    ...
    public static int e(Context context, TypedArray typedArray, int... iArr) {
        ...
        for (int i3 = 0; i3 < iArr.length && i2 < 0; i3++) {
            i2 = b.C0(context, typedArray, iArr[i3], -1);
        }
        return i2;
    }
    ...
    @Override // e.b.f.d0, android.widget.TextView
    public void setTextAppearance(Context context, int i2) {
        super.setTextAppearance(context, i2);
        if (b.m1(context, R$attr.textAppearanceLineHeightEnabled, true)) {
