...
public class ClockFaceView extends c implements ClockHandView.c {
    ...
    public final float[] E = {0.0f, 0.9f, 1.0f};
    ...
    public ClockFaceView(Context context, AttributeSet attributeSet) {
        ...
        ColorStateList y0 = b.y0(context, obtainStyledAttributes, R$styleable.ClockFaceView_clockNumberTextColor);
        this.L = y0;
        ...
        int colorForState = y0.getColorForState(new int[]{16842913}, y0.getDefaultColor());
        this.D = new int[]{colorForState, colorForState, y0.getDefaultColor()};
        clockHandView.f636g.add(this);
        int defaultColor = m.e.g0(context, R$color.material_timepicker_clockface).getDefaultColor();
        ColorStateList y02 = b.y0(context, obtainStyledAttributes, R$styleable.ClockFaceView_clockFaceBackgroundColor);
        setBackgroundColor(y02 != null ? y02.getDefaultColor() : defaultColor);
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        accessibilityNodeInfo.setCollectionInfo((AccessibilityNodeInfo.CollectionInfo) b.C0041b.a(1, this.J.length, false, 1).a);
    }
