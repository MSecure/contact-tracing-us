...
public class ClockHandView extends View {
    ...
    /* renamed from: g */
    public final List<c> f636g = new ArrayList();

    /* renamed from: k */
    public final RectF f640k = new RectF();
    ...
    public ClockHandView(Context context, AttributeSet attributeSet) {
        ...
        this.f637h = obtainStyledAttributes.getDimensionPixelSize(R$styleable.ClockHandView_selectorSize, 0);
        Resources resources = getResources();
        this.f641l = resources.getDimensionPixelSize(R$dimen.material_clock_hand_stroke_width);
        this.f638i = (float) resources.getDimensionPixelSize(R$dimen.material_clock_hand_center_dot_radius);
        int color = obtainStyledAttributes.getColor(R$styleable.ClockHandView_clockHandColor, 0);
        paint.setAntiAlias(true);
        paint.setColor(color);
        b(0.0f, false);
        this.f635f = ViewConfiguration.get(context).getScaledTouchSlop();
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.f639j.setStrokeWidth(0.0f);
        canvas.drawCircle((((float) this.p) * ((float) Math.cos(this.o))) + f2, (((float) this.p) * ((float) Math.sin(this.o))) + f3, (float) this.f637h, this.f639j);
        double sin = Math.sin(this.o);
        double cos = Math.cos(this.o);
        double d2 = (double) ((float) (this.p - this.f637h));
        this.f639j.setStrokeWidth((float) this.f641l);
        canvas.drawLine(f2, f3, (float) (width + ((int) (cos * d2))), (float) (height + ((int) (d2 * sin))), this.f639j);
        canvas.drawCircle(f2, f3, this.f638i, this.f639j);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1 || actionMasked == 2) {
                int i2 = (int) (x - this.c);
                int i3 = (int) (y - this.f633d);
                this.f634e = (i3 * i3) + (i2 * i2) > this.f635f;
                z2 = this.n;
                if (actionMasked == 1) {
                }
            } else {
