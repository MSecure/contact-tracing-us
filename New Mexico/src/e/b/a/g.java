...
public class g extends r implements DialogInterface {
    ...
    /* renamed from: d */
    public final AlertController f714d = new AlertController(getContext(), this, getWindow());
    ...
    public static class a {
        ...
        public g a() {
            ...
            AlertController alertController = gVar.f714d;
            View view = bVar.f32e;
            if (view != null) {
                alertController.G = view;
            } else {
                CharSequence charSequence = bVar.f31d;
            ...
            CharSequence charSequence2 = bVar.f33f;
            if (charSequence2 != null) {
                alertController.f24f = charSequence2;
                TextView textView2 = alertController.F;
                if (textView2 != null) {
                    textView2.setText(charSequence2);
                }
            }
            CharSequence charSequence3 = bVar.f34g;
            if (charSequence3 != null) {
                alertController.e(-1, charSequence3, bVar.f35h, null, null);
            }
            CharSequence charSequence4 = bVar.f36i;
            if (charSequence4 != null) {
                alertController.e(-2, charSequence4, bVar.f37j, null, null);
            }
            if (bVar.o != null) {
                ...
                alertController.f25g = recycleListView;
            }
            View view2 = bVar.r;
            if (view2 != null) {
                alertController.f26h = view2;
                alertController.f27i = 0;
                alertController.n = false;
            } else {
                int i3 = bVar.q;
                if (i3 != 0) {
                    alertController.f26h = null;
                    alertController.f27i = i3;
                    alertController.n = false;
                }
            }
            gVar.setCancelable(this.a.f38k);
            if (this.a.f38k) {
                gVar.setCanceledOnTouchOutside(true);
            }
            gVar.setOnCancelListener(this.a.f39l);
    ...
    public void onCreate(Bundle bundle) {
        ...
        AlertController alertController = this.f714d;
        ...
        View view4 = alertController.f26h;
        int i6 = 0;
        if (view4 == null) {
            view4 = alertController.f27i != 0 ? LayoutInflater.from(alertController.a).inflate(alertController.f27i, viewGroup, false) : null;
        }
        ...
        if (z2) {
            ...
            if (alertController.n) {
                frameLayout.setPadding(alertController.f28j, alertController.f29k, alertController.f30l, alertController.m);
            }
            if (alertController.f25g != null) {
        ...
        if (textView != null) {
            CharSequence charSequence = alertController.f24f;
            if (charSequence != null) {
                textView.setText(charSequence);
            } else {
                ...
                if (alertController.f25g != null) {
                    ...
                    viewGroup2.addView(alertController.f25g, indexOfChild, new ViewGroup.LayoutParams(-1, -1));
                } else {
                    d3.setVisibility(8);
                }
            }
        ...
        if (i11 != 0) {
            ...
            view3 = (alertController.f24f == null && alertController.f25g == null) ? view : d2.findViewById(R$id.titleDividerNoCustom);
        } else {
            view3 = d3.findViewById(R$id.textSpacerNoTitle);
        }
        ListView listView = alertController.f25g;
        ...
        if (!z3) {
            View view5 = alertController.f25g;
            if (view5 == null) {
                ...
                if (i13 >= 23) {
                    ...
                    if (!(findViewById9 == null && view2 == null)) {
                        if (alertController.f24f != null) {
                            ...
                            ListView listView2 = alertController.f25g;
                            if (listView2 != null) {
                                listView2.setOnScrollListener(new d(alertController, findViewById9, view2));
                                alertController.f25g.post(new e(alertController, findViewById9, view2));
                            } else {
                                if (findViewById9 != null) {
                                    d3.removeView(findViewById9);
                                }
        ...
        ListView listView3 = alertController.f25g;
    ...
    public boolean onKeyDown(int i2, KeyEvent keyEvent) {
        NestedScrollView nestedScrollView = this.f714d.A;
