...
public final class k {
    ...
    public class a implements r0.f {
        ...
        /* renamed from: d */
        public final int[] f981d = {R$drawable.abc_popup_background_mtrl_mult, R$drawable.abc_cab_background_internal_bg, R$drawable.abc_menu_hardkey_panel_mtrl_mult};

        /* renamed from: e */
        public final int[] f982e = {R$drawable.abc_tab_indicator_material, R$drawable.abc_textfield_search_material};

        /* renamed from: f */
        public final int[] f983f = {R$drawable.abc_btn_check_material, R$drawable.abc_btn_radio_material, R$drawable.abc_btn_check_material_anim, R$drawable.abc_btn_radio_material_anim};
        ...
        public final ColorStateList b(Context context, int i2) {
            ...
            return new ColorStateList(new int[][]{x0.b, x0.f1050d, x0.c, x0.f1052f}, new int[]{x0.b(context, R$attr.colorButtonNormal), e.j.c.a.a(c, i2), e.j.c.a.a(c, i2), i2});
        }
        ...
        public ColorStateList d(Context context, int i2) {
            if (i2 == R$drawable.abc_edit_text_material) {
                return m.e.g0(context, R$color.abc_tint_edittext);
            }
            if (i2 == R$drawable.abc_switch_track_mtrl_alpha) {
                return m.e.g0(context, R$color.abc_tint_switch_track);
            }
            if (i2 == R$drawable.abc_switch_thumb_material) {
                int[][] iArr = new int[3];
                int[] iArr2 = new int[3];
                int i3 = R$attr.colorSwitchThumbNormal;
                ColorStateList d2 = x0.d(context, i3);
                if (d2 == null || !d2.isStateful()) {
                    iArr[0] = x0.b;
                    iArr2[0] = x0.b(context, i3);
                    iArr[1] = x0.f1051e;
                    iArr2[1] = x0.c(context, R$attr.colorControlActivated);
                    iArr[2] = x0.f1052f;
                    iArr2[2] = x0.c(context, i3);
                } else {
                    iArr[0] = x0.b;
                ...
                if (i2 == R$drawable.abc_spinner_mtrl_am_alpha || i2 == R$drawable.abc_spinner_textfield_background_material) {
                    return m.e.g0(context, R$color.abc_tint_spinner);
                }
                if (a(this.b, i2)) {
                    return x0.d(context, R$attr.colorControlNormal);
                }
                if (a(this.f982e, i2)) {
                    return m.e.g0(context, R$color.abc_tint_default);
                }
                if (a(this.f983f, i2)) {
                    return m.e.g0(context, R$color.abc_tint_btn_checkable);
                }
                if (i2 == R$drawable.abc_seekbar_thumb_material) {
                    return m.e.g0(context, R$color.abc_tint_seek_thumb);
                }
                return null;
            }
        }
    ...
    public static void f(Drawable drawable, a1 a1Var, int[] iArr) {
        PorterDuff.Mode mode = r0.f1017h;
        if (!i0.a(drawable) || drawable.mutate() == drawable) {
            boolean z = a1Var.f900d;
            if (z || a1Var.c) {
                PorterDuffColorFilter porterDuffColorFilter = null;
                ColorStateList colorStateList = z ? a1Var.a : null;
                PorterDuff.Mode mode2 = a1Var.c ? a1Var.b : r0.f1017h;
