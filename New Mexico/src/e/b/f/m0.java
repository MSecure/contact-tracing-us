...
public class m0 extends ViewGroup {
    ...
    public m0(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f998h = obtainStyledAttributes.getFloat(R$styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.c = obtainStyledAttributes.getInt(R$styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.f999i = obtainStyledAttributes.getBoolean(R$styleable.LinearLayoutCompat_measureWithLargestChild, false);
        int i5 = R$styleable.LinearLayoutCompat_divider;
        setDividerDrawable((!obtainStyledAttributes.hasValue(i5) || (resourceId = obtainStyledAttributes.getResourceId(i5, 0)) == 0) ? obtainStyledAttributes.getDrawable(i5) : m.e.i0(context, resourceId));
    ...
    public void f(Canvas canvas, int i2) {
        this.f1002l.setBounds(getPaddingLeft() + this.p, i2, (getWidth() - getPaddingRight()) - this.p, this.n + i2);
        this.f1002l.draw(canvas);
    }

    public void g(Canvas canvas, int i2) {
        this.f1002l.setBounds(i2, getPaddingTop() + this.p, this.m + i2, (getHeight() - getPaddingBottom()) - this.p);
        this.f1002l.draw(canvas);
    }
    ...
    public int getBaseline() {
        ...
        if (childCount > i3) {
            ...
            if (baseline != -1) {
                int i4 = this.f994d;
                if (this.f995e == 1 && (i2 = this.f996f & 112) != 48) {
                    if (i2 == 16) {
                        i4 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f997g) / 2;
                    } else if (i2 == 80) {
                        i4 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f997g;
                    }
                }
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (this.f995e == 1) {
            ...
            int i22 = i21 & 112;
            int i23 = 8388615 & i21;
            int paddingTop = i22 != 16 ? i22 != 80 ? getPaddingTop() : ((getPaddingTop() + i5) - i3) - this.f997g : getPaddingTop() + (((i5 - i3) - this.f997g) / 2);
            int i24 = 0;
            while (i24 < virtualChildCount) {
                ...
                if (childAt == null) {
                    ...
                    int absoluteGravity = Gravity.getAbsoluteGravity(i25, v.e.d(this)) & 7;
        ...
        int i30 = i28 & 112;
        boolean z3 = this.b;
        int[] iArr = this.f1000j;
        int[] iArr2 = this.f1001k;
        AtomicInteger atomicInteger2 = v.a;
        int absoluteGravity2 = Gravity.getAbsoluteGravity(i29, v.e.d(this));
        int paddingLeft2 = absoluteGravity2 != 1 ? absoluteGravity2 != 5 ? getPaddingLeft() : ((getPaddingLeft() + i4) - i2) - this.f997g : getPaddingLeft() + (((i4 - i2) - this.f997g) / 2);
        if (a2) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:272:0x0620  */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f995e == 1) {
            ...
            while (i45 < virtualChildCount) {
                ...
                if (childAt == null) {
                    ...
                    if (mode2 == i43 && ((LinearLayout.LayoutParams) aVar3).height == 0 && f7 > f5) {
                        int i51 = this.f997g;
                        this.f997g = Math.max(i51, ((LinearLayout.LayoutParams) aVar3).topMargin + i51 + ((LinearLayout.LayoutParams) aVar3).bottomMargin);
                        i34 = i44;
                        i33 = mode2;
                        i37 = mode;
                        ...
                        int measuredHeight = childAt.getMeasuredHeight();
                        int i52 = this.f997g;
                        this.f997g = Math.max(i52, m() + i52 + measuredHeight + ((LinearLayout.LayoutParams) aVar2).topMargin + ((LinearLayout.LayoutParams) aVar2).bottomMargin);
                        if (z9) {
                    ...
                    if (i45 >= i34 || ((LinearLayout.LayoutParams) aVar2).weight <= 0.0f) {
                        ...
                        i50 = View.combineMeasuredStates(i50, childAt.getMeasuredState());
            ...
            int i55 = i49;
            int i56 = i50;
            if (this.f997g > 0 && n(virtualChildCount)) {
                this.f997g += this.n;
            }
            int i57 = mode2;
            if (z9 && (i57 == Integer.MIN_VALUE || i57 == 0)) {
                ...
                while (i58 < virtualChildCount) {
                    ...
                    if (childAt2 == null) {
                        ...
                        int i59 = this.f997g;
                        this.f997g = Math.max(i59, m() + i59 + i47 + ((LinearLayout.LayoutParams) aVar4).topMargin + ((LinearLayout.LayoutParams) aVar4).bottomMargin);
                    }
                    i58++;
                }
            }
            int paddingBottom = getPaddingBottom() + getPaddingTop() + this.f997g;
            this.f997g = paddingBottom;
            int resolveSizeAndState = View.resolveSizeAndState(Math.max(paddingBottom, getSuggestedMinimumHeight()), i3, 0);
            int i60 = (16777215 & resolveSizeAndState) - this.f997g;
            if (z10 || (i60 != 0 && f6 > 0.0f)) {
                    ...
                    if (childAt3.getVisibility() == 8) {
                        ...
                        if (mode != 1073741824) {
                            ...
                            if (((LinearLayout.LayoutParams) aVar5).width == -1) {
                                ...
                                int i64 = this.f997g;
                                this.f997g = Math.max(i64, m() + childAt3.getMeasuredHeight() + i64 + ((LinearLayout.LayoutParams) aVar5).topMargin + ((LinearLayout.LayoutParams) aVar5).bottomMargin);
                                z11 = z14;
                                i60 = i29;
                            }
                        } else {
                        ...
                        int i642 = this.f997g;
                        this.f997g = Math.max(i642, m() + childAt3.getMeasuredHeight() + i642 + ((LinearLayout.LayoutParams) aVar5).topMargin + ((LinearLayout.LayoutParams) aVar5).bottomMargin);
                        z11 = z14;
                        i60 = i29;
                    }
                    i61++;
                ...
                this.f997g = getPaddingBottom() + getPaddingTop() + this.f997g;
            } else {
        ...
        if (this.f1000j == null || this.f1001k == null) {
            this.f1000j = new int[4];
            this.f1001k = new int[4];
        }
        int[] iArr = this.f1000j;
        int[] iArr2 = this.f1001k;
        iArr[3] = -1;
            ...
            if (childAt6 == null) {
                ...
                if (childAt6.getVisibility() == 8) {
                    ...
                    if (mode3 == 1073741824 && ((LinearLayout.LayoutParams) aVar7).width == 0 && f11 > 0.0f) {
                        if (z17) {
                            i27 = i70;
                            this.f997g = ((LinearLayout.LayoutParams) aVar7).leftMargin + ((LinearLayout.LayoutParams) aVar7).rightMargin + this.f997g;
                        } else {
                            i27 = i70;
                            int i74 = this.f997g;
                            this.f997g = Math.max(i74, ((LinearLayout.LayoutParams) aVar7).leftMargin + i74 + ((LinearLayout.LayoutParams) aVar7).rightMargin);
                        }
                        if (z15) {
                            ...
                            if (z2 || (baseline2 = childAt6.getBaseline()) == -1) {
                                ...
                                int i75 = ((LinearLayout.LayoutParams) aVar).gravity;
                                if (i75 < 0) {
                                    i75 = this.f996f;
                                }
                            ...
                            if (((LinearLayout.LayoutParams) aVar).weight <= 0.0f) {
                                ...
                                i68 = Math.max(i21, measuredHeight2);
                            } else {
                                if (z5) {
                                    measuredHeight2 = i25;
                                }
                        ...
                        if (((LinearLayout.LayoutParams) aVar7).width == 0) {
                            ...
                            if (f11 > 0.0f) {
                                ...
                                z3 = z16;
                                z2 = z15;
                                o(childAt6, i2, f12 != f4 ? this.f997g : 0, i3, 0);
                                ...
                                int i77 = this.f997g;
                                if (!z17) {
                                    this.f997g = m() + ((LinearLayout.LayoutParams) aVar).leftMargin + measuredWidth3 + ((LinearLayout.LayoutParams) aVar).rightMargin + i77;
                                } else {
                                    this.f997g = Math.max(i77, m() + i77 + measuredWidth3 + ((LinearLayout.LayoutParams) aVar).leftMargin + ((LinearLayout.LayoutParams) aVar).rightMargin);
                                }
                                if (z3) {
        ...
        int i78 = i69;
        if (this.f997g > 0 && n(virtualChildCount2)) {
            this.f997g += this.m;
        }
                ...
                if (z16 && (mode3 == Integer.MIN_VALUE || mode3 == 0)) {
                    ...
                    while (i17 < virtualChildCount2) {
                        ...
                        if (childAt7 == null) {
                            ...
                            int i79 = this.f997g;
                            this.f997g = z17 ? m() + ((LinearLayout.LayoutParams) aVar8).leftMargin + i71 + ((LinearLayout.LayoutParams) aVar8).rightMargin + i79 : Math.max(i79, m() + i79 + i71 + ((LinearLayout.LayoutParams) aVar8).leftMargin + ((LinearLayout.LayoutParams) aVar8).rightMargin);
                        }
                        i17++;
                    }
                }
                int paddingRight = getPaddingRight() + getPaddingLeft() + this.f997g;
                this.f997g = paddingRight;
                int resolveSizeAndState2 = View.resolveSizeAndState(Math.max(paddingRight, getSuggestedMinimumWidth()), i2, 0);
                i5 = (16777215 & resolveSizeAndState2) - this.f997g;
                if (!z18 || (i5 != 0 && f10 > 0.0f)) {
                    ...
                    while (i9 < virtualChildCount2) {
                        ...
                        if (childAt8 == null || childAt8.getVisibility() == 8) {
                            ...
                            if (z17) {
                                f3 = f10;
                                i14 = m() + childAt8.getMeasuredWidth() + ((LinearLayout.LayoutParams) aVar9).leftMargin + ((LinearLayout.LayoutParams) aVar9).rightMargin + this.f997g;
                                i13 = i12;
                            } else {
                                f3 = f10;
                                int i83 = this.f997g;
                                i13 = i12;
                                i14 = Math.max(i83, m() + childAt8.getMeasuredWidth() + i83 + ((LinearLayout.LayoutParams) aVar9).leftMargin + ((LinearLayout.LayoutParams) aVar9).rightMargin);
                            }
                            this.f997g = i14;
                            boolean z22 = mode4 != 1073741824 && ((LinearLayout.LayoutParams) aVar9).height == -1;
                            int i84 = ((LinearLayout.LayoutParams) aVar9).topMargin + ((LinearLayout.LayoutParams) aVar9).bottomMargin;
                            int measuredHeight3 = childAt8.getMeasuredHeight() + i84;
                            i81 = Math.max(i81, measuredHeight3);
                            if (!z22) {
                                i84 = measuredHeight3;
                            }
                            i78 = Math.max(i78, i84);
                            if (z19) {
                                i15 = -1;
                                if (((LinearLayout.LayoutParams) aVar9).height == -1) {
                                    z = true;
                                    if (!z15 && (baseline = childAt8.getBaseline()) != i15) {
                                        int i85 = ((LinearLayout.LayoutParams) aVar9).gravity;
                                        if (i85 < 0) {
                                            i85 = this.f996f;
                                        }
                    ...
                    this.f997g = getPaddingRight() + getPaddingLeft() + this.f997g;
                    if (iArr[1] != -1 && iArr[0] == -1 && iArr[2] == -1) {
                        c = 3;
                        if (iArr[3] == -1) {
                            i73 = i81;
        ...
        int paddingRight2 = getPaddingRight() + getPaddingLeft() + this.f997g;
        this.f997g = paddingRight2;
        int resolveSizeAndState22 = View.resolveSizeAndState(Math.max(paddingRight2, getSuggestedMinimumWidth()), i2, 0);
        i5 = (16777215 & resolveSizeAndState22) - this.f997g;
        if (!z18) {
        }
        f2 = this.f998h;
        if (f2 > 0.0f) {
    ...
    public void setBaselineAlignedChildIndex(int i2) {
        if (i2 < 0 || i2 >= getChildCount()) {
            StringBuilder h2 = f.a.a.a.a.h("base aligned child index out of range (0, ");
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable != this.f1002l) {
            this.f1002l = drawable;
            boolean z = false;
            if (drawable != null) {
    ...
    public void setVerticalGravity(int i2) {
        ...
        int i4 = this.f996f;
        if ((i4 & 112) != i3) {
            this.f996f = i3 | (i4 & -113);
            requestLayout();
        }
    }

    public void setWeightSum(float f2) {
        this.f998h = Math.max(0.0f, f2);
    }
