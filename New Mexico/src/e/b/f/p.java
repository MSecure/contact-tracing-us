...
public class p {
    ...
    public void b(AttributeSet attributeSet, int i2) {
        ...
        try {
            ...
            if (!(drawable3 != null || (l2 = q.l(R$styleable.AppCompatImageView_srcCompat, -1)) == -1 || (drawable3 = m.e.i0(this.a.getContext(), l2)) == null)) {
    ...
    public void c(int i2) {
        if (i2 != 0) {
            Drawable i0 = m.e.i0(this.a.getContext(), i2);
            if (i0 != null) {
                i0.b(i0);
            }
            this.a.setImageDrawable(i0);
        } else {
