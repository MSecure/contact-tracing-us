...
public class w0 extends CompoundButton {
    ...
    /* renamed from: h */
    public ColorStateList f1039h;

    /* renamed from: i */
    public PorterDuff.Mode f1040i;
    ...
    /* loaded from: classes.dex */
    public static class b extends e.AbstractC0051e {
    ...
    public w0(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f1043l = c1Var.f(R$styleable.SwitchCompat_thumbTextPadding, 0);
        ...
        ColorStateList c = c1Var.c(R$styleable.SwitchCompat_thumbTint);
        if (c != null) {
            this.c = c;
            this.f1036e = true;
        }
        ...
        if (this.f1036e || this.f1037f) {
            a();
        }
        ColorStateList c2 = c1Var.c(R$styleable.SwitchCompat_trackTint);
        if (c2 != null) {
            this.f1039h = c2;
            this.f1041j = true;
        }
        ...
        if (l2 != 0) {
            ...
            ColorStateList colorStateList = (!obtainStyledAttributes2.hasValue(i3) || (resourceId = obtainStyledAttributes2.getResourceId(i3, 0)) == 0 || (colorStateList = m.e.g0(context, resourceId)) == null) ? obtainStyledAttributes2.getColorStateList(i3) : colorStateList;
            ...
            if (i5 > 0) {
                ...
                textPaint.setFakeBoldText((i6 & 1) == 0 ? false : z);
    ...
    public final void a() {
        ...
        if (this.f1036e || this.f1037f) {
            ...
            if (this.f1037f) {
                this.b.setTintMode(this.f1035d);
            }
    ...
    public final void b() {
        ...
        if (this.f1041j || this.f1042k) {
            ...
            this.f1038g = mutate;
            if (this.f1041j) {
                mutate.setTintList(this.f1039h);
            }
            if (this.f1042k) {
                this.f1038g.setTintMode(this.f1040i);
            }
            if (this.f1038g.isStateful()) {
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable2 != null) {
            ...
            if (d2 != null) {
                ...
                if (i14 > i15) {
                    i3 = i7 - (i14 - i15);
                    this.f1038g.setBounds(i4, i2, i6, i3);
                }
            } else {
                i2 = i5;
            }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.t) {
            i6 = (this.f1043l * 2) + Math.max(this.K.getWidth(), this.L.getWidth());
        } else {
            i6 = 0;
        }
        ...
        if (drawable2 != null) {
            drawable2.getPadding(rect);
            i7 = this.f1038g.getIntrinsicHeight();
        } else {
            rect.setEmpty();
        }
        int i8 = rect.left;
        ...
        if (actionMasked != 0) {
            ...
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    ...
                    if (i2 == 1) {
                        ...
                        if (Math.abs(x - this.w) > ((float) this.v) || Math.abs(y - this.x) > ((float) this.v)) {
                            this.u = 2;
            ...
            if (this.u == 2) {
                ...
                if (z3) {
                    ...
                    z = Math.abs(xVelocity) > ((float) this.z) ? !i1.a(this) ? xVelocity > 0.0f : xVelocity < 0.0f : getTargetCheckedState();
                } else {
                    z = isChecked;
                }
                if (z != isChecked) {
            ...
            if (isEnabled()) {
                if (this.b != null) {
                    ...
                    int i8 = this.H + i4;
                    if (x3 > ((float) i6) && x3 < ((float) i7) && y2 > ((float) i5) && y2 < ((float) i8)) {
                        z2 = true;
                    }
                }
                if (z2) {
    ...
    public void setThumbResource(int i2) {
        setThumbDrawable(m.e.i0(getContext(), i2));
    }
    ...
    public void setTrackResource(int i2) {
        setTrackDrawable(m.e.i0(getContext(), i2));
    }

    public void setTrackTintList(ColorStateList colorStateList) {
        this.f1039h = colorStateList;
        this.f1041j = true;
        b();
    }
    ...
    public boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.b || drawable == this.f1038g;
    }
}
