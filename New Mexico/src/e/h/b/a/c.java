...
public class c extends ConstraintLayout implements l {
    ...
    public CopyOnWriteArrayList<AbstractC0032c> N;
    public int O;
    public float P;
    public float Q;
    public boolean R;
    ...
    public class b {
        ...
        public void a() {
            ...
            d dVar2 = d.SETUP;
            int i3 = this.c;
            if (!(i3 == -1 && this.f1452d == -1)) {
                if (i3 == -1) {
                    c.this.w(this.f1452d);
                } else {
                    int i4 = this.f1452d;
                    if (i4 == -1) {
                        c cVar = c.this;
                        ...
                        cVar.w = -1;
                        cVar.y = -1;
                        e.h.c.c cVar2 = cVar.f119l;
                        if (cVar2 != null) {
                            float f2 = (float) -1;
                            int i5 = cVar2.b;
                            if (i5 == i3) {
                                c.a valueAt = i3 == -1 ? cVar2.f1475d.valueAt(0) : cVar2.f1475d.get(i5);
                                int i6 = cVar2.c;
                                if ((i6 == -1 || !valueAt.b.get(i6).a(f2, f2)) && cVar2.c != (i2 = valueAt.a(f2, f2))) {
                                    dVar = i2 == -1 ? null : valueAt.b.get(i2).f1480f;
                                    if (i2 != -1) {
                                        int i7 = valueAt.b.get(i2).f1479e;
                                    }
                                }
                            } else {
                                cVar2.b = i3;
                                c.a aVar = cVar2.f1475d.get(i3);
                                i2 = aVar.a(f2, f2);
                                dVar = i2 == -1 ? aVar.f1477d : aVar.b.get(i2).f1480f;
                                if (i2 != -1) {
                                    int i8 = aVar.b.get(i2).f1479e;
                                }
                            }
                        }
                    } else {
    ...
    /* renamed from: e.h.b.a.c$c */
    /* loaded from: classes.dex */
    public interface AbstractC0032c {
    ...
    public Bundle getTransitionState() {
        ...
        bundle.putInt("motion.EndState", bVar2.f1452d);
        return bundle;
    }
    ...
    public void s(boolean z) {
        ...
        if (this.K) {
            ...
            this.Q = f4;
            if (childCount <= 0) {
                boolean z3 = (i5 > 0 && f4 >= this.F) || (signum <= 0.0f && f4 <= this.F);
                if (!this.K && z3) {
                    setState(dVar);
                }
    ...
    public void setTransitionListener(AbstractC0032c cVar) {
        this.G = cVar;
    }
    ...
    public void setTransitionState(Bundle bundle) {
        ...
        bVar.f1452d = bundle.getInt("motion.EndState");
        if (isAttachedToWindow()) {
            this.S.a();
        }
    }
    ...
    public final void t() {
        CopyOnWriteArrayList<AbstractC0032c> copyOnWriteArrayList;
        if ((this.G != null || ((copyOnWriteArrayList = this.N) != null && !copyOnWriteArrayList.isEmpty())) && this.P != this.C) {
            if (this.O != -1) {
                AbstractC0032c cVar = this.G;
                if (cVar != null) {
                    cVar.a(this, this.w, this.y);
                }
                CopyOnWriteArrayList<AbstractC0032c> copyOnWriteArrayList2 = this.N;
                if (copyOnWriteArrayList2 != null) {
                    Iterator<AbstractC0032c> it = copyOnWriteArrayList2.iterator();
                    while (it.hasNext()) {
            ...
            float f2 = this.C;
            this.P = f2;
            AbstractC0032c cVar2 = this.G;
            if (cVar2 != null) {
                cVar2.b(this, this.w, this.y, f2);
            }
            CopyOnWriteArrayList<AbstractC0032c> copyOnWriteArrayList3 = this.N;
            if (copyOnWriteArrayList3 != null) {
                Iterator<AbstractC0032c> it2 = copyOnWriteArrayList3.iterator();
                while (it2.hasNext()) {
    ...
    public String toString() {
        ...
        return m.e.s0(context, this.w) + "->" + m.e.s0(context, this.y) + " (pos:" + this.D + " Dpos/Dt:" + this.v;
    }

    public void u() {
        CopyOnWriteArrayList<AbstractC0032c> copyOnWriteArrayList;
        CopyOnWriteArrayList<AbstractC0032c> copyOnWriteArrayList2;
