...
public final class n {
    ...
    public static c f1560g;
    public final Context a;
    public final NotificationManager b;
    public static final Object c = new Object();

    /* renamed from: e  reason: collision with root package name */
    public static Set<String> f1558e = new HashSet();

    /* renamed from: f  reason: collision with root package name */
    public static final Object f1559f = new Object();
    ...
    public static class a implements d {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final Notification f1561d;

        public a(String str, int i2, String str2, Notification notification) {
            this.a = str;
            this.b = i2;
            this.c = str2;
            this.f1561d = notification;
        }

        @Override // e.j.a.n.d
        public void a(d.a.a.a.a aVar) {
            aVar.H(this.a, this.b, this.c, this.f1561d);
        }
    ...
    public static class c implements Handler.Callback, ServiceConnection {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final Map<ComponentName, a> f1562d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        public Set<String> f1563e = new HashSet();
        ...
        public static class a {
            ...
            /* renamed from: d  reason: collision with root package name */
            public ArrayDeque<d> f1564d = new ArrayDeque<>();
        ...
        public final void a(a aVar) {
            ...
            if (Log.isLoggable("NotifManCompat", 3)) {
                ...
                h2.append(aVar.a);
                h2.append(", ");
                h2.append(aVar.f1564d.size());
                h2.append(" queued tasks");
                h2.toString();
            }
            if (!aVar.f1564d.isEmpty()) {
                if (aVar.b) {
                    z = true;
                } else {
            ...
            if (i2 == 0) {
                ...
                if (!set.equals(this.f1563e)) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (!this.f1562d.containsKey(componentName2)) {
                            if (Log.isLoggable("NotifManCompat", 3)) {
                                String str3 = "Adding listener record for " + componentName2;
                            }
                            this.f1562d.put(componentName2, new a(componentName2));
                        }
                    }
                    Iterator<Map.Entry<ComponentName, a>> it2 = this.f1562d.entrySet().iterator();
                    while (it2.hasNext()) {
                ...
                for (a aVar2 : this.f1562d.values()) {
                    aVar2.f1564d.add(dVar);
                    a(aVar2);
                }
                return true;
            } else if (i2 == 1) {
                ...
                a aVar3 = this.f1562d.get(componentName3);
                if (aVar3 != null) {
                ...
                a aVar4 = this.f1562d.get((ComponentName) message.obj);
                if (aVar4 != null) {
                    if (aVar4.b) {
                        this.a.unbindService(this);
                        aVar4.b = false;
                ...
                a aVar5 = this.f1562d.get((ComponentName) message.obj);
                if (aVar5 != null) {
                    a(aVar5);
                }
                return true;
    ...
    public final void b(d dVar) {
        synchronized (f1559f) {
            if (f1560g == null) {
                f1560g = new c(this.a.getApplicationContext());
            }
            f1560g.c.obtainMessage(0, dVar).sendToTarget();
        }
    }
}
