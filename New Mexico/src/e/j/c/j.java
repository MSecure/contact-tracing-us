    ...
    public Typeface a(Context context, d dVar, Resources resources, int i2) {
        try {
            ...
            while (true) {
                ...
                e eVar = eVarArr[i4];
                try {
                    Font.Builder weight = new Font.Builder(resources, eVar.f1568f).setWeight(eVar.b);
                    if (!eVar.c) {
                        i5 = 0;
                    }
                    Font build = weight.setSlant(i5).setTtcIndex(eVar.f1567e).setFontVariationSettings(eVar.f1566d).build();
                    if (builder == null) {
