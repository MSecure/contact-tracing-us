...
public class b implements Spannable {
    ...
    public static final class a {
        ...
        public a(PrecomputedText.Params params) {
            ...
            this.f1606d = params.getHyphenationFrequency();
        ...
        public boolean a(a aVar) {
            int i2 = Build.VERSION.SDK_INT;
            if ((i2 >= 23 && (this.c != aVar.c || this.f1606d != aVar.f1606d)) || this.a.getTextSize() != aVar.a.getTextSize() || this.a.getTextScaleX() != aVar.a.getTextScaleX() || this.a.getTextSkewX() != aVar.a.getTextSkewX() || this.a.getLetterSpacing() != aVar.a.getLetterSpacing() || !TextUtils.equals(this.a.getFontFeatureSettings(), aVar.a.getFontFeatureSettings()) || this.a.getFlags() != aVar.a.getFlags()) {
                return false;
            }
            if (i2 >= 24) {
        ...
        public String toString() {
            ...
            sb2.append(", hyphenationFrequency=" + this.f1606d);
            sb2.append("}");
            return sb2.toString();
        }
    }
