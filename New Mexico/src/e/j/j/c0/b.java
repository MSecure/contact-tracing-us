...
public class b {
    ...
    public static class a {
        ...
        /* renamed from: e */
        public static final a f1624e = new a(16, null);

        /* renamed from: f */
        public static final a f1625f = new a(4096, null);

        /* renamed from: g */
        public static final a f1626g = new a(8192, null);

        /* renamed from: h */
        public static final a f1627h = new a(262144, null);

        /* renamed from: i */
        public static final a f1628i = new a(524288, null);

        /* renamed from: j */
        public static final a f1629j = new a(1048576, null);

        /* renamed from: k */
        public static final a f1630k;

        /* renamed from: l */
        public static final a f1631l;
        public final Object a;
        public final int b;
        public final Class<? extends d.a> c;

        /* renamed from: d */
        public final d f1632d;
        ...
        static {
            ...
            f1630k = new a(i2 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_UP : null, 16908344, null, null, null);
            ...
            f1631l = new a(i2 >= 23 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_SCROLL_DOWN : null, 16908346, null, null, null);
    ...
    public static class C0041b {
        ...
        public static C0041b a(int i2, int i3, boolean z, int i4) {
            return new C0041b(AccessibilityNodeInfo.CollectionInfo.obtain(i2, i3, z, i4));
        }
    }
    ...
    public CharSequence g() {
        ...
        for (int i2 = 0; i2 < b.size(); i2++) {
            spannableString.setSpan(new a(b4.get(i2).intValue(), this, f().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), b.get(i2).intValue(), b2.get(i2).intValue(), b3.get(i2).intValue());
        }
    ...
    public void i(Object obj) {
        this.a.setCollectionInfo(obj == null ? null : (AccessibilityNodeInfo.CollectionInfo) ((C0041b) obj).a);
    }
