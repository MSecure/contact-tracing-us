...
public class a0 {
    ...
    public static Class<? extends m> c(ClassLoader classLoader, String str) {
        try {
            ...
            throw new m.e(a.c("Unable to instantiate fragment ", str, ": make sure class is a valid subclass of Fragment"), e2);
        } catch (ClassNotFoundException e3) {
            throw new m.e(a.c("Unable to instantiate fragment ", str, ": make sure class name exists"), e3);
        }
    }
