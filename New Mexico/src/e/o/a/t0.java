...
public class t0 {
    ...
    static {
        v0 v0Var;
        try {
            v0Var = (v0) Class.forName("e.z.d").getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
    ...
    public static void a(ArrayList<View> arrayList, e.f.a<String, View> aVar, Collection<String> collection) {
        for (int i2 = aVar.f1316d - 1; i2 >= 0; i2--) {
            View k2 = aVar.k(i2);
            AtomicInteger atomicInteger = v.a;
            if (collection.contains(v.i.k(k2))) {
                arrayList.add(k2);
            }
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:30:0x0038, code lost:
        if (r0.f1817l != false) goto L_0x0086;
     */
            ...
            if (i3 != 1) {
                if (i3 != 3) {
                    if (i3 != 4) {
                        ...
                        if (z4 && (bVar == null || bVar.f1869d == null)) {
                            if (bVar == null) {
                                b bVar3 = new b();
    ...
    public static void c(m mVar, m mVar2, boolean z, e.f.a<String, View> aVar, boolean z2) {
        if (z) {
            mVar2.o();
        } else {
            mVar.o();
    ...
    public static e.f.a<String, View> e(v0 v0Var, e.f.a<String, String> aVar, Object obj, b bVar) {
    ...
    public static e.f.a<String, View> f(v0 v0Var, e.f.a<String, String> aVar, Object obj, b bVar) {
        ArrayList<String> arrayList;
    ...
    public static View k(e.f.a<String, View> aVar, b bVar, Object obj, boolean z) {
        ArrayList<String> arrayList;
        a aVar2 = bVar.c;
    ...
    public static void m(e.f.a<String, String> aVar, e.f.a<String, View> aVar2) {
        int i2 = aVar.f1316d;
        while (true) {
            i2--;
            if (i2 < 0) {
    ...
    public static void n(v0 v0Var, Object obj, Object obj2, e.f.a<String, View> aVar, boolean z, a aVar2) {
                    ...
                    if (z3) {
                        ...
                        if (g2 == null) {
                            ...
                            if (mVar8 == null || mVar9 == null) {
                                ...
                                e.f.a<String, View> f2 = f(g2, aVar6, obj7, bVar);
                                mVar5 = mVar6;
                                e.f.a<String, View> e2 = e(g2, aVar6, obj7, bVar);
                                if (aVar6.isEmpty()) {
                                    if (f2 != null) {
                                        f2.clear();
                                    }
                                    ...
                                    a(arrayList12, f2, aVar6.keySet());
                                    a(arrayList11, e2, aVar6.values());
                                    obj8 = obj7;
                                }
                                if (i14 == null && j2 == null && obj8 == null) {
                                    ...
                                    if (obj8 != null) {
                                        ...
                                        g2.w(obj8, view2, arrayList12);
                                        arrayList5 = arrayList11;
                                        n(g2, obj8, j2, f2, bVar.f1870e, bVar.f1871f);
                                        Rect rect3 = new Rect();
                                    ...
                                    q.a(viewGroup, new r0(mVar8, mVar9, z6, e2, view, g2, rect2));
                                    obj6 = obj8;
                                    if (!(i14 != null && obj6 == null && j2 == null)) {
                                        ArrayList<View> h3 = h(g2, j2, mVar7, arrayList12, view2);
                                        ArrayList<View> h4 = h(g2, i14, mVar5, arrayList5, view2);
                                        o(h4, 4);
                                        m2 = g2.m(j2, i14, obj6);
                                        if (!(mVar7 == null || h3 == null || (h3.size() <= 0 && arrayList12.size() <= 0))) {
                                            e.j.f.a aVar8 = new e.j.f.a();
                                            e0.d dVar = (e0.d) aVar;
                                            dVar.b(mVar7, aVar8);
                                            g2.u(mVar7, m2, aVar8, new n0(dVar, mVar7, aVar8));
                                        }
                                        if (m2 != null) {
                                            if (mVar7 != null && j2 != null && mVar7.f1817l && mVar7.z && mVar7.J) {
                                                mVar7.C0(true);
                                                g2.q(j2, mVar7.F, h3);
                                                q.a(mVar7.E, new o0(h3));
                                            }
                                            ArrayList<String> n = g2.n(arrayList5);
                                            g2.r(m2, i14, h4, j2, h3, obj6, arrayList5);
                                            g2.c(viewGroup, m2);
                                            g2.v(viewGroup, arrayList12, arrayList5, n, aVar4);
                                            o(h4, 0);
                                            g2.x(obj6, arrayList12, arrayList5);
                                        }
                                    }
                                }
                            }
                            ...
                            ArrayList<View> h32 = h(g2, j2, mVar7, arrayList12, view2);
                            ArrayList<View> h42 = h(g2, i14, mVar5, arrayList5, view2);
                            o(h42, 4);
                            m2 = g2.m(j2, i14, obj6);
                            if (mVar7 == null) {
                                e.j.f.a aVar82 = new e.j.f.a();
                        ...
                        if (g3 != null) {
                            ...
                            if (mVar12 == null || mVar13 == null) {
                                ...
                                e.f.a<String, View> f3 = f(g3, aVar2, obj3, bVar);
                                if (aVar2.isEmpty()) {
                                    obj4 = null;
                                } else {
                                    arrayList13.addAll(f3.values());
                                    obj4 = obj3;
                                }
                                if (i15 == null && j3 == null && obj4 == null) {
                                    ...
                                    if (obj4 != null) {
                                        ...
                                        n(g3, obj5, j3, f3, bVar.f1870e, bVar.f1871f);
                                        if (i15 != null) {
                                            g3.s(i15, rect);
                                        }
                                    } else {
                                    ...
                                    obj2 = j3;
                                    i5 = i7;
                                    q.a(viewGroup, new s0(g3, aVar3, obj5, bVar, arrayList4, view2, mVar4, mVar3, z2, arrayList3, i15, rect));
                                    obj = obj5;
                                    if (i15 == null || obj != null || obj2 != null) {
                                        h2 = h(g3, obj2, mVar, arrayList3, view2);
                                        if (h2 != null || h2.isEmpty()) {
                                            obj2 = null;
                                        }
                                        g3.a(i15, view2);
                                        m = g3.m(obj2, i15, obj);
                                        if (!(mVar == null || h2 == null || (h2.size() <= 0 && arrayList3.size() <= 0))) {
                                            e.j.f.a aVar10 = new e.j.f.a();
                                        ...
                                        if (m == null) {
                                            ...
                                            g3.r(m, i15, arrayList15, obj2, h2, obj, arrayList4);
                                            q.a(viewGroup, new q0(i15, g3, view2, mVar2, arrayList4, arrayList15, h2, obj2));
                                            q.a(viewGroup, new w0(g3, arrayList4, aVar9));
                                            g3.c(viewGroup, m);
                                            q.a(viewGroup, new x0(g3, arrayList4, aVar9));
                                        }
                                    }
                                }
                            }
