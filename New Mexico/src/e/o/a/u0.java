...
public class u0 extends v0 {
    ...
    public class b implements Transition.TransitionListener {
        ...
        public b(u0 u0Var, View view, ArrayList arrayList) {
            this.a = view;
            this.b = arrayList;
        }
    ...
    public class c implements Transition.TransitionListener {
        ...
        public final /* synthetic */ ArrayList f1874d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ Object f1875e;

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ ArrayList f1876f;

        public c(Object obj, ArrayList arrayList, Object obj2, ArrayList arrayList2, Object obj3, ArrayList arrayList3) {
            this.a = obj;
            this.b = arrayList;
            this.c = obj2;
            this.f1874d = arrayList2;
            this.f1875e = obj3;
            this.f1876f = arrayList3;
        }
        ...
        public void onTransitionStart(Transition transition) {
            Object obj = this.a;
            if (obj != null) {
                u0.this.p(obj, this.b, null);
            }
            Object obj2 = this.c;
            if (obj2 != null) {
                u0.this.p(obj2, this.f1874d, null);
            }
            Object obj3 = this.f1875e;
            if (obj3 != null) {
                u0.this.p(obj3, this.f1876f, null);
            }
        }
    }
    ...
    public class d implements Transition.TransitionListener {
        ...
        public d(u0 u0Var, Runnable runnable) {
            this.a = runnable;
        }
    ...
    public static boolean z(Transition transition) {
        return !v0.k(transition.getTargetIds()) || !v0.k(transition.getTargetNames()) || !v0.k(transition.getTargetTypes());
    }
    ...
    public void b(Object obj, ArrayList<View> arrayList) {
        ...
        if (transition != null) {
            ...
            } else if (!z(transition) && v0.k(transition.getTargets())) {
    ...
    @Override // e.o.a.v0
    public void u(m mVar, Object obj, e.j.f.a aVar, Runnable runnable) {
