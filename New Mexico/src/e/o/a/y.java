...
public final class y extends FrameLayout {
    ...
    public View.OnApplyWindowInsetsListener f1884d;
    ...
    public y(Context context, AttributeSet attributeSet, e0 e0Var) {
        ...
        if (classAttribute != null && H == null) {
            if (id <= 0) {
                throw new IllegalStateException(a.c("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? a.x(" with tag ", string) : ""));
            }
            m a = e0Var.M().a(context.getClassLoader(), classAttribute);
    ...
    public WindowInsets dispatchApplyWindowInsets(WindowInsets windowInsets) {
        ...
        View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = this.f1884d;
    ...
    public boolean drawChild(Canvas canvas, View view, long j2) {
        ...
        if (!this.f1885e || (arrayList = this.b) == null || arrayList.size() <= 0 || !this.b.contains(view)) {
    ...
    public void setOnApplyWindowInsetsListener(View.OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        this.f1884d = onApplyWindowInsetsListener;
    }
