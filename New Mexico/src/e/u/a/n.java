...
public class n extends RecyclerView.x {
    ...
    public final DisplayMetrics f2031l;
    public float n;

    /* renamed from: i  reason: collision with root package name */
    public final LinearInterpolator f2028i = new LinearInterpolator();

    /* renamed from: j  reason: collision with root package name */
    public final DecelerateInterpolator f2029j = new DecelerateInterpolator();
    public boolean m = false;
    public int o = 0;
    public int p = 0;

    public n(Context context) {
        this.f2031l = context.getResources().getDisplayMetrics();
    }
