...
public class d {
    ...
    public final Set<C0062d> f2097d;
    ...
    public static class a {
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            if (this.f2099e != aVar.f2099e || !this.a.equals(aVar.a) || this.f2098d != aVar.f2098d) {
                return false;
            }
            if (this.f2101g == 1 && aVar.f2101g == 2 && (str3 = this.f2100f) != null && !str3.equals(aVar.f2100f)) {
                return false;
            }
            if (this.f2101g == 2 && aVar.f2101g == 1 && (str2 = aVar.f2100f) != null && !str2.equals(this.f2100f)) {
                return false;
            }
            int i2 = this.f2101g;
            return (i2 == 0 || i2 != aVar.f2101g || ((str = this.f2100f) == null ? aVar.f2100f == null : str.equals(aVar.f2100f))) && this.c == aVar.c;
        }

        public int hashCode() {
            return (((((this.a.hashCode() * 31) + this.c) * 31) + (this.f2098d ? 1231 : 1237)) * 31) + this.f2099e;
        }
        ...
        public String toString() {
            ...
            h2.append('\'');
            h2.append(", notNull=");
            h2.append(this.f2098d);
            h2.append(", primaryKeyPosition=");
            h2.append(this.f2099e);
            h2.append(", defaultValue='");
            h2.append(this.f2100f);
            h2.append('\'');
            h2.append('}');
            return h2.toString();
        }
    ...
    public static class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final List<String> f2102d;

        /* renamed from: e  reason: collision with root package name */
        public final List<String> f2103e;

        public b(String str, String str2, String str3, List<String> list, List<String> list2) {
            this.a = str;
            this.b = str2;
            this.c = str3;
            this.f2102d = Collections.unmodifiableList(list);
            this.f2103e = Collections.unmodifiableList(list2);
        }
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            if (this.a.equals(bVar.a) && this.b.equals(bVar.b) && this.c.equals(bVar.c) && this.f2102d.equals(bVar.f2102d)) {
                return this.f2103e.equals(bVar.f2103e);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            int hashCode3 = this.f2102d.hashCode();
            return this.f2103e.hashCode() + ((hashCode3 + ((hashCode2 + ((hashCode + (this.a.hashCode() * 31)) * 31)) * 31)) * 31);
        }
        ...
        public String toString() {
            ...
            h2.append(this.f2102d);
            h2.append(", referenceColumnNames=");
            h2.append(this.f2103e);
            h2.append('}');
            return h2.toString();
        }
    }
    ...
    /* renamed from: e.v.p.d$d  reason: collision with other inner class name */
    /* loaded from: classes.dex */
    ...
    public d(String str, Map<String, a> map, Set<b> set, Set<C0062d> set2) {
        ...
        this.f2097d = set2 == null ? null : Collections.unmodifiableSet(set2);
    }

    public static d a(e.x.a.b bVar, String str) {
        int i2;
        int i3;
        List<c> list;
        int i4;
                ...
                while (i5 < count) {
                    ...
                    if (t.getInt(columnIndex7) != 0) {
                        ...
                        while (it.hasNext()) {
                            c cVar = (c) it.next();
                            if (cVar.b == i6) {
                                arrayList.add(cVar.f2104d);
                                arrayList2.add(cVar.f2105e);
                            }
                            b2 = b2;
                            count = count;
                        }
                    ...
                    if (columnIndex11 != -1 && columnIndex12 != -1 && columnIndex13 != -1) {
                        ...
                        while (t.moveToNext()) {
                            if ("c".equals(t.getString(columnIndex12))) {
                                C0062d c2 = c(aVar, t.getString(columnIndex11), t.getInt(columnIndex13) == 1);
                                if (c2 != null) {
                                    hashSet3.add(c2);
                                }
                            }
    ...
    public static C0062d c(e.x.a.b bVar, String str, boolean z) {
        Cursor t = ((e.x.a.f.a) bVar).t(f.a.a.a.a.c("PRAGMA index_xinfo(`", str, "`)"));
        try {
    ...
    public boolean equals(Object obj) {
        ...
        Set<C0062d> set3 = this.f2097d;
        if (set3 == null || (set = dVar.f2097d) == null) {
            return true;
        }
