...
public class b extends h {
    ...
    public static final Property<i, PointF> B = new C0067b(PointF.class, "topLeft");
    ...
    /* loaded from: classes.dex */
    public static class C0067b extends Property<i, PointF> {
        ...
        public void set(i iVar, PointF pointF) {
            ...
            iVar2.b = round;
            int i2 = iVar2.f2125f + 1;
            iVar2.f2125f = i2;
            if (i2 == iVar2.f2126g) {
                s.b(iVar2.f2124e, iVar2.a, round, iVar2.c, iVar2.f2123d);
                iVar2.f2125f = 0;
                iVar2.f2126g = 0;
            }
        }
    ...
    public static class c extends Property<i, PointF> {
        ...
        public void set(i iVar, PointF pointF) {
            ...
            int round = Math.round(pointF2.y);
            iVar2.f2123d = round;
            int i2 = iVar2.f2126g + 1;
            iVar2.f2126g = i2;
            if (iVar2.f2125f == i2) {
                s.b(iVar2.f2124e, iVar2.a, iVar2.b, iVar2.c, round);
                iVar2.f2125f = 0;
                iVar2.f2126g = 0;
            }
        }
    ...
    public Animator k(ViewGroup viewGroup, p pVar, p pVar2) {
        ...
        if (i2 != 2) {
            ...
            bVar = this;
            i iVar = new i(view);
            ObjectAnimator d1 = m.e.d1(iVar, B, bVar.u.a((float) i3, (float) i5, (float) i4, (float) i6));
            ObjectAnimator d12 = m.e.d1(iVar, C, bVar.u.a((float) i7, (float) i9, (float) i8, (float) i10));
        ...
        objectAnimator = m.e.d1(view, property, path);
        if (view.getParent() instanceof ViewGroup) {
        }
        return objectAnimator;
    }
