...
public class a {
    ...
    public static boolean q(l1 l1Var, int i2, c cVar, int i3) {
        return cVar.a(i3, l1Var.b().get(i2).b());
    }

    public static String r(l lVar, StringBuilder sb, String str) {
        sb.append(lVar.c());
        sb.append(str);
        sb.append(lVar.n());
        return sb.toString();
    ...
    public static String s(f.b.e.a.a aVar, StringBuilder sb) {
        sb.append(aVar.U());
        sb.append(aVar.Q());
        return sb.toString();
    }
    ...
    public static String w(String str, m mVar, String str2) {
