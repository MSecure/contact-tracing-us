...
public class c {
    ...
    public static final Comparator<byte[]> f2185e = new a();
    ...
    public synchronized void b(byte[] bArr) {
        if (bArr != null) {
            if (bArr.length <= this.f2186d) {
                this.a.add(bArr);
                int binarySearch = Collections.binarySearch(this.b, bArr, f2185e);
                if (binarySearch < 0) {
