...
public abstract class d {
    ...
    public static abstract class a {
        public d a() {
            ...
            int i3;
            a.b bVar = (a.b) this;
            Integer num = bVar.f2210d;
            if (num != null) {
                if (num.intValue() > 0) {
                    Integer num2 = bVar.f2210d;
                    if (num2 != null) {
                        i2 = num2.intValue();
                    } else {
                ...
                if (num3 != null) {
                    ...
                    if (bVar.b == null) {
                        str = f.a.a.a.a.x(str, " intervalNumber");
                    }
                    if (bVar.c == null) {
                        str = f.a.a.a.a.x(str, " rollingPeriod");
                    }
                    if (bVar.f2210d == null) {
                        str = f.a.a.a.a.x(str, " transmissionRisk");
                    }
                    if (str.isEmpty()) {
                        return new a(bVar.a, bVar.b.intValue(), bVar.c.intValue(), bVar.f2210d.intValue(), null);
                    }
