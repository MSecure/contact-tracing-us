...
public class o0 extends i0 {
    ...
    public View V(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View inflate = layoutInflater.inflate(R.layout.fragment_onboarding_en_turndown, viewGroup, false);
            ...
            if (textView != null) {
                ...
                if (textView2 != null) {
                    ...
                    if (nestedScrollView != null) {
                        ...
                        this.b0 = new s(linearLayout, button, textView, textView2, nestedScrollView);
                        return linearLayout;
                    }
                }
            }
    ...
    public void m0(View view, Bundle bundle) {
        ...
        this.b0.b.setOnClickListener(new View.OnClickListener() { // from class: f.b.a.a.a.f0.n
