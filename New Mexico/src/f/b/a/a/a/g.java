...
public class g implements b {
    ...
    public ListenableWorker a(Context context, WorkerParameters workerParameters) {
        ...
        return new SmsVerificationWorker(context, workerParameters, kVar.x.get(), kVar.b(), kVar.j(), kVar.t(), m.e.j1(kVar.b), kVar.v.get(), kVar.G.get(), kVar.z.get(), kVar.H.get(), kVar.v(), m.e.k1(kVar.f2293e));
    }
}
