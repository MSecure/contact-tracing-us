...
public final class d extends z<d, b> implements e {
    ...
    public static final int RPC_CALL_RESULT_FIELD_NUMBER;
    public static final int RPC_CALL_TYPE_FIELD_NUMBER;
    ...
    public static final class b extends z.a<d, b> implements e {
        ...
        @Override // f.b.a.a.a.h0.e
        public EnumC0076d getRpcCallType() {
        ...
        public b setRpcCallType(EnumC0076d dVar) {
            copyOnWrite();
    ...
    public enum c implements c0.c {
        ...
        public static final int RESULT_FAILED_GENERIC_4XX_VALUE;
        public static final int RESULT_FAILED_GENERIC_5XX_VALUE;
        public static final int RESULT_FAILED_NETWORK_ERROR_VALUE;
        public static final int RESULT_FAILED_NO_CONNECTION_VALUE;
        public static final int RESULT_FAILED_PARSING_VALUE;
        public static final int RESULT_FAILED_TIMEOUT_VALUE;
        public static final int RESULT_FAILED_UNAUTHORIZED_CLIENT_VALUE;
        public static final int RESULT_FAILED_UNKNOWN_VALUE;
        public static final int RESULT_SUCCESS_VALUE;
        ...
        public static c forNumber(int i2) {
            switch (i2) {
                ...
                case 8:
                    return RESULT_FAILED_UNAUTHORIZED_CLIENT;
                default:
                    return null;
            }
        }
    ...
    /* renamed from: f.b.a.a.a.h0.d$d */
    /* loaded from: classes.dex */
    public enum EnumC0076d implements c0.c {
        RPC_TYPE_UNKNOWN(0),
        ...
        public static final int RPC_TYPE_ENPA_REMOTE_CONFIG_FETCH_VALUE;
        public static final int RPC_TYPE_KEYS_DOWNLOAD_VALUE;
        public static final int RPC_TYPE_KEYS_UPLOAD_VALUE;
        public static final int RPC_TYPE_UNKNOWN_VALUE;
        public static final int RPC_TYPE_VERIFICATION_VALUE;
        private static final c0.d<EnumC0076d> internalValueMap = new a();
        private final int value;

        /* renamed from: f.b.a.a.a.h0.d$d$a */
        /* loaded from: classes.dex */
        public class a implements c0.d<EnumC0076d> {
            @Override // f.b.g.c0.d
            public EnumC0076d findValueByNumber(int i2) {
                return EnumC0076d.forNumber(i2);
            }
        }

        /* renamed from: f.b.a.a.a.h0.d$d$b */
        /* loaded from: classes.dex */
        public static final class b implements c0.e {
            public static final c0.e INSTANCE = new b();
            ...
            @Override // f.b.g.c0.e
            public boolean isInRange(int i2) {
                return EnumC0076d.forNumber(i2) != null;
            }
        }
        ...
        public static EnumC0076d forNumber(int i2) {
            if (i2 == 0) {
        ...
        public static c0.d<EnumC0076d> internalGetValueMap() {
            return internalValueMap;
        }
        ...
        @Deprecated
        public static EnumC0076d valueOf(int i2) {
            return forNumber(i2);
        }
    ...
    public void clearRpcCallResult() {
        this.bitField0_ &= -5;
    ...
    public void setRpcCallResult(c cVar) {
        this.rpcCallResult_ = cVar.getNumber();
        this.bitField0_ |= 4;
    }

    public void setRpcCallType(EnumC0076d dVar) {
    ...
    public final Object dynamicMethod(z.f fVar, Object obj, Object obj2) {
        switch (fVar.ordinal()) {
            ...
            case 1:
                return null;
            case 2:
                return z.newMessageInfo(DEFAULT_INSTANCE, "\u0001\u0005\u0000\u0001\u0001\u0005\u0005\u0000\u0000\u0000\u0001\b\u0000\u0002\f\u0001\u0003\f\u0002\u0004\u0004\u0003\u0005\u0004\u0004", new Object[]{"bitField0_", "healthAuthority_", "rpcCallType_", EnumC0076d.internalGetVerifier(), "rpcCallResult_", c.internalGetVerifier(), "payloadSize_", "count_"});
            case 3:
                return new d();
            case 4:
                return new b(null);
    ...
    @Override // f.b.a.a.a.h0.e
    public EnumC0076d getRpcCallType() {
        EnumC0076d forNumber = EnumC0076d.forNumber(this.rpcCallType_);
        return forNumber == null ? EnumC0076d.RPC_TYPE_UNKNOWN : forNumber;
    }
