...
public final class l extends z<l, b> implements Object {
    ...
    public static final class b extends z.a<l, b> implements Object {
        ...
        public b addKeys(int i2, k.b bVar) {
            copyOnWrite();
            ((l) this.instance).addKeys(i2, bVar.build());
            return this;
        }
        ...
        public b addKeys(k.b bVar) {
            copyOnWrite();
            ((l) this.instance).addKeys(bVar.build());
            return this;
        }
        ...
        public b addSignatureInfos(int i2, f.b bVar) {
            copyOnWrite();
            ((l) this.instance).addSignatureInfos(i2, bVar.build());
            return this;
        }
        ...
        public b addSignatureInfos(f.b bVar) {
            copyOnWrite();
            ((l) this.instance).addSignatureInfos(bVar.build());
            return this;
        }
        ...
        public b setKeys(int i2, k.b bVar) {
            copyOnWrite();
            ((l) this.instance).setKeys(i2, bVar.build());
            return this;
        }
        ...
        public b setSignatureInfos(int i2, f.b bVar) {
            copyOnWrite();
            ((l) this.instance).setSignatureInfos(i2, bVar.build());
            return this;
        }
    ...
    public void addAllKeys(Iterable<? extends k> iterable) {
        ensureKeysIsMutable();
        f.b.g.a.addAll((Iterable) iterable, (List) this.keys_);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void addAllSignatureInfos(Iterable<? extends f> iterable) {
        ensureSignatureInfosIsMutable();
        f.b.g.a.addAll((Iterable) iterable, (List) this.signatureInfos_);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void addKeys(int i2, k kVar) {
        kVar.getClass();
        ensureKeysIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addSignatureInfos(int i2, f fVar) {
        fVar.getClass();
        ensureSignatureInfosIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void addSignatureInfos(f fVar) {
        fVar.getClass();
        ensureSignatureInfosIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void clearSignatureInfos() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void removeSignatureInfos(int i2) {
        ensureSignatureInfosIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setKeys(int i2, k kVar) {
        kVar.getClass();
        ensureKeysIsMutable();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setSignatureInfos(int i2, f fVar) {
        fVar.getClass();
        ensureSignatureInfosIsMutable();
