...
public class g0 implements Callable<List<j0>> {
    public final /* synthetic */ i a;
    public final /* synthetic */ CancellationSignal b;
    public final /* synthetic */ d0 c;

    public g0(d0 d0Var, i iVar, CancellationSignal cancellationSignal) {
        this.c = d0Var;
        this.a = iVar;
    ...
    public List<j0> call() {
        ...
        try {
            ...
            while (b.moveToNext()) {
                arrayList.add(j0.a(b.getLong(h0), b.getLong(h02), m.e.P1(b.getString(h03)), b.getString(h04), b.getString(h05), b.getString(h06), m.e.Q1(b.getString(h07)), b.getInt(h09) != 0, m.e.O1(b.getString(h08)), m.e.N1(b.getString(h010)), b.getString(h011), m.e.R1(b.getString(h012)), b.getInt(h013) != 0, b.getLong(h014), b.getInt(h015) != 0));
                h015 = h015;
                h0 = h0;
                h014 = h014;
            }
