...
public final class a extends d {
    ...
    public boolean equals(Object obj) {
        ...
        d dVar = (d) obj;
        return this.b == dVar.e() && this.c == dVar.c() && this.f2657d == dVar.a() && this.f2658e == dVar.b() && this.f2659f == dVar.d();
    }

    public int hashCode() {
        long j2 = this.b;
        long j3 = this.f2658e;
        return this.f2659f ^ ((((((((((int) (j2 ^ (j2 >>> 32))) ^ 1000003) * 1000003) ^ this.c) * 1000003) ^ this.f2657d) * 1000003) ^ ((int) ((j3 >>> 32) ^ j3))) * 1000003);
    }
    ...
    public String toString() {
        ...
        h2.append(this.f2657d);
        h2.append(", eventCleanUpAge=");
        h2.append(this.f2658e);
        h2.append(", maxBlobByteSizePerRow=");
        h2.append(this.f2659f);
        h2.append("}");
        return h2.toString();
    }
}
