...
public final class p {
    ...
    public static String e(Context context, int i2) {
        ...
        if (i2 == 2) {
            return f.b.a.c.b.o.b.a1(context) ? resources.getString(R$string.common_google_play_services_wear_update_text) : resources.getString(R$string.common_google_play_services_update_text, d2);
        }
        if (i2 == 3) {
