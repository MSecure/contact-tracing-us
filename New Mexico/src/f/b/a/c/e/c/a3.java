...
public abstract class a3<E> extends x2<E> implements List<E>, RandomAccess {
    public static final w2<Object> c = new y2(d3.f2763f, 0);

    public static <E> a3<E> p(Object[] objArr, int i2) {
        return i2 == 0 ? (a3<E>) d3.f2763f : new d3(objArr, i2);
    }
    ...
    @Override // f.b.a.c.e.c.x2, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.List
    ...
    public a3<E> subList(int i2, int i3) {
        b.U1(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? (a3<E>) d3.f2763f : new z2(this, i2, i4);
    }
    ...
    public final w2<E> listIterator(int i2) {
        ...
        throw new IndexOutOfBoundsException(b.W1(i2, size, "index"));
    }
