...
public final class a {
    ...
    public static boolean a(Context context) {
        ...
        HashMap<String, Boolean> hashMap = u2.f2779g;
        ...
        synchronized (u2.class) {
            u2.a(contentResolver);
            Object obj2 = u2.f2783k;
            if (u2.f2778f.containsKey("gms:nearby:requires_gms_check")) {
                String str2 = u2.f2778f.get("gms:nearby:requires_gms_check");
                if (str2 != null) {
                    str = str2;
                }
            } else {
                int length = u2.f2784l.length;
        ...
        if (str != null && !str.equals("")) {
            if (!u2.c.matcher(str).matches()) {
                if (u2.f2776d.matcher(str).matches()) {
                    bool2 = Boolean.FALSE;
                    z = false;
                }
            }
            synchronized (u2.class) {
                if (obj == u2.f2783k) {
                    ...
                    u2.f2778f.remove("gms:nearby:requires_gms_check");
                }
            }
            return z;
        }
