...
public class r implements z {
    ...
    /* renamed from: d */
    public static final c f2865d;

    /* renamed from: e */
    public static final a f2866e = a.a;
    ...
    static {
        ...
        d dVar = new d();
        dVar.h("yyyyMMdd");
        f2865d = dVar.r(locale).h(l.b.a.r.f4641g);
    }
    ...
    public boolean a(String str, Map<String, Object> map, f.b.a.d.a.i0.d dVar, b bVar, long j2) {
        ...
        a aVar = f2866e;
        c cVar = f2865d;
        String c = aVar.c(b("ENPA::alias", this.b, str, cVar.b(e.y())));
        if (instance.containsAlias(c)) {
        ...
        byte[] b = b("ENPA::attestation", this.b, str, cVar.b(e.y()));
        Context context = this.a;
        KeyPairGenerator instance2 = KeyPairGenerator.getInstance("EC", "AndroidKeyStore");
        try {
            KeyGenParameterSpec.Builder keyValidityEnd = new KeyGenParameterSpec.Builder(c, 12).setDigests("SHA-256").setAttestationChallenge(b).setKeyValidityEnd(new Date(v.G()));
            ...
            instance3.update(g2.build().toByteArray());
            map.put("signature", aVar.c(instance3.sign()));
            Certificate[] certificateChain = instance.getCertificateChain(c);
            ArrayList arrayList = new ArrayList(certificateChain.length);
            for (Certificate certificate : certificateChain) {
                arrayList.add(f2866e.c(certificate.getEncoded()));
            }
