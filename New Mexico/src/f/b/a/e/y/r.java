...
public class r extends m {
    ...
    public final TextWatcher f3157e = new a();

    /* renamed from: f  reason: collision with root package name */
    public final TextInputLayout.f f3158f = new b();

    /* renamed from: g  reason: collision with root package name */
    public final TextInputLayout.g f3159g = new c();
    ...
    public class b implements TextInputLayout.f {
        ...
        public void a(TextInputLayout textInputLayout) {
            ...
            r rVar = r.this;
            rVar.c.setChecked(!r.e(rVar));
            editText.removeTextChangedListener(r.this.f3157e);
            editText.addTextChangedListener(r.this.f3157e);
        }
    }
    ...
    public class c implements TextInputLayout.g {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                this.b.removeTextChangedListener(r.this.f3157e);
            }
        }
    ...
    public void a() {
        ...
        this.a.a(this.f3158f);
        this.a.k0.add(this.f3159g);
