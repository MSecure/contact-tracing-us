...
public abstract class d<K, V> implements Map<K, V>, Serializable {
    ...
    public static class a<K, V> {
        ...
        public a<K, V> b(K k2, V v) {
            ...
            if (i2 > objArr.length) {
                this.a = Arrays.copyOf(objArr, b.AbstractC0105b.b(objArr.length, i2));
                this.c = false;
            }
    ...
    public e<Map.Entry<K, V>> entrySet() {
        ...
        h hVar = (h) this;
        h.a aVar = new h.a(hVar, hVar.f3395f, 0, hVar.f3396g);
        this.b = aVar;
        return aVar;
    }
    ...
    /* renamed from: c */
    public b<V> values() {
        b<V> bVar = this.f3388d;
        if (bVar != null) {
            return bVar;
        }
        h hVar = (h) this;
        h.c cVar = new h.c(hVar.f3395f, 1, hVar.f3396g);
        this.f3388d = cVar;
        return cVar;
    }
    ...
    @Override // java.util.Map, java.lang.Object
    public int hashCode() {
        return f.b.a.c.b.o.b.Q0(entrySet());
    }
    ...
    public Set keySet() {
        ...
        h hVar = (h) this;
        h.b bVar = new h.b(hVar, new h.c(hVar.f3395f, 0, hVar.f3396g));
        this.c = bVar;
        return bVar;
    }
