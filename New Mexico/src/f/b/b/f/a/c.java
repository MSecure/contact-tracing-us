...
public abstract class c extends AbstractExecutorService implements w {
    ...
    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService, f.b.b.f.a.w
    /* renamed from: submit */
    public u<?> mo18submit(Runnable runnable) {
        return (u) super.submit(runnable);
    }

    @Override // java.util.concurrent.AbstractExecutorService, java.util.concurrent.ExecutorService, f.b.b.f.a.w
    /* renamed from: submit  reason: collision with other method in class */
    public Future mo18submit(Runnable runnable) {
        return (u) super.submit(runnable);
    }
