...
public abstract class k<K, V> implements i<K, V> {
    ...
    public i<K, V> d(K k2, V v, Comparator<K> comparator) {
        ...
        return (compare < 0 ? j(null, null, this.c.d(k2, v, comparator), null) : compare == 0 ? j(k2, v, null, null) : j(null, null, null, this.f3488d.d(k2, v, comparator))).k();
    }
    ...
    public i<K, V> e(K k2, Comparator<K> comparator) {
        ...
        if (comparator.compare(k2, this.a) < 0) {
            ...
            if (!q.f3488d.isEmpty() && !q.f3488d.g() && !((k) q.f3488d).c.g()) {
                q = q.h();
                if (q.c.c().g()) {
                    q = q.q().h();
                }
            ...
            if (comparator.compare(k2, q.a) == 0) {
                ...
                i<K, V> f2 = q.f3488d.f();
                q = q.j(f2.getKey(), f2.getValue(), null, ((k) q.f3488d).o());
            }
            kVar = q.j(null, null, null, q.f3488d.e(k2, comparator));
        }
        return kVar.k();
    }
    ...
    public final k<K, V> h() {
        i<K, V> iVar = this.c;
        i<K, V> b = iVar.b(null, null, n(iVar), null, null);
        i<K, V> iVar2 = this.f3488d;
        return i(null, null, g() ? i.a.BLACK : i.a.RED, b, iVar2.b(null, null, n(iVar2), null, null));
    }
    ...
    public final k<K, V> k() {
        k<K, V> p = (!this.f3488d.g() || this.c.g()) ? this : p();
        if (p.c.g() && ((k) p.c).c.g()) {
            p = p.q();
        }
        return (!p.c.g() || !p.f3488d.g()) ? p : p.h();
    }
    ...
    public final k<K, V> m() {
        k<K, V> h2 = h();
        return h2.f3488d.c().g() ? h2.j(null, null, null, ((k) h2.f3488d).q()).p().h() : h2;
    }
    ...
    public final k<K, V> p() {
        return (k) this.f3488d.b(null, null, l(), i(null, null, i.a.RED, null, ((k) this.f3488d).c), null);
    }

    public final k<K, V> q() {
        return (k) this.c.b(null, null, l(), null, i(null, null, i.a.RED, ((k) this.c).f3488d, null));
    }
