...
public class l<K, V> extends d<K, V> {
    ...
    public static class b<A, B, C> {
        ...
        public final d.a.AbstractC0113a<A, B> c;
        ...
        public b(List<A> list, Map<B, C> map, d.a.AbstractC0113a<A, B> aVar) {
            this.a = list;
            this.b = map;
            this.c = aVar;
        }

        public static <A, B, C> l<A, C> b(List<A> list, Map<B, C> map, d.a.AbstractC0113a<A, B> aVar, Comparator<A> comparator) {
            i.a aVar2 = i.a.BLACK;
            b bVar = new b(list, map, aVar);
            Collections.sort(list, comparator);
            a.C0114a aVar3 = new a.C0114a();
            int size = list.size();
            while (aVar3.hasNext()) {
                C0115b bVar2 = (C0115b) aVar3.next();
                int i2 = bVar2.b;
                size -= i2;
                boolean z = bVar2.a;
