...
public final class j extends e {
    ...
    public i b(i iVar, h hVar) {
        g(iVar);
        b.P0(hVar.b == null, "Transform results received by PatchMutation.", new Object[0]);
        if (!this.b.c(iVar)) {
    ...
    public final k h(i iVar) {
        ...
        for (h hVar : this.f3631d.a) {
            if (!hVar.l()) {
                s c = this.c.c(hVar);
                if (c == null) {
                    b.P0(!hVar.l(), "Cannot delete field for empty path on ObjectValue", new Object[0]);
                    aVar.d(hVar, null);
                } else {
                    aVar.c(hVar, c);
                }
