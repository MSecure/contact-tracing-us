...
public final class h0 {
    ...
    public static l r(l lVar) {
        f.b.a.c.b.o.b.P0(lVar.n() > 4 && lVar.i(4).equals("documents"), "Tried to deserialize invalid key %s", lVar);
        return lVar.o(5);
    }

    public f a(String str) {
        l d2 = d(str);
        f.b.a.c.b.o.b.P0(d2.i(1).equals(this.a.b), "Tried to deserialize key from different project.", new Object[0]);
        f.b.a.c.b.o.b.P0(d2.i(3).equals(this.a.c), "Tried to deserialize key from different database.", new Object[0]);
        return new f(r(d2));
    }
    ...
    public e b(t tVar) {
        ...
        if (tVar.p()) {
            ...
            if (ordinal == 0) {
                ...
                f.b.a.c.b.o.b.r0("Unknown precondition", new Object[0]);
                throw null;
            }
        } else {
            kVar = k.c;
        ...
        if (ordinal2 != 0) {
            ...
            if (ordinal2 == 3) {
                ...
                for (i.c cVar : tVar.l().g()) {
                    ...
                    if (ordinal3 == 0) {
                        f.b.a.c.b.o.b.P0(cVar.l() == i.c.b.REQUEST_TIME, "Unknown transform setToServerValue: %s", cVar.l());
                        ...
                        dVar = new d(h.r(cVar.i()), new a.C0117a(cVar.k().a()));
                    } else {
                        f.b.a.c.b.o.b.r0("Unknown FieldTransform proto: %s", cVar);
                        throw null;
                    }
                    arrayList.add(dVar);
                }
                ...
                f.b.a.c.b.o.b.P0(z, "Transforms only support precondition \"exists == true\"", new Object[0]);
                return new n(a(tVar.l().f()), arrayList);
            }
            f.b.a.c.b.o.b.r0("Unknown mutation operation: %d", tVar.k());
            throw null;
        } else if (!tVar.q()) {
            return new m(a(tVar.m().h()), f.b.c.k.u.k.b(tVar.m().g()), kVar);
        } else {
            f a = a(tVar.m().h());
            f.b.c.k.u.k b = f.b.c.k.u.k.b(tVar.m().g());
            g n = tVar.n();
            int f2 = n.f();
            ...
            return new j(a, b, new c(hashSet), kVar);
        }
    }
    ...
    public final l d(String str) {
        l s = l.s(str);
        f.b.a.c.b.o.b.P0(s.n() >= 4 && s.i(0).equals("projects") && s.i(2).equals("databases"), "Tried to deserialize invalid key %s", s);
        return s;
    }
    ...
    public t k(e eVar) {
        ...
        if (eVar instanceof m) {
            ...
            r.copyOnWrite();
            t.f((t) r.instance, g3);
            f.b.c.k.u.p.c cVar2 = jVar.f3631d;
            g.b g4 = g.g();
            for (h hVar : cVar2.a) {
                String c = hVar.c();
                g4.copyOnWrite();
            ...
            for (f.b.c.k.u.p.d dVar : nVar.c) {
                ...
                if (oVar instanceof f.b.c.k.u.p.l) {
                    ...
                    if (oVar instanceof a.b) {
                        ...
                        aVar.copyOnWrite();
                        i.c.c((i.c) aVar.instance, j3.build());
                    } else if (oVar instanceof a.C0117a) {
                        aVar = i.c.n();
                        aVar.b(dVar.a.c());
                        a.b j4 = f.b.d.a.a.j();
                        List<s> list2 = ((a.C0117a) oVar).a;
                        j4.copyOnWrite();
                        f.b.d.a.a.d((f.b.d.a.a) j4.instance, list2);
                        aVar.copyOnWrite();
                        i.c.e((i.c) aVar.instance, j4.build());
                        ...
                        f.b.a.c.b.o.b.r0("Unknown transform: %s", oVar);
                        throw null;
                    }
                    cVar = aVar.build();
                }
                h2.copyOnWrite();
                i.d((i) h2.instance, cVar);
            }
            r.copyOnWrite();
            t.c((t) r.instance, h2.build());
            ...
            f.b.a.c.b.o.b.r0("unknown mutation type %s", eVar.getClass());
            throw null;
        }
        if (!eVar.b.b()) {
            k kVar = eVar.b;
            f.b.a.c.b.o.b.P0(!kVar.b(), "Can't serialize an empty precondition", new Object[0]);
            o.b i2 = o.i();
    ...
    public q.d m(c0 c0Var) {
        ...
        p.b v = f.b.d.a.p.v();
        l lVar = c0Var.f3525d;
        if (c0Var.f3526e != null) {
            f.b.a.c.b.o.b.P0(lVar.n() % 2 == 0, "Collection Group queries should be within a document path or root.", new Object[0]);
            String n = n(this.a, lVar);
            h2.copyOnWrite();
            q.d.d((q.d) h2.instance, n);
            p.c.a g2 = p.c.g();
            String str = c0Var.f3526e;
            g2.copyOnWrite();
            p.c.c((p.c) g2.instance, str);
            g2.copyOnWrite();
            p.c.d((p.c) g2.instance, true);
            v.copyOnWrite();
            f.b.d.a.p.c((f.b.d.a.p) v.instance, g2.build());
        } else {
            f.b.a.c.b.o.b.P0(lVar.n() % 2 != 0, "Document queries with filters are not supported.", new Object[0]);
            String l2 = l(lVar.q());
            h2.copyOnWrite();
            ...
            v.copyOnWrite();
            f.b.d.a.p.c((f.b.d.a.p) v.instance, g3.build());
        }
        if (c0Var.c.size() > 0) {
            ...
            for (f.b.c.k.s.i iVar : list) {
                if (iVar instanceof f.b.c.k.s.h) {
                    ...
                    if (aVar2 == aVar3 || aVar2 == i.a.NOT_EQUAL) {
                        ...
                        aVar = p.h.k();
                        aVar.copyOnWrite();
                        p.h.c((p.h) aVar.instance, h4.build());
                    ...
                    switch (aVar4.ordinal()) {
                        ...
                        case 9:
                            ...
                            break;
                        default:
                            f.b.a.c.b.o.b.r0("Unknown operator %d", aVar4);
                            throw null;
                    }
                    j2.copyOnWrite();
                    ...
                    aVar = p.h.k();
                    aVar.copyOnWrite();
                    p.h.b((p.h) aVar.instance, j2.build());
                    arrayList.add((p.h) aVar.build());
                }
            }
            if (list.size() == 1) {
                ...
                p.h.a k2 = p.h.k();
                k2.copyOnWrite();
                p.h.e((p.h) k2.instance, h5.build());
                obj = k2.build();
            }
            v.copyOnWrite();
        ...
        for (w wVar : c0Var.b) {
            ...
            v.copyOnWrite();
            f.b.d.a.p.e((f.b.d.a.p) v.instance, g4.build());
        }
        if (c0Var.b()) {
            a0.b f2 = a0.f();
            f.b.a.c.b.o.b.P0(c0Var.b(), "Called getLimit when no limit was set", new Object[0]);
            int i5 = (int) c0Var.f3527f;
            f2.copyOnWrite();
            a0.c((a0) f2.instance, i5);
            v.copyOnWrite();
            f.b.d.a.p.h((f.b.d.a.p) v.instance, f2.build());
        }
        f.b.c.k.s.c cVar = c0Var.f3528g;
        if (cVar != null) {
            f.b.d.a.c f3 = f(cVar);
            v.copyOnWrite();
            f.b.d.a.p.f((f.b.d.a.p) v.instance, f3);
        }
        f.b.c.k.s.c cVar2 = c0Var.f3529h;
        if (cVar2 != null) {
