...
public class t0 extends b<u, v, a> {
    ...
    public void j(List<e> list) {
        f.b.a.c.b.o.b.P0(c(), "Writing mutations requires an opened stream", new Object[0]);
        f.b.a.c.b.o.b.P0(this.q, "Handshake must be complete before writing mutations", new Object[0]);
        u.b g2 = u.g();
        for (e eVar : list) {
            t k2 = this.p.k(eVar);
            g2.copyOnWrite();
