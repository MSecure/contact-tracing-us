...
public class h {
    ...
    public static class a<T> {
        ...
        public final Map<String, Method> f3694d = new HashMap();
        public final Map<String, Method> c = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        public final Map<String, Field> f3695e = new HashMap();

        /* renamed from: f  reason: collision with root package name */
        public final HashSet<String> f3696f = new HashSet<>();

        /* renamed from: g  reason: collision with root package name */
        public final HashSet<String> f3697g = new HashSet<>();

        /* JADX WARN: Removed duplicated region for block: B:112:0x031a  */
        /* JADX WARN: Removed duplicated region for block: B:156:0x02bd A[SYNTHETIC] */
        ...
        public a(Class<T> cls) {
            ...
            do {
                ...
                for (Method method2 : declaredMethods) {
                    if (method2.getName().startsWith("set") && !method2.getDeclaringClass().equals(Object.class) && !Modifier.isStatic(method2.getModifiers()) && method2.getReturnType().equals(Void.TYPE) && method2.getParameterTypes().length == 1 && !method2.isAnnotationPresent(d.class)) {
                        ...
                        if (str == null) {
                            ...
                            Method method3 = this.f3694d.get(f3);
                            if (method3 == null) {
                                method2.setAccessible(true);
                                this.f3694d.put(f3, method2);
                                if (method2.isAnnotationPresent(n.class)) {
                                    ...
                                    d("Method", "accepts", method2.getParameterTypes()[c2]);
                                    this.f3697g.add(f(method2));
                                }
                            } else {
                ...
                for (Field field2 : declaredFields) {
                    String e2 = e(field2);
                    if (this.b.containsKey(e2.toLowerCase(Locale.US)) && !this.f3695e.containsKey(e2)) {
                        field2.setAccessible(true);
                        this.f3695e.put(e2, field2);
                        c(field2);
                    }
                }
            ...
            if (!this.b.isEmpty()) {
                Iterator<String> it = this.f3697g.iterator();
                while (it.hasNext()) {
                    String next = it.next();
                    if (!(this.f3694d.containsKey(next) || this.f3695e.containsKey(next))) {
        ...
        public static String f(Method method) {
            ...
            throw new IllegalArgumentException(f.a.a.a.a.x("Unknown Bean prefix for method: ", name));
        }
    ...
    public static class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f3698d = new b(null, null, 0);
        public final int a;
        public final b b;
    ...
    public static void a(boolean z, String str) {
        if (!z) {
            throw new RuntimeException(f.a.a.a.a.x("Hard assert failed: ", str));
        }
    }
                        ...
                        for (String str2 : aVar.b.values()) {
                            if (!aVar.f3697g.contains(str2)) {
                                if (aVar.c.containsKey(str2)) {
                                    ...
                                    Field field = aVar.f3695e.get(str2);
                                    if (field != null) {
                                        try {
                                            obj = field.get(t);
                                        ...
                                        throw new IllegalStateException(f.a.a.a.a.x("Bean property without field or getter: ", str2));
                                    }
                                }
                                if (!aVar.f3696f.contains(str2) || obj != null) {
    ...
    public static IllegalArgumentException c(b bVar, String str) {
        String x = f.a.a.a.a.x("Could not serialize object. ", str);
        if (bVar.a > 0) {
            StringBuilder i2 = f.a.a.a.a.i(x, " (found in field '");
