...
public final class i extends z<i, b> implements Object {
    ...
    public static final class c extends z<c, a> implements Object {
        ...
        public EnumC0124c m() {
            ...
            if (i2 == 0) {
                return EnumC0124c.TRANSFORMTYPE_NOT_SET;
            }
            switch (i2) {
                case 2:
                    return EnumC0124c.SET_TO_SERVER_VALUE;
                case 3:
                    return EnumC0124c.INCREMENT;
                case 4:
                    return EnumC0124c.MAXIMUM;
                case 5:
                    return EnumC0124c.MINIMUM;
                case 6:
                    return EnumC0124c.APPEND_MISSING_ELEMENTS;
                case 7:
                    return EnumC0124c.REMOVE_ALL_FROM_ARRAY;
                default:
                    return null;
            }
        }
