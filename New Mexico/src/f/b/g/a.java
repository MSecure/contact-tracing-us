...
public abstract class a<MessageType extends a<MessageType, BuilderType>, BuilderType extends AbstractC0126a<MessageType, BuilderType>> implements t0 {
    public int memoizedHashCode = 0;

    /* renamed from: f.b.g.a$a */
    /* loaded from: classes.dex */
    public static abstract class AbstractC0126a<MessageType extends a<MessageType, BuilderType>, BuilderType extends AbstractC0126a<MessageType, BuilderType>> implements t0.a {

        /* renamed from: f.b.g.a$a$a */
        /* loaded from: classes.dex */
        public static final class C0127a extends FilterInputStream {
            public int b;

            public C0127a(InputStream inputStream, int i2) {
                super(inputStream);
                this.b = i2;
            }
        ...
        public boolean mergeDelimitedFrom(InputStream inputStream, r rVar) {
            ...
            mergeFrom((InputStream) new C0127a(inputStream, k.t(read, inputStream)), rVar);
            return true;
        }
    ...
    @Deprecated
    public static <T> void addAll(Iterable<T> iterable, Collection<? super T> collection) {
        AbstractC0126a.addAll((Iterable) iterable, (List) collection);
    }

    public static <T> void addAll(Iterable<T> iterable, List<? super T> list) {
        AbstractC0126a.addAll((Iterable) iterable, (List) list);
    }
