...
public abstract class g implements h1 {
    ...
    public static final class b extends g {
        ...
        public b(ByteBuffer byteBuffer, boolean z) {
            ...
            this.f3865d = byteBuffer.limit() + byteBuffer.arrayOffset();
        }
            ...
            try {
                ...
                while (true) {
                    ...
                    if (M == Integer.MAX_VALUE) {
                        ...
                        obj2 = S(aVar.c, aVar.f3926d.getClass(), rVar);
                    }
                }
            } finally {
                this.f3865d = i2;
        ...
        public boolean p() {
            ...
            int i3;
            int i4;
            if (Q() || (i2 = this.f3866e) == (i3 = this.f3867f)) {
                return false;
            }
            int i5 = i2 & 7;
            if (i5 != 0) {
