...
public abstract class m extends i {
    ...
    public static final boolean c = v1.f3955h;
    public n a;
    ...
    public static abstract class b extends m {
        ...
        public final void f0(int i2) {
            if (m.c) {
                ...
                byte[] bArr2 = this.f3918d;
                int i4 = this.f3920f;
                this.f3920f = i4 + 1;
                v1.s(bArr2, (long) i4, (byte) i2);
                this.f3921g += (int) (((long) this.f3920f) - j2);
                return;
            }
            while ((i2 & -128) != 0) {
                byte[] bArr3 = this.f3918d;
                int i5 = this.f3920f;
                this.f3920f = i5 + 1;
        ...
        public final void g0(long j2) {
            if (m.c) {
                ...
                this.f3921g += (int) (((long) this.f3920f) - j3);
                return;
            }
            while ((j2 & -128) != 0) {
                byte[] bArr3 = this.f3918d;
    ...
    public static class c extends m {
        ...
        @Override // f.b.g.m
        public final int G() {
            return this.f3923e - this.f3924f;
        }
        ...
        public final void H(byte b) {
            try {
                ...
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3924f), Integer.valueOf(this.f3923e), 1), e2);
            }
        }
        ...
        public final void X(String str) {
            ...
            try {
                ...
                if (A2 == A) {
                    int i3 = i2 + A2;
                    this.f3924f = i3;
                    c = w1.c(str, this.f3922d, i3, G());
                    this.f3924f = i2;
                    a0((c - i2) - A2);
                } else {
                    a0(w1.d(str));
                    c = w1.c(str, this.f3922d, this.f3924f, G());
                }
                this.f3924f = c;
            } catch (w1.c e2) {
                this.f3924f = i2;
        ...
        public final void d0(byte[] bArr, int i2, int i3) {
            try {
                System.arraycopy(bArr, i2, this.f3922d, this.f3924f, i3);
                this.f3924f += i3;
            } catch (IndexOutOfBoundsException e2) {
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3924f), Integer.valueOf(this.f3923e), Integer.valueOf(i3)), e2);
            }
        }
    }
    ...
    public static class d extends IOException {
        public d(String str, Throwable th) {
            super(f.a.a.a.a.x("CodedOutputStream was writing to a flat byte array and ran out of space.: ", str), th);
        }
    ...
    public static final class e extends b {
        ...
        /* renamed from: h */
        public final OutputStream f3925h;

        public e(OutputStream outputStream, int i2) {
            super(i2);
            Objects.requireNonNull(outputStream, "out");
            this.f3925h = outputStream;
        }

        @Override // f.b.g.m
        public void H(byte b) {
            if (this.f3920f == this.f3919e) {
                h0();
            }
            byte[] bArr = this.f3918d;
            int i2 = this.f3920f;
            ...
            try {
                ...
                try {
                    if (A2 == A) {
                        int i6 = i5 + A2;
                        this.f3920f = i6;
                        int c2 = w1.c(str, this.f3918d, i6, this.f3919e - i6);
                        this.f3920f = i5;
                        i2 = (c2 - i5) - A2;
                        f0(i2);
                        this.f3920f = c2;
                        ...
                        i2 = w1.d(str);
                        f0(i2);
                        this.f3920f = w1.c(str, this.f3918d, this.f3920f, i2);
                    }
                    this.f3921g += i2;
                } catch (w1.c e2) {
                    this.f3921g -= this.f3920f - i5;
                    this.f3920f = i5;
                    throw e2;
        ...
        public final void h0() {
            this.f3925h.write(this.f3918d, 0, this.f3920f);
            this.f3920f = 0;
        }
        ...
        public void k0(byte[] bArr, int i2, int i3) {
            ...
            int i5 = this.f3920f;
            if (i4 - i5 >= i3) {
                System.arraycopy(bArr, i2, this.f3918d, i5, i3);
                this.f3920f += i3;
            } else {
                int i6 = i4 - i5;
                System.arraycopy(bArr, i2, this.f3918d, i5, i6);
                int i7 = i2 + i6;
                i3 -= i6;
                ...
                h0();
                if (i3 <= this.f3919e) {
                    System.arraycopy(bArr, i7, this.f3918d, 0, i3);
                    this.f3920f = i3;
                } else {
                    this.f3925h.write(bArr, i7, i3);
                }
            }
            this.f3921g += i3;
        }
