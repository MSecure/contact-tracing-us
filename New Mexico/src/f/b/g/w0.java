...
public final class w0<T> implements j1<T> {
    ...
    public void a(T t, T t2) {
        ...
        if (this.c) {
            l1.B(this.f3972d, t, t2);
        }
    }

    @Override // f.b.g.j1
    public final boolean b(T t) {
        return this.f3972d.c(t).j();
    }
    ...
    public boolean d(T t, T t2) {
        ...
        if (this.c) {
            return this.f3972d.c(t).equals(this.f3972d.c(t2));
        }
        return true;
    }

    /* JADX WARN: Removed duplicated region for block: B:31:0x00b4  */
    /* JADX WARN: Removed duplicated region for block: B:57:0x00b9 A[EDGE_INSN: B:57:0x00b9->B:32:0x00b9 ?: BREAK  , SYNTHETIC] */
    @Override // f.b.g.j1
            ...
            if (i4 == 11) {
                ...
                while (h0 < i3) {
                    ...
                    if (i7 != 2) {
                        if (i7 == 3) {
                            if (eVar != null) {
                                h0 = b.R(e1.c.a(eVar.c.getClass()), bArr, h0, i3, fVar);
                                b.o(eVar.f3987d, fVar.c);
                            } else if (i8 == 2) {
                                h0 = b.M(bArr, h0, fVar);
                                jVar = (j) fVar.c;
                            }
                        ...
                        h0 = b.r1(i6, bArr, h0, i3, fVar);
                    } else if (i8 == 0) {
                        h0 = b.h0(bArr, h0, fVar);
                        i5 = fVar.a;
                        eVar = (z.e) this.f3972d.b(fVar.f3862d, this.a, i5);
                    } else if (i6 != 12) {
                    }
                }
                if (jVar != null) {
                ...
                z.e eVar2 = (z.e) this.f3972d.b(fVar.f3862d, this.a, i4 >>> 3);
                if (eVar2 != null) {
                    i2 = b.R(e1.c.a(eVar2.c.getClass()), bArr, h0, i3, fVar);
                    b.o(eVar2.f3987d, fVar.c);
                } else {
                    i2 = b.f0(i4, bArr, h0, i3, s1Var, fVar);
                }
                eVar = eVar2;
            } else {
                i2 = b.r1(i4, bArr, h0, i3, fVar);
            }
        }
        if (i2 != i3) {
            throw d0.g();
    ...
    public void h(T t, a2 a2Var) {
        Iterator<Map.Entry<?, Object>> l2 = this.f3972d.c(t).l();
        while (l2.hasNext()) {
    ...
    public int j(T t) {
        ...
        return this.c ? (hashCode * 53) + this.f3972d.c(t).hashCode() : hashCode;
    }
    ...
    public final <UT, UB, ET extends v.a<ET>> boolean k(h1 h1Var, r rVar, s<ET> sVar, v<ET> vVar, r1<UT, UB> r1Var, UB ub) {
        ...
        if (k2 == 11) {
            ...
            Object b = sVar.b(rVar, this.a, k2 >>> 3);
            if (b == null) {
                return r1Var.l(ub, h1Var);
            }
            sVar.h(h1Var, b, rVar, vVar);
            return true;
        }
    }
}
