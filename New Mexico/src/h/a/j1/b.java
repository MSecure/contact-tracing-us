...
public abstract class b<T extends b<T>> extends l0<T> {
    ...
    public static final t B = t.f4556d;
        ...
        synchronized (u0.class) {
            if (u0.f4558e == null) {
                ...
                try {
                    ...
                    u0.f4557d.log(Level.FINE, "Unable to find DNS NameResolver", (Throwable) e2);
                }
                List<s0> q = d.q(s0.class, Collections.unmodifiableList(arrayList), s0.class.getClassLoader(), new u0.b(null));
                if (q.isEmpty()) {
                    u0.f4557d.warning("No NameResolverProviders found via ServiceLoader, including for DNS. This is probably due to a broken build. If using ProGuard, check your configuration");
                }
                u0.f4558e = new u0();
                for (s0 s0Var : q) {
                    Logger logger2 = u0.f4557d;
                    logger2.fine("Service loader found " + s0Var);
                    if (s0Var.c()) {
                        u0 u0Var2 = u0.f4558e;
                        synchronized (u0Var2) {
                            f.b.a.c.b.o.b.p(s0Var.c(), "isAvailable() returned false");
                            u0Var2.b.add(s0Var);
                        }
                    }
                }
