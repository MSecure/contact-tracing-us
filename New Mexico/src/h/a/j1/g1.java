...
public final class g1 implements f0.f {
    ...
    public static final class b implements f0.e {
        ...
        public static a c(String str) {
            ...
            f.b.a.c.b.o.b.x1(split.length == 4, "Bad SRV Record: %s", str);
        ...
        public List<v> a(f0.a aVar, String str) {
            ...
            List<String> c3 = ((a) this.a).c("SRV", f.a.a.a.a.x("dns:///", str));
            if (logger.isLoggable(level)) {
            ...
            while (it.hasNext()) {
                ...
                try {
                    ...
                    e2 = e3;
                    Logger logger2 = b;
                    logger2.log(level2, "Failed to construct SRV record " + str2, e2);
                    if (th == null) {
                        th = e2;
                        level2 = Level.FINE;
                    }
                    ...
                    e2 = e4;
                    Logger logger3 = b;
                    logger3.log(level2, "Can't find address for SRV record " + str2, e2);
                    if (th == null) {
                        th = e2;
                        level2 = Level.FINE;
                    }
                ...
                for (InetAddress inetAddress : unmodifiableList) {
                    arrayList3.add(new InetSocketAddress(inetAddress, c2.b));
                }
                a.b a2 = h.a.a.a();
                a2.b(p0.c, substring);
        ...
        public List<String> b(String str) {
            ...
            List<String> c2 = ((a) this.a).c("TXT", f.a.a.a.a.x("dns:///", str));
            if (logger.isLoggable(level)) {
