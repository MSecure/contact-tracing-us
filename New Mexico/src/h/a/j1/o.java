...
public final class o {
    ...
    public static final Logger f4266e = Logger.getLogger(e.class.getName());
    ...
    public class a extends ArrayDeque<b0> {
        ...
        @Override // java.util.ArrayDeque, java.util.AbstractCollection, java.util.Collection, java.util.Queue, java.util.Deque
    ...
    public o(d0 d0Var, int i2, long j2, String str) {
        ...
        String x = f.a.a.a.a.x(str, " created");
        ...
        b(new b0(x, aVar, valueOf.longValue(), null, null, null));
    }

    public static void a(d0 d0Var, Level level, String str) {
        Logger logger = f4266e;
