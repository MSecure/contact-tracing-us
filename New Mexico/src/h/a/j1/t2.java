...
public final class t2 {
    ...
    /* renamed from: d */
    public static final t2 f4332d = new t2(new a());
    ...
    public static <T> T b(c<T> cVar, T t) {
        ...
        synchronized (t2Var) {
            ...
            if (bVar != null) {
                boolean z = false;
                f.b.a.c.b.o.b.p(t == bVar.a, "Releasing the wrong instance");
                f.b.a.c.b.o.b.G(bVar.b > 0, "Refcount has already reached zero");
                int i2 = bVar.b - 1;
                bVar.b = i2;
                if (i2 == 0) {
                    if (bVar.c == null) {
                    ...
                    f.b.a.c.b.o.b.G(z, "Destroy task already scheduled");
                    if (t2Var.c == null) {
