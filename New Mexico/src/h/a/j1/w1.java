...
public final class w1 extends n0 {
    ...
    public static final ConcurrentMap<a, a> f4341d = new ConcurrentHashMap();

    /* renamed from: e  reason: collision with root package name */
    public static final Logger f4342e = Logger.getLogger(w1.class.getName());
    public final a b;
    ...
    public static final class a extends WeakReference<w1> {
        ...
        public static final boolean f4343f = Boolean.parseBoolean(System.getProperty("io.grpc.ManagedChannel.enableAllocationTracking", "true"));

        /* renamed from: g  reason: collision with root package name */
        public static final RuntimeException f4344g;
        public final ReferenceQueue<w1> a;
        public final ConcurrentMap<a, a> b;
        public final String c;

        /* renamed from: d  reason: collision with root package name */
        public final Reference<RuntimeException> f4345d;
        ...
        static {
            ...
            f4344g = runtimeException;
        }

        public a(w1 w1Var, k0 k0Var, ReferenceQueue<w1> referenceQueue, ConcurrentMap<a, a> concurrentMap) {
            super(w1Var, referenceQueue);
            this.f4345d = new SoftReference(f4343f ? new RuntimeException("ManagedChannel allocation site") : f4344g);
        ...
        public static int a(ReferenceQueue<w1> referenceQueue) {
            ...
            while (true) {
                ...
                RuntimeException runtimeException = aVar.f4345d.get();
                super.clear();
                aVar.b.remove(aVar);
                aVar.f4345d.clear();
                if (!aVar.f4346e) {
    ...
    public w1(k0 k0Var) {
        ...
        ConcurrentMap<a, a> concurrentMap = f4341d;
