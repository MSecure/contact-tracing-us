...
public class f extends h.a.j1.a {
    ...
    /* renamed from: g */
    public final o0<?, ?> f4400g;

    /* renamed from: h */
    public final String f4401h;

    /* renamed from: i */
    public final w2 f4402i;

    /* renamed from: j */
    public String f4403j;

    /* renamed from: k */
    public Object f4404k;

    /* renamed from: l */
    public volatile int f4405l;
    public final b m;
    public final a n;
    ...
    public class b extends t0 {
        ...
        public static void l(b bVar, n0 n0Var, String str) {
            boolean z;
            f fVar = f.this;
            String str2 = fVar.f4403j;
            String str3 = fVar.f4401h;
            boolean z2 = fVar.p;
            ...
            n0Var.b(q0.f4290g);
            n0Var.b(q0.f4291h);
            n0.f<String> fVar2 = q0.f4292i;
            n0Var.b(fVar2);
            ArrayList arrayList = new ArrayList(n0Var.b + 7);
            arrayList.add(z3 ? c.b : c.a);
            arrayList.add(z2 ? c.f4387d : c.c);
            arrayList.add(new d(d.f4491h, str2));
            arrayList.add(new d(d.f4489f, str));
            arrayList.add(new d(fVar2.b, str3));
            arrayList.add(c.f4388e);
            arrayList.add(c.f4389f);
            Logger logger = a3.a;
            ...
            for (int i7 = 0; i7 < bArr.length; i7 += 2) {
                h f2 = h.f(bArr[i7]);
                String q = f2.q();
                if (!q.startsWith(":") && !q0.f4290g.b.equalsIgnoreCase(q) && !q0.f4292i.b.equalsIgnoreCase(q)) {
                    arrayList.add(new d(f2, h.f(bArr[i7 + 1])));
                }
            }
            bVar.z = arrayList;
            g gVar = bVar.I;
        ...
        public static void m(b bVar, e eVar, boolean z, boolean z2) {
            if (!bVar.D) {
                if (bVar.J) {
                ...
                f.b.a.c.b.o.b.G(f.this.f4405l != -1, "streamId should be set");
                bVar.H.a(z, f.this.f4405l, eVar, z2);
            }
        }
        ...
        public void e(boolean z) {
            ...
            if (!this.o) {
                ...
                this.I.k(f.this.f4405l, null, aVar, false, null, null);
            }
        ...
        public void f(int i2) {
            ...
            if (((float) i3) <= ((float) i4) * 0.5f) {
                ...
                this.E += i5;
                this.F = i3 + i5;
                this.G.s(f.this.f4405l, (long) i5);
            }
        }
        ...
        public final void n(c1 c1Var, boolean z, n0 n0Var) {
            ...
            if (!this.D) {
                ...
                synchronized (gVar2.f4412j) {
                    ...
                    if (remove != null) {
                        gVar2.f4410h.O(i2, h.a.k1.p.m.a.CANCEL);
                        if (c1Var != null) {
                            b bVar = remove.m;
                            if (n0Var == null) {
                                n0Var = new n0();
        ...
        public void o(e eVar, boolean z) {
            ...
            this.E = i2;
            if (i2 < 0) {
                this.G.O(f.this.f4405l, h.a.k1.p.m.a.FLOW_CONTROL_ERROR);
                this.I.k(f.this.f4405l, c1.m.g("Received data size exceeded our receiving window size"), aVar, false, null, null);
                return;
            }
            j jVar = new j(eVar);
            c1 c1Var2 = this.r;
            ...
            if (c1Var2 != null) {
                ...
                try {
                    if (this.p) {
                        h.a.j1.a.f4116f.log(Level.INFO, "Received data on closed stream");
                        jVar.b.c();
                    } else {
                        try {
                            this.b.L(jVar);
        ...
        public void p(List<d> list, boolean z) {
            ...
            if (z) {
                ...
                if (c1Var4 != null) {
                    ...
                    f.b.a.c.b.o.b.A(n0Var, "trailers");
                    if (!this.p) {
                        h.a.j1.a.f4116f.log(Level.INFO, "Received trailers on closed stream:\n {1}\n {2}", new Object[]{c1Var2, n0Var});
                        return;
                    }
    ...
    public f(o0<?, ?> o0Var, n0 n0Var, b bVar, g gVar, n nVar, Object obj, int i2, int i3, String str, String str2, w2 w2Var, c3 c3Var, h.a.c cVar, boolean z) {
        super(new m(), w2Var, c3Var, n0Var, cVar, z && o0Var.f4532h);
        this.f4405l = -1;
        this.n = new a();
        this.p = false;
