...
public class i {
    ...
    public static final h.a.k1.p.i c = h.a.k1.p.i.f4455d;

    /* renamed from: d  reason: collision with root package name */
    public static i f4426d;
    ...
    public static final class a extends i {
        ...
        public static final e<Socket> f4427e = new e<>(null, "setUseSessionTickets", Boolean.TYPE);

        /* renamed from: f  reason: collision with root package name */
        public static final e<Socket> f4428f = new e<>(null, "setHostname", String.class);

        /* renamed from: g  reason: collision with root package name */
        public static final e<Socket> f4429g = new e<>(byte[].class, "getAlpnSelectedProtocol", new Class[0]);

        /* renamed from: h  reason: collision with root package name */
        public static final e<Socket> f4430h = new e<>(null, "setAlpnProtocols", byte[].class);

        /* renamed from: i  reason: collision with root package name */
        public static final e<Socket> f4431i = new e<>(byte[].class, "getNpnSelectedProtocol", new Class[0]);

        /* renamed from: j  reason: collision with root package name */
        public static final e<Socket> f4432j = new e<>(null, "setNpnProtocols", byte[].class);
        ...
        public void a(SSLSocket sSLSocket, String str, List<j> list) {
            if (str != null) {
                f4427e.d(sSLSocket, Boolean.TRUE);
                f4428f.d(sSLSocket, str);
            }
            Object[] objArr = {h.a.k1.p.i.b(list)};
            if (this.a.e() == i.e.ALPN_AND_NPN) {
                f4430h.e(sSLSocket, objArr);
            }
            if (this.a.e() != i.e.NONE) {
                f4432j.e(sSLSocket, objArr);
                return;
            }
        ...
        public String b(SSLSocket sSLSocket) {
            if (this.a.e() == i.e.ALPN_AND_NPN) {
                try {
                    byte[] bArr = (byte[]) f4429g.e(sSLSocket, new Object[0]);
                    if (bArr != null) {
            ...
            try {
                byte[] bArr2 = (byte[]) f4431i.e(sSLSocket, new Object[0]);
                if (bArr2 != null) {
