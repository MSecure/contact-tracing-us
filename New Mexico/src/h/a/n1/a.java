...
public final class a extends h0 {
    ...
    public static final a.c<d<o>> f4523g = new a.c<>("state-info");

    /* renamed from: h  reason: collision with root package name */
    public static final c1 f4524h = c1.f4087f.g("no subchannels ready");
    public final h0.d b;
    ...
    public e f4527f = new b(f4524h);

    /* renamed from: d  reason: collision with root package name */
    public final Random f4525d = new Random();

    /* renamed from: h.a.n1.a$a  reason: collision with other inner class name */
    /* loaded from: classes.dex */
    public class C0153a implements h0.j {
        public final /* synthetic */ h0.h a;

        public C0153a(h0.h hVar) {
            this.a = hVar;
        }
        ...
        public void a(o oVar) {
            ...
            f.b.a.c.b.o.b.H(z, "%s does not have exactly one group", a);
    ...
    public static final class b extends e {
        ...
        public boolean b(e eVar) {
            if (eVar instanceof b) {
                b bVar = (b) eVar;
                if (f.b.a.c.b.o.b.n0(this.a, bVar.a) || (this.a.e() && bVar.a.e())) {
                    return true;
                }
            }
            return false;
    ...
    public static final class c extends e {
        ...
        public c(List<h0.h> list, int i2) {
            super(null);
            f.b.a.c.b.o.b.p(!list.isEmpty(), "empty list");
            this.a = list;
            this.b = i2 - 1;
        }
    ...
    public static d<o> e(h0.h hVar) {
        h.a.a b2 = hVar.b();
        Object obj = b2.a.get(f4523g);
        f.b.a.c.b.o.b.A(obj, "STATE_INFO");
        return (d) obj;
    }
    ...
    public final void g() {
        ...
        h(nVar2, new c(arrayList, this.f4525d.nextInt(arrayList.size())));
    }

    public final void h(n nVar, e eVar) {
        if (nVar != this.f4526e || !eVar.b(this.f4527f)) {
            this.b.d(nVar, eVar);
            this.f4526e = nVar;
            this.f4527f = eVar;
        }
