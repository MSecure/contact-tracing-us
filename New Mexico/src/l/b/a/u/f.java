...
public abstract class f<D extends b> extends l.b.a.w.b implements d, Comparable<f<?>> {
    ...
    public <R> R c(l<R> lVar) {
        return (lVar == k.a || lVar == k.f4777d) ? (R) s() : lVar == k.b ? (R) x().s() : lVar == k.c ? (R) l.b.a.x.b.NANOS : lVar == k.f4778e ? (R) r() : lVar == k.f4779f ? (R) l.b.a.f.R(x().x()) : lVar == k.f4780g ? (R) z() : (R) super.c(lVar);
    }
    ...
    public int compareTo(f<?> fVar) {
        int e2 = g.b.a.c.c.d.e(v(), fVar.v());
        if (e2 != 0) {
            return e2;
        }
        int i2 = z().f4623e - fVar.z().f4623e;
        if (i2 != 0) {
            return i2;
        }
    ...
    public String toString() {
        String str = y().toString() + r().f4644d;
        if (r() == s()) {
            return str;
        }
    ...
    public e w() {
        return e.B(v(), (long) ((t) this).b.c.f4623e);
    }
