...
public final class g<D extends b> extends f<D> implements Serializable {
    ...
    public static <R extends b> f<R> E(d<R> dVar, q qVar, r rVar) {
        ...
        if (c.size() != 1) {
            if (c.size() == 0) {
                l.b.a.y.d b = s.b(C);
                dVar = dVar.E(dVar.b, 0, 0, l.b.a.d.n((long) (b.f4803d.c - b.c.c)).b, 0);
                rVar = b.f4803d;
            } else if (rVar != null) {
            }
            d.u(rVar, "offset");
    ...
    public f<D> l(j jVar, long j2) {
        ...
        if (ordinal != 29) {
            return E(this.b.l(jVar, j2), this.f4648d, this.c);
        }
        return F(x().s(), this.b.w(r.z(aVar.f4761e.a(j2, aVar))), this.f4648d);
    }

    @Override // l.b.a.u.f
    public f<D> C(q qVar) {
        d.u(qVar, "zone");
        if (this.f4648d.equals(qVar)) {
            return this;
        }
    ...
    @Override // l.b.a.u.f, java.lang.Object
    ...
    @Override // l.b.a.u.f, java.lang.Object
    public int hashCode() {
        return (this.b.hashCode() ^ this.c.c) ^ Integer.rotateLeft(this.f4648d.hashCode(), 3);
    }
    ...
    public String toString() {
        ...
        return str + '[' + this.f4648d.toString() + ']';
    }
