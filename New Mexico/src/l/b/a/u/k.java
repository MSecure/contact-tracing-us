...
public final class k extends a<k> implements Serializable {
    ...
    public static final int[] f4653i;
    ...
    public final transient int f4657d;

    /* renamed from: e  reason: collision with root package name */
    public final transient int f4658e;

    /* renamed from: f  reason: collision with root package name */
    public final transient int f4659f;

    /* renamed from: g  reason: collision with root package name */
    public final transient c f4660g;

    /* renamed from: h  reason: collision with root package name */
    public final long f4661h;

    /* renamed from: j  reason: collision with root package name */
    public static final int[] f4654j = {0, 30, 59, 89, 118, 148, 177, 207, 236, 266, 295, 325};

    /* renamed from: k  reason: collision with root package name */
    public static final int[] f4655k = {30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 29};

    /* renamed from: l  reason: collision with root package name */
    public static final int[] f4656l = {30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 30};
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                if (parseInt2 == -1 || parseInt3 == -1 || parseInt4 == -1 || parseInt5 == -1) {
                                                    throw new ParseException(a.v("Unknown error at line ", i2, "."), i2);
                                                } else if (parseInt2 < 1) {
                                                    ...
                                                    if (numArr == null) {
                                                        if (!M) {
                                                            numArr = new Integer[f4653i.length];
                                                            int i4 = 0;
                                                            while (true) {
                                                                int[] iArr = f4653i;
                                                                if (i4 >= iArr.length) {
                                                            ...
                                                            numArr = new Integer[f4654j.length];
                                                            int i5 = 0;
                                                            while (true) {
                                                                int[] iArr2 = f4654j;
                                                                if (i5 >= iArr2.length) {
                                                    ...
                                                    if (numArr3 == null) {
                                                        if (!M) {
                                                            numArr3 = new Integer[f4655k.length];
                                                            int i7 = 0;
                                                            while (true) {
                                                                int[] iArr3 = f4655k;
                                                                if (i7 >= iArr3.length) {
                                                            ...
                                                            numArr3 = new Integer[f4656l.length];
                                                            int i8 = 0;
                                                            while (true) {
                                                                int[] iArr4 = f4656l;
                                                                if (i8 >= iArr4.length) {
                                                    ...
                                                    if (numArr9 == null) {
                                                        if (!M2) {
                                                            numArr9 = new Integer[f4653i.length];
                                                            int i21 = 0;
                                                            while (true) {
                                                                int[] iArr5 = f4653i;
                                                                if (i21 >= iArr5.length) {
                                                            ...
                                                            numArr9 = new Integer[f4654j.length];
                                                            int i22 = 0;
                                                            while (true) {
                                                                int[] iArr6 = f4654j;
                                                                if (i22 >= iArr6.length) {
                                                    ...
                                                    if (numArr11 == null) {
                                                        if (!M2) {
                                                            numArr11 = new Integer[f4655k.length];
                                                            int i24 = 0;
                                                            while (true) {
                                                                int[] iArr7 = f4655k;
                                                                if (i24 >= iArr7.length) {
                                                            ...
                                                            numArr11 = new Integer[f4656l.length];
                                                            int i25 = 0;
                                                            while (true) {
                                                                int[] iArr8 = f4656l;
                                                                if (i25 >= iArr8.length) {
                                                ...
                                                throw new ParseException(a.v("End month is not properly set at line ", i3, "."), i3);
                                            }
                                        } catch (NumberFormatException unused2) {
                                            throw new ParseException(a.v("End year is not properly set at line ", i3, "."), i3);
                                        }
                                    } else {
                                        throw new ParseException(a.v("End year/month has incorrect format at line ", i3, "."), i3);
                                    }
                                } catch (NumberFormatException unused3) {
                                    throw new ParseException(a.v("Start month is not properly set at line ", i3, "."), i3);
                                }
                            } catch (NumberFormatException unused4) {
                                throw new ParseException(a.v("Start year is not properly set at line ", i3, "."), i3);
                            }
                        } else {
                            throw new ParseException(a.v("Start year/month has incorrect format at line ", i3, "."), i3);
                        }
                    } else {
                        throw new ParseException(a.v("Start and end year/month has incorrect format at line ", i3, "."), i3);
                    }
                } catch (NumberFormatException unused5) {
                    throw new ParseException(a.v("Offset is not properly set at line ", i3, "."), i3);
                }
            } else {
                throw new ParseException(a.v("Offset has incorrect format at line ", i3, "."), i3);
            }
        }
    }

    /* JADX WARN: Removed duplicated region for block: B:59:0x012d A[ORIG_RETURN, RETURN] */
    ...
    public static void R() {
        ...
        if (property2 != null) {
            if (property2.length() != 0 || !property2.endsWith(System.getProperty("file.separator"))) {
                StringBuilder h2 = a.h(property2);
            ...
            while (stringTokenizer.hasMoreTokens()) {
                ...
                if (file2.exists()) {
                    if (file2.isDirectory()) {
                        StringBuilder h4 = a.h(nextToken);
                        char c = q;
                        h4.append(c);
                        String str = s;
                        h4.append(str);
                        if (new File(h4.toString(), property).exists()) {
                            try {
                                inputStream = new FileInputStream(nextToken + c + str + c + property);
                                break;
    ...
    public a C(long j2) {
        ...
        return O(this.b, d.v(this.c, i3), i4 + 1, this.f4658e);
    }
    ...
    public a D(long j2) {
        ...
        return O(this.b, d.v(this.c, (int) j2), this.f4657d, this.f4658e);
    }
    ...
    public k z(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            ...
            case 23:
                return S(this.c, i2, this.f4658e);
            case 24:
            default:
            ...
            case 25:
                ...
                return S(i2, this.f4657d, this.f4658e);
            case 26:
                return S(i2, this.f4657d, this.f4658e);
            case 27:
                return S(1 - this.c, this.f4657d, this.f4658e);
        }
    }
    ...
    public l.b.a.x.d e(f fVar) {
        return (k) j.f4649d.e(fVar.n(this));
    }
    ...
    public b w(i iVar) {
        return (k) j.f4649d.e(((l.b.a.m) iVar).b(this));
    }

    public long x() {
        return J(this.c, this.f4657d, this.f4658e);
    }
