...
public final class o extends h implements Serializable {
    ...
    /* renamed from: d */
    public static final Locale f4665d = new Locale("ja", "JP", "JP");

    /* renamed from: e */
    public static final o f4666e = new o();

    /* renamed from: f */
    public static final Map<String, String[]> f4667f;

    /* renamed from: g */
    public static final Map<String, String[]> f4668g;

    /* renamed from: h */
    public static final Map<String, String[]> f4669h;
        ...
        if (!(ordinal == 15 || ordinal == 18 || ordinal == 20 || ordinal == 24)) {
            switch (ordinal) {
                ...
                case 13:
                    break;
                default:
                    Calendar instance = Calendar.getInstance(f4665d);
                    ...
                    if (ordinal2 == 19) {
                        ...
                        switch (ordinal2) {
                            ...
                            case 26:
                                q[] t3 = q.t();
                                return l.b.a.x.o.d((long) p.f4670e.b, (long) t3[t3.length - 1].q().b);
                            case 27:
                                q[] t4 = q.t();
