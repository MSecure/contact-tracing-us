            ...
            if (!(hVar == null && qVar == null)) {
                ...
                if (qVar != null) {
                    if (eVar.f(a.INSTANT_SECONDS)) {
                        eVar = (hVar3 == null ? m.f4663d : hVar3).s(l.b.a.e.s(eVar), qVar);
                    } else {
                        try {
                            s = qVar.s();
                        } catch (g unused) {
                ...
                if (hVar != null) {
                    if (eVar.f(a.EPOCH_DAY)) {
                        bVar = hVar3.c(eVar);
                    } else if (!(hVar == m.f4663d && hVar2 == null)) {
                        a[] values = a.values();
