...
public final class a implements Externalizable {
    ...
    public void writeExternal(ObjectOutput objectOutput) {
        ...
        if (b == 1) {
            ...
            objectOutput.writeInt(bVar.f4796d.length);
            for (long j3 : bVar.f4796d) {
                d(j3, objectOutput);
            }
            for (r rVar2 : bVar.f4798f) {
                e(rVar2, objectOutput);
            }
            objectOutput.writeByte(bVar.f4799g.length);
            for (e eVar : bVar.f4799g) {
                eVar.b(objectOutput);
            }
        } else if (b == 2) {
            d dVar = (d) obj;
