...
public final class c extends i {
    ...
    public final ConcurrentNavigableMap<String, a> f4801d = new ConcurrentSkipListMap();
    ...
    public f b(String str, boolean z) {
        f fVar;
        d.u(str, "zoneId");
        a value = this.f4801d.lastEntry().getValue();
        ...
        if (binarySearch < 0) {
            ...
            try {
                ...
                Object obj = value.f4802d.get(s);
                if (obj instanceof byte[]) {
                    DataInputStream dataInputStream = new DataInputStream(new ByteArrayInputStream((byte[]) obj));
                    obj = a.b(dataInputStream.readByte(), dataInputStream);
                    value.f4802d.set(s, obj);
                }
                fVar = (f) obj;
            } catch (Exception e2) {
                StringBuilder j2 = f.a.a.a.a.j("Invalid binary time-zone data: TZDB:", str, ", version: ");
                j2.append(value.a);
                throw new g(j2.toString(), e2);
            }
        }
        if (fVar != null) {
            return fVar;
        }
        throw new g(f.a.a.a.a.x("Unknown time-zone ID: ", str));
    }
    ...
    public final boolean e(InputStream inputStream) {
        ...
        if (dataInputStream.readByte() != 1) {
            ...
            while (it.hasNext()) {
                a aVar = (a) it.next();
                a putIfAbsent = this.f4801d.putIfAbsent(aVar.a, aVar);
                if (putIfAbsent == null || putIfAbsent.a.equals(aVar.a)) {
                    z = true;
                } else {
                    StringBuilder h2 = f.a.a.a.a.h("Data already loaded for TZDB time-zone rules version: ");
                    h2.append(aVar.a);
