...
public class ViewPager extends ViewGroup {
    ...
    public final ArrayList<e> f289c = new ArrayList<>();

    /* renamed from: d  reason: collision with root package name */
    public final e f290d = new e();

    /* renamed from: e  reason: collision with root package name */
    public final Rect f291e = new Rect();
    public b.y.a.a f;
    public int g;
    public int h = -1;
    ...
    public static class f extends ViewGroup.LayoutParams {
        ...
        public f(Context context, AttributeSet attributeSet) {
            ...
            this.f299b = obtainStyledAttributes.getInteger(0, 48);
    ...
    public class g extends b.i.l.a {
        ...
        public void c(View view, AccessibilityEvent accessibilityEvent) {
            ...
            b.y.a.a aVar2 = ViewPager.this.f;
            boolean z = true;
        ...
        public void d(View view, b.i.l.w.b bVar) {
            ...
            bVar.f1195a.setClassName(ViewPager.class.getName());
            b.y.a.a aVar = ViewPager.this.f;
            bVar.f1195a.setScrollable(aVar != null && aVar.getCount() > 1);
    ...
    public interface h {
        void a(ViewPager viewPager, b.y.a.a aVar, b.y.a.a aVar2);
    }
    ...
    public static class k extends b.k.a.a {
        ...
        public k(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f306e = parcel.readParcelable(classLoader);
            this.f = classLoader;
        }
        ...
        public String toString() {
            StringBuilder g = c.a.a.a.a.g("FragmentPager.SavedState{");
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeParcelable(this.f306e, i);
        }
    }
    ...
    public static class l implements Comparator<View> {
        ...
        public int compare(View view, View view2) {
            ...
            boolean z = fVar.f298a;
            if (z != fVar2.f298a) {
                return z ? 1 : -1;
            }
            return fVar.f302e - fVar2.f302e;
        }
    }
    ...
    public e a(int i2, int i3) {
        e eVar = new e();
        eVar.f294b = i2;
        eVar.f293a = this.f.instantiateItem((ViewGroup) this, i2);
        eVar.f296d = this.f.getPageWidth(i2);
        if (i3 < 0 || i3 >= this.f289c.size()) {
            this.f289c.add(eVar);
        } else {
            this.f289c.add(i3, eVar);
        }
        return eVar;
    }
    ...
    public void addFocusables(ArrayList<View> arrayList, int i2, int i3) {
        ...
        if (descendantFocusability != 393216) {
            for (int i4 = 0; i4 < getChildCount(); i4++) {
                ...
                if (childAt.getVisibility() == 0 && (h2 = h(childAt)) != null && h2.f294b == this.g) {
    ...
    public void addView(View view, int i2, ViewGroup.LayoutParams layoutParams) {
        ...
        boolean z2 = fVar.f298a | (view.getClass().getAnnotation(d.class) != null);
        fVar.f298a = z2;
        if (!this.u) {
    ...
    public boolean b(int i2) {
        ...
        if (findFocus != this) {
            ...
            if (findNextFocus == null && findNextFocus != findFocus) {
                if (i2 == 17) {
                    int i3 = g(this.f291e, findNextFocus).left;
                    int i4 = g(this.f291e, findFocus).left;
                    if (findFocus != null && i3 >= i4) {
                        n2 = m();
                        z3 = n2;
                    }
                } else if (i2 == 66) {
                    int i5 = g(this.f291e, findNextFocus).left;
                    int i6 = g(this.f291e, findFocus).left;
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if (childAt.getVisibility() == 0 && (h2 = h(childAt)) != null && h2.f294b == this.g && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                return true;
            }
        }
        return false;
    ...
    public void draw(Canvas canvas) {
        ...
        boolean z2 = false;
        if (overScrollMode == 0 || (overScrollMode == 1 && (aVar = this.f) != null && aVar.getCount() > 1)) {
    ...
    public void e() {
        ...
        this.f288b = count;
        boolean z2 = this.f289c.size() < (this.x * 2) + 1 && this.f289c.size() < count;
        int i2 = this.g;
        int i3 = 0;
        boolean z3 = false;
        while (i3 < this.f289c.size()) {
            e eVar = this.f289c.get(i3);
            int itemPosition = this.f.getItemPosition(eVar.f293a);
            if (itemPosition != -1) {
                if (itemPosition == -2) {
                    this.f289c.remove(i3);
                    i3--;
                    if (!z3) {
                        this.f.startUpdate((ViewGroup) this);
                        z3 = true;
                    }
                    this.f.destroyItem((ViewGroup) this, eVar.f294b, eVar.f293a);
                    int i4 = this.g;
                    if (i4 == eVar.f294b) {
        ...
        Collections.sort(this.f289c, c0);
        if (z2) {
            int childCount = getChildCount();
    ...
    public int getChildDrawingOrder(int i2, int i3) {
        return ((f) this.V.get(i3).getLayoutParams()).f;
    }
    ...
    public e h(View view) {
        for (int i2 = 0; i2 < this.f289c.size(); i2++) {
            e eVar = this.f289c.get(i2);
            if (this.f.isViewFromObject(view, eVar.f293a)) {
                return eVar;
            }
        }
        return null;
    ...
    public final e i() {
        ...
        float f4 = 0.0f;
        while (i3 < this.f289c.size()) {
            e eVar2 = this.f289c.get(i3);
            if (!z2 && eVar2.f294b != (i2 = i4 + 1)) {
                eVar2 = this.f290d;
                eVar2.f297e = f2 + f4 + f3;
                eVar2.f294b = i2;
                eVar2.f296d = this.f.getPageWidth(i2);
                i3--;
            }
            f2 = eVar2.f297e;
            float f5 = eVar2.f296d + f2 + f3;
            if (!z2 && scrollX < f2) {
                return eVar;
            }
            if (scrollX < f5 || i3 == this.f289c.size() - 1) {
                return eVar2;
            }
            i4 = eVar2.f294b;
            f4 = eVar2.f296d;
    ...
    public e j(int i2) {
        for (int i3 = 0; i3 < this.f289c.size(); i3++) {
            e eVar = this.f289c.get(i3);
            if (eVar.f294b == i2) {
                return eVar;
            }
    ...
    public final boolean o(int i2) {
        if (this.f289c.size() != 0) {
            ...
            int i6 = i3.f294b;
            float f3 = ((((float) i2) / f2) - i3.f297e) / (i3.f296d + (((float) i4) / f2));
            this.Q = false;
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f3;
        super.onDraw(canvas);
        if (this.n > 0 && this.o != null && this.f289c.size() > 0 && this.f != null) {
            int scrollX = getScrollX();
            int width = getWidth();
            float f4 = (float) width;
            float f5 = ((float) this.n) / f4;
            int i2 = 0;
            e eVar = this.f289c.get(0);
            float f6 = eVar.f297e;
            int size = this.f289c.size();
            int i3 = eVar.f294b;
            int i4 = this.f289c.get(size - 1).f294b;
            while (i3 < i4) {
                while (i3 > eVar.f294b && i2 < size) {
                    i2++;
                    eVar = this.f289c.get(i2);
                }
                if (i3 == eVar.f294b) {
                    float f7 = eVar.f297e;
                    float f8 = eVar.f296d;
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!fVar2.f298a && (h2 = h(childAt2)) != null) {
                    float f2 = (float) i18;
                    int i20 = ((int) (h2.f297e * f2)) + paddingLeft;
                    if (fVar2.f301d) {
                        fVar2.f301d = false;
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f2 * fVar2.f300c), 1073741824), View.MeasureSpec.makeMeasureSpec((i11 - paddingTop) - paddingBottom, 1073741824));
                    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        while (true) {
            ...
            if (!(childAt.getVisibility() == 8 || (fVar2 = (f) childAt.getLayoutParams()) == null || !fVar2.f298a)) {
                int i7 = fVar2.f299b;
                int i8 = i7 & 7;
                int i9 = i7 & 112;
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8 && ((fVar = (f) childAt2.getLayoutParams()) == null || !fVar.f298a)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) paddingLeft) * fVar.f300c), 1073741824), this.t);
            }
        }
    }
    ...
    public boolean onRequestFocusInDescendants(int i2, Rect rect) {
        ...
        while (i4 != i5) {
            View childAt = getChildAt(i4);
            if (childAt.getVisibility() == 0 && (h2 = h(childAt)) != null && h2.f294b == this.g && childAt.requestFocus(i2, rect)) {
                return true;
            }
            i4 += i3;
        }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        k kVar = (k) parcelable;
        super.onRestoreInstanceState(kVar.f1231b);
        b.y.a.a aVar = this.f;
        if (aVar != null) {
            aVar.restoreState(kVar.f306e, kVar.f);
            v(kVar.f305d, false, true, 0);
            return;
        }
        this.h = kVar.f305d;
        this.i = kVar.f306e;
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        int i2;
        boolean z2 = false;
        if ((motionEvent.getAction() == 0 && motionEvent.getEdgeFlags() != 0) || (aVar = this.f) == null || aVar.getCount() == 0) {
            return false;
        }
        if (this.I == null) {
            this.I = VelocityTracker.obtain();
        ...
        if (action != 0) {
            if (action == 1) {
                if (this.y) {
                    ...
                    int i4 = i3.f294b;
                    float f4 = ((((float) scrollX) / f2) - i3.f297e) / (i3.f296d + f3);
                    ...
                    if (this.f289c.size() > 0) {
                        ArrayList<e> arrayList = this.f289c;
                        i4 = Math.max(this.f289c.get(0).f294b, Math.min(i4, arrayList.get(arrayList.size() - 1).f294b));
                    }
    ...
    public final boolean p(float f2) {
        ...
        if (eVar.f294b != 0) {
            f4 = eVar.f297e * clientWidth;
            z2 = false;
        } else {
            z2 = true;
        }
        if (eVar2.f294b != this.f.getCount() - 1) {
            f5 = eVar2.f297e * clientWidth;
            z3 = false;
        } else {
            z3 = true;
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:77:0x0130, code lost:
        if (r9 < r14.f289c.size()) goto L_0x0158;
     */
    ...
    public void q(int i2) {
        ...
        if (!(this.f == null || this.w || getWindowToken() == null)) {
            this.f.startUpdate((ViewGroup) this);
            int i6 = this.x;
            int i7 = 0;
            int max = Math.max(0, this.g - i6);
            int count = this.f.getCount();
            int min = Math.min(count - 1, this.g + i6);
            if (count == this.f288b) {
                while (true) {
                    if (i7 >= this.f289c.size()) {
                        break;
                    }
                    eVar2 = this.f289c.get(i7);
                    int i8 = eVar2.f294b;
                    int i9 = this.g;
                    if (i8 < i9) {
                        i7++;
                ...
                if (eVar2 != null) {
                    int i10 = i7 - 1;
                    e eVar6 = i10 >= 0 ? this.f289c.get(i10) : null;
                    int clientWidth = getClientWidth();
                    float paddingLeft = clientWidth <= 0 ? 0.0f : (((float) getPaddingLeft()) / ((float) clientWidth)) + (2.0f - eVar2.f296d);
                    float f2 = 0.0f;
                    for (int i11 = this.g - 1; i11 >= 0; i11--) {
                        if (f2 < paddingLeft || i11 >= max) {
                            if (eVar6 == null || i11 != eVar6.f294b) {
                                f2 += a(i11, i10 + 1).f296d;
                                i7++;
                            } else {
                                f2 += eVar6.f296d;
                                i10--;
                            ...
                            if (i11 == eVar6.f294b && !eVar6.f295c) {
                                this.f289c.remove(i10);
                                this.f.destroyItem((ViewGroup) this, i11, eVar6.f293a);
                                i10--;
                                i7--;
                            }
                        }
                        eVar6 = this.f289c.get(i10);
                    }
                    float f3 = eVar2.f296d;
                    int i12 = i7 + 1;
                    if (f3 < 2.0f) {
                        e eVar7 = i12 < this.f289c.size() ? this.f289c.get(i12) : null;
                        float paddingRight = clientWidth <= 0 ? 0.0f : (((float) getPaddingRight()) / ((float) clientWidth)) + 2.0f;
                        int i13 = i12;
                        for (int i14 = this.g + 1; i14 < count; i14++) {
                            if (f3 < paddingRight || i14 <= min) {
                                if (eVar7 == null || i14 != eVar7.f294b) {
                                    e a2 = a(i14, i13);
                                    i13++;
                                    f3 += a2.f296d;
                                } else {
                                ...
                                if (i14 == eVar7.f294b && !eVar7.f295c) {
                                    this.f289c.remove(i13);
                                    this.f.destroyItem((ViewGroup) this, i14, eVar7.f293a);
                                }
                            }
                            eVar7 = this.f289c.get(i13);
                        }
                    }
                    ...
                    if (eVar != null) {
                        ...
                        int i16 = eVar2.f294b;
                        if (i15 < i16) {
                            float f5 = eVar.f297e + eVar.f296d + f4;
                            int i17 = 0;
                            while (true) {
                                i15++;
                                if (i15 > eVar2.f294b || i17 >= this.f289c.size()) {
                                    break;
                                }
                                while (true) {
                                    eVar5 = this.f289c.get(i17);
                                    if (i15 > eVar5.f294b && i17 < this.f289c.size() - 1) {
                                        i17++;
                                    }
                                }
                                while (i15 < eVar5.f294b) {
                                    f5 += this.f.getPageWidth(i15) + f4;
                                    i15++;
                                }
                                eVar5.f297e = f5;
                                f5 += eVar5.f296d + f4;
                            ...
                            int size = this.f289c.size() - 1;
                            float f6 = eVar.f297e;
                            while (true) {
                                i15--;
                                if (i15 < eVar2.f294b || size < 0) {
                                    break;
                                }
                                while (true) {
                                    eVar4 = this.f289c.get(size);
                                    if (i15 < eVar4.f294b && size > 0) {
                                        size--;
                                    }
                                }
                                while (i15 > eVar4.f294b) {
                                    f6 -= this.f.getPageWidth(i15) + f4;
                                    i15--;
                                }
                                f6 -= eVar4.f296d + f4;
                                eVar4.f297e = f6;
                    ...
                    int size2 = this.f289c.size();
                    float f7 = eVar2.f297e;
                    int i18 = eVar2.f294b;
                    int i19 = i18 - 1;
                    this.r = i18 == 0 ? f7 : -3.4028235E38f;
                    int i20 = count2 - 1;
                    this.s = eVar2.f294b == i20 ? (eVar2.f297e + eVar2.f296d) - 1.0f : Float.MAX_VALUE;
                    int i21 = i7 - 1;
                    while (i21 >= 0) {
                        e eVar8 = this.f289c.get(i21);
                        while (true) {
                            i4 = eVar8.f294b;
                            if (i19 <= i4) {
                                break;
                            }
                            f7 -= this.f.getPageWidth(i19) + f4;
                            i19--;
                        }
                        f7 -= eVar8.f296d + f4;
                        eVar8.f297e = f7;
                    ...
                    float f8 = eVar2.f297e + eVar2.f296d + f4;
                    int i22 = eVar2.f294b;
                    while (true) {
                        i22++;
                        if (i12 >= size2) {
                        ...
                        e eVar9 = this.f289c.get(i12);
                        while (true) {
                            i3 = eVar9.f294b;
                            if (i22 >= i3) {
                                break;
                            }
                            f8 += this.f.getPageWidth(i22) + f4;
                            i22++;
                        }
                        if (i3 == i20) {
                            this.s = (eVar9.f296d + f8) - 1.0f;
                        }
                        eVar9.f297e = f8;
                        f8 += eVar9.f296d + f4;
                        i12++;
                    }
                    this.f.setPrimaryItem((ViewGroup) this, this.g, eVar2.f293a);
                }
                this.f.finishUpdate((ViewGroup) this);
                int childCount = getChildCount();
                for (int i23 = 0; i23 < childCount; i23++) {
                    ...
                    f fVar = (f) childAt.getLayoutParams();
                    fVar.f = i23;
                    if (!fVar.f298a && fVar.f300c == 0.0f && (h2 = h(childAt)) != null) {
                        fVar.f300c = h2.f296d;
                        fVar.f302e = h2.f294b;
                    }
                }
                if (hasFocus()) {
                    ...
                    eVar3 = null;
                    if (eVar3 == null || eVar3.f294b != this.g) {
                        for (int i24 = 0; i24 < getChildCount(); i24++) {
                            View childAt2 = getChildAt(i24);
                            e h3 = h(childAt2);
                            if (h3 != null && h3.f294b == this.g && childAt2.requestFocus(2)) {
                                return;
                            }
                        }
                        return;
            ...
            StringBuilder g2 = c.a.a.a.a.g("The application's PagerAdapter changed the adapter's contents without calling PagerAdapter#notifyDataSetChanged! Expected adapter item count: ");
            g2.append(this.f288b);
            g2.append(", found: ");
            g2.append(count);
            g2.append(" Pager id: ");
            g2.append(str);
            g2.append(" Pager class: ");
            g2.append(ViewPager.class);
            g2.append(" Problematic adapter: ");
            g2.append(this.f.getClass());
    ...
    public final void r(int i2, int i3, int i4, int i5) {
        int min;
        if (i3 <= 0 || this.f289c.isEmpty()) {
            e j2 = j(this.g);
            min = (int) ((j2 != null ? Math.min(j2.f297e, this.s) : 0.0f) * ((float) ((i2 - getPaddingLeft()) - getPaddingRight())));
            if (min != getScrollX()) {
                d(false);
            } else {
                return;
    ...
    public void setAdapter(b.y.a.a aVar) {
        ...
        if (aVar2 != null) {
            ...
            while (i3 < getChildCount()) {
                if (!((f) getChildAt(i3).getLayoutParams()).f298a) {
                    removeViewAt(i3);
                    i3--;
                }
                i3++;
    ...
    public final void u(int i2, boolean z2, int i3, boolean z3) {
        int i4;
        e j2 = j(i2);
        int max = j2 != null ? (int) (Math.max(this.r, Math.min(j2.f297e, this.s)) * ((float) getClientWidth())) : 0;
        if (z2) {
            if (getChildCount() == 0) {
                setScrollingCacheEnabled(false);
            } else {
                ...
                if (i5 == 0 && i6 == 0) {
                    ...
                    int abs = Math.abs(i3);
                    int min = Math.min(abs > 0 ? Math.round(Math.abs(sin / ((float) abs)) * 1000.0f) * 4 : (int) (((((float) Math.abs(i5)) / ((this.f.getPageWidth(this.g) * f2) + ((float) this.n))) + 1.0f) * 100.0f), 600);
                    this.l = false;
    ...
    public void v(int i2, boolean z2, boolean z3, int i3) {
        ...
        if (aVar == null || aVar.getCount() <= 0) {
            setScrollingCacheEnabled(false);
        } else if (z3 || this.g != i2 || this.f289c.size() == 0) {
            if (i2 < 0) {
                i2 = 0;
            ...
            if (i2 > i5 + i4 || i2 < i5 - i4) {
                for (int i6 = 0; i6 < this.f289c.size(); i6++) {
                    this.f289c.get(i6).f295c = true;
                }
            }
            if (this.g != i2) {
                z4 = true;
