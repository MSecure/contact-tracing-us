...
public class g implements b.i.g.a.a {
    ...
    public g(Context context) {
        boolean z2 = false;
        this.f540a = context;
        this.f541b = context.getResources();
        ...
        this.k = true;
        if (this.f541b.getConfiguration().keyboard != 1 && q.d(ViewConfiguration.get(this.f540a), this.f540a)) {
            z2 = true;
        }
        this.f543d = z2;
    }
        ...
        if (i6 >= 0) {
            ...
            if (i6 < iArr.length) {
                ...
                while (true) {
                    size--;
                    if (size >= 0) {
                        if (arrayList.get(size).f551d <= i7) {
                            i5 = size + 1;
                            break;
                        }
                    } else {
    ...
    public MenuItem add(int i2) {
        return a(0, 0, 0, this.f541b.getString(i2));
    }

    @Override // android.view.Menu
    public MenuItem add(int i2, int i3, int i4, int i5) {
        return a(i2, i3, i4, this.f541b.getString(i5));
    }
    ...
    public int addIntentOptions(int i2, int i3, int i4, ComponentName componentName, Intent[] intentArr, Intent intent, int i5, MenuItem[] menuItemArr) {
        int i6;
        PackageManager packageManager = this.f540a.getPackageManager();
    ...
    public SubMenu addSubMenu(int i2) {
        return addSubMenu(0, 0, 0, this.f541b.getString(i2));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i2, int i3, int i4, int i5) {
        return addSubMenu(i2, i3, i4, this.f541b.getString(i5));
    }

    @Override // android.view.Menu
    public SubMenu addSubMenu(int i2, int i3, int i4, CharSequence charSequence) {
        i iVar = (i) a(i2, i3, i4, charSequence);
        r rVar = new r(this.f540a, this, iVar);
        iVar.o = rVar;
        rVar.setHeaderTitle(iVar.f552e);
        return rVar;
    }
    ...
    public void removeGroup(int i2) {
        ...
        while (true) {
            if (i3 >= size) {
                i3 = -1;
                break;
            } else if (this.f.get(i3).f549b == i2) {
                break;
            } else {
                i3++;
            }
        ...
        if (i3 >= 0) {
            ...
            while (true) {
                int i5 = i4 + 1;
                if (i4 >= size2 || this.f.get(i3).f549b != i2) {
                    q(true);
                } else {
                    t(i3, false);
                    i4 = i5;
    ...
    public void removeItem(int i2) {
        ...
        while (true) {
            if (i3 >= size) {
                i3 = -1;
                break;
            } else if (this.f.get(i3).f548a == i2) {
                break;
            } else {
                i3++;
            }
    ...
    public boolean s(MenuItem menuItem, m mVar, int i2) {
        ...
        if (onMenuItemClickListener == null || !onMenuItemClickListener.onMenuItemClick(iVar)) {
            ...
            if (!gVar.e(gVar, iVar)) {
                ...
                if (intent != null) {
                    try {
                        iVar.n.f540a.startActivity(intent);
                    } catch (ActivityNotFoundException unused) {
                    }
                }
                b.i.l.b bVar = iVar.A;
                if (bVar == null || !((j.a) bVar).f556b.onPerformDefaultAction()) {
                    z2 = false;
                    b.i.l.b bVar2 = iVar.A;
                    boolean z4 = bVar2 == null && ((j.a) bVar2).f556b.hasSubMenu();
                    if (!iVar.f()) {
                        ...
                        if (z4) {
                            j.a aVar = (j.a) bVar2;
                            aVar.f556b.onPrepareSubMenu(j.this.d(rVar2));
                        }
                        if (!this.v.isEmpty()) {
                            if (mVar != null) {
                                z3 = mVar.i(rVar2);
    ...
    public final void x(int i2, CharSequence charSequence, int i3, Drawable drawable, View view) {
        Resources resources = this.f541b;
        if (view != null) {
            this.o = view;
            this.m = null;
            this.n = null;
            ...
            if (i3 > 0) {
                this.n = b.i.e.a.c(this.f540a, i3);
