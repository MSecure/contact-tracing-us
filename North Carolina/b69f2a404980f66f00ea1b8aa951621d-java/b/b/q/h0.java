...
public abstract class h0 implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ViewParent parent = h0.this.f645e.getParent();
            if (parent != null) {
    ...
    public h0(View view) {
        ...
        this.f642b = (float) ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
        int tapTimeout = ViewConfiguration.getTapTimeout();
        this.f643c = tapTimeout;
        this.f644d = (ViewConfiguration.getLongPressTimeout() + tapTimeout) / 2;
    }

    public final void a() {
        Runnable runnable = this.g;
        if (runnable != null) {
            this.f645e.removeCallbacks(runnable);
        }
        Runnable runnable2 = this.f;
        if (runnable2 != null) {
            this.f645e.removeCallbacks(runnable2);
        }
    }
        ...
        if (z4) {
            ...
            if (view3.isEnabled()) {
                ...
                if (actionMasked2 != 0) {
                            ...
                            if (findPointerIndex >= 0) {
                                ...
                                if (!(x >= f3 && y >= f3 && x < ((float) (view3.getRight() - view3.getLeft())) + f2 && y < ((float) (view3.getBottom() - view3.getTop())) + f2)) {
                                    ...
                                    if (z) {
                                        long uptimeMillis = SystemClock.uptimeMillis();
                                        MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, 0);
                                        this.f645e.onTouchEvent(obtain);
                                        obtain.recycle();
                                    }
                                }
                            }
                    ...
                    view3.postDelayed(this.f, (long) this.f643c);
                    if (this.g == null) {
                        this.g = new b();
                    }
                    view3.postDelayed(this.g, (long) this.f644d);
                }
            }
            z2 = false;
            if (!z2) {
