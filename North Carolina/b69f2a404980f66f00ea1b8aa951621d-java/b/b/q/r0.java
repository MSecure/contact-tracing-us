...
public class r0 extends c implements View.OnClickListener {
    ...
    public static final class a {
        ...
        public final ImageView f710c;

        /* renamed from: d  reason: collision with root package name */
        public final ImageView f711d;

        /* renamed from: e  reason: collision with root package name */
        public final ImageView f712e;

        public a(View view) {
            this.f708a = (TextView) view.findViewById(16908308);
            this.f709b = (TextView) view.findViewById(16908309);
            this.f710c = (ImageView) view.findViewById(16908295);
            this.f711d = (ImageView) view.findViewById(16908296);
            this.f712e = (ImageView) view.findViewById(f.edit_query);
        }
    }
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f709b != null) {
            ...
            if (i4 != null) {
                if (this.t == null) {
                    ...
                    this.f1226e.getTheme().resolveAttribute(b.b.a.textColorSearchUrl, typedValue, true);
                    this.t = this.f1226e.getResources().getColorStateList(typedValue.resourceId);
                }
            ...
            if (TextUtils.isEmpty(str)) {
                TextView textView2 = aVar.f708a;
                if (textView2 != null) {
                    textView2.setSingleLine(false);
                    aVar.f708a.setMaxLines(2);
                }
            } else {
                TextView textView3 = aVar.f708a;
                if (textView3 != null) {
                    textView3.setSingleLine(true);
                    aVar.f708a.setMaxLines(1);
                }
            }
            TextView textView4 = aVar.f709b;
            textView4.setText(str);
            textView4.setVisibility(TextUtils.isEmpty(str) ? 8 : 0);
        }
        ImageView imageView = aVar.f710c;
            ...
            if (i5 == -1) {
                ...
                if (drawable == null) {
                    ...
                    if (this.p.containsKey(flattenToShortString)) {
                        ...
                        PackageManager packageManager = this.f1226e.getPackageManager();
                        try {
                            ActivityInfo activityInfo = packageManager.getActivityInfo(searchActivity, RecyclerView.d0.FLAG_IGNORE);
                    ...
                    if (drawable == null) {
                        drawable = this.f1226e.getPackageManager().getDefaultActivityIcon();
                    }
                }
            }
        ...
        ImageView imageView2 = aVar.f711d;
        if (imageView2 != null) {
            int i6 = this.y;
            if (i6 != -1) {
        ...
        if (i7 == 2 || (i7 == 1 && (i2 & 1) != 0)) {
            ...
            aVar.f712e.setTag(aVar.f708a.getText());
    ...
    public Drawable f(Uri uri) {
        ...
        if (!TextUtils.isEmpty(authority)) {
            try {
                Resources resourcesForApplication = this.f1226e.getPackageManager().getResourcesForApplication(authority);
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            if (inflate != null) {
                ((a) inflate.getTag()).f708a.setText(e2.toString());
            }
            return inflate;
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View d2 = d(this.f1226e, this.f1225d, viewGroup);
            ((a) d2.getTag()).f708a.setText(e2.toString());
            return d2;
        }
    }
    ...
    public Cursor h(SearchableInfo searchableInfo, String str, int i) {
        ...
        return this.f1226e.getContentResolver().query(fragment.build(), null, suggestSelection, strArr, null);
    }
