...
public class s0 extends CompoundButton {
    ...
    public Drawable f714b;

    /* renamed from: c  reason: collision with root package name */
    public ColorStateList f715c;

    /* renamed from: d  reason: collision with root package name */
    public PorterDuff.Mode f716d;
    ...
    public s0(Context context, AttributeSet attributeSet, int i2) {
        ...
        m.S(this, context, j.SwitchCompat, attributeSet, y0Var.f759b, i2, 0);
    ...
    private int getThumbScrollRange() {
        ...
        Drawable drawable2 = this.f714b;
        Rect c2 = drawable2 != null ? e0.c(drawable2) : e0.f626c;
    ...
    public final void a() {
        ...
        if (this.f717e || this.f) {
            Drawable mutate = this.f714b.mutate();
            this.f714b = mutate;
            if (this.f717e) {
                mutate.setTintList(this.f715c);
            }
            if (this.f) {
                this.f714b.setTintMode(this.f716d);
            }
            if (this.f714b.isStateful()) {
    ...
    public void draw(Canvas canvas) {
        ...
        Drawable drawable = this.f714b;
        Rect c2 = drawable != null ? e0.c(drawable) : e0.f626c;
        ...
        Drawable drawable3 = this.f714b;
        if (drawable3 != null) {
            drawable3.getPadding(rect);
            int i16 = thumbOffset - rect.left;
            int i17 = thumbOffset + this.B + rect.right;
            this.f714b.setBounds(i16, i5, i17, i7);
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (drawable != null) {
            drawable.getPadding(rect);
            i5 = (this.f714b.getIntrinsicWidth() - rect.left) - rect.right;
            i4 = this.f714b.getIntrinsicHeight();
        } else {
            i5 = 0;
            i4 = 0;
        }
    ...
    public boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.f714b || drawable == this.g;
    }
}
