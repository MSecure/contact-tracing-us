...
public final class q {
    ...
    public static Method f1170a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f1170a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f1170a) != null) {
            try {
