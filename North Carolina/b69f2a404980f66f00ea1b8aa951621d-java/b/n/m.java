...
public class m {
    ...
    public static Map<Class<?>, Integer> f1399a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    public static Map<Class<?>, List<Constructor<? extends d>>> f1400b = new HashMap();
    ...
    public static int c(Class<?> cls) {
        ...
        if (cls.getCanonicalName() != null) {
            ...
            if (constructor != null) {
                ...
                b bVar = b.f1380c;
                Boolean bool = bVar.f1382b.get(cls);
                if (bool != null) {
                    z = bool.booleanValue();
                } else {
                    try {
                        ...
                        while (true) {
                            if (i2 >= length) {
                                bVar.f1382b.put(cls, Boolean.FALSE);
                                z = false;
                                break;
                ...
                if (!z) {
                    ...
                    if (superclass != null && h.class.isAssignableFrom(superclass)) {
                        if (c(superclass) != 1) {
                            list = new ArrayList<>(f1400b.get(superclass));
                        }
                    }
        ...
        f1399a.put(cls, Integer.valueOf(i));
        return i;
    }
    ...
    public static g d(Object obj) {
        ...
        List<Constructor<? extends d>> list = f1400b.get(cls);
        if (list.size() == 1) {
