...
public final class a {
    ...
    public static /* synthetic */ class C0079a {
        ...
        static {
            ...
            f3361a[RoundingMode.DOWN.ordinal()] = 2;
            f3361a[RoundingMode.FLOOR.ordinal()] = 3;
            f3361a[RoundingMode.UP.ordinal()] = 4;
            f3361a[RoundingMode.CEILING.ordinal()] = 5;
            f3361a[RoundingMode.HALF_DOWN.ordinal()] = 6;
            f3361a[RoundingMode.HALF_UP.ordinal()] = 7;
            f3361a[RoundingMode.HALF_EVEN.ordinal()] = 8;
        }
    }
    ...
    public static int a(int i, int i2, RoundingMode roundingMode) {
        if (roundingMode == null) {
            ...
            boolean z = true;
            int i5 = ((i ^ i2) >> 31) | 1;
            switch (C0079a.f3361a[roundingMode.ordinal()]) {
                case 1:
                    if (i4 != 0) {
                        z = false;
                    }
