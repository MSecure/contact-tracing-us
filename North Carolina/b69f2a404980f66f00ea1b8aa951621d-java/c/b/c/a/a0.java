...
public class a0 {
    ...
    public static a1 a(z0 z0Var) {
        ...
        bVar.d();
        ((a1) bVar.f3674c).primaryKeyId_ = i;
        for (z0.c cVar : z0Var.key_) {
            a1.c.a aVar = (a1.c.a) a1.c.DEFAULT_INSTANCE.e();
            String str = cVar.q().typeUrl_;
            aVar.d();
            a1.c.n((a1.c) aVar.f3674c, str);
            w0 s = cVar.s();
            aVar.d();
            a1.c.p((a1.c) aVar.f3674c, s);
            f1 r = cVar.r();
            aVar.d();
            a1.c.o((a1.c) aVar.f3674c, r);
            int i2 = cVar.keyId_;
            aVar.d();
            ((a1.c) aVar.f3674c).keyId_ = i2;
            bVar.d();
            a1.n((a1) bVar.f3674c, (a1.c) aVar.b());
        }
        return (a1) bVar.b();
    }
