...
public final class h1 {
    ...
    public static final Class<?> f3560a;

    /* renamed from: b  reason: collision with root package name */
    public static final l1<?, ?> f3561b = A(false);

    /* renamed from: c  reason: collision with root package name */
    public static final l1<?, ?> f3562c = A(true);

    /* renamed from: d  reason: collision with root package name */
    public static final l1<?, ?> f3563d = new n1();
    ...
    public static <T, FT extends u.a<FT>> void B(r<FT> rVar, T t, T t2) {
        if (((s) rVar) != null) {
            ...
            if (!uVar.h()) {
                u<FT> c2 = rVar.c(t);
                if (c2 != null) {
                    for (int i = 0; i < uVar.f3652a.e(); i++) {
                        c2.m(uVar.f3652a.d(i));
                    }
    ...
    public static <T> void C(m0 m0Var, T t, T t2, long j) {
        p1.f.q(t, j, m0Var.a(p1.n(t, j), p1.n(t2, j)));
    }
    ...
    public static <T, UT, UB> void D(l1<UT, UB> l1Var, T t, T t2) {
        if (((n1) l1Var) != null) {
            ...
            if (!m1Var2.equals(m1.f)) {
                int i = m1Var.f3607a + m1Var2.f3607a;
                int[] copyOf = Arrays.copyOf(m1Var.f3608b, i);
                System.arraycopy(m1Var2.f3608b, 0, copyOf, m1Var.f3607a, m1Var2.f3607a);
                Object[] copyOf2 = Arrays.copyOf(m1Var.f3609c, i);
                System.arraycopy(m1Var2.f3609c, 0, copyOf2, m1Var.f3607a, m1Var2.f3607a);
    ...
    public static void E(Class<?> cls) {
        Class<?> cls2;
        if (!y.class.isAssignableFrom(cls) && (cls2 = f3560a) != null && !cls2.isAssignableFrom(cls)) {
            ...
            if (mVar != null) {
                if (z) {
                    ...
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        mVar.f3606a.P(list.get(i4).booleanValue() ? (byte) 1 : 0);
                    }
                    return;
                }
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            if (mVar != null) {
                ...
                if (z) {
                    ...
                    mVar.f3606a.V(i3);
                    while (i2 < list.size()) {
                        mVar.f3606a.Q(list.get(i2).intValue());
                        i2++;
                    }
                    return;
                }
                while (i2 < list.size()) {
                    mVar.f3606a.T(i, list.get(i2).intValue());
                    i2++;
                }
                return;
            }
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            if (mVar != null) {
                ...
                if (z) {
                    ...
                    mVar.f3606a.V(i3);
                    while (i2 < list.size()) {
                        mVar.f3606a.R(list.get(i2).intValue());
                        i2++;
                    }
                    return;
                }
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            if (mVar != null) {
                ...
                if (z) {
                    ...
                    mVar.f3606a.V(i3);
                    while (i2 < list.size()) {
                        mVar.f3606a.S(list.get(i2).longValue());
                        i2++;
                    }
                    return;
                }
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            if (mVar != null) {
                ...
                if (z) {
                    ...
                    mVar.f3606a.V(i3);
                    while (i2 < list.size()) {
                        mVar.f3606a.U(list.get(i2).intValue());
                        i2++;
                    }
                    return;
                }
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            if (mVar != null) {
                if (z) {
                    ...
                    mVar.f3606a.V(i2);
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        mVar.f3606a.W(list.get(i4).longValue());
                    }
                    return;
                }
                for (int i5 = 0; i5 < list.size(); i5++) {
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            if (mVar != null) {
                if (z) {
                    ...
                    mVar.f3606a.V(i2);
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        mVar.f3606a.V(l.L(list.get(i4).intValue()));
                    }
                    return;
                }
                for (int i5 = 0; i5 < list.size(); i5++) {
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            if (mVar != null) {
                if (z) {
                    ...
                    mVar.f3606a.V(i2);
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        mVar.f3606a.W(l.M(list.get(i4).longValue()));
                    }
                    return;
                }
                for (int i5 = 0; i5 < list.size(); i5++) {
        ...
        if (!(list == null || list.isEmpty())) {
            ...
            if (mVar != null) {
                if (z) {
                    ...
                    mVar.f3606a.V(i2);
                    for (int i4 = 0; i4 < list.size(); i4++) {
                        mVar.f3606a.V(list.get(i4).intValue());
                    }
                    return;
                }
                for (int i5 = 0; i5 < list.size(); i5++) {
    ...
    public static int u(int i, List<?> list) {
        ...
        if (list instanceof g0) {
            ...
            while (i2 < size) {
                Object f = g0Var.f(i2);
                G = (f instanceof i ? l.e((i) f) : l.F((String) f)) + G;
                i2++;
            }
        } else {
            while (i2 < size) {
