...
public final class c extends s<k0, l0> {
    ...
    public class a extends i.b<t, k0> {
        ...
        public t a(k0 k0Var) {
            return new u(k0Var.keyValue_.r());
        }
    }
