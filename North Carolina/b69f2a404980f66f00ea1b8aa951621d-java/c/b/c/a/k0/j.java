...
public class j extends i<o1> {
    ...
    public class a extends i.b<u, o1> {
        ...
        public u a(o1 o1Var) {
            o1 o1Var2 = o1Var;
            m1 q = o1Var2.q();
            return new m0((RSAPublicKey) a0.k.a("RSA").generatePublic(new RSAPublicKeySpec(new BigInteger(1, o1Var2.n_.r()), new BigInteger(1, o1Var2.e_.r()))), c.o2(q.o()), c.o2(q.n()), q.saltLength_);
        }
    }
    ...
    public void g(o1 o1Var) {
        ...
        n0.c(new BigInteger(1, o1Var2.n_.r()).bitLength());
        c.y2(o1Var2.q());
    }
}
