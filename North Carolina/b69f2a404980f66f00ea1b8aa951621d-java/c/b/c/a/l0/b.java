...
public final class b extends i<o> {
    ...
    public class a extends i.b<z, o> {
        ...
        public z a(o oVar) {
            o oVar2 = oVar;
            byte[] r = oVar2.keyValue_.r();
            o0 b2 = o0.b(oVar2.p().hkdfHashType_);
            if (b2 == null) {
                b2 = o0.UNRECOGNIZED;
            }
            return new e(r, c.q2(b2), oVar2.p().derivedKeySize_, oVar2.p().ciphertextSegmentSize_, 0);
        }
    }

    /* renamed from: c.b.c.a.l0.b$b  reason: collision with other inner class name */
    public class C0095b extends i.a<p, o> {
        public C0095b(Class cls) {
            super(cls);
        }
        ...
        public o a(p pVar) {
            ...
            bVar.d();
            o.n((o) bVar.f3674c, qVar);
            if (b.this != null) {
                bVar.d();
                ((o) bVar.f3674c).version_ = 0;
                return (o) bVar.b();
            }
            throw null;
        }
