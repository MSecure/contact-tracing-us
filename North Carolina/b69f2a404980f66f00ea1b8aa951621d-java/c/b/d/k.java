...
public abstract class k {
    ...
    public static final class b extends k {
        ...
        public String E() {
            ...
            if (y > 0 && y <= this.h - this.j) {
                String str = new String(this.f, this.j, y, m0.f3998a);
                this.j += y;
                return str;
            } else if (y == 0) {
                return "";
            ...
            if (y > 0 && y <= this.h - this.j) {
                ...
                if (y > 0) {
                    ...
                    if (y <= i2 - i3) {
                        int i4 = y + i3;
                        this.j = i4;
                        bArr = Arrays.copyOfRange(this.f, i3, i4);
                        return j.v(bArr);
                    }
                }
                if (y > 0) {
        ...
        @Override // c.b.d.k
        public void t(int i2, h1.a aVar, z zVar) {
            int i3 = this.f3934a;
            if (i3 < this.f3935b) {
                this.f3934a = i3 + 1;
        ...
        @Override // c.b.d.k
        public <T extends h1> T w(v1<T> v1Var, z zVar) {
            int y = y();
            if (this.f3934a < this.f3935b) {
                int l2 = l(y);
                this.f3934a++;
                T parsePartialFrom = v1Var.parsePartialFrom(this, zVar);
                a(0);
                this.f3934a--;
                this.m = l2;
                P();
        ...
        @Override // c.b.d.k
        public void x(h1.a aVar, z zVar) {
            int y = y();
            if (this.f3934a < this.f3935b) {
                int l2 = l(y);
                this.f3934a++;
    ...
    public static final class c extends k {
        ...
        public String E() {
            int y = y();
            if (y > 0 && y <= this.h - this.j) {
                String str = new String(this.g, this.j, y, m0.f3998a);
                this.j += y;
                return str;
            } else if (y == 0) {
                return "";
                ...
                if (y > this.h) {
                    return new String(L(y, false), m0.f3998a);
                }
                T(y);
                String str2 = new String(this.g, this.j, y, m0.f3998a);
                this.j += y;
                return str2;
            }
        }
        ...
        public final void T(int i2) {
            ...
            if (i2 > (this.f3936c - this.l) - this.j) {
                throw new n0("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
            }
            throw n0.i();
        }
        ...
        public final boolean V(int i2) {
            ...
            if (i3 + i2 > this.h) {
                ...
                byte[] bArr2 = this.g;
                int i8 = this.h;
                int read = inputStream.read(bArr2, i8, Math.min(bArr2.length - i8, (this.f3936c - this.l) - i8));
                ...
                throw new IllegalStateException(c.a.a.a.a.m("refillBuffer() called when ", i2, " bytes were already available in buffer"));
            }
        }
    ...
    public static final class d extends k {
        ...
        public String E() {
            ...
            if (y > 0 && y <= R()) {
                byte[] bArr = new byte[y];
                long j2 = (long) y;
                u2.f.c(this.j, bArr, 0, j2);
                String str = new String(bArr, m0.f3998a);
                this.j += j2;
                return str;
            } else if (y == 0) {
                return "";
        ...
        public int M() {
            ...
            if (this.i - j2 >= 4) {
                this.j = 4 + j2;
                return ((u2.h(j2 + 3) & 255) << 24) | (u2.h(j2) & 255) | ((u2.h(1 + j2) & 255) << 8) | ((u2.h(2 + j2) & 255) << 16);
            }
            throw n0.i();
        }
        ...
        public long N() {
            ...
            if (this.i - j2 >= 8) {
                this.j = 8 + j2;
                return ((((long) u2.h(j2 + 7)) & 255) << 56) | (((long) u2.h(j2)) & 255) | ((((long) u2.h(1 + j2)) & 255) << 8) | ((((long) u2.h(2 + j2)) & 255) << 16) | ((((long) u2.h(3 + j2)) & 255) << 24) | ((((long) u2.h(4 + j2)) & 255) << 32) | ((((long) u2.h(5 + j2)) & 255) << 40) | ((((long) u2.h(6 + j2)) & 255) << 48);
            }
            throw n0.i();
        }
            ...
            if (this.i != j5) {
                ...
                if (h2 >= 0) {
                    ...
                    if (h3 < 0) {
                        ...
                        long j8 = j7 + 1;
                        int h4 = h3 ^ (u2.h(j7) << 14);
                        if (h4 >= 0) {
                            j2 = (long) (h4 ^ 16256);
                        } else {
                            j7 = j8 + 1;
                            int h5 = h4 ^ (u2.h(j8) << 21);
                            if (h5 < 0) {
                                i2 = h5 ^ -2080896;
                            } else {
                                j8 = j7 + 1;
                                long h6 = ((long) h5) ^ (((long) u2.h(j7)) << 28);
                                if (h6 >= 0) {
                                    j4 = 266354560;
                                } else {
                                    long j9 = j8 + 1;
                                    long h7 = h6 ^ (((long) u2.h(j8)) << 35);
                                    if (h7 < 0) {
                                        j3 = -34093383808L;
                                    } else {
                                        j8 = j9 + 1;
                                        h6 = h7 ^ (((long) u2.h(j9)) << 42);
                                        if (h6 >= 0) {
                                            j4 = 4363953127296L;
                                        } else {
                                            j9 = j8 + 1;
                                            h7 = h6 ^ (((long) u2.h(j8)) << 49);
                                            if (h7 < 0) {
                                                j3 = -558586000294016L;
                                            } else {
                                                j8 = j9 + 1;
                                                j2 = (h7 ^ (((long) u2.h(j9)) << 56)) ^ 71499008037633920L;
                                                if (j2 < 0) {
                                                    long j10 = 1 + j8;
                                                    if (((long) u2.h(j8)) >= 0) {
                                                        j7 = j10;
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:29:0x0083, code lost:
            if (c.b.d.u2.h(r4) < 0) goto L_0x0085;
         */
        @Override // c.b.d.k
        public int y() {
            int i2;
            ...
            if (this.i != j2) {
                ...
                if (h2 >= 0) {
                    ...
                    if (h3 < 0) {
                        ...
                        long j5 = j4 + 1;
                        int h4 = h3 ^ (u2.h(j4) << 14);
                        if (h4 >= 0) {
                            i2 = h4 ^ 16256;
                        } else {
                            j4 = j5 + 1;
                            int h5 = h4 ^ (u2.h(j5) << 21);
                            if (h5 < 0) {
                                i2 = h5 ^ -2080896;
                            } else {
                                j5 = j4 + 1;
    ...
    public static k h(ByteBuffer byteBuffer, boolean z) {
        ...
        } else if (byteBuffer.isDirect() && u2.g) {
    ...
    public static int z(int i, InputStream inputStream) {
        ...
        while (i3 < 64) {
            ...
            if (read2 == -1) {
                throw n0.i();
            } else if ((read2 & RecyclerView.d0.FLAG_IGNORE) == 0) {
                return i2;
            } else {
                i3 += 7;
            }
    ...
    public abstract void t(int i, h1.a aVar, z zVar);

    public abstract int u();

    public abstract long v();

    public abstract <T extends h1> T w(v1<T> v1Var, z zVar);

    public abstract void x(h1.a aVar, z zVar);
