...
public final class v2 {
    ...
    public static final a f4362a = ((!(u2.h && u2.g) || e.a()) ? new b() : new d());
        ...
        public final String b(ByteBuffer byteBuffer, int i, int i2) {
            if ((i | i2 | ((byteBuffer.limit() - i) - i2)) >= 0) {
                ...
                while (i < i3) {
                    ...
                    if (c.b.a.a.c.n.c.d(b3)) {
                        int i7 = i5 + 1;
                        cArr[i5] = (char) b3;
                        while (i6 < i3) {
                            byte b4 = byteBuffer.get(i6);
                            if (!c.b.a.a.c.n.c.d(b4)) {
                                break;
                            }
                            i6++;
                            cArr[i7] = (char) b4;
                        ...
                        i = i6;
                        i5 = i7;
                    } else if (c.b.a.a.c.n.c.e(b3)) {
                        if (i6 < i3) {
                            c.b.a.a.c.n.c.g(b3, byteBuffer.get(i6), cArr, i5);
                            i = i6 + 1;
                            i5++;
                        } else {
                            throw n0.c();
                        }
                    } else if (c.b.a.a.c.n.c.h(b3)) {
                        if (i6 < i3 - 1) {
                            int i8 = i6 + 1;
                            c.b.a.a.c.n.c.j(b3, byteBuffer.get(i6), byteBuffer.get(i8), cArr, i5);
                            i = i8 + 1;
                            i5++;
                        } else {
                            throw n0.c();
                        ...
                        int i10 = i9 + 1;
                        c.b.a.a.c.n.c.b(b3, b5, byteBuffer.get(i9), byteBuffer.get(i10), cArr, i5);
                        i = i10 + 1;
                        i5 = i5 + 1 + 1;
                    } else {
                        throw n0.c();
            ...
            if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
                ...
                while (i < i3) {
                    ...
                    if (c.b.a.a.c.n.c.d(b3)) {
                        ...
                        if (i6 < i3) {
                            c.b.a.a.c.n.c.g(b3, bArr[i6], cArr, i5);
                            i = i6 + 1;
                            i5++;
                        } else {
                            throw n0.c();
                        ...
                        if (i6 < i3 - 1) {
                            int i8 = i6 + 1;
                            c.b.a.a.c.n.c.j(b3, bArr[i6], bArr[i8], cArr, i5);
                            i = i8 + 1;
                            i5++;
                        } else {
                            throw n0.c();
                        ...
                        byte b5 = bArr[i6];
                        int i10 = i9 + 1;
                        c.b.a.a.c.n.c.b(b3, b5, bArr[i9], bArr[i10], cArr, i5);
                        i = i10 + 1;
                        i5 = i5 + 1 + 1;
                    } else {
                        throw n0.c();
    ...
    public static final class d extends a {
        public static int f(byte[] bArr, int i, long j, int i2) {
            ...
            if (i2 == 1) {
                return v2.f(i, u2.i(bArr, j));
            }
            if (i2 == 2) {
                return v2.g(i, u2.i(bArr, j), u2.i(bArr, j + 1));
            }
        ...
        public String a(byte[] bArr, int i, int i2) {
            if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
                ...
                int i4 = 0;
                while (i < i3) {
                    byte i5 = u2.i(bArr, (long) i);
                    if (!c.b.a.a.c.n.c.d(i5)) {
                        break;
                    }
                    i++;
                    cArr[i4] = (char) i5;
                ...
                while (i < i3) {
                    int i7 = i + 1;
                    byte i8 = u2.i(bArr, (long) i);
                    if (c.b.a.a.c.n.c.d(i8)) {
                        int i9 = i6 + 1;
                        cArr[i6] = (char) i8;
                        while (i7 < i3) {
                            byte i10 = u2.i(bArr, (long) i7);
                            if (!c.b.a.a.c.n.c.d(i10)) {
                                break;
                            }
                            i7++;
                            cArr[i9] = (char) i10;
                        ...
                        i = i7;
                        i6 = i9;
                    } else if (c.b.a.a.c.n.c.e(i8)) {
                        if (i7 < i3) {
                            c.b.a.a.c.n.c.g(i8, u2.i(bArr, (long) i7), cArr, i6);
                            i = i7 + 1;
                            i6++;
                        } else {
                            throw n0.c();
                        }
                    } else if (c.b.a.a.c.n.c.h(i8)) {
                        if (i7 < i3 - 1) {
                            int i11 = i7 + 1;
                            c.b.a.a.c.n.c.j(i8, u2.i(bArr, (long) i7), u2.i(bArr, (long) i11), cArr, i6);
                            i = i11 + 1;
                            i6++;
                        } else {
                            throw n0.c();
                        ...
                        int i12 = i7 + 1;
                        int i13 = i12 + 1;
                        c.b.a.a.c.n.c.b(i8, u2.i(bArr, (long) i7), u2.i(bArr, (long) i12), u2.i(bArr, (long) i13), cArr, i6);
                        i = i13 + 1;
                        i6 = i6 + 1 + 1;
                    } else {
                        throw n0.c();
        ...
        public String c(ByteBuffer byteBuffer, int i, int i2) {
            if ((i | i2 | ((byteBuffer.limit() - i) - i2)) >= 0) {
                long a2 = u2.a(byteBuffer) + ((long) i);
                long j = ((long) i2) + a2;
                char[] cArr = new char[i2];
                int i3 = 0;
                while (a2 < j) {
                    byte h = u2.h(a2);
                    if (!c.b.a.a.c.n.c.d(h)) {
                        break;
                    }
                    a2++;
                    cArr[i3] = (char) h;
                ...
                while (true) {
                    ...
                    while (a2 < j) {
                        long j2 = a2 + 1;
                        byte h2 = u2.h(a2);
                        if (c.b.a.a.c.n.c.d(h2)) {
                            cArr[i4] = (char) h2;
                            i4++;
                            a2 = j2;
                            while (a2 < j) {
                                byte h3 = u2.h(a2);
                                if (!c.b.a.a.c.n.c.d(h3)) {
                                    break;
                                }
                                a2++;
                                cArr[i4] = (char) h3;
                        ...
                        } else if (c.b.a.a.c.n.c.e(h2)) {
                            if (j2 < j) {
                                a2 = j2 + 1;
                                c.b.a.a.c.n.c.g(h2, u2.h(j2), cArr, i4);
                                i4++;
                            } else {
                                throw n0.c();
                            }
                        } else if (c.b.a.a.c.n.c.h(h2)) {
                            if (j2 < j - 1) {
                                long j3 = j2 + 1;
                                c.b.a.a.c.n.c.j(h2, u2.h(j2), u2.h(j3), cArr, i4);
                                i4++;
                                a2 = j3 + 1;
                            } else {
                                throw n0.c();
                            ...
                            byte h5 = u2.h(j4);
                            a2 = j5 + 1;
                            c.b.a.a.c.n.c.b(h2, h4, h5, u2.h(j5), cArr, i4);
                            i3 = i4 + 1 + 1;
                        } else {
                            throw n0.c();
                        }
                    ...
                    while (i4 < length) {
                        ...
                        if (charAt2 >= c2 || j2 >= j3) {
                            if (charAt2 < 2048 && j2 <= j3 - 2) {
                                long j5 = j2 + j4;
                                u2.t(bArr, j2, (byte) ((charAt2 >>> 6) | 960));
                                j = j5 + j4;
                                u2.t(bArr, j5, (byte) ((charAt2 & '?') | RecyclerView.d0.FLAG_IGNORE));
                            } else if ((charAt2 < 55296 || 57343 < charAt2) && j2 <= j3 - 3) {
                                long j6 = j2 + j4;
                                u2.t(bArr, j2, (byte) ((charAt2 >>> '\f') | 480));
                                long j7 = j4 + j6;
                                u2.t(bArr, j6, (byte) (((charAt2 >>> 6) & 63) | RecyclerView.d0.FLAG_IGNORE));
                                j = 1 + j7;
                                u2.t(bArr, j7, (byte) ((charAt2 & '?') | RecyclerView.d0.FLAG_IGNORE));
                                j4 = 1;
                            } else if (j2 <= j3 - 4) {
                                int i5 = i4 + 1;
                                if (i5 != length) {
                                    ...
                                    if (Character.isSurrogatePair(charAt2, charAt3)) {
                                        int codePoint = Character.toCodePoint(charAt2, charAt3);
                                        long j8 = j2 + 1;
                                        u2.t(bArr, j2, (byte) ((codePoint >>> 18) | 240));
                                        long j9 = 1 + j8;
                                        u2.t(bArr, j8, (byte) (((codePoint >>> 12) & 63) | RecyclerView.d0.FLAG_IGNORE));
                                        long j10 = 1 + j9;
                                        u2.t(bArr, j9, (byte) (((codePoint >>> 6) & 63) | RecyclerView.d0.FLAG_IGNORE));
                                        j4 = 1;
                                        u2.t(bArr, j10, (byte) ((codePoint & 63) | RecyclerView.d0.FLAG_IGNORE));
                                        i4 = i5;
                                        c2 = 128;
                                        j2 = j10 + 1;
                                    } else {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0036, code lost:
            if (c.b.d.u2.i(r25, r8) > -65) goto L_0x003d;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:128:?, code lost:
            return f(r25, r2, r8, r0);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:28:0x0067, code lost:
            if (c.b.d.u2.i(r25, r8) > -65) goto L_0x0069;
         */
        @Override // c.b.d.v2.a
        public int e(int i, byte[] bArr, int i2, int i3) {
            int i4;
