...
public class Payload {
    ...
    public static class File {
        ...
        public static File zza(ParcelFileDescriptor parcelFileDescriptor) {
            i.j.t(parcelFileDescriptor, "Cannot create Payload.File from null ParcelFileDescriptor.");
        ...
        public static File zza(java.io.File file, ParcelFileDescriptor parcelFileDescriptor, long j, Uri uri) {
            i.j.t(file, "Cannot create Payload.File from null java.io.File.");
            i.j.t(parcelFileDescriptor, "Cannot create Payload.File from null ParcelFileDescriptor.");
            i.j.t(uri, "Cannot create Payload.File from null Uri");
    ...
    public static class Stream {
        ...
        public static Stream zza(ParcelFileDescriptor parcelFileDescriptor) {
            i.j.t(parcelFileDescriptor, "Cannot create Payload.Stream from null ParcelFileDescriptor.");
            return new Stream(parcelFileDescriptor, null);
        }

        public static Stream zza(InputStream inputStream) {
            i.j.t(inputStream, "Cannot create Payload.Stream from null InputStream.");
    ...
    public static Payload fromBytes(byte[] bArr) {
        i.j.t(bArr, "Cannot create a Payload from null bytes.");
