...
public class MessageFilter extends a {
    ...
    public static final class Builder {
        ...
        public final MessageFilter build() {
            i.j.v(this.zzd || !this.zza.isEmpty(), "At least one of the include methods must be called.");
        ...
        public final Builder includeAudioBytes(int i) {
            boolean z = true;
            i.j.k(this.zze == 0, "includeAudioBytes() can only be called once per MessageFilter instance.");
            boolean z2 = i > 0;
            StringBuilder sb = new StringBuilder(44);
            sb.append("Invalid value for numAudioBytes: ");
            sb.append(i);
            i.j.k(z2, sb.toString());
            if (i > 10) {
                z = false;
            }
            i.j.k(z, "numAudioBytes is capped by AudioBytes.MAX_SIZE = 10");
        ...
        public final Builder includeNamespacedType(String str, String str2) {
            i.j.j(str != null && !str.isEmpty() && !str.contains("*"), "namespace(%s) cannot be null, empty or contain (*).", str);
            i.j.j(str2 != null && !str2.contains("*"), "type(%s) cannot be null or contain (*).", str2);
            return zza(str, str2);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.zzd == messageFilter.zzd && i.j.X(this.zzb, messageFilter.zzb) && i.j.X(this.zzc, messageFilter.zzc) && i.j.X(this.zze, messageFilter.zze);
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        int e2 = i.j.e(parcel);
        i.j.B1(parcel, 1, this.zzb, false);
        i.j.B1(parcel, 2, this.zzc, false);
        i.j.o1(parcel, 3, this.zzd);
        i.j.B1(parcel, 4, this.zze, false);
        i.j.u1(parcel, 5, this.zzf);
