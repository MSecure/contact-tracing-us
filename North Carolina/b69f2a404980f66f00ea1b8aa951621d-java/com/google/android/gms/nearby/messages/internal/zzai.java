...
import c.b.a.a.e.c.fa;
import c.b.a.a.e.c.ga;
import c.b.a.a.e.c.ia;
...
public final class zzai extends g<zzr> {
    ...
    public final void zza(k<c.b.a.a.c.k.o.e<Status>> kVar, PendingIntent pendingIntent) {
        ((zzr) getService()).zza(new zzch(null, new fa(kVar), pendingIntent));
    }

    @Deprecated
    public final void zza(k<c.b.a.a.c.k.o.e<Status>> kVar, PendingIntent pendingIntent, zzac zzac, SubscribeOptions subscribeOptions) {
        zza(kVar, pendingIntent, zzac, subscribeOptions, this.zze.zza);
    }

    public final void zza(k<c.b.a.a.c.k.o.e<Status>> kVar, PendingIntent pendingIntent, zzac zzac, SubscribeOptions subscribeOptions, int i) {
    ...
    public final void zza(k<c.b.a.a.c.k.o.e<Status>> kVar, k<MessageListener> kVar2) {
        k.a<L> aVar = kVar2.f2377c;
        if (aVar != null) {
            fa faVar = new fa(kVar);
            if (!(this.zzd.a(aVar) != null)) {
                faVar.zza(new Status(0));
                return;
            }
            ((zzr) getService()).zza(new zzch(this.zzd.a(aVar), faVar, null));
            this.zzd.f2622a.remove(aVar);
        }
    }

    @Deprecated
    public final void zza(k<c.b.a.a.c.k.o.e<Status>> kVar, k<MessageListener> kVar2, zzac zzac, SubscribeOptions subscribeOptions, byte[] bArr) {
        zza(kVar, kVar2, zzac, subscribeOptions, null, this.zze.zza);
    }

    public final void zza(k<c.b.a.a.c.k.o.e<Status>> kVar, zzag zzag) {
        ((zzr) getService()).zza(new zzcf(zzag, new fa(kVar)));
    }

    @Deprecated
    public final void zza(k<c.b.a.a.c.k.o.e<Status>> kVar, zzag zzag, zzw zzw, PublishOptions publishOptions) {
        zza(kVar, zzag, zzw, publishOptions, this.zze.zza);
    }

    public final void zza(k<c.b.a.a.c.k.o.e<Status>> kVar, zzag zzag, zzw zzw, PublishOptions publishOptions, int i) {
        ((zzr) getService()).zza(new zzca(zzag, publishOptions.getStrategy(), new fa(kVar), zzw, i));
    }

    public final void zzb(k<c.b.a.a.c.k.o.e<Status>> kVar, k<StatusCallback> kVar2) {
        k.a<L> aVar = kVar2.f2377c;
        if (aVar != null) {
            if (!(this.zzd.a(aVar) != null)) {
                this.zzd.f2622a.put(aVar, new WeakReference<>(new ga(kVar2)));
            }
    ...
    public final void zzc(k<c.b.a.a.c.k.o.e<Status>> kVar, k<StatusCallback> kVar2) {
        k.a<L> aVar = kVar2.f2377c;
        if (aVar != null) {
            fa faVar = new fa(kVar);
            if (!(this.zzd.a(aVar) != null)) {
    ...
    public final void zza(k<c.b.a.a.c.k.o.e<Status>> kVar, k<MessageListener> kVar2, zzac zzac, SubscribeOptions subscribeOptions, byte[] bArr, int i) {
        k.a<L> aVar = kVar2.f2377c;
        if (aVar != null) {
            if (!(this.zzd.a(aVar) != null)) {
                this.zzd.f2622a.put(aVar, new WeakReference<>(new da(kVar2)));
            }
