    ...
    public boolean C(View view, View view2, boolean z, boolean z2) {
        ...
        if (parent instanceof CoordinatorLayout) {
            ...
            for (int i3 = 0; i3 < childCount; i3++) {
                ...
                boolean z3 = (childAt.getLayoutParams() instanceof CoordinatorLayout.f) && (((CoordinatorLayout.f) childAt.getLayoutParams()).f125a instanceof FabTransformationScrimBehavior);
                if (childAt != view2 && !z3) {
