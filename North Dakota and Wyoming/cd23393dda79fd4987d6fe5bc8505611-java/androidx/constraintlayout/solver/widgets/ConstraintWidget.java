...
public class ConstraintWidget {
                ...
                if (!z5) {
                    ...
                    if (i12 == 0 || i12 == -1) {
                        ...
                        if (this.mHorizontalResolution != 2) {
                            ...
                            applyConstraints(linearSystem, z4, constraintWidget5 != null ? linearSystem.createObjectVariable(constraintWidget5.mLeft) : null, createObjectVariable6, this.mListDimensionBehaviors[0], z15, this.mLeft, this.mRight, this.mX, i4, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, z6, z2, i2, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, z142);
                        } else {
                            solverVariable2 = createObjectVariable3;
                            solverVariable4 = createObjectVariable2;
                            z7 = z3;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:172:0x030e  */
        ...
        if (z5) {
            if (!isConnected && !isConnected2 && !isConnected3) {
                ...
                if (z6) {
                    ...
                    if (i26 > 0) {
                        linearSystem.addLowerThan(createObjectVariable2, createObjectVariable, i26, 6);
                        i9 = Math.min(i9, i26);
                    }
                    if (i24 != 1) {
                        z14 = z6;
                            ...
                            if (!isConnected && isConnected2) {
                                ...
                                if (z7) {
                                    ...
                                    if (i11 == 0) {
                                        ...
                                        linearSystem.addEquality(createObjectVariable, solverVariable7, constraintAnchor.getMargin(), i22);
                                        linearSystem.addEquality(createObjectVariable2, solverVariable6, -constraintAnchor2.getMargin(), i22);
                                        z9 = i13 > 0 || i12 > 0;
                                        i19 = 5;
                                        z8 = z12;
                                    } else {
                                        ...
                                        if (i11 == 1) {
                                            ...
                                            int i27 = (z3 || this.mResolvedDimensionRatioSide == -1 || i13 > 0) ? 4 : 6;
                                            linearSystem.addEquality(createObjectVariable, solverVariable7, constraintAnchor.getMargin(), i27);
                                            linearSystem.addEquality(createObjectVariable2, solverVariable6, -constraintAnchor2.getMargin(), i27);
                                            i19 = 5;
                                        } else {
                                            i19 = 5;
                                            z9 = false;
                                    ...
                                    if (!z9) {
                                        ...
                                        linearSystem.addCentering(createObjectVariable, solverVariable7, constraintAnchor.getMargin(), f, solverVariable6, createObjectVariable2, constraintAnchor2.getMargin(), i19);
                                        ...
                                        if (z16 && !z17) {
                                            ...
                                            linearSystem.addGreaterThan(createObjectVariable, solverVariable9, constraintAnchor.getMargin(), i20);
                                            linearSystem.addLowerThan(solverVariable5, solverVariable8, -constraintAnchor2.getMargin(), i21);
                                            i17 = 6;
                                            i16 = 0;
                                            if (z) {
                                            }
                                            ...
                                            if (!z) {
                                                linearSystem.addGreaterThan(solverVariable2, solverVariable5, i16, i17);
                                                return;
                                            }
                                            return;
                                        }
