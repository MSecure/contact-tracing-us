            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (!layoutParams.isGuideline && !layoutParams.isHelper) {
                    ...
                    if (i11 == 0 || i12 == 0) {
                        ...
                        boolean z3 = i11 == -2 ? USE_CONSTRAINTS_HELPER : false;
                        int childMeasureSpec = getChildMeasureSpec(i, paddingLeft, i11);
                        boolean z4 = i12 == -2 ? USE_CONSTRAINTS_HELPER : false;
                        ...
                        constraintWidget.setWidthWrapContent(i11 == -2 ? USE_CONSTRAINTS_HELPER : false);
                        constraintWidget.setHeightWrapContent(i12 == -2 ? USE_CONSTRAINTS_HELPER : false);
            ...
            if (childAt2.getVisibility() != i3) {
                ...
                if (!layoutParams2.isGuideline && !layoutParams2.isHelper) {
                    ...
                    if (i14 == 0 || i15 == 0) {
                        ...
                        boolean z5 = (constraintWidget2.getAnchor(ConstraintAnchor.Type.LEFT).getTarget() == null || constraintWidget2.getAnchor(ConstraintAnchor.Type.RIGHT).getTarget() == null) ? false : USE_CONSTRAINTS_HELPER;
                        ...
                        i5 = childCount;
                        boolean z6 = (constraintWidget2.getAnchor(ConstraintAnchor.Type.TOP).getTarget() == null || constraintWidget2.getAnchor(ConstraintAnchor.Type.BOTTOM).getTarget() == null) ? false : USE_CONSTRAINTS_HELPER;
                        if (i14 != 0 || i15 != 0 || !z5 || !z6) {
                            i4 = i13;
                            boolean z7 = constraintLayout2.mLayoutWidget.getHorizontalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
                            boolean z8 = constraintLayout2.mLayoutWidget.getVerticalDimensionBehaviour() != ConstraintWidget.DimensionBehaviour.WRAP_CONTENT ? USE_CONSTRAINTS_HELPER : false;
                            if (!z7) {
                            ...
                            if (i14 == 0) {
                                if (!z7 || !constraintWidget2.isSpreadWidth() || !z5 || !resolutionNode.isResolved() || !resolutionNode2.isResolved()) {
                                    ...
                                    if (i15 == 0) {
                                        if (!z8 || !constraintWidget2.isSpreadHeight() || !z6 || !resolutionNode3.isResolved() || !resolutionNode4.isResolved()) {
                                            ...
                                            constraintWidget2.setWidthWrapContent(i14 == -2 ? USE_CONSTRAINTS_HELPER : false);
                                            constraintWidget2.setHeightWrapContent(i15 == -2 ? USE_CONSTRAINTS_HELPER : false);
                                        ...
                                        z2 = i15 == -2 ? USE_CONSTRAINTS_HELPER : false;
                                        i7 = getChildMeasureSpec(i2, paddingTop, i15);
                                        childAt2.measure(i6, i7);
                                        constraintLayout = this;
                                        metrics = constraintLayout.mMetrics;
                                ...
                                z = i14 == -2 ? USE_CONSTRAINTS_HELPER : false;
                                i6 = getChildMeasureSpec(i, paddingLeft, i14);
                                if (i15 == 0) {
                                }
                                z2 = false;
    ...
    public void onMeasure(int i, int i2) {
        ...
        if ((this.mOptimizationLevel & 32) == 32) {
            ...
            if (this.mLayoutWidget.mVerticalWrapOptimized && this.mLayoutWidget.mWrapFixedHeight > size3) {
                ...
                z2 = USE_CONSTRAINTS_HELPER;
                Analyzer.setPosition(list, 1, size3);
                if (getChildCount() > 0) {
                            ...
                            if (!layoutParams.isHelper && !layoutParams.isGuideline) {
                                ...
                                if (view.getVisibility() != 8 && (!z8 || !constraintWidget.getResolutionWidth().isResolved() || !constraintWidget.getResolutionHeight().isResolved())) {
                                    if (layoutParams.width != -2 || !layoutParams.horizontalDimensionFixed) {
                                        i8 = View.MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), Ints.MAX_POWER_OF_TWO);
                                    } else {
                                        i8 = getChildMeasureSpec(i11, paddingRight, layoutParams.width);
                                    }
                                    if (layoutParams.height != -2 || !layoutParams.verticalDimensionFixed) {
                                        i9 = View.MeasureSpec.makeMeasureSpec(constraintWidget.getHeight(), Ints.MAX_POWER_OF_TWO);
                                    } else {
