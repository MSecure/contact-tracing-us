    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        if (objArr != null) {
            ...
            for (int i20 = 0; i20 < i13; i20++) {
                ...
                measureChild(view2, (int) Ints.MAX_POWER_OF_TWO, true);
        ...
        for (int i21 = 0; i21 < i13; i21++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i16) {
                ...
                if (this.mOrientation == 1) {
                    i10 = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i23, layoutParams.width, false);
                    i9 = View.MeasureSpec.makeMeasureSpec(i16 - i22, Ints.MAX_POWER_OF_TWO);
                } else {
                    int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i16 - i23, Ints.MAX_POWER_OF_TWO);
                    i9 = getChildMeasureSpec(spaceForSpanRange, Ints.MAX_POWER_OF_TWO, i22, layoutParams.height, false);
                    i10 = makeMeasureSpec;
                }
