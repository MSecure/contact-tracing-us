...
final class zzeq extends AbstractSet<Map.Entry<K, V>> {
    ...
    public final boolean contains(@NullableDecl Object obj) {
        ...
        if (obj instanceof Map.Entry) {
            ...
            int zza2 = this.zza.zza((zzem) entry.getKey());
            if (zza2 == -1 || !zzdz.zza(this.zza.zzc[zza2], entry.getValue())) {
                return false;
            }
            return true;
        }
    ...
    public final boolean remove(@NullableDecl Object obj) {
        ...
        int zza2 = zzex.zza(entry.getKey(), entry.getValue(), zzi, this.zza.zze, this.zza.zza, this.zza.zzb, this.zza.zzc);
        if (zza2 == -1) {
            return false;
        }
