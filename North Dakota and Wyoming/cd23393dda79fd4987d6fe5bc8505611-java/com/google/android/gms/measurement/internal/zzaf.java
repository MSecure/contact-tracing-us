...
public final class zzaf extends zzki {
    ...
    public final boolean zza(zzkw zzkw) {
        ...
        contentValues.put(AppMeasurementSdk.ConditionalUserProperty.NAME, zzkw.zzc);
    ...
    public final boolean zza(zzz zzz) {
        ...
        contentValues.put(AppMeasurementSdk.ConditionalUserProperty.NAME, zzz.zzc.zza);
    ...
    public final void zza(String str, List<zzbv.zza> list) {
        ...
        Preconditions.checkNotNull(list);
        for (int i = 0; i < list.size(); i++) {
            zzbv.zza.C0026zza zza = (zzbv.zza.C0026zza) list.get(i).zzbo();
            if (zza.zzb() != 0) {
