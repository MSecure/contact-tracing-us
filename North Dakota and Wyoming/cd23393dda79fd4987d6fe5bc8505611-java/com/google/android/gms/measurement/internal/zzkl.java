...
public class zzkl implements zzgt {
    ...
    private final void zzc(zzaq zzaq, zzn zzn2) {
        ...
        if (zzkr.zza(zzaq, zzn2)) {
            if (!zzn2.zzh) {
                ...
                try {
                    zzc(zzn2);
                    boolean z4 = FirebaseAnalytics.Event.ECOMMERCE_PURCHASE.equals(zzaq2.zza) || FirebaseAnalytics.Event.PURCHASE.equals(zzaq2.zza) || FirebaseAnalytics.Event.REFUND.equals(zzaq2.zza);
                    if ("_iap".equals(zzaq2.zza) || z4) {
                        ...
                        if (z4) {
                            ...
                            if (doubleValue > 9.223372036854776E18d || doubleValue < -9.223372036854776E18d) {
                                ...
                                if (FirebaseAnalytics.Event.REFUND.equals(zzaq2.zza)) {
                                    j2 = -j2;
                                }
                            }
                        } else {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:96:0x0256, code lost:
        r0 = th;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:97:0x0257, code lost:
        r6 = null;
     */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:105:0x0275  */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:168:0x045f  */
    /* JADX WARNING: Removed duplicated region for block: B:175:0x046b  */
    /* JADX WARNING: Removed duplicated region for block: B:181:0x048a  */
    /* JADX WARNING: Removed duplicated region for block: B:191:0x04f5 A[ADDED_TO_REGION] */
    /* JADX WARNING: Removed duplicated region for block: B:195:0x052c  */
    /* JADX WARNING: Removed duplicated region for block: B:198:0x058e  */
    /* JADX WARNING: Removed duplicated region for block: B:199:0x0592  */
    /* JADX WARNING: Removed duplicated region for block: B:208:0x05f8  */
    /* JADX WARNING: Removed duplicated region for block: B:216:0x0621 A[ADDED_TO_REGION] */
    /* JADX WARNING: Removed duplicated region for block: B:219:0x062a  */
    /* JADX WARNING: Removed duplicated region for block: B:220:0x0649  */
    /* JADX WARNING: Removed duplicated region for block: B:258:0x073d  */
    /* JADX WARNING: Removed duplicated region for block: B:309:0x08cb  */
    /* JADX WARNING: Removed duplicated region for block: B:315:0x08e3  */
    /* JADX WARNING: Removed duplicated region for block: B:316:0x08fd  */
    /* JADX WARNING: Removed duplicated region for block: B:445:0x0c86  */
    /* JADX WARNING: Removed duplicated region for block: B:446:0x0c99  */
    /* JADX WARNING: Removed duplicated region for block: B:448:0x0c9c  */
    /* JADX WARNING: Removed duplicated region for block: B:449:0x0cc3  */
    /* JADX WARNING: Removed duplicated region for block: B:47:0x0118  */
    /* JADX WARNING: Removed duplicated region for block: B:50:0x012f  */
    /* JADX WARNING: Removed duplicated region for block: B:556:0x1013  */
    /* JADX WARNING: Removed duplicated region for block: B:561:0x102a  */
    /* JADX WARNING: Removed duplicated region for block: B:578:0x04f1 A[EDGE_INSN: B:578:0x04f1->B:189:0x04f1 ?: BREAK  , SYNTHETIC] */
    /* JADX WARNING: Removed duplicated region for block: B:96:0x0256 A[ExcHandler: all (th java.lang.Throwable), Splitter:B:4:0x0029] */
        ...
        try {
            ...
            try {
                ...
                if (TextUtils.isEmpty(null)) {
                    ...
                    try {
                        if (cursor.moveToFirst()) {
                            ...
                            try {
                                ...
                                cursor.close();
                                cursor = c_.query("raw_events_metadata", new String[]{"metadata"}, "app_id = ? and metadata_fingerprint = ?", new String[]{str9, str10}, null, null, "rowid", ExifInterface.GPS_MEASUREMENT_2D);
                                if (cursor.moveToFirst()) {
                                    ...
                                    try {
                                        ...
                                        query = c_.query("raw_events", new String[]{"rowid", AppMeasurementSdk.ConditionalUserProperty.NAME, "timestamp", Constants.ScionAnalytics.MessageType.DATA_MESSAGE}, str11, strArr, null, null, "rowid", null);
                                    } catch (IOException e2) {
                                        str2 = "";
                    ...
                    StringBuilder sb3 = new StringBuilder(str12.length() + 84);
        ...
        if (zze(zzn2)) {
            ...
            try {
                ...
                if (zzc2 != null) {
                    if (!"auto".equals(zzc2.zzb)) {
                            ...
                            if (zzb2.zzm() != -2147483648L) {
                                ...
                                if (zzb2.zzm() != zzn2.zzj) {
                                    ...
                                    if (z2 || ((zzb2.zzm() == -2147483648L || zzb2.zzl() == null || zzb2.zzl().equals(zzn2.zzc)) ? false : true)) {
                                        ...
                                        zza(new zzaq("_au", new zzap(bundle), "auto", j3), zzn2);
                                    }
                                }
                            } else {
                                str2 = "_sys";
                        ...
                        if (zzam != null) {
                            ...
                            if (i2 == 0) {
                                zza(new zzku("_fot", j3, Long.valueOf(j4), "auto"), zzn2);
                                zzx();
                                ...
                                if (this.zzk.zzm().getPackageManager() == null) {
                                    ...
                                    if (packageInfo == null || packageInfo.firstInstallTime == 0) {
                                        ...
                                        str3 = str;
                                        zza(new zzku("_fi", j3, Long.valueOf(z ? 1 : 0), "auto"), zzn2);
                                    }
                                    try {
                                ...
                                zzb(new zzaq("_f", new zzap(bundle2), "auto", j3), zzn2);
                            } else if (i2 == 1) {
                                zza(new zzku("_fvt", j3, Long.valueOf(j4), "auto"), zzn2);
                                zzx();
                                zzn();
                                ...
                                zzb(new zzaq("_v", new zzap(bundle3), "auto", j3), zzn2);
                            }
                            if (!this.zzk.zza().zze(zzn2.zza, zzas.zzat)) {
                                ...
                                zzb(new zzaq("_e", new zzap(bundle4), "auto", j3), zzn2);
                            }
                        } else if (zzn2.zzi) {
                            zzb(new zzaq("_cd", new zzap(new Bundle()), "auto", j3), zzn2);
                        }
                        zze().b_();
                    }
                }
                if (zzn2.zzs != null) {
                    str = "_sysu";
                    i = 1;
                    zzku zzku = new zzku("_npa", j3, Long.valueOf(zzn2.zzs.booleanValue() ? 1 : 0), "auto");
                    ...
                    i = 1;
                    if (zzc2 != null) {
                        zzb(new zzku("_npa", j3, null, "auto"), zzn2);
                    }
                }
                zzb2 = zze().zzb(zzn2.zza);
                if (zzb2 != null) {
