...
public final class Descriptors {
    ...
    public static final class Descriptor extends GenericDescriptor {
        ...
        public FieldDescriptor findFieldByName(String str) {
            ...
            GenericDescriptor findSymbol = descriptorPool.findSymbol(this.fullName + FilenameUtils.EXTENSION_SEPARATOR + str);
            ...
            if (this.proto.hasExtendee()) {
                ...
                if (lookupSymbol instanceof Descriptor) {
                    ...
                    if (!getContainingType().isExtensionNumber(getNumber())) {
                        throw new DescriptorValidationException(this, Typography.quote + getContainingType().getFullName() + "\" does not declare " + getNumber() + " as an extension number.", (AnonymousClass1) null);
                    }
                } else {
                    throw new DescriptorValidationException(this, Typography.quote + this.proto.getExtendee() + "\" is not a message type.", (AnonymousClass1) null);
                }
            }
            if (this.proto.hasTypeName()) {
                ...
                if (!this.proto.hasType()) {
                    if (lookupSymbol2 instanceof Descriptor) {
                        ...
                        throw new DescriptorValidationException(this, Typography.quote + this.proto.getTypeName() + "\" is not a type.", (AnonymousClass1) null);
                    }
                }
                if (getJavaType() == JavaType.MESSAGE) {
                    if (lookupSymbol2 instanceof Descriptor) {
                        ...
                        throw new DescriptorValidationException(this, Typography.quote + this.proto.getTypeName() + "\" is not a message type.", (AnonymousClass1) null);
                    }
                    ...
                    throw new DescriptorValidationException(this, Typography.quote + this.proto.getTypeName() + "\" is not an enum type.", (AnonymousClass1) null);
                }
    ...
    public static final class MethodDescriptor extends GenericDescriptor {
        ...
        private void crossLink() throws DescriptorValidationException {
            ...
            if (lookupSymbol instanceof Descriptor) {
                ...
                throw new DescriptorValidationException(this, Typography.quote + this.proto.getOutputType() + "\" is not a message type.", (AnonymousClass1) null);
            }
            throw new DescriptorValidationException(this, Typography.quote + this.proto.getInputType() + "\" is not a message type.", (AnonymousClass1) null);
        }
        ...
        public void addSymbol(GenericDescriptor genericDescriptor) throws DescriptorValidationException {
            ...
            if (put != null) {
                ...
                if (genericDescriptor.getFile() == put.getFile()) {
                    ...
                    if (lastIndexOf == -1) {
                        throw new DescriptorValidationException(genericDescriptor, Typography.quote + fullName + "\" is already defined.", (AnonymousClass1) null);
                    }
                    throw new DescriptorValidationException(genericDescriptor, Typography.quote + fullName.substring(lastIndexOf + 1) + "\" is already defined in \"" + fullName.substring(0, lastIndexOf) + "\".", (AnonymousClass1) null);
                }
                throw new DescriptorValidationException(genericDescriptor, Typography.quote + fullName + "\" is already defined in file \"" + put.getFile().getName() + "\".", (AnonymousClass1) null);
            }
        }
        ...
        public void addPackage(String str, FileDescriptor fileDescriptor) throws DescriptorValidationException {
            ...
            if (put != null) {
                ...
                if (!(put instanceof PackageDescriptor)) {
                    throw new DescriptorValidationException(fileDescriptor, Typography.quote + str2 + "\" is already defined (as something other than a package) in file \"" + put.getFile().getName() + "\".", (AnonymousClass1) null);
                }
            }
        }
            ...
            if (name.length() != 0) {
                for (int i = 0; i < name.length(); i++) {
                    ...
                    if (('a' > charAt || charAt > 'z') && (('A' > charAt || charAt > 'Z') && charAt != '_' && ('0' > charAt || charAt > '9' || i <= 0))) {
                        throw new DescriptorValidationException(genericDescriptor, Typography.quote + name + "\" is not a valid identifier.", (AnonymousClass1) null);
                    }
                }
                return;
            }
