    ...
    public <UT, UB> UB parseExtension(Reader reader, Object obj, ExtensionRegistryLite extensionRegistryLite, FieldSet<Descriptors.FieldDescriptor> fieldSet, UB ub, UnknownFieldSchema<UT, UB> unknownFieldSchema) throws IOException {
        ...
        if (!extensionInfo.descriptor.isRepeated() || !extensionInfo.descriptor.isPacked()) {
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[extensionInfo.descriptor.getLiteType().ordinal()]) {
                ...
                case 4:
                    arrayList2 = new ArrayList();
                    reader.readUInt64List(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 5:
                    arrayList2 = new ArrayList();
                    reader.readInt32List(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 6:
                    arrayList2 = new ArrayList();
                    reader.readFixed64List(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 7:
                    arrayList2 = new ArrayList();
                    reader.readFixed32List(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 8:
                    arrayList2 = new ArrayList();
                    reader.readBoolList(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 9:
                    arrayList2 = new ArrayList();
                    reader.readUInt32List(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 10:
                    arrayList2 = new ArrayList();
                    reader.readSFixed32List(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 11:
                    arrayList2 = new ArrayList();
                    reader.readSFixed64List(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 12:
                    arrayList2 = new ArrayList();
                    reader.readSInt32List(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 13:
                    arrayList2 = new ArrayList();
                    reader.readSInt64List(arrayList2);
                    arrayList = arrayList2;
                    break;
                case 14:
