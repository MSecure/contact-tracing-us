...
public class FinderPatternFinder {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:66:0x00eb A[ADDED_TO_REGION, RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:67:0x00ec  */
    /* JADX WARNING: Removed duplicated region for block: B:94:0x00e7 A[ADDED_TO_REGION, EDGE_INSN: B:94:0x00e7->B:64:0x00e7 ?: BREAK  , SYNTHETIC] */
    private boolean crossCheckDiagonal(int i, int i2, int i3, int i4) {
        ...
        if (i >= i10 && i2 >= i10) {
            ...
            if (i >= i10 && i2 >= i10 && crossCheckStateCount2[1] <= i3) {
                ...
                while (true) {
                    int i12 = i + i11;
                    if (i12 < height && (i9 = i2 + i11) < width && this.image.get(i9, i12)) {
                        crossCheckStateCount2[2] = crossCheckStateCount2[2] + 1;
                        i11++;
                    } else if (i12 < height && i2 + i11 < width) {
                        while (true) {
                            i5 = i + i11;
                            if (i5 < height && (i8 = i2 + i11) < width && !this.image.get(i8, i5) && crossCheckStateCount2[3] < i3) {
                                crossCheckStateCount2[3] = crossCheckStateCount2[3] + 1;
                                i11++;
                            } else if (i5 < height && i2 + i11 < width && crossCheckStateCount2[3] < i3) {
                                while (true) {
                                    i6 = i + i11;
                                    if (i6 >= height && (i7 = i2 + i11) < width && this.image.get(i7, i6) && crossCheckStateCount2[4] < i3) {
                        ...
                        return crossCheckStateCount2[4] >= i3;
                    }
                }
                while (true) {
                    i5 = i + i11;
