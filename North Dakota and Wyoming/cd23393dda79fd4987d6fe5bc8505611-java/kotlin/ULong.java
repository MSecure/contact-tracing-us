...
public final class ULong implements Comparable<ULong> {
    ...
    private static final long m200toULongimpl(long j) {
        return j;
    }
    ...
    private static final int m159compareToxj2QHRw(long j, short s) {
        return UnsignedKt.ulongCompare(j, m160constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }
    ...
    private static final long m179plusxj2QHRw(long j, short s) {
        return m160constructorimpl(j + m160constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }
    ...
    private static final long m162div7apg3OU(long j, byte b) {
        return UnsignedKt.m319ulongDivideeb3DHEI(j, m160constructorimpl(((long) b) & 255));
    }

    /* renamed from: div-xj2QHRw  reason: not valid java name */
    private static final long m165divxj2QHRw(long j, short s) {
        return UnsignedKt.m319ulongDivideeb3DHEI(j, m160constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* renamed from: div-WZ4Q5Ns  reason: not valid java name */
    private static final long m164divWZ4Q5Ns(long j, int i) {
        return UnsignedKt.m319ulongDivideeb3DHEI(j, m160constructorimpl(((long) i) & 4294967295L));
    }

    /* renamed from: div-VKZWuLQ  reason: not valid java name */
    private static final long m163divVKZWuLQ(long j, long j2) {
        return UnsignedKt.m319ulongDivideeb3DHEI(j, j2);
    }

    /* renamed from: rem-7apg3OU  reason: not valid java name */
    private static final long m181rem7apg3OU(long j, byte b) {
        return UnsignedKt.m320ulongRemaindereb3DHEI(j, m160constructorimpl(((long) b) & 255));
    }

    /* renamed from: rem-xj2QHRw  reason: not valid java name */
    private static final long m184remxj2QHRw(long j, short s) {
        return UnsignedKt.m320ulongRemaindereb3DHEI(j, m160constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* renamed from: rem-WZ4Q5Ns  reason: not valid java name */
    private static final long m183remWZ4Q5Ns(long j, int i) {
        return UnsignedKt.m320ulongRemaindereb3DHEI(j, m160constructorimpl(((long) i) & 4294967295L));
    }

    /* renamed from: rem-VKZWuLQ  reason: not valid java name */
    private static final long m182remVKZWuLQ(long j, long j2) {
        return UnsignedKt.m320ulongRemaindereb3DHEI(j, j2);
    }

    /* renamed from: inc-impl  reason: not valid java name */
    private static final long m169incimpl(long j) {
        return m160constructorimpl(j + 1);
    }

    /* renamed from: dec-impl  reason: not valid java name */
    private static final long m161decimpl(long j) {
        return m160constructorimpl(j - 1);
    }
    ...
    private static final long m185shlimpl(long j, int i) {
        return m160constructorimpl(j << i);
    }

    /* renamed from: shr-impl  reason: not valid java name */
    private static final long m186shrimpl(long j, int i) {
        return m160constructorimpl(j >>> i);
    }
    ...
    private static final long m170invimpl(long j) {
        return m160constructorimpl(~j);
    }

    /* renamed from: toUByte-impl  reason: not valid java name */
    private static final byte m198toUByteimpl(long j) {
        return UByte.m24constructorimpl((byte) ((int) j));
    }

    /* renamed from: toUShort-impl  reason: not valid java name */
    private static final short m201toUShortimpl(long j) {
        return UShort.m257constructorimpl((short) ((int) j));
    }

    /* renamed from: toUInt-impl  reason: not valid java name */
    private static final int m199toUIntimpl(long j) {
        return UInt.m91constructorimpl((int) j);
    }
