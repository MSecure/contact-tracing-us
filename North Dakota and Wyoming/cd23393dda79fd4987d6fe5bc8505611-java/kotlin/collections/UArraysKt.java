...
public final class UArraysKt {
    ...
    public static final int m349random2D5oskM(int[] iArr, Random random) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UIntArray.m145isEmptyimpl(iArr)) {
            return UIntArray.m142getimpl(iArr, random.nextInt(UIntArray.m143getSizeimpl(iArr)));
        }
    ...
    public static final long m350randomJzugnMA(long[] jArr, Random random) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!ULongArray.m214isEmptyimpl(jArr)) {
            return ULongArray.m211getimpl(jArr, random.nextInt(ULongArray.m212getSizeimpl(jArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final byte m351randomoSF2wD8(byte[] bArr, Random random) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UByteArray.m76isEmptyimpl(bArr)) {
            return UByteArray.m73getimpl(bArr, random.nextInt(UByteArray.m74getSizeimpl(bArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final short m352randoms5X_as8(short[] sArr, Random random) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$random");
        Intrinsics.checkParameterIsNotNull(random, "random");
        if (!UShortArray.m309isEmptyimpl(sArr)) {
            return UShortArray.m306getimpl(sArr, random.nextInt(UShortArray.m307getSizeimpl(sArr)));
        }
        throw new NoSuchElementException("Array is empty.");
    }
    ...
    public static final boolean m337contentEqualsctEhBpI(int[] iArr, int[] iArr2) {
    ...
    public static final boolean m340contentEqualsus8wMrg(long[] jArr, long[] jArr2) {
    ...
    public static final boolean m338contentEqualskdPth3s(byte[] bArr, byte[] bArr2) {
    ...
    public static final boolean m339contentEqualsmazbYpA(short[] sArr, short[] sArr2) {
    ...
    public static final int m341contentHashCodeajY9A(int[] iArr) {
    ...
    public static final int m343contentHashCodeQwZRm1k(long[] jArr) {
    ...
    public static final int m342contentHashCodeGBYM_sE(byte[] bArr) {
    ...
    public static final int m344contentHashCoderL5Bavg(short[] sArr) {
    ...
    public static final String m345contentToStringajY9A(int[] iArr) {
    ...
    public static final String m347contentToStringQwZRm1k(long[] jArr) {
    ...
    public static final String m346contentToStringGBYM_sE(byte[] bArr) {
    ...
    public static final String m348contentToStringrL5Bavg(short[] sArr) {
    ...
    public static final UInt[] m353toTypedArrayajY9A(int[] iArr) {
        Intrinsics.checkParameterIsNotNull(iArr, "$this$toTypedArray");
        int r0 = UIntArray.m143getSizeimpl(iArr);
        UInt[] uIntArr = new UInt[r0];
        for (int i = 0; i < r0; i++) {
            uIntArr[i] = UInt.m85boximpl(UIntArray.m142getimpl(iArr, i));
        }
        return uIntArr;
    }
    ...
    public static final ULong[] m355toTypedArrayQwZRm1k(long[] jArr) {
        Intrinsics.checkParameterIsNotNull(jArr, "$this$toTypedArray");
        int r0 = ULongArray.m212getSizeimpl(jArr);
        ULong[] uLongArr = new ULong[r0];
        for (int i = 0; i < r0; i++) {
            uLongArr[i] = ULong.m154boximpl(ULongArray.m211getimpl(jArr, i));
        }
        return uLongArr;
    }
    ...
    public static final UByte[] m354toTypedArrayGBYM_sE(byte[] bArr) {
        Intrinsics.checkParameterIsNotNull(bArr, "$this$toTypedArray");
        int r0 = UByteArray.m74getSizeimpl(bArr);
        UByte[] uByteArr = new UByte[r0];
        for (int i = 0; i < r0; i++) {
            uByteArr[i] = UByte.m18boximpl(UByteArray.m73getimpl(bArr, i));
        }
        return uByteArr;
    }
    ...
    public static final UShort[] m356toTypedArrayrL5Bavg(short[] sArr) {
        Intrinsics.checkParameterIsNotNull(sArr, "$this$toTypedArray");
        int r0 = UShortArray.m307getSizeimpl(sArr);
        UShort[] uShortArr = new UShort[r0];
        for (int i = 0; i < r0; i++) {
            uShortArr[i] = UShort.m251boximpl(UShortArray.m306getimpl(sArr, i));
        }
        return uShortArr;
    }
}
