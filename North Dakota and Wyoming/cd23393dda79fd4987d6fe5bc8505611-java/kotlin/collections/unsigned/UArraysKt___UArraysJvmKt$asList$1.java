...
public final class UArraysKt___UArraysJvmKt$asList$1 extends AbstractList<UInt> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m373containsWZ4Q5Ns(((UInt) obj).m134unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UInt) {
            return m374indexOfWZ4Q5Ns(((UInt) obj).m134unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UInt) {
            return m375lastIndexOfWZ4Q5Ns(((UInt) obj).m134unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UIntArray.m143getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection
    public boolean isEmpty() {
        return UIntArray.m145isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-WZ4Q5Ns  reason: not valid java name */
    public boolean m373containsWZ4Q5Ns(int i) {
        return UIntArray.m138containsWZ4Q5Ns(this.$this_asList, i);
    }

    @Override // java.util.List, kotlin.collections.AbstractList
    public UInt get(int i) {
        return UInt.m85boximpl(UIntArray.m142getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-WZ4Q5Ns  reason: not valid java name */
    public int m374indexOfWZ4Q5Ns(int i) {
        return ArraysKt.indexOf(this.$this_asList, i);
    }

    /* renamed from: lastIndexOf-WZ4Q5Ns  reason: not valid java name */
    public int m375lastIndexOfWZ4Q5Ns(int i) {
