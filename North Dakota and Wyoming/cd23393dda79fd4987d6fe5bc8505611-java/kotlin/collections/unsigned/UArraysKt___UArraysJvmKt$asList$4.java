...
public final class UArraysKt___UArraysJvmKt$asList$4 extends AbstractList<UShort> implements RandomAccess {
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UShort) {
            return m382containsxj2QHRw(((UShort) obj).m298unboximpl());
        }
        return false;
    }
    ...
    public final /* bridge */ int indexOf(Object obj) {
        if (obj instanceof UShort) {
            return m383indexOfxj2QHRw(((UShort) obj).m298unboximpl());
        }
        return -1;
    }
    ...
    public final /* bridge */ int lastIndexOf(Object obj) {
        if (obj instanceof UShort) {
            return m384lastIndexOfxj2QHRw(((UShort) obj).m298unboximpl());
        }
        return -1;
    }
    ...
    public int getSize() {
        return UShortArray.m307getSizeimpl(this.$this_asList);
    }

    @Override // kotlin.collections.AbstractCollection
    public boolean isEmpty() {
        return UShortArray.m309isEmptyimpl(this.$this_asList);
    }

    /* renamed from: contains-xj2QHRw  reason: not valid java name */
    public boolean m382containsxj2QHRw(short s) {
        return UShortArray.m302containsxj2QHRw(this.$this_asList, s);
    }

    @Override // java.util.List, kotlin.collections.AbstractList
    public UShort get(int i) {
        return UShort.m251boximpl(UShortArray.m306getimpl(this.$this_asList, i));
    }

    /* renamed from: indexOf-xj2QHRw  reason: not valid java name */
    public int m383indexOfxj2QHRw(short s) {
        return ArraysKt.indexOf(this.$this_asList, s);
    }

    /* renamed from: lastIndexOf-xj2QHRw  reason: not valid java name */
    public int m384lastIndexOfxj2QHRw(short s) {
