...
public class ComponentActivity extends g implements l, h0, e.q.g, e.v.c, e.a.c, e.a.e.d {
    ...
    public final ActivityResultRegistry f7j;
    ...
    public class b extends ActivityResultRegistry {
        ...
        public <I, O> void b(int i2, e.a.e.f.a<I, O> aVar, I i3, e.i.a.d dVar) {
            Bundle bundle;
            ...
            if ("androidx.activity.result.contract.action.REQUEST_PERMISSIONS".equals(a2.getAction())) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    ...
                    new Handler(Looper.getMainLooper()).post(new e.i.a.a(stringArrayExtra, componentActivity, i2));
                }
    ...
    public class d implements e.a.d.b {
        ...
        public void a(Context context) {
            Bundle a2 = ComponentActivity.this.f2e.b.a("android:support:activity-result");
            if (a2 != null) {
                ActivityResultRegistry activityResultRegistry = ComponentActivity.this.f7j;
                Objects.requireNonNull(activityResultRegistry);
                ...
                if (!(stringArrayList == null || integerArrayList == null)) {
                    activityResultRegistry.f15e = a2.getStringArrayList("KEY_COMPONENT_ACTIVITY_LAUNCHED_KEYS");
                    activityResultRegistry.a = (Random) a2.getSerializable("KEY_COMPONENT_ACTIVITY_RANDOM_OBJECT");
                    activityResultRegistry.f18h.putAll(a2.getBundle("KEY_COMPONENT_ACTIVITY_PENDING_RESULT"));
