...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attributeSet, int i2) {
        ...
        c1 q2 = c1.q(context2, attributeSet, iArr, i2, 0);
        v.t(this, context, iArr, attributeSet, q2.b, i2, 0);
        ...
        this.f96g = q2.g(R$styleable.Toolbar_collapseIcon);
        this.f97h = q2.n(R$styleable.Toolbar_collapseContentDescription);
    ...
    public int getContentInsetEnd() {
        t0 t0Var = this.u;
        if (t0Var != null) {
            return t0Var.f963g ? t0Var.a : t0Var.b;
        }
        return 0;
    }
    ...
    public int getContentInsetStart() {
        t0 t0Var = this.u;
        if (t0Var != null) {
            return t0Var.f963g ? t0Var.b : t0Var.a;
        }
        return 0;
    }
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (u(this.f94e)) {
            ...
            if (z3) {
                ...
                if (!u2 || u3) {
                    TextView textView = !u2 ? this.c : this.f93d;
                    TextView textView2 = !u3 ? this.f93d : this.c;
                    e eVar3 = (e) textView.getLayoutParams();
                    e eVar4 = (e) textView2.getLayoutParams();
                    boolean z4 = (!u2 && this.c.getMeasuredWidth() > 0) || (u3 && this.f93d.getMeasuredWidth() > 0);
                    i19 = this.x & 112;
                    i12 = paddingLeft;
                    if (i19 != 48) {
                        i20 = max;
    ...
    public void setCollapseIcon(int i2) {
        setCollapseIcon(m.e.h0(getContext(), i2));
    }
    ...
    public void setNavigationIcon(int i2) {
        setNavigationIcon(m.e.h0(getContext(), i2));
    }
