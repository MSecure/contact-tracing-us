...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public void Q1(int i2) {
        if (i2 != this.H) {
            ...
            throw new IllegalArgumentException(f.a.a.a.a.t("Span count should be at least 1. Provided ", i2));
        }
    }
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.m
    public void n0(RecyclerView.t tVar, RecyclerView.y yVar, View view, e.i.i.c0.b bVar) {
        boolean z;
        boolean z2;
        int i2;
        int i3;
