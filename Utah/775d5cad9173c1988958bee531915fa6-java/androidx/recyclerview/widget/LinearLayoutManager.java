...
public class LinearLayoutManager extends RecyclerView.m implements RecyclerView.x.b {
    ...
    public static class c {
        ...
        public void a(View view) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (view3 != view && !nVar.c() && (a2 = (nVar.a() - this.f200d) * this.f201e) >= 0 && a2 < i3) {
                    view2 = view3;
                    if (a2 == 0) {
                        break;
                    }
    ...
    public void D1(int i2) {
        ...
        throw new IllegalArgumentException(f.a.a.a.a.t("invalid orientation:", i2));
    }
    ...
    public void v0(RecyclerView.t tVar, RecyclerView.y yVar) {
                        ...
                        if (u3 != null) {
                            if (this.t.c(u3) <= this.t.l()) {
                                if (this.t.e(u3) - this.t.k() < 0) {
                                    ...
                                    aVar2.c = aVar2.f197d ? this.t.m() + this.t.b(u3) : this.t.e(u3);
                                }
                                z2 = true;
                                if (!z2) {
                                    if (z() != 0) {
        ...
        if (!(!yVar.f266g || (i7 = this.z) == -1 || this.A == Integer.MIN_VALUE || (u2 = u(i7)) == null)) {
            if (this.w) {
