...
public class SystemForegroundService extends o implements c.a {
    ...
    public final void b() {
        ...
        this.f313e = cVar;
        if (cVar.f1110k != null) {
            n.c().b(c.f1102l, "A callback already exists.", new Throwable[0]);
        } else {
            cVar.f1110k = this;
        }
    }
    ...
    public int onStartCommand(Intent intent, int i2, int i3) {
        ...
        if ("ACTION_START_FOREGROUND".equals(action)) {
            n.c().d(c.f1102l, String.format("Started foreground service %s", intent), new Throwable[0]);
            String stringExtra = intent.getStringExtra("KEY_WORKSPEC_ID");
            WorkDatabase workDatabase = cVar.c.c;
            e.b0.a0.t.t.a aVar = cVar.f1103d;
            ((b) aVar).a.execute(new e.b0.a0.r.b(cVar, workDatabase, stringExtra));
        } else if (!"ACTION_NOTIFY".equals(action)) {
            if ("ACTION_CANCEL_WORK".equals(action)) {
                n.c().d(c.f1102l, String.format("Stopping foreground work for %s", intent), new Throwable[0]);
                ...
                ((b) lVar.f1027d).a.execute(new e.b0.a0.t.a(lVar, fromString));
                return 3;
            } else if (!"ACTION_STOP_FOREGROUND".equals(action)) {
                return 3;
            } else {
                n.c().d(c.f1102l, "Stopping foreground service", new Throwable[0]);
                c.a aVar2 = cVar.f1110k;
                if (aVar2 == null) {
                    return 3;
                }
