...
public class SnackbarContentLayout extends LinearLayout implements n {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f598d = obtainStyledAttributes.getDimensionPixelSize(R$styleable.SnackbarLayout_android_maxWidth, -1);
        this.f599e = obtainStyledAttributes.getDimensionPixelSize(R$styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f598d > 0 && getMeasuredWidth() > (i4 = this.f598d)) {
        ...
        if (!z2 || this.f599e <= 0 || this.c.getMeasuredWidth() <= this.f599e) {
            if (!z2) {
