...
public class g extends r implements DialogInterface {
    ...
    public final AlertController f650d = new AlertController(getContext(), this, getWindow());
    ...
    public static class a {
        ...
        public g a() {
            ...
            AlertController alertController = gVar.f650d;
            View view = bVar.f32e;
            if (view != null) {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AlertController alertController = this.f650d;
    ...
    public boolean onKeyDown(int i2, KeyEvent keyEvent) {
        NestedScrollView nestedScrollView = this.f650d.A;
