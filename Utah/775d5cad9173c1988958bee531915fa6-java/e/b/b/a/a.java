...
public class a extends d implements e.i.c.m.a {
    public c q;
    public g r;
    public int s;
    public int t;
    ...
    public static class d extends g {
        public final e.z.a.a.c a;

        public d(e.z.a.a.c cVar) {
            super(null);
            this.a = cVar;
        }
    ...
    public static a g(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
        ...
        if (name.equals("animated-selector")) {
            ...
            TypedArray W0 = m.e.W0(resources, theme2, attributeSet2, R$styleable.AnimatedStateListDrawableCompat);
            int i2 = 1;
            aVar.setVisible(W0.getBoolean(R$styleable.AnimatedStateListDrawableCompat_android_visible, true), true);
            c cVar = aVar.q;
            cVar.f720d |= e.b.c.b.b(W0);
            cVar.f725i = W0.getBoolean(R$styleable.AnimatedStateListDrawableCompat_android_variablePadding, cVar.f725i);
            cVar.f728l = W0.getBoolean(R$styleable.AnimatedStateListDrawableCompat_android_constantSize, cVar.f728l);
            cVar.A = W0.getInt(R$styleable.AnimatedStateListDrawableCompat_android_enterFadeDuration, cVar.A);
            cVar.B = W0.getInt(R$styleable.AnimatedStateListDrawableCompat_android_exitFadeDuration, cVar.B);
            aVar.setDither(W0.getBoolean(R$styleable.AnimatedStateListDrawableCompat_android_dither, cVar.x));
            aVar.b.f(resources);
            W0.recycle();
            ...
            while (true) {
                ...
                if (next3 == i2 || ((depth = xmlPullParser.getDepth()) < depth2 && next3 == 3)) {
                    ...
                    if (xmlPullParser.getName().equals("item")) {
                        TypedArray W02 = m.e.W0(resources2, theme2, attributeSet2, R$styleable.AnimatedStateListDrawableItem);
                        int resourceId = W02.getResourceId(R$styleable.AnimatedStateListDrawableItem_android_id, 0);
                        int resourceId2 = W02.getResourceId(R$styleable.AnimatedStateListDrawableItem_android_drawable, -1);
                        if (resourceId2 > 0) {
                        ...
                        if (drawable == null) {
                            ...
                            if (next2 == 2) {
                                drawable = xmlPullParser.getName().equals("vector") ? e.z.a.a.g.a(resources, xmlPullParser, attributeSet, theme) : e.b.c.b.a(resources, xmlPullParser, attributeSet, theme);
                            } else {
                        ...
                        if (xmlPullParser.getName().equals("transition")) {
                            TypedArray W03 = m.e.W0(resources2, theme2, attributeSet2, R$styleable.AnimatedStateListDrawableTransition);
                            int resourceId3 = W03.getResourceId(R$styleable.AnimatedStateListDrawableTransition_android_fromId, -1);
                            int resourceId4 = W03.getResourceId(R$styleable.AnimatedStateListDrawableTransition_android_toId, -1);
                            int resourceId5 = W03.getResourceId(R$styleable.AnimatedStateListDrawableTransition_android_drawable, -1);
                            e.z.a.a.c f2 = resourceId5 > 0 ? r0.d().f(context2, resourceId5) : null;
                            boolean z = W03.getBoolean(R$styleable.AnimatedStateListDrawableTransition_android_reversible, false);
                            W03.recycle();
                            e.z.a.a.c cVar3 = f2;
                            if (f2 == null) {
                                do {
                                ...
                                if (next != 2) {
                                    ...
                                    e.z.a.a.c cVar4 = new e.z.a.a.c(context2, null, null);
        ...
        if (g2 != i2) {
            ...
            if (!(i4 == 0 || i3 == 0)) {
                ...
                if (longValue >= 0) {
                    ...
                    } else if (drawable instanceof e.z.a.a.c) {
                        gVar = new d((e.z.a.a.c) drawable);
