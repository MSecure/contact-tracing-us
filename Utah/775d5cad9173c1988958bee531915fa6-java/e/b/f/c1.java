...
public class c1 {
    ...
    public ColorStateList c(int i2) {
        int resourceId;
        ColorStateList f0;
        return (!this.b.hasValue(i2) || (resourceId = this.b.getResourceId(i2, 0)) == 0 || (f0 = m.e.f0(this.a, resourceId)) == null) ? this.b.getColorStateList(i2) : f0;
    }
    ...
    public Drawable g(int i2) {
        int resourceId;
        return (!this.b.hasValue(i2) || (resourceId = this.b.getResourceId(i2, 0)) == 0) ? this.b.getDrawable(i2) : m.e.h0(this.a, resourceId);
    }
