...
public class e1 implements h0 {
    ...
    public e1(Toolbar toolbar, boolean z) {
        ...
        if (z) {
            ...
            if (this.f874g == null && (drawable = this.p) != null) {
                this.f874g = drawable;
                z();
            }
        ...
        if (i3 != this.o) {
            ...
            if (TextUtils.isEmpty(this.a.getNavigationContentDescription())) {
                int i4 = this.o;
                this.f878k = i4 != 0 ? q().getString(i4) : str;
                y();
            }
        }
        this.f878k = this.a.getNavigationContentDescription();
    ...
    public final void A() {
        ...
        if ((i2 & 2) == 0) {
            drawable = null;
        } else if ((i2 & 1) == 0 || (drawable = this.f873f) == null) {
            drawable = this.f872e;
        }
    ...
    public void m(int i2) {
        this.f873f = i2 != 0 ? m.e.h0(q(), i2) : null;
        A();
    }
    ...
    public void setIcon(int i2) {
        this.f872e = i2 != 0 ? m.e.h0(q(), i2) : null;
        A();
    }
    ...
    public void x(int i2) {
        ...
        if (i3 != 0) {
            ...
            if ((i3 & 16) != 0 && (view = this.f871d) != null) {
                if ((i2 & 16) != 0) {
                    this.a.addView(view);
                } else {
                    this.a.removeView(view);
    ...
    public final void y() {
        ...
        if (TextUtils.isEmpty(this.f878k)) {
            ...
            this.a.setNavigationContentDescription(this.f878k);
        }
    }
