...
public class j0 extends ListView {
    ...
    public boolean b(MotionEvent motionEvent, int i2) {
        ...
        if (findPointerIndex >= 0) {
            ...
            if (pointToPosition != -1) {
                ...
                rect.left -= this.c;
                rect.top -= this.f908d;
                rect.right += this.f909e;
                rect.bottom += this.f910f;
                try {
                    boolean z4 = this.f912h.getBoolean(this);
                    if (childAt3.isEnabled() != z4) {
                        this.f912h.set(this, Boolean.valueOf(!z4));
                        if (pointToPosition != -1) {
            ...
            if (!z || z2) {
                ...
                childAt = getChildAt(this.f911g - getFirstVisiblePosition());
                if (childAt != null) {
    ...
    public final void c() {
        Drawable selector = getSelector();
        if (selector != null && this.f916l && isPressed()) {
    ...
    public boolean hasFocus() {
        return this.f915k || super.hasFocus();
    }

    public boolean hasWindowFocus() {
        return this.f915k || super.hasWindowFocus();
    }

    public boolean isFocused() {
        return this.f915k || super.isFocused();
    }

    public boolean isInTouchMode() {
        return (this.f915k && this.f914j) || super.isInTouchMode();
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f911g = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY());
        }
        b bVar = this.n;
        if (bVar != null) {
            j0 j0Var = j0.this;
    ...
    public void setSelector(Drawable drawable) {
        ...
        this.c = rect.left;
        this.f908d = rect.top;
        this.f909e = rect.right;
        this.f910f = rect.bottom;
    }
}
