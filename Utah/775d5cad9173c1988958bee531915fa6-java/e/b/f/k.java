...
public final class k {
    ...
    public class a implements r0.f {
        ...
        public final int[] f917d = {R$drawable.abc_popup_background_mtrl_mult, R$drawable.abc_cab_background_internal_bg, R$drawable.abc_menu_hardkey_panel_mtrl_mult};

        /* renamed from: e  reason: collision with root package name */
        public final int[] f918e = {R$drawable.abc_tab_indicator_material, R$drawable.abc_textfield_search_material};

        /* renamed from: f  reason: collision with root package name */
        public final int[] f919f = {R$drawable.abc_btn_check_material, R$drawable.abc_btn_radio_material, R$drawable.abc_btn_check_material_anim, R$drawable.abc_btn_radio_material_anim};
        ...
        public final ColorStateList b(Context context, int i2) {
            ...
            return new ColorStateList(new int[][]{x0.b, x0.f986d, x0.c, x0.f988f}, new int[]{b2, e.i.c.a.a(c2, i2), e.i.c.a.a(c2, i2), i2});
        }
        ...
        public ColorStateList d(Context context, int i2) {
            if (i2 == R$drawable.abc_edit_text_material) {
                return m.e.f0(context, R$color.abc_tint_edittext);
            }
            if (i2 == R$drawable.abc_switch_track_mtrl_alpha) {
                return m.e.f0(context, R$color.abc_tint_switch_track);
            }
            if (i2 == R$drawable.abc_switch_thumb_material) {
                ...
                if (i2 == R$drawable.abc_spinner_mtrl_am_alpha || i2 == R$drawable.abc_spinner_textfield_background_material) {
                    return m.e.f0(context, R$color.abc_tint_spinner);
                }
                if (a(this.b, i2)) {
                    return x0.d(context, R$attr.colorControlNormal);
                }
                if (a(this.f918e, i2)) {
                    return m.e.f0(context, R$color.abc_tint_default);
                }
                if (a(this.f919f, i2)) {
                    return m.e.f0(context, R$color.abc_tint_btn_checkable);
                }
                if (i2 == R$drawable.abc_seekbar_thumb_material) {
                    return m.e.f0(context, R$color.abc_tint_seek_thumb);
                }
                return null;
            }
        }
    ...
    public static void f(Drawable drawable, a1 a1Var, int[] iArr) {
        PorterDuff.Mode mode = r0.f953h;
        if (!i0.a(drawable) || drawable.mutate() == drawable) {
            boolean z = a1Var.f836d;
            if (z || a1Var.c) {
                PorterDuffColorFilter porterDuffColorFilter = null;
                ColorStateList colorStateList = z ? a1Var.a : null;
                PorterDuff.Mode mode2 = a1Var.c ? a1Var.b : r0.f953h;
