...
public class v0 extends c implements View.OnClickListener {
    ...
    public static final class a {
        ...
        public a(View view) {
            ...
            this.f969d = (ImageView) view.findViewById(16908296);
            this.f970e = (ImageView) view.findViewById(R$id.edit_query);
        }
    }
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        ImageView imageView2 = aVar.f969d;
        if (imageView2 != null) {
            int i5 = this.x;
            if (i5 != -1) {
        ...
        int i6 = this.r;
        if (i6 == 2 || (i6 == 1 && (i3 & 1) != 0)) {
            aVar.f970e.setVisibility(0);
            aVar.f970e.setTag(aVar.a.getText());
            aVar.f970e.setOnClickListener(this);
            return;
        }
        aVar.f970e.setVisibility(8);
    }
    ...
    public View d(Context context, Cursor cursor, ViewGroup viewGroup) {
        View inflate = this.f1591l.inflate(this.f1589j, viewGroup, false);
    ...
    public View getDropDownView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            View inflate = this.f1591l.inflate(this.f1590k, viewGroup, false);
            if (inflate != null) {
    ...
    public View getView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            View d2 = d(this.o, this.f1583d, viewGroup);
