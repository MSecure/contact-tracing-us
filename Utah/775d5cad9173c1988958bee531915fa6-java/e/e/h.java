...
public class h<K, V> {
    ...
    public static Object[] f1228e;

    /* renamed from: f  reason: collision with root package name */
    public static int f1229f;

    /* renamed from: g  reason: collision with root package name */
    public static Object[] f1230g;

    /* renamed from: h  reason: collision with root package name */
    public static int f1231h;
    public int[] b;
    public Object[] c;
    ...
    public final void a(int i2) {
        if (i2 == 8) {
            synchronized (h.class) {
                Object[] objArr = f1230g;
                if (objArr != null) {
                    this.c = objArr;
                    f1230g = (Object[]) objArr[0];
                    this.b = (int[]) objArr[1];
                    objArr[1] = null;
                    objArr[0] = null;
                    f1231h--;
            ...
            synchronized (h.class) {
                Object[] objArr2 = f1228e;
                if (objArr2 != null) {
                    this.c = objArr2;
                    f1228e = (Object[]) objArr2[0];
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof h) {
            h hVar = (h) obj;
            if (this.f1232d != hVar.f1232d) {
                return false;
            }
            for (int i2 = 0; i2 < this.f1232d; i2++) {
                try {
                    K h2 = h(i2);
                    V k2 = k(i2);
        ...
        if (obj instanceof Map) {
            Map map = (Map) obj;
            if (this.f1232d != map.size()) {
                return false;
            }
            for (int i3 = 0; i3 < this.f1232d; i3++) {
                try {
                    K h3 = h(i3);
                    V k3 = k(i3);
    ...
    public V put(K k2, V v) {
        ...
        if (i6 < i4) {
            ...
            Object[] objArr3 = this.c;
            System.arraycopy(objArr3, i6 << 1, objArr3, i8 << 1, (this.f1232d - i6) << 1);
        }
        int i9 = this.f1232d;
        if (i4 == i9) {
            int[] iArr4 = this.b;
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder(this.f1232d * 28);
        sb.append('{');
        for (int i2 = 0; i2 < this.f1232d; i2++) {
            if (i2 > 0) {
                sb.append(", ");
