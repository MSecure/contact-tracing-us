...
public abstract class a<V> implements u<V> {
    ...
    public static final boolean f1236e = Boolean.parseBoolean(System.getProperty("guava.concurrent.generate_cancellation_cause", "false"));

    /* renamed from: f  reason: collision with root package name */
    public static final Logger f1237f = Logger.getLogger(a.class.getName());

    /* renamed from: g  reason: collision with root package name */
    public static final b f1238g;

    /* renamed from: h  reason: collision with root package name */
    public static final Object f1239h = new Object();
    public volatile Object b;
    public volatile e c;

    /* renamed from: d  reason: collision with root package name */
    public volatile i f1240d;
    ...
    public static final class e {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final e f1242d = new e(null, null);
    ...
    public static final class f extends b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<a, e> f1243d;

        /* renamed from: e  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<a, Object> f1244e;
        ...
        public f(AtomicReferenceFieldUpdater<i, Thread> atomicReferenceFieldUpdater, AtomicReferenceFieldUpdater<i, i> atomicReferenceFieldUpdater2, AtomicReferenceFieldUpdater<a, i> atomicReferenceFieldUpdater3, AtomicReferenceFieldUpdater<a, e> atomicReferenceFieldUpdater4, AtomicReferenceFieldUpdater<a, Object> atomicReferenceFieldUpdater5) {
            ...
            this.f1243d = atomicReferenceFieldUpdater4;
            this.f1244e = atomicReferenceFieldUpdater5;
        }

        @Override // e.f.a.a.b
        public boolean a(a<?> aVar, e eVar, e eVar2) {
            return this.f1243d.compareAndSet(aVar, eVar, eVar2);
        }

        @Override // e.f.a.a.b
        public boolean b(a<?> aVar, Object obj, Object obj2) {
            return this.f1244e.compareAndSet(aVar, obj, obj2);
        }
    ...
    public static final class i {
        ...
        public i() {
            a.f1238g.e(this, Thread.currentThread());
        }
    ...
    static {
        ...
        f1238g = bVar;
        if (th != null) {
            f1237f.log(Level.SEVERE, "SafeAtomicHelper is broken!", th);
        }
    }
    ...
    public static void c(a<?> aVar) {
        ...
        do {
            eVar = aVar.c;
        } while (!f1238g.a(aVar, eVar, e.f1242d));
        e eVar2 = null;
        while (eVar != null) {
            e eVar3 = eVar.c;
            eVar.c = eVar2;
    ...
    public final boolean cancel(boolean z) {
        ...
        c cVar = f1236e ? new c(z, new CancellationException("Future.cancel() was called.")) : z ? c.c : c.f1241d;
        while (!f1238g.b(this, obj, cVar)) {
            obj = this.b;
            if (!(obj instanceof g)) {
            }
        }
        ...
        while (true) {
            ...
            if (iVar2 != i.c) {
                ...
                while (iVar2 != null) {
                    ...
                    } else if (!f1238g.c(this, iVar2, iVar4)) {
                    }
                    iVar2 = iVar4;
                }
                return;
    ...
    public boolean j(Throwable th) {
        Objects.requireNonNull(th);
        if (!f1238g.b(this, null, new d(th))) {
            return false;
        }
        c(this);
        return true;
