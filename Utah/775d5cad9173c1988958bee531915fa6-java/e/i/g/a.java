...
public final class a {
    ...
    public static final c f1514d;

    /* renamed from: e  reason: collision with root package name */
    public static final String f1515e = Character.toString(8206);

    /* renamed from: f  reason: collision with root package name */
    public static final String f1516f = Character.toString(8207);

    /* renamed from: g  reason: collision with root package name */
    public static final a f1517g;

    /* renamed from: h  reason: collision with root package name */
    public static final a f1518h;
    ...
    public static class C0035a {
        ...
        /* renamed from: e  reason: collision with root package name */
        public static final byte[] f1519e = new byte[1792];
        ...
        static {
            for (int i2 = 0; i2 < 1792; i2++) {
                f1519e[i2] = Character.getDirectionality(i2);
            }
        }

        public C0035a(CharSequence charSequence, boolean z) {
            this.a = charSequence;
        ...
        public byte a() {
            ...
            this.c--;
            char c2 = this.f1520d;
            return c2 < 1792 ? f1519e[c2] : Character.getDirectionality(c2);
        }
    }
    ...
    static {
        c cVar = d.c;
        f1514d = cVar;
        f1517g = new a(false, 2, cVar);
        f1518h = new a(true, 2, cVar);
    }
    ...
    public static int a(CharSequence charSequence) {
        byte b2;
        C0035a aVar = new C0035a(charSequence, false);
        aVar.c = 0;
        int i2 = 0;
        int i3 = 0;
        int i4 = 0;
        while (true) {
            ...
            if (i5 < aVar.b && i2 == 0) {
                ...
                if (Character.isHighSurrogate(charAt)) {
                    ...
                    aVar.c++;
                    char c2 = aVar.f1520d;
                    b2 = c2 < 1792 ? C0035a.f1519e[c2] : Character.getDirectionality(c2);
                }
                if (b2 != 0) {
                    if (b2 == 1 || b2 == 2) {
                        if (i4 == 0) {
    ...
    public CharSequence d(CharSequence charSequence, c cVar, boolean z) {
        ...
        if (((this.b & 2) != 0) && z) {
            ...
            spannableStringBuilder.append((CharSequence) ((this.a || (!b3 && a(charSequence) != 1)) ? (!this.a || (b3 && a(charSequence) != -1)) ? str : f1516f : f1515e));
        }
        if (b2 != this.a) {
