    ...
    public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        ...
        if (!this.f1582f) {
            ...
            try {
                ...
                this.c = cls;
                this.f1580d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                this.f1581e = true;
        ...
        Method declaredMethod = (!this.f1581e || !this.c.isInstance(menu)) ? menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE) : this.f1580d;
