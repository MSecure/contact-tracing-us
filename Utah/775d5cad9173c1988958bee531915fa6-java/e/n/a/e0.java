...
public abstract class e0 {
    ...
    public ArrayList<a> f1688d;

    /* renamed from: e  reason: collision with root package name */
    public ArrayList<m> f1689e;

    /* renamed from: f  reason: collision with root package name */
    public final c0 f1690f = new c0(this);

    /* renamed from: g  reason: collision with root package name */
    public OnBackPressedDispatcher f1691g;

    /* renamed from: h  reason: collision with root package name */
    public final e.a.b f1692h = new c(false);
    ...
    public final Map<String, Object> f1695k = Collections.synchronizedMap(new HashMap());

    /* renamed from: l  reason: collision with root package name */
    public Map<m, HashSet<e.i.e.a>> f1696l = Collections.synchronizedMap(new HashMap());
    ...
    public class d implements t0.a {
        ...
        public void a(m mVar, e.i.e.a aVar) {
            ...
            if (!z) {
                e0 e0Var = e0.this;
                HashSet<e.i.e.a> hashSet = e0Var.f1696l.get(mVar);
                if (hashSet != null && hashSet.remove(aVar) && hashSet.isEmpty()) {
                    e0Var.f1696l.remove(mVar);
                    if (mVar.b < 5) {
                        e0Var.i(mVar);
        ...
        public void b(m mVar, e.i.e.a aVar) {
            e0 e0Var = e0.this;
            if (e0Var.f1696l.get(mVar) == null) {
                e0Var.f1696l.put(mVar, new HashSet<>());
            }
            e0Var.f1696l.get(mVar).add(aVar);
        }
    }
        ...
        public Intent a(Context context, e.a.e.e eVar) {
            ...
            if (!(intent2 == null || (bundleExtra = intent2.getBundleExtra("androidx.activity.result.contract.extra.ACTIVITY_OPTIONS_BUNDLE")) == null)) {
                ...
                if (intent2.getBooleanExtra("androidx.fragment.extra.ACTIVITY_OPTIONS_BUNDLE", false)) {
                    eVar2 = new e.a.e.e(eVar2.b, null, eVar2.f638d, eVar2.f639e);
                }
            }
    ...
    public final void B(boolean z2) {
        if (this.b) {
            ...
            throw new IllegalStateException("FragmentManager has not been attached to a host.");
        } else if (Looper.myLooper() != this.q.f1679d.getLooper()) {
        ...
        while (true) {
            ...
            synchronized (this.a) {
                if (this.a.isEmpty()) {
                    ...
                    this.a.clear();
                    this.q.f1679d.removeCallbacks(this.K);
                }
            }
            if (z3) {
                this.b = true;
                            ...
                            if (i10 == 2) {
                                ...
                                while (size >= 0) {
                                    ...
                                    if (mVar3.x != i11) {
                                        ...
                                        aVar3.c = aVar2.c;
                                        aVar3.f1752e = aVar2.f1752e;
                                        aVar3.f1751d = aVar2.f1751d;
                                        aVar3.f1753f = aVar2.f1753f;
                                        aVar.a.add(i9, aVar3);
    ...
    public void T(int i2, boolean z2) {
        ...
        if (this.q == null && i2 != -1) {
            ...
            while (it.hasNext()) {
                k0 k0Var = l0Var.b.get(it.next().f1726f);
                if (k0Var != null) {
                    k0Var.k();
                }
            }
                ...
                if (i4 != 1) {
                    if (i4 != 2) {
                        ...
                        if (min < 4) {
                            ...
                            if (mVar.F != null && this.q.l(mVar) && mVar.f1724d == null) {
                                h2.o();
                            }
                        }
                    }
                        ...
                        if (!(view == null || (viewGroup = mVar.E) == null)) {
                            ...
                            if (!mVar.J()) {
                                if (this.p > -1 && !this.D && mVar.F.getVisibility() == 0 && mVar.K >= 0.0f) {
                                    vVar = m.e.P0(this.q.c, mVar, false, mVar.w());
                                }
                                mVar.K = 0.0f;
    ...
    public boolean Z(ArrayList<a> arrayList, ArrayList<Boolean> arrayList2, String str, int i2, int i3) {
        ArrayList<a> arrayList3 = this.f1688d;
        if (arrayList3 == null) {
            return false;
        }
        if (str == null && i2 < 0 && (i3 & 1) == 0) {
            ...
            if (str != null || i2 >= 0) {
                ...
                while (size2 >= 0) {
                    a aVar = this.f1688d.get(size2);
                    if ((str != null && str.equals(aVar.f1747i)) || (i2 >= 0 && i2 == aVar.s)) {
                        break;
                    }
                    size2--;
                }
                ...
                if ((i3 & 1) != 0) {
                    while (true) {
                        ...
                        a aVar2 = this.f1688d.get(size2);
                        if ((str == null || !str.equals(aVar2.f1747i)) && (i2 < 0 || i2 != aVar2.s)) {
                            break;
                        }
                    }
                }
            ...
            if (i4 == this.f1688d.size() - 1) {
                return false;
            }
            for (int size3 = this.f1688d.size() - 1; size3 > i4; size3--) {
    ...
    public void a0(Bundle bundle, String str, m mVar) {
        if (mVar.s == this) {
            bundle.putString(str, mVar.f1726f);
        } else {
            m0(new IllegalStateException(f.a.a.a.a.v("Fragment ", mVar, " is not currently in the FragmentManager")));
            throw null;
        }
    }
        ...
        if (this.q == null) {
            ...
            if (mVar != null) {
                ...
                if (b0Var instanceof e.a.c) {
                    ...
                    c2.a(lVar, this.f1692h);
                }
                if (mVar == null) {
                    h0 h0Var = mVar.s.J;
                    h0 h0Var2 = h0Var.f1707d.get(mVar.f1726f);
                    if (h0Var2 == null) {
                        h0Var2 = new h0(h0Var.f1709f);
                        h0Var.f1707d.put(mVar.f1726f, h0Var2);
                    }
                    this.J = h0Var2;
                    ...
                    if (canonicalName != null) {
                        String w2 = f.a.a.a.a.w("androidx.lifecycle.ViewModelProvider.DefaultKey:", canonicalName);
                        e.q.e0 e0Var = i2.a.get(w2);
                        if (!h0.class.isInstance(e0Var)) {
                            e0Var = bVar instanceof f0.c ? ((f0.c) bVar).c(w2, h0.class) : ((h0.a) bVar).a(h0.class);
                            e.q.e0 put = i2.a.put(w2, e0Var);
                            if (put != null) {
                                put.a();
                            }
                ...
                if (!(b0Var2 instanceof e.a.e.d)) {
                    ...
                    String w3 = f.a.a.a.a.w("FragmentManager:", mVar != null ? f.a.a.a.a.e(new StringBuilder(), mVar.f1726f, ":") : "");
                    this.w = f2.c(f.a.a.a.a.w(w3, "StartActivityForResult"), new e.a.e.f.c(), new i());
                    this.x = f2.c(f.a.a.a.a.w(w3, "StartIntentSenderForResult"), new j(), new a());
                    this.y = f2.c(f.a.a.a.a.w(w3, "RequestPermissions"), new e.a.e.f.b(), new b());
                    return;
                }
                return;
            }
    ...
    public final void d(m mVar) {
        HashSet<e.i.e.a> hashSet = this.f1696l.get(mVar);
        if (hashSet != null) {
    ...
    public void d0(Parcelable parcelable) {
        ...
        if (parcelable != null) {
            ...
            if (g0Var.b != null) {
                ...
                if (g0Var.f1698d != null) {
                    this.f1688d = new ArrayList<>(g0Var.f1698d.length);
                    int i2 = 0;
                    while (true) {
                        b[] bVarArr = g0Var.f1698d;
                        ...
                        while (true) {
                            ...
                            aVar2.f1754g = h.b.values()[bVar.f1670d[i4]];
                            aVar2.f1755h = h.b.values()[bVar.f1671e[i4]];
                            int[] iArr2 = bVar.b;
                            int i6 = i5 + 1;
                            int i7 = iArr2[i5];
                            aVar2.c = i7;
                        ...
                        aVar.f1744f = bVar.f1672f;
                        aVar.f1747i = bVar.f1673g;
                        aVar.s = bVar.f1674h;
                        aVar.f1745g = true;
                        aVar.f1748j = bVar.f1675i;
                        aVar.f1749k = bVar.f1676j;
                        aVar.f1750l = bVar.f1677k;
                        aVar.m = bVar.f1678l;
                        aVar.n = bVar.m;
                        aVar.o = bVar.n;
                        aVar.p = bVar.o;
                ...
                this.f1693i.set(g0Var.f1699e);
                String str8 = g0Var.f1700f;
                if (str8 != null) {
                    m G2 = G(str8);
                    this.t = G2;
                    t(G2);
                }
                ArrayList<String> arrayList2 = g0Var.f1701g;
                if (arrayList2 != null) {
                    for (int i13 = 0; i13 < arrayList2.size(); i13++) {
                        Bundle bundle = g0Var.f1702h.get(i13);
                        bundle.setClassLoader(this.q.c.getClassLoader());
                        this.f1694j.put(arrayList2.get(i13), bundle);
                    }
                }
                this.z = new ArrayDeque<>(g0Var.f1703i);
            }
        }
    }
    ...
    public Parcelable e0() {
        ...
        while (true) {
            ...
            if (next != null) {
                ...
                if (mVar2.b <= -1 || j0Var.n != null) {
                    ...
                    if (next.c.f1724d != null) {
                        if (bundle == null) {
                            bundle = new Bundle();
                        }
                        bundle.putSparseParcelableArray("android:view_state", next.c.f1724d);
                    }
                    if (next.c.f1725e != null) {
                        if (bundle == null) {
                            bundle = new Bundle();
                        }
                        bundle.putBundle("android:view_registry_state", next.c.f1725e);
                    }
                    if (!next.c.H) {
                        if (bundle == null) {
                            bundle = new Bundle();
                    ...
                    j0Var.n = bundle;
                    if (next.c.f1729i != null) {
                        if (bundle == null) {
                            j0Var.n = new Bundle();
                        }
                        j0Var.n.putString("android:target_state", next.c.f1729i);
                        int i3 = next.c.f1730j;
                        if (i3 != 0) {
        ...
        synchronized (l0Var2.a) {
            if (l0Var2.a.isEmpty()) {
                ...
                while (it3.hasNext()) {
                    m next2 = it3.next();
                    arrayList.add(next2.f1726f);
                    if (O(2)) {
                        String str2 = "saveAllState: adding fragment (" + next2.f1726f + "): " + next2;
                    }
                }
            }
        }
        ...
        if (arrayList3 != null && (size = arrayList3.size()) > 0) {
            bVarArr = new b[size];
            for (i2 = 0; i2 < size; i2++) {
                bVarArr[i2] = new b(this.f1688d.get(i2));
                if (O(2)) {
                    String str3 = "saveAllState: adding back stack #" + i2 + ": " + this.f1688d.get(i2);
                }
            }
        }
        g0 g0Var = new g0();
        g0Var.b = arrayList2;
        g0Var.c = arrayList;
        g0Var.f1698d = bVarArr;
        g0Var.f1699e = this.f1693i.get();
        m mVar4 = this.t;
        if (mVar4 != null) {
            g0Var.f1700f = mVar4.f1726f;
        }
        g0Var.f1701g.addAll(this.f1694j.keySet());
        g0Var.f1702h.addAll(this.f1694j.values());
        g0Var.f1703i = new ArrayList<>(this.z);
        return g0Var;
    }
    ...
    public void h0(m mVar, h.b bVar) {
        if (!mVar.equals(G(mVar.f1726f)) || !(mVar.t == null || mVar.s == this)) {
    ...
    public void i0(m mVar) {
        if (mVar == null || (mVar.equals(G(mVar.f1726f)) && (mVar.t == null || mVar.s == this))) {
            m mVar2 = this.t;
            this.t = mVar;
            t(mVar2);
            t(this.t);
    ...
    public final void j0(m mVar) {
        ViewGroup K2 = K(mVar);
        if (K2 != null) {
            if (mVar.y() + mVar.x() + mVar.o() + mVar.k() > 0) {
                int i2 = R$id.visible_removing_fragment_view_tag;
                if (K2.getTag(i2) == null) {
                    K2.setTag(i2, mVar);
                }
                ((m) K2.getTag(i2)).C0(mVar.w());
            }
        }
    }
    ...
    public boolean l(MenuItem menuItem) {
        ...
        for (m mVar : this.c.i()) {
            if (mVar != null) {
                if (!mVar.z ? mVar.P() ? true : mVar.u.l(menuItem) : false) {
                    return true;
                }
            }
        }
    ...
    public boolean n(Menu menu, MenuInflater menuInflater) {
        ...
        if (this.f1689e != null) {
            for (int i2 = 0; i2 < this.f1689e.size(); i2++) {
                m mVar2 = this.f1689e.get(i2);
    ...
    public final void t(m mVar) {
        if (mVar != null && mVar.equals(G(mVar.f1726f))) {
            boolean R = mVar.s.R(mVar);
            Boolean bool = mVar.f1731k;
            if (bool == null || bool.booleanValue() != R) {
                mVar.f1731k = Boolean.valueOf(R);
                mVar.e0(R);
                e0 e0Var = mVar.u;
                e0Var.n0();
                e0Var.t(e0Var.t);
    ...
    public boolean v(Menu menu) {
        ...
        for (m mVar : this.c.i()) {
            if (mVar != null && Q(mVar) && mVar.q0(menu)) {
                z2 = true;
            }
        }
        return z2;
    ...
    public void y(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        if (!l0Var.b.isEmpty()) {
            ...
            for (k0 k0Var : l0Var.b.values()) {
                ...
                if (k0Var != null) {
                    ...
                    printWriter.print(mVar.f1726f);
                    printWriter.print(" mBackStackNesting=");
                    printWriter.println(mVar.r);
                    printWriter.print(str3);
                    printWriter.print("mAdded=");
                    printWriter.print(mVar.f1732l);
                    ...
                    if (mVar.f1727g != null) {
                        ...
                        printWriter.println(mVar.f1727g);
                    }
                    if (mVar.c != null) {
                        printWriter.print(str3);
                    ...
                    if (mVar.f1724d != null) {
                        ...
                        printWriter.println(mVar.f1724d);
                    }
                    if (mVar.f1725e != null) {
                        printWriter.print(str3);
                        printWriter.print("mSavedViewRegistryState=");
                        printWriter.println(mVar.f1725e);
                    }
                    Object obj = mVar.f1728h;
                    if (obj == null) {
                        e0 e0Var = mVar.s;
                        obj = (e0Var == null || (str2 = mVar.f1729i) == null) ? null : e0Var.c.d(str2);
                    }
                    if (obj != null) {
                        printWriter.print(str3);
                        ...
                        printWriter.println(mVar.f1730j);
                    }
                    printWriter.print(str3);
                    ...
                    if (mVar.j() != null) {
                        e.r.a.a.b(mVar).a(str3, fileDescriptor, printWriter, strArr);
                    }
                    printWriter.print(str3);
                    printWriter.println("Child " + mVar.u + ":");
                    mVar.u.y(f.a.a.a.a.w(str3, "  "), fileDescriptor, printWriter, strArr);
                } else {
        ...
        ArrayList<m> arrayList = this.f1689e;
        if (arrayList != null && (size2 = arrayList.size()) > 0) {
            ...
            for (int i3 = 0; i3 < size2; i3++) {
                ...
                printWriter.print(": ");
                printWriter.println(this.f1689e.get(i3).toString());
            }
        }
        ArrayList<a> arrayList2 = this.f1688d;
        if (arrayList2 != null && (size = arrayList2.size()) > 0) {
            printWriter.print(str);
            printWriter.println("Back Stack:");
            for (int i4 = 0; i4 < size; i4++) {
                a aVar = this.f1688d.get(i4);
                printWriter.print(str);
                printWriter.print("  #");
                printWriter.print(i4);
                printWriter.print(": ");
                printWriter.println(aVar.toString());
                aVar.i(w2, printWriter, true);
            }
        }
        printWriter.print(str);
