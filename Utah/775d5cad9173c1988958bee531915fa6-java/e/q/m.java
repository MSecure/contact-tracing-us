...
public class m extends h {
    ...
    public ArrayList<h.b> f1812g = new ArrayList<>();

    /* renamed from: h  reason: collision with root package name */
    public final boolean f1813h;
    ...
    public void a(k kVar) {
        ...
        if (this.a.k(kVar, aVar) == null && (lVar = this.c.get()) != null) {
            boolean z = this.f1809d != 0 || this.f1810e;
            h.b c2 = c(kVar);
            this.f1809d++;
            while (aVar.a.compareTo((Enum) c2) < 0 && this.a.f1184f.containsKey(kVar)) {
                this.f1812g.add(aVar.a);
                h.a b2 = h.a.b(aVar.a);
                if (b2 != null) {
                    aVar.a(lVar, b2);
                    h();
    ...
    public final h.b c(k kVar) {
        ...
        h.b bVar = null;
        b.c<K, V> cVar = aVar.f1184f.containsKey(kVar) ? aVar.f1184f.get(kVar).f1188e : null;
        h.b bVar2 = cVar != null ? cVar.c.a : null;
        if (!this.f1812g.isEmpty()) {
            ArrayList<h.b> arrayList = this.f1812g;
    ...
    public final void j() {
        ...
        if (lVar != null) {
            while (true) {
                e.c.a.b.a<k, a> aVar = this.a;
                boolean z = true;
                if (!(aVar.f1186e == 0 || (aVar.b.c.a == (bVar = aVar.c.c.a) && this.b == bVar))) {
                    z = false;
                }
                this.f1811f = false;
                if (!z) {
                    if (this.b.compareTo((Enum) aVar.b.c.a) < 0) {
                        ...
                        aVar2.f1185d.put(bVar2, Boolean.FALSE);
                        while (bVar2.hasNext() && !this.f1811f) {
                            Map.Entry entry = (Map.Entry) bVar2.next();
                            a aVar3 = (a) entry.getValue();
                            while (aVar3.a.compareTo((Enum) this.b) > 0 && !this.f1811f && this.a.contains((k) entry.getKey())) {
                                int ordinal = aVar3.a.ordinal();
                                h.a aVar4 = ordinal != 2 ? ordinal != 3 ? ordinal != 4 ? null : h.a.ON_PAUSE : h.a.ON_STOP : h.a.ON_DESTROY;
                                if (aVar4 != null) {
                                    this.f1812g.add(aVar4.a());
                                    aVar3.a(lVar, aVar4);
                                    h();
                                } else {
                    ...
                    if (!this.f1811f && cVar != null && this.b.compareTo((Enum) cVar.c.a) > 0) {
                        b<K, V>.d i2 = this.a.i();
                        while (i2.hasNext() && !this.f1811f) {
                            Map.Entry entry2 = (Map.Entry) i2.next();
                            a aVar5 = (a) entry2.getValue();
                            while (aVar5.a.compareTo((Enum) this.b) < 0 && !this.f1811f && this.a.contains((k) entry2.getKey())) {
                                this.f1812g.add(aVar5.a);
