...
@q.b("activity")
public class a extends q<C0051a> {
    public Context a;
    public Activity b;
    ...
    public static class C0051a extends j {
        ...
        public Intent f1830j;

        /* renamed from: k  reason: collision with root package name */
        public String f1831k;

        public C0051a(q<? extends C0051a> qVar) {
            super(qVar);
        }
        ...
        public void k(Context context, AttributeSet attributeSet) {
            ...
            if (this.f1830j == null) {
                this.f1830j = new Intent();
            }
            this.f1830j.setPackage(string);
            ...
            if (string4 != null) {
                ...
                this.f1830j.setData(parse);
            }
            this.f1831k = obtainAttributes.getString(R$styleable.ActivityNavigator_dataPattern);
    ...
    @Override // e.s.q
    public j b(C0051a aVar, Bundle bundle, o oVar, q.a aVar2) {
        Activity activity;
        Intent intent;
        int intExtra;
        C0051a aVar3 = aVar;
        if (aVar3.f1830j != null) {
            Intent intent2 = new Intent(aVar3.f1830j);
            if (bundle != null) {
                intent2.putExtras(bundle);
                String str = aVar3.f1831k;
            ...
            intent2.putExtra("android-support-navigation:ActivityNavigator:current", aVar3.f1850d);
            if (oVar != null) {
                intent2.putExtra("android-support-navigation:ActivityNavigator:popEnterAnim", oVar.f1865f);
                intent2.putExtra("android-support-navigation:ActivityNavigator:popExitAnim", oVar.f1866g);
            }
            if (z) {
                Objects.requireNonNull((b) aVar2);
            }
