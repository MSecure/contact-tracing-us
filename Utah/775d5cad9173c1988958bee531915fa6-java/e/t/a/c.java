...
public class c extends x {
    ...
    public ArrayList<RecyclerView.b0> f1883h = new ArrayList<>();

    /* renamed from: i  reason: collision with root package name */
    public ArrayList<RecyclerView.b0> f1884i = new ArrayList<>();

    /* renamed from: j  reason: collision with root package name */
    public ArrayList<e> f1885j = new ArrayList<>();

    /* renamed from: k  reason: collision with root package name */
    public ArrayList<d> f1886k = new ArrayList<>();

    /* renamed from: l  reason: collision with root package name */
    public ArrayList<ArrayList<RecyclerView.b0>> f1887l = new ArrayList<>();
        ...
        public void run() {
            ...
            while (it.hasNext()) {
                ...
                if (view2 != null) {
                    ...
                    cVar.r.add(dVar.a);
                    duration.translationX((float) (dVar.f1889e - dVar.c));
                    duration.translationY((float) (dVar.f1890f - dVar.f1888d));
    ...
    public class RunnableC0056c implements Runnable {
        ...
        public RunnableC0056c(ArrayList arrayList) {
            this.b = arrayList;
        }
    ...
    public static class d {
        ...
        public String toString() {
            ...
            h2.append(this.c);
            h2.append(", fromY=");
            h2.append(this.f1888d);
            h2.append(", toX=");
            h2.append(this.f1889e);
            h2.append(", toY=");
            h2.append(this.f1890f);
            h2.append('}');
            return h2.toString();
        }
    }
    ...
    public void i(RecyclerView.b0 b0Var) {
        ...
        while (true) {
            ...
            if (size < 0) {
                break;
            } else if (this.f1885j.get(size).a == b0Var) {
                view.setTranslationY(0.0f);
                view.setTranslationX(0.0f);
                g(b0Var);
                this.f1885j.remove(size);
            }
        }
        r(this.f1886k, b0Var);
        if (this.f1883h.remove(b0Var)) {
            view.setAlpha(1.0f);
            g(b0Var);
        }
        if (this.f1884i.remove(b0Var)) {
            view.setAlpha(1.0f);
            g(b0Var);
        }
        ...
        int size5 = this.f1887l.size();
        while (true) {
            size5--;
            if (size5 >= 0) {
                ArrayList<RecyclerView.b0> arrayList3 = this.f1887l.get(size5);
                if (arrayList3.remove(b0Var)) {
                    view.setAlpha(1.0f);
                    g(b0Var);
                    if (arrayList3.isEmpty()) {
                        this.f1887l.remove(size5);
                    }
                }
            } else {
                this.q.remove(b0Var);
    ...
    public void j() {
        ...
        int size2 = this.f1883h.size();
        while (true) {
            size2--;
            if (size2 < 0) {
                break;
            }
            g(this.f1883h.get(size2));
            this.f1883h.remove(size2);
        }
        int size3 = this.f1884i.size();
        while (true) {
            size3--;
            if (size3 < 0) {
                break;
            }
            RecyclerView.b0 b0Var = this.f1884i.get(size3);
            b0Var.a.setAlpha(1.0f);
            g(b0Var);
            this.f1884i.remove(size3);
        }
        int size4 = this.f1886k.size();
        while (true) {
            size4--;
            if (size4 < 0) {
                break;
            }
            d dVar = this.f1886k.get(size4);
        ...
        if (k()) {
            ...
            int size7 = this.f1887l.size();
            while (true) {
                size7--;
                if (size7 < 0) {
                    break;
                }
                ArrayList<RecyclerView.b0> arrayList2 = this.f1887l.get(size7);
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.j
    public boolean k() {
        return !this.f1884i.isEmpty() || !this.f1886k.isEmpty() || !this.f1885j.isEmpty() || !this.f1883h.isEmpty() || !this.p.isEmpty() || !this.q.isEmpty() || !this.o.isEmpty() || !this.r.isEmpty() || !this.m.isEmpty() || !this.f1887l.isEmpty() || !this.n.isEmpty();
    }

    @Override // androidx.recyclerview.widget.RecyclerView.j
    public void m() {
        boolean z = !this.f1883h.isEmpty();
        boolean z2 = !this.f1885j.isEmpty();
        boolean z3 = !this.f1886k.isEmpty();
        boolean z4 = !this.f1884i.isEmpty();
        if (z || z2 || z4 || z3) {
            Iterator<RecyclerView.b0> it = this.f1883h.iterator();
            while (it.hasNext()) {
            ...
            if (z4) {
                ...
                arrayList3.addAll(this.f1884i);
                this.f1887l.add(arrayList3);
                this.f1884i.clear();
                RunnableC0056c cVar = new RunnableC0056c(arrayList3);
                if (z || z2 || z3) {
                    long j4 = 0;
    ...
    public boolean n(RecyclerView.b0 b0Var, int i2, int i3, int i4, int i5) {
        ...
        this.f1885j.add(new e(b0Var, translationX, translationY, i4, i5));
        return true;
    }
