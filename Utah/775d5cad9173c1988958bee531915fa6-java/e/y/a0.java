...
public abstract class a0 extends h {
    ...
    public static class a extends AnimatorListenerAdapter implements h.d {
        ...
        public final void g(boolean z) {
            ViewGroup viewGroup;
            if (this.f2032d && this.f2033e != z && (viewGroup = this.c) != null) {
                this.f2033e = z;
                r.a(viewGroup, z);
            }
        }
    ...
    public static class b {
        ...
        /* renamed from: e  reason: collision with root package name */
        public ViewGroup f2036e;

        /* renamed from: f  reason: collision with root package name */
        public ViewGroup f2037f;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x007f, code lost:
        if (r0.f2036e == null) goto L_0x0088;
     */
    ...
    public final b I(p pVar, p pVar2) {
        ...
        if (pVar == null || !pVar.a.containsKey("android:visibility:visibility")) {
            ...
            bVar.f2036e = (ViewGroup) pVar.a.get("android:visibility:parent");
        }
        if (pVar2 == null || !pVar2.a.containsKey("android:visibility:visibility")) {
            bVar.f2035d = -1;
            bVar.f2037f = null;
        } else {
            bVar.f2035d = ((Integer) pVar2.a.get("android:visibility:visibility")).intValue();
            bVar.f2037f = (ViewGroup) pVar2.a.get("android:visibility:parent");
        }
        if (pVar != null && pVar2 != null) {
            int i2 = bVar.c;
            int i3 = bVar.f2035d;
            if (i2 == i3 && bVar.f2036e == bVar.f2037f) {
                return bVar;
            }
            if (i2 != i3) {
                if (i2 != 0) {
            ...
            bVar.a = true;
            return bVar;
        } else if (!(pVar == null && bVar.f2035d == 0)) {
            if (pVar2 == null) {
            }
            return bVar;
        }
    ...
    public Animator k(ViewGroup viewGroup, p pVar, p pVar2) {
        ...
        Float f2;
        b I = I(pVar, pVar2);
        if (!I.a || (I.f2036e == null && I.f2037f == null)) {
            return null;
        }
        float f3 = 0.0f;
        boolean z6 = true;
