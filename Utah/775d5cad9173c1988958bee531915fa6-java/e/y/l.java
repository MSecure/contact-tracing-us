...
public class l {
    ...
    public static class a implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        /* renamed from: e.y.l$a$a  reason: collision with other inner class name */
        public class C0065a extends k {
            public final /* synthetic */ e.e.a a;

            public C0065a(e.e.a aVar) {
                this.a = aVar;
            }
        ...
        public boolean onPreDraw() {
            ...
            e.e.a<ViewGroup, ArrayList<h>> b2 = l.b();
            ArrayList<h> arrayList2 = b2.get(this.c);
            boolean z = false;
            if (arrayList2 == null) {
                    ...
                    if (i7 == i6) {
                        ...
                        while (true) {
                            ...
                            if (view3 != null && hVar.s(view3) && (pVar = (p) aVar2.remove(view3)) != null && hVar.s(pVar.b)) {
                                hVar.f2054l.add((p) aVar.i(i8));
                                hVar.m.add(pVar);
                            }
                        }
                    } else if (i7 == 2) {
                        qVar2 = qVar;
                        e.e.a<String, View> aVar3 = qVar2.f2057d;
                        e.e.a<String, View> aVar4 = qVar4.f2057d;
                        int i9 = aVar3.f1232d;
                ...
                for (i3 = 0; i3 < aVar.f1232d; i3++) {
                    p pVar8 = (p) aVar.k(i3);
                    if (hVar.s(pVar8.b)) {
                        hVar.f2054l.add(pVar8);
                        hVar.m.add(null);
                    }
                }
                for (i4 = 0; i4 < aVar2.f1232d; i4++) {
                    p pVar9 = (p) aVar2.k(i4);
                    if (hVar.s(pVar9.b)) {
                        hVar.m.add(pVar9);
                        hVar.f2054l.add(null);
                    }
                }
                ...
                for (i5 = i14 - 1; i5 >= 0; i5--) {
                    Animator h3 = o.h(i5);
                    if (!(h3 == null || (orDefault = o.getOrDefault(h3, null)) == null || orDefault.a == null || !b0Var.equals(orDefault.f2055d))) {
                        p pVar10 = orDefault.c;
                        View view4 = orDefault.a;
                        p q = hVar.q(view4, true);
                        p n = hVar.n(view4, true);
                        if (q == null && n == null) {
                            n = hVar.f2051i.a.get(view4);
                        }
                        if (!(q == null && n == null) && orDefault.f2056e.r(pVar10, n)) {
                ...
                hVar.l(viewGroup, hVar.f2050h, hVar.f2051i, hVar.f2054l, hVar.m);
                hVar.y();
                return true;
            }
            arrayList = null;
            ...
            while (i3 < aVar.f1232d) {
            }
            while (i4 < aVar2.f1232d) {
            }
            ...
            hVar.l(viewGroup2, hVar.f2050h, hVar.f2051i, hVar.f2054l, hVar.m);
            hVar.y();
            return true;
        }
    ...
    public static e.e.a<ViewGroup, ArrayList<h>> b() {
