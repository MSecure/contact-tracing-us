...
public class b implements h {
    ...
    public static List<g> b(List<g> list, b.a aVar) {
        ...
        List<g> list2 = aVar.f2126g;
        if (list2 != null) {
            if (!list2.isEmpty()) {
                for (g gVar2 : aVar.f2126g) {
                    if (!treeSet.contains(gVar2.a)) {
                        arrayList.add(gVar2);
                    }
                }
            }
        } else if (!aVar.f2125f.isEmpty()) {
            for (Map.Entry<String, String> entry : aVar.f2125f.entrySet()) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x00bb, code lost:
        r0 = r2.a;
        f.a.b.v.a("Unexpected response code %d for %s", java.lang.Integer.valueOf(r0), r29.f2138d);
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:63:0x0102, code lost:
        if (r29.f2146l != false) goto L_0x0104;
     */
    ...
    public k f(n<?> nVar) {
        ...
        while (true) {
            ...
            try {
                ...
                InputStream inputStream = a2.f2160d;
