...
public abstract class d0 extends z0 {
    ...
    public void K0(NestedScrollView nestedScrollView, LinearLayout linearLayout, Button button, boolean z) {
        float f2;
    ...
    public void k0(View view, Bundle bundle) {
        ...
        s0().setTitle(R.string.onboarding_opt_in_title);
        this.a0 = (OnboardingViewModel) new f0(s0()).a(OnboardingViewModel.class);
        if (bundle != null) {
