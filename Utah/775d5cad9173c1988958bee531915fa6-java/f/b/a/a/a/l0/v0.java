...
import f.b.a.a.a.s.o;
import f.b.a.a.a.s.q;
import f.b.a.a.a.s.y;
...
public class v0 {
    ...
    public static final f.b.a.a.a.s.d0.a f2311l = f.b.a.a.a.s.d0.a.e("Preferences");
    public static e m;
    public final SharedPreferences a;
    public final f.b.a.a.a.s.e0.a b;
    public final SecureRandom c;

    /* renamed from: d  reason: collision with root package name */
    public final LiveData<Boolean> f2312d;

    /* renamed from: e  reason: collision with root package name */
    public final LiveData<Boolean> f2313e;

    /* renamed from: f  reason: collision with root package name */
    public final LiveData<Boolean> f2314f;

    /* renamed from: g  reason: collision with root package name */
    public final LiveData<Boolean> f2315g;

    /* renamed from: h  reason: collision with root package name */
    public final LiveData<f.b.a.a.a.h0.d> f2316h;

    /* renamed from: i  reason: collision with root package name */
    public final LiveData<f> f2317i;

    /* renamed from: j  reason: collision with root package name */
    public final LiveData<f> f2318j;

    /* renamed from: k  reason: collision with root package name */
    public final LiveData<Boolean> f2319k;

    public class a extends y<f.b.a.a.a.h0.d> {
    ...
    public v0(Context context, f.b.a.a.a.s.e0.a aVar, SecureRandom secureRandom) {
        ...
        this.b = aVar;
        this.c = secureRandom;
        this.f2312d = new o(sharedPreferences, "ExposureNotificationSharedPreferences.SHARE_ANALYTICS_KEY", false);
        this.f2313e = new o(sharedPreferences, "ExposureNotificationSharedPreferences.SHARE_PRIVATE_ANALYTICS_KEY", false);
        new o(sharedPreferences, "ExposureNotificationSharedPreferences.EXPOSURE_CLASSIFICATION_IS_REVOKED_KEY", false);
        this.f2314f = new q(sharedPreferences, "ExposureNotificationSharedPreferences.ONBOARDING_STATE_KEY");
        this.f2315g = new q(sharedPreferences, "ExposureNotificationSharedPreferences.SHARE_PRIVATE_ANALYTICS_KEY");
        this.f2319k = new o(sharedPreferences, "ExposureNotificationSharedPreferences.IS_IN_APP_SMS_NOTICE_SEEN", false);
        this.f2316h = new a(sharedPreferences, "ExposureNotificationSharedPreferences.EXPOSURE_CLASSIFICATION_INDEX_KEY", "ExposureNotificationSharedPreferences.EXPOSURE_CLASSIFICATION_NAME_KEY", "ExposureNotificationSharedPreferences.EXPOSURE_CLASSIFICATION_DATE_KEY");
        this.f2317i = new b(sharedPreferences, "ExposureNotificationSharedPreferences.EXPOSURE_CLASSIFICATION_IS_CLASSIFICATION_NEW_KEY");
        this.f2318j = new c(sharedPreferences, "ExposureNotificationSharedPreferences.EXPOSURE_CLASSIFICATION_IS_DATE_NEW_KEY");
        new d(sharedPreferences, "ExposureNotificationSharedPreferences.PROVIDE_DIAGNOSIS_KEY_TO_LOG_KEY");
    }

    public f.b.a.a.a.h0.d a() {
        return new f.b.a.a.a.h0.a(this.a.getInt("ExposureNotificationSharedPreferences.EXPOSURE_CLASSIFICATION_INDEX_KEY", 0), this.a.getString("ExposureNotificationSharedPreferences.EXPOSURE_CLASSIFICATION_NAME_KEY", "No Exposure"), this.a.getLong("ExposureNotificationSharedPreferences.EXPOSURE_CLASSIFICATION_DATE_KEY", 0));
    }
    ...
    public void p(boolean z) {
        ...
        e eVar = m;
        if (eVar != null) {
            h hVar = ((f.b.a.a.a.z.c) eVar).a;
            if (z) {
                s.f2511j.f("Firelog analytics logging enabled");
                return;
            }
            s.f2511j.f("Firelog analytics logging disabled");
            hVar.a();
        }
    }
