...
public final class h extends a {
        ...
        if (num != null ? num.equals(((h) obj).a) : ((h) obj).a == null) {
            ...
            if (str != null ? str.equals(((h) obj).b) : ((h) obj).b == null) {
                ...
                if (str2 != null ? str2.equals(((h) obj).c) : ((h) obj).c == null) {
                    String str3 = this.f2525d;
                    if (str3 != null ? str3.equals(((h) obj).f2525d) : ((h) obj).f2525d == null) {
                        String str4 = this.f2526e;
                        if (str4 != null ? str4.equals(((h) obj).f2526e) : ((h) obj).f2526e == null) {
                            String str5 = this.f2527f;
                            if (str5 != null ? str5.equals(((h) obj).f2527f) : ((h) obj).f2527f == null) {
                                String str6 = this.f2528g;
                                if (str6 != null ? str6.equals(((h) obj).f2528g) : ((h) obj).f2528g == null) {
                                    String str7 = this.f2529h;
                                    String str8 = ((h) obj).f2529h;
                                    if (str7 == null) {
                                        if (str8 == null) {
                                            return true;
                                        }
    ...
    public String toString() {
        ...
        h2.append(this.c);
        h2.append(", device=");
        h2.append(this.f2525d);
        h2.append(", product=");
        h2.append(this.f2526e);
        h2.append(", osBuild=");
        h2.append(this.f2527f);
        h2.append(", manufacturer=");
        h2.append(this.f2528g);
        h2.append(", fingerprint=");
        return a.e(h2, this.f2529h, "}");
    }
}
