...
public final class c extends f.a {
    ...
    public static final class b extends f.a.AbstractC0078a {
        ...
        @Override // f.b.a.b.i.s.h.f.a.AbstractC0078a
        public f.a a() {
            String str = this.a == null ? " delta" : "";
            if (this.b == null) {
                str = f.a.a.a.a.w(str, " maxAllowedDelay");
            }
            if (this.c == null) {
                str = f.a.a.a.a.w(str, " flags");
            }
            if (str.isEmpty()) {
        ...
        @Override // f.b.a.b.i.s.h.f.a.AbstractC0078a
        public f.a.AbstractC0078a b(long j2) {
            this.a = Long.valueOf(j2);
            return this;
        }

        @Override // f.b.a.b.i.s.h.f.a.AbstractC0078a
        public f.a.AbstractC0078a c(long j2) {
