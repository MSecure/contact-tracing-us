...
public abstract class b<T extends IInterface> {
    ...
    public final ArrayList<h<?>> f2671k = new ArrayList<>();

    /* renamed from: l  reason: collision with root package name */
    public i f2672l;
    public int m = 1;
    public final a n;
    public final AbstractC0084b o;
    public final int p;
    ...
    public abstract class f extends h<Boolean> {
        ...
        public final /* synthetic */ void a(Boolean bool) {
            ...
            if (this.f2673d != 0) {
                ...
                d(new f.b.a.c.b.a(this.f2673d, pendingIntent));
            } else if (!e()) {
                b.this.B(1, null);
        ...
        public final void handleMessage(Message message) {
            ...
            if (b.this.u.get() == message.arg1) {
                ...
                if (i3 == 4) {
                    ...
                    b.this.f2669i.a(new f.b.a.c.b.a(message.arg2, pendingIntent));
                    Objects.requireNonNull(b.this);
                    System.currentTimeMillis();
                } else if (i3 == 6) {
                    b.this.B(5, null);
    ...
    public abstract class h<TListener> {
        ...
        public final void c() {
            ...
            synchronized (b.this.f2671k) {
                b.this.f2671k.remove(this);
            }
        }
    }
    ...
    public final class i implements ServiceConnection {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            synchronized (bVar.f2667g) {
                b bVar2 = b.this;
                IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.common.internal.IGmsServiceBroker");
                bVar2.f2668h = (queryLocalInterface == null || !(queryLocalInterface instanceof k)) ? new j(iBinder) : (k) queryLocalInterface;
            }
            b bVar3 = b.this;
            int i2 = this.a;
            Handler handler = bVar3.f2665e;
            handler.sendMessage(handler.obtainMessage(7, i2, -1, new l(0)));
        }

        public final void onServiceDisconnected(ComponentName componentName) {
            b bVar;
            synchronized (b.this.f2667g) {
                bVar = b.this;
                bVar.f2668h = null;
            }
            Handler handler = bVar.f2665e;
    ...
    public final class k extends f {
        ...
        public final boolean e() {
            try {
                ...
                IInterface q = b.this.q(this.f2676g);
                if (q == null) {
                    return false;
                }
    ...
    public final class l extends f {
        ...
        @Override // f.b.a.c.b.m.b.f
        public final boolean e() {
            b.this.f2669i.a(f.b.a.c.b.a.f2625f);
            return true;
        }
    }

    public b(@RecentlyNonNull Context context, @RecentlyNonNull Looper looper, @RecentlyNonNull g gVar, @RecentlyNonNull f.b.a.c.b.e eVar, @RecentlyNonNull int i2, a aVar, AbstractC0084b bVar, String str) {
    ...
    public void a(@RecentlyNonNull e eVar) {
        r rVar = (r) eVar;
        f.b.a.c.b.l.l.e.this.f2644j.post(new s(rVar));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0073, code lost:
        r0 = r4.u.get();
        r1 = r4.f2665e;
        r1.sendMessage(r1.obtainMessage(1, r0, -1, new f.b.a.c.b.m.b.k(r4, 8, null, null)));
     */
    ...
    public void h(h hVar, @RecentlyNonNull Set<Scope> set) {
        Bundle s2 = s();
        e eVar = new e(this.p);
        eVar.f2694e = this.c.getPackageName();
        eVar.f2697h = s2;
        if (set != null) {
            eVar.f2696g = (Scope[]) set.toArray(new Scope[set.size()]);
        }
        if (l()) {
        ...
        try {
            synchronized (this.f2667g) {
                k kVar = this.f2668h;
                if (kVar != null) {
                    kVar.A(new j(this, this.u.get()), eVar);
                }
            }
    ...
    public void j() {
        ...
        synchronized (this.f2671k) {
            int size = this.f2671k.size();
            for (int i2 = 0; i2 < size; i2++) {
                h<?> hVar = this.f2671k.get(i2);
                synchronized (hVar) {
                    hVar.a = null;
                }
            }
    ...
    public final T t() {
        ...
        synchronized (this.f2666f) {
            if (this.m == 5) {
                ...
                T t3 = this.f2670j;
                m.e.r(t3, "Client is connected but service is null");
                t2 = t3;
            } else {
