...
public final class d0 extends g {
    ...
    public d0(Context context) {
        ...
        this.f2689e = new d(context.getMainLooper(), new e0(this, null));
        if (a.c == null) {
            synchronized (a.b) {
                if (a.c == null) {
                    a.c = new a();
    ...
    public final boolean a(g.a aVar, ServiceConnection serviceConnection, String str) {
        ...
        synchronized (this.c) {
            ...
            if (f0Var == null) {
                ...
                this.f2689e.removeMessages(0, aVar);
                if (!f0Var.a.containsKey(serviceConnection)) {
                    f0Var.a.put(serviceConnection, serviceConnection);
                    int i2 = f0Var.b;
                    if (i2 == 1) {
                        ((b.i) serviceConnection).onServiceConnected(f0Var.f2704f, f0Var.f2702d);
                    } else if (i2 == 2) {
                        f0Var.a(str);
                    }
                } else {
    ...
    public final void b(g.a aVar, ServiceConnection serviceConnection, String str) {
        ...
        synchronized (this.c) {
            ...
            if (f0Var == null) {
                ...
                if (f0Var.a.isEmpty()) {
                    this.f2689e.sendMessageDelayed(this.f2689e.obtainMessage(0, aVar), this.f2691g);
                }
            } else {
