...
public abstract class a3<E> extends x2<E> implements List<E>, RandomAccess {
    public static final w2<Object> c = new y2(d3.f2721f, 0);

    public static <E> a3<E> p(Object[] objArr, int i2) {
        return i2 == 0 ? (a3<E>) d3.f2721f : new d3(objArr, i2);
    }
    ...
    public a3<E> subList(int i2, int i3) {
        b.E1(i2, i3, size());
        int i4 = i3 - i2;
        return i4 == size() ? this : i4 == 0 ? (a3<E>) d3.f2721f : new z2(this, i2, i4);
    }
    ...
    public final w2<E> listIterator(int i2) {
        ...
        throw new IndexOutOfBoundsException(b.F1(i2, size, "index"));
    }
