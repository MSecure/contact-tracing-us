...
public class a {
    ...
    public Drawable f2871i;

    /* renamed from: j  reason: collision with root package name */
    public ColorStateList f2872j;
    ...
    public final float a() {
        float b2 = b(this.f2874l.a, this.c.l());
        d dVar = this.f2874l.b;
        g gVar = this.c;
        float max = Math.max(b2, b(dVar, gVar.b.a.f3046f.a(gVar.h())));
        d dVar2 = this.f2874l.c;
        g gVar2 = this.c;
        float b3 = b(dVar2, gVar2.b.a.f3047g.a(gVar2.h()));
        d dVar3 = this.f2874l.f3044d;
        g gVar3 = this.c;
        return Math.max(max, Math.max(b3, b(dVar3, gVar3.b.a.f3048h.a(gVar3.h()))));
    }
    ...
    public final Drawable e() {
        if (this.n == null) {
            int[] iArr = b.a;
            this.q = new g(this.f2874l);
            this.n = new RippleDrawable(this.f2872j, null, this.q);
        }
        if (this.o == null) {
            LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{this.n, this.f2866d, this.f2871i});
    ...
    public void g(Drawable drawable) {
        this.f2871i = drawable;
        if (drawable != null) {
            Drawable mutate = m.e.P1(drawable).mutate();
            this.f2871i = mutate;
            mutate.setTintList(this.f2873k);
            boolean isChecked = this.a.isChecked();
            Drawable drawable2 = this.f2871i;
            if (drawable2 != null) {
        ...
        if (layerDrawable != null) {
            layerDrawable.setDrawableByLayerId(R$id.mtrl_card_checked_layer_id, this.f2871i);
        }
    }
    ...
    public void k() {
        ...
        Rect rect = this.b;
        materialCardView.f1194f.set(rect.left + i2, rect.top + i2, rect.right + i2, rect.bottom + i2);
        ((e.d.a.b) e.d.a.a.f1191j).c(materialCardView.f1196h);
    }
    ...
    public void l() {
        ...
        this.a.setForeground(f(this.f2870h));
    }
    ...
    public final void m() {
        ...
        if (drawable != null) {
            ((RippleDrawable) drawable).setColor(this.f2872j);
            return;
        }
        g gVar = this.p;
        if (gVar != null) {
    ...
    public void n() {
        this.f2866d.u((float) this.f2869g, this.m);
    }
}
