            ...
            for (b<Long, Long> bVar : this.c.Y.e()) {
                ...
                if (!(f2 == null || bVar.b == null)) {
                    ...
                    for (int i5 = i3; i5 <= i4; i5++) {
                        ...
                        if (u3 != null) {
                            int top = u3.getTop() + this.c.c0.f2891d.a.top;
                            int bottom = u3.getBottom() - this.c.c0.f2891d.a.bottom;
                            canvas.drawRect((float) (i5 == i3 ? (u.getWidth() / 2) + u.getLeft() : 0), (float) top, (float) (i5 == i4 ? (u2.getWidth() / 2) + u2.getLeft() : recyclerView.getWidth()), (float) bottom, this.c.c0.f2895h);
                        }
                    }
                }
            }
