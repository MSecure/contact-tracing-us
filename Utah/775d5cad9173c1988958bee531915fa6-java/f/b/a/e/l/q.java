...
public final class q<S> extends l {
    ...
    public class c extends y<S> {
        ...
        public void b(S s) {
            ...
            qVar.O0();
            q qVar2 = q.this;
            qVar2.C0.setEnabled(qVar2.J0().h());
        }
    }
    ...
    public static boolean L0(Context context) {
        return M0(context, 16843277);
    }

    public static boolean M0(Context context, int i2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(f.b.a.c.b.o.b.m1(context, R$attr.materialCalendarStyle, i.class.getCanonicalName()), new int[]{i2});
    ...
    public final Dialog G0(Bundle bundle) {
        ...
        Dialog dialog = new Dialog(t02, i2);
        Context context = dialog.getContext();
        this.x0 = L0(context);
        int m1 = f.b.a.c.b.o.b.m1(context, R$attr.colorSurface, q.class.getCanonicalName());
        g gVar = new g(context, null, R$attr.materialCalendarStyle, R$style.Widget_MaterialComponents_MaterialCalendar);
        this.B0 = gVar;
        gVar.n(context);
        this.B0.q(ColorStateList.valueOf(m1));
        g gVar2 = this.B0;
        View decorView = dialog.getWindow().getDecorView();
        AtomicInteger atomicInteger = v.a;
        gVar2.p(v.i.i(decorView));
        return dialog;
    }

    public final f<S> J0() {
        if (this.r0 == null) {
            this.r0 = (f) this.f1727g.getParcelable("DATE_SELECTOR_KEY");
        }
        return this.r0;
    }
    ...
    public final void N0() {
        ...
        bundle.putParcelable("CURRENT_MONTH_KEY", aVar.f2880e);
        iVar.y0(bundle);
        this.u0 = iVar;
    ...
    public final void O0() {
        String b2 = J0().b(j());
        this.z0.setContentDescription(String.format(E(R$string.mtrl_picker_announce_current_selection), b2));
        this.z0.setText(b2);
    }
    ...
    public final View T(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        stateListDrawable.addState(new int[]{16842912}, m.e.h0(context, R$drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], m.e.h0(context, R$drawable.material_ic_edit_black_24dp));
    ...
    public final void h0(Bundle bundle) {
        ...
        u uVar = this.u0.a0;
        if (uVar != null) {
            bVar.c = Long.valueOf(uVar.f2907g);
        }
    ...
    public void i0() {
        ...
        if (this.x0) {
            ...
            window.getDecorView().setOnTouchListener(new f.b.a.e.m.a(H0(), rect));
        }
        N0();
    }
