...
public class b extends g.a {
    ...
    public static final int f2919e = R$attr.alertDialogStyle;

    /* renamed from: f  reason: collision with root package name */
    public static final int f2920f = R$style.MaterialAlertDialog_MaterialComponents;

    /* renamed from: g  reason: collision with root package name */
    public static final int f2921g = R$attr.materialAlertDialogTheme;
    public Drawable c;

    /* renamed from: d  reason: collision with root package name */
    public final Rect f2922d;

    /* JADX WARNING: Illegal instructions before constructor call */
    public b(Context context, int i2) {
        super(r3, i2);
        int i3 = f2921g;
        TypedValue k1 = f.b.a.c.b.o.b.k1(context, i3);
        int i4 = k1 == null ? 0 : k1.data;
        int i5 = f2919e;
        int i6 = f2920f;
        Context a = a.a(context, null, i5, i6);
        a = i4 != 0 ? new c(a, i4) : a;
        if (i2 == 0) {
            TypedValue k12 = f.b.a.c.b.o.b.k1(context, i3);
            i2 = k12 == null ? 0 : k12.data;
        }
        ...
        this.f2922d = new Rect(dimensionPixelSize, dimensionPixelSize2, dimensionPixelSize3, dimensionPixelSize4);
        int m1 = f.b.a.c.b.o.b.m1(context2, R$attr.colorSurface, b.class.getCanonicalName());
    ...
    public g a() {
        ...
        if (drawable instanceof f.b.a.e.v.g) {
            ...
            ((f.b.a.e.v.g) drawable).p(v.i.i(decorView));
        }
        Drawable drawable2 = this.c;
        Rect rect = this.f2922d;
        window.setBackgroundDrawable(new InsetDrawable(drawable2, rect.left, rect.top, rect.right, rect.bottom));
        decorView.setOnTouchListener(new a(a, this.f2922d));
        return a;
    }
