...
public class p extends d {
    ...
    public final o0 f3112f;

    /* renamed from: g  reason: collision with root package name */
    public final AccessibilityManager f3113g;

    /* renamed from: h  reason: collision with root package name */
    public final Rect f3114h = new Rect();
    ...
    public p(Context context, AttributeSet attributeSet) {
        ...
        this.f3113g = (AccessibilityManager) context2.getSystemService("accessibility");
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE) {
            ...
            if (!(adapter == null || b == null)) {
                ...
                o0 o0Var = this.f3112f;
                int min = Math.min(adapter.getCount(), Math.max(0, !o0Var.c() ? -1 : o0Var.f940d.getSelectedItemPosition()) + 15);
                View view = null;
                int i5 = 0;
                ...
                Drawable i6 = this.f3112f.i();
                if (i6 != null) {
                    i6.getPadding(this.f3114h);
                    Rect rect = this.f3114h;
    ...
    public <T extends ListAdapter & Filterable> void setAdapter(T t) {
        super.setAdapter(t);
        this.f3112f.o(getAdapter());
    }

    public void showDropDown() {
        AccessibilityManager accessibilityManager = this.f3113g;
