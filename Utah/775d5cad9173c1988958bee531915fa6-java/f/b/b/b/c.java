...
public abstract class c<E> extends b<E> implements List<E>, RandomAccess {
    public static final a<Object> c = new b(g.f3135f, 0);
    ...
    public class C0104c extends c<E> {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final transient int f3130d;

        /* renamed from: e  reason: collision with root package name */
        public final transient int f3131e;
        ...
        public E get(int i2) {
            f.b.a.c.b.o.b.v(i2, this.f3131e);
            return (E) c.this.get(i2 + this.f3130d);
        }
        ...
        @Override // f.b.b.b.b
        public int k() {
            return c.this.l() + this.f3130d + this.f3131e;
        }

        @Override // f.b.b.b.b
        public int l() {
            return c.this.l() + this.f3130d;
        }
        ...
        public c<E> subList(int i2, int i3) {
            f.b.a.c.b.o.b.D(i2, i3, this.f3131e);
            c cVar = c.this;
            int i4 = this.f3130d;
    ...
    public static <E> c<E> p(Object[] objArr, int i2) {
        return i2 == 0 ? (c<E>) g.f3135f : new g(objArr, i2);
    }
    ...
    public c<E> subList(int i2, int i3) {
        ...
        return i4 == 0 ? (c<E>) g.f3135f : new C0104c(i2, i4);
    }
}
