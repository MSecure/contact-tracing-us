...
public abstract class b<V> extends f.b.b.f.a.e0.a implements u<V> {
    ...
    public static final boolean f3174e;

    /* renamed from: f  reason: collision with root package name */
    public static final Logger f3175f = Logger.getLogger(b.class.getName());

    /* renamed from: g  reason: collision with root package name */
    public static final AbstractC0109b f3176g;

    /* renamed from: h  reason: collision with root package name */
    public static final Object f3177h = new Object();
    private volatile Object b;
    private volatile e c;

    /* renamed from: d  reason: collision with root package name */
    private volatile l f3178d;
    ...
    public static final class e {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final e f3180d = new e(null, null);
    ...
    public static final class f extends AbstractC0109b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<b, e> f3181d;

        /* renamed from: e  reason: collision with root package name */
        public final AtomicReferenceFieldUpdater<b, Object> f3182e;
        ...
        public f(AtomicReferenceFieldUpdater<l, Thread> atomicReferenceFieldUpdater, AtomicReferenceFieldUpdater<l, l> atomicReferenceFieldUpdater2, AtomicReferenceFieldUpdater<b, l> atomicReferenceFieldUpdater3, AtomicReferenceFieldUpdater<b, e> atomicReferenceFieldUpdater4, AtomicReferenceFieldUpdater<b, Object> atomicReferenceFieldUpdater5) {
            ...
            this.f3181d = atomicReferenceFieldUpdater4;
            this.f3182e = atomicReferenceFieldUpdater5;
        }

        @Override // f.b.b.f.a.b.AbstractC0109b
        public boolean a(b<?> bVar, e eVar, e eVar2) {
            return this.f3181d.compareAndSet(bVar, eVar, eVar2);
        }

        @Override // f.b.b.f.a.b.AbstractC0109b
        public boolean b(b<?> bVar, Object obj, Object obj2) {
            return this.f3182e.compareAndSet(bVar, obj, obj2);
        }
    ...
    public static final class g<V> implements Runnable {
        ...
        public void run() {
            if (((b) this.b).b == this) {
                if (b.f3176g.b(this.b, this, b.o(this.c))) {
                    b.l(this.b);
                }
            }
        }
    ...
    public static final class k extends AbstractC0109b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final long f3183d;

        /* renamed from: e  reason: collision with root package name */
        public static final long f3184e;

        /* renamed from: f  reason: collision with root package name */
        public static final long f3185f;
        ...
        static {
            ...
            try {
                ...
                try {
                    ...
                    f3183d = unsafe.objectFieldOffset(b.class.getDeclaredField("b"));
                    f3184e = unsafe.objectFieldOffset(l.class.getDeclaredField("a"));
                    f3185f = unsafe.objectFieldOffset(l.class.getDeclaredField("b"));
                    a = unsafe;
                } catch (Exception e2) {
                    v.c(e2);
        ...
        @Override // f.b.b.f.a.b.AbstractC0109b
        public boolean b(b<?> bVar, Object obj, Object obj2) {
            return a.compareAndSwapObject(bVar, f3183d, obj, obj2);
        }
        ...
        @Override // f.b.b.f.a.b.AbstractC0109b
        public void d(l lVar, l lVar2) {
            a.putObject(lVar, f3185f, lVar2);
        }

        @Override // f.b.b.f.a.b.AbstractC0109b
        public void e(l lVar, Thread thread) {
            a.putObject(lVar, f3184e, thread);
        }
    }
    ...
    public static final class l {
        ...
        public l() {
            b.f3176g.e(this, Thread.currentThread());
        }
    ...
    public static void l(b<?> bVar) {
        ...
        e eVar3 = null;
        while (true) {
            l lVar = ((b) bVar).f3178d;
            if (f3176g.c((b) bVar, lVar, l.c)) {
                while (lVar != null) {
                ...
                do {
                    eVar = ((b) bVar).c;
                } while (!f3176g.a((b) bVar, eVar, e.f3180d));
                while (true) {
                    eVar2 = eVar3;
                    eVar3 = eVar;
                    if (eVar3 == null) {
                ...
                while (eVar2 != null) {
                    ...
                    if (runnable instanceof g) {
                        ...
                        bVar = gVar.b;
                        if (((b) bVar).b == gVar) {
                            if (f3176g.b(bVar, gVar, o(gVar.c))) {
                            }
                        } else {
                            continue;
                        }
    ...
    public static Object o(u<?> uVar) {
        ...
        if (uVar instanceof i) {
            ...
            c cVar = (c) obj;
            if (cVar.a) {
                return cVar.b != null ? new c(false, cVar.b) : c.f3179d;
            }
            return obj;
            ...
            if ((!f3174e) && isCancelled) {
                return c.f3179d;
            }
            try {
                Object p = p(uVar);
                if (!isCancelled) {
                    return p == null ? f3177h : p;
                }
    ...
    public void a(Runnable runnable, Executor executor) {
        ...
        if (isDone() || (eVar = this.c) == e.f3180d) {
            m(runnable, executor);
        }
        e eVar2 = new e(runnable, executor);
        do {
            eVar2.c = eVar;
            if (!f3176g.a(this, eVar, eVar2)) {
                eVar = this.c;
            } else {
                return;
            }
    ...
    public boolean cancel(boolean z) {
        ...
        c cVar = f3174e ? new c(z, new CancellationException("Future.cancel() was called.")) : z ? c.c : c.f3179d;
        boolean z2 = false;
        b<V> bVar = this;
        while (true) {
            if (f3176g.b(bVar, obj, cVar)) {
                l(bVar);
                if (!(obj instanceof g)) {
                    return true;
                }
        ...
        while (true) {
            ...
            if (lVar2 != l.c) {
                ...
                while (lVar2 != null) {
                    ...
                    } else if (!f3176g.c(this, lVar2, lVar4)) {
                    }
                    lVar2 = lVar4;
                }
                return;
    ...
    public boolean u(Throwable th) {
        Objects.requireNonNull(th);
        if (!f3176g.b(this, null, new d(th))) {
            return false;
        }
        l(this);
        return true;
