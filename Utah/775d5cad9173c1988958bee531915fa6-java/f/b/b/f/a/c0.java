...
public final class c0<V> extends l.a<V> {
    ...
    public static final class b<V> implements Runnable {
        ...
        public void run() {
            u<V> uVar;
            c0<V> c0Var = this.b;
            if (c0Var != null && (uVar = c0Var.f3188i) != null) {
                this.b = null;
                if (uVar.isDone()) {
                    c0Var.v(uVar);
                    return;
                ...
                try {
                    ScheduledFuture<?> scheduledFuture = c0Var.f3189j;
                    c0Var.f3189j = null;
    ...
    public void j() {
        q(this.f3188i);
        ScheduledFuture<?> scheduledFuture = this.f3189j;
        if (scheduledFuture != null) {
