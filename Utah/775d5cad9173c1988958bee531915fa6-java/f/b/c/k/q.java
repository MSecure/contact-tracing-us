...
public final class q {
    ...
    public final k a(Object obj, g0 g0Var) {
        if (!obj.getClass().isArray()) {
            s c = c(h.b(obj, h.b.f3443d), g0Var);
        ...
        throw new IllegalArgumentException(a.w("Invalid data. Data must be a Map<String, Object> or a suitable POJO object, but it was ", "an array"));
    }
                ...
                if (hVar3 != null) {
                    if (eVar instanceof e.c) {
                        ...
                        if (i0Var == i0.MergeSet) {
                            ...
                            f.b.a.c.b.o.b.O0(z, "FieldValue.delete() at the top level should have already been handled.", new Object[0]);
                        ...
                        if (eVar instanceof e.C0114e) {
                            ...
                            if (eVar instanceof e.b) {
                                ...
                                s c2 = c(h.b(null, h.b.f3443d), f0Var.a());
                                if (c2 == null) {
                                    z = false;
                                }
                                f.b.a.c.b.o.b.O0(z, "Parsed data should not be null.", new Object[0]);
                                f.b.a.c.b.o.b.O0(f0Var.c.isEmpty(), "Field transforms should have been disallowed.", new Object[0]);
                                oVar = new i(c2);
                                hVar3 = g0Var.b;
                            } else {
