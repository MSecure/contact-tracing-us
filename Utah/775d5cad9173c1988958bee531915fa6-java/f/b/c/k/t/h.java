...
public final class h {
    ...
    public i a(a aVar) {
        ...
        if (ordinal == 0) {
            ...
            f.b.a.c.b.o.b.q0("Unknown MaybeDocument %s", aVar);
            throw null;
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:100:0x0284  */
    ...
    public d1 c(f.b.c.k.v.c cVar) {
        ...
        if (ordinal == 0) {
            ...
            int l2 = g2.l();
            if (l2 > 0) {
                f.b.a.c.b.o.b.O0(l2 == 1, "StructuredQuery.from with more than one collection is not supported.", new Object[0]);
                p.c k2 = g2.k(0);
                boolean e4 = k2.e();
                String f2 = k2.f();
                if (e4) {
                    ...
                    if (!g2.u()) {
                        ...
                        if (q2.i() == p.h.b.COMPOSITE_FILTER) {
                            f.b.a.c.b.o.b.O0(q2.f().g() == p.d.b.AND, "Only AND-type composite filters are supported, got %d", q2.f().g());
                            list2 = q2.f().f();
                        } else {
                            list2 = Collections.singletonList(q2);
                        }
                        ArrayList arrayList2 = new ArrayList(list2.size());
                        Iterator<p.h> it2 = list2.iterator();
                        while (it2.hasNext()) {
                            p.h next = it2.next();
                            ...
                            if (ordinal2 != 0) {
                                if (ordinal2 == 1) {
                                    ...
                                    switch (h3.ordinal()) {
                                        ...
                                        case 10:
                                            ...
                                            break;
                                        default:
                                            f.b.a.c.b.o.b.q0("Unhandled FieldFilter.operator %d", h3);
                                            throw null;
                                    }
                                    ...
                                    if (ordinal3 == 1) {
                                        ...
                                        if (ordinal3 == 3) {
                                            ...
                                            f.b.a.c.b.o.b.q0("Unrecognized UnaryFilter.operator %d", j2.g());
                                            throw null;
                                        }
                                    ...
                                    f.b.a.c.b.o.b.q0("Unrecognized Filter.filterType %d", next.i());
                                    throw null;
                                }
                                arrayList2.add(hVar);
                                it2 = it;
                                ...
                                f.b.a.c.b.o.b.q0("Nested composite filters are not supported.", new Object[0]);
                                throw null;
                            }
                        }
                        jVar = o2;
                    ...
                    if (o <= 0) {
                        ...
                        for (int i2 = 0; i2 < o; i2++) {
                            ...
                            if (ordinal4 == 1) {
                                ...
                                f.b.a.c.b.o.b.q0("Unrecognized direction %d", n2.e());
                                throw null;
                            }
                            arrayList3.add(new w(aVar, r3));
                        }
                        cVar2 = null;
                        list = arrayList3;
                    } else {
                    ...
                    c0Var = new x(lVar, str, arrayList, list, j3, x.a.LIMIT_TO_FIRST, cVar3, cVar4).d();
                } else {
                    c = (l) c.b(f2);
                }
            }
            ...
            c0Var = new x(lVar, str, arrayList, list, j32, x.a.LIMIT_TO_FIRST, cVar3, cVar4).d();
        } else if (ordinal == 1) {
            h0 h0Var2 = this.a;
            q.c k3 = cVar.k();
            Objects.requireNonNull(h0Var2);
            int f3 = k3.f();
            f.b.a.c.b.o.b.O0(f3 == 1, "DocumentsTarget contained other than 1 document %d", Integer.valueOf(f3));
            c0Var = x.a(h0Var2.c(k3.e(0))).d();
            jVar = o2;
        } else {
            f.b.a.c.b.o.b.q0("Unknown targetType %d", cVar.r());
            throw null;
        }
