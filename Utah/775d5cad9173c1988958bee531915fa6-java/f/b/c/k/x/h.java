...
public class h {
    ...
    public static class a<T> {
        ...
        public final Map<String, Method> f3439d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        public final Map<String, Field> f3440e = new HashMap();

        /* renamed from: f  reason: collision with root package name */
        public final HashSet<String> f3441f = new HashSet<>();

        /* renamed from: g  reason: collision with root package name */
        public final HashSet<String> f3442g = new HashSet<>();
        ...
        public a(Class<T> cls) {
            ...
            do {
                ...
                for (Method method2 : declaredMethods) {
                    if (method2.getName().startsWith("set") && !method2.getDeclaringClass().equals(Object.class) && !Modifier.isStatic(method2.getModifiers()) && method2.getReturnType().equals(Void.TYPE) && method2.getParameterTypes().length == 1 && !method2.isAnnotationPresent(d.class)) {
                        ...
                        if (str == null) {
                            ...
                            Method method3 = this.f3439d.get(f3);
                            if (method3 == null) {
                                method2.setAccessible(true);
                                this.f3439d.put(f3, method2);
                ...
                for (Field field2 : declaredFields) {
                    String e2 = e(field2);
                    if (this.b.containsKey(e2.toLowerCase(Locale.US)) && !this.f3440e.containsKey(e2)) {
                        field2.setAccessible(true);
                        this.f3440e.put(e2, field2);
                        c(field2);
                    }
                }
            ...
            if (!this.b.isEmpty()) {
                Iterator<String> it = this.f3442g.iterator();
                while (it.hasNext()) {
                    String next = it.next();
                    if (!(this.f3439d.containsKey(next) || this.f3440e.containsKey(next))) {
        ...
        public static String f(Method method) {
            ...
            throw new IllegalArgumentException(f.a.a.a.a.w("Unknown Bean prefix for method: ", name));
        }
    ...
    public static class b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final b f3443d = new b(null, null, 0);
        public final int a;
        public final b b;
    ...
    public static void a(boolean z, String str) {
        if (!z) {
            throw new RuntimeException(f.a.a.a.a.w("Hard assert failed: ", str));
        }
    }
                        ...
                        for (String str2 : aVar.b.values()) {
                            if (!aVar.f3442g.contains(str2)) {
                                if (aVar.c.containsKey(str2)) {
                                    ...
                                    Field field = aVar.f3440e.get(str2);
                                    if (field != null) {
                                        try {
                                            obj = field.get(t);
                                        ...
                                        throw new IllegalStateException(f.a.a.a.a.w("Bean property without field or getter: ", str2));
                                    }
                                }
                                if (!aVar.f3441f.contains(str2) || obj != null) {
    ...
    public static IllegalArgumentException c(b bVar, String str) {
        String w = f.a.a.a.a.w("Could not serialize object. ", str);
        if (bVar.a > 0) {
            StringBuilder i2 = f.a.a.a.a.i(w, " (found in field '");
            i2.append(bVar.toString());
            i2.append("')");
            w = i2.toString();
        }
        return new IllegalArgumentException(w);
    }
}
