...
public final class b0 extends c<Integer> implements c0.g, RandomAccess, c1 {
    ...
    public void add(int i2, Object obj) {
        ...
        if (i3 < iArr.length) {
            ...
            System.arraycopy(this.c, i2, iArr2, i2 + 1, this.f3596d - i2);
            this.c = iArr2;
        }
        this.c[i2] = intValue;
        this.f3596d++;
    ...
    public boolean addAll(Collection<? extends Integer> collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(b0Var.c, 0, this.c, this.f3596d, b0Var.f3596d);
            this.f3596d = i4;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public boolean equals(Object obj) {
        ...
        b0 b0Var = (b0) obj;
        if (this.f3596d != b0Var.f3596d) {
            return false;
        }
        int[] iArr = b0Var.c;
        for (int i2 = 0; i2 < this.f3596d; i2++) {
    ...
    public int hashCode() {
        int i2 = 1;
        for (int i3 = 0; i3 < this.f3596d; i3++) {
            i2 = (i2 * 31) + this.c[i3];
        }
        return i2;
    }
    ...
    public final String l(int i2) {
        return "Index:" + i2 + ", Size:" + this.f3596d;
    }

    /* renamed from: m */
    public c0.g d(int i2) {
        if (i2 >= this.f3596d) {
            return new b0(Arrays.copyOf(this.c, i2), this.f3596d);
        }
    ...
    @Override // java.util.List, f.b.g.c
    public boolean remove(Object obj) {
        h();
        for (int i2 = 0; i2 < this.f3596d; i2++) {
            if (obj.equals(Integer.valueOf(this.c[i2]))) {
                int[] iArr = this.c;
                System.arraycopy(iArr, i2 + 1, iArr, i2, (this.f3596d - i2) - 1);
                this.f3596d--;
                ((AbstractList) this).modCount++;
                return true;
            }
    ...
    public void removeRange(int i2, int i3) {
        ...
        if (i3 >= i2) {
            int[] iArr = this.c;
            System.arraycopy(iArr, i3, iArr, i2, this.f3596d - i3);
            this.f3596d -= i3 - i2;
            ((AbstractList) this).modCount++;
            return;
        }
