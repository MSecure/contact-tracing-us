...
public final class k0 extends c<Long> implements c0.h, RandomAccess, c1 {
    ...
    public void add(int i2, Object obj) {
        ...
        if (i3 < jArr.length) {
            ...
            System.arraycopy(this.c, i2, jArr2, i2 + 1, this.f3660d - i2);
            this.c = jArr2;
        }
        this.c[i2] = longValue;
        this.f3660d++;
    ...
    public boolean addAll(Collection<? extends Long> collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(k0Var.c, 0, this.c, this.f3660d, k0Var.f3660d);
            this.f3660d = i4;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public boolean equals(Object obj) {
        ...
        k0 k0Var = (k0) obj;
        if (this.f3660d != k0Var.f3660d) {
            return false;
        }
        long[] jArr = k0Var.c;
        for (int i2 = 0; i2 < this.f3660d; i2++) {
    ...
    public int hashCode() {
        int i2 = 1;
        for (int i3 = 0; i3 < this.f3660d; i3++) {
    ...
    public final String l(int i2) {
        return "Index:" + i2 + ", Size:" + this.f3660d;
    }

    /* renamed from: m */
    public c0.h d(int i2) {
        if (i2 >= this.f3660d) {
            return new k0(Arrays.copyOf(this.c, i2), this.f3660d);
        }
    ...
    public boolean remove(Object obj) {
        ...
        for (int i2 = 0; i2 < this.f3660d; i2++) {
            if (obj.equals(Long.valueOf(this.c[i2]))) {
                long[] jArr = this.c;
                System.arraycopy(jArr, i2 + 1, jArr, i2, (this.f3660d - i2) - 1);
                this.f3660d--;
                ((AbstractList) this).modCount++;
                return true;
            }
    ...
    public void removeRange(int i2, int i3) {
        ...
        if (i3 >= i2) {
            long[] jArr = this.c;
            System.arraycopy(jArr, i3, jArr, i2, this.f3660d - i3);
            this.f3660d -= i3 - i2;
            ((AbstractList) this).modCount++;
            return;
        }
