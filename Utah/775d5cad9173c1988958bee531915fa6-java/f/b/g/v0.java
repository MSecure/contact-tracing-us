...
public final class v0<T> implements j1<T> {
    ...
    public v0(int[] iArr, Object[] objArr, int i2, int i3, t0 t0Var, boolean z, boolean z2, int[] iArr2, int i4, int i5, x0 x0Var, j0 j0Var, r1<?, ?> r1Var, s<?> sVar, o0 o0Var) {
        ...
        this.c = i2;
        this.f3687d = i3;
        this.f3690g = t0Var instanceof z;
        this.f3691h = z;
        this.f3689f = sVar != null && sVar.e(t0Var);
        this.f3692i = z2;
        this.f3693j = iArr2;
        this.f3694k = i4;
        this.f3695l = i5;
    ...
    public static <T> v0<T> B(g1 g1Var, x0 x0Var, j0 j0Var, r1<?, ?> r1Var, s<?> sVar, o0 o0Var) {
        ...
        d1 d1Var = d1.PROTO3;
        int i35 = 0;
        boolean z2 = ((g1Var.f3613d & 1) == 1 ? d1.PROTO2 : d1Var) == d1Var;
        String str2 = g1Var.b;
    ...
    public final <K, V> int I(T t, byte[] bArr, int i2, int i3, int i4, long j2, f fVar) {
        ...
        while (g0 < i7) {
            ...
            if (i9 == 1) {
                ...
                y1 y1Var2 = h2.c;
                if (i10 == y1Var2.c) {
                    g0 = l(bArr, i5, i3, y1Var2, h2.f3671d.getClass(), fVar);
                    obj3 = fVar.c;
                }
            }
            g0 = b.q1(b2, bArr, i5, i3, fVar);
        }
        if (g0 == i7) {
            e2.put(obj2, obj3);
            return i7;
    ...
    public int K(T t, byte[] bArr, int i2, int i3, int i4, f fVar) {
        ...
        while (true) {
            if (i27 < i26) {
                ...
                if (i35 > i29) {
                    int i37 = i30 / 3;
                    if (i35 < v0Var3.c || i35 > v0Var3.f3687d) {
                        i7 = -1;
                        i6 = -1;
                        if (i6 != i7) {
                            i10 = i35;
                            ...
                            if (i12 == i13 || i13 == 0) {
                                ...
                                if (v0Var2.f3689f) {
                                    fVar4 = fVar;
                                    if (fVar4.f3607d != r.a()) {
                                        t0 t0Var = v0Var2.f3688e;
                                        r1<?, ?> r1Var = v0Var2.o;
                                        i15 = i10;
                                        z.e<?, ?> eVar = fVar4.f3607d.a.get(new r.a(t0Var, i15));
                                        if (eVar == null) {
                            ...
                            if (W <= 17) {
                                ...
                                switch (W) {
                                    ...
                                    case 1:
                                        ...
                                        i16 = b2;
                                        if (i36 == 5) {
                                            v1.f3698f.p(t4, C, Float.intBitsToFloat(b.N(bArr2, i5)));
                                            i21 = i5 + 4;
                                            i27 = i21;
                                            i33 |= i20;
                                            break;
        ...
        s1 s1Var = null;
        for (int i42 = v0Var.f3694k; i42 < v0Var.f3695l; i42++) {
            s1Var = (s1) v0Var.m(t2, v0Var.f3693j[i42], s1Var, (r1<UT, UB>) v0Var.o);
        }
        if (s1Var != null) {
            v0Var.o.n(t2, s1Var);
        }
    ...
    public final int L(T t, byte[] bArr, int i2, int i3, f fVar) {
        ...
        while (i14 < i15) {
            ...
            if (i20 > i16) {
                int i22 = i17 / 3;
                if (i20 < v0Var.c || i20 > v0Var.f3687d) {
                    i4 = -1;
                    if (i4 != i13) {
                        i5 = i20;
                        i7 = i18;
                        ...
                        if (W <= 17) {
                            ...
                            switch (W) {
                                ...
                                case 1:
                                    i9 = i4;
                                    if (i21 == 5) {
                                        v1.f3698f.p(t2, C, Float.intBitsToFloat(b.N(bArr2, i18)));
                                        i14 = i18 + 4;
                                        i5 = i20;
                                        i17 = i9;
                                        break;
    ...
    public final void T(T t, int i2) {
        if (!this.f3691h) {
            ...
            v1.f3698f.q(t, j2, v1.n(t, j2) | (1 << (i3 >>> 20)));
        }
    }

    public final void U(T t, int i2, int i3) {
        v1.f3698f.q(t, (long) (this.a[i3 + 2] & 1048575), i2);
    }
            ...
            if (i2 < iArr.length) {
                ...
                switch (W(i3)) {
                    ...
                    case 50:
                        o0 o0Var = this.q;
                        Class<?> cls = l1.a;
                        v1.f3698f.s(t, C, o0Var.a(v1.p(t, C), v1.p(t2, C)));
                        break;
                    case 51:
                    case 52:
                    case 53:
    ...
    public final boolean b(T t) {
        ...
        while (true) {
            boolean z = true;
            if (i4 >= this.f3694k) {
                return !this.f3689f || this.p.c(t).j();
            }
            int i6 = this.f3693j[i4];
            int i7 = this.a[i6];
            int X = X(i6);
            if (!this.f3691h) {
                int i8 = this.a[i6 + 2];
    ...
    @Override // f.b.g.j1
    public int f(T t) {
        return this.f3691h ? s(t) : r(t);
    }

    @Override // f.b.g.j1
    public T g() {
        return (T) this.m.a(this.f3688e);
    }
    ...
    public void i(T t) {
        ...
        while (true) {
            ...
            long C = C(X(this.f3693j[i3]));
            Object p2 = v1.p(t, C);
            if (p2 != null) {
                v1.f3698f.s(t, C, this.q.g(p2));
            }
            i3++;
        }
        int length = this.f3693j.length;
        while (i2 < length) {
            this.n.a(t, (long) this.f3693j[i2]);
            i2++;
        }
        this.o.j(t);
        if (this.f3689f) {
    ...
    public int j(T t) {
        ...
        return this.f3689f ? (hashCode * 53) + this.p.c(t).hashCode() : hashCode;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:101:0x01d0, code lost:
        if (r16.f3692i != false) goto L_0x0227;
     */
    ...
    public final int r(T t) {
        ...
        for (int i13 = 0; i13 < this.a.length; i13 += 3) {
            ...
            if (W <= 17) {
                ...
                i3 = (!this.f3692i || W < w.DOUBLE_LIST_PACKED.b || W > w.SINT64_LIST_PACKED.b) ? 0 : this.a[i13 + 2] & 1048575;
                i2 = 0;
            }
            long C = C(X);
            switch (W) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:101:0x01ce, code lost:
        if (r13.f3692i != false) goto L_0x0203;
     */
    ...
    public final boolean u(T t, int i2, int i3, int i4) {
        return this.f3691h ? t(t, i2) : (i3 & i4) != 0;
    }
    ...
    public final <K, V> void x(Object obj, int i2, Object obj2, r rVar, h1 h1Var) {
        ...
        if (p2 == null) {
            p2 = this.q.c(obj2);
            v1.f3698f.s(obj, C, p2);
        } else if (this.q.f(p2)) {
            Object c2 = this.q.c(obj2);
            this.q.a(c2, p2);
            v1.f3698f.s(obj, C, c2);
            p2 = c2;
        }
