...
public final class c {
    ...
    public ArrayList<f.d.a.d.a> f3769d = new ArrayList<>();
    ...
    public final class a extends AsyncTask<String, h, h> {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ c f3772e;
        ...
        public h doInBackground(String[] strArr) {
            ...
            boolean z4;
            e.c(strArr, "strings");
            if (c.a(this.f3772e).b.length == 0) {
                Context context2 = this.f3771d;
                HashMap<String, String> hashMap = c.a(this.f3772e).s;
                ...
                aVar = new a(context2, (cls == null || (fields = cls.getFields()) == null) ? new String[0] : f.b.a.c.b.o.b.s1(fields), hashMap);
            } else {
                aVar = new a(this.f3771d, c.a(this.f3772e).b, c.a(this.f3772e).s);
            }
            b a2 = c.a(this.f3772e);
            Boolean o0 = f.b.a.c.b.o.b.o0(this.f3771d, Boolean.valueOf(c.a(this.f3772e).f3762f), "aboutLibraries_description_showIcon");
            a2.f3762f = o0 != null ? o0.booleanValue() : false;
            b a3 = c.a(this.f3772e);
            Boolean o02 = f.b.a.c.b.o.b.o0(this.f3771d, Boolean.valueOf(c.a(this.f3772e).f3764h), "aboutLibraries_description_showVersion");
            a3.f3764h = o02 != null ? o02.booleanValue() : false;
            b a4 = c.a(this.f3772e);
            Boolean o03 = f.b.a.c.b.o.b.o0(this.f3771d, Boolean.valueOf(c.a(this.f3772e).f3766j), "aboutLibraries_description_showVersionName");
            a4.f3766j = o03 != null ? o03.booleanValue() : false;
            b a5 = c.a(this.f3772e);
            Boolean o04 = f.b.a.c.b.o.b.o0(this.f3771d, Boolean.valueOf(c.a(this.f3772e).f3767k), "aboutLibraries_description_showVersionCode");
            a5.f3767k = o04 != null ? o04.booleanValue() : false;
            b a6 = c.a(this.f3772e);
            String p0 = f.b.a.c.b.o.b.p0(this.f3771d, c.a(this.f3772e).f3763g, "aboutLibraries_description_name");
            if (p0 == null) {
                p0 = "";
            }
            a6.f3763g = p0;
            b a7 = c.a(this.f3772e);
            String p02 = f.b.a.c.b.o.b.p0(this.f3771d, c.a(this.f3772e).f3765i, "aboutLibraries_description_text");
            if (p02 == null) {
                p02 = "";
            }
            a7.f3765i = p02;
            c.a(this.f3772e).f3768l = f.b.a.c.b.o.b.p0(this.f3771d, c.a(this.f3772e).f3768l, "aboutLibraries_description_special1_name");
            c.a(this.f3772e).m = f.b.a.c.b.o.b.p0(this.f3771d, c.a(this.f3772e).m, "aboutLibraries_description_special1_text");
            c.a(this.f3772e).n = f.b.a.c.b.o.b.p0(this.f3771d, c.a(this.f3772e).n, "aboutLibraries_description_special2_name");
            c.a(this.f3772e).o = f.b.a.c.b.o.b.p0(this.f3771d, c.a(this.f3772e).o, "aboutLibraries_description_special2_text");
            c.a(this.f3772e).p = f.b.a.c.b.o.b.p0(this.f3771d, c.a(this.f3772e).p, "aboutLibraries_description_special3_name");
            c.a(this.f3772e).q = f.b.a.c.b.o.b.p0(this.f3771d, c.a(this.f3772e).q, "aboutLibraries_description_special3_text");
            HashMap<String, HashMap<String, String>> hashMap2 = c.a(this.f3772e).r;
            if (hashMap2 != null) {
            ...
            Objects.requireNonNull(c.a(this.f3772e));
            Objects.requireNonNull(c.a(this.f3772e));
            Objects.requireNonNull(this.f3772e);
            c cVar2 = this.f3772e;
            Context context3 = this.f3771d;
            String[] strArr6 = c.a(cVar2).c;
            String[] strArr7 = c.a(this.f3772e).f3760d;
            Objects.requireNonNull(c.a(this.f3772e));
            Objects.requireNonNull(c.a(this.f3772e));
            e.c(context3, "ctx");
            ...
            cVar.f3769d = arrayList2;
            Objects.requireNonNull(this.f3772e);
            Objects.requireNonNull(c.a(this.f3772e));
            boolean z7 = c.a(this.f3772e).f3764h || c.a(this.f3772e).f3766j || c.a(this.f3772e).f3767k;
            if (c.a(this.f3772e).f3762f && z7) {
                PackageManager packageManager = this.f3771d.getPackageManager();
                String packageName2 = this.f3771d.getPackageName();
                try {
                ...
                if (c.a(this.f3772e).f3762f && applicationInfo != null) {
                    this.c = applicationInfo.loadIcon(packageManager);
                }
                this.a = null;
                this.b = null;
        ...
        public void onPostExecute(h hVar) {
            h hVar2 = hVar;
            e.c(hVar2, "nothing");
            f.d.b.p.a b2 = c.b(this.f3772e);
            l<Item> lVar = b2.f3801g;
            b<Item> bVar = b2.a;
            lVar.d(bVar != null ? bVar.q(b2.b) : 0);
            boolean z = c.a(this.f3772e).f3764h || c.a(this.f3772e).f3766j || c.a(this.f3772e).f3767k;
            if (c.a(this.f3772e).f3762f && z) {
                f.d.b.p.a b3 = c.b(this.f3772e);
                f.d.a.e.b.a aVar = new f.d.a.e.b.a(c.a(this.f3772e));
                aVar.c = this.a;
                aVar.b = this.b;
                aVar.f3784d = this.c;
                b3.e(aVar);
            ...
            Iterator<f.d.a.d.a> it = this.f3772e.f3769d.iterator();
            while (it.hasNext()) {
                f.d.a.d.a next = it.next();
                Objects.requireNonNull(c.a(this.f3772e));
                e.b(next, "library");
                arrayList.add(new f.d.a.e.b.d(next, c.a(this.f3772e)));
            }
            c.b(this.f3772e).d(arrayList);
