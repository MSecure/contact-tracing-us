...
public final class d implements Object<c.d> {
    ...
    public static c1 D(q qVar) {
        b.z(qVar, "context must not be null");
        if (!qVar.S()) {
            return null;
        }
        Throwable x = qVar.x();
        if (x == null) {
            return c1.f3833g.g("io.grpc.Context was cancelled without error");
        }
        if (x instanceof TimeoutException) {
            return c1.f3835i.g(x.getMessage()).f(x);
        }
        c1 d2 = c1.d(x);
        return (!c1.b.UNKNOWN.equals(d2.a) || d2.c != x) ? d2.f(x) : c1.f3833g.g("Context cancelled").f(x);
    }
    ...
    public static l1 f() {
        return l2.f3964e == null ? new l2() : new h();
    }
    ...
    public static Object m(Context context) {
        Application u0 = b.u0(context.getApplicationContext());
        boolean z = u0 instanceof g.b.b.b;
        Object[] objArr = {u0.getClass()};
        if (z) {
            return ((g.b.b.b) u0).e();
        }
    ...
    public static Set<c1.b> n(Map<String, ?> map, String str) {
        ...
        for (Object obj : b) {
            if (obj instanceof Double) {
                ...
                boolean z = true;
                b.w1(((double) intValue) == d2.doubleValue(), "Status code %s is not integral", obj);
                bVar = c1.c(intValue).a;
                if (bVar.b != d2.intValue()) {
                    z = false;
                }
                b.w1(z, "Status code %s is not valid", obj);
    ...
    public static <T> T u(T t, String str) {
        ...
        throw new NullPointerException(a.w(str, " must not be null"));
    }
