...
public abstract class a extends d implements u, a2.d {
    ...
    public static final Logger f3861f = Logger.getLogger(a.class.getName());
    public final c3 a;
    public final o0 b;
    public boolean c;
    ...
    public class C0144a implements o0 {
        ...
        public void close() {
            ...
            ((f.a) a.this.o()).a(this.a, this.f3864d);
            this.f3864d = null;
            this.a = null;
        }
        ...
        public void d(InputStream inputStream) {
            f.b.a.c.b.o.b.F(this.f3864d == null, "writePayload should not be called multiple times");
            try {
                this.f3864d = f.b.b.c.b.b(inputStream);
                for (f1 f1Var : this.c.a) {
                    Objects.requireNonNull(f1Var);
                }
                w2 w2Var = this.c;
                int length = this.f3864d.length;
                for (f1 f1Var2 : w2Var.a) {
                    Objects.requireNonNull(f1Var2);
                }
                w2 w2Var2 = this.c;
                int length2 = this.f3864d.length;
                for (f1 f1Var3 : w2Var2.a) {
                    Objects.requireNonNull(f1Var3);
                }
                w2 w2Var3 = this.c;
                long length3 = (long) this.f3864d.length;
    ...
    public static abstract class c extends d.a {
        ...
        public class RunnableC0145a implements Runnable {
            ...
            public void run() {
                c.this.g(this.b, this.c, this.f3871d);
            }
        }
        ...
        public final void g(c1 c1Var, v.a aVar, n0 n0Var) {
            if (!this.f3867i) {
                this.f3867i = true;
                w2 w2Var = this.f3866h;
                if (w2Var.b.compareAndSet(false, true)) {
                    for (f1 f1Var : w2Var.a) {
                        Objects.requireNonNull(f1Var);
                    }
                }
                this.f3868j.d(c1Var, aVar, n0Var);
                c3 c3Var = this.f3903d;
                if (c3Var == null) {
                    return;
                }
                if (c1Var.e()) {
        ...
        public void h(n0 n0Var) {
            ...
            String str2 = (String) n0Var.d(q0.f4033e);
            if (this.f3869k && str2 != null) {
                if (str2.equalsIgnoreCase("gzip")) {
                    ...
                    if (str != null) {
                        t.a aVar = this.f3870l.a.get(str);
    ...
    public a(e3 e3Var, w2 w2Var, c3 c3Var, n0 n0Var, h.a.c cVar, boolean z) {
        ...
        this.a = c3Var;
        this.c = !Boolean.TRUE.equals(cVar.a(q0.f4040l));
        this.f3862d = z;
        if (!z) {
    ...
    public void e(r rVar) {
        n0 n0Var = this.f3863e;
        n0.f<Long> fVar = q0.b;
        n0Var.b(fVar);
        this.f3863e.h(fVar, Long.valueOf(Math.max(0L, rVar.e(TimeUnit.NANOSECONDS))));
    }

    @Override // h.a.j1.u
    public final void f(t tVar) {
        c p = p();
        f.b.a.c.b.o.b.F(p.f3868j == null, "Already called start");
    ...
    public final void i(v vVar) {
        c p = p();
        f.b.a.c.b.o.b.F(p.f3868j == null, "Already called setListener");
        f.b.a.c.b.o.b.z(vVar, "listener");
        p.f3868j = vVar;
        if (!this.f3862d) {
            ((f.a) o()).a(this.f3863e, null);
            this.f3863e = null;
        }
    }
