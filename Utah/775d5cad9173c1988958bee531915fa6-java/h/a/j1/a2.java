...
public class a2 implements o0 {
    ...
    public l f3873d = k.b.a;

    /* renamed from: e  reason: collision with root package name */
    public final c f3874e = new c(null);

    /* renamed from: f  reason: collision with root package name */
    public final byte[] f3875f = new byte[5];

    /* renamed from: g  reason: collision with root package name */
    public final e3 f3876g;

    /* renamed from: h  reason: collision with root package name */
    public final w2 f3877h;
    ...
    public void d(InputStream inputStream) {
        ...
        if (!this.f3878i) {
            ...
            this.f3880k++;
            this.f3881l = 0;
            for (f1 f1Var : this.f3877h.a) {
                Objects.requireNonNull(f1Var);
            }
            boolean z = this.f3873d != k.b.a;
            try {
                if (!(inputStream instanceof g0)) {
                    if (!(inputStream instanceof ByteArrayInputStream)) {
                        ...
                        if (i2 != -1 || j2 == i2) {
                            for (f1 f1Var2 : this.f3877h.a) {
                                Objects.requireNonNull(f1Var2);
                            }
                            w2 w2Var = this.f3877h;
                            long j3 = this.f3881l;
                            for (f1 f1Var3 : w2Var.a) {
                                f1Var3.a(j3);
                            }
                            for (f1 f1Var4 : this.f3877h.a) {
                ...
                w2 w2Var2 = this.f3877h;
                long j32 = this.f3881l;
                while (r3 < r2) {
                }
                while (r4 < r0) {
                }
    ...
    public final void e(boolean z, boolean z2) {
        d3 d3Var = this.c;
        this.c = null;
        this.a.m(d3Var, z, z2, this.f3879j);
        this.f3879j = 0;
    }

    public final void f(b bVar, boolean z) {
        ByteBuffer wrap = ByteBuffer.wrap(this.f3875f);
        wrap.put(z ? (byte) 1 : 0);
        int i2 = 0;
        for (d3 d3Var : bVar.b) {
            i2 += d3Var.b();
        ...
        wrap.putInt(i2);
        d3 a2 = this.f3876g.a(5);
        a2.c(this.f3875f, 0, wrap.position());
        if (i2 == 0) {
            this.c = a2;
            return;
        }
        this.a.m(a2, false, false, this.f3879j - 1);
        this.f3879j = 1;
        List<d3> list = bVar.b;
    ...
    public final int g(InputStream inputStream) {
        b bVar = new b(null);
        OutputStream c2 = this.f3873d.c(bVar);
        try {
            ...
            throw new e1(c1.f3838l.g(String.format("message too large %d > %d", Integer.valueOf(i2), Integer.valueOf(this.b))));
        } catch (Throwable th) {
            c2.close();
            throw th;
        }
    ...
    public final int j(InputStream inputStream, int i2) {
        if (i2 != -1) {
            ...
            if (i3 < 0 || i2 <= i3) {
                ...
                wrap.putInt(i2);
                if (this.c == null) {
                    this.c = this.f3876g.a(wrap.position() + i2);
                }
                h(this.f3875f, 0, wrap.position());
                return i(inputStream, this.f3874e);
            }
            throw new e1(c1.f3838l.g(String.format("message too large %d > %d", Integer.valueOf(i2), Integer.valueOf(this.b))));
        }
        b bVar = new b(null);
        ...
        throw new e1(c1.f3838l.g(String.format("message too large %d > %d", Integer.valueOf(i4), Integer.valueOf(this.b))));
    }
