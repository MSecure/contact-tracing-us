...
public abstract class n2<ReqT> implements u {
    ...
    public static final c1 y = c1.f3833g.g("Stream thrown away because RetriableStream committed");
    ...
    public final n0 f3991d;

    /* renamed from: e  reason: collision with root package name */
    public final o2.a f3992e;

    /* renamed from: f  reason: collision with root package name */
    public final s0.a f3993f;
    ...
    public final Object f3997j = new Object();

    /* renamed from: k  reason: collision with root package name */
    public final q f3998k;
    ...
    public class c implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ Future f4000d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ Future f4001e;
        ...
        public void run() {
            ...
            Future future = this.f4000d;
            if (future != null) {
                future.cancel(false);
            }
            Future future2 = this.f4001e;
            if (future2 != null) {
    ...
    public class p extends h.a.j {
        ...
        public void a(long j2) {
            if (n2.this.p.f4006f == null) {
                Runnable runnable = null;
                synchronized (n2.this.f3997j) {
                    if (n2.this.p.f4006f == null) {
                        w wVar = this.a;
                        if (!wVar.b) {
                            long j3 = this.b + j2;
                            ...
                            if (j3 > j4) {
                                if (j3 > n2Var.f3999l) {
                                    ...
                                    long addAndGet = n2Var.f3998k.a.addAndGet(j3 - j4);
                                    n2 n2Var2 = n2.this;
                                    n2Var2.r = this.b;
    ...
    public final class s implements Runnable {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                synchronized (n2.this.f3997j) {
                    ...
                    if (!sVar.b.c) {
                        ...
                        if (n2Var4.u(n2Var4.p)) {
                            x xVar = n2.this.n;
                            if (xVar != null) {
                                if (xVar.f4010d.get() <= xVar.b) {
                                    z = false;
                                }
                            }
                            n2Var = n2.this;
                            rVar = new r(n2Var.f3997j);
                            n2Var.u = rVar;
                            z = false;
                        }
                        n2 n2Var5 = n2.this;
                ...
                if (z) {
                    q.a.g(c1.f3833g.g("Unneeded hedging"));
                    return;
                }
                if (rVar != null) {
                    n2 n2Var6 = n2.this;
                    rVar.b(n2Var6.c.schedule(new s(rVar), n2Var6.f3995h.b, TimeUnit.NANOSECONDS));
                }
                n2.this.s(q);
            }
        }
    ...
    public static final class u {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final Collection<w> f4004d;
        ...
        public u(List<o> list, Collection<w> collection, Collection<w> collection2, w wVar, boolean z, boolean z2, boolean z3, int i2) {
            this.b = list;
            f.b.a.c.b.o.b.z(collection, "drainedSubstreams");
            this.c = collection;
            this.f4006f = wVar;
            this.f4004d = collection2;
            this.f4007g = z;
            this.a = z2;
            this.f4008h = z3;
            this.f4005e = i2;
            boolean z4 = false;
            f.b.a.c.b.o.b.F(!z2 || list == null, "passThrough should imply buffer is null");
            f.b.a.c.b.o.b.F(!z2 || wVar != null, "passThrough should imply winningSubstream != null");
            f.b.a.c.b.o.b.F(!z2 || (collection.size() == 1 && collection.contains(wVar)) || (collection.size() == 0 && wVar.b), "passThrough should imply winningSubstream is drained");
            f.b.a.c.b.o.b.F((!z || wVar != null) ? true : z4, "cancelled should imply committed");
        }

        public u a(w wVar) {
            Collection collection;
            f.b.a.c.b.o.b.F(!this.f4008h, "hedging frozen");
            f.b.a.c.b.o.b.F(this.f4006f == null, "already committed");
            if (this.f4004d == null) {
                collection = Collections.singleton(wVar);
            } else {
                ArrayList arrayList = new ArrayList(this.f4004d);
                arrayList.add(wVar);
                collection = Collections.unmodifiableCollection(arrayList);
            }
            return new u(this.b, this.c, collection, this.f4006f, this.f4007g, this.a, this.f4008h, this.f4005e + 1);
        }

        public u b() {
            return this.f4008h ? this : new u(this.b, this.c, this.f4004d, this.f4006f, this.f4007g, this.a, true, this.f4005e);
        }

        public u c(w wVar) {
            ArrayList arrayList = new ArrayList(this.f4004d);
            arrayList.remove(wVar);
            return new u(this.b, this.c, Collections.unmodifiableCollection(arrayList), this.f4006f, this.f4007g, this.a, this.f4008h, this.f4005e);
        }
        ...
        public u e(w wVar) {
            ...
            arrayList.remove(wVar);
            return new u(this.b, Collections.unmodifiableCollection(arrayList), this.f4004d, this.f4006f, this.f4007g, this.a, this.f4008h, this.f4005e);
        }

        public u f(w wVar) {
            Collection unmodifiableCollection;
            boolean z = true;
            f.b.a.c.b.o.b.F(!this.a, "Already passThrough");
            if (wVar.b) {
            ...
            if (z2) {
                ...
                f.b.a.c.b.o.b.F(z, "Another RPC attempt has already committed");
                list = null;
            }
            return new u(list, unmodifiableCollection, this.f4004d, this.f4006f, this.f4007g, z2, this.f4008h, this.f4005e);
        }
    }
    ...
    public final class v implements v {
        ...
        public class b implements Runnable {
            ...
            public class a implements Runnable {
                ...
                public void run() {
                    v vVar = v.this;
                    n0.f<String> fVar = n2.w;
                    n2.this.s(n2.this.q(vVar.a.f4009d + 1));
                }
            }
        ...
        public void a(y2.a aVar) {
            u uVar = n2.this.p;
            f.b.a.c.b.o.b.F(uVar.f4006f != null, "Headers should be received prior to messages.");
            if (uVar.f4006f == this.a) {
                n2.this.s.a(aVar);
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:37:0x00aa, code lost:
            if (r2.f3994g.a == 1) goto L_0x00ac;
         */
            ...
            if (n2.this.p.f4006f == null) {
                ...
                if (aVar != v.a.REFUSED || !n2.this.q.compareAndSet(false, true)) {
                    if (aVar == v.a.DROPPED) {
                        ...
                        n2.this.q.set(true);
                        n2 n2Var6 = n2.this;
                        if (n2Var6.f3994g == null) {
                            n2Var6.f3994g = n2Var6.f3992e.get();
                            n2 n2Var7 = n2.this;
                            n2Var7.v = n2Var7.f3994g.b;
                        }
                        boolean contains = n2.this.f3994g.f4015e.contains(c1Var.a);
                        boolean contains2 = n2.this.f3995h.c.contains(c1Var.a);
                        if (!n2.this.f3996i || contains2) {
                            ...
                            if (n2.this.n == null || (!contains && !contains2 && (num == null || num.intValue() >= 0))) {
                                ...
                                x xVar = n2.this.n;
                                while (true) {
                                    int i2 = xVar.f4010d.get();
                                    if (i2 == 0) {
                                        break;
                                    }
                                    int i3 = i2 - 1000;
                                    if (xVar.f4010d.compareAndSet(i2, Math.max(i3, 0))) {
                                        if (i3 > xVar.b) {
                                            z3 = true;
                                        }
                                    }
                            ...
                            n2 n2Var8 = n2.this;
                            if (n2Var8.f3994g.a > this.a.f4009d + 1 && !z) {
                                if (num == null) {
                                    if (contains) {
                                        j4 = (long) (n2.z.nextDouble() * ((double) n2Var8.v));
                                        n2Var2 = n2.this;
                                        o2 o2Var = n2Var2.f3994g;
                                        j3 = Math.min((long) (((double) n2Var2.v) * o2Var.f4014d), o2Var.c);
                                    }
                                ...
                                j2 = j4;
                                z2 = true;
                                tVar = new t(z2, false, j2, !n2.this.f3996i ? num : null);
                            }
                            j2 = 0;
                            z2 = false;
                            tVar = new t(z2, false, j2, !n2.this.f3996i ? num : null);
                        ...
                        z5 = tVar.b;
                        n2.o(n2.this, tVar.f4003d);
                    }
                    n2 n2Var9 = n2.this;
                    if (n2Var9.f3996i) {
                        synchronized (n2Var9.f3997j) {
                            n2 n2Var10 = n2.this;
                            n2Var10.p = n2Var10.p.c(this.a);
                            if (!z5) {
                                n2 n2Var11 = n2.this;
                                if (n2Var11.u(n2Var11.p) || !n2.this.p.f4004d.isEmpty()) {
                                    return;
                                }
                            }
                        }
                    ...
                    w q = n2.this.q(this.a.f4009d);
                    n2 n2Var12 = n2.this;
                    if (n2Var12.f3996i) {
                        synchronized (n2Var12.f3997j) {
                            n2 n2Var13 = n2.this;
                            n2Var13.p = n2Var13.p.d(this.a, q);
                            n2 n2Var14 = n2.this;
                            if (n2Var14.u(n2Var14.p) || n2.this.p.f4004d.size() != 1) {
                                z4 = false;
                            }
                        }
                        if (z4) {
                    ...
                    if (n2Var12.f3994g == null) {
                        n2Var12.f3994g = n2Var12.f3992e.get();
                    }
                    n2Var3 = n2.this;
                    n2.m(n2Var3, q);
                    n2.this.b.execute(new a(q));
        ...
        public void e(n0 n0Var) {
            ...
            if (n2.this.p.f4006f == this.a) {
                ...
                if (xVar != null) {
                    ...
                    } while (!xVar.f4010d.compareAndSet(i2, Math.min(xVar.c + i2, i3)));
                }
            }
        }
    }
    ...
    public static final class x {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final AtomicInteger f4010d;

        public x(float f2, float f3) {
            AtomicInteger atomicInteger = new AtomicInteger();
            this.f4010d = atomicInteger;
    ...
    public n2(o0<ReqT, ?> o0Var, n0 n0Var, q qVar, long j2, long j3, Executor executor, ScheduledExecutorService scheduledExecutorService, o2.a aVar, s0.a aVar2, x xVar) {
        ...
        this.f3991d = n0Var;
        f.b.a.c.b.o.b.z(aVar, "retryPolicyProvider");
        this.f3992e = aVar;
        f.b.a.c.b.o.b.z(aVar2, "hedgingPolicyProvider");
        this.f3993f = aVar2;
        this.n = xVar;
    }
    ...
    public static void o(n2 n2Var, Integer num) {
        ...
        if (num != null) {
            ...
            synchronized (n2Var.f3997j) {
                r rVar = n2Var.u;
                if (rVar != null) {
                    Future<?> a2 = rVar.a();
                    r rVar2 = new r(n2Var.f3997j);
                    n2Var.u = rVar2;
                }
            }
        }
    ...
    public final void g(c1 c1Var) {
        ...
        this.p.f4006f.a.g(c1Var);
        synchronized (this.f3997j) {
            u uVar = this.p;
            this.p = new u(uVar.b, uVar.c, uVar.f4004d, uVar.f4006f, true, uVar.a, uVar.f4008h, uVar.f4005e);
        }
    }
    ...
    public final void i(v vVar) {
        ...
        boolean z2 = false;
        w q2 = q(0);
        f.b.a.c.b.o.b.F(this.f3995h == null, "hedgingPolicy has been initialized unexpectedly");
        s0 s0Var = this.f3993f.get();
        this.f3995h = s0Var;
        if (!s0.f4074d.equals(s0Var)) {
            this.f3996i = true;
            this.f3994g = o2.f4013f;
            r rVar = null;
            synchronized (this.f3997j) {
                this.p = this.p.a(q2);
                if (u(this.p)) {
                    ...
                    rVar = new r(this.f3997j);
                    this.u = rVar;
                }
            }
            if (rVar != null) {
                rVar.b(this.c.schedule(new s(rVar), this.f3995h.b, TimeUnit.NANOSECONDS));
            }
        }
        s(q2);
    }
    ...
    public final Runnable p(w wVar) {
        ...
        Future<?> future2;
        synchronized (this.f3997j) {
            if (this.p.f4006f != null) {
                return null;
            }
            Collection<w> collection = this.p.c;
            u uVar = this.p;
            boolean z2 = false;
            f.b.a.c.b.o.b.F(uVar.f4006f == null, "Already committed");
            List<o> list2 = uVar.b;
            ...
            this.p = new u(list, set, uVar.f4004d, wVar, uVar.f4007g, z2, uVar.f4008h, uVar.f4005e);
            this.f3998k.a.addAndGet(-this.r);
            r rVar = this.t;
            if (rVar != null) {
                Future<?> a2 = rVar.a();
                this.t = null;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x006f, code lost:
        if (r4.f4007g == false) goto L_0x007a;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0074, code lost:
        f.b.a.c.b.o.b.F(r0, "substream should be CANCELLED_BECAUSE_COMMITTED already");
     */
    ...
    public final boolean u(u uVar) {
        return uVar.f4006f == null && uVar.f4005e < this.f3995h.a && !uVar.f4008h;
    }
    ...
    public final void y(ReqT reqt) {
        u uVar = this.p;
        if (uVar.a) {
            uVar.f4006f.a.h(this.a.f4273d.b(reqt));
        } else {
            r(new m(reqt));
        }
    }
