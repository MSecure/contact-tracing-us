...
public final class q2 implements Executor, Runnable {
    ...
    public static final Logger f4050e = Logger.getLogger(q2.class.getName());

    /* renamed from: f  reason: collision with root package name */
    public static final b f4051f;
    public final Executor b;
    public final Queue<Runnable> c = new ConcurrentLinkedQueue();

    /* renamed from: d  reason: collision with root package name */
    private volatile int f4052d = 0;
    ...
    static {
        ...
        try {
            ...
            f4050e.log(Level.SEVERE, "FieldUpdaterAtomicHelper failed", th);
            bVar = new d(null);
        }
        f4051f = bVar;
    }
