...
public final class z0 implements c0<Object>, b3 {
    ...
    public final ScheduledExecutorService f4102g;

    /* renamed from: h  reason: collision with root package name */
    public final a0 f4103h;

    /* renamed from: i  reason: collision with root package name */
    public final m f4104i;

    /* renamed from: j  reason: collision with root package name */
    public final h.a.e f4105j;

    /* renamed from: k  reason: collision with root package name */
    public final g1 f4106k;

    /* renamed from: l  reason: collision with root package name */
    public final f f4107l;
    ...
    public class b implements Runnable {
        ...
        public void run() {
            if (z0.this.u.a == n.IDLE) {
                z0.this.f4105j.a(e.a.INFO, "CONNECTING as requested");
        ...
        public void run() {
            ...
            if (nVar != nVar2) {
                ...
                if (z0.this.q.isEmpty()) {
                    z0 z0Var4 = z0.this;
                    g1 g1Var = z0Var4.f4106k;
                    d1 d1Var = new d1(z0Var4);
                    Queue<Runnable> queue = g1Var.c;
                    f.b.a.c.b.o.b.z(d1Var, "runnable is null");
                    queue.add(d1Var);
                    g1Var.a();
                }
                z0 z0Var5 = z0.this;
    ...
    public class g implements y1.a {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                z0Var.n = null;
                if (z0Var.v != null) {
                    f.b.a.c.b.o.b.F(z0Var.t == null, "Unexpected non-null activeTransport");
                    g gVar2 = g.this;
                    gVar2.a.d(z0.this.v);
                    return;
                }
        ...
        public class b implements Runnable {
            ...
            public void run() {
                if (z0.this.u.a != n.SHUTDOWN) {
                    ...
                    if (z0Var.s == zVar) {
                        boolean z = true;
                        f.b.a.c.b.o.b.G(z0Var.u.a == n.CONNECTING, "Expected state is CONNECTING, actual state is %s", z0.this.u.a);
                        f fVar = z0.this.f4107l;
                        int i2 = fVar.c + 1;
                        fVar.c = i2;
                        ...
                        if (!(fVar2.b < fVar2.a.size())) {
                            ...
                            if (z0Var3.n == null) {
                                Objects.requireNonNull((h0.a) z0Var3.f4099d);
                                z0Var3.n = new h0();
                            }
                            ...
                            z0Var3.f4105j.b(e.a.INFO, "TRANSIENT_FAILURE ({0}). Will reconnect after {1} ns", z0Var3.k(c1Var), Long.valueOf(a2));
                            if (z0Var3.p != null) {
                                z = false;
                            }
                            f.b.a.c.b.o.b.F(z, "previous reconnectTask is not done");
                            z0Var3.p = z0Var3.f4106k.c(new a1(z0Var3), a2, timeUnit, z0Var3.f4102g);
                            return;
                        }
                        z0.i(z0.this);
                    }
        ...
        public void a() {
            f.b.a.c.b.o.b.F(this.b, "transportShutdown() must be called before transportTerminated().");
            z0.this.f4105j.b(e.a.INFO, "{0} Terminated", this.a.c());
            a0 a0Var = z0.this.f4103h;
            a0.b(a0Var.c, this.a);
            z0 z0Var = z0.this;
            z zVar = this.a;
            g1 g1Var = z0Var.f4106k;
            ...
            Queue<Runnable> queue = g1Var.c;
            f.b.a.c.b.o.b.z(e1Var, "runnable is null");
            queue.add(e1Var);
            g1Var.a();
            g1 g1Var2 = z0.this.f4106k;
            c cVar = new c();
        ...
        @Override // h.a.j1.y1.a
        public void b() {
            z0.this.f4105j.a(e.a.INFO, "READY");
            g1 g1Var = z0.this.f4106k;
            a aVar = new a();
            Queue<Runnable> queue = g1Var.c;
        ...
        public void d(c1 c1Var) {
            z0.this.f4105j.b(e.a.INFO, "{0} SHUTDOWN with {1}", this.a.c(), z0.this.k(c1Var));
            this.b = true;
            g1 g1Var = z0.this.f4106k;
            b bVar = new b(c1Var);
            Queue<Runnable> queue = g1Var.c;
    ...
    public z0(List<h.a.v> list, String str, String str2, j.a aVar, x xVar, ScheduledExecutorService scheduledExecutorService, u<s> uVar, g1 g1Var, e eVar, a0 a0Var, m mVar, o oVar, d0 d0Var, h.a.e eVar2) {
        f.b.a.c.b.o.b.z(list, "addressGroups");
        f.b.a.c.b.o.b.o(!list.isEmpty(), "addressGroups is empty");
        for (h.a.v vVar : list) {
            f.b.a.c.b.o.b.z(vVar, "addressGroups contains null entry");
        }
        List<h.a.v> unmodifiableList = Collections.unmodifiableList(new ArrayList(list));
        this.m = unmodifiableList;
        this.f4107l = new f(unmodifiableList);
        this.b = str;
        this.c = str2;
        this.f4099d = aVar;
        this.f4101f = xVar;
        this.f4102g = scheduledExecutorService;
        this.o = uVar.get();
        this.f4106k = g1Var;
        this.f4100e = eVar;
        this.f4103h = a0Var;
        this.f4104i = mVar;
        f.b.a.c.b.o.b.z(oVar, "channelTracer");
        f.b.a.c.b.o.b.z(d0Var, "logId");
        this.a = d0Var;
        f.b.a.c.b.o.b.z(eVar2, "channelLogger");
        this.f4105j = eVar2;
    }
    ...
    public static void i(z0 z0Var) {
        ...
        z zVar;
        z0Var.f4106k.d();
        f.b.a.c.b.o.b.F(z0Var.p == null, "Should have no reconnectTask scheduled");
        f fVar = z0Var.f4107l;
        ...
        SocketAddress a2 = z0Var.f4107l.a();
        if (a2 instanceof z) {
            zVar = (z) a2;
        ...
        f fVar2 = z0Var.f4107l;
        h.a.a aVar = fVar2.a.get(fVar2.b).b;
        String str = (String) aVar.a.get(h.a.v.f4305d);
        x.a aVar2 = new x.a();
        if (str == null) {
            str = z0Var.b;
        }
        ...
        aVar2.a = str;
        f.b.a.c.b.o.b.z(aVar, "eagAttributes");
        aVar2.b = aVar;
        aVar2.c = z0Var.c;
        aVar2.f4092d = zVar;
        h hVar = new h();
        hVar.a = z0Var.a;
        d dVar = new d(z0Var.f4101f.f(socketAddress, aVar2, hVar), z0Var.f4104i, null);
        hVar.a = dVar.c();
        a0.a(z0Var.f4103h.c, dVar);
        z0Var.s = dVar;
        z0Var.q.add(dVar);
        Runnable e2 = dVar.b().e(new g(dVar, socketAddress));
        if (e2 != null) {
            Queue<Runnable> queue = z0Var.f4106k.c;
            f.b.a.c.b.o.b.z(e2, "runnable is null");
            queue.add(e2);
        }
        z0Var.f4105j.b(e.a.INFO, "Started transport {0}", hVar.a);
    }
    ...
    public final void j(o oVar) {
        ...
        if (this.u.a != oVar.a) {
            ...
            f.b.a.c.b.o.b.F(z2, "Cannot transition out of SHUTDOWN to " + oVar);
            this.u = oVar;
            t1 t1Var = (t1) this.f4100e;
            m1 m1Var = m1.this;
            Logger logger = m1.c0;
            ...
            f.b.a.c.b.o.b.F(z, "listener is null");
            t1Var.a.a(oVar);
        }
    }
