...
public class g implements z, b.a {
    ...
    public final Random f4151d = new Random();

    /* renamed from: e  reason: collision with root package name */
    public final u<s> f4152e;
    ...
    public class a extends x0<f> {
        ...
        @Override // h.a.j1.x0
        public void a() {
            g.this.f4154g.c(true);
        }

        @Override // h.a.j1.x0
        public void b() {
            g.this.f4154g.c(false);
        }
    }
    ...
    public class c implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ i f4160d;
            ...
            try {
                ...
                if (zVar == null) {
                    ...
                    if (socketAddress instanceof InetSocketAddress) {
                        h2 = g.h(gVar2, zVar.c, (InetSocketAddress) socketAddress, zVar.f4307d, zVar.f4308e);
                    } else {
                        c1 c1Var = c1.m;
                ...
                try {
                    ...
                    b2.b(y.c, sSLSession);
                    b2.b(p0.f4027d, sSLSession == null ? z0.NONE : z0.PRIVACY_AND_INTEGRITY);
                    gVar4.s = b2.a();
                    g gVar5 = g.this;
                    gVar5.r = new e(gVar5, ((f) this.f4160d).e(nVar2, true));
                    synchronized (g.this.f4157j) {
                        g gVar6 = g.this;
                    ...
                    gVar = g.this;
                    eVar = new e(gVar, ((f) this.f4160d).e(nVar, true));
                    gVar.r = eVar;
                } catch (Exception e5) {
                    e3 = e5;
                    nVar = nVar2;
                    try {
                        ...
                        nVar2 = nVar;
                        g gVar8 = g.this;
                        gVar8.r = new e(gVar8, ((f) this.f4160d).e(nVar2, true));
                        throw th;
                    }
                } catch (Throwable th3) {
                    th = th3;
                    g gVar82 = g.this;
                    gVar82.r = new e(gVar82, ((f) this.f4160d).e(nVar2, true));
                    throw th;
                }
            } catch (d1 e6) {
                e2 = e6;
    ...
    static {
        ...
        enumMap.put((Object) h.a.k1.p.m.a.CANCEL, (Object) c1.f3833g.g("Cancelled"));
        ...
        enumMap.put((Object) h.a.k1.p.m.a.ENHANCE_YOUR_CALM, (Object) c1.f3838l.g("Enhance your calm"));
        enumMap.put((Object) h.a.k1.p.m.a.INADEQUATE_SECURITY, (Object) c1.f3836j.g("Inadequate security"));
    ...
    public g(InetSocketAddress inetSocketAddress, String str, String str2, h.a.a aVar, Executor executor, SocketFactory socketFactory, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier, h.a.k1.p.b bVar, int i2, int i3, h.a.z zVar, Runnable runnable, int i4, c3 c3Var, boolean z2) {
        ...
        this.L = i4;
        this.N = c3Var;
        this.f4158k = d0.a(g.class, inetSocketAddress.toString());
        a.b a2 = h.a.a.a();
        a2.b(p0.f4028e, aVar);
        this.s = a2.a();
        this.M = z2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x005c, code lost:
        if (r1.f4083d != false) goto L_0x0065;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x006f, code lost:
        r2 = new h.a.j1.u0(r12, r1.f4085f);
     */
    ...
    public void f(w.a aVar, Executor executor) {
        ...
        synchronized (this.f4157j) {
            boolean z2 = true;
            f.b.a.c.b.o.b.E(this.f4155h != null);
            if (this.w) {
            ...
            if (w0Var != null) {
                ...
                j2 = this.f4151d.nextLong();
                s sVar = this.f4152e.get();
                sVar.c();
            ...
            if (z2) {
                this.f4155h.z(false, (int) (j2 >>> 32), (int) j2);
            }
        }
    }
    ...
    public h.a.j1.u g(o0 o0Var, n0 n0Var, h.a.c cVar) {
        ...
        h.a.a aVar = this.s;
        w2 w2Var2 = w2.c;
        List<j.a> list = cVar.f3826g;
        if (list.isEmpty()) {
            w2Var = w2.c;
        } else {
            h.a.a aVar2 = h.a.a.b;
            h.a.c cVar2 = h.a.c.f3822k;
        ...
        Object obj2 = this.f4157j;
        synchronized (obj2) {
            try {
                obj = obj2;
                try {
                    f fVar = new f(o0Var, n0Var, this.f4155h, this, this.f4156i, this.f4157j, this.p, this.f4153f, this.b, this.c, w2Var, this.N, cVar, this.M);
                    return fVar;
                } catch (Throwable th2) {
                    th = th2;
                    while (true) {
                        ...
                        if (address.length == 16) {
                            ...
                            while (i2 < address.length) {
                                if (i2 == i27) {
                                    ...
                                    if (j2 == 0) {
                                        ...
                                        while (i31 >= i30) {
                                            bArr3[i31] = k.e.f4329d[(int) (j2 & 15)];
                                            j2 >>>= 4;
                                            i31--;
                                            i26 = i26;
                                            i27 = i27;
                            ...
                            if (str4 == null) {
                                ...
                                if (port <= 0 || port > 65535) {
                                    throw new IllegalArgumentException(f.a.a.a.a.t("unexpected port: ", port));
                                }
                                bVar.c = port;
                                if (bVar.a == null) {
                                ...
                                throw new IllegalArgumentException(f.a.a.a.a.w("unexpected host: ", str3));
                            }
                        } else {
                            throw new AssertionError();
                        }
    ...
    public final void r(f fVar) {
        if (this.x && this.C.isEmpty() && this.m.isEmpty()) {
            ...
            if (j1Var != null) {
                synchronized (j1Var) {
                    if (!j1Var.f3949d) {
                        j1.e eVar = j1Var.f3950e;
                        if (eVar == j1.e.PING_SCHEDULED || eVar == j1.e.PING_DELAYED) {
                            j1Var.f3950e = j1.e.IDLE;
                        }
                        if (j1Var.f3950e == j1.e.PING_SENT) {
                            j1Var.f3950e = j1.e.IDLE_AND_PING_SENT;
                        }
                    }
                }
            }
    ...
    public void t() {
        synchronized (this.f4157j) {
            ...
            hVar.b(7, 0, this.f4153f);
            b bVar2 = this.f4155h;
            bVar2.f4131d.f(h.a.OUTBOUND, hVar);
            try {
                bVar2.c.o(hVar);
            } catch (IOException e3) {
                bVar2.b.b(e3);
    ...
    public final void v(int i2, h.a.k1.p.m.a aVar, c1 c1Var) {
        ...
        synchronized (this.f4157j) {
            ...
            if (aVar != null && !this.u) {
                this.u = true;
                this.f4155h.M(0, aVar, new byte[0]);
            }
            Iterator<Map.Entry<Integer, f>> it = this.m.entrySet().iterator();
            while (it.hasNext()) {
                Map.Entry<Integer, f> next = it.next();
    ...
    public final void x(f fVar) {
        f.b.a.c.b.o.b.F(fVar.f4150l == -1, "StreamId already assigned");
        this.m.put(Integer.valueOf(this.f4159l), fVar);
        u(fVar);
        f.b bVar = fVar.m;
        int i2 = this.f4159l;
        if (f.this.f4150l == -1) {
            f.this.f4150l = i2;
            f.b bVar2 = f.this.m;
            f.b.a.c.b.o.b.E(bVar2.f3868j != null);
            synchronized (bVar2.c) {
                f.b.a.c.b.o.b.F(!bVar2.f3905f, "Already allocated");
                bVar2.f3905f = true;
            }
            bVar2.d();
            c3 c3Var = bVar2.f3903d;
            c3Var.b++;
            c3Var.a.a();
            if (bVar.J) {
                b bVar3 = bVar.G;
                f fVar2 = f.this;
                bVar3.B(fVar2.p, false, fVar2.f4150l, 0, bVar.z);
                for (f1 f1Var : f.this.f4147i.a) {
                    Objects.requireNonNull((j) f1Var);
                }
                bVar.z = null;
                if (bVar.A.c > 0) {
                    bVar.H.a(bVar.B, f.this.f4150l, bVar.A, bVar.C);
                }
                bVar.J = false;
            }
            o0.c cVar = fVar.f4145g.a;
        ...
        if (this.t != null && this.m.isEmpty() && this.C.isEmpty() && !this.w) {
            ...
            if (j1Var != null) {
                synchronized (j1Var) {
                    ...
                    if (eVar != eVar2) {
                        j1Var.f3950e = eVar2;
                        ScheduledFuture<?> scheduledFuture = j1Var.f3951f;
                        if (scheduledFuture != null) {
                            scheduledFuture.cancel(false);
                        }
                        ScheduledFuture<?> scheduledFuture2 = j1Var.f3952g;
            ...
            if (!this.u) {
                this.u = true;
                this.f4155h.M(0, h.a.k1.p.m.a.NO_ERROR, new byte[0]);
            }
            this.f4155h.close();
        }
    }
