...
public class h {
    ...
    public h(Level level, Class<?> cls) {
        ...
        f.b.a.c.b.o.b.z(level, "level");
        this.b = level;
        f.b.a.c.b.o.b.z(logger, "logger");
        this.a = logger;
    }
    ...
    public static String h(e eVar) {
        ...
        sb.append((min == 0 ? k.h.f4331f : new q(eVar, min)).e());
        sb.append("...");
        return sb.toString();
    }
    ...
    public void f(a aVar, h.a.k1.p.m.h hVar) {
        if (a()) {
            ...
            for (int i2 = 0; i2 < 6; i2++) {
                b bVar = values[i2];
                if (hVar.a(bVar.b)) {
                    enumMap.put((Enum) bVar, (Object) Integer.valueOf(hVar.f4255d[bVar.b]));
                }
            }
