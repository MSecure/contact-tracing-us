...
public final class f implements i {
        ...
        public long m(e eVar, long j2) {
            ...
            do {
                ...
                if (i3 == 0) {
                    ...
                    this.f4245d = (byte) (this.b.readByte() & 255);
                    Logger logger = f.a;
                    if (logger.isLoggable(Level.FINE)) {
                        logger.fine(b.a(true, this.f4246e, this.c, readByte, this.f4245d));
                    }
    ...
    public static final class c implements b {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final e.a f4249d;

        public c(g gVar, int i2, boolean z) {
            this.b = gVar;
            a aVar = new a(gVar);
            this.c = aVar;
            this.f4249d = new e.a(i2, aVar);
        }
        ...
        public final void J(b.a aVar, int i2, int i3) {
            if (i2 != 4) {
                ...
                if (a != null) {
                    ...
                    synchronized (h.a.k1.g.this.f4157j) {
            ...
            if (i3 != 0) {
                ...
                while (true) {
                    ...
                    if (i4 < i2) {
                        ...
                        synchronized (h.a.k1.g.this.f4157j) {
                            if (hVar.a(4)) {
                                h.a.k1.g.this.B = hVar.f4255d[4];
                            }
                            boolean c2 = hVar.a(7) ? h.a.k1.g.this.f4156i.c(hVar.f4255d[7]) : false;
                            if (eVar.f4162d) {
                                h.a.k1.g.this.f4154g.b();
                                eVar.f4162d = false;
                            }
                            h.a.k1.g.this.f4155h.e(hVar);
                            if (c2) {
                                h.a.k1.g.this.f4156i.f();
                            }
                            h.a.k1.g.this.w();
                        }
                        int i5 = hVar.a & 2;
                        int i6 = -1;
                        if ((i5 != 0 ? hVar.f4255d[1] : -1) >= 0) {
                            e.a aVar2 = this.f4249d;
                            if (i5 != 0) {
                                i6 = hVar.f4255d[1];
                            }
                            aVar2.c = i6;
            ...
            if (i2 == 4) {
                ...
                if (i4 != 0) {
                    ...
                    if (i4 == 0) {
                        ...
                        synchronized (h.a.k1.g.this.f4157j) {
                            if (i3 == 0) {
                                h.a.k1.g.this.f4156i.e(null, (int) readInt);
                                return;
                            }
                            h.a.k1.f fVar = h.a.k1.g.this.m.get(Integer.valueOf(i3));
                            if (fVar != null) {
                                h.a.k1.g.this.f4156i.e(fVar, (int) readInt);
                    ...
                    case 0:
                        ...
                        if (!((readByte2 & 32) != 0)) {
                            ...
                            if (p != null) {
                                ...
                                synchronized (h.a.k1.g.this.f4157j) {
                                    h.a.k1.g.this.f4155h.O(readInt, aVar2);
                                }
                                gVar.skip((long) c2);
                            } else {
                            ...
                            int i2 = gVar2.q + c2;
                            gVar2.q = i2;
                            if (((float) i2) >= ((float) gVar2.f4153f) * 0.5f) {
                                synchronized (gVar2.f4157j) {
                                    h.a.k1.g gVar3 = h.a.k1.g.this;
                                    gVar3.f4155h.s(0, (long) gVar3.q);
                                }
                                h.a.k1.g.this.q = 0;
                            }
                            this.b.skip((long) readByte3);
                        ...
                        if (readInt != 0) {
                            ...
                            synchronized (h.a.k1.g.this.f4157j) {
                                ...
                                if (fVar == null) {
                                    ...
                                    if (!z3) {
                                        h.a.k1.g.this.f4155h.O(readInt, a.CANCEL);
                                    }
        ...
        public final void t(b.a aVar, int i2, byte b2, int i3) {
            ...
            if (i2 != 8) {
                ...
                if (!z) {
                    synchronized (h.a.k1.g.this.f4157j) {
                        h.a.k1.g.this.f4155h.z(true, readInt, readInt2);
                    }
                    return;
                }
                synchronized (h.a.k1.g.this.f4157j) {
        ...
        public final void x(b.a aVar, int i2, byte b2, int i3) {
            ...
            if (i3 != 0) {
                ...
                synchronized (h.a.k1.g.this.f4157j) {
                    h.a.k1.g.this.f4155h.O(i3, a.PROTOCOL_ERROR);
                }
                return;
            }
    ...
    public static final class d implements c {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final k.e f4250d;

        /* renamed from: e  reason: collision with root package name */
        public final e.b f4251e;

        /* renamed from: f  reason: collision with root package name */
        public int f4252f = 16384;
        ...
        public void d(boolean z, int i2, List<d> list) {
            ...
            if (!this.f4253g) {
                ...
                while (true) {
                        ...
                        while (true) {
                            ...
                            if (dVarArr2[i7].a.equals(n)) {
                                if (bVar.c[i7].b.equals(hVar)) {
                                    i4 = e.b.length + (i7 - bVar.f4243e);
                                    break;
                                } else if (i3 == -1) {
                                    i3 = (i7 - bVar.f4243e) + e.b.length;
                                }
                            }
                            i6 = 1;
                        }
                    ...
                    if (i4 != -1) {
                        ...
                        if (i3 == -1) {
                            ...
                            if (!n.h(0, hVar2, 0, hVar2.l()) || d.f4236h.equals(n)) {
                                bVar.c(i3, 63, 64);
                            } else {
                                bVar.c(i3, 15, 0);
                                bVar.b(hVar);
                ...
                long j2 = this.f4250d.c;
                int min = (int) Math.min((long) this.f4252f, j2);
                long j3 = (long) min;
                ...
                c(i2, min, (byte) 1, b2);
                this.b.h(this.f4250d, j3);
                if (i8 > 0) {
                    long j4 = j2 - j3;
                    while (j4 > 0) {
                        int min2 = (int) Math.min((long) this.f4252f, j4);
                        long j5 = (long) min2;
                        j4 -= j5;
                        c(i2, min2, (byte) 9, j4 == 0 ? (byte) 4 : 0);
                        this.b.h(this.f4250d, j5);
                    }
                    return;
                }
                return;
