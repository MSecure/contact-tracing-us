...
public final class r implements Comparable<r> {
    ...
    public static final long f4298g;

    /* renamed from: h  reason: collision with root package name */
    public static final long f4299h = TimeUnit.SECONDS.toNanos(1);
    public final c b;
    public final long c;
    ...
    public r(c cVar, long j2, boolean z) {
        ...
        this.b = cVar;
        long min = Math.min(f4297f, Math.max(f4298g, j2));
        this.c = nanoTime + min;
        this.f4300d = z && min <= 0;
    }
    ...
    public long e(TimeUnit timeUnit) {
        Objects.requireNonNull((b) this.b);
        long nanoTime = System.nanoTime();
        if (!this.f4300d && this.c - nanoTime <= 0) {
            this.f4300d = true;
        }
