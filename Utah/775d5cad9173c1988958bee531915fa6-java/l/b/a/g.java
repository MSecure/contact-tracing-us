...
public final class g extends c<f> implements d, f, Serializable {
    ...
    public static final g f4361d = F(f.f4357e, h.f4363f);

    /* renamed from: e  reason: collision with root package name */
    public static final g f4362e = F(f.f4358f, h.f4364g);
    public final f b;
    public final h c;
    ...
    public void Q(DataOutput dataOutput) {
        ...
        dataOutput.writeByte(fVar.f4360d);
        this.c.J(dataOutput);
    }
    ...
    public <R> R c(l<R> lVar) {
        return lVar == k.f4524f ? (R) this.b : (R) super.c(lVar);
    }
