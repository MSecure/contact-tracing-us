...
public abstract class f<D extends b> extends l.b.a.w.b implements d, Comparable<f<?>> {
    ...
    public <R> R c(l<R> lVar) {
        return (lVar == k.a || lVar == k.f4522d) ? (R) s() : lVar == k.b ? (R) x().s() : lVar == k.c ? (R) l.b.a.x.b.NANOS : lVar == k.f4523e ? (R) r() : lVar == k.f4524f ? (R) l.b.a.f.R(x().x()) : lVar == k.f4525g ? (R) z() : (R) super.c(lVar);
    }
    ...
    public String toString() {
        String str = y().toString() + r().f4389d;
        if (r() == s()) {
            return str;
        }
    ...
    public e w() {
        return e.B(v(), (long) ((t) this).b.c.f4368e);
    }
