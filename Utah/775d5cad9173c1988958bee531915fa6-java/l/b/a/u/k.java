...
public final class k extends a<k> implements Serializable {
    ...
    public static final Integer[] B = new Integer[f4399j.length];
    public static final Integer[] C = new Integer[f4400k.length];
    public static final Integer[] D = new Integer[f4401l.length];
    public static final Integer[] E = new Integer[p.length];

    /* renamed from: i  reason: collision with root package name */
    public static final int[] f4398i;

    /* renamed from: j  reason: collision with root package name */
    public static final int[] f4399j = {0, 30, 59, 89, 118, 148, 177, 207, 236, 266, 295, 325};

    /* renamed from: k  reason: collision with root package name */
    public static final int[] f4400k = {30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 29};

    /* renamed from: l  reason: collision with root package name */
    public static final int[] f4401l = {30, 29, 30, 29, 30, 29, 30, 29, 30, 29, 30, 30};
    ...
    public final transient int f4402d;

    /* renamed from: e  reason: collision with root package name */
    public final transient int f4403e;

    /* renamed from: f  reason: collision with root package name */
    public final transient int f4404f;

    /* renamed from: g  reason: collision with root package name */
    public final transient c f4405g;
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                if (parseInt2 == -1 || parseInt3 == -1 || parseInt4 == -1 || parseInt5 == -1) {
                                                    throw new ParseException(a.u("Unknown error at line ", i2, "."), i2);
                                                } else if (parseInt2 < 1) {
                                                    ...
                                                    if (numArr == null) {
                                                        if (!M) {
                                                            numArr = new Integer[f4398i.length];
                                                            int i4 = 0;
                                                            while (true) {
                                                                int[] iArr = f4398i;
                                                                if (i4 >= iArr.length) {
                                                            ...
                                                            numArr = new Integer[f4399j.length];
                                                            int i5 = 0;
                                                            while (true) {
                                                                int[] iArr2 = f4399j;
                                                                if (i5 >= iArr2.length) {
                                                    ...
                                                    if (numArr3 == null) {
                                                        if (!M) {
                                                            numArr3 = new Integer[f4400k.length];
                                                            int i7 = 0;
                                                            while (true) {
                                                                int[] iArr3 = f4400k;
                                                                if (i7 >= iArr3.length) {
                                                            ...
                                                            numArr3 = new Integer[f4401l.length];
                                                            int i8 = 0;
                                                            while (true) {
                                                                int[] iArr4 = f4401l;
                                                                if (i8 >= iArr4.length) {
                                                    ...
                                                    if (numArr9 == null) {
                                                        if (!M2) {
                                                            numArr9 = new Integer[f4398i.length];
                                                            int i21 = 0;
                                                            while (true) {
                                                                int[] iArr5 = f4398i;
                                                                if (i21 >= iArr5.length) {
                                                            ...
                                                            numArr9 = new Integer[f4399j.length];
                                                            int i22 = 0;
                                                            while (true) {
                                                                int[] iArr6 = f4399j;
                                                                if (i22 >= iArr6.length) {
                                                    ...
                                                    if (numArr11 == null) {
                                                        if (!M2) {
                                                            numArr11 = new Integer[f4400k.length];
                                                            int i24 = 0;
                                                            while (true) {
                                                                int[] iArr7 = f4400k;
                                                                if (i24 >= iArr7.length) {
                                                            ...
                                                            numArr11 = new Integer[f4401l.length];
                                                            int i25 = 0;
                                                            while (true) {
                                                                int[] iArr8 = f4401l;
                                                                if (i25 >= iArr8.length) {
                                                ...
                                                throw new ParseException(a.u("End month is not properly set at line ", i3, "."), i3);
                                            }
                                        } catch (NumberFormatException unused2) {
                                            throw new ParseException(a.u("End year is not properly set at line ", i3, "."), i3);
                                        }
                                    } else {
                                        throw new ParseException(a.u("End year/month has incorrect format at line ", i3, "."), i3);
                                    }
                                } catch (NumberFormatException unused3) {
                                    throw new ParseException(a.u("Start month is not properly set at line ", i3, "."), i3);
                                }
                            } catch (NumberFormatException unused4) {
                                throw new ParseException(a.u("Start year is not properly set at line ", i3, "."), i3);
                            }
                        } else {
                            throw new ParseException(a.u("Start year/month has incorrect format at line ", i3, "."), i3);
                        }
                    } else {
                        throw new ParseException(a.u("Start and end year/month has incorrect format at line ", i3, "."), i3);
                    }
                } catch (NumberFormatException unused5) {
                    throw new ParseException(a.u("Offset is not properly set at line ", i3, "."), i3);
                }
            } else {
                throw new ParseException(a.u("Offset has incorrect format at line ", i3, "."), i3);
            }
        }
    }
    ...
    public a<k> C(long j2) {
        ...
        return O(this.b, d.v(this.c, i3), i4 + 1, this.f4403e);
    }
    ...
    public a<k> D(long j2) {
        ...
        return O(this.b, d.v(this.c, (int) j2), this.f4402d, this.f4403e);
    }
    ...
    public k z(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            ...
            case 23:
                return S(this.c, i2, this.f4403e);
            case 24:
            default:
            ...
            case 25:
                ...
                return S(i2, this.f4402d, this.f4403e);
            case 26:
                return S(i2, this.f4402d, this.f4403e);
            case 27:
                return S(1 - this.c, this.f4402d, this.f4403e);
        }
    }
    ...
    public l.b.a.x.d e(f fVar) {
        return (k) j.f4394d.e(fVar.n(this));
    }
    ...
    @Override // l.b.a.u.b
    public b w(i iVar) {
        return (k) j.f4394d.e(((l.b.a.m) iVar).b(this));
    }

    @Override // l.b.a.u.b
    public long x() {
        return J(this.c, this.f4402d, this.f4403e);
    }
