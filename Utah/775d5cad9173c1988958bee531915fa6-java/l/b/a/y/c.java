...
public final class c extends i {
    ...
    public final ConcurrentNavigableMap<String, a> f4546d = new ConcurrentSkipListMap();
    ...
    public f b(String str, boolean z) {
        f fVar;
        d.u(str, "zoneId");
        a value = this.f4546d.lastEntry().getValue();
        ...
        throw new g(f.a.a.a.a.w("Unknown time-zone ID: ", str));
    }
    ...
    public final boolean e(InputStream inputStream) {
        ...
        if (dataInputStream.readByte() != 1) {
            ...
            while (it.hasNext()) {
                a aVar = (a) it.next();
                a putIfAbsent = this.f4546d.putIfAbsent(aVar.a, aVar);
