...
public class ListMenuItemView extends LinearLayout implements n.a, AbsListView.SelectionBoundsAdjuster {
    ...
    public TextView f38g;

    /* renamed from: h  reason: collision with root package name */
    public ImageView f39h;

    /* renamed from: i  reason: collision with root package name */
    public ImageView f40i;

    /* renamed from: j  reason: collision with root package name */
    public LinearLayout f41j;
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet) {
        ...
        this.f42k = q2.g(R$styleable.MenuView_android_itemBackground);
        this.f43l = q2.l(R$styleable.MenuView_android_itemTextAppearance, -1);
    ...
    public final void a() {
        ...
        this.f37f = checkBox;
        LinearLayout linearLayout = this.f41j;
    ...
    public void adjustListItemSelectionBounds(Rect rect) {
        ...
        if (imageView != null && imageView.getVisibility() == 0) {
            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) this.f40i.getLayoutParams();
            rect.top = this.f40i.getHeight() + layoutParams.topMargin + layoutParams.bottomMargin + rect.top;
        }
    }

    public final void b() {
        RadioButton radioButton = (RadioButton) getInflater().inflate(R$layout.abc_list_menu_item_radio, (ViewGroup) this, false);
        this.f35d = radioButton;
        LinearLayout linearLayout = this.f41j;
        if (linearLayout != null) {
    ...
    public void c(boolean z) {
        ...
        if (i3 == 0) {
            ...
            if (e2 == 0) {
                ...
                int i4 = iVar.n.n() ? iVar.f803k : iVar.f801i;
        ...
        if (this.f38g.getVisibility() != i3) {
            this.f38g.setVisibility(i3);
        }
    }
    ...
    public void onFinishInflate() {
        ...
        this.f38g = (TextView) findViewById(R$id.shortcut);
        ImageView imageView = (ImageView) findViewById(R$id.submenuarrow);
        this.f39h = imageView;
        if (imageView != null) {
            imageView.setImageDrawable(this.o);
        }
        this.f40i = (ImageView) findViewById(R$id.group_divider);
        this.f41j = (LinearLayout) findViewById(R$id.content);
    }
    ...
    public void setCheckable(boolean z) {
        ...
        if (z || this.f35d != null || this.f37f != null) {
            if (this.b.h()) {
                if (this.f35d == null) {
                    b();
                }
                compoundButton2 = this.f35d;
                compoundButton = this.f37f;
            } else {
                if (this.f37f == null) {
                    a();
                }
                compoundButton2 = this.f37f;
                compoundButton = this.f35d;
            }
            if (z) {
            ...
            CheckBox checkBox = this.f37f;
            if (checkBox != null) {
                checkBox.setVisibility(8);
            }
            RadioButton radioButton = this.f35d;
            if (radioButton != null) {
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        if (charSequence != null) {
            this.f36e.setText(charSequence);
            if (this.f36e.getVisibility() != 0) {
                textView = this.f36e;
                i2 = 0;
            } else {
                return;
