...
public class ConstraintLayout extends ViewGroup {
    ...
    public int f102g = Integer.MAX_VALUE;

    /* renamed from: h  reason: collision with root package name */
    public int f103h = Integer.MAX_VALUE;

    /* renamed from: i  reason: collision with root package name */
    public boolean f104i = true;

    /* renamed from: j  reason: collision with root package name */
    public int f105j = 257;
            ...
            for (int i3 = 0; i3 < indexCount; i3++) {
                ...
                switch (i4) {
                    ...
                    case 7:
                        ...
                        continue;
                    case 8:
                        int resourceId2 = obtainStyledAttributes.getResourceId(index, this.f108d);
                        this.f108d = resourceId2;
                        if (resourceId2 == -1) {
                            this.f108d = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 9:
                        int resourceId3 = obtainStyledAttributes.getResourceId(index, this.f109e);
                        this.f109e = resourceId3;
                        if (resourceId3 == -1) {
                            this.f109e = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 10:
                        int resourceId4 = obtainStyledAttributes.getResourceId(index, this.f110f);
                        this.f110f = resourceId4;
                        if (resourceId4 == -1) {
                            this.f110f = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 11:
                        int resourceId5 = obtainStyledAttributes.getResourceId(index, this.f111g);
                        this.f111g = resourceId5;
                        if (resourceId5 == -1) {
                            this.f111g = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 12:
                        int resourceId6 = obtainStyledAttributes.getResourceId(index, this.f112h);
                        this.f112h = resourceId6;
                        if (resourceId6 == -1) {
                            this.f112h = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 13:
                        int resourceId7 = obtainStyledAttributes.getResourceId(index, this.f113i);
                        this.f113i = resourceId7;
                        if (resourceId7 == -1) {
                            this.f113i = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 14:
                        int resourceId8 = obtainStyledAttributes.getResourceId(index, this.f114j);
                        this.f114j = resourceId8;
                        if (resourceId8 == -1) {
                            this.f114j = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 15:
                        int resourceId9 = obtainStyledAttributes.getResourceId(index, this.f115k);
                        this.f115k = resourceId9;
                        if (resourceId9 == -1) {
                            this.f115k = obtainStyledAttributes.getInt(index, -1);
                        } else {
                            continue;
                        }
                    case 16:
    ...
    public class b implements b.AbstractC0028b {
            ...
            if (dVar != null) {
                if (dVar.c0 == 8 && !dVar.z) {
                    ...
                    if (ordinal2 == 0) {
                        ...
                        i12 = ViewGroup.getChildMeasureSpec(this.f119f, i16, -2);
                    } else if (ordinal2 != 2) {
                        if (ordinal2 != 3) {
                            i2 = 0;
                        } else {
                            ...
                            int i18 = cVar != null ? cVar.f1262g + 0 : 0;
                        ...
                        if (ordinal == 0) {
                            if (ordinal == 1) {
                                ...
                                i9 = ViewGroup.getChildMeasureSpec(this.f120g, i15, -2);
                                boolean z = dVar.m == 1;
                                int i19 = aVar.f1291j;
                                if (i19 == 1 || i19 == 2) {
                                    if (aVar.f1291j == 2 || !z || (z && (view.getMeasuredWidth() == dVar.r())) || (view instanceof g) || dVar.A()) {
                                ...
                                i3 = 0;
                                e eVar = (e) dVar.P;
                                if (eVar != null && i.b(ConstraintLayout.this.f105j, 256) && view.getMeasuredWidth() == dVar.r() && view.getMeasuredWidth() < eVar.r() && view.getMeasuredHeight() == dVar.l() && view.getMeasuredHeight() < eVar.l() && view.getBaseline() == dVar.W && !dVar.y()) {
                                ...
                                if (view != null) {
                                    ...
                                    int i20 = aVar.f1291j;
                                    if (i20 == 1 || i20 == 2 || !z2 || dVar.f1281l != 0 || !z3 || dVar.m != 0) {
                                        ...
                                        if (!i.b(ConstraintLayout.this.f105j, 1)) {
                                            if (z6 && z4) {
                                    ...
                                    boolean z8 = i6 != i7;
                                    aVar.f1290i = (i5 == aVar.c && i4 == aVar.f1285d) ? false : true;
                                    if (aVar7.X) {
                                        z8 = true;
                                    }
                                ...
                                i11 = this.f120g;
                                int i25 = dVar.D != null ? dVar.E.f1262g + 0 : 0;
                                if (dVar.F != null) {
                                    i25 += dVar.G.f1262g;
                                }
                                i15 += i25;
                        ...
                        i12 = ViewGroup.getChildMeasureSpec(this.f119f, i16, -2);
                        boolean z9 = dVar.f1281l == 1;
                        int i26 = aVar.f1291j;
                        if (i26 == 1 || i26 == 2) {
                            if (aVar.f1291j == 2 || !z9 || (z9 && (view.getMeasuredHeight() == dVar.l())) || (view instanceof g) || dVar.z()) {
        ...
        if (attributeSet != null) {
            ...
            for (int i4 = 0; i4 < indexCount; i4++) {
                ...
                if (index == R$styleable.ConstraintLayout_Layout_android_minWidth) {
                    this.f100e = obtainStyledAttributes.getDimensionPixelOffset(index, this.f100e);
                } else if (index == R$styleable.ConstraintLayout_Layout_android_minHeight) {
                    this.f101f = obtainStyledAttributes.getDimensionPixelOffset(index, this.f101f);
                } else if (index == R$styleable.ConstraintLayout_Layout_android_maxWidth) {
                    this.f102g = obtainStyledAttributes.getDimensionPixelOffset(index, this.f102g);
                } else if (index == R$styleable.ConstraintLayout_Layout_android_maxHeight) {
                    this.f103h = obtainStyledAttributes.getDimensionPixelOffset(index, this.f103h);
                } else if (index == R$styleable.ConstraintLayout_Layout_layout_optimizationLevel) {
                    this.f105j = obtainStyledAttributes.getInt(index, this.f105j);
                } else if (index == R$styleable.ConstraintLayout_Layout_layoutDescription) {
                    int resourceId = obtainStyledAttributes.getResourceId(index, 0);
                    if (resourceId != 0) {
                        try {
                            this.f107l = new c(getContext(), this, resourceId);
    ...
    public void h(int i2, int i3, int i4, int i5, boolean z, boolean z2) {
        b bVar = this.r;
        int i6 = bVar.f118e;
        int resolveSizeAndState = ViewGroup.resolveSizeAndState(i4 + bVar.f117d, i2, 0);
        int min = Math.min(this.f102g, resolveSizeAndState & 16777215);
        int min2 = Math.min(this.f103h, ViewGroup.resolveSizeAndState(i5 + i6, i3, 0) & 16777215);
        if (z) {
            min |= 16777216;
        }
        if (z2) {
    ...
    public final boolean j() {
        ...
        if (z) {
            ...
            if (this.m != -1) {
                for (int i20 = 0; i20 < childCount2; i20++) {
                    ...
                    if (childAt2.getId() == this.m && (childAt2 instanceof e.g.c.e)) {
                        this.f106k = ((e.g.c.e) childAt2).getConstraintSet();
                    }
                }
            }
            e.g.c.d dVar6 = this.f106k;
            if (dVar6 != null) {
                dVar6.a(this, true);
            }
            this.f99d.l0.clear();
            ...
            if (size > 0) {
                ...
                while (i21 < size) {
                    ...
                    if (bVar.isInEditMode()) {
                        bVar.setIds(bVar.f1343f);
                    }
                    e.g.b.h.g gVar = bVar.f1342e;
                    if (gVar != null) {
                        ...
                        for (int i22 = 0; i22 < bVar.c; i22++) {
                            int i23 = bVar.b[i22];
                            View d2 = d(i23);
                            if (d2 == null && (e2 = bVar.e(this, (str = bVar.f1345h.get(Integer.valueOf(i23))))) != 0) {
                                bVar.b[i22] = e2;
                                bVar.f1345h.put(Integer.valueOf(e2), str);
                                d2 = d(e2);
                            }
                            if (d2 != null) {
                                e.g.b.h.g gVar2 = bVar.f1342e;
                                e.g.b.h.d e4 = e(d2);
            ...
            for (int i26 = 0; i26 < childCount2; i26++) {
                ...
                if (childAt3 instanceof g) {
                    ...
                    if (gVar3.b == -1 && !gVar3.isInEditMode()) {
                        gVar3.setVisibility(gVar3.f1380d);
                    }
            ...
            this.q.clear();
            this.q.put(0, this.f99d);
            this.q.put(getId(), this.f99d);
            ...
            while (i28 < childCount2) {
                ...
                if (e5 == null) {
                    ...
                    if (childAt5 instanceof e.g.c.b) {
                        ((e.g.c.b) childAt5).g(e5, this.f99d.p0);
                    }
                    if (aVar.Y) {
                        f fVar = (f) e5;
                        int i29 = aVar.i0;
                                    ...
                                    if (i7 != -1) {
                                        ...
                                        if (i8 != -1) {
                                            ...
                                            if (i9 != -1) {
                                                ...
                                                e.g.b.h.d dVar13 = sparseArray.get(aVar.f116l);
                        ...
                        if (aVar.V) {
                            ...
                            e5.i(aVar7).f1262g = ((ViewGroup.MarginLayoutParams) aVar).leftMargin;
                            e5.i(aVar6).f1262g = ((ViewGroup.MarginLayoutParams) aVar).rightMargin;
                        } else {
                            e5.O[0] = aVar5;
                            e5.M(0);
                        }
                        if (aVar.W) {
                            ...
                            e5.i(aVar9).f1262g = ((ViewGroup.MarginLayoutParams) aVar).topMargin;
                            e5.i(aVar8).f1262g = ((ViewGroup.MarginLayoutParams) aVar).bottomMargin;
                        } else {
                            e5.O[1] = aVar5;
                            e5.H(0);
                        }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        boolean z9;
        int i15;
        b.AbstractC0028b bVar4;
        e eVar;
        int i16;
        int i17;
        b.AbstractC0028b bVar5;
        c.a aVar7;
        c.a aVar8;
        e.g.b.h.l.b bVar6;
        e.g.b.h.l.k kVar;
        ...
        if (!this.f104i) {
            ...
            if (i25 == i2 && this.t == i3) {
                ...
                eVar2 = this.f99d;
                z6 = eVar2.y0;
            } else if (i25 == i2 && View.MeasureSpec.getMode(i2) == 1073741824 && View.MeasureSpec.getMode(i3) == Integer.MIN_VALUE && View.MeasureSpec.getMode(this.t) == Integer.MIN_VALUE && View.MeasureSpec.getSize(i3) >= this.f99d.l()) {
                this.s = i2;
                this.t = i3;
                r2 = this.f99d.r();
                l2 = this.f99d.l();
        ...
        if (mode != Integer.MIN_VALUE) {
            if (mode != 0) {
                if (mode != 1073741824) {
                    ...
                    i4 = Math.min(this.f102g - i31, i28);
                    aVar = aVar9;
                    if (mode2 == Integer.MIN_VALUE) {
                        if (mode2 != 0) {
                            if (mode2 != 1073741824) {
                                ...
                                aVar2 = aVar10;
                                aVar3 = aVar9;
                                i5 = Math.min(this.f103h - i30, i29);
                                aVar4 = aVar3;
                                ...
                                eVar4.V = i7;
                                int[] iArr = eVar4.w;
                                iArr[i7] = this.f102g - i31;
                                iArr[1] = this.f103h - i30;
                                eVar4.K(i7);
                                eVar4.J(i7);
                                eVar4.O[i7] = aVar;
                                eVar4.M(i4);
                                eVar4.O[1] = aVar4;
                                eVar4.H(i5);
                                eVar4.K(this.f100e - i31);
                                eVar4.J(this.f101f - i30);
                                eVar4.r0 = max3;
                                eVar4.s0 = max;
                                ...
                                b.AbstractC0028b bVar10 = eVar4.o0;
                                size = eVar4.l0.size();
                                int r3 = eVar4.r();
                                int l3 = eVar4.l();
                                ...
                                if (z) {
                                    ...
                                    if (!z3) {
                                        ...
                                        if (mode == 1073741824 && mode2 == 1073741824) {
                                            ...
                                            int t2 = eVar5.a.t();
                                            bVar2 = bVar10;
                                            eVar5.a.f1273d.f1325h.c(s2);
                                            eVar5.a.f1274e.f1325h.c(t2);
                                            eVar5.g();
                                            if (k2 == aVar2 || k3 == aVar2) {
                                                boolean z14 = z13;
                                                if (z13) {
                                                    Iterator<o> it2 = eVar5.f1295e.iterator();
                                                    while (true) {
                                                        if (it2.hasNext()) {
                                                            if (!it2.next().k()) {
                                                                z14 = false;
                                                ...
                                                if (z14 && k3 == aVar2) {
                                                    ...
                                                    e eVar11 = eVar5.a;
                                                    eVar11.f1274e.f1322e.c(eVar11.l());
                                                }
                                            } else {
                                                i10 = r3;
                                                i9 = l3;
                                            ...
                                            if (aVarArr[0] == aVar3 || aVarArr[0] == aVar14) {
                                                int r4 = eVar12.r() + s2;
                                                eVar5.a.f1273d.f1326i.c(r4);
                                                eVar5.a.f1273d.f1322e.c(r4 - s2);
                                                eVar5.g();
                                                e eVar13 = eVar5.a;
                                                d.a[] aVarArr2 = eVar13.O;
                                                if (aVarArr2[1] == aVar3 || aVarArr2[1] == aVar14) {
                                                    int l4 = eVar13.l() + t2;
                                                    eVar5.a.f1274e.f1326i.c(l4);
                                                    eVar5.a.f1274e.f1322e.c(l4 - t2);
                                                }
                                                eVar5.g();
                                                z10 = true;
                                            } else {
                                            ...
                                            Iterator<o> it3 = eVar5.f1295e.iterator();
                                            while (it3.hasNext()) {
                                                o next2 = it3.next();
                                                if (next2.b != eVar5.a || next2.f1324g) {
                                                    next2.e();
                                                }
                                            }
                                            Iterator<o> it4 = eVar5.f1295e.iterator();
                                            while (true) {
                                                if (!it4.hasNext()) {
                                                    z11 = true;
                                                    break;
                                                ...
                                                o next3 = it4.next();
                                                if ((z10 || next3.b != eVar5.a) && (!next3.f1325h.f1305j || ((!next3.f1326i.f1305j && !(next3 instanceof e.g.b.h.l.i)) || (!next3.f1322e.f1305j && !(next3 instanceof e.g.b.h.l.c) && !(next3 instanceof e.g.b.h.l.i))))) {
                                                    z11 = false;
                                                }
                                            }
                                            z11 = false;
                                            ...
                                            if (eVar14.b) {
                                                ...
                                                while (it5.hasNext()) {
                                                    ...
                                                    next4.h();
                                                    next4.a = false;
                                                    e.g.b.h.l.k kVar2 = next4.f1273d;
                                                    kVar2.f1322e.f1305j = false;
                                                    kVar2.f1324g = false;
                                                    kVar2.n();
                                                    m mVar2 = next4.f1274e;
                                                    mVar2.f1322e.f1305j = false;
                                                    mVar2.f1324g = false;
                                                    mVar2.m();
                                                }
                                                i19 = 0;
                                                ...
                                                e eVar15 = eVar14.a;
                                                eVar15.a = false;
                                                e.g.b.h.l.k kVar3 = eVar15.f1273d;
                                                kVar3.f1322e.f1305j = false;
                                                kVar3.f1324g = false;
                                                kVar3.n();
                                                m mVar3 = eVar14.a.f1274e;
                                                mVar3.f1322e.f1305j = false;
                                                mVar3.f1324g = false;
                                                mVar3.m();
                                                eVar14.c();
                                            } else {
                                            ...
                                            eVar14.b(eVar14.f1294d);
                                            e eVar16 = eVar14.a;
                                            eVar16.U = i19;
                                            eVar16.V = i19;
                                            eVar16.f1273d.f1325h.c(i19);
                                            eVar14.a.f1274e.f1325h.c(i19);
                                            i18 = 1073741824;
                                            if (mode == 1073741824) {
                                                i20 = 1;
                                    ...
                                    if (!z5 || i11 != 2) {
                                        ...
                                        if (size <= 0) {
                                            ...
                                            b.AbstractC0028b bVar11 = eVar4.o0;
                                            int i34 = 0;
                                            while (i34 < size5) {
                                                e.g.b.h.d dVar2 = eVar4.l0.get(i34);
                                                if (!(dVar2 instanceof f) && !(dVar2 instanceof e.g.b.h.a) && !dVar2.A && (!Y || (kVar = dVar2.f1273d) == null || (mVar = dVar2.f1274e) == null || !kVar.f1322e.f1305j || !mVar.f1322e.f1305j)) {
                                                    d.a k4 = dVar2.k(0);
                                                    d.a k5 = dVar2.k(1);
                                                    boolean z15 = k4 == aVar13 && dVar2.f1281l != 1 && k5 == aVar13 && dVar2.m != 1;
                                                    if (!z15 && eVar4.Y(1) && !(dVar2 instanceof j)) {
                                                        if (k4 == aVar13 && dVar2.f1281l == 0 && k5 != aVar13 && !dVar2.w()) {
                                                            z15 = true;
                                                        }
                                            ...
                                            while (true) {
                                                ...
                                                while (i40 < size2) {
                                                    ...
                                                    if ((!(dVar4 instanceof e.g.b.h.g) || (dVar4 instanceof j)) && !(dVar4 instanceof f)) {
                                                        i16 = size2;
                                                        if (dVar4.c0 != 8 && ((!z4 || !dVar4.f1273d.f1322e.f1305j || !dVar4.f1274e.f1322e.f1305j) && !(dVar4 instanceof j))) {
                                                            int r7 = dVar4.r();
                                                            int l7 = dVar4.l();
                                                            eVar = eVar4;
                                                            int i41 = dVar4.W;
                        ...
                        eVar4.V = i7;
                        int[] iArr2 = eVar4.w;
                        iArr2[i7] = this.f102g - i31;
                        iArr2[1] = this.f103h - i30;
                        eVar4.K(i7);
                        eVar4.J(i7);
                        eVar4.O[i7] = aVar;
                        eVar4.M(i4);
                        ...
                        b.AbstractC0028b bVar102 = eVar4.o0;
                        size = eVar4.l0.size();
                        int r32 = eVar4.r();
                        int l32 = eVar4.l();
                        ...
                        eVar4.V = i7;
                        int[] iArr22 = eVar4.w;
                        iArr22[i7] = this.f102g - i31;
                        iArr22[1] = this.f103h - i30;
                        eVar4.K(i7);
                        eVar4.J(i7);
                        eVar4.O[i7] = aVar;
                        eVar4.M(i4);
                        ...
                        b.AbstractC0028b bVar1022 = eVar4.o0;
                        size = eVar4.l0.size();
                        int r322 = eVar4.r();
                        int l322 = eVar4.l();
                    ...
                    eVar4.V = i7;
                    int[] iArr222 = eVar4.w;
                    iArr222[i7] = this.f102g - i31;
                    iArr222[1] = this.f103h - i30;
                    eVar4.K(i7);
                    eVar4.J(i7);
                    eVar4.O[i7] = aVar;
                    eVar4.M(i4);
                    ...
                    b.AbstractC0028b bVar10222 = eVar4.o0;
                    size = eVar4.l0.size();
                    int r3222 = eVar4.r();
                    int l3222 = eVar4.l();
            ...
            iArr2222[i7] = this.f102g - i31;
            iArr2222[1] = this.f103h - i30;
            eVar4.K(i7);
            eVar4.J(i7);
            eVar4.O[i7] = aVar;
            eVar4.M(i4);
            ...
            b.AbstractC0028b bVar102222 = eVar4.o0;
            size = eVar4.l0.size();
            int r32222 = eVar4.r();
            int l32222 = eVar4.l();
            ...
            iArr22222[i7] = this.f102g - i31;
            iArr22222[1] = this.f103h - i30;
            eVar4.K(i7);
            eVar4.J(i7);
            eVar4.O[i7] = aVar;
            eVar4.M(i4);
            ...
            b.AbstractC0028b bVar1022222 = eVar4.o0;
            size = eVar4.l0.size();
            int r322222 = eVar4.r();
            int l322222 = eVar4.l();
        ...
        iArr222222[i7] = this.f102g - i31;
        iArr222222[1] = this.f103h - i30;
        eVar4.K(i7);
        eVar4.J(i7);
        eVar4.O[i7] = aVar;
        eVar4.M(i4);
        ...
        b.AbstractC0028b bVar10222222 = eVar4.o0;
        size = eVar4.l0.size();
