...
public class RecyclerView extends ViewGroup implements e.i.i.e {
    ...
    public final class t {
        ...
        public void a(b0 b0Var, boolean z) {
            ...
            if (uVar != null) {
                u.a aVar = uVar.f1824e;
                e.i.i.l.r(view, aVar instanceof u.a ? aVar.f1826e.remove(view) : null);
            }
            if (z) {
                    ...
                    if (i6 == 0 && i8 == 0) {
                        ...
                        if (a3 != null) {
                            ...
                            if (!(f3 == 0.0f && a3.y == 0.0f)) {
                                ...
                                aVar.b((int) (((float) lVar.o) * 1.2f), (int) (((float) lVar.p) * 1.2f), (int) (((float) lVar.h(10000)) * 1.2f), lVar.f1815i);
                            }
                        }
                        aVar.f247d = lVar.a;
                        lVar.d();
    ...
    public void onAttachedToWindow() {
        ...
        this.o0 = false;
        if (C0) {
            ThreadLocal<e.s.a.j> threadLocal = e.s.a.j.f1802f;
            ...
            if (yVar2.f251d == 1) {
                ...
                if (!(!aVar.c.isEmpty() && !aVar.b.isEmpty()) && this.n.p == getWidth() && this.n.q == getHeight()) {
                    ...
                    if (yVar.f257j) {
                        ...
                        y.b bVar = this.y0;
                        for (int i5 = yVar3.a.f1198d - 1; i5 >= 0; i5--) {
                            b0 h2 = yVar3.a.h(i5);
                            y.a i6 = yVar3.a.i(i5);
                            int i7 = i6.a;
                            if ((i7 & 3) != 3) {
    ...
    public void setNestedScrollingEnabled(boolean z2) {
        ...
        scrollingChildHelper.f1464d = z2;
    }
