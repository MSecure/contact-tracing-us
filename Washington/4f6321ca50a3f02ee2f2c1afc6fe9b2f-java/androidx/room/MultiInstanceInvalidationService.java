...
public class MultiInstanceInvalidationService extends Service {
    ...
    public final RemoteCallbackList<c> f278d = new a();

    /* renamed from: e  reason: collision with root package name */
    public final d f279e = new b();
    ...
    public class b extends d {
        ...
        public void C(c cVar, int i2) {
            synchronized (MultiInstanceInvalidationService.this.f278d) {
                MultiInstanceInvalidationService.this.f278d.unregister(cVar);
        ...
        public void l(int i2, String[] strArr) {
            synchronized (MultiInstanceInvalidationService.this.f278d) {
                ...
                int beginBroadcast = MultiInstanceInvalidationService.this.f278d.beginBroadcast();
                for (int i3 = 0; i3 < beginBroadcast; i3++) {
                    try {
                        int intValue = ((Integer) MultiInstanceInvalidationService.this.f278d.getBroadcastCookie(i3)).intValue();
                        String str2 = MultiInstanceInvalidationService.this.c.get(Integer.valueOf(intValue));
                        if (i2 != intValue && str.equals(str2)) {
                            try {
                                MultiInstanceInvalidationService.this.f278d.getBroadcastItem(i3).t(strArr);
                            } catch (RemoteException e2) {
                                Log.w("ROOM", "Error invoking a remote callback", e2);
                            }
                        }
                    } catch (Throwable th) {
                        MultiInstanceInvalidationService.this.f278d.finishBroadcast();
                        throw th;
                    }
                }
                MultiInstanceInvalidationService.this.f278d.finishBroadcast();
        ...
        public int n(c cVar, String str) {
            ...
            synchronized (MultiInstanceInvalidationService.this.f278d) {
                ...
                if (multiInstanceInvalidationService.f278d.register(cVar, Integer.valueOf(i2))) {
