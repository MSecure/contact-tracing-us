...
public abstract class BasePendingResult<R extends i> extends f<R> {
    ...
    public final ArrayList<f.a> f414d = new ArrayList<>();

    /* renamed from: e  reason: collision with root package name */
    public final AtomicReference<Object> f415e = new AtomicReference<>();
    ...
    public static class a<R extends i> extends d {
        ...
        public void handleMessage(@RecentlyNonNull Message message) {
            ...
            if (i2 == 1) {
                ...
                ((BasePendingResult) message.obj).b(Status.f409h);
            }
        }
    }
    ...
    public final class b {
        ...
        public final void finalize() {
            BasePendingResult.e(BasePendingResult.this.f416f);
            super.finalize();
        }
    }
    ...
    public final void f(R r) {
        this.f416f = r;
        this.f417g = r.getStatus();
        this.c.countDown();
        if (this.f416f instanceof g) {
            this.mResultGuardian = new b(null);
        }
        ArrayList<f.a> arrayList = this.f414d;
