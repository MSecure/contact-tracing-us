...
public class HideBottomViewOnScrollBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    public ViewPropertyAnimator f454d;
    ...
    public class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            HideBottomViewOnScrollBehavior.this.f454d = null;
        }
    }
    ...
    public final void B(V v, int i2, long j2, TimeInterpolator timeInterpolator) {
        this.f454d = v.animate().translationY((float) i2).setInterpolator(timeInterpolator).setDuration(j2).setListener(new a());
    }
    ...
    public void r(CoordinatorLayout coordinatorLayout, V v, View view, int i2, int i3, int i4, int i5, int i6, int[] iArr) {
        if (i3 > 0) {
            if (this.b != 1) {
                ViewPropertyAnimator viewPropertyAnimator = this.f454d;
            ...
            ViewPropertyAnimator viewPropertyAnimator2 = this.f454d;
            if (viewPropertyAnimator2 != null) {
                viewPropertyAnimator2.cancel();
                v.clearAnimation();
            }
            this.b = 2;
            B(v, 0, 225, f.b.a.d.a.a.f2553d);
        }
    }
