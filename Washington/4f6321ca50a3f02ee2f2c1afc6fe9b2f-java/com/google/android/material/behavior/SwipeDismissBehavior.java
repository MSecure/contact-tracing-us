...
public class SwipeDismissBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    public float f456e = 0.5f;

    /* renamed from: f  reason: collision with root package name */
    public float f457f = 0.0f;

    /* renamed from: g  reason: collision with root package name */
    public float f458g = 0.5f;

    /* renamed from: h  reason: collision with root package name */
    public final e.c f459h = new a();
    ...
    public class a extends e.c {
        ...
        public int a(View view, int i2, int i3) {
            ...
            int i6 = SwipeDismissBehavior.this.f455d;
            if (i6 != 0) {
                if (i6 != 1) {
        ...
        public void g(View view, int i2, int i3, int i4, int i5) {
            float width = (((float) view.getWidth()) * SwipeDismissBehavior.this.f457f) + ((float) this.a);
            float width2 = (((float) view.getWidth()) * SwipeDismissBehavior.this.f458g) + ((float) this.a);
            float f2 = (float) i2;
            if (f2 <= width) {
                view.setAlpha(1.0f);
            } else if (f2 >= width2) {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x0056, code lost:
            if (java.lang.Math.abs(r8.getLeft() - r7.a) >= java.lang.Math.round(((float) r8.getWidth()) * r7.c.f456e)) goto L_0x002c;
         */
        ...
        public void h(View view, float f2, float f3) {
            ...
            if (i3 != 0) {
                ...
                int i4 = SwipeDismissBehavior.this.f455d;
                if (i4 != 2) {
                    if (i4 == 0) {
                        z = false;
                        if (z) {
    ...
    public boolean j(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        if (this.a == null) {
            this.a = new e(coordinatorLayout.getContext(), coordinatorLayout, this.f459h);
        }
    ...
    public boolean k(CoordinatorLayout coordinatorLayout, V v, int i2) {
        ...
        if (v.getImportantForAccessibility() == 0) {
            ...
            l.k(v, 0);
            if (B(v)) {
                l.p(v, b.a.f1489j, null, new f.b.a.d.d.a(this));
            }
        }
        return false;
    }
