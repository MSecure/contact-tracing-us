...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    public static class d extends e.k.a.a {
        ...
        public d(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f480g = parcel.readInt() == 1;
            this.f481h = parcel.readInt() == 1 ? true : z;
        }

        public d(Parcelable parcelable, BottomSheetBehavior<?> bottomSheetBehavior) {
            super(parcelable);
            this.f477d = bottomSheetBehavior.y;
            this.f478e = bottomSheetBehavior.f467d;
            this.f479f = bottomSheetBehavior.b;
            this.f480g = bottomSheetBehavior.v;
            this.f481h = bottomSheetBehavior.w;
        }
    ...
    public class e implements Runnable {
        ...
        public void run() {
            ...
            if (eVar == null || !eVar.i(true)) {
                BottomSheetBehavior.this.K(this.f482d);
            } else {
                View view = this.b;
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        int i2;
        int i3;
        this.f470g = context.getResources().getDimensionPixelSize(R$dimen.mtrl_min_touch_target_size);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R$styleable.BottomSheetBehavior_Layout);
        this.f471h = obtainStyledAttributes.hasValue(R$styleable.BottomSheetBehavior_Layout_shapeAppearance);
        ...
        this.f474k = obtainStyledAttributes.getBoolean(R$styleable.BottomSheetBehavior_Layout_gestureInsetBottomIgnored, false);
    ...
    public final int C() {
        int i2;
        return this.f468e ? Math.min(Math.max(this.f469f, this.F - ((this.E * 9) / 16)), this.D) : (this.f474k || (i2 = this.f473j) <= 0) ? this.f467d : Math.max(this.f467d, i2 + this.f470g);
    }

    public final void D(Context context, AttributeSet attributeSet, boolean z2, ColorStateList colorStateList) {
        if (this.f471h) {
            this.f475l = j.b(context, attributeSet, R$attr.bottomSheetStyle, Q).a();
            g gVar = new g(this.f475l);
            this.f472i = gVar;
            ...
            if (!z2 || colorStateList == null) {
                ...
                this.f472i.setTint(typedValue.data);
                return;
            }
            this.f472i.q(colorStateList);
        }
    }
    ...
    public void I(int i2) {
        ...
        } else if (this.f468e || this.f467d != i2) {
            this.f468e = false;
            this.f467d = Math.max(0, i2);
            if (z2) {
            }
        }
        z2 = false;
    ...
    public final void Q(int i2) {
        ...
        if (i2 != 2) {
            ...
            if (this.m != z2) {
                this.m = z2;
                if (this.f472i != null && (valueAnimator = this.o) != null) {
    ...
    public boolean k(CoordinatorLayout coordinatorLayout, V v2, int i2) {
        ...
        if (this.G == null) {
            this.f469f = coordinatorLayout.getResources().getDimensionPixelSize(R$dimen.design_bottom_sheet_peek_height_min);
            if (Build.VERSION.SDK_INT >= 29 && !this.f474k && !this.f468e) {
            ...
            if (this.f471h && (gVar = this.f472i) != null) {
