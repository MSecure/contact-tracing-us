...
public class Chip extends g implements b.a, n {
    ...
    public f.b.a.d.j.b f508e;

    /* renamed from: f  reason: collision with root package name */
    public InsetDrawable f509f;

    /* renamed from: g  reason: collision with root package name */
    public RippleDrawable f510g;

    /* renamed from: h  reason: collision with root package name */
    public View.OnClickListener f511h;

    /* renamed from: i  reason: collision with root package name */
    public CompoundButton.OnCheckedChangeListener f512i;
    ...
    public class b extends e.k.b.a {
        ...
        public void o(List<Integer> list) {
            ...
            if (chip.e()) {
                ...
                f.b.a.d.j.b bVar = chip2.f508e;
                if (bVar != null && bVar.M) {
                    z = true;
                }
                if (z && chip2.f511h != null) {
                    list.add(1);
                }
            }
        }
        ...
        public boolean r(int i2, int i3, Bundle bundle) {
            ...
            if (i3 == 16) {
                ...
                if (i2 == 1) {
                    ...
                    View.OnClickListener onClickListener = chip.f511h;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        ...
        bVar2.f2750k = d2.getDimension(R$styleable.Chip_android_textSize, bVar2.f2750k);
    ...
    public boolean d(int i2) {
        ...
        int max = Math.max(0, i2 - ((int) this.f508e.B));
        int max2 = Math.max(0, i2 - this.f508e.getIntrinsicWidth());
        if (max2 > 0 || max > 0) {
            int i3 = max2 > 0 ? max2 / 2 : 0;
            int i4 = max > 0 ? max / 2 : 0;
            if (this.f509f != null) {
                Rect rect = new Rect();
                this.f509f.getPadding(rect);
                if (rect.top == i4) {
                    if (rect.bottom == i4) {
                        if (rect.left == i3) {
                        }
            ...
            this.f509f = new InsetDrawable((Drawable) this.f508e, i3, i4, i3, i4);
    ...
    public boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        if (!z || this.q.f1530l == Integer.MIN_VALUE) {
    ...
    public Drawable getBackgroundDrawable() {
        InsetDrawable insetDrawable = this.f509f;
        return insetDrawable == null ? this.f508e : insetDrawable;
    }
    ...
    public void getFocusedRect(Rect rect) {
        b bVar = this.q;
        if (bVar.f1530l == 1 || bVar.f1529k == 1) {
    ...
    public final void h() {
        ...
        if (e()) {
            f.b.a.d.j.b bVar2 = this.f508e;
            if ((bVar2 != null && bVar2.M) && this.f511h != null) {
                bVar = this.q;
                l.r(this, bVar);
            }
        }
    ...
    public final void i() {
        this.f510g = new RippleDrawable(f.b.a.d.t.a.b(this.f508e.F), getBackgroundDrawable(), null);
        this.f508e.o0(false);
        RippleDrawable rippleDrawable = this.f510g;
    ...
    public final void j() {
        f.b.a.d.j.b bVar;
        if (!TextUtils.isEmpty(getText()) && (bVar = this.f508e) != null) {
    ...
    public void onAttachedToWindow() {
        ...
        f.b.a.c.b.o.b.O1(this, this.f508e);
    }
    ...
    public void setBackground(Drawable drawable) {
        if (drawable == getBackgroundDrawable() || drawable == this.f510g) {
    ...
    public void setChecked(boolean z) {
        ...
        if (bVar == null) {
            ...
            super.setChecked(z);
            if (isChecked != z && (onCheckedChangeListener = this.f512i) != null) {
    ...
    public void setOnCheckedChangeListenerInternal(CompoundButton.OnCheckedChangeListener onCheckedChangeListener) {
        this.f512i = onCheckedChangeListener;
    }
