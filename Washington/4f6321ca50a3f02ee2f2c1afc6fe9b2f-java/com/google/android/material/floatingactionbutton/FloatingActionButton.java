...
public class FloatingActionButton extends q implements f.b.a.d.o.a, n, CoordinatorLayout.b {
    ...
    public PorterDuff.Mode f523d;

    /* renamed from: e  reason: collision with root package name */
    public ColorStateList f524e;

    /* renamed from: f  reason: collision with root package name */
    public PorterDuff.Mode f525f;

    /* renamed from: g  reason: collision with root package name */
    public ColorStateList f526g;
    ...
    public float getCompatHoveredFocusedTranslationZ() {
        return getImpl().f2665e;
    }

    public float getCompatPressedTranslationZ() {
        return getImpl().f2666f;
    }
    ...
    public f.b.a.d.a.g getHideMotionSpec() {
        return getImpl().f2672l;
    }

    @Deprecated
    public int getRippleColor() {
        ColorStateList colorStateList = this.f526g;
    ...
    public void i(a aVar, boolean z) {
        ...
        if (!impl.e()) {
            Animator animator = impl.f2670j;
            if (animator != null) {
                animator.cancel();
            }
            if (impl.q()) {
                f.b.a.d.a.g gVar = impl.f2672l;
                if (gVar == null) {
                    if (impl.f2669i == null) {
                        impl.f2669i = f.b.a.d.a.g.b(impl.s.getContext(), R$animator.design_fab_hide_motion_spec);
                    }
                    gVar = impl.f2669i;
    ...
    public final void l() {
        ...
        if (drawable != null) {
            ColorStateList colorStateList = this.f524e;
            if (colorStateList == null) {
                m.h.t(drawable);
                return;
            }
            int colorForState = colorStateList.getColorForState(getDrawableState(), 0);
            PorterDuff.Mode mode = this.f525f;
            if (mode == null) {
    ...
    public void m(a aVar, boolean z) {
        ...
        if (!impl.f()) {
            ...
            if (impl.q()) {
                ...
                f.b.a.d.a.g gVar = impl.f2671k;
                if (gVar == null) {
                    if (impl.f2668h == null) {
                        impl.f2668h = f.b.a.d.a.g.b(impl.s.getContext(), R$animator.design_fab_show_motion_spec);
                    }
                    gVar = impl.f2668h;
                    Objects.requireNonNull(gVar);
                }
    ...
    public void onMeasure(int i2, int i3) {
        this.f529j = (getSizeDimension() + 0) / 2;
        getImpl().t();
        throw null;
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        Objects.requireNonNull(aVar.f2827d.getOrDefault("expandableWidgetHelper", null));
        throw null;
    }
    ...
    public void setCompatElevation(float f2) {
        ...
        if (impl.f2664d != f2) {
            impl.f2664d = f2;
            impl.j(f2, impl.f2665e, impl.f2666f);
        }
    }
    ...
    public void setCompatHoveredFocusedTranslationZ(float f2) {
        ...
        if (impl.f2665e != f2) {
            impl.f2665e = f2;
            impl.j(impl.f2664d, f2, impl.f2666f);
        }
    }
    ...
    public void setCompatPressedTranslationZ(float f2) {
        ...
        if (impl.f2666f != f2) {
            impl.f2666f = f2;
            impl.j(impl.f2664d, impl.f2665e, f2);
        }
    }
    ...
    public void setRippleColor(ColorStateList colorStateList) {
        if (this.f526g != colorStateList) {
            this.f526g = colorStateList;
            getImpl().o(this.f526g);
        }
    }
    ...
    public void setSupportImageTintList(ColorStateList colorStateList) {
        if (this.f524e != colorStateList) {
            this.f524e = colorStateList;
            l();
        }
    }
