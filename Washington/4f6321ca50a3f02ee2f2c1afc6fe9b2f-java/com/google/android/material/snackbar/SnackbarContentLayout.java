...
public class SnackbarContentLayout extends LinearLayout implements n {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f568d = obtainStyledAttributes.getDimensionPixelSize(R$styleable.SnackbarLayout_android_maxWidth, -1);
        this.f569e = obtainStyledAttributes.getDimensionPixelSize(R$styleable.SnackbarLayout_maxActionInlineWidth, -1);
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f568d > 0 && getMeasuredWidth() > (i4 = this.f568d)) {
        ...
        if (!z2 || this.f569e <= 0 || this.c.getMeasuredWidth() <= this.f569e) {
            if (!z2) {
