...
public class ClockHandView extends View {
    ...
    public final List<c> f625g = new ArrayList();
    ...
    public ClockHandView(Context context, AttributeSet attributeSet) {
        ...
        this.f626h = obtainStyledAttributes.getDimensionPixelSize(R$styleable.ClockHandView_selectorSize, 0);
        Resources resources = getResources();
        this.f630l = resources.getDimensionPixelSize(R$dimen.material_clock_hand_stroke_width);
        this.f627i = (float) resources.getDimensionPixelSize(R$dimen.material_clock_hand_center_dot_radius);
        int K0 = f.b.a.c.b.o.b.K0(this, R$attr.colorPrimary);
        paint.setAntiAlias(true);
        paint.setColor(K0);
        b(0.0f, false);
        this.f624f = ViewConfiguration.get(context).getScaledTouchSlop();
    ...
    public void onDraw(Canvas canvas) {
        ...
        this.f628j.setStrokeWidth(0.0f);
        canvas.drawCircle((((float) this.p) * ((float) Math.cos(this.o))) + f2, (((float) this.p) * ((float) Math.sin(this.o))) + f3, (float) this.f626h, this.f628j);
        double sin = Math.sin(this.o);
        double cos = Math.cos(this.o);
        double d2 = (double) ((float) (this.p - this.f626h));
        this.f628j.setStrokeWidth((float) this.f630l);
        canvas.drawLine(f2, f3, (float) (width + ((int) (cos * d2))), (float) (height + ((int) (d2 * sin))), this.f628j);
        canvas.drawCircle(f2, f3, this.f627i, this.f628j);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1 || actionMasked == 2) {
                int i2 = (int) (x - this.c);
                int i3 = (int) (y - this.f622d);
                this.f623e = (i3 * i3) + (i2 * i2) > this.f624f;
                z2 = this.n;
                if (actionMasked == 1) {
                }
            } else {
