...
public class TimePickerView extends ConstraintLayout {
    ...
    public TimePickerView(Context context, AttributeSet attributeSet) {
        ...
        materialButtonToggleGroup.f496e.add(new d(this));
