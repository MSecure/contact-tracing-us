...
public final class f extends RecyclerView.r {
    ...
    public final LinearLayoutManager f642d;
    ...
    public f(ViewPager2 viewPager2) {
        ...
        this.c = recyclerView;
        this.f642d = (LinearLayoutManager) recyclerView.getLayoutManager();
        e();
    }
    ...
    public void a(RecyclerView recyclerView, int i2) {
        ...
        if (!(i3 == 1 && this.f644f == 1) && i2 == 1) {
            ...
            if (i4 != -1) {
                this.f646h = i4;
                this.f647i = -1;
            } else if (this.f646h == -1) {
                this.f646h = this.f642d.l1();
            }
            d(1);
            return;
        }
        if (!(i3 == 1 || i3 == 4) || i2 != 2) {
            ...
            if (this.f643e == 2 && i2 == 0 && this.f650l) {
                f();
                a aVar2 = this.f645g;
                if (aVar2.c == 0) {
                    int i8 = this.f647i;
    ...
    public void b(RecyclerView recyclerView, int i2, int i3) {
        ...
        if (this.f648j) {
            ...
            i5 = aVar3.a;
            i6 = this.f647i;
            if ((i5 != i6 || i6 == -1) && aVar3.c == 0 && this.f644f != 1) {
                d(0);
                e();
            }
            return;
    ...
    public final void d(int i2) {
        if ((this.f643e != 3 || this.f644f != 0) && this.f644f != i2) {
            this.f644f = i2;
            ViewPager2.e eVar = this.a;
            if (eVar != null) {
                eVar.a(i2);
    ...
    public final void f() {
        ...
        int i7;
        a aVar = this.f645g;
        int l1 = this.f642d.l1();
        aVar.a = l1;
        if (l1 == -1) {
            aVar.a();
            return;
        }
        View t = this.f642d.t(l1);
        if (t == null) {
            aVar.a();
            return;
        }
        Objects.requireNonNull(this.f642d);
        ...
        aVar.c = i12;
        if (i12 < 0) {
            LinearLayoutManager linearLayoutManager = this.f642d;
