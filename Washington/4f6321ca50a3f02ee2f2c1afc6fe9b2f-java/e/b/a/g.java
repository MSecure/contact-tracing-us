...
public class g extends r implements DialogInterface {
    ...
    public final AlertController f653d = new AlertController(getContext(), this, getWindow());
    ...
    public static class a {
        ...
        public g a() {
            ...
            AlertController alertController = gVar.f653d;
            View view = bVar.f20e;
            if (view != null) {
                alertController.G = view;
            } else {
                CharSequence charSequence = bVar.f19d;
                if (charSequence != null) {
                    alertController.f11e = charSequence;
            ...
            CharSequence charSequence2 = bVar.f21f;
            if (charSequence2 != null) {
                alertController.f12f = charSequence2;
                TextView textView2 = alertController.F;
                if (textView2 != null) {
                    textView2.setText(charSequence2);
                }
            }
            CharSequence charSequence3 = bVar.f22g;
            if (charSequence3 != null) {
                alertController.e(-1, charSequence3, bVar.f23h, null, null);
            }
            CharSequence charSequence4 = bVar.f24i;
            if (charSequence4 != null) {
                alertController.e(-2, charSequence4, bVar.f25j, null, null);
            }
            if (bVar.o != null) {
                ...
                alertController.f13g = recycleListView;
            }
            gVar.setCancelable(this.a.f26k);
            if (this.a.f26k) {
                gVar.setCanceledOnTouchOutside(true);
            }
            gVar.setOnCancelListener(this.a.f27l);
    ...
    public void onCreate(Bundle bundle) {
        ...
        AlertController alertController = this.f653d;
        ...
        View view4 = alertController.f14h;
        int i6 = 0;
        if (view4 == null) {
            view4 = alertController.f15i != 0 ? LayoutInflater.from(alertController.a).inflate(alertController.f15i, viewGroup, false) : null;
        }
        ...
        if (z2) {
            ...
            if (alertController.n) {
                frameLayout.setPadding(alertController.f16j, alertController.f17k, alertController.f18l, alertController.m);
            }
            if (alertController.f13g != null) {
        ...
        if (textView != null) {
            CharSequence charSequence = alertController.f12f;
            if (charSequence != null) {
                textView.setText(charSequence);
            } else {
                ...
                if (alertController.f13g != null) {
                    ...
                    viewGroup2.addView(alertController.f13g, indexOfChild, new ViewGroup.LayoutParams(-1, -1));
                } else {
                    d3.setVisibility(8);
                }
            }
        ...
        if (alertController.G != null) {
            ...
            if (!(!TextUtils.isEmpty(alertController.f11e)) || !alertController.P) {
                alertController.c.findViewById(R$id.title_template).setVisibility(8);
                ...
                textView2.setText(alertController.f11e);
        ...
        if (i11 != 0) {
            ...
            view3 = (alertController.f12f == null && alertController.f13g == null) ? view : d2.findViewById(R$id.titleDividerNoCustom);
        } else {
            view3 = d3.findViewById(R$id.textSpacerNoTitle);
        }
        view3.setVisibility(0);
        ListView listView = alertController.f13g;
        ...
        if (!z3) {
            View view5 = alertController.f13g;
            if (view5 == null) {
                ...
                if (i13 >= 23) {
                    ...
                    if (!(findViewById9 == null && view2 == null)) {
                        if (alertController.f12f != null) {
                            ...
                            ListView listView2 = alertController.f13g;
                            if (listView2 != null) {
                                listView2.setOnScrollListener(new d(alertController, findViewById9, view2));
                                alertController.f13g.post(new e(alertController, findViewById9, view2));
                            } else {
                                if (findViewById9 != null) {
                                    d3.removeView(findViewById9);
                                }
        ...
        ListView listView3 = alertController.f13g;
    ...
    public boolean onKeyDown(int i2, KeyEvent keyEvent) {
        NestedScrollView nestedScrollView = this.f653d.A;
