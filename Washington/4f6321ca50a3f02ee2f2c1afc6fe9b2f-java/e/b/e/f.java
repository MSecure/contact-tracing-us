...
public class f extends MenuInflater {
    ...
    public static final Class<?>[] f736e;

    /* renamed from: f  reason: collision with root package name */
    public static final Class<?>[] f737f;
    ...
    public class b {
        ...
        public SubMenu a() {
            this.f743h = true;
            SubMenu addSubMenu = this.a.addSubMenu(this.b, this.f744i, this.f745j, this.f746k);
        ...
        public final void c(MenuItem menuItem) {
            ...
            boolean z2 = false;
            menuItem.setChecked(this.s).setVisible(this.t).setEnabled(this.u).setCheckable(this.r >= 1).setTitleCondensed(this.f747l).setIcon(this.m);
            int i3 = this.v;
            if (i3 >= 0) {
            ...
            if (this.z != null) {
                if (!f.this.c.isRestricted()) {
                    f fVar = f.this;
                    if (fVar.f738d == null) {
                        fVar.f738d = fVar.a(fVar.c);
                    }
                    menuItem.setOnMenuItemClickListener(new a(fVar.f738d, this.z));
                } else {
            ...
            if (this.r >= 2) {
                if (menuItem instanceof i) {
                    ...
                    try {
                        if (jVar.f806e == null) {
                            jVar.f806e = jVar.f805d.getClass().getDeclaredMethod("setExclusiveCheckable", Boolean.TYPE);
                        }
                        jVar.f806e.invoke(jVar.f805d, Boolean.TRUE);
                    } catch (Exception e2) {
            ...
            String str = this.x;
            if (str != null) {
                menuItem.setActionView((View) b(str, f.f736e, f.this.a));
                z2 = true;
            }
            int i4 = this.w;
            if (i4 > 0) {
            ...
            if (eventType != 1) {
                if (eventType != 2) {
                        ...
                        if (z2 && name2.equals(str)) {
                            ...
                            if (!bVar.f743h) {
                                ...
                                if (bVar2 == null || !bVar2.a()) {
                                    bVar.f743h = true;
                                    bVar.c(bVar.a.add(bVar.b, bVar.f744i, bVar.f745j, bVar.f746k));
                                } else {
                                    bVar.a();
                                }
                            }
                    ...
                    if (name3.equals("group")) {
                        ...
                        bVar.f739d = obtainStyledAttributes.getInt(R$styleable.MenuGroup_android_orderInCategory, 0);
                        bVar.f740e = obtainStyledAttributes.getInt(R$styleable.MenuGroup_android_checkableBehavior, 0);
                        bVar.f741f = obtainStyledAttributes.getBoolean(R$styleable.MenuGroup_android_visible, true);
                        bVar.f742g = obtainStyledAttributes.getBoolean(R$styleable.MenuGroup_android_enabled, true);
                        obtainStyledAttributes.recycle();
                    } else if (name3.equals("item")) {
                        y0 p = y0.p(f.this.c, attributeSet, R$styleable.MenuItem);
                        bVar.f744i = p.l(R$styleable.MenuItem_android_id, 0);
                        bVar.f745j = (p.j(R$styleable.MenuItem_android_menuCategory, bVar.c) & -65536) | (p.j(R$styleable.MenuItem_android_orderInCategory, bVar.f739d) & 65535);
                        bVar.f746k = p.n(R$styleable.MenuItem_android_title);
                        bVar.f747l = p.n(R$styleable.MenuItem_android_titleCondensed);
                        ...
                        bVar.r = p.o(i2) ? p.a(i2, false) : bVar.f740e ? 1 : 0;
                        bVar.s = p.a(R$styleable.MenuItem_android_checked, false);
                        bVar.t = p.a(R$styleable.MenuItem_android_visible, bVar.f741f);
                        bVar.u = p.a(R$styleable.MenuItem_android_enabled, bVar.f742g);
                        ...
                        if (z3 && bVar.w == 0 && bVar.x == null) {
                            bVar.A = (e.i.i.b) bVar.b(m3, f737f, f.this.b);
                        } else {
                            if (z3) {
