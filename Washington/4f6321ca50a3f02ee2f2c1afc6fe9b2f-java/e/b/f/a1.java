...
public class a1 implements d0 {
    ...
    public Drawable f844e;

    /* renamed from: f  reason: collision with root package name */
    public Drawable f845f;
    ...
    public a1(Toolbar toolbar, boolean z) {
        ...
        if (z) {
            ...
            if (this.f846g == null && (drawable = this.p) != null) {
                this.f846g = drawable;
                z();
            }
            ...
            if (l4 != 0) {
                ...
                toolbar4.n = l4;
                TextView textView2 = toolbar4.f81d;
                if (textView2 != null) {
        ...
        if (i3 != this.o) {
            ...
            if (TextUtils.isEmpty(this.a.getNavigationContentDescription())) {
                int i4 = this.o;
                this.f850k = i4 != 0 ? q().getString(i4) : str;
                y();
            }
        }
        this.f850k = this.a.getNavigationContentDescription();
    ...
    public final void A() {
        ...
        if ((i2 & 2) == 0) {
            drawable = null;
        } else if ((i2 & 1) == 0 || (drawable = this.f845f) == null) {
            drawable = this.f844e;
        }
    ...
    public void a(Menu menu, m.a aVar) {
        ...
        if (gVar != null || toolbar.b != null) {
            ...
            if (gVar2 != gVar) {
                ...
                cVar2.r = true;
                if (gVar != null) {
                    gVar.b(cVar2, toolbar.f88k);
                    gVar.b(toolbar.L, toolbar.f88k);
                } else {
                    cVar2.e(toolbar.f88k, null);
                ...
                toolbar.b.setPopupTheme(toolbar.f89l);
    ...
    public void m(int i2) {
        this.f845f = i2 != 0 ? e.b.b.a.a.b(q(), i2) : null;
        A();
    }
    ...
    public void setIcon(int i2) {
        this.f844e = i2 != 0 ? e.b.b.a.a.b(q(), i2) : null;
        A();
    }
    ...
    public void x(int i2) {
        ...
        if (i3 != 0) {
            ...
            if ((i3 & 8) != 0) {
                if ((i2 & 8) != 0) {
                    this.a.setTitle(this.f848i);
                    toolbar = this.a;
                    charSequence = this.f849j;
                } else {
                    charSequence = null;
    ...
    public final void y() {
        ...
        if (TextUtils.isEmpty(this.f850k)) {
            ...
            this.a.setNavigationContentDescription(this.f850k);
        }
    }
