...
public class f0 extends ListView {
    ...
    public boolean b(MotionEvent motionEvent, int i2) {
        ...
        if (findPointerIndex >= 0) {
            ...
            if (pointToPosition != -1) {
                ...
                rect.left -= this.c;
                rect.top -= this.f875d;
                rect.right += this.f876e;
                rect.bottom += this.f877f;
                try {
                    boolean z4 = this.f879h.getBoolean(this);
                    if (childAt3.isEnabled() != z4) {
                        this.f879h.set(this, Boolean.valueOf(!z4));
                        if (pointToPosition != -1) {
            ...
            if (!z || z2) {
                ...
                childAt = getChildAt(this.f878g - getFirstVisiblePosition());
                if (childAt != null) {
    ...
    public final void c() {
        Drawable selector = getSelector();
        if (selector != null && this.f883l && isPressed()) {
    ...
    public boolean hasFocus() {
        return this.f882k || super.hasFocus();
    }

    public boolean hasWindowFocus() {
        return this.f882k || super.hasWindowFocus();
    }

    public boolean isFocused() {
        return this.f882k || super.isFocused();
    }

    public boolean isInTouchMode() {
        return (this.f882k && this.f881j) || super.isInTouchMode();
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        if (motionEvent.getAction() == 0) {
            this.f878g = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY());
        }
        b bVar = this.n;
        if (bVar != null) {
            f0 f0Var = f0.this;
    ...
    public void setSelector(Drawable drawable) {
        ...
        this.c = rect.left;
        this.f875d = rect.top;
        this.f876e = rect.right;
        this.f877f = rect.bottom;
    }
}
