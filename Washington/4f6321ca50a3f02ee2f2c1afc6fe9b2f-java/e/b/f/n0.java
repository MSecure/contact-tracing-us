...
public final class n0 {
    ...
    public static final PorterDuff.Mode f917h = PorterDuff.Mode.SRC_IN;

    /* renamed from: i  reason: collision with root package name */
    public static n0 f918i;

    /* renamed from: j  reason: collision with root package name */
    public static final c f919j = new c(6);
    public WeakHashMap<Context, i<ColorStateList>> a;
    public h<String, e> b;
    public i<String> c;

    /* renamed from: d  reason: collision with root package name */
    public final WeakHashMap<Context, e.e.e<WeakReference<Drawable.ConstantState>>> f920d = new WeakHashMap<>(0);
    ...
    public final synchronized boolean b(Context context, long j2, Drawable drawable) {
        ...
        if (constantState != null) {
            e.e.e<WeakReference<Drawable.ConstantState>> eVar = this.f920d.get(context);
            if (eVar == null) {
                eVar = new e.e.e<>();
                this.f920d.put(context, eVar);
            }
