...
public class r0 extends c implements View.OnClickListener {
    ...
    public static final class a {
        ...
        public final ImageView f933d;

        /* renamed from: e  reason: collision with root package name */
        public final ImageView f934e;

        public a(View view) {
            this.a = (TextView) view.findViewById(16908308);
            this.b = (TextView) view.findViewById(16908309);
            this.c = (ImageView) view.findViewById(16908295);
            this.f933d = (ImageView) view.findViewById(16908296);
            this.f934e = (ImageView) view.findViewById(R$id.edit_query);
        }
    }
    ...
    public void a(View view, Context context, Cursor cursor) {
        ...
        if (aVar.b != null) {
            ...
            if (h3 != null) {
                if (this.s == null) {
                    ...
                    this.f1514e.getTheme().resolveAttribute(R$attr.textColorSearchUrl, typedValue, true);
                    this.s = this.f1514e.getResources().getColorStateList(typedValue.resourceId);
                }
            ...
            if (i4 == -1) {
                ...
                if (drawable == null) {
                    ...
                    if (this.p.containsKey(flattenToShortString)) {
                        ...
                        PackageManager packageManager = this.f1514e.getPackageManager();
                        try {
                    ...
                    if (drawable == null) {
                        drawable = this.f1514e.getPackageManager().getDefaultActivityIcon();
                    }
                }
            }
        ...
        ImageView imageView2 = aVar.f933d;
        if (imageView2 != null) {
            int i5 = this.x;
            if (i5 != -1) {
        ...
        int i6 = this.r;
        if (i6 == 2 || (i6 == 1 && (i3 & 1) != 0)) {
            aVar.f934e.setVisibility(0);
            aVar.f934e.setTag(aVar.a.getText());
            aVar.f934e.setOnClickListener(this);
            return;
        }
        aVar.f934e.setVisibility(8);
    }
    ...
    public View d(Context context, Cursor cursor, ViewGroup viewGroup) {
        View inflate = this.f1521l.inflate(this.f1519j, viewGroup, false);
    ...
    public Drawable e(Uri uri) {
        ...
        if (!TextUtils.isEmpty(authority)) {
            try {
                Resources resourcesForApplication = this.f1514e.getPackageManager().getResourcesForApplication(authority);
    ...
    public Cursor g(SearchableInfo searchableInfo, String str, int i2) {
        ...
        return this.f1514e.getContentResolver().query(fragment.build(), null, suggestSelection, strArr, null);
    }
    ...
    public View getDropDownView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            View inflate = this.f1521l.inflate(this.f1520k, viewGroup, false);
            if (inflate != null) {
    ...
    public View getView(int i2, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", e2);
            View d2 = d(this.f1514e, this.f1513d, viewGroup);
