...
public class w extends Spinner {
    ...
    public static final int[] f956j = {16843505};
    public final e b;
    ...
    public final Rect f962i = new Rect();
    ...
    public class b implements f, DialogInterface.OnClickListener {
        ...
        public void e(int i2, int i3) {
            if (this.c != null) {
                ...
                CharSequence charSequence = this.f963d;
                ...
                g a = aVar.a();
                this.b = a;
                ListView listView = a.f653d.f13g;
    ...
    public class d extends k0 implements f {
        ...
        public void t() {
            ...
            int i4 = 0;
            if (i3 != null) {
                i3.getPadding(w.this.f962i);
                i4 = e1.a(w.this) ? w.this.f962i.right : -w.this.f962i.left;
            } else {
                Rect rect = w.this.f962i;
                rect.right = 0;
                rect.left = 0;
            }
            ...
            if (i5 == -2) {
                ...
                r(i5);
                this.f911g = !e1.a(w.this) ? (((width - paddingRight) - this.f910f) - this.H) + i4 : paddingLeft + this.H + i4;
            }
            r(i2);
            this.f911g = !e1.a(w.this) ? (((width - paddingRight) - this.f910f) - this.H) + i4 : paddingLeft + this.H + i4;
        }
    ...
    public w(Context context, AttributeSet attributeSet, int i2) {
        ...
        int i3 = -1;
        try {
            typedArray = context.obtainStyledAttributes(attributeSet, f956j, i2, 0);
            try {
        ...
        if (i3 == 0) {
            ...
            this.f961h = q.k(R$styleable.Spinner_android_dropDownWidth, -2);
            ...
            q.b.recycle();
            this.f960g = dVar;
            this.f957d = new v(this, this, dVar);
        }
        ...
        this.f959f = true;
        SpinnerAdapter spinnerAdapter = this.f958e;
        if (spinnerAdapter != null) {
    ...
    public int a(SpinnerAdapter spinnerAdapter, Drawable drawable) {
        ...
        drawable.getPadding(this.f962i);
        Rect rect = this.f962i;
        return i3 + rect.left + rect.right;
    }

    public void b() {
        this.f960g.e(getTextDirection(), getTextAlignment());
    }
    ...
    public int getDropDownWidth() {
        return this.f960g != null ? this.f961h : super.getDropDownWidth();
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.f960g != null && View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE) {
    ...
    public void setAdapter(SpinnerAdapter spinnerAdapter) {
        ...
        if (this.f960g != null) {
            ...
            this.f960g.o(new c(spinnerAdapter, context.getTheme()));
        }
    }
