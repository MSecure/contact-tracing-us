...
public class d implements c.a {
    ...
    public static final String f1084d = l.e("WorkConstraintsTracker");
    public final c a;
    public final c<?>[] b;
        ...
        synchronized (this.c) {
            ...
            for (c<?> cVar : cVarArr) {
                ...
                if (aVar != null && cVar.c(aVar) && cVar.a.contains(str)) {
                    l.c().a(f1084d, String.format("Work %s constrained by %s", str, cVar.getClass().getSimpleName()), new Throwable[0]);
                    return false;
                }
            }
            return true;
