...
public abstract class c implements Runnable {
    ...
    public void a(l lVar, String str) {
        ...
        synchronized (dVar.f1014k) {
            e.b0.l.c().a(d.f1006l, String.format("Processor cancelling %s", str), new Throwable[0]);
            dVar.f1012i.add(str);
            o remove = dVar.f1009f.remove(str);
            if (remove == null) {
                z = false;
            }
            if (remove == null) {
                remove = dVar.f1010g.remove(str);
            }
            d.c(str, remove);
            if (z) {
                dVar.g();
