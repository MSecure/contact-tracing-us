...
public class d implements Runnable {
    ...
    public static final String f1131d = l.e("EnqueueRunnable");
    public final g b;
    ...
    public static boolean a(g gVar) {
        ...
        if (list != null) {
            ...
            for (g gVar3 : list) {
                if (!gVar3.f1021h) {
                    ...
                    l.c().f(f1131d, String.format("Already enqueued work ids (%s).", TextUtils.join(", ", gVar3.f1018e)), new Throwable[0]);
                }
            }
        } else {
            z = false;
        ...
        List<? extends u> list2 = gVar.f1017d;
        ...
        if (z12) {
            ...
            while (i2 < length) {
                ...
                if (i3 == null) {
                    l.c().b(f1131d, String.format("Prerequisite %s doesn't exist; not enqueuing", str2), new Throwable[0]);
                    break;
                }
                s sVar6 = i3.b;
                z4 &= sVar6 == sVar3;
                        ...
                        if (i4 < 23 || i4 > 25) {
                            if (i4 <= 22) {
                                try {
                                    ...
                                    Iterator<e> it3 = lVar.f1029e.iterator();
                                    while (true) {
                                        if (!it3.hasNext()) {
                                            break;
    ...
    public static void b(o oVar) {
        e.b0.c cVar = oVar.f1119j;
        if (cVar.f986d || cVar.f987e) {
            String str = oVar.c;
            e.a aVar = new e.a();
            aVar.b(oVar.f1114e.a);
