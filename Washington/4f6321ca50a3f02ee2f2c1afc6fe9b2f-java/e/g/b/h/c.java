...
public class c {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0022, code lost:
        if (r6.f1259d.y == false) goto L_0x0040;
     */
    ...
    public boolean a(c cVar, int i2, int i3, boolean z) {
            ...
            if (aVar4 != aVar5) {
                switch (aVar5.ordinal()) {
                    ...
                    case 6:
                        ...
                        break;
                    default:
                        throw new AssertionError(this.f1260e.name());
                }
                if (!z2) {
                }
            } else if (aVar5 == aVar3) {
        ...
        HashSet<c> hashSet = this.f1261f.a;
        if (hashSet != null) {
            hashSet.add(this);
        }
        if (i2 > 0) {
    ...
    public void b(int i2, ArrayList<n> arrayList, n nVar) {
        ...
        if (hashSet != null) {
            ...
            while (it.hasNext()) {
                m.h.V(it.next().f1259d, i2, arrayList, nVar);
            }
        }
    }
    ...
    public int d() {
        ...
        int i2 = this.f1263h;
        if (i2 <= -1 || (cVar = this.f1261f) == null || cVar.f1259d.c0 != 8) {
            return this.f1262g;
        }
        return i2;
    }
        ...
        while (it.hasNext()) {
            ...
            switch (next.f1260e.ordinal()) {
                ...
                case 4:
                    ...
                    break;
                default:
                    throw new AssertionError(next.f1260e.name());
            }
            if (cVar.g()) {
                return true;
            }
    ...
    public void i() {
        g gVar = this.f1264i;
        if (gVar == null) {
            this.f1264i = new g(g.a.UNRESTRICTED);
        } else {
            gVar.c();
        }
    }
    ...
    public String toString() {
        return this.f1259d.d0 + ":" + this.f1260e.toString();
    }
}
