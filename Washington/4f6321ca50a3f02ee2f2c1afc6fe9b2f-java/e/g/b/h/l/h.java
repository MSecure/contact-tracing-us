...
public class h {
    ...
    public static boolean a(d dVar) {
        ...
        boolean z = m == aVar3 || m == aVar2 || (m == aVar && dVar.f1281l == 0 && dVar.S == 0.0f && dVar.u(0)) || dVar.z();
    ...
    public static void b(d dVar, b.AbstractC0028b bVar, boolean z) {
        ...
        if (hashSet2 != null && i2.c) {
            ...
            while (it.hasNext()) {
                ...
                if (dVar2.m() != aVar || a2) {
                    if (!dVar2.y()) {
                        c cVar6 = dVar2.D;
                        if (next == cVar6 && dVar2.F.f1261f == null) {
                            int d2 = cVar6.d() + c;
                            dVar2.F(d2, dVar2.r() + d2);
                        } else {
                            c cVar7 = dVar2.F;
                            if (next == cVar7 && cVar6.f1261f == null) {
                                int d3 = c - cVar7.d();
                                dVar2.F(d3 - dVar2.r(), d3);
                            } else if (next == cVar6 && (cVar3 = cVar7.f1261f) != null && cVar3.c && !dVar2.w()) {
                                c(bVar, dVar2, z);
                            }
                        }
                        b(dVar2, bVar, z);
                    ...
                    if ((dVar2.c0 == 8 || (dVar2.f1281l == 0 && dVar2.S == 0.0f)) && !dVar2.w() && !dVar2.A) {
                        c cVar8 = dVar2.D;
                        if (((next == cVar8 && (cVar5 = dVar2.F.f1261f) != null && cVar5.c) || (next == dVar2.F && (cVar4 = cVar8.f1261f) != null && cVar4.c)) && !dVar2.w()) {
                            d(dVar, bVar, dVar2, z);
                        }
                    }
                }
        ...
        if (!(dVar instanceof f) && (hashSet = i3.a) != null && i3.c) {
            ...
            while (it2.hasNext()) {
                c next2 = it2.next();
                d dVar3 = next2.f1259d;
                boolean a3 = a(dVar3);
                if (dVar3.y() && a3) {
                    e.X(dVar3, bVar, new b.a(), 0);
                }
                c cVar9 = dVar3.D;
                boolean z2 = (next2 == cVar9 && (cVar2 = dVar3.F.f1261f) != null && cVar2.c) || (next2 == dVar3.F && (cVar = cVar9.f1261f) != null && cVar.c);
                if (dVar3.m() != aVar || a3) {
                    if (!dVar3.y()) {
                        c cVar10 = dVar3.D;
                        if (next2 == cVar10 && dVar3.F.f1261f == null) {
                            int d4 = cVar10.d() + c2;
                            dVar3.F(d4, dVar3.r() + d4);
                        } else {
                            c cVar11 = dVar3.F;
                            if (next2 == cVar11 && cVar10.f1261f == null) {
                                int d5 = c2 - cVar11.d();
                    ...
                    if ((dVar3.c0 == 8 || (dVar3.f1281l == 0 && dVar3.S == 0.0f)) && !dVar3.w() && !dVar3.A && z2 && !dVar3.w()) {
                        d(dVar, bVar, dVar3, z);
                    }
                }
            }
    ...
    public static void c(b.AbstractC0028b bVar, d dVar, boolean z) {
        float f2 = dVar.Z;
        int c = dVar.D.f1261f.c();
        int c2 = dVar.F.f1261f.c();
        int d2 = dVar.D.d() + c;
        int d3 = c2 - dVar.F.d();
        if (c == c2) {
            f2 = 0.5f;
    ...
    public static void d(d dVar, b.AbstractC0028b bVar, d dVar2, boolean z) {
        float f2 = dVar2.Z;
        int d2 = dVar2.D.d() + dVar2.D.f1261f.c();
        int c = dVar2.F.f1261f.c() - dVar2.F.d();
        if (c >= d2) {
            int r = dVar2.r();
            if (dVar2.c0 != 8) {
                int i2 = dVar2.f1281l;
    ...
    public static void e(b.AbstractC0028b bVar, d dVar) {
        float f2 = dVar.a0;
        int c = dVar.E.f1261f.c();
        int c2 = dVar.G.f1261f.c();
        int d2 = dVar.E.d() + c;
        int d3 = c2 - dVar.G.d();
        if (c == c2) {
            f2 = 0.5f;
    ...
    public static void f(d dVar, b.AbstractC0028b bVar, d dVar2) {
        float f2 = dVar2.a0;
        int d2 = dVar2.E.d() + dVar2.E.f1261f.c();
        int c = dVar2.G.f1261f.c() - dVar2.G.d();
        if (c >= d2) {
            int l2 = dVar2.l();
            if (dVar2.c0 != 8) {
                int i2 = dVar2.m;
        ...
        if (hashSet != null && i2.c) {
            ...
            while (it.hasNext()) {
                ...
                if (dVar2.q() != aVar || a2) {
                    if (!dVar2.y()) {
                        c cVar6 = dVar2.E;
                        if (next == cVar6 && dVar2.G.f1261f == null) {
                            int d2 = cVar6.d() + c;
                            dVar2.G(d2, dVar2.l() + d2);
                        } else {
                            c cVar7 = dVar2.G;
                            if (next == cVar7 && cVar7.f1261f == null) {
                                int d3 = c - cVar7.d();
                                dVar2.G(d3 - dVar2.l(), d3);
                            } else if (next == cVar6 && (cVar3 = cVar7.f1261f) != null && cVar3.c) {
                                e(bVar, dVar2);
                            }
                        }
                        g(dVar2, bVar);
                    ...
                    if ((dVar2.c0 == 8 || (dVar2.m == 0 && dVar2.S == 0.0f)) && !dVar2.x() && !dVar2.A) {
                        c cVar8 = dVar2.E;
                        if (((next == cVar8 && (cVar5 = dVar2.G.f1261f) != null && cVar5.c) || (next == dVar2.G && (cVar4 = cVar8.f1261f) != null && cVar4.c)) && !dVar2.x()) {
                            f(dVar, bVar, dVar2);
                        }
                    }
                }
        ...
        if (!(dVar instanceof f)) {
            ...
            if (hashSet2 != null && i3.c) {
                ...
                while (it2.hasNext()) {
                    ...
                    c cVar9 = dVar3.E;
                    boolean z = (next2 == cVar9 && (cVar2 = dVar3.G.f1261f) != null && cVar2.c) || (next2 == dVar3.G && (cVar = cVar9.f1261f) != null && cVar.c);
                    if (dVar3.q() != aVar || a3) {
                        if (!dVar3.y()) {
                            c cVar10 = dVar3.E;
                            if (next2 == cVar10 && dVar3.G.f1261f == null) {
                                int d4 = cVar10.d() + c2;
