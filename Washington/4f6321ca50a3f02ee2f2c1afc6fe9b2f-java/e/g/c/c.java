            ...
            for (int i2 = 0; i2 < indexCount; i2++) {
                ...
                if (index == R$styleable.Variant_constraints) {
                    ...
                    if ("layout".equals(resourceTypeName)) {
                        d dVar = new d();
                        this.f1349f = dVar;
                        dVar.b((ConstraintLayout) LayoutInflater.from(context).inflate(this.f1348e, (ViewGroup) null));
                    }
                        ...
                        if (eventType != 0) {
                            ...
                            if (eventType == 2) {
                                ...
                                switch (c) {
                                    ...
                                    case 4:
                                        if (aVar2 != null) {
                                            aVar2.f1353e.a(context, Xml.asAttributeSet(xmlPullParser));
                                            break;
                                        } else {
                                            throw new RuntimeException("XML parser error must be within a Constraint " + xmlPullParser.getLineNumber());
                                        }
                                    case 5:
                                        if (aVar2 != null) {
                                            aVar2.f1352d.a(context, Xml.asAttributeSet(xmlPullParser));
                                            break;
                                        } else {
                                            throw new RuntimeException("XML parser error must be within a Constraint " + xmlPullParser.getLineNumber());
                                        }
                                    ...
                                    case 7:
                                        if (aVar2 != null) {
                                            a.a(context, xmlPullParser, aVar2.f1354f);
                                            break;
                                        } else {
                                            throw new RuntimeException("XML parser error must be within a Constraint " + xmlPullParser.getLineNumber());
                                        }
