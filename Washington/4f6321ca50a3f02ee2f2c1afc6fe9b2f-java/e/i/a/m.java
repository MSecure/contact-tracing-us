...
public final class m {
    ...
    public static Set<String> f1410e = new HashSet();

    /* renamed from: f  reason: collision with root package name */
    public static final Object f1411f = new Object();

    /* renamed from: g  reason: collision with root package name */
    public static c f1412g;
    ...
    public static class a implements d {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final Notification f1413d;

        public a(String str, int i2, String str2, Notification notification) {
            this.a = str;
            this.b = i2;
            this.c = str2;
            this.f1413d = notification;
        }

        @Override // e.i.a.m.d
        public void a(d.a.a.a.a aVar) {
            aVar.u(this.a, this.b, this.c, this.f1413d);
        }
    ...
    public static class c implements Handler.Callback, ServiceConnection {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final Map<ComponentName, a> f1414d = new HashMap();

        /* renamed from: e  reason: collision with root package name */
        public Set<String> f1415e = new HashSet();
        ...
        public static class a {
            ...
            /* renamed from: d  reason: collision with root package name */
            public ArrayDeque<d> f1416d = new ArrayDeque<>();
        ...
        public final void a(a aVar) {
            ...
            if (Log.isLoggable("NotifManCompat", 3)) {
                ...
                h2.append(aVar.a);
                h2.append(", ");
                h2.append(aVar.f1416d.size());
                h2.append(" queued tasks");
                h2.toString();
            }
            if (!aVar.f1416d.isEmpty()) {
                if (aVar.b) {
                    z = true;
                } else {
            ...
            if (i2 == 0) {
                ...
                if (!set.equals(this.f1415e)) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (!this.f1414d.containsKey(componentName2)) {
                            if (Log.isLoggable("NotifManCompat", 3)) {
                                String str2 = "Adding listener record for " + componentName2;
                            }
                            this.f1414d.put(componentName2, new a(componentName2));
                        }
                    }
                    Iterator<Map.Entry<ComponentName, a>> it2 = this.f1414d.entrySet().iterator();
                    while (it2.hasNext()) {
                ...
                for (a aVar2 : this.f1414d.values()) {
                    aVar2.f1416d.add(dVar);
                    a(aVar2);
                }
                return true;
            } else if (i2 == 1) {
                ...
                a aVar3 = this.f1414d.get(componentName3);
                if (aVar3 != null) {
                ...
                a aVar4 = this.f1414d.get((ComponentName) message.obj);
                if (aVar4 != null) {
                    if (aVar4.b) {
                        this.a.unbindService(this);
                        aVar4.b = false;
                ...
                a aVar5 = this.f1414d.get((ComponentName) message.obj);
                if (aVar5 != null) {
                    a(aVar5);
                }
                return true;
