...
public class g extends e {
    ...
    public final Class<?> f1428g;

    /* renamed from: h  reason: collision with root package name */
    public final Constructor<?> f1429h;

    /* renamed from: i  reason: collision with root package name */
    public final Method f1430i;

    /* renamed from: j  reason: collision with root package name */
    public final Method f1431j;

    /* renamed from: k  reason: collision with root package name */
    public final Method f1432k;

    /* renamed from: l  reason: collision with root package name */
    public final Method f1433l;
    ...
    private Object m() {
        try {
            return this.f1429h.newInstance(new Object[0]);
    ...
    public Typeface a(Context context, c cVar, Resources resources, int i2) {
        ...
        d[] dVarArr = cVar.a;
        for (d dVar : dVarArr) {
            if (!i(context, m2, dVar.a, dVar.f1419e, dVar.b, dVar.c ? 1 : 0, FontVariationAxis.fromFontVariationSettings(dVar.f1418d))) {
                h(m2);
                return null;
            }
        }
    ...
    public Typeface b(Context context, CancellationSignal cancellationSignal, e.c[] cVarArr, int i2) {
        ...
        if (!l()) {
            ...
            try {
                ...
                try {
                    Typeface build = new Typeface.Builder(openFileDescriptor.getFileDescriptor()).setWeight(cVar.c).setItalic(cVar.f1446d).build();
                    openFileDescriptor.close();
                    return build;
                } catch (Throwable th) {
                    th.addSuppressed(th);
            ...
            for (e.c cVar2 : cVarArr) {
                if (cVar2.f1447e == 0) {
                    ...
                    if (!hashMap.containsKey(uri)) {
                        hashMap.put(uri, m.h.E0(context, cancellationSignal, uri));
                    }
                }
            }
            ...
            for (e.c cVar3 : cVarArr) {
                ...
                if (byteBuffer != null) {
                    try {
                        z = ((Boolean) this.f1431j.invoke(m2, byteBuffer, Integer.valueOf(cVar3.b), null, Integer.valueOf(cVar3.c), Integer.valueOf(cVar3.f1446d ? 1 : 0))).booleanValue();
    ...
    public final void h(Object obj) {
        try {
            this.f1433l.invoke(obj, new Object[0]);
    ...
    public final boolean i(Context context, Object obj, String str, int i2, int i3, int i4, FontVariationAxis[] fontVariationAxisArr) {
        try {
            return ((Boolean) this.f1430i.invoke(obj, context.getAssets(), str, 0, Boolean.FALSE, Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4), fontVariationAxisArr)).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
    ...
    public final boolean k(Object obj) {
        try {
            return ((Boolean) this.f1432k.invoke(obj, new Object[0])).booleanValue();
        } catch (IllegalAccessException | InvocationTargetException unused) {
            return false;
        }
    }
