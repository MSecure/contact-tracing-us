...
public class e {
    ...
    public static final h<String, ArrayList<f.c<d>>> f1444d = new h<>();

    /* renamed from: e  reason: collision with root package name */
    public static final Comparator<byte[]> f1445e = new a();
    ...
    public static b a(Context context, CancellationSignal cancellationSignal, a aVar) {
        ...
        if (resolveContentProvider == null) {
            ...
            Collections.sort(arrayList, f1445e);
            List<List<byte[]>> list = aVar.f1441d;
            if (list == null) {
                list = m.h.Q0(resources, 0);
            }
            int i2 = 0;
            while (true) {
                cursor = 0;
                ...
                Collections.sort(arrayList2, f1445e);
