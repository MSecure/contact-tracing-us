...
public class f {
    ...
    public Handler.Callback f1449e = new a();
    ...
    public class b implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ ReentrantLock f1450d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ AtomicBoolean f1451e;

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ Condition f1452f;
        ...
        public b(f fVar, AtomicReference atomicReference, Callable callable, ReentrantLock reentrantLock, AtomicBoolean atomicBoolean, Condition condition) {
            ...
            this.c = callable;
            this.f1450d = reentrantLock;
            this.f1451e = atomicBoolean;
            this.f1452f = condition;
        }
    ...
    public final void a(Runnable runnable) {
        synchronized (this.a) {
            if (this.b == null) {
                ...
                handlerThread.start();
                this.c = new Handler(this.b.getLooper(), this.f1449e);
                this.f1448d++;
            }
