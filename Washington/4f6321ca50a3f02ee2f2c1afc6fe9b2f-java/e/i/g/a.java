...
public final class a {
    ...
    public static final c f1454d;

    /* renamed from: e  reason: collision with root package name */
    public static final String f1455e = Character.toString(8206);

    /* renamed from: f  reason: collision with root package name */
    public static final String f1456f = Character.toString(8207);

    /* renamed from: g  reason: collision with root package name */
    public static final a f1457g;

    /* renamed from: h  reason: collision with root package name */
    public static final a f1458h;
    ...
    public static class C0032a {
        ...
        /* renamed from: e  reason: collision with root package name */
        public static final byte[] f1459e = new byte[1792];
        ...
        static {
            for (int i2 = 0; i2 < 1792; i2++) {
                f1459e[i2] = Character.getDirectionality(i2);
            }
        }
        ...
        public byte a() {
            ...
            this.c--;
            char c2 = this.f1460d;
            return c2 < 1792 ? f1459e[c2] : Character.getDirectionality(c2);
        }
    }
    ...
    static {
        c cVar = d.c;
        f1454d = cVar;
        f1457g = new a(false, 2, cVar);
        f1458h = new a(true, 2, cVar);
    }
        ...
        while (true) {
            ...
            if (i5 < aVar.b && i2 == 0) {
                ...
                if (Character.isHighSurrogate(charAt)) {
                    ...
                    aVar.c++;
                    char c2 = aVar.f1460d;
                    b2 = c2 < 1792 ? C0032a.f1459e[c2] : Character.getDirectionality(c2);
                }
                if (b2 != 0) {
                    if (b2 == 1 || b2 == 2) {
                        if (i4 == 0) {
    ...
    public CharSequence d(CharSequence charSequence, c cVar, boolean z) {
        ...
        if (((this.b & 2) != 0) && z) {
            ...
            spannableStringBuilder.append((CharSequence) ((this.a || (!b3 && a(charSequence) != 1)) ? (!this.a || (b3 && a(charSequence) != -1)) ? str : f1456f : f1455e));
        }
        if (b2 != this.a) {
