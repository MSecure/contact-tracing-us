...
public class f {
    ...
    public final boolean f(int i2, int i3, int i4, int i5, int[] iArr, int i6, int[] iArr2) {
        ...
        View view = this.c;
        if (g2 instanceof h) {
            ((h) g2).m(view, i2, i3, i4, i5, i6, iArr3);
        } else {
            iArr3[0] = iArr3[0] + i4;
            iArr3[1] = iArr3[1] + i5;
            if (g2 instanceof g) {
                ((g) g2).n(view, i2, i3, i4, i5, i6);
            } else if (i6 == 0) {
                try {
