...
public class e {
    ...
    public void a() {
        this.c = -1;
        float[] fArr = this.f1532d;
        if (fArr != null) {
            Arrays.fill(fArr, 0.0f);
            Arrays.fill(this.f1533e, 0.0f);
            Arrays.fill(this.f1534f, 0.0f);
            Arrays.fill(this.f1535g, 0.0f);
            Arrays.fill(this.f1536h, 0);
            Arrays.fill(this.f1537i, 0);
            Arrays.fill(this.f1538j, 0);
            this.f1539k = 0;
        }
        VelocityTracker velocityTracker = this.f1540l;
    ...
    public final boolean c(float f2, float f3, int i2, int i3) {
        ...
        if ((this.f1536h[i2] & i3) != i3 || (0 & i3) == 0 || (this.f1538j[i2] & i3) == i3 || (this.f1537i[i2] & i3) == i3) {
            return false;
        }
        int i4 = this.b;
        ...
        return (this.f1537i[i2] & i3) == 0 && abs > ((float) this.b);
    }
    ...
    public void n(MotionEvent motionEvent) {
        ...
        if (this.f1540l == null) {
            this.f1540l = VelocityTracker.obtain();
        }
        this.f1540l.addMovement(motionEvent);
        int i3 = 0;
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    if (this.a != 1) {
                        ...
                        while (i3 < pointerCount) {
                            ...
                            if (m(pointerId)) {
                                ...
                                float f2 = x - this.f1532d[pointerId];
                                float f3 = y - this.f1533e[pointerId];
                                p(f2, f3, pointerId);
                                if (this.a != 1) {
                        ...
                        float[] fArr = this.f1534f;
                        int i4 = this.c;
                        int i5 = (int) (x2 - fArr[i4]);
                        int i6 = (int) (y2 - this.f1535g[i4]);
    ...
    public final void o() {
        this.f1540l.computeCurrentVelocity(1000, this.m);
        j(e(this.f1540l.getXVelocity(this.c), this.n, this.m), e(this.f1540l.getYVelocity(this.c), this.n, this.m));
    }
    ...
    public final void q(float f2, float f3, int i2) {
        ...
        if (fArr == null || fArr.length <= i2) {
            ...
            if (fArr != null) {
                ...
                float[] fArr6 = this.f1533e;
                System.arraycopy(fArr6, 0, fArr3, 0, fArr6.length);
                float[] fArr7 = this.f1534f;
                System.arraycopy(fArr7, 0, fArr4, 0, fArr7.length);
                float[] fArr8 = this.f1535g;
                System.arraycopy(fArr8, 0, fArr5, 0, fArr8.length);
                int[] iArr4 = this.f1536h;
                System.arraycopy(iArr4, 0, iArr, 0, iArr4.length);
                int[] iArr5 = this.f1537i;
                System.arraycopy(iArr5, 0, iArr2, 0, iArr5.length);
                int[] iArr6 = this.f1538j;
        ...
        float[] fArr9 = this.f1532d;
        this.f1534f[i2] = f2;
        fArr9[i2] = f2;
        float[] fArr10 = this.f1533e;
        this.f1535g[i2] = f3;
        fArr10[i2] = f3;
        int[] iArr7 = this.f1536h;
        int i5 = (int) f2;
        int i6 = (int) f3;
    ...
    public final void r(MotionEvent motionEvent) {
        ...
        for (int i2 = 0; i2 < pointerCount; i2++) {
            ...
            if (m(pointerId)) {
                ...
                this.f1534f[pointerId] = x;
                this.f1535g[pointerId] = y;
            }
        }
    }
    ...
    public boolean t(int i2, int i3) {
        if (this.s) {
            return l(i2, i3, (int) this.f1540l.getXVelocity(this.c), (int) this.f1540l.getYVelocity(this.c));
        }
    ...
    public boolean u(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked != 2) {
                ...
                } else if (!(this.f1532d == null || this.f1533e == null)) {
                    int pointerCount = motionEvent.getPointerCount();
                    for (int i3 = 0; i3 < pointerCount; i3++) {
                        ...
                        if (m(pointerId2)) {
                            ...
                            float f2 = x2 - this.f1532d[pointerId2];
                            float f3 = y2 - this.f1533e[pointerId2];
