...
public class a {
    ...
    public static final ThreadLocal<a> f1541g = new ThreadLocal<>();
    ...
    public class C0041a {
        ...
        public void a() {
            boolean z;
            a.this.f1543e = SystemClock.uptimeMillis();
            a aVar = a.this;
            long j2 = aVar.f1543e;
            ...
            if (a.this.b.size() > 0) {
                a aVar2 = a.this;
                if (aVar2.f1542d == null) {
                    aVar2.f1542d = new d(aVar2.c);
                }
                d dVar = (d) aVar2.f1542d;
    ...
    public static a a() {
        ThreadLocal<a> threadLocal = f1541g;
