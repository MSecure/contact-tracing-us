...
public abstract class b<T extends b<T>> implements a.b {
    ...
    public static final k f1545l = new c("scaleX");
    ...
    public float f1549g = -3.4028235E38f;

    /* renamed from: h  reason: collision with root package name */
    public long f1550h = 0;

    /* renamed from: i  reason: collision with root package name */
    public float f1551i;

    /* renamed from: j  reason: collision with root package name */
    public final ArrayList<i> f1552j = new ArrayList<>();

    /* renamed from: k  reason: collision with root package name */
    public final ArrayList<j> f1553k = new ArrayList<>();
    ...
    public <K> b(K k2, c<K> cVar) {
        ...
        if (cVar == n || cVar == o || cVar == p) {
            f2 = 0.1f;
        } else if (cVar == q || cVar == f1545l || cVar == m) {
            this.f1551i = 0.00390625f;
            return;
        } else {
            f2 = 1.0f;
        }
    ...
    public boolean a(long j2) {
        ...
        e eVar = dVar.r;
        if (i2 != 0) {
            double d3 = eVar.f1559i;
            j4 /= 2;
            h b2 = eVar.b((double) dVar.b, (double) dVar.a, j4);
            eVar = dVar.r;
            eVar.f1559i = (double) dVar.s;
        ...
        dVar.b = f3;
        dVar.a = b3.b;
        float max = Math.max(f3, dVar.f1549g);
        dVar.b = max;
        ...
        boolean z = true;
        if (((double) Math.abs(f4)) < eVar2.f1555e && ((double) Math.abs(min - ((float) eVar2.f1559i))) < eVar2.f1554d) {
            dVar.b = (float) dVar.r.f1559i;
            dVar.a = 0.0f;
        } else {
            z = false;
        }
        ...
        this.b = min2;
        float max2 = Math.max(min2, this.f1549g);
        this.b = max2;
        e(max2);
        if (z) {
            c(false);
    ...
    public final void c(boolean z) {
        ...
        this.f1550h = 0;
        this.c = false;
        for (int i2 = 0; i2 < this.f1552j.size(); i2++) {
            if (this.f1552j.get(i2) != null) {
                this.f1552j.get(i2).a(this, z, this.b, this.a);
            }
        }
        d(this.f1552j);
    }
    ...
    public void e(float f2) {
        this.f1547e.b(this.f1546d, f2);
        for (int i2 = 0; i2 < this.f1553k.size(); i2++) {
            if (this.f1553k.get(i2) != null) {
                this.f1553k.get(i2).a(this, this.b, this.a);
            }
        }
        d(this.f1553k);
    }
