...
public class d extends z0 {
    ...
    public final HashMap<z0.d, HashSet<e.i.e.a>> f1580f = new HashMap<>();
    ...
    public class a implements Runnable {
        ...
        public void run() {
            ...
            if (dVar.a == z0.d.c.VISIBLE) {
                l.b bVar = dVar.c.I;
                View view = bVar == null ? null : bVar.f1633k;
                if (view != null) {
                    view.requestFocus();
                    this.b.c.f().f1633k = null;
                }
            }
        }
    }
    ...
    public class c implements a.AbstractC0031a {
        ...
        public void a() {
            d dVar = d.this;
            HashSet<e.i.e.a> remove = dVar.f1580f.remove(this.a);
            if (remove != null) {
    ...
    public void b(List<z0.d> list, boolean z) {
        ...
        while (it2.hasNext()) {
            ...
            next.f1698e.add(new a(this, next));
            next.f1698e.add(new b(arrayList12, next));
            next.f1697d.c(new c(next));
        }
        ...
        if (u0Var2 == null) {
            ...
            while (it5.hasNext()) {
                ...
                if (!(obj3 != null) || dVar6 == null || dVar7 == null) {
                    ...
                    l.b bVar = dVar7.c.I;
                    if (bVar == null || (arrayList6 = bVar.f1627e) == null) {
                        arrayList6 = new ArrayList<>();
                    }
                    l.b bVar2 = dVar6.c.I;
                    if (bVar2 == null || (arrayList7 = bVar2.f1627e) == null) {
                        arrayList7 = new ArrayList<>();
                    }
                    cVar4 = cVar5;
                    l.b bVar3 = dVar6.c.I;
                    if (bVar3 == null || (arrayList8 = bVar3.f1628f) == null) {
                    ...
                    l.b bVar4 = dVar7.c.I;
                    if (bVar4 == null || (arrayList9 = bVar4.f1628f) == null) {
        ...
        while (it10.hasNext()) {
            ...
            if (c3 != cVar7 && (c3 == cVar || cVar7 == cVar)) {
                s A0 = m.h.A0(context, lVar, cVar7 == cVar);
                if (A0 != null) {
                    if (!containsValue || A0.a == null) {
                        if (!booleanValue) {
                            viewGroup.startViewTransition(view9);
                            if (A0.a != null) {
                                Animation uVar = dVar11.a == cVar ? new u(A0.a) : new t(A0.a, viewGroup, view9);
                                cVar2 = cVar;
                                uVar.setAnimationListener(new e(this, viewGroup, view9, dVar11, aVar9));
                                view9.startAnimation(uVar);
                            } else {
                                cVar2 = cVar;
                                A0.b.addListener(new f(this, viewGroup, view9, dVar11, aVar9));
                                A0.b.setTarget(view9);
                                A0.b.start();
                            }
    ...
    public final void g(z0.d dVar, e.i.e.a aVar) {
        if (this.f1580f.get(dVar) == null) {
            this.f1580f.put(dVar, new HashSet<>());
        }
        this.f1580f.get(dVar).add(aVar);
    }
    ...
    public void j(z0.d dVar, e.i.e.a aVar) {
        HashSet<e.i.e.a> hashSet = this.f1580f.get(dVar);
        if (hashSet != null && hashSet.remove(aVar) && hashSet.isEmpty()) {
            this.f1580f.remove(dVar);
            dVar.a();
        }
    }
