...
public class l implements ComponentCallbacks, View.OnCreateContextMenuListener, j, d0, e.p.f, e.u.c {
    ...
    public SparseArray<Parcelable> f1617d;

    /* renamed from: e  reason: collision with root package name */
    public Bundle f1618e;

    /* renamed from: f  reason: collision with root package name */
    public String f1619f = UUID.randomUUID().toString();
    ...
    public static class b {
        ...
        /* renamed from: e  reason: collision with root package name */
        public ArrayList<String> f1627e;

        /* renamed from: f  reason: collision with root package name */
        public ArrayList<String> f1628f;

        /* renamed from: g  reason: collision with root package name */
        public Object f1629g;

        /* renamed from: h  reason: collision with root package name */
        public Object f1630h;
    ...
    public final boolean C() {
        return this.t != null && this.f1625l;
    }
    ...
    public c0 h() {
        ...
        if (c0Var != null) {
            g0 g0Var = c0Var.J;
            c0 c0Var2 = g0Var.f1596e.get(this.f1619f);
            if (c0Var2 != null) {
                return c0Var2;
            }
            c0 c0Var3 = new c0();
            g0Var.f1596e.put(this.f1619f, c0Var3);
            return c0Var3;
        }
    ...
    public b0.b k() {
        if (this.s != null) {
            if (this.S == null) {
                ...
                this.S = new v(application, this, this.f1620g);
            }
            return this.S;
        }
        throw new IllegalStateException("Can't access ViewModels from detached fragment");
