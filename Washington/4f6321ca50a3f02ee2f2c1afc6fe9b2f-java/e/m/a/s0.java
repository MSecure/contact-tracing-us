...
public class s0 {
    ...
    public static void a(ArrayList<View> arrayList, e.e.a<String, View> aVar, Collection<String> collection) {
        for (int i2 = aVar.f1198d - 1; i2 >= 0; i2--) {
            View k2 = aVar.k(i2);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0038, code lost:
        if (r0.f1625l != false) goto L_0x0087;
     */
            ...
            if (i3 != 1) {
                if (i3 != 3) {
                    if (i3 != 4) {
                        ...
                        if (z4 && (bVar == null || bVar.f1678d == null)) {
                            if (bVar == null) {
                                b bVar3 = new b();
                            ...
                            if (lVar8 == null || lVar9 == null) {
                                ...
                                if (i14 == null && j2 == null && obj8 == null) {
                                    ...
                                    if (obj8 != null) {
                                        ...
                                        arrayList5 = arrayList12;
                                        n(g2, obj8, j2, f2, bVar.f1679e, bVar.f1680f);
                                        Rect rect3 = new Rect();
                                    ...
                                    if (!(i14 == null && obj6 == null && j2 == null)) {
                                        ...
                                        if (m2 != null) {
                                            if (lVar7 != null && j2 != null && lVar7.f1625l && lVar7.z && lVar7.K) {
                                                lVar7.t0(true);
                                                g2.q(j2, lVar7.F, h2);
                            ...
                            if (lVar12 == null || lVar13 == null) {
                                ...
                                if (i15 == null && j3 == null && obj4 == null) {
                                    ...
                                    if (obj4 != null) {
                                        ...
                                        n(g3, obj5, j3, f3, bVar.f1679e, bVar.f1680f);
                                        if (i15 != null) {
                                            g3.s(i15, rect);
                                        }
                                    } else {
