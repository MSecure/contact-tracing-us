...
public abstract class z0 {
    ...
    public static class d {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final e.i.e.a f1697d = new e.i.e.a();

        /* renamed from: e  reason: collision with root package name */
        public final List<Runnable> f1698e = new ArrayList();
        ...
        public void a() {
            for (Runnable runnable : this.f1698e) {
                runnable.run();
            }
        }
    }
    ...
    public void c() {
        if (!this.f1695e) {
            synchronized (this.b) {
                if (!this.b.isEmpty()) {
                    b(new ArrayList(this.b), this.f1694d);
                    this.b.clear();
                    this.f1694d = false;
                }
            }
