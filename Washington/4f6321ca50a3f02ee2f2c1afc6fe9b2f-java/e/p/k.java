...
public class k extends g {
    ...
    public boolean f1712f = false;

    /* renamed from: g  reason: collision with root package name */
    public ArrayList<g.b> f1713g = new ArrayList<>();
    ...
    public void a(i iVar) {
        ...
        if (this.a.k(iVar, aVar) == null && (jVar = this.c.get()) != null) {
            boolean z = this.f1710d != 0 || this.f1711e;
            g.b c2 = c(iVar);
            this.f1710d++;
            while (aVar.a.compareTo((Enum) c2) < 0 && this.a.f1150f.containsKey(iVar)) {
                this.f1713g.add(aVar.a);
                g.a b2 = g.a.b(aVar.a);
                if (b2 != null) {
                    aVar.a(jVar, b2);
                    h();
    ...
    public final g.b c(i iVar) {
        ...
        g.b bVar = null;
        b.c<K, V> cVar = aVar.f1150f.containsKey(iVar) ? aVar.f1150f.get(iVar).f1154e : null;
        g.b bVar2 = cVar != null ? cVar.c.a : null;
        if (!this.f1713g.isEmpty()) {
            ArrayList<g.b> arrayList = this.f1713g;
    ...
    public final void j() {
        ...
        if (jVar != null) {
            while (true) {
                e.c.a.b.a<i, a> aVar = this.a;
                boolean z = true;
                if (!(aVar.f1152e == 0 || (aVar.b.c.a == (bVar = aVar.c.c.a) && this.b == bVar))) {
                    z = false;
                }
                this.f1712f = false;
                if (!z) {
                    if (this.b.compareTo((Enum) aVar.b.c.a) < 0) {
                        ...
                        b.C0023b bVar2 = new b.C0023b(aVar2.c, aVar2.b);
                        aVar2.f1151d.put(bVar2, Boolean.FALSE);
                        while (bVar2.hasNext() && !this.f1712f) {
                            Map.Entry entry = (Map.Entry) bVar2.next();
                            a aVar3 = (a) entry.getValue();
                            while (aVar3.a.compareTo((Enum) this.b) > 0 && !this.f1712f && this.a.contains(entry.getKey())) {
                                int ordinal = aVar3.a.ordinal();
                                g.a aVar4 = ordinal != 2 ? ordinal != 3 ? ordinal != 4 ? null : g.a.ON_PAUSE : g.a.ON_STOP : g.a.ON_DESTROY;
                                if (aVar4 != null) {
                                    this.f1713g.add(aVar4.a());
                                    aVar3.a(jVar, aVar4);
                                    h();
                                } else {
                    ...
                    if (!this.f1712f && cVar != null && this.b.compareTo((Enum) cVar.c.a) > 0) {
                        b<K, V>.d i2 = this.a.i();
                        while (i2.hasNext() && !this.f1712f) {
                            Map.Entry entry2 = (Map.Entry) i2.next();
                            a aVar5 = (a) entry2.getValue();
                            while (aVar5.a.compareTo((Enum) this.b) < 0 && !this.f1712f && this.a.contains(entry2.getKey())) {
                                this.f1713g.add(aVar5.a);
