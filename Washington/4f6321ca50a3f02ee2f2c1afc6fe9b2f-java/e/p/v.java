...
public final class v extends b0.c {
    ...
    public static final Class<?>[] f1718f = {Application.class, u.class};

    /* renamed from: g  reason: collision with root package name */
    public static final Class<?>[] f1719g = {u.class};
    public final Application a;
    public final b0.b b;
    public final Bundle c;

    /* renamed from: d  reason: collision with root package name */
    public final g f1720d;
    ...
    public void b(a0 a0Var) {
        SavedStateHandleController.h(a0Var, this.f1721e, this.f1720d);
    }
    ...
    public <T extends a0> T c(String str, Class<T> cls) {
        ...
        Constructor d2 = (!isAssignableFrom || this.a == null) ? d(cls, f1719g) : d(cls, f1718f);
        if (d2 == null) {
            return (T) this.b.a(cls);
        }
        SavedStateHandleController j2 = SavedStateHandleController.j(this.f1721e, this.f1720d, str, this.c);
        if (isAssignableFrom) {
            try {
