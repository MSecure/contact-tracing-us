            ...
            if (next == 2 && depth <= depth2) {
                ...
                if ("argument".equals(name)) {
                    ...
                    if (string != null) {
                        ...
                        if (a2.f1749i == null) {
                            a2.f1749i = new HashMap<>();
                        }
                        a2.f1749i.put(string, d2);
                            ...
                            if (next2 == 2 && depth4 <= depth3) {
                                if ("argument".equals(xmlResourceParser.getName())) {
                                    ...
                                    if (string5 != null) {
                                        ...
                                        boolean z = d3.c;
                                        if (z && z) {
                                            d3.a.d(bundle, string5, d3.f1726d);
                                        }
    ...
    public final d d(TypedArray typedArray, Resources resources, int i2) {
        ...
        if (pVar17 != null) {
            ...
            if (obj instanceof long[]) {
                ...
                pVar4 = new p.C0047p(obj.getClass());
            } else {
