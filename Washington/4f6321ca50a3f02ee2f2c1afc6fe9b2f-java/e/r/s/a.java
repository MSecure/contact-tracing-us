...
public class a extends q<C0048a> {
    ...
    public ArrayDeque<Integer> f1770d = new ArrayDeque<>();
    ...
    public j b(C0048a aVar, Bundle bundle, o oVar, q.a aVar2) {
        ...
        if (this.b.U()) {
            ...
            if (str != null) {
                ...
                int i2 = oVar != null ? oVar.f1757d : -1;
                int i3 = oVar != null ? oVar.f1758e : -1;
                int i4 = oVar != null ? oVar.f1759f : -1;
                int i5 = oVar != null ? oVar.f1760g : -1;
                ...
                aVar4.q(a2);
                int i6 = aVar3.f1744d;
                boolean isEmpty = this.f1770d.isEmpty();
                boolean z2 = oVar != null && !isEmpty && oVar.a && this.f1770d.peekLast().intValue() == i6;
                if (!isEmpty) {
                    if (z2) {
                        if (this.f1770d.size() > 1) {
                            this.b.a0(f(this.f1770d.size(), this.f1770d.peekLast().intValue()), 1);
                            String f2 = f(this.f1770d.size(), i6);
                            if (aVar4.f1639h) {
                                aVar4.f1638g = true;
                                aVar4.f1640i = f2;
                            } else {
                        ...
                        aVar4.c();
                        if (z) {
                            this.f1770d.add(Integer.valueOf(i6));
                            return aVar3;
                        }
                    } else {
                        String f3 = f(this.f1770d.size() + 1, i6);
                        if (aVar4.f1639h) {
                            aVar4.f1638g = true;
                            aVar4.f1640i = f3;
                        } else {
    ...
    public void c(Bundle bundle) {
        ...
        if (intArray != null) {
            this.f1770d.clear();
            for (int i2 : intArray) {
                this.f1770d.add(Integer.valueOf(i2));
            }
        }
    }
    ...
    public Bundle d() {
        ...
        int[] iArr = new int[this.f1770d.size()];
        Iterator<Integer> it = this.f1770d.iterator();
        int i2 = 0;
        while (it.hasNext()) {
