...
public class i extends RecyclerView.l implements RecyclerView.q {
    ...
    public final StateListDrawable f1796g;

    /* renamed from: h  reason: collision with root package name */
    public final Drawable f1797h;
    ...
    public class b extends RecyclerView.r {
        ...
        public void b(RecyclerView recyclerView, int i2, int i3) {
            ...
            if (z2 || z) {
                if (z2) {
                    float f2 = (float) i4;
                    iVar.f1801l = (int) ((((f2 / 2.0f) + ((float) computeVerticalScrollOffset)) * f2) / ((float) computeVerticalScrollRange));
                    iVar.f1800k = Math.min(i4, (i4 * i4) / computeVerticalScrollRange);
                }
                if (iVar.u) {
    ...
    public class d implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            i.this.f1793d.setAlpha(floatValue);
            i.this.s.invalidate();
        }
    }
    ...
    public i(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i2, int i3, int i4) {
        ...
        this.f1793d = drawable;
        this.f1796g = stateListDrawable2;
        this.f1797h = drawable2;
        this.f1794e = Math.max(i2, stateListDrawable.getIntrinsicWidth());
        this.f1795f = Math.max(i2, drawable.getIntrinsicWidth());
        this.f1798i = Math.max(i2, stateListDrawable2.getIntrinsicWidth());
        this.f1799j = Math.max(i2, drawable2.getIntrinsicWidth());
        this.a = i3;
        this.b = i4;
        ...
        if (this.v != 0) {
            if (motionEvent.getAction() == 0) {
                ...
                if (this.w == 2) {
                    ...
                    if (Math.abs(((float) this.f1801l) - max2) >= 2.0f) {
    ...
    public void e(Canvas canvas, RecyclerView recyclerView, RecyclerView.y yVar) {
        if (this.q != this.s.getWidth() || this.r != this.s.getHeight()) {
            ...
            if (this.t) {
                ...
                this.f1793d.setBounds(0, 0, this.f1795f, this.r);
                RecyclerView recyclerView2 = this.s;
                ...
                if (z2) {
                    this.f1793d.draw(canvas);
                    canvas.translate((float) this.f1794e, (float) i7);
            ...
            if (this.u) {
                ...
                int i12 = this.n;
                int i13 = i11 - (i12 / 2);
                this.f1796g.setBounds(0, 0, i12, i9);
                this.f1797h.setBounds(0, 0, this.q, this.f1799j);
                canvas.translate(0.0f, (float) i10);
                this.f1797h.draw(canvas);
                canvas.translate((float) i13, 0.0f);
                this.f1796g.draw(canvas);
    ...
    public boolean g(float f2, float f3) {
        if (f3 >= ((float) (this.r - this.f1798i))) {
            int i2 = this.o;
            int i3 = this.n;
    ...
    public boolean h(float f2, float f3) {
        ...
        if (recyclerView.getLayoutDirection() == 1) {
            if (f2 > ((float) (this.f1794e / 2))) {
                return false;
            }
        } else if (f2 < ((float) (this.q - this.f1794e))) {
            return false;
        }
        int i2 = this.f1801l;
        int i3 = this.f1800k / 2;
