...
public class c {
    ...
    public static class a {
        ...
        public boolean equals(Object obj) {
            ...
            a aVar = (a) obj;
            if (this.f1890e != aVar.f1890e || !this.a.equals(aVar.a) || this.f1889d != aVar.f1889d) {
                return false;
            }
            if (this.f1892g == 1 && aVar.f1892g == 2 && (str3 = this.f1891f) != null && !str3.equals(aVar.f1891f)) {
                return false;
            }
            if (this.f1892g == 2 && aVar.f1892g == 1 && (str2 = aVar.f1891f) != null && !str2.equals(this.f1891f)) {
                return false;
            }
            int i2 = this.f1892g;
            return (i2 == 0 || i2 != aVar.f1892g || ((str = this.f1891f) == null ? aVar.f1891f == null : str.equals(aVar.f1891f))) && this.c == aVar.c;
        }

        public int hashCode() {
            return (((((this.a.hashCode() * 31) + this.c) * 31) + (this.f1889d ? 1231 : 1237)) * 31) + this.f1890e;
        }
        ...
        public String toString() {
            ...
            h2.append(this.f1890e);
            h2.append(", defaultValue='");
            h2.append(this.f1891f);
            h2.append('\'');
            h2.append('}');
            return h2.toString();
        }
    ...
    public static class b {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final List<String> f1894e;

        public b(String str, String str2, String str3, List<String> list, List<String> list2) {
            this.a = str;
            this.b = str2;
            this.c = str3;
            this.f1893d = Collections.unmodifiableList(list);
            this.f1894e = Collections.unmodifiableList(list2);
        }
        ...
        public boolean equals(Object obj) {
            ...
            b bVar = (b) obj;
            if (this.a.equals(bVar.a) && this.b.equals(bVar.b) && this.c.equals(bVar.c) && this.f1893d.equals(bVar.f1893d)) {
                return this.f1894e.equals(bVar.f1894e);
            }
            return false;
        }
        ...
        public int hashCode() {
            ...
            int hashCode3 = this.f1893d.hashCode();
            return this.f1894e.hashCode() + ((hashCode3 + ((hashCode2 + ((hashCode + (this.a.hashCode() * 31)) * 31)) * 31)) * 31);
        }
    ...
    public c(String str, Map<String, a> map, Set<b> set, Set<d> set2) {
        ...
        this.f1888d = set2 == null ? null : Collections.unmodifiableSet(set2);
    }
                ...
                while (i5 < count) {
                    ...
                    if (v2.getInt(columnIndex7) != 0) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if (cVar.b == i6) {
                                arrayList.add(cVar.f1895d);
                                arrayList2.add(cVar.f1896e);
                            }
                            b2 = b2;
                            count = count;
                        }
    ...
    public boolean equals(Object obj) {
        ...
        Set<d> set3 = this.f1888d;
        if (set3 == null || (set = cVar.f1888d) == null) {
            return true;
        }
