...
public class c implements e.v.a.c {
    ...
    public final c.a f1900d;

    /* renamed from: e  reason: collision with root package name */
    public final boolean f1901e;

    /* renamed from: f  reason: collision with root package name */
    public final Object f1902f = new Object();
    ...
    public static class a extends SQLiteOpenHelper {
        ...
        public class C0057a implements DatabaseErrorHandler {
            ...
            public C0057a(c.a aVar, a[] aVarArr) {
                this.a = aVar;
                this.b = aVarArr;
            }
                ...
                try {
                    ...
                    if (z) {
                        ...
                        try {
                            ...
                            d4.close();
                            if (!hVar.f1870d.equals(string) && !hVar.f1871e.equals(string)) {
    ...
    public final a c() {
        ...
        synchronized (this.f1902f) {
            if (this.f1903g == null) {
                a[] aVarArr = new a[1];
                if (Build.VERSION.SDK_INT < 23 || this.c == null || !this.f1901e) {
                    this.f1903g = new a(this.b, this.c, aVarArr, this.f1900d);
                } else {
                    this.f1903g = new a(this.b, new File(this.b.getNoBackupFilesDir(), this.c).getAbsolutePath(), aVarArr, this.f1900d);
                }
                this.f1903g.setWriteAheadLoggingEnabled(this.f1904h);
            }
            aVar = this.f1903g;
        }
        return aVar;
