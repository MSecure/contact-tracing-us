...
public abstract class a0 extends h {
    ...
    public static class a extends AnimatorListenerAdapter implements h.d {
        ...
        public final void g(boolean z) {
            ViewGroup viewGroup;
            if (this.f1906d && this.f1907e != z && (viewGroup = this.c) != null) {
                this.f1907e = z;
                r.a(viewGroup, z);
            }
        }
    ...
    public static class b {
        ...
        /* renamed from: e  reason: collision with root package name */
        public ViewGroup f1910e;

        /* renamed from: f  reason: collision with root package name */
        public ViewGroup f1911f;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x007f, code lost:
        if (r0.f1910e == null) goto L_0x0088;
     */
    ...
    public final b I(p pVar, p pVar2) {
        ...
        if (pVar == null || !pVar.a.containsKey("android:visibility:visibility")) {
            ...
            bVar.f1910e = (ViewGroup) pVar.a.get("android:visibility:parent");
        }
        if (pVar2 == null || !pVar2.a.containsKey("android:visibility:visibility")) {
            bVar.f1909d = -1;
            bVar.f1911f = null;
        } else {
            bVar.f1909d = ((Integer) pVar2.a.get("android:visibility:visibility")).intValue();
            bVar.f1911f = (ViewGroup) pVar2.a.get("android:visibility:parent");
        }
        if (pVar != null && pVar2 != null) {
            int i2 = bVar.c;
            int i3 = bVar.f1909d;
            if (i2 == i3 && bVar.f1910e == bVar.f1911f) {
                return bVar;
            }
            if (i2 != i3) {
                if (i2 != 0) {
            ...
            bVar.a = true;
            return bVar;
        } else if (!(pVar == null && bVar.f1909d == 0)) {
            if (pVar2 == null) {
            }
            return bVar;
        }
    ...
    public Animator k(ViewGroup viewGroup, p pVar, p pVar2) {
        ...
        Float f2;
        b I = I(pVar, pVar2);
        if (!I.a || (I.f1910e == null && I.f1911f == null)) {
            return null;
        }
        float f3 = 0.0f;
        boolean z6 = true;
