...
public class b extends h {
    ...
    public Animator k(ViewGroup viewGroup, p pVar, p pVar2) {
        ...
        if (i2 != 2) {
            ...
            bVar = this;
            i iVar = new i(view);
            ObjectAnimator F0 = m.h.F0(iVar, B, bVar.u.a((float) i3, (float) i5, (float) i4, (float) i6));
            ObjectAnimator F02 = m.h.F0(iVar, C, bVar.u.a((float) i7, (float) i9, (float) i8, (float) i10));
        ...
        objectAnimator = m.h.F0(view, property, path);
        if (view.getParent() instanceof ViewGroup) {
        }
        return objectAnimator;
    }
