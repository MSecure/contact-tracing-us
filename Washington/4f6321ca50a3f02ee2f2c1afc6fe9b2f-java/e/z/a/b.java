...
public class b extends ViewGroup {
    ...
    public static class g extends e.k.a.a {
        ...
        /* renamed from: e  reason: collision with root package name */
        public Parcelable f2015e;

        /* renamed from: f  reason: collision with root package name */
        public ClassLoader f2016f;
        ...
        public g(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f2015e = parcel.readParcelable(classLoader);
            this.f2016f = classLoader;
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            parcel.writeParcelable(this.f2015e, i2);
        }
    }
    ...
    public void addView(View view, int i2, ViewGroup.LayoutParams layoutParams) {
        ...
        boolean z2 = dVar.a | (view.getClass().getAnnotation(AbstractC0063b.class) != null);
        dVar.a = z2;
        if (!this.f2012k) {
    ...
    public void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f2007f > 0 && this.f2008g != null) {
            throw null;
        }
    }
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        this.f2009h = paddingTop;
        this.f2010i = i11 - paddingBottom;
        this.x = i12;
        if (!this.w) {
            this.w = false;
            return;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        this.f2011j = View.MeasureSpec.makeMeasureSpec(measuredHeight, 1073741824);
        this.f2012k = true;
        f();
        this.f2012k = false;
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8 && ((dVar = (d) childAt2.getLayoutParams()) == null || !dVar.a)) {
                ...
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) paddingLeft) * 0.0f), 1073741824), this.f2011j);
            }
        }
    }
    ...
    public boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.f2008g;
    }
}
