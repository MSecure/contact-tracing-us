...
public class c extends Thread {
    ...
    public void run() {
        ...
        Objects.requireNonNull((h) this.f2022d);
        while (true) {
            try {
                a();
