...
public class i extends Thread {
    ...
    public final void a() {
        ...
        try {
            ...
            take.m();
            TrafficStats.setThreadStatsTag(take.f2033e);
            k f2 = ((b) this.c).f(take);
            take.a("network-http-complete");
            if (f2.f2031e) {
                synchronized (take.f2034f) {
                    z = take.f2039k;
                }
                if (z) {
                    take.c("not-modified");
            ...
            ((f) this.f2028e).a(take, q, null);
            take.o(q);
        } catch (u e2) {
            SystemClock.elapsedRealtime();
            Objects.requireNonNull(take);
            f fVar = (f) this.f2028e;
