...
public abstract class n<T> implements Comparable<n<T>> {
    ...
    public void c(String str) {
        ...
        if (oVar != null) {
            ...
            synchronized (oVar.f2051j) {
                for (o.a aVar : oVar.f2051j) {
                    aVar.a(this);
                }
            }
        }
    ...
    public int compareTo(Object obj) {
        ...
        return this.f2036h.intValue() - nVar.f2036h.intValue();
    }
    ...
    public void o(p<?> pVar) {
        ...
        if (bVar != null) {
            ...
            b.a aVar2 = pVar.b;
            if (aVar2 != null) {
                if (!(aVar2.f2017d < System.currentTimeMillis())) {
                    String h2 = h();
                    synchronized (aVar) {
                    ...
                    if (remove != null) {
                        ...
                        for (n<?> nVar : remove) {
                            ((f) aVar.b.f2023e).a(nVar, pVar, null);
                        }
                        return;
                    }
                    return;
    ...
    public String toString() {
        ...
        h2.append(Integer.toHexString(this.f2033e));
