...
public final /* synthetic */ class a implements d {
    ...
    public final Object a(b bVar) {
        ...
        while (t.hasNext()) {
            ...
            arrayList.add(String.format(Locale.ENGLISH, "%s.%d.%d.%d", r.f2114h.c(next.c()), Integer.valueOf(next.a()), Integer.valueOf(next.d()), Integer.valueOf(next.e())));
        }
        Collections.sort(arrayList);
        String a2 = r.f2113g.a(arrayList);
        tVar.g().size();
        try {
            Mac instance = Mac.getInstance("HmacSHA256");
            f.b.b.c.a aVar = r.f2114h;
            ...
            r.a aVar2 = new r.a(rVar.f2116d, rVar.b, put2, new f(rVar, put2, bVar, tVar), new c(rVar, bVar), rVar.f2117e, tVar.f());
            rVar.c.a(aVar2);
            return aVar2;
