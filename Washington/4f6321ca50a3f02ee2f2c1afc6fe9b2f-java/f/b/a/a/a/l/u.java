    ...
    public f.b.b.f.a.u<t> b(t tVar) {
        ...
        try {
            ...
            while (t.hasNext()) {
                ...
                jSONArray.put(new JSONObject().put("key", s.f2119h.c(next.c())).put("rollingStartNumber", next.a()).put("rollingPeriod", next.d()).put("transmissionRisk", next.e()));
            }
        ...
        return l.x(uVar).z(new k(sVar, tVar), sVar.f2120d).z(new i(sVar, tVar), sVar.f2121e);
    }
}
