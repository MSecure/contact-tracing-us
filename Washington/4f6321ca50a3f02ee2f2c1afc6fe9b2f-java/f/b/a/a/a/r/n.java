...
public final /* synthetic */ class n implements i {
    ...
    public final u a(Object obj) {
        ...
        if (!((Boolean) obj).booleanValue() || !w.b()) {
            return new s.a(new SubmitPrivateAnalyticsWorker.b(null));
        }
        b0 b0Var = submitPrivateAnalyticsWorker.f389e;
        z zVar = b0Var.c;
        Objects.requireNonNull(zVar);
        return l.x(l.x(m.h.f0(new d(zVar))).y(new b(zVar), zVar.f2241d)).y(new k(b0Var), b0Var.a);
    }
}
