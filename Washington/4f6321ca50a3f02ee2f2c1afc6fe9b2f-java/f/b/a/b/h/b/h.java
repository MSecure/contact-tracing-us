...
public final class h extends a {
        ...
        if (num != null ? num.equals(((h) obj).a) : ((h) obj).a == null) {
            ...
            if (str != null ? str.equals(((h) obj).b) : ((h) obj).b == null) {
                ...
                if (str2 != null ? str2.equals(((h) obj).c) : ((h) obj).c == null) {
                    ...
                    if (str3 != null ? str3.equals(((h) obj).f2302d) : ((h) obj).f2302d == null) {
                        String str4 = this.f2303e;
                        if (str4 != null ? str4.equals(((h) obj).f2303e) : ((h) obj).f2303e == null) {
                            String str5 = this.f2304f;
                            if (str5 != null ? str5.equals(((h) obj).f2304f) : ((h) obj).f2304f == null) {
                                String str6 = this.f2305g;
                                if (str6 != null ? str6.equals(((h) obj).f2305g) : ((h) obj).f2305g == null) {
                                    String str7 = this.f2306h;
                                    String str8 = ((h) obj).f2306h;
                                    if (str7 == null) {
                                        if (str8 == null) {
                                            return true;
                                        }
    ...
    public String toString() {
        ...
        h2.append(this.c);
        h2.append(", device=");
        h2.append(this.f2302d);
        h2.append(", product=");
        h2.append(this.f2303e);
        h2.append(", osBuild=");
        h2.append(this.f2304f);
        h2.append(", manufacturer=");
        h2.append(this.f2305g);
        h2.append(", fingerprint=");
        return a.e(h2, this.f2306h, "}");
    }
}
