            ...
            if (it.hasNext()) {
                ...
                while (it2.hasNext()) {
                    ...
                    if (bVar.equals(new f.b.a.b.b("proto"))) {
                        ...
                        Log.w(m.h.o0("CctTransportBackend"), String.format("Received event of unsupported encoding %s. Skipping...", bVar));
                        it2 = it2;
                        it = it;
                    }
                ...
                try {
                    b bVar2 = (b) m.h.W0(5, new a(url, iVar, str4), new c(this), d.a);
                    int i2 = bVar2.a;
                    if (i2 == 200) {
