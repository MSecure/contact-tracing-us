...
public class l {
    ...
    public final Executor f2384e;

    /* renamed from: f  reason: collision with root package name */
    public final b f2385f;

    /* renamed from: g  reason: collision with root package name */
    public final a f2386g;
    ...
    public void a(i iVar, int i2) {
        ...
        Iterable<h> iterable = (Iterable) this.f2385f.c(new h(this, iVar));
        if (iterable.iterator().hasNext()) {
            ...
            this.f2385f.c(new i(this, b2, iterable, iVar, i2));
        }
    }
}
