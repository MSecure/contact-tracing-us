...
public class d extends e {
    ...
    public static final d f2406d = new d();
    ...
    public boolean c(@RecentlyNonNull Activity activity, @RecentlyNonNull int i2, @RecentlyNonNull int i3, DialogInterface.OnCancelListener onCancelListener) {
        ...
        if (activity instanceof o) {
            ...
            kVar.B0(n, "GooglePlayServicesErrorDialog");
        } else {
    ...
    public final void d(Context context, int i2, PendingIntent pendingIntent) {
        ...
        if (i2 == 18) {
            ...
            if (b.k1(context)) {
                ...
                iVar.f1403h = 2;
                if (b.l1(context)) {
                    iVar.b.add(new g(R$drawable.common_full_open_on_phone, resources.getString(R$string.common_open_on_phone), pendingIntent));
                } else {
                    iVar.f1402g = pendingIntent;
                }
            } else {
                iVar.q.icon = 17301642;
                iVar.q.tickerText = i.b(resources.getString(R$string.common_google_play_services_notification_ticker));
