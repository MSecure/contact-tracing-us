...
public final class a<O extends c> {
    ...
    public static abstract class AbstractC0080a<T extends e, O> extends d<T, O> {
        @RecentlyNonNull
        @Deprecated
    ...
    public interface c {
        ...
        public interface AbstractC0081a extends c {
            @RecentlyNonNull
            Account a();
        }
    ...
    public <C extends e> a(@RecentlyNonNull String str, @RecentlyNonNull AbstractC0080a<C, O> aVar, @RecentlyNonNull f<C> fVar) {
