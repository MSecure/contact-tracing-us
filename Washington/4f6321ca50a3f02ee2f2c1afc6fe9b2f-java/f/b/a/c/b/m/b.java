...
public abstract class b<T extends IInterface> {
    ...
    public final Object f2444g = new Object();
    ...
    public final ArrayList<h<?>> f2448k = new ArrayList<>();
    ...
    public abstract class f extends h<Boolean> {
        ...
        public final /* synthetic */ void a(Boolean bool) {
            ...
            if (this.f2450d != 0) {
                ...
                d(new f.b.a.c.b.a(this.f2450d, pendingIntent));
            } else if (!e()) {
                b.this.B(1, null);
        ...
        public final void handleMessage(Message message) {
            ...
            if (b.this.u.get() == message.arg1) {
                ...
                if (i3 == 4) {
                    ...
                    b.this.f2446i.a(new f.b.a.c.b.a(message.arg2, pendingIntent));
                    Objects.requireNonNull(b.this);
                    System.currentTimeMillis();
                } else if (i3 == 6) {
                    b.this.B(5, null);
    ...
    public abstract class h<TListener> {
        ...
        public final void c() {
            ...
            synchronized (b.this.f2448k) {
                b.this.f2448k.remove(this);
            }
        }
    }
    ...
    public final class i implements ServiceConnection {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            synchronized (bVar.f2444g) {
                ...
                bVar2.f2445h = (queryLocalInterface == null || !(queryLocalInterface instanceof k)) ? new j(iBinder) : (k) queryLocalInterface;
            }
            b bVar3 = b.this;
            int i2 = this.a;
            Handler handler = bVar3.f2442e;
            handler.sendMessage(handler.obtainMessage(7, i2, -1, new l(0)));
        }

        public final void onServiceDisconnected(ComponentName componentName) {
            b bVar;
            synchronized (b.this.f2444g) {
                bVar = b.this;
                bVar.f2445h = null;
            }
            Handler handler = bVar.f2442e;
    ...
    public final class k extends f {
        ...
        public final boolean e() {
            try {
                ...
                IInterface q = b.this.q(this.f2453g);
    ...
    public final class l extends f {
        ...
        @Override // f.b.a.c.b.m.b.f
        public final boolean e() {
            b.this.f2446i.a(f.b.a.c.b.a.f2402f);
            return true;
        }
    }
    ...
    public void a(@RecentlyNonNull e eVar) {
        r rVar = (r) eVar;
        f.b.a.c.b.l.l.e.this.f2421j.post(new s(rVar));
    }
    ...
    public void h(h hVar, @RecentlyNonNull Set<Scope> set) {
        Bundle s2 = s();
        e eVar = new e(this.p);
        eVar.f2471e = this.c.getPackageName();
        eVar.f2474h = s2;
        if (set != null) {
            eVar.f2473g = (Scope[]) set.toArray(new Scope[set.size()]);
        }
        if (l()) {
    ...
    public void j() {
        ...
        synchronized (this.f2448k) {
            int size = this.f2448k.size();
            for (int i2 = 0; i2 < size; i2++) {
                h<?> hVar = this.f2448k.get(i2);
                synchronized (hVar) {
                    hVar.a = null;
                }
            }
