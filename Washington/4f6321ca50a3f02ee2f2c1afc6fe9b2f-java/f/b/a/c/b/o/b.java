...
public final class b {
    ...
    public static Executor A1(Executor executor, f.b.b.f.a.b<?> bVar) {
        Objects.requireNonNull(executor);
        return executor == k.INSTANCE ? executor : new x(executor, bVar);
    }
    ...
    public static <T> T B(T t, String str, Object obj) {
        ...
        throw new NullPointerException(n1(str, obj));
    }
    ...
    public static <T> T B1(T t, String str) {
        if (t != null) {
            return t;
        }
    ...
    public static int C0(long j2, int i2) {
        long j3 = (long) i2;
        return (int) (((j2 % j3) + j3) % j3);
    }

    public static TypedValue C1(Context context, int i2) {
    ...
    public static boolean D1(Context context, int i2, boolean z) {
        TypedValue C1 = C1(context, i2);
        return (C1 == null || C1.type != 18) ? z : C1.data != 0;
    }
    ...
    public static void E(int i2, int i3, int i4) {
        ...
        if (i2 < 0 || i3 < i2 || i3 > i4) {
            if (i2 < 0 || i2 > i4) {
                ...
                str = n1("end index (%s) must not be less than start index (%s)", Integer.valueOf(i3), Integer.valueOf(i2));
            }
    ...
    public static int E1(Context context, int i2, String str) {
        TypedValue C1 = C1(context, i2);
        if (C1 != null) {
            return C1.data;
        }
    ...
    public static Object F1(Context context, int[] iArr, int i2, int i3, j.j.a.b bVar, int i4) {
        int[] iArr2;
        if ((i4 & 1) != 0) {
    ...
    public static void H(boolean z, String str, Object obj) {
        if (!z) {
            throw new IllegalStateException(n1(str, obj));
        }
    }
    ...
    public static b0.b I0(ComponentActivity componentActivity) {
        return P0(((g.a.a.b.b.a) H0(componentActivity, g.a.a.b.b.a.class)).a());
    }

    public static long I1(long j2, int i2) {
        if (i2 != -1) {
            if (i2 == 0) {
                return 0;
            }
    ...
    public static int J0(Context context, int i2, int i3) {
        TypedValue C1 = C1(context, i2);
        return C1 != null ? C1.data : i3;
    }

    public static long J1(long j2, long j3) {
        if (j3 == 1) {
            return j2;
        }
        if (j2 == 1) {
    ...
    public static int K0(View view, int i2) {
        return E1(view.getContext(), i2, view.getClass().getCanonicalName());
    }
    ...
    public static long L1(long j2, long j3) {
        long j4 = j2 - j3;
        if ((j2 ^ j4) >= 0 || (j2 ^ j3) >= 0) {
            return j4;
        }
    ...
    public static l1 O() {
        return l2.f3649e == null ? new l2() : new h.a.j1.h();
    }

    public static Drawable O0(Context context, TypedArray typedArray, int i2) {
        int resourceId;
        Drawable b2;
    ...
    public static void O1(View view, g gVar) {
    ...
    public static b0.b P0(Set<b0.b> set) {
        if (set.isEmpty()) {
            return null;
        }
        if (set.size() <= 1) {
    ...
    public static b0.b Q0(l lVar) {
        return P0(((g.a.a.b.b.b) H0(lVar, g.a.a.b.b.b.class)).b());
    }
    ...
    public static Set<c1.b> R0(Map<String, ?> map, String str) {
        c1.b bVar;
        ...
        for (Object obj : b2) {
            if (obj instanceof Double) {
                ...
                boolean z = true;
                v.a(((double) intValue) == d2.doubleValue(), "Status code %s is not integral", obj);
                bVar = c1.c(intValue).a;
                if (bVar.b != d2.intValue()) {
                    z = false;
                }
                v.a(z, "Status code %s is not valid", obj);
    ...
    public static int S(int i2, byte[] bArr, int i3, int i4, z.c<?, ?> cVar, z.e<?, ?> eVar, r1<s1, s1> r1Var, f fVar) {
        ...
        int i9;
        f.b.f.c cVar2;
        Object obj3 = s1.f3368f;
        f.b.f.v<z.d> vVar = cVar.extensions;
        int i10 = i2 >>> 3;
        z.d dVar2 = eVar.f3418d;
        Object obj4 = null;
        if (!dVar2.f3416e || !dVar2.f3417f) {
            y1 y1Var = dVar2.f3415d;
            if (y1Var == y1.ENUM) {
                i6 = m0(bArr, i3, fVar);
                if (eVar.f3418d.b.findValueByNumber(fVar.a) == null) {
                ...
                if (!dVar.f3416e) {
                    ...
                    int ordinal = dVar.f3415d.ordinal();
                    if ((ordinal == 9 || ordinal == 10) && (g2 = vVar.g(eVar.f3418d)) != null) {
                        obj4 = f.b.f.c0.c(g2, obj4);
                    }
                    vVar.o(eVar.f3418d, obj4);
                }
                return i3;
            }
            i3 = i6;
        ...
        switch (dVar2.f3415d.ordinal()) {
            ...
            case 13:
                ...
                s1 s1Var = (s1) f.b.f.l1.y(i10, b0Var3, eVar.f3418d.b, obj4, r1Var);
                if (s1Var != null) {
                    cVar.unknownFields = s1Var;
                }
                vVar.o(eVar.f3418d, b0Var3);
                return f0;
            case 16:
        ...
        vVar.o(eVar.f3418d, cVar2);
        return i9;
    }

    public static List<Map<String, ?>> S0(Map<String, ?> map) {
        String g2;
    ...
    public static c1 S1(q qVar) {
        ...
        Throwable A = qVar.A();
        if (A == null) {
            return c1.f3518g.g("io.grpc.Context was cancelled without error");
        }
        if (A instanceof TimeoutException) {
            return c1.f3520i.g(A.getMessage()).f(A);
        }
        c1 d2 = c1.d(A);
        return (!c1.b.UNKNOWN.equals(d2.a) || d2.c != A) ? d2.f(A) : c1.f3518g.g("Context cancelled").f(A);
    }
    ...
    public static List<s2> V1(List<Map<String, ?>> list) {
        if (list == null) {
            return null;
        }
        ArrayList arrayList = new ArrayList();
    ...
    public static final int W0(Context context, int i2) {
    ...
    public static int X1(int i2, int i3) {
        String str;
        if (i2 >= 0 && i2 < i3) {
            return i2;
        }
        if (i2 < 0) {
            str = a2("%s (%s) must not be negative", "index", Integer.valueOf(i2));
        } else if (i3 < 0) {
            ...
            str = a2("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i2), Integer.valueOf(i3));
        }
        throw new IndexOutOfBoundsException(str);
    }
    ...
    public static final int Y0(Context context, int i2, int i3) {
        e.c(context, "$this$getThemeColor");
        TypedValue typedValue = new TypedValue();
        if (!context.getTheme().resolveAttribute(i2, typedValue, true)) {
            return i3;
    ...
    public static <TResult> TResult Y1(h<TResult> hVar) {
        if (hVar.n()) {
            return hVar.k();
        }
        if (hVar.l()) {
    ...
    public static String Z1(int i2, int i3, String str) {
        if (i2 < 0) {
    ...
    public static void a(byte b2, byte b3, byte b4, byte b5, char[] cArr, int i2) {
        if (!h1(b3)) {
            if ((((b3 + 112) + (b2 << 28)) >> 30) == 0 && !h1(b4) && !h1(b5)) {
    ...
    public static void a1(boolean z, String str, Object... objArr) {
        if (!z) {
            z0(str, objArr);
            throw null;
        }
    ...
    public static void b2(int i2, int i3, int i4) {
        String str;
        if (i2 < 0 || i3 < i2 || i3 > i4) {
            if (i2 < 0 || i2 > i4) {
                str = Z1(i2, i4, "start index");
            } else if (i3 < 0 || i3 > i4) {
                str = Z1(i3, i4, "end index");
            } else {
    ...
    public static void f(byte b2, byte b3, byte b4, char[] cArr, int i2) {
        if (h1(b3) || ((b2 == -32 && b3 < -96) || ((b2 == -19 && b3 >= -96) || h1(b4)))) {
            throw d0.c();
        }
    ...
    public static f.b.c.k.u.l h0(String str) {
        ...
        a1(length >= 2, "Invalid path \"%s\"", str);
        if (length == 2) {
            a1(str.charAt(0) == 1 && str.charAt(1) == 1, "Non-empty path \"%s\" had length 2", str);
    ...
    public static boolean h1(byte b2) {
        return b2 > -65;
    }
    ...
    public static String k(int i2, int i3, String str) {
        if (i2 < 0) {
            return n1("%s (%s) must not be negative", str, Integer.valueOf(i2));
        } else if (i3 >= 0) {
            return n1("%s (%s) must not be greater than size (%s)", str, Integer.valueOf(i2), Integer.valueOf(i3));
        } else {
    ...
    public static float o1(float f2, float f3, float f4) {
        return (f4 * f3) + ((1.0f - f4) * f2);
    }

    public static void p(boolean z, String str, char c2) {
        if (!z) {
            throw new IllegalArgumentException(n1(str, Character.valueOf(c2)));
        }
    }
    ...
    public static final <T> List<T> p1(T t) {
    ...
    public static void q(boolean z, String str, int i2) {
        if (!z) {
            throw new IllegalArgumentException(n1(str, Integer.valueOf(i2)));
        }
    }
    ...
    public static <T> List<T> q1(Class<T> cls, Iterable<Class<?>> iterable, ClassLoader classLoader, b1<T> b1Var) {
        boolean z;
        ?? r7;
        try {
    ...
    public static void r(boolean z, String str, long j2) {
        if (!z) {
            throw new IllegalArgumentException(n1(str, Long.valueOf(j2)));
        }
    }
    ...
    public static void s(boolean z, String str, Object obj) {
        if (!z) {
            throw new IllegalArgumentException(n1(str, obj));
        }
    }
    ...
    public static View t1(RecyclerView.b0 b0Var) {
        e.c(b0Var, "viewHolder");
        return null;
    }
    ...
    public static List u1(RecyclerView.b0 b0Var) {
        e.c(b0Var, "viewHolder");
        return null;
    }
    ...
    public static PorterDuff.Mode v1(int i2, PorterDuff.Mode mode) {
        if (i2 == 3) {
    ...
    public static int w(int i2, int i3) {
        ...
        if (i2 < 0) {
            str = n1("%s (%s) must not be negative", "index", Integer.valueOf(i2));
        } else if (i3 >= 0) {
            str = n1("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i2), Integer.valueOf(i3));
        } else {
            throw new IllegalArgumentException(a.q("negative size: ", i3));
        }
        throw new IndexOutOfBoundsException(str);
    ...
    public static void w1(AnimatorSet animatorSet, List<Animator> list) {
        int size = list.size();
        long j2 = 0;
    ...
    public static final Boolean x0(Context context, Boolean bool, String str) {
        ...
        if (V0.length() > 0) {
            try {
                return Boolean.valueOf(Boolean.parseBoolean(V0));
            } catch (Exception unused) {
            }
        }
        return null;
    ...
    public static final void x1(StringBuilder sb, int i2, String str, Object obj) {
        String w0;
        if (obj instanceof List) {
            ...
            if (obj instanceof String) {
                ...
                if (obj instanceof z) {
                    ...
                    int i5 = i2 + 2;
                    x1(sb, i5, "key", entry2.getKey());
                    x1(sb, i5, "value", entry2.getValue());
                    sb.append("\n");
                    while (i3 < i2) {
                        sb.append(' ');
                        i3++;
    ...
    public static Context y1(g.a.a.b.d.a aVar) {
     ...
     */
    public static void z1(t0 t0Var, StringBuilder sb, int i2) {
        Object obj;
        String str;
        boolean z;
        Object obj2;
        ...
        while (it.hasNext()) {
            ...
            if (substring.endsWith("Map") && !substring.equals("Map")) {
                ...
                if (method3 != null && method3.getReturnType().equals(Map.class) && !method3.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method3.getModifiers())) {
                    x1(sb, i2, m(str4), z.invokeOrDie(method3, t0Var, new Object[0]));
                }
            }
        ...
        if (t0Var instanceof z.c) {
            ...
            while (l2.hasNext()) {
                ...
                h3.append("]");
                x1(sb, i2, h3.toString(), next.getValue());
            }
        }
        s1 s1Var = ((z) t0Var).unknownFields;
        if (s1Var != null) {
            for (int i3 = 0; i3 < s1Var.a; i3++) {
                x1(sb, i2, String.valueOf(s1Var.b[i3] >>> 3), s1Var.c[i3]);
            }
        }
    }
}
