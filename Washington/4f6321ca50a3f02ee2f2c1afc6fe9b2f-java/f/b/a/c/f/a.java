...
public final class a {
    ...
    public static boolean a(Context context) {
        ...
        HashMap<String, Boolean> hashMap = h2.f2503g;
        synchronized (h2.class) {
            str = null;
        ...
        synchronized (h2.class) {
            h2.a(contentResolver);
            Object obj2 = h2.f2507k;
            if (h2.f2502f.containsKey("gms:nearby:requires_gms_check")) {
                str2 = h2.f2502f.get("gms:nearby:requires_gms_check");
            } else {
                for (String str3 : h2.m) {
                    if ("gms:nearby:requires_gms_check".startsWith(str3)) {
                        if (!h2.f2508l || h2.f2502f.isEmpty()) {
                            String[] strArr = h2.m;
                            HashMap<String, String> hashMap2 = h2.f2502f;
        ...
        if (str != null && !str.equals("")) {
            if (!h2.c.matcher(str).matches()) {
                if (h2.f2500d.matcher(str).matches()) {
                    bool2 = Boolean.FALSE;
                    z = false;
                } else {
            ...
            HashMap<String, Boolean> hashMap3 = h2.f2503g;
            synchronized (h2.class) {
                if (obj == h2.f2507k) {
                    hashMap3.put("gms:nearby:requires_gms_check", bool2);
                    h2.f2502f.remove("gms:nearby:requires_gms_check");
                }
            }
            return z;
        }
        bool2 = bool3;
        HashMap<String, Boolean> hashMap32 = h2.f2503g;
        synchronized (h2.class) {
        }
    }
}
