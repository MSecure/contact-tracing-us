...
public class a extends f<f> implements f.b.a.c.h.f {
    ...
    public final void m(d dVar) {
        ...
        try {
            ...
            ((f) t()).s(new l(new u(account, num.intValue(), googleSignInAccount)), dVar);
    ...
    @RecentlyNonNull
    public Bundle s() {
        if (!this.c.getPackageName().equals(this.z.f2457e)) {
            this.A.putString("com.google.android.gms.signin.internal.realClientPackageName", this.z.f2457e);
        }
        return this.A;
    }
