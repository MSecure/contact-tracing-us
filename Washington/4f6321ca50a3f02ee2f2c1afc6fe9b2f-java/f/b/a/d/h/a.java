...
public class a {
    ...
    public Drawable f2609h;

    /* renamed from: i  reason: collision with root package name */
    public Drawable f2610i;

    /* renamed from: j  reason: collision with root package name */
    public ColorStateList f2611j;

    /* renamed from: k  reason: collision with root package name */
    public ColorStateList f2612k;
    ...
    public final float a() {
        float b2 = b(this.f2613l.a, this.c.l());
        d dVar = this.f2613l.b;
        g gVar = this.c;
        float max = Math.max(b2, b(dVar, gVar.b.a.f2789f.a(gVar.h())));
        d dVar2 = this.f2613l.c;
        g gVar2 = this.c;
        float b3 = b(dVar2, gVar2.b.a.f2790g.a(gVar2.h()));
        d dVar3 = this.f2613l.f2787d;
        g gVar3 = this.c;
        return Math.max(max, Math.max(b3, b(dVar3, gVar3.b.a.f2791h.a(gVar3.h()))));
    }
    ...
    public final Drawable e() {
        if (this.n == null) {
            ...
            this.q = new g(this.f2613l);
            this.n = new RippleDrawable(this.f2611j, null, this.q);
        }
        if (this.o == null) {
            StateListDrawable stateListDrawable = new StateListDrawable();
            Drawable drawable = this.f2610i;
            if (drawable != null) {
                stateListDrawable.addState(t, drawable);
            }
            LayerDrawable layerDrawable = new LayerDrawable(new Drawable[]{this.n, this.f2605d, stateListDrawable});
    ...
    public void g(Drawable drawable) {
        this.f2610i = drawable;
        if (drawable != null) {
            Drawable w1 = m.h.w1(drawable.mutate());
            this.f2610i = w1;
            w1.setTintList(this.f2612k);
        }
        if (this.o != null) {
            StateListDrawable stateListDrawable = new StateListDrawable();
            Drawable drawable2 = this.f2610i;
            if (drawable2 != null) {
    ...
    public void k() {
        ...
        Rect rect = this.b;
        materialCardView.f1160f.set(rect.left + i2, rect.top + i2, rect.right + i2, rect.bottom + i2);
        ((b) e.d.a.a.f1157j).c(materialCardView.f1162h);
    }
    ...
    public void l() {
        ...
        this.a.setForeground(f(this.f2609h));
    }
    ...
    public final void m() {
        ...
        if (drawable != null) {
            ((RippleDrawable) drawable).setColor(this.f2611j);
            return;
        }
        g gVar = this.p;
        if (gVar != null) {
    ...
    public void n() {
        this.f2605d.u((float) this.f2608g, this.m);
    }
}
