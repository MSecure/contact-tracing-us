...
public class v extends BaseAdapter {
    ...
    public static final int f2648g = d0.g().getMaximum(4);
    public final u b;
    public final f<?> c;

    /* renamed from: d  reason: collision with root package name */
    public Collection<Long> f2649d;
    ...
    public int d() {
        return (this.b.s() + this.b.f2645f) - 1;
    }

    public final TextView e(TextView textView, long j2) {
        b bVar;
        if (this.f2651f.f2618d.f(j2)) {
    ...
    public int getCount() {
        return b() + this.b.f2645f;
    }

    public long getItemId(int i2) {
        return (long) (i2 / this.b.f2644e);
    }
