...
public class x extends RecyclerView.e<a> {
    ...
    public x(Context context, f<?> fVar, a aVar, i.f fVar2) {
        ...
        if (uVar.compareTo(uVar3) > 0) {
            ...
            this.c = context;
            this.f2655g = dimensionPixelSize + dimensionPixelSize2;
            this.f2652d = aVar;
            this.f2653e = fVar;
            this.f2654f = fVar2;
            o(true);
    ...
    public int c() {
        return this.f2652d.f2621g;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.e
    public long d(int i2) {
        return this.f2652d.b.v(i2).b.getTimeInMillis();
    }
    ...
    public void g(a aVar, int i2) {
        ...
        if (materialCalendarGridView.getAdapter() == null || !v.equals(materialCalendarGridView.getAdapter().b)) {
            v vVar = new v(v, this.f2653e, this.f2652d);
            materialCalendarGridView.setNumColumns(v.f2644e);
            materialCalendarGridView.setAdapter((ListAdapter) vVar);
        } else {
            materialCalendarGridView.invalidate();
            v a2 = materialCalendarGridView.getAdapter();
            for (Long l2 : a2.f2649d) {
    ...
    public a i(ViewGroup viewGroup, int i2) {
        ...
        linearLayout.setLayoutParams(new RecyclerView.n(-1, this.f2655g));
        return new a(linearLayout, true);
    }

    public u p(int i2) {
        return this.f2652d.b.v(i2);
    }

    public int q(u uVar) {
        return this.f2652d.b.w(uVar);
    }
}
