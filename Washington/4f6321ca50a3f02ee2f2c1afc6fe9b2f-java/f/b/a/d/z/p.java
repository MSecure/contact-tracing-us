...
public class p extends d {
    ...
    public p(Context context, AttributeSet attributeSet) {
        ...
        this.f2860f = (AccessibilityManager) context2.getSystemService("accessibility");
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (View.MeasureSpec.getMode(i2) == Integer.MIN_VALUE) {
            ...
            if (!(adapter == null || b == null)) {
                ...
                k0 k0Var = this.f2859e;
                int min = Math.min(adapter.getCount(), Math.max(0, !k0Var.c() ? -1 : k0Var.f908d.getSelectedItemPosition()) + 15);
                View view = null;
                int i5 = 0;
                ...
                Drawable i6 = this.f2859e.i();
                if (i6 != null) {
                    i6.getPadding(this.f2861g);
    ...
    public <T extends ListAdapter & Filterable> void setAdapter(T t) {
        super.setAdapter(t);
        this.f2859e.o(getAdapter());
    }

    public void showDropDown() {
        AccessibilityManager accessibilityManager = this.f2860f;
