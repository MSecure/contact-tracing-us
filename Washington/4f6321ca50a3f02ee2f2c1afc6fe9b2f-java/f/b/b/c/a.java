...
public abstract class a {
        ...
        public C0103a(String str, char[] cArr) {
            ...
            try {
                ...
                try {
                    ...
                    this.f2910g = bArr;
                    boolean[] zArr = new boolean[this.f2908e];
                    for (int i3 = 0; i3 < this.f2909f; i3++) {
                        zArr[f.b.b.d.a.a(i3 * 8, this.f2907d, RoundingMode.CEILING)] = true;
                    }
                    this.f2911h = zArr;
    ...
    public static final class b extends e {
        ...
        /* renamed from: g  reason: collision with root package name */
        public final char[] f2912g = new char[512];

        public b(C0103a aVar) {
            super(aVar, null);
            f.b.a.c.b.o.b.n(aVar.b.length == 16);
            for (int i2 = 0; i2 < 256; i2++) {
                char[] cArr = this.f2912g;
                char[] cArr2 = aVar.b;
                cArr[i2] = cArr2[i2 >>> 4];
        ...
        public int b(byte[] bArr, CharSequence charSequence) {
            if (charSequence.length() % 2 != 1) {
                ...
                while (i2 < charSequence.length()) {
                    bArr[i3] = (byte) ((this.f2913d.a(charSequence.charAt(i2)) << 4) | this.f2913d.a(charSequence.charAt(i2 + 1)));
                    i2 += 2;
                    i3++;
                }
                return i3;
        ...
        public void d(Appendable appendable, byte[] bArr, int i2, int i3) {
            ...
            for (int i4 = 0; i4 < i3; i4++) {
                ...
                appendable.append(this.f2912g[i5]);
                appendable.append(this.f2912g[i5 | 256]);
            }
        }
    ...
    public static class e extends a {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final C0103a f2913d;

        /* renamed from: e  reason: collision with root package name */
        public final Character f2914e;

        /* renamed from: f  reason: collision with root package name */
        public transient a f2915f;
        ...
        public int b(byte[] bArr, CharSequence charSequence) {
            ...
            C0103a aVar2 = this.f2913d;
            if (aVar2.f2911h[f2.length() % aVar2.f2908e]) {
                int i2 = 0;
                int i3 = 0;
                while (i2 < f2.length()) {
                    long j2 = 0;
                    ...
                    while (true) {
                        ...
                        j2 <<= aVar.f2907d;
                        if (i2 + i4 < f2.length()) {
                            j2 |= (long) this.f2913d.a(f2.charAt(i5 + i2));
                            i5++;
                        }
                        i4++;
                    }
                    int i6 = aVar.f2909f;
                    int i7 = (i6 * 8) - (i5 * aVar.f2907d);
                    int i8 = (i6 - 1) * 8;
                    while (i8 >= i7) {
        ...
        public void d(Appendable appendable, byte[] bArr, int i2, int i3) {
            ...
            int i4 = 0;
            while (i4 < i3) {
                g(appendable, bArr, i2 + i4, Math.min(this.f2913d.f2909f, i3 - i4));
                i4 += this.f2913d.f2909f;
            }
        }
        ...
        public a e() {
            ...
            if (aVar == null) {
                ...
                aVar = aVar2 == this.f2913d ? this : h(aVar2, this.f2914e);
                this.f2915f = aVar;
            }
            return aVar;
        }
        ...
        public boolean equals(Object obj) {
            ...
            e eVar = (e) obj;
            return this.f2913d.equals(eVar.f2913d) && f.b.a.c.b.o.b.t0(this.f2914e, eVar.f2914e);
        }

        @Override // f.b.b.c.a
        public CharSequence f(CharSequence charSequence) {
            Objects.requireNonNull(charSequence);
            Character ch = this.f2914e;
            if (ch == null) {
                return charSequence;
            }
            char charValue = ch.charValue();
        ...
        public void g(Appendable appendable, byte[] bArr, int i2, int i3) {
            f.b.a.c.b.o.b.E(i2, i2 + i3, bArr.length);
            int i4 = 0;
            f.b.a.c.b.o.b.n(i3 <= this.f2913d.f2909f);
            long j2 = 0;
            for (int i5 = 0; i5 < i3; i5++) {
                j2 = (j2 | ((long) (bArr[i2 + i5] & 255))) << 8;
            }
            int i6 = ((i3 + 1) * 8) - this.f2913d.f2907d;
            while (i4 < i3 * 8) {
                C0103a aVar = this.f2913d;
                appendable.append(aVar.b[((int) (j2 >>> (i6 - i4))) & aVar.c]);
                i4 += this.f2913d.f2907d;
            }
            if (this.f2914e != null) {
                while (i4 < this.f2913d.f2909f * 8) {
                    appendable.append(this.f2914e.charValue());
                    i4 += this.f2913d.f2907d;
                }
            }
        }
        ...
        public int hashCode() {
            return this.f2913d.hashCode() ^ Arrays.hashCode(new Object[]{this.f2914e});
        }

        public String toString() {
            String str;
            StringBuilder sb = new StringBuilder("BaseEncoding.");
            sb.append(this.f2913d.a);
            if (8 % this.f2913d.f2907d != 0) {
                if (this.f2914e == null) {
                    str = ".omitPadding()";
                } else {
    ...
    public final byte[] a(CharSequence charSequence) {
        try {
            CharSequence f2 = f(charSequence);
            int length = (int) (((((long) ((e) this).f2913d.f2907d) * ((long) f2.length())) + 7) / 8);
    ...
    public String c(byte[] bArr) {
        ...
        C0103a aVar = ((e) this).f2913d;
        StringBuilder sb = new StringBuilder(f.b.b.d.a.a(length, aVar.f2909f, RoundingMode.CEILING) * aVar.f2908e);
        try {
            d(sb, bArr, 0, length);
            return sb.toString();
    ...
    public static final class c extends e {
        ...
        public int b(byte[] bArr, CharSequence charSequence) {
            CharSequence f2 = f(charSequence);
            C0103a aVar = this.f2913d;
            if (aVar.f2911h[f2.length() % aVar.f2908e]) {
                int i2 = 0;
                int i3 = 0;
                while (i2 < f2.length()) {
                    int i4 = i2 + 1;
                    int i5 = i4 + 1;
                    int a = (this.f2913d.a(f2.charAt(i2)) << 18) | (this.f2913d.a(f2.charAt(i4)) << 12);
                    int i6 = i3 + 1;
                    bArr[i3] = (byte) (a >>> 16);
                    if (i5 < f2.length()) {
                        int i7 = i5 + 1;
                        int a2 = a | (this.f2913d.a(f2.charAt(i5)) << 6);
                        i3 = i6 + 1;
                        bArr[i6] = (byte) ((a2 >>> 8) & 255);
                        if (i7 < f2.length()) {
                            i5 = i7 + 1;
                            i6 = i3 + 1;
                            bArr[i3] = (byte) ((a2 | this.f2913d.a(f2.charAt(i7))) & 255);
                        } else {
                            i2 = i7;
                        }
                    }
        ...
        public void d(Appendable appendable, byte[] bArr, int i2, int i3) {
            ...
            while (i3 >= 3) {
                ...
                appendable.append(this.f2913d.b[i8 >>> 18]);
                appendable.append(this.f2913d.b[(i8 >>> 12) & 63]);
                appendable.append(this.f2913d.b[(i8 >>> 6) & 63]);
                appendable.append(this.f2913d.b[i8 & 63]);
                i3 -= 3;
                i2 = i6 + 1;
            }
            if (i2 < i4) {
