...
public abstract class k<K, V> implements i<K, V> {
    ...
    public k(K k2, V v, i<K, V> iVar, i<K, V> iVar2) {
        ...
        this.f2979d = iVar2 == null ? hVar : iVar2;
    }
    ...
    public i<K, V> d(K k2, V v, Comparator<K> comparator) {
        ...
        return (compare < 0 ? j(null, null, this.c.d(k2, v, comparator), null) : compare == 0 ? j(k2, v, null, null) : j(null, null, null, this.f2979d.d(k2, v, comparator))).k();
    }
    ...
    public i<K, V> e(K k2, Comparator<K> comparator) {
        ...
        if (comparator.compare(k2, this.a) < 0) {
            ...
            if (!q.f2979d.isEmpty() && !q.f2979d.g() && !((k) q.f2979d).c.g()) {
                q = q.h();
                if (q.c.c().g()) {
                    q = q.q().h();
                }
            ...
            if (comparator.compare(k2, q.a) == 0) {
                ...
                i<K, V> f2 = q.f2979d.f();
                q = q.j(f2.getKey(), f2.getValue(), null, ((k) q.f2979d).o());
            }
            kVar = q.j(null, null, null, q.f2979d.e(k2, comparator));
        }
        return kVar.k();
    }
    ...
    public final k<K, V> k() {
        k<K, V> p = (!this.f2979d.g() || this.c.g()) ? this : p();
        if (p.c.g() && ((k) p.c).c.g()) {
            p = p.q();
        }
        return (!p.c.g() || !p.f2979d.g()) ? p : p.h();
    }
    ...
    public final k<K, V> m() {
        k<K, V> h2 = h();
        return h2.f2979d.c().g() ? h2.j(null, null, null, ((k) h2.f2979d).q()).p().h() : h2;
    }
    ...
    public final k<K, V> p() {
        return (k) this.f2979d.b(null, null, l(), i(null, null, i.a.RED, null, ((k) this.f2979d).c), null);
    }

    public final k<K, V> q() {
        return (k) this.c.b(null, null, l(), null, i(null, null, i.a.RED, ((k) this.c).f2979d, null));
    }
