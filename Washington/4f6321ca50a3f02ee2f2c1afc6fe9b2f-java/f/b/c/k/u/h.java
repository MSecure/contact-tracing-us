...
public final class h extends a<h> {
    ...
    public static final h f3118d = new h(Collections.emptyList());
            ...
            if (charAt == '\\') {
                ...
                if (!z) {
                    ...
                    if (!sb2.isEmpty()) {
                        ...
                        throw new IllegalArgumentException(a.c("Invalid field path (", str, "). Paths must not be empty, begin with '.', end with '.', or contain '..'"));
                    }
                }
            } else if (charAt == '`') {
                z = !z;
