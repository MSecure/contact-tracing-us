...
public final class j extends e {
    ...
    public i b(i iVar, h hVar) {
        g(iVar);
        b.a1(hVar.b == null, "Transform results received by PatchMutation.", new Object[0]);
        if (!this.b.c(iVar)) {
    ...
    public final k h(i iVar) {
        ...
        for (h hVar : this.f3122d.a) {
            if (!hVar.l()) {
                s c2 = this.c.c(hVar);
                if (c2 == null) {
                    b.a1(!hVar.l(), "Cannot delete field for empty path on ObjectValue", new Object[0]);
                    aVar.d(hVar, null);
                } else {
                    aVar.c(hVar, c2);
                }
    ...
    public String toString() {
        StringBuilder h2 = a.h("PatchMutation{");
        h2.append(f());
        h2.append(", mask=");
        h2.append(this.f3122d);
        h2.append(", value=");
        h2.append(this.c);
        h2.append("}");
        return h2.toString();
