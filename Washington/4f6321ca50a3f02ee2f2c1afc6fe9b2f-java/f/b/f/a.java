...
public abstract class a<MessageType extends a<MessageType, BuilderType>, BuilderType extends AbstractC0120a<MessageType, BuilderType>> implements t0 {
    public int memoizedHashCode = 0;

    /* renamed from: f.b.f.a$a  reason: collision with other inner class name */
    public static abstract class AbstractC0120a<MessageType extends a<MessageType, BuilderType>, BuilderType extends AbstractC0120a<MessageType, BuilderType>> implements t0.a {
        ...
        public static final class C0121a extends FilterInputStream {
            ...
            public C0121a(InputStream inputStream, int i2) {
                super(inputStream);
                this.b = i2;
            }
        ...
        public boolean mergeDelimitedFrom(InputStream inputStream, r rVar) {
            ...
            mergeFrom((InputStream) new C0121a(inputStream, k.t(read, inputStream)), rVar);
            return true;
        }
