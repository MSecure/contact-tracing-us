...
public final class b0 extends c<Integer> implements c0.g, RandomAccess, c1 {
    ...
    public void add(int i2, Object obj) {
        ...
        if (i3 < iArr.length) {
            ...
            System.arraycopy(this.c, i2, iArr2, i2 + 1, this.f3282d - i2);
            this.c = iArr2;
        }
        this.c[i2] = intValue;
        this.f3282d++;
    ...
    public boolean addAll(Collection<? extends Integer> collection) {
        ...
        if (Integer.MAX_VALUE - i3 >= i2) {
            ...
            System.arraycopy(b0Var.c, 0, this.c, this.f3282d, b0Var.f3282d);
            this.f3282d = i4;
            ((AbstractList) this).modCount++;
            return true;
        }
    ...
    public int hashCode() {
        int i2 = 1;
        for (int i3 = 0; i3 < this.f3282d; i3++) {
            i2 = (i2 * 31) + this.c[i3];
        }
        return i2;
    }
    ...
    public final String l(int i2) {
        return "Index:" + i2 + ", Size:" + this.f3282d;
    }

    /* renamed from: m */
    public c0.g d(int i2) {
        if (i2 >= this.f3282d) {
            return new b0(Arrays.copyOf(this.c, i2), this.f3282d);
        }
    ...
    public boolean remove(Object obj) {
        ...
        for (int i2 = 0; i2 < this.f3282d; i2++) {
            if (obj.equals(Integer.valueOf(this.c[i2]))) {
                int[] iArr = this.c;
                System.arraycopy(iArr, i2 + 1, iArr, i2, (this.f3282d - i2) - 1);
                this.f3282d--;
                ((AbstractList) this).modCount++;
                return true;
            }
    ...
    public void removeRange(int i2, int i3) {
        ...
        if (i3 >= i2) {
            int[] iArr = this.c;
            System.arraycopy(iArr, i3, iArr, i2, this.f3282d - i3);
            this.f3282d -= i3 - i2;
            ((AbstractList) this).modCount++;
            return;
        }
