...
public abstract class k {
    ...
    public static final class b extends k {
        ...
        @Override // f.b.f.k
        public int d() {
            return this.f3325i - this.f3326j;
        }

        @Override // f.b.f.k
        public boolean e() {
            return this.f3325i == this.f3323g;
        }
        ...
        public j l() {
            ...
            if (H > 0) {
                ...
                int i3 = this.f3325i;
                if (H <= i2 - i3) {
                    boolean z = this.f3322f;
                    j m = j.m(this.f3321e, i3, H);
                    this.f3325i += H;
                    return m;
                }
            }
            ...
            if (H > 0) {
                ...
                if (H <= i4 - i5) {
                    int i6 = H + i5;
                    this.f3325i = i6;
                    bArr = Arrays.copyOfRange(this.f3321e, i5, i6);
                    j jVar = j.c;
                    return new j.h(bArr);
                }
            }
        ...
        public String y() {
            int H = H();
            if (H > 0 && H <= this.f3323g - this.f3325i) {
                String str = new String(this.f3321e, this.f3325i, H, c0.a);
                this.f3325i += H;
                return str;
            } else if (H == 0) {
                return "";
        ...
        public String z() {
            ...
            if (H > 0) {
                ...
                int i3 = this.f3325i;
                if (H <= i2 - i3) {
                    String b = w1.b(this.f3321e, i3, H);
                    this.f3325i += H;
                    return b;
                }
            }
    ...
    public static final class c extends k {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final InputStream f3329e;

        /* renamed from: f  reason: collision with root package name */
        public final byte[] f3330f;
        ...
        /* renamed from: l  reason: collision with root package name */
        public int f3336l = Integer.MAX_VALUE;

        public c(InputStream inputStream, int i2, a aVar) {
            super(null);
            Charset charset = c0.a;
            this.f3329e = inputStream;
            this.f3330f = new byte[i2];
            this.f3331g = 0;
            this.f3333i = 0;
            this.f3335k = 0;
        }
        ...
        public final byte[] F(int i2, boolean z) {
            ...
            System.arraycopy(this.f3330f, i3, bArr, 0, i5);
        ...
        public final byte[] G(int i2) {
            ...
            if (i2 >= 0) {
                ...
                if (i5 - this.c <= 0) {
                    int i6 = this.f3336l;
                    if (i5 <= i6) {
                        int i7 = this.f3331g - i4;
                        int i8 = i2 - i7;
                        if (i8 >= 4096 && i8 > this.f3329e.available()) {
                            return null;
                        }
                        byte[] bArr = new byte[i2];
                        System.arraycopy(this.f3330f, this.f3333i, bArr, 0, i7);
                        this.f3335k += this.f3331g;
                        this.f3333i = 0;
                        this.f3331g = 0;
                        while (i7 < i2) {
                            int read = this.f3329e.read(bArr, i7, i2 - i7);
                            if (read != -1) {
                                this.f3335k += read;
                                i7 += read;
                            } else {
        ...
        public final List<byte[]> H(int i2) {
            ...
            while (i2 > 0) {
                ...
                int i3 = 0;
                while (i3 < min) {
                    int read = this.f3329e.read(bArr, i3, min - i3);
                    if (read != -1) {
                        this.f3335k += read;
                        i3 += read;
                    } else {
        ...
        public final void N() {
            int i2 = this.f3331g + this.f3332h;
            this.f3331g = i2;
            int i3 = this.f3335k + i2;
            int i4 = this.f3336l;
            if (i3 > i4) {
                int i5 = i3 - i4;
                this.f3332h = i5;
        ...
        public final void O(int i2) {
            ...
            if (i2 > (this.c - this.f3335k) - this.f3333i) {
                throw new d0("Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit.");
            }
            throw d0.h();
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:19:0x0062, code lost:
            throw new java.lang.IllegalStateException(r8.f3329e.getClass() + "#skip returned invalid result: " + r1 + "\nThe InputStream implementation is buggy.");
         */
        ...
        public final boolean Q(int i2) {
            ...
            if (i4 > i5) {
                int i6 = this.c;
                int i7 = this.f3335k;
                if (i2 > (i6 - i7) - i3 || i7 + i3 + i2 > this.f3336l) {
                    return false;
                }
                if (i3 > 0) {
                    if (i5 > i3) {
                ...
                InputStream inputStream = this.f3329e;
                byte[] bArr2 = this.f3330f;
                int i8 = this.f3331g;
                int read = inputStream.read(bArr2, i8, Math.min(bArr2.length - i8, (this.c - this.f3335k) - i8));
                if (read == 0 || read < -1 || read > this.f3330f.length) {
                    throw new IllegalStateException(this.f3329e.getClass() + "#read(byte[]) returned invalid result: " + read + "\nThe InputStream implementation is buggy.");
                } else if (read <= 0) {
                    return false;
                } else {
                    this.f3331g += read;
        ...
        @Override // f.b.f.k
        public int d() {
            return this.f3335k + this.f3333i;
        }

        @Override // f.b.f.k
        public boolean e() {
            return this.f3333i == this.f3331g && !Q(1);
        }
        ...
        public int j(int i2) {
            if (i2 >= 0) {
                int i3 = this.f3335k + this.f3333i + i2;
                int i4 = this.f3336l;
                if (i3 <= i4) {
                    this.f3336l = i3;
                    N();
        ...
        public j l() {
            ...
            if (K <= i2 - i3 && K > 0) {
                ...
                System.arraycopy(this.f3330f, i4, bArr, 0, i6);
                Iterator it = ((ArrayList) H).iterator();
                while (it.hasNext()) {
                    byte[] bArr2 = (byte[]) it.next();
        ...
        public String y() {
            int K = K();
            if (K > 0 && K <= this.f3331g - this.f3333i) {
                String str = new String(this.f3330f, this.f3333i, K, c0.a);
                this.f3333i += K;
                return str;
            } else if (K == 0) {
                return "";
                ...
                O(K);
                String str2 = new String(this.f3330f, this.f3333i, K, c0.a);
                this.f3333i += K;
                return str2;
            }
        }
    ...
    public static final class d extends k {
        ...
        /* renamed from: e  reason: collision with root package name */
        public final ByteBuffer f3337e;
        ...
        public d(ByteBuffer byteBuffer, boolean z, a aVar) {
            super(null);
            this.f3337e = byteBuffer;
            long a = v1.a(byteBuffer);
            this.f3339g = a;
            this.f3340h = ((long) byteBuffer.limit()) + a;
            long position = a + ((long) byteBuffer.position());
            this.f3341i = position;
            this.f3342j = position;
            this.f3338f = z;
        }
        ...
        public final void L() {
            long j2 = this.f3340h + ((long) this.f3343k);
            this.f3340h = j2;
            int i2 = (int) (j2 - this.f3342j);
            int i3 = this.m;
            if (i2 > i3) {
                int i4 = i2 - i3;
                this.f3343k = i4;
                this.f3340h = j2 - ((long) i4);
                return;
            }
            this.f3343k = 0;
        }
        ...
        public final int M() {
            return (int) (this.f3340h - this.f3341i);
        }
        ...
        @Override // f.b.f.k
        public int d() {
            return (int) (this.f3341i - this.f3342j);
        }

        @Override // f.b.f.k
        public boolean e() {
            return this.f3341i == this.f3340h;
        }
        ...
        public j l() {
            ...
            if (I > 0 && I <= M()) {
                ...
                long j2 = (long) I;
                v1.f3384f.c(this.f3341i, bArr, 0, j2);
                this.f3341i += j2;
                j jVar = j.c;
                return new j.h(bArr);
            } else if (I == 0) {
        ...
        public String z() {
            ...
            if (I > 0 && I <= M()) {
                int E = E(this.f3341i);
                ByteBuffer byteBuffer = this.f3337e;
                w1.a aVar = w1.a;
    ...
    public static k g(ByteBuffer byteBuffer, boolean z) {
        ...
        } else if (byteBuffer.isDirect() && v1.f3385g) {
