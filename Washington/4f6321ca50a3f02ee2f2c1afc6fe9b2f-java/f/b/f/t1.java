...
public class t1 extends r1<s1, s1> {
    ...
    /* JADX DEBUG: Method arguments types fixed to match base method, original types: [java.lang.Object, int, f.b.f.j] */
    @Override // f.b.f.r1
    ...
    public void j(Object obj) {
        ((z) obj).unknownFields.f3370e = false;
    }
    ...
    public s1 k(s1 s1Var, s1 s1Var2) {
        s1 s1Var3 = s1Var;
        s1 s1Var4 = s1Var2;
        return s1Var4.equals(s1.f3368f) ? s1Var3 : s1.d(s1Var3, s1Var4);
    }
    ...
    /* JADX DEBUG: Method arguments types fixed to match base method, original types: [java.lang.Object, f.b.f.a2] */
    @Override // f.b.f.r1
