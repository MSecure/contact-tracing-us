...
public abstract class z<MessageType extends z<MessageType, BuilderType>, BuilderType extends a<MessageType, BuilderType>> extends a<MessageType, BuilderType> {
    ...
    public s1 unknownFields = s1.f3368f;
    ...
    public static abstract class c<MessageType extends c<MessageType, BuilderType>, BuilderType extends Object<MessageType, BuilderType>> extends z<MessageType, BuilderType> implements Object<MessageType, BuilderType> {
        public v<d> extensions = v.f3372d;
    ...
    public static final class d implements v.a<d> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r1v1, resolved type: f.b.f.z$a */
    ...
    public static class e<ContainingType extends t0, Type> extends p<ContainingType, Type> {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final d f3418d;

        /* JADX WARN: Incorrect args count in method signature: (TContainingType;TType;Lf/b/f/t0;Lf/b/f/z$d;Ljava/lang/Class;)V */
        /* JADX DEBUG: Multi-variable search result rejected for r3v0, resolved type: f.b.f.t0 */
        /* JADX DEBUG: Multi-variable search result rejected for r4v0, resolved type: java.lang.Object */
        /* JADX WARN: Multi-variable type inference failed */
        public e(t0 t0Var, Object obj, t0 t0Var2, d dVar) {
            if (t0Var == 0) {
                throw new IllegalArgumentException("Null containingTypeDefaultInstance");
            } else if (dVar.f3415d == y1.MESSAGE && t0Var2 == null) {
    ...
    private final void ensureUnknownFieldsInitialized() {
        if (this.unknownFields == s1.f3368f) {
    ...
    private static <T extends z<T, ?>> T parsePartialDelimitedFrom(T t, InputStream inputStream, r rVar) {
        try {
            ...
            k f2 = k.f(new a.AbstractC0120a.C0121a(inputStream, k.t(read, inputStream)));
    ...
    public static c0.b mutableCopy(c0.b bVar) {
        int i2 = ((o) bVar).f3367d;
        return ((o) bVar).d(i2 == 0 ? 10 : i2 * 2);
    }

    public static abstract class a<MessageType extends z<MessageType, BuilderType>, BuilderType extends a<MessageType, BuilderType>> extends a.AbstractC0120a<MessageType, BuilderType> {
        ...
        public final MessageType build() {
            ...
            throw a.AbstractC0120a.newUninitializedMessageException(buildPartial);
        }
        ...
        @Override // java.lang.Object, f.b.f.a.AbstractC0120a, f.b.f.a.AbstractC0120a, f.b.f.a.AbstractC0120a
        ...
        @Override // f.b.f.a.AbstractC0120a, f.b.f.a.AbstractC0120a
