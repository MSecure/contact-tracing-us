...
public final class a {
    ...
    public final List<f.d.a.d.b> f3435d = new ArrayList();
        ...
        while (it2.hasNext()) {
            ...
            if (b3 != null) {
                ...
                if (!(str5 == null || (b2 = b(context, str5)) == null)) {
                    e.c(b2, "enchantWith");
                    String b4 = b3.b(b2.f3460e);
                    b3.f3460e = b4 == null ? b3.f3460e : b4;
                    String b5 = b3.b(b2.f3461f);
                    b3.f3461f = b5 == null ? b3.f3461f : b5;
                    String b6 = b3.b(b2.f3462g);
                    b3.f3462g = b6 == null ? b3.f3462g : b6;
                    String b7 = b3.b(b2.f3463h);
                    b3.f3463h = b7 == null ? b3.f3463h : b7;
                    String b8 = b3.b(b2.f3464i);
                    b3.f3464i = b8 == null ? b3.f3464i : b8;
                    String b9 = b3.b(b2.f3465j);
                    b3.f3465j = b9 == null ? b3.f3465j : b9;
                    String b10 = b3.b(b2.f3466k);
                    b3.f3466k = b10 == null ? b3.f3466k : b10;
                    Set<f.d.a.d.b> set = b2.f3467l;
                    b3.f3467l = set == null ? b3.f3467l : set;
                    b3.m = b2.m;
    ...
    public final List<f.d.a.d.a> a(List<f.d.a.d.a> list, String str, boolean z, int i2) {
        ...
        for (f.d.a.d.a aVar : list) {
            ...
            } else if (h.a(aVar.f3460e, str, true) || h.a(aVar.b, str, true)) {
                arrayList.add(aVar);
                i3++;
                if (i2 != -1 && i2 < i3) {
                    break;
        ...
        try {
            ...
            if (!h.h(V06) || !h.h(V07)) {
                ...
                for (String str2 : h.h(V06) ? f.b.a.c.b.o.b.p1(V07) : h.n(V06, new String[]{","}, false, 0, 6)) {
                    ...
                    Iterator it = new ArrayList(this.f3435d).iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            bVar = null;
                            break;
                    ...
                    if (bVar != null) {
                        ...
                        String f3 = f(a2.f3468d, c2);
                        e.c(f3, "<set-?>");
                        a2.f3468d = f3;
                        String f4 = f(a2.f3469e, c2);
                        e.c(f4, "<set-?>");
                        a2.f3469e = f4;
                        set.add(a2);
                    }
            ...
            e.c(V09, "<set-?>");
            aVar.o = V09;
            if (!h.h(aVar.f3460e) || !h.h(aVar.f3463h)) {
                return aVar;
            }
            return null;
        } catch (Exception e2) {
    ...
    public final f.d.a.d.a e(String str) {
        ...
        while (it.hasNext()) {
            ...
            if (h.b(aVar.f3460e, str, true) || h.b(aVar.b, str, true)) {
                return aVar;
            }
            while (it.hasNext()) {
            }
