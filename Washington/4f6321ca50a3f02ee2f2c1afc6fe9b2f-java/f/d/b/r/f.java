...
public class f<Item extends k<? extends RecyclerView.b0>> implements e {
    ...
    public void a(RecyclerView.b0 b0Var, int i2) {
        ...
        if (s != null) {
            try {
                s.c(b0Var);
                if (!(b0Var instanceof b.AbstractC0130b)) {
                    b0Var = null;
                }
                if (((b.AbstractC0130b) b0Var) != null) {
                    e.c(s, "item");
                }
    ...
    public void b(RecyclerView.b0 b0Var, int i2, List<? extends Object> list) {
        ...
        if (bVar != null && (s = bVar.s(i2)) != null) {
            ...
            b.AbstractC0130b bVar2 = (b.AbstractC0130b) b0Var2;
            if (bVar2 != 0) {
                bVar2.w(s, list);
            }
    ...
    public boolean c(RecyclerView.b0 b0Var, int i2) {
        ...
        if (!d2) {
            b.AbstractC0130b bVar = (b.AbstractC0130b) b0Var;
            e.c(kVar2, "item");
        } else {
            z = true;
        }
    ...
    public void d(RecyclerView.b0 b0Var, int i2) {
        ...
        if (kVar != null) {
            kVar.j(b0Var);
            b.AbstractC0130b bVar = (b.AbstractC0130b) (!(b0Var instanceof b.AbstractC0130b) ? null : b0Var);
            if (bVar != 0) {
                bVar.x(kVar);
            }
