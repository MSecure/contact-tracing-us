    ...
    public static final class b extends k0 {
        ...
        public final void n() {
            ...
            if (Build.VERSION.SDK_INT < 24 || this.c == null) {
                ...
                runnable = new RunnableC0138b(dVar);
            } else {
                c cVar = new c(null);
                this.c.registerDefaultNetworkCallback(cVar);
                runnable = new RunnableC0137a(cVar);
            }
            this.f3543e = runnable;
        }
    }
