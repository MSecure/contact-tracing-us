...
public final class f0 extends q0 {
    ...
    public final AtomicReference<e> f3615d = new AtomicReference<>();
    ...
    public final t2.c<Executor> f3619h;
    ...
    public final class d implements Runnable {
        ...
        public void a() {
            ...
            f0 f0Var = f0.this;
            try {
                x0 a2 = f0.this.a.a(InetSocketAddress.createUnresolved(f0Var.f3617f, f0Var.f3618g));
                q0.b bVar2 = null;
                if (a2 != null) {
                    Logger logger2 = f0.t;
                ...
                try {
                    ...
                    if (z) {
                        ...
                        a aVar2 = f0.this.c;
                        f0 f0Var2 = f0.this;
                        h2 = f0.h(aVar2, eVar, f0Var2.p, f0.A, f0Var2.f3617f);
                        g1 g1Var = f0.this.f3621j;
                        b bVar3 = new b(h2);
                        ...
                        if (logger.isLoggable(Level.FINER)) {
                            logger.finer("Found DNS results " + h2 + " for " + f0.this.f3617f);
                        }
                        ArrayList arrayList = new ArrayList();
                        for (InetAddress inetAddress : h2.a) {
                            arrayList.add(new v(Collections.singletonList(new InetSocketAddress(inetAddress, f0.this.f3618g)), h.a.a.b));
                        }
                        Collections.emptyList();
                        h.a.a aVar3 = h.a.a.b;
                        a.b a3 = h.a.a.a();
                        ...
                        if (h2.b.isEmpty()) {
                            ...
                            try {
                                ...
                                while (it.hasNext()) {
                                    try {
                                        ...
                                        bVar = new q0.b(c1.f3519h.g("failed to pick service config choice").f(e3));
                                    }
                                }
                                bVar = map == null ? null : new q0.b(map);
                            } catch (IOException | RuntimeException e4) {
                                bVar = new q0.b(c1.f3519h.g("failed to parse TXT records").f(e4));
                            }
                            if (bVar != null) {
                                c1 c1Var = bVar.a;
                                if (c1Var != null) {
                            ...
                            f0.t.log(Level.FINE, "No TXT records found for {0}", new Object[]{f0.this.f3617f});
                        }
                    ...
                    a aVar22 = f0.this.c;
                    f0 f0Var22 = f0.this;
                    h2 = f0.h(aVar22, eVar, f0Var22.p, f0.A, f0Var22.f3617f);
                    g1 g1Var2 = f0.this.f3621j;
                    b bVar32 = new b(h2);
    ...
    public f0(String str, q0.a aVar, t2.c cVar, s sVar, boolean z2, boolean z3) {
        ...
        this.f3616e = authority;
        this.f3617f = create.getHost();
        if (create.getPort() == -1) {
            i2 = aVar.a;
        } else {
            i2 = create.getPort();
        ...
        this.f3621j = g1Var;
        Executor executor = aVar.f3979g;
        this.n = executor;
        this.o = executor != null ? false : z4;
        this.p = z3;
        q0.g gVar = aVar.f3976d;
    ...
    public void d(q0.e eVar) {
        ...
        if (this.o) {
            this.n = (Executor) t2.a(this.f3619h);
        }
    ...
    public final void g() {
        int i2;
        if (!this.r && !this.m) {
            if (this.f3623l == null || this.f3620i == 0 || (i2 > 0 && this.f3622k.a(TimeUnit.NANOSECONDS) > this.f3620i)) {
                this.r = true;
