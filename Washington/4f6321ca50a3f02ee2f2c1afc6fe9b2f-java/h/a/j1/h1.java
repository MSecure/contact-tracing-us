        ...
        if (ordinal != 0) {
            ...
            if (ordinal == 2) {
                ...
                if (i7 == 10) {
                    ...
                    if (i7 == 8) {
                        ...
                        if (i7 == 11) {
                            ...
                            str2 = Long.toString(aVar.f3266i);
                        } else if (i7 == 16) {
                            str2 = new String(aVar.c, aVar.f3261d, aVar.f3267j);
                            aVar.f3261d += aVar.f3267j;
                        } else {
                ...
                if (i9 == 15) {
                    ...
                    d2 = (double) aVar.f3266i;
                } else {
                    if (i9 == 16) {
                        aVar.f3268k = new String(aVar.c, aVar.f3261d, aVar.f3267j);
                        aVar.f3261d += aVar.f3267j;
                    } else {
                        if (i9 == 8 || i9 == 9) {
                            if (i9 == 8) {
                    ...
                    aVar.f3265h = 11;
                    double parseDouble = Double.parseDouble(aVar.f3268k);
