...
public final class m1 extends k0 implements c0<Object> {
    ...
    public final q0.a f3651d;

    /* renamed from: e  reason: collision with root package name */
    public final i f3652e;

    /* renamed from: f  reason: collision with root package name */
    public final x f3653f;

    /* renamed from: g  reason: collision with root package name */
    public final r f3654g;

    /* renamed from: h  reason: collision with root package name */
    public final Executor f3655h;

    /* renamed from: i  reason: collision with root package name */
    public final d2<? extends Executor> f3656i;

    /* renamed from: j  reason: collision with root package name */
    public final d2<? extends Executor> f3657j;

    /* renamed from: k  reason: collision with root package name */
    public final k f3658k;

    /* renamed from: l  reason: collision with root package name */
    public final k f3659l;
    public final z2 m;
    public final g1 n;
    ...
    public final class c implements Runnable {
        ...
        public void run() {
            ...
            Executor executor = m1Var.f3655h;
            h.a.n nVar = this.c;
    ...
    public final class o extends q0.e {
        ...
        public final void d() {
            ...
            m1 m1Var2 = m1.this;
            m1Var2.Y = m1Var2.n.c(new i(), a2, TimeUnit.NANOSECONDS, m1Var2.f3653f.q());
        }
    }
    ...
    public class p extends h.a.d {
        ...
        public <ReqT, RespT> h.a.f<ReqT, RespT> h(o0<ReqT, RespT> o0Var, h.a.c cVar) {
            ...
            Executor executor2 = executor == null ? m1Var.f3655h : executor;
            m1 m1Var2 = m1.this;
            p.c cVar2 = m1Var2.a0;
            if (m1Var2.I) {
                scheduledExecutorService = null;
            } else {
                scheduledExecutorService = m1.this.f3653f.q();
            }
    ...
    public static final class s extends q0.g {
        ...
        public q0.b a(Map<String, ?> map) {
            Object obj;
            try {
                q0.b b2 = this.c.b(map, this.f3664d);
                if (b2 == null) {
                    obj = null;
                } else {
                    c1 c1Var = b2.a;
                ...
                return new q0.b(c1.f3519h.g("failed to parse service config").f(e2));
            }
        }
    }
    ...
    public final class u extends e {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                if (!uVar.f3668g) {
                    uVar.f3668g = true;
                } else if (m1.this.H && (cVar = uVar.f3669h) != null) {
                    cVar.a();
                    uVar.f3669h = null;
                } else {
                    return;
                ...
                if (!m1.this.H) {
                    uVar.f3669h = m1.this.n.c(new k1(new u1(uVar)), 5, TimeUnit.SECONDS, m1.this.f3653f.q());
                } else {
                    uVar.f3666e.d(m1.f0);
                }
            }
        ...
        public List<h.a.v> a() {
            ...
            f.b.a.c.b.o.b.G(this.f3667f, "not started");
            return this.f3666e.m;
        }
        ...
        @Override // h.a.h0.h
        public Object c() {
            f.b.a.c.b.o.b.G(this.f3667f, "Subchannel is not started");
            return this.f3666e;
        }
        ...
        public void f(h0.j jVar) {
            m1.this.n.d();
            f.b.a.c.b.o.b.G(!this.f3667f, "already started");
            f.b.a.c.b.o.b.G(!this.f3668g, "already shutdown");
            this.f3667f = true;
            if (m1.this.H) {
                g1 g1Var = m1.this.n;
            ...
            m1 m1Var2 = m1.this;
            z0 z0Var = new z0(list, b2, null, aVar, xVar, q, m1Var2.q, m1Var2.n, new t1(this, jVar), m1Var2.O, m1Var2.K.a(), this.f3665d, this.b, this.c);
            m1 m1Var3 = m1.this;
            o oVar = m1Var3.M;
    ...
    public m1(b<?> bVar, x xVar, j.a aVar, d2<? extends Executor> d2Var, f.b.b.a.t<f.b.b.a.s> tVar, List<h.a.g> list, z2 z2Var) {
        ...
        this.N = nVar;
        q0.c cVar = bVar.f3569e;
        this.c = cVar;
        y0 y0Var = q0.f3724k;
        i iVar = new i(bVar.f3571g);
        this.f3652e = iVar;
        d2<? extends Executor> d2Var3 = bVar.b;
        f.b.a.c.b.o.b.A(d2Var3, "offloadExecutorPool");
        this.f3659l = new k(d2Var3);
        s sVar = new s(false, bVar.f3575k, bVar.f3576l, iVar, nVar);
        ...
        h.a.t tVar2 = bVar.f3572h;
        f.b.a.c.b.o.b.A(tVar2, "decompressorRegistry");
        this.o = tVar2;
        h.a.m mVar = bVar.f3573i;
    ...
    public final void r(boolean z2) {
        ...
        m2 m2Var = this.b0;
        m2Var.f3674f = false;
        if (z2 && (scheduledFuture = m2Var.f3675g) != null) {
    ...
    public final void v() {
        ...
        if (j2 != -1) {
            ...
            f.b.b.a.s sVar = m2Var.f3672d;
            TimeUnit timeUnit2 = TimeUnit.NANOSECONDS;
            long a2 = sVar.a(timeUnit2) + nanos;
            m2Var.f3674f = true;
            if (a2 - m2Var.f3673e < 0 || m2Var.f3675g == null) {
                ScheduledFuture<?> scheduledFuture = m2Var.f3675g;
                if (scheduledFuture != null) {
                    scheduledFuture.cancel(false);
                }
                m2Var.f3675g = m2Var.a.schedule(new m2.c(null), nanos, timeUnit2);
            }
            m2Var.f3673e = a2;
        }
    }
    ...
    public final void w(boolean z2) {
        ...
        if (this.w != null) {
            ...
            this.x = false;
            if (z2) {
                this.w = t(this.b, this.c, this.f3651d);
            } else {
                this.w = null;
            }
        }
