...
public abstract class n2<ReqT> implements u {
    ...
    public static final c1 y = c1.f3518g.g("Stream thrown away because RetriableStream committed");
    ...
    public final n0 f3676d;

    /* renamed from: e  reason: collision with root package name */
    public final o2.a f3677e;

    /* renamed from: f  reason: collision with root package name */
    public final s0.a f3678f;
    ...
    public final Object f3682j = new Object();

    /* renamed from: k  reason: collision with root package name */
    public final q f3683k;
    ...
    public class c implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ Future f3685d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ Future f3686e;
        ...
        public void run() {
            ...
            Future future = this.f3685d;
            if (future != null) {
                future.cancel(false);
            }
            Future future2 = this.f3686e;
            if (future2 != null) {
    ...
    public class p extends h.a.j {
        ...
        public void a(long j2) {
            if (n2.this.p.f3691f == null) {
                Runnable runnable = null;
                synchronized (n2.this.f3682j) {
                    if (n2.this.p.f3691f == null) {
                        w wVar = this.a;
                        if (!wVar.b) {
                            long j3 = this.b + j2;
                            ...
                            if (j3 > j4) {
                                if (j3 > n2Var.f3684l) {
                                    ...
                                    long addAndGet = n2Var.f3683k.a.addAndGet(j3 - j4);
                                    n2 n2Var2 = n2.this;
                                    n2Var2.r = this.b;
    ...
    public final class s implements Runnable {
        ...
        public class a implements Runnable {
            ...
            public void run() {
                ...
                synchronized (n2.this.f3682j) {
                    ...
                    if (!sVar.b.c) {
                        ...
                        if (n2Var4.u(n2Var4.p)) {
                            x xVar = n2.this.n;
                            if (xVar != null) {
                                if (xVar.f3695d.get() <= xVar.b) {
                                    z = false;
                                }
                            }
                            n2Var = n2.this;
                            rVar = new r(n2Var.f3682j);
                            n2Var.u = rVar;
                            z = false;
                        }
                        n2 n2Var5 = n2.this;
                ...
                if (z) {
                    q.a.g(c1.f3518g.g("Unneeded hedging"));
                    return;
                }
                if (rVar != null) {
                    n2 n2Var6 = n2.this;
                    rVar.b(n2Var6.c.schedule(new s(rVar), n2Var6.f3680h.b, TimeUnit.NANOSECONDS));
                }
                n2.this.s(q);
            }
        }
    ...
    public static final class u {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final Collection<w> f3689d;

        /* renamed from: e  reason: collision with root package name */
        public final int f3690e;

        /* renamed from: f  reason: collision with root package name */
        public final w f3691f;
        ...
        public u a(w wVar) {
            ...
            f.b.a.c.b.o.b.G(!this.f3693h, "hedging frozen");
            f.b.a.c.b.o.b.G(this.f3691f == null, "already committed");
            if (this.f3689d == null) {
            ...
            return new u(this.b, this.c, collection, this.f3691f, this.f3692g, this.a, this.f3693h, this.f3690e + 1);
        }

        public u b() {
            return this.f3693h ? this : new u(this.b, this.c, this.f3689d, this.f3691f, this.f3692g, this.a, true, this.f3690e);
        }

        public u c(w wVar) {
            ArrayList arrayList = new ArrayList(this.f3689d);
            arrayList.remove(wVar);
            return new u(this.b, this.c, Collections.unmodifiableCollection(arrayList), this.f3691f, this.f3692g, this.a, this.f3693h, this.f3690e);
        }
        ...
        public u e(w wVar) {
            ...
            arrayList.remove(wVar);
            return new u(this.b, Collections.unmodifiableCollection(arrayList), this.f3689d, this.f3691f, this.f3692g, this.a, this.f3693h, this.f3690e);
        }
        ...
        public u f(w wVar) {
            ...
            return new u(list, unmodifiableCollection, this.f3689d, this.f3691f, this.f3692g, z2, this.f3693h, this.f3690e);
        }
    }
    ...
    public final class v implements v {
        ...
        public class b implements Runnable {
            ...
            public class a implements Runnable {
                ...
                public void run() {
                    v vVar = v.this;
                    n0.f<String> fVar = n2.w;
                    n2.this.s(n2.this.q(vVar.a.f3694d + 1));
                }
            }
        ...
        public void a(y2.a aVar) {
            u uVar = n2.this.p;
            f.b.a.c.b.o.b.G(uVar.f3691f != null, "Headers should be received prior to messages.");
            if (uVar.f3691f == this.a) {
                n2.this.s.a(aVar);
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:37:0x00aa, code lost:
            if (r2.f3679g.a == 1) goto L_0x00ac;
         */
            ...
            if (n2.this.p.f3691f == null) {
                ...
                if (aVar != v.a.REFUSED || !n2.this.q.compareAndSet(false, true)) {
                    if (aVar == v.a.DROPPED) {
                        ...
                        n2.this.q.set(true);
                        n2 n2Var6 = n2.this;
                        if (n2Var6.f3679g == null) {
                            n2Var6.f3679g = n2Var6.f3677e.get();
                            n2 n2Var7 = n2.this;
                            n2Var7.v = n2Var7.f3679g.b;
                        }
                        boolean contains = n2.this.f3679g.f3700e.contains(c1Var.a);
                        boolean contains2 = n2.this.f3680h.c.contains(c1Var.a);
                        if (!n2.this.f3681i || contains2) {
                            ...
                            if (n2.this.n == null || (!contains && !contains2 && (num == null || num.intValue() >= 0))) {
                                ...
                                x xVar = n2.this.n;
                                while (true) {
                                    int i2 = xVar.f3695d.get();
                                    if (i2 == 0) {
                                        break;
                                    }
                                    int i3 = i2 - 1000;
                                    if (xVar.f3695d.compareAndSet(i2, Math.max(i3, 0))) {
                                        if (i3 > xVar.b) {
                                            z3 = true;
                                        }
                                    }
                            ...
                            n2 n2Var8 = n2.this;
                            if (n2Var8.f3679g.a > this.a.f3694d + 1 && !z) {
                                if (num == null) {
                                    if (contains) {
                                        j4 = (long) (n2.z.nextDouble() * ((double) n2Var8.v));
                                        n2Var2 = n2.this;
                                        o2 o2Var = n2Var2.f3679g;
                                        j3 = Math.min((long) (((double) n2Var2.v) * o2Var.f3699d), o2Var.c);
                                    }
                                ...
                                j2 = j4;
                                z2 = true;
                                tVar = new t(z2, false, j2, !n2.this.f3681i ? num : null);
                            }
                            j2 = 0;
                            z2 = false;
                            tVar = new t(z2, false, j2, !n2.this.f3681i ? num : null);
                        ...
                        z5 = tVar.b;
                        n2.o(n2.this, tVar.f3688d);
                    }
                    n2 n2Var9 = n2.this;
                    if (n2Var9.f3681i) {
                        synchronized (n2Var9.f3682j) {
                            n2 n2Var10 = n2.this;
                            n2Var10.p = n2Var10.p.c(this.a);
                            if (!z5) {
                                n2 n2Var11 = n2.this;
                                if (n2Var11.u(n2Var11.p) || !n2.this.p.f3689d.isEmpty()) {
                                    return;
                                }
                            }
                        }
                    ...
                    w q = n2.this.q(this.a.f3694d);
                    n2 n2Var12 = n2.this;
                    if (n2Var12.f3681i) {
                        synchronized (n2Var12.f3682j) {
                            n2 n2Var13 = n2.this;
                            n2Var13.p = n2Var13.p.d(this.a, q);
                            n2 n2Var14 = n2.this;
                            if (n2Var14.u(n2Var14.p) || n2.this.p.f3689d.size() != 1) {
                                z4 = false;
                            }
                        }
                        if (z4) {
                    ...
                    if (n2Var12.f3679g == null) {
                        n2Var12.f3679g = n2Var12.f3677e.get();
                    }
                    n2Var3 = n2.this;
                    n2.m(n2Var3, q);
                    n2.this.b.execute(new a(q));
        ...
        public void e(n0 n0Var) {
            ...
            if (n2.this.p.f3691f == this.a) {
                ...
                if (xVar != null) {
                    ...
                    } while (!xVar.f3695d.compareAndSet(i2, Math.min(xVar.c + i2, i3)));
                }
            }
        }
    }
    ...
    public static void o(n2 n2Var, Integer num) {
        ...
        if (num != null) {
            ...
            synchronized (n2Var.f3682j) {
                r rVar = n2Var.u;
                if (rVar != null) {
                    Future<?> a2 = rVar.a();
                    r rVar2 = new r(n2Var.f3682j);
                    n2Var.u = rVar2;
                }
            }
        }
    ...
    public final void g(c1 c1Var) {
        ...
        this.p.f3691f.a.g(c1Var);
        synchronized (this.f3682j) {
            u uVar = this.p;
            this.p = new u(uVar.b, uVar.c, uVar.f3689d, uVar.f3691f, true, uVar.a, uVar.f3693h, uVar.f3690e);
        }
    }
    ...
    public final void i(v vVar) {
        ...
        boolean z2 = false;
        w q2 = q(0);
        f.b.a.c.b.o.b.G(this.f3680h == null, "hedgingPolicy has been initialized unexpectedly");
        s0 s0Var = this.f3678f.get();
        this.f3680h = s0Var;
        if (!s0.f3759d.equals(s0Var)) {
            this.f3681i = true;
            this.f3679g = o2.f3698f;
            r rVar = null;
            synchronized (this.f3682j) {
                this.p = this.p.a(q2);
                if (u(this.p)) {
                    ...
                    rVar = new r(this.f3682j);
                    this.u = rVar;
                }
            }
            if (rVar != null) {
                rVar.b(this.c.schedule(new s(rVar), this.f3680h.b, TimeUnit.NANOSECONDS));
            }
        }
        s(q2);
    }
    ...
    public final Runnable p(w wVar) {
        ...
        Future<?> future2;
        synchronized (this.f3682j) {
            if (this.p.f3691f != null) {
                return null;
            }
            Collection<w> collection = this.p.c;
            u uVar = this.p;
            boolean z2 = false;
            f.b.a.c.b.o.b.G(uVar.f3691f == null, "Already committed");
            List<o> list2 = uVar.b;
            ...
            this.p = new u(list, set, uVar.f3689d, wVar, uVar.f3692g, z2, uVar.f3693h, uVar.f3690e);
            this.f3683k.a.addAndGet(-this.r);
            r rVar = this.t;
            if (rVar != null) {
                Future<?> a2 = rVar.a();
                this.t = null;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:31:0x006f, code lost:
        if (r4.f3692g == false) goto L_0x007a;
     */
    ...
    public final boolean u(u uVar) {
        return uVar.f3691f == null && uVar.f3690e < this.f3680h.a && !uVar.f3693h;
    }
    ...
    public final void y(ReqT reqt) {
        u uVar = this.p;
        if (uVar.a) {
            uVar.f3691f.a.h(this.a.f3958d.b(reqt));
        } else {
            r(new m(reqt));
        }
    }
