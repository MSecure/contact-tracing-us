...
public final class w1 extends n0 {
    ...
    public static final ConcurrentMap<a, a> f3771d = new ConcurrentHashMap();

    /* renamed from: e  reason: collision with root package name */
    public static final Logger f3772e = Logger.getLogger(w1.class.getName());
    public final a b;

    public static final class a extends WeakReference<w1> {

        /* renamed from: f  reason: collision with root package name */
        public static final boolean f3773f = Boolean.parseBoolean(System.getProperty("io.grpc.ManagedChannel.enableAllocationTracking", "true"));

        /* renamed from: g  reason: collision with root package name */
        public static final RuntimeException f3774g;
        public final ReferenceQueue<w1> a;
        public final ConcurrentMap<a, a> b;
        public final String c;

        /* renamed from: d  reason: collision with root package name */
        public final Reference<RuntimeException> f3775d;
        ...
        static {
            ...
            f3774g = runtimeException;
        }

        public a(w1 w1Var, k0 k0Var, ReferenceQueue<w1> referenceQueue, ConcurrentMap<a, a> concurrentMap) {
            super(w1Var, referenceQueue);
            this.f3775d = new SoftReference(f3773f ? new RuntimeException("ManagedChannel allocation site") : f3774g);
        ...
        public static int a(ReferenceQueue<w1> referenceQueue) {
            ...
            while (true) {
                ...
                RuntimeException runtimeException = aVar.f3775d.get();
                super.clear();
                aVar.b.remove(aVar);
                aVar.f3775d.clear();
                if (!aVar.f3776e) {
    ...
    public w1(k0 k0Var) {
        ...
        ConcurrentMap<a, a> concurrentMap = f3771d;
