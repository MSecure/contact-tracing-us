...
public final class z0 implements c0<Object>, b3 {
    ...
    public final j.a f3784d;

    /* renamed from: e  reason: collision with root package name */
    public final e f3785e;

    /* renamed from: f  reason: collision with root package name */
    public final x f3786f;

    /* renamed from: g  reason: collision with root package name */
    public final ScheduledExecutorService f3787g;

    /* renamed from: h  reason: collision with root package name */
    public final a0 f3788h;

    /* renamed from: i  reason: collision with root package name */
    public final m f3789i;

    /* renamed from: j  reason: collision with root package name */
    public final h.a.e f3790j;

    /* renamed from: k  reason: collision with root package name */
    public final g1 f3791k;
    ...
    public class b implements Runnable {
        ...
        public void run() {
            if (z0.this.u.a == n.IDLE) {
                z0.this.f3790j.a(e.a.INFO, "CONNECTING as requested");
    ...
    public class g implements y1.a {
                ...
                if (z0.this.u.a != n.SHUTDOWN) {
                    ...
                    if (z0Var.s == zVar) {
                        ...
                        if (!(fVar2.b < fVar2.a.size())) {
                            ...
                            if (z0Var3.n == null) {
                                Objects.requireNonNull((h0.a) z0Var3.f3784d);
                                z0Var3.n = new h0();
                            }
                            ...
                            z0Var3.f3790j.b(e.a.INFO, "TRANSIENT_FAILURE ({0}). Will reconnect after {1} ns", z0Var3.k(c1Var), Long.valueOf(a2));
                            if (z0Var3.p != null) {
                                z = false;
                            }
                            f.b.a.c.b.o.b.G(z, "previous reconnectTask is not done");
                            z0Var3.p = z0Var3.f3791k.c(new a1(z0Var3), a2, timeUnit, z0Var3.f3787g);
                            return;
                        }
                        z0.i(z0.this);
                    }
        ...
        public void a() {
            ...
            z0.this.f3790j.b(e.a.INFO, "{0} Terminated", this.a.c());
            a0 a0Var = z0.this.f3788h;
            a0.b(a0Var.c, this.a);
            z0 z0Var = z0.this;
            z zVar = this.a;
            g1 g1Var = z0Var.f3791k;
        ...
        @Override // h.a.j1.y1.a
        public void b() {
            z0.this.f3790j.a(e.a.INFO, "READY");
            g1 g1Var = z0.this.f3791k;
            a aVar = new a();
            Queue<Runnable> queue = g1Var.c;
        ...
        public void d(c1 c1Var) {
            z0.this.f3790j.b(e.a.INFO, "{0} SHUTDOWN with {1}", this.a.c(), z0.this.k(c1Var));
            this.b = true;
            g1 g1Var = z0.this.f3791k;
            b bVar = new b(c1Var);
            Queue<Runnable> queue = g1Var.c;
    ...
    public z0(List<h.a.v> list, String str, String str2, j.a aVar, x xVar, ScheduledExecutorService scheduledExecutorService, t<s> tVar, g1 g1Var, e eVar, a0 a0Var, m mVar, o oVar, d0 d0Var, h.a.e eVar2) {
        ...
        this.f3792l = new f(unmodifiableList);
        this.b = str;
        this.c = str2;
        this.f3784d = aVar;
        this.f3786f = xVar;
        this.f3787g = scheduledExecutorService;
        this.o = tVar.get();
        this.f3791k = g1Var;
        this.f3785e = eVar;
        this.f3788h = a0Var;
    ...
    public static void i(z0 z0Var) {
        ...
        SocketAddress a2 = z0Var.f3792l.a();
        if (a2 instanceof z) {
            zVar = (z) a2;
        ...
        f fVar2 = z0Var.f3792l;
        h.a.a aVar = fVar2.a.get(fVar2.b).b;
        String str = (String) aVar.a.get(h.a.v.f3990d);
        x.a aVar2 = new x.a();
        if (str == null) {
            str = z0Var.b;
        }
        ...
        h hVar = new h();
        hVar.a = z0Var.a;
        d dVar = new d(z0Var.f3786f.f(socketAddress, aVar2, hVar), z0Var.f3789i, null);
        hVar.a = dVar.c();
        a0.a(z0Var.f3788h.c, dVar);
        z0Var.s = dVar;
        z0Var.q.add(dVar);
        Runnable e2 = dVar.b().e(new g(dVar, socketAddress));
        if (e2 != null) {
            Queue<Runnable> queue = z0Var.f3791k.c;
            f.b.a.c.b.o.b.A(e2, "runnable is null");
            queue.add(e2);
        }
        z0Var.f3790j.b(e.a.INFO, "Started transport {0}", hVar.a);
    }
