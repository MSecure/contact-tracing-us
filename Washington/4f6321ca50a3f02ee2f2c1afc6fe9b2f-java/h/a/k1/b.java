...
public final class b implements c {
    ...
    public static final Logger f3815e = Logger.getLogger(g.class.getName());
    public final a b;
    public final c c;
    ...
    public void R(int i2, h.a.k1.p.m.a aVar, byte[] bArr) {
        this.f3816d.c(h.a.OUTBOUND, i2, aVar, k.h.f(bArr));
        try {
    ...
    public void T(int i2, h.a.k1.p.m.a aVar) {
        this.f3816d.e(h.a.OUTBOUND, i2, aVar);
        try {
            this.c.T(i2, aVar);
        } catch (IOException e2) {
            this.b.b(e2);
    ...
    public void close() {
        try {
            ...
            f3815e.log(e2.getClass().equals(IOException.class) ? Level.FINE : Level.INFO, "Failed closing connection", (Throwable) e2);
        }
    }
    ...
    public void i(boolean z, int i2, e eVar, int i3) {
        this.f3816d.b(h.a.OUTBOUND, i2, eVar, i3, z);
        try {
    ...
    public void o(h.a.k1.p.m.h hVar) {
        this.f3816d.f(h.a.OUTBOUND, hVar);
        try {
            this.c.o(hVar);
        } catch (IOException e2) {
            this.b.b(e2);
    ...
    public void u(int i2, long j2) {
        this.f3816d.g(h.a.OUTBOUND, i2, j2);
        try {
            this.c.u(i2, j2);
        } catch (IOException e2) {
            this.b.b(e2);
