...
public class f extends h.a.j1.a {
    ...
    public class b extends t0 {
        ...
        public static void l(b bVar, n0 n0Var, String str) {
            boolean z2;
            f fVar = f.this;
            String str2 = fVar.f3833j;
            String str3 = fVar.f3831h;
            boolean z3 = fVar.p;
            ...
            n0Var.b(q0.f3720g);
            n0Var.b(q0.f3721h);
            n0.f<String> fVar2 = q0.f3722i;
            n0Var.b(fVar2);
            ArrayList arrayList = new ArrayList(n0Var.b + 7);
            arrayList.add(z4 ? c.b : c.a);
            arrayList.add(z3 ? c.f3817d : c.c);
            arrayList.add(new h.a.k1.p.m.d(h.a.k1.p.m.d.f3921h, str2));
            arrayList.add(new h.a.k1.p.m.d(h.a.k1.p.m.d.f3919f, str));
            arrayList.add(new h.a.k1.p.m.d(fVar2.b, str3));
            arrayList.add(c.f3818e);
            arrayList.add(c.f3819f);
            Logger logger = a3.a;
            ...
            for (int i8 = 0; i8 < bArr.length; i8 += 2) {
                h f2 = h.f(bArr[i8]);
                String q = f2.q();
                if (!q.startsWith(":") && !q0.f3720g.b.equalsIgnoreCase(q) && !q0.f3722i.b.equalsIgnoreCase(q)) {
        ...
        public static void m(b bVar, e eVar, boolean z2, boolean z3) {
            if (!bVar.D) {
                ...
                f.b.a.c.b.o.b.G(f.this.f3835l != -1, "streamId should be set");
                bVar.H.a(z2, f.this.f3835l, eVar, z3);
            }
        }
        ...
        public void e(boolean z2) {
            ...
            if (!this.o) {
                ...
                this.I.k(f.this.f3835l, null, aVar, false, null, null);
            }
        ...
        public void f(int i2) {
            ...
            if (((float) i3) <= ((float) i4) * 0.5f) {
                ...
                this.E += i5;
                this.F = i3 + i5;
                this.G.u(f.this.f3835l, (long) i5);
            }
        }
        ...
        public final void n(c1 c1Var, boolean z2, n0 n0Var) {
            ...
            if (!this.D) {
                ...
                synchronized (gVar2.f3842j) {
                    ...
                    if (remove != null) {
                        gVar2.f3840h.T(i2, h.a.k1.p.m.a.CANCEL);
                        if (c1Var != null) {
                            b bVar = remove.m;
                            if (n0Var == null) {
                                n0Var = new n0();
        ...
        public void o(e eVar, boolean z2) {
            ...
            this.E = i2;
            if (i2 < 0) {
                this.G.T(f.this.f3835l, h.a.k1.p.m.a.FLOW_CONTROL_ERROR);
                this.I.k(f.this.f3835l, c1.m.g("Received data size exceeded our receiving window size"), aVar, false, null, null);
                return;
            }
            j jVar = new j(eVar);
            c1 c1Var2 = this.r;
            ...
            if (c1Var2 != null) {
                ...
                try {
                    if (this.p) {
                        h.a.j1.a.f3546f.log(Level.INFO, "Received data on closed stream");
                        jVar.b.c();
                    } else {
                        try {
                            this.b.P(jVar);
        ...
        public void p(List<h.a.k1.p.m.d> list, boolean z2) {
            ...
            if (z2) {
                ...
                if (c1Var4 != null) {
                    ...
                    f.b.a.c.b.o.b.A(n0Var, "trailers");
                    if (!this.p) {
                        h.a.j1.a.f3546f.log(Level.INFO, "Received trailers on closed stream:\n {1}\n {2}", new Object[]{c1Var2, n0Var});
                        return;
                    }
    ...
    public f(o0<?, ?> o0Var, n0 n0Var, b bVar, g gVar, n nVar, Object obj, int i2, int i3, String str, String str2, w2 w2Var, c3 c3Var, h.a.c cVar, boolean z) {
        super(new m(), w2Var, c3Var, n0Var, cVar, z && o0Var.f3962h);
        this.f3835l = -1;
        this.n = new a();
        this.p = false;
