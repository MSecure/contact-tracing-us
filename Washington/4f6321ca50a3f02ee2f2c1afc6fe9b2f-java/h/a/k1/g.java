...
public class g implements z, b.a {
    ...
    public final Random f3836d = new Random();

    /* renamed from: e  reason: collision with root package name */
    public final t<s> f3837e;
    ...
    public final Object f3842j;

    /* renamed from: k  reason: collision with root package name */
    public final d0 f3843k;
    ...
    public class a extends x0<f> {
        ...
        @Override // h.a.j1.x0
        public void a() {
            g.this.f3839g.c(true);
        }

        @Override // h.a.j1.x0
        public void b() {
            g.this.f3839g.c(false);
        }
    }
    ...
    public class c implements Runnable {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final /* synthetic */ i f3845d;
            ...
            try {
                ...
                if (zVar == null) {
                    ...
                    if (socketAddress instanceof InetSocketAddress) {
                        h2 = g.h(gVar2, zVar.c, (InetSocketAddress) socketAddress, zVar.f3992d, zVar.f3993e);
                    } else {
                        c1 c1Var = c1.m;
                ...
                try {
                    ...
                    b2.b(y.c, sSLSession);
                    b2.b(p0.f3712d, sSLSession == null ? z0.NONE : z0.PRIVACY_AND_INTEGRITY);
                    gVar4.s = b2.a();
                    g gVar5 = g.this;
                    gVar5.r = new e(gVar5, ((f) this.f3845d).e(nVar2, true));
                    synchronized (g.this.f3842j) {
                        g gVar6 = g.this;
                    ...
                    gVar = g.this;
                    eVar = new e(gVar, ((f) this.f3845d).e(nVar, true));
                    gVar.r = eVar;
                } catch (Exception e5) {
                    e3 = e5;
                    nVar = nVar2;
                    try {
                        ...
                        nVar2 = nVar;
                        g gVar8 = g.this;
                        gVar8.r = new e(gVar8, ((f) this.f3845d).e(nVar2, true));
                        throw th;
                    }
                } catch (Throwable th3) {
                    th = th3;
                    g gVar82 = g.this;
                    gVar82.r = new e(gVar82, ((f) this.f3845d).e(nVar2, true));
                    throw th;
                }
            } catch (d1 e6) {
                e2 = e6;
    ...
    static {
        ...
        enumMap.put((Object) h.a.k1.p.m.a.CANCEL, (Object) c1.f3518g.g("Cancelled"));
        ...
        enumMap.put((Object) h.a.k1.p.m.a.ENHANCE_YOUR_CALM, (Object) c1.f3523l.g("Enhance your calm"));
        enumMap.put((Object) h.a.k1.p.m.a.INADEQUATE_SECURITY, (Object) c1.f3521j.g("Inadequate security"));
    ...
    public g(InetSocketAddress inetSocketAddress, String str, String str2, h.a.a aVar, Executor executor, SocketFactory socketFactory, SSLSocketFactory sSLSocketFactory, HostnameVerifier hostnameVerifier, h.a.k1.p.b bVar, int i2, int i3, h.a.z zVar, Runnable runnable, int i4, c3 c3Var, boolean z2) {
        ...
        this.L = i4;
        this.N = c3Var;
        this.f3843k = d0.a(g.class, inetSocketAddress.toString());
        a.b a2 = h.a.a.a();
        a2.b(p0.f3713e, aVar);
        this.s = a2.a();
        this.M = z2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x005c, code lost:
        if (r1.f3768d != false) goto L_0x0065;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x006f, code lost:
        r2 = new h.a.j1.u0(r12, r1.f3770f);
     */
    ...
    public void f(w.a aVar, Executor executor) {
        ...
        synchronized (this.f3842j) {
            boolean z2 = true;
            f.b.a.c.b.o.b.F(this.f3840h != null);
            if (this.w) {
            ...
            if (w0Var != null) {
                ...
                j2 = this.f3836d.nextLong();
                s sVar = this.f3837e.get();
                sVar.c();
            ...
            if (z2) {
                this.f3840h.C(false, (int) (j2 >>> 32), (int) j2);
            }
        }
    }
    ...
    public h.a.j1.u g(o0 o0Var, n0 n0Var, h.a.c cVar) {
        ...
        h.a.a aVar = this.s;
        w2 w2Var2 = w2.c;
        List<j.a> list = cVar.f3511g;
        if (list.isEmpty()) {
            w2Var = w2.c;
        } else {
            h.a.a aVar2 = h.a.a.b;
            h.a.c cVar2 = h.a.c.f3507k;
        ...
        Object obj2 = this.f3842j;
        synchronized (obj2) {
            try {
                obj = obj2;
                try {
                    f fVar = new f(o0Var, n0Var, this.f3840h, this, this.f3841i, this.f3842j, this.p, this.f3838f, this.b, this.c, w2Var, this.N, cVar, this.M);
                    return fVar;
                } catch (Throwable th2) {
                    th = th2;
                    while (true) {
                            ...
                            while (i2 < address.length) {
                                if (i2 == i27) {
                                    ...
                                    if (j2 == 0) {
                                        ...
                                        while (i31 >= i30) {
                                            bArr3[i31] = k.e.f4013d[(int) (j2 & 15)];
                                            j2 >>>= 4;
                                            i31--;
                                            i26 = i26;
                                            i27 = i27;
    ...
    public final void r(f fVar) {
        if (this.x && this.C.isEmpty() && this.m.isEmpty()) {
            ...
            if (j1Var != null) {
                synchronized (j1Var) {
                    if (!j1Var.f3634d) {
                        j1.e eVar = j1Var.f3635e;
                        if (eVar == j1.e.PING_SCHEDULED || eVar == j1.e.PING_DELAYED) {
                            j1Var.f3635e = j1.e.IDLE;
                        }
                        if (j1Var.f3635e == j1.e.PING_SENT) {
                            j1Var.f3635e = j1.e.IDLE_AND_PING_SENT;
                        }
                    }
                }
            }
    ...
    public void t() {
        synchronized (this.f3842j) {
            ...
            hVar.b(7, 0, this.f3838f);
            b bVar2 = this.f3840h;
            bVar2.f3816d.f(h.a.OUTBOUND, hVar);
            try {
                bVar2.c.o(hVar);
            } catch (IOException e3) {
                bVar2.b.b(e3);
    ...
    public final void v(int i2, h.a.k1.p.m.a aVar, c1 c1Var) {
        ...
        synchronized (this.f3842j) {
            ...
            if (aVar != null && !this.u) {
                this.u = true;
                this.f3840h.R(0, aVar, new byte[0]);
            }
            Iterator<Map.Entry<Integer, f>> it = this.m.entrySet().iterator();
            while (it.hasNext()) {
                Map.Entry<Integer, f> next = it.next();
    ...
    public final void x(f fVar) {
        f.b.a.c.b.o.b.G(fVar.f3835l == -1, "StreamId already assigned");
        this.m.put(Integer.valueOf(this.f3844l), fVar);
        u(fVar);
        f.b bVar = fVar.m;
        int i2 = this.f3844l;
        if (f.this.f3835l == -1) {
            f.this.f3835l = i2;
            f.b bVar2 = f.this.m;
            f.b.a.c.b.o.b.F(bVar2.f3553j != null);
            synchronized (bVar2.c) {
                f.b.a.c.b.o.b.G(!bVar2.f3590f, "Already allocated");
                bVar2.f3590f = true;
            }
            bVar2.d();
            c3 c3Var = bVar2.f3588d;
            c3Var.b++;
            c3Var.a.a();
            if (bVar.J) {
                b bVar3 = bVar.G;
                f fVar2 = f.this;
                bVar3.F(fVar2.p, false, fVar2.f3835l, 0, bVar.z);
                for (f1 f1Var : f.this.f3832i.a) {
                    Objects.requireNonNull((j) f1Var);
                }
                bVar.z = null;
                if (bVar.A.c > 0) {
                    bVar.H.a(bVar.B, f.this.f3835l, bVar.A, bVar.C);
                }
                bVar.J = false;
            }
            o0.c cVar = fVar.f3830g.a;
            if (!(cVar == o0.c.UNARY || cVar == o0.c.SERVER_STREAMING) || fVar.p) {
                this.f3840h.flush();
            }
            int i3 = this.f3844l;
            if (i3 >= 2147483645) {
                this.f3844l = Integer.MAX_VALUE;
        ...
        throw new IllegalStateException(f.b.a.c.b.o.b.n1("the stream has been started with id %s", Integer.valueOf(i2)));
    }
        ...
        if (this.t != null && this.m.isEmpty() && this.C.isEmpty() && !this.w) {
            ...
            if (j1Var != null) {
                synchronized (j1Var) {
                    ...
                    if (eVar != eVar2) {
                        j1Var.f3635e = eVar2;
                        ScheduledFuture<?> scheduledFuture = j1Var.f3636f;
                        if (scheduledFuture != null) {
                            scheduledFuture.cancel(false);
                        }
                        ScheduledFuture<?> scheduledFuture2 = j1Var.f3637g;
            ...
            if (!this.u) {
                this.u = true;
                this.f3840h.R(0, h.a.k1.p.m.a.NO_ERROR, new byte[0]);
            }
            this.f3840h.close();
        }
    }
