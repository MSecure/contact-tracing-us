...
public final class n0 {
    ...
    public static final f.b.b.c.a f3948d;
    public Object[] a;
    public int b;
    ...
    public static class c<T> extends f<T> {
        ...
        public T c(byte[] bArr) {
            return this.f3949f.b(new String(bArr, f.b.b.a.d.a));
        }

        @Override // h.a.n0.f
        public byte[] d(T t) {
            return this.f3949f.a(t).getBytes(f.b.b.a.d.a);
        }
    }
    ...
    public static abstract class f<T> {
        ...
        public static final BitSet f3950e;
        ...
        public f(String str, boolean z, Object obj, a aVar) {
            ...
            for (int i2 = 0; i2 < lowerCase.length(); i2++) {
                ...
                if (!(z && charAt == ':' && i2 == 0) && !f3950e.get(charAt)) {
    ...
    public static final class h<T> extends f<T> {
        ...
        @Override // h.a.n0.f
        public T c(byte[] bArr) {
            return this.f3952f.b(bArr);
        }

        @Override // h.a.n0.f
        public byte[] d(T t) {
            return this.f3952f.a(t);
        }
    }
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < this.b; i2++) {
            ...
            sb.append(str);
            sb.append('=');
            sb.append(str.endsWith("-bin") ? f3948d.c(k(i2)) : new String(k(i2), charset));
        }
        sb.append(')');
        return sb.toString();
    }
