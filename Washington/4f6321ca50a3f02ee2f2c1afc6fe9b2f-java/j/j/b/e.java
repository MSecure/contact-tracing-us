...
public class e {
    ...
    public static void b(Object obj, String str) {
        if (obj == null) {
            NullPointerException nullPointerException = new NullPointerException(a.t(str, " must not be null"));
    ...
    public static void e(String str) {
        f fVar = new f(a.c("lateinit property ", str, " has not been initialized"));
        d(fVar, e.class.getName());
        throw fVar;
    }
}
