...
public final class g extends c implements d, f, Comparable<g>, Serializable {
    ...
    public static final g f4047f;

    /* renamed from: g  reason: collision with root package name */
    public static final g f4048g = new g(23, 59, 59, 999999999);

    /* renamed from: h  reason: collision with root package name */
    public static final g f4049h;

    /* renamed from: i  reason: collision with root package name */
    public static final g[] f4050i = new g[24];
    public final byte b;
    public final byte c;

    /* renamed from: d  reason: collision with root package name */
    public final byte f4051d;
    ...
    public static g r(int i2, int i3, int i4, int i5) {
        return ((i3 | i4) | i5) == 0 ? f4050i[i2] : new g(i2, i3, i4, i5);
    }
    ...
    public g A(long j2) {
        ...
        return i2 == i3 ? this : r(i3 / 60, i3 % 60, this.f4051d, this.f4052e);
    }
    ...
    public g C(long j2) {
        ...
        int i2 = (this.c * 60) + (this.b * 3600) + this.f4051d;
        int i3 = ((((int) (j2 % 86400)) + i2) + 86400) % 86400;
        return i2 == i3 ? this : r(i3 / 3600, (i3 / 60) % 60, i3 % 60, this.f4052e);
    }

    public long E() {
        return (((long) this.f4051d) * 1000000000) + (((long) this.c) * 60000000000L) + (((long) this.b) * 3600000000000L) + ((long) this.f4052e);
    }

    public int F() {
        return (this.c * 60) + (this.b * 3600) + this.f4051d;
    }
    ...
    public g l(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            ...
            case 6:
                ...
                return r(this.b, this.c, i2, this.f4052e);
            case 7:
                return C(j2 - ((long) F()));
            case 8:
                int i3 = (int) j2;
                ...
                aVar3.f4190e.b((long) i3, aVar3);
                return r(this.b, i3, this.f4051d, this.f4052e);
            case 9:
    ...
    public g H(int i2) {
        ...
        l.b.a.w.a aVar = l.b.a.w.a.HOUR_OF_DAY;
        aVar.f4190e.b((long) i2, aVar);
        return r(i2, this.c, this.f4051d, this.f4052e);
    }
    ...
    public g I(int i2) {
        ...
        aVar.f4190e.b((long) i2, aVar);
        return r(this.b, this.c, this.f4051d, i2);
    }
    ...
    public void J(DataOutput dataOutput) {
        ...
        dataOutput.writeByte(this.b);
        dataOutput.writeByte(this.c);
        dataOutput.writeByte(this.f4051d);
        dataOutput.writeInt(this.f4052e);
    }
    ...
    public <R> R c(l<R> lVar) {
        ...
        if (lVar == k.b || lVar == k.a || lVar == k.f4206d || lVar == k.f4207e || lVar == k.f4208f) {
            return null;
        }
        return lVar.a(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        g gVar = (g) obj;
        return this.b == gVar.b && this.c == gVar.c && this.f4051d == gVar.f4051d && this.f4052e == gVar.f4052e;
    }
    ...
    public int compareTo(g gVar) {
        ...
        int K3 = f.b.a.c.b.o.b.K(this.f4051d, gVar.f4051d);
        return K3 == 0 ? f.b.a.c.b.o.b.K(this.f4052e, gVar.f4052e) : K3;
    }
    ...
    public final int t(j jVar) {
        switch (((l.b.a.w.a) jVar).ordinal()) {
            ...
            case 2:
                return this.f4052e / 1000;
            case 3:
                throw new a(a.d("Field too large for an int: ", jVar));
            case 4:
                return this.f4052e / 1000000;
            case 5:
    ...
    public g z(long j2) {
        return j2 == 0 ? this : r(((((int) (j2 % 24)) + this.b) + 24) % 24, this.c, this.f4051d, this.f4052e);
    }
}
