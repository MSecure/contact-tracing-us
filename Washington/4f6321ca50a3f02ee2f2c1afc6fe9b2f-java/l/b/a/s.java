...
public final class s extends f<e> implements d, Serializable {
    ...
    public static s I(f fVar, p pVar, q qVar) {
        ...
        if (c2.size() == 1) {
            ...
            if (c2.size() == 0) {
                ...
                fVar = fVar.K(c.l((long) (b2.f4232d.c - b2.c.c)).b);
                qVar = b2.f4232d;
    ...
    public f<e> D(p pVar) {
        b.B1(pVar, "zone");
        return this.f4076d.equals(pVar) ? this : I(this.b, pVar, this.c);
    }
    ...
    public s u(long j2, m mVar) {
        ...
        b.B1(qVar, "offset");
        b.B1(pVar, "zone");
        return E(H.v(qVar), H.c.f4052e, pVar);
    }

    public s K(long j2) {
        f fVar = this.b;
        return I(fVar.N(fVar.b.V(j2), fVar.c), this.f4076d, this.c);
    }

    public final s L(f fVar) {
        return I(fVar, this.f4076d, this.c);
    }

    public final s M(q qVar) {
        return (qVar.equals(this.c) || !this.f4076d.s().f(this.b, qVar)) ? this : new s(this.b, qVar, this.f4076d);
    }

    /* renamed from: N */
    public s e(l.b.a.w.f fVar) {
        if (fVar instanceof e) {
            return I(f.F((e) fVar, this.b.c), this.f4076d, this.c);
        }
        if (fVar instanceof g) {
            return I(f.F(this.b.b, (g) fVar), this.f4076d, this.c);
        }
        ...
        d dVar = (d) fVar;
        return E(dVar.b, dVar.c, this.f4076d);
    }
    ...
    public s l(j jVar, long j2) {
        ...
        if (ordinal == 28) {
            return E(j2, this.b.c.f4052e, this.f4076d);
        }
        if (ordinal != 29) {
            return L(this.b.l(jVar, j2));
        }
        return M(q.z(aVar.f4190e.a(j2, aVar)));
    }

    /* renamed from: P */
    public s C(p pVar) {
        b.B1(pVar, "zone");
        return this.f4076d.equals(pVar) ? this : E(this.b.v(this.c), this.b.c.f4052e, pVar);
    }
    ...
    public <R> R c(l<R> lVar) {
        return lVar == k.f4208f ? (R) this.b.b : (R) super.c(lVar);
    }
    ...
    public boolean equals(Object obj) {
        ...
        s sVar = (s) obj;
        return this.b.equals(sVar.b) && this.c.equals(sVar.c) && this.f4076d.equals(sVar.f4076d);
    }
    ...
    @Override // l.b.a.t.f
    public int hashCode() {
        return (this.b.hashCode() ^ this.c.c) ^ Integer.rotateLeft(this.f4076d.hashCode(), 3);
    }
    ...
    public String toString() {
        ...
        if (this.c == this.f4076d) {
            return str;
        }
        return str + '[' + this.f4076d.toString() + ']';
    }
