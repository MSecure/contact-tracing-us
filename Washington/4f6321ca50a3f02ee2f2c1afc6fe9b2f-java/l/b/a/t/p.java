...
public final class p extends a<p> implements Serializable {
    ...
    public static final e f4099e = e.P(1873, 1, 1);
    public final e b;
    public transient q c;

    /* renamed from: d  reason: collision with root package name */
    public transient int f4100d;

    public p(e eVar) {
        if (!eVar.J(f4099e)) {
            q r = q.r(eVar);
            this.c = r;
            this.f4100d = eVar.b - (r.c.b - 1);
            this.b = eVar;
            return;
        }
    ...
    public final o E(int i2) {
        Calendar instance = Calendar.getInstance(o.f4094d);
        instance.set(0, this.c.b + 2);
        int i3 = this.f4100d;
        e eVar = this.b;
        instance.set(i3, eVar.c - 1, eVar.f4044d);
        return o.d((long) instance.getActualMinimum(i2), (long) instance.getActualMaximum(i2));
    }

    public final long F() {
        return (long) (this.f4100d == 1 ? (this.b.H() - this.c.c.H()) + 1 : this.b.H());
    }
    ...
    public p z(j jVar, long j2) {
        ...
        if (ordinal == 19 || ordinal == 25 || ordinal == 27) {
            int a = o.f4095e.u(aVar).a(j2, aVar);
    ...
    public final p I(q qVar, int i2) {
        Objects.requireNonNull(o.f4095e);
    ...
    public d e(f fVar) {
        return (p) o.f4095e.e(fVar.n(this));
    }
    ...
    @Override // l.b.a.t.b
    public b w(i iVar) {
        return (p) o.f4095e.e(((l) iVar).b(this));
    }
