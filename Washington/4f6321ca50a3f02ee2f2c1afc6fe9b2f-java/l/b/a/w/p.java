...
public final class p implements Serializable {
    ...
    public static final ConcurrentMap<String, p> f4212h = new ConcurrentHashMap(4, 0.75f, 2);
    public final b b;
    public final int c;

    /* renamed from: d  reason: collision with root package name */
    public final transient j f4213d;

    /* renamed from: e  reason: collision with root package name */
    public final transient j f4214e;

    /* renamed from: f  reason: collision with root package name */
    public final transient j f4215f;

    /* renamed from: g  reason: collision with root package name */
    public final transient j f4216g;

    public static class a implements j {

        /* renamed from: g  reason: collision with root package name */
        public static final o f4217g = o.d(1, 7);

        /* renamed from: h  reason: collision with root package name */
        public static final o f4218h = o.f(0, 1, 4, 6);

        /* renamed from: i  reason: collision with root package name */
        public static final o f4219i = o.f(0, 1, 52, 54);

        /* renamed from: j  reason: collision with root package name */
        public static final o f4220j = o.e(1, 52, 53);

        /* renamed from: k  reason: collision with root package name */
        public static final o f4221k = a.YEAR.f4190e;
        public final String b;
        public final p c;

        /* renamed from: d  reason: collision with root package name */
        public final m f4222d;

        /* renamed from: e  reason: collision with root package name */
        public final m f4223e;
        ...
        public <R extends d> R c(R r, long j2) {
            long j3;
            int a = this.f4224f.a(j2, this);
            int b2 = r.b(this);
            if (a == b2) {
                return r;
            }
            if (this.f4223e != b.FOREVER) {
                return (R) r.m((long) (a - b2), this.f4222d);
            }
            int b3 = r.b(this.c.f4215f);
            b bVar = b.WEEKS;
            R r2 = (R) r.m((long) (((double) (j2 - ((long) b2))) * 52.1775d), bVar);
            if (r2.b(this) > a) {
                j3 = (long) r2.b(this.c.f4215f);
            } else {
                if (r2.b(this) < a) {
                    r2 = (R) r2.m(2, bVar);
                }
                r2 = (R) r2.m((long) (b3 - r2.b(this.c.f4215f)), bVar);
                if (r2.b(this) <= a) {
                    return r2;
                }
                j3 = 1;
        ...
        public e e(Map<j, Long> map, e eVar, l lVar) {
            ...
            l lVar3 = l.LENIENT;
            int q = this.c.b.q();
            if (this.f4223e == b.WEEKS) {
                map.put(a.DAY_OF_WEEK, Long.valueOf((long) (f.b.a.c.b.o.b.E0((this.f4224f.a(map.remove(this).longValue(), this) - 1) + (q - 1), 7) + 1)));
                return null;
            }
            ...
            if (this.f4223e != b.FOREVER) {
                ...
                if (mVar == bVar4) {
                    ...
                    if (lVar == lVar3) {
                        ...
                        i3 = g(bVar2, q);
                        longValue = (long) this.f4224f.a(longValue, this);
                    }
                    ...
                    if (lVar == lVar3) {
                        ...
                        i2 = g(b3, q);
                        longValue2 = (long) this.f4224f.a(longValue2, this);
                    }
            ...
            } else if (!map.containsKey(this.c.f4215f)) {
                return null;
            } else {
                h l3 = h.l(eVar);
                int E02 = f.b.a.c.b.o.b.E0(aVar.m(map.get(aVar).longValue()) - q, 7) + 1;
                int a = this.f4224f.a(map.get(this).longValue(), this);
                if (lVar == lVar3) {
                    bVar3 = l3.b(a, 1, this.c.c);
                    j2 = map.get(this.c.f4215f).longValue();
                } else {
                    bVar3 = l3.b(a, 1, this.c.c);
                    j2 = (long) this.c.f4215f.h().a(map.get(this.c.f4215f).longValue(), this.c.f4215f);
                }
                int g2 = g(bVar3, q);
                bVar = bVar3.m(((j2 - j(bVar3, g2)) * 7) + ((long) (E02 - g2)), b.DAYS);
                if (lVar != lVar2 || bVar.i(this) == map.get(this).longValue()) {
                    map.remove(this);
                    map.remove(this.c.f4215f);
                } else {
                    throw new l.b.a.a("Strict mode rejected date parsed to a different year");
                }
            }
        ...
        public o l(e eVar) {
            ...
            o a = eVar.a(aVar);
            return o.d((long) d(m, (int) a.b), (long) d(m, (int) a.f4211e));
        }
    ...
    public p(b bVar, int i2) {
        b bVar2 = b.DAYS;
        b bVar3 = b.WEEKS;
        this.f4213d = new a("DayOfWeek", this, bVar2, bVar3, a.f4217g);
        this.f4214e = new a("WeekOfMonth", this, bVar3, b.MONTHS, a.f4218h);
        b bVar4 = b.YEARS;
        o oVar = a.f4219i;
        m mVar = c.a;
        this.f4215f = new a("WeekOfWeekBasedYear", this, bVar3, mVar, a.f4220j);
        this.f4216g = new a("WeekBasedYear", this, mVar, b.FOREVER, a.f4221k);
    ...
    public static p a(Locale locale) {
        ...
        b bVar = b.SUNDAY;
        return b(b.f4037i[((((int) (((long) (firstDayOfWeek - 1)) % 7)) + 7) + 6) % 7], gregorianCalendar.getMinimalDaysInFirstWeek());
    }

    public static p b(b bVar, int i2) {
        String str = bVar.toString() + i2;
        ConcurrentMap<String, p> concurrentMap = f4212h;
