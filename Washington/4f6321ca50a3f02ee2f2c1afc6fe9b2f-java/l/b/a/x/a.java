...
public final class a implements Externalizable {
    ...
    public void writeExternal(ObjectOutput objectOutput) {
        ...
        if (b2 == 1) {
            ...
            objectOutput.writeInt(bVar.f4225d.length);
            for (long j3 : bVar.f4225d) {
                d(j3, objectOutput);
            }
            for (q qVar2 : bVar.f4227f) {
                e(qVar2, objectOutput);
            }
            objectOutput.writeByte(bVar.f4228g.length);
            for (e eVar : bVar.f4228g) {
                eVar.b(objectOutput);
            }
        } else if (b2 == 2) {
            d dVar = (d) obj;
