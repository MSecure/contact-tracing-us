...
public final class UploadCoverTrafficWorker extends ListenableWorker {
    ...
    public final k f350i;

    public UploadCoverTrafficWorker(Context context, WorkerParameters workerParameters, u uVar, ExecutorService executorService, ExecutorService executorService2, SecureRandom secureRandom, k kVar) {
    ...
    public f.b.b.f.a.u<ListenableWorker.a> d() {
        ...
        l y = l.x(this.f350i.a()).z(new p(this), this.f348g).y(n.a, this.f348g);
        o oVar = o.a;
