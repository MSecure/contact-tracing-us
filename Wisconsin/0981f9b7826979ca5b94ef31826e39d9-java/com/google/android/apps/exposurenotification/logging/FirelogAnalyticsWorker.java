...
public class FirelogAnalyticsWorker extends ListenableWorker {
    ...
    public FirelogAnalyticsWorker(Context context, WorkerParameters workerParameters, p pVar, k kVar, ExecutorService executorService) {
    ...
    public u<ListenableWorker.a> d() {
        l y = l.x(this.f353f.a()).z(new n(this), this.f354g).y(new f.b.a.a.a.m.l(this), this.f354g);
        m mVar = new m(this);
        ...
        f.b.a.a.a.m.k kVar = new f.b.a.a.a.m.k(this);
