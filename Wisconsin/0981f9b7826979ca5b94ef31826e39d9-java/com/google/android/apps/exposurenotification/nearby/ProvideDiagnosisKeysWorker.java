...
public class ProvideDiagnosisKeysWorker extends ListenableWorker {
    ...
    public ProvideDiagnosisKeysWorker(Context context, WorkerParameters workerParameters, n nVar, f0 f0Var, d0 d0Var, DiagnosisKeysDataMapping diagnosisKeysDataMapping, ExecutorService executorService, ScheduledExecutorService scheduledExecutorService, k kVar, p pVar) {
    ...
    public u<ListenableWorker.a> d() {
        l z = l.x(this.f361k.a()).z(new s(this), this.f359i).z(new t(this), this.f359i);
        ...
        l z2 = aVar.z(new r(this), this.f359i);
        d0 d0Var = this.f356f;
        Objects.requireNonNull(d0Var);
        l y = z2.z(new f.b.a.a.a.n.p(d0Var), this.f359i).y(new q(this), this.f359i);
        w wVar = new w(this);
