...
public class SubmitPrivateAnalyticsWorker extends ListenableWorker {
    ...
    public SubmitPrivateAnalyticsWorker(Context context, WorkerParameters workerParameters, b0 b0Var, ExecutorService executorService, k kVar, p pVar) {
    ...
    public u<ListenableWorker.a> d() {
        l y = l.x(this.f392h.a()).z(new n(this), this.f390f).y(f.b.a.a.a.r.l.a, this.f390f);
        m mVar = m.a;
