...
public class CountryCheckingWorker extends ListenableWorker {
    ...
    public final k f395g;

    /* renamed from: h  reason: collision with root package name */
    public final p f396h;

    public CountryCheckingWorker(Context context, WorkerParameters workerParameters, ExecutorService executorService, d dVar, k kVar, p pVar) {
    ...
    public u<ListenableWorker.a> d() {
        l z = l.x(this.f395g.a()).z(new b(this), this.f393e);
        a aVar = new a(this);
