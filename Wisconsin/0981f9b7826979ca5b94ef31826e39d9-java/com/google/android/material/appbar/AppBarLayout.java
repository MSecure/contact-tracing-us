...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.b {
    ...
    public WeakReference<View> f447l;
    ...
    public static class BaseBehavior<T extends AppBarLayout> extends e<T> {
        ...
        public static class a extends e.k.a.a {
            ...
            public a(Parcel parcel, ClassLoader classLoader) {
                ...
                this.f452e = parcel.readFloat();
                this.f453f = parcel.readByte() != 0;
            }
            ...
            public void writeToParcel(Parcel parcel, int i2) {
                ...
                parcel.writeFloat(this.f452e);
                parcel.writeByte(this.f453f ? (byte) 1 : 0);
            }
        }
            ...
            if (i3 == 0 || E < i3 || E > i4) {
                ...
                if (E != s) {
                    if (appBarLayout.f441f) {
                        ...
                        int i10 = E - s;
                        this.f448j = s - i5;
                        if (!D && appBarLayout.f441f && (orDefault = coordinatorLayout.c.b.getOrDefault(appBarLayout, null)) != null && !orDefault.isEmpty()) {
        ...
        public final void I(CoordinatorLayout coordinatorLayout, T t, int i2, float f2) {
            ...
            int E = E();
            if (E == i2) {
                ValueAnimator valueAnimator = this.f450l;
            ...
            ValueAnimator valueAnimator2 = this.f450l;
            if (valueAnimator2 == null) {
                ValueAnimator valueAnimator3 = new ValueAnimator();
                this.f450l = valueAnimator3;
                valueAnimator3.setInterpolator(f.b.a.d.a.a.f2554e);
                this.f450l.addUpdateListener(new b(this, coordinatorLayout, t));
            } else {
                valueAnimator2.cancel();
            }
            this.f450l.setDuration((long) Math.min(round, 600));
            this.f450l.setIntValues(E, i2);
            this.f450l.start();
        }
        ...
        public boolean N(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, View view, int i2, int i3) {
            ...
            if ((i2 & 2) != 0) {
                ...
                if (z && (valueAnimator = this.f450l) != null) {
                            ...
                            if (c) {
                                ...
                                while (true) {
                                    ...
                                    if (!(cVar instanceof ScrollingViewBehavior)) {
                                        i6++;
                                    } else if (((ScrollingViewBehavior) cVar).f2568f != 0) {
                                        z3 = true;
                                    }
                                }
                                if (!z3) {
        ...
        public Parcelable v(CoordinatorLayout coordinatorLayout, View view) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (childAt.getTop() + B <= 0 && bottom >= 0) {
                    ...
                    aVar.f453f = z;
                    aVar.f452e = ((float) bottom) / ((float) childAt.getHeight());
                    return aVar;
                }
            }
    ...
    public static class ScrollingViewBehavior extends f {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            ...
            this.f2568f = obtainStyledAttributes.getDimensionPixelSize(R$styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0);
        ...
        public boolean g(CoordinatorLayout coordinatorLayout, View view, View view2) {
            ...
            if (cVar instanceof BaseBehavior) {
                l.m(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) cVar).f448j) + this.f2567e) - E(view2));
            }
        ...
        public void h(CoordinatorLayout coordinatorLayout, View view, View view2) {
            if (view2 instanceof AppBarLayout) {
                l.o(b.a.f1485f.a(), coordinatorLayout);
                l.k(coordinatorLayout, 0);
                l.o(b.a.f1486g.a(), coordinatorLayout);
                l.k(coordinatorLayout, 0);
            }
        }
    ...
    public boolean c(boolean z) {
        ...
        if (this.f445j && (getBackground() instanceof g)) {
    ...
    public boolean d(View view) {
        int i2;
        View view2 = null;
        if (this.f447l == null && (i2 = this.f446k) != -1) {
            View findViewById = view != null ? view.findViewById(i2) : null;
            if (findViewById == null && (getParent() instanceof ViewGroup)) {
                findViewById = ((ViewGroup) getParent()).findViewById(this.f446k);
            }
            if (findViewById != null) {
                this.f447l = new WeakReference<>(findViewById);
            }
        }
        WeakReference<View> weakReference = this.f447l;
    ...
    public int[] onCreateDrawableState(int i2) {
        ...
        iArr[0] = i3;
        iArr[1] = (!z || !this.f444i) ? -R$attr.state_lifted : R$attr.state_lifted;
        int i4 = R$attr.state_collapsible;
        if (!z) {
            i4 = -i4;
        }
        iArr[2] = i4;
        iArr[3] = (!z || !this.f444i) ? -R$attr.state_collapsed : R$attr.state_collapsed;
