...
public class TextInputLayout extends LinearLayout {
    ...
    public final LinearLayout f604d;
    public int d0 = 0;

    /* renamed from: e  reason: collision with root package name */
    public final FrameLayout f605e;
    ...
    public final n f608h = new n(this);
    ...
    public class c implements Runnable {
        ...
        public void run() {
            TextInputLayout.this.f606f.requestLayout();
        }
    }
    ...
    public static class e extends e.i.i.a {
        ...
        /* renamed from: d  reason: collision with root package name */
        public final TextInputLayout f613d;

        public e(TextInputLayout textInputLayout) {
            this.f613d = textInputLayout;
        }

        @Override // e.i.i.a
        public void d(View view, e.i.i.w.b bVar) {
            this.a.onInitializeAccessibilityNodeInfo(view, bVar.a);
            EditText editText = this.f613d.getEditText();
            Editable text = editText != null ? editText.getText() : null;
            CharSequence hint = this.f613d.getHint();
            CharSequence error = this.f613d.getError();
            int counterMaxLength = this.f613d.getCounterMaxLength();
            CharSequence counterOverflowDescription = this.f613d.getCounterOverflowDescription();
    ...
    public static class h extends e.k.a.a {
        ...
        /* renamed from: d  reason: collision with root package name */
        public CharSequence f614d;

        /* renamed from: e  reason: collision with root package name */
        public boolean f615e;

        /* renamed from: f  reason: collision with root package name */
        public CharSequence f616f;

        /* renamed from: g  reason: collision with root package name */
        public CharSequence f617g;
        ...
        public h(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f614d = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel);
            this.f615e = parcel.readInt() != 1 ? false : true;
            this.f616f = (CharSequence) TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(parcel);
        ...
        public String toString() {
            ...
            h2.append(" error=");
            h2.append((Object) this.f614d);
            h2.append(" hint=");
            h2.append((Object) this.f616f);
            h2.append(" helperText=");
            h2.append((Object) this.f617g);
            h2.append(" placeholderText=");
            h2.append((Object) this.f618h);
            h2.append("}");
            return h2.toString();
        }
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            TextUtils.writeToParcel(this.f614d, parcel, i2);
            parcel.writeInt(this.f615e ? 1 : 0);
            TextUtils.writeToParcel(this.f616f, parcel, i2);
            TextUtils.writeToParcel(this.f617g, parcel, i2);
            TextUtils.writeToParcel(this.f618h, parcel, i2);
        }
    }
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f604d = linearLayout2;
        linearLayout2.setOrientation(0);
        linearLayout2.setLayoutParams(new FrameLayout.LayoutParams(-2, -1, 8388613));
        frameLayout.addView(linearLayout2);
        FrameLayout frameLayout2 = new FrameLayout(context2);
        this.f605e = frameLayout2;
        ...
        this.f0 = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(i27, (ViewGroup) this.f605e, false);
        this.f605e.addView(this.f0);
        ...
        if (!y0Var.o(R$styleable.TextInputLayout_passwordToggleEnabled)) {
            ...
            if (y0Var.o(i42)) {
                ...
                this.f604d.addView(zVar2);
                this.f604d.addView(this.q0);
                this.f604d.addView(this.f605e);
    ...
    private void setEditText(EditText editText) {
        if (this.f606f == null) {
            ...
            this.E0.q(this.f606f.getTypeface());
            f.b.a.d.q.c cVar = this.E0;
            float textSize = this.f606f.getTextSize();
            if (cVar.f2683i != textSize) {
                cVar.f2683i = textSize;
                cVar.k();
            }
            int gravity = this.f606f.getGravity();
            this.E0.n((gravity & -113) | 48);
            f.b.a.d.q.c cVar2 = this.E0;
            if (cVar2.f2681g != gravity) {
                cVar2.f2681g = gravity;
                cVar2.k();
            }
            this.f606f.addTextChangedListener(new a());
            if (this.s0 == null) {
                this.s0 = this.f606f.getHintTextColors();
            }
            if (this.z) {
                if (TextUtils.isEmpty(this.A)) {
                    CharSequence hint = this.f606f.getHint();
                    this.f607g = hint;
                    setHint(hint);
                    this.f606f.setHint((CharSequence) null);
                }
                this.B = true;
            }
            if (this.f612l != null) {
                t(this.f606f.getText().length());
            }
            w();
            this.f608h.b();
            this.c.bringToFront();
            this.f604d.bringToFront();
            this.f605e.bringToFront();
    ...
    private void setErrorIconVisible(boolean z2) {
        ...
        FrameLayout frameLayout = this.f605e;
        if (z2) {
            i2 = 8;
        }
    ...
    public final void A() {
        ...
        if (this.f606f != null) {
            ...
            int compoundPaddingTop = this.f606f.getCompoundPaddingTop();
            int compoundPaddingBottom = this.f606f.getCompoundPaddingBottom();
        ...
        if (this.f606f != null) {
            if (!k()) {
                if (!(this.q0.getVisibility() == 0)) {
                    ...
                    int paddingTop = this.f606f.getPaddingTop();
                    int paddingBottom = this.f606f.getPaddingBottom();
                    AtomicInteger atomicInteger2 = l.a;
            ...
            int paddingTop2 = this.f606f.getPaddingTop();
            int paddingBottom2 = this.f606f.getPaddingBottom();
    ...
    public void F() {
        ...
        if (this.C != null && this.G != 0) {
            boolean z2 = false;
            boolean z3 = isFocused() || ((editText2 = this.f606f) != null && editText2.hasFocus());
            boolean z4 = isHovered() || ((editText = this.f606f) != null && editText.isHovered());
            if (!isEnabled()) {
                i2 = this.C0;
            } else {
                if (this.f608h.e()) {
                ...
                } else if (!this.f611k || (textView = this.f612l) == null) {
                ...
                if (getEndIconDelegate().d()) {
                    if (!this.f608h.e() || getEndIconDrawable() == null) {
                        d();
                    } else {
                        Drawable mutate = m.h.v1(getEndIconDrawable()).mutate();
                        mutate.setTint(this.f608h.g());
        ...
        if (gVar2 != null) {
            ...
            if (this.G == 2) {
                if (this.I > -1 && this.L != 0) {
                    ...
                    if (this.d0 == 3) {
                        this.f606f.getBackground().invalidateSelf();
                    }
                    gVar = this.D;
                    if (gVar != null) {
                        if (this.I > -1 && this.L != 0) {
    ...
    public void dispatchProvideAutofillStructure(ViewStructure viewStructure, int i2) {
        ...
        if (this.f607g != null) {
            ...
            this.f606f.setHint(this.f607g);
            try {
                super.dispatchProvideAutofillStructure(viewStructure, i2);
            } finally {
                this.f606f.setHint(hint);
                this.B = z2;
            }
        } else {
    ...
    public void drawableStateChanged() {
        ...
        if (!this.I0) {
            ...
            if (cVar != null) {
                ...
                ColorStateList colorStateList2 = cVar.f2686l;
                if ((colorStateList2 != null && colorStateList2.isStateful()) || ((colorStateList = cVar.f2685k) != null && colorStateList.isStateful())) {
                    cVar.k();
                    z3 = true;
                } else {
                    z3 = false;
    ...
    public float getBoxCornerRadiusBottomEnd() {
        ...
        return gVar.b.a.f2791h.a(gVar.h());
    }

    public float getBoxCornerRadiusBottomStart() {
        f.b.a.d.v.g gVar = this.C;
        return gVar.b.a.f2790g.a(gVar.h());
    }

    public float getBoxCornerRadiusTopEnd() {
        f.b.a.d.v.g gVar = this.C;
        return gVar.b.a.f2789f.a(gVar.h());
    }
    ...
    public CharSequence getCounterOverflowDescription() {
        TextView textView;
        if (!this.f609i || !this.f611k || (textView = this.f612l) == null) {
            return null;
        }
    ...
    public int getHelperTextCurrentTextColor() {
        TextView textView = this.f608h.r;
        if (textView != null) {
    ...
    public final int h(int i2, boolean z2) {
        int compoundPaddingLeft = this.f606f.getCompoundPaddingLeft() + i2;
    ...
    public final int i(int i2, boolean z2) {
        int compoundPaddingRight = i2 - this.f606f.getCompoundPaddingRight();
    ...
    public boolean k() {
        return this.f605e.getVisibility() == 0 && this.f0.getVisibility() == 0;
    }
    ...
    public final void m() {
        ...
        if (g()) {
            ...
            if (gravity == 17 || (gravity & 7) == 1) {
                ...
                f4 = (float) cVar.f2679e.right;
                f3 = cVar.b();
            } else {
                f2 = (float) cVar.f2679e.left;
                rectF.left = f2;
                Rect rect = cVar.f2679e;
                ...
                float f5 = cVar.f() + ((float) cVar.f2679e.top);
                rectF.bottom = f5;
                float f6 = rectF.left;
            ...
            float f52 = cVar.f() + ((float) cVar.f2679e.top);
            rectF.bottom = f52;
            ...
            if (this.z) {
                ...
                if (this.f606f != null) {
                    ...
                    if (i13 == 1) {
                        ...
                        rect2.left = this.f606f.getPaddingLeft() + rect.left;
                        rect2.top = rect.top - f();
                        i6 = rect.right - this.f606f.getPaddingRight();
                        rect2.right = i6;
                        ...
                        i9 = rect2.right;
                        i10 = rect2.bottom;
                        if (!f.b.a.d.q.c.l(cVar3.f2679e, i7, i8, i9, i10)) {
                            cVar3.f2679e.set(i7, i8, i9, i10);
                            cVar3.D = true;
                            cVar3.j();
                        }
                        ...
                        if (this.f606f == null) {
                            ...
                            textPaint.setTextSize(cVar4.f2683i);
                            textPaint.setTypeface(cVar4.t);
                            textPaint.setLetterSpacing(0.0f);
                            float f2 = -cVar4.F.ascent();
                            rect3.left = this.f606f.getCompoundPaddingLeft() + rect.left;
                            rect3.top = this.G == 1 && this.f606f.getMinLines() <= 1 ? (int) (((float) rect.centerY()) - (f2 / 2.0f)) : rect.top + this.f606f.getCompoundPaddingTop();
                            rect3.right = rect.right - this.f606f.getCompoundPaddingRight();
                            if (this.G == 1 && this.f606f.getMinLines() <= 1) {
                                z3 = true;
                            }
                            int compoundPaddingBottom = z3 ? (int) (((float) rect3.top) + f2) : rect.bottom - this.f606f.getCompoundPaddingBottom();
                            rect3.bottom = compoundPaddingBottom;
                            int i14 = rect3.left;
                            int i15 = rect3.top;
                            int i16 = rect3.right;
                            if (!f.b.a.d.q.c.l(cVar4.f2678d, i14, i15, i16, compoundPaddingBottom)) {
                                cVar4.f2678d.set(i14, i15, i16, compoundPaddingBottom);
                                cVar4.D = true;
                                cVar4.j();
                            }
                            this.E0.k();
    ...
    public void onMeasure(int i2, int i3) {
        ...
        boolean z2 = false;
        if (this.f606f != null && this.f606f.getMeasuredHeight() < (max = Math.max(this.f604d.getMeasuredHeight(), this.c.getMeasuredHeight()))) {
            this.f606f.setMinimumHeight(max);
            z2 = true;
        }
        boolean v2 = v();
        if (z2 || v2) {
            this.f606f.post(new c());
        }
        if (!(this.q == null || (editText = this.f606f) == null)) {
            this.q.setGravity(editText.getGravity());
            this.q.setPadding(this.f606f.getCompoundPaddingLeft(), this.f606f.getCompoundPaddingTop(), this.f606f.getCompoundPaddingRight(), this.f606f.getCompoundPaddingBottom());
        }
        A();
        D();
    }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        setHint(hVar.f616f);
        setHelperText(hVar.f617g);
        setPlaceholderText(hVar.f618h);
        requestLayout();
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        hVar.f615e = j() && this.f0.isChecked();
        hVar.f616f = getHint();
        hVar.f617g = getHelperText();
        hVar.f618h = getPlaceholderText();
        return hVar;
    }
    ...
    public void setCounterEnabled(boolean z2) {
        if (this.f609i != z2) {
            if (z2) {
                ...
                if (typeface != null) {
                    this.f612l.setTypeface(typeface);
                }
                this.f612l.setMaxLines(1);
                this.f608h.a(this.f612l, 2);
                ((ViewGroup.MarginLayoutParams) this.f612l.getLayoutParams()).setMarginStart(getResources().getDimensionPixelOffset(R$dimen.mtrl_textinput_counter_margin_start));
                u();
                s();
            } else {
                this.f608h.j(this.f612l, 2);
                this.f612l = null;
            }
            this.f609i = z2;
        }
    ...
    public void setError(CharSequence charSequence) {
        ...
        if (!TextUtils.isEmpty(charSequence)) {
            n nVar = this.f608h;
            nVar.c();
            nVar.f2854j = charSequence;
            nVar.f2856l.setText(charSequence);
            int i2 = nVar.f2852h;
            if (i2 != 1) {
                nVar.f2853i = 1;
            }
            nVar.l(i2, nVar.f2853i, nVar.k(nVar.f2856l, charSequence));
            return;
        }
        this.f608h.i();
    }
    ...
    public void setErrorEnabled(boolean z2) {
        ...
        if (nVar.f2855k != z2) {
            ...
            if (z2) {
                ...
                nVar.f2856l.setTextAlignment(5);
                Typeface typeface = nVar.u;
                if (typeface != null) {
                    nVar.f2856l.setTypeface(typeface);
                }
                int i2 = nVar.n;
                nVar.n = i2;
                TextView textView = nVar.f2856l;
                ...
                TextView textView2 = nVar.f2856l;
                if (!(textView2 == null || colorStateList == null)) {
                    textView2.setTextColor(colorStateList);
                }
                CharSequence charSequence = nVar.m;
                nVar.m = charSequence;
                TextView textView3 = nVar.f2856l;
                if (textView3 != null) {
                    textView3.setContentDescription(charSequence);
                }
                nVar.f2856l.setVisibility(4);
                TextView textView4 = nVar.f2856l;
                AtomicInteger atomicInteger = l.a;
                textView4.setAccessibilityLiveRegion(1);
                nVar.a(nVar.f2856l, 0);
            } else {
                nVar.i();
                nVar.j(nVar.f2856l, 0);
                nVar.f2856l = null;
                nVar.b.w();
                nVar.b.F();
            }
    ...
    public void setHelperText(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence)) {
            ...
            nVar.l(i2, nVar.f2853i, nVar.k(nVar.r, charSequence));
        } else if (this.f608h.q) {
    ...
    public void setHelperTextEnabled(boolean z2) {
        ...
        if (nVar.q != z2) {
            ...
            if (z2) {
                ...
                nVar.l(i3, nVar.f2853i, nVar.k(nVar.r, null));
                nVar.j(nVar.r, 1);
                nVar.r = null;
                nVar.b.w();
                nVar.b.F();
    ...
    public void setHintEnabled(boolean z2) {
        if (z2 != this.z) {
            ...
            if (!z2) {
                this.B = false;
                if (!TextUtils.isEmpty(this.A) && TextUtils.isEmpty(this.f606f.getHint())) {
                    this.f606f.setHint(this.A);
                }
    ...
    public void setHintTextAppearance(int i2) {
        ...
        if (colorStateList != null) {
            cVar.f2686l = colorStateList;
        }
        float f2 = bVar.f2750k;
        if (f2 != 0.0f) {
            cVar.f2684j = f2;
        }
    ...
    public void t(int i2) {
        boolean z2 = this.f611k;
        int i3 = this.f610j;
        String str = null;
        if (i3 == -1) {
            this.f612l.setText(String.valueOf(i2));
            this.f612l.setContentDescription(null);
            this.f611k = false;
        } else {
            this.f611k = i2 > i3;
            Context context = getContext();
            this.f612l.setContentDescription(context.getString(this.f611k ? R$string.character_counter_overflowed_content_description : R$string.character_counter_content_description, Integer.valueOf(i2), Integer.valueOf(this.f610j)));
            if (z2 != this.f611k) {
                u();
            }
            e.i.g.a c2 = e.i.g.a.c();
            TextView textView = this.f612l;
            String string = getContext().getString(R$string.character_counter_pattern, Integer.valueOf(i2), Integer.valueOf(this.f610j));
            e.i.g.c cVar = c2.c;
            if (string != null) {
        ...
        if (this.f606f != null && z2 != this.f611k) {
            y(false, false);
            F();
            w();
        }
    ...
    public final void u() {
        ...
        TextView textView = this.f612l;
        if (textView != null) {
            r(textView, this.f611k ? this.m : this.n);
            if (!this.f611k && (colorStateList2 = this.t) != null) {
                this.f612l.setTextColor(colorStateList2);
            }
            if (this.f611k && (colorStateList = this.u) != null) {
                this.f612l.setTextColor(colorStateList);
            }
        }
    }
    ...
    public final boolean v() {
        ...
        if (!(getStartIconDrawable() == null && this.v == null) && this.c.getMeasuredWidth() > 0) {
            int measuredWidth = this.c.getMeasuredWidth() - this.f606f.getPaddingLeft();
            ...
            Drawable[] compoundDrawablesRelative = this.f606f.getCompoundDrawablesRelative();
            Drawable drawable = compoundDrawablesRelative[0];
            Drawable drawable2 = this.W;
            if (drawable != drawable2) {
                this.f606f.setCompoundDrawablesRelative(drawable2, compoundDrawablesRelative[1], compoundDrawablesRelative[2], compoundDrawablesRelative[3]);
            }
            z2 = false;
            if ((this.q0.getVisibility() != 0 || ((j() && k()) || this.x != null)) && this.f604d.getMeasuredWidth() > 0) {
                int measuredWidth2 = this.y.getMeasuredWidth() - this.f606f.getPaddingRight();
                CheckableImageButton endIconToUpdateDummyDrawable = getEndIconToUpdateDummyDrawable();
                if (endIconToUpdateDummyDrawable != null) {
                    measuredWidth2 = ((ViewGroup.MarginLayoutParams) endIconToUpdateDummyDrawable.getLayoutParams()).getMarginStart() + endIconToUpdateDummyDrawable.getMeasuredWidth() + measuredWidth2;
                }
                Drawable[] compoundDrawablesRelative2 = this.f606f.getCompoundDrawablesRelative();
                ...
                if (drawable3 == null || this.m0 == measuredWidth2) {
                    ...
                    if (drawable4 != drawable5) {
                        ...
                        this.f606f.setCompoundDrawablesRelative(compoundDrawablesRelative2[0], compoundDrawablesRelative2[1], drawable5, compoundDrawablesRelative2[3]);
                    } else {
                        z3 = z2;
                    }
                } else {
                    ...
                    this.f606f.setCompoundDrawablesRelative(compoundDrawablesRelative2[0], compoundDrawablesRelative2[1], this.l0, compoundDrawablesRelative2[3]);
                }
            } else if (this.l0 == null) {
                return z2;
            } else {
                Drawable[] compoundDrawablesRelative3 = this.f606f.getCompoundDrawablesRelative();
                if (compoundDrawablesRelative3[2] == this.l0) {
                    this.f606f.setCompoundDrawablesRelative(compoundDrawablesRelative3[0], compoundDrawablesRelative3[1], this.n0, compoundDrawablesRelative3[3]);
                } else {
                    z3 = z2;
                }
                this.l0 = null;
        ...
        if (this.W != null) {
            Drawable[] compoundDrawablesRelative4 = this.f606f.getCompoundDrawablesRelative();
            this.f606f.setCompoundDrawablesRelative(null, compoundDrawablesRelative4[1], compoundDrawablesRelative4[2], compoundDrawablesRelative4[3]);
            this.W = null;
        }
        z2 = false;
        if ((this.q0.getVisibility() != 0 || ((j() && k()) || this.x != null)) && this.f604d.getMeasuredWidth() > 0) {
    ...
    public void w() {
        ...
        if (editText != null && this.G == 0 && (background = editText.getBackground()) != null) {
            ...
            if (this.f608h.e()) {
                currentTextColor = this.f608h.g();
            } else if (!this.f611k || (textView = this.f612l) == null) {
                m.h.t(background);
                this.f606f.refreshDrawableState();
                return;
            } else {
    ...
    public final void y(boolean z2, boolean z3) {
        ...
        EditText editText2 = this.f606f;
        boolean z5 = editText2 != null && editText2.hasFocus();
        boolean e2 = this.f608h.e();
        ColorStateList colorStateList2 = this.s0;
        if (colorStateList2 != null) {
            f.b.a.d.q.c cVar2 = this.E0;
            if (cVar2.f2686l != colorStateList2) {
                cVar2.f2686l = colorStateList2;
                cVar2.k();
            }
            f.b.a.d.q.c cVar3 = this.E0;
            ColorStateList colorStateList3 = this.s0;
            if (cVar3.f2685k != colorStateList3) {
                cVar3.f2685k = colorStateList3;
                cVar3.k();
            }
        }
        if (!isEnabled) {
            ...
            if (cVar4.f2685k != valueOf) {
                cVar4.f2685k = valueOf;
                cVar4.k();
            }
        } else if (e2) {
            f.b.a.d.q.c cVar5 = this.E0;
            TextView textView2 = this.f608h.f2856l;
            cVar5.m(textView2 != null ? textView2.getTextColors() : null);
        } else {
            if (this.f611k && (textView = this.f612l) != null) {
                cVar = this.E0;
    ...
    public void setErrorIconDrawable(Drawable drawable) {
        this.q0.setImageDrawable(drawable);
        setErrorIconVisible(drawable != null && this.f608h.f2855k);
    }
}
