...
public final class c implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        int i2 = this.b;
        if (i2 == 0) {
            Context context = (Context) this.f328d;
            e.b(context, "ctx");
            String str = ((d) this.c).b.f3462g;
            ...
            Context context2 = (Context) this.f328d;
            e.b(context2, "ctx");
            String str2 = ((d) this.c).b.f3466k;
            Objects.requireNonNull((d) this.c);
            try {
            ...
            Context context3 = (Context) this.f328d;
            e.b(context3, "ctx");
            d dVar = (d) this.c;
