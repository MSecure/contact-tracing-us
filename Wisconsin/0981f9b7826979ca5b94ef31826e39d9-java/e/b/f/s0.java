...
public class s0 extends CompoundButton {
    ...
    public ColorStateList f939h;

    /* renamed from: i  reason: collision with root package name */
    public PorterDuff.Mode f940i;
    ...
    public s0(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f943l = y0Var.f(R$styleable.SwitchCompat_thumbTextPadding, 0);
    ...
    public final void b() {
        ...
        if (this.f941j || this.f942k) {
            ...
            this.f938g = mutate;
            if (this.f941j) {
                mutate.setTintList(this.f939h);
            }
            if (this.f942k) {
                this.f938g.setTintMode(this.f940i);
            }
            if (this.f938g.isStateful()) {
                this.f938g.setState(getDrawableState());
            }
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (drawable2 != null) {
            ...
            if (c2 != null) {
                ...
                if (i14 > i15) {
                    i3 = i7 - (i14 - i15);
                    this.f938g.setBounds(i4, i2, i6, i3);
                }
            } else {
                i2 = i5;
            }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.r) {
            i6 = (this.f943l * 2) + Math.max(this.I.getWidth(), this.J.getWidth());
        } else {
            i6 = 0;
        }
        ...
        if (drawable2 != null) {
            drawable2.getPadding(rect);
            i7 = this.f938g.getIntrinsicHeight();
        } else {
            rect.setEmpty();
        }
        int i8 = rect.left;
    ...
    public boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.b || drawable == this.f938g;
    }
}
