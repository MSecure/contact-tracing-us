...
public class z extends TextView implements f, b {
    ...
    public int getAutoSizeMaxTextSize() {
        ...
        y yVar = this.c;
        if (yVar != null) {
            return Math.round(yVar.f971i.f836e);
        }
        return -1;
    }
    ...
    public int getAutoSizeMinTextSize() {
        ...
        y yVar = this.c;
        if (yVar != null) {
            return Math.round(yVar.f971i.f835d);
        }
        return -1;
    }
    ...
    public int getAutoSizeStepGranularity() {
        ...
        y yVar = this.c;
        if (yVar != null) {
            return Math.round(yVar.f971i.c);
        }
        return -1;
    }
    ...
    public int[] getAutoSizeTextAvailableSizes() {
        ...
        y yVar = this.c;
        return yVar != null ? yVar.f971i.f837f : new int[0];
    }
    ...
    public CharSequence getText() {
        Future<e.i.g.b> future = this.f978f;
        if (future != null) {
            try {
                this.f978f = null;
                m.h.b1(this, future.get());
    ...
    public TextClassifier getTextClassifier() {
        x xVar;
        return (Build.VERSION.SDK_INT >= 28 || (xVar = this.f976d) == null) ? super.getTextClassifier() : xVar.a();
    }
    ...
    public void setTextClassifier(TextClassifier textClassifier) {
        x xVar;
        if (Build.VERSION.SDK_INT >= 28 || (xVar = this.f976d) == null) {
    ...
    public void setTextMetricsParamsCompat(b.a aVar) {
        ...
        setHyphenationFrequency(aVar.f1461d);
    }
