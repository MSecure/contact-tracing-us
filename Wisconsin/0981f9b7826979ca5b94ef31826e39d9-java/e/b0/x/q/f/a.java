...
public class a extends c<Boolean> {
    ...
    public static final String f1088i = l.e("BatteryChrgTracker");

    public a(Context context, e.b0.x.t.q.a aVar) {
        super(context, aVar);
    }
    ...
    public Object a() {
        ...
        if (registerReceiver == null) {
            l.c().b(f1088i, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
    ...
    public void g(Context context, Intent intent) {
        ...
        if (action != null) {
            char c = 0;
            l.c().a(f1088i, String.format("Received %s", action), new Throwable[0]);
