...
public class o {
    ...
    public static final String f1137f = l.e("WorkTimer");
    public final ThreadFactory a;
    public final ScheduledExecutorService b;
    public final Map<String, c> c = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    public final Map<String, b> f1138d = new HashMap();
    ...
    public static class c implements Runnable {
        ...
        public void run() {
            synchronized (this.b.f1139e) {
                if (this.b.c.remove(this.c) != null) {
                    b remove = this.b.f1138d.remove(this.c);
                    if (remove != null) {
                        remove.b(this.c);
                    }
                } else {
    ...
    public void a(String str, long j2, b bVar) {
        synchronized (this.f1139e) {
            l.c().a(f1137f, String.format("Starting timer for %s", str), new Throwable[0]);
            b(str);
            c cVar = new c(this, str);
            this.c.put(str, cVar);
            this.f1138d.put(str, bVar);
    ...
    public void b(String str) {
        synchronized (this.f1139e) {
            if (this.c.remove(str) != null) {
                l.c().a(f1137f, String.format("Stopping timer for %s", str), new Throwable[0]);
