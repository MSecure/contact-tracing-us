...
public class l {
    ...
    public static ThreadLocal<Rect> f1468e;

    /* renamed from: f  reason: collision with root package name */
    public static final int[] f1469f = {R$id.accessibility_custom_action_0, R$id.accessibility_custom_action_1, R$id.accessibility_custom_action_2, R$id.accessibility_custom_action_3, R$id.accessibility_custom_action_4, R$id.accessibility_custom_action_5, R$id.accessibility_custom_action_6, R$id.accessibility_custom_action_7, R$id.accessibility_custom_action_8, R$id.accessibility_custom_action_9, R$id.accessibility_custom_action_10, R$id.accessibility_custom_action_11, R$id.accessibility_custom_action_12, R$id.accessibility_custom_action_13, R$id.accessibility_custom_action_14, R$id.accessibility_custom_action_15, R$id.accessibility_custom_action_16, R$id.accessibility_custom_action_17, R$id.accessibility_custom_action_18, R$id.accessibility_custom_action_19, R$id.accessibility_custom_action_20, R$id.accessibility_custom_action_21, R$id.accessibility_custom_action_22, R$id.accessibility_custom_action_23, R$id.accessibility_custom_action_24, R$id.accessibility_custom_action_25, R$id.accessibility_custom_action_26, R$id.accessibility_custom_action_27, R$id.accessibility_custom_action_28, R$id.accessibility_custom_action_29, R$id.accessibility_custom_action_30, R$id.accessibility_custom_action_31};
    ...
    public static class d {
        ...
        /* renamed from: d  reason: collision with root package name */
        public static final ArrayList<WeakReference<View>> f1471d = new ArrayList<>();
    ...
    public static boolean e(View view, KeyEvent keyEvent) {
        ...
        ArrayList<WeakReference<View>> arrayList = d.f1471d;
        ...
        if (keyEvent.getAction() == 0) {
            ...
            ArrayList<WeakReference<View>> arrayList2 = d.f1471d;
            if (!arrayList2.isEmpty()) {
                synchronized (arrayList2) {
                    ...
                    while (true) {
                        ...
                        ArrayList<WeakReference<View>> arrayList3 = d.f1471d;
    ...
    public static Rect i() {
        if (f1468e == null) {
            f1468e = new ThreadLocal<>();
        }
        Rect rect = f1468e.get();
        if (rect == null) {
            rect = new Rect();
            f1468e.set(rect);
        }
