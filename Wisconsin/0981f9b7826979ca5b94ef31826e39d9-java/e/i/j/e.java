    ...
    public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        ...
        if (!this.f1512f) {
            ...
            try {
                ...
                this.c = cls;
                this.f1510d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                this.f1511e = true;
        ...
        Method declaredMethod = (!this.f1511e || !this.c.isInstance(menu)) ? menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE) : this.f1510d;
