...
public final class a extends l0 implements c0.m {
    ...
    public static boolean n(l0.a aVar) {
        l lVar = aVar.b;
        return lVar != null && lVar.f1625l && lVar.F != null && !lVar.A && !lVar.z && lVar.F();
    }
    ...
    public boolean a(ArrayList<a> arrayList, ArrayList<Boolean> arrayList2) {
        ...
        c0 c0Var = this.q;
        if (c0Var.f1570d == null) {
            c0Var.f1570d = new ArrayList<>();
        }
        c0Var.f1570d.add(this);
        return true;
    }
    ...
    public int h(boolean z) {
        if (!this.r) {
            ...
            this.r = true;
            this.s = this.f1638g ? this.q.f1575i.getAndIncrement() : -1;
            this.q.B(this, z);
            return this.s;
        }
    ...
    public void i(String str, PrintWriter printWriter, boolean z) {
        ...
        if (z) {
            ...
            if (!(this.f1635d == 0 && this.f1636e == 0)) {
                printWriter.print(str);
                printWriter.print("mPopEnterAnim=#");
                printWriter.print(Integer.toHexString(this.f1635d));
                printWriter.print(" mPopExitAnim=#");
                printWriter.println(Integer.toHexString(this.f1636e));
            }
        ...
        if (!this.a.isEmpty()) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (z) {
                    if (!(aVar.c == 0 && aVar.f1644d == 0)) {
                        printWriter.print(str);
                        printWriter.print("enterAnim=#");
                        printWriter.print(Integer.toHexString(aVar.c));
                        printWriter.print(" exitAnim=#");
                        printWriter.println(Integer.toHexString(aVar.f1644d));
                    }
                    if (aVar.f1645e != 0 || aVar.f1646f != 0) {
                        printWriter.print(str);
                        printWriter.print("popEnterAnim=#");
                        printWriter.print(Integer.toHexString(aVar.f1645e));
                        printWriter.print(" popExitAnim=#");
                        printWriter.println(Integer.toHexString(aVar.f1646f));
                    }
                }
            }
        }
    ...
    public void j() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (lVar != null) {
                ...
                lVar.f();
                l.b bVar = lVar.I;
                bVar.f1627e = arrayList;
                bVar.f1628f = arrayList2;
            }
            switch (aVar.a) {
                case 1:
                    lVar.u0(aVar.c);
