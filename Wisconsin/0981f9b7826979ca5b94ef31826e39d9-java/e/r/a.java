...
public class a extends q<C0046a> {
    ...
    public static class C0046a extends j {
        ...
        public void k(Context context, AttributeSet attributeSet) {
            ...
            if (this.f1724j == null) {
                this.f1724j = new Intent();
            }
            this.f1724j.setPackage(string);
            ...
            if (string4 != null) {
                ...
                this.f1724j.setData(parse);
            }
            this.f1725k = obtainAttributes.getString(R$styleable.ActivityNavigator_dataPattern);
    ...
    public j b(C0046a aVar, Bundle bundle, o oVar, q.a aVar2) {
        ...
        int intExtra;
        C0046a aVar3 = aVar;
        if (aVar3.f1724j != null) {
            Intent intent2 = new Intent(aVar3.f1724j);
            if (bundle != null) {
                intent2.putExtras(bundle);
                String str = aVar3.f1725k;
            ...
            intent2.putExtra("android-support-navigation:ActivityNavigator:current", aVar3.f1744d);
            if (oVar != null) {
                intent2.putExtra("android-support-navigation:ActivityNavigator:popEnterAnim", oVar.f1759f);
                intent2.putExtra("android-support-navigation:ActivityNavigator:popExitAnim", oVar.f1760g);
            }
            if (z) {
                Objects.requireNonNull((b) aVar2);
            }
