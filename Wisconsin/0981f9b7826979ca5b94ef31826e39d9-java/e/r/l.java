...
public class l extends q<k> {
    ...
    public j b(k kVar, Bundle bundle, o oVar, q.a aVar) {
        ...
        if (i2 == 0) {
            ...
            int i3 = kVar2.f1744d;
            if (i3 != 0) {
                if (kVar2.f1745e == null) {
                    kVar2.f1745e = Integer.toString(i3);
                }
                str = kVar2.f1745e;
            } else {
        ...
        if (kVar2.f1755l == null) {
            kVar2.f1755l = Integer.toString(kVar2.f1754k);
        }
        throw new IllegalArgumentException(a.c("navigation destination ", kVar2.f1755l, " is not a direct child of this NavGraph"));
    }
