...
public class f {
    ...
    public static final String[] f1840l = {"UPDATE", "DELETE", "INSERT"};
    public final HashMap<String, Integer> a;
    public final String[] b;
    public Map<String, Set<String>> c;

    /* renamed from: d  reason: collision with root package name */
    public final g f1841d;

    /* renamed from: e  reason: collision with root package name */
    public AtomicBoolean f1842e = new AtomicBoolean(false);

    /* renamed from: f  reason: collision with root package name */
    public volatile boolean f1843f = false;

    /* renamed from: g  reason: collision with root package name */
    public volatile e.v.a.f.f f1844g;

    /* renamed from: h  reason: collision with root package name */
    public b f1845h;

    /* renamed from: i  reason: collision with root package name */
    public final e f1846i;

    /* renamed from: j  reason: collision with root package name */
    public final e.c.a.b.b<c, d> f1847j = new e.c.a.b.b<>();
    ...
    public class a implements Runnable {
        ...
        public final Set<Integer> a() {
            ...
            Cursor k2 = f.this.f1841d.k(new e.v.a.a("SELECT * FROM room_table_modification_log WHERE invalidated = 1;"), null);
            while (k2.moveToNext()) {
                try {
        ...
        public void run() {
            ...
            Throwable th;
            Set<Integer> a;
            ReentrantReadWriteLock.ReadLock readLock = f.this.f1841d.f1857i.readLock();
            try {
                readLock.lock();
                if (!f.this.c()) {
                    readLock.unlock();
                } else if (!f.this.f1842e.compareAndSet(true, false)) {
                    readLock.unlock();
                } else if (f.this.f1841d.h()) {
                    readLock.unlock();
                } else {
                    g gVar = f.this.f1841d;
                    if (gVar.f1855g) {
                        e.v.a.b I = gVar.f1852d.I();
                    ...
                    if (set == null && !set.isEmpty()) {
                        synchronized (f.this.f1847j) {
                            Iterator<Map.Entry<c, d>> it = f.this.f1847j.iterator();
                            while (true) {
                                b.e eVar = (b.e) it;
                                if (eVar.hasNext()) {
    ...
    public f(g gVar, Map<String, String> map, Map<String, Set<String>> map2, String... strArr) {
        this.f1841d = gVar;
        this.f1845h = new b(strArr.length);
        this.a = new HashMap<>();
        this.c = map2;
        this.f1846i = new e(gVar);
    ...
    public void i(e.v.a.b bVar) {
        if (!((e.v.a.f.a) bVar).b.inTransaction()) {
            while (true) {
                try {
                    ReentrantReadWriteLock.ReadLock readLock = this.f1841d.f1857i.readLock();
                    readLock.lock();
                    try {
                        int[] a2 = this.f1845h.a();
                        if (a2 == null) {
                            readLock.unlock();
                            return;
                        }
