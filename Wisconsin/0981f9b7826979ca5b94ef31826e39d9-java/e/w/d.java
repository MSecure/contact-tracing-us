...
public class d extends u0 {
    ...
    public class c extends k {
        ...
        public final /* synthetic */ ArrayList f1916d;

        /* renamed from: e  reason: collision with root package name */
        public final /* synthetic */ Object f1917e;

        /* renamed from: f  reason: collision with root package name */
        public final /* synthetic */ ArrayList f1918f;

        public c(Object obj, ArrayList arrayList, Object obj2, ArrayList arrayList2, Object obj3, ArrayList arrayList3) {
            this.a = obj;
            this.b = arrayList;
            this.c = obj2;
            this.f1916d = arrayList2;
            this.f1917e = obj3;
            this.f1918f = arrayList3;
        }
        ...
        public void c(h hVar) {
            ...
            Object obj2 = this.c;
            if (obj2 != null) {
                d.this.p(obj2, this.f1916d, null);
            }
            Object obj3 = this.f1917e;
            if (obj3 != null) {
                d.this.p(obj3, this.f1918f, null);
            }
        }
    ...
    public class C0059d extends h.c {
        public C0059d(d dVar, Rect rect) {
        }
    }

    public static boolean z(h hVar) {
        return !u0.k(hVar.f1922f) || !u0.k(null) || !u0.k(null);
    }
    ...
    public void b(Object obj, ArrayList<View> arrayList) {
        ...
        if (hVar != null) {
            ...
            } else if (!z(hVar) && u0.k(hVar.f1923g)) {
    ...
    public void p(Object obj, ArrayList<View> arrayList, ArrayList<View> arrayList2) {
        ...
        if (hVar instanceof n) {
            ...
            ArrayList<View> arrayList3 = hVar.f1923g;
    ...
    public void w(Object obj, View view, ArrayList<View> arrayList) {
        n nVar = (n) obj;
        ArrayList<View> arrayList2 = nVar.f1923g;
        arrayList2.clear();
        int size = arrayList.size();
        for (int i2 = 0; i2 < size; i2++) {
            u0.d(arrayList2, arrayList.get(i2));
        }
        arrayList2.add(view);
        arrayList.add(view);
        b(nVar, arrayList);
