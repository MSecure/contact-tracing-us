...
public abstract class h implements Cloneable {
    ...
    public TimeInterpolator f1921e = null;

    /* renamed from: f  reason: collision with root package name */
    public ArrayList<Integer> f1922f = new ArrayList<>();

    /* renamed from: g  reason: collision with root package name */
    public ArrayList<View> f1923g = new ArrayList<>();

    /* renamed from: h  reason: collision with root package name */
    public q f1924h = new q();

    /* renamed from: i  reason: collision with root package name */
    public q f1925i = new q();

    /* renamed from: j  reason: collision with root package name */
    public n f1926j = null;

    /* renamed from: k  reason: collision with root package name */
    public int[] f1927k = v;

    /* renamed from: l  reason: collision with root package name */
    public ArrayList<p> f1928l;
    ...
    public static void c(q qVar, View view, p pVar) {
        ...
        if (transitionName != null) {
            if (qVar.f1931d.e(transitionName) >= 0) {
                qVar.f1931d.put(transitionName, null);
            } else {
                qVar.f1931d.put(transitionName, view);
            }
        }
        if (view.getParent() instanceof ListView) {
            ...
            if (listView.getAdapter().hasStableIds()) {
                ...
                if (e.e.d.b(eVar.c, eVar.f1184e, itemIdAtPosition) >= 0) {
    ...
    public String G(String str) {
        ...
        if (this.f1921e != null) {
            ...
            i4.append(this.f1921e);
            i4.append(") ");
            sb = i4.toString();
        }
        if (this.f1922f.size() <= 0 && this.f1923g.size() <= 0) {
            return sb;
        }
        String t2 = f.a.a.a.a.t(sb, "tgts(");
        if (this.f1922f.size() > 0) {
            for (int i5 = 0; i5 < this.f1922f.size(); i5++) {
                if (i5 > 0) {
                    t2 = f.a.a.a.a.t(t2, ", ");
                }
                StringBuilder h3 = f.a.a.a.a.h(t2);
                h3.append(this.f1922f.get(i5));
                t2 = h3.toString();
            }
        }
        if (this.f1923g.size() > 0) {
            for (int i6 = 0; i6 < this.f1923g.size(); i6++) {
                if (i6 > 0) {
                    t2 = f.a.a.a.a.t(t2, ", ");
                }
                StringBuilder h4 = f.a.a.a.a.h(t2);
                h4.append(this.f1923g.get(i6));
                t2 = h4.toString();
            }
        }
    ...
    public final void e(View view, boolean z) {
        if (view != null) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                pVar.c.add(this);
                f(pVar);
                c(z ? this.f1924h : this.f1925i, view, pVar);
            }
    ...
    public void h(ViewGroup viewGroup, boolean z) {
        i(z);
        if (this.f1922f.size() > 0 || this.f1923g.size() > 0) {
            for (int i2 = 0; i2 < this.f1922f.size(); i2++) {
                View findViewById = viewGroup.findViewById(this.f1922f.get(i2).intValue());
                if (findViewById != null) {
                    ...
                    pVar.c.add(this);
                    f(pVar);
                    c(z ? this.f1924h : this.f1925i, findViewById, pVar);
                }
            }
            for (int i3 = 0; i3 < this.f1923g.size(); i3++) {
                View view = this.f1923g.get(i3);
                p pVar2 = new p(view);
                if (z) {
                    g(pVar2);
                } else {
                ...
                pVar2.c.add(this);
                f(pVar2);
                c(z ? this.f1924h : this.f1925i, view, pVar2);
            }
            return;
        }
        e(viewGroup, z);
    ...
    public void m() {
        ...
        if (i2 == 0) {
            ...
            for (int i4 = 0; i4 < this.f1924h.c.l(); i4++) {
                View m2 = this.f1924h.c.m(i4);
                if (m2 != null) {
                    AtomicInteger atomicInteger = l.a;
                    m2.setHasTransientState(false);
                }
            }
            for (int i5 = 0; i5 < this.f1925i.c.l(); i5++) {
                View m3 = this.f1925i.c.m(i5);
                if (m3 != null) {
    ...
    public p n(View view, boolean z) {
        ...
        ArrayList<p> arrayList = z ? this.f1928l : this.m;
        if (arrayList == null) {
            return null;
        }
        int size = arrayList.size();
        ...
        return (z ? this.m : this.f1928l).get(i2);
    }
    ...
    public p q(View view, boolean z) {
        ...
        return (z ? this.f1924h : this.f1925i).a.getOrDefault(view, null);
    }
    ...
    public boolean s(View view) {
        return (this.f1922f.size() == 0 && this.f1923g.size() == 0) || this.f1922f.contains(Integer.valueOf(view.getId())) || this.f1923g.contains(view);
    }
    ...
    public void u(View view) {
        if (!this.q) {
            ...
            for (int i3 = i2 - 1; i3 >= 0; i3--) {
                b k2 = o2.k(i3);
                if (k2.a != null && b0Var.equals(k2.f1929d)) {
                    o2.h(i3).pause();
                }
            }
            ArrayList<d> arrayList = this.r;
        ...
        while (it.hasNext()) {
            ...
            if (o2.containsKey(next)) {
                ...
                if (next != null) {
                    ...
                    TimeInterpolator timeInterpolator = this.f1921e;
