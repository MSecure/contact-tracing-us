...
public class b implements h {
    ...
    public static List<g> b(List<g> list, b.a aVar) {
        ...
        List<g> list2 = aVar.f2020g;
        if (list2 != null) {
            if (!list2.isEmpty()) {
                for (g gVar2 : aVar.f2020g) {
                    if (!treeSet.contains(gVar2.a)) {
                        arrayList.add(gVar2);
                    }
                }
            }
        } else if (!aVar.f2019f.isEmpty()) {
            for (Map.Entry<String, String> entry : aVar.f2019f.entrySet()) {
    ...
    public final void e(long j2, n<?> nVar, byte[] bArr, int i2) {
        if (c || j2 > 3000) {
            ...
            objArr[4] = Integer.valueOf(nVar.f2040l.c());
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x00bb, code lost:
        r0 = r2.a;
        f.a.b.v.b("Unexpected response code %d for %s", java.lang.Integer.valueOf(r0), r29.f2032d);
     */
    ...
    public k f(n<?> nVar) {
        ...
        while (true) {
            ...
            try {
                ...
                InputStream inputStream = a2.f2054d;
