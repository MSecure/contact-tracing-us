...
public class c {
    ...
    public static final Comparator<byte[]> f2052e = new a();
    ...
    public synchronized void b(byte[] bArr) {
        if (bArr != null) {
            if (bArr.length <= this.f2053d) {
                this.a.add(bArr);
                int binarySearch = Collections.binarySearch(this.b, bArr, f2052e);
                if (binarySearch < 0) {
