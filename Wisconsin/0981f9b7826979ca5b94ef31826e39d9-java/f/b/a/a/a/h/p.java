...
public abstract class p<T> extends LiveData<T> {
    ...
    public final SharedPreferences f2074l;
    ...
    public void h() {
        m();
        this.f2074l.registerOnSharedPreferenceChangeListener(this.n);
    }

    @Override // androidx.lifecycle.LiveData
    public void i() {
        this.f2074l.unregisterOnSharedPreferenceChangeListener(this.n);
    }
