...
public final /* synthetic */ class t implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        intent.putExtra("android.intent.extra.TEXT", t0Var.W.getString(R.string.settings_share_message, String.format("https://play.google.com/store/apps/details?id=%s", "gov.wi.covid19.exposurenotifications")));
