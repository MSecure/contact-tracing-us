...
public class t implements c, f.b.a.b.i.t.b {
    ...
    public static final f.b.a.b.b f2396f = new f.b.a.b.b("proto");
    public final z b;
    public final f.b.a.b.i.u.a c;

    /* renamed from: d  reason: collision with root package name */
    public final f.b.a.b.i.u.a f2397d;
    ...
    public final <T> T N(d<T> dVar, b<Throwable, T> bVar) {
        long a2 = this.f2397d.a();
        while (true) {
            try {
                return dVar.a();
            } catch (SQLiteDatabaseLockedException e2) {
                if (this.f2397d.a() >= ((long) this.f2398e.a()) + a2) {
                    return bVar.a(e2);
                }
    ...
    @Override // f.b.a.b.i.s.i.c
    public int g() {
        long a2 = this.c.a() - this.f2398e.b();
        SQLiteDatabase d2 = d();
        d2.beginTransaction();
        try {
