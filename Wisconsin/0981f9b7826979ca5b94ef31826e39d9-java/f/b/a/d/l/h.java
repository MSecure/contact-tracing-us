...
public class h extends BaseAdapter {
    ...
    public static final int f2639e = (Build.VERSION.SDK_INT >= 26 ? 4 : 1);
    ...
    public h() {
        ...
        this.f2640d = g2.getFirstDayOfWeek();
    }
    ...
    public View getView(int i2, View view, ViewGroup viewGroup) {
        ...
        int i3 = i2 + this.f2640d;
        int i4 = this.c;
        if (i3 > i4) {
            i3 -= i4;
        }
        calendar.set(7, i3);
        textView.setText(this.b.getDisplayName(7, f2639e, Locale.getDefault()));
