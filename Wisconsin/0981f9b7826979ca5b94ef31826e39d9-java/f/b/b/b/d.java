...
public abstract class d<K, V> implements Map<K, V>, Serializable {
    ...
    public static class a<K, V> {
        ...
        public a<K, V> b(K k2, V v) {
            ...
            if (i2 > objArr.length) {
                this.a = Arrays.copyOf(objArr, b.AbstractC0100b.b(objArr.length, i2));
                this.c = false;
            }
    ...
    public e<Map.Entry<K, V>> entrySet() {
        ...
        h hVar = (h) this;
        h.a aVar = new h.a(hVar, hVar.f2887f, 0, hVar.f2888g);
        this.b = aVar;
        return aVar;
    }
    ...
    /* renamed from: c */
    public b<V> values() {
        b<V> bVar = this.f2880d;
        if (bVar != null) {
            return bVar;
        }
        h hVar = (h) this;
        h.c cVar = new h.c(hVar.f2887f, 1, hVar.f2888g);
        this.f2880d = cVar;
        return cVar;
    }
    ...
    public int hashCode() {
        return f.b.a.c.b.o.b.b1(entrySet());
    }
    ...
    public Set keySet() {
        ...
        h hVar = (h) this;
        h.b bVar = new h.b(hVar, new h.c(hVar.f2887f, 0, hVar.f2888g));
        this.c = bVar;
        return bVar;
    }
