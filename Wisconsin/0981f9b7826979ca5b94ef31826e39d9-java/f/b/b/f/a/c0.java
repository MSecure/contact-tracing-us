...
public class c0<V> extends l.a<V> implements RunnableFuture<V> {
    ...
    public volatile t<?> f2936i;

    public final class a extends t<V> {

        /* renamed from: e  reason: collision with root package name */
        public final Callable<V> f2937e;

        public a(Callable<V> callable) {
            Objects.requireNonNull(callable);
            this.f2937e = callable;
        }
    ...
    public c0(Callable<V> callable) {
        this.f2936i = new a(callable);
    }

    @Override // f.b.b.f.a.b
    public void j() {
        t<?> tVar;
        if (w() && (tVar = this.f2936i) != null) {
            Runnable runnable = t.f2949d;
