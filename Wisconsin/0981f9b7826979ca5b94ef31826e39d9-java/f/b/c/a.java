...
public class a {
    ...
    public static final Object f2952i = new Object();

    /* renamed from: j  reason: collision with root package name */
    public static final Executor f2953j = new d(null);

    /* renamed from: k  reason: collision with root package name */
    public static final Map<String, a> f2954k = new e.e.a();
    ...
    public final List<b> f2958g = new CopyOnWriteArrayList();

    /* renamed from: h  reason: collision with root package name */
    public final List<Object> f2959h = new CopyOnWriteArrayList();
    ...
    public static class c implements c.a {
        ...
        public void a(boolean z) {
            Object obj = a.f2952i;
            synchronized (a.f2952i) {
                Iterator it = new ArrayList(a.f2954k.values()).iterator();
                while (it.hasNext()) {
                    a aVar = (a) it.next();
                    if (aVar.f2956e.get()) {
                        for (b bVar : aVar.f2958g) {
                            bVar.a(z);
                        }
                    }
                }
    ...
    public a(Context context, String str, c cVar) {
        ...
        try {
            ...
            if (packageManager == null) {
                ...
                if (serviceInfo == null) {
                    ...
                    str2 = j.a.f3996f.toString();
                    Executor executor = f2953j;
                    ...
                    a3.c(f.b.c.l.a.a);
                    dVarArr[7] = a3.b();
                    this.f2955d = new k(executor, arrayList2, dVarArr);
                }
            }
        ...
        a32.c(f.b.c.l.a.a);
        dVarArr2[7] = a32.b();
        this.f2955d = new k(executor2, arrayList22, dVarArr2);
    }

    public static a b() {
        a aVar;
        synchronized (f2952i) {
            aVar = f2954k.get("[DEFAULT]");
            if (aVar == null) {
        ...
        if (context.getApplicationContext() instanceof Application) {
            ...
            if (c.a.get() == null) {
                ...
                if (c.a.compareAndSet(null, cVar2)) {
                    ...
                    f.b.a.c.b.l.l.c cVar3 = f.b.a.c.b.l.l.c.f2411f;
                    Objects.requireNonNull(cVar3);
                    synchronized (cVar3) {
                        cVar3.f2412d.add(cVar2);
                    }
                }
            }
        }
    ...
    public final void a() {
        m.h.r(!this.f2957f.get(), "FirebaseApp was deleted");
    }
