...
public final class x {
    ...
    public static final w f3064k;

    /* renamed from: l  reason: collision with root package name */
    public static final w f3065l;
    public final List<w> a;
    public List<w> b;
    public c0 c;

    /* renamed from: d  reason: collision with root package name */
    public final List<i> f3066d;
    ...
    static {
        ...
        h hVar = h.c;
        f3064k = new w(aVar, hVar);
        f3065l = new w(w.a.DESCENDING, hVar);
    }
    ...
    public List<w> c() {
        ...
        if (this.b == null) {
            Iterator<i> it = this.f3066d.iterator();
            while (true) {
                z = false;
                if (!it.hasNext()) {
                    hVar = null;
            ...
            if (hVar == null || b2 != null) {
                ...
                if (!z) {
                    ...
                    arrayList.add(aVar.equals(aVar2) ? f3064k : f3065l);
                }
                this.b = arrayList;
            } else {
                if (hVar.s()) {
                    list = Collections.singletonList(f3064k);
                } else {
                    list = Arrays.asList(new w(aVar2, hVar), f3064k);
                }
                this.b = list;
            }
        }
    ...
    public c0 d() {
        if (this.c == null) {
            if (this.f3070h == a.LIMIT_TO_FIRST) {
                this.c = new c0(this.f3067e, this.f3068f, this.f3066d, c(), this.f3069g, this.f3071i, this.f3072j);
            } else {
                ArrayList arrayList = new ArrayList();
                for (w wVar : c()) {
                    w.a aVar = wVar.a;
                ...
                this.c = new c0(this.f3067e, this.f3068f, this.f3066d, arrayList, this.f3069g, cVar3, cVar2);
            }
        }
        return this.c;
    }
    ...
    public int hashCode() {
        return this.f3070h.hashCode() + (d().hashCode() * 31);
    }
    ...
    public String toString() {
        ...
        h2.append(";limitType=");
        h2.append(this.f3070h.toString());
        h2.append(")");
        return h2.toString();
    }
}
