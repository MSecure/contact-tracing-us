...
public class j {
    ...
    public static final Set<String> f3147d = new HashSet(Arrays.asList("date", "x-google-backends", "x-google-netmon-label", "x-google-service", "x-google-gfe-request-trace"));
    public final h0 a;
    public final c b;
    public final t c;
