...
public abstract class g implements h1 {
    ...
    public static final class b extends g {
        ...
        public b(ByteBuffer byteBuffer, boolean z) {
            ...
            this.f3296d = byteBuffer.limit() + byteBuffer.arrayOffset();
        }
        ...
        public final <T> T V(j1<T> j1Var, r rVar) {
            int i2 = this.f3298f;
            this.f3298f = ((this.f3297e >>> 3) << 3) | 4;
            try {
                T g2 = j1Var.g();
                j1Var.c(g2, this, rVar);
                j1Var.i(g2);
                if (this.f3297e == this.f3298f) {
                    return g2;
                }
                throw d0.g();
            } finally {
        ...
        public <K, V> void a(Map<K, V> map, m0.a<K, V> aVar, r rVar) {
            ...
            g0(d0);
            int i2 = this.f3296d;
            this.f3296d = this.c + d0;
            try {
                Object obj = aVar.b;
                Object obj2 = aVar.f3357d;
                while (true) {
                    int O = O();
                    if (O == Integer.MAX_VALUE) {
                        ...
                        obj2 = U(aVar.c, aVar.f3357d.getClass(), rVar);
                    }
                }
            } finally {
                this.f3296d = i2;
        ...
        public boolean q() {
            ...
            int i3;
            int i4;
            if (S() || (i2 = this.f3297e) == (i3 = this.f3298f)) {
                return false;
            }
            int i5 = i2 & 7;
            if (i5 != 0) {
