...
public abstract class m extends i {
    ...
    public static final boolean c = v1.f3386h;
    public n a;

    public static abstract class b extends m {

        /* renamed from: d  reason: collision with root package name */
        public final byte[] f3349d;
        ...
        public final void f0(int i2) {
            if (m.c) {
                ...
                this.f3352g += (int) (((long) this.f3351f) - j2);
                return;
            }
            while ((i2 & -128) != 0) {
                byte[] bArr3 = this.f3349d;
                int i5 = this.f3351f;
                this.f3351f = i5 + 1;
        ...
        public final void g0(long j2) {
            if (m.c) {
                ...
                this.f3352g += (int) (((long) this.f3351f) - j3);
                return;
            }
            while ((j2 & -128) != 0) {
                byte[] bArr3 = this.f3349d;
    ...
    public static class c extends m {
        ...
        @Override // f.b.f.m
        public final int G() {
            return this.f3354e - this.f3355f;
        }

        @Override // f.b.f.m
        public final void H(byte b) {
            try {
                byte[] bArr = this.f3353d;
                int i2 = this.f3355f;
                this.f3355f = i2 + 1;
                bArr[i2] = b;
            } catch (IndexOutOfBoundsException e2) {
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3355f), Integer.valueOf(this.f3354e), 1), e2);
            }
        }
        ...
        public final void X(String str) {
            ...
            try {
                ...
                if (A2 == A) {
                    int i3 = i2 + A2;
                    this.f3355f = i3;
                    c = w1.c(str, this.f3353d, i3, G());
                    this.f3355f = i2;
                    a0((c - i2) - A2);
                } else {
                    a0(w1.d(str));
                    c = w1.c(str, this.f3353d, this.f3355f, G());
                }
                this.f3355f = c;
            } catch (w1.c e2) {
                this.f3355f = i2;
        ...
        public final void d0(byte[] bArr, int i2, int i3) {
            try {
                System.arraycopy(bArr, i2, this.f3353d, this.f3355f, i3);
                this.f3355f += i3;
            } catch (IndexOutOfBoundsException e2) {
                throw new d(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.f3355f), Integer.valueOf(this.f3354e), Integer.valueOf(i3)), e2);
            }
        }
    }
    ...
    public static final class e extends b {
        ...
        public final OutputStream f3356h;

        public e(OutputStream outputStream, int i2) {
            super(i2);
            Objects.requireNonNull(outputStream, "out");
            this.f3356h = outputStream;
        }
        ...
        public void X(String str) {
            ...
            try {
                ...
                if (A2 == A) {
                    ...
                    try {
                        this.f3351f = i6;
                        int c2 = w1.c(str, this.f3349d, i6, this.f3350e - i6);
                        this.f3351f = i5;
                        i2 = (c2 - i5) - A2;
                        f0(i2);
                        this.f3351f = c2;
                    } catch (w1.c e2) {
                        this.f3352g -= this.f3351f - i5;
                        this.f3351f = i5;
                        throw e2;
                    ...
                    i2 = w1.d(str);
                    f0(i2);
                    this.f3351f = w1.c(str, this.f3349d, this.f3351f, i2);
                }
                this.f3352g += i2;
            } catch (w1.c e4) {
                F(str, e4);
        ...
        public final void h0() {
            this.f3356h.write(this.f3349d, 0, this.f3351f);
            this.f3351f = 0;
        }
        ...
        public void k0(byte[] bArr, int i2, int i3) {
            ...
            int i5 = this.f3351f;
            if (i4 - i5 >= i3) {
                System.arraycopy(bArr, i2, this.f3349d, i5, i3);
                this.f3351f += i3;
            } else {
                int i6 = i4 - i5;
                System.arraycopy(bArr, i2, this.f3349d, i5, i6);
                int i7 = i2 + i6;
                i3 -= i6;
                this.f3351f = this.f3350e;
                this.f3352g += i6;
                h0();
                if (i3 <= this.f3350e) {
                    System.arraycopy(bArr, i7, this.f3349d, 0, i3);
                    this.f3351f = i3;
                } else {
                    this.f3356h.write(bArr, i7, i3);
                }
            }
            this.f3352g += i3;
        }
