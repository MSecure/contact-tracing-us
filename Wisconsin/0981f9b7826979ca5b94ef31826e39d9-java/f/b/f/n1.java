...
public class n1<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public static final /* synthetic */ int f3358h = 0;
    public final int b;
    public List<n1<K, V>.b> c = Collections.emptyList();

    /* renamed from: d  reason: collision with root package name */
    public Map<K, V> f3359d = Collections.emptyMap();

    /* renamed from: e  reason: collision with root package name */
    public boolean f3360e;

    /* renamed from: f  reason: collision with root package name */
    public volatile n1<K, V>.d f3361f;

    /* renamed from: g  reason: collision with root package name */
    public Map<K, V> f3362g = Collections.emptyMap();
    ...
    public class c implements Iterator<Map.Entry<K, V>> {
        ...
        /* renamed from: d  reason: collision with root package name */
        public Iterator<Map.Entry<K, V>> f3364d;
        ...
        public final Iterator<Map.Entry<K, V>> b() {
            if (this.f3364d == null) {
                this.f3364d = n1.this.f3359d.entrySet().iterator();
            }
            return (Iterator<Map.Entry<K, V>>) this.f3364d;
        }
        ...
        public boolean hasNext() {
            ...
            if (n1.this.f3359d.isEmpty() || !b().hasNext()) {
                return false;
            }
            return true;
        }
    ...
    public boolean containsKey(Object obj) {
        ...
        return a(comparable) >= 0 || this.f3359d.containsKey(comparable);
    }
    ...
    public Iterable<Map.Entry<K, V>> e() {
        return this.f3359d.isEmpty() ? (Iterable<Map.Entry<K, V>>) a.b : this.f3359d.entrySet();
    }

    @Override // java.util.AbstractMap, java.util.Map
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.f3361f == null) {
            this.f3361f = new d(null);
        }
        return this.f3361f;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (d2 != size) {
            return this.f3359d.equals(n1Var.f3359d);
        }
        return true;
    }
    ...
    public final SortedMap<K, V> f() {
        b();
        if (this.f3359d.isEmpty() && !(this.f3359d instanceof TreeMap)) {
            TreeMap treeMap = new TreeMap();
            this.f3359d = treeMap;
            this.f3362g = treeMap.descendingMap();
        }
        return (SortedMap) this.f3359d;
    }

    public void g() {
        if (!this.f3360e) {
            this.f3359d = this.f3359d.isEmpty() ? Collections.emptyMap() : Collections.unmodifiableMap(this.f3359d);
            this.f3362g = this.f3362g.isEmpty() ? Collections.emptyMap() : Collections.unmodifiableMap(this.f3362g);
            this.f3360e = true;
        }
    }
    ...
    public V get(Object obj) {
        ...
        return this.f3359d.get(comparable);
    }
    ...
    public int hashCode() {
        ...
        return this.f3359d.size() > 0 ? i2 + this.f3359d.hashCode() : i2;
    }
    ...
    public V remove(Object obj) {
        ...
        return this.f3359d.remove(comparable);
    }

    public int size() {
        return this.f3359d.size() + this.c.size();
    }
}
