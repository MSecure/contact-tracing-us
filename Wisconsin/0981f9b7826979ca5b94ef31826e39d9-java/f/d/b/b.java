...
public class b<Item extends k<? extends RecyclerView.b0>> extends RecyclerView.e<RecyclerView.b0> {
    ...
    public n<m<?>> f3475d = new f.d.b.s.d();

    /* renamed from: e  reason: collision with root package name */
    public final SparseArray<c<Item>> f3476e = new SparseArray<>();

    /* renamed from: f  reason: collision with root package name */
    public int f3477f;

    /* renamed from: g  reason: collision with root package name */
    public List<f.d.b.r.c<? extends Item>> f3478g;

    /* renamed from: h  reason: collision with root package name */
    public final e.e.a<Class<?>, d<Item>> f3479h = new e.e.a<>();

    /* renamed from: i  reason: collision with root package name */
    public boolean f3480i = true;

    /* renamed from: j  reason: collision with root package name */
    public final o f3481j = new o("FastAdapter");

    /* renamed from: k  reason: collision with root package name */
    public g<Item> f3482k = new h();

    /* renamed from: l  reason: collision with root package name */
    public f.d.b.r.e f3483l = new f();
        ...
        public void c(View view, int i2, b<Item> bVar, Item item) {
            ...
            if (item.isEnabled() && (q = bVar.q(i2)) != null) {
                ...
                if (gVar2 == null || (b = gVar2.b()) == null || !b.a(view, q, item, Integer.valueOf(i2)).booleanValue()) {
                    Iterator it = ((g.e) bVar.f3479h.values()).iterator();
                    do {
                        aVar = (g.a) it;
                        if (!aVar.hasNext()) {
                            if (z) {
    ...
    public int e(int i2) {
        ...
        if (!this.f3475d.b(s.h())) {
            j.j.b.e.c(s, "item");
            if (s instanceof m) {
                int h2 = s.h();
                m<?> mVar = (m) s;
                j.j.b.e.c(mVar, "item");
                this.f3475d.a(h2, mVar);
            } else {
                m<?> a2 = s.a();
                if (a2 != null) {
                    int h3 = s.h();
    ...
    public void f(RecyclerView recyclerView) {
        ...
        Objects.requireNonNull(this.f3481j);
    ...
    public RecyclerView.b0 i(ViewGroup viewGroup, int i2) {
        ...
        m<?> mVar = this.f3475d.get(i2);
        RecyclerView.b0 a2 = this.f3482k.a(this, viewGroup, i2, mVar);
        ...
        return this.f3482k.b(this, a2, mVar);
    }
    ...
    public boolean k(RecyclerView.b0 b0Var) {
        ...
        return this.f3483l.c(b0Var, b0Var.e());
    }
    ...
    public final void p() {
        ...
        while (it.hasNext()) {
            c<Item> next = it.next();
            if (next.c() > 0) {
                this.f3476e.append(i2, next);
                i2 += next.c();
            }
        }
        if (i2 == 0 && this.c.size() > 0) {
            this.f3476e.append(0, this.c.get(0));
        }
        this.f3477f = i2;
    }

    public c<Item> q(int i2) {
        if (i2 < 0 || i2 >= this.f3477f) {
            return null;
        }
        Objects.requireNonNull(this.f3481j);
        j.j.b.e.c("getAdapter", "message");
        SparseArray<c<Item>> sparseArray = this.f3476e;
    ...
    public Item s(int i2) {
        ...
        int indexOfKey = this.f3476e.indexOfKey(i2);
        if (indexOfKey < 0) {
            indexOfKey = (~indexOfKey) - 1;
        }
        return this.f3476e.valueAt(indexOfKey).a(i2 - this.f3476e.keyAt(indexOfKey));
    }
    ...
    public void u() {
        Iterator it = ((g.e) this.f3479h.values()).iterator();
        while (true) {
            g.a aVar = (g.a) it;
            if (aVar.hasNext()) {
                ((d) aVar.next()).h();
