...
public class c<Model, Item extends k<? extends RecyclerView.b0>> extends a<Item> implements Object<Model, Item> {
    ...
    public i<Item> f3484d;

    /* renamed from: e  reason: collision with root package name */
    public boolean f3485e;

    /* renamed from: f  reason: collision with root package name */
    public b<Model, Item> f3486f;

    /* renamed from: g  reason: collision with root package name */
    public final l<Item> f3487g;

    /* renamed from: h  reason: collision with root package name */
    public b<? super Model, ? extends Item> f3488h;
    ...
    public c(b<? super Model, ? extends Item> bVar) {
        ...
        this.f3484d = iVar;
        this.f3485e = true;
        this.f3486f = new b<>(this);
    }

    @Override // f.d.b.c
    public Item a(int i2) {
        Item item = this.f3487g.get(i2);
        if (item != null) {
            return item;
        }
    ...
    public c<Model, Item> d(List<? extends Model> list) {
        ...
        while (it.hasNext()) {
            k kVar = (k) this.f3488h.d(it.next());
            if (kVar != null) {
                arrayList.add(kVar);
            }
        }
        e.c(arrayList, "items");
        if (this.f3485e) {
            this.f3484d.a(arrayList);
        }
        f.d.b.b<Item> bVar = this.a;
        if (bVar != null) {
            this.f3487g.a(arrayList, bVar.t(this.b));
        } else {
            this.f3487g.a(arrayList, 0);
        }
        return this;
    }
