...
public final class a0 {
    ...
    public static final Logger f3500d = Logger.getLogger(a0.class.getName());

    /* renamed from: e  reason: collision with root package name */
    public static final a0 f3501e = new a0();
    ...
    public static final class b {
        public b(SSLSession sSLSession) {
            ...
            try {
                ...
                a0.f3500d.log(Level.FINE, String.format("Peer cert not available for peerHost=%s", sSLSession.getPeerHost()), (Throwable) e2);
            }
        }
    }
