                ...
                if (i2 < i4) {
                    ...
                    if (this.f3884g[i2] == ' ') {
                        while (true) {
                            ...
                            char[] cArr2 = this.f3884g;
                            if (cArr2[i5] == '=' || cArr2[i5] != ' ') {
                                break;
                            }
                            this.c = i5 + 1;
                        }
                        if (this.f3884g[i5] != '=' || i5 == i6) {
                            StringBuilder h2 = a.h("Unexpected end of DN: ");
                            h2.append(this.a);
                            throw new IllegalStateException(h2.toString());
                        }
                    ...
                    } while (this.f3884g[i7] == ' ');
                    int i8 = this.f3882e;
                    int i9 = this.f3881d;
                    if (i8 - i9 > 4) {
                        char[] cArr3 = this.f3884g;
                        if (cArr3[i9 + 3] == '.' && ((cArr3[i9] == 'O' || cArr3[i9] == 'o') && ((cArr3[i9 + 1] == 'I' || cArr3[i9 + 1] == 'i') && (cArr3[i9 + 2] == 'D' || cArr3[i9 + 2] == 'd')))) {
                            this.f3881d = i9 + 4;
                        }
                    }
                    char[] cArr4 = this.f3884g;
                    int i10 = this.f3881d;
                    return new String(cArr4, i10, this.f3882e - i10);
                }
