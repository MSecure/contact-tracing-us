...
public final class e extends b implements d, f, Serializable {
    ...
    public static final e f4041e = P(-999999999, 1, 1);

    /* renamed from: f  reason: collision with root package name */
    public static final e f4042f = P(999999999, 12, 31);

    /* renamed from: g  reason: collision with root package name */
    public static final l<e> f4043g = new a();
    public final int b;
    public final short c;

    /* renamed from: d  reason: collision with root package name */
    public final short f4044d;
    ...
    public e(int i2, int i3, int i4) {
        this.b = i2;
        this.c = (short) i3;
        this.f4044d = (short) i4;
    }

    public static e C(int i2, h hVar, int i3) {
        if (i3 <= 28 || i3 <= hVar.s(m.f4092d.u((long) i2))) {
    ...
    public static e O(p pVar) {
        ...
        return R(f.b.a.c.b.o.b.B0(d.x(System.currentTimeMillis()).b + ((long) ((f.a) pVar.s()).b.c), 86400));
    }

    public static e P(int i2, int i3, int i4) {
        l.b.a.w.a aVar = l.b.a.w.a.YEAR;
        aVar.f4190e.b((long) i2, aVar);
        l.b.a.w.a aVar2 = l.b.a.w.a.MONTH_OF_YEAR;
        aVar2.f4190e.b((long) i3, aVar2);
        l.b.a.w.a aVar3 = l.b.a.w.a.DAY_OF_MONTH;
        aVar3.f4190e.b((long) i4, aVar3);
    ...
    public static e T(CharSequence charSequence, c cVar) {
        ...
        l<e> lVar = f4043g;
        f.b.a.c.b.o.b.B1(charSequence, "text");
        f.b.a.c.b.o.b.B1(lVar, "type");
        try {
            l.b.a.u.a d2 = cVar.d(charSequence, null);
            d2.x(cVar.f4125d, cVar.f4126e);
            return lVar.a(d2);
        } catch (l.b.a.u.f e2) {
            throw e2;
    ...
    public int B(e eVar) {
        ...
        return i3 == 0 ? this.f4044d - eVar.f4044d : i3;
    }
    ...
    public b G() {
        return b.r(f.b.a.c.b.o.b.C0(x() + 3, 7) + 1);
    }

    public int H() {
        return (h.u(this.c).q(K()) + this.f4044d) - 1;
    }
    ...
    public final long N(e eVar) {
        return (((eVar.I() * 32) + ((long) eVar.f4044d)) - ((I() * 32) + ((long) this.f4044d))) / 32;
    }
    ...
    public e v(long j2, l.b.a.w.m mVar) {
        ...
        switch (((l.b.a.w.b) mVar).ordinal()) {
            ...
            case 10:
                return Y(j2);
            case 11:
                return Y(f.b.a.c.b.o.b.I1(j2, 10));
            case 12:
                return Y(f.b.a.c.b.o.b.I1(j2, 100));
            case 13:
                return Y(f.b.a.c.b.o.b.I1(j2, 1000));
            case 14:
                l.b.a.w.a aVar = l.b.a.w.a.ERA;
                return z(aVar, f.b.a.c.b.o.b.H1(i(aVar), j2));
            default:
    ...
    public e V(long j2) {
        return j2 == 0 ? this : R(f.b.a.c.b.o.b.H1(x(), j2));
    }
    ...
    public e W(long j2) {
        ...
        return Z(l.b.a.w.a.YEAR.m(f.b.a.c.b.o.b.B0(j3, 12)), f.b.a.c.b.o.b.C0(j3, 12) + 1, this.f4044d);
    }

    public e X(long j2) {
        return V(f.b.a.c.b.o.b.I1(j2, 7));
    }

    public e Y(long j2) {
        return j2 == 0 ? this : Z(l.b.a.w.a.YEAR.m(((long) this.b) + j2), this.c, this.f4044d);
    }
    ...
    public e z(j jVar, long j2) {
        ...
        switch (aVar.ordinal()) {
            ...
            case 18:
                int i2 = (int) j2;
                return this.f4044d == i2 ? this : P(this.b, this.c, i2);
            case 19:
                int i3 = (int) j2;
            ...
            case 23:
                ...
                l.b.a.w.a aVar2 = l.b.a.w.a.MONTH_OF_YEAR;
                aVar2.f4190e.b((long) i4, aVar2);
                return Z(this.b, i4, this.f4044d);
            case 24:
    ...
    public <R> R c(l<R> lVar) {
        return lVar == k.f4208f ? this : (R) super.c(lVar);
    }
    ...
    public e c0(int i2) {
        ...
        l.b.a.w.a aVar = l.b.a.w.a.YEAR;
        aVar.f4190e.b((long) i2, aVar);
        return Z(i2, this.c, this.f4044d);
    }
    ...
    public int hashCode() {
        int i2 = this.b;
        return (((i2 << 11) + (this.c << 6)) + this.f4044d) ^ (i2 & -2048);
    }
    ...
    public long x() {
        ...
        long j6 = (((367 * j4) - 362) / 12) + j2 + ((long) (this.f4044d - 1));
        if (j4 > 2) {
            j6--;
            if (!K()) {
                j6--;
