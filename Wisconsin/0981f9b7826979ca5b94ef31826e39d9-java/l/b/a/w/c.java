    ...
    public enum b implements j {
        DAY_OF_QUARTER {
            ...
            public long f(e eVar) {
                if (eVar.f(this)) {
                    return (long) (eVar.b(a.DAY_OF_YEAR) - b.f4202f[((eVar.b(a.MONTH_OF_YEAR) - 1) / 3) + (m.f4092d.u(eVar.i(a.YEAR)) ? 4 : 0)]);
                }
            ...
            public o l(e eVar) {
                if (eVar.f(this)) {
                    ...
                    return m.f4092d.u(eVar.i(a.YEAR)) ? o.d(1, 91) : o.d(1, 90);
                }
                throw new n("Unsupported field: DayOfQuarter");
            }
        ...
        WEEK_OF_WEEK_BASED_YEAR {
            ...
            public e e(Map<j, Long> map, e eVar, l lVar) {
                ...
                int a = a.YEAR.f4190e.a(l2.longValue(), bVar2);
        ...
        WEEK_BASED_YEAR {
            ...
            public <R extends d> R c(R r, long j2) {
                if (b(r)) {
                    int a = a.YEAR.f4190e.a(j2, b.WEEK_BASED_YEAR);
                    e E = e.E(r);
                    a aVar = a.DAY_OF_WEEK;
                    int b = E.b(aVar);
                    int n = b.n(E);
        ...
        public static final int[] f4202f = {0, 90, 181, 273, 0, 91, 182, 274};
        ...
        public static boolean m(e eVar) {
            return h.l(eVar).equals(m.f4092d);
        }
        ...
        public static int n(e eVar) {
            ...
            if (H < i4) {
                ...
                return (int) o.d(1, (long) q(o(eVar.Y(-1)))).f4211e;
            }
            int i5 = ((H - i4) / 7) + 1;
            if (i5 == 53) {
            }
